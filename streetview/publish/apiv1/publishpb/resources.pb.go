...
func (x *UploadRef) GetFileSource() isUploadRef_FileSource {
	if x != nil {
		return x.FileSource
	}
	return nil
...
func (x *UploadRef) GetUploadUrl() string {
	if x != nil {
		if x, ok := x.FileSource.(*UploadRef_UploadUrl); ok {
			return x.UploadUrl
		}
	}
	return ""
...
func (x *ProcessingFailureDetails) GetDetails() isProcessingFailureDetails_Details {
	if x != nil {
		return x.Details
	}
	return nil
...
func (x *ProcessingFailureDetails) GetInsufficientGpsDetails() *InsufficientGpsFailureDetails {
	if x != nil {
		if x, ok := x.Details.(*ProcessingFailureDetails_InsufficientGpsDetails); ok {
...
func (x *ProcessingFailureDetails) GetGpsDataGapDetails() *GpsDataGapFailureDetails {
	if x != nil {
		if x, ok := x.Details.(*ProcessingFailureDetails_GpsDataGapDetails); ok {
...
func (x *ProcessingFailureDetails) GetImuDataGapDetails() *ImuDataGapFailureDetails {
	if x != nil {
		if x, ok := x.Details.(*ProcessingFailureDetails_ImuDataGapDetails); ok {
...
func (x *ProcessingFailureDetails) GetNotOutdoorsDetails() *NotOutdoorsFailureDetails {
	if x != nil {
		if x, ok := x.Details.(*ProcessingFailureDetails_NotOutdoorsDetails); ok {
...
func (x *ProcessingFailureDetails) GetNoOverlapGpsDetails() *NoOverlapGpsFailureDetails {
	if x != nil {
		if x, ok := x.Details.(*ProcessingFailureDetails_NoOverlapGpsDetails); ok {
...
const file_google_streetview_publish_v1_resources_proto_rawDesc = "" +
	"\n" +
	",google/streetview/publish/v1/resources.proto\x12\x1cgoogle.streetview.publish.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x18google/type/latlng.proto\";\n" +
	"\tUploadRef\x12\x1f\n" +
	"\n" +
	...
	"\x05Level\x12\x1b\n" +
	"\x06number\x18\x01 \x01(\x01B\x03\xe0A\x01R\x06number\x12\x17\n" +
	"\x04name\x18\x02 \x01(\tB\x03\xe0A\x02R\x04name\"\xe3\x02\n" +
	"\x04Pose\x125\n" +
	"\flat_lng_pair\x18\x01 \x01(\v2\x13.google.type.LatLngR\n" +
	"latLngPair\x12\x1a\n" +
	"\baltitude\x18\x02 \x01(\x01R\baltitude\x12\x18\n" +
	"\aheading\x18\x03 \x01(\x01R\aheading\x12\x14\n" +
	"\x05pitch\x18\x04 \x01(\x01R\x05pitch\x12\x12\n" +
	"\x04roll\x18\x05 \x01(\x01R\x04roll\x12`\n" +
	"\x1fgps_record_timestamp_unix_epoch\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x1bgpsRecordTimestampUnixEpoch\x129\n" +
	"\x05level\x18\a \x01(\v2#.google.streetview.publish.v1.LevelR\x05level\x12'\n" +
	"\x0faccuracy_meters\x18\t \x01(\x02R\x0eaccuracyMeters\"\xe5\x02\n" +
	"\x03Imu\x12P\n" +
	"\vaccel_mpsps\x18\x01 \x03(\v2/.google.streetview.publish.v1.Imu.Measurement3dR\n" +
	"accelMpsps\x12J\n" +
	"\bgyro_rps\x18\x02 \x03(\v2/.google.streetview.publish.v1.Imu.Measurement3dR\agyroRps\x12F\n" +
	"\x06mag_ut\x18\x03 \x03(\v2/.google.streetview.publish.v1.Imu.Measurement3dR\x05magUt\x1ax\n" +
	"\rMeasurement3d\x12=\n" +
	"\fcapture_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\vcaptureTime\x12\f\n" +
	"\x01x\x18\x02 \x01(\x02R\x01x\x12\f\n" +
	"\x01y\x18\x03 \x01(\x02R\x01y\x12\f\n" +
	"\x01z\x18\x04 \x01(\x02R\x01z\"e\n" +
	"\x05Place\x12\x19\n" +
	"\bplace_id\x18\x01 \x01(\tR\aplaceId\x12\x17\n" +
	"\x04name\x18\x02 \x01(\tB\x03\xe0A\x03R\x04name\x12(\n" +
	"\rlanguage_code\x18\x03 \x01(\tB\x03\xe0A\x03R\flanguageCode\"P\n" +
	"\n" +
	"Connection\x12B\n" +
	"\x06target\x18\x01 \x01(\v2%.google.streetview.publish.v1.PhotoIdB\x03\xe0A\x02R\x06target\"\xef\b\n" +
	"\x05Photo\x12H\n" +
	"\bphoto_id\x18\x01 \x01(\v2%.google.streetview.publish.v1.PhotoIdB\x06\xe0A\x02\xe0A\x03R\aphotoId\x12W\n" +
	"\x10upload_reference\x18\x02 \x01(\v2'.google.streetview.publish.v1.UploadRefB\x03\xe0A\x04R\x0fuploadReference\x12&\n" +
	"\fdownload_url\x18\x03 \x01(\tB\x03\xe0A\x03R\vdownloadUrl\x12(\n" +
	"\rthumbnail_url\x18\t \x01(\tB\x03\xe0A\x03R\fthumbnailUrl\x12\"\n" +
	"\n" +
	"share_link\x18\v \x01(\tB\x03\xe0A\x03R\tshareLink\x12;\n" +
	"\x04pose\x18\x04 \x01(\v2\".google.streetview.publish.v1.PoseB\x03\xe0A\x01R\x04pose\x12O\n" +
	"\vconnections\x18\x05 \x03(\v2(.google.streetview.publish.v1.ConnectionB\x03\xe0A\x01R\vconnections\x12B\n" +
	"\fcapture_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x01R\vcaptureTime\x12@\n" +
	"\vupload_time\x18\x0e \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"uploadTime\x12@\n" +
	"\x06places\x18\a \x03(\v2#.google.streetview.publish.v1.PlaceB\x03\xe0A\x01R\x06places\x12\"\n" +
	"\n" +
	"view_count\x18\n" +
	" \x01(\x03B\x03\xe0A\x03R\tviewCount\x12`\n" +
	"\x0ftransfer_status\x18\f \x01(\x0e22.google.streetview.publish.v1.Photo.TransferStatusB\x03\xe0A\x03R\x0etransferStatus\x12j\n" +
	"\x13maps_publish_status\x18\r \x01(\x0e25.google.streetview.publish.v1.Photo.MapsPublishStatusB\x03\xe0A\x03R\x11mapsPublishStatus\"\xa5\x01\n" +
	"\x0eTransferStatus\x12\x1b\n" +
	"\x17TRANSFER_STATUS_UNKNOWN\x10\x00\x12\x15\n" +
	"\x11NEVER_TRANSFERRED\x10\x01\x12\v\n" +
	"\aPENDING\x10\x02\x12\r\n" +
	"\tCOMPLETED\x10\x03\x12\f\n" +
	"\bREJECTED\x10\x04\x12\v\n" +
	"\aEXPIRED\x10\x05\x12\r\n" +
	"\tCANCELLED\x10\x06\x12\x19\n" +
	"\x15RECEIVED_VIA_TRANSFER\x10\a\"]\n" +
	"\x11MapsPublishStatus\x12#\n" +
	"\x1fUNSPECIFIED_MAPS_PUBLISH_STATUS\x10\x00\x12\r\n" +
	"\tPUBLISHED\x10\x01\x12\x14\n" +
	"\x10REJECTED_UNKNOWN\x10\x02\"\xf6\b\n" +
	"\rPhotoSequence\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x03R\x02id\x12@\n" +
	"\x06photos\x18\x02 \x03(\v2#.google.streetview.publish.v1.PhotoB\x03\xe0A\x03R\x06photos\x12W\n" +
	"\x10upload_reference\x18\x03 \x01(\v2'.google.streetview.publish.v1.UploadRefB\x03\xe0A\x04R\x0fuploadReference\x12S\n" +
	"\x15capture_time_override\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x01R\x13captureTimeOverride\x12@\n" +
	"\vupload_time\x18\x12 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"uploadTime\x12Q\n" +
	"\x10raw_gps_timeline\x18\a \x03(\v2\".google.streetview.publish.v1.PoseB\x03\xe0A\x04R\x0erawGpsTimeline\x12Y\n" +
	"\n" +
	"gps_source\x18\b \x01(\x0e25.google.streetview.publish.v1.PhotoSequence.GpsSourceB\x03\xe0A\x04R\tgpsSource\x128\n" +
	"\x03imu\x18\v \x01(\v2!.google.streetview.publish.v1.ImuB\x03\xe0A\x04R\x03imu\x12]\n" +
	"\x10processing_state\x18\f \x01(\x0e2-.google.streetview.publish.v1.ProcessingStateB\x03\xe0A\x03R\x0fprocessingState\x12a\n" +
	"\x0efailure_reason\x18\r \x01(\x0e25.google.streetview.publish.v1.ProcessingFailureReasonB\x03\xe0A\x03R\rfailureReason\x12d\n" +
	"\x0ffailure_details\x18\x17 \x01(\v26.google.streetview.publish.v1.ProcessingFailureDetailsB\x03\xe0A\x03R\x0efailureDetails\x12,\n" +
	"\x0fdistance_meters\x18\x10 \x01(\x01B\x03\xe0A\x03R\x0edistanceMeters\x12X\n" +
	"\x0fsequence_bounds\x18\x14 \x01(\v2*.google.streetview.publish.v1.LatLngBoundsB\x03\xe0A\x03R\x0esequenceBounds\x12\"\n" +
	"\n" +
	"view_count\x18\x15 \x01(\x03B\x03\xe0A\x03R\tviewCount\x12\x1f\n" +
	"\bfilename\x18\x16 \x01(\tB\x03\xe0A\x03R\bfilename\"A\n" +
	"\tGpsSource\x12\x12\n" +
	"\x0ePHOTO_SEQUENCE\x10\x00\x12 \n" +
	"\x1cCAMERA_MOTION_METADATA_TRACK\x10\x01\"t\n" +
	"\fLatLngBounds\x121\n" +
	"\tsouthwest\x18\x01 \x01(\v2\x13.google.type.LatLngR\tsouthwest\x121\n" +
	"\tnortheast\x18\x02 \x01(\v2\x13.google.type.LatLngR\tnortheast\"\xd2\x04\n" +
	"\x18ProcessingFailureDetails\x12w\n" +
	"\x18insufficient_gps_details\x18\x01 \x01(\v2;.google.streetview.publish.v1.InsufficientGpsFailureDetailsH\x00R\x16insufficientGpsDetails\x12i\n" +
	"\x14gps_data_gap_details\x18\x02 \x01(\v26.google.streetview.publish.v1.GpsDataGapFailureDetailsH\x00R\x11gpsDataGapDetails\x12i\n" +
	"\x14imu_data_gap_details\x18\x03 \x01(\v26.google.streetview.publish.v1.ImuDataGapFailureDetailsH\x00R\x11imuDataGapDetails\x12k\n" +
	"\x14not_outdoors_details\x18\x04 \x01(\v27.google.streetview.publish.v1.NotOutdoorsFailureDetailsH\x00R\x12notOutdoorsDetails\x12o\n" +
	"\x16no_overlap_gps_details\x18\x05 \x01(\v28.google.streetview.publish.v1.NoOverlapGpsFailureDetailsH\x00R\x13noOverlapGpsDetailsB\t\n" +
	"\adetails\"c\n" +
	"\x1dInsufficientGpsFailureDetails\x12-\n" +
	"\x10gps_points_found\x18\x01 \x01(\x05H\x00R\x0egpsPointsFound\x88\x01\x01B\x13\n" +
	"\x11_gps_points_found\"\xc7\x01\n" +
	"\x18GpsDataGapFailureDetails\x12A\n" +
	"\fgap_duration\x18\x01 \x01(\v2\x19.google.protobuf.DurationH\x00R\vgapDuration\x88\x01\x01\x12D\n" +
	"\x0egap_start_time\x18\x02 \x01(\v2\x19.google.protobuf.DurationH\x01R\fgapStartTime\x88\x01\x01B\x0f\n" +
	"\r_gap_durationB\x11\n" +
	"\x0f_gap_start_time\"\xc7\x01\n" +
	"\x18ImuDataGapFailureDetails\x12A\n" +
	"\fgap_duration\x18\x01 \x01(\v2\x19.google.protobuf.DurationH\x00R\vgapDuration\x88\x01\x01\x12D\n" +
	"\x0egap_start_time\x18\x02 \x01(\v2\x19.google.protobuf.DurationH\x01R\fgapStartTime\x88\x01\x01B\x0f\n" +
	"\r_gap_durationB\x11\n" +
	"\x0f_gap_start_time\"i\n" +
	"\x19NotOutdoorsFailureDetails\x12=\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x19.google.protobuf.DurationH\x00R\tstartTime\x88\x01\x01B\r\n" +
	"\v_start_time\"\x84\x03\n" +
	"\x1aNoOverlapGpsFailureDetails\x12E\n" +
	"\x0egps_start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampH\x00R\fgpsStartTime\x88\x01\x01\x12A\n" +
	"\fgps_end_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampH\x01R\n" +
	"gpsEndTime\x88\x01\x01\x12I\n" +
	"\x10video_start_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampH\x02R\x0evideoStartTime\x88\x01\x01\x12E\n" +
	"\x0evideo_end_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampH\x03R\fvideoEndTime\x88\x01\x01B\x11\n" +
	...
	"\vINVALID_GPS\x10\x05\x12\x1e\n" +
	"\x1aFAILED_TO_REFINE_POSITIONS\x10\x06\x12\f\n" +
	"\bTAKEDOWN\x10\a\x12\x11\n" +
	"\rCORRUPT_VIDEO\x10\b\x12\f\n" +
	"\bINTERNAL\x10\t\x12\x18\n" +
	"\x14INVALID_VIDEO_FORMAT\x10\n" +
	"\x12\x1c\n" +
	"\x18INVALID_VIDEO_DIMENSIONS\x10\v\x12\x18\n" +
	"\x14INVALID_CAPTURE_TIME\x10\f\x12\x10\n" +
	"\fGPS_DATA_GAP\x10\r\x12\r\n" +
	"\tJUMPY_GPS\x10\x0e\x12\x0f\n" +
	"\vINVALID_IMU\x10\x0f\x12\x14\n" +
	"\x10INSUFFICIENT_IMU\x10\x15\x12$\n" +
	" INSUFFICIENT_OVERLAP_TIME_SERIES\x10\x16\x12\x10\n" +
	"\fIMU_DATA_GAP\x10\x10\x12\x16\n" +
	"\x12UNSUPPORTED_CAMERA\x10\x11\x12\x10\n" +
	"\fNOT_OUTDOORS\x10\x12\x12\x1d\n" +
...
var (
	...
	file_google_streetview_publish_v1_resources_proto_rawDescData []byte
)
...
func file_google_streetview_publish_v1_resources_proto_rawDescGZIP() []byte {
	file_google_streetview_publish_v1_resources_proto_rawDescOnce.Do(func() {
		file_google_streetview_publish_v1_resources_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_streetview_publish_v1_resources_proto_rawDesc), len(file_google_streetview_publish_v1_resources_proto_rawDesc)))
	})
...
func file_google_streetview_publish_v1_resources_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_streetview_publish_v1_resources_proto_rawDesc), len(file_google_streetview_publish_v1_resources_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   0,
