...
func (op *CreateBacktestResultOperation) Metadata() (*financialservicespb.OperationMetadata, error) {
	var meta financialservicespb.OperationMetadata
...
func (op *ExportBacktestResultMetadataOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*financialservicespb.ExportBacktestResultMetadataResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp financialservicespb.ExportBacktestResultMetadataResponse
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
	return &resp, nil
...
func (op *ExportEngineConfigMetadataOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*financialservicespb.ExportEngineConfigMetadataResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp financialservicespb.ExportEngineConfigMetadataResponse
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
	return &resp, nil
...
func (op *ExportModelMetadataOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*financialservicespb.ExportModelMetadataResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp financialservicespb.ExportModelMetadataResponse
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
	return &resp, nil
...
func (op *ExportPredictionResultMetadataOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*financialservicespb.ExportPredictionResultMetadataResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp financialservicespb.ExportPredictionResultMetadataResponse
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
	return &resp, nil
...
func (op *ExportRegisteredPartiesOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*financialservicespb.ExportRegisteredPartiesResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp financialservicespb.ExportRegisteredPartiesResponse
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
	return &resp, nil
...
func (op *ImportRegisteredPartiesOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*financialservicespb.ImportRegisteredPartiesResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp financialservicespb.ImportRegisteredPartiesResponse
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
	return &resp, nil
...
func (it *BacktestResultIterator) Next() (*financialservicespb.BacktestResult, error) {
	var item *financialservicespb.BacktestResult
...
func (it *BacktestResultIterator) bufLen() int {
	return len(it.items)
}

func (it *BacktestResultIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type DatasetIterator struct {
	items    []*financialservicespb.Dataset
	pageInfo *iterator.PageInfo
	nextFunc func() error
...
func (it *DatasetIterator) Next() (*financialservicespb.Dataset, error) {
	var item *financialservicespb.Dataset
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *EngineConfigIterator) Next() (*financialservicespb.EngineConfig, error) {
	var item *financialservicespb.EngineConfig
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *EngineConfigIterator) bufLen() int {
	return len(it.items)
}

func (it *EngineConfigIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type EngineVersionIterator struct {
	items    []*financialservicespb.EngineVersion
	pageInfo *iterator.PageInfo
	nextFunc func() error
...
func (it *EngineVersionIterator) Next() (*financialservicespb.EngineVersion, error) {
	var item *financialservicespb.EngineVersion
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *EngineVersionIterator) bufLen() int {
	return len(it.items)
}

func (it *EngineVersionIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
func (it *InstanceIterator) Next() (*financialservicespb.Instance, error) {
	var item *financialservicespb.Instance
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *ModelIterator) Next() (*financialservicespb.Model, error) {
	var item *financialservicespb.Model
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
type PredictionResultIterator struct {
	items    []*financialservicespb.PredictionResult
	pageInfo *iterator.PageInfo
	nextFunc func() error
...
func (it *PredictionResultIterator) Next() (*financialservicespb.PredictionResult, error) {
	var item *financialservicespb.PredictionResult
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *PredictionResultIterator) bufLen() int {
	return len(it.items)
}

func (it *PredictionResultIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
