...
const file_google_cloud_gkeconnect_gateway_v1beta1_control_proto_rawDesc = "" +
	"\n" +
	"5google/cloud/gkeconnect/gateway/v1beta1/control.proto\x12'google.cloud.gkeconnect.gateway.v1beta1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\"\x92\x03\n" +
	...
	"\x14kubernetes_namespace\x18\x04 \x01(\tB\x03\xe0A\x01R\x13kubernetesNamespace\x12\x83\x01\n" +
	"\x10operating_system\x18\x05 \x01(\x0e2S.google.cloud.gkeconnect.gateway.v1beta1.GenerateCredentialsRequest.OperatingSystemB\x03\xe0A\x01R\x0foperatingSystem\"Q\n" +
	...
	"kubeconfig\x12\x1a\n" +
	"\bendpoint\x18\x02 \x01(\tR\bendpoint2\xd8\x02\n" +
	...
	"+com.google.cloud.gkeconnect.gateway.v1beta1B\fControlProtoP\x01ZEcloud.google.com/go/gkeconnect/gateway/apiv1beta1/gatewaypb;gatewaypb\xaa\x02'Google.Cloud.GkeConnect.Gateway.V1Beta1\xca\x02'Google\\Cloud\\GkeConnect\\Gateway\\V1beta1\xea\x02+Google::Cloud::GkeConnect::Gateway::V1beta1b\x06proto3"

var (
	file_google_cloud_gkeconnect_gateway_v1beta1_control_proto_rawDescOnce sync.Once
	file_google_cloud_gkeconnect_gateway_v1beta1_control_proto_rawDescData []byte
)
...
func file_google_cloud_gkeconnect_gateway_v1beta1_control_proto_rawDescGZIP() []byte {
	file_google_cloud_gkeconnect_gateway_v1beta1_control_proto_rawDescOnce.Do(func() {
		file_google_cloud_gkeconnect_gateway_v1beta1_control_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_gkeconnect_gateway_v1beta1_control_proto_rawDesc), len(file_google_cloud_gkeconnect_gateway_v1beta1_control_proto_rawDesc)))
	})
...
func file_google_cloud_gkeconnect_gateway_v1beta1_control_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_gkeconnect_gateway_v1beta1_control_proto_rawDesc), len(file_google_cloud_gkeconnect_gateway_v1beta1_control_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
