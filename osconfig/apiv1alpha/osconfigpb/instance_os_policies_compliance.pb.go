...
type InstanceOSPoliciesCompliance struct {
	...
	LastComplianceCheckTime *timestamp.Timestamp `protobuf:"bytes,7,opt,name=last_compliance_check_time,json=lastComplianceCheckTime,proto3" json:"last_compliance_check_time,omitempty"`
...
func (x *InstanceOSPoliciesCompliance) GetLastComplianceCheckTime() *timestamp.Timestamp {
	if x != nil {
