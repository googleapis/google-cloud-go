...
const file_google_cloud_osconfig_v1alpha_config_common_proto_rawDesc = "" +
	"\n" +
	...
	"\x04type\x18\x01 \x01(\x0e2>.google.cloud.osconfig.v1alpha.OSPolicyResourceConfigStep.TypeR\x04type\x12[\n" +
	"\aoutcome\x18\x02 \x01(\x0e2A.google.cloud.osconfig.v1alpha.OSPolicyResourceConfigStep.OutcomeR\aoutcome\x12#\n" +
	...
	"\fconfig_steps\x18\x02 \x03(\v29.google.cloud.osconfig.v1alpha.OSPolicyResourceConfigStepR\vconfigSteps\x12L\n" +
	"\x05state\x18\x03 \x01(\x0e26.google.cloud.osconfig.v1alpha.OSPolicyComplianceStateR\x05state\x12\x80\x01\n" +
	"\x14exec_resource_output\x18\x04 \x01(\v2L.google.cloud.osconfig.v1alpha.OSPolicyResourceCompliance.ExecResourceOutputH\x00R\x12execResourceOutput\x1aG\n" +
	"\x12ExecResourceOutput\x12-\n" +
	"\x12enforcement_output\x18\x02 \x01(\fR\x11enforcementOutput:\x02\x18\x01:\x02\x18\x01B\b\n" +
	"\x06output*\x97\x01\n" +
...
var (
	...
	file_google_cloud_osconfig_v1alpha_config_common_proto_rawDescData []byte
)
...
func file_google_cloud_osconfig_v1alpha_config_common_proto_rawDescGZIP() []byte {
	file_google_cloud_osconfig_v1alpha_config_common_proto_rawDescOnce.Do(func() {
		file_google_cloud_osconfig_v1alpha_config_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_v1alpha_config_common_proto_rawDesc), len(file_google_cloud_osconfig_v1alpha_config_common_proto_rawDesc)))
	})
...
func file_google_cloud_osconfig_v1alpha_config_common_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_v1alpha_config_common_proto_rawDesc), len(file_google_cloud_osconfig_v1alpha_config_common_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
