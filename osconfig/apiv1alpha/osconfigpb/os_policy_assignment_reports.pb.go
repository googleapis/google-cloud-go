...
func (x *OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance) GetOutput() isOSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance_Output {
	if x != nil {
		return x.Output
	}
	return nil
...
func (x *OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance) GetExecResourceOutput() *OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance_ExecResourceOutput {
	if x != nil {
		if x, ok := x.Output.(*OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance_ExecResourceOutput_); ok {
...
const file_google_cloud_osconfig_v1alpha_os_policy_assignment_reports_proto_rawDesc = "" +
	"\n" +
	...
	"0osconfig.googleapis.com/OSPolicyAssignmentReportR\x04name\"\xcd\x01\n" +
	"$ListOSPolicyAssignmentReportsRequest\x12Q\n" +
	"\x06parent\x18\x01 \x01(\tB9\xe0A\x02\xfaA3\n" +
	"1compute.googleapis.com/InstanceOSPolicyAssignmentR\x06parent\x12\x1b\n" +
	...
	"\x1cos_policy_assignment_reports\x18\x01 \x03(\v27.google.cloud.osconfig.v1alpha.OSPolicyAssignmentReportR\x19osPolicyAssignmentReports\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\x97\x11\n" +
	"\x18OSPolicyAssignmentReport\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1a\n" +
	"\binstance\x18\x02 \x01(\tR\binstance\x12a\n" +
	"\x14os_policy_assignment\x18\x03 \x01(\tB/\xfaA,\n" +
	"*osconfig.googleapis.com/OSPolicyAssignmentR\x12osPolicyAssignment\x12~\n" +
	"\x15os_policy_compliances\x18\x04 \x03(\v2J.google.cloud.osconfig.v1alpha.OSPolicyAssignmentReport.OSPolicyComplianceR\x13osPolicyCompliances\x12;\n" +
	"\vupdate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\x12\x1e\n" +
	"\vlast_run_id\x18\x06 \x01(\tR\tlastRunId\x1a\xeb\f\n" +
	"\x12OSPolicyCompliance\x12 \n" +
	"\fos_policy_id\x18\x01 \x01(\tR\n" +
	"osPolicyId\x12\x85\x01\n" +
	"\x10compliance_state\x18\x02 \x01(\x0e2Z.google.cloud.osconfig.v1alpha.OSPolicyAssignmentReport.OSPolicyCompliance.ComplianceStateR\x0fcomplianceState\x126\n" +
	"\x17compliance_state_reason\x18\x03 \x01(\tR\x15complianceStateReason\x12\xaa\x01\n" +
	"\x1eos_policy_resource_compliances\x18\x04 \x03(\v2e.google.cloud.osconfig.v1alpha.OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceComplianceR\x1bosPolicyResourceCompliances\x1a\x83\t\n" +
	"\x1aOSPolicyResourceCompliance\x121\n" +
	"\x15os_policy_resource_id\x18\x01 \x01(\tR\x12osPolicyResourceId\x12\xa4\x01\n" +
	"\fconfig_steps\x18\x02 \x03(\v2\x80\x01.google.cloud.osconfig.v1alpha.OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.OSPolicyResourceConfigStepR\vconfigSteps\x12\xa0\x01\n" +
	"\x10compliance_state\x18\x03 \x01(\x0e2u.google.cloud.osconfig.v1alpha.OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.ComplianceStateR\x0fcomplianceState\x126\n" +
	"\x17compliance_state_reason\x18\x04 \x01(\tR\x15complianceStateReason\x12\xac\x01\n" +
	"\x14exec_resource_output\x18\x05 \x01(\v2x.google.cloud.osconfig.v1alpha.OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.ExecResourceOutputH\x00R\x12execResourceOutput\x1a\xef\x02\n" +
	"\x1aOSPolicyResourceConfigStep\x12\x9a\x01\n" +
	"\x04type\x18\x01 \x01(\x0e2\x85\x01.google.cloud.osconfig.v1alpha.OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.OSPolicyResourceConfigStep.TypeR\x04type\x12#\n" +
	...
	"$DESIRED_STATE_CHECK_POST_ENFORCEMENT\x10\x04\x1aC\n" +
	"\x12ExecResourceOutput\x12-\n" +
	"\x12enforcement_output\x18\x02 \x01(\fR\x11enforcementOutput\"@\n" +
	"\x0fComplianceState\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\r\n" +
	"\tCOMPLIANT\x10\x01\x12\x11\n" +
	"\rNON_COMPLIANT\x10\x02B\b\n" +
	"\x06output\"@\n" +
	"\x0fComplianceState\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\r\n" +
	"\tCOMPLIANT\x10\x01\x12\x11\n" +
	"\rNON_COMPLIANT\x10\x02:\x9c\x01\xeaA\x98\x01\n" +
	"0osconfig.googleapis.com/OSPolicyAssignmentReport\x12dprojects/{project}/locations/{location}/instances/{instance}/osPolicyAssignments/{assignment}/reportB\xfd\x02\xeaA\x92\x01\n" +
	...
	"!com.google.cloud.osconfig.v1alphaB\x1eOSPolicyAssignmentReportsProtoP\x01Z=cloud.google.com/go/osconfig/apiv1alpha/osconfigpb;osconfigpb\xaa\x02\x1dGoogle.Cloud.OsConfig.V1Alpha\xca\x02\x1dGoogle\\Cloud\\OsConfig\\V1alpha\xea\x02 Google::Cloud::OsConfig::V1alphab\x06proto3"

var (
	file_google_cloud_osconfig_v1alpha_os_policy_assignment_reports_proto_rawDescOnce sync.Once
	file_google_cloud_osconfig_v1alpha_os_policy_assignment_reports_proto_rawDescData []byte
)
...
func file_google_cloud_osconfig_v1alpha_os_policy_assignment_reports_proto_rawDescGZIP() []byte {
	file_google_cloud_osconfig_v1alpha_os_policy_assignment_reports_proto_rawDescOnce.Do(func() {
		file_google_cloud_osconfig_v1alpha_os_policy_assignment_reports_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_v1alpha_os_policy_assignment_reports_proto_rawDesc), len(file_google_cloud_osconfig_v1alpha_os_policy_assignment_reports_proto_rawDesc)))
	})
...
func file_google_cloud_osconfig_v1alpha_os_policy_assignment_reports_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_v1alpha_os_policy_assignment_reports_proto_rawDesc), len(file_google_cloud_osconfig_v1alpha_os_policy_assignment_reports_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
