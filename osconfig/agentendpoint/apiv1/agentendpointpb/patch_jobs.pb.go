...
const file_google_cloud_osconfig_agentendpoint_v1_patch_jobs_proto_rawDesc = "" +
	"\n" +
	"7google/cloud/osconfig/agentendpoint/v1/patch_jobs.proto\x12&google.cloud.osconfig.agentendpoint.v1\"\x80\a\n" +
	"\vPatchConfig\x12e\n" +
	"\rreboot_config\x18\x01 \x01(\x0e2@.google.cloud.osconfig.agentendpoint.v1.PatchConfig.RebootConfigR\frebootConfig\x12\\\n" +
	"\x0eretry_strategy\x18\x02 \x01(\v25.google.cloud.osconfig.agentendpoint.v1.RetryStrategyR\rretryStrategy\x12E\n" +
	"\x03apt\x18\x03 \x01(\v23.google.cloud.osconfig.agentendpoint.v1.AptSettingsR\x03apt\x12E\n" +
	"\x03yum\x18\x04 \x01(\v23.google.cloud.osconfig.agentendpoint.v1.YumSettingsR\x03yum\x12E\n" +
	"\x03goo\x18\x05 \x01(\v23.google.cloud.osconfig.agentendpoint.v1.GooSettingsR\x03goo\x12N\n" +
	"\x06zypper\x18\x06 \x01(\v26.google.cloud.osconfig.agentendpoint.v1.ZypperSettingsR\x06zypper\x12d\n" +
	"\x0ewindows_update\x18\a \x01(\v2=.google.cloud.osconfig.agentendpoint.v1.WindowsUpdateSettingsR\rwindowsUpdate\x12K\n" +
	"\bpre_step\x18\b \x01(\v20.google.cloud.osconfig.agentendpoint.v1.ExecStepR\apreStep\x12M\n" +
	"\tpost_step\x18\t \x01(\v20.google.cloud.osconfig.agentendpoint.v1.ExecStepR\bpostStep\x122\n" +
	...
	"\vAptSettings\x12L\n" +
	"\x04type\x18\x01 \x01(\x0e28.google.cloud.osconfig.agentendpoint.v1.AptSettings.TypeR\x04type\x12\x1a\n" +
	...
	"\x11exclusive_patches\x18\x06 \x03(\tR\x10exclusivePatches\"\x90\x03\n" +
	"\x15WindowsUpdateSettings\x12v\n" +
	"\x0fclassifications\x18\x01 \x03(\x0e2L.google.cloud.osconfig.agentendpoint.v1.WindowsUpdateSettings.ClassificationR\x0fclassifications\x12\x1a\n" +
	"\bexcludes\x18\x02 \x03(\tR\bexcludes\x12+\n" +
	...
	"\bExecStep\x12k\n" +
	"\x16linux_exec_step_config\x18\x01 \x01(\v26.google.cloud.osconfig.agentendpoint.v1.ExecStepConfigR\x13linuxExecStepConfig\x12o\n" +
	"\x18windows_exec_step_config\x18\x02 \x01(\v26.google.cloud.osconfig.agentendpoint.v1.ExecStepConfigR\x15windowsExecStepConfig\"\xfe\x02\n" +
	"\x0eExecStepConfig\x12\x1f\n" +
	"\n" +
	"local_path\x18\x01 \x01(\tH\x00R\tlocalPath\x12R\n" +
	"\n" +
	"gcs_object\x18\x02 \x01(\v21.google.cloud.osconfig.agentendpoint.v1.GcsObjectH\x00R\tgcsObject\x122\n" +
	"\x15allowed_success_codes\x18\x03 \x03(\x05R\x13allowedSuccessCodes\x12d\n" +
	"\vinterpreter\x18\x04 \x01(\x0e2B.google.cloud.osconfig.agentendpoint.v1.ExecStepConfig.InterpreterR\vinterpreter\"O\n" +
	...
	"\x11generation_number\x18\x03 \x01(\x03R\x10generationNumberB\x89\x01\n" +
...
var (
	...
	file_google_cloud_osconfig_agentendpoint_v1_patch_jobs_proto_rawDescData []byte
)
...
func file_google_cloud_osconfig_agentendpoint_v1_patch_jobs_proto_rawDescGZIP() []byte {
	file_google_cloud_osconfig_agentendpoint_v1_patch_jobs_proto_rawDescOnce.Do(func() {
		file_google_cloud_osconfig_agentendpoint_v1_patch_jobs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_agentendpoint_v1_patch_jobs_proto_rawDesc), len(file_google_cloud_osconfig_agentendpoint_v1_patch_jobs_proto_rawDesc)))
	})
...
func file_google_cloud_osconfig_agentendpoint_v1_patch_jobs_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_agentendpoint_v1_patch_jobs_proto_rawDesc), len(file_google_cloud_osconfig_agentendpoint_v1_patch_jobs_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
