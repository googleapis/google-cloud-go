...
const file_google_cloud_osconfig_agentendpoint_v1_inventory_proto_rawDesc = "" +
	"\n" +
	"6google/cloud/osconfig/agentendpoint/v1/inventory.proto\x12&google.cloud.osconfig.agentendpoint.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x16google/type/date.proto\"\xa2\x17\n" +
	"\tInventory\x12Q\n" +
	"\aos_info\x18\x01 \x01(\v28.google.cloud.osconfig.agentendpoint.v1.Inventory.OsInfoR\x06osInfo\x12p\n" +
	"\x12installed_packages\x18\x02 \x03(\v2A.google.cloud.osconfig.agentendpoint.v1.Inventory.SoftwarePackageR\x11installedPackages\x12p\n" +
	"\x12available_packages\x18\x03 \x03(\v2A.google.cloud.osconfig.agentendpoint.v1.Inventory.SoftwarePackageR\x11availablePackages\x1a\xa2\x02\n" +
	"\x06OsInfo\x12\x1a\n" +
	...
	"\x16osconfig_agent_version\x18\b \x01(\tR\x14osconfigAgentVersion\x1a\xeb\a\n" +
	"\x0fSoftwarePackage\x12e\n" +
	"\vyum_package\x18\x01 \x01(\v2B.google.cloud.osconfig.agentendpoint.v1.Inventory.VersionedPackageH\x00R\n" +
	"yumPackage\x12e\n" +
	"\vapt_package\x18\x02 \x01(\v2B.google.cloud.osconfig.agentendpoint.v1.Inventory.VersionedPackageH\x00R\n" +
	"aptPackage\x12k\n" +
	"\x0ezypper_package\x18\x03 \x01(\v2B.google.cloud.osconfig.agentendpoint.v1.Inventory.VersionedPackageH\x00R\rzypperPackage\x12k\n" +
	"\x0egooget_package\x18\x04 \x01(\v2B.google.cloud.osconfig.agentendpoint.v1.Inventory.VersionedPackageH\x00R\rgoogetPackage\x12b\n" +
	"\fzypper_patch\x18\x05 \x01(\v2=.google.cloud.osconfig.agentendpoint.v1.Inventory.ZypperPatchH\x00R\vzypperPatch\x12i\n" +
	"\vwua_package\x18\x06 \x01(\v2F.google.cloud.osconfig.agentendpoint.v1.Inventory.WindowsUpdatePackageH\x00R\n" +
	"wuaPackage\x12v\n" +
	"\vqfe_package\x18\a \x01(\v2S.google.cloud.osconfig.agentendpoint.v1.Inventory.WindowsQuickFixEngineeringPackageH\x00R\n" +
	"qfePackage\x12e\n" +
	"\vcos_package\x18\b \x01(\v2B.google.cloud.osconfig.agentendpoint.v1.Inventory.VersionedPackageH\x00R\n" +
	"cosPackage\x12w\n" +
	"\x13windows_application\x18\t \x01(\v2D.google.cloud.osconfig.agentendpoint.v1.Inventory.WindowsApplicationH\x00R\x12windowsApplicationB\t\n" +
	"\adetails\x1a\x9d\x02\n" +
	...
	"\x06source\x18\x04 \x01(\v2I.google.cloud.osconfig.agentendpoint.v1.Inventory.VersionedPackage.SourceB\x03\xe0A\x01R\x06source\x1a@\n" +
	"\x06Source\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x12\x1d\n" +
	"\aversion\x18\x02 \x01(\tB\x03\xe0A\x01R\aversion\x1a~\n" +
	...
	"\asummary\x18\x04 \x01(\tR\asummary\x1a\x97\x04\n" +
	"\x14WindowsUpdatePackage\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12|\n" +
	"\n" +
	"categories\x18\x03 \x03(\v2\\.google.cloud.osconfig.agentendpoint.v1.Inventory.WindowsUpdatePackage.WindowsUpdateCategoryR\n" +
	"categories\x12$\n" +
	"\x0ekb_article_ids\x18\x04 \x03(\tR\fkbArticleIds\x12\x1f\n" +
	"\vsupport_url\x18\x05 \x01(\tR\n" +
	"supportUrl\x12$\n" +
	"\x0emore_info_urls\x18\x06 \x03(\tR\fmoreInfoUrls\x12\x1b\n" +
	"\tupdate_id\x18\a \x01(\tR\bupdateId\x12'\n" +
	"\x0frevision_number\x18\b \x01(\x05R\x0erevisionNumber\x12Y\n" +
	"\x1blast_deployment_change_time\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\x18lastDeploymentChangeTime\x1a;\n" +
	...
	"\finstall_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\vinstallTime\x1a\xd1\x01\n" +
	...
	"\thelp_link\x18\x05 \x01(\tR\bhelpLinkB\x90\x01\n" +
...
var (
	...
	file_google_cloud_osconfig_agentendpoint_v1_inventory_proto_rawDescData []byte
)
...
func file_google_cloud_osconfig_agentendpoint_v1_inventory_proto_rawDescGZIP() []byte {
	file_google_cloud_osconfig_agentendpoint_v1_inventory_proto_rawDescOnce.Do(func() {
		file_google_cloud_osconfig_agentendpoint_v1_inventory_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_agentendpoint_v1_inventory_proto_rawDesc), len(file_google_cloud_osconfig_agentendpoint_v1_inventory_proto_rawDesc)))
	})
...
func file_google_cloud_osconfig_agentendpoint_v1_inventory_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_agentendpoint_v1_inventory_proto_rawDesc), len(file_google_cloud_osconfig_agentendpoint_v1_inventory_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
