...
const file_google_cloud_osconfig_agentendpoint_v1beta_patch_jobs_proto_rawDesc = "" +
	"\n" +
	";google/cloud/osconfig/agentendpoint/v1beta/patch_jobs.proto\x12*google.cloud.osconfig.agentendpoint.v1beta\"\xa4\a\n" +
	"\vPatchConfig\x12i\n" +
	"\rreboot_config\x18\x01 \x01(\x0e2D.google.cloud.osconfig.agentendpoint.v1beta.PatchConfig.RebootConfigR\frebootConfig\x12`\n" +
	"\x0eretry_strategy\x18\x02 \x01(\v29.google.cloud.osconfig.agentendpoint.v1beta.RetryStrategyR\rretryStrategy\x12I\n" +
	"\x03apt\x18\x03 \x01(\v27.google.cloud.osconfig.agentendpoint.v1beta.AptSettingsR\x03apt\x12I\n" +
	"\x03yum\x18\x04 \x01(\v27.google.cloud.osconfig.agentendpoint.v1beta.YumSettingsR\x03yum\x12I\n" +
	"\x03goo\x18\x05 \x01(\v27.google.cloud.osconfig.agentendpoint.v1beta.GooSettingsR\x03goo\x12R\n" +
	"\x06zypper\x18\x06 \x01(\v2:.google.cloud.osconfig.agentendpoint.v1beta.ZypperSettingsR\x06zypper\x12h\n" +
	"\x0ewindows_update\x18\a \x01(\v2A.google.cloud.osconfig.agentendpoint.v1beta.WindowsUpdateSettingsR\rwindowsUpdate\x12O\n" +
	"\bpre_step\x18\b \x01(\v24.google.cloud.osconfig.agentendpoint.v1beta.ExecStepR\apreStep\x12Q\n" +
	"\tpost_step\x18\t \x01(\v24.google.cloud.osconfig.agentendpoint.v1beta.ExecStepR\bpostStep\x122\n" +
	...
	"\vAptSettings\x12P\n" +
	"\x04type\x18\x01 \x01(\x0e2<.google.cloud.osconfig.agentendpoint.v1beta.AptSettings.TypeR\x04type\x12\x1a\n" +
	...
	"\x11exclusive_patches\x18\x06 \x03(\tR\x10exclusivePatches\"\x94\x03\n" +
	"\x15WindowsUpdateSettings\x12z\n" +
	"\x0fclassifications\x18\x01 \x03(\x0e2P.google.cloud.osconfig.agentendpoint.v1beta.WindowsUpdateSettings.ClassificationR\x0fclassifications\x12\x1a\n" +
	"\bexcludes\x18\x02 \x03(\tR\bexcludes\x12+\n" +
	...
	"\bExecStep\x12o\n" +
	"\x16linux_exec_step_config\x18\x01 \x01(\v2:.google.cloud.osconfig.agentendpoint.v1beta.ExecStepConfigR\x13linuxExecStepConfig\x12s\n" +
	"\x18windows_exec_step_config\x18\x02 \x01(\v2:.google.cloud.osconfig.agentendpoint.v1beta.ExecStepConfigR\x15windowsExecStepConfig\"\x86\x03\n" +
	"\x0eExecStepConfig\x12\x1f\n" +
	"\n" +
	"local_path\x18\x01 \x01(\tH\x00R\tlocalPath\x12V\n" +
	"\n" +
	"gcs_object\x18\x02 \x01(\v25.google.cloud.osconfig.agentendpoint.v1beta.GcsObjectH\x00R\tgcsObject\x122\n" +
	"\x15allowed_success_codes\x18\x03 \x03(\x05R\x13allowedSuccessCodes\x12h\n" +
	"\vinterpreter\x18\x04 \x01(\x0e2F.google.cloud.osconfig.agentendpoint.v1beta.ExecStepConfig.InterpreterR\vinterpreter\"O\n" +
	...
	"\x11generation_number\x18\x03 \x01(\x03R\x10generationNumberB\xb0\x01\n" +
...
var (
	...
	file_google_cloud_osconfig_agentendpoint_v1beta_patch_jobs_proto_rawDescData []byte
)
...
func file_google_cloud_osconfig_agentendpoint_v1beta_patch_jobs_proto_rawDescGZIP() []byte {
	file_google_cloud_osconfig_agentendpoint_v1beta_patch_jobs_proto_rawDescOnce.Do(func() {
		file_google_cloud_osconfig_agentendpoint_v1beta_patch_jobs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_agentendpoint_v1beta_patch_jobs_proto_rawDesc), len(file_google_cloud_osconfig_agentendpoint_v1beta_patch_jobs_proto_rawDesc)))
	})
...
var file_google_cloud_osconfig_agentendpoint_v1beta_patch_jobs_proto_goTypes = []any{
...
func file_google_cloud_osconfig_agentendpoint_v1beta_patch_jobs_proto_init() {
	...
	file_google_cloud_osconfig_agentendpoint_v1beta_patch_jobs_proto_msgTypes[8].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_agentendpoint_v1beta_patch_jobs_proto_rawDesc), len(file_google_cloud_osconfig_agentendpoint_v1beta_patch_jobs_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
