...
const file_google_cloud_osconfig_agentendpoint_v1beta_tasks_proto_rawDesc = "" +
	"\n" +
	...
	"\x04Task\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12Q\n" +
	"\ttask_type\x18\x02 \x01(\x0e24.google.cloud.osconfig.agentendpoint.v1beta.TaskTypeR\btaskType\x12`\n" +
	"\x0etask_directive\x18\x03 \x01(\x0e29.google.cloud.osconfig.agentendpoint.v1beta.TaskDirectiveR\rtaskDirective\x12l\n" +
	"\x12apply_patches_task\x18\x04 \x01(\v2<.google.cloud.osconfig.agentendpoint.v1beta.ApplyPatchesTaskH\x00R\x10applyPatchesTask\x12`\n" +
	"\x0eexec_step_task\x18\x05 \x01(\v28.google.cloud.osconfig.agentendpoint.v1beta.ExecStepTaskH\x00R\fexecStepTask\x12j\n" +
	"\x0eservice_labels\x18\x06 \x03(\v2C.google.cloud.osconfig.agentendpoint.v1beta.Task.ServiceLabelsEntryR\rserviceLabels\x1a@\n" +
	"\x12ServiceLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x0e\n" +
	"\ftask_details\"\x87\x01\n" +
	"\x10ApplyPatchesTask\x12Z\n" +
	"\fpatch_config\x18\x01 \x01(\v27.google.cloud.osconfig.agentendpoint.v1beta.PatchConfigR\vpatchConfig\x12\x17\n" +
	"\adry_run\x18\x03 \x01(\bR\x06dryRun\"\xec\x01\n" +
	"\x18ApplyPatchesTaskProgress\x12e\n" +
	"\x05state\x18\x01 \x01(\x0e2J.google.cloud.osconfig.agentendpoint.v1beta.ApplyPatchesTaskProgress.StateB\x03\xe0A\x02R\x05state\"i\n" +
	"\x05State\x12\x15\n" +
	...
	"\tREBOOTING\x10\x03\"\xd7\x01\n" +
	"\x16ApplyPatchesTaskOutput\x12c\n" +
	"\x05state\x18\x01 \x01(\x0e2H.google.cloud.osconfig.agentendpoint.v1beta.ApplyPatchesTaskOutput.StateB\x03\xe0A\x02R\x05state\"X\n" +
	"\x05State\x12\x15\n" +
	...
	"\x06FAILED\x10\x03\"a\n" +
	"\fExecStepTask\x12Q\n" +
	"\texec_step\x18\x01 \x01(\v24.google.cloud.osconfig.agentendpoint.v1beta.ExecStepR\bexecStep\"\xa6\x01\n" +
	"\x14ExecStepTaskProgress\x12a\n" +
	"\x05state\x18\x01 \x01(\x0e2F.google.cloud.osconfig.agentendpoint.v1beta.ExecStepTaskProgress.StateB\x03\xe0A\x02R\x05state\"+\n" +
	"\x05State\x12\x15\n" +
	"\x11STATE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aSTARTED\x10\x01\"\xe4\x01\n" +
	"\x12ExecStepTaskOutput\x12_\n" +
	"\x05state\x18\x01 \x01(\x0e2D.google.cloud.osconfig.agentendpoint.v1beta.ExecStepTaskOutput.StateB\x03\xe0A\x02R\x05state\x12 \n" +
...
var (
	...
	file_google_cloud_osconfig_agentendpoint_v1beta_tasks_proto_rawDescData []byte
)
...
func file_google_cloud_osconfig_agentendpoint_v1beta_tasks_proto_rawDescGZIP() []byte {
	file_google_cloud_osconfig_agentendpoint_v1beta_tasks_proto_rawDescOnce.Do(func() {
		file_google_cloud_osconfig_agentendpoint_v1beta_tasks_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_agentendpoint_v1beta_tasks_proto_rawDesc), len(file_google_cloud_osconfig_agentendpoint_v1beta_tasks_proto_rawDesc)))
	})
...
var file_google_cloud_osconfig_agentendpoint_v1beta_tasks_proto_goTypes = []any{
...
func file_google_cloud_osconfig_agentendpoint_v1beta_tasks_proto_init() {
	...
	file_google_cloud_osconfig_agentendpoint_v1beta_tasks_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_agentendpoint_v1beta_tasks_proto_rawDesc), len(file_google_cloud_osconfig_agentendpoint_v1beta_tasks_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
