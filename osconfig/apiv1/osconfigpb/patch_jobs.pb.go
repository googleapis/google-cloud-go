...
const file_google_cloud_osconfig_v1_patch_jobs_proto_rawDesc = "" +
	"\n" +
	")google/cloud/osconfig/v1/patch_jobs.proto\x12\x18google.cloud.osconfig.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a.google/cloud/osconfig/v1/osconfig_common.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe3\x03\n" +
	...
	"\x0finstance_filter\x18\a \x01(\v2-.google.cloud.osconfig.v1.PatchInstanceFilterB\x03\xe0A\x02R\x0einstanceFilter\x12H\n" +
	"\fpatch_config\x18\x04 \x01(\v2%.google.cloud.osconfig.v1.PatchConfigR\vpatchConfig\x125\n" +
	...
	"\arollout\x18\t \x01(\v2&.google.cloud.osconfig.v1.PatchRolloutR\arollout\"R\n" +
	"\x12GetPatchJobRequest\x12<\n" +
	"\x04name\x18\x01 \x01(\tB(\xe0A\x02\xfaA\"\n" +
	" osconfig.googleapis.com/PatchJobR\x04name\"\xba\x01\n" +
	"\"ListPatchJobInstanceDetailsRequest\x12@\n" +
	"\x06parent\x18\x01 \x01(\tB(\xe0A\x02\xfaA\"\n" +
	" osconfig.googleapis.com/PatchJobR\x06parent\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken\x12\x16\n" +
	"\x06filter\x18\x04 \x01(\tR\x06filter\"\xbd\x01\n" +
	"#ListPatchJobInstanceDetailsResponse\x12n\n" +
	"\x1apatch_job_instance_details\x18\x01 \x03(\v21.google.cloud.osconfig.v1.PatchJobInstanceDetailsR\x17patchJobInstanceDetails\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\x92\x02\n" +
	"\x17PatchJobInstanceDetails\x128\n" +
	"\x04name\x18\x01 \x01(\tB$\xfaA!\n" +
	"\x1fcompute.googleapis.com/InstanceR\x04name\x12,\n" +
	"\x12instance_system_id\x18\x02 \x01(\tR\x10instanceSystemId\x12C\n" +
	"\x05state\x18\x03 \x01(\x0e2-.google.cloud.osconfig.v1.Instance.PatchStateR\x05state\x12%\n" +
	"\x0efailure_reason\x18\x04 \x01(\tR\rfailureReason\x12#\n" +
	"\rattempt_count\x18\x05 \x01(\x03R\fattemptCount\"\xb7\x01\n" +
	...
	"\n" +
	"patch_jobs\x18\x01 \x03(\v2\".google.cloud.osconfig.v1.PatchJobR\tpatchJobs\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\x9f\x10\n" +
	"\bPatchJob\x12\x12\n" +
	...
	"updateTime\x12>\n" +
	"\x05state\x18\x05 \x01(\x0e2(.google.cloud.osconfig.v1.PatchJob.StateR\x05state\x12V\n" +
	"\x0finstance_filter\x18\r \x01(\v2-.google.cloud.osconfig.v1.PatchInstanceFilterR\x0einstanceFilter\x12H\n" +
	"\fpatch_config\x18\a \x01(\v2%.google.cloud.osconfig.v1.PatchConfigR\vpatchConfig\x125\n" +
	"\bduration\x18\b \x01(\v2\x19.google.protobuf.DurationR\bduration\x12s\n" +
	"\x18instance_details_summary\x18\t \x01(\v29.google.cloud.osconfig.v1.PatchJob.InstanceDetailsSummaryR\x16instanceDetailsSummary\x12\x17\n" +
	"\adry_run\x18\n" +
	" \x01(\bR\x06dryRun\x12#\n" +
	"\rerror_message\x18\v \x01(\tR\ferrorMessage\x12)\n" +
	"\x10percent_complete\x18\f \x01(\x01R\x0fpercentComplete\x12Z\n" +
	"\x10patch_deployment\x18\x0f \x01(\tB/\xe0A\x03\xfaA)\n" +
	"'osconfig.googleapis.com/PatchDeploymentR\x0fpatchDeployment\x12@\n" +
	"\arollout\x18\x10 \x01(\v2&.google.cloud.osconfig.v1.PatchRolloutR\arollout\x1a\xc1\a\n" +
	...
	" osconfig.googleapis.com/PatchJob\x12(projects/{project}/patchJobs/{patch_job}\"\xb2\x05\n" +
	"\vPatchConfig\x12W\n" +
	"\rreboot_config\x18\x01 \x01(\x0e22.google.cloud.osconfig.v1.PatchConfig.RebootConfigR\frebootConfig\x127\n" +
	"\x03apt\x18\x03 \x01(\v2%.google.cloud.osconfig.v1.AptSettingsR\x03apt\x127\n" +
	"\x03yum\x18\x04 \x01(\v2%.google.cloud.osconfig.v1.YumSettingsR\x03yum\x127\n" +
	"\x03goo\x18\x05 \x01(\v2%.google.cloud.osconfig.v1.GooSettingsR\x03goo\x12@\n" +
	"\x06zypper\x18\x06 \x01(\v2(.google.cloud.osconfig.v1.ZypperSettingsR\x06zypper\x12V\n" +
	"\x0ewindows_update\x18\a \x01(\v2/.google.cloud.osconfig.v1.WindowsUpdateSettingsR\rwindowsUpdate\x12=\n" +
	"\bpre_step\x18\b \x01(\v2\".google.cloud.osconfig.v1.ExecStepR\apreStep\x12?\n" +
	"\tpost_step\x18\t \x01(\v2\".google.cloud.osconfig.v1.ExecStepR\bpostStep\x122\n" +
	...
	"\vAptSettings\x12>\n" +
	"\x04type\x18\x01 \x01(\x0e2*.google.cloud.osconfig.v1.AptSettings.TypeR\x04type\x12\x1a\n" +
	...
	"\x11exclusive_patches\x18\x06 \x03(\tR\x10exclusivePatches\"\x82\x03\n" +
	"\x15WindowsUpdateSettings\x12h\n" +
	"\x0fclassifications\x18\x01 \x03(\x0e2>.google.cloud.osconfig.v1.WindowsUpdateSettings.ClassificationR\x0fclassifications\x12\x1a\n" +
	"\bexcludes\x18\x02 \x03(\tR\bexcludes\x12+\n" +
	...
	"\bExecStep\x12]\n" +
	"\x16linux_exec_step_config\x18\x01 \x01(\v2(.google.cloud.osconfig.v1.ExecStepConfigR\x13linuxExecStepConfig\x12a\n" +
	"\x18windows_exec_step_config\x18\x02 \x01(\v2(.google.cloud.osconfig.v1.ExecStepConfigR\x15windowsExecStepConfig\"\xd8\x02\n" +
	"\x0eExecStepConfig\x12\x1f\n" +
	"\n" +
	"local_path\x18\x01 \x01(\tH\x00R\tlocalPath\x12D\n" +
	"\n" +
	"gcs_object\x18\x02 \x01(\v2#.google.cloud.osconfig.v1.GcsObjectH\x00R\tgcsObject\x122\n" +
	"\x15allowed_success_codes\x18\x03 \x03(\x05R\x13allowedSuccessCodes\x12V\n" +
	"\vinterpreter\x18\x04 \x01(\x0e24.google.cloud.osconfig.v1.ExecStepConfig.InterpreterR\vinterpreter\"E\n" +
	...
	"\x11generation_number\x18\x03 \x01(\x03B\x03\xe0A\x02R\x10generationNumber\"\x96\x03\n" +
	"\x13PatchInstanceFilter\x12\x10\n" +
	"\x03all\x18\x01 \x01(\bR\x03all\x12[\n" +
	"\fgroup_labels\x18\x02 \x03(\v28.google.cloud.osconfig.v1.PatchInstanceFilter.GroupLabelR\vgroupLabels\x12\x14\n" +
	...
	"\n" +
	"GroupLabel\x12\\\n" +
	"\x06labels\x18\x01 \x03(\v2D.google.cloud.osconfig.v1.PatchInstanceFilter.GroupLabel.LabelsEntryR\x06labels\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xec\x01\n" +
	"\fPatchRollout\x12?\n" +
	"\x04mode\x18\x01 \x01(\x0e2+.google.cloud.osconfig.v1.PatchRollout.ModeR\x04mode\x12U\n" +
	"\x11disruption_budget\x18\x02 \x01(\v2(.google.cloud.osconfig.v1.FixedOrPercentR\x10disruptionBudget\"D\n" +
	"\x04Mode\x12\x14\n" +
...
var (
	...
	file_google_cloud_osconfig_v1_patch_jobs_proto_rawDescData []byte
)
...
func file_google_cloud_osconfig_v1_patch_jobs_proto_rawDescGZIP() []byte {
	file_google_cloud_osconfig_v1_patch_jobs_proto_rawDescOnce.Do(func() {
		file_google_cloud_osconfig_v1_patch_jobs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_v1_patch_jobs_proto_rawDesc), len(file_google_cloud_osconfig_v1_patch_jobs_proto_rawDesc)))
	})
...
var file_google_cloud_osconfig_v1_patch_jobs_proto_goTypes = []any{
...
func file_google_cloud_osconfig_v1_patch_jobs_proto_init() {
	...
	file_google_cloud_osconfig_v1_patch_jobs_proto_msgTypes[17].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_v1_patch_jobs_proto_rawDesc), len(file_google_cloud_osconfig_v1_patch_jobs_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   24,
			NumExtensions: 0,
			NumServices:   0,
