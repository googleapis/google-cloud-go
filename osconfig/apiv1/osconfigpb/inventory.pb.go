...
const file_google_cloud_osconfig_v1_inventory_proto_rawDesc = "" +
	"\n" +
	"(google/cloud/osconfig/v1/inventory.proto\x12\x18google.cloud.osconfig.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x16google/type/date.proto\"\xfa\x1a\n" +
	"\tInventory\x12\x17\n" +
	"\x04name\x18\x03 \x01(\tB\x03\xe0A\x03R\x04name\x12C\n" +
	"\aos_info\x18\x01 \x01(\v2*.google.cloud.osconfig.v1.Inventory.OsInfoR\x06osInfo\x12D\n" +
	"\x05items\x18\x02 \x03(\v2..google.cloud.osconfig.v1.Inventory.ItemsEntryR\x05items\x12@\n" +
	...
	"\x16osconfig_agent_version\x18\b \x01(\tR\x14osconfigAgentVersion\x1a\x89\x05\n" +
	"\x04Item\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12T\n" +
	"\vorigin_type\x18\x02 \x01(\x0e23.google.cloud.osconfig.v1.Inventory.Item.OriginTypeR\n" +
	"originType\x12;\n" +
	"\vcreate_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x12;\n" +
	"\vupdate_time\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\x12A\n" +
	"\x04type\x18\x05 \x01(\x0e2-.google.cloud.osconfig.v1.Inventory.Item.TypeR\x04type\x12b\n" +
	"\x11installed_package\x18\x06 \x01(\v23.google.cloud.osconfig.v1.Inventory.SoftwarePackageH\x00R\x10installedPackage\x12b\n" +
	"\x11available_package\x18\a \x01(\v23.google.cloud.osconfig.v1.Inventory.SoftwarePackageH\x00R\x10availablePackage\"?\n" +
	"\n" +
	"OriginType\x12\x1b\n" +
	...
	"\adetails\x1a\xed\x06\n" +
	"\x0fSoftwarePackage\x12W\n" +
	"\vyum_package\x18\x01 \x01(\v24.google.cloud.osconfig.v1.Inventory.VersionedPackageH\x00R\n" +
	"yumPackage\x12W\n" +
	"\vapt_package\x18\x02 \x01(\v24.google.cloud.osconfig.v1.Inventory.VersionedPackageH\x00R\n" +
	"aptPackage\x12]\n" +
	"\x0ezypper_package\x18\x03 \x01(\v24.google.cloud.osconfig.v1.Inventory.VersionedPackageH\x00R\rzypperPackage\x12]\n" +
	"\x0egooget_package\x18\x04 \x01(\v24.google.cloud.osconfig.v1.Inventory.VersionedPackageH\x00R\rgoogetPackage\x12T\n" +
	"\fzypper_patch\x18\x05 \x01(\v2/.google.cloud.osconfig.v1.Inventory.ZypperPatchH\x00R\vzypperPatch\x12[\n" +
	"\vwua_package\x18\x06 \x01(\v28.google.cloud.osconfig.v1.Inventory.WindowsUpdatePackageH\x00R\n" +
	"wuaPackage\x12h\n" +
	"\vqfe_package\x18\a \x01(\v2E.google.cloud.osconfig.v1.Inventory.WindowsQuickFixEngineeringPackageH\x00R\n" +
	"qfePackage\x12W\n" +
	"\vcos_package\x18\b \x01(\v24.google.cloud.osconfig.v1.Inventory.VersionedPackageH\x00R\n" +
	"cosPackage\x12i\n" +
	"\x13windows_application\x18\t \x01(\v26.google.cloud.osconfig.v1.Inventory.WindowsApplicationH\x00R\x12windowsApplicationB\t\n" +
	"\adetails\x1as\n" +
	...
	"\asummary\x18\x04 \x01(\tR\asummary\x1a\x89\x04\n" +
	"\x14WindowsUpdatePackage\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12n\n" +
	"\n" +
	"categories\x18\x03 \x03(\v2N.google.cloud.osconfig.v1.Inventory.WindowsUpdatePackage.WindowsUpdateCategoryR\n" +
	"categories\x12$\n" +
	...
	"\thelp_link\x18\x05 \x01(\tR\bhelpLink\x1ab\n" +
	"\n" +
	"ItemsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12>\n" +
	"\x05value\x18\x02 \x01(\v2(.google.cloud.osconfig.v1.Inventory.ItemR\x05value:\x028\x01:n\xeaAk\n" +
	"!osconfig.googleapis.com/Inventory\x12Fprojects/{project}/locations/{location}/instances/{instance}/inventory\"\x91\x01\n" +
	"\x13GetInventoryRequest\x12=\n" +
	"\x04name\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!osconfig.googleapis.com/InventoryR\x04name\x12;\n" +
	"\x04view\x18\x02 \x01(\x0e2'.google.cloud.osconfig.v1.InventoryViewR\x04view\"\xea\x01\n" +
	"\x16ListInventoriesRequest\x12?\n" +
	"\x06parent\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\n" +
	"\x1fcompute.googleapis.com/InstanceR\x06parent\x12;\n" +
	"\x04view\x18\x02 \x01(\x0e2'.google.cloud.osconfig.v1.InventoryViewR\x04view\x12\x1b\n" +
	"\tpage_size\x18\x03 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x04 \x01(\tR\tpageToken\x12\x16\n" +
	"\x06filter\x18\x05 \x01(\tR\x06filter\"\x88\x01\n" +
	"\x17ListInventoriesResponse\x12E\n" +
	"\vinventories\x18\x01 \x03(\v2#.google.cloud.osconfig.v1.InventoryR\vinventories\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken*D\n" +
	"\rInventoryView\x12\x1e\n" +
	"\x1aINVENTORY_VIEW_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05BASIC\x10\x01\x12\b\n" +
	"\x04FULL\x10\x02B\xbb\x01\n" +
	"\x1ccom.google.cloud.osconfig.v1B\vInventoriesP\x01Z8cloud.google.com/go/osconfig/apiv1/osconfigpb;osconfigpb\xaa\x02\x18Google.Cloud.OsConfig.V1\xca\x02\x18Google\\Cloud\\OsConfig\\V1\xea\x02\x1bGoogle::Cloud::OsConfig::V1b\x06proto3"

var (
	file_google_cloud_osconfig_v1_inventory_proto_rawDescOnce sync.Once
	file_google_cloud_osconfig_v1_inventory_proto_rawDescData []byte
)
...
func file_google_cloud_osconfig_v1_inventory_proto_rawDescGZIP() []byte {
	file_google_cloud_osconfig_v1_inventory_proto_rawDescOnce.Do(func() {
		file_google_cloud_osconfig_v1_inventory_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_v1_inventory_proto_rawDesc), len(file_google_cloud_osconfig_v1_inventory_proto_rawDesc)))
	})
...
var file_google_cloud_osconfig_v1_inventory_proto_goTypes = []any{
...
func file_google_cloud_osconfig_v1_inventory_proto_init() {
	...
	file_google_cloud_osconfig_v1_inventory_proto_msgTypes[5].OneofWrappers = []any{
		(*Inventory_Item_InstalledPackage)(nil),
		(*Inventory_Item_AvailablePackage)(nil),
	}
	file_google_cloud_osconfig_v1_inventory_proto_msgTypes[6].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_v1_inventory_proto_rawDesc), len(file_google_cloud_osconfig_v1_inventory_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
