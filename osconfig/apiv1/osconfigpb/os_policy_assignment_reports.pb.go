...
const file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_rawDesc = "" +
	"\n" +
	";google/cloud/osconfig/v1/os_policy_assignment_reports.proto\x12\x18google.cloud.osconfig.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"r\n" +
	"\"GetOSPolicyAssignmentReportRequest\x12L\n" +
	"\x04name\x18\x01 \x01(\tB8\xe0A\x02\xfaA2\n" +
	"0osconfig.googleapis.com/OSPolicyAssignmentReportR\x04name\"\xce\x01\n" +
	...
	"\x1cos_policy_assignment_reports\x18\x01 \x03(\v22.google.cloud.osconfig.v1.OSPolicyAssignmentReportR\x19osPolicyAssignmentReports\x12&\n" +
	...
	"\x15os_policy_compliances\x18\x04 \x03(\v2E.google.cloud.osconfig.v1.OSPolicyAssignmentReport.OSPolicyComplianceR\x13osPolicyCompliances\x12;\n" +
	"\vupdate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\x12\x1e\n" +
	"\vlast_run_id\x18\x06 \x01(\tR\tlastRunId\x1a\xcc\f\n" +
	"\x12OSPolicyCompliance\x12 \n" +
	"\fos_policy_id\x18\x01 \x01(\tR\n" +
	"osPolicyId\x12\x80\x01\n" +
	"\x10compliance_state\x18\x02 \x01(\x0e2U.google.cloud.osconfig.v1.OSPolicyAssignmentReport.OSPolicyCompliance.ComplianceStateR\x0fcomplianceState\x126\n" +
	"\x17compliance_state_reason\x18\x03 \x01(\tR\x15complianceStateReason\x12\xa5\x01\n" +
	"\x1eos_policy_resource_compliances\x18\x04 \x03(\v2`.google.cloud.osconfig.v1.OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceComplianceR\x1bosPolicyResourceCompliances\x1a\xee\b\n" +
	"\x1aOSPolicyResourceCompliance\x121\n" +
	"\x15os_policy_resource_id\x18\x01 \x01(\tR\x12osPolicyResourceId\x12\x9e\x01\n" +
	"\fconfig_steps\x18\x02 \x03(\v2{.google.cloud.osconfig.v1.OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.OSPolicyResourceConfigStepR\vconfigSteps\x12\x9b\x01\n" +
	"\x10compliance_state\x18\x03 \x01(\x0e2p.google.cloud.osconfig.v1.OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.ComplianceStateR\x0fcomplianceState\x126\n" +
	"\x17compliance_state_reason\x18\x04 \x01(\tR\x15complianceStateReason\x12\xa7\x01\n" +
	"\x14exec_resource_output\x18\x05 \x01(\v2s.google.cloud.osconfig.v1.OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.ExecResourceOutputH\x00R\x12execResourceOutput\x1a\xea\x02\n" +
	"\x1aOSPolicyResourceConfigStep\x12\x95\x01\n" +
	"\x04type\x18\x01 \x01(\x0e2\x80\x01.google.cloud.osconfig.v1.OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.OSPolicyResourceConfigStep.TypeR\x04type\x12#\n" +
	...
	"0osconfig.googleapis.com/OSPolicyAssignmentReport\x12dprojects/{project}/locations/{location}/instances/{instance}/osPolicyAssignments/{assignment}/reportB\xe5\x02\xeaA\x93\x01\n" +
	...
	"\x1ccom.google.cloud.osconfig.v1B\x1eOSPolicyAssignmentReportsProtoP\x01Z8cloud.google.com/go/osconfig/apiv1/osconfigpb;osconfigpb\xaa\x02\x18Google.Cloud.OsConfig.V1\xca\x02\x18Google\\Cloud\\OsConfig\\V1\xea\x02\x1bGoogle::Cloud::OsConfig::V1b\x06proto3"

var (
	file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_rawDescOnce sync.Once
	file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_rawDescData []byte
)
...
func file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_rawDescGZIP() []byte {
	file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_rawDescOnce.Do(func() {
		file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_rawDesc), len(file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_rawDesc)))
	})
...
var file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_goTypes = []any{
...
func file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_init() {
	...
	file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_msgTypes[5].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_rawDesc), len(file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
