...
var file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x42, 0xe5, 0x02, 0xea, 0x41, 0x93, 0x01, 0x0a, 0x32, 0x6f,
	...
	0x75, 0x64, 0x2e, 0x6f, 0x73, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x76, 0x31, 0x42, 0x1e,
...
func file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_google_cloud_osconfig_v1_os_policy_assignment_reports_proto_msgTypes[7].Exporter = func(v any, i int) any {
