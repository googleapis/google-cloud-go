...
func file_google_cloud_osconfig_v1beta_patch_deployments_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_osconfig_v1beta_patch_deployments_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_osconfig_v1beta_patch_deployments_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_osconfig_v1beta_patch_deployments_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
