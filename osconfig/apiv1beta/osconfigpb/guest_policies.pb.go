...
const file_google_cloud_osconfig_v1beta_guest_policies_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/osconfig/v1beta/guest_policies.proto\x12\x1cgoogle.cloud.osconfig.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf9\x04\n" +
	"\vGuestPolicy\x12\x17\n" +
	...
	"updateTime\x12M\n" +
	"\n" +
	"assignment\x18\x06 \x01(\v2(.google.cloud.osconfig.v1beta.AssignmentB\x03\xe0A\x02R\n" +
	"assignment\x12A\n" +
	"\bpackages\x18\a \x03(\v2%.google.cloud.osconfig.v1beta.PackageR\bpackages\x12b\n" +
	"\x14package_repositories\x18\b \x03(\v2/.google.cloud.osconfig.v1beta.PackageRepositoryR\x13packageRepositories\x12F\n" +
	"\arecipes\x18\t \x03(\v2,.google.cloud.osconfig.v1beta.SoftwareRecipeR\arecipes\x12\x12\n" +
	"\x04etag\x18\n" +
	" \x01(\tR\x04etag:Y\xeaAV\n" +
	"#osconfig.googleapis.com/GuestPolicy\x12/projects/{project}/guestPolicies/{guest_policy}\"\xb3\x04\n" +
	"\n" +
	"Assignment\x12V\n" +
	"\fgroup_labels\x18\x01 \x03(\v23.google.cloud.osconfig.v1beta.Assignment.GroupLabelR\vgroupLabels\x12\x14\n" +
	"\x05zones\x18\x02 \x03(\tR\x05zones\x12\x1c\n" +
	"\tinstances\x18\x03 \x03(\tR\tinstances\x124\n" +
	"\x16instance_name_prefixes\x18\x04 \x03(\tR\x14instanceNamePrefixes\x12J\n" +
	"\bos_types\x18\x05 \x03(\v2/.google.cloud.osconfig.v1beta.Assignment.OsTypeR\aosTypes\x1a\xa0\x01\n" +
	"\n" +
	"GroupLabel\x12W\n" +
	"\x06labels\x18\x01 \x03(\v2?.google.cloud.osconfig.v1beta.Assignment.GroupLabel.LabelsEntryR\x06labels\x1a9\n" +
	...
	"\x0fos_architecture\x18\x03 \x01(\tR\x0eosArchitecture\"\x90\x02\n" +
	"\aPackage\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x12O\n" +
	"\rdesired_state\x18\x02 \x01(\x0e2*.google.cloud.osconfig.v1beta.DesiredStateR\fdesiredState\x12G\n" +
	"\amanager\x18\x03 \x01(\x0e2-.google.cloud.osconfig.v1beta.Package.ManagerR\amanager\"R\n" +
	"\aManager\x12\x17\n" +
	...
	"\x03GOO\x10\x05\"\xac\x02\n" +
	"\rAptRepository\x12Z\n" +
	"\farchive_type\x18\x01 \x01(\x0e27.google.cloud.osconfig.v1beta.AptRepository.ArchiveTypeR\varchiveType\x12\x15\n" +
	...
	"\bgpg_keys\x18\x04 \x03(\tR\agpgKeys\"\x85\x01\n" +
	...
	"\x03url\x18\x02 \x01(\tB\x03\xe0A\x02R\x03url\"\xae\x02\n" +
	"\x11PackageRepository\x12?\n" +
	"\x03apt\x18\x01 \x01(\v2+.google.cloud.osconfig.v1beta.AptRepositoryH\x00R\x03apt\x12?\n" +
	"\x03yum\x18\x02 \x01(\v2+.google.cloud.osconfig.v1beta.YumRepositoryH\x00R\x03yum\x12H\n" +
	"\x06zypper\x18\x03 \x01(\v2..google.cloud.osconfig.v1beta.ZypperRepositoryH\x00R\x06zypper\x12?\n" +
	"\x03goo\x18\x04 \x01(\v2+.google.cloud.osconfig.v1beta.GooRepositoryH\x00R\x03gooB\f\n" +
	"\n" +
	"repository\"\xdf\x14\n" +
	"\x0eSoftwareRecipe\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x12S\n" +
	"\tartifacts\x18\x03 \x03(\v25.google.cloud.osconfig.v1beta.SoftwareRecipe.ArtifactR\tartifacts\x12V\n" +
	"\rinstall_steps\x18\x04 \x03(\v21.google.cloud.osconfig.v1beta.SoftwareRecipe.StepR\finstallSteps\x12T\n" +
	"\fupdate_steps\x18\x05 \x03(\v21.google.cloud.osconfig.v1beta.SoftwareRecipe.StepR\vupdateSteps\x12O\n" +
	"\rdesired_state\x18\x06 \x01(\x0e2*.google.cloud.osconfig.v1beta.DesiredStateR\fdesiredState\x1a\x88\x03\n" +
	"\bArtifact\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x02R\x02id\x12V\n" +
	"\x06remote\x18\x02 \x01(\v2<.google.cloud.osconfig.v1beta.SoftwareRecipe.Artifact.RemoteH\x00R\x06remote\x12M\n" +
	"\x03gcs\x18\x03 \x01(\v29.google.cloud.osconfig.v1beta.SoftwareRecipe.Artifact.GcsH\x00R\x03gcs\x12%\n" +
	...
	"generationB\n" +
	"\n" +
	"\bartifact\x1a\xba\x0e\n" +
	"\x04Step\x12Y\n" +
	"\tfile_copy\x18\x01 \x01(\v2:.google.cloud.osconfig.v1beta.SoftwareRecipe.Step.CopyFileH\x00R\bfileCopy\x12q\n" +
	"\x12archive_extraction\x18\x02 \x01(\v2@.google.cloud.osconfig.v1beta.SoftwareRecipe.Step.ExtractArchiveH\x00R\x11archiveExtraction\x12i\n" +
	"\x10msi_installation\x18\x03 \x01(\v2<.google.cloud.osconfig.v1beta.SoftwareRecipe.Step.InstallMsiH\x00R\x0fmsiInstallation\x12l\n" +
	"\x11dpkg_installation\x18\x04 \x01(\v2=.google.cloud.osconfig.v1beta.SoftwareRecipe.Step.InstallDpkgH\x00R\x10dpkgInstallation\x12i\n" +
	"\x10rpm_installation\x18\x05 \x01(\v2<.google.cloud.osconfig.v1beta.SoftwareRecipe.Step.InstallRpmH\x00R\x0frpmInstallation\x12Y\n" +
	"\tfile_exec\x18\x06 \x01(\v2:.google.cloud.osconfig.v1beta.SoftwareRecipe.Step.ExecFileH\x00R\bfileExec\x12\\\n" +
	"\n" +
	"script_run\x18\a \x01(\v2;.google.cloud.osconfig.v1beta.SoftwareRecipe.Step.RunScriptH\x00R\tscriptRun\x1a\x97\x01\n" +
	"\bCopyFile\x12$\n" +
	"\vartifact_id\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"artifactId\x12%\n" +
	"\vdestination\x18\x02 \x01(\tB\x03\xe0A\x02R\vdestination\x12\x1c\n" +
	"\toverwrite\x18\x03 \x01(\bR\toverwrite\x12 \n" +
	"\vpermissions\x18\x04 \x01(\tR\vpermissions\x1a\xb4\x02\n" +
	"\x0eExtractArchive\x12$\n" +
	"\vartifact_id\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"artifactId\x12 \n" +
	"\vdestination\x18\x02 \x01(\tR\vdestination\x12e\n" +
	"\x04type\x18\x03 \x01(\x0e2L.google.cloud.osconfig.v1beta.SoftwareRecipe.Step.ExtractArchive.ArchiveTypeB\x03\xe0A\x02R\x04type\"s\n" +
	"\vArchiveType\x12\x1c\n" +
	"\x18ARCHIVE_TYPE_UNSPECIFIED\x10\x00\x12\a\n" +
	...
	"\x12allowed_exit_codes\x18\x03 \x03(\x05R\x10allowedExitCodes\x1a3\n" +
	"\vInstallDpkg\x12$\n" +
	"\vartifact_id\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"artifactId\x1a2\n" +
	"\n" +
	...
	"\rlocation_type\x1a\x88\x02\n" +
	"\tRunScript\x12\x1b\n" +
	"\x06script\x18\x01 \x01(\tB\x03\xe0A\x02R\x06script\x12,\n" +
	"\x12allowed_exit_codes\x18\x02 \x03(\x05R\x10allowedExitCodes\x12i\n" +
	"\vinterpreter\x18\x03 \x01(\x0e2G.google.cloud.osconfig.v1beta.SoftwareRecipe.Step.RunScript.InterpreterR\vinterpreter\"E\n" +
	...
	"\x04step\"\xdf\x01\n" +
	"\x18CreateGuestPolicyRequest\x12C\n" +
	"\x06parent\x18\x01 \x01(\tB+\xe0A\x02\xfaA%\x12#osconfig.googleapis.com/GuestPolicyR\x06parent\x12+\n" +
	"\x0fguest_policy_id\x18\x02 \x01(\tB\x03\xe0A\x02R\rguestPolicyId\x12Q\n" +
	"\fguest_policy\x18\x03 \x01(\v2).google.cloud.osconfig.v1beta.GuestPolicyB\x03\xe0A\x02R\vguestPolicy\"X\n" +
	"\x15GetGuestPolicyRequest\x12?\n" +
	"\x04name\x18\x01 \x01(\tB+\xe0A\x02\xfaA%\n" +
	"#osconfig.googleapis.com/GuestPolicyR\x04name\"\x9b\x01\n" +
	"\x18ListGuestPoliciesRequest\x12C\n" +
	"\x06parent\x18\x01 \x01(\tB+\xe0A\x02\xfaA%\x12#osconfig.googleapis.com/GuestPolicyR\x06parent\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken\"\x95\x01\n" +
	"\x19ListGuestPoliciesResponse\x12P\n" +
	"\x0eguest_policies\x18\x01 \x03(\v2).google.cloud.osconfig.v1beta.GuestPolicyR\rguestPolicies\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xaa\x01\n" +
	"\x18UpdateGuestPolicyRequest\x12Q\n" +
	"\fguest_policy\x18\x01 \x01(\v2).google.cloud.osconfig.v1beta.GuestPolicyB\x03\xe0A\x02R\vguestPolicy\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"[\n" +
	"\x18DeleteGuestPolicyRequest\x12?\n" +
	"\x04name\x18\x01 \x01(\tB+\xe0A\x02\xfaA%\n" +
	"#osconfig.googleapis.com/GuestPolicyR\x04name\"\xb0\x01\n" +
	"!LookupEffectiveGuestPolicyRequest\x12\x1f\n" +
	"\binstance\x18\x01 \x01(\tB\x03\xe0A\x02R\binstance\x12\"\n" +
	...
	"\x14EffectiveGuestPolicy\x12]\n" +
	"\bpackages\x18\x01 \x03(\v2A.google.cloud.osconfig.v1beta.EffectiveGuestPolicy.SourcedPackageR\bpackages\x12~\n" +
	"\x14package_repositories\x18\x02 \x03(\v2K.google.cloud.osconfig.v1beta.EffectiveGuestPolicy.SourcedPackageRepositoryR\x13packageRepositories\x12s\n" +
	"\x10software_recipes\x18\x03 \x03(\v2H.google.cloud.osconfig.v1beta.EffectiveGuestPolicy.SourcedSoftwareRecipeR\x0fsoftwareRecipes\x1ai\n" +
	"\x0eSourcedPackage\x12\x16\n" +
	"\x06source\x18\x01 \x01(\tR\x06source\x12?\n" +
	"\apackage\x18\x02 \x01(\v2%.google.cloud.osconfig.v1beta.PackageR\apackage\x1a\x92\x01\n" +
	"\x18SourcedPackageRepository\x12\x16\n" +
	"\x06source\x18\x01 \x01(\tR\x06source\x12^\n" +
	"\x12package_repository\x18\x02 \x01(\v2/.google.cloud.osconfig.v1beta.PackageRepositoryR\x11packageRepository\x1a\x86\x01\n" +
	"\x15SourcedSoftwareRecipe\x12\x16\n" +
	"\x06source\x18\x01 \x01(\tR\x06source\x12U\n" +
	"\x0fsoftware_recipe\x18\x02 \x01(\v2,.google.cloud.osconfig.v1beta.SoftwareRecipeR\x0esoftwareRecipe*V\n" +
...
var (
	...
	file_google_cloud_osconfig_v1beta_guest_policies_proto_rawDescData []byte
)
...
func file_google_cloud_osconfig_v1beta_guest_policies_proto_rawDescGZIP() []byte {
	file_google_cloud_osconfig_v1beta_guest_policies_proto_rawDescOnce.Do(func() {
		file_google_cloud_osconfig_v1beta_guest_policies_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_v1beta_guest_policies_proto_rawDesc), len(file_google_cloud_osconfig_v1beta_guest_policies_proto_rawDesc)))
	})
...
var file_google_cloud_osconfig_v1beta_guest_policies_proto_goTypes = []any{
...
func file_google_cloud_osconfig_v1beta_guest_policies_proto_init() {
	...
	file_google_cloud_osconfig_v1beta_guest_policies_proto_msgTypes[7].OneofWrappers = []any{
		(*PackageRepository_Apt)(nil),
		(*PackageRepository_Yum)(nil),
		(*PackageRepository_Zypper)(nil),
		(*PackageRepository_Goo)(nil),
	}
	file_google_cloud_osconfig_v1beta_guest_policies_proto_msgTypes[20].OneofWrappers = []any{
		(*SoftwareRecipe_Artifact_Remote_)(nil),
		(*SoftwareRecipe_Artifact_Gcs_)(nil),
	}
	file_google_cloud_osconfig_v1beta_guest_policies_proto_msgTypes[21].OneofWrappers = []any{
	...
	file_google_cloud_osconfig_v1beta_guest_policies_proto_msgTypes[29].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_osconfig_v1beta_guest_policies_proto_rawDesc), len(file_google_cloud_osconfig_v1beta_guest_policies_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   34,
			NumExtensions: 0,
			NumServices:   0,
