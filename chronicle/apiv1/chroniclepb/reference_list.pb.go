...
type VerifyReferenceListRequest struct {
	...
	SyntaxType ReferenceListSyntaxType `protobuf:"varint,2,opt,name=syntax_type,json=syntaxType,proto3,enum=google.cloud.chronicle.v1.ReferenceListSyntaxType" json:"syntax_type,omitempty"`
...
func (x *ReferenceList) Reset() {
	*x = ReferenceList{}
	mi := &file_google_cloud_chronicle_v1_reference_list_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReferenceList) Descriptor() ([]byte, []int) {
	return file_google_cloud_chronicle_v1_reference_list_proto_rawDescGZIP(), []int{9}
}
...
func (x *ReferenceListEntry) Reset() {
	*x = ReferenceListEntry{}
	mi := &file_google_cloud_chronicle_v1_reference_list_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReferenceListEntry) Descriptor() ([]byte, []int) {
	return file_google_cloud_chronicle_v1_reference_list_proto_rawDescGZIP(), []int{10}
}
...
func (x *ReferenceListError) Reset() {
	*x = ReferenceListError{}
	mi := &file_google_cloud_chronicle_v1_reference_list_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReferenceListError) Descriptor() ([]byte, []int) {
	return file_google_cloud_chronicle_v1_reference_list_proto_rawDescGZIP(), []int{11}
}
...
const file_google_cloud_chronicle_v1_reference_list_proto_rawDesc = "" +
	...
	"updateMask\"\x8b\x02\n" +
	"\x1aVerifyReferenceListRequest\x12E\n" +
	"\binstance\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!chronicle.googleapis.com/InstanceR\binstance\x12X\n" +
	"\vsyntax_type\x18\x02 \x01(\x0e22.google.cloud.chronicle.v1.ReferenceListSyntaxTypeB\x03\xe0A\x02R\n" +
	"syntaxType\x12L\n" +
	"\aentries\x18\x03 \x03(\v2-.google.cloud.chronicle.v1.ReferenceListEntryB\x03\xe0A\x02R\aentries\"~\n" +
	"\x1bVerifyReferenceListResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12E\n" +
	"\x06errors\x18\x02 \x03(\v2-.google.cloud.chronicle.v1.ReferenceListErrorR\x06errors\"\x9c\x05\n" +
	...
	"\x05value\x18\x01 \x01(\tB\x03\xe0A\x02R\x05value\"Z\n" +
	"\x12ReferenceListError\x12\x1f\n" +
	...
	"\x18REFERENCE_LIST_VIEW_FULL\x10\x022\xad\n" +
	"\n" +
	...
	"\x13UpdateReferenceList\x125.google.cloud.chronicle.v1.UpdateReferenceListRequest\x1a(.google.cloud.chronicle.v1.ReferenceList\"\x82\x01\xdaA\x1areference_list,update_mask\x82\xd3\xe4\x93\x02_:\x0ereference_list2M/v1/{reference_list.name=projects/*/locations/*/instances/*/referenceLists/*}\x12\xd6\x01\n" +
	"\x13VerifyReferenceList\x125.google.cloud.chronicle.v1.VerifyReferenceListRequest\x1a6.google.cloud.chronicle.v1.VerifyReferenceListResponse\"P\x82\xd3\xe4\x93\x02J:\x01*\"E/v1/{instance=projects/*/locations/*/instances/*}:verifyReferenceList\x1a\xaa\x01\xcaA\x18chronicle.googleapis.com\xd2A\x8b\x01https://www.googleapis.com/auth/chronicle,https://www.googleapis.com/auth/chronicle.readonly,https://www.googleapis.com/auth/cloud-platformB\xc9\x01\n" +
...
var file_google_cloud_chronicle_v1_reference_list_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_google_cloud_chronicle_v1_reference_list_proto_goTypes = []any{
	...
	(*VerifyReferenceListRequest)(nil),  // 9: google.cloud.chronicle.v1.VerifyReferenceListRequest
	(*VerifyReferenceListResponse)(nil), // 10: google.cloud.chronicle.v1.VerifyReferenceListResponse
	(*ReferenceList)(nil),               // 11: google.cloud.chronicle.v1.ReferenceList
	(*ReferenceListEntry)(nil),          // 12: google.cloud.chronicle.v1.ReferenceListEntry
	(*ReferenceListError)(nil),          // 13: google.cloud.chronicle.v1.ReferenceListError
...
var file_google_cloud_chronicle_v1_reference_list_proto_depIdxs = []int32{
	...
	11, // 3: google.cloud.chronicle.v1.ListReferenceListsResponse.reference_lists:type_name -> google.cloud.chronicle.v1.ReferenceList
	11, // 4: google.cloud.chronicle.v1.CreateReferenceListRequest.reference_list:type_name -> google.cloud.chronicle.v1.ReferenceList
	11, // 5: google.cloud.chronicle.v1.UpdateReferenceListRequest.reference_list:type_name -> google.cloud.chronicle.v1.ReferenceList
	14, // 6: google.cloud.chronicle.v1.UpdateReferenceListRequest.update_mask:type_name -> google.protobuf.FieldMask
	0,  // 7: google.cloud.chronicle.v1.VerifyReferenceListRequest.syntax_type:type_name -> google.cloud.chronicle.v1.ReferenceListSyntaxType
	12, // 8: google.cloud.chronicle.v1.VerifyReferenceListRequest.entries:type_name -> google.cloud.chronicle.v1.ReferenceListEntry
	13, // 9: google.cloud.chronicle.v1.VerifyReferenceListResponse.errors:type_name -> google.cloud.chronicle.v1.ReferenceListError
	15, // 10: google.cloud.chronicle.v1.ReferenceList.revision_create_time:type_name -> google.protobuf.Timestamp
	12, // 11: google.cloud.chronicle.v1.ReferenceList.entries:type_name -> google.cloud.chronicle.v1.ReferenceListEntry
	0,  // 12: google.cloud.chronicle.v1.ReferenceList.syntax_type:type_name -> google.cloud.chronicle.v1.ReferenceListSyntaxType
	2,  // 13: google.cloud.chronicle.v1.ReferenceList.scope_info:type_name -> google.cloud.chronicle.v1.ScopeInfo
	4,  // 14: google.cloud.chronicle.v1.ReferenceListService.GetReferenceList:input_type -> google.cloud.chronicle.v1.GetReferenceListRequest
	5,  // 15: google.cloud.chronicle.v1.ReferenceListService.ListReferenceLists:input_type -> google.cloud.chronicle.v1.ListReferenceListsRequest
	7,  // 16: google.cloud.chronicle.v1.ReferenceListService.CreateReferenceList:input_type -> google.cloud.chronicle.v1.CreateReferenceListRequest
	8,  // 17: google.cloud.chronicle.v1.ReferenceListService.UpdateReferenceList:input_type -> google.cloud.chronicle.v1.UpdateReferenceListRequest
	9,  // 18: google.cloud.chronicle.v1.ReferenceListService.VerifyReferenceList:input_type -> google.cloud.chronicle.v1.VerifyReferenceListRequest
	11, // 19: google.cloud.chronicle.v1.ReferenceListService.GetReferenceList:output_type -> google.cloud.chronicle.v1.ReferenceList
	6,  // 20: google.cloud.chronicle.v1.ReferenceListService.ListReferenceLists:output_type -> google.cloud.chronicle.v1.ListReferenceListsResponse
	11, // 21: google.cloud.chronicle.v1.ReferenceListService.CreateReferenceList:output_type -> google.cloud.chronicle.v1.ReferenceList
	11, // 22: google.cloud.chronicle.v1.ReferenceListService.UpdateReferenceList:output_type -> google.cloud.chronicle.v1.ReferenceList
	10, // 23: google.cloud.chronicle.v1.ReferenceListService.VerifyReferenceList:output_type -> google.cloud.chronicle.v1.VerifyReferenceListResponse
