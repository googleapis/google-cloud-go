...
const file_google_cloud_visionai_v1_annotations_proto_rawDesc = "" +
	"\n" +
	"*google/cloud/visionai/v1/annotations.proto\x12\x18google.cloud.visionai.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd5\x10\n" +
	"*PersonalProtectiveEquipmentDetectionOutput\x12=\n" +
	"\fcurrent_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\vcurrentTime\x12~\n" +
	"\x10detected_persons\x18\x02 \x03(\v2S.google.cloud.visionai.v1.PersonalProtectiveEquipmentDetectionOutput.DetectedPersonR\x0fdetectedPersons\x1a8\n" +
	"\fPersonEntity\x12(\n" +
	"\x10person_entity_id\x18\x01 \x01(\x03R\x0epersonEntityId\x1a\xc0\x01\n" +
	"\tPPEEntity\x12 \n" +
	"\fppe_label_id\x18\x01 \x01(\x03R\n" +
	"ppeLabelId\x12(\n" +
	"\x10ppe_label_string\x18\x02 \x01(\tR\x0eppeLabelString\x12C\n" +
	"\x1eppe_supercategory_label_string\x18\x03 \x01(\tR\x1bppeSupercategoryLabelString\x12\"\n" +
	"\rppe_entity_id\x18\x04 \x01(\x03R\vppeEntityId\x1am\n" +
	...
	"\x06height\x18\x04 \x01(\x02R\x06height\x1a\xe4\x02\n" +
	"\x13PersonIdentifiedBox\x12\x15\n" +
	"\x06box_id\x18\x01 \x01(\x03R\x05boxId\x12\x92\x01\n" +
	"\x17normalized_bounding_box\x18\x02 \x01(\v2Z.google.cloud.visionai.v1.PersonalProtectiveEquipmentDetectionOutput.NormalizedBoundingBoxR\x15normalizedBoundingBox\x12)\n" +
	"\x10confidence_score\x18\x03 \x01(\x02R\x0fconfidenceScore\x12v\n" +
	"\rperson_entity\x18\x04 \x01(\v2Q.google.cloud.visionai.v1.PersonalProtectiveEquipmentDetectionOutput.PersonEntityR\fpersonEntity\x1a\xd8\x02\n" +
	"\x10PPEIdentifiedBox\x12\x15\n" +
	"\x06box_id\x18\x01 \x01(\x03R\x05boxId\x12\x92\x01\n" +
	"\x17normalized_bounding_box\x18\x02 \x01(\v2Z.google.cloud.visionai.v1.PersonalProtectiveEquipmentDetectionOutput.NormalizedBoundingBoxR\x15normalizedBoundingBox\x12)\n" +
	"\x10confidence_score\x18\x03 \x01(\x02R\x0fconfidenceScore\x12m\n" +
	"\n" +
	"ppe_entity\x18\x04 \x01(\v2N.google.cloud.visionai.v1.PersonalProtectiveEquipmentDetectionOutput.PPEEntityR\tppeEntity\x1a\xb9\x06\n" +
	"\x0eDetectedPerson\x12\x1b\n" +
	"\tperson_id\x18\x01 \x01(\x03R\bpersonId\x12\x9d\x01\n" +
	"\x1edetected_person_identified_box\x18\x02 \x01(\v2X.google.cloud.visionai.v1.PersonalProtectiveEquipmentDetectionOutput.PersonIdentifiedBoxR\x1bdetectedPersonIdentifiedBox\x12\x98\x01\n" +
	"\x1ddetected_ppe_identified_boxes\x18\x03 \x03(\v2U.google.cloud.visionai.v1.PersonalProtectiveEquipmentDetectionOutput.PPEIdentifiedBoxR\x1adetectedPpeIdentifiedBoxes\x123\n" +
	"\x13face_coverage_score\x18\x04 \x01(\x02H\x00R\x11faceCoverageScore\x88\x01\x01\x123\n" +
	"\x13eyes_coverage_score\x18\x05 \x01(\x02H\x01R\x11eyesCoverageScore\x88\x01\x01\x123\n" +
	"\x13head_coverage_score\x18\x06 \x01(\x02H\x02R\x11headCoverageScore\x88\x01\x01\x125\n" +
	"\x14hands_coverage_score\x18\a \x01(\x02H\x03R\x12handsCoverageScore\x88\x01\x01\x123\n" +
	"\x13body_coverage_score\x18\b \x01(\x02H\x04R\x11bodyCoverageScore\x88\x01\x01\x123\n" +
	"\x13feet_coverage_score\x18\t \x01(\x02H\x05R\x11feetCoverageScore\x88\x01\x01B\x16\n" +
	...
	"\x14_feet_coverage_score\"\xd1\x05\n" +
	"\x1fObjectDetectionPredictionResult\x12=\n" +
	"\fcurrent_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\vcurrentTime\x12r\n" +
	"\x10identified_boxes\x18\x02 \x03(\v2G.google.cloud.visionai.v1.ObjectDetectionPredictionResult.IdentifiedBoxR\x0fidentifiedBoxes\x1aF\n" +
	"\x06Entity\x12\x19\n" +
	"\blabel_id\x18\x01 \x01(\x03R\alabelId\x12!\n" +
	"\flabel_string\x18\x02 \x01(\tR\vlabelString\x1a\xb2\x03\n" +
	"\rIdentifiedBox\x12\x15\n" +
	"\x06box_id\x18\x01 \x01(\x03R\x05boxId\x12\x95\x01\n" +
	"\x17normalized_bounding_box\x18\x02 \x01(\v2].google.cloud.visionai.v1.ObjectDetectionPredictionResult.IdentifiedBox.NormalizedBoundingBoxR\x15normalizedBoundingBox\x12)\n" +
	"\x10confidence_score\x18\x03 \x01(\x02R\x0fconfidenceScore\x12X\n" +
	"\x06entity\x18\x04 \x01(\v2@.google.cloud.visionai.v1.ObjectDetectionPredictionResult.EntityR\x06entity\x1am\n" +
	"\x15NormalizedBoundingBox\x12\x12\n" +
	"\x04xmin\x18\x01 \x01(\x02R\x04xmin\x12\x12\n" +
	"\x04ymin\x18\x02 \x01(\x02R\x04ymin\x12\x14\n" +
	"\x05width\x18\x03 \x01(\x02R\x05width\x12\x16\n" +
	"\x06height\x18\x04 \x01(\x02R\x06height\"\xb3\x01\n" +
	"$ImageObjectDetectionPredictionResult\x12\x10\n" +
	"\x03ids\x18\x01 \x03(\x03R\x03ids\x12#\n" +
	"\rdisplay_names\x18\x02 \x03(\tR\fdisplayNames\x12 \n" +
	"\vconfidences\x18\x03 \x03(\x02R\vconfidences\x122\n" +
	"\x06bboxes\x18\x04 \x03(\v2\x1a.google.protobuf.ListValueR\x06bboxes\"y\n" +
	"\x1eClassificationPredictionResult\x12\x10\n" +
	"\x03ids\x18\x01 \x03(\x03R\x03ids\x12#\n" +
	"\rdisplay_names\x18\x02 \x03(\tR\fdisplayNames\x12 \n" +
	"\vconfidences\x18\x03 \x03(\x02R\vconfidences\"q\n" +
	"!ImageSegmentationPredictionResult\x12#\n" +
	"\rcategory_mask\x18\x01 \x01(\tR\fcategoryMask\x12'\n" +
	"\x0fconfidence_mask\x18\x02 \x01(\tR\x0econfidenceMask\"\x8c\x03\n" +
	"&VideoActionRecognitionPredictionResult\x12H\n" +
	"\x12segment_start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x10segmentStartTime\x12D\n" +
	"\x10segment_end_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x0esegmentEndTime\x12k\n" +
	"\aactions\x18\x03 \x03(\v2Q.google.cloud.visionai.v1.VideoActionRecognitionPredictionResult.IdentifiedActionR\aactions\x1ae\n" +
	"\x10IdentifiedAction\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x12\x1e\n" +
	"\n" +
	"confidence\x18\x03 \x01(\x02R\n" +
	"confidence\"\xef\x04\n" +
	"#VideoObjectTrackingPredictionResult\x12H\n" +
	"\x12segment_start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x10segmentStartTime\x12D\n" +
	"\x10segment_end_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x0esegmentEndTime\x12f\n" +
	"\aobjects\x18\x03 \x03(\v2L.google.cloud.visionai.v1.VideoObjectTrackingPredictionResult.DetectedObjectR\aobjects\x1aa\n" +
	"\vBoundingBox\x12\x13\n" +
	"\x05x_min\x18\x01 \x01(\x02R\x04xMin\x12\x13\n" +
	"\x05x_max\x18\x02 \x01(\x02R\x04xMax\x12\x13\n" +
	"\x05y_min\x18\x03 \x01(\x02R\x04yMin\x12\x13\n" +
	"\x05y_max\x18\x04 \x01(\x02R\x04yMax\x1a\xec\x01\n" +
	"\x0eDetectedObject\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x12l\n" +
	"\fbounding_box\x18\x03 \x01(\v2I.google.cloud.visionai.v1.VideoObjectTrackingPredictionResult.BoundingBoxR\vboundingBox\x12\x1e\n" +
	"\n" +
	"confidence\x18\x04 \x01(\x02R\n" +
	"confidence\x12\x19\n" +
	"\btrack_id\x18\x05 \x01(\x03R\atrackId\"\xa7\x03\n" +
	"#VideoClassificationPredictionResult\x12H\n" +
	"\x12segment_start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x10segmentStartTime\x12D\n" +
	"\x10segment_end_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x0esegmentEndTime\x12\x80\x01\n" +
	"\x0fclassifications\x18\x03 \x03(\v2V.google.cloud.visionai.v1.VideoClassificationPredictionResult.IdentifiedClassificationR\x0fclassifications\x1am\n" +
	"\x18IdentifiedClassification\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x12\x1e\n" +
	"\n" +
	"confidence\x18\x03 \x01(\x02R\n" +
	"confidence\"\xd3\x17\n" +
	"!OccupancyCountingPredictionResult\x12=\n" +
	"\fcurrent_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\vcurrentTime\x12t\n" +
	"\x10identified_boxes\x18\x02 \x03(\v2I.google.cloud.visionai.v1.OccupancyCountingPredictionResult.IdentifiedBoxR\x0fidentifiedBoxes\x12W\n" +
	"\x05stats\x18\x03 \x01(\v2A.google.cloud.visionai.v1.OccupancyCountingPredictionResult.StatsR\x05stats\x12d\n" +
	"\n" +
	"track_info\x18\x04 \x03(\v2E.google.cloud.visionai.v1.OccupancyCountingPredictionResult.TrackInfoR\ttrackInfo\x12q\n" +
	"\x0fdwell_time_info\x18\x05 \x03(\v2I.google.cloud.visionai.v1.OccupancyCountingPredictionResult.DwellTimeInfoR\rdwellTimeInfo\x12\x15\n" +
	"\x03pts\x18\x06 \x01(\x03H\x00R\x03pts\x88\x01\x01\x1aF\n" +
	"\x06Entity\x12\x19\n" +
	"\blabel_id\x18\x01 \x01(\x03R\alabelId\x12!\n" +
	"\flabel_string\x18\x02 \x01(\tR\vlabelString\x1a\xbc\x03\n" +
	"\rIdentifiedBox\x12\x15\n" +
	"\x06box_id\x18\x01 \x01(\x03R\x05boxId\x12\x97\x01\n" +
	"\x17normalized_bounding_box\x18\x02 \x01(\v2_.google.cloud.visionai.v1.OccupancyCountingPredictionResult.IdentifiedBox.NormalizedBoundingBoxR\x15normalizedBoundingBox\x12\x14\n" +
	"\x05score\x18\x03 \x01(\x02R\x05score\x12Z\n" +
	"\x06entity\x18\x04 \x01(\v2B.google.cloud.visionai.v1.OccupancyCountingPredictionResult.EntityR\x06entity\x12\x19\n" +
	"\btrack_id\x18\x05 \x01(\x03R\atrackId\x1am\n" +
	"\x15NormalizedBoundingBox\x12\x12\n" +
	"\x04xmin\x18\x01 \x01(\x02R\x04xmin\x12\x12\n" +
	"\x04ymin\x18\x02 \x01(\x02R\x04ymin\x12\x14\n" +
	"\x05width\x18\x03 \x01(\x02R\x05width\x12\x16\n" +
	"\x06height\x18\x04 \x01(\x02R\x06height\x1a\xef\f\n" +
	"\x05Stats\x12w\n" +
	"\x10full_frame_count\x18\x01 \x03(\v2M.google.cloud.visionai.v1.OccupancyCountingPredictionResult.Stats.ObjectCountR\x0efullFrameCount\x12\x85\x01\n" +
	"\x14crossing_line_counts\x18\x02 \x03(\v2S.google.cloud.visionai.v1.OccupancyCountingPredictionResult.Stats.CrossingLineCountR\x12crossingLineCounts\x12\x7f\n" +
	"\x12active_zone_counts\x18\x03 \x03(\v2Q.google.cloud.visionai.v1.OccupancyCountingPredictionResult.Stats.ActiveZoneCountR\x10activeZoneCounts\x1a\x7f\n" +
	"\vObjectCount\x12Z\n" +
	"\x06entity\x18\x01 \x01(\v2B.google.cloud.visionai.v1.OccupancyCountingPredictionResult.EntityR\x06entity\x12\x14\n" +
	"\x05count\x18\x02 \x01(\x05R\x05count\x1a\xc5\x01\n" +
	"\x16AccumulatedObjectCount\x129\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x12p\n" +
	"\fobject_count\x18\x02 \x01(\v2M.google.cloud.visionai.v1.OccupancyCountingPredictionResult.Stats.ObjectCountR\vobjectCount\x1a\xd3\x05\n" +
	"\x11CrossingLineCount\x12J\n" +
	"\n" +
	"annotation\x18\x01 \x01(\v2*.google.cloud.visionai.v1.StreamAnnotationR\n" +
	"annotation\x12\x89\x01\n" +
	"\x19positive_direction_counts\x18\x02 \x03(\v2M.google.cloud.visionai.v1.OccupancyCountingPredictionResult.Stats.ObjectCountR\x17positiveDirectionCounts\x12\x89\x01\n" +
	"\x19negative_direction_counts\x18\x03 \x03(\v2M.google.cloud.visionai.v1.OccupancyCountingPredictionResult.Stats.ObjectCountR\x17negativeDirectionCounts\x12\xab\x01\n" +
	"%accumulated_positive_direction_counts\x18\x04 \x03(\v2X.google.cloud.visionai.v1.OccupancyCountingPredictionResult.Stats.AccumulatedObjectCountR\"accumulatedPositiveDirectionCounts\x12\xab\x01\n" +
	"%accumulated_negative_direction_counts\x18\x05 \x03(\v2X.google.cloud.visionai.v1.OccupancyCountingPredictionResult.Stats.AccumulatedObjectCountR\"accumulatedNegativeDirectionCounts\x1a\xc4\x01\n" +
	"\x0fActiveZoneCount\x12J\n" +
	"\n" +
	"annotation\x18\x01 \x01(\v2*.google.cloud.visionai.v1.StreamAnnotationR\n" +
	"annotation\x12e\n" +
	"\x06counts\x18\x02 \x03(\v2M.google.cloud.visionai.v1.OccupancyCountingPredictionResult.Stats.ObjectCountR\x06counts\x1aa\n" +
	"\tTrackInfo\x12\x19\n" +
	"\btrack_id\x18\x01 \x01(\tR\atrackId\x129\n" +
	"\n" +
	"start_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x1a\xcb\x01\n" +
	"\rDwellTimeInfo\x12\x19\n" +
	"\btrack_id\x18\x01 \x01(\tR\atrackId\x12\x17\n" +
	"\azone_id\x18\x02 \x01(\tR\x06zoneId\x12D\n" +
	"\x10dwell_start_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x0edwellStartTime\x12@\n" +
	"\x0edwell_end_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\fdwellEndTimeB\x06\n" +
	"\x04_pts\"\xe9\x02\n" +
	"\x10StreamAnnotation\x12N\n" +
	"\vactive_zone\x18\x05 \x01(\v2+.google.cloud.visionai.v1.NormalizedPolygonH\x00R\n" +
	"activeZone\x12S\n" +
	"\rcrossing_line\x18\x06 \x01(\v2,.google.cloud.visionai.v1.NormalizedPolylineH\x00R\fcrossingLine\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x12#\n" +
	"\rsource_stream\x18\x03 \x01(\tR\fsourceStream\x12B\n" +
	"\x04type\x18\x04 \x01(\x0e2..google.cloud.visionai.v1.StreamAnnotationTypeR\x04typeB\x14\n" +
	"\x12annotation_payload\"n\n" +
	"\x11StreamAnnotations\x12Y\n" +
	"\x12stream_annotations\x18\x01 \x03(\v2*.google.cloud.visionai.v1.StreamAnnotationR\x11streamAnnotations\"p\n" +
	"\x11NormalizedPolygon\x12[\n" +
	"\x13normalized_vertices\x18\x01 \x03(\v2*.google.cloud.visionai.v1.NormalizedVertexR\x12normalizedVertices\"q\n" +
	"\x12NormalizedPolyline\x12[\n" +
	"\x13normalized_vertices\x18\x01 \x03(\v2*.google.cloud.visionai.v1.NormalizedVertexR\x12normalizedVertices\".\n" +
	"\x10NormalizedVertex\x12\f\n" +
	"\x01x\x18\x01 \x01(\x02R\x01x\x12\f\n" +
	"\x01y\x18\x02 \x01(\x02R\x01y\"\x8a\x01\n" +
	"\x13AppPlatformMetadata\x12 \n" +
	"\vapplication\x18\x01 \x01(\tR\vapplication\x12\x1f\n" +
	"\vinstance_id\x18\x02 \x01(\tR\n" +
	"instanceId\x12\x12\n" +
	"\x04node\x18\x03 \x01(\tR\x04node\x12\x1c\n" +
	"\tprocessor\x18\x04 \x01(\tR\tprocessor\"\x82\x03\n" +
	"\x1fAppPlatformCloudFunctionRequest\x12a\n" +
	"\x15app_platform_metadata\x18\x01 \x01(\v2-.google.cloud.visionai.v1.AppPlatformMetadataR\x13appPlatformMetadata\x12s\n" +
	"\vannotations\x18\x02 \x03(\v2Q.google.cloud.visionai.v1.AppPlatformCloudFunctionRequest.StructedInputAnnotationR\vannotations\x1a\x86\x01\n" +
	"\x17StructedInputAnnotation\x122\n" +
	"\x15ingestion_time_micros\x18\x01 \x01(\x03R\x13ingestionTimeMicros\x127\n" +
	"\n" +
	"annotation\x18\x02 \x01(\v2\x17.google.protobuf.StructR\n" +
	"annotation\"\xed\x02\n" +
	" AppPlatformCloudFunctionResponse\x12u\n" +
	"\vannotations\x18\x02 \x03(\v2S.google.cloud.visionai.v1.AppPlatformCloudFunctionResponse.StructedOutputAnnotationR\vannotations\x125\n" +
	"\x16annotation_passthrough\x18\x03 \x01(\bR\x15annotationPassthrough\x12F\n" +
	"\x06events\x18\x04 \x03(\v2..google.cloud.visionai.v1.AppPlatformEventBodyR\x06events\x1aS\n" +
	"\x18StructedOutputAnnotation\x127\n" +
	"\n" +
	"annotation\x18\x01 \x01(\v2\x17.google.protobuf.StructR\n" +
	"annotation\"\x89\x01\n" +
	"\x14AppPlatformEventBody\x12#\n" +
	"\revent_message\x18\x01 \x01(\tR\feventMessage\x121\n" +
	"\apayload\x18\x02 \x01(\v2\x17.google.protobuf.StructR\apayload\x12\x19\n" +
	"\bevent_id\x18\x03 \x01(\tR\aeventId*\x90\x01\n" +
...
var (
	...
	file_google_cloud_visionai_v1_annotations_proto_rawDescData []byte
)
...
func file_google_cloud_visionai_v1_annotations_proto_rawDescGZIP() []byte {
	file_google_cloud_visionai_v1_annotations_proto_rawDescOnce.Do(func() {
		file_google_cloud_visionai_v1_annotations_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_visionai_v1_annotations_proto_rawDesc), len(file_google_cloud_visionai_v1_annotations_proto_rawDesc)))
	})
...
func file_google_cloud_visionai_v1_annotations_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_visionai_v1_annotations_proto_rawDesc), len(file_google_cloud_visionai_v1_annotations_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   43,
			NumExtensions: 0,
			NumServices:   0,
