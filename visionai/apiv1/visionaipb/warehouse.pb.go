...
func file_google_cloud_visionai_v1_warehouse_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_visionai_v1_warehouse_proto_msgTypes[88].Exporter = func(v any, i int) any {
			switch v := v.(*BatchOperationStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_google_cloud_visionai_v1_warehouse_proto_msgTypes[159].Exporter = func(v any, i int) any {
		...
		file_google_cloud_visionai_v1_warehouse_proto_msgTypes[161].Exporter = func(v any, i int) any {
		...
		file_google_cloud_visionai_v1_warehouse_proto_msgTypes[175].Exporter = func(v any, i int) any {
