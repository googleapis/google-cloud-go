...
type AssetSource struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to SourceForm:
	//
...
func (x *AssetSource) GetSourceForm() isAssetSource_SourceForm {
	if x != nil {
		return x.SourceForm
	}
	return nil
...
func (x *AssetSource) GetAssetGcsSource() *AssetSource_AssetGcsSource {
	if x != nil {
		if x, ok := x.SourceForm.(*AssetSource_AssetGcsSource_); ok {
...
func (x *AssetSource) GetAssetContentData() *AssetSource_AssetContentData {
	if x != nil {
		if x, ok := x.SourceForm.(*AssetSource_AssetContentData_); ok {
...
type Index struct {
	...
	//
	// Types that are valid to be assigned to AssetFilter:
	//
	//	*Index_EntireCorpus
...
func (x *Index) GetAssetFilter() isIndex_AssetFilter {
	if x != nil {
...
func (x *Index) GetEntireCorpus() bool {
	if x != nil {
		if x, ok := x.AssetFilter.(*Index_EntireCorpus); ok {
...
func (x *AnnotationValue) GetValue() isAnnotationValue_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *AnnotationValue) GetIntValue() int64 {
	if x != nil {
		if x, ok := x.Value.(*AnnotationValue_IntValue); ok {
			return x.IntValue
		}
	}
	return 0
...
func (x *AnnotationValue) GetFloatValue() float32 {
	if x != nil {
		if x, ok := x.Value.(*AnnotationValue_FloatValue); ok {
			return x.FloatValue
		}
	}
	return 0
...
func (x *AnnotationValue) GetStrValue() string {
	if x != nil {
		if x, ok := x.Value.(*AnnotationValue_StrValue); ok {
			return x.StrValue
		}
	}
	return ""
...
func (x *AnnotationValue) GetDatetimeValue() string {
	if x != nil {
		if x, ok := x.Value.(*AnnotationValue_DatetimeValue); ok {
...
func (x *AnnotationValue) GetGeoCoordinate() *GeoCoordinate {
	if x != nil {
		if x, ok := x.Value.(*AnnotationValue_GeoCoordinate); ok {
...
func (x *AnnotationValue) GetProtoAnyValue() *anypb.Any {
	if x != nil {
		if x, ok := x.Value.(*AnnotationValue_ProtoAnyValue); ok {
...
func (x *AnnotationValue) GetBoolValue() bool {
	if x != nil {
		if x, ok := x.Value.(*AnnotationValue_BoolValue); ok {
			return x.BoolValue
		}
	}
	return false
...
func (x *AnnotationValue) GetCustomizedStructDataValue() *structpb.Struct {
	if x != nil {
		if x, ok := x.Value.(*AnnotationValue_CustomizedStructDataValue); ok {
...
func (x *AnnotationValue) GetListValue() *AnnotationList {
	if x != nil {
		if x, ok := x.Value.(*AnnotationValue_ListValue); ok {
			return x.ListValue
		}
	}
	return nil
...
func (x *AnnotationValue) GetCustomizedStructValue() *AnnotationCustomizedStruct {
	if x != nil {
		if x, ok := x.Value.(*AnnotationValue_CustomizedStructValue); ok {
...
type AnnotationCustomizedStruct struct {
	...
	Elements      map[string]*AnnotationValue `protobuf:"bytes,2,rep,name=elements,proto3" json:"elements,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ImportAssetsRequest) GetSource() isImportAssetsRequest_Source {
	if x != nil {
		return x.Source
	}
	return nil
...
func (x *ImportAssetsRequest) GetAssetsGcsUri() string {
	if x != nil {
		if x, ok := x.Source.(*ImportAssetsRequest_AssetsGcsUri); ok {
...
type FacetProperty struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to RangeFacetConfig:
	//
...
func (x *FacetProperty) GetRangeFacetConfig() isFacetProperty_RangeFacetConfig {
	if x != nil {
		return x.RangeFacetConfig
	}
	return nil
}
...
func (x *FacetProperty) GetFixedRangeBucketSpec() *FacetProperty_FixedRangeBucketSpec {
	if x != nil {
		if x, ok := x.RangeFacetConfig.(*FacetProperty_FixedRangeBucketSpec_); ok {
...
func (x *FacetProperty) GetCustomRangeBucketSpec() *FacetProperty_CustomRangeBucketSpec {
	if x != nil {
		if x, ok := x.RangeFacetConfig.(*FacetProperty_CustomRangeBucketSpec_); ok {
...
func (x *FacetProperty) GetDatetimeBucketSpec() *FacetProperty_DateTimeBucketSpec {
	if x != nil {
		if x, ok := x.RangeFacetConfig.(*FacetProperty_DatetimeBucketSpec); ok {
...
func (x *FacetValue) GetStringValue() string {
	if x != nil {
		if x, ok := x.Value.(*FacetValue_StringValue); ok {
...
func (x *FacetValue) GetIntegerValue() int64 {
	if x != nil {
		if x, ok := x.Value.(*FacetValue_IntegerValue); ok {
...
func (x *FacetValue) GetDatetimeValue() *datetime.DateTime {
	if x != nil {
		if x, ok := x.Value.(*FacetValue_DatetimeValue); ok {
			return x.DatetimeValue
		}
	}
	return nil
...
type FacetBucket struct {
	...
	//
	// Types that are valid to be assigned to BucketValue:
	//
	//	*FacetBucket_Value
	//	*FacetBucket_Range_
...
func (x *FacetBucket) GetBucketValue() isFacetBucket_BucketValue {
	if x != nil {
...
func (x *FacetBucket) GetValue() *FacetValue {
	if x != nil {
		if x, ok := x.BucketValue.(*FacetBucket_Value); ok {
			return x.Value
		}
	}
	return nil
...
func (x *FacetBucket) GetRange() *FacetBucket_Range {
	if x != nil {
		if x, ok := x.BucketValue.(*FacetBucket_Range_); ok {
			return x.Range
		}
	}
	return nil
...
func (x *IngestAssetRequest) GetStreamingRequest() isIngestAssetRequest_StreamingRequest {
	if x != nil {
...
func (x *IngestAssetRequest) GetConfig() *IngestAssetRequest_Config {
	if x != nil {
		if x, ok := x.StreamingRequest.(*IngestAssetRequest_Config_); ok {
			return x.Config
		}
	}
	return nil
...
func (x *IngestAssetRequest) GetTimeIndexedData() *IngestAssetRequest_TimeIndexedData {
	if x != nil {
		if x, ok := x.StreamingRequest.(*IngestAssetRequest_TimeIndexedData_); ok {
...
type SearchAssetsRequest struct {
	...
	//
	// Types that are valid to be assigned to SortSpec:
	//
...
func (x *SearchAssetsRequest) GetSortSpec() isSearchAssetsRequest_SortSpec {
	if x != nil {
		return x.SortSpec
	}
	return nil
...
func (x *SearchAssetsRequest) GetSchemaKeySortingStrategy() *SchemaKeySortingStrategy {
	if x != nil {
		if x, ok := x.SortSpec.(*SearchAssetsRequest_SchemaKeySortingStrategy); ok {
...
func (x *SearchIndexEndpointRequest) GetQuery() isSearchIndexEndpointRequest_Query {
	if x != nil {
		return x.Query
	}
	return nil
...
func (x *SearchIndexEndpointRequest) GetImageQuery() *ImageQuery {
	if x != nil {
		if x, ok := x.Query.(*SearchIndexEndpointRequest_ImageQuery); ok {
			return x.ImageQuery
		}
	}
	return nil
...
func (x *SearchIndexEndpointRequest) GetTextQuery() string {
	if x != nil {
		if x, ok := x.Query.(*SearchIndexEndpointRequest_TextQuery); ok {
			return x.TextQuery
		}
	}
	return ""
...
func (x *ImageQuery) GetImage() isImageQuery_Image {
	if x != nil {
		return x.Image
	}
	return nil
...
func (x *ImageQuery) GetInputImage() []byte {
	if x != nil {
		if x, ok := x.Image.(*ImageQuery_InputImage); ok {
			return x.InputImage
		}
	}
	return nil
...
func (x *ImageQuery) GetAsset() string {
	if x != nil {
		if x, ok := x.Image.(*ImageQuery_Asset); ok {
			return x.Asset
		}
	}
	return ""
...
func (x *Criteria) GetValue() isCriteria_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *Criteria) GetTextArray() *StringArray {
	if x != nil {
		if x, ok := x.Value.(*Criteria_TextArray); ok {
			return x.TextArray
		}
	}
	return nil
...
func (x *Criteria) GetIntRangeArray() *IntRangeArray {
	if x != nil {
		if x, ok := x.Value.(*Criteria_IntRangeArray); ok {
...
func (x *Criteria) GetFloatRangeArray() *FloatRangeArray {
	if x != nil {
		if x, ok := x.Value.(*Criteria_FloatRangeArray); ok {
...
func (x *Criteria) GetDateTimeRangeArray() *DateTimeRangeArray {
	if x != nil {
		if x, ok := x.Value.(*Criteria_DateTimeRangeArray); ok {
...
func (x *Criteria) GetGeoLocationArray() *GeoLocationArray {
	if x != nil {
		if x, ok := x.Value.(*Criteria_GeoLocationArray); ok {
...
func (x *Criteria) GetBoolValue() *BoolValue {
	if x != nil {
		if x, ok := x.Value.(*Criteria_BoolValue); ok {
			return x.BoolValue
		}
	}
	return nil
...
type DataSchemaDetails_CustomizedStructConfig struct {
	...
	FieldSchemas  map[string]*DataSchemaDetails `protobuf:"bytes,1,rep,name=field_schemas,json=fieldSchemas,proto3" json:"field_schemas,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *IngestAssetRequest_Config) GetDataType() isIngestAssetRequest_Config_DataType {
	if x != nil {
		return x.DataType
	}
	return nil
...
func (x *IngestAssetRequest_Config) GetVideoType() *IngestAssetRequest_Config_VideoType {
	if x != nil {
		if x, ok := x.DataType.(*IngestAssetRequest_Config_VideoType_); ok {
			return x.VideoType
		}
	}
	return nil
...
const file_google_cloud_visionai_v1_warehouse_proto_rawDesc = "" +
	"\n" +
	"(google/cloud/visionai/v1/warehouse.proto\x12\x18google.cloud.visionai.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a%google/cloud/visionai/v1/common.proto\x1a#google/longrunning/operations.proto\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\x1a\x1agoogle/type/datetime.proto\"\xc2\x01\n" +
	"\x12CreateAssetRequest\x12>\n" +
	"\x06parent\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1evisionai.googleapis.com/CorpusR\x06parent\x12:\n" +
	"\x05asset\x18\x02 \x01(\v2\x1f.google.cloud.visionai.v1.AssetB\x03\xe0A\x02R\x05asset\x12#\n" +
	"\basset_id\x18\x03 \x01(\tB\x03\xe0A\x01H\x00R\aassetId\x88\x01\x01B\v\n" +
	"\t_asset_id\"L\n" +
	"\x0fGetAssetRequest\x129\n" +
	"\x04name\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/AssetR\x04name\"\xa6\x01\n" +
	"\x11ListAssetsRequest\x12=\n" +
	"\x06parent\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\x12\x1dvisionai.googleapis.com/AssetR\x06parent\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken\x12\x16\n" +
	"\x06filter\x18\x05 \x01(\tR\x06filter\"u\n" +
	"\x12ListAssetsResponse\x127\n" +
	"\x06assets\x18\x01 \x03(\v2\x1f.google.cloud.visionai.v1.AssetR\x06assets\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\x8d\x01\n" +
	"\x12UpdateAssetRequest\x12:\n" +
	"\x05asset\x18\x01 \x01(\v2\x1f.google.cloud.visionai.v1.AssetB\x03\xe0A\x02R\x05asset\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"O\n" +
	"\x12DeleteAssetRequest\x129\n" +
	"\x04name\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/AssetR\x04name\"\xd3\x02\n" +
	"\vAssetSource\x12`\n" +
	"\x10asset_gcs_source\x18\x01 \x01(\v24.google.cloud.visionai.v1.AssetSource.AssetGcsSourceH\x00R\x0eassetGcsSource\x12f\n" +
	"\x12asset_content_data\x18\x02 \x01(\v26.google.cloud.visionai.v1.AssetSource.AssetContentDataH\x00R\x10assetContentData\x1a)\n" +
	"\x0eAssetGcsSource\x12\x17\n" +
	"\agcs_uri\x18\x01 \x01(\tR\x06gcsUri\x1a@\n" +
	"\x10AssetContentData\x12,\n" +
	"\x12asset_content_data\x18\x01 \x01(\fR\x10assetContentDataB\r\n" +
	"\vsource_form\"\x99\x01\n" +
	"\x12UploadAssetRequest\x129\n" +
	"\x04name\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/AssetR\x04name\x12H\n" +
	"\fasset_source\x18\x02 \x01(\v2%.google.cloud.visionai.v1.AssetSourceR\vassetSource\"\x15\n" +
	"\x13UploadAssetResponse\"\x8d\x01\n" +
	"\x13UploadAssetMetadata\x129\n" +
	"\n" +
	...
	"updateTime\"X\n" +
	"\x1bGenerateRetrievalUrlRequest\x129\n" +
	"\x04name\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/AssetR\x04name\"=\n" +
	"\x1cGenerateRetrievalUrlResponse\x12\x1d\n" +
	"\n" +
	"signed_uri\x18\x01 \x01(\tR\tsignedUri\"\xa1\x02\n" +
	"\x05Asset\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12+\n" +
	"\x03ttl\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x03ttl\x12c\n" +
	"\x10asset_gcs_source\x18\x04 \x01(\v24.google.cloud.visionai.v1.AssetSource.AssetGcsSourceB\x03\xe0A\x03R\x0eassetGcsSource:r\xeaAo\n" +
	"\x1dvisionai.googleapis.com/Asset\x12Nprojects/{project_number}/locations/{location}/corpora/{corpus}/assets/{asset}\"P\n" +
	"\x13AnalyzeAssetRequest\x129\n" +
	"\x04name\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/AssetR\x04name\"\xb0\x04\n" +
	"\x14AnalyzeAssetMetadata\x12f\n" +
	"\x0fanalysis_status\x18\x01 \x03(\v2=.google.cloud.visionai.v1.AnalyzeAssetMetadata.AnalysisStatusR\x0eanalysisStatus\x129\n" +
	"\n" +
	...
	"updateTime\x1a\xb7\x02\n" +
	"\x0eAnalysisStatus\x12Y\n" +
	"\x05state\x18\x02 \x01(\x0e2C.google.cloud.visionai.v1.AnalyzeAssetMetadata.AnalysisStatus.StateR\x05state\x12%\n" +
	"\x0estatus_message\x18\x03 \x01(\tR\rstatusMessage\x12W\n" +
	"\x11search_capability\x18\x04 \x01(\v2*.google.cloud.visionai.v1.SearchCapabilityR\x10searchCapability\"J\n" +
	"\x05State\x12\x15\n" +
	...
	"\x14AnalyzeAssetResponse\"\xce\x01\n" +
	"\x0eIndexingStatus\x12I\n" +
	"\x05state\x18\x02 \x01(\x0e2..google.cloud.visionai.v1.IndexingStatus.StateB\x03\xe0A\x03R\x05state\x12%\n" +
	...
	"\x11IndexAssetRequest\x129\n" +
	"\x04name\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/AssetR\x04name\x12;\n" +
	"\x05index\x18\x02 \x01(\tB%\xe0A\x01\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/IndexR\x05index\"\xce\x01\n" +
	"\x12IndexAssetMetadata\x12@\n" +
	"\x06status\x18\x04 \x01(\v2(.google.cloud.visionai.v1.IndexingStatusR\x06status\x129\n" +
	"\n" +
	"start_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x12;\n" +
	"\vupdate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\"\x14\n" +
	"\x12IndexAssetResponse\"\x91\x01\n" +
	"\x17RemoveIndexAssetRequest\x129\n" +
	"\x04name\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/AssetR\x04name\x12;\n" +
	"\x05index\x18\x02 \x01(\tB%\xe0A\x01\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/IndexR\x05index\"\xe5\x01\n" +
	"\x18RemoveIndexAssetMetadata\x12Q\n" +
	"\x0findexing_status\x18\x01 \x01(\v2(.google.cloud.visionai.v1.IndexingStatusR\x0eindexingStatus\x129\n" +
	"\n" +
	"start_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x12;\n" +
	"\vupdate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\"\x1a\n" +
	"\x18RemoveIndexAssetResponse\"\x8c\x02\n" +
	"\fIndexedAsset\x12;\n" +
	"\x05index\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/IndexR\x05index\x12;\n" +
	"\x05asset\x18\x02 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/AssetR\x05asset\x12@\n" +
	...
	"updateTime\"\xab\x01\n" +
	"\x18ViewIndexedAssetsRequest\x12;\n" +
	"\x05index\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/IndexR\x05index\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken\x12\x16\n" +
	"\x06filter\x18\x04 \x01(\tR\x06filter\"\x92\x01\n" +
	"\x19ViewIndexedAssetsResponse\x12M\n" +
	"\x0eindexed_assets\x18\x01 \x03(\v2&.google.cloud.visionai.v1.IndexedAssetR\rindexedAssets\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"q\n" +
	"\x13CreateCorpusRequest\x12\x1b\n" +
	"\x06parent\x18\x01 \x01(\tB\x03\xe0A\x02R\x06parent\x12=\n" +
	"\x06corpus\x18\x02 \x01(\v2 .google.cloud.visionai.v1.CorpusB\x03\xe0A\x02R\x06corpus\"\x90\x01\n" +
	"\x14CreateCorpusMetadata\x12;\n" +
	"\vcreate_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x12;\n" +
	"\vupdate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\"\x8b\x01\n" +
	"\x10SearchCapability\x12C\n" +
	"\x04type\x18\x01 \x01(\x0e2/.google.cloud.visionai.v1.SearchCapability.TypeR\x04type\"2\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\x14\n" +
	"\x10EMBEDDING_SEARCH\x10\x01\"v\n" +
	"\x17SearchCapabilitySetting\x12[\n" +
	"\x13search_capabilities\x18\x01 \x03(\v2*.google.cloud.visionai.v1.SearchCapabilityR\x12searchCapabilities\"v\n" +
	"\x18CreateCollectionMetadata\x12Z\n" +
	"\x12operation_metadata\x18\x01 \x01(\v2+.google.cloud.visionai.v1.OperationMetadataR\x11operationMetadata\"\xe5\x01\n" +
	"\x17CreateCollectionRequest\x12>\n" +
	"\x06parent\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1evisionai.googleapis.com/CorpusR\x06parent\x12I\n" +
	"\n" +
	"collection\x18\x02 \x01(\v2$.google.cloud.visionai.v1.CollectionB\x03\xe0A\x02R\n" +
	"collection\x12-\n" +
	"\rcollection_id\x18\x03 \x01(\tB\x03\xe0A\x01H\x00R\fcollectionId\x88\x01\x01B\x10\n" +
	"\x0e_collection_id\"v\n" +
	"\x18DeleteCollectionMetadata\x12Z\n" +
	"\x12operation_metadata\x18\x01 \x01(\v2+.google.cloud.visionai.v1.OperationMetadataR\x11operationMetadata\"Y\n" +
	"\x17DeleteCollectionRequest\x12>\n" +
	"\x04name\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\n" +
	"\"visionai.googleapis.com/CollectionR\x04name\"V\n" +
	"\x14GetCollectionRequest\x12>\n" +
	"\x04name\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\n" +
	"\"visionai.googleapis.com/CollectionR\x04name\"\xa1\x01\n" +
	"\x17UpdateCollectionRequest\x12I\n" +
	"\n" +
	"collection\x18\x01 \x01(\v2$.google.cloud.visionai.v1.CollectionB\x03\xe0A\x02R\n" +
	"collection\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"\x98\x01\n" +
	"\x16ListCollectionsRequest\x12B\n" +
	"\x06parent\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\x12\"visionai.googleapis.com/CollectionR\x06parent\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken\"\x89\x01\n" +
	"\x17ListCollectionsResponse\x12F\n" +
	"\vcollections\x18\x01 \x03(\v2$.google.cloud.visionai.v1.CollectionR\vcollections\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"]\n" +
	"\x18AddCollectionItemRequest\x12A\n" +
	"\x04item\x18\x01 \x01(\v2(.google.cloud.visionai.v1.CollectionItemB\x03\xe0A\x02R\x04item\"Y\n" +
	"\x19AddCollectionItemResponse\x12<\n" +
	"\x04item\x18\x01 \x01(\v2(.google.cloud.visionai.v1.CollectionItemR\x04item\"`\n" +
	"\x1bRemoveCollectionItemRequest\x12A\n" +
	"\x04item\x18\x01 \x01(\v2(.google.cloud.visionai.v1.CollectionItemB\x03\xe0A\x02R\x04item\"\\\n" +
	"\x1cRemoveCollectionItemResponse\x12<\n" +
	"\x04item\x18\x01 \x01(\v2(.google.cloud.visionai.v1.CollectionItemR\x04item\"\xa4\x01\n" +
	"\x1aViewCollectionItemsRequest\x12J\n" +
	"\n" +
	"collection\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\n" +
	"\"visionai.googleapis.com/CollectionR\n" +
	"collection\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken\"\x85\x01\n" +
	"\x1bViewCollectionItemsResponse\x12>\n" +
	"\x05items\x18\x01 \x03(\v2(.google.cloud.visionai.v1.CollectionItemR\x05items\x12&\n" +
	...
	"\vdescription\x18\x03 \x01(\tB\x03\xe0A\x01R\vdescription:\x81\x01\xeaA~\n" +
	"\"visionai.googleapis.com/Collection\x12Xprojects/{project_number}/locations/{location}/corpora/{corpus}/collections/{collection}\"\xf7\x01\n" +
	"\x0eCollectionItem\x12J\n" +
	"\n" +
	"collection\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\n" +
	"\"visionai.googleapis.com/CollectionR\n" +
	"collection\x12F\n" +
	"\x04type\x18\x02 \x01(\x0e2-.google.cloud.visionai.v1.CollectionItem.TypeB\x03\xe0A\x02R\x04type\x12(\n" +
	"\ritem_resource\x18\x03 \x01(\tB\x03\xe0A\x02R\fitemResource\"'\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05ASSET\x10\x01\"\xb0\x01\n" +
	"\x12CreateIndexRequest\x12>\n" +
	"\x06parent\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1evisionai.googleapis.com/CorpusR\x06parent\x12\x1e\n" +
	"\bindex_id\x18\x02 \x01(\tB\x03\xe0A\x01R\aindexId\x12:\n" +
	"\x05index\x18\x03 \x01(\v2\x1f.google.cloud.visionai.v1.IndexB\x03\xe0A\x02R\x05index\"q\n" +
	"\x13CreateIndexMetadata\x12Z\n" +
	"\x12operation_metadata\x18\x01 \x01(\v2+.google.cloud.visionai.v1.OperationMetadataR\x11operationMetadata\"\x92\x01\n" +
	"\x12UpdateIndexRequest\x12:\n" +
	"\x05index\x18\x01 \x01(\v2\x1f.google.cloud.visionai.v1.IndexB\x03\xe0A\x02R\x05index\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"q\n" +
	"\x13UpdateIndexMetadata\x12Z\n" +
	"\x12operation_metadata\x18\x01 \x01(\v2+.google.cloud.visionai.v1.OperationMetadataR\x11operationMetadata\"L\n" +
	"\x0fGetIndexRequest\x129\n" +
	"\x04name\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/IndexR\x04name\"\x8f\x01\n" +
	"\x12ListIndexesRequest\x12=\n" +
	"\x06parent\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\x12\x1dvisionai.googleapis.com/IndexR\x06parent\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken\"x\n" +
	"\x13ListIndexesResponse\x129\n" +
	"\aindexes\x18\x01 \x03(\v2\x1f.google.cloud.visionai.v1.IndexR\aindexes\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"O\n" +
	"\x12DeleteIndexRequest\x129\n" +
	"\x04name\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/IndexR\x04name\"\x15\n" +
	"\x13DeleteIndexMetadata\"\x8e\x06\n" +
	"\x05Index\x12%\n" +
	"\rentire_corpus\x18\t \x01(\bH\x00R\fentireCorpus\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x01R\vdisplayName\x12%\n" +
	"\vdescription\x18\x03 \x01(\tB\x03\xe0A\x01R\vdescription\x12@\n" +
	"\x05state\x18\x04 \x01(\x0e2%.google.cloud.visionai.v1.Index.StateB\x03\xe0A\x03R\x05state\x12@\n" +
	"\vcreate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12@\n" +
	"\vupdate_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12`\n" +
	"\x10deployed_indexes\x18\b \x03(\v20.google.cloud.visionai.v1.DeployedIndexReferenceB\x03\xe0A\x03R\x0fdeployedIndexes\x12-\n" +
	"\rsatisfies_pzs\x18\v \x01(\bB\x03\xe0A\x03H\x01R\fsatisfiesPzs\x88\x01\x01\x12-\n" +
	"\rsatisfies_pzi\x18\f \x01(\bB\x03\xe0A\x03H\x02R\fsatisfiesPzi\x88\x01\x01\"G\n" +
	"\x05State\x12\x15\n" +
	"\x11STATE_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bCREATING\x10\x01\x12\v\n" +
	"\aCREATED\x10\x02\x12\f\n" +
	"\bUPDATING\x10\x03:s\xeaAp\n" +
	...
	"\x0e_satisfies_pzi\"n\n" +
	"\x16DeployedIndexReference\x12T\n" +
	"\x0eindex_endpoint\x18\x01 \x01(\tB-\xe0A\x05\xfaA'\n" +
	"%visionai.googleapis.com/IndexEndpointR\rindexEndpoint\"\x93\x05\n" +
	"\x06Corpus\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x02R\vdisplayName\x12%\n" +
	"\vdescription\x18\x03 \x01(\tB\x03\xe0A\x01R\vdescription\x12?\n" +
	"\vdefault_ttl\x18\x05 \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x01R\n" +
	"defaultTtl\x12>\n" +
	"\x04type\x18\a \x01(\x0e2%.google.cloud.visionai.v1.Corpus.TypeB\x03\xe0A\x01R\x04type\x12m\n" +
	"\x19search_capability_setting\x18\b \x01(\v21.google.cloud.visionai.v1.SearchCapabilitySettingR\x17searchCapabilitySetting\x12-\n" +
	"\rsatisfies_pzs\x18\v \x01(\bB\x03\xe0A\x03H\x00R\fsatisfiesPzs\x88\x01\x01\x12-\n" +
	"\rsatisfies_pzi\x18\f \x01(\bB\x03\xe0A\x03H\x01R\fsatisfiesPzi\x88\x01\x01\"N\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fSTREAM_VIDEO\x10\x01\x12\t\n" +
	...
	"\x04name\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1evisionai.googleapis.com/CorpusR\x04name\"\x91\x01\n" +
	"\x13UpdateCorpusRequest\x12=\n" +
	"\x06corpus\x18\x01 \x01(\v2 .google.cloud.visionai.v1.CorpusB\x03\xe0A\x02R\x06corpus\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"\x85\x01\n" +
	"\x12ListCorporaRequest\x12\x1b\n" +
	...
	"\acorpora\x18\x01 \x03(\v2 .google.cloud.visionai.v1.CorpusR\acorpora\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"Q\n" +
	"\x13DeleteCorpusRequest\x12:\n" +
	"\x04name\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1evisionai.googleapis.com/CorpusR\x04name\"R\n" +
	"\x14AnalyzeCorpusRequest\x12:\n" +
	"\x04name\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1evisionai.googleapis.com/CorpusR\x04name\"`\n" +
	"\x15AnalyzeCorpusMetadata\x12G\n" +
	"\bmetadata\x18\x01 \x01(\v2+.google.cloud.visionai.v1.OperationMetadataR\bmetadata\"\x17\n" +
	"\x15AnalyzeCorpusResponse\"\xa5\x01\n" +
	"\x17CreateDataSchemaRequest\x12>\n" +
	"\x06parent\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1evisionai.googleapis.com/CorpusR\x06parent\x12J\n" +
	"\vdata_schema\x18\x02 \x01(\v2$.google.cloud.visionai.v1.DataSchemaB\x03\xe0A\x02R\n" +
	"dataSchema\"\x90\x02\n" +
	"\n" +
	"DataSchema\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x15\n" +
	"\x03key\x18\x02 \x01(\tB\x03\xe0A\x02R\x03key\x12R\n" +
	"\x0eschema_details\x18\x03 \x01(\v2+.google.cloud.visionai.v1.DataSchemaDetailsR\rschemaDetails:\x82\x01\xeaA\x7f\n" +
	"\"visionai.googleapis.com/DataSchema\x12Yprojects/{project_number}/locations/{location}/corpora/{corpus}/dataSchemas/{data_schema}\"\xa2\x0e\n" +
	"\x11DataSchemaDetails\x12M\n" +
	"\x04type\x18\x01 \x01(\x0e24.google.cloud.visionai.v1.DataSchemaDetails.DataTypeH\x00R\x04type\x88\x01\x01\x12d\n" +
	"\x10proto_any_config\x18\x06 \x01(\v2:.google.cloud.visionai.v1.DataSchemaDetails.ProtoAnyConfigR\x0eprotoAnyConfig\x12W\n" +
	"\vlist_config\x18\b \x01(\v26.google.cloud.visionai.v1.DataSchemaDetails.ListConfigR\n" +
	"listConfig\x12|\n" +
	"\x18customized_struct_config\x18\t \x01(\v2B.google.cloud.visionai.v1.DataSchemaDetails.CustomizedStructConfigR\x16customizedStructConfig\x12^\n" +
	"\vgranularity\x18\x05 \x01(\x0e27.google.cloud.visionai.v1.DataSchemaDetails.GranularityH\x01R\vgranularity\x88\x01\x01\x12c\n" +
	"\x0fsearch_strategy\x18\a \x01(\v2:.google.cloud.visionai.v1.DataSchemaDetails.SearchStrategyR\x0esearchStrategy\x1a+\n" +
	"\x0eProtoAnyConfig\x12\x19\n" +
	"\btype_uri\x18\x01 \x01(\tR\atypeUri\x1a\\\n" +
	"\n" +
	"ListConfig\x12N\n" +
	"\fvalue_schema\x18\x01 \x01(\v2+.google.cloud.visionai.v1.DataSchemaDetailsR\vvalueSchema\x1a\x81\x02\n" +
	"\x16CustomizedStructConfig\x12y\n" +
	"\rfield_schemas\x18\x01 \x03(\v2T.google.cloud.visionai.v1.DataSchemaDetails.CustomizedStructConfig.FieldSchemasEntryR\ffieldSchemas\x1al\n" +
	"\x11FieldSchemasEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12A\n" +
	"\x05value\x18\x02 \x01(\v2+.google.cloud.visionai.v1.DataSchemaDetailsR\x05value:\x028\x01\x1a\xfe\x03\n" +
	"\x0eSearchStrategy\x12\x84\x01\n" +
	"\x14search_strategy_type\x18\x01 \x01(\x0e2M.google.cloud.visionai.v1.DataSchemaDetails.SearchStrategy.SearchStrategyTypeH\x00R\x12searchStrategyType\x88\x01\x01\x12\x9d\x01\n" +
	"\x1dconfidence_score_index_config\x18\x02 \x01(\v2U.google.cloud.visionai.v1.DataSchemaDetails.SearchStrategy.ConfidenceScoreIndexConfigB\x03\xe0A\x01R\x1aconfidenceScoreIndexConfig\x1ac\n" +
	"\x1aConfidenceScoreIndexConfig\x12\"\n" +
	"\n" +
	"field_path\x18\x01 \x01(\tB\x03\xe0A\x02R\tfieldPath\x12!\n" +
	"\tthreshold\x18\x02 \x01(\x02B\x03\xe0A\x02R\tthreshold\"G\n" +
	"\x12SearchStrategyType\x12\r\n" +
	"\tNO_SEARCH\x10\x00\x12\x10\n" +
	"\fEXACT_SEARCH\x10\x01\x12\x10\n" +
	"\fSMART_SEARCH\x10\x02B\x17\n" +
	...
	"\bDATETIME\x10\x05\x12\x12\n" +
	"\x0eGEO_COORDINATE\x10\a\x12\r\n" +
	"\tPROTO_ANY\x10\b\x12\v\n" +
	"\aBOOLEAN\x10\t\x12\b\n" +
	"\x04LIST\x10\n" +
	"\x12\x15\n" +
	...
	"\x1bGRANULARITY_PARTITION_LEVEL\x10\x02B\a\n" +
	"\x05_typeB\x0e\n" +
	"\f_granularity\"\xa2\x01\n" +
	"\x17UpdateDataSchemaRequest\x12J\n" +
	"\vdata_schema\x18\x01 \x01(\v2$.google.cloud.visionai.v1.DataSchemaB\x03\xe0A\x02R\n" +
	"dataSchema\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"V\n" +
	"\x14GetDataSchemaRequest\x12>\n" +
	"\x04name\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\n" +
	"\"visionai.googleapis.com/DataSchemaR\x04name\"Y\n" +
	"\x17DeleteDataSchemaRequest\x12>\n" +
	"\x04name\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\n" +
	"\"visionai.googleapis.com/DataSchemaR\x04name\"\x98\x01\n" +
	"\x16ListDataSchemasRequest\x12B\n" +
	"\x06parent\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\x12\"visionai.googleapis.com/DataSchemaR\x06parent\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken\"\x8a\x01\n" +
	"\x17ListDataSchemasResponse\x12G\n" +
	"\fdata_schemas\x18\x01 \x03(\v2$.google.cloud.visionai.v1.DataSchemaR\vdataSchemas\x12&\n" +
	...
	"\x1dvisionai.googleapis.com/AssetR\x06parent\x12I\n" +
	"\n" +
	"annotation\x18\x02 \x01(\v2$.google.cloud.visionai.v1.AnnotationB\x03\xe0A\x02R\n" +
	"annotation\x12-\n" +
	"\rannotation_id\x18\x03 \x01(\tB\x03\xe0A\x01H\x00R\fannotationId\x88\x01\x01B\x10\n" +
	"\x0e_annotation_id\"\xa3\x02\n" +
	"\n" +
	"Annotation\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12m\n" +
	"\x19user_specified_annotation\x18\x02 \x01(\v21.google.cloud.visionai.v1.UserSpecifiedAnnotationR\x17userSpecifiedAnnotation:\x91\x01\xeaA\x8d\x01\n" +
	"\"visionai.googleapis.com/Annotation\x12gprojects/{project_number}/locations/{location}/corpora/{corpus}/assets/{asset}/annotations/{annotation}\"\xb4\x01\n" +
	"\x17UserSpecifiedAnnotation\x12\x15\n" +
	"\x03key\x18\x01 \x01(\tB\x03\xe0A\x02R\x03key\x12?\n" +
	"\x05value\x18\x02 \x01(\v2).google.cloud.visionai.v1.AnnotationValueR\x05value\x12A\n" +
	"\tpartition\x18\x03 \x01(\v2#.google.cloud.visionai.v1.PartitionR\tpartition\"I\n" +
	"\rGeoCoordinate\x12\x1a\n" +
	"\blatitude\x18\x01 \x01(\x01R\blatitude\x12\x1c\n" +
	"\tlongitude\x18\x02 \x01(\x01R\tlongitude\"\xee\x04\n" +
	"\x0fAnnotationValue\x12\x1d\n" +
	...
	"\x0edatetime_value\x18\x05 \x01(\tH\x00R\rdatetimeValue\x12P\n" +
	"\x0egeo_coordinate\x18\a \x01(\v2'.google.cloud.visionai.v1.GeoCoordinateH\x00R\rgeoCoordinate\x12>\n" +
	"\x0fproto_any_value\x18\b \x01(\v2\x14.google.protobuf.AnyH\x00R\rprotoAnyValue\x12\x1f\n" +
	"\n" +
	"bool_value\x18\t \x01(\bH\x00R\tboolValue\x12Z\n" +
	"\x1ccustomized_struct_data_value\x18\n" +
	" \x01(\v2\x17.google.protobuf.StructH\x00R\x19customizedStructDataValue\x12I\n" +
	"\n" +
	"list_value\x18\v \x01(\v2(.google.cloud.visionai.v1.AnnotationListH\x00R\tlistValue\x12n\n" +
	"\x17customized_struct_value\x18\x06 \x01(\v24.google.cloud.visionai.v1.AnnotationCustomizedStructH\x00R\x15customizedStructValueB\a\n" +
	"\x05value\"S\n" +
	"\x0eAnnotationList\x12A\n" +
	"\x06values\x18\x01 \x03(\v2).google.cloud.visionai.v1.AnnotationValueR\x06values\"\xe4\x01\n" +
	"\x1aAnnotationCustomizedStruct\x12^\n" +
	"\belements\x18\x02 \x03(\v2B.google.cloud.visionai.v1.AnnotationCustomizedStruct.ElementsEntryR\belements\x1af\n" +
	"\rElementsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12?\n" +
	"\x05value\x18\x02 \x01(\v2).google.cloud.visionai.v1.AnnotationValueR\x05value:\x028\x01\"\xa8\x01\n" +
	"\x16ListAnnotationsRequest\x12:\n" +
	"\x06parent\x18\x01 \x01(\tB\"\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/AssetR\x06parent\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken\x12\x16\n" +
	"\x06filter\x18\x04 \x01(\tR\x06filter\"\x89\x01\n" +
	"\x17ListAnnotationsResponse\x12F\n" +
	"\vannotations\x18\x01 \x03(\v2$.google.cloud.visionai.v1.AnnotationR\vannotations\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"V\n" +
	"\x14GetAnnotationRequest\x12>\n" +
	"\x04name\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\n" +
	"\"visionai.googleapis.com/AnnotationR\x04name\"\xa1\x01\n" +
	"\x17UpdateAnnotationRequest\x12I\n" +
	"\n" +
	"annotation\x18\x01 \x01(\v2$.google.cloud.visionai.v1.AnnotationB\x03\xe0A\x02R\n" +
	"annotation\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"Y\n" +
	"\x17DeleteAnnotationRequest\x12>\n" +
	"\x04name\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\n" +
	"\"visionai.googleapis.com/AnnotationR\x04name\"\x87\x01\n" +
	"\x13ImportAssetsRequest\x12&\n" +
	"\x0eassets_gcs_uri\x18\x02 \x01(\tH\x00R\fassetsGcsUri\x12>\n" +
	"\x06parent\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1evisionai.googleapis.com/CorpusR\x06parentB\b\n" +
	"\x06source\"\xa7\x01\n" +
	"\x14ImportAssetsMetadata\x12G\n" +
	"\bmetadata\x18\x01 \x01(\v2+.google.cloud.visionai.v1.OperationMetadataR\bmetadata\x12F\n" +
	"\x06status\x18\x02 \x01(\v2..google.cloud.visionai.v1.BatchOperationStatusR\x06status\"`\n" +
	"\x14BatchOperationStatus\x12#\n" +
	"\rsuccess_count\x18\x01 \x01(\x05R\fsuccessCount\x12#\n" +
	"\rfailure_count\x18\x02 \x01(\x05R\ffailureCount\"\x16\n" +
	"\x14ImportAssetsResponse\"\xe2\x01\n" +
	"\x19CreateSearchConfigRequest\x12D\n" +
	"\x06parent\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\x12$visionai.googleapis.com/SearchConfigR\x06parent\x12P\n" +
	"\rsearch_config\x18\x02 \x01(\v2&.google.cloud.visionai.v1.SearchConfigB\x03\xe0A\x02R\fsearchConfig\x12-\n" +
	"\x10search_config_id\x18\x03 \x01(\tB\x03\xe0A\x02R\x0esearchConfigId\"\xaa\x01\n" +
	"\x19UpdateSearchConfigRequest\x12P\n" +
	"\rsearch_config\x18\x01 \x01(\v2&.google.cloud.visionai.v1.SearchConfigB\x03\xe0A\x02R\fsearchConfig\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"Z\n" +
	"\x16GetSearchConfigRequest\x12@\n" +
	"\x04name\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\n" +
	"$visionai.googleapis.com/SearchConfigR\x04name\"]\n" +
	"\x19DeleteSearchConfigRequest\x12@\n" +
	"\x04name\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\n" +
	"$visionai.googleapis.com/SearchConfigR\x04name\"\x9c\x01\n" +
	"\x18ListSearchConfigsRequest\x12D\n" +
	"\x06parent\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\x12$visionai.googleapis.com/SearchConfigR\x06parent\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken\"\x92\x01\n" +
	"\x19ListSearchConfigsResponse\x12M\n" +
	"\x0esearch_configs\x18\x01 \x03(\v2&.google.cloud.visionai.v1.SearchConfigR\rsearchConfigs\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xea\x02\n" +
	"\fSearchConfig\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12N\n" +
	"\x0efacet_property\x18\x02 \x01(\v2'.google.cloud.visionai.v1.FacetPropertyR\rfacetProperty\x12j\n" +
	"\x18search_criteria_property\x18\x03 \x01(\v20.google.cloud.visionai.v1.SearchCriteriaPropertyR\x16searchCriteriaProperty:\x89\x01\xeaA\x85\x01\n" +
	"$visionai.googleapis.com/SearchConfig\x12]projects/{project_number}/locations/{location}/corpora/{corpus}/searchConfigs/{search_config}\"\xf3\x06\n" +
	"\rIndexEndpoint\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x01R\vdisplayName\x12%\n" +
	"\vdescription\x18\x03 \x01(\tB\x03\xe0A\x01R\vdescription\x12S\n" +
	"\x0edeployed_index\x18\t \x01(\v2'.google.cloud.visionai.v1.DeployedIndexB\x03\xe0A\x03R\rdeployedIndex\x12H\n" +
	"\x05state\x18\x05 \x01(\x0e2-.google.cloud.visionai.v1.IndexEndpoint.StateB\x03\xe0A\x03R\x05state\x12P\n" +
	"\x06labels\x18\x06 \x03(\v23.google.cloud.visionai.v1.IndexEndpoint.LabelsEntryB\x03\xe0A\x01R\x06labels\x12@\n" +
	...
	"updateTime\x12-\n" +
	"\rsatisfies_pzs\x18\n" +
	" \x01(\bB\x03\xe0A\x03H\x00R\fsatisfiesPzs\x88\x01\x01\x12-\n" +
	"\rsatisfies_pzi\x18\v \x01(\bB\x03\xe0A\x03H\x01R\fsatisfiesPzi\x88\x01\x01\x1a9\n" +
	...
	"\x0e_satisfies_pzsB\x10\n" +
	"\x0e_satisfies_pzi\"\xe5\x01\n" +
	"\x1aCreateIndexEndpointRequest\x12A\n" +
	"\x06parent\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!locations.googleapis.com/LocationR\x06parent\x12/\n" +
	"\x11index_endpoint_id\x18\x02 \x01(\tB\x03\xe0A\x01R\x0findexEndpointId\x12S\n" +
	"\x0eindex_endpoint\x18\x03 \x01(\v2'.google.cloud.visionai.v1.IndexEndpointB\x03\xe0A\x02R\rindexEndpoint\"y\n" +
	"\x1bCreateIndexEndpointMetadata\x12Z\n" +
	"\x12operation_metadata\x18\x01 \x01(\v2+.google.cloud.visionai.v1.OperationMetadataR\x11operationMetadata\"\\\n" +
	"\x17GetIndexEndpointRequest\x12A\n" +
	"\x04name\x18\x01 \x01(\tB-\xe0A\x02\xfaA'\n" +
	"%visionai.googleapis.com/IndexEndpointR\x04name\"\xc1\x01\n" +
	...
	"\x1aListIndexEndpointsResponse\x12P\n" +
	"\x0findex_endpoints\x18\x01 \x03(\v2'.google.cloud.visionai.v1.IndexEndpointR\x0eindexEndpoints\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xb3\x01\n" +
	"\x1aUpdateIndexEndpointRequest\x12S\n" +
	"\x0eindex_endpoint\x18\x01 \x01(\v2'.google.cloud.visionai.v1.IndexEndpointB\x03\xe0A\x02R\rindexEndpoint\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"y\n" +
	"\x1bUpdateIndexEndpointMetadata\x12Z\n" +
	"\x12operation_metadata\x18\x01 \x01(\v2+.google.cloud.visionai.v1.OperationMetadataR\x11operationMetadata\"_\n" +
	"\x1aDeleteIndexEndpointRequest\x12A\n" +
	"\x04name\x18\x01 \x01(\tB-\xe0A\x02\xfaA'\n" +
	"%visionai.googleapis.com/IndexEndpointR\x04name\"y\n" +
	"\x1bDeleteIndexEndpointMetadata\x12Z\n" +
	"\x12operation_metadata\x18\x01 \x01(\v2+.google.cloud.visionai.v1.OperationMetadataR\x11operationMetadata\"\xbf\x01\n" +
	"\x12DeployIndexRequest\x12T\n" +
	"\x0eindex_endpoint\x18\x01 \x01(\tB-\xe0A\x02\xfaA'\n" +
	"%visionai.googleapis.com/IndexEndpointR\rindexEndpoint\x12S\n" +
	"\x0edeployed_index\x18\x03 \x01(\v2'.google.cloud.visionai.v1.DeployedIndexB\x03\xe0A\x02R\rdeployedIndex\"\x15\n" +
	"\x13DeployIndexResponse\"\xbf\x01\n" +
	"\x13DeployIndexMetadata\x12Z\n" +
	"\x12operation_metadata\x18\x01 \x01(\v2+.google.cloud.visionai.v1.OperationMetadataR\x11operationMetadata\x12L\n" +
	"\x0edeployed_index\x18\x02 \x01(\tB%\xe0A\x03\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/IndexR\rdeployedIndex\"\xc1\x01\n" +
	"\x15UndeployIndexMetadata\x12Z\n" +
	"\x12operation_metadata\x18\x01 \x01(\v2+.google.cloud.visionai.v1.OperationMetadataR\x11operationMetadata\x12L\n" +
	"\x0edeployed_index\x18\x02 \x01(\tB%\xe0A\x03\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/IndexR\rdeployedIndex\"l\n" +
	"\x14UndeployIndexRequest\x12T\n" +
	"\x0eindex_endpoint\x18\x01 \x01(\tB-\xe0A\x02\xfaA'\n" +
	"%visionai.googleapis.com/IndexEndpointR\rindexEndpoint\"\x17\n" +
	"\x15UndeployIndexResponse\"L\n" +
	"\rDeployedIndex\x12;\n" +
	"\x05index\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/IndexR\x05index\"\xbd\b\n" +
	"\rFacetProperty\x12u\n" +
	"\x17fixed_range_bucket_spec\x18\x05 \x01(\v2<.google.cloud.visionai.v1.FacetProperty.FixedRangeBucketSpecH\x00R\x14fixedRangeBucketSpec\x12x\n" +
	"\x18custom_range_bucket_spec\x18\x06 \x01(\v2=.google.cloud.visionai.v1.FacetProperty.CustomRangeBucketSpecH\x00R\x15customRangeBucketSpec\x12n\n" +
	"\x14datetime_bucket_spec\x18\a \x01(\v2:.google.cloud.visionai.v1.FacetProperty.DateTimeBucketSpecH\x00R\x12datetimeBucketSpec\x12#\n" +
	"\rmapped_fields\x18\x01 \x03(\tR\fmappedFields\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x12\x1f\n" +
	"\vresult_size\x18\x03 \x01(\x03R\n" +
	"resultSize\x12J\n" +
	"\vbucket_type\x18\x04 \x01(\x0e2).google.cloud.visionai.v1.FacetBucketTypeR\n" +
	"bucketType\x1a\xd7\x01\n" +
	"\x14FixedRangeBucketSpec\x12G\n" +
	"\fbucket_start\x18\x01 \x01(\v2$.google.cloud.visionai.v1.FacetValueR\vbucketStart\x12S\n" +
	"\x12bucket_granularity\x18\x02 \x01(\v2$.google.cloud.visionai.v1.FacetValueR\x11bucketGranularity\x12!\n" +
	"\fbucket_count\x18\x03 \x01(\x05R\vbucketCount\x1a[\n" +
	"\x15CustomRangeBucketSpec\x12B\n" +
	"\tendpoints\x18\x01 \x03(\v2$.google.cloud.visionai.v1.FacetValueR\tendpoints\x1a\xc8\x01\n" +
	"\x12DateTimeBucketSpec\x12h\n" +
	"\vgranularity\x18\x01 \x01(\x0e2F.google.cloud.visionai.v1.FacetProperty.DateTimeBucketSpec.GranularityR\vgranularity\"H\n" +
	"\vGranularity\x12\x1b\n" +
	"\x17GRANULARITY_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04YEAR\x10\x01\x12\t\n" +
	"\x05MONTH\x10\x02\x12\a\n" +
	"\x03DAY\x10\x03B\x14\n" +
	"\x12range_facet_config\"\xf8\x01\n" +
	"\x0eSearchHypernym\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1f\n" +
	"\bhypernym\x18\x02 \x01(\tB\x03\xe0A\x01R\bhypernym\x12\x1f\n" +
	"\bhyponyms\x18\x03 \x03(\tB\x03\xe0A\x01R\bhyponyms:\x8f\x01\xeaA\x8b\x01\n" +
	"&visionai.googleapis.com/SearchHypernym\x12aprojects/{project_number}/locations/{location}/corpora/{corpus}/searchHypernyms/{search_hypernym}\"\x84\x02\n" +
	"\x1bCreateSearchHypernymRequest\x12>\n" +
	"\x06parent\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1evisionai.googleapis.com/CorpusR\x06parent\x12V\n" +
	"\x0fsearch_hypernym\x18\x02 \x01(\v2(.google.cloud.visionai.v1.SearchHypernymB\x03\xe0A\x02R\x0esearchHypernym\x126\n" +
	"\x12search_hypernym_id\x18\x03 \x01(\tB\x03\xe0A\x01H\x00R\x10searchHypernymId\x88\x01\x01B\x15\n" +
	"\x13_search_hypernym_id\"\xb2\x01\n" +
	"\x1bUpdateSearchHypernymRequest\x12V\n" +
	"\x0fsearch_hypernym\x18\x01 \x01(\v2(.google.cloud.visionai.v1.SearchHypernymB\x03\xe0A\x02R\x0esearchHypernym\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"^\n" +
	"\x18GetSearchHypernymRequest\x12B\n" +
	"\x04name\x18\x01 \x01(\tB.\xe0A\x02\xfaA(\n" +
	"&visionai.googleapis.com/SearchHypernymR\x04name\"a\n" +
	"\x1bDeleteSearchHypernymRequest\x12B\n" +
	"\x04name\x18\x01 \x01(\tB.\xe0A\x02\xfaA(\n" +
	"&visionai.googleapis.com/SearchHypernymR\x04name\"\xa0\x01\n" +
	"\x1aListSearchHypernymsRequest\x12F\n" +
	"\x06parent\x18\x01 \x01(\tB.\xe0A\x02\xfaA(\x12&visionai.googleapis.com/SearchHypernymR\x06parent\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken\"\x9a\x01\n" +
	"\x1bListSearchHypernymsResponse\x12S\n" +
	"\x10search_hypernyms\x18\x01 \x03(\v2(.google.cloud.visionai.v1.SearchHypernymR\x0fsearchHypernyms\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"=\n" +
	"\x16SearchCriteriaProperty\x12#\n" +
	"\rmapped_fields\x18\x01 \x03(\tR\fmappedFields\"\xa1\x01\n" +
	"\n" +
	"FacetValue\x12#\n" +
	"\fstring_value\x18\x01 \x01(\tH\x00R\vstringValue\x12%\n" +
	"\rinteger_value\x18\x02 \x01(\x03H\x00R\fintegerValue\x12>\n" +
	"\x0edatetime_value\x18\x03 \x01(\v2\x15.google.type.DateTimeH\x00R\rdatetimeValueB\a\n" +
	"\x05value\"\xb9\x02\n" +
	"\vFacetBucket\x12<\n" +
	"\x05value\x18\x02 \x01(\v2$.google.cloud.visionai.v1.FacetValueH\x00R\x05value\x12C\n" +
	"\x05range\x18\x04 \x01(\v2+.google.cloud.visionai.v1.FacetBucket.RangeH\x00R\x05range\x12\x1a\n" +
	"\bselected\x18\x03 \x01(\bR\bselected\x1a{\n" +
	"\x05Range\x12:\n" +
	"\x05start\x18\x01 \x01(\v2$.google.cloud.visionai.v1.FacetValueR\x05start\x126\n" +
	"\x03end\x18\x02 \x01(\v2$.google.cloud.visionai.v1.FacetValueR\x03endB\x0e\n" +
	"\fbucket_value\"\x93\x02\n" +
	"\n" +
	"FacetGroup\x12\x19\n" +
	"\bfacet_id\x18\x01 \x01(\tR\afacetId\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x12?\n" +
	"\abuckets\x18\x03 \x03(\v2%.google.cloud.visionai.v1.FacetBucketR\abuckets\x12J\n" +
	"\vbucket_type\x18\x04 \x01(\x0e2).google.cloud.visionai.v1.FacetBucketTypeR\n" +
	"bucketType\x12:\n" +
	"\x19fetch_matched_annotations\x18\x05 \x01(\bR\x17fetchMatchedAnnotations\"\xfe\x05\n" +
	"\x12IngestAssetRequest\x12M\n" +
	"\x06config\x18\x01 \x01(\v23.google.cloud.visionai.v1.IngestAssetRequest.ConfigH\x00R\x06config\x12j\n" +
	"\x11time_indexed_data\x18\x02 \x01(\v2<.google.cloud.visionai.v1.IngestAssetRequest.TimeIndexedDataH\x00R\x0ftimeIndexedData\x1a\x89\x03\n" +
	"\x06Config\x12^\n" +
	"\n" +
	"video_type\x18\x02 \x01(\v2=.google.cloud.visionai.v1.IngestAssetRequest.Config.VideoTypeH\x00R\tvideoType\x12;\n" +
	"\x05asset\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/AssetR\x05asset\x1a\xd4\x01\n" +
	"\tVideoType\x12x\n" +
	"\x10container_format\x18\x01 \x01(\x0e2M.google.cloud.visionai.v1.IngestAssetRequest.Config.VideoType.ContainerFormatR\x0fcontainerFormat\"M\n" +
	"\x0fContainerFormat\x12 \n" +
	"\x1cCONTAINER_FORMAT_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14CONTAINER_FORMAT_MP4\x10\x01B\v\n" +
	"\tdata_type\x1a\x8b\x01\n" +
	"\x0fTimeIndexedData\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\x12d\n" +
	"\x12temporal_partition\x18\x02 \x01(\v25.google.cloud.visionai.v1.Partition.TemporalPartitionR\x11temporalPartitionB\x13\n" +
	"\x11streaming_request\"\x94\x01\n" +
	"\x13IngestAssetResponse\x12}\n" +
	"\x1fsuccessfully_ingested_partition\x18\x01 \x01(\v25.google.cloud.visionai.v1.Partition.TemporalPartitionR\x1dsuccessfullyIngestedPartition\"\xb8\x01\n" +
	"\x10ClipAssetRequest\x129\n" +
	"\x04name\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/AssetR\x04name\x12i\n" +
	"\x12temporal_partition\x18\x02 \x01(\v25.google.cloud.visionai.v1.Partition.TemporalPartitionB\x03\xe0A\x02R\x11temporalPartition\"\x86\x02\n" +
	"\x11ClipAssetResponse\x12f\n" +
	"\x11time_indexed_uris\x18\x01 \x03(\v2:.google.cloud.visionai.v1.ClipAssetResponse.TimeIndexedUriR\x0ftimeIndexedUris\x1a\x88\x01\n" +
	"\x0eTimeIndexedUri\x12d\n" +
	"\x12temporal_partition\x18\x01 \x01(\v25.google.cloud.visionai.v1.Partition.TemporalPartitionR\x11temporalPartition\x12\x10\n" +
	"\x03uri\x18\x02 \x01(\tR\x03uri\"\xe6\x01\n" +
	"\x15GenerateHlsUriRequest\x129\n" +
	"\x04name\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/AssetR\x04name\x12f\n" +
	"\x13temporal_partitions\x18\x02 \x03(\v25.google.cloud.visionai.v1.Partition.TemporalPartitionR\x12temporalPartitions\x12*\n" +
	"\x11live_view_enabled\x18\x03 \x01(\bR\x0fliveViewEnabled\"\x92\x01\n" +
	"\x16GenerateHlsUriResponse\x12\x10\n" +
	"\x03uri\x18\x01 \x01(\tR\x03uri\x12f\n" +
	"\x13temporal_partitions\x18\x02 \x03(\v25.google.cloud.visionai.v1.Partition.TemporalPartitionR\x12temporalPartitions\"\xdb\x04\n" +
	"\x13SearchAssetsRequest\x12s\n" +
	"\x1bschema_key_sorting_strategy\x18\t \x01(\v22.google.cloud.visionai.v1.SchemaKeySortingStrategyH\x00R\x18schemaKeySortingStrategy\x12>\n" +
	"\x06corpus\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1evisionai.googleapis.com/CorpusR\x06corpus\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken\x12\\\n" +
	"\x13content_time_ranges\x18\x05 \x01(\v2,.google.cloud.visionai.v1.DateTimeRangeArrayR\x11contentTimeRanges\x12>\n" +
	"\bcriteria\x18\x04 \x03(\v2\".google.cloud.visionai.v1.CriteriaR\bcriteria\x12O\n" +
	"\x10facet_selections\x18\x06 \x03(\v2$.google.cloud.visionai.v1.FacetGroupR\x0ffacetSelections\x124\n" +
	"\x16result_annotation_keys\x18\b \x03(\tR\x14resultAnnotationKeys\x12!\n" +
	"\fsearch_query\x18\n" +
	" \x01(\tR\vsearchQueryB\v\n" +
	"\tsort_spec\"\xb4\x03\n" +
	"\x1aSearchIndexEndpointRequest\x12G\n" +
	"\vimage_query\x18\x02 \x01(\v2$.google.cloud.visionai.v1.ImageQueryH\x00R\n" +
	"imageQuery\x12\x1f\n" +
	"\n" +
	"text_query\x18\x03 \x01(\tH\x00R\ttextQuery\x12T\n" +
	"\x0eindex_endpoint\x18\x01 \x01(\tB-\xe0A\x02\xfaA'\n" +
	"%visionai.googleapis.com/IndexEndpointR\rindexEndpoint\x12>\n" +
	"\bcriteria\x18\x04 \x03(\v2\".google.cloud.visionai.v1.CriteriaR\bcriteria\x12Q\n" +
	"\x12exclusion_criteria\x18\a \x03(\v2\".google.cloud.visionai.v1.CriteriaR\x11exclusionCriteria\x12\x1b\n" +
	"\tpage_size\x18\x05 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x06 \x01(\tR\tpageTokenB\a\n" +
	"\x05query\"t\n" +
	"\n" +
	"ImageQuery\x12!\n" +
	"\vinput_image\x18\x01 \x01(\fH\x00R\n" +
	"inputImage\x12:\n" +
	"\x05asset\x18\x02 \x01(\tB\"\xfaA\x1f\n" +
	"\x1dvisionai.googleapis.com/AssetH\x00R\x05assetB\a\n" +
	"\x05image\"\xcd\x03\n" +
	"\x18SchemaKeySortingStrategy\x12S\n" +
	"\aoptions\x18\x01 \x03(\v29.google.cloud.visionai.v1.SchemaKeySortingStrategy.OptionR\aoptions\x1a\xdb\x02\n" +
	"\x06Option\x12&\n" +
	"\x0fdata_schema_key\x18\x01 \x01(\tR\rdataSchemaKey\x12'\n" +
	"\x0fsort_decreasing\x18\x02 \x01(\bR\x0esortDecreasing\x12y\n" +
	"\x10aggregate_method\x18\x03 \x01(\x0e2I.google.cloud.visionai.v1.SchemaKeySortingStrategy.Option.AggregateMethodH\x00R\x0faggregateMethod\x88\x01\x01\"p\n" +
	...
	"\x13DeleteAssetMetadata\"\xdd\x01\n" +
	"\x18AnnotationMatchingResult\x12>\n" +
	"\bcriteria\x18\x01 \x01(\v2\".google.cloud.visionai.v1.CriteriaR\bcriteria\x12U\n" +
	"\x13matched_annotations\x18\x02 \x03(\v2$.google.cloud.visionai.v1.AnnotationR\x12matchedAnnotations\x12*\n" +
	"\x06status\x18\x03 \x01(\v2\x12.google.rpc.StatusR\x06status\"\xbd\x03\n" +
	"\x10SearchResultItem\x12\x14\n" +
	"\x05asset\x18\x01 \x01(\tR\x05asset\x12U\n" +
	"\bsegments\x18\x02 \x03(\v25.google.cloud.visionai.v1.Partition.TemporalPartitionB\x02\x18\x01R\bsegments\x12O\n" +
	"\asegment\x18\x05 \x01(\v25.google.cloud.visionai.v1.Partition.TemporalPartitionR\asegment\x12\x1c\n" +
	"\trelevance\x18\x06 \x01(\x01R\trelevance\x12Y\n" +
	"\x15requested_annotations\x18\x03 \x03(\v2$.google.cloud.visionai.v1.AnnotationR\x14requestedAnnotations\x12r\n" +
	"\x1bannotation_matching_results\x18\x04 \x03(\v22.google.cloud.visionai.v1.AnnotationMatchingResultR\x19annotationMatchingResults\"\xe5\x01\n" +
	"\x14SearchAssetsResponse\x12Z\n" +
	"\x13search_result_items\x18\x01 \x03(\v2*.google.cloud.visionai.v1.SearchResultItemR\x11searchResultItems\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12I\n" +
	"\rfacet_results\x18\x03 \x03(\v2$.google.cloud.visionai.v1.FacetGroupR\ffacetResults\"\xa1\x01\n" +
	"\x1bSearchIndexEndpointResponse\x12Z\n" +
	"\x13search_result_items\x18\x01 \x03(\v2*.google.cloud.visionai.v1.SearchResultItemR\x11searchResultItems\x12&\n" +
	...
	"\x03end\x18\x02 \x01(\x02H\x01R\x03end\x88\x01\x01B\b\n" +
	"\x06_startB\x06\n" +
	"\x04_end\",\n" +
	"\vStringArray\x12\x1d\n" +
	"\n" +
	"txt_values\x18\x01 \x03(\tR\ttxtValues\"R\n" +
	"\rIntRangeArray\x12A\n" +
	"\n" +
	"int_ranges\x18\x01 \x03(\v2\".google.cloud.visionai.v1.IntRangeR\tintRanges\"Z\n" +
	"\x0fFloatRangeArray\x12G\n" +
	"\ffloat_ranges\x18\x01 \x03(\v2$.google.cloud.visionai.v1.FloatRangeR\vfloatRanges\"e\n" +
	"\rDateTimeRange\x12+\n" +
	"\x05start\x18\x01 \x01(\v2\x15.google.type.DateTimeR\x05start\x12'\n" +
	"\x03end\x18\x02 \x01(\v2\x15.google.type.DateTimeR\x03end\"g\n" +
	"\x12DateTimeRangeArray\x12Q\n" +
	"\x10date_time_ranges\x18\x01 \x03(\v2'.google.cloud.visionai.v1.DateTimeRangeR\x0edateTimeRanges\"i\n" +
	"\n" +
	"CircleArea\x12\x1a\n" +
	"\blatitude\x18\x01 \x01(\x01R\blatitude\x12\x1c\n" +
	"\tlongitude\x18\x02 \x01(\x01R\tlongitude\x12!\n" +
	"\fradius_meter\x18\x03 \x01(\x01R\vradiusMeter\"[\n" +
	"\x10GeoLocationArray\x12G\n" +
	"\fcircle_areas\x18\x01 \x03(\v2$.google.cloud.visionai.v1.CircleAreaR\vcircleAreas\"!\n" +
	"\tBoolValue\x12\x14\n" +
	"\x05value\x18\x01 \x01(\bR\x05value\"\xde\x04\n" +
	"\bCriteria\x12F\n" +
	"\n" +
	"text_array\x18\x02 \x01(\v2%.google.cloud.visionai.v1.StringArrayH\x00R\ttextArray\x12Q\n" +
	"\x0fint_range_array\x18\x03 \x01(\v2'.google.cloud.visionai.v1.IntRangeArrayH\x00R\rintRangeArray\x12W\n" +
	"\x11float_range_array\x18\x04 \x01(\v2).google.cloud.visionai.v1.FloatRangeArrayH\x00R\x0ffloatRangeArray\x12a\n" +
	"\x15date_time_range_array\x18\x05 \x01(\v2,.google.cloud.visionai.v1.DateTimeRangeArrayH\x00R\x12dateTimeRangeArray\x12Z\n" +
	"\x12geo_location_array\x18\x06 \x01(\v2*.google.cloud.visionai.v1.GeoLocationArrayH\x00R\x10geoLocationArray\x12D\n" +
	"\n" +
	"bool_value\x18\a \x01(\v2#.google.cloud.visionai.v1.BoolValueH\x00R\tboolValue\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12:\n" +
	"\x19fetch_matched_annotations\x18\b \x01(\bR\x17fetchMatchedAnnotationsB\a\n" +
	"\x05value\"\x96\x06\n" +
	"\tPartition\x12d\n" +
	"\x12temporal_partition\x18\x01 \x01(\v25.google.cloud.visionai.v1.Partition.TemporalPartitionR\x11temporalPartition\x12a\n" +
	"\x11spatial_partition\x18\x02 \x01(\v24.google.cloud.visionai.v1.Partition.SpatialPartitionR\x10spatialPartition\x12}\n" +
	"\x1brelative_temporal_partition\x18\x03 \x01(\v2=.google.cloud.visionai.v1.Partition.RelativeTemporalPartitionR\x19relativeTemporalPartition\x1a\x85\x01\n" +
	"\x11TemporalPartition\x129\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x125\n" +
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\x1a\xa2\x01\n" +
	"\x10SpatialPartition\x12\x18\n" +
	...
	"\x05y_max\x18\x04 \x01(\x03H\x03R\x04yMax\x88\x01\x01B\b\n" +
	"\x06_x_minB\b\n" +
	"\x06_y_minB\b\n" +
	"\x06_x_maxB\b\n" +
	"\x06_y_max\x1a\x93\x01\n" +
	"\x19RelativeTemporalPartition\x12<\n" +
	"\fstart_offset\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\vstartOffset\x128\n" +
	"\n" +
	"end_offset\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\tendOffset*\xb8\x01\n" +
	...
	"\x1eFACET_BUCKET_TYPE_CUSTOM_RANGE\x10\x042\x9bf\n" +
	"\tWarehouse\x12\xb9\x01\n" +
	"\vCreateAsset\x12,.google.cloud.visionai.v1.CreateAssetRequest\x1a\x1f.google.cloud.visionai.v1.Asset\"[\xdaA\x15parent,asset,asset_id\x82\xd3\xe4\x93\x02=:\x05asset\"4/v1/{parent=projects/*/locations/*/corpora/*}/assets\x12\xbb\x01\n" +
	"\vUpdateAsset\x12,.google.cloud.visionai.v1.UpdateAssetRequest\x1a\x1f.google.cloud.visionai.v1.Asset\"]\xdaA\x11asset,update_mask\x82\xd3\xe4\x93\x02C:\x05asset2:/v1/{asset.name=projects/*/locations/*/corpora/*/assets/*}\x12\x9b\x01\n" +
	"\bGetAsset\x12).google.cloud.visionai.v1.GetAssetRequest\x1a\x1f.google.cloud.visionai.v1.Asset\"C\xdaA\x04name\x82\xd3\xe4\x93\x026\x124/v1/{name=projects/*/locations/*/corpora/*/assets/*}\x12\xae\x01\n" +
	"\n" +
	...
	"\vDeleteAsset\x12,.google.cloud.visionai.v1.DeleteAssetRequest\x1a\x1d.google.longrunning.Operation\"r\xcaA,\n" +
	...
	"\vUploadAsset\x12,.google.cloud.visionai.v1.UploadAssetRequest\x1a\x1d.google.longrunning.Operation\"s\xcaA*\n" +
	"\x13UploadAssetResponse\x12\x13UploadAssetMetadata\x82\xd3\xe4\x93\x02@:\x01*\";/v1/{name=projects/*/locations/*/corpora/*/assets/*}:upload\x12\xdb\x01\n" +
	"\x14GenerateRetrievalUrl\x125.google.cloud.visionai.v1.GenerateRetrievalUrlRequest\x1a6.google.cloud.visionai.v1.GenerateRetrievalUrlResponse\"T\x82\xd3\xe4\x93\x02N:\x01*\"I/v1/{name=projects/*/locations/*/corpora/*/assets/*}:generateRetrievalUrl\x12\xd4\x01\n" +
	"\fAnalyzeAsset\x12-.google.cloud.visionai.v1.AnalyzeAssetRequest\x1a\x1d.google.longrunning.Operation\"v\xcaA,\n" +
	"\x14AnalyzeAssetResponse\x12\x14AnalyzeAssetMetadata\x82\xd3\xe4\x93\x02A:\x01*\"</v1/{name=projects/*/locations/*/corpora/*/assets/*}:analyze\x12\xca\x01\n" +
	"\n" +
	"IndexAsset\x12+.google.cloud.visionai.v1.IndexAssetRequest\x1a\x1d.google.longrunning.Operation\"p\xcaA(\n" +
	"\x12IndexAssetResponse\x12\x12IndexAssetMetadata\x82\xd3\xe4\x93\x02?:\x01*\":/v1/{name=projects/*/locations/*/corpora/*/assets/*}:index\x12\xe9\x01\n" +
	...
	"\x18RemoveIndexAssetResponse\x12\x18RemoveIndexAssetMetadata\x82\xd3\xe4\x93\x02E:\x01*\"@/v1/{name=projects/*/locations/*/corpora/*/assets/*}:removeIndex\x12\xcf\x01\n" +
	...
	"\vCreateIndex\x12,.google.cloud.visionai.v1.CreateIndexRequest\x1a\x1d.google.longrunning.Operation\"{\xcaA\x1c\n" +
	"\x05Index\x12\x13CreateIndexMetadata\xdaA\x15parent,index,index_id\x82\xd3\xe4\x93\x02>:\x05index\"5/v1/{parent=projects/*/locations/*/corpora/*}/indexes\x12\xd9\x01\n" +
	"\vUpdateIndex\x12,.google.cloud.visionai.v1.UpdateIndexRequest\x1a\x1d.google.longrunning.Operation\"}\xcaA\x1c\n" +
	"\x05Index\x12\x13UpdateIndexMetadata\xdaA\x11index,update_mask\x82\xd3\xe4\x93\x02D:\x05index2;/v1/{index.name=projects/*/locations/*/corpora/*/indexes/*}\x12\x9c\x01\n" +
	"\bGetIndex\x12).google.cloud.visionai.v1.GetIndexRequest\x1a\x1f.google.cloud.visionai.v1.Index\"D\xdaA\x04name\x82\xd3\xe4\x93\x027\x125/v1/{name=projects/*/locations/*/corpora/*/indexes/*}\x12\xb2\x01\n" +
	"\vListIndexes\x12,.google.cloud.visionai.v1.ListIndexesRequest\x1a-.google.cloud.visionai.v1.ListIndexesResponse\"F\xdaA\x06parent\x82\xd3\xe4\x93\x027\x125/v1/{parent=projects/*/locations/*/corpora/*}/indexes\x12\xcf\x01\n" +
	"\vDeleteIndex\x12,.google.cloud.visionai.v1.DeleteIndexRequest\x1a\x1d.google.longrunning.Operation\"s\xcaA,\n" +
	...
	"\fCreateCorpus\x12-.google.cloud.visionai.v1.CreateCorpusRequest\x1a\x1d.google.longrunning.Operation\"l\xcaA\x1e\n" +
	"\x06Corpus\x12\x14CreateCorpusMetadata\xdaA\rparent,corpus\x82\xd3\xe4\x93\x025:\x06corpus\"+/v1/{parent=projects/*/locations/*}/corpora\x12\x95\x01\n" +
	...
	"\fUpdateCorpus\x12-.google.cloud.visionai.v1.UpdateCorpusRequest\x1a .google.cloud.visionai.v1.Corpus\"W\xdaA\x12corpus,update_mask\x82\xd3\xe4\x93\x02<:\x06corpus22/v1/{corpus.name=projects/*/locations/*/corpora/*}\x12\xa8\x01\n" +
	"\vListCorpora\x12,.google.cloud.visionai.v1.ListCorporaRequest\x1a-.google.cloud.visionai.v1.ListCorporaResponse\"<\xdaA\x06parent\x82\xd3\xe4\x93\x02-\x12+/v1/{parent=projects/*/locations/*}/corpora\x12\x91\x01\n" +
	"\fDeleteCorpus\x12-.google.cloud.visionai.v1.DeleteCorpusRequest\x1a\x16.google.protobuf.Empty\":\xdaA\x04name\x82\xd3\xe4\x93\x02-*+/v1/{name=projects/*/locations/*/corpora/*}\x12\xcf\x01\n" +
	"\rAnalyzeCorpus\x12..google.cloud.visionai.v1.AnalyzeCorpusRequest\x1a\x1d.google.longrunning.Operation\"o\xcaA.\n" +
	"\x15AnalyzeCorpusResponse\x12\x15AnalyzeCorpusMetadata\x82\xd3\xe4\x93\x028:\x01*\"3/v1/{name=projects/*/locations/*/corpora/*}:analyze\x12\xd0\x01\n" +
	"\x10CreateDataSchema\x121.google.cloud.visionai.v1.CreateDataSchemaRequest\x1a$.google.cloud.visionai.v1.DataSchema\"c\xdaA\x12parent,data_schema\x82\xd3\xe4\x93\x02H:\vdata_schema\"9/v1/{parent=projects/*/locations/*/corpora/*}/dataSchemas\x12\xe1\x01\n" +
	"\x10UpdateDataSchema\x121.google.cloud.visionai.v1.UpdateDataSchemaRequest\x1a$.google.cloud.visionai.v1.DataSchema\"t\xdaA\x17data_schema,update_mask\x82\xd3\xe4\x93\x02T:\vdata_schema2E/v1/{data_schema.name=projects/*/locations/*/corpora/*/dataSchemas/*}\x12\xaf\x01\n" +
	...
	"\x10CreateAnnotation\x121.google.cloud.visionai.v1.CreateAnnotationRequest\x1a$.google.cloud.visionai.v1.Annotation\"x\xdaA\x1fparent,annotation,annotation_id\x82\xd3\xe4\x93\x02P:\n" +
	"annotation\"B/v1/{parent=projects/*/locations/*/corpora/*/assets/*}/annotations\x12\xb8\x01\n" +
	...
	"\x10UpdateAnnotation\x121.google.cloud.visionai.v1.UpdateAnnotationRequest\x1a$.google.cloud.visionai.v1.Annotation\"z\xdaA\x16annotation,update_mask\x82\xd3\xe4\x93\x02[:\n" +
	"annotation2M/v1/{annotation.name=projects/*/locations/*/corpora/*/assets/*/annotations/*}\x12\xb0\x01\n" +
	...
	"\vIngestAsset\x12,.google.cloud.visionai.v1.IngestAssetRequest\x1a-.google.cloud.visionai.v1.IngestAssetResponse\"\x00(\x010\x01\x12\xaa\x01\n" +
	"\tClipAsset\x12*.google.cloud.visionai.v1.ClipAssetRequest\x1a+.google.cloud.visionai.v1.ClipAssetResponse\"D\x82\xd3\xe4\x93\x02>:\x01*\"9/v1/{name=projects/*/locations/*/corpora/*/assets/*}:clip\x12\xc3\x01\n" +
	"\x0eGenerateHlsUri\x12/.google.cloud.visionai.v1.GenerateHlsUriRequest\x1a0.google.cloud.visionai.v1.GenerateHlsUriResponse\"N\x82\xd3\xe4\x93\x02H:\x01*\"C/v1/{name=projects/*/locations/*/corpora/*/assets/*}:generateHlsUri\x12\xd3\x01\n" +
	"\fImportAssets\x12-.google.cloud.visionai.v1.ImportAssetsRequest\x1a\x1d.google.longrunning.Operation\"u\xcaA,\n" +
	"\x14ImportAssetsResponse\x12\x14ImportAssetsMetadata\x82\xd3\xe4\x93\x02@:\x01*\";/v1/{parent=projects/*/locations/*/corpora/*}/assets:import\x12\xed\x01\n" +
	"\x12CreateSearchConfig\x123.google.cloud.visionai.v1.CreateSearchConfigRequest\x1a&.google.cloud.visionai.v1.SearchConfig\"z\xdaA%parent,search_config,search_config_id\x82\xd3\xe4\x93\x02L:\rsearch_config\";/v1/{parent=projects/*/locations/*/corpora/*}/searchConfigs\x12\xef\x01\n" +
	"\x12UpdateSearchConfig\x123.google.cloud.visionai.v1.UpdateSearchConfigRequest\x1a&.google.cloud.visionai.v1.SearchConfig\"|\xdaA\x19search_config,update_mask\x82\xd3\xe4\x93\x02Z:\rsearch_config2I/v1/{search_config.name=projects/*/locations/*/corpora/*/searchConfigs/*}\x12\xb7\x01\n" +
	...
	"\x14CreateSearchHypernym\x125.google.cloud.visionai.v1.CreateSearchHypernymRequest\x1a(.google.cloud.visionai.v1.SearchHypernym\"\x82\x01\xdaA)parent,search_hypernym,search_hypernym_id\x82\xd3\xe4\x93\x02P:\x0fsearch_hypernym\"=/v1/{parent=projects/*/locations/*/corpora/*}/searchHypernyms\x12\xfe\x01\n" +
	"\x14UpdateSearchHypernym\x125.google.cloud.visionai.v1.UpdateSearchHypernymRequest\x1a(.google.cloud.visionai.v1.SearchHypernym\"\x84\x01\xdaA\x1bsearch_hypernym,update_mask\x82\xd3\xe4\x93\x02`:\x0fsearch_hypernym2M/v1/{search_hypernym.name=projects/*/locations/*/corpora/*/searchHypernyms/*}\x12\xbf\x01\n" +
	...
	"\fSearchAssets\x12-.google.cloud.visionai.v1.SearchAssetsRequest\x1a..google.cloud.visionai.v1.SearchAssetsResponse\"E\x82\xd3\xe4\x93\x02?:\x01*\":/v1/{corpus=projects/*/locations/*/corpora/*}:searchAssets\x12\xdf\x01\n" +
	"\x13SearchIndexEndpoint\x124.google.cloud.visionai.v1.SearchIndexEndpointRequest\x1a5.google.cloud.visionai.v1.SearchIndexEndpointResponse\"[\x82\xd3\xe4\x93\x02U:\x01*\"P/v1/{index_endpoint=projects/*/locations/*/indexEndpoints/*}:searchIndexEndpoint\x12\x90\x02\n" +
	...
	"\rIndexEndpoint\x12\x1bCreateIndexEndpointMetadata\xdaA'parent,index_endpoint,index_endpoint_id\x82\xd3\xe4\x93\x02D:\x0eindex_endpoint\"2/v1/{parent=projects/*/locations/*}/indexEndpoints\x12\xb1\x01\n" +
	...
	"\rIndexEndpoint\x12\x1bUpdateIndexEndpointMetadata\xdaA\x1aindex_endpoint,update_mask\x82\xd3\xe4\x93\x02S:\x0eindex_endpoint2A/v1/{index_endpoint.name=projects/*/locations/*/indexEndpoints/*}\x12\xe4\x01\n" +
	...
	"\vDeployIndex\x12,.google.cloud.visionai.v1.DeployIndexRequest\x1a\x1d.google.longrunning.Operation\"\x80\x01\xcaA*\n" +
	"\x13DeployIndexResponse\x12\x13DeployIndexMetadata\x82\xd3\xe4\x93\x02M:\x01*\"H/v1/{index_endpoint=projects/*/locations/*/indexEndpoints/*}:deployIndex\x12\xe7\x01\n" +
	"\rUndeployIndex\x12..google.cloud.visionai.v1.UndeployIndexRequest\x1a\x1d.google.longrunning.Operation\"\x86\x01\xcaA.\n" +
	"\x15UndeployIndexResponse\x12\x15UndeployIndexMetadata\x82\xd3\xe4\x93\x02O:\x01*\"J/v1/{index_endpoint=projects/*/locations/*/indexEndpoints/*}:undeployIndex\x12\xff\x01\n" +
	...
	"\n" +
	"Collection\x12\x18CreateCollectionMetadata\xdaA\x1fparent,collection,collection_id\x82\xd3\xe4\x93\x02G:\n" +
	"collection\"9/v1/{parent=projects/*/locations/*/corpora/*}/collections\x12\xe2\x01\n" +
	...
	"\x10UpdateCollection\x121.google.cloud.visionai.v1.UpdateCollectionRequest\x1a$.google.cloud.visionai.v1.Collection\"q\xdaA\x16collection,update_mask\x82\xd3\xe4\x93\x02R:\n" +
	"collection2D/v1/{collection.name=projects/*/locations/*/corpora/*/collections/*}\x12\xc2\x01\n" +
	...
	"\x11AddCollectionItem\x122.google.cloud.visionai.v1.AddCollectionItemRequest\x1a3.google.cloud.visionai.v1.AddCollectionItemResponse\"h\xdaA\x04item\x82\xd3\xe4\x93\x02[:\x01*\"V/v1/{item.collection=projects/*/locations/*/corpora/*/collections/*}:addCollectionItem\x12\xf2\x01\n" +
	"\x14RemoveCollectionItem\x125.google.cloud.visionai.v1.RemoveCollectionItemRequest\x1a6.google.cloud.visionai.v1.RemoveCollectionItemResponse\"k\xdaA\x04item\x82\xd3\xe4\x93\x02^:\x01*\"Y/v1/{item.collection=projects/*/locations/*/corpora/*/collections/*}:removeCollectionItem\x12\xec\x01\n" +
	...
	"collection\x82\xd3\xe4\x93\x02U\x12S/v1/{collection=projects/*/locations/*/corpora/*/collections/*}:viewCollectionItems\x1aU\xcaA!warehouse-visionai.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xbe\x01\n" +
...
var (
	...
	file_google_cloud_visionai_v1_warehouse_proto_rawDescData []byte
)
...
func file_google_cloud_visionai_v1_warehouse_proto_rawDescGZIP() []byte {
	file_google_cloud_visionai_v1_warehouse_proto_rawDescOnce.Do(func() {
		file_google_cloud_visionai_v1_warehouse_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_visionai_v1_warehouse_proto_rawDesc), len(file_google_cloud_visionai_v1_warehouse_proto_rawDesc)))
	})
...
func file_google_cloud_visionai_v1_warehouse_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_visionai_v1_warehouse_proto_rawDesc), len(file_google_cloud_visionai_v1_warehouse_proto_rawDesc)),
			NumEnums:      14,
			NumMessages:   176,
			NumExtensions: 0,
			NumServices:   1,
