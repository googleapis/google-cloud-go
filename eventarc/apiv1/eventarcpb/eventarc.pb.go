...
func file_google_cloud_eventarc_v1_eventarc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_eventarc_v1_eventarc_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_eventarc_v1_eventarc_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
