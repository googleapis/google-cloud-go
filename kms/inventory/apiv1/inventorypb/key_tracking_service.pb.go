...
type ProtectedResourcesSummary struct {
	...
	ResourceTypes map[string]int64 `protobuf:"bytes,3,rep,name=resource_types,json=resourceTypes,proto3" json:"resource_types,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	// The number of resources protected by the key grouped by Cloud product.
	CloudProducts map[string]int64 `protobuf:"bytes,6,rep,name=cloud_products,json=cloudProducts,proto3" json:"cloud_products,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	// The number of resources protected by the key grouped by region.
	Locations map[string]int64 `protobuf:"bytes,4,rep,name=locations,proto3" json:"locations,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
const file_google_cloud_kms_inventory_v1_key_tracking_service_proto_rawDesc = "" +
	"\n" +
	"8google/cloud/kms/inventory/v1/key_tracking_service.proto\x12\x1dgoogle.cloud.kms.inventory.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd2\x01\n" +
	"#GetProtectedResourcesSummaryRequest\x12Q\n" +
	"\x04name\x18\x01 \x01(\tB=\xe0A\x02\xfaA7\n" +
	"5kmsinventory.googleapis.com/ProtectedResourcesSummaryR\x04name\x12X\n" +
	"\x0efallback_scope\x18\x02 \x01(\x0e2,.google.cloud.kms.inventory.v1.FallbackScopeB\x03\xe0A\x01R\rfallbackScope\"\x94\b\n" +
	"\x19ProtectedResourcesSummary\x12\x12\n" +
	"\x04name\x18\x05 \x01(\tR\x04name\x12%\n" +
	"\x0eresource_count\x18\x01 \x01(\x03R\rresourceCount\x12#\n" +
	"\rproject_count\x18\x02 \x01(\x05R\fprojectCount\x12r\n" +
	"\x0eresource_types\x18\x03 \x03(\v2K.google.cloud.kms.inventory.v1.ProtectedResourcesSummary.ResourceTypesEntryR\rresourceTypes\x12r\n" +
	"\x0ecloud_products\x18\x06 \x03(\v2K.google.cloud.kms.inventory.v1.ProtectedResourcesSummary.CloudProductsEntryR\rcloudProducts\x12e\n" +
	"\tlocations\x18\x04 \x03(\v2G.google.cloud.kms.inventory.v1.ProtectedResourcesSummary.LocationsEntryR\tlocations\x12B\n" +
	"\bwarnings\x18\a \x03(\v2&.google.cloud.kms.inventory.v1.WarningR\bwarnings\x1a@\n" +
	"\x12ResourceTypesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\x1a@\n" +
	"\x12CloudProductsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\x1a<\n" +
	"\x0eLocationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01:\xc1\x02\xeaA\xbd\x02\n" +
	"5kmsinventory.googleapis.com/ProtectedResourcesSummary\x12mprojects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/protectedResourcesSummary\x12\x94\x01projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/cryptoKeyVersions/{crypto_key_version}/protectedResourcesSummary\"\x85\x02\n" +
	"\x1fSearchProtectedResourcesRequest\x12P\n" +
	"\x05scope\x18\x02 \x01(\tB:\xe0A\x02\xfaA4\x122kmsinventory.googleapis.com/ProtectedResourceScopeR\x05scope\x12(\n" +
	"\n" +
	"crypto_key\x18\x01 \x01(\tB\t\xe0A\x02\xfaA\x03\n" +
	"\x01*R\tcryptoKey\x12\x1b\n" +
	"\tpage_size\x18\x03 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x04 \x01(\tR\tpageToken\x12*\n" +
	"\x0eresource_types\x18\x05 \x03(\tB\x03\xe0A\x01R\rresourceTypes\"\xad\x01\n" +
	" SearchProtectedResourcesResponse\x12a\n" +
	"\x13protected_resources\x18\x01 \x03(\v20.google.cloud.kms.inventory.v1.ProtectedResourceR\x12protectedResources\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xfe\x04\n" +
	"\x11ProtectedResource\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\aproject\x18\x02 \x01(\tR\aproject\x12\x1d\n" +
	"\n" +
	"project_id\x18\t \x01(\tR\tprojectId\x12#\n" +
	"\rcloud_product\x18\b \x01(\tR\fcloudProduct\x12#\n" +
	"\rresource_type\x18\x03 \x01(\tR\fresourceType\x12\x1a\n" +
	"\blocation\x18\x04 \x01(\tR\blocation\x12T\n" +
	"\x06labels\x18\x05 \x03(\v2<.google.cloud.kms.inventory.v1.ProtectedResource.LabelsEntryR\x06labels\x12[\n" +
	"\x12crypto_key_version\x18\x06 \x01(\tB-\xfaA*\n" +
	"(cloudkms.googleapis.com/CryptoKeyVersionR\x10cryptoKeyVersion\x12]\n" +
	"\x13crypto_key_versions\x18\n" +
	" \x03(\tB-\xfaA*\n" +
	"(cloudkms.googleapis.com/CryptoKeyVersionR\x11cryptoKeyVersions\x12@\n" +
	"\vcreate_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:'\xeaA$\n" +
	"\x1fcloudasset.googleapis.com/Asset\x12\x01*\"\xaf\x02\n" +
	"\aWarning\x12U\n" +
	"\fwarning_code\x18\x01 \x01(\x0e22.google.cloud.kms.inventory.v1.Warning.WarningCodeR\vwarningCode\x12'\n" +
	"\x0fdisplay_message\x18\x02 \x01(\tR\x0edisplayMessage\"\xa3\x01\n" +
	...
	"\x1aFALLBACK_SCOPE_UNSPECIFIED\x10\x00\x12\x1a\n" +
	"\x16FALLBACK_SCOPE_PROJECT\x10\x012\x8f\x05\n" +
	"\x12KeyTrackingService\x12\x81\x02\n" +
	"\x1cGetProtectedResourcesSummary\x12B.google.cloud.kms.inventory.v1.GetProtectedResourcesSummaryRequest\x1a8.google.cloud.kms.inventory.v1.ProtectedResourcesSummary\"c\xdaA\x04name\x82\xd3\xe4\x93\x02V\x12T/v1/{name=projects/*/locations/*/keyRings/*/cryptoKeys/**}/protectedResourcesSummary\x12\xa3\x02\n" +
	"\x18SearchProtectedResources\x12>.google.cloud.kms.inventory.v1.SearchProtectedResourcesRequest\x1a?.google.cloud.kms.inventory.v1.SearchProtectedResourcesResponse\"\x85\x01\xdaA\x11scope, crypto_key\x82\xd3\xe4\x93\x02kZ2\x120/v1/{scope=projects/*}/protectedResources:search\x125/v1/{scope=organizations/*}/protectedResources:search\x1aO\xcaA\x1bkmsinventory.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xd7\x02\xeaA\x94\x01\n" +
	"2kmsinventory.googleapis.com/ProtectedResourceScope\x123organizations/{organization}/protectedResourceScope\x12)projects/{project}/protectedResourceScope\n" +
	"!com.google.cloud.kms.inventory.v1B\x17KeyTrackingServiceProtoP\x01Z?cloud.google.com/go/kms/inventory/apiv1/inventorypb;inventorypb\xaa\x02\x1dGoogle.Cloud.Kms.Inventory.V1\xca\x02\x1dGoogle\\Cloud\\Kms\\Inventory\\V1b\x06proto3"

var (
	file_google_cloud_kms_inventory_v1_key_tracking_service_proto_rawDescOnce sync.Once
	file_google_cloud_kms_inventory_v1_key_tracking_service_proto_rawDescData []byte
)
...
func file_google_cloud_kms_inventory_v1_key_tracking_service_proto_rawDescGZIP() []byte {
	file_google_cloud_kms_inventory_v1_key_tracking_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_kms_inventory_v1_key_tracking_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_kms_inventory_v1_key_tracking_service_proto_rawDesc), len(file_google_cloud_kms_inventory_v1_key_tracking_service_proto_rawDesc)))
	})
...
func file_google_cloud_kms_inventory_v1_key_tracking_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_kms_inventory_v1_key_tracking_service_proto_rawDesc), len(file_google_cloud_kms_inventory_v1_key_tracking_service_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
