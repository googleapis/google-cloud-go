...
const (
	...
	StorageControl_GetIntelligenceFinding_FullMethodName               = "/google.storage.control.v2.StorageControl/GetIntelligenceFinding"
	StorageControl_ListIntelligenceFindings_FullMethodName             = "/google.storage.control.v2.StorageControl/ListIntelligenceFindings"
...
func (c *storageControlClient) GetIntelligenceFinding(ctx context.Context, in *GetIntelligenceFindingRequest, opts ...grpc.CallOption) (*IntelligenceFinding, error) {
	out := new(IntelligenceFinding)
	err := c.cc.Invoke(ctx, StorageControl_GetIntelligenceFinding_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageControlClient) ListIntelligenceFindings(ctx context.Context, in *ListIntelligenceFindingsRequest, opts ...grpc.CallOption) (*ListIntelligenceFindingsResponse, error) {
	out := new(ListIntelligenceFindingsResponse)
	err := c.cc.Invoke(ctx, StorageControl_ListIntelligenceFindings_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageControlClient) SummarizeIntelligenceFindings(ctx context.Context, in *SummarizeIntelligenceFindingsRequest, opts ...grpc.CallOption) (*SummarizeIntelligenceFindingsResponse, error) {
	out := new(SummarizeIntelligenceFindingsResponse)
	err := c.cc.Invoke(ctx, StorageControl_SummarizeIntelligenceFindings_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageControlClient) GetIntelligenceFindingRevision(ctx context.Context, in *GetIntelligenceFindingRevisionRequest, opts ...grpc.CallOption) (*IntelligenceFindingRevision, error) {
	out := new(IntelligenceFindingRevision)
	err := c.cc.Invoke(ctx, StorageControl_GetIntelligenceFindingRevision_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageControlClient) ListIntelligenceFindingRevisions(ctx context.Context, in *ListIntelligenceFindingRevisionsRequest, opts ...grpc.CallOption) (*ListIntelligenceFindingRevisionsResponse, error) {
	out := new(ListIntelligenceFindingRevisionsResponse)
	err := c.cc.Invoke(ctx, StorageControl_ListIntelligenceFindingRevisions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStorageControlServer) GetIntelligenceFinding(context.Context, *GetIntelligenceFindingRequest) (*IntelligenceFinding, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetIntelligenceFinding not implemented")
}
func (UnimplementedStorageControlServer) ListIntelligenceFindings(context.Context, *ListIntelligenceFindingsRequest) (*ListIntelligenceFindingsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListIntelligenceFindings not implemented")
}
func (UnimplementedStorageControlServer) SummarizeIntelligenceFindings(context.Context, *SummarizeIntelligenceFindingsRequest) (*SummarizeIntelligenceFindingsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SummarizeIntelligenceFindings not implemented")
}
func (UnimplementedStorageControlServer) GetIntelligenceFindingRevision(context.Context, *GetIntelligenceFindingRevisionRequest) (*IntelligenceFindingRevision, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetIntelligenceFindingRevision not implemented")
}
...
func _StorageControl_GetIntelligenceFinding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetIntelligenceFindingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageControlServer).GetIntelligenceFinding(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StorageControl_GetIntelligenceFinding_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageControlServer).GetIntelligenceFinding(ctx, req.(*GetIntelligenceFindingRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StorageControl_ListIntelligenceFindings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListIntelligenceFindingsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageControlServer).ListIntelligenceFindings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StorageControl_ListIntelligenceFindings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageControlServer).ListIntelligenceFindings(ctx, req.(*ListIntelligenceFindingsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StorageControl_SummarizeIntelligenceFindings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SummarizeIntelligenceFindingsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageControlServer).SummarizeIntelligenceFindings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StorageControl_SummarizeIntelligenceFindings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageControlServer).SummarizeIntelligenceFindings(ctx, req.(*SummarizeIntelligenceFindingsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StorageControl_GetIntelligenceFindingRevision_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetIntelligenceFindingRevisionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageControlServer).GetIntelligenceFindingRevision(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StorageControl_GetIntelligenceFindingRevision_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageControlServer).GetIntelligenceFindingRevision(ctx, req.(*GetIntelligenceFindingRevisionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StorageControl_ListIntelligenceFindingRevisions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListIntelligenceFindingRevisionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageControlServer).ListIntelligenceFindingRevisions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StorageControl_ListIntelligenceFindingRevisions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageControlServer).ListIntelligenceFindingRevisions(ctx, req.(*ListIntelligenceFindingRevisionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StorageControl_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetIntelligenceFinding",
			Handler:    _StorageControl_GetIntelligenceFinding_Handler,
		},
		{
			MethodName: "ListIntelligenceFindings",
			Handler:    _StorageControl_ListIntelligenceFindings_Handler,
		},
		{
			MethodName: "SummarizeIntelligenceFindings",
			Handler:    _StorageControl_SummarizeIntelligenceFindings_Handler,
		},
		{
