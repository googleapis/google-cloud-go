...
const (
	...
	FindingType_FINDING_TYPE_COLDLINE_AND_ARCHIVAL_STORAGE_OPERATIONS_SPIKE FindingType = 1
	// Finding is about a spike in throttled requests (429 errors) within a
	// project.
	FindingType_FINDING_TYPE_THROTTLED_REQUEST_SPIKE FindingType = 2
	// Finding is about a spike in cross region egress in Cloud Storage.
	FindingType_FINDING_TYPE_CROSS_REGION_EGRESS_SPIKE FindingType = 3
	// Finding is about growth in storage above the expected trend.
	FindingType_FINDING_TYPE_STORAGE_GROWTH_ABOVE_TREND FindingType = 4
)
...
var (
	FindingType_name = map[int32]string{
		...
		1: "FINDING_TYPE_COLDLINE_AND_ARCHIVAL_STORAGE_OPERATIONS_SPIKE",
		2: "FINDING_TYPE_THROTTLED_REQUEST_SPIKE",
		3: "FINDING_TYPE_CROSS_REGION_EGRESS_SPIKE",
		4: "FINDING_TYPE_STORAGE_GROWTH_ABOVE_TREND",
	}
...
const (
	...
	FindingCategory_FINDING_CATEGORY_DATA_MANAGEMENT FindingCategory = 1
	// Category is 'Performance'.
	FindingCategory_FINDING_CATEGORY_PERFORMANCE FindingCategory = 2
)
...
var (
	FindingCategory_name = map[int32]string{
		...
		1: "FINDING_CATEGORY_DATA_MANAGEMENT",
		2: "FINDING_CATEGORY_PERFORMANCE",
	}
...
func (FindingSeverity) Descriptor() protoreflect.EnumDescriptor {
	return file_google_storage_control_v2_storage_control_proto_enumTypes[2].Descriptor()
}

func (FindingSeverity) Type() protoreflect.EnumType {
	return &file_google_storage_control_v2_storage_control_proto_enumTypes[2]
}
...
type ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite int32

const (
	// The behavior is not specified at this resource level.
	// It should be inherited from the parent resource's configuration.
	// This is the default value.
	ManagedFolder_RapidCacheConfig_RapidCachePolicy_INGEST_ON_WRITE_UNSPECIFIED ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite = 0
	// Ingestion on write is explicitly enabled for this resource.
	ManagedFolder_RapidCacheConfig_RapidCachePolicy_INGEST_ON_WRITE_ENABLED ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite = 1
)

// Enum value maps for ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite.
var (
	ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite_name = map[int32]string{
		0: "INGEST_ON_WRITE_UNSPECIFIED",
		1: "INGEST_ON_WRITE_ENABLED",
	}
	ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite_value = map[string]int32{
		"INGEST_ON_WRITE_UNSPECIFIED": 0,
		"INGEST_ON_WRITE_ENABLED":     1,
	}
)

func (x ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite) Enum() *ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite {
	p := new(ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite)
	*p = x
	return p
}

func (x ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite) Descriptor() protoreflect.EnumDescriptor {
	return file_google_storage_control_v2_storage_control_proto_enumTypes[3].Descriptor()
}

func (ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite) Type() protoreflect.EnumType {
	return &file_google_storage_control_v2_storage_control_proto_enumTypes[3]
}

func (x ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite.Descriptor instead.
func (ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite) EnumDescriptor() ([]byte, []int) {
	return file_google_storage_control_v2_storage_control_proto_rawDescGZIP(), []int{14, 0, 0, 0}
}
...
const (
	...
	IntelligenceConfig_ESSENTIALS IntelligenceConfig_EditionConfig = 6
)
...
func (IntelligenceConfig_EditionConfig) Descriptor() protoreflect.EnumDescriptor {
	return file_google_storage_control_v2_storage_control_proto_enumTypes[4].Descriptor()
}

func (IntelligenceConfig_EditionConfig) Type() protoreflect.EnumType {
	return &file_google_storage_control_v2_storage_control_proto_enumTypes[4]
}
...
func (IntelligenceConfig_EffectiveIntelligenceConfig_EffectiveEdition) Descriptor() protoreflect.EnumDescriptor {
	return file_google_storage_control_v2_storage_control_proto_enumTypes[5].Descriptor()
}

func (IntelligenceConfig_EffectiveIntelligenceConfig_EffectiveEdition) Type() protoreflect.EnumType {
	return &file_google_storage_control_v2_storage_control_proto_enumTypes[5]
}
...
const (
	...
	SummarizeIntelligenceFindingsRequest_RESOURCE_SCOPE_UNSPECIFIED SummarizeIntelligenceFindingsRequest_ResourceScope = 0
	// Summaries are aggregated at the level of the `parent` resource.
	SummarizeIntelligenceFindingsRequest_PARENT SummarizeIntelligenceFindingsRequest_ResourceScope = 1
	// Summaries are broken down by each project within the `parent` scope.
	SummarizeIntelligenceFindingsRequest_PROJECT SummarizeIntelligenceFindingsRequest_ResourceScope = 2
)

// Enum value maps for SummarizeIntelligenceFindingsRequest_ResourceScope.
var (
	SummarizeIntelligenceFindingsRequest_ResourceScope_name = map[int32]string{
		0: "RESOURCE_SCOPE_UNSPECIFIED",
		1: "PARENT",
		2: "PROJECT",
	}
	SummarizeIntelligenceFindingsRequest_ResourceScope_value = map[string]int32{
...
func (x SummarizeIntelligenceFindingsRequest_ResourceScope) Enum() *SummarizeIntelligenceFindingsRequest_ResourceScope {
	p := new(SummarizeIntelligenceFindingsRequest_ResourceScope)
	*p = x
	return p
}
...
func (SummarizeIntelligenceFindingsRequest_ResourceScope) Descriptor() protoreflect.EnumDescriptor {
	return file_google_storage_control_v2_storage_control_proto_enumTypes[6].Descriptor()
}

func (SummarizeIntelligenceFindingsRequest_ResourceScope) Type() protoreflect.EnumType {
	return &file_google_storage_control_v2_storage_control_proto_enumTypes[6]
}
...
const (
	...
	FindingSummary_SummaryDetails_RESOURCE_TYPE_UNSPECIFIED FindingSummary_SummaryDetails_ResourceType = 0
	// Resource type is project.
	FindingSummary_SummaryDetails_PROJECT FindingSummary_SummaryDetails_ResourceType = 1
	// Resource type is bucket.
	FindingSummary_SummaryDetails_BUCKET FindingSummary_SummaryDetails_ResourceType = 2
)

// Enum value maps for FindingSummary_SummaryDetails_ResourceType.
var (
	FindingSummary_SummaryDetails_ResourceType_name = map[int32]string{
		0: "RESOURCE_TYPE_UNSPECIFIED",
		1: "PROJECT",
		2: "BUCKET",
	}
	FindingSummary_SummaryDetails_ResourceType_value = map[string]int32{
...
func (x FindingSummary_SummaryDetails_ResourceType) Enum() *FindingSummary_SummaryDetails_ResourceType {
	p := new(FindingSummary_SummaryDetails_ResourceType)
	*p = x
	return p
}
...
func (FindingSummary_SummaryDetails_ResourceType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_storage_control_v2_storage_control_proto_enumTypes[7].Descriptor()
}

func (FindingSummary_SummaryDetails_ResourceType) Type() protoreflect.EnumType {
	return &file_google_storage_control_v2_storage_control_proto_enumTypes[7]
}
...
func (x *DeleteFolderRecursiveRequest) Reset() {
	*x = DeleteFolderRecursiveRequest{}
...
func (x *DeleteFolderRecursiveMetadata) Reset() {
	*x = DeleteFolderRecursiveMetadata{}
...
type ManagedFolder struct {
	...
	RapidCacheConfig *ManagedFolder_RapidCacheConfig `protobuf:"bytes,6,opt,name=rapid_cache_config,json=rapidCacheConfig,proto3,oneof" json:"rapid_cache_config,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *ManagedFolder) GetRapidCacheConfig() *ManagedFolder_RapidCacheConfig {
	if x != nil {
		return x.RapidCacheConfig
	}
	return nil
}
...
type UpdateManagedFolderRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	// `managed_folder`.
	ManagedFolder *ManagedFolder `protobuf:"bytes,1,opt,name=managed_folder,json=managedFolder,proto3" json:"managed_folder,omitempty"`
...
func (x *UpdateManagedFolderRequest) Reset() {
	*x = UpdateManagedFolderRequest{}
	mi := &file_google_storage_control_v2_storage_control_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateManagedFolderRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateManagedFolderRequest) ProtoMessage() {}

func (x *UpdateManagedFolderRequest) ProtoReflect() protoreflect.Message {
	mi := &file_google_storage_control_v2_storage_control_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateManagedFolderRequest.ProtoReflect.Descriptor instead.
func (*UpdateManagedFolderRequest) Descriptor() ([]byte, []int) {
	return file_google_storage_control_v2_storage_control_proto_rawDescGZIP(), []int{20}
}

func (x *UpdateManagedFolderRequest) GetManagedFolder() *ManagedFolder {
	if x != nil {
		return x.ManagedFolder
	}
	return nil
...
func (x *UpdateManagedFolderRequest) GetUpdateMask() *fieldmaskpb.FieldMask {
	if x != nil {
		return x.UpdateMask
	}
	return nil
...
func (x *UpdateManagedFolderRequest) GetIfMetagenerationMatch() int64 {
	if x != nil && x.IfMetagenerationMatch != nil {
		return *x.IfMetagenerationMatch
	}
	return 0
...
func (x *UpdateManagedFolderRequest) GetIfMetagenerationNotMatch() int64 {
	if x != nil && x.IfMetagenerationNotMatch != nil {
		return *x.IfMetagenerationNotMatch
	}
	return 0
...
func (x *UpdateManagedFolderRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
type CreateAnywhereCacheMetadata struct {
	...
	// Defaults to false.
	IngestOnWrite *bool `protobuf:"varint,7,opt,name=ingest_on_write,json=ingestOnWrite,proto3,oneof" json:"ingest_on_write,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateAnywhereCacheMetadata) GetIngestOnWrite() bool {
...
type CreateRapidCacheMetadata struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Generic metadata for the long running operation.
	CommonMetadata *CommonLongRunningOperationMetadata `protobuf:"bytes,1,opt,name=common_metadata,json=commonMetadata,proto3" json:"common_metadata,omitempty"`
	// Rapid Cache ID.
	...
	// Optional. Specifies whether objects are ingested into the cache upon write.
	// Defaults to false.
	IngestOnWrite *bool `protobuf:"varint,6,opt,name=ingest_on_write,json=ingestOnWrite,proto3,oneof" json:"ingest_on_write,omitempty"`
	// Optional. The type of cache. Either rapid cache or rapid cache ultra.
	CacheType     *string `protobuf:"bytes,7,opt,name=cache_type,json=cacheType,proto3,oneof" json:"cache_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CreateRapidCacheMetadata) Reset() {
	*x = CreateRapidCacheMetadata{}
	mi := &file_google_storage_control_v2_storage_control_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CreateRapidCacheMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateRapidCacheMetadata) ProtoMessage() {}

func (x *CreateRapidCacheMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_google_storage_control_v2_storage_control_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateRapidCacheMetadata.ProtoReflect.Descriptor instead.
func (*CreateRapidCacheMetadata) Descriptor() ([]byte, []int) {
	return file_google_storage_control_v2_storage_control_proto_rawDescGZIP(), []int{22}
}

func (x *CreateRapidCacheMetadata) GetCommonMetadata() *CommonLongRunningOperationMetadata {
	if x != nil {
		return x.CommonMetadata
	}
	return nil
...
func (x *CreateRapidCacheMetadata) GetRapidCacheId() string {
...
func (x *CreateRapidCacheMetadata) GetZone() string {
	if x != nil && x.Zone != nil {
		return *x.Zone
	}
	return ""
...
func (x *CreateRapidCacheMetadata) GetTtl() *durationpb.Duration {
	if x != nil {
		return x.Ttl
	}
	return nil
...
func (x *CreateRapidCacheMetadata) GetAdmissionPolicy() string {
	if x != nil && x.AdmissionPolicy != nil {
		return *x.AdmissionPolicy
	}
	return ""
...
func (x *CreateRapidCacheMetadata) GetIngestOnWrite() bool {
	if x != nil && x.IngestOnWrite != nil {
		return *x.IngestOnWrite
	}
	return false
...
func (x *CreateRapidCacheMetadata) GetCacheType() string {
...
func (x *UpdateAnywhereCacheMetadata) GetIngestOnWrite() bool {
	if x != nil && x.IngestOnWrite != nil {
		return *x.IngestOnWrite
	}
	return false
...
type UpdateRapidCacheMetadata struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Generic metadata for the long running operation.
	CommonMetadata *CommonLongRunningOperationMetadata `protobuf:"bytes,1,opt,name=common_metadata,json=commonMetadata,proto3" json:"common_metadata,omitempty"`
	// Rapid Cache ID.
...
func (x *UpdateRapidCacheMetadata) Reset() {
	*x = UpdateRapidCacheMetadata{}
	mi := &file_google_storage_control_v2_storage_control_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateRapidCacheMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateRapidCacheMetadata) ProtoMessage() {}

func (x *UpdateRapidCacheMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_google_storage_control_v2_storage_control_proto_msgTypes[24]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateRapidCacheMetadata.ProtoReflect.Descriptor instead.
func (*UpdateRapidCacheMetadata) Descriptor() ([]byte, []int) {
	return file_google_storage_control_v2_storage_control_proto_rawDescGZIP(), []int{24}
}

func (x *UpdateRapidCacheMetadata) GetCommonMetadata() *CommonLongRunningOperationMetadata {
	if x != nil {
		return x.CommonMetadata
	}
	return nil
...
func (x *UpdateRapidCacheMetadata) GetRapidCacheId() string {
	if x != nil && x.RapidCacheId != nil {
		return *x.RapidCacheId
	}
	return ""
...
func (x *UpdateRapidCacheMetadata) GetZone() string {
	if x != nil && x.Zone != nil {
		return *x.Zone
	}
	return ""
...
func (x *UpdateRapidCacheMetadata) GetTtl() *durationpb.Duration {
	if x != nil {
		return x.Ttl
	}
	return nil
...
func (x *UpdateRapidCacheMetadata) GetAdmissionPolicy() string {
	if x != nil && x.AdmissionPolicy != nil {
		return *x.AdmissionPolicy
	}
	return ""
...
func (x *UpdateRapidCacheMetadata) GetIngestOnWrite() bool {
	if x != nil && x.IngestOnWrite != nil {
		return *x.IngestOnWrite
	}
	return false
...
func (x *UpdateRapidCacheMetadata) GetCacheType() string {
	if x != nil && x.CacheType != nil {
		return *x.CacheType
	}
	return ""
...
type AnywhereCache struct {
	...
	// Optional. Specifies whether objects are ingested into the cache upon write.
	// Defaults to false.
	IngestOnWrite *bool `protobuf:"varint,11,opt,name=ingest_on_write,json=ingestOnWrite,proto3,oneof" json:"ingest_on_write,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RapidCache struct {
	...
	CacheType string `protobuf:"bytes,3,opt,name=cache_type,json=cacheType,proto3" json:"cache_type,omitempty"`
	// Cache entry TTL (ranges between 1h to 7d). This is a cache-level config
	// that defines how long a cache entry can live. Default ttl value (24hrs)
	// is applied if not specified in the create request. TTL must be in whole
	// seconds.
	...
	// specified in the create request.
	AdmissionPolicy string `protobuf:"bytes,5,opt,name=admission_policy,json=admissionPolicy,proto3" json:"admission_policy,omitempty"`
	...
	// instance. Subsequential update requests will be rejected if this field is
	// true. Output only.
	PendingUpdate bool `protobuf:"varint,9,opt,name=pending_update,json=pendingUpdate,proto3" json:"pending_update,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RapidCache) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RapidCache) GetZone() string {
	if x != nil {
		return x.Zone
	}
	return ""
...
func (x *RapidCache) GetCacheType() string {
	if x != nil {
		return x.CacheType
	}
	return ""
...
func (x *RapidCache) GetTtl() *durationpb.Duration {
	if x != nil {
		return x.Ttl
	}
	return nil
...
func (x *RapidCache) GetAdmissionPolicy() string {
	if x != nil {
		return x.AdmissionPolicy
	}
	return ""
...
func (x *RapidCache) GetState() string {
	if x != nil {
		return x.State
	}
	return ""
...
func (x *RapidCache) GetCreateTime() *timestamppb.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *RapidCache) GetUpdateTime() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *RapidCache) GetPendingUpdate() bool {
	if x != nil {
		return x.PendingUpdate
	}
	return false
...
type CreateRapidCacheRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Required. The bucket to which this cache belongs.
	// Format: `projects/{project}/buckets/{bucket}`
	Parent string `protobuf:"bytes,1,opt,name=parent,proto3" json:"parent,omitempty"`
	...
	RapidCache *RapidCache `protobuf:"bytes,2,opt,name=rapid_cache,json=rapidCache,proto3" json:"rapid_cache,omitempty"`
	// Optional. A unique identifier for this request. UUID is the recommended
	// format, but other formats are still accepted. This request is only
	// idempotent if a `request_id` is provided.
	RequestId     string `protobuf:"bytes,3,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
...
func (x *CreateRapidCacheRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CreateRapidCacheRequest) GetRapidCache() *RapidCache {
	if x != nil {
		return x.RapidCache
	}
	return nil
...
func (x *CreateRapidCacheRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
type UpdateRapidCacheRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Required. The RapidCache to update.
	RapidCache *RapidCache `protobuf:"bytes,1,opt,name=rapid_cache,json=rapidCache,proto3" json:"rapid_cache,omitempty"`
...
func (x *UpdateRapidCacheRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *UpdateRapidCacheRequest) GetUpdateMask() *fieldmaskpb.FieldMask {
	if x != nil {
		return x.UpdateMask
	}
	return nil
...
func (x *UpdateRapidCacheRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *GetRapidCacheRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetRapidCacheRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
type ListRapidCachesRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Required. The bucket to which this cache belongs.
	Parent string `protobuf:"bytes,1,opt,name=parent,proto3" json:"parent,omitempty"`
	// Maximum number of caches to return in a single response.
...
func (x *ListRapidCachesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ListRapidCachesRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *ListRapidCachesRequest) GetPageToken() string {
	if x != nil {
		return x.PageToken
	}
	return ""
...
func (x *ListRapidCachesRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
type ListRapidCachesResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The list of rapid caches.
	RapidCaches []*RapidCache `protobuf:"bytes,1,rep,name=rapid_caches,json=rapidCaches,proto3" json:"rapid_caches,omitempty"`
	// A token, which can be sent as `page_token` to retrieve the next page.
	// If this field is omitted, there are no subsequent pages.
	NextPageToken string `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *ListRapidCachesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ListRapidCachesResponse) GetRapidCaches() []*RapidCache {
	if x != nil {
		return x.RapidCaches
	}
	return nil
}

func (x *ListRapidCachesResponse) GetNextPageToken() string {
	if x != nil {
		return x.NextPageToken
	}
	return ""
...
func (x *IntelligenceFinding) GetIntelligenceFindingDetails() isIntelligenceFinding_IntelligenceFindingDetails {
	if x != nil {
		return x.IntelligenceFindingDetails
	}
	return nil
}
...
func (x *IntelligenceFinding) GetColdlineAndArchivalStorageOperationsSpike() *IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike {
	if x != nil {
		if x, ok := x.IntelligenceFindingDetails.(*IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_); ok {
			return x.ColdlineAndArchivalStorageOperationsSpike
		}
	}
	return nil
}
...
func (x *IntelligenceFinding) GetThrottledRequestsSpike() *IntelligenceFinding_ThrottledRequestSpike {
	if x != nil {
		if x, ok := x.IntelligenceFindingDetails.(*IntelligenceFinding_ThrottledRequestsSpike); ok {
			return x.ThrottledRequestsSpike
		}
	}
	return nil
}
...
func (x *IntelligenceFinding) GetCrossRegionEgressSpike() *IntelligenceFinding_CrossRegionEgressSpike {
	if x != nil {
		if x, ok := x.IntelligenceFindingDetails.(*IntelligenceFinding_CrossRegionEgressSpike_); ok {
			return x.CrossRegionEgressSpike
		}
	}
	return nil
}
...
func (x *IntelligenceFinding) GetStorageGrowthAboveTrend() *IntelligenceFinding_StorageGrowthAboveTrend {
	if x != nil {
		if x, ok := x.IntelligenceFindingDetails.(*IntelligenceFinding_StorageGrowthAboveTrend_); ok {
			return x.StorageGrowthAboveTrend
		}
	}
	return nil
}

type isIntelligenceFinding_IntelligenceFindingDetails interface {
	isIntelligenceFinding_IntelligenceFindingDetails()
}
...
type IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_ struct {
	...
	ColdlineAndArchivalStorageOperationsSpike *IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike `protobuf:"bytes,11,opt,name=coldline_and_archival_storage_operations_spike,json=coldlineAndArchivalStorageOperationsSpike,proto3,oneof"`
}
...
func (*IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_) isIntelligenceFinding_IntelligenceFindingDetails() {
}

func (*IntelligenceFinding_ThrottledRequestsSpike) isIntelligenceFinding_IntelligenceFindingDetails() {
}

func (*IntelligenceFinding_CrossRegionEgressSpike_) isIntelligenceFinding_IntelligenceFindingDetails() {
}

func (*IntelligenceFinding_StorageGrowthAboveTrend_) isIntelligenceFinding_IntelligenceFindingDetails() {
}
...
type SummarizeIntelligenceFindingsRequest struct {
	...
	ResourceScope SummarizeIntelligenceFindingsRequest_ResourceScope `protobuf:"varint,2,opt,name=resource_scope,json=resourceScope,proto3,enum=google.storage.control.v2.SummarizeIntelligenceFindingsRequest_ResourceScope" json:"resource_scope,omitempty"`
...
func (x *SummarizeIntelligenceFindingsRequest) GetResourceScope() SummarizeIntelligenceFindingsRequest_ResourceScope {
	...
	return SummarizeIntelligenceFindingsRequest_RESOURCE_SCOPE_UNSPECIFIED
}
...
type ListIntelligenceFindingRevisionsResponse struct {
	...
	IntelligenceFindingRevisions []*IntelligenceFindingRevision `protobuf:"bytes,1,rep,name=intelligence_finding_revisions,json=intelligenceFindingRevisions,proto3" json:"intelligence_finding_revisions,omitempty"`
...
func (x *ListIntelligenceFindingRevisionsResponse) GetIntelligenceFindingRevisions() []*IntelligenceFindingRevision {
	if x != nil {
		return x.IntelligenceFindingRevisions
	}
	return nil
}
...
func (*StorageLayout_CustomPlacementConfig) Descriptor() ([]byte, []int) {
	return file_google_storage_control_v2_storage_control_proto_rawDescGZIP(), []int{12, 0}
}
...
func (*StorageLayout_HierarchicalNamespace) Descriptor() ([]byte, []int) {
	return file_google_storage_control_v2_storage_control_proto_rawDescGZIP(), []int{12, 1}
}
...
type ManagedFolder_RapidCacheConfig struct {
	...
	Policies      map[string]*ManagedFolder_RapidCacheConfig_RapidCachePolicy `protobuf:"bytes,1,rep,name=policies,proto3" json:"policies,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ManagedFolder_RapidCacheConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use ManagedFolder_RapidCacheConfig.ProtoReflect.Descriptor instead.
func (*ManagedFolder_RapidCacheConfig) Descriptor() ([]byte, []int) {
	return file_google_storage_control_v2_storage_control_proto_rawDescGZIP(), []int{14, 0}
}

func (x *ManagedFolder_RapidCacheConfig) GetPolicies() map[string]*ManagedFolder_RapidCacheConfig_RapidCachePolicy {
	if x != nil {
		return x.Policies
	}
	return nil
...
type ManagedFolder_RapidCacheConfig_RapidCachePolicy struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Required. The identifier for the rapid cache.
	RapidCacheId string `protobuf:"bytes,1,opt,name=rapid_cache_id,json=rapidCacheId,proto3" json:"rapid_cache_id,omitempty"`
	// Required. If enabled, objects in the Managed Folder will be ingested
	// into the cache when they are written.
	IngestOnWrite ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite `protobuf:"varint,2,opt,name=ingest_on_write,json=ingestOnWrite,proto3,enum=google.storage.control.v2.ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite" json:"ingest_on_write,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ManagedFolder_RapidCacheConfig_RapidCachePolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use ManagedFolder_RapidCacheConfig_RapidCachePolicy.ProtoReflect.Descriptor instead.
func (*ManagedFolder_RapidCacheConfig_RapidCachePolicy) Descriptor() ([]byte, []int) {
	return file_google_storage_control_v2_storage_control_proto_rawDescGZIP(), []int{14, 0, 0}
}

func (x *ManagedFolder_RapidCacheConfig_RapidCachePolicy) GetRapidCacheId() string {
	if x != nil {
		return x.RapidCacheId
	}
	return ""
...
func (x *ManagedFolder_RapidCacheConfig_RapidCachePolicy) GetIngestOnWrite() ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite {
	if x != nil {
		return x.IngestOnWrite
	}
	return ManagedFolder_RapidCacheConfig_RapidCachePolicy_INGEST_ON_WRITE_UNSPECIFIED
}
...
func (x *IntelligenceConfig_Filter) GetIncludedCloudStorageLocations() *IntelligenceConfig_Filter_CloudStorageLocations {
	if x != nil {
		if x, ok := x.CloudStorageLocations.(*IntelligenceConfig_Filter_IncludedCloudStorageLocations); ok {
...
func (x *IntelligenceConfig_Filter) GetExcludedCloudStorageLocations() *IntelligenceConfig_Filter_CloudStorageLocations {
	if x != nil {
		if x, ok := x.CloudStorageLocations.(*IntelligenceConfig_Filter_ExcludedCloudStorageLocations); ok {
...
func (x *IntelligenceConfig_Filter) GetIncludedCloudStorageBuckets() *IntelligenceConfig_Filter_CloudStorageBuckets {
	if x != nil {
		if x, ok := x.CloudStorageBuckets.(*IntelligenceConfig_Filter_IncludedCloudStorageBuckets); ok {
...
func (x *IntelligenceConfig_Filter) GetExcludedCloudStorageBuckets() *IntelligenceConfig_Filter_CloudStorageBuckets {
	if x != nil {
		if x, ok := x.CloudStorageBuckets.(*IntelligenceConfig_Filter_ExcludedCloudStorageBuckets); ok {
...
func (x *IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike) GetTotalOperationsCount() int64 {
	if x != nil {
		return x.TotalOperationsCount
	}
	return 0
}

func (x *IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike) GetTopBuckets() []*IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution {
	if x != nil {
		return x.TopBuckets
	}
	return nil
...
type IntelligenceFinding_StorageGrowthAboveTrend struct {
	...
	TotalStorageGrowthBytes int64 `protobuf:"varint,1,opt,name=total_storage_growth_bytes,json=totalStorageGrowthBytes,proto3" json:"total_storage_growth_bytes,omitempty"`
...
func (x *IntelligenceFinding_StorageGrowthAboveTrend) GetTotalStorageGrowthBytes() int64 {
	if x != nil {
		return x.TotalStorageGrowthBytes
	}
	return 0
}
...
func (x *IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution) GetContribution() *IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution_Contribution {
	if x != nil {
		if x, ok := x.Details.(*IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution_Contribution_); ok {
...
func (x *IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution) GetError() *status.Status {
	if x != nil {
		if x, ok := x.Details.(*IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution_Error); ok {
			return x.Error
		}
	}
	return nil
...
type isIntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution_Details interface {
	isIntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution_Details()
}
...
type IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution_Error struct {
...
func (*IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution_Contribution_) isIntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution_Details() {
}

func (*IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution_Error) isIntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution_Details() {
}
...
func (x *IntelligenceFinding_CrossRegionEgressSpike_BucketContribution) GetContribution() *IntelligenceFinding_CrossRegionEgressSpike_BucketContribution_Contribution {
	if x != nil {
		if x, ok := x.Details.(*IntelligenceFinding_CrossRegionEgressSpike_BucketContribution_Contribution_); ok {
			return x.Contribution
		}
	}
	return nil
...
func (x *IntelligenceFinding_CrossRegionEgressSpike_BucketContribution) GetError() *status.Status {
	if x != nil {
		if x, ok := x.Details.(*IntelligenceFinding_CrossRegionEgressSpike_BucketContribution_Error); ok {
			return x.Error
		}
	}
	return nil
...
type isIntelligenceFinding_CrossRegionEgressSpike_BucketContribution_Details interface {
	isIntelligenceFinding_CrossRegionEgressSpike_BucketContribution_Details()
}
...
type IntelligenceFinding_CrossRegionEgressSpike_BucketContribution_Error struct {
	// Output only. The error related to accessing the details about the
	// contribution of the bucket.
	Error *status.Status `protobuf:"bytes,5,opt,name=error,proto3,oneof"`
}

func (*IntelligenceFinding_CrossRegionEgressSpike_BucketContribution_Contribution_) isIntelligenceFinding_CrossRegionEgressSpike_BucketContribution_Details() {
}

func (*IntelligenceFinding_CrossRegionEgressSpike_BucketContribution_Error) isIntelligenceFinding_CrossRegionEgressSpike_BucketContribution_Details() {
}
...
func (x *IntelligenceFinding_ThrottledRequestSpike_BucketContribution) GetContribution() *IntelligenceFinding_ThrottledRequestSpike_BucketContribution_Contribution {
	if x != nil {
		if x, ok := x.Details.(*IntelligenceFinding_ThrottledRequestSpike_BucketContribution_Contribution_); ok {
			return x.Contribution
		}
	}
	return nil
...
func (x *IntelligenceFinding_ThrottledRequestSpike_BucketContribution) GetError() *status.Status {
	if x != nil {
		if x, ok := x.Details.(*IntelligenceFinding_ThrottledRequestSpike_BucketContribution_Error); ok {
			return x.Error
		}
	}
	return nil
...
type isIntelligenceFinding_ThrottledRequestSpike_BucketContribution_Details interface {
	isIntelligenceFinding_ThrottledRequestSpike_BucketContribution_Details()
}
...
type IntelligenceFinding_ThrottledRequestSpike_BucketContribution_Error struct {
	// Output only. The error related to accessing the details about the
	// contribution of the bucket.
	Error *status.Status `protobuf:"bytes,5,opt,name=error,proto3,oneof"`
}

func (*IntelligenceFinding_ThrottledRequestSpike_BucketContribution_Contribution_) isIntelligenceFinding_ThrottledRequestSpike_BucketContribution_Details() {
}

func (*IntelligenceFinding_ThrottledRequestSpike_BucketContribution_Error) isIntelligenceFinding_ThrottledRequestSpike_BucketContribution_Details() {
}
...
type IntelligenceFinding_StorageGrowthAboveTrend_BucketContribution struct {
	...
	TotalStorageGrowthBytes int64 `protobuf:"varint,2,opt,name=total_storage_growth_bytes,json=totalStorageGrowthBytes,proto3" json:"total_storage_growth_bytes,omitempty"`
...
func (x *IntelligenceFinding_StorageGrowthAboveTrend_BucketContribution) GetError() *status.Status {
	if x != nil {
		if x, ok := x.Details.(*IntelligenceFinding_StorageGrowthAboveTrend_BucketContribution_Error); ok {
			return x.Error
		}
	}
	return nil
...
type isIntelligenceFinding_StorageGrowthAboveTrend_BucketContribution_Details interface {
	isIntelligenceFinding_StorageGrowthAboveTrend_BucketContribution_Details()
}

type IntelligenceFinding_StorageGrowthAboveTrend_BucketContribution_Error struct {
	// Output only. The error related to accessing the details about the
	// contribution of the bucket.
	Error *status.Status `protobuf:"bytes,5,opt,name=error,proto3,oneof"`
}

func (*IntelligenceFinding_StorageGrowthAboveTrend_BucketContribution_Error) isIntelligenceFinding_StorageGrowthAboveTrend_BucketContribution_Details() {
}
...
type FindingSummary_SummaryDetails struct {
	...
	ResourceType FindingSummary_SummaryDetails_ResourceType `protobuf:"varint,3,opt,name=resource_type,json=resourceType,proto3,enum=google.storage.control.v2.FindingSummary_SummaryDetails_ResourceType" json:"resource_type,omitempty"`
...
func (x *FindingSummary_SummaryDetails) GetCount() int64 {
	if x != nil {
		if x, ok := x.Magnitude.(*FindingSummary_SummaryDetails_Count); ok {
			return x.Count
		}
	}
	return 0
...
func (x *FindingSummary_SummaryDetails) GetPercentage() float32 {
	if x != nil {
		if x, ok := x.Magnitude.(*FindingSummary_SummaryDetails_Percentage); ok {
			return x.Percentage
		}
	}
	return 0
...
func (x *FindingSummary_SummaryDetails) GetResourceType() FindingSummary_SummaryDetails_ResourceType {
	...
	return FindingSummary_SummaryDetails_RESOURCE_TYPE_UNSPECIFIED
}
...
type isFindingSummary_SummaryDetails_Magnitude interface {
	isFindingSummary_SummaryDetails_Magnitude()
}
...
func (*FindingSummary_SummaryDetails_Count) isFindingSummary_SummaryDetails_Magnitude() {}

func (*FindingSummary_SummaryDetails_Percentage) isFindingSummary_SummaryDetails_Magnitude() {}

var File_google_storage_control_v2_storage_control_proto protoreflect.FileDescriptor

const file_google_storage_control_v2_storage_control_proto_rawDesc = "" +
	"\n" +
	...
	"\x11PendingRenameInfo\x12!\n" +
	"\toperation\x18\x01 \x01(\tB\x03\xe0A\x03R\toperation\"\xa3\x03\n" +
	"\x06Folder\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12+\n" +
	"\x0emetageneration\x18\x03 \x01(\x03B\x03\xe0A\x03R\x0emetageneration\x12@\n" +
	"\vcreate_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12@\n" +
	"\vupdate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12a\n" +
	"\x13pending_rename_info\x18\a \x01(\v2,.google.storage.control.v2.PendingRenameInfoB\x03\xe0A\x03R\x11pendingRenameInfo:l\xeaAi\n" +
	"\x1dstorage.googleapis.com/Folder\x127projects/{project}/buckets/{bucket}/folders/{folder=**}*\afolders2\x06folder\"\xb6\x02\n" +
	"\x10GetFolderRequest\x129\n" +
	"\x04name\x18\x06 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dstorage.googleapis.com/FolderR\x04name\x12;\n" +
	"\x17if_metageneration_match\x18\x03 \x01(\x03H\x00R\x15ifMetagenerationMatch\x88\x01\x01\x12B\n" +
	"\x1bif_metageneration_not_match\x18\x04 \x01(\x03H\x01R\x18ifMetagenerationNotMatch\x88\x01\x01\x12*\n" +
	"\n" +
	"request_id\x18\x05 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestIdB\x1a\n" +
	"\x18_if_metageneration_matchB\x1e\n" +
	"\x1c_if_metageneration_not_match\"\x85\x02\n" +
	"\x13CreateFolderRequest\x12=\n" +
	"\x06parent\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\x12\x1dstorage.googleapis.com/FolderR\x06parent\x12>\n" +
	"\x06folder\x18\x02 \x01(\v2!.google.storage.control.v2.FolderB\x03\xe0A\x02R\x06folder\x12 \n" +
	"\tfolder_id\x18\x03 \x01(\tB\x03\xe0A\x02R\bfolderId\x12!\n" +
	"\trecursive\x18\x04 \x01(\bB\x03\xe0A\x01R\trecursive\x12*\n" +
	"\n" +
	"request_id\x18\x05 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\xb9\x02\n" +
	"\x13DeleteFolderRequest\x129\n" +
	"\x04name\x18\x06 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dstorage.googleapis.com/FolderR\x04name\x12;\n" +
	"\x17if_metageneration_match\x18\x03 \x01(\x03H\x00R\x15ifMetagenerationMatch\x88\x01\x01\x12B\n" +
	"\x1bif_metageneration_not_match\x18\x04 \x01(\x03H\x01R\x18ifMetagenerationNotMatch\x88\x01\x01\x12*\n" +
	...
	"request_id\x18\x05 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestIdB\x1a\n" +
	"\x18_if_metageneration_matchB\x1e\n" +
	"\x1c_if_metageneration_not_match\"\xed\x02\n" +
	...
	"\tdelimiter\x18\b \x01(\tB\x03\xe0A\x01R\tdelimiter\x124\n" +
	"\x13lexicographic_start\x18\x06 \x01(\tB\x03\xe0A\x01R\x12lexicographicStart\x120\n" +
	"\x11lexicographic_end\x18\a \x01(\tB\x03\xe0A\x01R\x10lexicographicEnd\x12*\n" +
	"\n" +
	"request_id\x18\t \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"z\n" +
	"\x13ListFoldersResponse\x12;\n" +
	"\afolders\x18\x01 \x03(\v2!.google.storage.control.v2.FolderR\afolders\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xf2\x02\n" +
	"\x13RenameFolderRequest\x129\n" +
	"\x04name\x18\a \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dstorage.googleapis.com/FolderR\x04name\x127\n" +
	"\x15destination_folder_id\x18\b \x01(\tB\x03\xe0A\x02R\x13destinationFolderId\x12;\n" +
	...
	"\n" +
	"request_id\x18\x06 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestIdB\x1a\n" +
	"\x18_if_metageneration_matchB\x1e\n" +
	"\x1c_if_metageneration_not_match\"\xcc\x02\n" +
	"\x1cDeleteFolderRecursiveRequest\x129\n" +
	"\x04name\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dstorage.googleapis.com/FolderR\x04name\x12@\n" +
	"\x17if_metageneration_match\x18\x02 \x01(\x03B\x03\xe0A\x01H\x00R\x15ifMetagenerationMatch\x88\x01\x01\x12G\n" +
	"\x1bif_metageneration_not_match\x18\x03 \x01(\x03B\x03\xe0A\x01H\x01R\x18ifMetagenerationNotMatch\x88\x01\x01\x12*\n" +
	"\n" +
	"request_id\x18\x04 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestIdB\x1a\n" +
	"\x18_if_metageneration_matchB\x1e\n" +
	"\x1c_if_metageneration_not_match\"\xe9\x02\n" +
	"\"CommonLongRunningOperationMetadata\x12@\n" +
	...
	"\x10progress_percent\x18\x06 \x01(\x05B\x03\xe0A\x03R\x0fprogressPercent\"\xdc\x01\n" +
	"\x14RenameFolderMetadata\x12f\n" +
	...
	"\x15destination_folder_id\x18\x03 \x01(\tR\x13destinationFolderId\"\xa4\x01\n" +
	"\x1dDeleteFolderRecursiveMetadata\x12f\n" +
	"\x0fcommon_metadata\x18\x01 \x01(\v2=.google.storage.control.v2.CommonLongRunningOperationMetadataR\x0ecommonMetadata\x12\x1b\n" +
	"\tfolder_id\x18\x02 \x01(\tR\bfolderId\"\xdc\x04\n" +
	"\rStorageLayout\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12\x1f\n" +
	"\blocation\x18\x02 \x01(\tB\x03\xe0A\x03R\blocation\x12(\n" +
	"\rlocation_type\x18\x03 \x01(\tB\x03\xe0A\x03R\flocationType\x12{\n" +
	"\x17custom_placement_config\x18\x04 \x01(\v2>.google.storage.control.v2.StorageLayout.CustomPlacementConfigB\x03\xe0A\x03R\x15customPlacementConfig\x12z\n" +
	"\x16hierarchical_namespace\x18\x05 \x01(\v2>.google.storage.control.v2.StorageLayout.HierarchicalNamespaceB\x03\xe0A\x03R\x15hierarchicalNamespace\x1a>\n" +
	"\x15CustomPlacementConfig\x12%\n" +
	"\x0edata_locations\x18\x01 \x03(\tR\rdataLocations\x1a1\n" +
	"\x15HierarchicalNamespace\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled:{\xeaAx\n" +
	"$storage.googleapis.com/StorageLayout\x121projects/{project}/buckets/{bucket}/storageLayout*\x0estorageLayouts2\rstorageLayout\"\x9f\x01\n" +
	"\x17GetStorageLayoutRequest\x12@\n" +
	"\x04name\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\n" +
	"$storage.googleapis.com/StorageLayoutR\x04name\x12\x16\n" +
	"\x06prefix\x18\x02 \x01(\tR\x06prefix\x12*\n" +
	"\n" +
	"request_id\x18\x03 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\x92\b\n" +
	"\rManagedFolder\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12+\n" +
	"\x0emetageneration\x18\x03 \x01(\x03B\x03\xe0A\x03R\x0emetageneration\x12@\n" +
	"\vcreate_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12@\n" +
	"\vupdate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12l\n" +
	"\x12rapid_cache_config\x18\x06 \x01(\v29.google.storage.control.v2.ManagedFolder.RapidCacheConfigH\x00R\x10rapidCacheConfig\x88\x01\x01\x1a\x9d\x04\n" +
	"\x10RapidCacheConfig\x12h\n" +
	"\bpolicies\x18\x01 \x03(\v2G.google.storage.control.v2.ManagedFolder.RapidCacheConfig.PoliciesEntryB\x03\xe0A\x01R\bpolicies\x1a\x94\x02\n" +
	"\x10RapidCachePolicy\x12)\n" +
	"\x0erapid_cache_id\x18\x01 \x01(\tB\x03\xe0A\x02R\frapidCacheId\x12\x85\x01\n" +
	"\x0fingest_on_write\x18\x02 \x01(\x0e2X.google.storage.control.v2.ManagedFolder.RapidCacheConfig.RapidCachePolicy.IngestOnWriteB\x03\xe0A\x02R\ringestOnWrite\"M\n" +
	"\rIngestOnWrite\x12\x1f\n" +
	"\x1bINGEST_ON_WRITE_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17INGEST_ON_WRITE_ENABLED\x10\x01\x1a\x87\x01\n" +
	"\rPoliciesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12`\n" +
	"\x05value\x18\x02 \x01(\v2J.google.storage.control.v2.ManagedFolder.RapidCacheConfig.RapidCachePolicyR\x05value:\x028\x01:\x91\x01\xeaA\x8d\x01\n" +
	"$storage.googleapis.com/ManagedFolder\x12Fprojects/{project}/buckets/{bucket}/managedFolders/{managed_folder=**}*\x0emanagedFolders2\rmanagedFolderB\x15\n" +
	"\x13_rapid_cache_config\"\xc4\x02\n" +
	"\x17GetManagedFolderRequest\x12@\n" +
	"\x04name\x18\x06 \x01(\tB,\xe0A\x02\xfaA&\n" +
	"$storage.googleapis.com/ManagedFolderR\x04name\x12;\n" +
	"\x17if_metageneration_match\x18\x03 \x01(\x03H\x00R\x15ifMetagenerationMatch\x88\x01\x01\x12B\n" +
	"\x1bif_metageneration_not_match\x18\x04 \x01(\x03H\x01R\x18ifMetagenerationNotMatch\x88\x01\x01\x12*\n" +
	"\n" +
	"request_id\x18\x05 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestIdB\x1a\n" +
	...
	"\x1aCreateManagedFolderRequest\x12D\n" +
	"\x06parent\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\x12$storage.googleapis.com/ManagedFolderR\x06parent\x12T\n" +
	"\x0emanaged_folder\x18\x02 \x01(\v2(.google.storage.control.v2.ManagedFolderB\x03\xe0A\x02R\rmanagedFolder\x12/\n" +
	"\x11managed_folder_id\x18\x03 \x01(\tB\x03\xe0A\x02R\x0fmanagedFolderId\x12*\n" +
	"\n" +
	"request_id\x18\x04 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\xef\x02\n" +
	"\x1aDeleteManagedFolderRequest\x12@\n" +
	"\x04name\x18\a \x01(\tB,\xe0A\x02\xfaA&\n" +
	"$storage.googleapis.com/ManagedFolderR\x04name\x12;\n" +
	"\x17if_metageneration_match\x18\x03 \x01(\x03H\x00R\x15ifMetagenerationMatch\x88\x01\x01\x12B\n" +
	"\x1bif_metageneration_not_match\x18\x04 \x01(\x03H\x01R\x18ifMetagenerationNotMatch\x88\x01\x01\x12&\n" +
	"\x0fallow_non_empty\x18\x05 \x01(\bR\rallowNonEmpty\x12*\n" +
	"\n" +
	"request_id\x18\x06 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestIdB\x1a\n" +
	"\x18_if_metageneration_matchB\x1e\n" +
	"\x1c_if_metageneration_not_match\"\xf0\x01\n" +
	"\x19ListManagedFoldersRequest\x12D\n" +
	"\x06parent\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\x12$storage.googleapis.com/ManagedFolderR\x06parent\x12 \n" +
	"\tpage_size\x18\x02 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tB\x03\xe0A\x01R\tpageToken\x12\x1b\n" +
	"\x06prefix\x18\x04 \x01(\tB\x03\xe0A\x01R\x06prefix\x12*\n" +
	"\n" +
	"request_id\x18\x05 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\x97\x01\n" +
	"\x1aListManagedFoldersResponse\x12Q\n" +
	"\x0fmanaged_folders\x18\x01 \x03(\v2(.google.storage.control.v2.ManagedFolderR\x0emanagedFolders\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xa7\x03\n" +
	"\x1aUpdateManagedFolderRequest\x12T\n" +
	"\x0emanaged_folder\x18\x01 \x01(\v2(.google.storage.control.v2.ManagedFolderB\x03\xe0A\x02R\rmanagedFolder\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x01R\n" +
	"updateMask\x12@\n" +
	"\x17if_metageneration_match\x18\x03 \x01(\x03B\x03\xe0A\x01H\x00R\x15ifMetagenerationMatch\x88\x01\x01\x12G\n" +
	"\x1bif_metageneration_not_match\x18\x04 \x01(\x03B\x03\xe0A\x01H\x01R\x18ifMetagenerationNotMatch\x88\x01\x01\x12*\n" +
	"\n" +
	"request_id\x18\x05 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestIdB\x1a\n" +
	"\x18_if_metageneration_matchB\x1e\n" +
	"\x1c_if_metageneration_not_match\"\xb3\x03\n" +
	"\x1bCreateAnywhereCacheMetadata\x12f\n" +
	"\x0fcommon_metadata\x18\x01 \x01(\v2=.google.storage.control.v2.CommonLongRunningOperationMetadataR\x0ecommonMetadata\x12/\n" +
	"\x11anywhere_cache_id\x18\x02 \x01(\tH\x00R\x0fanywhereCacheId\x88\x01\x01\x12\x17\n" +
	"\x04zone\x18\x06 \x01(\tH\x01R\x04zone\x88\x01\x01\x120\n" +
	"\x03ttl\x18\x03 \x01(\v2\x19.google.protobuf.DurationH\x02R\x03ttl\x88\x01\x01\x12.\n" +
	"\x10admission_policy\x18\x05 \x01(\tH\x03R\x0fadmissionPolicy\x88\x01\x01\x120\n" +
	"\x0fingest_on_write\x18\a \x01(\bB\x03\xe0A\x01H\x04R\ringestOnWrite\x88\x01\x01B\x14\n" +
	"\x12_anywhere_cache_idB\a\n" +
	"\x05_zoneB\x06\n" +
	"\x04_ttlB\x13\n" +
	"\x11_admission_policyB\x12\n" +
	"\x10_ingest_on_write\"\xdf\x03\n" +
	"\x18CreateRapidCacheMetadata\x12f\n" +
	"\x0fcommon_metadata\x18\x01 \x01(\v2=.google.storage.control.v2.CommonLongRunningOperationMetadataR\x0ecommonMetadata\x12)\n" +
	"\x0erapid_cache_id\x18\x02 \x01(\tH\x00R\frapidCacheId\x88\x01\x01\x12\x17\n" +
	"\x04zone\x18\x03 \x01(\tH\x01R\x04zone\x88\x01\x01\x120\n" +
	"\x03ttl\x18\x04 \x01(\v2\x19.google.protobuf.DurationH\x02R\x03ttl\x88\x01\x01\x12.\n" +
	"\x10admission_policy\x18\x05 \x01(\tH\x03R\x0fadmissionPolicy\x88\x01\x01\x120\n" +
	"\x0fingest_on_write\x18\x06 \x01(\bB\x03\xe0A\x01H\x04R\ringestOnWrite\x88\x01\x01\x12'\n" +
	"\n" +
	"cache_type\x18\a \x01(\tB\x03\xe0A\x01H\x05R\tcacheType\x88\x01\x01B\x11\n" +
	"\x0f_rapid_cache_idB\a\n" +
	"\x05_zoneB\x06\n" +
	"\x04_ttlB\x13\n" +
	"\x11_admission_policyB\x12\n" +
	"\x10_ingest_on_writeB\r\n" +
	"\v_cache_type\"\xb3\x03\n" +
	"\x1bUpdateAnywhereCacheMetadata\x12f\n" +
	"\x0fcommon_metadata\x18\x01 \x01(\v2=.google.storage.control.v2.CommonLongRunningOperationMetadataR\x0ecommonMetadata\x12/\n" +
	"\x11anywhere_cache_id\x18\x02 \x01(\tH\x00R\x0fanywhereCacheId\x88\x01\x01\x12\x17\n" +
	"\x04zone\x18\x05 \x01(\tH\x01R\x04zone\x88\x01\x01\x120\n" +
	"\x03ttl\x18\x03 \x01(\v2\x19.google.protobuf.DurationH\x02R\x03ttl\x88\x01\x01\x123\n" +
	"\x10admission_policy\x18\x04 \x01(\tB\x03\xe0A\x01H\x03R\x0fadmissionPolicy\x88\x01\x01\x12+\n" +
	"\x0fingest_on_write\x18\x06 \x01(\bH\x04R\ringestOnWrite\x88\x01\x01B\x14\n" +
	"\x12_anywhere_cache_idB\a\n" +
	"\x05_zoneB\x06\n" +
	"\x04_ttlB\x13\n" +
	"\x11_admission_policyB\x12\n" +
	"\x10_ingest_on_write\"\xdf\x03\n" +
	"\x18UpdateRapidCacheMetadata\x12f\n" +
	"\x0fcommon_metadata\x18\x01 \x01(\v2=.google.storage.control.v2.CommonLongRunningOperationMetadataR\x0ecommonMetadata\x12)\n" +
	"\x0erapid_cache_id\x18\x02 \x01(\tH\x00R\frapidCacheId\x88\x01\x01\x12\x17\n" +
	"\x04zone\x18\x03 \x01(\tH\x01R\x04zone\x88\x01\x01\x120\n" +
	"\x03ttl\x18\x04 \x01(\v2\x19.google.protobuf.DurationH\x02R\x03ttl\x88\x01\x01\x123\n" +
	"\x10admission_policy\x18\x05 \x01(\tB\x03\xe0A\x01H\x03R\x0fadmissionPolicy\x88\x01\x01\x12+\n" +
	"\x0fingest_on_write\x18\x06 \x01(\bH\x04R\ringestOnWrite\x88\x01\x01\x12'\n" +
	"\n" +
	"cache_type\x18\a \x01(\tB\x03\xe0A\x01H\x05R\tcacheType\x88\x01\x01B\x11\n" +
	"\x0f_rapid_cache_idB\a\n" +
	"\x05_zoneB\x06\n" +
	...
	"\x04zone\x18\n" +
	" \x01(\tB\x03\xe0A\x05R\x04zone\x12+\n" +
	"\x03ttl\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\x03ttl\x12)\n" +
	"\x10admission_policy\x18\t \x01(\tR\x0fadmissionPolicy\x12\x19\n" +
	...
	"updateTime\x12*\n" +
	"\x0epending_update\x18\b \x01(\bB\x03\xe0A\x03R\rpendingUpdate\x120\n" +
	"\x0fingest_on_write\x18\v \x01(\bB\x03\xe0A\x01H\x00R\ringestOnWrite\x88\x01\x01:\x8e\x01\xeaA\x8a\x01\n" +
	"$storage.googleapis.com/AnywhereCache\x12Cprojects/{project}/buckets/{bucket}/anywhereCaches/{anywhere_cache}*\x0eanywhereCaches2\ranywhereCacheB\x12\n" +
	"\x10_ingest_on_write\"\xe4\x01\n" +
	"\x1aCreateAnywhereCacheRequest\x12D\n" +
	"\x06parent\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\x12$storage.googleapis.com/AnywhereCacheR\x06parent\x12T\n" +
	"\x0eanywhere_cache\x18\x03 \x01(\v2(.google.storage.control.v2.AnywhereCacheB\x03\xe0A\x02R\ranywhereCache\x12*\n" +
	"\n" +
	"request_id\x18\x04 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\xe0\x01\n" +
	"\x1aUpdateAnywhereCacheRequest\x12T\n" +
	"\x0eanywhere_cache\x18\x01 \x01(\v2(.google.storage.control.v2.AnywhereCacheB\x03\xe0A\x02R\ranywhereCache\x12@\n" +
	...
	"\x04name\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\n" +
	"$storage.googleapis.com/AnywhereCacheR\x04name\x12*\n" +
	"\n" +
	"request_id\x18\x02 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\x89\x01\n" +
	"\x19PauseAnywhereCacheRequest\x12@\n" +
	"\x04name\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\n" +
	"$storage.googleapis.com/AnywhereCacheR\x04name\x12*\n" +
	"\n" +
	"request_id\x18\x02 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\x8a\x01\n" +
	"\x1aResumeAnywhereCacheRequest\x12@\n" +
	"\x04name\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\n" +
	"$storage.googleapis.com/AnywhereCacheR\x04name\x12*\n" +
	"\n" +
	"request_id\x18\x02 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\x87\x01\n" +
	"\x17GetAnywhereCacheRequest\x12@\n" +
	"\x04name\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\n" +
	"$storage.googleapis.com/AnywhereCacheR\x04name\x12*\n" +
	"\n" +
	"request_id\x18\x02 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\xc9\x01\n" +
	"\x19ListAnywhereCachesRequest\x12D\n" +
	"\x06parent\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\x12$storage.googleapis.com/AnywhereCacheR\x06parent\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken\x12*\n" +
	"\n" +
	"request_id\x18\x04 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\x97\x01\n" +
	"\x1aListAnywhereCachesResponse\x12Q\n" +
	"\x0fanywhere_caches\x18\x01 \x03(\v2(.google.storage.control.v2.AnywhereCacheR\x0eanywhereCaches\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\x85\x04\n" +
	"\n" +
	"RapidCache\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x05R\x04name\x12\x17\n" +
	"\x04zone\x18\x02 \x01(\tB\x03\xe0A\x05R\x04zone\x12\"\n" +
	"\n" +
	"cache_type\x18\x03 \x01(\tB\x03\xe0A\x05R\tcacheType\x12+\n" +
	"\x03ttl\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\x03ttl\x12)\n" +
	"\x10admission_policy\x18\x05 \x01(\tR\x0fadmissionPolicy\x12\x19\n" +
	"\x05state\x18\x06 \x01(\tB\x03\xe0A\x03R\x05state\x12@\n" +
	...
	"updateTime\x12*\n" +
	"\x0epending_update\x18\t \x01(\bB\x03\xe0A\x03R\rpendingUpdate:~\xeaA{\n" +
	"!storage.googleapis.com/RapidCache\x12=projects/{project}/buckets/{bucket}/rapidCaches/{rapid_cache}*\vrapidCaches2\n" +
	"rapidCache\"\xd5\x01\n" +
	"\x17CreateRapidCacheRequest\x12A\n" +
	"\x06parent\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\x12!storage.googleapis.com/RapidCacheR\x06parent\x12K\n" +
	"\vrapid_cache\x18\x02 \x01(\v2%.google.storage.control.v2.RapidCacheB\x03\xe0A\x02R\n" +
	"rapidCache\x12*\n" +
	"\n" +
	"request_id\x18\x03 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\xd4\x01\n" +
	"\x17UpdateRapidCacheRequest\x12K\n" +
	"\vrapid_cache\x18\x01 \x01(\v2%.google.storage.control.v2.RapidCacheB\x03\xe0A\x02R\n" +
	"rapidCache\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\x12*\n" +
	"\n" +
	...
	"\n" +
	"request_id\x18\x02 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\xc3\x01\n" +
	"\x16ListRapidCachesRequest\x12A\n" +
	"\x06parent\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\x12!storage.googleapis.com/RapidCacheR\x06parent\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken\x12*\n" +
	"\n" +
	"request_id\x18\x04 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\x8b\x01\n" +
	"\x17ListRapidCachesResponse\x12H\n" +
	"\frapid_caches\x18\x01 \x03(\v2%.google.storage.control.v2.RapidCacheR\vrapidCaches\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xbd\x10\n" +
	"\x12IntelligenceConfig\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12g\n" +
	"\x0eedition_config\x18\x02 \x01(\x0e2;.google.storage.control.v2.IntelligenceConfig.EditionConfigB\x03\xe0A\x01R\reditionConfig\x12@\n" +
	"\vupdate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12Q\n" +
	"\x06filter\x18\x04 \x01(\v24.google.storage.control.v2.IntelligenceConfig.FilterB\x03\xe0A\x01R\x06filter\x12\x92\x01\n" +
	"\x1deffective_intelligence_config\x18\x05 \x01(\v2I.google.storage.control.v2.IntelligenceConfig.EffectiveIntelligenceConfigB\x03\xe0A\x03R\x1beffectiveIntelligenceConfig\x12\\\n" +
	"\ftrial_config\x18\a \x01(\v29.google.storage.control.v2.IntelligenceConfig.TrialConfigR\vtrialConfig\x1a\x94\x06\n" +
	"\x06Filter\x12\x95\x01\n" +
	" included_cloud_storage_locations\x18\x01 \x01(\v2J.google.storage.control.v2.IntelligenceConfig.Filter.CloudStorageLocationsH\x00R\x1dincludedCloudStorageLocations\x12\x95\x01\n" +
	" excluded_cloud_storage_locations\x18\x02 \x01(\v2J.google.storage.control.v2.IntelligenceConfig.Filter.CloudStorageLocationsH\x00R\x1dexcludedCloudStorageLocations\x12\x8f\x01\n" +
	"\x1eincluded_cloud_storage_buckets\x18\x03 \x01(\v2H.google.storage.control.v2.IntelligenceConfig.Filter.CloudStorageBucketsH\x01R\x1bincludedCloudStorageBuckets\x12\x8f\x01\n" +
	"\x1eexcluded_cloud_storage_buckets\x18\x04 \x01(\v2H.google.storage.control.v2.IntelligenceConfig.Filter.CloudStorageBucketsH\x01R\x1bexcludedCloudStorageBuckets\x1a:\n" +
	"\x15CloudStorageLocations\x12!\n" +
	"\tlocations\x18\x01 \x03(\tB\x03\xe0A\x01R\tlocations\x1aF\n" +
	"\x13CloudStorageBuckets\x12/\n" +
	"\x11bucket_id_regexes\x18\x01 \x03(\tB\x03\xe0A\x01R\x0fbucketIdRegexesB\x19\n" +
	"\x17cloud_storage_locationsB\x17\n" +
	"\x15cloud_storage_buckets\x1a\xb1\x02\n" +
	"\x1bEffectiveIntelligenceConfig\x12\x8c\x01\n" +
	"\x11effective_edition\x18\x01 \x01(\x0e2Z.google.storage.control.v2.IntelligenceConfig.EffectiveIntelligenceConfig.EffectiveEditionB\x03\xe0A\x03R\x10effectiveEdition\x124\n" +
	"\x13intelligence_config\x18\x02 \x01(\tB\x03\xe0A\x03R\x12intelligenceConfig\"M\n" +
	"\x10EffectiveEdition\x12!\n" +
	"\x1dEFFECTIVE_EDITION_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04NONE\x10\x01\x12\f\n" +
	"\bSTANDARD\x10\x02\x1aO\n" +
	"\vTrialConfig\x12@\n" +
	"\vexpire_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"expireTime\"s\n" +
	"\rEditionConfig\x12\x1e\n" +
	"\x1aEDITION_CONFIG_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aINHERIT\x10\x01\x12\f\n" +
	"\bDISABLED\x10\x02\x12\f\n" +
	"\bSTANDARD\x10\x03\x12\t\n" +
	"\x05TRIAL\x10\x05\x12\x0e\n" +
	"\n" +
	"ESSENTIALS\x10\x06:\x8b\x02\xeaA\x87\x02\n" +
	")storage.googleapis.com/IntelligenceConfig\x128folders/{folder}/locations/{location}/intelligenceConfig\x12;organizations/{org}/locations/{location}/intelligenceConfig\x12:projects/{project}/locations/{location}/intelligenceConfig*\x13intelligenceConfigs2\x12intelligenceConfig\"\x80\x02\n" +
	"+UpdateOrganizationIntelligenceConfigRequest\x12c\n" +
	"\x13intelligence_config\x18\x01 \x01(\v2-.google.storage.control.v2.IntelligenceConfigB\x03\xe0A\x02R\x12intelligenceConfig\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\x12*\n" +
	"\n" +
	"request_id\x18\x03 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\xfa\x01\n" +
	"%UpdateFolderIntelligenceConfigRequest\x12c\n" +
	"\x13intelligence_config\x18\x01 \x01(\v2-.google.storage.control.v2.IntelligenceConfigB\x03\xe0A\x02R\x12intelligenceConfig\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\x12*\n" +
	"\n" +
	"request_id\x18\x03 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\xfb\x01\n" +
	"&UpdateProjectIntelligenceConfigRequest\x12c\n" +
	"\x13intelligence_config\x18\x01 \x01(\v2-.google.storage.control.v2.IntelligenceConfigB\x03\xe0A\x02R\x12intelligenceConfig\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\x12*\n" +
	"\n" +
	"request_id\x18\x03 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"q\n" +
	"(GetOrganizationIntelligenceConfigRequest\x12E\n" +
	"\x04name\x18\x01 \x01(\tB1\xe0A\x02\xfaA+\n" +
	")storage.googleapis.com/IntelligenceConfigR\x04name\"k\n" +
	"\"GetFolderIntelligenceConfigRequest\x12E\n" +
	"\x04name\x18\x01 \x01(\tB1\xe0A\x02\xfaA+\n" +
	")storage.googleapis.com/IntelligenceConfigR\x04name\"l\n" +
	"#GetProjectIntelligenceConfigRequest\x12E\n" +
	"\x04name\x18\x01 \x01(\tB1\xe0A\x02\xfaA+\n" +
	")storage.googleapis.com/IntelligenceConfigR\x04name\"\xc9'\n" +
	"\x13IntelligenceFinding\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12%\n" +
	"\vdescription\x18\x02 \x01(\tB\x03\xe0A\x03R\vdescription\x12?\n" +
	"\x04type\x18\x03 \x01(\x0e2&.google.storage.control.v2.FindingTypeB\x03\xe0A\x03R\x04type\x12K\n" +
	"\bcategory\x18\x04 \x01(\x0e2*.google.storage.control.v2.FindingCategoryB\x03\xe0A\x03R\bcategory\x12K\n" +
	"\bseverity\x18\x05 \x01(\x0e2*.google.storage.control.v2.FindingSeverityB\x03\xe0A\x03R\bseverity\x12@\n" +
	"\vcreate_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12@\n" +
	"\vupdate_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12,\n" +
	"\x0ftarget_resource\x18\b \x01(\tB\x03\xe0A\x03R\x0etargetResource\x126\n" +
	"\x14associated_resources\x18\t \x03(\tB\x03\xe0A\x03R\x13associatedResources\x12I\n" +
	"\x12observation_period\x18\n" +
	" \x01(\v2\x15.google.type.IntervalB\x03\xe0A\x03R\x11observationPeriod\x12\xc2\x01\n" +
	".coldline_and_archival_storage_operations_spike\x18\v \x01(\v2X.google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpikeB\x03\xe0A\x03H\x00R)coldlineAndArchivalStorageOperationsSpike\x12\x85\x01\n" +
	"\x18throttled_requests_spike\x18\f \x01(\v2D.google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpikeB\x03\xe0A\x03H\x00R\x16throttledRequestsSpike\x12\x87\x01\n" +
	"\x19cross_region_egress_spike\x18\r \x01(\v2E.google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpikeB\x03\xe0A\x03H\x00R\x16crossRegionEgressSpike\x12\x8a\x01\n" +
	"\x1astorage_growth_above_trend\x18\x0e \x01(\v2F.google.storage.control.v2.IntelligenceFinding.StorageGrowthAboveTrendB\x03\xe0A\x03H\x00R\x17storageGrowthAboveTrend\x1a\xc6\b\n" +
	")ColdlineAndArchivalStorageOperationsSpike\x124\n" +
	"\x13percentage_increase\x18\x01 \x01(\x01B\x03\xe0A\x03R\x12percentageIncrease\x129\n" +
	"\x16total_operations_count\x18\x02 \x01(\x03B\x03\xe0A\x03R\x14totalOperationsCount\x12\x91\x01\n" +
	"\vtop_buckets\x18\x03 \x03(\v2k.google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpike.BucketContributionB\x03\xe0A\x03R\n" +
	"topBuckets\x1a\x93\x06\n" +
	"\x12BucketContribution\x12=\n" +
	"\x06bucket\x18\x01 \x01(\tB%\xe0A\x03\xfaA\x1f\n" +
	"\x1dstorage.googleapis.com/BucketR\x06bucket\x124\n" +
	"\x13percentage_increase\x18\x02 \x01(\x01B\x03\xe0A\x03R\x12percentageIncrease\x129\n" +
	"\x16total_operations_count\x18\x03 \x01(\x03B\x03\xe0A\x03R\x14totalOperationsCount\x12\xa3\x01\n" +
	"\fcontribution\x18\x04 \x01(\v2x.google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpike.BucketContribution.ContributionB\x03\xe0A\x03H\x00R\fcontribution\x12/\n" +
	"\x05error\x18\x05 \x01(\v2\x12.google.rpc.StatusB\x03\xe0A\x03H\x00R\x05error\x1a\xea\x02\n" +
	"\fContribution\x12\xb4\x01\n" +
	"\ftop_prefixes\x18\x01 \x03(\v2\x8b\x01.google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpike.BucketContribution.Contribution.PrefixContributionB\x03\xe0A\x03R\vtopPrefixes\x1a\xa2\x01\n" +
	"\x12PrefixContribution\x12\x1b\n" +
	"\x06prefix\x18\x01 \x01(\tB\x03\xe0A\x03R\x06prefix\x124\n" +
	"\x13percentage_increase\x18\x02 \x01(\x01B\x03\xe0A\x03R\x12percentageIncrease\x129\n" +
	"\x16total_operations_count\x18\x03 \x01(\x03B\x03\xe0A\x03R\x14totalOperationsCountB\t\n" +
	"\adetails\x1a\xe0\a\n" +
	"\x16CrossRegionEgressSpike\x121\n" +
	"\x12total_egress_bytes\x18\x01 \x01(\x03B\x03\xe0A\x03R\x10totalEgressBytes\x124\n" +
	"\x13percentage_increase\x18\x02 \x01(\x01B\x03\xe0A\x03R\x12percentageIncrease\x12~\n" +
	"\vtop_buckets\x18\x03 \x03(\v2X.google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpike.BucketContributionB\x03\xe0A\x03R\n" +
	"topBuckets\x1a\xdc\x05\n" +
	"\x12BucketContribution\x12=\n" +
	"\x06bucket\x18\x01 \x01(\tB%\xe0A\x03\xfaA\x1f\n" +
	"\x1dstorage.googleapis.com/BucketR\x06bucket\x121\n" +
	"\x12total_egress_bytes\x18\x02 \x01(\x03B\x03\xe0A\x03R\x10totalEgressBytes\x124\n" +
	"\x13percentage_increase\x18\x03 \x01(\x01B\x03\xe0A\x03R\x12percentageIncrease\x12\x90\x01\n" +
	"\fcontribution\x18\x04 \x01(\v2e.google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpike.BucketContribution.ContributionB\x03\xe0A\x03H\x00R\fcontribution\x12/\n" +
	"\x05error\x18\x05 \x01(\v2\x12.google.rpc.StatusB\x03\xe0A\x03H\x00R\x05error\x1a\xce\x02\n" +
	"\fContribution\x12\xa0\x01\n" +
	"\ftop_prefixes\x18\x01 \x03(\v2x.google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpike.BucketContribution.Contribution.PrefixContributionB\x03\xe0A\x03R\vtopPrefixes\x1a\x9a\x01\n" +
	"\x12PrefixContribution\x12\x1b\n" +
	"\x06prefix\x18\x01 \x01(\tB\x03\xe0A\x03R\x06prefix\x121\n" +
	"\x12total_egress_bytes\x18\x02 \x01(\x03B\x03\xe0A\x03R\x10totalEgressBytes\x124\n" +
	"\x13percentage_increase\x18\x03 \x01(\x01B\x03\xe0A\x03R\x12percentageIncreaseB\t\n" +
	"\adetails\x1a\xdf\a\n" +
	"\x15ThrottledRequestSpike\x122\n" +
	"\x12throttled_requests\x18\x01 \x01(\x03B\x03\xe0A\x03R\x11throttledRequests\x124\n" +
	"\x13percentage_increase\x18\x02 \x01(\x01B\x03\xe0A\x03R\x12percentageIncrease\x12}\n" +
	"\vtop_buckets\x18\x03 \x03(\v2W.google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpike.BucketContributionB\x03\xe0A\x03R\n" +
	"topBuckets\x1a\xdc\x05\n" +
	"\x12BucketContribution\x12=\n" +
	"\x06bucket\x18\x01 \x01(\tB%\xe0A\x03\xfaA\x1f\n" +
	"\x1dstorage.googleapis.com/BucketR\x06bucket\x122\n" +
	"\x12throttled_requests\x18\x02 \x01(\x03B\x03\xe0A\x03R\x11throttledRequests\x124\n" +
	"\x13percentage_increase\x18\x03 \x01(\x01B\x03\xe0A\x03R\x12percentageIncrease\x12\x8f\x01\n" +
	"\fcontribution\x18\x04 \x01(\v2d.google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpike.BucketContribution.ContributionB\x03\xe0A\x03H\x00R\fcontribution\x12/\n" +
	"\x05error\x18\x05 \x01(\v2\x12.google.rpc.StatusB\x03\xe0A\x03H\x00R\x05error\x1a\xce\x02\n" +
	"\fContribution\x12\x9f\x01\n" +
	"\ftop_prefixes\x18\x01 \x03(\v2w.google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpike.BucketContribution.Contribution.PrefixContributionB\x03\xe0A\x03R\vtopPrefixes\x1a\x9b\x01\n" +
	"\x12PrefixContribution\x12\x1b\n" +
	"\x06prefix\x18\x01 \x01(\tB\x03\xe0A\x03R\x06prefix\x122\n" +
	"\x12throttled_requests\x18\x02 \x01(\x03B\x03\xe0A\x03R\x11throttledRequests\x124\n" +
	"\x13percentage_increase\x18\x03 \x01(\x01B\x03\xe0A\x03R\x12percentageIncreaseB\t\n" +
	"\adetails\x1a\x9c\x04\n" +
	"\x17StorageGrowthAboveTrend\x12@\n" +
	"\x1atotal_storage_growth_bytes\x18\x01 \x01(\x03B\x03\xe0A\x03R\x17totalStorageGrowthBytes\x124\n" +
	"\x13percentage_increase\x18\x02 \x01(\x01B\x03\xe0A\x03R\x12percentageIncrease\x12\x7f\n" +
	"\vtop_buckets\x18\x03 \x03(\v2Y.google.storage.control.v2.IntelligenceFinding.StorageGrowthAboveTrend.BucketContributionB\x03\xe0A\x03R\n" +
	"topBuckets\x1a\x87\x02\n" +
	"\x12BucketContribution\x12=\n" +
	"\x06bucket\x18\x01 \x01(\tB%\xe0A\x03\xfaA\x1f\n" +
	"\x1dstorage.googleapis.com/BucketR\x06bucket\x12@\n" +
	"\x1atotal_storage_growth_bytes\x18\x02 \x01(\x03B\x03\xe0A\x03R\x17totalStorageGrowthBytes\x124\n" +
	"\x13percentage_increase\x18\x03 \x01(\x01B\x03\xe0A\x03R\x12percentageIncrease\x12/\n" +
	"\x05error\x18\x05 \x01(\v2\x12.google.rpc.StatusB\x03\xe0A\x03H\x00R\x05errorB\t\n" +
	"\adetails:\xb0\x01\xeaA\xac\x01\n" +
	...
	"\x1cintelligence_finding_details\"\xa9\x03\n" +
	"\x1bIntelligenceFindingRevision\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12O\n" +
	"\bsnapshot\x18\x02 \x01(\v2..google.storage.control.v2.IntelligenceFindingB\x03\xe0A\x03R\bsnapshot\x12@\n" +
	"\vcreate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime:\xdd\x01\xeaA\xd9\x01\n" +
	"2storage.googleapis.com/IntelligenceFindingRevision\x12hprojects/{project}/locations/{location}/intelligenceFindings/{intelligence_finding}/revisions/{revision}*\x1cintelligenceFindingRevisions2\x1bintelligenceFindingRevision\"g\n" +
	"\x1dGetIntelligenceFindingRequest\x12F\n" +
	"\x04name\x18\x01 \x01(\tB2\xe0A\x02\xfaA,\n" +
	"*storage.googleapis.com/IntelligenceFindingR\x04name\"\xd0\x01\n" +
	"\x1fListIntelligenceFindingsRequest\x12J\n" +
	"\x06parent\x18\x01 \x01(\tB2\xe0A\x02\xfaA,\x12*storage.googleapis.com/IntelligenceFindingR\x06parent\x12\x1b\n" +
	"\x06filter\x18\x02 \x01(\tB\x03\xe0A\x01R\x06filter\x12 \n" +
	"\tpage_size\x18\x03 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x04 \x01(\tB\x03\xe0A\x01R\tpageToken\"\xaf\x01\n" +
	" ListIntelligenceFindingsResponse\x12c\n" +
	"\x15intelligence_findings\x18\x01 \x03(\v2..google.storage.control.v2.IntelligenceFindingR\x14intelligenceFindings\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xeb\x02\n" +
	"$SummarizeIntelligenceFindingsRequest\x12\x1b\n" +
	"\x06parent\x18\x01 \x01(\tB\x03\xe0A\x02R\x06parent\x12y\n" +
	"\x0eresource_scope\x18\x02 \x01(\x0e2M.google.storage.control.v2.SummarizeIntelligenceFindingsRequest.ResourceScopeB\x03\xe0A\x01R\rresourceScope\x12\x1b\n" +
	"\x06filter\x18\x03 \x01(\tB\x03\xe0A\x01R\x06filter\x12 \n" +
	"\tpage_size\x18\x04 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x05 \x01(\tB\x03\xe0A\x01R\tpageToken\"H\n" +
	"\rResourceScope\x12\x1e\n" +
	"\x1aRESOURCE_SCOPE_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06PARENT\x10\x01\x12\v\n" +
	"\aPROJECT\x10\x02\"\xa7\x01\n" +
	"%SummarizeIntelligenceFindingsResponse\x12V\n" +
	"\x11finding_summaries\x18\x01 \x03(\v2).google.storage.control.v2.FindingSummaryR\x10findingSummaries\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"w\n" +
	"%GetIntelligenceFindingRevisionRequest\x12N\n" +
	"\x04name\x18\x01 \x01(\tB:\xe0A\x02\xfaA4\n" +
	"2storage.googleapis.com/IntelligenceFindingRevisionR\x04name\"\xc3\x01\n" +
	"'ListIntelligenceFindingRevisionsRequest\x12R\n" +
	"\x06parent\x18\x01 \x01(\tB:\xe0A\x02\xfaA4\x122storage.googleapis.com/IntelligenceFindingRevisionR\x06parent\x12 \n" +
	"\tpage_size\x18\x02 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tB\x03\xe0A\x01R\tpageToken\"\xd0\x01\n" +
	"(ListIntelligenceFindingRevisionsResponse\x12|\n" +
	"\x1eintelligence_finding_revisions\x18\x01 \x03(\v26.google.storage.control.v2.IntelligenceFindingRevisionR\x1cintelligenceFindingRevisions\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xba\x06\n" +
	"\x0eFindingSummary\x12?\n" +
	"\x04type\x18\x01 \x01(\x0e2&.google.storage.control.v2.FindingTypeB\x03\xe0A\x03R\x04type\x12K\n" +
	"\bcategory\x18\x02 \x01(\x0e2*.google.storage.control.v2.FindingCategoryB\x03\xe0A\x03R\bcategory\x12,\n" +
	"\x0ftarget_resource\x18\x04 \x01(\tB\x03\xe0A\x03R\x0etargetResource\x12@\n" +
	"\vcreate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12@\n" +
	"\vupdate_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12F\n" +
	"\bseverity\x18\a \x01(\x0e2*.google.storage.control.v2.FindingSeverityR\bseverity\x12f\n" +
	"\x0fsummary_details\x18\b \x03(\v28.google.storage.control.v2.FindingSummary.SummaryDetailsB\x03\xe0A\x03R\x0esummaryDetails\x1a\xb7\x02\n" +
	"\x0eSummaryDetails\x12\x16\n" +
	"\x05count\x18\x01 \x01(\x03H\x00R\x05count\x12 \n" +
	"\n" +
	"percentage\x18\x02 \x01(\x02H\x00R\n" +
	"percentage\x12o\n" +
	"\rresource_type\x18\x03 \x01(\x0e2E.google.storage.control.v2.FindingSummary.SummaryDetails.ResourceTypeB\x03\xe0A\x03R\fresourceType\x12%\n" +
	"\vdescription\x18\x04 \x01(\tB\x03\xe0A\x03R\vdescription\"F\n" +
	"\fResourceType\x12\x1d\n" +
	"\x19RESOURCE_TYPE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aPROJECT\x10\x01\x12\n" +
	"\n" +
	"\x06BUCKET\x10\x02B\v\n" +
	"\tmagnitude*\xef\x01\n" +
	"\vFindingType\x12\x1c\n" +
	"\x18FINDING_TYPE_UNSPECIFIED\x10\x00\x12?\n" +
	...
	"\x19FINDING_SEVERITY_CRITICAL\x10\x012\xd5A\n" +
	...
	"\fDeleteFolder\x12..google.storage.control.v2.DeleteFolderRequest\x1a\x16.google.protobuf.Empty\"i\xdaA\x04name\x82\xd3\xe4\x93\x02,**/v2/{name=projects/*/buckets/*/folders/**}\x8a\xd3\xe4\x93\x02*\x12(\n" +
	"\x04name\x12 {bucket=projects/*/buckets/*}/**\x12\xc6\x01\n" +
	"\tGetFolder\x12+.google.storage.control.v2.GetFolderRequest\x1a!.google.storage.control.v2.Folder\"i\xdaA\x04name\x82\xd3\xe4\x93\x02,\x12*/v2/{name=projects/*/buckets/*/folders/**}\x8a\xd3\xe4\x93\x02*\x12(\n" +
	"\x04name\x12 {bucket=projects/*/buckets/*}/**\x12\xc5\x01\n" +
	"\vListFolders\x12-.google.storage.control.v2.ListFoldersRequest\x1a..google.storage.control.v2.ListFoldersResponse\"W\xdaA\x06parent\x82\xd3\xe4\x93\x02+\x12)/v2/{parent=projects/*/buckets/*}/folders\x8a\xd3\xe4\x93\x02\x17\x12\x15\n" +
	"\x06parent\x12\v{bucket=**}\x12\x8a\x02\n" +
	"\fRenameFolder\x12..google.storage.control.v2.RenameFolderRequest\x1a\x1d.google.longrunning.Operation\"\xaa\x01\xcaA\x1e\n" +
	"\x06Folder\x12\x14RenameFolderMetadata\xdaA\x1aname,destination_folder_id\x82\xd3\xe4\x93\x026:\x01*\"1/v2/{name=projects/*/buckets/*/folders/**}:rename\x8a\xd3\xe4\x93\x02*\x12(\n" +
	"\x04name\x12 {bucket=projects/*/buckets/*}/**\x12\xa7\x02\n" +
	"\x15DeleteFolderRecursive\x127.google.storage.control.v2.DeleteFolderRecursiveRequest\x1a\x1d.google.longrunning.Operation\"\xb5\x01\xcaA6\n" +
	"\x15google.protobuf.Empty\x12\x1dDeleteFolderRecursiveMetadata\xdaA\x04name\x82\xd3\xe4\x93\x02?:\x01*\":/v2/{name=projects/*/buckets/*/folders/**}:deleteRecursive\x8a\xd3\xe4\x93\x02*\x12(\n" +
	"\x04name\x12 {bucket=projects/*/buckets/*}/**\x12\xde\x01\n" +
	"\x10GetStorageLayout\x122.google.storage.control.v2.GetStorageLayoutRequest\x1a(.google.storage.control.v2.StorageLayout\"l\xdaA\x04name\x82\xd3\xe4\x93\x02/\x12-/v2/{name=projects/*/buckets/*/storageLayout}\x8a\xd3\xe4\x93\x02*\x12(\n" +
	...
	"\x06parent\x12\v{bucket=**}\x12\x9d\x01\n" +
	...
	"\x06parent\x12\v{bucket=**}\x12\xd4\x01\n" +
	"\x13UpdateManagedFolder\x125.google.storage.control.v2.UpdateManagedFolderRequest\x1a(.google.storage.control.v2.ManagedFolder\"\\\xdaA\x1amanaged_folder,update_mask\x8a\xd3\xe4\x93\x029\x127\n" +
	"\x13managed_folder.name\x12 {bucket=projects/*/buckets/*}/**\x12\xd1\x01\n" +
	...
	"\x06parent\x12\v{bucket=**}\x12\xf9\x01\n" +
	...
	"\x06parent\x12\v{bucket=**}\x12\xc2\x01\n" +
	"\x10CreateRapidCache\x122.google.storage.control.v2.CreateRapidCacheRequest\x1a\x1d.google.longrunning.Operation\"[\xcaA&\n" +
	"\n" +
	"RapidCache\x12\x18CreateRapidCacheMetadata\xdaA\x12parent,rapid_cache\x8a\xd3\xe4\x93\x02\x17\x12\x15\n" +
	"\x06parent\x12\v{bucket=**}\x12\xe6\x01\n" +
	...
	"\x06parent\x12\v{bucket=**}\x12\xd2\x01\n" +
	...
	"\x1fUpdateProjectIntelligenceConfig\x12A.google.storage.control.v2.UpdateProjectIntelligenceConfigRequest\x1a-.google.storage.control.v2.IntelligenceConfig\"\x87\x01\xdaA\x1fintelligence_config,update_mask\x82\xd3\xe4\x93\x02_:\x13intelligence_config2H/v2/{intelligence_config.name=projects/*/locations/*/intelligenceConfig}\x12\xcf\x01\n" +
	...
	"\x1eUpdateFolderIntelligenceConfig\x12@.google.storage.control.v2.UpdateFolderIntelligenceConfigRequest\x1a-.google.storage.control.v2.IntelligenceConfig\"\x86\x01\xdaA\x1fintelligence_config,update_mask\x82\xd3\xe4\x93\x02^:\x13intelligence_config2G/v2/{intelligence_config.name=folders/*/locations/*/intelligenceConfig}\x12\xe1\x01\n" +
	...
	"$UpdateOrganizationIntelligenceConfig\x12F.google.storage.control.v2.UpdateOrganizationIntelligenceConfigRequest\x1a-.google.storage.control.v2.IntelligenceConfig\"\x8c\x01\xdaA\x1fintelligence_config,update_mask\x82\xd3\xe4\x93\x02d:\x13intelligence_config2M/v2/{intelligence_config.name=organizations/*/locations/*/intelligenceConfig}\x12\xa3\x01\n" +
	...
	"\bresource\x12/{bucket=projects/*/buckets/*}/managedFolders/**\x12\xcb\x01\n" +
	"\x16GetIntelligenceFinding\x128.google.storage.control.v2.GetIntelligenceFindingRequest\x1a..google.storage.control.v2.IntelligenceFinding\"G\xdaA\x04name\x82\xd3\xe4\x93\x02:\x128/v2/{name=projects/*/locations/*/intelligenceFindings/*}\x12\xde\x01\n" +
	"\x18ListIntelligenceFindings\x12:.google.storage.control.v2.ListIntelligenceFindingsRequest\x1a;.google.storage.control.v2.ListIntelligenceFindingsResponse\"I\xdaA\x06parent\x82\xd3\xe4\x93\x02:\x128/v2/{parent=projects/*/locations/*}/intelligenceFindings\x12\x89\x03\n" +
	"\x1dSummarizeIntelligenceFindings\x12?.google.storage.control.v2.SummarizeIntelligenceFindingsRequest\x1a@.google.storage.control.v2.SummarizeIntelligenceFindingsResponse\"\xe4\x01\xdaA\x06parent\x82\xd3\xe4\x93\x02\xd4\x01ZC\x12A/v2/{parent=folders/*/locations/*}/intelligenceFindings:summarizeZI\x12G/v2/{parent=organizations/*/locations/*}/intelligenceFindings:summarize\x12B/v2/{parent=projects/*/locations/*}/intelligenceFindings:summarize\x12\xef\x01\n" +
	"\x1eGetIntelligenceFindingRevision\x12@.google.storage.control.v2.GetIntelligenceFindingRevisionRequest\x1a6.google.storage.control.v2.IntelligenceFindingRevision\"S\xdaA\x04name\x82\xd3\xe4\x93\x02F\x12D/v2/{name=projects/*/locations/*/intelligenceFindings/*/revisions/*}\x12\x82\x02\n" +
	" ListIntelligenceFindingRevisions\x12B.google.storage.control.v2.ListIntelligenceFindingRevisionsRequest\x1aC.google.storage.control.v2.ListIntelligenceFindingRevisionsResponse\"U\xdaA\x06parent\x82\xd3\xe4\x93\x02F\x12D/v2/{parent=projects/*/locations/*/intelligenceFindings/*}/revisions\x1a\xa7\x02\xcaA\x16storage.googleapis.com\xd2A\x8a\x02https://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/cloud-platform.read-only,https://www.googleapis.com/auth/devstorage.full_control,https://www.googleapis.com/auth/devstorage.read_only,https://www.googleapis.com/auth/devstorage.read_writeB\xa6\x02\xeaAD\n" +
	"\x1dstorage.googleapis.com/Bucket\x12#projects/{project}/buckets/{bucket}\n" +
	"\x1dcom.google.storage.control.v2B\x13StorageControlProtoP\x01Z=cloud.google.com/go/storage/control/apiv2/controlpb;controlpb\xaa\x02\x1fGoogle.Cloud.Storage.Control.V2\xca\x02\x1fGoogle\\Cloud\\Storage\\Control\\V2\xea\x02#Google::Cloud::Storage::Control::V2b\x06proto3"

var (
	file_google_storage_control_v2_storage_control_proto_rawDescOnce sync.Once
	file_google_storage_control_v2_storage_control_proto_rawDescData []byte
)
...
func file_google_storage_control_v2_storage_control_proto_rawDescGZIP() []byte {
	file_google_storage_control_v2_storage_control_proto_rawDescOnce.Do(func() {
		file_google_storage_control_v2_storage_control_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_storage_control_v2_storage_control_proto_rawDesc), len(file_google_storage_control_v2_storage_control_proto_rawDesc)))
	})
	return file_google_storage_control_v2_storage_control_proto_rawDescData
}

var file_google_storage_control_v2_storage_control_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
var file_google_storage_control_v2_storage_control_proto_msgTypes = make([]protoimpl.MessageInfo, 83)
var file_google_storage_control_v2_storage_control_proto_goTypes = []any{
	...
	(FindingSeverity)(0), // 2: google.storage.control.v2.FindingSeverity
	(ManagedFolder_RapidCacheConfig_RapidCachePolicy_IngestOnWrite)(0),   // 3: google.storage.control.v2.ManagedFolder.RapidCacheConfig.RapidCachePolicy.IngestOnWrite
	(IntelligenceConfig_EditionConfig)(0),                                // 4: google.storage.control.v2.IntelligenceConfig.EditionConfig
	(IntelligenceConfig_EffectiveIntelligenceConfig_EffectiveEdition)(0), // 5: google.storage.control.v2.IntelligenceConfig.EffectiveIntelligenceConfig.EffectiveEdition
	(SummarizeIntelligenceFindingsRequest_ResourceScope)(0),              // 6: google.storage.control.v2.SummarizeIntelligenceFindingsRequest.ResourceScope
	(FindingSummary_SummaryDetails_ResourceType)(0),                      // 7: google.storage.control.v2.FindingSummary.SummaryDetails.ResourceType
	(*PendingRenameInfo)(nil),                                            // 8: google.storage.control.v2.PendingRenameInfo
	(*Folder)(nil),                                                       // 9: google.storage.control.v2.Folder
	(*GetFolderRequest)(nil),                                             // 10: google.storage.control.v2.GetFolderRequest
	(*CreateFolderRequest)(nil),                                          // 11: google.storage.control.v2.CreateFolderRequest
	(*DeleteFolderRequest)(nil),                                          // 12: google.storage.control.v2.DeleteFolderRequest
	(*ListFoldersRequest)(nil),                                           // 13: google.storage.control.v2.ListFoldersRequest
	(*ListFoldersResponse)(nil),                                          // 14: google.storage.control.v2.ListFoldersResponse
	(*RenameFolderRequest)(nil),                                          // 15: google.storage.control.v2.RenameFolderRequest
	(*DeleteFolderRecursiveRequest)(nil),                                 // 16: google.storage.control.v2.DeleteFolderRecursiveRequest
	(*CommonLongRunningOperationMetadata)(nil),                           // 17: google.storage.control.v2.CommonLongRunningOperationMetadata
	(*RenameFolderMetadata)(nil),                                         // 18: google.storage.control.v2.RenameFolderMetadata
	(*DeleteFolderRecursiveMetadata)(nil),                                // 19: google.storage.control.v2.DeleteFolderRecursiveMetadata
	(*StorageLayout)(nil),                                                // 20: google.storage.control.v2.StorageLayout
	(*GetStorageLayoutRequest)(nil),                                      // 21: google.storage.control.v2.GetStorageLayoutRequest
	(*ManagedFolder)(nil),                                                // 22: google.storage.control.v2.ManagedFolder
	(*GetManagedFolderRequest)(nil),                                      // 23: google.storage.control.v2.GetManagedFolderRequest
	(*CreateManagedFolderRequest)(nil),                                   // 24: google.storage.control.v2.CreateManagedFolderRequest
	(*DeleteManagedFolderRequest)(nil),                                   // 25: google.storage.control.v2.DeleteManagedFolderRequest
	(*ListManagedFoldersRequest)(nil),                                    // 26: google.storage.control.v2.ListManagedFoldersRequest
	(*ListManagedFoldersResponse)(nil),                                   // 27: google.storage.control.v2.ListManagedFoldersResponse
	(*UpdateManagedFolderRequest)(nil),                                   // 28: google.storage.control.v2.UpdateManagedFolderRequest
	(*CreateAnywhereCacheMetadata)(nil),                                  // 29: google.storage.control.v2.CreateAnywhereCacheMetadata
	(*CreateRapidCacheMetadata)(nil),                                     // 30: google.storage.control.v2.CreateRapidCacheMetadata
	(*UpdateAnywhereCacheMetadata)(nil),                                  // 31: google.storage.control.v2.UpdateAnywhereCacheMetadata
	(*UpdateRapidCacheMetadata)(nil),                                     // 32: google.storage.control.v2.UpdateRapidCacheMetadata
	(*AnywhereCache)(nil),                                                // 33: google.storage.control.v2.AnywhereCache
	(*CreateAnywhereCacheRequest)(nil),                                   // 34: google.storage.control.v2.CreateAnywhereCacheRequest
	(*UpdateAnywhereCacheRequest)(nil),                                   // 35: google.storage.control.v2.UpdateAnywhereCacheRequest
	(*DisableAnywhereCacheRequest)(nil),                                  // 36: google.storage.control.v2.DisableAnywhereCacheRequest
	(*PauseAnywhereCacheRequest)(nil),                                    // 37: google.storage.control.v2.PauseAnywhereCacheRequest
	(*ResumeAnywhereCacheRequest)(nil),                                   // 38: google.storage.control.v2.ResumeAnywhereCacheRequest
	(*GetAnywhereCacheRequest)(nil),                                      // 39: google.storage.control.v2.GetAnywhereCacheRequest
	(*ListAnywhereCachesRequest)(nil),                                    // 40: google.storage.control.v2.ListAnywhereCachesRequest
	(*ListAnywhereCachesResponse)(nil),                                   // 41: google.storage.control.v2.ListAnywhereCachesResponse
	(*RapidCache)(nil),                                                   // 42: google.storage.control.v2.RapidCache
	(*CreateRapidCacheRequest)(nil),                                      // 43: google.storage.control.v2.CreateRapidCacheRequest
	(*UpdateRapidCacheRequest)(nil),                                      // 44: google.storage.control.v2.UpdateRapidCacheRequest
	(*GetRapidCacheRequest)(nil),                                         // 45: google.storage.control.v2.GetRapidCacheRequest
	(*ListRapidCachesRequest)(nil),                                       // 46: google.storage.control.v2.ListRapidCachesRequest
	(*ListRapidCachesResponse)(nil),                                      // 47: google.storage.control.v2.ListRapidCachesResponse
	(*IntelligenceConfig)(nil),                                           // 48: google.storage.control.v2.IntelligenceConfig
	(*UpdateOrganizationIntelligenceConfigRequest)(nil),                  // 49: google.storage.control.v2.UpdateOrganizationIntelligenceConfigRequest
	(*UpdateFolderIntelligenceConfigRequest)(nil),                        // 50: google.storage.control.v2.UpdateFolderIntelligenceConfigRequest
	(*UpdateProjectIntelligenceConfigRequest)(nil),                       // 51: google.storage.control.v2.UpdateProjectIntelligenceConfigRequest
	(*GetOrganizationIntelligenceConfigRequest)(nil),                     // 52: google.storage.control.v2.GetOrganizationIntelligenceConfigRequest
	(*GetFolderIntelligenceConfigRequest)(nil),                           // 53: google.storage.control.v2.GetFolderIntelligenceConfigRequest
	(*GetProjectIntelligenceConfigRequest)(nil),                          // 54: google.storage.control.v2.GetProjectIntelligenceConfigRequest
	(*IntelligenceFinding)(nil),                                          // 55: google.storage.control.v2.IntelligenceFinding
	(*IntelligenceFindingRevision)(nil),                                  // 56: google.storage.control.v2.IntelligenceFindingRevision
	(*GetIntelligenceFindingRequest)(nil),                                // 57: google.storage.control.v2.GetIntelligenceFindingRequest
	(*ListIntelligenceFindingsRequest)(nil),                              // 58: google.storage.control.v2.ListIntelligenceFindingsRequest
	(*ListIntelligenceFindingsResponse)(nil),                             // 59: google.storage.control.v2.ListIntelligenceFindingsResponse
	(*SummarizeIntelligenceFindingsRequest)(nil),                         // 60: google.storage.control.v2.SummarizeIntelligenceFindingsRequest
	(*SummarizeIntelligenceFindingsResponse)(nil),                        // 61: google.storage.control.v2.SummarizeIntelligenceFindingsResponse
	(*GetIntelligenceFindingRevisionRequest)(nil),                        // 62: google.storage.control.v2.GetIntelligenceFindingRevisionRequest
	(*ListIntelligenceFindingRevisionsRequest)(nil),                      // 63: google.storage.control.v2.ListIntelligenceFindingRevisionsRequest
	(*ListIntelligenceFindingRevisionsResponse)(nil),                     // 64: google.storage.control.v2.ListIntelligenceFindingRevisionsResponse
	(*FindingSummary)(nil),                                               // 65: google.storage.control.v2.FindingSummary
	(*StorageLayout_CustomPlacementConfig)(nil),                          // 66: google.storage.control.v2.StorageLayout.CustomPlacementConfig
	(*StorageLayout_HierarchicalNamespace)(nil),                          // 67: google.storage.control.v2.StorageLayout.HierarchicalNamespace
	(*ManagedFolder_RapidCacheConfig)(nil),                               // 68: google.storage.control.v2.ManagedFolder.RapidCacheConfig
	(*ManagedFolder_RapidCacheConfig_RapidCachePolicy)(nil),              // 69: google.storage.control.v2.ManagedFolder.RapidCacheConfig.RapidCachePolicy
	nil,                               // 70: google.storage.control.v2.ManagedFolder.RapidCacheConfig.PoliciesEntry
	(*IntelligenceConfig_Filter)(nil), // 71: google.storage.control.v2.IntelligenceConfig.Filter
	(*IntelligenceConfig_EffectiveIntelligenceConfig)(nil),                                                                   // 72: google.storage.control.v2.IntelligenceConfig.EffectiveIntelligenceConfig
	(*IntelligenceConfig_TrialConfig)(nil),                                                                                   // 73: google.storage.control.v2.IntelligenceConfig.TrialConfig
	(*IntelligenceConfig_Filter_CloudStorageLocations)(nil),                                                                  // 74: google.storage.control.v2.IntelligenceConfig.Filter.CloudStorageLocations
	(*IntelligenceConfig_Filter_CloudStorageBuckets)(nil),                                                                    // 75: google.storage.control.v2.IntelligenceConfig.Filter.CloudStorageBuckets
	(*IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike)(nil),                                                    // 76: google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpike
	(*IntelligenceFinding_CrossRegionEgressSpike)(nil),                                                                       // 77: google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpike
	(*IntelligenceFinding_ThrottledRequestSpike)(nil),                                                                        // 78: google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpike
	(*IntelligenceFinding_StorageGrowthAboveTrend)(nil),                                                                      // 79: google.storage.control.v2.IntelligenceFinding.StorageGrowthAboveTrend
	(*IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution)(nil),                                 // 80: google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpike.BucketContribution
	(*IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution_Contribution)(nil),                    // 81: google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpike.BucketContribution.Contribution
	(*IntelligenceFinding_ColdlineAndArchivalStorageOperationsSpike_BucketContribution_Contribution_PrefixContribution)(nil), // 82: google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpike.BucketContribution.Contribution.PrefixContribution
	(*IntelligenceFinding_CrossRegionEgressSpike_BucketContribution)(nil),                                                    // 83: google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpike.BucketContribution
	(*IntelligenceFinding_CrossRegionEgressSpike_BucketContribution_Contribution)(nil),                                       // 84: google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpike.BucketContribution.Contribution
	(*IntelligenceFinding_CrossRegionEgressSpike_BucketContribution_Contribution_PrefixContribution)(nil),                    // 85: google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpike.BucketContribution.Contribution.PrefixContribution
	(*IntelligenceFinding_ThrottledRequestSpike_BucketContribution)(nil),                                                     // 86: google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpike.BucketContribution
	(*IntelligenceFinding_ThrottledRequestSpike_BucketContribution_Contribution)(nil),                                        // 87: google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpike.BucketContribution.Contribution
	(*IntelligenceFinding_ThrottledRequestSpike_BucketContribution_Contribution_PrefixContribution)(nil),                     // 88: google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpike.BucketContribution.Contribution.PrefixContribution
	(*IntelligenceFinding_StorageGrowthAboveTrend_BucketContribution)(nil),                                                   // 89: google.storage.control.v2.IntelligenceFinding.StorageGrowthAboveTrend.BucketContribution
	(*FindingSummary_SummaryDetails)(nil),                                                                                    // 90: google.storage.control.v2.FindingSummary.SummaryDetails
	...
	(*interval.Interval)(nil),                                                                                                // 94: google.type.Interval
	(*status.Status)(nil),                                                                                                    // 95: google.rpc.Status
	(*iampb.GetIamPolicyRequest)(nil),                                                                                        // 96: google.iam.v1.GetIamPolicyRequest
	(*iampb.SetIamPolicyRequest)(nil),                                                                                        // 97: google.iam.v1.SetIamPolicyRequest
	(*iampb.TestIamPermissionsRequest)(nil),                                                                                  // 98: google.iam.v1.TestIamPermissionsRequest
...
var file_google_storage_control_v2_storage_control_proto_depIdxs = []int32{
	91,  // 0: google.storage.control.v2.Folder.create_time:type_name -> google.protobuf.Timestamp
	91,  // 1: google.storage.control.v2.Folder.update_time:type_name -> google.protobuf.Timestamp
	8,   // 2: google.storage.control.v2.Folder.pending_rename_info:type_name -> google.storage.control.v2.PendingRenameInfo
	9,   // 3: google.storage.control.v2.CreateFolderRequest.folder:type_name -> google.storage.control.v2.Folder
	9,   // 4: google.storage.control.v2.ListFoldersResponse.folders:type_name -> google.storage.control.v2.Folder
	91,  // 5: google.storage.control.v2.CommonLongRunningOperationMetadata.create_time:type_name -> google.protobuf.Timestamp
	91,  // 6: google.storage.control.v2.CommonLongRunningOperationMetadata.end_time:type_name -> google.protobuf.Timestamp
	91,  // 7: google.storage.control.v2.CommonLongRunningOperationMetadata.update_time:type_name -> google.protobuf.Timestamp
	17,  // 8: google.storage.control.v2.RenameFolderMetadata.common_metadata:type_name -> google.storage.control.v2.CommonLongRunningOperationMetadata
	17,  // 9: google.storage.control.v2.DeleteFolderRecursiveMetadata.common_metadata:type_name -> google.storage.control.v2.CommonLongRunningOperationMetadata
	66,  // 10: google.storage.control.v2.StorageLayout.custom_placement_config:type_name -> google.storage.control.v2.StorageLayout.CustomPlacementConfig
	67,  // 11: google.storage.control.v2.StorageLayout.hierarchical_namespace:type_name -> google.storage.control.v2.StorageLayout.HierarchicalNamespace
	91,  // 12: google.storage.control.v2.ManagedFolder.create_time:type_name -> google.protobuf.Timestamp
	91,  // 13: google.storage.control.v2.ManagedFolder.update_time:type_name -> google.protobuf.Timestamp
	68,  // 14: google.storage.control.v2.ManagedFolder.rapid_cache_config:type_name -> google.storage.control.v2.ManagedFolder.RapidCacheConfig
	22,  // 15: google.storage.control.v2.CreateManagedFolderRequest.managed_folder:type_name -> google.storage.control.v2.ManagedFolder
	22,  // 16: google.storage.control.v2.ListManagedFoldersResponse.managed_folders:type_name -> google.storage.control.v2.ManagedFolder
	22,  // 17: google.storage.control.v2.UpdateManagedFolderRequest.managed_folder:type_name -> google.storage.control.v2.ManagedFolder
	92,  // 18: google.storage.control.v2.UpdateManagedFolderRequest.update_mask:type_name -> google.protobuf.FieldMask
	17,  // 19: google.storage.control.v2.CreateAnywhereCacheMetadata.common_metadata:type_name -> google.storage.control.v2.CommonLongRunningOperationMetadata
	93,  // 20: google.storage.control.v2.CreateAnywhereCacheMetadata.ttl:type_name -> google.protobuf.Duration
	17,  // 21: google.storage.control.v2.CreateRapidCacheMetadata.common_metadata:type_name -> google.storage.control.v2.CommonLongRunningOperationMetadata
	93,  // 22: google.storage.control.v2.CreateRapidCacheMetadata.ttl:type_name -> google.protobuf.Duration
	17,  // 23: google.storage.control.v2.UpdateAnywhereCacheMetadata.common_metadata:type_name -> google.storage.control.v2.CommonLongRunningOperationMetadata
	93,  // 24: google.storage.control.v2.UpdateAnywhereCacheMetadata.ttl:type_name -> google.protobuf.Duration
	17,  // 25: google.storage.control.v2.UpdateRapidCacheMetadata.common_metadata:type_name -> google.storage.control.v2.CommonLongRunningOperationMetadata
	93,  // 26: google.storage.control.v2.UpdateRapidCacheMetadata.ttl:type_name -> google.protobuf.Duration
	93,  // 27: google.storage.control.v2.AnywhereCache.ttl:type_name -> google.protobuf.Duration
	91,  // 28: google.storage.control.v2.AnywhereCache.create_time:type_name -> google.protobuf.Timestamp
	91,  // 29: google.storage.control.v2.AnywhereCache.update_time:type_name -> google.protobuf.Timestamp
	33,  // 30: google.storage.control.v2.CreateAnywhereCacheRequest.anywhere_cache:type_name -> google.storage.control.v2.AnywhereCache
	33,  // 31: google.storage.control.v2.UpdateAnywhereCacheRequest.anywhere_cache:type_name -> google.storage.control.v2.AnywhereCache
	92,  // 32: google.storage.control.v2.UpdateAnywhereCacheRequest.update_mask:type_name -> google.protobuf.FieldMask
	33,  // 33: google.storage.control.v2.ListAnywhereCachesResponse.anywhere_caches:type_name -> google.storage.control.v2.AnywhereCache
	93,  // 34: google.storage.control.v2.RapidCache.ttl:type_name -> google.protobuf.Duration
	91,  // 35: google.storage.control.v2.RapidCache.create_time:type_name -> google.protobuf.Timestamp
	91,  // 36: google.storage.control.v2.RapidCache.update_time:type_name -> google.protobuf.Timestamp
	42,  // 37: google.storage.control.v2.CreateRapidCacheRequest.rapid_cache:type_name -> google.storage.control.v2.RapidCache
	42,  // 38: google.storage.control.v2.UpdateRapidCacheRequest.rapid_cache:type_name -> google.storage.control.v2.RapidCache
	92,  // 39: google.storage.control.v2.UpdateRapidCacheRequest.update_mask:type_name -> google.protobuf.FieldMask
	42,  // 40: google.storage.control.v2.ListRapidCachesResponse.rapid_caches:type_name -> google.storage.control.v2.RapidCache
	4,   // 41: google.storage.control.v2.IntelligenceConfig.edition_config:type_name -> google.storage.control.v2.IntelligenceConfig.EditionConfig
	91,  // 42: google.storage.control.v2.IntelligenceConfig.update_time:type_name -> google.protobuf.Timestamp
	71,  // 43: google.storage.control.v2.IntelligenceConfig.filter:type_name -> google.storage.control.v2.IntelligenceConfig.Filter
	72,  // 44: google.storage.control.v2.IntelligenceConfig.effective_intelligence_config:type_name -> google.storage.control.v2.IntelligenceConfig.EffectiveIntelligenceConfig
	73,  // 45: google.storage.control.v2.IntelligenceConfig.trial_config:type_name -> google.storage.control.v2.IntelligenceConfig.TrialConfig
	48,  // 46: google.storage.control.v2.UpdateOrganizationIntelligenceConfigRequest.intelligence_config:type_name -> google.storage.control.v2.IntelligenceConfig
	92,  // 47: google.storage.control.v2.UpdateOrganizationIntelligenceConfigRequest.update_mask:type_name -> google.protobuf.FieldMask
	48,  // 48: google.storage.control.v2.UpdateFolderIntelligenceConfigRequest.intelligence_config:type_name -> google.storage.control.v2.IntelligenceConfig
	92,  // 49: google.storage.control.v2.UpdateFolderIntelligenceConfigRequest.update_mask:type_name -> google.protobuf.FieldMask
	48,  // 50: google.storage.control.v2.UpdateProjectIntelligenceConfigRequest.intelligence_config:type_name -> google.storage.control.v2.IntelligenceConfig
	92,  // 51: google.storage.control.v2.UpdateProjectIntelligenceConfigRequest.update_mask:type_name -> google.protobuf.FieldMask
	0,   // 52: google.storage.control.v2.IntelligenceFinding.type:type_name -> google.storage.control.v2.FindingType
	1,   // 53: google.storage.control.v2.IntelligenceFinding.category:type_name -> google.storage.control.v2.FindingCategory
	2,   // 54: google.storage.control.v2.IntelligenceFinding.severity:type_name -> google.storage.control.v2.FindingSeverity
	91,  // 55: google.storage.control.v2.IntelligenceFinding.create_time:type_name -> google.protobuf.Timestamp
	91,  // 56: google.storage.control.v2.IntelligenceFinding.update_time:type_name -> google.protobuf.Timestamp
	94,  // 57: google.storage.control.v2.IntelligenceFinding.observation_period:type_name -> google.type.Interval
	76,  // 58: google.storage.control.v2.IntelligenceFinding.coldline_and_archival_storage_operations_spike:type_name -> google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpike
	78,  // 59: google.storage.control.v2.IntelligenceFinding.throttled_requests_spike:type_name -> google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpike
	77,  // 60: google.storage.control.v2.IntelligenceFinding.cross_region_egress_spike:type_name -> google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpike
	79,  // 61: google.storage.control.v2.IntelligenceFinding.storage_growth_above_trend:type_name -> google.storage.control.v2.IntelligenceFinding.StorageGrowthAboveTrend
	55,  // 62: google.storage.control.v2.IntelligenceFindingRevision.snapshot:type_name -> google.storage.control.v2.IntelligenceFinding
	91,  // 63: google.storage.control.v2.IntelligenceFindingRevision.create_time:type_name -> google.protobuf.Timestamp
	55,  // 64: google.storage.control.v2.ListIntelligenceFindingsResponse.intelligence_findings:type_name -> google.storage.control.v2.IntelligenceFinding
	6,   // 65: google.storage.control.v2.SummarizeIntelligenceFindingsRequest.resource_scope:type_name -> google.storage.control.v2.SummarizeIntelligenceFindingsRequest.ResourceScope
	65,  // 66: google.storage.control.v2.SummarizeIntelligenceFindingsResponse.finding_summaries:type_name -> google.storage.control.v2.FindingSummary
	56,  // 67: google.storage.control.v2.ListIntelligenceFindingRevisionsResponse.intelligence_finding_revisions:type_name -> google.storage.control.v2.IntelligenceFindingRevision
	0,   // 68: google.storage.control.v2.FindingSummary.type:type_name -> google.storage.control.v2.FindingType
	1,   // 69: google.storage.control.v2.FindingSummary.category:type_name -> google.storage.control.v2.FindingCategory
	91,  // 70: google.storage.control.v2.FindingSummary.create_time:type_name -> google.protobuf.Timestamp
	91,  // 71: google.storage.control.v2.FindingSummary.update_time:type_name -> google.protobuf.Timestamp
	2,   // 72: google.storage.control.v2.FindingSummary.severity:type_name -> google.storage.control.v2.FindingSeverity
	90,  // 73: google.storage.control.v2.FindingSummary.summary_details:type_name -> google.storage.control.v2.FindingSummary.SummaryDetails
	70,  // 74: google.storage.control.v2.ManagedFolder.RapidCacheConfig.policies:type_name -> google.storage.control.v2.ManagedFolder.RapidCacheConfig.PoliciesEntry
	3,   // 75: google.storage.control.v2.ManagedFolder.RapidCacheConfig.RapidCachePolicy.ingest_on_write:type_name -> google.storage.control.v2.ManagedFolder.RapidCacheConfig.RapidCachePolicy.IngestOnWrite
	69,  // 76: google.storage.control.v2.ManagedFolder.RapidCacheConfig.PoliciesEntry.value:type_name -> google.storage.control.v2.ManagedFolder.RapidCacheConfig.RapidCachePolicy
	74,  // 77: google.storage.control.v2.IntelligenceConfig.Filter.included_cloud_storage_locations:type_name -> google.storage.control.v2.IntelligenceConfig.Filter.CloudStorageLocations
	74,  // 78: google.storage.control.v2.IntelligenceConfig.Filter.excluded_cloud_storage_locations:type_name -> google.storage.control.v2.IntelligenceConfig.Filter.CloudStorageLocations
	75,  // 79: google.storage.control.v2.IntelligenceConfig.Filter.included_cloud_storage_buckets:type_name -> google.storage.control.v2.IntelligenceConfig.Filter.CloudStorageBuckets
	75,  // 80: google.storage.control.v2.IntelligenceConfig.Filter.excluded_cloud_storage_buckets:type_name -> google.storage.control.v2.IntelligenceConfig.Filter.CloudStorageBuckets
	5,   // 81: google.storage.control.v2.IntelligenceConfig.EffectiveIntelligenceConfig.effective_edition:type_name -> google.storage.control.v2.IntelligenceConfig.EffectiveIntelligenceConfig.EffectiveEdition
	91,  // 82: google.storage.control.v2.IntelligenceConfig.TrialConfig.expire_time:type_name -> google.protobuf.Timestamp
	80,  // 83: google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpike.top_buckets:type_name -> google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpike.BucketContribution
	83,  // 84: google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpike.top_buckets:type_name -> google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpike.BucketContribution
	86,  // 85: google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpike.top_buckets:type_name -> google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpike.BucketContribution
	89,  // 86: google.storage.control.v2.IntelligenceFinding.StorageGrowthAboveTrend.top_buckets:type_name -> google.storage.control.v2.IntelligenceFinding.StorageGrowthAboveTrend.BucketContribution
	81,  // 87: google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpike.BucketContribution.contribution:type_name -> google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpike.BucketContribution.Contribution
	95,  // 88: google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpike.BucketContribution.error:type_name -> google.rpc.Status
	82,  // 89: google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpike.BucketContribution.Contribution.top_prefixes:type_name -> google.storage.control.v2.IntelligenceFinding.ColdlineAndArchivalStorageOperationsSpike.BucketContribution.Contribution.PrefixContribution
	84,  // 90: google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpike.BucketContribution.contribution:type_name -> google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpike.BucketContribution.Contribution
	95,  // 91: google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpike.BucketContribution.error:type_name -> google.rpc.Status
	85,  // 92: google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpike.BucketContribution.Contribution.top_prefixes:type_name -> google.storage.control.v2.IntelligenceFinding.CrossRegionEgressSpike.BucketContribution.Contribution.PrefixContribution
	87,  // 93: google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpike.BucketContribution.contribution:type_name -> google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpike.BucketContribution.Contribution
	95,  // 94: google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpike.BucketContribution.error:type_name -> google.rpc.Status
	88,  // 95: google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpike.BucketContribution.Contribution.top_prefixes:type_name -> google.storage.control.v2.IntelligenceFinding.ThrottledRequestSpike.BucketContribution.Contribution.PrefixContribution
	95,  // 96: google.storage.control.v2.IntelligenceFinding.StorageGrowthAboveTrend.BucketContribution.error:type_name -> google.rpc.Status
	7,   // 97: google.storage.control.v2.FindingSummary.SummaryDetails.resource_type:type_name -> google.storage.control.v2.FindingSummary.SummaryDetails.ResourceType
	11,  // 98: google.storage.control.v2.StorageControl.CreateFolder:input_type -> google.storage.control.v2.CreateFolderRequest
	12,  // 99: google.storage.control.v2.StorageControl.DeleteFolder:input_type -> google.storage.control.v2.DeleteFolderRequest
	10,  // 100: google.storage.control.v2.StorageControl.GetFolder:input_type -> google.storage.control.v2.GetFolderRequest
	13,  // 101: google.storage.control.v2.StorageControl.ListFolders:input_type -> google.storage.control.v2.ListFoldersRequest
	15,  // 102: google.storage.control.v2.StorageControl.RenameFolder:input_type -> google.storage.control.v2.RenameFolderRequest
	16,  // 103: google.storage.control.v2.StorageControl.DeleteFolderRecursive:input_type -> google.storage.control.v2.DeleteFolderRecursiveRequest
	21,  // 104: google.storage.control.v2.StorageControl.GetStorageLayout:input_type -> google.storage.control.v2.GetStorageLayoutRequest
	24,  // 105: google.storage.control.v2.StorageControl.CreateManagedFolder:input_type -> google.storage.control.v2.CreateManagedFolderRequest
	25,  // 106: google.storage.control.v2.StorageControl.DeleteManagedFolder:input_type -> google.storage.control.v2.DeleteManagedFolderRequest
	23,  // 107: google.storage.control.v2.StorageControl.GetManagedFolder:input_type -> google.storage.control.v2.GetManagedFolderRequest
	26,  // 108: google.storage.control.v2.StorageControl.ListManagedFolders:input_type -> google.storage.control.v2.ListManagedFoldersRequest
	28,  // 109: google.storage.control.v2.StorageControl.UpdateManagedFolder:input_type -> google.storage.control.v2.UpdateManagedFolderRequest
	34,  // 110: google.storage.control.v2.StorageControl.CreateAnywhereCache:input_type -> google.storage.control.v2.CreateAnywhereCacheRequest
	35,  // 111: google.storage.control.v2.StorageControl.UpdateAnywhereCache:input_type -> google.storage.control.v2.UpdateAnywhereCacheRequest
	36,  // 112: google.storage.control.v2.StorageControl.DisableAnywhereCache:input_type -> google.storage.control.v2.DisableAnywhereCacheRequest
	37,  // 113: google.storage.control.v2.StorageControl.PauseAnywhereCache:input_type -> google.storage.control.v2.PauseAnywhereCacheRequest
	38,  // 114: google.storage.control.v2.StorageControl.ResumeAnywhereCache:input_type -> google.storage.control.v2.ResumeAnywhereCacheRequest
	39,  // 115: google.storage.control.v2.StorageControl.GetAnywhereCache:input_type -> google.storage.control.v2.GetAnywhereCacheRequest
	40,  // 116: google.storage.control.v2.StorageControl.ListAnywhereCaches:input_type -> google.storage.control.v2.ListAnywhereCachesRequest
	43,  // 117: google.storage.control.v2.StorageControl.CreateRapidCache:input_type -> google.storage.control.v2.CreateRapidCacheRequest
	44,  // 118: google.storage.control.v2.StorageControl.UpdateRapidCache:input_type -> google.storage.control.v2.UpdateRapidCacheRequest
	45,  // 119: google.storage.control.v2.StorageControl.GetRapidCache:input_type -> google.storage.control.v2.GetRapidCacheRequest
	46,  // 120: google.storage.control.v2.StorageControl.ListRapidCaches:input_type -> google.storage.control.v2.ListRapidCachesRequest
	54,  // 121: google.storage.control.v2.StorageControl.GetProjectIntelligenceConfig:input_type -> google.storage.control.v2.GetProjectIntelligenceConfigRequest
	51,  // 122: google.storage.control.v2.StorageControl.UpdateProjectIntelligenceConfig:input_type -> google.storage.control.v2.UpdateProjectIntelligenceConfigRequest
	53,  // 123: google.storage.control.v2.StorageControl.GetFolderIntelligenceConfig:input_type -> google.storage.control.v2.GetFolderIntelligenceConfigRequest
	50,  // 124: google.storage.control.v2.StorageControl.UpdateFolderIntelligenceConfig:input_type -> google.storage.control.v2.UpdateFolderIntelligenceConfigRequest
	52,  // 125: google.storage.control.v2.StorageControl.GetOrganizationIntelligenceConfig:input_type -> google.storage.control.v2.GetOrganizationIntelligenceConfigRequest
	49,  // 126: google.storage.control.v2.StorageControl.UpdateOrganizationIntelligenceConfig:input_type -> google.storage.control.v2.UpdateOrganizationIntelligenceConfigRequest
	96,  // 127: google.storage.control.v2.StorageControl.GetIamPolicy:input_type -> google.iam.v1.GetIamPolicyRequest
	97,  // 128: google.storage.control.v2.StorageControl.SetIamPolicy:input_type -> google.iam.v1.SetIamPolicyRequest
	98,  // 129: google.storage.control.v2.StorageControl.TestIamPermissions:input_type -> google.iam.v1.TestIamPermissionsRequest
	57,  // 130: google.storage.control.v2.StorageControl.GetIntelligenceFinding:input_type -> google.storage.control.v2.GetIntelligenceFindingRequest
	58,  // 131: google.storage.control.v2.StorageControl.ListIntelligenceFindings:input_type -> google.storage.control.v2.ListIntelligenceFindingsRequest
	60,  // 132: google.storage.control.v2.StorageControl.SummarizeIntelligenceFindings:input_type -> google.storage.control.v2.SummarizeIntelligenceFindingsRequest
	62,  // 133: google.storage.control.v2.StorageControl.GetIntelligenceFindingRevision:input_type -> google.storage.control.v2.GetIntelligenceFindingRevisionRequest
	63,  // 134: google.storage.control.v2.StorageControl.ListIntelligenceFindingRevisions:input_type -> google.storage.control.v2.ListIntelligenceFindingRevisionsRequest
	9,   // 135: google.storage.control.v2.StorageControl.CreateFolder:output_type -> google.storage.control.v2.Folder
	99,  // 136: google.storage.control.v2.StorageControl.DeleteFolder:output_type -> google.protobuf.Empty
	9,   // 137: google.storage.control.v2.StorageControl.GetFolder:output_type -> google.storage.control.v2.Folder
	14,  // 138: google.storage.control.v2.StorageControl.ListFolders:output_type -> google.storage.control.v2.ListFoldersResponse
	100, // 139: google.storage.control.v2.StorageControl.RenameFolder:output_type -> google.longrunning.Operation
	100, // 140: google.storage.control.v2.StorageControl.DeleteFolderRecursive:output_type -> google.longrunning.Operation
	20,  // 141: google.storage.control.v2.StorageControl.GetStorageLayout:output_type -> google.storage.control.v2.StorageLayout
	22,  // 142: google.storage.control.v2.StorageControl.CreateManagedFolder:output_type -> google.storage.control.v2.ManagedFolder
	99,  // 143: google.storage.control.v2.StorageControl.DeleteManagedFolder:output_type -> google.protobuf.Empty
	22,  // 144: google.storage.control.v2.StorageControl.GetManagedFolder:output_type -> google.storage.control.v2.ManagedFolder
	27,  // 145: google.storage.control.v2.StorageControl.ListManagedFolders:output_type -> google.storage.control.v2.ListManagedFoldersResponse
	22,  // 146: google.storage.control.v2.StorageControl.UpdateManagedFolder:output_type -> google.storage.control.v2.ManagedFolder
	100, // 147: google.storage.control.v2.StorageControl.CreateAnywhereCache:output_type -> google.longrunning.Operation
	100, // 148: google.storage.control.v2.StorageControl.UpdateAnywhereCache:output_type -> google.longrunning.Operation
	33,  // 149: google.storage.control.v2.StorageControl.DisableAnywhereCache:output_type -> google.storage.control.v2.AnywhereCache
	33,  // 150: google.storage.control.v2.StorageControl.PauseAnywhereCache:output_type -> google.storage.control.v2.AnywhereCache
	33,  // 151: google.storage.control.v2.StorageControl.ResumeAnywhereCache:output_type -> google.storage.control.v2.AnywhereCache
	33,  // 152: google.storage.control.v2.StorageControl.GetAnywhereCache:output_type -> google.storage.control.v2.AnywhereCache
	41,  // 153: google.storage.control.v2.StorageControl.ListAnywhereCaches:output_type -> google.storage.control.v2.ListAnywhereCachesResponse
	100, // 154: google.storage.control.v2.StorageControl.CreateRapidCache:output_type -> google.longrunning.Operation
	100, // 155: google.storage.control.v2.StorageControl.UpdateRapidCache:output_type -> google.longrunning.Operation
	42,  // 156: google.storage.control.v2.StorageControl.GetRapidCache:output_type -> google.storage.control.v2.RapidCache
	47,  // 157: google.storage.control.v2.StorageControl.ListRapidCaches:output_type -> google.storage.control.v2.ListRapidCachesResponse
	48,  // 158: google.storage.control.v2.StorageControl.GetProjectIntelligenceConfig:output_type -> google.storage.control.v2.IntelligenceConfig
	48,  // 159: google.storage.control.v2.StorageControl.UpdateProjectIntelligenceConfig:output_type -> google.storage.control.v2.IntelligenceConfig
	48,  // 160: google.storage.control.v2.StorageControl.GetFolderIntelligenceConfig:output_type -> google.storage.control.v2.IntelligenceConfig
	48,  // 161: google.storage.control.v2.StorageControl.UpdateFolderIntelligenceConfig:output_type -> google.storage.control.v2.IntelligenceConfig
	48,  // 162: google.storage.control.v2.StorageControl.GetOrganizationIntelligenceConfig:output_type -> google.storage.control.v2.IntelligenceConfig
	48,  // 163: google.storage.control.v2.StorageControl.UpdateOrganizationIntelligenceConfig:output_type -> google.storage.control.v2.IntelligenceConfig
	101, // 164: google.storage.control.v2.StorageControl.GetIamPolicy:output_type -> google.iam.v1.Policy
	101, // 165: google.storage.control.v2.StorageControl.SetIamPolicy:output_type -> google.iam.v1.Policy
	102, // 166: google.storage.control.v2.StorageControl.TestIamPermissions:output_type -> google.iam.v1.TestIamPermissionsResponse
	55,  // 167: google.storage.control.v2.StorageControl.GetIntelligenceFinding:output_type -> google.storage.control.v2.IntelligenceFinding
	59,  // 168: google.storage.control.v2.StorageControl.ListIntelligenceFindings:output_type -> google.storage.control.v2.ListIntelligenceFindingsResponse
	61,  // 169: google.storage.control.v2.StorageControl.SummarizeIntelligenceFindings:output_type -> google.storage.control.v2.SummarizeIntelligenceFindingsResponse
	56,  // 170: google.storage.control.v2.StorageControl.GetIntelligenceFindingRevision:output_type -> google.storage.control.v2.IntelligenceFindingRevision
	64,  // 171: google.storage.control.v2.StorageControl.ListIntelligenceFindingRevisions:output_type -> google.storage.control.v2.ListIntelligenceFindingRevisionsResponse
	135, // [135:172] is the sub-list for method output_type
	98,  // [98:135] is the sub-list for method input_type
...
func file_google_storage_control_v2_storage_control_proto_init() {
	...
	file_google_storage_control_v2_storage_control_proto_msgTypes[8].OneofWrappers = []any{}
	...
	file_google_storage_control_v2_storage_control_proto_msgTypes[17].OneofWrappers = []any{}
	...
	file_google_storage_control_v2_storage_control_proto_msgTypes[63].OneofWrappers = []any{
	...
	file_google_storage_control_v2_storage_control_proto_msgTypes[72].OneofWrappers = []any{
	...
	file_google_storage_control_v2_storage_control_proto_msgTypes[82].OneofWrappers = []any{
