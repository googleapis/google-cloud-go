...
type UserEvent struct {
	...
	Attributes map[string]*CustomAttribute `protobuf:"bytes,7,rep,name=attributes,proto3" json:"attributes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_google_cloud_retail_v2_user_event_proto_rawDesc = "" +
	"\n" +
	"'google/cloud/retail/v2/user_event.proto\x12\x16google.cloud.retail.v2\x1a\x1fgoogle/api/field_behavior.proto\x1a#google/cloud/retail/v2/common.proto\x1a$google/cloud/retail/v2/product.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xa1\b\n" +
	"\tUserEvent\x12\"\n" +
	"\n" +
	"event_type\x18\x01 \x01(\tB\x03\xe0A\x02R\teventType\x12\"\n" +
	"\n" +
	"visitor_id\x18\x02 \x01(\tB\x03\xe0A\x02R\tvisitorId\x12\x1d\n" +
	"\n" +
	"session_id\x18\x15 \x01(\tR\tsessionId\x129\n" +
	"\n" +
	"event_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\teventTime\x12%\n" +
	"\x0eexperiment_ids\x18\x04 \x03(\tR\rexperimentIds\x12+\n" +
	"\x11attribution_token\x18\x05 \x01(\tR\x10attributionToken\x12N\n" +
	"\x0fproduct_details\x18\x06 \x03(\v2%.google.cloud.retail.v2.ProductDetailR\x0eproductDetails\x12U\n" +
	"\x11completion_detail\x18\x16 \x01(\v2(.google.cloud.retail.v2.CompletionDetailR\x10completionDetail\x12Q\n" +
	"\n" +
	"attributes\x18\a \x03(\v21.google.cloud.retail.v2.UserEvent.AttributesEntryR\n" +
	"attributes\x12\x17\n" +
	"\acart_id\x18\b \x01(\tR\x06cartId\x12^\n" +
	"\x14purchase_transaction\x18\t \x01(\v2+.google.cloud.retail.v2.PurchaseTransactionR\x13purchaseTransaction\x12!\n" +
	"\fsearch_query\x18\n" +
	" \x01(\tR\vsearchQuery\x12\x16\n" +
	"\x06filter\x18\x10 \x01(\tR\x06filter\x12\x19\n" +
	"\border_by\x18\x11 \x01(\tR\aorderBy\x12\x16\n" +
	"\x06offset\x18\x12 \x01(\x05R\x06offset\x12'\n" +
	"\x0fpage_categories\x18\v \x03(\tR\x0epageCategories\x12=\n" +
	"\tuser_info\x18\f \x01(\v2 .google.cloud.retail.v2.UserInfoR\buserInfo\x12\x10\n" +
	"\x03uri\x18\r \x01(\tR\x03uri\x12!\n" +
	"\freferrer_uri\x18\x0e \x01(\tR\vreferrerUri\x12 \n" +
	"\fpage_view_id\x18\x0f \x01(\tR\n" +
	"pageViewId\x12\x16\n" +
	"\x06entity\x18\x17 \x01(\tR\x06entity\x1af\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12=\n" +
	"\x05value\x18\x02 \x01(\v2'.google.cloud.retail.v2.CustomAttributeR\x05value:\x028\x01\"\x88\x01\n" +
	"\rProductDetail\x12>\n" +
	"\aproduct\x18\x01 \x01(\v2\x1f.google.cloud.retail.v2.ProductB\x03\xe0A\x02R\aproduct\x127\n" +
	"\bquantity\x18\x02 \x01(\v2\x1b.google.protobuf.Int32ValueR\bquantity\"\xb2\x01\n" +
	"\x10CompletionDetail\x12@\n" +
	"\x1ccompletion_attribution_token\x18\x01 \x01(\tR\x1acompletionAttributionToken\x12/\n" +
	"\x13selected_suggestion\x18\x02 \x01(\tR\x12selectedSuggestion\x12+\n" +
	"\x11selected_position\x18\x03 \x01(\x05R\x10selectedPosition\"\x94\x01\n" +
	"\x13PurchaseTransaction\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1d\n" +
	"\arevenue\x18\x02 \x01(\x02B\x03\xe0A\x02R\arevenue\x12\x10\n" +
	"\x03tax\x18\x03 \x01(\x02R\x03tax\x12\x12\n" +
	"\x04cost\x18\x04 \x01(\x02R\x04cost\x12(\n" +
	"\rcurrency_code\x18\x05 \x01(\tB\x03\xe0A\x02R\fcurrencyCodeB\xb9\x01\n" +
...
var (
	...
	file_google_cloud_retail_v2_user_event_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2_user_event_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2_user_event_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2_user_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2_user_event_proto_rawDesc), len(file_google_cloud_retail_v2_user_event_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2_user_event_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2_user_event_proto_rawDesc), len(file_google_cloud_retail_v2_user_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
