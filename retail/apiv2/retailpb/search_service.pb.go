...
const file_google_cloud_retail_v2_search_service_proto_rawDesc = "" +
	"\n" +
	...
	"\binterval\x18\x02 \x01(\v2 .google.cloud.retail.v2.IntervalR\binterval\"\xb2\x02\n" +
	"\x04Tile\x12g\n" +
	"\x17product_attribute_value\x18\x01 \x01(\v2-.google.cloud.retail.v2.ProductAttributeValueH\x00R\x15productAttributeValue\x12p\n" +
	"\x1aproduct_attribute_interval\x18\x02 \x01(\v20.google.cloud.retail.v2.ProductAttributeIntervalH\x00R\x18productAttributeInterval\x12:\n" +
	"\x19representative_product_id\x18\x03 \x01(\tR\x17representativeProductIdB\x13\n" +
	"\x11product_attribute\"\xde\"\n" +
	"\rSearchRequest\x12!\n" +
	...
	"\n" +
	"visitor_id\x18\x04 \x01(\tB\x03\xe0A\x02R\tvisitorId\x12=\n" +
	"\tuser_info\x18\x05 \x01(\v2 .google.cloud.retail.v2.UserInfoR\buserInfo\x12\x1b\n" +
	...
	"\border_by\x18\v \x01(\tR\aorderBy\x12P\n" +
	"\vfacet_specs\x18\f \x03(\v2/.google.cloud.retail.v2.SearchRequest.FacetSpecR\n" +
	"facetSpecs\x12h\n" +
	"\x12dynamic_facet_spec\x18\x15 \x01(\v26.google.cloud.retail.v2.SearchRequest.DynamicFacetSpecB\x02\x18\x01R\x10dynamicFacetSpec\x12N\n" +
	"\n" +
	"boost_spec\x18\r \x01(\v2/.google.cloud.retail.v2.SearchRequest.BoostSpecR\tboostSpec\x12j\n" +
	"\x14query_expansion_spec\x18\x0e \x01(\v28.google.cloud.retail.v2.SearchRequest.QueryExpansionSpecR\x12queryExpansionSpec\x12.\n" +
	"\x13variant_rollup_keys\x18\x11 \x03(\tR\x11variantRollupKeys\x12'\n" +
	"\x0fpage_categories\x18\x17 \x03(\tR\x0epageCategories\x12Q\n" +
	"\vsearch_mode\x18\x1f \x01(\x0e20.google.cloud.retail.v2.SearchRequest.SearchModeR\n" +
	"searchMode\x12l\n" +
	"\x14personalization_spec\x18  \x01(\v29.google.cloud.retail.v2.SearchRequest.PersonalizationSpecR\x13personalizationSpec\x12I\n" +
	"\x06labels\x18\" \x03(\v21.google.cloud.retail.v2.SearchRequest.LabelsEntryR\x06labels\x12r\n" +
	"\x15spell_correction_spec\x18# \x01(\v29.google.cloud.retail.v2.SearchRequest.SpellCorrectionSpecH\x00R\x13spellCorrectionSpec\x88\x01\x01\x12\x16\n" +
	"\x06entity\x18& \x01(\tR\x06entity\x12\x81\x01\n" +
	"\x1aconversational_search_spec\x18( \x01(\v2>.google.cloud.retail.v2.SearchRequest.ConversationalSearchSpecB\x03\xe0A\x01R\x18conversationalSearchSpec\x12o\n" +
	"\x14tile_navigation_spec\x18) \x01(\v28.google.cloud.retail.v2.SearchRequest.TileNavigationSpecB\x03\xe0A\x01R\x12tileNavigationSpec\x12(\n" +
	"\rlanguage_code\x18+ \x01(\tB\x03\xe0A\x01R\flanguageCode\x12$\n" +
	"\vregion_code\x18, \x01(\tB\x03\xe0A\x01R\n" +
	"regionCode\x12\x1e\n" +
	"\bplace_id\x18. \x01(\tB\x03\xe0A\x01R\aplaceId\x12g\n" +
	"\x0fuser_attributes\x18/ \x03(\v29.google.cloud.retail.v2.SearchRequest.UserAttributesEntryB\x03\xe0A\x01R\x0euserAttributes\x1a\xb2\x04\n" +
	"\tFacetSpec\x12Z\n" +
	"\tfacet_key\x18\x01 \x01(\v28.google.cloud.retail.v2.SearchRequest.FacetSpec.FacetKeyB\x03\xe0A\x02R\bfacetKey\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x05R\x05limit\x120\n" +
	"\x14excluded_filter_keys\x18\x03 \x03(\tR\x12excludedFilterKeys\x126\n" +
	"\x17enable_dynamic_position\x18\x04 \x01(\bR\x15enableDynamicPosition\x1a\xc8\x02\n" +
	"\bFacetKey\x12\x15\n" +
	"\x03key\x18\x01 \x01(\tB\x03\xe0A\x02R\x03key\x12>\n" +
	"\tintervals\x18\x02 \x03(\v2 .google.cloud.retail.v2.IntervalR\tintervals\x12+\n" +
	...
	"\x0ereturn_min_max\x18\v \x01(\bR\freturnMinMax\x1a\x9c\x01\n" +
	"\x10DynamicFacetSpec\x12O\n" +
	"\x04mode\x18\x01 \x01(\x0e2;.google.cloud.retail.v2.SearchRequest.DynamicFacetSpec.ModeR\x04mode\"7\n" +
	"\x04Mode\x12\x14\n" +
	"\x10MODE_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bDISABLED\x10\x01\x12\v\n" +
	"\aENABLED\x10\x02\x1a\xae\x02\n" +
	"\tBoostSpec\x12v\n" +
	"\x15condition_boost_specs\x18\x01 \x03(\v2B.google.cloud.retail.v2.SearchRequest.BoostSpec.ConditionBoostSpecR\x13conditionBoostSpecs\x12@\n" +
	...
	"\x1b_skip_boost_spec_validation\x1a\xec\x01\n" +
	"\x12QueryExpansionSpec\x12`\n" +
	"\tcondition\x18\x01 \x01(\x0e2B.google.cloud.retail.v2.SearchRequest.QueryExpansionSpec.ConditionR\tcondition\x124\n" +
	...
	"\x04AUTO\x10\x03\x1a\x9f\x01\n" +
	"\x13PersonalizationSpec\x12R\n" +
	"\x04mode\x18\x01 \x01(\x0e2>.google.cloud.retail.v2.SearchRequest.PersonalizationSpec.ModeR\x04mode\"4\n" +
	"\x04Mode\x12\x14\n" +
	"\x10MODE_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04AUTO\x10\x01\x12\f\n" +
	"\bDISABLED\x10\x02\x1a\xa6\x01\n" +
	"\x13SpellCorrectionSpec\x12R\n" +
	"\x04mode\x18\x01 \x01(\x0e2>.google.cloud.retail.v2.SearchRequest.SpellCorrectionSpec.ModeR\x04mode\";\n" +
	"\x04Mode\x12\x14\n" +
	"\x10MODE_UNSPECIFIED\x10\x00\x12\x13\n" +
	"\x0fSUGGESTION_ONLY\x10\x01\x12\b\n" +
	"\x04AUTO\x10\x02\x1a\x9e\x05\n" +
	"\x18ConversationalSearchSpec\x12F\n" +
	"\x1ffollowup_conversation_requested\x18\x01 \x01(\bR\x1dfollowupConversationRequested\x12'\n" +
	"\x0fconversation_id\x18\x02 \x01(\tR\x0econversationId\x12j\n" +
	"\vuser_answer\x18\x03 \x01(\v2I.google.cloud.retail.v2.SearchRequest.ConversationalSearchSpec.UserAnswerR\n" +
	"userAnswer\x1a\xa4\x03\n" +
	"\n" +
	"UserAnswer\x12!\n" +
	"\vtext_answer\x18\x01 \x01(\tH\x00R\n" +
	"textAnswer\x12\x83\x01\n" +
	"\x0fselected_answer\x18\x02 \x01(\v2X.google.cloud.retail.v2.SearchRequest.ConversationalSearchSpec.UserAnswer.SelectedAnswerH\x00R\x0eselectedAnswer\x1a\xe4\x01\n" +
	"\x0eSelectedAnswer\x12k\n" +
	"\x18product_attribute_values\x18\x01 \x03(\v2-.google.cloud.retail.v2.ProductAttributeValueB\x02\x18\x01R\x16productAttributeValues\x12e\n" +
	"\x17product_attribute_value\x18\x02 \x01(\v2-.google.cloud.retail.v2.ProductAttributeValueR\x15productAttributeValueB\x06\n" +
	"\x04type\x1a\x93\x01\n" +
	"\x12TileNavigationSpec\x12:\n" +
	"\x19tile_navigation_requested\x18\x01 \x01(\bR\x17tileNavigationRequested\x12A\n" +
	"\rapplied_tiles\x18\x02 \x03(\v2\x1c.google.cloud.retail.v2.TileR\fappliedTiles\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1ae\n" +
	"\x13UserAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x128\n" +
	"\x05value\x18\x02 \x01(\v2\".google.cloud.retail.v2.StringListR\x05value:\x028\x01\"[\n" +
	"\n" +
	"SearchMode\x12\x1b\n" +
	"\x17SEARCH_MODE_UNSPECIFIED\x10\x00\x12\x17\n" +
	"\x13PRODUCT_SEARCH_ONLY\x10\x01\x12\x17\n" +
	"\x13FACETED_SEARCH_ONLY\x10\x02B\x18\n" +
	"\x16_spell_correction_spec\"\xb0\x19\n" +
	"\x0eSearchResponse\x12M\n" +
	"\aresults\x18\x01 \x03(\v23.google.cloud.retail.v2.SearchResponse.SearchResultR\aresults\x12D\n" +
	"\x06facets\x18\x02 \x03(\v2,.google.cloud.retail.v2.SearchResponse.FacetR\x06facets\x12\x1d\n" +
	"\n" +
	...
	"\x14query_expansion_info\x18\a \x01(\v29.google.cloud.retail.v2.SearchResponse.QueryExpansionInfoR\x12queryExpansionInfo\x12!\n" +
	"\fredirect_uri\x18\n" +
	" \x01(\tR\vredirectUri\x12)\n" +
	"\x10applied_controls\x18\f \x03(\tR\x0fappliedControls\x12\\\n" +
	"\x14pin_control_metadata\x18\x16 \x01(\v2*.google.cloud.retail.v2.PinControlMetadataR\x12pinControlMetadata\x12\x85\x01\n" +
	"\x1dinvalid_condition_boost_specs\x18\x0e \x03(\v2B.google.cloud.retail.v2.SearchRequest.BoostSpec.ConditionBoostSpecR\x1ainvalidConditionBoostSpecs\x12O\n" +
	"\x0fexperiment_info\x18\x11 \x03(\v2&.google.cloud.retail.v2.ExperimentInfoR\x0eexperimentInfo\x12\x83\x01\n" +
	"\x1cconversational_search_result\x18\x12 \x01(\v2A.google.cloud.retail.v2.SearchResponse.ConversationalSearchResultR\x1aconversationalSearchResult\x12q\n" +
	"\x16tile_navigation_result\x18\x13 \x01(\v2;.google.cloud.retail.v2.SearchResponse.TileNavigationResultR\x14tileNavigationResult\x1a\xd7\x06\n" +
	"\fSearchResult\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x129\n" +
	"\aproduct\x18\x02 \x01(\v2\x1f.google.cloud.retail.v2.ProductR\aproduct\x124\n" +
	"\x16matching_variant_count\x18\x03 \x01(\x05R\x14matchingVariantCount\x12\x86\x01\n" +
	"\x17matching_variant_fields\x18\x04 \x03(\v2N.google.cloud.retail.v2.SearchResponse.SearchResult.MatchingVariantFieldsEntryR\x15matchingVariantFields\x12\x80\x01\n" +
	"\x15variant_rollup_values\x18\x05 \x03(\v2L.google.cloud.retail.v2.SearchResponse.SearchResult.VariantRollupValuesEntryR\x13variantRollupValues\x12'\n" +
	"\x0fpersonal_labels\x18\a \x03(\tR\x0epersonalLabels\x12g\n" +
	"\fmodel_scores\x18\b \x03(\v2D.google.cloud.retail.v2.SearchResponse.SearchResult.ModelScoresEntryR\vmodelScores\x1ad\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x128\n" +
	"\x05value\x18\x02 \x01(\v2\".google.cloud.retail.v2.DoubleListR\x05value:\x028\x01\x1a\xd5\x02\n" +
	"\x05Facet\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12O\n" +
	"\x06values\x18\x02 \x03(\v27.google.cloud.retail.v2.SearchResponse.Facet.FacetValueR\x06values\x12#\n" +
	"\rdynamic_facet\x18\x03 \x01(\bR\fdynamicFacet\x1a\xc3\x01\n" +
	"\n" +
	"FacetValue\x12\x16\n" +
	"\x05value\x18\x01 \x01(\tH\x00R\x05value\x12>\n" +
	"\binterval\x18\x02 \x01(\v2 .google.cloud.retail.v2.IntervalH\x00R\binterval\x12\x14\n" +
	...
	"\x13pinned_result_count\x18\x02 \x01(\x03R\x11pinnedResultCount\x1a\x95\x06\n" +
	"\x1aConversationalSearchResult\x12'\n" +
	"\x0fconversation_id\x18\x01 \x01(\tR\x0econversationId\x12#\n" +
	"\rrefined_query\x18\x02 \x01(\tR\frefinedQuery\x12\x85\x01\n" +
	"\x12additional_filters\x18\x03 \x03(\v2R.google.cloud.retail.v2.SearchResponse.ConversationalSearchResult.AdditionalFilterB\x02\x18\x01R\x11additionalFilters\x12+\n" +
	"\x11followup_question\x18\x04 \x01(\tR\x10followupQuestion\x12~\n" +
	"\x11suggested_answers\x18\x05 \x03(\v2Q.google.cloud.retail.v2.SearchResponse.ConversationalSearchResult.SuggestedAnswerR\x10suggestedAnswers\x12\x7f\n" +
	"\x11additional_filter\x18\x06 \x01(\v2R.google.cloud.retail.v2.SearchResponse.ConversationalSearchResult.AdditionalFilterR\x10additionalFilter\x1ax\n" +
	"\x0fSuggestedAnswer\x12e\n" +
	"\x17product_attribute_value\x18\x01 \x01(\v2-.google.cloud.retail.v2.ProductAttributeValueR\x15productAttributeValue\x1ay\n" +
	"\x10AdditionalFilter\x12e\n" +
	"\x17product_attribute_value\x18\x01 \x01(\v2-.google.cloud.retail.v2.ProductAttributeValueR\x15productAttributeValue\x1aJ\n" +
	"\x14TileNavigationResult\x122\n" +
	"\x05tiles\x18\x01 \x03(\v2\x1c.google.cloud.retail.v2.TileR\x05tiles\"\xd0\x03\n" +
	"\x0eExperimentInfo\x12|\n" +
	"\x19serving_config_experiment\x18\x02 \x01(\v2>.google.cloud.retail.v2.ExperimentInfo.ServingConfigExperimentH\x00R\x17servingConfigExperiment\x12E\n" +
	"\n" +
	...
	"\x06Search\x12%.google.cloud.retail.v2.SearchRequest\x1a&.google.cloud.retail.v2.SearchResponse\"\xa1\x01\x82\xd3\xe4\x93\x02\x9a\x01:\x01*ZN:\x01*\"I/v2/{placement=projects/*/locations/*/catalogs/*/servingConfigs/*}:search\"E/v2/{placement=projects/*/locations/*/catalogs/*/placements/*}:search\x1aI\xcaA\x15retail.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xb7\x02\xeaAw\n" +
	" retail.googleapis.com/Experiment\x12Sprojects/{project}/locations/{location}/catalogs/{catalog}/experiments/{experiment}\n" +
	"\x1acom.google.cloud.retail.v2B\x12SearchServiceProtoP\x01Z2cloud.google.com/go/retail/apiv2/retailpb;retailpb\xa2\x02\x06RETAIL\xaa\x02\x16Google.Cloud.Retail.V2\xca\x02\x16Google\\Cloud\\Retail\\V2\xea\x02\x19Google::Cloud::Retail::V2b\x06proto3"

var (
	file_google_cloud_retail_v2_search_service_proto_rawDescOnce sync.Once
	file_google_cloud_retail_v2_search_service_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2_search_service_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2_search_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2_search_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2_search_service_proto_rawDesc), len(file_google_cloud_retail_v2_search_service_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2_search_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2_search_service_proto_rawDesc), len(file_google_cloud_retail_v2_search_service_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   32,
			NumExtensions: 0,
			NumServices:   1,
