...
const file_google_cloud_retail_v2_prediction_service_proto_rawDesc = "" +
	"\n" +
	"/google/cloud/retail/v2/prediction_service.proto\x12\x16google.cloud.retail.v2\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a'google/cloud/retail/v2/user_event.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x9d\x04\n" +
	"\x0ePredictRequest\x12!\n" +
	"\tplacement\x18\x01 \x01(\tB\x03\xe0A\x02R\tplacement\x12E\n" +
	"\n" +
	"user_event\x18\x02 \x01(\v2!.google.cloud.retail.v2.UserEventB\x03\xe0A\x02R\tuserEvent\x12\x1b\n" +
	"\tpage_size\x18\x03 \x01(\x05R\bpageSize\x12!\n" +
	"\n" +
	"page_token\x18\x04 \x01(\tB\x02\x18\x01R\tpageToken\x12\x16\n" +
	"\x06filter\x18\x05 \x01(\tR\x06filter\x12#\n" +
	"\rvalidate_only\x18\x06 \x01(\bR\fvalidateOnly\x12J\n" +
	"\x06params\x18\a \x03(\v22.google.cloud.retail.v2.PredictRequest.ParamsEntryR\x06params\x12J\n" +
	"\x06labels\x18\b \x03(\v22.google.cloud.retail.v2.PredictRequest.LabelsEntryR\x06labels\x1aQ\n" +
	...
	"\aresults\x18\x01 \x03(\v28.google.cloud.retail.v2.PredictResponse.PredictionResultR\aresults\x12+\n" +
	"\x11attribution_token\x18\x02 \x01(\tR\x10attributionToken\x12\x1f\n" +
	"\vmissing_ids\x18\x03 \x03(\tR\n" +
	"missingIds\x12#\n" +
	"\rvalidate_only\x18\x04 \x01(\bR\fvalidateOnly\x1a\xdb\x01\n" +
	"\x10PredictionResult\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12b\n" +
	"\bmetadata\x18\x02 \x03(\v2F.google.cloud.retail.v2.PredictResponse.PredictionResult.MetadataEntryR\bmetadata\x1aS\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value:\x028\x012\xe1\x02\n" +
	"\x11PredictionService\x12\x80\x02\n" +
	"\aPredict\x12&.google.cloud.retail.v2.PredictRequest\x1a'.google.cloud.retail.v2.PredictResponse\"\xa3\x01\x82\xd3\xe4\x93\x02\x9c\x01:\x01*ZO:\x01*\"J/v2/{placement=projects/*/locations/*/catalogs/*/servingConfigs/*}:predict\"F/v2/{placement=projects/*/locations/*/catalogs/*/placements/*}:predict\x1aI\xcaA\x15retail.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xc1\x01\n" +
...
var (
	...
	file_google_cloud_retail_v2_prediction_service_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2_prediction_service_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2_prediction_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2_prediction_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2_prediction_service_proto_rawDesc), len(file_google_cloud_retail_v2_prediction_service_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2_prediction_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2_prediction_service_proto_rawDesc), len(file_google_cloud_retail_v2_prediction_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
