...
const file_google_cloud_retail_v2_product_proto_rawDesc = "" +
	"\n" +
	"$google/cloud/retail/v2/product.proto\x12\x16google.cloud.retail.v2\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a#google/cloud/retail/v2/common.proto\x1a&google/cloud/retail/v2/promotion.proto\x1a\x1egoogle/protobuf/duration.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xe3\x10\n" +
	"\aProduct\x12=\n" +
	...
	"\x04type\x18\x03 \x01(\x0e2$.google.cloud.retail.v2.Product.TypeB\x03\xe0A\x05R\x04type\x12,\n" +
	...
	"\rlanguage_code\x18\v \x01(\tR\flanguageCode\x12O\n" +
	"\n" +
	"attributes\x18\f \x03(\v2/.google.cloud.retail.v2.Product.AttributesEntryR\n" +
	"attributes\x12\x12\n" +
	"\x04tags\x18\r \x03(\tR\x04tags\x12@\n" +
	"\n" +
	"price_info\x18\x0e \x01(\v2!.google.cloud.retail.v2.PriceInfoR\tpriceInfo\x126\n" +
	"\x06rating\x18\x0f \x01(\v2\x1e.google.cloud.retail.v2.RatingR\x06rating\x12A\n" +
	"\x0eavailable_time\x18\x12 \x01(\v2\x1a.google.protobuf.TimestampR\ravailableTime\x12P\n" +
	"\favailability\x18\x13 \x01(\x0e2,.google.cloud.retail.v2.Product.AvailabilityR\favailability\x12J\n" +
	"\x12available_quantity\x18\x14 \x01(\v2\x1b.google.protobuf.Int32ValueR\x11availableQuantity\x12R\n" +
	"\x10fulfillment_info\x18\x15 \x03(\v2'.google.cloud.retail.v2.FulfillmentInfoR\x0ffulfillmentInfo\x12\x10\n" +
	"\x03uri\x18\x16 \x01(\tR\x03uri\x125\n" +
	"\x06images\x18\x17 \x03(\v2\x1d.google.cloud.retail.v2.ImageR\x06images\x12<\n" +
	"\baudience\x18\x18 \x01(\v2 .google.cloud.retail.v2.AudienceR\baudience\x12@\n" +
	"\n" +
	"color_info\x18\x19 \x01(\v2!.google.cloud.retail.v2.ColorInfoR\tcolorInfo\x12\x14\n" +
	...
	"conditions\x12A\n" +
	"\n" +
	"promotions\x18\" \x03(\v2!.google.cloud.retail.v2.PromotionR\n" +
	"promotions\x12=\n" +
	"\fpublish_time\x18! \x01(\v2\x1a.google.protobuf.TimestampR\vpublishTime\x12M\n" +
	"\x12retrievable_fields\x18\x1e \x01(\v2\x1a.google.protobuf.FieldMaskB\x02\x18\x01R\x11retrievableFields\x12@\n" +
	"\bvariants\x18\x1f \x03(\v2\x1f.google.cloud.retail.v2.ProductB\x03\xe0A\x03R\bvariants\x12X\n" +
	"\x11local_inventories\x18# \x03(\v2&.google.cloud.retail.v2.LocalInventoryB\x03\xe0A\x03R\x10localInventories\x1af\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12=\n" +
	"\x05value\x18\x02 \x01(\v2'.google.cloud.retail.v2.CustomAttributeR\x05value:\x028\x01\"F\n" +
	"\x04Type\x12\x14\n" +
	...
	"\n" +
	"expirationB\xa6\x02\xeaAl\n" +
	"\x1cretail.googleapis.com/Branch\x12Lprojects/{project}/locations/{location}/catalogs/{catalog}/branches/{branch}\n" +
	"\x1acom.google.cloud.retail.v2B\fProductProtoP\x01Z2cloud.google.com/go/retail/apiv2/retailpb;retailpb\xa2\x02\x06RETAIL\xaa\x02\x16Google.Cloud.Retail.V2\xca\x02\x16Google\\Cloud\\Retail\\V2\xea\x02\x19Google::Cloud::Retail::V2b\x06proto3"

var (
	file_google_cloud_retail_v2_product_proto_rawDescOnce sync.Once
	file_google_cloud_retail_v2_product_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2_product_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2_product_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2_product_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2_product_proto_rawDesc), len(file_google_cloud_retail_v2_product_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2_product_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2_product_proto_rawDesc), len(file_google_cloud_retail_v2_product_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
