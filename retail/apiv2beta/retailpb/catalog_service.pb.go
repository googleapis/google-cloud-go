...
const file_google_cloud_retail_v2beta_catalog_service_proto_rawDesc = "" +
	"\n" +
	...
	"\bcatalogs\x18\x01 \x03(\v2#.google.cloud.retail.v2beta.CatalogR\bcatalogs\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\x97\x01\n" +
	"\x14UpdateCatalogRequest\x12B\n" +
	"\acatalog\x18\x01 \x01(\v2#.google.cloud.retail.v2beta.CatalogB\x03\xe0A\x02R\acatalog\x12;\n" +
	...
	"&retail.googleapis.com/CompletionConfigR\x04name\"\xbc\x01\n" +
	"\x1dUpdateCompletionConfigRequest\x12^\n" +
	"\x11completion_config\x18\x01 \x01(\v2,.google.cloud.retail.v2beta.CompletionConfigB\x03\xe0A\x02R\x10completionConfig\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"`\n" +
	"\x1aGetAttributesConfigRequest\x12B\n" +
	"\x04name\x18\x01 \x01(\tB.\xe0A\x02\xfaA(\n" +
	"&retail.googleapis.com/AttributesConfigR\x04name\"\xbc\x01\n" +
	"\x1dUpdateAttributesConfigRequest\x12^\n" +
	"\x11attributes_config\x18\x01 \x01(\v2,.google.cloud.retail.v2beta.AttributesConfigB\x03\xe0A\x02R\x10attributesConfig\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"\xd9\x01\n" +
	...
	"\x11catalog_attribute\x18\x02 \x01(\v2,.google.cloud.retail.v2beta.CatalogAttributeB\x03\xe0A\x02R\x10catalogAttribute\"\x93\x01\n" +
	...
	"\x18reset_catalog_attributes\x18\x02 \x03(\tR\x16resetCatalogAttributes\"\x9a\x02\n" +
	"\x1eReplaceCatalogAttributeRequest\x12[\n" +
	"\x11attributes_config\x18\x01 \x01(\tB.\xe0A\x02\xfaA(\n" +
	"&retail.googleapis.com/AttributesConfigR\x10attributesConfig\x12^\n" +
	"\x11catalog_attribute\x18\x02 \x01(\v2,.google.cloud.retail.v2beta.CatalogAttributeB\x03\xe0A\x02R\x10catalogAttribute\x12;\n" +
	"\vupdate_mask\x18\x03 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask2\xb3\x16\n" +
	"\x0eCatalogService\x12\xb4\x01\n" +
	"\fListCatalogs\x12/.google.cloud.retail.v2beta.ListCatalogsRequest\x1a0.google.cloud.retail.v2beta.ListCatalogsResponse\"A\xdaA\x06parent\x82\xd3\xe4\x93\x022\x120/v2beta/{parent=projects/*/locations/*}/catalogs\x12\xc7\x01\n" +
	"\rUpdateCatalog\x120.google.cloud.retail.v2beta.UpdateCatalogRequest\x1a#.google.cloud.retail.v2beta.Catalog\"_\xdaA\x13catalog,update_mask\x82\xd3\xe4\x93\x02C:\acatalog28/v2beta/{catalog.name=projects/*/locations/*/catalogs/*}\x12\xba\x01\n" +
	"\x10SetDefaultBranch\x123.google.cloud.retail.v2beta.SetDefaultBranchRequest\x1a\x16.google.protobuf.Empty\"Y\xdaA\acatalog\x82\xd3\xe4\x93\x02I:\x01*\"D/v2beta/{catalog=projects/*/locations/*/catalogs/*}:setDefaultBranch\x12\xd5\x01\n" +
	"\x10GetDefaultBranch\x123.google.cloud.retail.v2beta.GetDefaultBranchRequest\x1a4.google.cloud.retail.v2beta.GetDefaultBranchResponse\"V\xdaA\acatalog\x82\xd3\xe4\x93\x02F\x12D/v2beta/{catalog=projects/*/locations/*/catalogs/*}:getDefaultBranch\x12\xcd\x01\n" +
	...
	"\x16UpdateAttributesConfig\x129.google.cloud.retail.v2beta.UpdateAttributesConfigRequest\x1a,.google.cloud.retail.v2beta.AttributesConfig\"\x8e\x01\xdaA\x1dattributes_config,update_mask\x82\xd3\xe4\x93\x02h:\x11attributes_config2S/v2beta/{attributes_config.name=projects/*/locations/*/catalogs/*/attributesConfig}\x12\xea\x01\n" +
	"\x13AddCatalogAttribute\x126.google.cloud.retail.v2beta.AddCatalogAttributeRequest\x1a,.google.cloud.retail.v2beta.AttributesConfig\"m\x82\xd3\xe4\x93\x02g:\x01*\"b/v2beta/{attributes_config=projects/*/locations/*/catalogs/*/attributesConfig}:addCatalogAttribute\x12\xf3\x01\n" +
	"\x16RemoveCatalogAttribute\x129.google.cloud.retail.v2beta.RemoveCatalogAttributeRequest\x1a,.google.cloud.retail.v2beta.AttributesConfig\"p\x82\xd3\xe4\x93\x02j:\x01*\"e/v2beta/{attributes_config=projects/*/locations/*/catalogs/*/attributesConfig}:removeCatalogAttribute\x12\x99\x02\n" +
	"\x1cBatchRemoveCatalogAttributes\x12?.google.cloud.retail.v2beta.BatchRemoveCatalogAttributesRequest\x1a@.google.cloud.retail.v2beta.BatchRemoveCatalogAttributesResponse\"v\x82\xd3\xe4\x93\x02p:\x01*\"k/v2beta/{attributes_config=projects/*/locations/*/catalogs/*/attributesConfig}:batchRemoveCatalogAttributes\x12\xf6\x01\n" +
	"\x17ReplaceCatalogAttribute\x12:.google.cloud.retail.v2beta.ReplaceCatalogAttributeRequest\x1a,.google.cloud.retail.v2beta.AttributesConfig\"q\x82\xd3\xe4\x93\x02k:\x01*\"f/v2beta/{attributes_config=projects/*/locations/*/catalogs/*/attributesConfig}:replaceCatalogAttribute\x1aI\xcaA\x15retail.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xd2\x01\n" +
...
var (
	...
	file_google_cloud_retail_v2beta_catalog_service_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2beta_catalog_service_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2beta_catalog_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2beta_catalog_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2beta_catalog_service_proto_rawDesc), len(file_google_cloud_retail_v2beta_catalog_service_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2beta_catalog_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2beta_catalog_service_proto_rawDesc), len(file_google_cloud_retail_v2beta_catalog_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   1,
