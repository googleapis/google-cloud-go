...
const file_google_cloud_retail_v2beta_completion_service_proto_rawDesc = "" +
	"\n" +
	"3google/cloud/retail/v2beta/completion_service.proto\x12\x1agoogle.cloud.retail.v2beta\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a'google/cloud/retail/v2beta/common.proto\x1a.google/cloud/retail/v2beta/import_config.proto\x1a#google/longrunning/operations.proto\"\xf6\x02\n" +
	...
	"\x06entity\x18\n" +
	" \x01(\tR\x06entity\"\xbd\a\n" +
	"\x15CompleteQueryResponse\x12q\n" +
	"\x12completion_results\x18\x01 \x03(\v2B.google.cloud.retail.v2beta.CompleteQueryResponse.CompletionResultR\x11completionResults\x12+\n" +
	"\x11attribution_token\x18\x02 \x01(\tR\x10attributionToken\x12|\n" +
	"\x15recent_search_results\x18\x03 \x03(\v2D.google.cloud.retail.v2beta.CompleteQueryResponse.RecentSearchResultB\x02\x18\x01R\x13recentSearchResults\x12t\n" +
	"\x11attribute_results\x18\x04 \x03(\v2G.google.cloud.retail.v2beta.CompleteQueryResponse.AttributeResultsEntryR\x10attributeResults\x1a\x92\x02\n" +
	"\x10CompletionResult\x12\x1e\n" +
	"\n" +
	"suggestion\x18\x01 \x01(\tR\n" +
	"suggestion\x12r\n" +
	"\n" +
	"attributes\x18\x02 \x03(\v2R.google.cloud.retail.v2beta.CompleteQueryResponse.CompletionResult.AttributesEntryR\n" +
	"attributes\x1aj\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12A\n" +
	"\x05value\x18\x02 \x01(\v2+.google.cloud.retail.v2beta.CustomAttributeR\x05value:\x028\x01\x1a=\n" +
	"\x12RecentSearchResult\x12#\n" +
	"\rrecent_search\x18\x01 \x01(\tR\frecentSearch:\x02\x18\x01\x1a3\n" +
	"\x0fAttributeResult\x12 \n" +
	"\vsuggestions\x18\x01 \x03(\tR\vsuggestions\x1a\x86\x01\n" +
	"\x15AttributeResultsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12W\n" +
	"\x05value\x18\x02 \x01(\v2A.google.cloud.retail.v2beta.CompleteQueryResponse.AttributeResultR\x05value:\x028\x012\xce\x04\n" +
	...
	"7google.cloud.retail.v2beta.ImportCompletionDataResponse\x12)google.cloud.retail.v2beta.ImportMetadata\x82\xd3\xe4\x93\x02M:\x01*\"H/v2beta/{parent=projects/*/locations/*/catalogs/*}/completionData:import\x1aI\xcaA\x15retail.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xd5\x01\n" +
...
var (
	...
	file_google_cloud_retail_v2beta_completion_service_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2beta_completion_service_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2beta_completion_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2beta_completion_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2beta_completion_service_proto_rawDesc), len(file_google_cloud_retail_v2beta_completion_service_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2beta_completion_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2beta_completion_service_proto_rawDesc), len(file_google_cloud_retail_v2beta_completion_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
