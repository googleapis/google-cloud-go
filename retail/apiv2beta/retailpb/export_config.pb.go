...
func file_google_cloud_retail_v2beta_export_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_retail_v2beta_export_config_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_google_cloud_retail_v2beta_export_config_proto_msgTypes[13].Exporter = func(v any, i int) any {
