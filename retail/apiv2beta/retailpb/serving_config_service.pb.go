...
const file_google_cloud_retail_v2beta_serving_config_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x0eserving_config\x18\x02 \x01(\v2).google.cloud.retail.v2beta.ServingConfigB\x03\xe0A\x02R\rservingConfig\x12/\n" +
	"\x11serving_config_id\x18\x03 \x01(\tB\x03\xe0A\x02R\x0fservingConfigId\"\xb0\x01\n" +
	"\x1aUpdateServingConfigRequest\x12U\n" +
	"\x0eserving_config\x18\x01 \x01(\v2).google.cloud.retail.v2beta.ServingConfigB\x03\xe0A\x02R\rservingConfig\x12;\n" +
	...
	"\x1aListServingConfigsResponse\x12R\n" +
	"\x0fserving_configs\x18\x01 \x03(\v2).google.cloud.retail.v2beta.ServingConfigR\x0eservingConfigs\x12&\n" +
	...
	"#retail.googleapis.com/ServingConfigR\rservingConfig\x12\"\n" +
	"\n" +
	"control_id\x18\x02 \x01(\tB\x03\xe0A\x02R\tcontrolId2\x83\r\n" +
	"\x14ServingConfigService\x12\xfe\x01\n" +
	"\x13CreateServingConfig\x126.google.cloud.retail.v2beta.CreateServingConfigRequest\x1a).google.cloud.retail.v2beta.ServingConfig\"\x83\x01\xdaA'parent,serving_config,serving_config_id\x82\xd3\xe4\x93\x02S:\x0eserving_config\"A/v2beta/{parent=projects/*/locations/*/catalogs/*}/servingConfigs\x12\xb7\x01\n" +
	...
	"\x13UpdateServingConfig\x126.google.cloud.retail.v2beta.UpdateServingConfigRequest\x1a).google.cloud.retail.v2beta.ServingConfig\"\x85\x01\xdaA\x1aserving_config,update_mask\x82\xd3\xe4\x93\x02b:\x0eserving_config2P/v2beta/{serving_config.name=projects/*/locations/*/catalogs/*/servingConfigs/*}\x12\xc4\x01\n" +
	...
	"\n" +
	"AddControl\x12-.google.cloud.retail.v2beta.AddControlRequest\x1a).google.cloud.retail.v2beta.ServingConfig\"r\xdaA\x0eserving_config\x82\xd3\xe4\x93\x02[:\x01*\"V/v2beta/{serving_config=projects/*/locations/*/catalogs/*/servingConfigs/*}:addControl\x12\xe3\x01\n" +
	"\rRemoveControl\x120.google.cloud.retail.v2beta.RemoveControlRequest\x1a).google.cloud.retail.v2beta.ServingConfig\"u\xdaA\x0eserving_config\x82\xd3\xe4\x93\x02^:\x01*\"Y/v2beta/{serving_config=projects/*/locations/*/catalogs/*/servingConfigs/*}:removeControl\x1aI\xcaA\x15retail.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xd8\x01\n" +
...
var (
	...
	file_google_cloud_retail_v2beta_serving_config_service_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2beta_serving_config_service_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2beta_serving_config_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2beta_serving_config_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2beta_serving_config_service_proto_rawDesc), len(file_google_cloud_retail_v2beta_serving_config_service_proto_rawDesc)))
	})
...
var file_google_cloud_retail_v2beta_serving_config_service_proto_goTypes = []any{
...
func file_google_cloud_retail_v2beta_serving_config_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2beta_serving_config_service_proto_rawDesc), len(file_google_cloud_retail_v2beta_serving_config_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
