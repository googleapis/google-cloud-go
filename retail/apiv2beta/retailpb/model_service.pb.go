...
const file_google_cloud_retail_v2beta_model_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x05model\x18\x02 \x01(\v2!.google.cloud.retail.v2beta.ModelB\x03\xe0A\x02R\x05model\x12\x1c\n" +
	"\adry_run\x18\x03 \x01(\bB\x03\xe0A\x01R\x06dryRun\"\x94\x01\n" +
	"\x12UpdateModelRequest\x12<\n" +
	"\x05model\x18\x01 \x01(\v2!.google.cloud.retail.v2beta.ModelB\x03\xe0A\x02R\x05model\x12@\n" +
	...
	"\x04name\x18\x01 \x01(\tB#\xe0A\x02\xfaA\x1d\n" +
	"\x1bretail.googleapis.com/ModelR\x04name\"w\n" +
	"\x12ListModelsResponse\x129\n" +
	"\x06models\x18\x01 \x03(\v2!.google.cloud.retail.v2beta.ModelR\x06models\x12&\n" +
	...
	"\fModelService\x12\x8b\x02\n" +
	"\vCreateModel\x12..google.cloud.retail.v2beta.CreateModelRequest\x1a\x1d.google.longrunning.Operation\"\xac\x01\xcaAR\n" +
	" google.cloud.retail.v2beta.Model\x12.google.cloud.retail.v2beta.CreateModelMetadata\xdaA\fparent,model\x82\xd3\xe4\x93\x02B:\x05model\"9/v2beta/{parent=projects/*/locations/*/catalogs/*}/models\x12\xa4\x01\n" +
	"\bGetModel\x12+.google.cloud.retail.v2beta.GetModelRequest\x1a!.google.cloud.retail.v2beta.Model\"H\xdaA\x04name\x82\xd3\xe4\x93\x02;\x129/v2beta/{name=projects/*/locations/*/catalogs/*/models/*}\x12\xb1\x01\n" +
	"\n" +
	"PauseModel\x12-.google.cloud.retail.v2beta.PauseModelRequest\x1a!.google.cloud.retail.v2beta.Model\"Q\xdaA\x04name\x82\xd3\xe4\x93\x02D:\x01*\"?/v2beta/{name=projects/*/locations/*/catalogs/*/models/*}:pause\x12\xb4\x01\n" +
	"\vResumeModel\x12..google.cloud.retail.v2beta.ResumeModelRequest\x1a!.google.cloud.retail.v2beta.Model\"R\xdaA\x04name\x82\xd3\xe4\x93\x02E:\x01*\"@/v2beta/{name=projects/*/locations/*/catalogs/*/models/*}:resume\x12\x9f\x01\n" +
	"\vDeleteModel\x12..google.cloud.retail.v2beta.DeleteModelRequest\x1a\x16.google.protobuf.Empty\"H\xdaA\x04name\x82\xd3\xe4\x93\x02;*9/v2beta/{name=projects/*/locations/*/catalogs/*/models/*}\x12\xb7\x01\n" +
	"\n" +
	...
	"\vUpdateModel\x12..google.cloud.retail.v2beta.UpdateModelRequest\x1a!.google.cloud.retail.v2beta.Model\"b\xdaA\x11model,update_mask\x82\xd3\xe4\x93\x02H:\x05model2?/v2beta/{model.name=projects/*/locations/*/catalogs/*/models/*}\x12\x8a\x02\n" +
	"\tTuneModel\x12,.google.cloud.retail.v2beta.TuneModelRequest\x1a\x1d.google.longrunning.Operation\"\xaf\x01\xcaA\\\n" +
	",google.cloud.retail.v2beta.TuneModelResponse\x12,google.cloud.retail.v2beta.TuneModelMetadata\xdaA\x04name\x82\xd3\xe4\x93\x02C:\x01*\">/v2beta/{name=projects/*/locations/*/catalogs/*/models/*}:tune\x1aI\xcaA\x15retail.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xd0\x01\n" +
...
var (
	...
	file_google_cloud_retail_v2beta_model_service_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2beta_model_service_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2beta_model_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2beta_model_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2beta_model_service_proto_rawDesc), len(file_google_cloud_retail_v2beta_model_service_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2beta_model_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2beta_model_service_proto_rawDesc), len(file_google_cloud_retail_v2beta_model_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   1,
