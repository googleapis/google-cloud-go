...
const file_google_cloud_retail_v2beta_common_proto_rawDesc = "" +
	"\n" +
	"'google/cloud/retail/v2beta/common.proto\x12\x1agoogle.cloud.retail.v2beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa4\x03\n" +
	"\tCondition\x12P\n" +
	"\vquery_terms\x18\x01 \x03(\v2/.google.cloud.retail.v2beta.Condition.QueryTermR\n" +
	"queryTerms\x12[\n" +
	"\x11active_time_range\x18\x03 \x03(\v2/.google.cloud.retail.v2beta.Condition.TimeRangeR\x0factiveTimeRange\x12'\n" +
	...
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\"\xfb\x11\n" +
	"\x04Rule\x12Q\n" +
	"\fboost_action\x18\x02 \x01(\v2,.google.cloud.retail.v2beta.Rule.BoostActionH\x00R\vboostAction\x12Z\n" +
	"\x0fredirect_action\x18\x03 \x01(\v2/.google.cloud.retail.v2beta.Rule.RedirectActionH\x00R\x0eredirectAction\x12m\n" +
	"\x16oneway_synonyms_action\x18\x06 \x01(\v25.google.cloud.retail.v2beta.Rule.OnewaySynonymsActionH\x00R\x14onewaySynonymsAction\x12n\n" +
	"\x17do_not_associate_action\x18\a \x01(\v25.google.cloud.retail.v2beta.Rule.DoNotAssociateActionH\x00R\x14doNotAssociateAction\x12c\n" +
	"\x12replacement_action\x18\b \x01(\v22.google.cloud.retail.v2beta.Rule.ReplacementActionH\x00R\x11replacementAction\x12T\n" +
	"\rignore_action\x18\t \x01(\v2-.google.cloud.retail.v2beta.Rule.IgnoreActionH\x00R\fignoreAction\x12T\n" +
	"\rfilter_action\x18\n" +
	" \x01(\v2-.google.cloud.retail.v2beta.Rule.FilterActionH\x00R\ffilterAction\x12m\n" +
	"\x16twoway_synonyms_action\x18\v \x01(\v25.google.cloud.retail.v2beta.Rule.TwowaySynonymsActionH\x00R\x14twowaySynonymsAction\x12t\n" +
	"\x19force_return_facet_action\x18\f \x01(\v27.google.cloud.retail.v2beta.Rule.ForceReturnFacetActionH\x00R\x16forceReturnFacetAction\x12d\n" +
	"\x13remove_facet_action\x18\r \x01(\v22.google.cloud.retail.v2beta.Rule.RemoveFacetActionH\x00R\x11removeFacetAction\x12K\n" +
	"\n" +
	"pin_action\x18\x0e \x01(\v2*.google.cloud.retail.v2beta.Rule.PinActionH\x00R\tpinAction\x12H\n" +
	"\tcondition\x18\x01 \x01(\v2%.google.cloud.retail.v2beta.ConditionB\x03\xe0A\x02R\tcondition\x1aL\n" +
	...
	"\fIgnoreAction\x12!\n" +
	"\fignore_terms\x18\x01 \x03(\tR\vignoreTerms\x1a\x86\x02\n" +
	"\x16ForceReturnFacetAction\x12\x8d\x01\n" +
	"\x1afacet_position_adjustments\x18\x01 \x03(\v2O.google.cloud.retail.v2beta.Rule.ForceReturnFacetAction.FacetPositionAdjustmentR\x18facetPositionAdjustments\x1a\\\n" +
	...
	"\x0fattribute_names\x18\x01 \x03(\tR\x0eattributeNames\x1a\x9c\x01\n" +
	"\tPinAction\x12T\n" +
	"\apin_map\x18\x01 \x03(\v26.google.cloud.retail.v2beta.Rule.PinAction.PinMapEntryB\x03\xe0A\x02R\x06pinMap\x1a9\n" +
	...
	"\x11price_expire_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x0fpriceExpireTime\x12V\n" +
	"\vprice_range\x18\a \x01(\v20.google.cloud.retail.v2beta.PriceInfo.PriceRangeB\x03\xe0A\x03R\n" +
	"priceRange\x1a\x95\x01\n" +
	"\n" +
	"PriceRange\x12:\n" +
	"\x05price\x18\x01 \x01(\v2$.google.cloud.retail.v2beta.IntervalR\x05price\x12K\n" +
	"\x0eoriginal_price\x18\x02 \x01(\v2$.google.cloud.retail.v2beta.IntervalR\roriginalPrice\"}\n" +
	"\x06Rating\x12!\n" +
	...
	"\x13direct_user_request\x18\x04 \x01(\bR\x11directUserRequest\"\xfa\x02\n" +
	"\x0eLocalInventory\x12\x1e\n" +
	"\bplace_id\x18\x01 \x01(\tB\x03\xe0A\x01R\aplaceId\x12I\n" +
	"\n" +
	"price_info\x18\x02 \x01(\v2%.google.cloud.retail.v2beta.PriceInfoB\x03\xe0A\x01R\tpriceInfo\x12_\n" +
	"\n" +
	"attributes\x18\x03 \x03(\v2:.google.cloud.retail.v2beta.LocalInventory.AttributesEntryB\x03\xe0A\x01R\n" +
	"attributes\x120\n" +
	"\x11fulfillment_types\x18\x04 \x03(\tB\x03\xe0A\x01R\x10fulfillmentTypes\x1aj\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12A\n" +
	"\x05value\x18\x02 \x01(\v2+.google.cloud.retail.v2beta.CustomAttributeR\x05value:\x028\x01\"\x8f\x04\n" +
	"\x12PinControlMetadata\x12l\n" +
	"\x10all_matched_pins\x18\x01 \x03(\v2B.google.cloud.retail.v2beta.PinControlMetadata.AllMatchedPinsEntryR\x0eallMatchedPins\x12b\n" +
	"\fdropped_pins\x18\x02 \x03(\v2?.google.cloud.retail.v2beta.PinControlMetadata.DroppedPinsEntryR\vdroppedPins\x1a,\n" +
	...
	"\x05value\x18\x02 \x01(\v2:.google.cloud.retail.v2beta.PinControlMetadata.ProductPinsR\x05value:\x028\x01\x1az\n" +
	"\x10DroppedPinsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12P\n" +
	"\x05value\x18\x02 \x01(\v2:.google.cloud.retail.v2beta.PinControlMetadata.ProductPinsR\x05value:\x028\x01\"$\n" +
	"\n" +
	"StringList\x12\x16\n" +
	...
	"\x1ecom.google.cloud.retail.v2betaB\vCommonProtoP\x01Z6cloud.google.com/go/retail/apiv2beta/retailpb;retailpb\xa2\x02\x06RETAIL\xaa\x02\x1aGoogle.Cloud.Retail.V2Beta\xca\x02\x1aGoogle\\Cloud\\Retail\\V2beta\xea\x02\x1dGoogle::Cloud::Retail::V2betab\x06proto3"

var (
	file_google_cloud_retail_v2beta_common_proto_rawDescOnce sync.Once
	file_google_cloud_retail_v2beta_common_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2beta_common_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2beta_common_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2beta_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2beta_common_proto_rawDesc), len(file_google_cloud_retail_v2beta_common_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2beta_common_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2beta_common_proto_rawDesc), len(file_google_cloud_retail_v2beta_common_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   35,
			NumExtensions: 0,
			NumServices:   0,
