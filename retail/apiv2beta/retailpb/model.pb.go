...
func file_google_cloud_retail_v2beta_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_retail_v2beta_model_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_retail_v2beta_model_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_retail_v2beta_model_proto_msgTypes[3].OneofWrappers = []interface{}{
