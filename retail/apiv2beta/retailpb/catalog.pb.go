...
const file_google_cloud_retail_v2beta_catalog_proto_rawDesc = "" +
	"\n" +
	"(google/cloud/retail/v2beta/catalog.proto\x12\x1agoogle.cloud.retail.v2beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a'google/cloud/retail/v2beta/common.proto\x1a.google/cloud/retail/v2beta/import_config.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x92\x01\n" +
	"\x12ProductLevelConfig\x124\n" +
	"\x16ingestion_product_type\x18\x01 \x01(\tR\x14ingestionProductType\x12F\n" +
	" merchant_center_product_id_field\x18\x02 \x01(\tR\x1cmerchantCenterProductIdField\"\xdf\x13\n" +
	"\x10CatalogAttribute\x12\x15\n" +
	"\x03key\x18\x01 \x01(\tB\x03\xe0A\x02R\x03key\x12\x1a\n" +
	"\x06in_use\x18\t \x01(\bB\x03\xe0A\x03R\x05inUse\x12S\n" +
	"\x04type\x18\n" +
	" \x01(\x0e2:.google.cloud.retail.v2beta.CatalogAttribute.AttributeTypeB\x03\xe0A\x03R\x04type\x12g\n" +
	"\x10indexable_option\x18\x05 \x01(\x0e2<.google.cloud.retail.v2beta.CatalogAttribute.IndexableOptionR\x0findexableOption\x12}\n" +
	"\x18dynamic_facetable_option\x18\x06 \x01(\x0e2C.google.cloud.retail.v2beta.CatalogAttribute.DynamicFacetableOptionR\x16dynamicFacetableOption\x12j\n" +
	"\x11searchable_option\x18\a \x01(\x0e2=.google.cloud.retail.v2beta.CatalogAttribute.SearchableOptionR\x10searchableOption\x12\x84\x01\n" +
	" recommendations_filtering_option\x18\b \x01(\x0e2:.google.cloud.retail.v2beta.RecommendationsFilteringOptionR\x1erecommendationsFilteringOption\x12z\n" +
	"\x17exact_searchable_option\x18\v \x01(\x0e2B.google.cloud.retail.v2beta.CatalogAttribute.ExactSearchableOptionR\x15exactSearchableOption\x12m\n" +
	"\x12retrievable_option\x18\f \x01(\x0e2>.google.cloud.retail.v2beta.CatalogAttribute.RetrievableOptionR\x11retrievableOption\x12[\n" +
	"\ffacet_config\x18\r \x01(\v28.google.cloud.retail.v2beta.CatalogAttribute.FacetConfigR\vfacetConfig\x1a\xaa\a\n" +
	"\vFacetConfig\x12M\n" +
	"\x0ffacet_intervals\x18\x01 \x03(\v2$.google.cloud.retail.v2beta.IntervalR\x0efacetIntervals\x12}\n" +
	"\x14ignored_facet_values\x18\x02 \x03(\v2K.google.cloud.retail.v2beta.CatalogAttribute.FacetConfig.IgnoredFacetValuesR\x12ignoredFacetValues\x12y\n" +
	"\x13merged_facet_values\x18\x03 \x03(\v2I.google.cloud.retail.v2beta.CatalogAttribute.FacetConfig.MergedFacetValueR\x11mergedFacetValues\x12g\n" +
	"\fmerged_facet\x18\x04 \x01(\v2D.google.cloud.retail.v2beta.CatalogAttribute.FacetConfig.MergedFacetR\vmergedFacet\x12j\n" +
	"\rrerank_config\x18\x05 \x01(\v2E.google.cloud.retail.v2beta.CatalogAttribute.FacetConfig.RerankConfigR\frerankConfig\x1a\x9e\x01\n" +
	...
	"\x14RETRIEVABLE_DISABLED\x10\x02\"\xfd\x03\n" +
	"\x10AttributesConfig\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xe0A\x02\xe0A\x05R\x04name\x12r\n" +
	"\x12catalog_attributes\x18\x02 \x03(\v2C.google.cloud.retail.v2beta.AttributesConfig.CatalogAttributesEntryR\x11catalogAttributes\x12k\n" +
	"\x16attribute_config_level\x18\x03 \x01(\x0e20.google.cloud.retail.v2beta.AttributeConfigLevelB\x03\xe0A\x03R\x14attributeConfigLevel\x1ar\n" +
	"\x16CatalogAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12B\n" +
	"\x05value\x18\x02 \x01(\v2,.google.cloud.retail.v2beta.CatalogAttributeR\x05value:\x028\x01:x\xeaAu\n" +
	"&retail.googleapis.com/AttributesConfig\x12Kprojects/{project}/locations/{location}/catalogs/{catalog}/attributesConfig\"\x87\a\n" +
	...
	"\rauto_learning\x18\v \x01(\bR\fautoLearning\x12t\n" +
	"\x18suggestions_input_config\x18\x05 \x01(\v25.google.cloud.retail.v2beta.CompletionDataInputConfigB\x03\xe0A\x03R\x16suggestionsInputConfig\x12N\n" +
	"!last_suggestions_import_operation\x18\x06 \x01(\tB\x03\xe0A\x03R\x1elastSuggestionsImportOperation\x12n\n" +
	"\x15denylist_input_config\x18\a \x01(\v25.google.cloud.retail.v2beta.CompletionDataInputConfigB\x03\xe0A\x03R\x13denylistInputConfig\x12H\n" +
	"\x1elast_denylist_import_operation\x18\b \x01(\tB\x03\xe0A\x03R\x1blastDenylistImportOperation\x12p\n" +
	"\x16allowlist_input_config\x18\t \x01(\v25.google.cloud.retail.v2beta.CompletionDataInputConfigB\x03\xe0A\x03R\x14allowlistInputConfig\x12J\n" +
	"\x1flast_allowlist_import_operation\x18\n" +
	" \x01(\tB\x03\xe0A\x03R\x1clastAllowlistImportOperation:x\xeaAu\n" +
	"&retail.googleapis.com/CompletionConfig\x12Kprojects/{project}/locations/{location}/catalogs/{catalog}/completionConfig\"\xa9\x02\n" +
	...
	"regionCode\x12#\n" +
	"\rlanguage_code\x18\x05 \x01(\tR\flanguageCode\x12J\n" +
	"\x05feeds\x18\x06 \x03(\v24.google.cloud.retail.v2beta.MerchantCenterFeedFilterR\x05feeds\"n\n" +
	"\x18MerchantCenterFeedFilter\x12&\n" +
	"\x0fprimary_feed_id\x18\x01 \x01(\x03R\rprimaryFeedId\x12*\n" +
	"\x11primary_feed_name\x18\x02 \x01(\tR\x0fprimaryFeedName\"c\n" +
	"\x1bMerchantCenterLinkingConfig\x12D\n" +
	"\x05links\x18\x01 \x03(\v2..google.cloud.retail.v2beta.MerchantCenterLinkR\x05links\"\x95\x03\n" +
	"\aCatalog\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xe0A\x02\xe0A\x05R\x04name\x12)\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x06\xe0A\x02\xe0A\x05R\vdisplayName\x12e\n" +
	"\x14product_level_config\x18\x04 \x01(\v2..google.cloud.retail.v2beta.ProductLevelConfigB\x03\xe0A\x02R\x12productLevelConfig\x12|\n" +
	"\x1emerchant_center_linking_config\x18\x06 \x01(\v27.google.cloud.retail.v2beta.MerchantCenterLinkingConfigR\x1bmerchantCenterLinkingConfig:^\xeaA[\n" +
	"\x1dretail.googleapis.com/Catalog\x12:projects/{project}/locations/{location}/catalogs/{catalog}B\xcb\x01\n" +
	"\x1ecom.google.cloud.retail.v2betaB\fCatalogProtoP\x01Z6cloud.google.com/go/retail/apiv2beta/retailpb;retailpb\xa2\x02\x06RETAIL\xaa\x02\x1aGoogle.Cloud.Retail.V2Beta\xca\x02\x1aGoogle\\Cloud\\Retail\\V2beta\xea\x02\x1dGoogle::Cloud::Retail::V2betab\x06proto3"

var (
	file_google_cloud_retail_v2beta_catalog_proto_rawDescOnce sync.Once
	file_google_cloud_retail_v2beta_catalog_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2beta_catalog_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2beta_catalog_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2beta_catalog_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2beta_catalog_proto_rawDesc), len(file_google_cloud_retail_v2beta_catalog_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2beta_catalog_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2beta_catalog_proto_rawDesc), len(file_google_cloud_retail_v2beta_catalog_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
