...
const file_google_cloud_retail_v2beta_serving_config_proto_rawDesc = "" +
	"\n" +
	"/google/cloud/retail/v2beta/serving_config.proto\x12\x1agoogle.cloud.retail.v2beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a'google/cloud/retail/v2beta/common.proto\x1a/google/cloud/retail/v2beta/search_service.proto\"\x9a\v\n" +
	...
	"\x11facet_control_ids\x18\x05 \x03(\tR\x0ffacetControlIds\x12h\n" +
	"\x12dynamic_facet_spec\x18\x06 \x01(\v2:.google.cloud.retail.v2beta.SearchRequest.DynamicFacetSpecR\x10dynamicFacetSpec\x12*\n" +
	...
	"\x0fdiversity_level\x18\b \x01(\tR\x0ediversityLevel\x12^\n" +
	"\x0ediversity_type\x18\x14 \x01(\x0e27.google.cloud.retail.v2beta.ServingConfig.DiversityTypeR\rdiversityType\x12?\n" +
	"\x1cenable_category_filter_level\x18\x10 \x01(\tR\x19enableCategoryFilterLevel\x120\n" +
	"\x14ignore_recs_denylist\x18\x18 \x01(\bR\x12ignoreRecsDenylist\x12p\n" +
	"\x14personalization_spec\x18\x15 \x01(\v2=.google.cloud.retail.v2beta.SearchRequest.PersonalizationSpecR\x13personalizationSpec\x12W\n" +
	"\x0esolution_types\x18\x13 \x03(\x0e2(.google.cloud.retail.v2beta.SolutionTypeB\x06\xe0A\x02\xe0A\x05R\rsolutionTypes\"d\n" +
...
var (
	...
	file_google_cloud_retail_v2beta_serving_config_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2beta_serving_config_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2beta_serving_config_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2beta_serving_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2beta_serving_config_proto_rawDesc), len(file_google_cloud_retail_v2beta_serving_config_proto_rawDesc)))
	})
...
var file_google_cloud_retail_v2beta_serving_config_proto_goTypes = []any{
...
func file_google_cloud_retail_v2beta_serving_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2beta_serving_config_proto_rawDesc), len(file_google_cloud_retail_v2beta_serving_config_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
