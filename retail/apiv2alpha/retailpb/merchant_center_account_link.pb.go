...
var file_google_cloud_retail_v2alpha_merchant_center_account_link_proto_goTypes = []interface{}{
...
func file_google_cloud_retail_v2alpha_merchant_center_account_link_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_retail_v2alpha_merchant_center_account_link_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_retail_v2alpha_merchant_center_account_link_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_retail_v2alpha_merchant_center_account_link_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
