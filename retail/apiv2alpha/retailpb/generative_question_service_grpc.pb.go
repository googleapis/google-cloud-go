...
const (
	GenerativeQuestionService_UpdateGenerativeQuestionsFeatureConfig_FullMethodName = "/google.cloud.retail.v2alpha.GenerativeQuestionService/UpdateGenerativeQuestionsFeatureConfig"
	GenerativeQuestionService_GetGenerativeQuestionsFeatureConfig_FullMethodName    = "/google.cloud.retail.v2alpha.GenerativeQuestionService/GetGenerativeQuestionsFeatureConfig"
	GenerativeQuestionService_ListGenerativeQuestionConfigs_FullMethodName          = "/google.cloud.retail.v2alpha.GenerativeQuestionService/ListGenerativeQuestionConfigs"
	GenerativeQuestionService_UpdateGenerativeQuestionConfig_FullMethodName         = "/google.cloud.retail.v2alpha.GenerativeQuestionService/UpdateGenerativeQuestionConfig"
	GenerativeQuestionService_BatchUpdateGenerativeQuestionConfigs_FullMethodName   = "/google.cloud.retail.v2alpha.GenerativeQuestionService/BatchUpdateGenerativeQuestionConfigs"
)
