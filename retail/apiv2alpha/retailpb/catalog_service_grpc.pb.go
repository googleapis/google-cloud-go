...
const (
	CatalogService_ListCatalogs_FullMethodName                 = "/google.cloud.retail.v2alpha.CatalogService/ListCatalogs"
	CatalogService_UpdateCatalog_FullMethodName                = "/google.cloud.retail.v2alpha.CatalogService/UpdateCatalog"
	CatalogService_SetDefaultBranch_FullMethodName             = "/google.cloud.retail.v2alpha.CatalogService/SetDefaultBranch"
	CatalogService_GetDefaultBranch_FullMethodName             = "/google.cloud.retail.v2alpha.CatalogService/GetDefaultBranch"
	CatalogService_GetCompletionConfig_FullMethodName          = "/google.cloud.retail.v2alpha.CatalogService/GetCompletionConfig"
	CatalogService_UpdateCompletionConfig_FullMethodName       = "/google.cloud.retail.v2alpha.CatalogService/UpdateCompletionConfig"
	CatalogService_GetAttributesConfig_FullMethodName          = "/google.cloud.retail.v2alpha.CatalogService/GetAttributesConfig"
	CatalogService_UpdateAttributesConfig_FullMethodName       = "/google.cloud.retail.v2alpha.CatalogService/UpdateAttributesConfig"
	CatalogService_AddCatalogAttribute_FullMethodName          = "/google.cloud.retail.v2alpha.CatalogService/AddCatalogAttribute"
	CatalogService_RemoveCatalogAttribute_FullMethodName       = "/google.cloud.retail.v2alpha.CatalogService/RemoveCatalogAttribute"
	CatalogService_BatchRemoveCatalogAttributes_FullMethodName = "/google.cloud.retail.v2alpha.CatalogService/BatchRemoveCatalogAttributes"
	CatalogService_ReplaceCatalogAttribute_FullMethodName      = "/google.cloud.retail.v2alpha.CatalogService/ReplaceCatalogAttribute"
)
