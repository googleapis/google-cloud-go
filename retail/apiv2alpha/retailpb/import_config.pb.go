...
const file_google_cloud_retail_v2alpha_import_config_proto_rawDesc = "" +
	"\n" +
	...
	"dataSchemaB\v\n" +
	"\tpartition\"\\\n" +
	"\x13ProductInlineSource\x12E\n" +
	"\bproducts\x18\x01 \x03(\v2$.google.cloud.retail.v2alpha.ProductB\x03\xe0A\x02R\bproducts\"e\n" +
	"\x15UserEventInlineSource\x12L\n" +
	"\vuser_events\x18\x01 \x03(\v2&.google.cloud.retail.v2alpha.UserEventB\x03\xe0A\x02R\n" +
	"userEvents\"D\n" +
	...
	"\n" +
	"request_id\x18\x06 \x01(\tB\x02\x18\x01R\trequestId\x12W\n" +
	"\finput_config\x18\x02 \x01(\v2/.google.cloud.retail.v2alpha.ProductInputConfigB\x03\xe0A\x02R\vinputConfig\x12T\n" +
	"\rerrors_config\x18\x03 \x01(\v2/.google.cloud.retail.v2alpha.ImportErrorsConfigR\ferrorsConfig\x12;\n" +
	"\vupdate_mask\x18\x04 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\x12v\n" +
	"\x13reconciliation_mode\x18\x05 \x01(\x0e2E.google.cloud.retail.v2alpha.ImportProductsRequest.ReconciliationModeR\x12reconciliationMode\x12:\n" +
	"\x19notification_pubsub_topic\x18\a \x01(\tR\x17notificationPubsubTopic\x12C\n" +
	"\x1eskip_default_branch_protection\x18\b \x01(\bR\x1bskipDefaultBranchProtection\"T\n" +
	...
	"\finput_config\x18\x02 \x01(\v21.google.cloud.retail.v2alpha.UserEventInputConfigB\x03\xe0A\x02R\vinputConfig\x12T\n" +
	"\rerrors_config\x18\x03 \x01(\v2/.google.cloud.retail.v2alpha.ImportErrorsConfigR\ferrorsConfig\"\xf8\x01\n" +
	"\x1bImportCompletionDataRequest\x12=\n" +
	"\x06parent\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dretail.googleapis.com/CatalogR\x06parent\x12^\n" +
	"\finput_config\x18\x02 \x01(\v26.google.cloud.retail.v2alpha.CompletionDataInputConfigB\x03\xe0A\x02R\vinputConfig\x12:\n" +
	"\x19notification_pubsub_topic\x18\x03 \x01(\tR\x17notificationPubsubTopic\"\xa8\x02\n" +
	"\x12ProductInputConfig\x12f\n" +
	"\x15product_inline_source\x18\x01 \x01(\v20.google.cloud.retail.v2alpha.ProductInlineSourceH\x00R\x13productInlineSource\x12G\n" +
	"\n" +
	"gcs_source\x18\x02 \x01(\v2&.google.cloud.retail.v2alpha.GcsSourceH\x00R\tgcsSource\x12W\n" +
	"\x10big_query_source\x18\x03 \x01(\v2+.google.cloud.retail.v2alpha.BigQuerySourceH\x00R\x0ebigQuerySourceB\b\n" +
	"\x06source\"\xc0\x02\n" +
	"\x14UserEventInputConfig\x12r\n" +
	"\x18user_event_inline_source\x18\x01 \x01(\v22.google.cloud.retail.v2alpha.UserEventInlineSourceB\x03\xe0A\x02H\x00R\x15userEventInlineSource\x12L\n" +
	"\n" +
	"gcs_source\x18\x02 \x01(\v2&.google.cloud.retail.v2alpha.GcsSourceB\x03\xe0A\x02H\x00R\tgcsSource\x12\\\n" +
	"\x10big_query_source\x18\x03 \x01(\v2+.google.cloud.retail.v2alpha.BigQuerySourceB\x03\xe0A\x02H\x00R\x0ebigQuerySourceB\b\n" +
	"\x06source\"\x83\x01\n" +
	"\x19CompletionDataInputConfig\x12\\\n" +
	"\x10big_query_source\x18\x01 \x01(\v2+.google.cloud.retail.v2alpha.BigQuerySourceB\x03\xe0A\x02H\x00R\x0ebigQuerySourceB\b\n" +
	"\x06source\"\xb9\x03\n" +
	...
	"\x19notification_pubsub_topic\x18\x06 \x01(\tR\x17notificationPubsubTopic\x12\x83\x01\n" +
	" transformed_user_events_metadata\x18\a \x01(\v2:.google.cloud.retail.v2alpha.TransformedUserEventsMetadataR\x1dtransformedUserEventsMetadata\"\x89\x01\n" +
	"\x1dTransformedUserEventsMetadata\x12.\n" +
	"\x13source_events_count\x18\x01 \x01(\x03R\x11sourceEventsCount\x128\n" +
	"\x18transformed_events_count\x18\x02 \x01(\x03R\x16transformedEventsCount\"\xa7\x01\n" +
	"\x16ImportProductsResponse\x127\n" +
	"\rerror_samples\x18\x01 \x03(\v2\x12.google.rpc.StatusR\ferrorSamples\x12T\n" +
	"\rerrors_config\x18\x02 \x01(\v2/.google.cloud.retail.v2alpha.ImportErrorsConfigR\ferrorsConfig\"\x85\x02\n" +
	"\x18ImportUserEventsResponse\x127\n" +
	"\rerror_samples\x18\x01 \x03(\v2\x12.google.rpc.StatusR\ferrorSamples\x12T\n" +
	"\rerrors_config\x18\x02 \x01(\v2/.google.cloud.retail.v2alpha.ImportErrorsConfigR\ferrorsConfig\x12Z\n" +
	"\x0eimport_summary\x18\x03 \x01(\v23.google.cloud.retail.v2alpha.UserEventImportSummaryR\rimportSummary\"|\n" +
	...
	"\rerror_samples\x18\x01 \x03(\v2\x12.google.rpc.StatusR\ferrorSamplesB\xd5\x01\n" +
...
var (
	...
	file_google_cloud_retail_v2alpha_import_config_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2alpha_import_config_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2alpha_import_config_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2alpha_import_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_import_config_proto_rawDesc), len(file_google_cloud_retail_v2alpha_import_config_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2alpha_import_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_import_config_proto_rawDesc), len(file_google_cloud_retail_v2alpha_import_config_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   0,
