...
const file_google_cloud_retail_v2alpha_product_proto_rawDesc = "" +
	"\n" +
	")google/cloud/retail/v2alpha/product.proto\x12\x1bgoogle.cloud.retail.v2alpha\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a(google/cloud/retail/v2alpha/common.proto\x1a+google/cloud/retail/v2alpha/promotion.proto\x1a\x1egoogle/protobuf/duration.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xa4\x11\n" +
	"\aProduct\x12=\n" +
	...
	"\x02id\x18\x02 \x01(\tB\x03\xe0A\x05R\x02id\x12B\n" +
	"\x04type\x18\x03 \x01(\x0e2).google.cloud.retail.v2alpha.Product.TypeB\x03\xe0A\x05R\x04type\x12,\n" +
	...
	"\rlanguage_code\x18\v \x01(\tR\flanguageCode\x12T\n" +
	"\n" +
	"attributes\x18\f \x03(\v24.google.cloud.retail.v2alpha.Product.AttributesEntryR\n" +
	"attributes\x12\x12\n" +
	"\x04tags\x18\r \x03(\tR\x04tags\x12E\n" +
	"\n" +
	"price_info\x18\x0e \x01(\v2&.google.cloud.retail.v2alpha.PriceInfoR\tpriceInfo\x12;\n" +
	"\x06rating\x18\x0f \x01(\v2#.google.cloud.retail.v2alpha.RatingR\x06rating\x12A\n" +
	"\x0eavailable_time\x18\x12 \x01(\v2\x1a.google.protobuf.TimestampR\ravailableTime\x12U\n" +
	"\favailability\x18\x13 \x01(\x0e21.google.cloud.retail.v2alpha.Product.AvailabilityR\favailability\x12J\n" +
	"\x12available_quantity\x18\x14 \x01(\v2\x1b.google.protobuf.Int32ValueR\x11availableQuantity\x12W\n" +
	"\x10fulfillment_info\x18\x15 \x03(\v2,.google.cloud.retail.v2alpha.FulfillmentInfoR\x0ffulfillmentInfo\x12\x10\n" +
	"\x03uri\x18\x16 \x01(\tR\x03uri\x12:\n" +
	"\x06images\x18\x17 \x03(\v2\".google.cloud.retail.v2alpha.ImageR\x06images\x12A\n" +
	"\baudience\x18\x18 \x01(\v2%.google.cloud.retail.v2alpha.AudienceR\baudience\x12E\n" +
	"\n" +
	"color_info\x18\x19 \x01(\v2&.google.cloud.retail.v2alpha.ColorInfoR\tcolorInfo\x12\x14\n" +
	...
	"conditions\x12F\n" +
	"\n" +
	"promotions\x18\" \x03(\v2&.google.cloud.retail.v2alpha.PromotionR\n" +
	"promotions\x12=\n" +
	"\fpublish_time\x18! \x01(\v2\x1a.google.protobuf.TimestampR\vpublishTime\x12M\n" +
	"\x12retrievable_fields\x18\x1e \x01(\v2\x1a.google.protobuf.FieldMaskB\x02\x18\x01R\x11retrievableFields\x12E\n" +
	"\bvariants\x18\x1f \x03(\v2$.google.cloud.retail.v2alpha.ProductB\x03\xe0A\x03R\bvariants\x12]\n" +
	"\x11local_inventories\x18# \x03(\v2+.google.cloud.retail.v2alpha.LocalInventoryB\x03\xe0A\x03R\x10localInventories\x1ak\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12B\n" +
	"\x05value\x18\x02 \x01(\v2,.google.cloud.retail.v2alpha.CustomAttributeR\x05value:\x028\x01\"F\n" +
	"\x04Type\x12\x14\n" +
	...
	"\n" +
	"expirationB\xd0\x01\n" +
	"\x1fcom.google.cloud.retail.v2alphaB\fProductProtoP\x01Z7cloud.google.com/go/retail/apiv2alpha/retailpb;retailpb\xa2\x02\x06RETAIL\xaa\x02\x1bGoogle.Cloud.Retail.V2Alpha\xca\x02\x1bGoogle\\Cloud\\Retail\\V2alpha\xea\x02\x1eGoogle::Cloud::Retail::V2alphab\x06proto3"

var (
	file_google_cloud_retail_v2alpha_product_proto_rawDescOnce sync.Once
	file_google_cloud_retail_v2alpha_product_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2alpha_product_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2alpha_product_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2alpha_product_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_product_proto_rawDesc), len(file_google_cloud_retail_v2alpha_product_proto_rawDesc)))
	})
...
var file_google_cloud_retail_v2alpha_product_proto_goTypes = []any{
...
func file_google_cloud_retail_v2alpha_product_proto_init() {
	...
	file_google_cloud_retail_v2alpha_product_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_product_proto_rawDesc), len(file_google_cloud_retail_v2alpha_product_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
