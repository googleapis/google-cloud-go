...
func (HarmCategory) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_retail_v2alpha_safety_proto_enumTypes[0].Descriptor()
}

func (HarmCategory) Type() protoreflect.EnumType {
	return &file_google_cloud_retail_v2alpha_safety_proto_enumTypes[0]
}
...
func (HarmCategory) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_retail_v2alpha_safety_proto_rawDescGZIP(), []int{0}
}
...
func (SafetySetting_HarmBlockThreshold) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_retail_v2alpha_safety_proto_enumTypes[1].Descriptor()
}

func (SafetySetting_HarmBlockThreshold) Type() protoreflect.EnumType {
	return &file_google_cloud_retail_v2alpha_safety_proto_enumTypes[1]
}
...
func (SafetySetting_HarmBlockThreshold) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_retail_v2alpha_safety_proto_rawDescGZIP(), []int{0, 0}
}
...
func (SafetySetting_HarmBlockMethod) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_retail_v2alpha_safety_proto_enumTypes[2].Descriptor()
}

func (SafetySetting_HarmBlockMethod) Type() protoreflect.EnumType {
	return &file_google_cloud_retail_v2alpha_safety_proto_enumTypes[2]
}
...
func (SafetySetting_HarmBlockMethod) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_retail_v2alpha_safety_proto_rawDescGZIP(), []int{0, 1}
}
...
type SafetySetting struct {
	...
	// Harm category.
	Category HarmCategory `protobuf:"varint,1,opt,name=category,proto3,enum=google.cloud.retail.v2alpha.HarmCategory" json:"category,omitempty"`
	// The harm block threshold.
	Threshold SafetySetting_HarmBlockThreshold `protobuf:"varint,2,opt,name=threshold,proto3,enum=google.cloud.retail.v2alpha.SafetySetting_HarmBlockThreshold" json:"threshold,omitempty"`
	// Optional. Specify if the threshold is used for probability or severity
	// score. If not specified, the threshold is used for probability score.
	Method SafetySetting_HarmBlockMethod `protobuf:"varint,3,opt,name=method,proto3,enum=google.cloud.retail.v2alpha.SafetySetting_HarmBlockMethod" json:"method,omitempty"`
}

func (x *SafetySetting) Reset() {
	*x = SafetySetting{}
	mi := &file_google_cloud_retail_v2alpha_safety_proto_msgTypes[0]
...
var File_google_cloud_retail_v2alpha_safety_proto protoreflect.FileDescriptor

var file_google_cloud_retail_v2alpha_safety_proto_rawDesc = []byte{
	0x0a, 0x28, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x72,
	0x65, 0x74, 0x61, 0x69, 0x6c, 0x2f, 0x76, 0x32, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2f, 0x73, 0x61,
	0x66, 0x65, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1b, 0x67, 0x6f, 0x6f, 0x67,
	...
	0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x81, 0x04, 0x0a, 0x0d, 0x53, 0x61, 0x66,
	0x65, 0x74, 0x79, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x45, 0x0a, 0x08, 0x63, 0x61,
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x29, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x72, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x2e, 0x76, 0x32, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x48, 0x61, 0x72, 0x6d, 0x43,
	0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x08, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72,
	0x79, 0x12, 0x5b, 0x0a, 0x09, 0x74, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x18, 0x02,
	...
	0x68, 0x61, 0x2e, 0x53, 0x61, 0x66, 0x65, 0x74, 0x79, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67,
	0x2e, 0x48, 0x61, 0x72, 0x6d, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x54, 0x68, 0x72, 0x65, 0x73, 0x68,
	0x6f, 0x6c, 0x64, 0x52, 0x09, 0x74, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x12, 0x57,
	0x0a, 0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x3a,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x72, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x2e, 0x76, 0x32, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x53, 0x61, 0x66,
	...
	0x52, 0x4f, 0x42, 0x41, 0x42, 0x49, 0x4c, 0x49, 0x54, 0x59, 0x10, 0x02, 0x2a, 0xd7, 0x01, 0x0a,
	...
	0x52, 0x49, 0x54, 0x59, 0x10, 0x05, 0x42, 0xcf, 0x01, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x72, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x2e, 0x76, 0x32, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x42, 0x0b, 0x53, 0x61, 0x66, 0x65,
	0x74, 0x79, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x37, 0x63, 0x6c, 0x6f, 0x75, 0x64,
...
var (
	file_google_cloud_retail_v2alpha_safety_proto_rawDescOnce sync.Once
	file_google_cloud_retail_v2alpha_safety_proto_rawDescData = file_google_cloud_retail_v2alpha_safety_proto_rawDesc
)

func file_google_cloud_retail_v2alpha_safety_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2alpha_safety_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2alpha_safety_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_cloud_retail_v2alpha_safety_proto_rawDescData)
	})
	return file_google_cloud_retail_v2alpha_safety_proto_rawDescData
}

var file_google_cloud_retail_v2alpha_safety_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_google_cloud_retail_v2alpha_safety_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_cloud_retail_v2alpha_safety_proto_goTypes = []any{
	(HarmCategory)(0),                     // 0: google.cloud.retail.v2alpha.HarmCategory
	(SafetySetting_HarmBlockThreshold)(0), // 1: google.cloud.retail.v2alpha.SafetySetting.HarmBlockThreshold
	(SafetySetting_HarmBlockMethod)(0),    // 2: google.cloud.retail.v2alpha.SafetySetting.HarmBlockMethod
	(*SafetySetting)(nil),                 // 3: google.cloud.retail.v2alpha.SafetySetting
}
var file_google_cloud_retail_v2alpha_safety_proto_depIdxs = []int32{
	0, // 0: google.cloud.retail.v2alpha.SafetySetting.category:type_name -> google.cloud.retail.v2alpha.HarmCategory
	1, // 1: google.cloud.retail.v2alpha.SafetySetting.threshold:type_name -> google.cloud.retail.v2alpha.SafetySetting.HarmBlockThreshold
	2, // 2: google.cloud.retail.v2alpha.SafetySetting.method:type_name -> google.cloud.retail.v2alpha.SafetySetting.HarmBlockMethod
...
func init() { file_google_cloud_retail_v2alpha_safety_proto_init() }
func file_google_cloud_retail_v2alpha_safety_proto_init() {
	if File_google_cloud_retail_v2alpha_safety_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_cloud_retail_v2alpha_safety_proto_rawDesc,
			NumEnums:      3,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_cloud_retail_v2alpha_safety_proto_goTypes,
		DependencyIndexes: file_google_cloud_retail_v2alpha_safety_proto_depIdxs,
		EnumInfos:         file_google_cloud_retail_v2alpha_safety_proto_enumTypes,
		MessageInfos:      file_google_cloud_retail_v2alpha_safety_proto_msgTypes,
	}.Build()
	File_google_cloud_retail_v2alpha_safety_proto = out.File
	file_google_cloud_retail_v2alpha_safety_proto_rawDesc = nil
	file_google_cloud_retail_v2alpha_safety_proto_goTypes = nil
	file_google_cloud_retail_v2alpha_safety_proto_depIdxs = nil
}
