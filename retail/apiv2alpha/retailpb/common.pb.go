...
func file_google_cloud_retail_v2alpha_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_retail_v2alpha_common_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_retail_v2alpha_common_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_retail_v2alpha_common_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
