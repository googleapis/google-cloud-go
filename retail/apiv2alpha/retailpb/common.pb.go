...
const file_google_cloud_retail_v2alpha_common_proto_rawDesc = "" +
	"\n" +
	"(google/cloud/retail/v2alpha/common.proto\x12\x1bgoogle.cloud.retail.v2alpha\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa6\x03\n" +
	"\tCondition\x12Q\n" +
	"\vquery_terms\x18\x01 \x03(\v20.google.cloud.retail.v2alpha.Condition.QueryTermR\n" +
	"queryTerms\x12\\\n" +
	"\x11active_time_range\x18\x03 \x03(\v20.google.cloud.retail.v2alpha.Condition.TimeRangeR\x0factiveTimeRange\x12'\n" +
	...
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\"\x89\x12\n" +
	"\x04Rule\x12R\n" +
	"\fboost_action\x18\x02 \x01(\v2-.google.cloud.retail.v2alpha.Rule.BoostActionH\x00R\vboostAction\x12[\n" +
	"\x0fredirect_action\x18\x03 \x01(\v20.google.cloud.retail.v2alpha.Rule.RedirectActionH\x00R\x0eredirectAction\x12n\n" +
	"\x16oneway_synonyms_action\x18\x06 \x01(\v26.google.cloud.retail.v2alpha.Rule.OnewaySynonymsActionH\x00R\x14onewaySynonymsAction\x12o\n" +
	"\x17do_not_associate_action\x18\a \x01(\v26.google.cloud.retail.v2alpha.Rule.DoNotAssociateActionH\x00R\x14doNotAssociateAction\x12d\n" +
	"\x12replacement_action\x18\b \x01(\v23.google.cloud.retail.v2alpha.Rule.ReplacementActionH\x00R\x11replacementAction\x12U\n" +
	"\rignore_action\x18\t \x01(\v2..google.cloud.retail.v2alpha.Rule.IgnoreActionH\x00R\fignoreAction\x12U\n" +
	"\rfilter_action\x18\n" +
	" \x01(\v2..google.cloud.retail.v2alpha.Rule.FilterActionH\x00R\ffilterAction\x12n\n" +
	"\x16twoway_synonyms_action\x18\v \x01(\v26.google.cloud.retail.v2alpha.Rule.TwowaySynonymsActionH\x00R\x14twowaySynonymsAction\x12u\n" +
	"\x19force_return_facet_action\x18\f \x01(\v28.google.cloud.retail.v2alpha.Rule.ForceReturnFacetActionH\x00R\x16forceReturnFacetAction\x12e\n" +
	"\x13remove_facet_action\x18\r \x01(\v23.google.cloud.retail.v2alpha.Rule.RemoveFacetActionH\x00R\x11removeFacetAction\x12L\n" +
	"\n" +
	"pin_action\x18\x0e \x01(\v2+.google.cloud.retail.v2alpha.Rule.PinActionH\x00R\tpinAction\x12I\n" +
	"\tcondition\x18\x01 \x01(\v2&.google.cloud.retail.v2alpha.ConditionB\x03\xe0A\x02R\tcondition\x1aL\n" +
	...
	"\fIgnoreAction\x12!\n" +
	"\fignore_terms\x18\x01 \x03(\tR\vignoreTerms\x1a\x87\x02\n" +
	"\x16ForceReturnFacetAction\x12\x8e\x01\n" +
	"\x1afacet_position_adjustments\x18\x01 \x03(\v2P.google.cloud.retail.v2alpha.Rule.ForceReturnFacetAction.FacetPositionAdjustmentR\x18facetPositionAdjustments\x1a\\\n" +
	...
	"\x0fattribute_names\x18\x01 \x03(\tR\x0eattributeNames\x1a\x9d\x01\n" +
	"\tPinAction\x12U\n" +
	"\apin_map\x18\x01 \x03(\v27.google.cloud.retail.v2alpha.Rule.PinAction.PinMapEntryB\x03\xe0A\x02R\x06pinMap\x1a9\n" +
	...
	"\x11price_expire_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x0fpriceExpireTime\x12W\n" +
	"\vprice_range\x18\a \x01(\v21.google.cloud.retail.v2alpha.PriceInfo.PriceRangeB\x03\xe0A\x03R\n" +
	"priceRange\x1a\x97\x01\n" +
	"\n" +
	"PriceRange\x12;\n" +
	"\x05price\x18\x01 \x01(\v2%.google.cloud.retail.v2alpha.IntervalR\x05price\x12L\n" +
	"\x0eoriginal_price\x18\x02 \x01(\v2%.google.cloud.retail.v2alpha.IntervalR\roriginalPrice\"}\n" +
	"\x06Rating\x12!\n" +
	...
	"\x13direct_user_request\x18\x04 \x01(\bR\x11directUserRequest\"\xcb\x04\n" +
	"\x0eLocalInventory\x12\x1e\n" +
	"\bplace_id\x18\x01 \x01(\tB\x03\xe0A\x01R\aplaceId\x12J\n" +
	"\n" +
	"price_info\x18\x02 \x01(\v2&.google.cloud.retail.v2alpha.PriceInfoB\x03\xe0A\x01R\tpriceInfo\x12a\n" +
	"\favailability\x18\x05 \x01(\x0e28.google.cloud.retail.v2alpha.LocalInventory.AvailabilityB\x03\xe0A\x01R\favailability\x12`\n" +
	"\n" +
	"attributes\x18\x03 \x03(\v2;.google.cloud.retail.v2alpha.LocalInventory.AttributesEntryB\x03\xe0A\x01R\n" +
	"attributes\x120\n" +
	"\x11fulfillment_types\x18\x04 \x03(\tB\x03\xe0A\x01R\x10fulfillmentTypes\x1ak\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12B\n" +
	"\x05value\x18\x02 \x01(\v2,.google.cloud.retail.v2alpha.CustomAttributeR\x05value:\x028\x01\"i\n" +
	...
	"\tBACKORDER\x10\x04\"\x93\x04\n" +
	"\x12PinControlMetadata\x12m\n" +
	"\x10all_matched_pins\x18\x01 \x03(\v2C.google.cloud.retail.v2alpha.PinControlMetadata.AllMatchedPinsEntryR\x0eallMatchedPins\x12c\n" +
	"\fdropped_pins\x18\x02 \x03(\v2@.google.cloud.retail.v2alpha.PinControlMetadata.DroppedPinsEntryR\vdroppedPins\x1a,\n" +
	"\vProductPins\x12\x1d\n" +
	"\n" +
	"product_id\x18\x01 \x03(\tR\tproductId\x1a~\n" +
	"\x13AllMatchedPinsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12Q\n" +
	"\x05value\x18\x02 \x01(\v2;.google.cloud.retail.v2alpha.PinControlMetadata.ProductPinsR\x05value:\x028\x01\x1a{\n" +
	"\x10DroppedPinsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12Q\n" +
	"\x05value\x18\x02 \x01(\v2;.google.cloud.retail.v2alpha.PinControlMetadata.ProductPinsR\x05value:\x028\x01\"$\n" +
	"\n" +
	"StringList\x12\x16\n" +
	...
	"\x1fcom.google.cloud.retail.v2alphaB\vCommonProtoP\x01Z7cloud.google.com/go/retail/apiv2alpha/retailpb;retailpb\xa2\x02\x06RETAIL\xaa\x02\x1bGoogle.Cloud.Retail.V2Alpha\xca\x02\x1bGoogle\\Cloud\\Retail\\V2alpha\xea\x02\x1eGoogle::Cloud::Retail::V2alphab\x06proto3"

var (
	file_google_cloud_retail_v2alpha_common_proto_rawDescOnce sync.Once
	file_google_cloud_retail_v2alpha_common_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2alpha_common_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2alpha_common_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2alpha_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_common_proto_rawDesc), len(file_google_cloud_retail_v2alpha_common_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2alpha_common_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_common_proto_rawDesc), len(file_google_cloud_retail_v2alpha_common_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   35,
			NumExtensions: 0,
			NumServices:   0,
