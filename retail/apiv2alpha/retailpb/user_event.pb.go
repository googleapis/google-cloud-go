...
const file_google_cloud_retail_v2alpha_user_event_proto_rawDesc = "" +
	"\n" +
	",google/cloud/retail/v2alpha/user_event.proto\x12\x1bgoogle.cloud.retail.v2alpha\x1a\x1fgoogle/api/field_behavior.proto\x1a(google/cloud/retail/v2alpha/common.proto\x1a)google/cloud/retail/v2alpha/product.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xbf\b\n" +
	"\tUserEvent\x12\"\n" +
	"\n" +
	...
	"\x11attribution_token\x18\x05 \x01(\tR\x10attributionToken\x12S\n" +
	"\x0fproduct_details\x18\x06 \x03(\v2*.google.cloud.retail.v2alpha.ProductDetailR\x0eproductDetails\x12Z\n" +
	"\x11completion_detail\x18\x16 \x01(\v2-.google.cloud.retail.v2alpha.CompletionDetailR\x10completionDetail\x12V\n" +
	"\n" +
	"attributes\x18\a \x03(\v26.google.cloud.retail.v2alpha.UserEvent.AttributesEntryR\n" +
	"attributes\x12\x17\n" +
	"\acart_id\x18\b \x01(\tR\x06cartId\x12c\n" +
	"\x14purchase_transaction\x18\t \x01(\v20.google.cloud.retail.v2alpha.PurchaseTransactionR\x13purchaseTransaction\x12!\n" +
	"\fsearch_query\x18\n" +
	...
	"\x0fpage_categories\x18\v \x03(\tR\x0epageCategories\x12B\n" +
	"\tuser_info\x18\f \x01(\v2%.google.cloud.retail.v2alpha.UserInfoR\buserInfo\x12\x10\n" +
	"\x03uri\x18\r \x01(\tR\x03uri\x12!\n" +
	"\freferrer_uri\x18\x0e \x01(\tR\vreferrerUri\x12 \n" +
	"\fpage_view_id\x18\x0f \x01(\tR\n" +
	"pageViewId\x12\x16\n" +
	"\x06entity\x18\x17 \x01(\tR\x06entity\x1ak\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12B\n" +
	"\x05value\x18\x02 \x01(\v2,.google.cloud.retail.v2alpha.CustomAttributeR\x05value:\x028\x01\"\x8d\x01\n" +
	"\rProductDetail\x12C\n" +
	"\aproduct\x18\x01 \x01(\v2$.google.cloud.retail.v2alpha.ProductB\x03\xe0A\x02R\aproduct\x127\n" +
	...
	"\rcurrency_code\x18\x05 \x01(\tB\x03\xe0A\x02R\fcurrencyCodeB\xd2\x01\n" +
...
var (
	...
	file_google_cloud_retail_v2alpha_user_event_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2alpha_user_event_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2alpha_user_event_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2alpha_user_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_user_event_proto_rawDesc), len(file_google_cloud_retail_v2alpha_user_event_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2alpha_user_event_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_user_event_proto_rawDesc), len(file_google_cloud_retail_v2alpha_user_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
