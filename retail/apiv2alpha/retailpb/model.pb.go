...
func file_google_cloud_retail_v2alpha_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_retail_v2alpha_model_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_retail_v2alpha_model_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_retail_v2alpha_model_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*Model_ModelFeaturesConfig_FrequentlyBoughtTogetherConfig)(nil),
	}
	file_google_cloud_retail_v2alpha_model_proto_msgTypes[5].OneofWrappers = []interface{}{
