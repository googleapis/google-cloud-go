...
const file_google_cloud_retail_v2alpha_purge_config_proto_rawDesc = "" +
	"\n" +
	...
	"\x13purged_events_count\x18\x01 \x01(\x03R\x11purgedEventsCountB\xd4\x01\n" +
...
var (
	...
	file_google_cloud_retail_v2alpha_purge_config_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2alpha_purge_config_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2alpha_purge_config_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2alpha_purge_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_purge_config_proto_rawDesc), len(file_google_cloud_retail_v2alpha_purge_config_proto_rawDesc)))
	})
...
var file_google_cloud_retail_v2alpha_purge_config_proto_goTypes = []any{
...
func file_google_cloud_retail_v2alpha_purge_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_purge_config_proto_rawDesc), len(file_google_cloud_retail_v2alpha_purge_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
