...
const (
	CompletionService_CompleteQuery_FullMethodName        = "/google.cloud.retail.v2alpha.CompletionService/CompleteQuery"
	CompletionService_ImportCompletionData_FullMethodName = "/google.cloud.retail.v2alpha.CompletionService/ImportCompletionData"
)
