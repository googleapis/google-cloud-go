...
const file_google_cloud_retail_v2alpha_export_config_proto_rawDesc = "" +
	"\n" +
	"/google/cloud/retail/v2alpha/export_config.proto\x12\x1bgoogle.cloud.retail.v2alpha\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\xc6\x03\n" +
	"\fOutputConfig\x12c\n" +
	"\x0fgcs_destination\x18\x01 \x01(\v28.google.cloud.retail.v2alpha.OutputConfig.GcsDestinationH\x00R\x0egcsDestination\x12r\n" +
	"\x14bigquery_destination\x18\x02 \x01(\v2=.google.cloud.retail.v2alpha.OutputConfig.BigQueryDestinationH\x00R\x13bigqueryDestination\x1aA\n" +
	...
	"\vdestination\"\xc2\x01\n" +
	"\x15ExportProductsRequest\x12<\n" +
	"\x06parent\x18\x01 \x01(\tB$\xe0A\x02\xfaA\x1e\n" +
	"\x1cretail.googleapis.com/BranchR\x06parent\x12S\n" +
	"\routput_config\x18\x02 \x01(\v2).google.cloud.retail.v2alpha.OutputConfigB\x03\xe0A\x02R\foutputConfig\x12\x16\n" +
	"\x06filter\x18\x03 \x01(\tR\x06filter\"\xc5\x01\n" +
	"\x17ExportUserEventsRequest\x12=\n" +
	"\x06parent\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dretail.googleapis.com/CatalogR\x06parent\x12S\n" +
	"\routput_config\x18\x02 \x01(\v2).google.cloud.retail.v2alpha.OutputConfigB\x03\xe0A\x02R\foutputConfig\x12\x16\n" +
	"\x06filter\x18\x03 \x01(\tR\x06filter\"\xab\x01\n" +
	"\x1dExportAnalyticsMetricsRequest\x12\x1d\n" +
	"\acatalog\x18\x01 \x01(\tB\x03\xe0A\x02R\acatalog\x12S\n" +
	"\routput_config\x18\x02 \x01(\v2).google.cloud.retail.v2alpha.OutputConfigB\x03\xe0A\x02R\foutputConfig\x12\x16\n" +
	...
	"\rerror_samples\x18\x01 \x03(\v2\x12.google.rpc.StatusR\ferrorSamples\x12T\n" +
	"\rerrors_config\x18\x02 \x01(\v2/.google.cloud.retail.v2alpha.ExportErrorsConfigR\ferrorsConfig\x12N\n" +
	"\routput_result\x18\x03 \x01(\v2).google.cloud.retail.v2alpha.OutputResultR\foutputResult\"\xf9\x01\n" +
	"\x18ExportUserEventsResponse\x127\n" +
	"\rerror_samples\x18\x01 \x03(\v2\x12.google.rpc.StatusR\ferrorSamples\x12T\n" +
	"\rerrors_config\x18\x02 \x01(\v2/.google.cloud.retail.v2alpha.ExportErrorsConfigR\ferrorsConfig\x12N\n" +
	"\routput_result\x18\x03 \x01(\v2).google.cloud.retail.v2alpha.OutputResultR\foutputResult\"\xff\x01\n" +
	"\x1eExportAnalyticsMetricsResponse\x127\n" +
	"\rerror_samples\x18\x01 \x03(\v2\x12.google.rpc.StatusR\ferrorSamples\x12T\n" +
	"\rerrors_config\x18\x02 \x01(\v2/.google.cloud.retail.v2alpha.ExportErrorsConfigR\ferrorsConfig\x12N\n" +
	"\routput_result\x18\x03 \x01(\v2).google.cloud.retail.v2alpha.OutputResultR\foutputResult\"\xb7\x01\n" +
	"\fOutputResult\x12Z\n" +
	"\x0fbigquery_result\x18\x01 \x03(\v21.google.cloud.retail.v2alpha.BigQueryOutputResultR\x0ebigqueryResult\x12K\n" +
	"\n" +
	"gcs_result\x18\x02 \x03(\v2,.google.cloud.retail.v2alpha.GcsOutputResultR\tgcsResult\"P\n" +
	...
	"\n" +
	"output_uri\x18\x01 \x01(\tR\toutputUriB\xd5\x01\n" +
...
var (
	...
	file_google_cloud_retail_v2alpha_export_config_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2alpha_export_config_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2alpha_export_config_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2alpha_export_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_export_config_proto_rawDesc), len(file_google_cloud_retail_v2alpha_export_config_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2alpha_export_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_export_config_proto_rawDesc), len(file_google_cloud_retail_v2alpha_export_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
