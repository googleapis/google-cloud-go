...
const file_google_cloud_retail_v2alpha_completion_service_proto_rawDesc = "" +
	"\n" +
	"4google/cloud/retail/v2alpha/completion_service.proto\x12\x1bgoogle.cloud.retail.v2alpha\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a(google/cloud/retail/v2alpha/common.proto\x1a/google/cloud/retail/v2alpha/import_config.proto\x1a0google/cloud/retail/v2alpha/search_service.proto\x1a#google/longrunning/operations.proto\"\xf6\x02\n" +
	...
	"8google.cloud.retail.v2alpha.ImportCompletionDataResponse\x12*google.cloud.retail.v2alpha.ImportMetadata\x82\xd3\xe4\x93\x02N:\x01*\"I/v2alpha/{parent=projects/*/locations/*/catalogs/*}/completionData:import\x1aI\xcaA\x15retail.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xda\x01\n" +
...
var (
	...
	file_google_cloud_retail_v2alpha_completion_service_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2alpha_completion_service_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2alpha_completion_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2alpha_completion_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_completion_service_proto_rawDesc), len(file_google_cloud_retail_v2alpha_completion_service_proto_rawDesc)))
	})
