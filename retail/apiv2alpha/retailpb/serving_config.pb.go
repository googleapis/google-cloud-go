...
var file_google_cloud_retail_v2alpha_serving_config_proto_goTypes = []any{
...
func file_google_cloud_retail_v2alpha_serving_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_retail_v2alpha_serving_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
