...
const file_google_cloud_retail_v2alpha_serving_config_proto_rawDesc = "" +
	"\n" +
	"0google/cloud/retail/v2alpha/serving_config.proto\x12\x1bgoogle.cloud.retail.v2alpha\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a(google/cloud/retail/v2alpha/common.proto\x1a0google/cloud/retail/v2alpha/search_service.proto\"\x9e\v\n" +
	...
	"\x11facet_control_ids\x18\x05 \x03(\tR\x0ffacetControlIds\x12i\n" +
	"\x12dynamic_facet_spec\x18\x06 \x01(\v2;.google.cloud.retail.v2alpha.SearchRequest.DynamicFacetSpecR\x10dynamicFacetSpec\x12*\n" +
	...
	"\x0fdiversity_level\x18\b \x01(\tR\x0ediversityLevel\x12_\n" +
	"\x0ediversity_type\x18\x14 \x01(\x0e28.google.cloud.retail.v2alpha.ServingConfig.DiversityTypeR\rdiversityType\x12?\n" +
	"\x1cenable_category_filter_level\x18\x10 \x01(\tR\x19enableCategoryFilterLevel\x120\n" +
	"\x14ignore_recs_denylist\x18\x18 \x01(\bR\x12ignoreRecsDenylist\x12q\n" +
	"\x14personalization_spec\x18\x15 \x01(\v2>.google.cloud.retail.v2alpha.SearchRequest.PersonalizationSpecR\x13personalizationSpec\x12X\n" +
	"\x0esolution_types\x18\x13 \x03(\x0e2).google.cloud.retail.v2alpha.SolutionTypeB\x06\xe0A\x02\xe0A\x05R\rsolutionTypes\"d\n" +
...
var (
	...
	file_google_cloud_retail_v2alpha_serving_config_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2alpha_serving_config_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2alpha_serving_config_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2alpha_serving_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_serving_config_proto_rawDesc), len(file_google_cloud_retail_v2alpha_serving_config_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2alpha_serving_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_serving_config_proto_rawDesc), len(file_google_cloud_retail_v2alpha_serving_config_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
