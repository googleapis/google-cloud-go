...
func file_google_cloud_retail_v2alpha_search_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_retail_v2alpha_search_service_proto_msgTypes[14].Exporter = func(v any, i int) any {
	...
	file_google_cloud_retail_v2alpha_search_service_proto_msgTypes[0].OneofWrappers = []any{}
