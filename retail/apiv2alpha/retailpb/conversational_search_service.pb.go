...
const file_google_cloud_retail_v2alpha_conversational_search_service_proto_rawDesc = "" +
	"\n" +
	"?google/cloud/retail/v2alpha/conversational_search_service.proto\x12\x1bgoogle.cloud.retail.v2alpha\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a(google/cloud/retail/v2alpha/common.proto\x1a(google/cloud/retail/v2alpha/safety.proto\x1a0google/cloud/retail/v2alpha/search_service.proto\"\xed\x0e\n" +
	...
	"\x0fconversation_id\x18\x05 \x01(\tB\x03\xe0A\x01R\x0econversationId\x12o\n" +
	"\rsearch_params\x18\x06 \x01(\v2E.google.cloud.retail.v2alpha.ConversationalSearchRequest.SearchParamsB\x03\xe0A\x01R\fsearchParams\x12\"\n" +
	"\n" +
	"visitor_id\x18\t \x01(\tB\x03\xe0A\x02R\tvisitorId\x12G\n" +
	"\tuser_info\x18\a \x01(\v2%.google.cloud.retail.v2alpha.UserInfoB\x03\xe0A\x01R\buserInfo\x12\x9d\x01\n" +
	"\x1dconversational_filtering_spec\x18\b \x01(\v2T.google.cloud.retail.v2alpha.ConversationalSearchRequest.ConversationalFilteringSpecB\x03\xe0A\x01R\x1bconversationalFilteringSpec\x12n\n" +
	"\vuser_labels\x18\f \x03(\v2H.google.cloud.retail.v2alpha.ConversationalSearchRequest.UserLabelsEntryB\x03\xe0A\x01R\n" +
	"userLabels\x12X\n" +
	"\x0fsafety_settings\x18\x0e \x03(\v2*.google.cloud.retail.v2alpha.SafetySettingB\x03\xe0A\x01R\x0esafetySettings\x1a\xd3\x01\n" +
	...
	"\asort_by\x18\x03 \x01(\tB\x03\xe0A\x01R\x06sortBy\x12X\n" +
	"\n" +
	"boost_spec\x18\x04 \x01(\v24.google.cloud.retail.v2alpha.SearchRequest.BoostSpecB\x03\xe0A\x01R\tboostSpec\x1a\xc0\x02\n" +
	"\n" +
	"UserAnswer\x12!\n" +
	"\vtext_answer\x18\x01 \x01(\tH\x00R\n" +
	"textAnswer\x12\x82\x01\n" +
	"\x0fselected_answer\x18\x02 \x01(\v2R.google.cloud.retail.v2alpha.ConversationalSearchRequest.UserAnswer.SelectedAnswerB\x03\xe0A\x01H\x00R\x0eselectedAnswer\x1a\x81\x01\n" +
	"\x0eSelectedAnswer\x12o\n" +
	"\x17product_attribute_value\x18\x01 \x01(\v22.google.cloud.retail.v2alpha.ProductAttributeValueB\x03\xe0A\x01R\x15productAttributeValueB\x06\n" +
	"\x04type\x1a\xd5\x03\n" +
	"\x1bConversationalFilteringSpec\x12M\n" +
	"\x1fenable_conversational_filtering\x18\x01 \x01(\bB\x05\xe0A\x01\x18\x01R\x1denableConversationalFiltering\x12i\n" +
	"\vuser_answer\x18\x02 \x01(\v2C.google.cloud.retail.v2alpha.ConversationalSearchRequest.UserAnswerB\x03\xe0A\x01R\n" +
	"userAnswer\x12\xa2\x01\n" +
	"\x1dconversational_filtering_mode\x18\x04 \x01(\x0e2Y.google.cloud.retail.v2alpha.ConversationalSearchRequest.ConversationalFilteringSpec.ModeB\x03\xe0A\x01R\x1bconversationalFilteringMode\"W\n" +
	"\x04Mode\x12\x14\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xfd\v\n" +
	"\x1cConversationalSearchResponse\x12(\n" +
	"\x10user_query_types\x18\n" +
	" \x03(\tR\x0euserQueryTypes\x12@\n" +
	"\x1cconversational_text_response\x18\x02 \x01(\tR\x1aconversationalTextResponse\x12w\n" +
	"\x11followup_question\x18\x03 \x01(\v2J.google.cloud.retail.v2alpha.ConversationalSearchResponse.FollowupQuestionR\x10followupQuestion\x12'\n" +
	"\x0fconversation_id\x18\x04 \x01(\tR\x0econversationId\x12n\n" +
	"\x0erefined_search\x18\x06 \x03(\v2G.google.cloud.retail.v2alpha.ConversationalSearchResponse.RefinedSearchR\rrefinedSearch\x12\x9f\x01\n" +
	"\x1fconversational_filtering_result\x18\a \x01(\v2W.google.cloud.retail.v2alpha.ConversationalSearchResponse.ConversationalFilteringResultR\x1dconversationalFilteringResult\x12Z\n" +
	"\x05state\x18\t \x01(\x0e2?.google.cloud.retail.v2alpha.ConversationalSearchResponse.StateB\x03\xe0A\x03R\x05state\x1a\xc8\x02\n" +
	"\x10FollowupQuestion\x12+\n" +
	"\x11followup_question\x18\x01 \x01(\tR\x10followupQuestion\x12\x87\x01\n" +
	"\x11suggested_answers\x18\x02 \x03(\v2Z.google.cloud.retail.v2alpha.ConversationalSearchResponse.FollowupQuestion.SuggestedAnswerR\x10suggestedAnswers\x1a}\n" +
	...
	"\x05query\x18\x01 \x01(\tR\x05query\x1a\xb0\x03\n" +
	"\x1dConversationalFilteringResult\x12w\n" +
	"\x11followup_question\x18\x01 \x01(\v2J.google.cloud.retail.v2alpha.ConversationalSearchResponse.FollowupQuestionR\x10followupQuestion\x12\x95\x01\n" +
	"\x11additional_filter\x18\x02 \x01(\v2h.google.cloud.retail.v2alpha.ConversationalSearchResponse.ConversationalFilteringResult.AdditionalFilterR\x10additionalFilter\x1a~\n" +
	"\x10AdditionalFilter\x12j\n" +
	"\x17product_attribute_value\x18\x01 \x01(\v22.google.cloud.retail.v2alpha.ProductAttributeValueR\x15productAttributeValue\"<\n" +
	"\x05State\x12\x15\n" +
	"\x11STATE_UNSPECIFIED\x10\x00\x12\r\n" +
	"\tSTREAMING\x10\x01\x12\r\n" +
	"\tSUCCEEDED\x10\x022\xc2\x03\n" +
	"\x1bConversationalSearchService\x12\xd7\x02\n" +
	"\x14ConversationalSearch\x128.google.cloud.retail.v2alpha.ConversationalSearchRequest\x1a9.google.cloud.retail.v2alpha.ConversationalSearchResponse\"\xc7\x01\x82\xd3\xe4\x93\x02\xc0\x01:\x01*Za:\x01*\"\\/v2alpha/{placement=projects/*/locations/*/catalogs/*/servingConfigs/*}:conversationalSearch\"X/v2alpha/{placement=projects/*/locations/*/catalogs/*/placements/*}:conversationalSearch0\x01\x1aI\xcaA\x15retail.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xe4\x01\n" +
...
var (
	...
	file_google_cloud_retail_v2alpha_conversational_search_service_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2alpha_conversational_search_service_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2alpha_conversational_search_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2alpha_conversational_search_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_conversational_search_service_proto_rawDesc), len(file_google_cloud_retail_v2alpha_conversational_search_service_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2alpha_conversational_search_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_conversational_search_service_proto_rawDesc), len(file_google_cloud_retail_v2alpha_conversational_search_service_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   1,
