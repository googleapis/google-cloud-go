...
const file_google_cloud_retail_v2alpha_generative_question_proto_rawDesc = "" +
	"\n" +
	"5google/cloud/retail/v2alpha/generative_question.proto\x12\x1bgoogle.cloud.retail.v2alpha\x1a\x1fgoogle/api/field_behavior.proto\"\x9f\x01\n" +
	...
	"\x17allowed_in_conversation\x18\a \x01(\bB\x03\xe0A\x01R\x15allowedInConversationB\xdb\x01\n" +
...
var (
	...
	file_google_cloud_retail_v2alpha_generative_question_proto_rawDescData []byte
)
...
func file_google_cloud_retail_v2alpha_generative_question_proto_rawDescGZIP() []byte {
	file_google_cloud_retail_v2alpha_generative_question_proto_rawDescOnce.Do(func() {
		file_google_cloud_retail_v2alpha_generative_question_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_generative_question_proto_rawDesc), len(file_google_cloud_retail_v2alpha_generative_question_proto_rawDesc)))
	})
...
func file_google_cloud_retail_v2alpha_generative_question_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_retail_v2alpha_generative_question_proto_rawDesc), len(file_google_cloud_retail_v2alpha_generative_question_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
