...
func NewMerchantCenterAccountLinkClient(ctx context.Context, opts ...option.ClientOption) (*MerchantCenterAccountLinkClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.ListMerchantCenterAccountLinks = append(client.CallOptions.ListMerchantCenterAccountLinks, gax.WithClientMetrics(metrics))
		client.CallOptions.CreateMerchantCenterAccountLink = append(client.CallOptions.CreateMerchantCenterAccountLink, gax.WithClientMetrics(metrics))
...
func NewMerchantCenterAccountLinkRESTClient(ctx context.Context, opts ...option.ClientOption) (*MerchantCenterAccountLinkClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.ListMerchantCenterAccountLinks = append(callOpts.ListMerchantCenterAccountLinks, gax.WithClientMetrics(metrics))
		callOpts.CreateMerchantCenterAccountLink = append(callOpts.CreateMerchantCenterAccountLink, gax.WithClientMetrics(metrics))
		callOpts.DeleteMerchantCenterAccountLink = append(callOpts.DeleteMerchantCenterAccountLink, gax.WithClientMetrics(metrics))
...
func (c *merchantCenterAccountLinkGRPCClient) ListMerchantCenterAccountLinks(ctx context.Context, req *retailpb.ListMerchantCenterAccountLinksRequest, opts ...gax.CallOption) (*retailpb.ListMerchantCenterAccountLinksResponse, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.merchantCenterAccountLinkClient.ListMerchantCenterAccountLinks, req, settings.GRPC, c.logger, "ListMerchantCenterAccountLinks")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *merchantCenterAccountLinkGRPCClient) CreateMerchantCenterAccountLink(ctx context.Context, req *retailpb.CreateMerchantCenterAccountLinkRequest, opts ...gax.CallOption) (*CreateMerchantCenterAccountLinkOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.merchantCenterAccountLinkClient.CreateMerchantCenterAccountLink, req, settings.GRPC, c.logger, "CreateMerchantCenterAccountLink")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *merchantCenterAccountLinkGRPCClient) DeleteMerchantCenterAccountLink(ctx context.Context, req *retailpb.DeleteMerchantCenterAccountLinkRequest, opts ...gax.CallOption) error {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		_, err = executeRPC(ctx, c.merchantCenterAccountLinkClient.DeleteMerchantCenterAccountLink, req, settings.GRPC, c.logger, "DeleteMerchantCenterAccountLink")
		return err
	}, opts...)
	return err
}
...
func (c *merchantCenterAccountLinkRESTClient) ListMerchantCenterAccountLinks(ctx context.Context, req *retailpb.ListMerchantCenterAccountLinksRequest, opts ...gax.CallOption) (*retailpb.ListMerchantCenterAccountLinksResponse, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "ListMerchantCenterAccountLinks")
		if err != nil {
			return err
		}
...
func (c *merchantCenterAccountLinkRESTClient) CreateMerchantCenterAccountLink(ctx context.Context, req *retailpb.CreateMerchantCenterAccountLinkRequest, opts ...gax.CallOption) (*CreateMerchantCenterAccountLinkOperation, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "CreateMerchantCenterAccountLink")
		if err != nil {
			return err
		}
		if err := unm.Unmarshal(buf, resp); err != nil {
...
func (c *merchantCenterAccountLinkRESTClient) DeleteMerchantCenterAccountLink(ctx context.Context, req *retailpb.DeleteMerchantCenterAccountLinkRequest, opts ...gax.CallOption) error {
	...
	return gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		_, err = executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "DeleteMerchantCenterAccountLink")
		return err
	}, opts...)
}
