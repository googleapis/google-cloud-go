...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/oracledatabase.svg)](https://pkg.go.dev/cloud.google.com/go/oracledatabase)

Go Client Library for Oracle Database@Google Cloud API.
