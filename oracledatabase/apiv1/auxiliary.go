...
func (op *ConfigureExascaleCloudExadataInfrastructureOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*oracledatabasepb.CloudExadataInfrastructure, error) {
...
func (op *ConfigureExascaleCloudExadataInfrastructureOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*oracledatabasepb.CloudExadataInfrastructure, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp oracledatabasepb.CloudExadataInfrastructure
...
func (op *ConfigureExascaleCloudExadataInfrastructureOperation) Metadata() (*oracledatabasepb.OperationMetadata, error) {
...
func (op *ConfigureExascaleCloudExadataInfrastructureOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *ConfigureExascaleCloudExadataInfrastructureOperation) Name() string {
	return op.lro.Name()
}
...
//
// See documentation of Poll for error-handling information.
func (op *CreateGoldengateConnectionAssignmentOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*oracledatabasepb.GoldengateConnectionAssignment, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *CreateGoldengateConnectionAssignmentOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*oracledatabasepb.GoldengateConnectionAssignment, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp oracledatabasepb.GoldengateConnectionAssignment
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *CreateGoldengateConnectionAssignmentOperation) Metadata() (*oracledatabasepb.OperationMetadata, error) {
	var meta oracledatabasepb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *CreateGoldengateConnectionAssignmentOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *CreateGoldengateConnectionAssignmentOperation) Name() string {
	return op.lro.Name()
}
...
//
// See documentation of Poll for error-handling information.
func (op *CreateGoldengateConnectionOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*oracledatabasepb.GoldengateConnection, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *CreateGoldengateConnectionOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*oracledatabasepb.GoldengateConnection, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp oracledatabasepb.GoldengateConnection
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *CreateGoldengateConnectionOperation) Metadata() (*oracledatabasepb.OperationMetadata, error) {
	var meta oracledatabasepb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *CreateGoldengateConnectionOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *CreateGoldengateConnectionOperation) Name() string {
	return op.lro.Name()
}
...
//
// See documentation of Poll for error-handling information.
func (op *CreateGoldengateDeploymentOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*oracledatabasepb.GoldengateDeployment, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *CreateGoldengateDeploymentOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*oracledatabasepb.GoldengateDeployment, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp oracledatabasepb.GoldengateDeployment
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *CreateGoldengateDeploymentOperation) Metadata() (*oracledatabasepb.OperationMetadata, error) {
	var meta oracledatabasepb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *CreateGoldengateDeploymentOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *CreateGoldengateDeploymentOperation) Name() string {
	return op.lro.Name()
}
...
//
// See documentation of Poll for error-handling information.
func (op *DeleteGoldengateConnectionAssignmentOperation) Wait(ctx context.Context, opts ...gax.CallOption) error {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	return op.lro.WaitWithInterval(ctx, nil, time.Minute, opts...)
}
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *DeleteGoldengateConnectionAssignmentOperation) Poll(ctx context.Context, opts ...gax.CallOption) error {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	return op.lro.Poll(ctx, nil, opts...)
}
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *DeleteGoldengateConnectionAssignmentOperation) Metadata() (*oracledatabasepb.OperationMetadata, error) {
	var meta oracledatabasepb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *DeleteGoldengateConnectionAssignmentOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *DeleteGoldengateConnectionAssignmentOperation) Name() string {
	return op.lro.Name()
}
...
//
// See documentation of Poll for error-handling information.
func (op *DeleteGoldengateConnectionOperation) Wait(ctx context.Context, opts ...gax.CallOption) error {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	return op.lro.WaitWithInterval(ctx, nil, time.Minute, opts...)
}
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *DeleteGoldengateConnectionOperation) Poll(ctx context.Context, opts ...gax.CallOption) error {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	return op.lro.Poll(ctx, nil, opts...)
}
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *DeleteGoldengateConnectionOperation) Metadata() (*oracledatabasepb.OperationMetadata, error) {
	var meta oracledatabasepb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *DeleteGoldengateConnectionOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *DeleteGoldengateConnectionOperation) Name() string {
	return op.lro.Name()
}
...
//
// See documentation of Poll for error-handling information.
func (op *DeleteGoldengateDeploymentOperation) Wait(ctx context.Context, opts ...gax.CallOption) error {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	return op.lro.WaitWithInterval(ctx, nil, time.Minute, opts...)
}
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *DeleteGoldengateDeploymentOperation) Poll(ctx context.Context, opts ...gax.CallOption) error {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	return op.lro.Poll(ctx, nil, opts...)
}
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *DeleteGoldengateDeploymentOperation) Metadata() (*oracledatabasepb.OperationMetadata, error) {
	var meta oracledatabasepb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *DeleteGoldengateDeploymentOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *DeleteGoldengateDeploymentOperation) Name() string {
	return op.lro.Name()
}
...
// RefreshAutonomousDatabaseOperation manages a long-running operation from RefreshAutonomousDatabase.
type RefreshAutonomousDatabaseOperation struct {
	lro      *longrunning.Operation
	pollPath string
}
...
//
// See documentation of Poll for error-handling information.
func (op *RefreshAutonomousDatabaseOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*oracledatabasepb.AutonomousDatabase, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp oracledatabasepb.AutonomousDatabase
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *RefreshAutonomousDatabaseOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*oracledatabasepb.AutonomousDatabase, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp oracledatabasepb.AutonomousDatabase
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *RefreshAutonomousDatabaseOperation) Metadata() (*oracledatabasepb.OperationMetadata, error) {
	var meta oracledatabasepb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *RefreshAutonomousDatabaseOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *RefreshAutonomousDatabaseOperation) Name() string {
	return op.lro.Name()
}
...
//
// See documentation of Poll for error-handling information.
func (op *StartGoldengateDeploymentOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*oracledatabasepb.GoldengateDeployment, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp oracledatabasepb.GoldengateDeployment
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *StartGoldengateDeploymentOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*oracledatabasepb.GoldengateDeployment, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp oracledatabasepb.GoldengateDeployment
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *StartGoldengateDeploymentOperation) Metadata() (*oracledatabasepb.OperationMetadata, error) {
	var meta oracledatabasepb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *StartGoldengateDeploymentOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *StartGoldengateDeploymentOperation) Name() string {
	return op.lro.Name()
}
...
//
// See documentation of Poll for error-handling information.
func (op *StopGoldengateDeploymentOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*oracledatabasepb.GoldengateDeployment, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp oracledatabasepb.GoldengateDeployment
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *StopGoldengateDeploymentOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*oracledatabasepb.GoldengateDeployment, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp oracledatabasepb.GoldengateDeployment
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *StopGoldengateDeploymentOperation) Metadata() (*oracledatabasepb.OperationMetadata, error) {
	var meta oracledatabasepb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *StopGoldengateDeploymentOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *StopGoldengateDeploymentOperation) Name() string {
	return op.lro.Name()
}
...
// PageInfo supports pagination. See the [google.golang.org/api/iterator] package for details.
func (it *GoldengateConnectionAssignmentIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *GoldengateConnectionAssignmentIterator) Next() (*oracledatabasepb.GoldengateConnectionAssignment, error) {
	var item *oracledatabasepb.GoldengateConnectionAssignment
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *GoldengateConnectionAssignmentIterator) bufLen() int {
	return len(it.items)
}

func (it *GoldengateConnectionAssignmentIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type GoldengateConnectionIterator struct {
	items    []*oracledatabasepb.GoldengateConnection
	pageInfo *iterator.PageInfo
	nextFunc func() error
...
// PageInfo supports pagination. See the [google.golang.org/api/iterator] package for details.
func (it *GoldengateConnectionIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *GoldengateConnectionIterator) Next() (*oracledatabasepb.GoldengateConnection, error) {
	var item *oracledatabasepb.GoldengateConnection
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *GoldengateConnectionIterator) bufLen() int {
	return len(it.items)
}

func (it *GoldengateConnectionIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
// PageInfo supports pagination. See the [google.golang.org/api/iterator] package for details.
func (it *GoldengateConnectionTypeIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *GoldengateConnectionTypeIterator) Next() (*oracledatabasepb.GoldengateConnectionType, error) {
	var item *oracledatabasepb.GoldengateConnectionType
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *GoldengateConnectionTypeIterator) bufLen() int {
	return len(it.items)
}

func (it *GoldengateConnectionTypeIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type GoldengateDeploymentEnvironmentIterator struct {
	items    []*oracledatabasepb.GoldengateDeploymentEnvironment
	pageInfo *iterator.PageInfo
	nextFunc func() error
...
// PageInfo supports pagination. See the [google.golang.org/api/iterator] package for details.
func (it *GoldengateDeploymentEnvironmentIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *GoldengateDeploymentEnvironmentIterator) Next() (*oracledatabasepb.GoldengateDeploymentEnvironment, error) {
	var item *oracledatabasepb.GoldengateDeploymentEnvironment
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *GoldengateDeploymentEnvironmentIterator) bufLen() int {
	return len(it.items)
}

func (it *GoldengateDeploymentEnvironmentIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
// PageInfo supports pagination. See the [google.golang.org/api/iterator] package for details.
func (it *GoldengateDeploymentIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *GoldengateDeploymentIterator) Next() (*oracledatabasepb.GoldengateDeployment, error) {
	var item *oracledatabasepb.GoldengateDeployment
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *GoldengateDeploymentIterator) bufLen() int {
	return len(it.items)
}

func (it *GoldengateDeploymentIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type GoldengateDeploymentTypeIterator struct {
	items    []*oracledatabasepb.GoldengateDeploymentType
	pageInfo *iterator.PageInfo
	nextFunc func() error
...
// PageInfo supports pagination. See the [google.golang.org/api/iterator] package for details.
func (it *GoldengateDeploymentTypeIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *GoldengateDeploymentTypeIterator) Next() (*oracledatabasepb.GoldengateDeploymentType, error) {
	var item *oracledatabasepb.GoldengateDeploymentType
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *GoldengateDeploymentTypeIterator) bufLen() int {
	return len(it.items)
}

func (it *GoldengateDeploymentTypeIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
// PageInfo supports pagination. See the [google.golang.org/api/iterator] package for details.
func (it *GoldengateDeploymentVersionIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *GoldengateDeploymentVersionIterator) Next() (*oracledatabasepb.GoldengateDeploymentVersion, error) {
	var item *oracledatabasepb.GoldengateDeploymentVersion
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *GoldengateDeploymentVersionIterator) bufLen() int {
	return len(it.items)
}

func (it *GoldengateDeploymentVersionIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
