...
func file_google_cloud_oracledatabase_v1_autonomous_db_backup_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_oracledatabase_v1_autonomous_db_backup_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*AutonomousDatabaseBackup); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_google_cloud_oracledatabase_v1_autonomous_db_backup_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*AutonomousDatabaseBackupProperties); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
