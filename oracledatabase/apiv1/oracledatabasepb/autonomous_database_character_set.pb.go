...
func file_google_cloud_oracledatabase_v1_autonomous_database_character_set_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_oracledatabase_v1_autonomous_database_character_set_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*AutonomousDatabaseCharacterSet); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
