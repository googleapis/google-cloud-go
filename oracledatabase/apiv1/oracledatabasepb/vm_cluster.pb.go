...
type CloudVmClusterProperties_StorageManagementType int32

const (
	// Unspecified storage management type.
	CloudVmClusterProperties_STORAGE_MANAGEMENT_TYPE_UNSPECIFIED CloudVmClusterProperties_StorageManagementType = 0
	// Automatic Storage Management.
	CloudVmClusterProperties_ASM CloudVmClusterProperties_StorageManagementType = 1
	// Exascale storage management.
	CloudVmClusterProperties_EXASCALE CloudVmClusterProperties_StorageManagementType = 2
)

// Enum value maps for CloudVmClusterProperties_StorageManagementType.
var (
	CloudVmClusterProperties_StorageManagementType_name = map[int32]string{
		0: "STORAGE_MANAGEMENT_TYPE_UNSPECIFIED",
		1: "ASM",
		2: "EXASCALE",
	}
	CloudVmClusterProperties_StorageManagementType_value = map[string]int32{
...
func (x CloudVmClusterProperties_StorageManagementType) Enum() *CloudVmClusterProperties_StorageManagementType {
	p := new(CloudVmClusterProperties_StorageManagementType)
	*p = x
	return p
}

func (x CloudVmClusterProperties_StorageManagementType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CloudVmClusterProperties_StorageManagementType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_oracledatabase_v1_vm_cluster_proto_enumTypes[3].Descriptor()
}

func (CloudVmClusterProperties_StorageManagementType) Type() protoreflect.EnumType {
	return &file_google_cloud_oracledatabase_v1_vm_cluster_proto_enumTypes[3]
}

func (x CloudVmClusterProperties_StorageManagementType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CloudVmClusterProperties_StorageManagementType.Descriptor instead.
func (CloudVmClusterProperties_StorageManagementType) EnumDescriptor() ([]byte, []int) {
...
type CloudVmCluster struct {
	...
	ExascaleDbStorageVault string `protobuf:"bytes,17,opt,name=exascale_db_storage_vault,json=exascaleDbStorageVault,proto3" json:"exascale_db_storage_vault,omitempty"`
...
func (x *CloudVmCluster) GetExascaleDbStorageVault() string {
	if x != nil {
...
func (x *CloudVmClusterProperties) GetStorageManagementType() CloudVmClusterProperties_StorageManagementType {
	if x != nil {
		return x.StorageManagementType
	}
...
const file_google_cloud_oracledatabase_v1_vm_cluster_proto_rawDesc = "" +
	"\n" +
	"/google/cloud/oracledatabase/v1/vm_cluster.proto\x12\x1egoogle.cloud.oracledatabase.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a+google/cloud/oracledatabase/v1/common.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1agoogle/type/datetime.proto\"\xbc\n" +
	"\n" +
	...
	"\x12identity_connector\x18\x10 \x01(\v21.google.cloud.oracledatabase.v1.IdentityConnectorB\x03\xe0A\x03R\x11identityConnector\x12w\n" +
	"\x19exascale_db_storage_vault\x18\x11 \x01(\tB<\xe0A\x01\xfaA6\n" +
	"4oracledatabase.googleapis.com/ExascaleDbStorageVaultR\x16exascaleDbStorageVault\x1a9\n" +
