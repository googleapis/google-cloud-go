...
func file_google_cloud_support_v2_attachment_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_support_v2_attachment_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_support_v2_attachment_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
