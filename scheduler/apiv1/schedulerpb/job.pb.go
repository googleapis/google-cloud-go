...
const file_google_cloud_scheduler_v1_job_proto_rawDesc = "" +
	"\n" +
	"#google/cloud/scheduler/v1/job.proto\x12\x19google.cloud.scheduler.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a&google/cloud/scheduler/v1/target.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\xa1\b\n" +
	"\x03Job\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12N\n" +
	"\rpubsub_target\x18\x04 \x01(\v2'.google.cloud.scheduler.v1.PubsubTargetH\x00R\fpubsubTarget\x12e\n" +
	"\x16app_engine_http_target\x18\x05 \x01(\v2..google.cloud.scheduler.v1.AppEngineHttpTargetH\x00R\x13appEngineHttpTarget\x12H\n" +
	"\vhttp_target\x18\x06 \x01(\v2%.google.cloud.scheduler.v1.HttpTargetH\x00R\n" +
	"httpTarget\x12\x1a\n" +
	"\bschedule\x18\x14 \x01(\tR\bschedule\x12\x1b\n" +
	"\ttime_zone\x18\x15 \x01(\tR\btimeZone\x12I\n" +
	"\x10user_update_time\x18\t \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\x0euserUpdateTime\x12?\n" +
	"\x05state\x18\n" +
	" \x01(\x0e2$.google.cloud.scheduler.v1.Job.StateB\x03\xe0A\x03R\x05state\x12/\n" +
	"\x06status\x18\v \x01(\v2\x12.google.rpc.StatusB\x03\xe0A\x03R\x06status\x12D\n" +
	"\rschedule_time\x18\x11 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\fscheduleTime\x12K\n" +
	"\x11last_attempt_time\x18\x12 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\x0flastAttemptTime\x12I\n" +
	"\fretry_config\x18\x13 \x01(\v2&.google.cloud.scheduler.v1.RetryConfigR\vretryConfig\x12D\n" +
	...
	"!cloudscheduler.googleapis.com/Job\x122projects/{project}/locations/{location}/jobs/{job}*\x04jobs2\x03jobB\b\n" +
	"\x06target\"\xb6\x02\n" +
	...
	"\rmax_doublings\x18\x05 \x01(\x05R\fmaxDoublingsBh\n" +
	"\x1dcom.google.cloud.scheduler.v1B\bJobProtoP\x01Z;cloud.google.com/go/scheduler/apiv1/schedulerpb;schedulerpbb\x06proto3"

var (
	file_google_cloud_scheduler_v1_job_proto_rawDescOnce sync.Once
	file_google_cloud_scheduler_v1_job_proto_rawDescData []byte
)
...
func file_google_cloud_scheduler_v1_job_proto_rawDescGZIP() []byte {
	file_google_cloud_scheduler_v1_job_proto_rawDescOnce.Do(func() {
		file_google_cloud_scheduler_v1_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_scheduler_v1_job_proto_rawDesc), len(file_google_cloud_scheduler_v1_job_proto_rawDesc)))
	})
...
func file_google_cloud_scheduler_v1_job_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_scheduler_v1_job_proto_rawDesc), len(file_google_cloud_scheduler_v1_job_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
