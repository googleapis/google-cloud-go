...
const file_google_cloud_scheduler_v1beta1_target_proto_rawDesc = "" +
	"\n" +
	"+google/cloud/scheduler/v1beta1/target.proto\x12\x1egoogle.cloud.scheduler.v1beta1\x1a\x19google/api/resource.proto\"\xc1\x03\n" +
	"\n" +
	"HttpTarget\x12\x10\n" +
	"\x03uri\x18\x01 \x01(\tR\x03uri\x12K\n" +
	"\vhttp_method\x18\x02 \x01(\x0e2*.google.cloud.scheduler.v1beta1.HttpMethodR\n" +
	"httpMethod\x12Q\n" +
	"\aheaders\x18\x03 \x03(\v27.google.cloud.scheduler.v1beta1.HttpTarget.HeadersEntryR\aheaders\x12\x12\n" +
	"\x04body\x18\x04 \x01(\fR\x04body\x12M\n" +
	"\voauth_token\x18\x05 \x01(\v2*.google.cloud.scheduler.v1beta1.OAuthTokenH\x00R\n" +
	"oauthToken\x12J\n" +
	"\n" +
	"oidc_token\x18\x06 \x01(\v2).google.cloud.scheduler.v1beta1.OidcTokenH\x00R\toidcToken\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x16\n" +
	"\x14authorization_header\"\x91\x03\n" +
	"\x13AppEngineHttpTarget\x12K\n" +
	"\vhttp_method\x18\x01 \x01(\x0e2*.google.cloud.scheduler.v1beta1.HttpMethodR\n" +
	"httpMethod\x12^\n" +
	"\x12app_engine_routing\x18\x02 \x01(\v20.google.cloud.scheduler.v1beta1.AppEngineRoutingR\x10appEngineRouting\x12!\n" +
	"\frelative_uri\x18\x03 \x01(\tR\vrelativeUri\x12Z\n" +
	"\aheaders\x18\x04 \x03(\v2@.google.cloud.scheduler.v1beta1.AppEngineHttpTarget.HeadersEntryR\aheaders\x12\x12\n" +
	...
	"\n" +
	"attributes\x18\x04 \x03(\v2<.google.cloud.scheduler.v1beta1.PubsubTarget.AttributesEntryR\n" +
	"attributes\x1a=\n" +
	...
	"\aOPTIONS\x10\aB\xb8\x01\xeaA@\n" +
	"\x1bpubsub.googleapis.com/Topic\x12!projects/{project}/topics/{topic}\n" +
	"\"com.google.cloud.scheduler.v1beta1B\vTargetProtoP\x01Z@cloud.google.com/go/scheduler/apiv1beta1/schedulerpb;schedulerpbb\x06proto3"

var (
	file_google_cloud_scheduler_v1beta1_target_proto_rawDescOnce sync.Once
	file_google_cloud_scheduler_v1beta1_target_proto_rawDescData []byte
)
...
func file_google_cloud_scheduler_v1beta1_target_proto_rawDescGZIP() []byte {
	file_google_cloud_scheduler_v1beta1_target_proto_rawDescOnce.Do(func() {
		file_google_cloud_scheduler_v1beta1_target_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_scheduler_v1beta1_target_proto_rawDesc), len(file_google_cloud_scheduler_v1beta1_target_proto_rawDesc)))
	})
...
var file_google_cloud_scheduler_v1beta1_target_proto_goTypes = []any{
...
func file_google_cloud_scheduler_v1beta1_target_proto_init() {
	...
	file_google_cloud_scheduler_v1beta1_target_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_scheduler_v1beta1_target_proto_rawDesc), len(file_google_cloud_scheduler_v1beta1_target_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
