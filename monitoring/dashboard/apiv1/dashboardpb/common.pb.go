...
const file_google_monitoring_dashboard_v1_common_proto_rawDesc = "" +
	"\n" +
	"+google/monitoring/dashboard/v1/common.proto\x12\x1egoogle.monitoring.dashboard.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1agoogle/type/interval.proto\"\x87\b\n" +
	"\vAggregation\x12D\n" +
	"\x10alignment_period\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\x0falignmentPeriod\x12a\n" +
	"\x12per_series_aligner\x18\x02 \x01(\x0e23.google.monitoring.dashboard.v1.Aggregation.AlignerR\x10perSeriesAligner\x12e\n" +
	"\x14cross_series_reducer\x18\x04 \x01(\x0e23.google.monitoring.dashboard.v1.Aggregation.ReducerR\x12crossSeriesReducer\x12&\n" +
	...
	"\x14REDUCE_PERCENTILE_05\x10\f\"\xe6\x03\n" +
	"\x14PickTimeSeriesFilter\x12b\n" +
	"\x0eranking_method\x18\x01 \x01(\x0e2;.google.monitoring.dashboard.v1.PickTimeSeriesFilter.MethodR\rrankingMethod\x12&\n" +
	"\x0fnum_time_series\x18\x02 \x01(\x05R\rnumTimeSeries\x12\\\n" +
	"\tdirection\x18\x03 \x01(\x0e2>.google.monitoring.dashboard.v1.PickTimeSeriesFilter.DirectionR\tdirection\x121\n" +
	"\binterval\x18\x04 \x01(\v2\x15.google.type.IntervalR\binterval\"t\n" +
	"\x06Method\x12\x16\n" +
	"\x12METHOD_UNSPECIFIED\x10\x00\x12\x0f\n" +
	"\vMETHOD_MEAN\x10\x01\x12\x0e\n" +
	"\n" +
	...
	"\x03TOP\x10\x01\x12\n" +
	"\n" +
	"\x06BOTTOM\x10\x02\"\xee\x01\n" +
	"\x1bStatisticalTimeSeriesFilter\x12i\n" +
	"\x0eranking_method\x18\x01 \x01(\x0e2B.google.monitoring.dashboard.v1.StatisticalTimeSeriesFilter.MethodR\rrankingMethod\x12&\n" +
	...
	"\"com.google.monitoring.dashboard.v1B\vCommonProtoP\x01ZFcloud.google.com/go/monitoring/dashboard/apiv1/dashboardpb;dashboardpb\xaa\x02$Google.Cloud.Monitoring.Dashboard.V1\xca\x02$Google\\Cloud\\Monitoring\\Dashboard\\V1\xea\x02(Google::Cloud::Monitoring::Dashboard::V1b\x06proto3"

var (
	file_google_monitoring_dashboard_v1_common_proto_rawDescOnce sync.Once
	file_google_monitoring_dashboard_v1_common_proto_rawDescData []byte
)
...
func file_google_monitoring_dashboard_v1_common_proto_rawDescGZIP() []byte {
	file_google_monitoring_dashboard_v1_common_proto_rawDescOnce.Do(func() {
		file_google_monitoring_dashboard_v1_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_monitoring_dashboard_v1_common_proto_rawDesc), len(file_google_monitoring_dashboard_v1_common_proto_rawDesc)))
	})
...
func file_google_monitoring_dashboard_v1_common_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_monitoring_dashboard_v1_common_proto_rawDesc), len(file_google_monitoring_dashboard_v1_common_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
