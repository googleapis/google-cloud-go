...
func ExampleUptimeCheckClient_ListUptimeCheckConfigs_all() {
	...
	for resp, err := range c.ListUptimeCheckConfigs(ctx, req).All() {
		if err != nil {
			// TODO: Handle error.
		}
		// TODO: Use resp.
...
func ExampleUptimeCheckClient_ListUptimeCheckIps_all() {
	ctx := context.Background()
	// This snippet has been automatically generated and should be regarded as a code template only.
	// It will require modifications to work:
	// - It may require correct/in-range values for request initialization.
	...
	for resp, err := range c.ListUptimeCheckIps(ctx, req).All() {
		if err != nil {
			// TODO: Handle error.
		}
		// TODO: Use resp.
