...
func file_google_monitoring_v3_alert_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_monitoring_v3_alert_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_monitoring_v3_alert_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_monitoring_v3_alert_proto_msgTypes[6].OneofWrappers = []interface{}{
