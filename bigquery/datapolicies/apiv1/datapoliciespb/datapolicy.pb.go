...
const file_google_cloud_bigquery_datapolicies_v1_datapolicy_proto_rawDesc = "" +
	"\n" +
	...
	"\x06parent\x18\x01 \x01(\tB4\xe0A\x02\xfaA.\x12,bigquerydatapolicy.googleapis.com/DataPolicyR\x06parent\x12W\n" +
	"\vdata_policy\x18\x02 \x01(\v21.google.cloud.bigquery.datapolicies.v1.DataPolicyB\x03\xe0A\x02R\n" +
	"dataPolicy\"\xaf\x01\n" +
	"\x17UpdateDataPolicyRequest\x12W\n" +
	"\vdata_policy\x18\x01 \x01(\v21.google.cloud.bigquery.datapolicies.v1.DataPolicyB\x03\xe0A\x02R\n" +
	"dataPolicy\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"d\n" +
	"\x17RenameDataPolicyRequest\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x120\n" +
	"\x12new_data_policy_id\x18\x02 \x01(\tB\x03\xe0A\x02R\x0fnewDataPolicyId\"c\n" +
	...
	"\x04name\x18\x01 \x01(\tB4\xe0A\x02\xfaA.\n" +
	",bigquerydatapolicy.googleapis.com/DataPolicyR\x04name\"\xbb\x01\n" +
	...
	"\x06filter\x18\x04 \x01(\tR\x06filter\"\x9a\x01\n" +
	"\x18ListDataPoliciesResponse\x12V\n" +
	"\rdata_policies\x18\x01 \x03(\v21.google.cloud.bigquery.datapolicies.v1.DataPolicyR\fdataPolicies\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xc6\x04\n" +
	"\n" +
	"DataPolicy\x12\x1f\n" +
	"\n" +
	"policy_tag\x18\x04 \x01(\tH\x00R\tpolicyTag\x12j\n" +
	"\x13data_masking_policy\x18\x05 \x01(\v28.google.cloud.bigquery.datapolicies.v1.DataMaskingPolicyH\x01R\x11dataMaskingPolicy\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12j\n" +
	"\x10data_policy_type\x18\x02 \x01(\x0e2@.google.cloud.bigquery.datapolicies.v1.DataPolicy.DataPolicyTypeR\x0edataPolicyType\x12$\n" +
	...
	"\x06policy\"\x9d\x03\n" +
	"\x11DataMaskingPolicy\x12\x84\x01\n" +
	"\x15predefined_expression\x18\x01 \x01(\x0e2M.google.cloud.bigquery.datapolicies.v1.DataMaskingPolicy.PredefinedExpressionH\x00R\x14predefinedExpression\x12\x1a\n" +
	"\aroutine\x18\x03 \x01(\tH\x00R\aroutine\"\xce\x01\n" +
	...
	"\x15DEFAULT_MASKING_VALUE\x10\a\x12\x18\n" +
	"\x14LAST_FOUR_CHARACTERS\x10\t\x12\x19\n" +
	"\x15FIRST_FOUR_CHARACTERS\x10\n" +
	"\x12\x0e\n" +
	"\n" +
	"EMAIL_MASK\x10\f\x12\x12\n" +
	"\x0eDATE_YEAR_MASK\x10\rB\x14\n" +
	"\x12masking_expression2\x90\x0f\n" +
	"\x11DataPolicyService\x12\xe1\x01\n" +
	"\x10CreateDataPolicy\x12>.google.cloud.bigquery.datapolicies.v1.CreateDataPolicyRequest\x1a1.google.cloud.bigquery.datapolicies.v1.DataPolicy\"Z\xdaA\x12parent,data_policy\x82\xd3\xe4\x93\x02?:\vdata_policy\"0/v1/{parent=projects/*/locations/*}/dataPolicies\x12\xf2\x01\n" +
	"\x10UpdateDataPolicy\x12>.google.cloud.bigquery.datapolicies.v1.UpdateDataPolicyRequest\x1a1.google.cloud.bigquery.datapolicies.v1.DataPolicy\"k\xdaA\x17data_policy,update_mask\x82\xd3\xe4\x93\x02K:\vdata_policy2</v1/{data_policy.name=projects/*/locations/*/dataPolicies/*}\x12\xe3\x01\n" +
	"\x10RenameDataPolicy\x12>.google.cloud.bigquery.datapolicies.v1.RenameDataPolicyRequest\x1a1.google.cloud.bigquery.datapolicies.v1.DataPolicy\"\\\xdaA\x17name,new_data_policy_id\x82\xd3\xe4\x93\x02<:\x01*\"7/v1/{name=projects/*/locations/*/dataPolicies/*}:rename\x12\xab\x01\n" +
	...
	"\fGetIamPolicy\x12\".google.iam.v1.GetIamPolicyRequest\x1a\x15.google.iam.v1.Policy\"L\x82\xd3\xe4\x93\x02F:\x01*\"A/v1/{resource=projects/*/locations/*/dataPolicies/*}:getIamPolicy\x12\x97\x01\n" +
	"\fSetIamPolicy\x12\".google.iam.v1.SetIamPolicyRequest\x1a\x15.google.iam.v1.Policy\"L\x82\xd3\xe4\x93\x02F:\x01*\"A/v1/{resource=projects/*/locations/*/dataPolicies/*}:setIamPolicy\x12\xbd\x01\n" +
	"\x12TestIamPermissions\x12(.google.iam.v1.TestIamPermissionsRequest\x1a).google.iam.v1.TestIamPermissionsResponse\"R\x82\xd3\xe4\x93\x02L:\x01*\"G/v1/{resource=projects/*/locations/*/dataPolicies/*}:testIamPermissions\x1a~\xcaA!bigquerydatapolicy.googleapis.com\xd2AWhttps://www.googleapis.com/auth/bigquery,https://www.googleapis.com/auth/cloud-platformB\x89\x02\n" +
...
var (
	...
	file_google_cloud_bigquery_datapolicies_v1_datapolicy_proto_rawDescData []byte
)
...
func file_google_cloud_bigquery_datapolicies_v1_datapolicy_proto_rawDescGZIP() []byte {
	file_google_cloud_bigquery_datapolicies_v1_datapolicy_proto_rawDescOnce.Do(func() {
		file_google_cloud_bigquery_datapolicies_v1_datapolicy_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_datapolicies_v1_datapolicy_proto_rawDesc), len(file_google_cloud_bigquery_datapolicies_v1_datapolicy_proto_rawDesc)))
	})
...
func file_google_cloud_bigquery_datapolicies_v1_datapolicy_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_datapolicies_v1_datapolicy_proto_rawDesc), len(file_google_cloud_bigquery_datapolicies_v1_datapolicy_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
