...
const file_google_cloud_bigquery_datapolicies_v2beta1_datapolicy_proto_rawDesc = "" +
	...
	"\x0edata_policy_id\x18\x02 \x01(\tB\x03\xe0A\x02R\fdataPolicyId\x12\\\n" +
	"\vdata_policy\x18\x03 \x01(\v26.google.cloud.bigquery.datapolicies.v2beta1.DataPolicyB\x03\xe0A\x02R\n" +
	"dataPolicy\"\xb9\x01\n" +
	"\x17UpdateDataPolicyRequest\x12\\\n" +
	"\vdata_policy\x18\x01 \x01(\v26.google.cloud.bigquery.datapolicies.v2beta1.DataPolicyB\x03\xe0A\x02R\n" +
	"dataPolicy\x12@\n" +
	...
	"\x04name\x18\x01 \x01(\tB4\xe0A\x02\xfaA.\n" +
	",bigquerydatapolicy.googleapis.com/DataPolicyR\x04name\"\xad\x01\n" +
	...
	"\rdata_policies\x18\x01 \x03(\v26.google.cloud.bigquery.datapolicies.v2beta1.DataPolicyR\fdataPolicies\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xe5\x06\n" +
	"\n" +
	"DataPolicy\x12t\n" +
	"\x13data_masking_policy\x18\a \x01(\v2=.google.cloud.bigquery.datapolicies.v2beta1.DataMaskingPolicyB\x03\xe0A\x01H\x00R\x11dataMaskingPolicy\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12)\n" +
	"\x0edata_policy_id\x18\x02 \x01(\tB\x03\xe0A\x03R\fdataPolicyId\x12\x17\n" +
	"\x04etag\x18\v \x01(\tH\x01R\x04etag\x88\x01\x01\x12t\n" +
	"\x10data_policy_type\x18\x03 \x01(\x0e2E.google.cloud.bigquery.datapolicies.v2beta1.DataPolicy.DataPolicyTypeB\x03\xe0A\x02R\x0edataPolicyType\x12K\n" +
	"\n" +
	"policy_tag\x18\x04 \x01(\tB,\xe0A\x03\xfaA&\n" +
	"$datacatalog.googleapis.com/PolicyTagR\tpolicyTag\x12\x1f\n" +
	"\bgrantees\x18\b \x03(\tB\x03\xe0A\x01R\bgrantees\x12]\n" +
	"\aversion\x18\t \x01(\x0e2>.google.cloud.bigquery.datapolicies.v2beta1.DataPolicy.VersionB\x03\xe0A\x03R\aversion\"g\n" +
	...
	"\x06policyB\a\n" +
	"\x05_etag\"\xb1\x02\n" +
	"\x11DataMaskingPolicy\x12\x8e\x01\n" +
	"\x15predefined_expression\x18\x01 \x01(\x0e2R.google.cloud.bigquery.datapolicies.v2beta1.DataMaskingPolicy.PredefinedExpressionB\x03\xe0A\x01H\x00R\x14predefinedExpression\"u\n" +
	...
	"\x10CreateDataPolicy\x12C.google.cloud.bigquery.datapolicies.v2beta1.CreateDataPolicyRequest\x1a6.google.cloud.bigquery.datapolicies.v2beta1.DataPolicy\"d\xdaA!parent,data_policy,data_policy_id\x82\xd3\xe4\x93\x02::\x01*\"5/v2beta1/{parent=projects/*/locations/*}/dataPolicies\x12\xf1\x01\n" +
	"\vAddGrantees\x12>.google.cloud.bigquery.datapolicies.v2beta1.AddGranteesRequest\x1a6.google.cloud.bigquery.datapolicies.v2beta1.DataPolicy\"j\xdaA\x14data_policy,grantees\x82\xd3\xe4\x93\x02M:\x01*\"H/v2beta1/{data_policy=projects/*/locations/*/dataPolicies/*}:addGrantees\x12\xfa\x01\n" +
	"\x0eRemoveGrantees\x12A.google.cloud.bigquery.datapolicies.v2beta1.RemoveGranteesRequest\x1a6.google.cloud.bigquery.datapolicies.v2beta1.DataPolicy\"m\xdaA\x14data_policy,grantees\x82\xd3\xe4\x93\x02P:\x01*\"K/v2beta1/{data_policy=projects/*/locations/*/dataPolicies/*}:removeGrantees\x12\x81\x02\n" +
	"\x10UpdateDataPolicy\x12C.google.cloud.bigquery.datapolicies.v2beta1.UpdateDataPolicyRequest\x1a6.google.cloud.bigquery.datapolicies.v2beta1.DataPolicy\"p\xdaA\x17data_policy,update_mask\x82\xd3\xe4\x93\x02P:\vdata_policy2A/v2beta1/{data_policy.name=projects/*/locations/*/dataPolicies/*}\x12\xb5\x01\n" +
	...
	"\fGetIamPolicy\x12\".google.iam.v1.GetIamPolicyRequest\x1a\x15.google.iam.v1.Policy\"Q\x82\xd3\xe4\x93\x02K:\x01*\"F/v2beta1/{resource=projects/*/locations/*/dataPolicies/*}:getIamPolicy\x12\x9c\x01\n" +
	"\fSetIamPolicy\x12\".google.iam.v1.SetIamPolicyRequest\x1a\x15.google.iam.v1.Policy\"Q\x82\xd3\xe4\x93\x02K:\x01*\"F/v2beta1/{resource=projects/*/locations/*/dataPolicies/*}:setIamPolicy\x12\xc2\x01\n" +
	"\x12TestIamPermissions\x12(.google.iam.v1.TestIamPermissionsRequest\x1a).google.iam.v1.TestIamPermissionsResponse\"W\x82\xd3\xe4\x93\x02Q:\x01*\"L/v2beta1/{resource=projects/*/locations/*/dataPolicies/*}:testIamPermissions\x1a~\xcaA!bigquerydatapolicy.googleapis.com\xd2AWhttps://www.googleapis.com/auth/bigquery,https://www.googleapis.com/auth/cloud-platformB\xa2\x03\xeaA}\n" +
	"$datacatalog.googleapis.com/PolicyTag\x12Uprojects/{project}/locations/{location}/taxonomies/{taxonomy}/policyTags/{policy_tag}\n" +
	".com.google.cloud.bigquery.datapolicies.v2beta1B\x0fDataPolicyProtoP\x01ZRcloud.google.com/go/bigquery/datapolicies/apiv2beta1/datapoliciespb;datapoliciespb\xaa\x02*Google.Cloud.BigQuery.DataPolicies.V2Beta1\xca\x02*Google\\Cloud\\BigQuery\\DataPolicies\\V2beta1\xea\x02.Google::Cloud::Bigquery::DataPolicies::V2beta1b\x06proto3"

var (
	file_google_cloud_bigquery_datapolicies_v2beta1_datapolicy_proto_rawDescOnce sync.Once
	file_google_cloud_bigquery_datapolicies_v2beta1_datapolicy_proto_rawDescData []byte
)
...
func file_google_cloud_bigquery_datapolicies_v2beta1_datapolicy_proto_rawDescGZIP() []byte {
	file_google_cloud_bigquery_datapolicies_v2beta1_datapolicy_proto_rawDescOnce.Do(func() {
		file_google_cloud_bigquery_datapolicies_v2beta1_datapolicy_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_datapolicies_v2beta1_datapolicy_proto_rawDesc), len(file_google_cloud_bigquery_datapolicies_v2beta1_datapolicy_proto_rawDesc)))
	})
...
func file_google_cloud_bigquery_datapolicies_v2beta1_datapolicy_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_datapolicies_v2beta1_datapolicy_proto_rawDesc), len(file_google_cloud_bigquery_datapolicies_v2beta1_datapolicy_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
