...
func (mc *monoClient) GetRoutine(ctx context.Context, req *bigquerypb.GetRoutineRequest, opts ...gax.CallOption) (*bigquerypb.Routine, error) {
	return mc.routClient.GetRoutine(ctx, req, opts...)
}

// InsertRoutine creates a new routine in the dataset.
func (mc *monoClient) InsertRoutine(ctx context.Context, req *bigquerypb.InsertRoutineRequest, opts ...gax.CallOption) (*bigquerypb.Routine, error) {
...
func (mc *monoClient) UpdateRoutine(ctx context.Context, req *bigquerypb.UpdateRoutineRequest, opts ...gax.CallOption) (*bigquerypb.Routine, error) {
...
func (mc *monoClient) PatchRoutine(ctx context.Context, req *bigquerypb.PatchRoutineRequest, opts ...gax.CallOption) (*bigquerypb.Routine, error) {
	return mc.routClient.PatchRoutine(ctx, req, opts...)
}

// DeleteRoutine deletes the routine specified by routineId from the dataset.
func (mc *monoClient) DeleteRoutine(ctx context.Context, req *bigquerypb.DeleteRoutineRequest, opts ...gax.CallOption) error {
...
// role.
func (mc *monoClient) ListRoutines(ctx context.Context, req *bigquerypb.ListRoutinesRequest, opts ...gax.CallOption) *bigquery.RoutineIterator {
