...
func (gcs *GCSReference) populateJobForLoad(job *bq.Job) io.Reader {
	job.Configuration.Load.SourceUris = gcs.uris
	gcs.FileConfig.populateLoadConfig(job.Configuration.Load)
	return nil
}
