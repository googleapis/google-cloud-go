...
const file_google_cloud_bigquery_migration_v2alpha_migration_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x12migration_workflow\x18\x02 \x01(\v2:.google.cloud.bigquery.migration.v2alpha.MigrationWorkflowB\x03\xe0A\x02R\x11migrationWorkflow\"\xa6\x01\n" +
	...
	"\x13migration_workflows\x18\x01 \x03(\v2:.google.cloud.bigquery.migration.v2alpha.MigrationWorkflowR\x12migrationWorkflows\x12&\n" +
	...
	"\x06filter\x18\x05 \x01(\tB\x03\xe0A\x01R\x06filter\"\xb1\x01\n" +
	"\x1dListMigrationSubtasksResponse\x12h\n" +
	"\x12migration_subtasks\x18\x01 \x03(\v29.google.cloud.bigquery.migration.v2alpha.MigrationSubtaskR\x11migrationSubtasks\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken2\xaa\r\n" +
	"\x10MigrationService\x12\x8a\x02\n" +
	"\x17CreateMigrationWorkflow\x12G.google.cloud.bigquery.migration.v2alpha.CreateMigrationWorkflowRequest\x1a:.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow\"j\xdaA\x19parent,migration_workflow\x82\xd3\xe4\x93\x02H:\x12migration_workflow\"2/v2alpha/{parent=projects/*/locations/*}/workflows\x12\xdb\x01\n" +
	...
	"\x16StartMigrationWorkflow\x12F.google.cloud.bigquery.migration.v2alpha.StartMigrationWorkflowRequest\x1a\x16.google.protobuf.Empty\"J\xdaA\x04name\x82\xd3\xe4\x93\x02=:\x01*\"8/v2alpha/{name=projects/*/locations/*/workflows/*}:start\x12\xe3\x01\n" +
...
var (
	...
	file_google_cloud_bigquery_migration_v2alpha_migration_service_proto_rawDescData []byte
)
...
func file_google_cloud_bigquery_migration_v2alpha_migration_service_proto_rawDescGZIP() []byte {
	file_google_cloud_bigquery_migration_v2alpha_migration_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_bigquery_migration_v2alpha_migration_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_migration_v2alpha_migration_service_proto_rawDesc), len(file_google_cloud_bigquery_migration_v2alpha_migration_service_proto_rawDesc)))
	})
...
func file_google_cloud_bigquery_migration_v2alpha_migration_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_migration_v2alpha_migration_service_proto_rawDesc), len(file_google_cloud_bigquery_migration_v2alpha_migration_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
