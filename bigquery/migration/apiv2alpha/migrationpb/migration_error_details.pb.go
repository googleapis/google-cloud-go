...
const file_google_cloud_bigquery_migration_v2alpha_migration_error_details_proto_rawDesc = "" +
	"\n" +
	"Egoogle/cloud/bigquery/migration/v2alpha/migration_error_details.proto\x12'google.cloud.bigquery.migration.v2alpha\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1egoogle/rpc/error_details.proto\"\xdf\x01\n" +
	"\x13ResourceErrorDetail\x12B\n" +
	"\rresource_info\x18\x01 \x01(\v2\x18.google.rpc.ResourceInfoB\x03\xe0A\x02R\fresourceInfo\x12^\n" +
	"\rerror_details\x18\x02 \x03(\v24.google.cloud.bigquery.migration.v2alpha.ErrorDetailB\x03\xe0A\x02R\ferrorDetails\x12$\n" +
	"\verror_count\x18\x03 \x01(\x05B\x03\xe0A\x02R\n" +
	"errorCount\"\xa1\x01\n" +
	"\vErrorDetail\x12W\n" +
	"\blocation\x18\x01 \x01(\v26.google.cloud.bigquery.migration.v2alpha.ErrorLocationB\x03\xe0A\x01R\blocation\x129\n" +
	"\n" +
	...
	"\x06column\x18\x02 \x01(\x05B\x03\xe0A\x01R\x06columnB\xea\x01\n" +
...
var (
	...
	file_google_cloud_bigquery_migration_v2alpha_migration_error_details_proto_rawDescData []byte
)
...
func file_google_cloud_bigquery_migration_v2alpha_migration_error_details_proto_rawDescGZIP() []byte {
	file_google_cloud_bigquery_migration_v2alpha_migration_error_details_proto_rawDescOnce.Do(func() {
		file_google_cloud_bigquery_migration_v2alpha_migration_error_details_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_migration_v2alpha_migration_error_details_proto_rawDesc), len(file_google_cloud_bigquery_migration_v2alpha_migration_error_details_proto_rawDesc)))
	})
...
var file_google_cloud_bigquery_migration_v2alpha_migration_error_details_proto_goTypes = []any{
...
func file_google_cloud_bigquery_migration_v2alpha_migration_error_details_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_migration_v2alpha_migration_error_details_proto_rawDesc), len(file_google_cloud_bigquery_migration_v2alpha_migration_error_details_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
