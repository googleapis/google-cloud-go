...
func (x *AppendRowsRequest) GetArrowRows() *AppendRowsRequest_ArrowData {
	if x != nil {
		if x, ok := x.Rows.(*AppendRowsRequest_ArrowRows); ok {
			return x.ArrowRows
		}
	}
	return nil
...
const file_google_cloud_bigquery_storage_v1_storage_proto_rawDesc = "" +
	...
	"\trow_count\x18\x06 \x01(\x03R\browCount\x12C\n" +
	"\x05stats\x18\x02 \x01(\v2-.google.cloud.bigquery.storage.v1.StreamStatsR\x05stats\x12V\n" +
	"\x0ethrottle_state\x18\x05 \x01(\v2/.google.cloud.bigquery.storage.v1.ThrottleStateR\rthrottleState\x12T\n" +
	...
	"\bfraction\x18\x02 \x01(\x01R\bfraction\"\xc7\x01\n" +
	"\x17SplitReadStreamResponse\x12S\n" +
	"\x0eprimary_stream\x18\x01 \x01(\v2,.google.cloud.bigquery.storage.v1.ReadStreamR\rprimaryStream\x12W\n" +
	"\x10remainder_stream\x18\x02 \x01(\v2,.google.cloud.bigquery.storage.v1.ReadStreamR\x0fremainderStream\"\xb0\x01\n" +
	...
	"\x06offset\x18\x02 \x01(\v2\x1b.google.protobuf.Int64ValueR\x06offset\x12^\n" +
	"\n" +
	"proto_rows\x18\x04 \x01(\v2=.google.cloud.bigquery.storage.v1.AppendRowsRequest.ProtoDataH\x00R\tprotoRows\x12^\n" +
	"\n" +
	...
	"\tProtoData\x12R\n" +
	"\rwriter_schema\x18\x01 \x01(\v2-.google.cloud.bigquery.storage.v1.ProtoSchemaR\fwriterSchema\x12?\n" +
	"\x04rows\x18\x02 \x01(\v2+.google.cloud.bigquery.storage.v1.ProtoRowsR\x04rows\x1a\x9e\x01\n" +
	" MissingValueInterpretationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12d\n" +
	"\x05value\x18\x02 \x01(\x0e2N.google.cloud.bigquery.storage.v1.AppendRowsRequest.MissingValueInterpretationR\x05value:\x028\x01\"m\n" +
	...
	"\x04rows\"\xbf\x03\n" +
	"\x12AppendRowsResponse\x12h\n" +
	"\rappend_result\x18\x01 \x01(\v2A.google.cloud.bigquery.storage.v1.AppendRowsResponse.AppendResultH\x00R\fappendResult\x12*\n" +
	"\x05error\x18\x02 \x01(\v2\x12.google.rpc.StatusH\x00R\x05error\x12T\n" +
	"\x0eupdated_schema\x18\x03 \x01(\v2-.google.cloud.bigquery.storage.v1.TableSchemaR\rupdatedSchema\x12I\n" +
	"\n" +
	"row_errors\x18\x04 \x03(\v2*.google.cloud.bigquery.storage.v1.RowErrorR\trowErrors\x12!\n" +
	"\fwrite_stream\x18\x05 \x01(\tR\vwriteStream\x1aC\n" +
	"\fAppendResult\x123\n" +
	...
	"*bigquerystorage.googleapis.com/WriteStreamR\x04name\x12E\n" +
	"\x04view\x18\x03 \x01(\x0e21.google.cloud.bigquery.storage.v1.WriteStreamViewR\x04view\"\x89\x01\n" +
	"\x1eBatchCommitWriteStreamsRequest\x12=\n" +
	"\x06parent\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dbigquery.googleapis.com/TableR\x06parent\x12(\n" +
	"\rwrite_streams\x18\x02 \x03(\tB\x03\xe0A\x02R\fwriteStreams\"\xb3\x01\n" +
	"\x1fBatchCommitWriteStreamsResponse\x12;\n" +
	"\vcommit_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"commitTime\x12S\n" +
	"\rstream_errors\x18\x02 \x03(\v2..google.cloud.bigquery.storage.v1.StorageErrorR\fstreamErrors\"d\n" +
	...
	"\x06offset\x18\x01 \x01(\x03R\x06offset\"\xc0\x04\n" +
	"\fStorageError\x12S\n" +
	"\x04code\x18\x01 \x01(\x0e2?.google.cloud.bigquery.storage.v1.StorageError.StorageErrorCodeR\x04code\x12\x16\n" +
	"\x06entity\x18\x02 \x01(\tR\x06entity\x12#\n" +
	"\rerror_message\x18\x03 \x01(\tR\ferrorMessage\"\x9d\x03\n" +
	...
	"\x1cSCHEMA_MISMATCH_EXTRA_FIELDS\x10\a\x12\x19\n" +
	"\x15OFFSET_ALREADY_EXISTS\x10\b\x12\x17\n" +
	"\x13OFFSET_OUT_OF_RANGE\x10\t\x12\x15\n" +
	"\x11CMEK_NOT_PROVIDED\x10\n" +
	"\x12\x19\n" +
	"\x15INVALID_CMEK_PROVIDED\x10\v\x12\x19\n" +
	"\x15CMEK_ENCRYPTION_ERROR\x10\f\x12\x15\n" +
	"\x11KMS_SERVICE_ERROR\x10\r\x12\x19\n" +
	"\x15KMS_PERMISSION_DENIED\x10\x0e\"\xc9\x01\n" +
	"\bRowError\x12\x14\n" +
	"\x05index\x18\x01 \x01(\x03R\x05index\x12K\n" +
	"\x04code\x18\x02 \x01(\x0e27.google.cloud.bigquery.storage.v1.RowError.RowErrorCodeR\x04code\x12\x18\n" +
	...
	"\x11CreateWriteStream\x12:.google.cloud.bigquery.storage.v1.CreateWriteStreamRequest\x1a-.google.cloud.bigquery.storage.v1.WriteStream\"W\xdaA\x13parent,write_stream\x82\xd3\xe4\x93\x02;:\fwrite_stream\"+/v1/{parent=projects/*/datasets/*/tables/*}\x12\xd2\x01\n" +
	"\n" +
	"AppendRows\x123.google.cloud.bigquery.storage.v1.AppendRowsRequest\x1a4.google.cloud.bigquery.storage.v1.AppendRowsResponse\"U\xdaA\fwrite_stream\x82\xd3\xe4\x93\x02@:\x01*\";/v1/{write_stream=projects/*/datasets/*/tables/*/streams/*}(\x010\x01\x12\xbf\x01\n" +
	"\x0eGetWriteStream\x127.google.cloud.bigquery.storage.v1.GetWriteStreamRequest\x1a-.google.cloud.bigquery.storage.v1.WriteStream\"E\xdaA\x04name\x82\xd3\xe4\x93\x028:\x01*\"3/v1/{name=projects/*/datasets/*/tables/*/streams/*}\x12\xd9\x01\n" +
	"\x13FinalizeWriteStream\x12<.google.cloud.bigquery.storage.v1.FinalizeWriteStreamRequest\x1a=.google.cloud.bigquery.storage.v1.FinalizeWriteStreamResponse\"E\xdaA\x04name\x82\xd3\xe4\x93\x028:\x01*\"3/v1/{name=projects/*/datasets/*/tables/*/streams/*}\x12\xdc\x01\n" +
	...
	"\tFlushRows\x122.google.cloud.bigquery.storage.v1.FlushRowsRequest\x1a3.google.cloud.bigquery.storage.v1.FlushRowsResponse\"U\xdaA\fwrite_stream\x82\xd3\xe4\x93\x02@:\x01*\";/v1/{write_stream=projects/*/datasets/*/tables/*/streams/*}\x1a\xb0\x01\xcaA\x1ebigquerystorage.googleapis.com\xd2A\x8b\x01https://www.googleapis.com/auth/bigquery,https://www.googleapis.com/auth/bigquery.insertdata,https://www.googleapis.com/auth/cloud-platformB\x94\x02\xeaAU\n" +
	"\x1dbigquery.googleapis.com/Table\x124projects/{project}/datasets/{dataset}/tables/{table}\n" +
	"$com.google.cloud.bigquery.storage.v1B\fStorageProtoP\x01Z>cloud.google.com/go/bigquery/storage/apiv1/storagepb;storagepb\xaa\x02 Google.Cloud.BigQuery.Storage.V1\xca\x02 Google\\Cloud\\BigQuery\\Storage\\V1b\x06proto3"

var (
	file_google_cloud_bigquery_storage_v1_storage_proto_rawDescOnce sync.Once
	file_google_cloud_bigquery_storage_v1_storage_proto_rawDescData []byte
)
...
func file_google_cloud_bigquery_storage_v1_storage_proto_rawDescGZIP() []byte {
	file_google_cloud_bigquery_storage_v1_storage_proto_rawDescOnce.Do(func() {
		file_google_cloud_bigquery_storage_v1_storage_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_storage_v1_storage_proto_rawDesc), len(file_google_cloud_bigquery_storage_v1_storage_proto_rawDesc)))
	})
