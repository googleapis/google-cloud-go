...
const file_google_cloud_bigquery_storage_v1beta1_table_reference_proto_rawDesc = "" +
	"\n" +
	";google/cloud/bigquery/storage/v1beta1/table_reference.proto\x12%google.cloud.bigquery.storage.v1beta1\x1a\x1fgoogle/protobuf/timestamp.proto\"i\n" +
	"\x0eTableReference\x12\x1d\n" +
	"\n" +
	"project_id\x18\x01 \x01(\tR\tprojectId\x12\x1d\n" +
	"\n" +
	"dataset_id\x18\x02 \x01(\tR\tdatasetId\x12\x19\n" +
	"\btable_id\x18\x03 \x01(\tR\atableId\"Q\n" +
	"\x0eTableModifiers\x12?\n" +
	"\rsnapshot_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\fsnapshotTimeB\x85\x01\n" +
...
var (
	...
	file_google_cloud_bigquery_storage_v1beta1_table_reference_proto_rawDescData []byte
)
...
func file_google_cloud_bigquery_storage_v1beta1_table_reference_proto_rawDescGZIP() []byte {
	file_google_cloud_bigquery_storage_v1beta1_table_reference_proto_rawDescOnce.Do(func() {
		file_google_cloud_bigquery_storage_v1beta1_table_reference_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_storage_v1beta1_table_reference_proto_rawDesc), len(file_google_cloud_bigquery_storage_v1beta1_table_reference_proto_rawDesc)))
	})
...
func file_google_cloud_bigquery_storage_v1beta1_table_reference_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_storage_v1beta1_table_reference_proto_rawDesc), len(file_google_cloud_bigquery_storage_v1beta1_table_reference_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
