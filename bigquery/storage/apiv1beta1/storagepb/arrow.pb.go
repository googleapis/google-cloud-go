...
const file_google_cloud_bigquery_storage_v1beta1_arrow_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/bigquery/storage/v1beta1/arrow.proto\x12%google.cloud.bigquery.storage.v1beta1\":\n" +
	"\vArrowSchema\x12+\n" +
	"\x11serialized_schema\x18\x01 \x01(\fR\x10serializedSchema\"g\n" +
	"\x10ArrowRecordBatch\x126\n" +
	"\x17serialized_record_batch\x18\x01 \x01(\fR\x15serializedRecordBatch\x12\x1b\n" +
...
var (
	...
	file_google_cloud_bigquery_storage_v1beta1_arrow_proto_rawDescData []byte
)
...
func file_google_cloud_bigquery_storage_v1beta1_arrow_proto_rawDescGZIP() []byte {
	file_google_cloud_bigquery_storage_v1beta1_arrow_proto_rawDescOnce.Do(func() {
		file_google_cloud_bigquery_storage_v1beta1_arrow_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_storage_v1beta1_arrow_proto_rawDesc), len(file_google_cloud_bigquery_storage_v1beta1_arrow_proto_rawDesc)))
	})
...
var file_google_cloud_bigquery_storage_v1beta1_arrow_proto_goTypes = []any{
...
func file_google_cloud_bigquery_storage_v1beta1_arrow_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_storage_v1beta1_arrow_proto_rawDesc), len(file_google_cloud_bigquery_storage_v1beta1_arrow_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
