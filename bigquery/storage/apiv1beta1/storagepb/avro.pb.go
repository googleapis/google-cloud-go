...
const file_google_cloud_bigquery_storage_v1beta1_avro_proto_rawDesc = "" +
	"\n" +
	...
	"\bAvroRows\x124\n" +
	"\x16serialized_binary_rows\x18\x01 \x01(\fR\x14serializedBinaryRows\x12\x1b\n" +
	"\trow_count\x18\x02 \x01(\x03R\browCountB{\n" +
...
var (
	...
	file_google_cloud_bigquery_storage_v1beta1_avro_proto_rawDescData []byte
)
...
func file_google_cloud_bigquery_storage_v1beta1_avro_proto_rawDescGZIP() []byte {
	file_google_cloud_bigquery_storage_v1beta1_avro_proto_rawDescOnce.Do(func() {
		file_google_cloud_bigquery_storage_v1beta1_avro_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_storage_v1beta1_avro_proto_rawDesc), len(file_google_cloud_bigquery_storage_v1beta1_avro_proto_rawDesc)))
	})
...
var file_google_cloud_bigquery_storage_v1beta1_avro_proto_goTypes = []any{
...
func file_google_cloud_bigquery_storage_v1beta1_avro_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_storage_v1beta1_avro_proto_rawDesc), len(file_google_cloud_bigquery_storage_v1beta1_avro_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
