	...
	for _, test := range []struct {
		...
		{&bq.Table{}, &TableMetadata{}}, // test minimal case
		{
			&bq.Table{
				...
				NumBytes:                   123,
				NumLongTermBytes:           23,
				NumTimeTravelPhysicalBytes: 142,
				NumTotalLogicalBytes:       342,
				NumActiveLogicalBytes:      2,
				NumLongTermLogicalBytes:    24,
				NumTotalPhysicalBytes:      49,
				NumActivePhysicalBytes:     949,
				NumLongTermPhysicalBytes:   234,
				NumRows:                    7,
