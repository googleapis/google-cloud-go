...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/vectorsearch.svg)](https://pkg.go.dev/cloud.google.com/go/vectorsearch)

Go Client Library for Vector Search API.

## Install

```bash
go get cloud.google.com/go/vectorsearch
```
