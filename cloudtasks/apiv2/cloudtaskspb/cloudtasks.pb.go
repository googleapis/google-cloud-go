...
func (BatchDeleteTasksMetadata_State) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_tasks_v2_cloudtasks_proto_enumTypes[0].Descriptor()
}

func (BatchDeleteTasksMetadata_State) Type() protoreflect.EnumType {
	return &file_google_cloud_tasks_v2_cloudtasks_proto_enumTypes[0]
}
...
func (BatchDeleteTasksMetadata_State) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_tasks_v2_cloudtasks_proto_rawDescGZIP(), []int{16, 0}
}
...
func (BatchCreateTasksMetadata_State) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_tasks_v2_cloudtasks_proto_enumTypes[1].Descriptor()
}

func (BatchCreateTasksMetadata_State) Type() protoreflect.EnumType {
	return &file_google_cloud_tasks_v2_cloudtasks_proto_enumTypes[1]
}
...
func (BatchCreateTasksMetadata_State) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_tasks_v2_cloudtasks_proto_rawDescGZIP(), []int{21, 0}
}
...
func (x *BatchDeleteTasksRequest) Reset() {
	*x = BatchDeleteTasksRequest{}
	mi := &file_google_cloud_tasks_v2_cloudtasks_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BatchDeleteTasksRequest) Descriptor() ([]byte, []int) {
	return file_google_cloud_tasks_v2_cloudtasks_proto_rawDescGZIP(), []int{15}
}
...
type BatchDeleteTasksMetadata struct {
	...
	State BatchDeleteTasksMetadata_State `protobuf:"varint,3,opt,name=state,proto3,enum=google.cloud.tasks.v2.BatchDeleteTasksMetadata_State" json:"state,omitempty"`
...
func (x *BatchDeleteTasksMetadata) Reset() {
	*x = BatchDeleteTasksMetadata{}
	mi := &file_google_cloud_tasks_v2_cloudtasks_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BatchDeleteTasksMetadata) Descriptor() ([]byte, []int) {
	return file_google_cloud_tasks_v2_cloudtasks_proto_rawDescGZIP(), []int{16}
}
...
func (x *RunTaskRequest) Reset() {
	*x = RunTaskRequest{}
	mi := &file_google_cloud_tasks_v2_cloudtasks_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RunTaskRequest) Descriptor() ([]byte, []int) {
	return file_google_cloud_tasks_v2_cloudtasks_proto_rawDescGZIP(), []int{17}
}
...
func (x *UpdateCmekConfigRequest) Reset() {
	*x = UpdateCmekConfigRequest{}
	mi := &file_google_cloud_tasks_v2_cloudtasks_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateCmekConfigRequest) Descriptor() ([]byte, []int) {
	return file_google_cloud_tasks_v2_cloudtasks_proto_rawDescGZIP(), []int{18}
}
...
func (x *GetCmekConfigRequest) Reset() {
	*x = GetCmekConfigRequest{}
	mi := &file_google_cloud_tasks_v2_cloudtasks_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetCmekConfigRequest) Descriptor() ([]byte, []int) {
	return file_google_cloud_tasks_v2_cloudtasks_proto_rawDescGZIP(), []int{19}
}
...
func (x *BatchCreateTasksResponse) Reset() {
	*x = BatchCreateTasksResponse{}
	mi := &file_google_cloud_tasks_v2_cloudtasks_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BatchCreateTasksResponse) Descriptor() ([]byte, []int) {
	return file_google_cloud_tasks_v2_cloudtasks_proto_rawDescGZIP(), []int{20}
}
...
type BatchCreateTasksMetadata struct {
	...
	State BatchCreateTasksMetadata_State `protobuf:"varint,3,opt,name=state,proto3,enum=google.cloud.tasks.v2.BatchCreateTasksMetadata_State" json:"state,omitempty"`
...
func (x *BatchCreateTasksMetadata) Reset() {
	*x = BatchCreateTasksMetadata{}
	mi := &file_google_cloud_tasks_v2_cloudtasks_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BatchCreateTasksMetadata) Descriptor() ([]byte, []int) {
	return file_google_cloud_tasks_v2_cloudtasks_proto_rawDescGZIP(), []int{21}
}
...
const file_google_cloud_tasks_v2_cloudtasks_proto_rawDesc = "" +
	"\n" +
	"&google/cloud/tasks/v2/cloudtasks.proto\x12\x15google.cloud.tasks.v2\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/api/field_info.proto\x1a\x19google/api/resource.proto\x1a'google/cloud/tasks/v2/cmek_config.proto\x1a!google/cloud/tasks/v2/queue.proto\x1a google/cloud/tasks/v2/task.proto\x1a\x1egoogle/iam/v1/iam_policy.proto\x1a\x1agoogle/iam/v1/policy.proto\x1a#google/longrunning/operations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\xa8\x01\n" +
	...
	"\rresponse_view\x18\x03 \x01(\x0e2 .google.cloud.tasks.v2.Task.ViewR\fresponseView\"\xd1\x01\n" +
	"\x17BatchCreateTasksRequest\x12?\n" +
	"\x06parent\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\n" +
	"\x1fcloudtasks.googleapis.com/QueueR\x06parent\x12I\n" +
	"\brequests\x18\x02 \x03(\v2(.google.cloud.tasks.v2.CreateTaskRequestB\x03\xe0A\x02R\brequests\x12*\n" +
	"\n" +
	...
	"\n" +
	"request_id\x18\x03 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\x93\x04\n" +
	"\x18BatchDeleteTasksMetadata\x12>\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tstartTime\x12:\n" +
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\aendTime\x12P\n" +
	"\x05state\x18\x03 \x01(\x0e25.google.cloud.tasks.v2.BatchDeleteTasksMetadata.StateB\x03\xe0A\x03R\x05state\x12q\n" +
	"\x0ffailed_requests\x18\x04 \x03(\v2C.google.cloud.tasks.v2.BatchDeleteTasksMetadata.FailedRequestsEntryB\x03\xe0A\x03R\x0efailedRequests\x1aU\n" +
	...
	"\n" +
	"\x06FAILED\x10\x04\"\x93\x01\n" +
	"\x0eRunTaskRequest\x12:\n" +
	"\x04name\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1ecloudtasks.googleapis.com/TaskR\x04name\x12E\n" +
	"\rresponse_view\x18\x02 \x01(\x0e2 .google.cloud.tasks.v2.Task.ViewR\fresponseView\"\x9f\x01\n" +
	"\x17UpdateCmekConfigRequest\x12G\n" +
	"\vcmek_config\x18\x01 \x01(\v2!.google.cloud.tasks.v2.CmekConfigB\x03\xe0A\x02R\n" +
	"cmekConfig\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"X\n" +
	"\x14GetCmekConfigRequest\x12@\n" +
	"\x04name\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\n" +
	"$cloudtasks.googleapis.com/CmekConfigR\x04name\"M\n" +
	"\x18BatchCreateTasksResponse\x121\n" +
	"\x05tasks\x18\x01 \x03(\v2\x1b.google.cloud.tasks.v2.TaskR\x05tasks\"\x93\x04\n" +
	"\x18BatchCreateTasksMetadata\x129\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x125\n" +
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\x12P\n" +
	"\x05state\x18\x03 \x01(\x0e25.google.cloud.tasks.v2.BatchCreateTasksMetadata.StateB\x03\xe0A\x03R\x05state\x12l\n" +
	"\x0ffailed_requests\x18\x04 \x03(\v2C.google.cloud.tasks.v2.BatchCreateTasksMetadata.FailedRequestsEntryR\x0efailedRequests\x1aU\n" +
	"\x13FailedRequestsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x12(\n" +
	...
	"\n" +
	"CreateTask\x12(.google.cloud.tasks.v2.CreateTaskRequest\x1a\x1b.google.cloud.tasks.v2.Task\"K\xdaA\vparent,task\x82\xd3\xe4\x93\x027:\x01*\"2/v2/{parent=projects/*/locations/*/queues/*}/tasks\x12\xf6\x01\n" +
	"\x10BatchCreateTasks\x12..google.cloud.tasks.v2.BatchCreateTasksRequest\x1a\x1d.google.longrunning.Operation\"\x92\x01\xcaA4\n" +
	"\x18BatchCreateTasksResponse\x12\x18BatchCreateTasksMetadata\xdaA\x0fparent,requests\x82\xd3\xe4\x93\x02C:\x01*\">/v2/{parent=projects/*/locations/*/queues/*}/tasks:batchCreate\x12\x91\x01\n" +
	"\n" +
	"DeleteTask\x12(.google.cloud.tasks.v2.DeleteTaskRequest\x1a\x16.google.protobuf.Empty\"A\xdaA\x04name\x82\xd3\xe4\x93\x024*2/v2/{name=projects/*/locations/*/queues/*/tasks/*}\x12\xf0\x01\n" +
	"\x10BatchDeleteTasks\x12..google.cloud.tasks.v2.BatchDeleteTasksRequest\x1a\x1d.google.longrunning.Operation\"\x8c\x01\xcaA1\n" +
	"\x15google.protobuf.Empty\x12\x18BatchDeleteTasksMetadata\xdaA\fparent,names\x82\xd3\xe4\x93\x02C:\x01*\">/v2/{parent=projects/*/locations/*/queues/*}/tasks:batchDelete\x12\x97\x01\n" +
	"\aRunTask\x12%.google.cloud.tasks.v2.RunTaskRequest\x1a\x1b.google.cloud.tasks.v2.Task\"H\xdaA\x04name\x82\xd3\xe4\x93\x02;:\x01*\"6/v2/{name=projects/*/locations/*/queues/*/tasks/*}:run\x12\xce\x01\n" +
	"\x10UpdateCmekConfig\x12..google.cloud.tasks.v2.UpdateCmekConfigRequest\x1a!.google.cloud.tasks.v2.CmekConfig\"g\xdaA\x17cmek_config,update_mask\x82\xd3\xe4\x93\x02G:\vcmek_config28/v2/{cmek_config.name=projects/*/locations/*/cmekConfig}\x12\x9c\x01\n" +
	"\rGetCmekConfig\x12+.google.cloud.tasks.v2.GetCmekConfigRequest\x1a!.google.cloud.tasks.v2.CmekConfig\";\xdaA\x04name\x82\xd3\xe4\x93\x02.\x12,/v2/{name=projects/*/locations/*/cmekConfig}\x1aM\xcaA\x19cloudtasks.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformBv\n" +
...
var file_google_cloud_tasks_v2_cloudtasks_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_google_cloud_tasks_v2_cloudtasks_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_google_cloud_tasks_v2_cloudtasks_proto_goTypes = []any{
	(BatchDeleteTasksMetadata_State)(0),      // 0: google.cloud.tasks.v2.BatchDeleteTasksMetadata.State
	(BatchCreateTasksMetadata_State)(0),      // 1: google.cloud.tasks.v2.BatchCreateTasksMetadata.State
	(*ListQueuesRequest)(nil),                // 2: google.cloud.tasks.v2.ListQueuesRequest
	(*ListQueuesResponse)(nil),               // 3: google.cloud.tasks.v2.ListQueuesResponse
	(*GetQueueRequest)(nil),                  // 4: google.cloud.tasks.v2.GetQueueRequest
	(*CreateQueueRequest)(nil),               // 5: google.cloud.tasks.v2.CreateQueueRequest
	(*UpdateQueueRequest)(nil),               // 6: google.cloud.tasks.v2.UpdateQueueRequest
	(*DeleteQueueRequest)(nil),               // 7: google.cloud.tasks.v2.DeleteQueueRequest
	(*PurgeQueueRequest)(nil),                // 8: google.cloud.tasks.v2.PurgeQueueRequest
	(*PauseQueueRequest)(nil),                // 9: google.cloud.tasks.v2.PauseQueueRequest
	(*ResumeQueueRequest)(nil),               // 10: google.cloud.tasks.v2.ResumeQueueRequest
	(*ListTasksRequest)(nil),                 // 11: google.cloud.tasks.v2.ListTasksRequest
	(*ListTasksResponse)(nil),                // 12: google.cloud.tasks.v2.ListTasksResponse
	(*GetTaskRequest)(nil),                   // 13: google.cloud.tasks.v2.GetTaskRequest
	(*CreateTaskRequest)(nil),                // 14: google.cloud.tasks.v2.CreateTaskRequest
	(*BatchCreateTasksRequest)(nil),          // 15: google.cloud.tasks.v2.BatchCreateTasksRequest
	(*DeleteTaskRequest)(nil),                // 16: google.cloud.tasks.v2.DeleteTaskRequest
	(*BatchDeleteTasksRequest)(nil),          // 17: google.cloud.tasks.v2.BatchDeleteTasksRequest
	(*BatchDeleteTasksMetadata)(nil),         // 18: google.cloud.tasks.v2.BatchDeleteTasksMetadata
	(*RunTaskRequest)(nil),                   // 19: google.cloud.tasks.v2.RunTaskRequest
	(*UpdateCmekConfigRequest)(nil),          // 20: google.cloud.tasks.v2.UpdateCmekConfigRequest
	(*GetCmekConfigRequest)(nil),             // 21: google.cloud.tasks.v2.GetCmekConfigRequest
	(*BatchCreateTasksResponse)(nil),         // 22: google.cloud.tasks.v2.BatchCreateTasksResponse
	(*BatchCreateTasksMetadata)(nil),         // 23: google.cloud.tasks.v2.BatchCreateTasksMetadata
	nil,                                      // 24: google.cloud.tasks.v2.BatchDeleteTasksMetadata.FailedRequestsEntry
	nil,                                      // 25: google.cloud.tasks.v2.BatchCreateTasksMetadata.FailedRequestsEntry
	(*Queue)(nil),                            // 26: google.cloud.tasks.v2.Queue
	(*fieldmaskpb.FieldMask)(nil),            // 27: google.protobuf.FieldMask
	(Task_View)(0),                           // 28: google.cloud.tasks.v2.Task.View
	(*Task)(nil),                             // 29: google.cloud.tasks.v2.Task
	(*timestamppb.Timestamp)(nil),            // 30: google.protobuf.Timestamp
	(*CmekConfig)(nil),                       // 31: google.cloud.tasks.v2.CmekConfig
...
var file_google_cloud_tasks_v2_cloudtasks_proto_depIdxs = []int32{
	26, // 0: google.cloud.tasks.v2.ListQueuesResponse.queues:type_name -> google.cloud.tasks.v2.Queue
	26, // 1: google.cloud.tasks.v2.CreateQueueRequest.queue:type_name -> google.cloud.tasks.v2.Queue
	26, // 2: google.cloud.tasks.v2.UpdateQueueRequest.queue:type_name -> google.cloud.tasks.v2.Queue
	27, // 3: google.cloud.tasks.v2.UpdateQueueRequest.update_mask:type_name -> google.protobuf.FieldMask
	28, // 4: google.cloud.tasks.v2.ListTasksRequest.response_view:type_name -> google.cloud.tasks.v2.Task.View
	29, // 5: google.cloud.tasks.v2.ListTasksResponse.tasks:type_name -> google.cloud.tasks.v2.Task
	28, // 6: google.cloud.tasks.v2.GetTaskRequest.response_view:type_name -> google.cloud.tasks.v2.Task.View
	29, // 7: google.cloud.tasks.v2.CreateTaskRequest.task:type_name -> google.cloud.tasks.v2.Task
	28, // 8: google.cloud.tasks.v2.CreateTaskRequest.response_view:type_name -> google.cloud.tasks.v2.Task.View
	14, // 9: google.cloud.tasks.v2.BatchCreateTasksRequest.requests:type_name -> google.cloud.tasks.v2.CreateTaskRequest
	30, // 10: google.cloud.tasks.v2.BatchDeleteTasksMetadata.start_time:type_name -> google.protobuf.Timestamp
	30, // 11: google.cloud.tasks.v2.BatchDeleteTasksMetadata.end_time:type_name -> google.protobuf.Timestamp
	0,  // 12: google.cloud.tasks.v2.BatchDeleteTasksMetadata.state:type_name -> google.cloud.tasks.v2.BatchDeleteTasksMetadata.State
	24, // 13: google.cloud.tasks.v2.BatchDeleteTasksMetadata.failed_requests:type_name -> google.cloud.tasks.v2.BatchDeleteTasksMetadata.FailedRequestsEntry
	28, // 14: google.cloud.tasks.v2.RunTaskRequest.response_view:type_name -> google.cloud.tasks.v2.Task.View
	31, // 15: google.cloud.tasks.v2.UpdateCmekConfigRequest.cmek_config:type_name -> google.cloud.tasks.v2.CmekConfig
	27, // 16: google.cloud.tasks.v2.UpdateCmekConfigRequest.update_mask:type_name -> google.protobuf.FieldMask
	29, // 17: google.cloud.tasks.v2.BatchCreateTasksResponse.tasks:type_name -> google.cloud.tasks.v2.Task
	30, // 18: google.cloud.tasks.v2.BatchCreateTasksMetadata.start_time:type_name -> google.protobuf.Timestamp
	30, // 19: google.cloud.tasks.v2.BatchCreateTasksMetadata.end_time:type_name -> google.protobuf.Timestamp
	1,  // 20: google.cloud.tasks.v2.BatchCreateTasksMetadata.state:type_name -> google.cloud.tasks.v2.BatchCreateTasksMetadata.State
	25, // 21: google.cloud.tasks.v2.BatchCreateTasksMetadata.failed_requests:type_name -> google.cloud.tasks.v2.BatchCreateTasksMetadata.FailedRequestsEntry
	32, // 22: google.cloud.tasks.v2.BatchDeleteTasksMetadata.FailedRequestsEntry.value:type_name -> google.rpc.Status
	32, // 23: google.cloud.tasks.v2.BatchCreateTasksMetadata.FailedRequestsEntry.value:type_name -> google.rpc.Status
	2,  // 24: google.cloud.tasks.v2.CloudTasks.ListQueues:input_type -> google.cloud.tasks.v2.ListQueuesRequest
	4,  // 25: google.cloud.tasks.v2.CloudTasks.GetQueue:input_type -> google.cloud.tasks.v2.GetQueueRequest
	5,  // 26: google.cloud.tasks.v2.CloudTasks.CreateQueue:input_type -> google.cloud.tasks.v2.CreateQueueRequest
	6,  // 27: google.cloud.tasks.v2.CloudTasks.UpdateQueue:input_type -> google.cloud.tasks.v2.UpdateQueueRequest
	7,  // 28: google.cloud.tasks.v2.CloudTasks.DeleteQueue:input_type -> google.cloud.tasks.v2.DeleteQueueRequest
	8,  // 29: google.cloud.tasks.v2.CloudTasks.PurgeQueue:input_type -> google.cloud.tasks.v2.PurgeQueueRequest
	9,  // 30: google.cloud.tasks.v2.CloudTasks.PauseQueue:input_type -> google.cloud.tasks.v2.PauseQueueRequest
	10, // 31: google.cloud.tasks.v2.CloudTasks.ResumeQueue:input_type -> google.cloud.tasks.v2.ResumeQueueRequest
	33, // 32: google.cloud.tasks.v2.CloudTasks.GetIamPolicy:input_type -> google.iam.v1.GetIamPolicyRequest
	34, // 33: google.cloud.tasks.v2.CloudTasks.SetIamPolicy:input_type -> google.iam.v1.SetIamPolicyRequest
	35, // 34: google.cloud.tasks.v2.CloudTasks.TestIamPermissions:input_type -> google.iam.v1.TestIamPermissionsRequest
	11, // 35: google.cloud.tasks.v2.CloudTasks.ListTasks:input_type -> google.cloud.tasks.v2.ListTasksRequest
	13, // 36: google.cloud.tasks.v2.CloudTasks.GetTask:input_type -> google.cloud.tasks.v2.GetTaskRequest
	14, // 37: google.cloud.tasks.v2.CloudTasks.CreateTask:input_type -> google.cloud.tasks.v2.CreateTaskRequest
	15, // 38: google.cloud.tasks.v2.CloudTasks.BatchCreateTasks:input_type -> google.cloud.tasks.v2.BatchCreateTasksRequest
	16, // 39: google.cloud.tasks.v2.CloudTasks.DeleteTask:input_type -> google.cloud.tasks.v2.DeleteTaskRequest
	17, // 40: google.cloud.tasks.v2.CloudTasks.BatchDeleteTasks:input_type -> google.cloud.tasks.v2.BatchDeleteTasksRequest
	19, // 41: google.cloud.tasks.v2.CloudTasks.RunTask:input_type -> google.cloud.tasks.v2.RunTaskRequest
	20, // 42: google.cloud.tasks.v2.CloudTasks.UpdateCmekConfig:input_type -> google.cloud.tasks.v2.UpdateCmekConfigRequest
	21, // 43: google.cloud.tasks.v2.CloudTasks.GetCmekConfig:input_type -> google.cloud.tasks.v2.GetCmekConfigRequest
	3,  // 44: google.cloud.tasks.v2.CloudTasks.ListQueues:output_type -> google.cloud.tasks.v2.ListQueuesResponse
	26, // 45: google.cloud.tasks.v2.CloudTasks.GetQueue:output_type -> google.cloud.tasks.v2.Queue
	26, // 46: google.cloud.tasks.v2.CloudTasks.CreateQueue:output_type -> google.cloud.tasks.v2.Queue
	26, // 47: google.cloud.tasks.v2.CloudTasks.UpdateQueue:output_type -> google.cloud.tasks.v2.Queue
	36, // 48: google.cloud.tasks.v2.CloudTasks.DeleteQueue:output_type -> google.protobuf.Empty
	26, // 49: google.cloud.tasks.v2.CloudTasks.PurgeQueue:output_type -> google.cloud.tasks.v2.Queue
	26, // 50: google.cloud.tasks.v2.CloudTasks.PauseQueue:output_type -> google.cloud.tasks.v2.Queue
	26, // 51: google.cloud.tasks.v2.CloudTasks.ResumeQueue:output_type -> google.cloud.tasks.v2.Queue
	37, // 52: google.cloud.tasks.v2.CloudTasks.GetIamPolicy:output_type -> google.iam.v1.Policy
	37, // 53: google.cloud.tasks.v2.CloudTasks.SetIamPolicy:output_type -> google.iam.v1.Policy
	38, // 54: google.cloud.tasks.v2.CloudTasks.TestIamPermissions:output_type -> google.iam.v1.TestIamPermissionsResponse
	12, // 55: google.cloud.tasks.v2.CloudTasks.ListTasks:output_type -> google.cloud.tasks.v2.ListTasksResponse
	29, // 56: google.cloud.tasks.v2.CloudTasks.GetTask:output_type -> google.cloud.tasks.v2.Task
	29, // 57: google.cloud.tasks.v2.CloudTasks.CreateTask:output_type -> google.cloud.tasks.v2.Task
	39, // 58: google.cloud.tasks.v2.CloudTasks.BatchCreateTasks:output_type -> google.longrunning.Operation
	36, // 59: google.cloud.tasks.v2.CloudTasks.DeleteTask:output_type -> google.protobuf.Empty
	39, // 60: google.cloud.tasks.v2.CloudTasks.BatchDeleteTasks:output_type -> google.longrunning.Operation
	29, // 61: google.cloud.tasks.v2.CloudTasks.RunTask:output_type -> google.cloud.tasks.v2.Task
	31, // 62: google.cloud.tasks.v2.CloudTasks.UpdateCmekConfig:output_type -> google.cloud.tasks.v2.CmekConfig
	31, // 63: google.cloud.tasks.v2.CloudTasks.GetCmekConfig:output_type -> google.cloud.tasks.v2.CmekConfig
...
func file_google_cloud_tasks_v2_cloudtasks_proto_init() {
	...
	file_google_cloud_tasks_v2_cmek_config_proto_init()
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_google_cloud_tasks_v2_cloudtasks_proto_enumTypes,
