...
func file_google_cloud_tasks_v2_task_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_tasks_v2_task_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Task); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_cloud_tasks_v2_task_proto_msgTypes[1].Exporter = func(v any, i int) any {
