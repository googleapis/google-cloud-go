...
func file_google_cloud_tasks_v2beta3_target_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_tasks_v2beta3_target_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_tasks_v2beta3_target_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_tasks_v2beta3_target_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_tasks_v2beta3_target_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_tasks_v2beta3_target_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_tasks_v2beta3_target_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_tasks_v2beta3_target_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_google_cloud_tasks_v2beta3_target_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*HttpTarget_OauthToken)(nil),
		(*HttpTarget_OidcToken)(nil),
	}
	file_google_cloud_tasks_v2beta3_target_proto_msgTypes[5].OneofWrappers = []interface{}{
