...
const file_google_cloud_tasks_v2beta3_target_proto_rawDesc = "" +
	"\n" +
	"'google/cloud/tasks/v2beta3/target.proto\x12\x1agoogle.cloud.tasks.v2beta3\"9\n" +
	...
	"\vUriOverride\x12K\n" +
	"\x06scheme\x18\x01 \x01(\x0e2..google.cloud.tasks.v2beta3.UriOverride.SchemeH\x00R\x06scheme\x88\x01\x01\x12\x17\n" +
	"\x04host\x18\x02 \x01(\tH\x01R\x04host\x88\x01\x01\x12\x17\n" +
	"\x04port\x18\x03 \x01(\x03H\x02R\x04port\x88\x01\x01\x12M\n" +
	"\rpath_override\x18\x04 \x01(\v2(.google.cloud.tasks.v2beta3.PathOverrideR\fpathOverride\x12P\n" +
	"\x0equery_override\x18\x05 \x01(\v2).google.cloud.tasks.v2beta3.QueryOverrideR\rqueryOverride\x12y\n" +
	"\x19uri_override_enforce_mode\x18\x06 \x01(\x0e2>.google.cloud.tasks.v2beta3.UriOverride.UriOverrideEnforceModeR\x16uriOverrideEnforceMode\"5\n" +
	"\x06Scheme\x12\x16\n" +
	...
	"\n" +
	"HttpTarget\x12J\n" +
	"\furi_override\x18\x01 \x01(\v2'.google.cloud.tasks.v2beta3.UriOverrideR\vuriOverride\x12G\n" +
	"\vhttp_method\x18\x02 \x01(\x0e2&.google.cloud.tasks.v2beta3.HttpMethodR\n" +
	"httpMethod\x12`\n" +
	"\x10header_overrides\x18\x03 \x03(\v25.google.cloud.tasks.v2beta3.HttpTarget.HeaderOverrideR\x0fheaderOverrides\x12I\n" +
	"\voauth_token\x18\x05 \x01(\v2&.google.cloud.tasks.v2beta3.OAuthTokenH\x00R\n" +
	"oauthToken\x12F\n" +
	"\n" +
	"oidc_token\x18\x06 \x01(\v2%.google.cloud.tasks.v2beta3.OidcTokenH\x00R\toidcToken\x1a0\n" +
	"\x06Header\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x1aW\n" +
	"\x0eHeaderOverride\x12E\n" +
	"\x06header\x18\x01 \x01(\v2-.google.cloud.tasks.v2beta3.HttpTarget.HeaderR\x06headerB\x16\n" +
	"\x14authorization_header\"\xb3\x03\n" +
	"\vHttpRequest\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12G\n" +
	"\vhttp_method\x18\x02 \x01(\x0e2&.google.cloud.tasks.v2beta3.HttpMethodR\n" +
	"httpMethod\x12N\n" +
	"\aheaders\x18\x03 \x03(\v24.google.cloud.tasks.v2beta3.HttpRequest.HeadersEntryR\aheaders\x12\x12\n" +
	"\x04body\x18\x04 \x01(\fR\x04body\x12I\n" +
	"\voauth_token\x18\x05 \x01(\v2&.google.cloud.tasks.v2beta3.OAuthTokenH\x00R\n" +
	"oauthToken\x12F\n" +
	"\n" +
	"oidc_token\x18\x06 \x01(\v2%.google.cloud.tasks.v2beta3.OidcTokenH\x00R\toidcToken\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x16\n" +
	"\x14authorization_header\"\x81\x01\n" +
	"\x12AppEngineHttpQueue\x12k\n" +
	"\x1bapp_engine_routing_override\x18\x01 \x01(\v2,.google.cloud.tasks.v2beta3.AppEngineRoutingR\x18appEngineRoutingOverride\"\x87\x03\n" +
	"\x14AppEngineHttpRequest\x12G\n" +
	"\vhttp_method\x18\x01 \x01(\x0e2&.google.cloud.tasks.v2beta3.HttpMethodR\n" +
	"httpMethod\x12Z\n" +
	"\x12app_engine_routing\x18\x02 \x01(\v2,.google.cloud.tasks.v2beta3.AppEngineRoutingR\x10appEngineRouting\x12!\n" +
	"\frelative_uri\x18\x03 \x01(\tR\vrelativeUri\x12W\n" +
	"\aheaders\x18\x04 \x03(\v2=.google.cloud.tasks.v2beta3.AppEngineHttpRequest.HeadersEntryR\aheaders\x12\x12\n" +
	...
	"\aOPTIONS\x10\aBt\n" +
	"\x1ecom.google.cloud.tasks.v2beta3B\vTargetProtoP\x01ZCcloud.google.com/go/cloudtasks/apiv2beta3/cloudtaskspb;cloudtaskspbb\x06proto3"

var (
	file_google_cloud_tasks_v2beta3_target_proto_rawDescOnce sync.Once
	file_google_cloud_tasks_v2beta3_target_proto_rawDescData []byte
)
...
func file_google_cloud_tasks_v2beta3_target_proto_rawDescGZIP() []byte {
	file_google_cloud_tasks_v2beta3_target_proto_rawDescOnce.Do(func() {
		file_google_cloud_tasks_v2beta3_target_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_tasks_v2beta3_target_proto_rawDesc), len(file_google_cloud_tasks_v2beta3_target_proto_rawDesc)))
	})
...
func file_google_cloud_tasks_v2beta3_target_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_tasks_v2beta3_target_proto_rawDesc), len(file_google_cloud_tasks_v2beta3_target_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   0,
