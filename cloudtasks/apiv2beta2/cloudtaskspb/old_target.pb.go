...
const file_google_cloud_tasks_v2beta2_old_target_proto_rawDesc = "" +
	"\n" +
...
func file_google_cloud_tasks_v2beta2_old_target_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_tasks_v2beta2_old_target_proto_rawDesc), len(file_google_cloud_tasks_v2beta2_old_target_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
