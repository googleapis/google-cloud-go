...
type AclIterator struct {
	...
	InternalFetch func(pageSize int, pageToken string) (results []*managedkafkapb.Acl, nextPageToken string, err error)
}
...
func (it *AclIterator) bufLen() int {
	return len(it.items)
}

func (it *AclIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type ConnectClusterIterator struct {
	...
	// The number of results is no greater than pageSize.
	// If there are no more results, nextPageToken is empty and err is nil.
	InternalFetch func(pageSize int, pageToken string) (results []*managedkafkapb.ConnectCluster, nextPageToken string, err error)
}
...
func (it *ConnectClusterIterator) Next() (*managedkafkapb.ConnectCluster, error) {
	var item *managedkafkapb.ConnectCluster
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *ConnectClusterIterator) bufLen() int {
	return len(it.items)
}

func (it *ConnectClusterIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type ConnectorIterator struct {
	items    []*managedkafkapb.Connector
	pageInfo *iterator.PageInfo
	nextFunc func() error
	...
	// The number of results is no greater than pageSize.
	// If there are no more results, nextPageToken is empty and err is nil.
	InternalFetch func(pageSize int, pageToken string) (results []*managedkafkapb.Connector, nextPageToken string, err error)
}
...
func (it *ConnectorIterator) Next() (*managedkafkapb.Connector, error) {
	var item *managedkafkapb.Connector
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
