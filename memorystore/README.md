...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/memorystore.svg)](https://pkg.go.dev/cloud.google.com/go/memorystore)

Go Client Library for Memorystore API.
