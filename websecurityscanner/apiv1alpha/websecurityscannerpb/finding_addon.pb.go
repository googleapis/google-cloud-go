...
var file_google_cloud_websecurityscanner_v1alpha_finding_addon_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x9f, 0x01, 0x0a,
...
var file_google_cloud_websecurityscanner_v1alpha_finding_addon_proto_goTypes = []any{
...
func file_google_cloud_websecurityscanner_v1alpha_finding_addon_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_websecurityscanner_v1alpha_finding_addon_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_websecurityscanner_v1alpha_finding_addon_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_websecurityscanner_v1alpha_finding_addon_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_websecurityscanner_v1alpha_finding_addon_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_cloud_websecurityscanner_v1alpha_finding_addon_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Xss); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_cloud_websecurityscanner_v1alpha_finding_addon_proto_msgTypes[5].Exporter = func(v any, i int) any {
