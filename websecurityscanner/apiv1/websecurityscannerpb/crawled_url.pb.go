...
const file_google_cloud_websecurityscanner_v1_crawled_url_proto_rawDesc = "" +
	"\n" +
	...
	"\x04body\x18\x03 \x01(\tR\x04bodyB\x85\x02\n" +
	"&com.google.cloud.websecurityscanner.v1B\x0fCrawledUrlProtoP\x01ZVcloud.google.com/go/websecurityscanner/apiv1/websecurityscannerpb;websecurityscannerpb\xaa\x02\"Google.Cloud.WebSecurityScanner.V1\xca\x02\"Google\\Cloud\\WebSecurityScanner\\V1\xea\x02%Google::Cloud::WebSecurityScanner::V1b\x06proto3"

var (
	file_google_cloud_websecurityscanner_v1_crawled_url_proto_rawDescOnce sync.Once
	file_google_cloud_websecurityscanner_v1_crawled_url_proto_rawDescData []byte
)
...
func file_google_cloud_websecurityscanner_v1_crawled_url_proto_rawDescGZIP() []byte {
	file_google_cloud_websecurityscanner_v1_crawled_url_proto_rawDescOnce.Do(func() {
		file_google_cloud_websecurityscanner_v1_crawled_url_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_websecurityscanner_v1_crawled_url_proto_rawDesc), len(file_google_cloud_websecurityscanner_v1_crawled_url_proto_rawDesc)))
	})
...
func file_google_cloud_websecurityscanner_v1_crawled_url_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_websecurityscanner_v1_crawled_url_proto_rawDesc), len(file_google_cloud_websecurityscanner_v1_crawled_url_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
