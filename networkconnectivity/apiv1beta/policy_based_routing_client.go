...
func NewPolicyBasedRoutingClient(ctx context.Context, opts ...option.ClientOption) (*PolicyBasedRoutingClient, error) {
	...
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		clientOpts = append(clientOpts, internaloption.WithTelemetryAttributes(map[string]string{
			...
			"gcp.client.artifact": "cloud.google.com/go/networkconnectivity/apiv1beta",
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.ListPolicyBasedRoutes = append(client.CallOptions.ListPolicyBasedRoutes, gax.WithClientMetrics(metrics))
		client.CallOptions.GetPolicyBasedRoute = append(client.CallOptions.GetPolicyBasedRoute, gax.WithClientMetrics(metrics))
		client.CallOptions.CreatePolicyBasedRoute = append(client.CallOptions.CreatePolicyBasedRoute, gax.WithClientMetrics(metrics))
		client.CallOptions.DeletePolicyBasedRoute = append(client.CallOptions.DeletePolicyBasedRoute, gax.WithClientMetrics(metrics))
...
func (c *policyBasedRoutingGRPCClient) ListPolicyBasedRoutes(ctx context.Context, req *networkconnectivitypb.ListPolicyBasedRoutesRequest, opts ...gax.CallOption) *PolicyBasedRouteIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*networkconnectivitypb.PolicyBasedRoute, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.policyBasedRoutingClient.ListPolicyBasedRoutes, req, settings.GRPC, c.logger, "ListPolicyBasedRoutes")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *policyBasedRoutingGRPCClient) GetPolicyBasedRoute(ctx context.Context, req *networkconnectivitypb.GetPolicyBasedRouteRequest, opts ...gax.CallOption) (*networkconnectivitypb.PolicyBasedRoute, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.policyBasedRoutingClient.GetPolicyBasedRoute, req, settings.GRPC, c.logger, "GetPolicyBasedRoute")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *policyBasedRoutingGRPCClient) CreatePolicyBasedRoute(ctx context.Context, req *networkconnectivitypb.CreatePolicyBasedRouteRequest, opts ...gax.CallOption) (*CreatePolicyBasedRouteOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.policyBasedRoutingClient.CreatePolicyBasedRoute, req, settings.GRPC, c.logger, "CreatePolicyBasedRoute")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *policyBasedRoutingGRPCClient) DeletePolicyBasedRoute(ctx context.Context, req *networkconnectivitypb.DeletePolicyBasedRouteRequest, opts ...gax.CallOption) (*DeletePolicyBasedRouteOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.policyBasedRoutingClient.DeletePolicyBasedRoute, req, settings.GRPC, c.logger, "DeletePolicyBasedRoute")
		return err
	}, opts...)
	if err != nil {
		return nil, err
