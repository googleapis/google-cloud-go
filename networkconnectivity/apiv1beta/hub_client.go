...
type internalHubClient interface {
	...
	CreateGatewayAdvertisedRoute(context.Context, *networkconnectivitypb.CreateGatewayAdvertisedRouteRequest, ...gax.CallOption) (*CreateGatewayAdvertisedRouteOperation, error)
	CreateGatewayAdvertisedRouteOperation(name string) *CreateGatewayAdvertisedRouteOperation
	GetGatewayAdvertisedRoute(context.Context, *networkconnectivitypb.GetGatewayAdvertisedRouteRequest, ...gax.CallOption) (*networkconnectivitypb.GatewayAdvertisedRoute, error)
	ListGatewayAdvertisedRoutes(context.Context, *networkconnectivitypb.ListGatewayAdvertisedRoutesRequest, ...gax.CallOption) *GatewayAdvertisedRouteIterator
	UpdateGatewayAdvertisedRoute(context.Context, *networkconnectivitypb.UpdateGatewayAdvertisedRouteRequest, ...gax.CallOption) (*UpdateGatewayAdvertisedRouteOperation, error)
	UpdateGatewayAdvertisedRouteOperation(name string) *UpdateGatewayAdvertisedRouteOperation
	DeleteGatewayAdvertisedRoute(context.Context, *networkconnectivitypb.DeleteGatewayAdvertisedRouteRequest, ...gax.CallOption) (*DeleteGatewayAdvertisedRouteOperation, error)
	DeleteGatewayAdvertisedRouteOperation(name string) *DeleteGatewayAdvertisedRouteOperation
...
// CreateGatewayAdvertisedRoute create a GatewayAdvertisedRoute
func (c *HubClient) CreateGatewayAdvertisedRoute(ctx context.Context, req *networkconnectivitypb.CreateGatewayAdvertisedRouteRequest, opts ...gax.CallOption) (*CreateGatewayAdvertisedRouteOperation, error) {
	return c.internalClient.CreateGatewayAdvertisedRoute(ctx, req, opts...)
}

// CreateGatewayAdvertisedRouteOperation returns a new CreateGatewayAdvertisedRouteOperation from a given name.
// The name must be that of a previously created CreateGatewayAdvertisedRouteOperation, possibly from a different process.
func (c *HubClient) CreateGatewayAdvertisedRouteOperation(name string) *CreateGatewayAdvertisedRouteOperation {
	return c.internalClient.CreateGatewayAdvertisedRouteOperation(name)
}

// GetGatewayAdvertisedRoute get a GatewayAdvertisedRoute
func (c *HubClient) GetGatewayAdvertisedRoute(ctx context.Context, req *networkconnectivitypb.GetGatewayAdvertisedRouteRequest, opts ...gax.CallOption) (*networkconnectivitypb.GatewayAdvertisedRoute, error) {
	return c.internalClient.GetGatewayAdvertisedRoute(ctx, req, opts...)
}

// ListGatewayAdvertisedRoutes list GatewayAdvertisedRoutes
func (c *HubClient) ListGatewayAdvertisedRoutes(ctx context.Context, req *networkconnectivitypb.ListGatewayAdvertisedRoutesRequest, opts ...gax.CallOption) *GatewayAdvertisedRouteIterator {
	return c.internalClient.ListGatewayAdvertisedRoutes(ctx, req, opts...)
}

// UpdateGatewayAdvertisedRoute update a GatewayAdvertisedRoute
func (c *HubClient) UpdateGatewayAdvertisedRoute(ctx context.Context, req *networkconnectivitypb.UpdateGatewayAdvertisedRouteRequest, opts ...gax.CallOption) (*UpdateGatewayAdvertisedRouteOperation, error) {
	return c.internalClient.UpdateGatewayAdvertisedRoute(ctx, req, opts...)
}

// UpdateGatewayAdvertisedRouteOperation returns a new UpdateGatewayAdvertisedRouteOperation from a given name.
// The name must be that of a previously created UpdateGatewayAdvertisedRouteOperation, possibly from a different process.
func (c *HubClient) UpdateGatewayAdvertisedRouteOperation(name string) *UpdateGatewayAdvertisedRouteOperation {
	return c.internalClient.UpdateGatewayAdvertisedRouteOperation(name)
}

// DeleteGatewayAdvertisedRoute delete a GatewayAdvertisedRoute
func (c *HubClient) DeleteGatewayAdvertisedRoute(ctx context.Context, req *networkconnectivitypb.DeleteGatewayAdvertisedRouteRequest, opts ...gax.CallOption) (*DeleteGatewayAdvertisedRouteOperation, error) {
	return c.internalClient.DeleteGatewayAdvertisedRoute(ctx, req, opts...)
}

// DeleteGatewayAdvertisedRouteOperation returns a new DeleteGatewayAdvertisedRouteOperation from a given name.
// The name must be that of a previously created DeleteGatewayAdvertisedRouteOperation, possibly from a different process.
func (c *HubClient) DeleteGatewayAdvertisedRouteOperation(name string) *DeleteGatewayAdvertisedRouteOperation {
	return c.internalClient.DeleteGatewayAdvertisedRouteOperation(name)
}
...
func NewHubClient(ctx context.Context, opts ...option.ClientOption) (*HubClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.CreateGatewayAdvertisedRoute = append(client.CallOptions.CreateGatewayAdvertisedRoute, gax.WithClientMetrics(metrics))
		client.CallOptions.GetGatewayAdvertisedRoute = append(client.CallOptions.GetGatewayAdvertisedRoute, gax.WithClientMetrics(metrics))
		client.CallOptions.ListGatewayAdvertisedRoutes = append(client.CallOptions.ListGatewayAdvertisedRoutes, gax.WithClientMetrics(metrics))
		client.CallOptions.UpdateGatewayAdvertisedRoute = append(client.CallOptions.UpdateGatewayAdvertisedRoute, gax.WithClientMetrics(metrics))
		client.CallOptions.DeleteGatewayAdvertisedRoute = append(client.CallOptions.DeleteGatewayAdvertisedRoute, gax.WithClientMetrics(metrics))
...
func (c *hubGRPCClient) UpdateHub(ctx context.Context, req *networkconnectivitypb.UpdateHubRequest, opts ...gax.CallOption) (*UpdateHubOperation, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.networkconnectivity.v1beta.HubService/UpdateHub")
	}
...
func (c *hubGRPCClient) UpdateSpoke(ctx context.Context, req *networkconnectivitypb.UpdateSpokeRequest, opts ...gax.CallOption) (*UpdateSpokeOperation, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.networkconnectivity.v1beta.HubService/UpdateSpoke")
	}
...
func (c *hubGRPCClient) UpdateGroup(ctx context.Context, req *networkconnectivitypb.UpdateGroupRequest, opts ...gax.CallOption) (*UpdateGroupOperation, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.networkconnectivity.v1beta.HubService/UpdateGroup")
	}
...
func (c *hubGRPCClient) CreateGatewayAdvertisedRoute(ctx context.Context, req *networkconnectivitypb.CreateGatewayAdvertisedRouteRequest, opts ...gax.CallOption) (*CreateGatewayAdvertisedRouteOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}
	...
	opts = append((*c.CallOptions).CreateGatewayAdvertisedRoute[0:len((*c.CallOptions).CreateGatewayAdvertisedRoute):len((*c.CallOptions).CreateGatewayAdvertisedRoute)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.hubClient.CreateGatewayAdvertisedRoute, req, settings.GRPC, c.logger, "CreateGatewayAdvertisedRoute")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *hubGRPCClient) GetGatewayAdvertisedRoute(ctx context.Context, req *networkconnectivitypb.GetGatewayAdvertisedRouteRequest, opts ...gax.CallOption) (*networkconnectivitypb.GatewayAdvertisedRoute, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
	...
	opts = append((*c.CallOptions).GetGatewayAdvertisedRoute[0:len((*c.CallOptions).GetGatewayAdvertisedRoute):len((*c.CallOptions).GetGatewayAdvertisedRoute)], opts...)
	var resp *networkconnectivitypb.GatewayAdvertisedRoute
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.hubClient.GetGatewayAdvertisedRoute, req, settings.GRPC, c.logger, "GetGatewayAdvertisedRoute")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *hubGRPCClient) ListGatewayAdvertisedRoutes(ctx context.Context, req *networkconnectivitypb.ListGatewayAdvertisedRoutesRequest, opts ...gax.CallOption) *GatewayAdvertisedRouteIterator {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*networkconnectivitypb.GatewayAdvertisedRoute, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.hubClient.ListGatewayAdvertisedRoutes, req, settings.GRPC, c.logger, "ListGatewayAdvertisedRoutes")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
		...
		it.Response = resp
		return resp.GetGatewayAdvertisedRoutes(), resp.GetNextPageToken(), nil
	}
	fetch := func(pageSize int, pageToken string) (string, error) {
		items, nextPageToken, err := it.InternalFetch(pageSize, pageToken)
		if err != nil {
...
func (c *hubGRPCClient) UpdateGatewayAdvertisedRoute(ctx context.Context, req *networkconnectivitypb.UpdateGatewayAdvertisedRouteRequest, opts ...gax.CallOption) (*UpdateGatewayAdvertisedRouteOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "gateway_advertised_route.name", url.QueryEscape(req.GetGatewayAdvertisedRoute().GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.networkconnectivity.v1beta.HubService/UpdateGatewayAdvertisedRoute")
	}
	opts = append((*c.CallOptions).UpdateGatewayAdvertisedRoute[0:len((*c.CallOptions).UpdateGatewayAdvertisedRoute):len((*c.CallOptions).UpdateGatewayAdvertisedRoute)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.hubClient.UpdateGatewayAdvertisedRoute, req, settings.GRPC, c.logger, "UpdateGatewayAdvertisedRoute")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *hubGRPCClient) DeleteGatewayAdvertisedRoute(ctx context.Context, req *networkconnectivitypb.DeleteGatewayAdvertisedRouteRequest, opts ...gax.CallOption) (*DeleteGatewayAdvertisedRouteOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
	...
	opts = append((*c.CallOptions).DeleteGatewayAdvertisedRoute[0:len((*c.CallOptions).DeleteGatewayAdvertisedRoute):len((*c.CallOptions).DeleteGatewayAdvertisedRoute)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.hubClient.DeleteGatewayAdvertisedRoute, req, settings.GRPC, c.logger, "DeleteGatewayAdvertisedRoute")
		return err
	}, opts...)
	if err != nil {
		return nil, err
