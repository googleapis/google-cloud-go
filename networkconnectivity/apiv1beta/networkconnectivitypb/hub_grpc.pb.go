...
const (
	HubService_ListHubs_FullMethodName                     = "/google.cloud.networkconnectivity.v1beta.HubService/ListHubs"
	HubService_GetHub_FullMethodName                       = "/google.cloud.networkconnectivity.v1beta.HubService/GetHub"
	HubService_CreateHub_FullMethodName                    = "/google.cloud.networkconnectivity.v1beta.HubService/CreateHub"
	HubService_UpdateHub_FullMethodName                    = "/google.cloud.networkconnectivity.v1beta.HubService/UpdateHub"
	HubService_DeleteHub_FullMethodName                    = "/google.cloud.networkconnectivity.v1beta.HubService/DeleteHub"
	HubService_ListHubSpokes_FullMethodName                = "/google.cloud.networkconnectivity.v1beta.HubService/ListHubSpokes"
	HubService_QueryHubStatus_FullMethodName               = "/google.cloud.networkconnectivity.v1beta.HubService/QueryHubStatus"
	HubService_ListSpokes_FullMethodName                   = "/google.cloud.networkconnectivity.v1beta.HubService/ListSpokes"
	HubService_GetSpoke_FullMethodName                     = "/google.cloud.networkconnectivity.v1beta.HubService/GetSpoke"
	HubService_CreateSpoke_FullMethodName                  = "/google.cloud.networkconnectivity.v1beta.HubService/CreateSpoke"
	HubService_UpdateSpoke_FullMethodName                  = "/google.cloud.networkconnectivity.v1beta.HubService/UpdateSpoke"
	HubService_RejectHubSpoke_FullMethodName               = "/google.cloud.networkconnectivity.v1beta.HubService/RejectHubSpoke"
	HubService_AcceptHubSpoke_FullMethodName               = "/google.cloud.networkconnectivity.v1beta.HubService/AcceptHubSpoke"
	HubService_AcceptSpokeUpdate_FullMethodName            = "/google.cloud.networkconnectivity.v1beta.HubService/AcceptSpokeUpdate"
	HubService_RejectSpokeUpdate_FullMethodName            = "/google.cloud.networkconnectivity.v1beta.HubService/RejectSpokeUpdate"
	HubService_DeleteSpoke_FullMethodName                  = "/google.cloud.networkconnectivity.v1beta.HubService/DeleteSpoke"
	HubService_GetRouteTable_FullMethodName                = "/google.cloud.networkconnectivity.v1beta.HubService/GetRouteTable"
	HubService_GetRoute_FullMethodName                     = "/google.cloud.networkconnectivity.v1beta.HubService/GetRoute"
	HubService_ListRoutes_FullMethodName                   = "/google.cloud.networkconnectivity.v1beta.HubService/ListRoutes"
	HubService_ListRouteTables_FullMethodName              = "/google.cloud.networkconnectivity.v1beta.HubService/ListRouteTables"
	HubService_GetGroup_FullMethodName                     = "/google.cloud.networkconnectivity.v1beta.HubService/GetGroup"
	HubService_ListGroups_FullMethodName                   = "/google.cloud.networkconnectivity.v1beta.HubService/ListGroups"
	HubService_UpdateGroup_FullMethodName                  = "/google.cloud.networkconnectivity.v1beta.HubService/UpdateGroup"
	HubService_CreateGatewayAdvertisedRoute_FullMethodName = "/google.cloud.networkconnectivity.v1beta.HubService/CreateGatewayAdvertisedRoute"
	HubService_GetGatewayAdvertisedRoute_FullMethodName    = "/google.cloud.networkconnectivity.v1beta.HubService/GetGatewayAdvertisedRoute"
	HubService_ListGatewayAdvertisedRoutes_FullMethodName  = "/google.cloud.networkconnectivity.v1beta.HubService/ListGatewayAdvertisedRoutes"
	HubService_UpdateGatewayAdvertisedRoute_FullMethodName = "/google.cloud.networkconnectivity.v1beta.HubService/UpdateGatewayAdvertisedRoute"
	HubService_DeleteGatewayAdvertisedRoute_FullMethodName = "/google.cloud.networkconnectivity.v1beta.HubService/DeleteGatewayAdvertisedRoute"
)
...
type HubServiceClient interface {
	...
	CreateGatewayAdvertisedRoute(ctx context.Context, in *CreateGatewayAdvertisedRouteRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error)
	// Get a GatewayAdvertisedRoute
	GetGatewayAdvertisedRoute(ctx context.Context, in *GetGatewayAdvertisedRouteRequest, opts ...grpc.CallOption) (*GatewayAdvertisedRoute, error)
	// List GatewayAdvertisedRoutes
	ListGatewayAdvertisedRoutes(ctx context.Context, in *ListGatewayAdvertisedRoutesRequest, opts ...grpc.CallOption) (*ListGatewayAdvertisedRoutesResponse, error)
	// Update a GatewayAdvertisedRoute
	UpdateGatewayAdvertisedRoute(ctx context.Context, in *UpdateGatewayAdvertisedRouteRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error)
	// Delete a GatewayAdvertisedRoute
	DeleteGatewayAdvertisedRoute(ctx context.Context, in *DeleteGatewayAdvertisedRouteRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error)
}
...
func (c *hubServiceClient) CreateGatewayAdvertisedRoute(ctx context.Context, in *CreateGatewayAdvertisedRouteRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, HubService_CreateGatewayAdvertisedRoute_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hubServiceClient) GetGatewayAdvertisedRoute(ctx context.Context, in *GetGatewayAdvertisedRouteRequest, opts ...grpc.CallOption) (*GatewayAdvertisedRoute, error) {
	out := new(GatewayAdvertisedRoute)
	err := c.cc.Invoke(ctx, HubService_GetGatewayAdvertisedRoute_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hubServiceClient) ListGatewayAdvertisedRoutes(ctx context.Context, in *ListGatewayAdvertisedRoutesRequest, opts ...grpc.CallOption) (*ListGatewayAdvertisedRoutesResponse, error) {
	out := new(ListGatewayAdvertisedRoutesResponse)
	err := c.cc.Invoke(ctx, HubService_ListGatewayAdvertisedRoutes_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hubServiceClient) UpdateGatewayAdvertisedRoute(ctx context.Context, in *UpdateGatewayAdvertisedRouteRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, HubService_UpdateGatewayAdvertisedRoute_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hubServiceClient) DeleteGatewayAdvertisedRoute(ctx context.Context, in *DeleteGatewayAdvertisedRouteRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, HubService_DeleteGatewayAdvertisedRoute_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HubServiceServer interface {
	...
	// Create a GatewayAdvertisedRoute
	CreateGatewayAdvertisedRoute(context.Context, *CreateGatewayAdvertisedRouteRequest) (*longrunningpb.Operation, error)
	// Get a GatewayAdvertisedRoute
	GetGatewayAdvertisedRoute(context.Context, *GetGatewayAdvertisedRouteRequest) (*GatewayAdvertisedRoute, error)
	// List GatewayAdvertisedRoutes
	ListGatewayAdvertisedRoutes(context.Context, *ListGatewayAdvertisedRoutesRequest) (*ListGatewayAdvertisedRoutesResponse, error)
	// Update a GatewayAdvertisedRoute
	UpdateGatewayAdvertisedRoute(context.Context, *UpdateGatewayAdvertisedRouteRequest) (*longrunningpb.Operation, error)
	// Delete a GatewayAdvertisedRoute
	DeleteGatewayAdvertisedRoute(context.Context, *DeleteGatewayAdvertisedRouteRequest) (*longrunningpb.Operation, error)
}
...
func (UnimplementedHubServiceServer) CreateGatewayAdvertisedRoute(context.Context, *CreateGatewayAdvertisedRouteRequest) (*longrunningpb.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateGatewayAdvertisedRoute not implemented")
}
func (UnimplementedHubServiceServer) GetGatewayAdvertisedRoute(context.Context, *GetGatewayAdvertisedRouteRequest) (*GatewayAdvertisedRoute, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetGatewayAdvertisedRoute not implemented")
}
func (UnimplementedHubServiceServer) ListGatewayAdvertisedRoutes(context.Context, *ListGatewayAdvertisedRoutesRequest) (*ListGatewayAdvertisedRoutesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListGatewayAdvertisedRoutes not implemented")
}
func (UnimplementedHubServiceServer) UpdateGatewayAdvertisedRoute(context.Context, *UpdateGatewayAdvertisedRouteRequest) (*longrunningpb.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateGatewayAdvertisedRoute not implemented")
}
func (UnimplementedHubServiceServer) DeleteGatewayAdvertisedRoute(context.Context, *DeleteGatewayAdvertisedRouteRequest) (*longrunningpb.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteGatewayAdvertisedRoute not implemented")
}
...
func _HubService_CreateGatewayAdvertisedRoute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateGatewayAdvertisedRouteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HubServiceServer).CreateGatewayAdvertisedRoute(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HubService_CreateGatewayAdvertisedRoute_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HubServiceServer).CreateGatewayAdvertisedRoute(ctx, req.(*CreateGatewayAdvertisedRouteRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _HubService_GetGatewayAdvertisedRoute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetGatewayAdvertisedRouteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HubServiceServer).GetGatewayAdvertisedRoute(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HubService_GetGatewayAdvertisedRoute_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HubServiceServer).GetGatewayAdvertisedRoute(ctx, req.(*GetGatewayAdvertisedRouteRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _HubService_ListGatewayAdvertisedRoutes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListGatewayAdvertisedRoutesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HubServiceServer).ListGatewayAdvertisedRoutes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HubService_ListGatewayAdvertisedRoutes_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HubServiceServer).ListGatewayAdvertisedRoutes(ctx, req.(*ListGatewayAdvertisedRoutesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _HubService_UpdateGatewayAdvertisedRoute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateGatewayAdvertisedRouteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HubServiceServer).UpdateGatewayAdvertisedRoute(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HubService_UpdateGatewayAdvertisedRoute_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HubServiceServer).UpdateGatewayAdvertisedRoute(ctx, req.(*UpdateGatewayAdvertisedRouteRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _HubService_DeleteGatewayAdvertisedRoute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteGatewayAdvertisedRouteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HubServiceServer).DeleteGatewayAdvertisedRoute(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HubService_DeleteGatewayAdvertisedRoute_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HubServiceServer).DeleteGatewayAdvertisedRoute(ctx, req.(*DeleteGatewayAdvertisedRouteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HubService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateGatewayAdvertisedRoute",
			Handler:    _HubService_CreateGatewayAdvertisedRoute_Handler,
		},
		{
			MethodName: "GetGatewayAdvertisedRoute",
			Handler:    _HubService_GetGatewayAdvertisedRoute_Handler,
		},
		{
			MethodName: "ListGatewayAdvertisedRoutes",
			Handler:    _HubService_ListGatewayAdvertisedRoutes_Handler,
		},
		{
			MethodName: "UpdateGatewayAdvertisedRoute",
			Handler:    _HubService_UpdateGatewayAdvertisedRoute_Handler,
		},
		{
			MethodName: "DeleteGatewayAdvertisedRoute",
			Handler:    _HubService_DeleteGatewayAdvertisedRoute_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "google/cloud/networkconnectivity/v1beta/hub.proto",
}
