...
type DataDiscoverySpec_StorageConfig struct {
	...
	UnstructuredDataOptions *DataDiscoverySpec_StorageConfig_UnstructuredDataOptions `protobuf:"bytes,5,opt,name=unstructured_data_options,json=unstructuredDataOptions,proto3" json:"unstructured_data_options,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *DataDiscoverySpec_StorageConfig) GetUnstructuredDataOptions() *DataDiscoverySpec_StorageConfig_UnstructuredDataOptions {
	if x != nil {
		return x.UnstructuredDataOptions
	}
	return nil
}
...
type DataDiscoverySpec_StorageConfig_UnstructuredDataOptions struct {
	...
	SemanticInferenceEnabled bool `protobuf:"varint,2,opt,name=semantic_inference_enabled,json=semanticInferenceEnabled,proto3" json:"semantic_inference_enabled,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}

func (x *DataDiscoverySpec_StorageConfig_UnstructuredDataOptions) Reset() {
	*x = DataDiscoverySpec_StorageConfig_UnstructuredDataOptions{}
	mi := &file_google_cloud_dataplex_v1_data_discovery_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DataDiscoverySpec_StorageConfig_UnstructuredDataOptions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DataDiscoverySpec_StorageConfig_UnstructuredDataOptions) ProtoMessage() {}

func (x *DataDiscoverySpec_StorageConfig_UnstructuredDataOptions) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dataplex_v1_data_discovery_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DataDiscoverySpec_StorageConfig_UnstructuredDataOptions.ProtoReflect.Descriptor instead.
func (*DataDiscoverySpec_StorageConfig_UnstructuredDataOptions) Descriptor() ([]byte, []int) {
	return file_google_cloud_dataplex_v1_data_discovery_proto_rawDescGZIP(), []int{0, 1, 2}
}

func (x *DataDiscoverySpec_StorageConfig_UnstructuredDataOptions) GetSemanticInferenceEnabled() bool {
	if x != nil {
		return x.SemanticInferenceEnabled
	}
	return false
}
...
func (x *DataDiscoveryResult_ScanStatistics) Reset() {
	*x = DataDiscoveryResult_ScanStatistics{}
	mi := &file_google_cloud_dataplex_v1_data_discovery_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_google_cloud_dataplex_v1_data_discovery_proto_rawDesc = "" +
	"\n" +
	"-google/cloud/dataplex/v1/data_discovery.proto\x12\x18google.cloud.dataplex.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\xad\f\n" +
	...
	"csvOptions\x12m\n" +
	"\fjson_options\x18\x04 \x01(\v2E.google.cloud.dataplex.v1.DataDiscoverySpec.StorageConfig.JsonOptionsB\x03\xe0A\x01R\vjsonOptions\x12\x92\x01\n" +
	"\x19unstructured_data_options\x18\x05 \x01(\v2Q.google.cloud.dataplex.v1.DataDiscoverySpec.StorageConfig.UnstructuredDataOptionsB\x03\xe0A\x01R\x17unstructuredDataOptions\x1a\xce\x01\n" +
	"\n" +
	"CsvOptions\x12$\n" +
	...
	"\x17type_inference_disabled\x18\x02 \x01(\bB\x03\xe0A\x01R\x15typeInferenceDisabled\x1a\\\n" +
	"\x17UnstructuredDataOptions\x12A\n" +
	"\x1asemantic_inference_enabled\x18\x02 \x01(\bB\x03\xe0A\x01R\x18semanticInferenceEnabledB\x11\n" +
...
var file_google_cloud_dataplex_v1_data_discovery_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_google_cloud_dataplex_v1_data_discovery_proto_goTypes = []any{
	...
	(*DataDiscoverySpec_StorageConfig_UnstructuredDataOptions)(nil), // 7: google.cloud.dataplex.v1.DataDiscoverySpec.StorageConfig.UnstructuredDataOptions
	(*DataDiscoveryResult_BigQueryPublishing)(nil),                  // 8: google.cloud.dataplex.v1.DataDiscoveryResult.BigQueryPublishing
	(*DataDiscoveryResult_ScanStatistics)(nil),                      // 9: google.cloud.dataplex.v1.DataDiscoveryResult.ScanStatistics
}
var file_google_cloud_dataplex_v1_data_discovery_proto_depIdxs = []int32{
	...
	8, // 2: google.cloud.dataplex.v1.DataDiscoveryResult.bigquery_publishing:type_name -> google.cloud.dataplex.v1.DataDiscoveryResult.BigQueryPublishing
	9, // 3: google.cloud.dataplex.v1.DataDiscoveryResult.scan_statistics:type_name -> google.cloud.dataplex.v1.DataDiscoveryResult.ScanStatistics
	...
	7, // 7: google.cloud.dataplex.v1.DataDiscoverySpec.StorageConfig.unstructured_data_options:type_name -> google.cloud.dataplex.v1.DataDiscoverySpec.StorageConfig.UnstructuredDataOptions
