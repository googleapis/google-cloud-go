...
var file_google_cloud_dataplex_v1_security_proto_goTypes = []interface{}{
...
func file_google_cloud_dataplex_v1_security_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_dataplex_v1_security_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_dataplex_v1_security_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
