...
func file_google_cloud_dataplex_v1_datascans_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_dataplex_v1_datascans_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_dataplex_v1_datascans_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_dataplex_v1_datascans_proto_msgTypes[14].OneofWrappers = []interface{}{
	...
	file_google_cloud_dataplex_v1_datascans_proto_msgTypes[15].OneofWrappers = []interface{}{
