...
// UnimplementedBusinessGlossaryServiceServer can be embedded to have forward compatible implementations.
...
func RegisterBusinessGlossaryServiceServer(s *grpc.Server, srv BusinessGlossaryServiceServer) {
	s.RegisterService(&_BusinessGlossaryService_serviceDesc, srv)
}
...
var _BusinessGlossaryService_serviceDesc = grpc.ServiceDesc{
