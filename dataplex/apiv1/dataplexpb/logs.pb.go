...
const (
	...
	DataQualityScanRuleResult_TEMPLATE_REFERENCE DataQualityScanRuleResult_RuleType = 10
)
...
const file_google_cloud_dataplex_v1_logs_proto_rawDesc = "" +
	...
	"\x13assertion_row_count\x18\r \x01(\x03R\x11assertionRowCount\"\xaa\x02\n" +
	"\bRuleType\x12\x19\n" +
	...
	"\rSQL_ASSERTION\x10\t\x12\x16\n" +
	"\x12TEMPLATE_REFERENCE\x10\n" +
	"\"M\n" +
