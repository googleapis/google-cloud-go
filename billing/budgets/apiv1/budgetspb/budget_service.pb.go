...
const file_google_cloud_billing_budgets_v1_budget_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x06parent\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\x12$billingbudgets.googleapis.com/BudgetR\x06parent\x12D\n" +
	"\x06budget\x18\x02 \x01(\v2'.google.cloud.billing.budgets.v1.BudgetB\x03\xe0A\x02R\x06budget\"\x9d\x01\n" +
	"\x13UpdateBudgetRequest\x12D\n" +
	"\x06budget\x18\x01 \x01(\v2'.google.cloud.billing.budgets.v1.BudgetB\x03\xe0A\x02R\x06budget\x12@\n" +
	...
	"\x13ListBudgetsResponse\x12A\n" +
	"\abudgets\x18\x01 \x03(\v2'.google.cloud.billing.budgets.v1.BudgetR\abudgets\x12&\n" +
	...
	"\fCreateBudget\x124.google.cloud.billing.budgets.v1.CreateBudgetRequest\x1a'.google.cloud.billing.budgets.v1.Budget\"F\xdaA\rparent,budget\x82\xd3\xe4\x93\x020:\x06budget\"&/v1/{parent=billingAccounts/*}/budgets\x12\xc1\x01\n" +
	"\fUpdateBudget\x124.google.cloud.billing.budgets.v1.UpdateBudgetRequest\x1a'.google.cloud.billing.budgets.v1.Budget\"R\xdaA\x12budget,update_mask\x82\xd3\xe4\x93\x027:\x06budget2-/v1/{budget.name=billingAccounts/*/budgets/*}\x12\x9e\x01\n" +
	...
	"\vListBudgets\x123.google.cloud.billing.budgets.v1.ListBudgetsRequest\x1a4.google.cloud.billing.budgets.v1.ListBudgetsResponse\"7\xdaA\x06parent\x82\xd3\xe4\x93\x02(\x12&/v1/{parent=billingAccounts/*}/budgets\x12\x93\x01\n" +
	"\fDeleteBudget\x124.google.cloud.billing.budgets.v1.DeleteBudgetRequest\x1a\x16.google.protobuf.Empty\"5\xdaA\x04name\x82\xd3\xe4\x93\x02(*&/v1/{name=billingAccounts/*/budgets/*}\x1a\x7f\xcaA\x1dbillingbudgets.googleapis.com\xd2A\\https://www.googleapis.com/auth/cloud-billing,https://www.googleapis.com/auth/cloud-platformBz\n" +
...
var (
	...
	file_google_cloud_billing_budgets_v1_budget_service_proto_rawDescData []byte
)
...
func file_google_cloud_billing_budgets_v1_budget_service_proto_rawDescGZIP() []byte {
	file_google_cloud_billing_budgets_v1_budget_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_billing_budgets_v1_budget_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_billing_budgets_v1_budget_service_proto_rawDesc), len(file_google_cloud_billing_budgets_v1_budget_service_proto_rawDesc)))
	})
...
func file_google_cloud_billing_budgets_v1_budget_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_billing_budgets_v1_budget_service_proto_rawDesc), len(file_google_cloud_billing_budgets_v1_budget_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
