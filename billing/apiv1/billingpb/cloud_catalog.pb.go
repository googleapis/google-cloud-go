...
const file_google_cloud_billing_v1_cloud_catalog_proto_rawDesc = "" +
	"\n" +
	...
	"\x14business_entity_name\x18\x04 \x01(\tR\x12businessEntityName:<\xeaA9\n" +
	"#cloudbilling.googleapis.com/Service\x12\x12services/{service}\"\xc5\x03\n" +
	"\x03Sku\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x15\n" +
	"\x06sku_id\x18\x02 \x01(\tR\x05skuId\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12=\n" +
	"\bcategory\x18\x04 \x01(\v2!.google.cloud.billing.v1.CategoryR\bcategory\x12'\n" +
	"\x0fservice_regions\x18\x05 \x03(\tR\x0eserviceRegions\x12G\n" +
	"\fpricing_info\x18\x06 \x03(\v2$.google.cloud.billing.v1.PricingInfoR\vpricingInfo\x122\n" +
	"\x15service_provider_name\x18\a \x01(\tR\x13serviceProviderName\x12G\n" +
	"\fgeo_taxonomy\x18\b \x01(\v2$.google.cloud.billing.v1.GeoTaxonomyR\vgeoTaxonomy:C\xeaA@\n" +
	"\x1fcloudbilling.googleapis.com/Sku\x12\x1dservices/{service}/skus/{sku}\"\xab\x01\n" +
	"\bCategory\x120\n" +
	...
	"\vPricingInfo\x12A\n" +
	"\x0eeffective_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\reffectiveTime\x12\x18\n" +
	"\asummary\x18\x02 \x01(\tR\asummary\x12Y\n" +
	"\x12pricing_expression\x18\x03 \x01(\v2*.google.cloud.billing.v1.PricingExpressionR\x11pricingExpression\x12S\n" +
	"\x10aggregation_info\x18\x04 \x01(\v2(.google.cloud.billing.v1.AggregationInfoR\x0faggregationInfo\x128\n" +
	"\x18currency_conversion_rate\x18\x05 \x01(\x01R\x16currencyConversionRate\"\xe8\x03\n" +
	"\x11PricingExpression\x12\x1d\n" +
	"\n" +
	"usage_unit\x18\x01 \x01(\tR\tusageUnit\x12)\n" +
	"\x10display_quantity\x18\x02 \x01(\x01R\x0fdisplayQuantity\x12V\n" +
	"\ftiered_rates\x18\x03 \x03(\v23.google.cloud.billing.v1.PricingExpression.TierRateR\vtieredRates\x124\n" +
	"\x16usage_unit_description\x18\x04 \x01(\tR\x14usageUnitDescription\x12\x1b\n" +
	"\tbase_unit\x18\x05 \x01(\tR\bbaseUnit\x122\n" +
	"\x15base_unit_description\x18\x06 \x01(\tR\x13baseUnitDescription\x12=\n" +
	"\x1bbase_unit_conversion_factor\x18\a \x01(\x01R\x18baseUnitConversionFactor\x1ak\n" +
	"\bTierRate\x12,\n" +
	"\x12start_usage_amount\x18\x01 \x01(\x01R\x10startUsageAmount\x121\n" +
	"\n" +
	"unit_price\x18\x02 \x01(\v2\x12.google.type.MoneyR\tunitPrice\"\xbd\x03\n" +
	"\x0fAggregationInfo\x12f\n" +
	"\x11aggregation_level\x18\x01 \x01(\x0e29.google.cloud.billing.v1.AggregationInfo.AggregationLevelR\x10aggregationLevel\x12o\n" +
	"\x14aggregation_interval\x18\x02 \x01(\x0e2<.google.cloud.billing.v1.AggregationInfo.AggregationIntervalR\x13aggregationInterval\x12+\n" +
	"\x11aggregation_count\x18\x03 \x01(\x05R\x10aggregationCount\"O\n" +
	"\x10AggregationLevel\x12!\n" +
	"\x1dAGGREGATION_LEVEL_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aACCOUNT\x10\x01\x12\v\n" +
	"\aPROJECT\x10\x02\"S\n" +
	"\x13AggregationInterval\x12$\n" +
	" AGGREGATION_INTERVAL_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05DAILY\x10\x01\x12\v\n" +
	"\aMONTHLY\x10\x02\"\xb2\x01\n" +
	"\vGeoTaxonomy\x12=\n" +
	"\x04type\x18\x01 \x01(\x0e2).google.cloud.billing.v1.GeoTaxonomy.TypeR\x04type\x12\x18\n" +
	"\aregions\x18\x02 \x03(\tR\aregions\"J\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06GLOBAL\x10\x01\x12\f\n" +
	"\bREGIONAL\x10\x02\x12\x12\n" +
	"\x0eMULTI_REGIONAL\x10\x03\"Q\n" +
	"\x13ListServicesRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\"|\n" +
	"\x14ListServicesResponse\x12<\n" +
	"\bservices\x18\x01 \x03(\v2 .google.cloud.billing.v1.ServiceR\bservices\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xa9\x02\n" +
	"\x0fListSkusRequest\x12C\n" +
	"\x06parent\x18\x01 \x01(\tB+\xe0A\x02\xfaA%\n" +
	"#cloudbilling.googleapis.com/ServiceR\x06parent\x129\n" +
	"\n" +
	...
	"\x04skus\x18\x01 \x03(\v2\x1c.google.cloud.billing.v1.SkuR\x04skus\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken2\xde\x03\n" +
	"\fCloudCatalog\x12\x84\x01\n" +
	"\fListServices\x12,.google.cloud.billing.v1.ListServicesRequest\x1a-.google.cloud.billing.v1.ListServicesResponse\"\x17\xdaA\x00\x82\xd3\xe4\x93\x02\x0e\x12\f/v1/services\x12\x8e\x01\n" +
	...
	"\x1bcom.google.cloud.billing.v1B\x11CloudCatalogProtoP\x01Z5cloud.google.com/go/billing/apiv1/billingpb;billingpb\xa2\x02\aCLDCTLG\xaa\x02\x17Google.Cloud.Billing.V1b\x06proto3"

var (
	file_google_cloud_billing_v1_cloud_catalog_proto_rawDescOnce sync.Once
	file_google_cloud_billing_v1_cloud_catalog_proto_rawDescData []byte
)
...
func file_google_cloud_billing_v1_cloud_catalog_proto_rawDescGZIP() []byte {
	file_google_cloud_billing_v1_cloud_catalog_proto_rawDescOnce.Do(func() {
		file_google_cloud_billing_v1_cloud_catalog_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_billing_v1_cloud_catalog_proto_rawDesc), len(file_google_cloud_billing_v1_cloud_catalog_proto_rawDesc)))
	})
...
func file_google_cloud_billing_v1_cloud_catalog_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_billing_v1_cloud_catalog_proto_rawDesc), len(file_google_cloud_billing_v1_cloud_catalog_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   1,
