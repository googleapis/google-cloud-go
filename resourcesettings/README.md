...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/resourcesettings.svg)](https://pkg.go.dev/cloud.google.com/go/resourcesettings)

Go Client Library for Resource Settings API.

## Install

```bash
go get cloud.google.com/go/resourcesettings
```
