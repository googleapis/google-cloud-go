...
var file_google_cloud_networksecurity_v1_tls_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x42, 0xe9, 0x01,
...
func file_google_cloud_networksecurity_v1_tls_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_networksecurity_v1_tls_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_networksecurity_v1_tls_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_networksecurity_v1_tls_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_networksecurity_v1_tls_proto_msgTypes[3].Exporter = func(v any, i int) any {
