...
const file_google_cloud_networksecurity_v1_tls_proto_rawDesc = "" +
	"\n" +
	")google/cloud/networksecurity/v1/tls.proto\x12\x1fgoogle.cloud.networksecurity.v1\x1a\x1fgoogle/api/field_behavior.proto\"2\n" +
	"\fGrpcEndpoint\x12\"\n" +
	"\n" +
	"target_uri\x18\x01 \x01(\tB\x03\xe0A\x02R\ttargetUri\"\xf1\x01\n" +
	"\fValidationCA\x12T\n" +
	"\rgrpc_endpoint\x18\x02 \x01(\v2-.google.cloud.networksecurity.v1.GrpcEndpointH\x00R\fgrpcEndpoint\x12\x82\x01\n" +
	"\x1dcertificate_provider_instance\x18\x03 \x01(\v2<.google.cloud.networksecurity.v1.CertificateProviderInstanceH\x00R\x1bcertificateProviderInstanceB\x06\n" +
	"\x04type\"K\n" +
	"\x1bCertificateProviderInstance\x12,\n" +
	"\x0fplugin_instance\x18\x01 \x01(\tB\x03\xe0A\x02R\x0epluginInstance\"\xf8\x01\n" +
	"\x13CertificateProvider\x12T\n" +
	"\rgrpc_endpoint\x18\x02 \x01(\v2-.google.cloud.networksecurity.v1.GrpcEndpointH\x00R\fgrpcEndpoint\x12\x82\x01\n" +
	"\x1dcertificate_provider_instance\x18\x03 \x01(\v2<.google.cloud.networksecurity.v1.CertificateProviderInstanceH\x00R\x1bcertificateProviderInstanceB\x06\n" +
	"\x04typeB\xe9\x01\n" +
	"#com.google.cloud.networksecurity.v1B\bTlsProtoP\x01ZMcloud.google.com/go/networksecurity/apiv1/networksecuritypb;networksecuritypb\xaa\x02\x1fGoogle.Cloud.NetworkSecurity.V1\xca\x02\x1fGoogle\\Cloud\\NetworkSecurity\\V1\xea\x02\"Google::Cloud::NetworkSecurity::V1b\x06proto3"

var (
	file_google_cloud_networksecurity_v1_tls_proto_rawDescOnce sync.Once
	file_google_cloud_networksecurity_v1_tls_proto_rawDescData []byte
)
...
func file_google_cloud_networksecurity_v1_tls_proto_rawDescGZIP() []byte {
	file_google_cloud_networksecurity_v1_tls_proto_rawDescOnce.Do(func() {
		file_google_cloud_networksecurity_v1_tls_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_networksecurity_v1_tls_proto_rawDesc), len(file_google_cloud_networksecurity_v1_tls_proto_rawDesc)))
	})
...
var file_google_cloud_networksecurity_v1_tls_proto_goTypes = []any{
...
func file_google_cloud_networksecurity_v1_tls_proto_init() {
	...
	file_google_cloud_networksecurity_v1_tls_proto_msgTypes[1].OneofWrappers = []any{
		(*ValidationCA_GrpcEndpoint)(nil),
		(*ValidationCA_CertificateProviderInstance)(nil),
	}
	file_google_cloud_networksecurity_v1_tls_proto_msgTypes[3].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_networksecurity_v1_tls_proto_rawDesc), len(file_google_cloud_networksecurity_v1_tls_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
