...
func NewAutoscalingPolicyClient(ctx context.Context, opts ...option.ClientOption) (*AutoscalingPolicyClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.CreateAutoscalingPolicy = append(client.CallOptions.CreateAutoscalingPolicy, gax.WithClientMetrics(metrics))
		client.CallOptions.UpdateAutoscalingPolicy = append(client.CallOptions.UpdateAutoscalingPolicy, gax.WithClientMetrics(metrics))
		client.CallOptions.GetAutoscalingPolicy = append(client.CallOptions.GetAutoscalingPolicy, gax.WithClientMetrics(metrics))
		client.CallOptions.ListAutoscalingPolicies = append(client.CallOptions.ListAutoscalingPolicies, gax.WithClientMetrics(metrics))
		client.CallOptions.DeleteAutoscalingPolicy = append(client.CallOptions.DeleteAutoscalingPolicy, gax.WithClientMetrics(metrics))
...
func NewAutoscalingPolicyRESTClient(ctx context.Context, opts ...option.ClientOption) (*AutoscalingPolicyClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.CreateAutoscalingPolicy = append(callOpts.CreateAutoscalingPolicy, gax.WithClientMetrics(metrics))
		callOpts.UpdateAutoscalingPolicy = append(callOpts.UpdateAutoscalingPolicy, gax.WithClientMetrics(metrics))
		callOpts.GetAutoscalingPolicy = append(callOpts.GetAutoscalingPolicy, gax.WithClientMetrics(metrics))
		callOpts.ListAutoscalingPolicies = append(callOpts.ListAutoscalingPolicies, gax.WithClientMetrics(metrics))
		callOpts.DeleteAutoscalingPolicy = append(callOpts.DeleteAutoscalingPolicy, gax.WithClientMetrics(metrics))
...
func (c *autoscalingPolicyGRPCClient) CreateAutoscalingPolicy(ctx context.Context, req *dataprocpb.CreateAutoscalingPolicyRequest, opts ...gax.CallOption) (*dataprocpb.AutoscalingPolicy, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.autoscalingPolicyClient.CreateAutoscalingPolicy, req, settings.GRPC, c.logger, "CreateAutoscalingPolicy")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *autoscalingPolicyGRPCClient) UpdateAutoscalingPolicy(ctx context.Context, req *dataprocpb.UpdateAutoscalingPolicyRequest, opts ...gax.CallOption) (*dataprocpb.AutoscalingPolicy, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dataproc.v1.AutoscalingPolicyService/UpdateAutoscalingPolicy")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.autoscalingPolicyClient.UpdateAutoscalingPolicy, req, settings.GRPC, c.logger, "UpdateAutoscalingPolicy")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *autoscalingPolicyGRPCClient) GetAutoscalingPolicy(ctx context.Context, req *dataprocpb.GetAutoscalingPolicyRequest, opts ...gax.CallOption) (*dataprocpb.AutoscalingPolicy, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.autoscalingPolicyClient.GetAutoscalingPolicy, req, settings.GRPC, c.logger, "GetAutoscalingPolicy")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *autoscalingPolicyGRPCClient) ListAutoscalingPolicies(ctx context.Context, req *dataprocpb.ListAutoscalingPoliciesRequest, opts ...gax.CallOption) *AutoscalingPolicyIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*dataprocpb.AutoscalingPolicy, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.autoscalingPolicyClient.ListAutoscalingPolicies, req, settings.GRPC, c.logger, "ListAutoscalingPolicies")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *autoscalingPolicyGRPCClient) DeleteAutoscalingPolicy(ctx context.Context, req *dataprocpb.DeleteAutoscalingPolicyRequest, opts ...gax.CallOption) error {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		_, err = executeRPC(ctx, c.autoscalingPolicyClient.DeleteAutoscalingPolicy, req, settings.GRPC, c.logger, "DeleteAutoscalingPolicy")
		return err
	}, opts...)
	return err
}
...
func (c *autoscalingPolicyRESTClient) CreateAutoscalingPolicy(ctx context.Context, req *dataprocpb.CreateAutoscalingPolicyRequest, opts ...gax.CallOption) (*dataprocpb.AutoscalingPolicy, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "CreateAutoscalingPolicy")
		if err != nil {
			return err
		}
...
func (c *autoscalingPolicyRESTClient) UpdateAutoscalingPolicy(ctx context.Context, req *dataprocpb.UpdateAutoscalingPolicyRequest, opts ...gax.CallOption) (*dataprocpb.AutoscalingPolicy, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dataproc.v1.AutoscalingPolicyService/UpdateAutoscalingPolicy")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1/{policy.name=projects/*/locations/*/autoscalingPolicies/*}")
	}
	opts = append((*c.CallOptions).UpdateAutoscalingPolicy[0:len((*c.CallOptions).UpdateAutoscalingPolicy):len((*c.CallOptions).UpdateAutoscalingPolicy)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &dataprocpb.AutoscalingPolicy{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "UpdateAutoscalingPolicy")
		if err != nil {
			return err
		}
...
func (c *autoscalingPolicyRESTClient) GetAutoscalingPolicy(ctx context.Context, req *dataprocpb.GetAutoscalingPolicyRequest, opts ...gax.CallOption) (*dataprocpb.AutoscalingPolicy, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "GetAutoscalingPolicy")
		if err != nil {
			return err
		}
...
func (c *autoscalingPolicyRESTClient) ListAutoscalingPolicies(ctx context.Context, req *dataprocpb.ListAutoscalingPoliciesRequest, opts ...gax.CallOption) *AutoscalingPolicyIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*dataprocpb.AutoscalingPolicy, string, error) {
		...
		e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			...
			buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "ListAutoscalingPolicies")
			if err != nil {
				return err
			}
			if err := unm.Unmarshal(buf, resp); err != nil {
...
func (c *autoscalingPolicyRESTClient) DeleteAutoscalingPolicy(ctx context.Context, req *dataprocpb.DeleteAutoscalingPolicyRequest, opts ...gax.CallOption) error {
	...
	return gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		_, err = executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "DeleteAutoscalingPolicy")
		return err
	}, opts...)
}
