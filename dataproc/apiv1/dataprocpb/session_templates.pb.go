...
const file_google_cloud_dataproc_v1_session_templates_proto_rawDesc = "" +
	...
	"\x04name\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'dataproc.googleapis.com/SessionTemplateR\x04name\"\x9c\a\n" +
	"\x0fSessionTemplate\x12\x1a\n" +
