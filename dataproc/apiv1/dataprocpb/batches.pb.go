...
func (x *Batch) GetPysparkNotebookBatch() *PySparkNotebookBatch {
	if x != nil {
		if x, ok := x.BatchConfig.(*Batch_PysparkNotebookBatch); ok {
			return x.PysparkNotebookBatch
		}
	}
	return nil
}
...
type Batch_PysparkNotebookBatch struct {
	...
	PysparkNotebookBatch *PySparkNotebookBatch `protobuf:"bytes,19,opt,name=pyspark_notebook_batch,json=pysparkNotebookBatch,proto3,oneof"`
}
...
func (*Batch_PysparkNotebookBatch) isBatch_BatchConfig() {}
...
type PySparkNotebookBatch struct {
	...
	NotebookFileUri string `protobuf:"bytes,1,opt,name=notebook_file_uri,json=notebookFileUri,proto3" json:"notebook_file_uri,omitempty"`
...
func (x *PySparkNotebookBatch) Reset() {
	*x = PySparkNotebookBatch{}
	mi := &file_google_cloud_dataproc_v1_batches_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PySparkNotebookBatch) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PySparkNotebookBatch) ProtoMessage() {}

func (x *PySparkNotebookBatch) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dataproc_v1_batches_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PySparkNotebookBatch.ProtoReflect.Descriptor instead.
func (*PySparkNotebookBatch) Descriptor() ([]byte, []int) {
	return file_google_cloud_dataproc_v1_batches_proto_rawDescGZIP(), []int{10}
}

func (x *PySparkNotebookBatch) GetNotebookFileUri() string {
	if x != nil {
		return x.NotebookFileUri
	}
	return ""
}

func (x *PySparkNotebookBatch) GetParams() map[string]string {
	if x != nil {
		return x.Params
	}
	return nil
...
func (x *PySparkNotebookBatch) GetPythonFileUris() []string {
	if x != nil {
		return x.PythonFileUris
	}
	return nil
...
func (x *PySparkNotebookBatch) GetJarFileUris() []string {
	if x != nil {
		return x.JarFileUris
	}
	return nil
...
func (x *PySparkNotebookBatch) GetFileUris() []string {
	if x != nil {
		return x.FileUris
	}
	return nil
...
func (x *PySparkNotebookBatch) GetArchiveUris() []string {
	if x != nil {
		return x.ArchiveUris
	}
	return nil
...
func (x *Batch_StateHistory) Reset() {
	*x = Batch_StateHistory{}
	mi := &file_google_cloud_dataproc_v1_batches_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_google_cloud_dataproc_v1_batches_proto_rawDesc = "" +
	...
	"\x04name\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1ddataproc.googleapis.com/BatchR\x04name\"\xad\r\n" +
	"\x05Batch\x12\x17\n" +
	...
	"\x0fspark_sql_batch\x18\a \x01(\v2'.google.cloud.dataproc.v1.SparkSqlBatchB\x03\xe0A\x01H\x00R\rsparkSqlBatch\x12k\n" +
	"\x16pyspark_notebook_batch\x18\x13 \x01(\v2..google.cloud.dataproc.v1.PySparkNotebookBatchB\x03\xe0A\x01H\x00R\x14pysparkNotebookBatch\x12M\n" +
	...
	"\x14PySparkNotebookBatch\x12/\n" +
	"\x11notebook_file_uri\x18\x01 \x01(\tB\x03\xe0A\x02R\x0fnotebookFileUri\x12W\n" +
	"\x06params\x18\x02 \x03(\v2:.google.cloud.dataproc.v1.PySparkNotebookBatch.ParamsEntryB\x03\xe0A\x01R\x06params\x12-\n" +
	"\x10python_file_uris\x18\x03 \x03(\tB\x03\xe0A\x01R\x0epythonFileUris\x12'\n" +
	"\rjar_file_uris\x18\x04 \x03(\tB\x03\xe0A\x01R\vjarFileUris\x12 \n" +
	"\tfile_uris\x18\x05 \x03(\tB\x03\xe0A\x01R\bfileUris\x12&\n" +
...
var file_google_cloud_dataproc_v1_batches_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_google_cloud_dataproc_v1_batches_proto_goTypes = []any{
	...
	(*PySparkNotebookBatch)(nil),    // 11: google.cloud.dataproc.v1.PySparkNotebookBatch
	(*Batch_StateHistory)(nil),      // 12: google.cloud.dataproc.v1.Batch.StateHistory
	nil,                             // 13: google.cloud.dataproc.v1.Batch.LabelsEntry
	nil,                             // 14: google.cloud.dataproc.v1.SparkSqlBatch.QueryVariablesEntry
	nil,                             // 15: google.cloud.dataproc.v1.PySparkNotebookBatch.ParamsEntry
	(*timestamppb.Timestamp)(nil),   // 16: google.protobuf.Timestamp
	(*RuntimeInfo)(nil),             // 17: google.cloud.dataproc.v1.RuntimeInfo
	(*RuntimeConfig)(nil),           // 18: google.cloud.dataproc.v1.RuntimeConfig
	(*EnvironmentConfig)(nil),       // 19: google.cloud.dataproc.v1.EnvironmentConfig
...
var file_google_cloud_dataproc_v1_batches_proto_depIdxs = []int32{
	...
	16, // 2: google.cloud.dataproc.v1.Batch.create_time:type_name -> google.protobuf.Timestamp
	...
	11, // 7: google.cloud.dataproc.v1.Batch.pyspark_notebook_batch:type_name -> google.cloud.dataproc.v1.PySparkNotebookBatch
	17, // 8: google.cloud.dataproc.v1.Batch.runtime_info:type_name -> google.cloud.dataproc.v1.RuntimeInfo
	0,  // 9: google.cloud.dataproc.v1.Batch.state:type_name -> google.cloud.dataproc.v1.Batch.State
	16, // 10: google.cloud.dataproc.v1.Batch.state_time:type_name -> google.protobuf.Timestamp
	13, // 11: google.cloud.dataproc.v1.Batch.labels:type_name -> google.cloud.dataproc.v1.Batch.LabelsEntry
	18, // 12: google.cloud.dataproc.v1.Batch.runtime_config:type_name -> google.cloud.dataproc.v1.RuntimeConfig
	19, // 13: google.cloud.dataproc.v1.Batch.environment_config:type_name -> google.cloud.dataproc.v1.EnvironmentConfig
	12, // 14: google.cloud.dataproc.v1.Batch.state_history:type_name -> google.cloud.dataproc.v1.Batch.StateHistory
	14, // 15: google.cloud.dataproc.v1.SparkSqlBatch.query_variables:type_name -> google.cloud.dataproc.v1.SparkSqlBatch.QueryVariablesEntry
	15, // 16: google.cloud.dataproc.v1.PySparkNotebookBatch.params:type_name -> google.cloud.dataproc.v1.PySparkNotebookBatch.ParamsEntry
	0,  // 17: google.cloud.dataproc.v1.Batch.StateHistory.state:type_name -> google.cloud.dataproc.v1.Batch.State
	16, // 18: google.cloud.dataproc.v1.Batch.StateHistory.state_start_time:type_name -> google.protobuf.Timestamp
	1,  // 19: google.cloud.dataproc.v1.BatchController.CreateBatch:input_type -> google.cloud.dataproc.v1.CreateBatchRequest
	2,  // 20: google.cloud.dataproc.v1.BatchController.GetBatch:input_type -> google.cloud.dataproc.v1.GetBatchRequest
	3,  // 21: google.cloud.dataproc.v1.BatchController.ListBatches:input_type -> google.cloud.dataproc.v1.ListBatchesRequest
	5,  // 22: google.cloud.dataproc.v1.BatchController.DeleteBatch:input_type -> google.cloud.dataproc.v1.DeleteBatchRequest
	20, // 23: google.cloud.dataproc.v1.BatchController.CreateBatch:output_type -> google.longrunning.Operation
	6,  // 24: google.cloud.dataproc.v1.BatchController.GetBatch:output_type -> google.cloud.dataproc.v1.Batch
	4,  // 25: google.cloud.dataproc.v1.BatchController.ListBatches:output_type -> google.cloud.dataproc.v1.ListBatchesResponse
	21, // 26: google.cloud.dataproc.v1.BatchController.DeleteBatch:output_type -> google.protobuf.Empty
...
func file_google_cloud_dataproc_v1_batches_proto_init() {
	...
	file_google_cloud_dataproc_v1_batches_proto_msgTypes[5].OneofWrappers = []any{
		...
		(*Batch_PysparkNotebookBatch)(nil),
	}
