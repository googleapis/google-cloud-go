	...
	return &Client{
		AgentEngines: &clientAgentEngines{
			...
			Sandboxes: &clientSandboxes{
				...
				Templates: &SandboxTemplates{apiClient: ac},
				Snapshots: &SandboxSnapshots{apiClient: ac},
			},
		},
		Runtimes: &clientRuntimes{
			Runtimes: Runtimes{apiClient: ac},
		},
	}, nil
}
