...
func (x *StreamingAnnotateVideoRequest) GetStreamingRequest() isStreamingAnnotateVideoRequest_StreamingRequest {
	if x != nil {
...
func (x *StreamingAnnotateVideoRequest) GetVideoConfig() *StreamingVideoConfig {
	if x != nil {
		if x, ok := x.StreamingRequest.(*StreamingAnnotateVideoRequest_VideoConfig); ok {
...
func (x *StreamingAnnotateVideoRequest) GetInputContent() []byte {
	if x != nil {
		if x, ok := x.StreamingRequest.(*StreamingAnnotateVideoRequest_InputContent); ok {
			return x.InputContent
		}
	}
	return nil
...
func (x *StreamingVideoConfig) GetStreamingConfig() isStreamingVideoConfig_StreamingConfig {
	if x != nil {
...
func (x *StreamingVideoConfig) GetShotChangeDetectionConfig() *StreamingShotChangeDetectionConfig {
	if x != nil {
		if x, ok := x.StreamingConfig.(*StreamingVideoConfig_ShotChangeDetectionConfig); ok {
			return x.ShotChangeDetectionConfig
		}
	}
	return nil
...
func (x *StreamingVideoConfig) GetLabelDetectionConfig() *StreamingLabelDetectionConfig {
	if x != nil {
		if x, ok := x.StreamingConfig.(*StreamingVideoConfig_LabelDetectionConfig); ok {
			return x.LabelDetectionConfig
		}
	}
	return nil
...
func (x *StreamingVideoConfig) GetExplicitContentDetectionConfig() *StreamingExplicitContentDetectionConfig {
	if x != nil {
		if x, ok := x.StreamingConfig.(*StreamingVideoConfig_ExplicitContentDetectionConfig); ok {
			return x.ExplicitContentDetectionConfig
		}
	}
	return nil
...
func (x *StreamingVideoConfig) GetObjectTrackingConfig() *StreamingObjectTrackingConfig {
	if x != nil {
		if x, ok := x.StreamingConfig.(*StreamingVideoConfig_ObjectTrackingConfig); ok {
			return x.ObjectTrackingConfig
		}
	}
	return nil
...
func (x *StreamingVideoConfig) GetAutomlActionRecognitionConfig() *StreamingAutomlActionRecognitionConfig {
	if x != nil {
		if x, ok := x.StreamingConfig.(*StreamingVideoConfig_AutomlActionRecognitionConfig); ok {
...
func (x *StreamingVideoConfig) GetAutomlClassificationConfig() *StreamingAutomlClassificationConfig {
	if x != nil {
		if x, ok := x.StreamingConfig.(*StreamingVideoConfig_AutomlClassificationConfig); ok {
...
func (x *StreamingVideoConfig) GetAutomlObjectTrackingConfig() *StreamingAutomlObjectTrackingConfig {
	if x != nil {
		if x, ok := x.StreamingConfig.(*StreamingVideoConfig_AutomlObjectTrackingConfig); ok {
...
const file_google_cloud_videointelligence_v1p3beta1_video_intelligence_proto_rawDesc = "" +
	"\n" +
	"Agoogle/cloud/videointelligence/v1p3beta1/video_intelligence.proto\x12(google.cloud.videointelligence.v1p3beta1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a#google/longrunning/operations.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\xd3\x02\n" +
	"\x14AnnotateVideoRequest\x12\x1b\n" +
	"\tinput_uri\x18\x01 \x01(\tR\binputUri\x12#\n" +
	"\rinput_content\x18\x06 \x01(\fR\finputContent\x12R\n" +
	"\bfeatures\x18\x02 \x03(\x0e21.google.cloud.videointelligence.v1p3beta1.FeatureB\x03\xe0A\x02R\bfeatures\x12[\n" +
	"\rvideo_context\x18\x03 \x01(\v26.google.cloud.videointelligence.v1p3beta1.VideoContextR\fvideoContext\x12\"\n" +
	"\n" +
	"output_uri\x18\x04 \x01(\tB\x03\xe0A\x01R\toutputUri\x12$\n" +
	"\vlocation_id\x18\x05 \x01(\tB\x03\xe0A\x01R\n" +
	"locationId\"\xd0\b\n" +
	"\fVideoContext\x12R\n" +
	"\bsegments\x18\x01 \x03(\v26.google.cloud.videointelligence.v1p3beta1.VideoSegmentR\bsegments\x12t\n" +
	"\x16label_detection_config\x18\x02 \x01(\v2>.google.cloud.videointelligence.v1p3beta1.LabelDetectionConfigR\x14labelDetectionConfig\x12\x84\x01\n" +
	"\x1cshot_change_detection_config\x18\x03 \x01(\v2C.google.cloud.videointelligence.v1p3beta1.ShotChangeDetectionConfigR\x19shotChangeDetectionConfig\x12\x93\x01\n" +
	"!explicit_content_detection_config\x18\x04 \x01(\v2H.google.cloud.videointelligence.v1p3beta1.ExplicitContentDetectionConfigR\x1eexplicitContentDetectionConfig\x12q\n" +
	"\x15face_detection_config\x18\x05 \x01(\v2=.google.cloud.videointelligence.v1p3beta1.FaceDetectionConfigR\x13faceDetectionConfig\x12\x83\x01\n" +
	"\x1bspeech_transcription_config\x18\x06 \x01(\v2C.google.cloud.videointelligence.v1p3beta1.SpeechTranscriptionConfigR\x19speechTranscriptionConfig\x12q\n" +
	"\x15text_detection_config\x18\b \x01(\v2=.google.cloud.videointelligence.v1p3beta1.TextDetectionConfigR\x13textDetectionConfig\x12w\n" +
	"\x17person_detection_config\x18\v \x01(\v2?.google.cloud.videointelligence.v1p3beta1.PersonDetectionConfigR\x15personDetectionConfig\x12t\n" +
	"\x16object_tracking_config\x18\r \x01(\v2>.google.cloud.videointelligence.v1p3beta1.ObjectTrackingConfigR\x14objectTrackingConfig\"\xc5\x02\n" +
	"\x14LabelDetectionConfig\x12n\n" +
	"\x14label_detection_mode\x18\x01 \x01(\x0e2<.google.cloud.videointelligence.v1p3beta1.LabelDetectionModeR\x12labelDetectionMode\x12+\n" +
	...
	"\x12include_attributes\x18\x03 \x01(\bR\x11includeAttributes\"R\n" +
	...
	"\x0fend_time_offset\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\rendTimeOffset\"\x80\x01\n" +
	"\fLabelSegment\x12P\n" +
	"\asegment\x18\x01 \x01(\v26.google.cloud.videointelligence.v1p3beta1.VideoSegmentR\asegment\x12\x1e\n" +
	"\n" +
	...
	"\rlanguage_code\x18\x03 \x01(\tR\flanguageCode\"\xdc\x02\n" +
	"\x0fLabelAnnotation\x12H\n" +
	"\x06entity\x18\x01 \x01(\v20.google.cloud.videointelligence.v1p3beta1.EntityR\x06entity\x12]\n" +
	"\x11category_entities\x18\x02 \x03(\v20.google.cloud.videointelligence.v1p3beta1.EntityR\x10categoryEntities\x12R\n" +
	"\bsegments\x18\x03 \x03(\v26.google.cloud.videointelligence.v1p3beta1.LabelSegmentR\bsegments\x12L\n" +
	"\x06frames\x18\x04 \x03(\v24.google.cloud.videointelligence.v1p3beta1.LabelFrameR\x06frames\"\xbf\x01\n" +
	"\x14ExplicitContentFrame\x12:\n" +
	"\vtime_offset\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\n" +
	"timeOffset\x12k\n" +
	"\x16pornography_likelihood\x18\x02 \x01(\x0e24.google.cloud.videointelligence.v1p3beta1.LikelihoodR\x15pornographyLikelihood\"s\n" +
	"\x19ExplicitContentAnnotation\x12V\n" +
	"\x06frames\x18\x01 \x03(\v2>.google.cloud.videointelligence.v1p3beta1.ExplicitContentFrameR\x06frames\"k\n" +
	...
	"\x06bottom\x18\x04 \x01(\x02R\x06bottom\"\x89\x03\n" +
	"\x11TimestampedObject\x12w\n" +
	"\x17normalized_bounding_box\x18\x01 \x01(\v2?.google.cloud.videointelligence.v1p3beta1.NormalizedBoundingBoxR\x15normalizedBoundingBox\x12:\n" +
	"\vtime_offset\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\n" +
	"timeOffset\x12`\n" +
	"\n" +
	"attributes\x18\x03 \x03(\v2;.google.cloud.videointelligence.v1p3beta1.DetectedAttributeB\x03\xe0A\x01R\n" +
	"attributes\x12]\n" +
	"\tlandmarks\x18\x04 \x03(\v2:.google.cloud.videointelligence.v1p3beta1.DetectedLandmarkB\x03\xe0A\x01R\tlandmarks\"\xce\x02\n" +
	"\x05Track\x12P\n" +
	"\asegment\x18\x01 \x01(\v26.google.cloud.videointelligence.v1p3beta1.VideoSegmentR\asegment\x12l\n" +
	"\x13timestamped_objects\x18\x02 \x03(\v2;.google.cloud.videointelligence.v1p3beta1.TimestampedObjectR\x12timestampedObjects\x12`\n" +
	"\n" +
	"attributes\x18\x03 \x03(\v2;.google.cloud.videointelligence.v1p3beta1.DetectedAttributeB\x03\xe0A\x01R\n" +
	"attributes\x12#\n" +
	"\n" +
	...
	"\x0eCelebrityTrack\x12n\n" +
	"\vcelebrities\x18\x01 \x03(\v2L.google.cloud.videointelligence.v1p3beta1.CelebrityTrack.RecognizedCelebrityR\vcelebrities\x12N\n" +
	"\n" +
	"face_track\x18\x03 \x01(\v2/.google.cloud.videointelligence.v1p3beta1.TrackR\tfaceTrack\x1a\x88\x01\n" +
	"\x13RecognizedCelebrity\x12Q\n" +
	"\tcelebrity\x18\x01 \x01(\v23.google.cloud.videointelligence.v1p3beta1.CelebrityR\tcelebrity\x12\x1e\n" +
	"\n" +
	"confidence\x18\x02 \x01(\x02R\n" +
	"confidence\"\x85\x01\n" +
	"\x1eCelebrityRecognitionAnnotation\x12c\n" +
	"\x10celebrity_tracks\x18\x01 \x03(\v28.google.cloud.videointelligence.v1p3beta1.CelebrityTrackR\x0fcelebrityTracks\"\x98\x01\n" +
	"\x10DetectedLandmark\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12P\n" +
	"\x05point\x18\x02 \x01(\v2:.google.cloud.videointelligence.v1p3beta1.NormalizedVertexR\x05point\x12\x1e\n" +
	"\n" +
	"confidence\x18\x03 \x01(\x02R\n" +
	"confidence\"\x80\x01\n" +
	"\x17FaceDetectionAnnotation\x12G\n" +
	"\x06tracks\x18\x03 \x03(\v2/.google.cloud.videointelligence.v1p3beta1.TrackR\x06tracks\x12\x1c\n" +
	"\tthumbnail\x18\x04 \x01(\fR\tthumbnail\"d\n" +
	"\x19PersonDetectionAnnotation\x12G\n" +
	"\x06tracks\x18\x01 \x03(\v2/.google.cloud.videointelligence.v1p3beta1.TrackR\x06tracks\"\xe5\x0e\n" +
	"\x16VideoAnnotationResults\x12\x1b\n" +
	"\tinput_uri\x18\x01 \x01(\tR\binputUri\x12P\n" +
	"\asegment\x18\n" +
	" \x01(\v26.google.cloud.videointelligence.v1p3beta1.VideoSegmentR\asegment\x12u\n" +
	"\x19segment_label_annotations\x18\x02 \x03(\v29.google.cloud.videointelligence.v1p3beta1.LabelAnnotationR\x17segmentLabelAnnotations\x12\x86\x01\n" +
	"\"segment_presence_label_annotations\x18\x17 \x03(\v29.google.cloud.videointelligence.v1p3beta1.LabelAnnotationR\x1fsegmentPresenceLabelAnnotations\x12o\n" +
	"\x16shot_label_annotations\x18\x03 \x03(\v29.google.cloud.videointelligence.v1p3beta1.LabelAnnotationR\x14shotLabelAnnotations\x12\x80\x01\n" +
	"\x1fshot_presence_label_annotations\x18\x18 \x03(\v29.google.cloud.videointelligence.v1p3beta1.LabelAnnotationR\x1cshotPresenceLabelAnnotations\x12q\n" +
	"\x17frame_label_annotations\x18\x04 \x03(\v29.google.cloud.videointelligence.v1p3beta1.LabelAnnotationR\x15frameLabelAnnotations\x12\x7f\n" +
	"\x1aface_detection_annotations\x18\r \x03(\v2A.google.cloud.videointelligence.v1p3beta1.FaceDetectionAnnotationR\x18faceDetectionAnnotations\x12a\n" +
	"\x10shot_annotations\x18\x06 \x03(\v26.google.cloud.videointelligence.v1p3beta1.VideoSegmentR\x0fshotAnnotations\x12t\n" +
	"\x13explicit_annotation\x18\a \x01(\v2C.google.cloud.videointelligence.v1p3beta1.ExplicitContentAnnotationR\x12explicitAnnotation\x12r\n" +
	"\x15speech_transcriptions\x18\v \x03(\v2=.google.cloud.videointelligence.v1p3beta1.SpeechTranscriptionR\x14speechTranscriptions\x12c\n" +
	"\x10text_annotations\x18\f \x03(\v28.google.cloud.videointelligence.v1p3beta1.TextAnnotationR\x0ftextAnnotations\x12q\n" +
	"\x12object_annotations\x18\x0e \x03(\v2B.google.cloud.videointelligence.v1p3beta1.ObjectTrackingAnnotationR\x11objectAnnotations\x12\x85\x01\n" +
	"\x1clogo_recognition_annotations\x18\x13 \x03(\v2C.google.cloud.videointelligence.v1p3beta1.LogoRecognitionAnnotationR\x1alogoRecognitionAnnotations\x12\x85\x01\n" +
	"\x1cperson_detection_annotations\x18\x14 \x03(\v2C.google.cloud.videointelligence.v1p3beta1.PersonDetectionAnnotationR\x1apersonDetectionAnnotations\x12\x94\x01\n" +
	"!celebrity_recognition_annotations\x18\x15 \x01(\v2H.google.cloud.videointelligence.v1p3beta1.CelebrityRecognitionAnnotationR\x1fcelebrityRecognitionAnnotations\x12(\n" +
	"\x05error\x18\t \x01(\v2\x12.google.rpc.StatusR\x05error\"\x88\x01\n" +
	"\x15AnnotateVideoResponse\x12o\n" +
	"\x12annotation_results\x18\x01 \x03(\v2@.google.cloud.videointelligence.v1p3beta1.VideoAnnotationResultsR\x11annotationResults\"\xf8\x02\n" +
	...
	"updateTime\x12K\n" +
	"\afeature\x18\x05 \x01(\x0e21.google.cloud.videointelligence.v1p3beta1.FeatureR\afeature\x12P\n" +
	"\asegment\x18\x06 \x01(\v26.google.cloud.videointelligence.v1p3beta1.VideoSegmentR\asegment\"\x8b\x01\n" +
	"\x15AnnotateVideoProgress\x12r\n" +
	"\x13annotation_progress\x18\x01 \x03(\v2A.google.cloud.videointelligence.v1p3beta1.VideoAnnotationProgressR\x12annotationProgress\"\xba\x04\n" +
	...
	"\x10filter_profanity\x18\x03 \x01(\bB\x03\xe0A\x01R\x0ffilterProfanity\x12e\n" +
	"\x0fspeech_contexts\x18\x04 \x03(\v27.google.cloud.videointelligence.v1p3beta1.SpeechContextB\x03\xe0A\x01R\x0espeechContexts\x12E\n" +
	...
	"\aphrases\x18\x01 \x03(\tB\x03\xe0A\x01R\aphrases\"\xab\x01\n" +
	"\x13SpeechTranscription\x12j\n" +
	"\falternatives\x18\x01 \x03(\v2F.google.cloud.videointelligence.v1p3beta1.SpeechRecognitionAlternativeR\falternatives\x12(\n" +
	"\rlanguage_code\x18\x02 \x01(\tB\x03\xe0A\x03R\flanguageCode\"\xb2\x01\n" +
	...
	"confidence\x12M\n" +
	"\x05words\x18\x03 \x03(\v22.google.cloud.videointelligence.v1p3beta1.WordInfoB\x03\xe0A\x03R\x05words\"\xd9\x01\n" +
	"\bWordInfo\x128\n" +
	"\n" +
	...
	"\bvertices\x18\x01 \x03(\v2:.google.cloud.videointelligence.v1p3beta1.NormalizedVertexR\bvertices\"\xcc\x01\n" +
	"\vTextSegment\x12P\n" +
	"\asegment\x18\x01 \x01(\v26.google.cloud.videointelligence.v1p3beta1.VideoSegmentR\asegment\x12\x1e\n" +
	"\n" +
	"confidence\x18\x02 \x01(\x02R\n" +
	"confidence\x12K\n" +
	"\x06frames\x18\x03 \x03(\v23.google.cloud.videointelligence.v1p3beta1.TextFrameR\x06frames\"\xbb\x01\n" +
	"\tTextFrame\x12r\n" +
	"\x14rotated_bounding_box\x18\x01 \x01(\v2@.google.cloud.videointelligence.v1p3beta1.NormalizedBoundingPolyR\x12rotatedBoundingBox\x12:\n" +
	"\vtime_offset\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\n" +
	"timeOffset\"w\n" +
	"\x0eTextAnnotation\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12Q\n" +
	"\bsegments\x18\x02 \x03(\v25.google.cloud.videointelligence.v1p3beta1.TextSegmentR\bsegments\"\xca\x01\n" +
	"\x13ObjectTrackingFrame\x12w\n" +
	"\x17normalized_bounding_box\x18\x01 \x01(\v2?.google.cloud.videointelligence.v1p3beta1.NormalizedBoundingBoxR\x15normalizedBoundingBox\x12:\n" +
	"\vtime_offset\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\n" +
	"timeOffset\"\xda\x02\n" +
	"\x18ObjectTrackingAnnotation\x12R\n" +
	"\asegment\x18\x03 \x01(\v26.google.cloud.videointelligence.v1p3beta1.VideoSegmentH\x00R\asegment\x12\x1b\n" +
	"\btrack_id\x18\x05 \x01(\x03H\x00R\atrackId\x12H\n" +
	"\x06entity\x18\x01 \x01(\v20.google.cloud.videointelligence.v1p3beta1.EntityR\x06entity\x12\x1e\n" +
	"\n" +
	"confidence\x18\x04 \x01(\x02R\n" +
	"confidence\x12U\n" +
	"\x06frames\x18\x02 \x03(\v2=.google.cloud.videointelligence.v1p3beta1.ObjectTrackingFrameR\x06framesB\f\n" +
	"\n" +
	"track_info\"\x82\x02\n" +
	"\x19LogoRecognitionAnnotation\x12H\n" +
	"\x06entity\x18\x01 \x01(\v20.google.cloud.videointelligence.v1p3beta1.EntityR\x06entity\x12G\n" +
	"\x06tracks\x18\x02 \x03(\v2/.google.cloud.videointelligence.v1p3beta1.TrackR\x06tracks\x12R\n" +
	"\bsegments\x18\x03 \x03(\v26.google.cloud.videointelligence.v1p3beta1.VideoSegmentR\bsegments\"\xc0\x01\n" +
	"\x1dStreamingAnnotateVideoRequest\x12c\n" +
	"\fvideo_config\x18\x01 \x01(\v2>.google.cloud.videointelligence.v1p3beta1.StreamingVideoConfigH\x00R\vvideoConfig\x12%\n" +
	"\rinput_content\x18\x02 \x01(\fH\x00R\finputContentB\x13\n" +
	"\x11streaming_request\"\xe5\t\n" +
	"\x14StreamingVideoConfig\x12\x8f\x01\n" +
	"\x1cshot_change_detection_config\x18\x02 \x01(\v2L.google.cloud.videointelligence.v1p3beta1.StreamingShotChangeDetectionConfigH\x00R\x19shotChangeDetectionConfig\x12\x7f\n" +
	"\x16label_detection_config\x18\x03 \x01(\v2G.google.cloud.videointelligence.v1p3beta1.StreamingLabelDetectionConfigH\x00R\x14labelDetectionConfig\x12\x9e\x01\n" +
	"!explicit_content_detection_config\x18\x04 \x01(\v2Q.google.cloud.videointelligence.v1p3beta1.StreamingExplicitContentDetectionConfigH\x00R\x1eexplicitContentDetectionConfig\x12\x7f\n" +
	"\x16object_tracking_config\x18\x05 \x01(\v2G.google.cloud.videointelligence.v1p3beta1.StreamingObjectTrackingConfigH\x00R\x14objectTrackingConfig\x12\x9b\x01\n" +
	" automl_action_recognition_config\x18\x17 \x01(\v2P.google.cloud.videointelligence.v1p3beta1.StreamingAutomlActionRecognitionConfigH\x00R\x1dautomlActionRecognitionConfig\x12\x91\x01\n" +
	"\x1cautoml_classification_config\x18\x15 \x01(\v2M.google.cloud.videointelligence.v1p3beta1.StreamingAutomlClassificationConfigH\x00R\x1aautomlClassificationConfig\x12\x92\x01\n" +
	"\x1dautoml_object_tracking_config\x18\x16 \x01(\v2M.google.cloud.videointelligence.v1p3beta1.StreamingAutomlObjectTrackingConfigH\x00R\x1aautomlObjectTrackingConfig\x12T\n" +
	"\afeature\x18\x01 \x01(\x0e2:.google.cloud.videointelligence.v1p3beta1.StreamingFeatureR\afeature\x12g\n" +
	"\x0estorage_config\x18\x1e \x01(\v2@.google.cloud.videointelligence.v1p3beta1.StreamingStorageConfigR\rstorageConfigB\x12\n" +
	"\x10streaming_config\"\xfa\x01\n" +
	"\x1eStreamingAnnotateVideoResponse\x12(\n" +
	"\x05error\x18\x01 \x01(\v2\x12.google.rpc.StatusR\x05error\x12x\n" +
	"\x12annotation_results\x18\x02 \x01(\v2I.google.cloud.videointelligence.v1p3beta1.StreamingVideoAnnotationResultsR\x11annotationResults\x124\n" +
	"\x16annotation_results_uri\x18\x03 \x01(\tR\x14annotationResultsUri\"\xd5\x03\n" +
	"\x1fStreamingVideoAnnotationResults\x12a\n" +
	"\x10shot_annotations\x18\x01 \x03(\v26.google.cloud.videointelligence.v1p3beta1.VideoSegmentR\x0fshotAnnotations\x12f\n" +
	"\x11label_annotations\x18\x02 \x03(\v29.google.cloud.videointelligence.v1p3beta1.LabelAnnotationR\x10labelAnnotations\x12t\n" +
	"\x13explicit_annotation\x18\x03 \x01(\v2C.google.cloud.videointelligence.v1p3beta1.ExplicitContentAnnotationR\x12explicitAnnotation\x12q\n" +
	"\x12object_annotations\x18\x04 \x03(\v2B.google.cloud.videointelligence.v1p3beta1.ObjectTrackingAnnotationR\x11objectAnnotations\"$\n" +
	"\"StreamingShotChangeDetectionConfig\"L\n" +
	"\x1dStreamingLabelDetectionConfig\x12+\n" +
	"\x11stationary_camera\x18\x01 \x01(\bR\x10stationaryCamera\")\n" +
	...
	" enable_storage_annotation_result\x18\x01 \x01(\bR\x1denableStorageAnnotationResult\x12M\n" +
	...
	"\x10LOGO_RECOGNITION\x10\f\x12\x19\n" +
	...
	"\x15AnnotateVideoResponse\x12\x15AnnotateVideoProgress\xdaA\x12input_uri,features\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/v1p3beta1/videos:annotate\x1aT\xcaA videointelligence.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platform2\xad\x02\n" +
...
var (
	...
	file_google_cloud_videointelligence_v1p3beta1_video_intelligence_proto_rawDescData []byte
)
...
func file_google_cloud_videointelligence_v1p3beta1_video_intelligence_proto_rawDescGZIP() []byte {
	file_google_cloud_videointelligence_v1p3beta1_video_intelligence_proto_rawDescOnce.Do(func() {
		file_google_cloud_videointelligence_v1p3beta1_video_intelligence_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_videointelligence_v1p3beta1_video_intelligence_proto_rawDesc), len(file_google_cloud_videointelligence_v1p3beta1_video_intelligence_proto_rawDesc)))
	})
...
var file_google_cloud_videointelligence_v1p3beta1_video_intelligence_proto_goTypes = []any{
...
func file_google_cloud_videointelligence_v1p3beta1_video_intelligence_proto_init() {
	...
	file_google_cloud_videointelligence_v1p3beta1_video_intelligence_proto_msgTypes[41].OneofWrappers = []any{
		(*ObjectTrackingAnnotation_Segment)(nil),
		(*ObjectTrackingAnnotation_TrackId)(nil),
	}
	file_google_cloud_videointelligence_v1p3beta1_video_intelligence_proto_msgTypes[43].OneofWrappers = []any{
		(*StreamingAnnotateVideoRequest_VideoConfig)(nil),
		(*StreamingAnnotateVideoRequest_InputContent)(nil),
	}
	file_google_cloud_videointelligence_v1p3beta1_video_intelligence_proto_msgTypes[44].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_videointelligence_v1p3beta1_video_intelligence_proto_rawDesc), len(file_google_cloud_videointelligence_v1p3beta1_video_intelligence_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   56,
			NumExtensions: 0,
			NumServices:   2,
