...
func (x *ObjectTrackingAnnotation) GetSegment() *VideoSegment {
	if x != nil {
		if x, ok := x.TrackInfo.(*ObjectTrackingAnnotation_Segment); ok {
			return x.Segment
		}
	}
	return nil
...
func (x *ObjectTrackingAnnotation) GetTrackId() int64 {
	if x != nil {
		if x, ok := x.TrackInfo.(*ObjectTrackingAnnotation_TrackId); ok {
			return x.TrackId
		}
	}
	return 0
...
const file_google_cloud_videointelligence_v1_video_intelligence_proto_rawDesc = "" +
	"\n" +
	":google/cloud/videointelligence/v1/video_intelligence.proto\x12!google.cloud.videointelligence.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a#google/longrunning/operations.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\xc5\x02\n" +
	"\x14AnnotateVideoRequest\x12\x1b\n" +
	"\tinput_uri\x18\x01 \x01(\tR\binputUri\x12#\n" +
	"\rinput_content\x18\x06 \x01(\fR\finputContent\x12K\n" +
	"\bfeatures\x18\x02 \x03(\x0e2*.google.cloud.videointelligence.v1.FeatureB\x03\xe0A\x02R\bfeatures\x12T\n" +
	"\rvideo_context\x18\x03 \x01(\v2/.google.cloud.videointelligence.v1.VideoContextR\fvideoContext\x12\"\n" +
	"\n" +
	"output_uri\x18\x04 \x01(\tB\x03\xe0A\x01R\toutputUri\x12$\n" +
	"\vlocation_id\x18\x05 \x01(\tB\x03\xe0A\x01R\n" +
	"locationId\"\x8f\b\n" +
	"\fVideoContext\x12K\n" +
	"\bsegments\x18\x01 \x03(\v2/.google.cloud.videointelligence.v1.VideoSegmentR\bsegments\x12m\n" +
	"\x16label_detection_config\x18\x02 \x01(\v27.google.cloud.videointelligence.v1.LabelDetectionConfigR\x14labelDetectionConfig\x12}\n" +
	"\x1cshot_change_detection_config\x18\x03 \x01(\v2<.google.cloud.videointelligence.v1.ShotChangeDetectionConfigR\x19shotChangeDetectionConfig\x12\x8c\x01\n" +
	"!explicit_content_detection_config\x18\x04 \x01(\v2A.google.cloud.videointelligence.v1.ExplicitContentDetectionConfigR\x1eexplicitContentDetectionConfig\x12j\n" +
	"\x15face_detection_config\x18\x05 \x01(\v26.google.cloud.videointelligence.v1.FaceDetectionConfigR\x13faceDetectionConfig\x12|\n" +
	"\x1bspeech_transcription_config\x18\x06 \x01(\v2<.google.cloud.videointelligence.v1.SpeechTranscriptionConfigR\x19speechTranscriptionConfig\x12j\n" +
	"\x15text_detection_config\x18\b \x01(\v26.google.cloud.videointelligence.v1.TextDetectionConfigR\x13textDetectionConfig\x12p\n" +
	"\x17person_detection_config\x18\v \x01(\v28.google.cloud.videointelligence.v1.PersonDetectionConfigR\x15personDetectionConfig\x12m\n" +
	"\x16object_tracking_config\x18\r \x01(\v27.google.cloud.videointelligence.v1.ObjectTrackingConfigR\x14objectTrackingConfig\"\xbe\x02\n" +
	"\x14LabelDetectionConfig\x12g\n" +
	"\x14label_detection_mode\x18\x01 \x01(\x0e25.google.cloud.videointelligence.v1.LabelDetectionModeR\x12labelDetectionMode\x12+\n" +
	"\x11stationary_camera\x18\x02 \x01(\bR\x10stationaryCamera\x12\x14\n" +
	"\x05model\x18\x03 \x01(\tR\x05model\x12<\n" +
	"\x1aframe_confidence_threshold\x18\x04 \x01(\x02R\x18frameConfidenceThreshold\x12<\n" +
	...
	"\x16include_bounding_boxes\x18\x02 \x01(\bR\x14includeBoundingBoxes\x12-\n" +
	"\x12include_attributes\x18\x05 \x01(\bR\x11includeAttributes\"\xb2\x01\n" +
	"\x15PersonDetectionConfig\x124\n" +
	"\x16include_bounding_boxes\x18\x01 \x01(\bR\x14includeBoundingBoxes\x124\n" +
	"\x16include_pose_landmarks\x18\x02 \x01(\bR\x14includePoseLandmarks\x12-\n" +
	"\x12include_attributes\x18\x03 \x01(\bR\x11includeAttributes\"6\n" +
	...
	"\x0fend_time_offset\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\rendTimeOffset\"y\n" +
	"\fLabelSegment\x12I\n" +
	"\asegment\x18\x01 \x01(\v2/.google.cloud.videointelligence.v1.VideoSegmentR\asegment\x12\x1e\n" +
	"\n" +
	...
	"\rlanguage_code\x18\x03 \x01(\tR\flanguageCode\"\xda\x02\n" +
	"\x0fLabelAnnotation\x12A\n" +
	"\x06entity\x18\x01 \x01(\v2).google.cloud.videointelligence.v1.EntityR\x06entity\x12V\n" +
	"\x11category_entities\x18\x02 \x03(\v2).google.cloud.videointelligence.v1.EntityR\x10categoryEntities\x12K\n" +
	"\bsegments\x18\x03 \x03(\v2/.google.cloud.videointelligence.v1.LabelSegmentR\bsegments\x12E\n" +
	"\x06frames\x18\x04 \x03(\v2-.google.cloud.videointelligence.v1.LabelFrameR\x06frames\x12\x18\n" +
	"\aversion\x18\x05 \x01(\tR\aversion\"\xb8\x01\n" +
	"\x14ExplicitContentFrame\x12:\n" +
	"\vtime_offset\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\n" +
	"timeOffset\x12d\n" +
	"\x16pornography_likelihood\x18\x02 \x01(\x0e2-.google.cloud.videointelligence.v1.LikelihoodR\x15pornographyLikelihood\"\x86\x01\n" +
	"\x19ExplicitContentAnnotation\x12O\n" +
	"\x06frames\x18\x01 \x03(\v27.google.cloud.videointelligence.v1.ExplicitContentFrameR\x06frames\x12\x18\n" +
	...
	"\x06bottom\x18\x04 \x01(\x02R\x06bottom\"\x93\x01\n" +
	"\x17FaceDetectionAnnotation\x12@\n" +
	"\x06tracks\x18\x03 \x03(\v2(.google.cloud.videointelligence.v1.TrackR\x06tracks\x12\x1c\n" +
	"\tthumbnail\x18\x04 \x01(\fR\tthumbnail\x12\x18\n" +
	"\aversion\x18\x05 \x01(\tR\aversion\"w\n" +
	"\x19PersonDetectionAnnotation\x12@\n" +
	"\x06tracks\x18\x01 \x03(\v2(.google.cloud.videointelligence.v1.TrackR\x06tracks\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\"X\n" +
	"\vFaceSegment\x12I\n" +
	"\asegment\x18\x01 \x01(\v2/.google.cloud.videointelligence.v1.VideoSegmentR\asegment\"\xc1\x01\n" +
	"\tFaceFrame\x12t\n" +
	"\x19normalized_bounding_boxes\x18\x01 \x03(\v28.google.cloud.videointelligence.v1.NormalizedBoundingBoxR\x17normalizedBoundingBoxes\x12:\n" +
	"\vtime_offset\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\n" +
	"timeOffset:\x02\x18\x01\"\xc4\x01\n" +
	"\x0eFaceAnnotation\x12\x1c\n" +
	"\tthumbnail\x18\x01 \x01(\fR\tthumbnail\x12J\n" +
	"\bsegments\x18\x02 \x03(\v2..google.cloud.videointelligence.v1.FaceSegmentR\bsegments\x12D\n" +
	"\x06frames\x18\x03 \x03(\v2,.google.cloud.videointelligence.v1.FaceFrameR\x06frames:\x02\x18\x01\"\xf4\x02\n" +
	"\x11TimestampedObject\x12p\n" +
	"\x17normalized_bounding_box\x18\x01 \x01(\v28.google.cloud.videointelligence.v1.NormalizedBoundingBoxR\x15normalizedBoundingBox\x12:\n" +
	"\vtime_offset\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\n" +
	"timeOffset\x12Y\n" +
	"\n" +
	"attributes\x18\x03 \x03(\v24.google.cloud.videointelligence.v1.DetectedAttributeB\x03\xe0A\x01R\n" +
	"attributes\x12V\n" +
	"\tlandmarks\x18\x04 \x03(\v23.google.cloud.videointelligence.v1.DetectedLandmarkB\x03\xe0A\x01R\tlandmarks\"\xb9\x02\n" +
	"\x05Track\x12I\n" +
	"\asegment\x18\x01 \x01(\v2/.google.cloud.videointelligence.v1.VideoSegmentR\asegment\x12e\n" +
	"\x13timestamped_objects\x18\x02 \x03(\v24.google.cloud.videointelligence.v1.TimestampedObjectR\x12timestampedObjects\x12Y\n" +
	"\n" +
	"attributes\x18\x03 \x03(\v24.google.cloud.videointelligence.v1.DetectedAttributeB\x03\xe0A\x01R\n" +
	"attributes\x12#\n" +
	"\n" +
	"confidence\x18\x04 \x01(\x02B\x03\xe0A\x01R\n" +
	"confidence\"]\n" +
	"\x11DetectedAttribute\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1e\n" +
	"\n" +
	"confidence\x18\x02 \x01(\x02R\n" +
	"confidence\x12\x14\n" +
	"\x05value\x18\x03 \x01(\tR\x05value\"\x91\x01\n" +
	"\x10DetectedLandmark\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12I\n" +
	"\x05point\x18\x02 \x01(\v23.google.cloud.videointelligence.v1.NormalizedVertexR\x05point\x12\x1e\n" +
	"\n" +
	"confidence\x18\x03 \x01(\x02R\n" +
	"confidence\"\xca\r\n" +
	"\x16VideoAnnotationResults\x12\x1b\n" +
	"\tinput_uri\x18\x01 \x01(\tR\binputUri\x12I\n" +
	"\asegment\x18\n" +
	" \x01(\v2/.google.cloud.videointelligence.v1.VideoSegmentR\asegment\x12n\n" +
	"\x19segment_label_annotations\x18\x02 \x03(\v22.google.cloud.videointelligence.v1.LabelAnnotationR\x17segmentLabelAnnotations\x12\x7f\n" +
	"\"segment_presence_label_annotations\x18\x17 \x03(\v22.google.cloud.videointelligence.v1.LabelAnnotationR\x1fsegmentPresenceLabelAnnotations\x12h\n" +
	"\x16shot_label_annotations\x18\x03 \x03(\v22.google.cloud.videointelligence.v1.LabelAnnotationR\x14shotLabelAnnotations\x12y\n" +
	"\x1fshot_presence_label_annotations\x18\x18 \x03(\v22.google.cloud.videointelligence.v1.LabelAnnotationR\x1cshotPresenceLabelAnnotations\x12j\n" +
	"\x17frame_label_annotations\x18\x04 \x03(\v22.google.cloud.videointelligence.v1.LabelAnnotationR\x15frameLabelAnnotations\x12`\n" +
	"\x10face_annotations\x18\x05 \x03(\v21.google.cloud.videointelligence.v1.FaceAnnotationB\x02\x18\x01R\x0ffaceAnnotations\x12x\n" +
	"\x1aface_detection_annotations\x18\r \x03(\v2:.google.cloud.videointelligence.v1.FaceDetectionAnnotationR\x18faceDetectionAnnotations\x12Z\n" +
	"\x10shot_annotations\x18\x06 \x03(\v2/.google.cloud.videointelligence.v1.VideoSegmentR\x0fshotAnnotations\x12m\n" +
	"\x13explicit_annotation\x18\a \x01(\v2<.google.cloud.videointelligence.v1.ExplicitContentAnnotationR\x12explicitAnnotation\x12k\n" +
	"\x15speech_transcriptions\x18\v \x03(\v26.google.cloud.videointelligence.v1.SpeechTranscriptionR\x14speechTranscriptions\x12\\\n" +
	"\x10text_annotations\x18\f \x03(\v21.google.cloud.videointelligence.v1.TextAnnotationR\x0ftextAnnotations\x12j\n" +
	"\x12object_annotations\x18\x0e \x03(\v2;.google.cloud.videointelligence.v1.ObjectTrackingAnnotationR\x11objectAnnotations\x12~\n" +
	"\x1clogo_recognition_annotations\x18\x13 \x03(\v2<.google.cloud.videointelligence.v1.LogoRecognitionAnnotationR\x1alogoRecognitionAnnotations\x12~\n" +
	"\x1cperson_detection_annotations\x18\x14 \x03(\v2<.google.cloud.videointelligence.v1.PersonDetectionAnnotationR\x1apersonDetectionAnnotations\x12(\n" +
	"\x05error\x18\t \x01(\v2\x12.google.rpc.StatusR\x05error\"\x81\x01\n" +
	"\x15AnnotateVideoResponse\x12h\n" +
	"\x12annotation_results\x18\x01 \x03(\v29.google.cloud.videointelligence.v1.VideoAnnotationResultsR\x11annotationResults\"\xea\x02\n" +
	...
	"updateTime\x12D\n" +
	"\afeature\x18\x05 \x01(\x0e2*.google.cloud.videointelligence.v1.FeatureR\afeature\x12I\n" +
	"\asegment\x18\x06 \x01(\v2/.google.cloud.videointelligence.v1.VideoSegmentR\asegment\"\x84\x01\n" +
	"\x15AnnotateVideoProgress\x12k\n" +
	"\x13annotation_progress\x18\x01 \x03(\v2:.google.cloud.videointelligence.v1.VideoAnnotationProgressR\x12annotationProgress\"\xb3\x04\n" +
	"\x19SpeechTranscriptionConfig\x12(\n" +
	"\rlanguage_code\x18\x01 \x01(\tB\x03\xe0A\x02R\flanguageCode\x12.\n" +
	"\x10max_alternatives\x18\x02 \x01(\x05B\x03\xe0A\x01R\x0fmaxAlternatives\x12.\n" +
	"\x10filter_profanity\x18\x03 \x01(\bB\x03\xe0A\x01R\x0ffilterProfanity\x12^\n" +
	"\x0fspeech_contexts\x18\x04 \x03(\v20.google.cloud.videointelligence.v1.SpeechContextB\x03\xe0A\x01R\x0espeechContexts\x12E\n" +
	"\x1cenable_automatic_punctuation\x18\x05 \x01(\bB\x03\xe0A\x01R\x1aenableAutomaticPunctuation\x12&\n" +
	"\faudio_tracks\x18\x06 \x03(\x05B\x03\xe0A\x01R\vaudioTracks\x12A\n" +
	"\x1aenable_speaker_diarization\x18\a \x01(\bB\x03\xe0A\x01R\x18enableSpeakerDiarization\x12?\n" +
	"\x19diarization_speaker_count\x18\b \x01(\x05B\x03\xe0A\x01R\x17diarizationSpeakerCount\x129\n" +
	"\x16enable_word_confidence\x18\t \x01(\bB\x03\xe0A\x01R\x14enableWordConfidence\".\n" +
	"\rSpeechContext\x12\x1d\n" +
	"\aphrases\x18\x01 \x03(\tB\x03\xe0A\x01R\aphrases\"\xa4\x01\n" +
	"\x13SpeechTranscription\x12c\n" +
	"\falternatives\x18\x01 \x03(\v2?.google.cloud.videointelligence.v1.SpeechRecognitionAlternativeR\falternatives\x12(\n" +
	"\rlanguage_code\x18\x02 \x01(\tB\x03\xe0A\x03R\flanguageCode\"\xab\x01\n" +
	"\x1cSpeechRecognitionAlternative\x12\x1e\n" +
	"\n" +
	"transcript\x18\x01 \x01(\tR\n" +
	"transcript\x12#\n" +
	"\n" +
	"confidence\x18\x02 \x01(\x02B\x03\xe0A\x03R\n" +
	"confidence\x12F\n" +
	"\x05words\x18\x03 \x03(\v2+.google.cloud.videointelligence.v1.WordInfoB\x03\xe0A\x03R\x05words\"\xd9\x01\n" +
	"\bWordInfo\x128\n" +
	"\n" +
	...
	"\n" +
	"confidence\x18\x04 \x01(\x02B\x03\xe0A\x03R\n" +
	"confidence\x12$\n" +
	"\vspeaker_tag\x18\x05 \x01(\x05B\x03\xe0A\x03R\n" +
	"speakerTag\".\n" +
	"\x10NormalizedVertex\x12\f\n" +
	"\x01x\x18\x01 \x01(\x02R\x01x\x12\f\n" +
	"\x01y\x18\x02 \x01(\x02R\x01y\"i\n" +
	"\x16NormalizedBoundingPoly\x12O\n" +
	"\bvertices\x18\x01 \x03(\v23.google.cloud.videointelligence.v1.NormalizedVertexR\bvertices\"\xbe\x01\n" +
	"\vTextSegment\x12I\n" +
	"\asegment\x18\x01 \x01(\v2/.google.cloud.videointelligence.v1.VideoSegmentR\asegment\x12\x1e\n" +
	"\n" +
	"confidence\x18\x02 \x01(\x02R\n" +
	"confidence\x12D\n" +
	"\x06frames\x18\x03 \x03(\v2,.google.cloud.videointelligence.v1.TextFrameR\x06frames\"\xb4\x01\n" +
	"\tTextFrame\x12k\n" +
	"\x14rotated_bounding_box\x18\x01 \x01(\v29.google.cloud.videointelligence.v1.NormalizedBoundingPolyR\x12rotatedBoundingBox\x12:\n" +
	"\vtime_offset\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\n" +
	"timeOffset\"\x8a\x01\n" +
	"\x0eTextAnnotation\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12J\n" +
	"\bsegments\x18\x02 \x03(\v2..google.cloud.videointelligence.v1.TextSegmentR\bsegments\x12\x18\n" +
	...
	"\asegment\x18\x03 \x01(\v2/.google.cloud.videointelligence.v1.VideoSegmentH\x00R\asegment\x12\x1b\n" +
	"\btrack_id\x18\x05 \x01(\x03H\x00R\atrackId\x12A\n" +
	"\x06entity\x18\x01 \x01(\v2).google.cloud.videointelligence.v1.EntityR\x06entity\x12\x1e\n" +
	"\n" +
	"confidence\x18\x04 \x01(\x02R\n" +
	"confidence\x12N\n" +
	"\x06frames\x18\x02 \x03(\v26.google.cloud.videointelligence.v1.ObjectTrackingFrameR\x06frames\x12\x18\n" +
	"\aversion\x18\x06 \x01(\tR\aversionB\f\n" +
	"\n" +
	"track_info\"\xed\x01\n" +
	"\x19LogoRecognitionAnnotation\x12A\n" +
	"\x06entity\x18\x01 \x01(\v2).google.cloud.videointelligence.v1.EntityR\x06entity\x12@\n" +
	"\x06tracks\x18\x02 \x03(\v2(.google.cloud.videointelligence.v1.TrackR\x06tracks\x12K\n" +
	"\bsegments\x18\x03 \x03(\v2/.google.cloud.videointelligence.v1.VideoSegmentR\bsegments*\xf5\x01\n" +
	"\aFeature\x12\x17\n" +
	...
	"\x0eTEXT_DETECTION\x10\a\x12\x13\n" +
	"\x0fOBJECT_TRACKING\x10\t\x12\x14\n" +
	"\x10LOGO_RECOGNITION\x10\f\x12\x14\n" +
	...
	"\x15AnnotateVideoResponse\x12\x15AnnotateVideoProgress\xdaA\x12input_uri,features\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/v1/videos:annotate\x1aT\xcaA videointelligence.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\x8c\x02\n" +
...
var (
	...
	file_google_cloud_videointelligence_v1_video_intelligence_proto_rawDescData []byte
)
...
func file_google_cloud_videointelligence_v1_video_intelligence_proto_rawDescGZIP() []byte {
	file_google_cloud_videointelligence_v1_video_intelligence_proto_rawDescOnce.Do(func() {
		file_google_cloud_videointelligence_v1_video_intelligence_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_videointelligence_v1_video_intelligence_proto_rawDesc), len(file_google_cloud_videointelligence_v1_video_intelligence_proto_rawDesc)))
	})
...
func file_google_cloud_videointelligence_v1_video_intelligence_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_videointelligence_v1_video_intelligence_proto_rawDesc), len(file_google_cloud_videointelligence_v1_video_intelligence_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   43,
			NumExtensions: 0,
			NumServices:   1,
