...
// [START dataform_v1beta1_generated_Dataform_FetchWorkspaceBranches_sync]
...
func main() {
	...
	it := c.FetchWorkspaceBranches(ctx, req)
	for {
		resp, err := it.Next()
		...
		_ = it.Response.(*dataformpb.FetchWorkspaceBranchesResponse)
	}
}

// [END dataform_v1beta1_generated_Dataform_FetchWorkspaceBranches_sync]
