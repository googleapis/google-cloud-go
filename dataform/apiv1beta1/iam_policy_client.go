...
// internalIamPolicyClient is an interface that defines the methods available from Dataform API.
...
// iamPolicyGRPCClient is a client for interacting with Dataform API over gRPC transport.
//
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
