...
func main() {
	...
	req := &aiplatformpb.AsyncQueryReasoningEngineRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb#AsyncQueryReasoningEngineRequest.
	}
	op, err := c.AsyncQueryReasoningEngine(ctx, req)
	if err != nil {
		// TODO: Handle error.
	}
