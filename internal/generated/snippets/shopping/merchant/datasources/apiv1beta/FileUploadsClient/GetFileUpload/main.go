...
func main() {
	...
	c, err := datasources.NewFileUploadsClient(ctx)
	if err != nil {
		// TODO: Handle error.
	}
	defer c.Close()
	...
	req := &datasourcespb.GetFileUploadRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/shopping/merchant/datasources/apiv1beta/datasourcespb#GetFileUploadRequest.
	}
	resp, err := c.GetFileUpload(ctx, req)
	if err != nil {
		// TODO: Handle error.
	}
	// TODO: Use resp.
