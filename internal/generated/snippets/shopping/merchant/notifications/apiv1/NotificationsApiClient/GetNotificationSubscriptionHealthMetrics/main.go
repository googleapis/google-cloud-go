...
func main() {
	...
	req := &notificationspb.GetNotificationSubscriptionHealthMetricsRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/shopping/merchant/notifications/apiv1/notificationspb#GetNotificationSubscriptionHealthMetricsRequest.
	}
	resp, err := c.GetNotificationSubscriptionHealthMetrics(ctx, req)
	if err != nil {
		// TODO: Handle error.
	}
	// TODO: Use resp.
