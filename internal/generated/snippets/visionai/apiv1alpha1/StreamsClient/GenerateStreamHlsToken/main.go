...
// [START visionai_v1alpha1_generated_StreamsService_GenerateStreamHlsToken_sync]
...
func main() {
	...
	req := &visionaipb.GenerateStreamHlsTokenRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/visionai/apiv1alpha1/visionaipb#GenerateStreamHlsTokenRequest.
	}
