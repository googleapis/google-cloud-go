...
// [START visionai_v1alpha1_generated_AppPlatform_CreateApplicationInstances_sync]
...
func main() {
	...
	req := &visionaipb.CreateApplicationInstancesRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/visionai/apiv1alpha1/visionaipb#CreateApplicationInstancesRequest.
	}
