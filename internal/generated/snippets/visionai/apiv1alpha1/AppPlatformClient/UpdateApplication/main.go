...
// [START visionai_v1alpha1_generated_AppPlatform_UpdateApplication_sync]
...
func main() {
	...
	req := &visionaipb.UpdateApplicationRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/visionai/apiv1alpha1/visionaipb#UpdateApplicationRequest.
	}
