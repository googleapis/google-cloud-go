...
func main() {
	...
	req := &backupdrpb.ListResourceBackupConfigsRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/backupdr/apiv1/backupdrpb#ListResourceBackupConfigsRequest.
	}
	it := c.ListResourceBackupConfigs(ctx, req)
	for {
		resp, err := it.Next()
		...
		_ = it.Response.(*backupdrpb.ListResourceBackupConfigsResponse)
	}
}
