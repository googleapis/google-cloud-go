...
func main() {
	...
	c, err := dataplex.NewCmekClient(ctx)
	if err != nil {
		// TODO: Handle error.
	}
	defer c.Close()
	...
	req := &dataplexpb.CreateEncryptionConfigRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/dataplex/apiv1/dataplexpb#CreateEncryptionConfigRequest.
	}
	op, err := c.CreateEncryptionConfig(ctx, req)
	if err != nil {
		// TODO: Handle error.
	}
