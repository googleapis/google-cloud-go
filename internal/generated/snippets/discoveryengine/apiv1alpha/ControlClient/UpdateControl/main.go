...
// [START discoveryengine_v1alpha_generated_ControlService_UpdateControl_sync]
...
func main() {
	...
	req := &discoveryenginepb.UpdateControlRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/discoveryengine/apiv1alpha/discoveryenginepb#UpdateControlRequest.
	}
