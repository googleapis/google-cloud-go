...
// [START discoveryengine_v1_generated_DataStoreService_UpdateDataStore_sync]
...
func main() {
	...
	req := &discoveryenginepb.UpdateDataStoreRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/discoveryengine/apiv1/discoveryenginepb#UpdateDataStoreRequest.
	}
