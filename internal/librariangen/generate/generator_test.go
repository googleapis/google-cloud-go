...
func TestApplyModuleVersion(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupFiles:  []string{"functions/apiv1/client.go", "internal/generated/snippets/functions/snippets.go"},
			wantPresent: []string{"functions/apiv1/client.go", "internal/generated/snippets/functions/snippets.go"},
		},
		{
			name:        "v2",
			moduleName:  "functions",
			modulePath:  "cloud.google.com/go/functions/v2",
			setupFiles:  []string{"functions/v2/apiv1/client.go", "internal/generated/snippets/functions/v2/snippets.go"},
			wantPresent: []string{"functions/apiv1/client.go", "internal/generated/snippets/functions/snippets.go"},
			wantAbsent:  []string{"functions/v2/apiv1/client.go", "internal/generated/snippets/functions/v2/snippets.go"},
		},
		{
			name:        "recaptchaenterprise doesn't move snippets",
			moduleName:  "recaptchaenterprise",
			modulePath:  "cloud.google.com/go/recaptchaenterprise/v2",
			setupFiles:  []string{"recaptchaenterprise/v2/apiv1/client.go", "internal/generated/snippets/recaptchaenterprise/v2/snippets.go"},
			wantPresent: []string{"recaptchaenterprise/apiv1/client.go", "internal/generated/snippets/recaptchaenterprise/v2/snippets.go"},
			wantAbsent:  []string{"recaptchaenterprise/v2/apiv1/client.go"},
		},
		{
