...
func file_google_privacy_dlp_v2_storage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_privacy_dlp_v2_storage_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_privacy_dlp_v2_storage_proto_msgTypes[24].OneofWrappers = []interface{}{
		(*CustomInfoType_Dictionary_WordList_)(nil),
		(*CustomInfoType_Dictionary_CloudStoragePath)(nil),
	}
	file_google_privacy_dlp_v2_storage_proto_msgTypes[27].OneofWrappers = []interface{}{
		(*CustomInfoType_DetectionRule_HotwordRule_)(nil),
	}
	file_google_privacy_dlp_v2_storage_proto_msgTypes[30].OneofWrappers = []interface{}{
	...
	file_google_privacy_dlp_v2_storage_proto_msgTypes[35].OneofWrappers = []interface{}{
