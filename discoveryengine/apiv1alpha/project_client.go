...
type ProjectCallOptions struct {
	...
	ReportConsentChange []gax.CallOption
...
type internalProjectClient interface {
	...
	ReportConsentChange(context.Context, *discoveryenginepb.ReportConsentChangeRequest, ...gax.CallOption) (*discoveryenginepb.Project, error)
...
//
//	Terms for data use (at https://cloud.google.com/retail/data-use-terms)
func (c *ProjectClient) ReportConsentChange(ctx context.Context, req *discoveryenginepb.ReportConsentChangeRequest, opts ...gax.CallOption) (*discoveryenginepb.Project, error) {
	return c.internalClient.ReportConsentChange(ctx, req, opts...)
}
...
func NewProjectClient(ctx context.Context, opts ...option.ClientOption) (*ProjectClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.ProvisionProject = append(client.CallOptions.ProvisionProject, gax.WithClientMetrics(metrics))
		client.CallOptions.ReportConsentChange = append(client.CallOptions.ReportConsentChange, gax.WithClientMetrics(metrics))
...
func NewProjectRESTClient(ctx context.Context, opts ...option.ClientOption) (*ProjectClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.ProvisionProject = append(callOpts.ProvisionProject, gax.WithClientMetrics(metrics))
		callOpts.ReportConsentChange = append(callOpts.ReportConsentChange, gax.WithClientMetrics(metrics))
...
func (c *projectGRPCClient) ProvisionProject(ctx context.Context, req *discoveryenginepb.ProvisionProjectRequest, opts ...gax.CallOption) (*ProvisionProjectOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.projectClient.ProvisionProject, req, settings.GRPC, c.logger, "ProvisionProject")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *projectGRPCClient) ReportConsentChange(ctx context.Context, req *discoveryenginepb.ReportConsentChangeRequest, opts ...gax.CallOption) (*discoveryenginepb.Project, error) {
	...
	opts = append((*c.CallOptions).ReportConsentChange[0:len((*c.CallOptions).ReportConsentChange):len((*c.CallOptions).ReportConsentChange)], opts...)
	var resp *discoveryenginepb.Project
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.projectClient.ReportConsentChange, req, settings.GRPC, c.logger, "ReportConsentChange")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *projectRESTClient) ProvisionProject(ctx context.Context, req *discoveryenginepb.ProvisionProjectRequest, opts ...gax.CallOption) (*ProvisionProjectOperation, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "ProvisionProject")
		if err != nil {
			return err
		}
		if err := unm.Unmarshal(buf, resp); err != nil {
...
//
//	Terms for data use (at https://cloud.google.com/retail/data-use-terms)
func (c *projectRESTClient) ReportConsentChange(ctx context.Context, req *discoveryenginepb.ReportConsentChangeRequest, opts ...gax.CallOption) (*discoveryenginepb.Project, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v:reportConsentChange", req.GetProject())
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "ReportConsentChange")
		if err != nil {
			return err
		}
