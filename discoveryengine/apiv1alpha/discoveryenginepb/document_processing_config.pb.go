...
const file_google_cloud_discoveryengine_v1alpha_document_processing_config_proto_rawDesc = "" +
	"\n" +
	"Egoogle/cloud/discoveryengine/v1alpha/document_processing_config.proto\x12$google.cloud.discoveryengine.v1alpha\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\xcc\x0e\n" +
	"\x18DocumentProcessingConfig\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12v\n" +
	"\x0fchunking_config\x18\x03 \x01(\v2M.google.cloud.discoveryengine.v1alpha.DocumentProcessingConfig.ChunkingConfigR\x0echunkingConfig\x12\x82\x01\n" +
	"\x16default_parsing_config\x18\x04 \x01(\v2L.google.cloud.discoveryengine.v1alpha.DocumentProcessingConfig.ParsingConfigR\x14defaultParsingConfig\x12\x94\x01\n" +
	"\x18parsing_config_overrides\x18\x05 \x03(\v2Z.google.cloud.discoveryengine.v1alpha.DocumentProcessingConfig.ParsingConfigOverridesEntryR\x16parsingConfigOverrides\x1a\xc3\x02\n" +
	"\x0eChunkingConfig\x12\xaa\x01\n" +
	"\x1clayout_based_chunking_config\x18\x01 \x01(\v2g.google.cloud.discoveryengine.v1alpha.DocumentProcessingConfig.ChunkingConfig.LayoutBasedChunkingConfigH\x00R\x19layoutBasedChunkingConfig\x1av\n" +
	...
	"\n" +
	"chunk_mode\x1a\x9a\x05\n" +
	"\rParsingConfig\x12\x99\x01\n" +
	"\x16digital_parsing_config\x18\x01 \x01(\v2a.google.cloud.discoveryengine.v1alpha.DocumentProcessingConfig.ParsingConfig.DigitalParsingConfigH\x00R\x14digitalParsingConfig\x12\x8d\x01\n" +
	"\x12ocr_parsing_config\x18\x02 \x01(\v2].google.cloud.discoveryengine.v1alpha.DocumentProcessingConfig.ParsingConfig.OcrParsingConfigH\x00R\x10ocrParsingConfig\x12\x96\x01\n" +
	"\x15layout_parsing_config\x18\x03 \x01(\v2`.google.cloud.discoveryengine.v1alpha.DocumentProcessingConfig.ParsingConfig.LayoutParsingConfigH\x00R\x13layoutParsingConfig\x1a\x16\n" +
	...
	"\x15type_dedicated_config\x1a\x97\x01\n" +
	"\x1bParsingConfigOverridesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12b\n" +
	"\x05value\x18\x02 \x01(\v2L.google.cloud.discoveryengine.v1alpha.DocumentProcessingConfig.ParsingConfigR\x05value:\x028\x01:\x8a\x02\xeaA\x86\x02\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1alpha_document_processing_config_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1alpha_document_processing_config_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1alpha_document_processing_config_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1alpha_document_processing_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_document_processing_config_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_document_processing_config_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1alpha_document_processing_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_document_processing_config_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_document_processing_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
