...
const file_google_cloud_discoveryengine_v1alpha_conversational_search_service_proto_rawDesc = "" +
	"\n" +
	"Hgoogle/cloud/discoveryengine/v1alpha/conversational_search_service.proto\x12$google.cloud.discoveryengine.v1alpha\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a1google/cloud/discoveryengine/v1alpha/answer.proto\x1a1google/cloud/discoveryengine/v1alpha/common.proto\x1a7google/cloud/discoveryengine/v1alpha/conversation.proto\x1a9google/cloud/discoveryengine/v1alpha/search_service.proto\x1a2google/cloud/discoveryengine/v1alpha/session.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\"\xa4\x06\n" +
	"\x1bConverseConversationRequest\x12G\n" +
	"\x04name\x18\x01 \x01(\tB3\xe0A\x02\xfaA-\n" +
	"+discoveryengine.googleapis.com/ConversationR\x04name\x12J\n" +
	"\x05query\x18\x02 \x01(\v2/.google.cloud.discoveryengine.v1alpha.TextInputB\x03\xe0A\x02R\x05query\x12X\n" +
	"\x0eserving_config\x18\x03 \x01(\tB1\xfaA.\n" +
	",discoveryengine.googleapis.com/ServingConfigR\rservingConfig\x12V\n" +
	"\fconversation\x18\x05 \x01(\v22.google.cloud.discoveryengine.v1alpha.ConversationR\fconversation\x12\x1f\n" +
	"\vsafe_search\x18\x06 \x01(\bR\n" +
	"safeSearch\x12r\n" +
	"\vuser_labels\x18\a \x03(\v2Q.google.cloud.discoveryengine.v1alpha.ConverseConversationRequest.UserLabelsEntryR\n" +
	"userLabels\x12t\n" +
	"\fsummary_spec\x18\b \x01(\v2Q.google.cloud.discoveryengine.v1alpha.SearchRequest.ContentSearchSpec.SummarySpecR\vsummarySpec\x12\x16\n" +
	"\x06filter\x18\t \x01(\tR\x06filter\x12\\\n" +
	"\n" +
	"boost_spec\x18\n" +
	" \x01(\v2=.google.cloud.discoveryengine.v1alpha.SearchRequest.BoostSpecR\tboostSpec\x1a=\n" +
	"\x0fUserLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xd0\x02\n" +
	"\x1cConverseConversationResponse\x12A\n" +
	"\x05reply\x18\x01 \x01(\v2+.google.cloud.discoveryengine.v1alpha.ReplyR\x05reply\x12V\n" +
	"\fconversation\x18\x02 \x01(\v22.google.cloud.discoveryengine.v1alpha.ConversationR\fconversation\x12+\n" +
	"\x11related_questions\x18\x06 \x03(\tR\x10relatedQuestions\x12h\n" +
	"\x0esearch_results\x18\x03 \x03(\v2A.google.cloud.discoveryengine.v1alpha.SearchResponse.SearchResultR\rsearchResults\"\xc2\x01\n" +
	...
	"\fconversation\x18\x02 \x01(\v22.google.cloud.discoveryengine.v1alpha.ConversationB\x03\xe0A\x02R\fconversation\"\xb5\x01\n" +
	"\x19UpdateConversationRequest\x12[\n" +
	"\fconversation\x18\x01 \x01(\v22.google.cloud.discoveryengine.v1alpha.ConversationB\x03\xe0A\x02R\fconversation\x12;\n" +
	...
	"\x19ListConversationsResponse\x12X\n" +
	"\rconversations\x18\x01 \x03(\v22.google.cloud.discoveryengine.v1alpha.ConversationR\rconversations\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xb2'\n" +
	"\x12AnswerQueryRequest\x12[\n" +
	"\x0eserving_config\x18\x01 \x01(\tB4\xe0A\x02\xfaA.\n" +
	",discoveryengine.googleapis.com/ServingConfigR\rservingConfig\x12F\n" +
	"\x05query\x18\x02 \x01(\v2+.google.cloud.discoveryengine.v1alpha.QueryB\x03\xe0A\x02R\x05query\x12E\n" +
	"\asession\x18\x03 \x01(\tB+\xfaA(\n" +
	"&discoveryengine.googleapis.com/SessionR\asession\x12d\n" +
	"\vsafety_spec\x18\x04 \x01(\v2C.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.SafetySpecR\n" +
	"safetySpec\x12\x83\x01\n" +
	"\x16related_questions_spec\x18\x05 \x01(\v2M.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.RelatedQuestionsSpecR\x14relatedQuestionsSpec\x12\x83\x01\n" +
	"\x16answer_generation_spec\x18\a \x01(\v2M.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.AnswerGenerationSpecR\x14answerGenerationSpec\x12d\n" +
	"\vsearch_spec\x18\b \x01(\v2C.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.SearchSpecR\n" +
	"searchSpec\x12\x89\x01\n" +
	"\x18query_understanding_spec\x18\t \x01(\v2O.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.QueryUnderstandingSpecR\x16queryUnderstandingSpec\x12+\n" +
	"\x11asynchronous_mode\x18\n" +
	" \x01(\bR\x10asynchronousMode\x12$\n" +
	"\x0euser_pseudo_id\x18\f \x01(\tR\fuserPseudoId\x12i\n" +
	"\vuser_labels\x18\r \x03(\v2H.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.UserLabelsEntryR\n" +
	"userLabels\x1a$\n" +
	"\n" +
	"SafetySpec\x12\x16\n" +
	"\x06enable\x18\x01 \x01(\bR\x06enable\x1a.\n" +
	"\x14RelatedQuestionsSpec\x12\x16\n" +
	"\x06enable\x18\x01 \x01(\bR\x06enable\x1a\xa8\x05\n" +
	"\x14AnswerGenerationSpec\x12v\n" +
	"\n" +
	"model_spec\x18\x01 \x01(\v2W.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.AnswerGenerationSpec.ModelSpecR\tmodelSpec\x12y\n" +
	"\vprompt_spec\x18\x02 \x01(\v2X.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.AnswerGenerationSpec.PromptSpecR\n" +
	"promptSpec\x12+\n" +
	...
	"\x1bignore_low_relevant_content\x18\a \x01(\bH\x00R\x18ignoreLowRelevantContent\x88\x01\x01\x1a0\n" +
	"\tModelSpec\x12#\n" +
	"\rmodel_version\x18\x01 \x01(\tR\fmodelVersion\x1a(\n" +
	"\n" +
	"PromptSpec\x12\x1a\n" +
	"\bpreamble\x18\x01 \x01(\tR\bpreambleB\x1e\n" +
	"\x1c_ignore_low_relevant_content\x1a\x8a\x13\n" +
	"\n" +
	"SearchSpec\x12w\n" +
	"\rsearch_params\x18\x01 \x01(\v2P.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.SearchSpec.SearchParamsH\x00R\fsearchParams\x12\x84\x01\n" +
	"\x12search_result_list\x18\x02 \x01(\v2T.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.SearchSpec.SearchResultListH\x00R\x10searchResultList\x1a\xb4\x04\n" +
	"\fSearchParams\x12,\n" +
	"\x12max_return_results\x18\x01 \x01(\x05R\x10maxReturnResults\x12\x16\n" +
	"\x06filter\x18\x02 \x01(\tR\x06filter\x12\\\n" +
	"\n" +
	"boost_spec\x18\x03 \x01(\v2=.google.cloud.discoveryengine.v1alpha.SearchRequest.BoostSpecR\tboostSpec\x12\x19\n" +
	"\border_by\x18\x04 \x01(\tR\aorderBy\x12\x84\x01\n" +
	"\x12search_result_mode\x18\x05 \x01(\x0e2V.google.cloud.discoveryengine.v1alpha.SearchRequest.ContentSearchSpec.SearchResultModeR\x10searchResultMode\x12q\n" +
	"\x17custom_fine_tuning_spec\x18\x06 \x01(\v2:.google.cloud.discoveryengine.v1alpha.CustomFineTuningSpecR\x14customFineTuningSpec\x12k\n" +
	"\x10data_store_specs\x18\a \x03(\v2A.google.cloud.discoveryengine.v1alpha.SearchRequest.DataStoreSpecR\x0edataStoreSpecs\x1a\xbb\f\n" +
	"\x10SearchResultList\x12\x88\x01\n" +
	"\x0esearch_results\x18\x01 \x03(\v2a.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.SearchSpec.SearchResultList.SearchResultR\rsearchResults\x1a\x9b\v\n" +
	"\fSearchResult\x12\xba\x01\n" +
	"\x1aunstructured_document_info\x18\x01 \x01(\v2z.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.SearchSpec.SearchResultList.SearchResult.UnstructuredDocumentInfoH\x00R\x18unstructuredDocumentInfo\x12\x8c\x01\n" +
	"\n" +
	"chunk_info\x18\x02 \x01(\v2k.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.SearchSpec.SearchResultList.SearchResult.ChunkInfoH\x00R\tchunkInfo\x1a\xcb\a\n" +
	...
	"\x05title\x18\x03 \x01(\tR\x05title\x12\xb8\x01\n" +
	"\x11document_contexts\x18\x04 \x03(\v2\x8a\x01.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.SearchSpec.SearchResultList.SearchResult.UnstructuredDocumentInfo.DocumentContextR\x10documentContexts\x12\xbe\x01\n" +
	"\x13extractive_segments\x18\x05 \x03(\v2\x8c\x01.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.SearchSpec.SearchResultList.SearchResult.UnstructuredDocumentInfo.ExtractiveSegmentR\x12extractiveSegments\x12\xbb\x01\n" +
	"\x12extractive_answers\x18\x06 \x03(\v2\x8b\x01.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.SearchSpec.SearchResultList.SearchResult.UnstructuredDocumentInfo.ExtractiveAnswerR\x11extractiveAnswers\x1aT\n" +
	...
	"\x0fpage_identifier\x18\x01 \x01(\tR\x0epageIdentifier\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontent\x1af\n" +
	"\tChunkInfo\x12?\n" +
	"\x05chunk\x18\x01 \x01(\tB)\xfaA&\n" +
	"$discoveryengine.googleapis.com/ChunkR\x05chunk\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontentB\t\n" +
	"\acontentB\a\n" +
	"\x05input\x1a\xc0\x05\n" +
	"\x16QueryUnderstandingSpec\x12\xa3\x01\n" +
	"\x19query_classification_spec\x18\x01 \x01(\v2g.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.QueryUnderstandingSpec.QueryClassificationSpecR\x17queryClassificationSpec\x12\x94\x01\n" +
	"\x14query_rephraser_spec\x18\x02 \x01(\v2b.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.QueryUnderstandingSpec.QueryRephraserSpecR\x12queryRephraserSpec\x1a\x8a\x02\n" +
	"\x17QueryClassificationSpec\x12\x82\x01\n" +
	"\x05types\x18\x01 \x03(\x0e2l.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.QueryUnderstandingSpec.QueryClassificationSpec.TypeR\x05types\"j\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\x15\n" +
	"\x11ADVERSARIAL_QUERY\x10\x01\x12\x1c\n" +
	"\x18NON_ANSWER_SEEKING_QUERY\x10\x02\x12\x17\n" +
	"\x13JAIL_BREAKING_QUERY\x10\x03\x1a\\\n" +
	"\x12QueryRephraserSpec\x12\x18\n" +
	"\adisable\x18\x01 \x01(\bR\adisable\x12,\n" +
	"\x12max_rephrase_steps\x18\x02 \x01(\x05R\x10maxRephraseSteps\x1a=\n" +
	"\x0fUserLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xd2\x01\n" +
	"\x13AnswerQueryResponse\x12D\n" +
	"\x06answer\x18\x01 \x01(\v2,.google.cloud.discoveryengine.v1alpha.AnswerR\x06answer\x12G\n" +
	"\asession\x18\x02 \x01(\v2-.google.cloud.discoveryengine.v1alpha.SessionR\asession\x12,\n" +
	"\x12answer_query_token\x18\x03 \x01(\tR\x10answerQueryToken\"U\n" +
	"\x10GetAnswerRequest\x12A\n" +
	"\x04name\x18\x01 \x01(\tB-\xe0A\x02\xfaA'\n" +
	"%discoveryengine.googleapis.com/AnswerR\x04name\"\xae\x01\n" +
	"\x14CreateSessionRequest\x12H\n" +
	"\x06parent\x18\x01 \x01(\tB0\xe0A\x02\xfaA*\n" +
	"(discoveryengine.googleapis.com/DataStoreR\x06parent\x12L\n" +
	"\asession\x18\x02 \x01(\v2-.google.cloud.discoveryengine.v1alpha.SessionB\x03\xe0A\x02R\asession\"\xa1\x01\n" +
	"\x14UpdateSessionRequest\x12L\n" +
	"\asession\x18\x01 \x01(\v2-.google.cloud.discoveryengine.v1alpha.SessionB\x03\xe0A\x02R\asession\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"Z\n" +
	...
	"\x14ListSessionsResponse\x12I\n" +
	"\bsessions\x18\x01 \x03(\v2-.google.cloud.discoveryengine.v1alpha.SessionR\bsessions\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken2\x96*\n" +
	"\x1bConversationalSearchService\x12\xc4\x03\n" +
	"\x14ConverseConversation\x12A.google.cloud.discoveryengine.v1alpha.ConverseConversationRequest\x1aB.google.cloud.discoveryengine.v1alpha.ConverseConversationResponse\"\xa4\x02\xdaA\n" +
	"name,query\x82\xd3\xe4\x93\x02\x90\x02:\x01*Z_:\x01*\"Z/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/conversations/*}:converseZ\\:\x01*\"W/v1alpha/{name=projects/*/locations/*/collections/*/engines/*/conversations/*}:converse\"L/v1alpha/{name=projects/*/locations/*/dataStores/*/conversations/*}:converse\x12\xbf\x03\n" +
	"\x12CreateConversation\x12?.google.cloud.discoveryengine.v1alpha.CreateConversationRequest\x1a2.google.cloud.discoveryengine.v1alpha.Conversation\"\xb3\x02\xdaA\x13parent,conversation\x82\xd3\xe4\x93\x02\x96\x02:\fconversationZa:\fconversation\"Q/v1alpha/{parent=projects/*/locations/*/collections/*/dataStores/*}/conversationsZ^:\fconversation\"N/v1alpha/{parent=projects/*/locations/*/collections/*/engines/*}/conversations\"C/v1alpha/{parent=projects/*/locations/*/dataStores/*}/conversations\x12\xea\x02\n" +
	"\x12DeleteConversation\x12?.google.cloud.discoveryengine.v1alpha.DeleteConversationRequest\x1a\x16.google.protobuf.Empty\"\xfa\x01\xdaA\x04name\x82\xd3\xe4\x93\x02\xec\x01ZS*Q/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/conversations/*}ZP*N/v1alpha/{name=projects/*/locations/*/collections/*/engines/*/conversations/*}*C/v1alpha/{name=projects/*/locations/*/dataStores/*/conversations/*}\x12\xeb\x03\n" +
	"\x12UpdateConversation\x12?.google.cloud.discoveryengine.v1alpha.UpdateConversationRequest\x1a2.google.cloud.discoveryengine.v1alpha.Conversation\"\xdf\x02\xdaA\x18conversation,update_mask\x82\xd3\xe4\x93\x02\xbd\x02:\fconversationZn:\fconversation2^/v1alpha/{conversation.name=projects/*/locations/*/collections/*/dataStores/*/conversations/*}Zk:\fconversation2[/v1alpha/{conversation.name=projects/*/locations/*/collections/*/engines/*/conversations/*}2P/v1alpha/{conversation.name=projects/*/locations/*/dataStores/*/conversations/*}\x12\x80\x03\n" +
	"\x0fGetConversation\x12<.google.cloud.discoveryengine.v1alpha.GetConversationRequest\x1a2.google.cloud.discoveryengine.v1alpha.Conversation\"\xfa\x01\xdaA\x04name\x82\xd3\xe4\x93\x02\xec\x01ZS\x12Q/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/conversations/*}ZP\x12N/v1alpha/{name=projects/*/locations/*/collections/*/engines/*/conversations/*}\x12C/v1alpha/{name=projects/*/locations/*/dataStores/*/conversations/*}\x12\x93\x03\n" +
	"\x11ListConversations\x12>.google.cloud.discoveryengine.v1alpha.ListConversationsRequest\x1a?.google.cloud.discoveryengine.v1alpha.ListConversationsResponse\"\xfc\x01\xdaA\x06parent\x82\xd3\xe4\x93\x02\xec\x01ZS\x12Q/v1alpha/{parent=projects/*/locations/*/collections/*/dataStores/*}/conversationsZP\x12N/v1alpha/{parent=projects/*/locations/*/collections/*/engines/*}/conversations\x12C/v1alpha/{parent=projects/*/locations/*/dataStores/*}/conversations\x12\xb7\x03\n" +
	"\vAnswerQuery\x128.google.cloud.discoveryengine.v1alpha.AnswerQueryRequest\x1a9.google.cloud.discoveryengine.v1alpha.AnswerQueryResponse\"\xb2\x02\x82\xd3\xe4\x93\x02\xab\x02:\x01*Zh:\x01*\"c/v1alpha/{serving_config=projects/*/locations/*/collections/*/dataStores/*/servingConfigs/*}:answerZe:\x01*\"`/v1alpha/{serving_config=projects/*/locations/*/collections/*/engines/*/servingConfigs/*}:answer\"U/v1alpha/{serving_config=projects/*/locations/*/dataStores/*/servingConfigs/*}:answer\x12\xfd\x02\n" +
	"\tGetAnswer\x126.google.cloud.discoveryengine.v1alpha.GetAnswerRequest\x1a,.google.cloud.discoveryengine.v1alpha.Answer\"\x89\x02\xdaA\x04name\x82\xd3\xe4\x93\x02\xfb\x01ZX\x12V/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/sessions/*/answers/*}ZU\x12S/v1alpha/{name=projects/*/locations/*/collections/*/engines/*/sessions/*/answers/*}\x12H/v1alpha/{name=projects/*/locations/*/dataStores/*/sessions/*/answers/*}\x12\x8d\x03\n" +
	...
	"\fListSessions\x129.google.cloud.discoveryengine.v1alpha.ListSessionsRequest\x1a:.google.cloud.discoveryengine.v1alpha.ListSessionsResponse\"\xed\x01\xdaA\x06parent\x82\xd3\xe4\x93\x02\xdd\x01ZN\x12L/v1alpha/{parent=projects/*/locations/*/collections/*/dataStores/*}/sessionsZK\x12I/v1alpha/{parent=projects/*/locations/*/collections/*/engines/*}/sessions\x12>/v1alpha/{parent=projects/*/locations/*/dataStores/*}/sessions\x1aR\xcaA\x1ediscoveryengine.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xac\x02\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1alpha_conversational_search_service_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1alpha_conversational_search_service_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1alpha_conversational_search_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1alpha_conversational_search_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_conversational_search_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_conversational_search_service_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1alpha_conversational_search_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_conversational_search_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_conversational_search_service_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   36,
			NumExtensions: 0,
			NumServices:   1,
