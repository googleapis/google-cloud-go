...
const file_google_cloud_discoveryengine_v1alpha_conversation_proto_rawDesc = "" +
	"\n" +
	"7google/cloud/discoveryengine/v1alpha/conversation.proto\x12$google.cloud.discoveryengine.v1alpha\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a9google/cloud/discoveryengine/v1alpha/search_service.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa9\x06\n" +
	"\fConversation\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x05R\x04name\x12N\n" +
	"\x05state\x18\x02 \x01(\x0e28.google.cloud.discoveryengine.v1alpha.Conversation.StateR\x05state\x12$\n" +
	"\x0euser_pseudo_id\x18\x03 \x01(\tR\fuserPseudoId\x12U\n" +
	"\bmessages\x18\x04 \x03(\v29.google.cloud.discoveryengine.v1alpha.ConversationMessageR\bmessages\x12>\n" +
	"\n" +
	...
	"\x05Reply\x12\x18\n" +
	"\x05reply\x18\x01 \x01(\tB\x02\x18\x01R\x05reply\x12Y\n" +
	"\n" +
	"references\x18\x02 \x03(\v25.google.cloud.discoveryengine.v1alpha.Reply.ReferenceB\x02\x18\x01R\n" +
	"references\x12V\n" +
	"\asummary\x18\x03 \x01(\v2<.google.cloud.discoveryengine.v1alpha.SearchResponse.SummaryR\asummary\x1aj\n" +
	"\tReference\x12\x10\n" +
	...
	"\x0factive_document\x18\x02 \x01(\tR\x0eactiveDocument\"v\n" +
	"\tTextInput\x12\x14\n" +
	"\x05input\x18\x01 \x01(\tR\x05input\x12S\n" +
	"\acontext\x18\x02 \x01(\v29.google.cloud.discoveryengine.v1alpha.ConversationContextR\acontext\"\xf9\x01\n" +
	"\x13ConversationMessage\x12P\n" +
	"\n" +
	"user_input\x18\x01 \x01(\v2/.google.cloud.discoveryengine.v1alpha.TextInputH\x00R\tuserInput\x12C\n" +
	"\x05reply\x18\x02 \x01(\v2+.google.cloud.discoveryengine.v1alpha.ReplyH\x00R\x05reply\x12@\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1alpha_conversation_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1alpha_conversation_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1alpha_conversation_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1alpha_conversation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_conversation_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_conversation_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1alpha_conversation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_conversation_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_conversation_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
