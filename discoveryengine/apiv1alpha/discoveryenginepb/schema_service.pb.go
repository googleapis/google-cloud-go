...
func file_google_cloud_discoveryengine_v1alpha_schema_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_discoveryengine_v1alpha_schema_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_discoveryengine_v1alpha_schema_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_discoveryengine_v1alpha_schema_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_discoveryengine_v1alpha_schema_service_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
