...
type SetUriPatternDocumentDataRequest struct {
	...
	//	  }
	//	}
	DocumentDataMap map[string]*structpb.Struct `protobuf:"bytes,2,rep,name=document_data_map,json=documentDataMap,proto3" json:"document_data_map,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_google_cloud_discoveryengine_v1alpha_site_search_engine_service_proto_rawDesc = "" +
	"\n" +
	"Egoogle/cloud/discoveryengine/v1alpha/site_search_engine_service.proto\x12$google.cloud.discoveryengine.v1alpha\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a=google/cloud/discoveryengine/v1alpha/site_search_engine.proto\x1a#google/longrunning/operations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"i\n" +
	"\x1aGetSiteSearchEngineRequest\x12K\n" +
	"\x04name\x18\x01 \x01(\tB7\xe0A\x02\xfaA1\n" +
	"/discoveryengine.googleapis.com/SiteSearchEngineR\x04name\"\xc2\x01\n" +
	"\x17CreateTargetSiteRequest\x12O\n" +
	"\x06parent\x18\x01 \x01(\tB7\xe0A\x02\xfaA1\n" +
	"/discoveryengine.googleapis.com/SiteSearchEngineR\x06parent\x12V\n" +
	"\vtarget_site\x18\x02 \x01(\v20.google.cloud.discoveryengine.v1alpha.TargetSiteB\x03\xe0A\x02R\n" +
	"targetSite\"\x94\x01\n" +
	...
	"\brequests\x18\x02 \x03(\v2=.google.cloud.discoveryengine.v1alpha.CreateTargetSiteRequestB\x03\xe0A\x02R\brequests\"]\n" +
	"\x14GetTargetSiteRequest\x12E\n" +
	"\x04name\x18\x01 \x01(\tB1\xe0A\x02\xfaA+\n" +
	")discoveryengine.googleapis.com/TargetSiteR\x04name\"q\n" +
	"\x17UpdateTargetSiteRequest\x12V\n" +
	"\vtarget_site\x18\x01 \x01(\v20.google.cloud.discoveryengine.v1alpha.TargetSiteB\x03\xe0A\x02R\n" +
	"targetSite\"\x94\x01\n" +
	...
	"\x17ListTargetSitesResponse\x12S\n" +
	"\ftarget_sites\x18\x01 \x03(\v20.google.cloud.discoveryengine.v1alpha.TargetSiteR\vtargetSites\x12&\n" +
	...
	"\vupdate_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\"u\n" +
	"\x1eBatchCreateTargetSitesResponse\x12S\n" +
	"\ftarget_sites\x18\x01 \x03(\v20.google.cloud.discoveryengine.v1alpha.TargetSiteR\vtargetSites\"\x88\x01\n" +
	...
	"\x04uris\x18\x02 \x03(\tB\x03\xe0A\x02R\x04uris\"\xc2\x04\n" +
	"\x13RecrawlUrisResponse\x12n\n" +
	"\x0ffailure_samples\x18\x01 \x03(\v2E.google.cloud.discoveryengine.v1alpha.RecrawlUrisResponse.FailureInfoR\x0efailureSamples\x12\x1f\n" +
	"\vfailed_uris\x18\x02 \x03(\tR\n" +
	"failedUris\x1a\x99\x03\n" +
	"\vFailureInfo\x12\x10\n" +
	"\x03uri\x18\x01 \x01(\tR\x03uri\x12|\n" +
	"\x0ffailure_reasons\x18\x02 \x03(\v2S.google.cloud.discoveryengine.v1alpha.RecrawlUrisResponse.FailureInfo.FailureReasonR\x0efailureReasons\x1a\xf9\x01\n" +
	"\rFailureReason\x12\x7f\n" +
	"\vcorpus_type\x18\x01 \x01(\x0e2^.google.cloud.discoveryengine.v1alpha.RecrawlUrisResponse.FailureInfo.FailureReason.CorpusTypeR\n" +
	"corpusType\x12#\n" +
	...
	"%FetchDomainVerificationStatusResponse\x12S\n" +
	"\ftarget_sites\x18\x01 \x03(\v20.google.cloud.discoveryengine.v1alpha.TargetSiteR\vtargetSites\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize\"\xd8\x03\n" +
	" SetUriPatternDocumentDataRequest\x12e\n" +
	"\x12site_search_engine\x18\x01 \x01(\tB7\xe0A\x02\xfaA1\n" +
	"/discoveryengine.googleapis.com/SiteSearchEngineR\x10siteSearchEngine\x12\x87\x01\n" +
	"\x11document_data_map\x18\x02 \x03(\v2[.google.cloud.discoveryengine.v1alpha.SetUriPatternDocumentDataRequest.DocumentDataMapEntryR\x0fdocumentDataMap\x125\n" +
	"\x17empty_document_data_map\x18\x04 \x01(\bR\x14emptyDocumentDataMap\x12/\n" +
	"\x06schema\x18\x03 \x01(\v2\x17.google.protobuf.StructR\x06schema\x1a[\n" +
	"\x14DocumentDataMapEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12-\n" +
	"\x05value\x18\x02 \x01(\v2\x17.google.protobuf.StructR\x05value:\x028\x01\"#\n" +
	"!SetUriPatternDocumentDataResponse\"\x9d\x01\n" +
	"!SetUriPatternDocumentDataMetadata\x12;\n" +
	"\vcreate_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x12;\n" +
	"\vupdate_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\"\x89\x01\n" +
	" GetUriPatternDocumentDataRequest\x12e\n" +
	"\x12site_search_engine\x18\x01 \x01(\tB7\xe0A\x02\xfaA1\n" +
	"/discoveryengine.googleapis.com/SiteSearchEngineR\x10siteSearchEngine\"\x8b\x02\n" +
	"!GetUriPatternDocumentDataResponse\x12\x88\x01\n" +
	"\x11document_data_map\x18\x01 \x03(\v2\\.google.cloud.discoveryengine.v1alpha.GetUriPatternDocumentDataResponse.DocumentDataMapEntryR\x0fdocumentDataMap\x1a[\n" +
	"\x14DocumentDataMapEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12-\n" +
	"\x05value\x18\x02 \x01(\v2\x17.google.protobuf.StructR\x05value:\x028\x012\x95.\n" +
	"\x17SiteSearchEngineService\x12\xbc\x02\n" +
	"\x13GetSiteSearchEngine\x12@.google.cloud.discoveryengine.v1alpha.GetSiteSearchEngineRequest\x1a6.google.cloud.discoveryengine.v1alpha.SiteSearchEngine\"\xaa\x01\xdaA\x04name\x82\xd3\xe4\x93\x02\x9c\x01ZT\x12R/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine}\x12D/v1alpha/{name=projects/*/locations/*/dataStores/*/siteSearchEngine}\x12\xd4\x03\n" +
	"\x10CreateTargetSite\x12=.google.cloud.discoveryengine.v1alpha.CreateTargetSiteRequest\x1a\x1d.google.longrunning.Operation\"\xe1\x02\xcaAp\n" +
	"/google.cloud.discoveryengine.v1alpha.TargetSite\x12=google.cloud.discoveryengine.v1alpha.CreateTargetSiteMetadata\xdaA\x12parent,target_site\x82\xd3\xe4\x93\x02\xd2\x01:\vtarget_siteZo:\vtarget_site\"`/v1alpha/{parent=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine}/targetSites\"R/v1alpha/{parent=projects/*/locations/*/dataStores/*/siteSearchEngine}/targetSites\x12\xe9\x03\n" +
	"\x16BatchCreateTargetSites\x12C.google.cloud.discoveryengine.v1alpha.BatchCreateTargetSitesRequest\x1a\x1d.google.longrunning.Operation\"\xea\x02\xcaA\x89\x01\n" +
	"Cgoogle.cloud.discoveryengine.v1alpha.BatchCreateTargetSitesResponse\x12Bgoogle.cloud.discoveryengine.v1alpha.BatchCreateTargetSiteMetadata\x82\xd3\xe4\x93\x02\xd6\x01:\x01*Zq:\x01*\"l/v1alpha/{parent=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine}/targetSites:batchCreate\"^/v1alpha/{parent=projects/*/locations/*/dataStores/*/siteSearchEngine}/targetSites:batchCreate\x12\xc6\x02\n" +
	"\rGetTargetSite\x12:.google.cloud.discoveryengine.v1alpha.GetTargetSiteRequest\x1a0.google.cloud.discoveryengine.v1alpha.TargetSite\"\xc6\x01\xdaA\x04name\x82\xd3\xe4\x93\x02\xb8\x01Zb\x12`/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine/targetSites/*}\x12R/v1alpha/{name=projects/*/locations/*/dataStores/*/siteSearchEngine/targetSites/*}\x12\xe5\x03\n" +
	"\x10UpdateTargetSite\x12=.google.cloud.discoveryengine.v1alpha.UpdateTargetSiteRequest\x1a\x1d.google.longrunning.Operation\"\xf2\x02\xcaAp\n" +
	"/google.cloud.discoveryengine.v1alpha.TargetSite\x12=google.cloud.discoveryengine.v1alpha.UpdateTargetSiteMetadata\xdaA\vtarget_site\x82\xd3\xe4\x93\x02\xea\x01:\vtarget_siteZ{:\vtarget_site2l/v1alpha/{target_site.name=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine/targetSites/*}2^/v1alpha/{target_site.name=projects/*/locations/*/dataStores/*/siteSearchEngine/targetSites/*}\x12\x92\x03\n" +
	"\x10DeleteTargetSite\x12=.google.cloud.discoveryengine.v1alpha.DeleteTargetSiteRequest\x1a\x1d.google.longrunning.Operation\"\x9f\x02\xcaAV\n" +
	"\x15google.protobuf.Empty\x12=google.cloud.discoveryengine.v1alpha.DeleteTargetSiteMetadata\xdaA\x04name\x82\xd3\xe4\x93\x02\xb8\x01Zb*`/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine/targetSites/*}*R/v1alpha/{name=projects/*/locations/*/dataStores/*/siteSearchEngine/targetSites/*}\x12\xd9\x02\n" +
	"\x0fListTargetSites\x12<.google.cloud.discoveryengine.v1alpha.ListTargetSitesRequest\x1a=.google.cloud.discoveryengine.v1alpha.ListTargetSitesResponse\"\xc8\x01\xdaA\x06parent\x82\xd3\xe4\x93\x02\xb8\x01Zb\x12`/v1alpha/{parent=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine}/targetSites\x12R/v1alpha/{parent=projects/*/locations/*/dataStores/*/siteSearchEngine}/targetSites\x12\x8c\x04\n" +
	"\x18EnableAdvancedSiteSearch\x12E.google.cloud.discoveryengine.v1alpha.EnableAdvancedSiteSearchRequest\x1a\x1d.google.longrunning.Operation\"\x89\x03\xcaA\x8e\x01\n" +
	"Egoogle.cloud.discoveryengine.v1alpha.EnableAdvancedSiteSearchResponse\x12Egoogle.cloud.discoveryengine.v1alpha.EnableAdvancedSiteSearchMetadata\x82\xd3\xe4\x93\x02\xf0\x01:\x01*Z~:\x01*\"y/v1alpha/{site_search_engine=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine}:enableAdvancedSiteSearch\"k/v1alpha/{site_search_engine=projects/*/locations/*/dataStores/*/siteSearchEngine}:enableAdvancedSiteSearch\x12\x92\x04\n" +
	"\x19DisableAdvancedSiteSearch\x12F.google.cloud.discoveryengine.v1alpha.DisableAdvancedSiteSearchRequest\x1a\x1d.google.longrunning.Operation\"\x8d\x03\xcaA\x90\x01\n" +
	"Fgoogle.cloud.discoveryengine.v1alpha.DisableAdvancedSiteSearchResponse\x12Fgoogle.cloud.discoveryengine.v1alpha.DisableAdvancedSiteSearchMetadata\x82\xd3\xe4\x93\x02\xf2\x01:\x01*Z\x7f:\x01*\"z/v1alpha/{site_search_engine=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine}:disableAdvancedSiteSearch\"l/v1alpha/{site_search_engine=projects/*/locations/*/dataStores/*/siteSearchEngine}:disableAdvancedSiteSearch\x12\xbd\x03\n" +
	"\vRecrawlUris\x128.google.cloud.discoveryengine.v1alpha.RecrawlUrisRequest\x1a\x1d.google.longrunning.Operation\"\xd4\x02\xcaAt\n" +
	"8google.cloud.discoveryengine.v1alpha.RecrawlUrisResponse\x128google.cloud.discoveryengine.v1alpha.RecrawlUrisMetadata\x82\xd3\xe4\x93\x02\xd6\x01:\x01*Zq:\x01*\"l/v1alpha/{site_search_engine=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine}:recrawlUris\"^/v1alpha/{site_search_engine=projects/*/locations/*/dataStores/*/siteSearchEngine}:recrawlUris\x12\x83\x03\n" +
	"\x16BatchVerifyTargetSites\x12C.google.cloud.discoveryengine.v1alpha.BatchVerifyTargetSitesRequest\x1a\x1d.google.longrunning.Operation\"\x84\x02\xcaA\x8a\x01\n" +
	"Cgoogle.cloud.discoveryengine.v1alpha.BatchVerifyTargetSitesResponse\x12Cgoogle.cloud.discoveryengine.v1alpha.BatchVerifyTargetSitesMetadata\x82\xd3\xe4\x93\x02p:\x01*\"k/v1alpha/{parent=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine}:batchVerifyTargetSites\x12\xc2\x02\n" +
	"\x1dFetchDomainVerificationStatus\x12J.google.cloud.discoveryengine.v1alpha.FetchDomainVerificationStatusRequest\x1aK.google.cloud.discoveryengine.v1alpha.FetchDomainVerificationStatusResponse\"\x87\x01\x82\xd3\xe4\x93\x02\x80\x01\x12~/v1alpha/{site_search_engine=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine}:fetchDomainVerificationStatus\x12\x9e\x03\n" +
	"\x19SetUriPatternDocumentData\x12F.google.cloud.discoveryengine.v1alpha.SetUriPatternDocumentDataRequest\x1a\x1d.google.longrunning.Operation\"\x99\x02\xcaA\x90\x01\n" +
	"Fgoogle.cloud.discoveryengine.v1alpha.SetUriPatternDocumentDataResponse\x12Fgoogle.cloud.discoveryengine.v1alpha.SetUriPatternDocumentDataMetadata\x82\xd3\xe4\x93\x02\x7f:\x01*\"z/v1alpha/{site_search_engine=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine}:setUriPatternDocumentData\x12\xb1\x02\n" +
	"\x19GetUriPatternDocumentData\x12F.google.cloud.discoveryengine.v1alpha.GetUriPatternDocumentDataRequest\x1aG.google.cloud.discoveryengine.v1alpha.GetUriPatternDocumentDataResponse\"\x82\x01\x82\xd3\xe4\x93\x02|\x12z/v1alpha/{site_search_engine=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine}:getUriPatternDocumentData\x1aR\xcaA\x1ediscoveryengine.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xa8\x02\n" +
	"(com.google.cloud.discoveryengine.v1alphaB\x1cSiteSearchEngineServiceProtoP\x01ZRcloud.google.com/go/discoveryengine/apiv1alpha/discoveryenginepb;discoveryenginepb\xa2\x02\x0fDISCOVERYENGINE\xaa\x02$Google.Cloud.DiscoveryEngine.V1Alpha\xca\x02$Google\\Cloud\\DiscoveryEngine\\V1alpha\xea\x02'Google::Cloud::DiscoveryEngine::V1alphab\x06proto3"

var (
	file_google_cloud_discoveryengine_v1alpha_site_search_engine_service_proto_rawDescOnce sync.Once
	file_google_cloud_discoveryengine_v1alpha_site_search_engine_service_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1alpha_site_search_engine_service_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1alpha_site_search_engine_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1alpha_site_search_engine_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_site_search_engine_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_site_search_engine_service_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1alpha_site_search_engine_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_site_search_engine_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_site_search_engine_service_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   36,
			NumExtensions: 0,
			NumServices:   1,
