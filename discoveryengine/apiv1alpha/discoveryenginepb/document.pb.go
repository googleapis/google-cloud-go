...
func (x *ProcessedDocument) GetJsonData() string {
	if x != nil {
		if x, ok := x.ProcessedDataFormat.(*ProcessedDocument_JsonData); ok {
			return x.JsonData
		}
	}
	return ""
...
const file_google_cloud_discoveryengine_v1alpha_document_proto_rawDesc = "" +
	...
	"\tschema_id\x18\x03 \x01(\tR\bschemaId\x12P\n" +
	"\acontent\x18\n" +
	" \x01(\v26.google.cloud.discoveryengine.v1alpha.Document.ContentR\acontent\x12,\n" +
	"\x12parent_document_id\x18\a \x01(\tR\x10parentDocumentId\x12L\n" +
	"\x13derived_struct_data\x18\x06 \x01(\v2\x17.google.protobuf.StructB\x03\xe0A\x03R\x11derivedStructData\x12Q\n" +
	"\bacl_info\x18\v \x01(\v26.google.cloud.discoveryengine.v1alpha.Document.AclInfoR\aaclInfo\x12>\n" +
	"\n" +
	"index_time\x18\r \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tindexTime\x12b\n" +
	"\findex_status\x18\x0f \x01(\v2:.google.cloud.discoveryengine.v1alpha.Document.IndexStatusB\x03\xe0A\x03R\vindexStatus\x1ad\n" +
	"\aContent\x12\x1d\n" +
	...
	"\acontent\x1a\xee\x01\n" +
	"\aAclInfo\x12b\n" +
	"\areaders\x18\x01 \x03(\v2H.google.cloud.discoveryengine.v1alpha.Document.AclInfo.AccessRestrictionR\areaders\x1a\x7f\n" +
	"\x11AccessRestriction\x12O\n" +
	"\n" +
	"principals\x18\x01 \x03(\v2/.google.cloud.discoveryengine.v1alpha.PrincipalR\n" +
	"principals\x12\x19\n" +
	"\bidp_wide\x18\x02 \x01(\bR\aidpWide\x1a\x81\x01\n" +
	"\vIndexStatus\x129\n" +
	"\n" +
	...
	"\x04data\"\x98\x01\n" +
	"\x11ProcessedDocument\x12\x1d\n" +
	"\tjson_data\x18\x02 \x01(\tH\x00R\bjsonData\x12K\n" +
	"\bdocument\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'discoveryengine.googleapis.com/DocumentR\bdocumentB\x17\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1alpha_document_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1alpha_document_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1alpha_document_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1alpha_document_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_document_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_document_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1alpha_document_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_document_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_document_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
