...
var file_google_cloud_discoveryengine_v1alpha_session_proto_goTypes = []interface{}{
...
func file_google_cloud_discoveryengine_v1alpha_session_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_discoveryengine_v1alpha_session_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_discoveryengine_v1alpha_session_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Query); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_cloud_discoveryengine_v1alpha_session_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_discoveryengine_v1alpha_session_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*Query_Text)(nil),
	}
	type x struct{}
