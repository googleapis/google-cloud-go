...
var file_google_cloud_discoveryengine_v1alpha_control_service_proto_goTypes = []interface{}{
...
func file_google_cloud_discoveryengine_v1alpha_control_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_discoveryengine_v1alpha_control_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_discoveryengine_v1alpha_control_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_discoveryengine_v1alpha_control_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_discoveryengine_v1alpha_control_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_discoveryengine_v1alpha_control_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_discoveryengine_v1alpha_control_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
...
func (c *controlServiceClient) CreateControl(ctx context.Context, in *CreateControlRequest, opts ...grpc.CallOption) (*Control, error) {
	out := new(Control)
	err := c.cc.Invoke(ctx, "/google.cloud.discoveryengine.v1alpha.ControlService/CreateControl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *controlServiceClient) DeleteControl(ctx context.Context, in *DeleteControlRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/google.cloud.discoveryengine.v1alpha.ControlService/DeleteControl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *controlServiceClient) UpdateControl(ctx context.Context, in *UpdateControlRequest, opts ...grpc.CallOption) (*Control, error) {
	out := new(Control)
	err := c.cc.Invoke(ctx, "/google.cloud.discoveryengine.v1alpha.ControlService/UpdateControl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *controlServiceClient) GetControl(ctx context.Context, in *GetControlRequest, opts ...grpc.CallOption) (*Control, error) {
	out := new(Control)
	err := c.cc.Invoke(ctx, "/google.cloud.discoveryengine.v1alpha.ControlService/GetControl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *controlServiceClient) ListControls(ctx context.Context, in *ListControlsRequest, opts ...grpc.CallOption) (*ListControlsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.cloud.discoveryengine.v1alpha.ControlService/ListControls", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ControlService_CreateControl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.cloud.discoveryengine.v1alpha.ControlService/CreateControl",
	}
...
func _ControlService_DeleteControl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.cloud.discoveryengine.v1alpha.ControlService/DeleteControl",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ControlService_UpdateControl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.cloud.discoveryengine.v1alpha.ControlService/UpdateControl",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ControlService_GetControl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.cloud.discoveryengine.v1alpha.ControlService/GetControl",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ControlService_ListControls_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.cloud.discoveryengine.v1alpha.ControlService/ListControls",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
