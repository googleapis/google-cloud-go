...
const file_google_cloud_discoveryengine_v1alpha_control_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x06parent\x18\x01 \x01(\tB.\xe0A\x02\xfaA(\x12&discoveryengine.googleapis.com/ControlR\x06parent\x12L\n" +
	"\acontrol\x18\x02 \x01(\v2-.google.cloud.discoveryengine.v1alpha.ControlB\x03\xe0A\x02R\acontrol\x12\"\n" +
	"\n" +
	"control_id\x18\x03 \x01(\tB\x03\xe0A\x02R\tcontrolId\"\xa6\x01\n" +
	"\x14UpdateControlRequest\x12L\n" +
	"\acontrol\x18\x01 \x01(\v2-.google.cloud.discoveryengine.v1alpha.ControlB\x03\xe0A\x02R\acontrol\x12@\n" +
	...
	"\x06filter\x18\x04 \x01(\tB\x03\xe0A\x01R\x06filter\"\x89\x01\n" +
	"\x14ListControlsResponse\x12I\n" +
	"\bcontrols\x18\x01 \x03(\v2-.google.cloud.discoveryengine.v1alpha.ControlR\bcontrols\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken2\xdd\x0f\n" +
	"\x0eControlService\x12\x98\x03\n" +
	"\rCreateControl\x12:.google.cloud.discoveryengine.v1alpha.CreateControlRequest\x1a-.google.cloud.discoveryengine.v1alpha.Control\"\x9b\x02\xdaA\x19parent,control,control_id\x82\xd3\xe4\x93\x02\xf8\x01:\acontrolZW:\acontrol\"L/v1alpha/{parent=projects/*/locations/*/collections/*/dataStores/*}/controlsZT:\acontrol\"I/v1alpha/{parent=projects/*/locations/*/collections/*/engines/*}/controls\">/v1alpha/{parent=projects/*/locations/*/dataStores/*}/controls\x12\xd1\x02\n" +
	"\rDeleteControl\x12:.google.cloud.discoveryengine.v1alpha.DeleteControlRequest\x1a\x16.google.protobuf.Empty\"\xeb\x01\xdaA\x04name\x82\xd3\xe4\x93\x02\xdd\x01ZN*L/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/controls/*}ZK*I/v1alpha/{name=projects/*/locations/*/collections/*/engines/*/controls/*}*>/v1alpha/{name=projects/*/locations/*/dataStores/*/controls/*}\x12\xaa\x03\n" +
	"\rUpdateControl\x12:.google.cloud.discoveryengine.v1alpha.UpdateControlRequest\x1a-.google.cloud.discoveryengine.v1alpha.Control\"\xad\x02\xdaA\x13control,update_mask\x82\xd3\xe4\x93\x02\x90\x02:\acontrolZ_:\acontrol2T/v1alpha/{control.name=projects/*/locations/*/collections/*/dataStores/*/controls/*}Z\\:\acontrol2Q/v1alpha/{control.name=projects/*/locations/*/collections/*/engines/*/controls/*}2F/v1alpha/{control.name=projects/*/locations/*/dataStores/*/controls/*}\x12\xe2\x02\n" +
	"\n" +
	"GetControl\x127.google.cloud.discoveryengine.v1alpha.GetControlRequest\x1a-.google.cloud.discoveryengine.v1alpha.Control\"\xeb\x01\xdaA\x04name\x82\xd3\xe4\x93\x02\xdd\x01ZN\x12L/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/controls/*}ZK\x12I/v1alpha/{name=projects/*/locations/*/collections/*/engines/*/controls/*}\x12>/v1alpha/{name=projects/*/locations/*/dataStores/*/controls/*}\x12\xf5\x02\n" +
	"\fListControls\x129.google.cloud.discoveryengine.v1alpha.ListControlsRequest\x1a:.google.cloud.discoveryengine.v1alpha.ListControlsResponse\"\xed\x01\xdaA\x06parent\x82\xd3\xe4\x93\x02\xdd\x01ZN\x12L/v1alpha/{parent=projects/*/locations/*/collections/*/dataStores/*}/controlsZK\x12I/v1alpha/{parent=projects/*/locations/*/collections/*/engines/*}/controls\x12>/v1alpha/{parent=projects/*/locations/*/dataStores/*}/controls\x1aR\xcaA\x1ediscoveryengine.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\x9f\x02\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1alpha_control_service_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1alpha_control_service_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1alpha_control_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1alpha_control_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_control_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_control_service_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1alpha_control_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_control_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_control_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
