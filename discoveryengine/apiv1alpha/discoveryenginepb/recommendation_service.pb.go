...
const file_google_cloud_discoveryengine_v1alpha_recommendation_service_proto_rawDesc = "" +
	"\n" +
	...
	",discoveryengine.googleapis.com/ServingConfigR\rservingConfig\x12S\n" +
	"\n" +
	"user_event\x18\x02 \x01(\v2/.google.cloud.discoveryengine.v1alpha.UserEventB\x03\xe0A\x02R\tuserEvent\x12\x1b\n" +
	...
	"\x06params\x18\x06 \x03(\v2B.google.cloud.discoveryengine.v1alpha.RecommendRequest.ParamsEntryR\x06params\x12g\n" +
	"\vuser_labels\x18\b \x03(\v2F.google.cloud.discoveryengine.v1alpha.RecommendRequest.UserLabelsEntryR\n" +
	"userLabels\x1aQ\n" +
	...
	"\aresults\x18\x01 \x03(\v2L.google.cloud.discoveryengine.v1alpha.RecommendResponse.RecommendationResultR\aresults\x12+\n" +
	"\x11attribution_token\x18\x02 \x01(\tR\x10attributionToken\x12\x1f\n" +
	"\vmissing_ids\x18\x03 \x03(\tR\n" +
	"missingIds\x12#\n" +
	"\rvalidate_only\x18\x04 \x01(\bR\fvalidateOnly\x1a\xbf\x02\n" +
	"\x14RecommendationResult\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12J\n" +
	"\bdocument\x18\x02 \x01(\v2..google.cloud.discoveryengine.v1alpha.DocumentR\bdocument\x12v\n" +
	"\bmetadata\x18\x03 \x03(\v2Z.google.cloud.discoveryengine.v1alpha.RecommendResponse.RecommendationResult.MetadataEntryR\bmetadata\x1aS\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value:\x028\x012\xa8\x04\n" +
	"\x15RecommendationService\x12\xba\x03\n" +
	"\tRecommend\x126.google.cloud.discoveryengine.v1alpha.RecommendRequest\x1a7.google.cloud.discoveryengine.v1alpha.RecommendResponse\"\xbb\x02\x82\xd3\xe4\x93\x02\xb4\x02:\x01*Zk:\x01*\"f/v1alpha/{serving_config=projects/*/locations/*/collections/*/dataStores/*/servingConfigs/*}:recommendZh:\x01*\"c/v1alpha/{serving_config=projects/*/locations/*/collections/*/engines/*/servingConfigs/*}:recommend\"X/v1alpha/{serving_config=projects/*/locations/*/dataStores/*/servingConfigs/*}:recommend\x1aR\xcaA\x1ediscoveryengine.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xa6\x02\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1alpha_recommendation_service_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1alpha_recommendation_service_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1alpha_recommendation_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1alpha_recommendation_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_recommendation_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_recommendation_service_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1alpha_recommendation_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_recommendation_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_recommendation_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
