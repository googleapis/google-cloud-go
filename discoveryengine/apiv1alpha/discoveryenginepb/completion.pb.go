...
const file_google_cloud_discoveryengine_v1alpha_completion_proto_rawDesc = "" +
	"\n" +
	"5google/cloud/discoveryengine/v1alpha/completion.proto\x12$google.cloud.discoveryengine.v1alpha\x1a\x1fgoogle/api/field_behavior.proto\"\x8a\x02\n" +
	"\x17SuggestionDenyListEntry\x12&\n" +
	"\fblock_phrase\x18\x01 \x01(\tB\x03\xe0A\x02R\vblockPhrase\x12w\n" +
	"\x0ematch_operator\x18\x02 \x01(\x0e2K.google.cloud.discoveryengine.v1alpha.SuggestionDenyListEntry.MatchOperatorB\x03\xe0A\x02R\rmatchOperator\"N\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1alpha_completion_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1alpha_completion_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1alpha_completion_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1alpha_completion_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_completion_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_completion_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1alpha_completion_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_completion_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_completion_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
