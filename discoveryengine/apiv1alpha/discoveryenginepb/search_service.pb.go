...
func file_google_cloud_discoveryengine_v1alpha_search_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_discoveryengine_v1alpha_search_service_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_google_cloud_discoveryengine_v1alpha_search_service_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_google_cloud_discoveryengine_v1alpha_search_service_proto_msgTypes[35].Exporter = func(v any, i int) any {
	...
	file_google_cloud_discoveryengine_v1alpha_search_service_proto_msgTypes[30].OneofWrappers = []any{
