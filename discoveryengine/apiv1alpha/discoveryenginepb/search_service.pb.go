...
type SearchRequest struct {
	...
	Params map[string]*structpb.Value `protobuf:"bytes,11,rep,name=params,proto3" json:"params,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	// for more details.
	UserLabels map[string]string `protobuf:"bytes,22,rep,name=user_labels,json=userLabels,proto3" json:"user_labels,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *SearchRequest_ImageQuery) GetImage() isSearchRequest_ImageQuery_Image {
	if x != nil {
		return x.Image
	}
	return nil
...
func (x *SearchRequest_ImageQuery) GetImageBytes() string {
	if x != nil {
		if x, ok := x.Image.(*SearchRequest_ImageQuery_ImageBytes); ok {
			return x.ImageBytes
		}
	}
	return ""
...
func (x *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_Expression) GetExpr() isSearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_Expression_Expr {
	if x != nil {
		return x.Expr
	}
	return nil
...
func (x *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_Expression) GetStringConstraint() *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_StringConstraint {
	if x != nil {
		if x, ok := x.Expr.(*SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_Expression_StringConstraint); ok {
...
func (x *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_Expression) GetNumberConstraint() *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_NumberConstraint {
	if x != nil {
		if x, ok := x.Expr.(*SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_Expression_NumberConstraint); ok {
...
func (x *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_Expression) GetGeolocationConstraint() *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_GeolocationConstraint {
	if x != nil {
		if x, ok := x.Expr.(*SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_Expression_GeolocationConstraint); ok {
...
func (x *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_Expression) GetAndExpr() *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_AndExpression {
	if x != nil {
		if x, ok := x.Expr.(*SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_Expression_AndExpr); ok {
			return x.AndExpr
		}
	}
	return nil
...
func (x *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_Expression) GetOrExpr() *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_OrExpression {
	if x != nil {
		if x, ok := x.Expr.(*SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_Expression_OrExpr); ok {
			return x.OrExpr
		}
	}
	return nil
...
const file_google_cloud_discoveryengine_v1alpha_search_service_proto_rawDesc = "" +
	...
	"%discoveryengine.googleapis.com/BranchR\x06branch\x12\x14\n" +
	"\x05query\x18\x03 \x01(\tR\x05query\x12_\n" +
	"\vimage_query\x18\x13 \x01(\v2>.google.cloud.discoveryengine.v1alpha.SearchRequest.ImageQueryR\n" +
	"imageQuery\x12\x1b\n" +
	"\tpage_size\x18\x04 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x05 \x01(\tR\tpageToken\x12\x16\n" +
	"\x06offset\x18\x06 \x01(\x05R\x06offset\x12k\n" +
	"\x10data_store_specs\x18  \x03(\v2A.google.cloud.discoveryengine.v1alpha.SearchRequest.DataStoreSpecR\x0edataStoreSpecs\x12\x16\n" +
	"\x06filter\x18\a \x01(\tR\x06filter\x12)\n" +
	"\x10canonical_filter\x18\x1d \x01(\tR\x0fcanonicalFilter\x12\x19\n" +
	"\border_by\x18\b \x01(\tR\aorderBy\x12K\n" +
	"\tuser_info\x18\x15 \x01(\v2..google.cloud.discoveryengine.v1alpha.UserInfoR\buserInfo\x12#\n" +
	"\rlanguage_code\x18# \x01(\tR\flanguageCode\x12\x1f\n" +
	"\vregion_code\x18$ \x01(\tR\n" +
	"regionCode\x12^\n" +
	"\vfacet_specs\x18\t \x03(\v2=.google.cloud.discoveryengine.v1alpha.SearchRequest.FacetSpecR\n" +
	"facetSpecs\x12\\\n" +
	"\n" +
	"boost_spec\x18\n" +
	" \x01(\v2=.google.cloud.discoveryengine.v1alpha.SearchRequest.BoostSpecR\tboostSpec\x12W\n" +
	"\x06params\x18\v \x03(\v2?.google.cloud.discoveryengine.v1alpha.SearchRequest.ParamsEntryR\x06params\x12x\n" +
	"\x14query_expansion_spec\x18\r \x01(\v2F.google.cloud.discoveryengine.v1alpha.SearchRequest.QueryExpansionSpecR\x12queryExpansionSpec\x12{\n" +
	"\x15spell_correction_spec\x18\x0e \x01(\v2G.google.cloud.discoveryengine.v1alpha.SearchRequest.SpellCorrectionSpecR\x13spellCorrectionSpec\x12$\n" +
	"\x0euser_pseudo_id\x18\x0f \x01(\tR\fuserPseudoId\x12u\n" +
	"\x13content_search_spec\x18\x18 \x01(\v2E.google.cloud.discoveryengine.v1alpha.SearchRequest.ContentSearchSpecR\x11contentSearchSpec\x12h\n" +
	"\x0eembedding_spec\x18\x17 \x01(\v2A.google.cloud.discoveryengine.v1alpha.SearchRequest.EmbeddingSpecR\rembeddingSpec\x12-\n" +
	"\x12ranking_expression\x18\x1a \x01(\tR\x11rankingExpression\x12\x8f\x01\n" +
	"\x1aranking_expression_backend\x185 \x01(\x0e2L.google.cloud.discoveryengine.v1alpha.SearchRequest.RankingExpressionBackendB\x03\xe0A\x01R\x18rankingExpressionBackend\x12\x1f\n" +
	"\vsafe_search\x18\x14 \x01(\bR\n" +
	"safeSearch\x12d\n" +
	"\vuser_labels\x18\x16 \x03(\v2C.google.cloud.discoveryengine.v1alpha.SearchRequest.UserLabelsEntryR\n" +
	"userLabels\x12\xb3\x01\n" +
	")natural_language_query_understanding_spec\x18\x1c \x01(\v2Y.google.cloud.discoveryengine.v1alpha.SearchRequest.NaturalLanguageQueryUnderstandingSpecR%naturalLanguageQueryUnderstandingSpec\x12}\n" +
	"\x17search_as_you_type_spec\x18\x1f \x01(\v2G.google.cloud.discoveryengine.v1alpha.SearchRequest.SearchAsYouTypeSpecR\x13searchAsYouTypeSpec\x12q\n" +
	"\x17custom_fine_tuning_spec\x18\" \x01(\v2:.google.cloud.discoveryengine.v1alpha.CustomFineTuningSpecR\x14customFineTuningSpec\x12E\n" +
	"\asession\x18) \x01(\tB+\xfaA(\n" +
	"&discoveryengine.googleapis.com/SessionR\asession\x12b\n" +
	"\fsession_spec\x18* \x01(\v2?.google.cloud.discoveryengine.v1alpha.SearchRequest.SessionSpecR\vsessionSpec\x12w\n" +
	"\x13relevance_threshold\x18, \x01(\x0e2F.google.cloud.discoveryengine.v1alpha.SearchRequest.RelevanceThresholdR\x12relevanceThreshold\x1a8\n" +
	"\n" +
	"ImageQuery\x12!\n" +
	...
	"(discoveryengine.googleapis.com/DataStoreR\tdataStore\x1a\x92\x04\n" +
	"\tFacetSpec\x12h\n" +
	"\tfacet_key\x18\x01 \x01(\v2F.google.cloud.discoveryengine.v1alpha.SearchRequest.FacetSpec.FacetKeyB\x03\xe0A\x02R\bfacetKey\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x05R\x05limit\x120\n" +
	"\x14excluded_filter_keys\x18\x03 \x03(\tR\x12excludedFilterKeys\x126\n" +
	"\x17enable_dynamic_position\x18\x04 \x01(\bR\x15enableDynamicPosition\x1a\x9a\x02\n" +
	"\bFacetKey\x12\x15\n" +
	"\x03key\x18\x01 \x01(\tB\x03\xe0A\x02R\x03key\x12L\n" +
	"\tintervals\x18\x02 \x03(\v2..google.cloud.discoveryengine.v1alpha.IntervalR\tintervals\x12+\n" +
	"\x11restricted_values\x18\x03 \x03(\tR\x10restrictedValues\x12\x1a\n" +
	"\bprefixes\x18\x04 \x03(\tR\bprefixes\x12\x1a\n" +
	"\bcontains\x18\x05 \x03(\tR\bcontains\x12)\n" +
	"\x10case_insensitive\x18\x06 \x01(\bR\x0fcaseInsensitive\x12\x19\n" +
	"\border_by\x18\a \x01(\tR\aorderBy\x1a\xe9\b\n" +
	"\tBoostSpec\x12\x84\x01\n" +
	"\x15condition_boost_specs\x18\x01 \x03(\v2P.google.cloud.discoveryengine.v1alpha.SearchRequest.BoostSpec.ConditionBoostSpecR\x13conditionBoostSpecs\x1a\xd4\a\n" +
	"\x12ConditionBoostSpec\x12\x1c\n" +
	"\tcondition\x18\x01 \x01(\tR\tcondition\x12\x14\n" +
	"\x05boost\x18\x02 \x01(\x02R\x05boost\x12\x8f\x01\n" +
	"\x12boost_control_spec\x18\x03 \x01(\v2a.google.cloud.discoveryengine.v1alpha.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpecR\x10boostControlSpec\x1a\xf7\x05\n" +
	"\x10BoostControlSpec\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x12\x96\x01\n" +
	"\x0eattribute_type\x18\x02 \x01(\x0e2o.google.cloud.discoveryengine.v1alpha.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.AttributeTypeR\rattributeType\x12\xa2\x01\n" +
	"\x12interpolation_type\x18\x03 \x01(\x0e2s.google.cloud.discoveryengine.v1alpha.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.InterpolationTypeR\x11interpolationType\x12\x95\x01\n" +
	"\x0econtrol_points\x18\x04 \x03(\v2n.google.cloud.discoveryengine.v1alpha.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.ControlPointR\rcontrolPoints\x1aZ\n" +
	"\fControlPoint\x12'\n" +
	"\x0fattribute_value\x18\x01 \x01(\tR\x0eattributeValue\x12!\n" +
	"\fboost_amount\x18\x02 \x01(\x02R\vboostAmount\"M\n" +
	...
	"\n" +
	"\x06LINEAR\x10\x01\x1a\xfa\x01\n" +
	"\x12QueryExpansionSpec\x12n\n" +
	"\tcondition\x18\x01 \x01(\x0e2P.google.cloud.discoveryengine.v1alpha.SearchRequest.QueryExpansionSpec.ConditionR\tcondition\x124\n" +
	...
	"\x04AUTO\x10\x02\x1a\xb4\x01\n" +
	"\x13SpellCorrectionSpec\x12`\n" +
	"\x04mode\x18\x01 \x01(\x0e2L.google.cloud.discoveryengine.v1alpha.SearchRequest.SpellCorrectionSpec.ModeR\x04mode\";\n" +
	"\x04Mode\x12\x14\n" +
	"\x10MODE_UNSPECIFIED\x10\x00\x12\x13\n" +
	"\x0fSUGGESTION_ONLY\x10\x01\x12\b\n" +
	"\x04AUTO\x10\x02\x1a\xfe\x0f\n" +
	"\x11ContentSearchSpec\x12t\n" +
	"\fsnippet_spec\x18\x01 \x01(\v2Q.google.cloud.discoveryengine.v1alpha.SearchRequest.ContentSearchSpec.SnippetSpecR\vsnippetSpec\x12t\n" +
	"\fsummary_spec\x18\x02 \x01(\v2Q.google.cloud.discoveryengine.v1alpha.SearchRequest.ContentSearchSpec.SummarySpecR\vsummarySpec\x12\x93\x01\n" +
	"\x17extractive_content_spec\x18\x03 \x01(\v2[.google.cloud.discoveryengine.v1alpha.SearchRequest.ContentSearchSpec.ExtractiveContentSpecR\x15extractiveContentSpec\x12\x84\x01\n" +
	"\x12search_result_mode\x18\x04 \x01(\x0e2V.google.cloud.discoveryengine.v1alpha.SearchRequest.ContentSearchSpec.SearchResultModeR\x10searchResultMode\x12n\n" +
	"\n" +
	"chunk_spec\x18\x05 \x01(\v2O.google.cloud.discoveryengine.v1alpha.SearchRequest.ContentSearchSpec.ChunkSpecR\tchunkSpec\x1a\x8f\x01\n" +
	"\vSnippetSpec\x12.\n" +
	"\x11max_snippet_count\x18\x01 \x01(\x05B\x02\x18\x01R\x0fmaxSnippetCount\x12)\n" +
	"\x0ereference_only\x18\x02 \x01(\bB\x02\x18\x01R\rreferenceOnly\x12%\n" +
	"\x0ereturn_snippet\x18\x03 \x01(\bR\rreturnSnippet\x1a\xe4\x05\n" +
	"\vSummarySpec\x120\n" +
	"\x14summary_result_count\x18\x01 \x01(\x05R\x12summaryResultCount\x12+\n" +
	"\x11include_citations\x18\x02 \x01(\bR\x10includeCitations\x128\n" +
	"\x18ignore_adversarial_query\x18\x03 \x01(\bR\x16ignoreAdversarialQuery\x12F\n" +
	" ignore_non_summary_seeking_query\x18\x04 \x01(\bR\x1cignoreNonSummarySeekingQuery\x12=\n" +
	"\x1bignore_low_relevant_content\x18\t \x01(\bR\x18ignoreLowRelevantContent\x12\x8d\x01\n" +
	"\x11model_prompt_spec\x18\x05 \x01(\v2a.google.cloud.discoveryengine.v1alpha.SearchRequest.ContentSearchSpec.SummarySpec.ModelPromptSpecR\x0fmodelPromptSpec\x12#\n" +
	"\rlanguage_code\x18\x06 \x01(\tR\flanguageCode\x12z\n" +
	"\n" +
	"model_spec\x18\a \x01(\v2[.google.cloud.discoveryengine.v1alpha.SearchRequest.ContentSearchSpec.SummarySpec.ModelSpecR\tmodelSpec\x12.\n" +
	"\x13use_semantic_chunks\x18\b \x01(\bR\x11useSemanticChunks\x1a-\n" +
	"\x0fModelPromptSpec\x12\x1a\n" +
	"\bpreamble\x18\x01 \x01(\tR\bpreamble\x1a%\n" +
	"\tModelSpec\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\x1a\xbe\x02\n" +
	"\x15ExtractiveContentSpec\x12=\n" +
	"\x1bmax_extractive_answer_count\x18\x01 \x01(\x05R\x18maxExtractiveAnswerCount\x12?\n" +
	"\x1cmax_extractive_segment_count\x18\x02 \x01(\x05R\x19maxExtractiveSegmentCount\x12E\n" +
	"\x1freturn_extractive_segment_score\x18\x03 \x01(\bR\x1creturnExtractiveSegmentScore\x122\n" +
	"\x15num_previous_segments\x18\x04 \x01(\x05R\x13numPreviousSegments\x12*\n" +
	"\x11num_next_segments\x18\x05 \x01(\x05R\x0fnumNextSegments\x1ac\n" +
	"\tChunkSpec\x12.\n" +
	"\x13num_previous_chunks\x18\x01 \x01(\x05R\x11numPreviousChunks\x12&\n" +
	"\x0fnum_next_chunks\x18\x02 \x01(\x05R\rnumNextChunks\"Q\n" +
	"\x10SearchResultMode\x12\"\n" +
	"\x1eSEARCH_RESULT_MODE_UNSPECIFIED\x10\x00\x12\r\n" +
	"\tDOCUMENTS\x10\x01\x12\n" +
	"\n" +
	"\x06CHUNKS\x10\x02\x1a\xd9\x01\n" +
	"\rEmbeddingSpec\x12~\n" +
	"\x11embedding_vectors\x18\x01 \x03(\v2Q.google.cloud.discoveryengine.v1alpha.SearchRequest.EmbeddingSpec.EmbeddingVectorR\x10embeddingVectors\x1aH\n" +
	"\x0fEmbeddingVector\x12\x1d\n" +
	"\n" +
	"field_path\x18\x01 \x01(\tR\tfieldPath\x12\x16\n" +
	"\x06vector\x18\x02 \x03(\x02R\x06vector\x1a\x83\x03\n" +
	"%NaturalLanguageQueryUnderstandingSpec\x12\xb3\x01\n" +
	"\x1bfilter_extraction_condition\x18\x01 \x01(\x0e2s.google.cloud.discoveryengine.v1alpha.SearchRequest.NaturalLanguageQueryUnderstandingSpec.FilterExtractionConditionR\x19filterExtractionCondition\x12Q\n" +
	"&geo_search_query_detection_field_names\x18\x02 \x03(\tR!geoSearchQueryDetectionFieldNames\"Q\n" +
	...
	" _search_result_persistence_count\x1aQ\n" +
	...
	"\x0fRANK_BY_FORMULA\x10\x04\"\x04\b\x01\x10\x01\"\x04\b\x02\x10\x02\"\xfc?\n" +
	"\x0eSearchResponse\x12[\n" +
	"\aresults\x18\x01 \x03(\v2A.google.cloud.discoveryengine.v1alpha.SearchResponse.SearchResultR\aresults\x12R\n" +
	"\x06facets\x18\x02 \x03(\v2:.google.cloud.discoveryengine.v1alpha.SearchResponse.FacetR\x06facets\x12y\n" +
	"\x14guided_search_result\x18\b \x01(\v2G.google.cloud.discoveryengine.v1alpha.SearchResponse.GuidedSearchResultR\x12guidedSearchResult\x12\x1d\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize\x12+\n" +
	"\x11attribution_token\x18\x04 \x01(\tR\x10attributionToken\x12!\n" +
	"\fredirect_uri\x18\f \x01(\tR\vredirectUri\x12&\n" +
	"\x0fnext_page_token\x18\x05 \x01(\tR\rnextPageToken\x12'\n" +
	"\x0fcorrected_query\x18\a \x01(\tR\x0ecorrectedQuery\x12V\n" +
	"\asummary\x18\t \x01(\v2<.google.cloud.discoveryengine.v1alpha.SearchResponse.SummaryR\asummary\x12)\n" +
	"\x10applied_controls\x18\n" +
	" \x03(\tR\x0fappliedControls\x12z\n" +
	"\x15geo_search_debug_info\x18\x10 \x03(\v2G.google.cloud.discoveryengine.v1alpha.SearchResponse.GeoSearchDebugInfoR\x12geoSearchDebugInfo\x12y\n" +
	"\x14query_expansion_info\x18\x0e \x01(\v2G.google.cloud.discoveryengine.v1alpha.SearchResponse.QueryExpansionInfoR\x12queryExpansionInfo\x12\xb4\x01\n" +
	")natural_language_query_understanding_info\x18\x0f \x01(\v2Z.google.cloud.discoveryengine.v1alpha.SearchResponse.NaturalLanguageQueryUnderstandingInfoR%naturalLanguageQueryUnderstandingInfo\x12c\n" +
	"\fsession_info\x18\x13 \x01(\v2@.google.cloud.discoveryengine.v1alpha.SearchResponse.SessionInfoR\vsessionInfo\x12i\n" +
	"\x0fone_box_results\x18\x14 \x03(\v2A.google.cloud.discoveryengine.v1alpha.SearchResponse.OneBoxResultR\roneBoxResults\x1a\xa5\n" +
	"\n" +
	"\fSearchResult\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12J\n" +
	"\bdocument\x18\x02 \x01(\v2..google.cloud.discoveryengine.v1alpha.DocumentR\bdocument\x12A\n" +
	"\x05chunk\x18\x12 \x01(\v2+.google.cloud.discoveryengine.v1alpha.ChunkR\x05chunk\x12u\n" +
	"\fmodel_scores\x18\x04 \x03(\v2R.google.cloud.discoveryengine.v1alpha.SearchResponse.SearchResult.ModelScoresEntryR\vmodelScores\x12u\n" +
	"\frank_signals\x18\a \x01(\v2M.google.cloud.discoveryengine.v1alpha.SearchResponse.SearchResult.RankSignalsB\x03\xe0A\x01R\vrankSignals\x1ap\n" +
	"\x10ModelScoresEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12F\n" +
	"\x05value\x18\x02 \x01(\v20.google.cloud.discoveryengine.v1alpha.DoubleListR\x05value:\x028\x01\x1a\x95\x06\n" +
	"\vRankSignals\x12B\n" +
	...
	"\x19semantic_similarity_score\x18\x03 \x01(\x02B\x03\xe0A\x01H\x02R\x17semanticSimilarityScore\x88\x01\x01\x12%\n" +
	"\tpctr_rank\x18\x04 \x01(\x02B\x03\xe0A\x01H\x03R\bpctrRank\x88\x01\x01\x121\n" +
	"\x0ftopicality_rank\x18\x06 \x01(\x02B\x03\xe0A\x01H\x04R\x0etopicalityRank\x88\x01\x01\x12+\n" +
	...
	"\fdefault_rank\x18  \x01(\x02B\x03\xe0A\x01R\vdefaultRank\x12\x86\x01\n" +
	"\x0ecustom_signals\x18! \x03(\v2Z.google.cloud.discoveryengine.v1alpha.SearchResponse.SearchResult.RankSignals.CustomSignalB\x03\xe0A\x01R\rcustomSignals\x1aB\n" +
	...
	"\x1a_semantic_similarity_scoreB\f\n" +
	"\n" +
	"_pctr_rankB\x12\n" +
	"\x10_topicality_rankB\x0f\n" +
	"\r_document_ageB\x12\n" +
	"\x10_boosting_factorJ\x04\b\x05\x10\x06\x1a\xb7\x02\n" +
	"\x05Facet\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12]\n" +
	"\x06values\x18\x02 \x03(\v2E.google.cloud.discoveryengine.v1alpha.SearchResponse.Facet.FacetValueR\x06values\x12#\n" +
	"\rdynamic_facet\x18\x03 \x01(\bR\fdynamicFacet\x1a\x97\x01\n" +
	"\n" +
	"FacetValue\x12\x16\n" +
	"\x05value\x18\x01 \x01(\tH\x00R\x05value\x12L\n" +
	"\binterval\x18\x02 \x01(\v2..google.cloud.discoveryengine.v1alpha.IntervalH\x00R\binterval\x12\x14\n" +
	"\x05count\x18\x03 \x01(\x03R\x05countB\r\n" +
	"\vfacet_value\x1a\xbc\x02\n" +
	"\x12GuidedSearchResult\x12\x90\x01\n" +
	"\x15refinement_attributes\x18\x01 \x03(\v2[.google.cloud.discoveryengine.v1alpha.SearchResponse.GuidedSearchResult.RefinementAttributeR\x14refinementAttributes\x12.\n" +
	"\x13follow_up_questions\x18\x02 \x03(\tR\x11followUpQuestions\x1ac\n" +
	"\x13RefinementAttribute\x12#\n" +
	"\rattribute_key\x18\x01 \x01(\tR\fattributeKey\x12'\n" +
	"\x0fattribute_value\x18\x02 \x01(\tR\x0eattributeValue\x1a\xbb\x0e\n" +
	"\aSummary\x12!\n" +
	"\fsummary_text\x18\x01 \x01(\tR\vsummaryText\x12\x89\x01\n" +
	"\x17summary_skipped_reasons\x18\x02 \x03(\x0e2Q.google.cloud.discoveryengine.v1alpha.SearchResponse.Summary.SummarySkippedReasonR\x15summarySkippedReasons\x12z\n" +
	"\x11safety_attributes\x18\x03 \x01(\v2M.google.cloud.discoveryengine.v1alpha.SearchResponse.Summary.SafetyAttributesR\x10safetyAttributes\x12\x84\x01\n" +
	"\x15summary_with_metadata\x18\x04 \x01(\v2P.google.cloud.discoveryengine.v1alpha.SearchResponse.Summary.SummaryWithMetadataR\x13summaryWithMetadata\x1aJ\n" +
	"\x10SafetyAttributes\x12\x1e\n" +
	"\n" +
	"categories\x18\x01 \x03(\tR\n" +
	"categories\x12\x16\n" +
	"\x06scores\x18\x02 \x03(\x02R\x06scores\x1aw\n" +
	"\x10CitationMetadata\x12c\n" +
	"\tcitations\x18\x01 \x03(\v2E.google.cloud.discoveryengine.v1alpha.SearchResponse.Summary.CitationR\tcitations\x1a\xaf\x01\n" +
	"\bCitation\x12\x1f\n" +
	"\vstart_index\x18\x01 \x01(\x03R\n" +
	"startIndex\x12\x1b\n" +
	"\tend_index\x18\x02 \x01(\x03R\bendIndex\x12e\n" +
	"\asources\x18\x03 \x03(\v2K.google.cloud.discoveryengine.v1alpha.SearchResponse.Summary.CitationSourceR\asources\x1a9\n" +
	"\x0eCitationSource\x12'\n" +
	"\x0freference_index\x18\x04 \x01(\x03R\x0ereferenceIndex\x1a\xcf\x02\n" +
	"\tReference\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12K\n" +
	"\bdocument\x18\x02 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'discoveryengine.googleapis.com/DocumentR\bdocument\x12\x10\n" +
	"\x03uri\x18\x03 \x01(\tR\x03uri\x12z\n" +
	"\x0echunk_contents\x18\x04 \x03(\v2S.google.cloud.discoveryengine.v1alpha.SearchResponse.Summary.Reference.ChunkContentR\rchunkContents\x1aQ\n" +
	"\fChunkContent\x12\x18\n" +
	"\acontent\x18\x01 \x01(\tR\acontent\x12'\n" +
	"\x0fpage_identifier\x18\x02 \x01(\tR\x0epageIdentifier\x1a\x93\x02\n" +
	"\x13SummaryWithMetadata\x12\x18\n" +
	"\asummary\x18\x01 \x01(\tR\asummary\x12z\n" +
	"\x11citation_metadata\x18\x02 \x01(\v2M.google.cloud.discoveryengine.v1alpha.SearchResponse.Summary.CitationMetadataR\x10citationMetadata\x12f\n" +
	"\n" +
	"references\x18\x03 \x03(\v2F.google.cloud.discoveryengine.v1alpha.SearchResponse.Summary.ReferenceR\n" +
	"references\"\xe3\x02\n" +
	...
	"\x1bJAIL_BREAKING_QUERY_IGNORED\x10\a\x12\x1d\n" +
	"\x19CUSTOMER_POLICY_VIOLATION\x10\b\x12(\n" +
	"$NON_SUMMARY_SEEKING_QUERY_IGNORED_V2\x10\t\x1ao\n" +
	"\x12GeoSearchDebugInfo\x124\n" +
	"\x16original_address_query\x18\x01 \x01(\tR\x14originalAddressQuery\x12#\n" +
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\x1ak\n" +
	"\x12QueryExpansionInfo\x12%\n" +
	"\x0eexpanded_query\x18\x01 \x01(\bR\rexpandedQuery\x12.\n" +
	"\x13pinned_result_count\x18\x02 \x01(\x03R\x11pinnedResultCount\x1a\xc1\x13\n" +
	"%NaturalLanguageQueryUnderstandingInfo\x12+\n" +
	"\x11extracted_filters\x18\x01 \x01(\tR\x10extractedFilters\x12'\n" +
	"\x0frewritten_query\x18\x02 \x01(\tR\x0erewrittenQuery\x12\xb4\x01\n" +
	"\x1bstructured_extracted_filter\x18\x03 \x01(\v2t.google.cloud.discoveryengine.v1alpha.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilterR\x19structuredExtractedFilter\x1a\x8a\x11\n" +
	"\x19StructuredExtractedFilter\x12\x9f\x01\n" +
	"\n" +
	"expression\x18\x01 \x01(\v2\x7f.google.cloud.discoveryengine.v1alpha.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.ExpressionR\n" +
	"expression\x1an\n" +
	"\x10StringConstraint\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x12\x16\n" +
	"\x06values\x18\x02 \x03(\tR\x06values\x12#\n" +
	"\rquery_segment\x18\x03 \x01(\tR\fquerySegment\x1a\xa7\x03\n" +
	"\x10NumberConstraint\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x12\xb1\x01\n" +
	"\n" +
	"comparison\x18\x02 \x01(\x0e2\x90\x01.google.cloud.discoveryengine.v1alpha.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.NumberConstraint.ComparisonR\n" +
	"comparison\x12\x14\n" +
	"\x05value\x18\x03 \x01(\x01R\x05value\x12#\n" +
	"\rquery_segment\x18\x04 \x01(\tR\fquerySegment\"\x84\x01\n" +
	"\n" +
	"Comparison\x12\x1a\n" +
	...
	"\fGREATER_THAN\x10\x05\x1a\xb4\x01\n" +
	"\x15GeolocationConstraint\x12\x1d\n" +
	"\n" +
	...
	"\x10radius_in_meters\x18\x03 \x01(\x02R\x0eradiusInMeters\x1a\xb3\x01\n" +
	"\rAndExpression\x12\xa1\x01\n" +
	"\vexpressions\x18\x01 \x03(\v2\x7f.google.cloud.discoveryengine.v1alpha.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.ExpressionR\vexpressions\x1a\xb2\x01\n" +
	"\fOrExpression\x12\xa1\x01\n" +
	"\vexpressions\x18\x01 \x03(\v2\x7f.google.cloud.discoveryengine.v1alpha.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.ExpressionR\vexpressions\x1a\x8e\a\n" +
	"\n" +
	"Expression\x12\xb5\x01\n" +
	"\x11string_constraint\x18\x01 \x01(\v2\x85\x01.google.cloud.discoveryengine.v1alpha.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.StringConstraintH\x00R\x10stringConstraint\x12\xb5\x01\n" +
	"\x11number_constraint\x18\x02 \x01(\v2\x85\x01.google.cloud.discoveryengine.v1alpha.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.NumberConstraintH\x00R\x10numberConstraint\x12\xc4\x01\n" +
	"\x16geolocation_constraint\x18\x03 \x01(\v2\x8a\x01.google.cloud.discoveryengine.v1alpha.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.GeolocationConstraintH\x00R\x15geolocationConstraint\x12\xa0\x01\n" +
	"\band_expr\x18\x04 \x01(\v2\x82\x01.google.cloud.discoveryengine.v1alpha.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.AndExpressionH\x00R\aandExpr\x12\x9d\x01\n" +
	"\aor_expr\x18\x05 \x01(\v2\x81\x01.google.cloud.discoveryengine.v1alpha.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.OrExpressionH\x00R\x06orExprB\x06\n" +
	"\x04expr\x1a<\n" +
	"\vSessionInfo\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x19\n" +
	"\bquery_id\x18\x02 \x01(\tR\aqueryId\x1a\xbd\x02\n" +
	"\fOneBoxResult\x12n\n" +
	"\fone_box_type\x18\x01 \x01(\x0e2L.google.cloud.discoveryengine.v1alpha.SearchResponse.OneBoxResult.OneBoxTypeR\n" +
	"oneBoxType\x12h\n" +
	"\x0esearch_results\x18\x02 \x03(\v2A.google.cloud.discoveryengine.v1alpha.SearchResponse.SearchResultR\rsearchResults\"S\n" +
	"\n" +
	"OneBoxType\x12\x1c\n" +
	...
	"\x06Search\x123.google.cloud.discoveryengine.v1alpha.SearchRequest\x1a4.google.cloud.discoveryengine.v1alpha.SearchResponse\"\xb2\x02\x82\xd3\xe4\x93\x02\xab\x02:\x01*Zh:\x01*\"c/v1alpha/{serving_config=projects/*/locations/*/collections/*/dataStores/*/servingConfigs/*}:searchZe:\x01*\"`/v1alpha/{serving_config=projects/*/locations/*/collections/*/engines/*/servingConfigs/*}:search\"U/v1alpha/{serving_config=projects/*/locations/*/dataStores/*/servingConfigs/*}:search\x1aR\xcaA\x1ediscoveryengine.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\x9e\x02\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1alpha_search_service_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1alpha_search_service_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1alpha_search_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1alpha_search_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_search_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_search_service_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1alpha_search_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_search_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_search_service_proto_rawDesc)),
			NumEnums:      12,
			NumMessages:   54,
			NumExtensions: 0,
			NumServices:   1,
