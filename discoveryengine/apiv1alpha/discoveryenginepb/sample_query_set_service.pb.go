...
const file_google_cloud_discoveryengine_v1alpha_sample_query_set_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x1bListSampleQuerySetsResponse\x12`\n" +
	"\x11sample_query_sets\x18\x01 \x03(\v24.google.cloud.discoveryengine.v1alpha.SampleQuerySetR\x0fsampleQuerySets\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xff\x01\n" +
	"\x1bCreateSampleQuerySetRequest\x12G\n" +
	"\x06parent\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'discoveryengine.googleapis.com/LocationR\x06parent\x12c\n" +
	"\x10sample_query_set\x18\x02 \x01(\v24.google.cloud.discoveryengine.v1alpha.SampleQuerySetB\x03\xe0A\x02R\x0esampleQuerySet\x122\n" +
	"\x13sample_query_set_id\x18\x03 \x01(\tB\x03\xe0A\x02R\x10sampleQuerySetId\"\xbf\x01\n" +
	"\x1bUpdateSampleQuerySetRequest\x12c\n" +
	"\x10sample_query_set\x18\x01 \x01(\v24.google.cloud.discoveryengine.v1alpha.SampleQuerySetB\x03\xe0A\x02R\x0esampleQuerySet\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"h\n" +
	"\x1bDeleteSampleQuerySetRequest\x12I\n" +
	"\x04name\x18\x01 \x01(\tB5\xe0A\x02\xfaA/\n" +
	"-discoveryengine.googleapis.com/SampleQuerySetR\x04name2\x91\n" +
	"\n" +
	...
	"\x14CreateSampleQuerySet\x12A.google.cloud.discoveryengine.v1alpha.CreateSampleQuerySetRequest\x1a4.google.cloud.discoveryengine.v1alpha.SampleQuerySet\"\x80\x01\xdaA+parent,sample_query_set,sample_query_set_id\x82\xd3\xe4\x93\x02L:\x10sample_query_set\"8/v1alpha/{parent=projects/*/locations/*}/sampleQuerySets\x12\x94\x02\n" +
	"\x14UpdateSampleQuerySet\x12A.google.cloud.discoveryengine.v1alpha.UpdateSampleQuerySetRequest\x1a4.google.cloud.discoveryengine.v1alpha.SampleQuerySet\"\x82\x01\xdaA\x1csample_query_set,update_mask\x82\xd3\xe4\x93\x02]:\x10sample_query_set2I/v1alpha/{sample_query_set.name=projects/*/locations/*/sampleQuerySets/*}\x12\xba\x01\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1alpha_sample_query_set_service_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1alpha_sample_query_set_service_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1alpha_sample_query_set_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1alpha_sample_query_set_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_sample_query_set_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_sample_query_set_service_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1alpha_sample_query_set_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_sample_query_set_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_sample_query_set_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
