...
func file_google_cloud_discoveryengine_v1alpha_grounded_generation_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_discoveryengine_v1alpha_grounded_generation_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_discoveryengine_v1alpha_grounded_generation_service_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
