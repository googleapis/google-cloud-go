...
const file_google_cloud_discoveryengine_v1alpha_answer_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/discoveryengine/v1alpha/answer.proto\x12$google.cloud.discoveryengine.v1alpha\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa5(\n" +
	"\x06Answer\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x05R\x04name\x12H\n" +
	"\x05state\x18\x02 \x01(\x0e22.google.cloud.discoveryengine.v1alpha.Answer.StateR\x05state\x12\x1f\n" +
	"\vanswer_text\x18\x03 \x01(\tR\n" +
	"answerText\x12S\n" +
	"\tcitations\x18\x04 \x03(\v25.google.cloud.discoveryengine.v1alpha.Answer.CitationR\tcitations\x12V\n" +
	"\n" +
	"references\x18\x05 \x03(\v26.google.cloud.discoveryengine.v1alpha.Answer.ReferenceR\n" +
	"references\x12+\n" +
	"\x11related_questions\x18\x06 \x03(\tR\x10relatedQuestions\x12G\n" +
	"\x05steps\x18\a \x03(\v21.google.cloud.discoveryengine.v1alpha.Answer.StepR\x05steps\x12}\n" +
	"\x18query_understanding_info\x18\n" +
	" \x01(\v2C.google.cloud.discoveryengine.v1alpha.Answer.QueryUnderstandingInfoR\x16queryUnderstandingInfo\x12v\n" +
	"\x16answer_skipped_reasons\x18\v \x03(\x0e2@.google.cloud.discoveryengine.v1alpha.Answer.AnswerSkippedReasonR\x14answerSkippedReasons\x12@\n" +
	"\vcreate_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12D\n" +
	"\rcomplete_time\x18\t \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\fcompleteTime\x1a\x9f\x01\n" +
	"\bCitation\x12\x1f\n" +
	"\vstart_index\x18\x01 \x01(\x03R\n" +
	"startIndex\x12\x1b\n" +
	"\tend_index\x18\x02 \x01(\x03R\bendIndex\x12U\n" +
	"\asources\x18\x03 \x03(\v2;.google.cloud.discoveryengine.v1alpha.Answer.CitationSourceR\asources\x1a3\n" +
	"\x0eCitationSource\x12!\n" +
	"\freference_id\x18\x01 \x01(\tR\vreferenceId\x1a\xb0\f\n" +
	"\tReference\x12\x8f\x01\n" +
	"\x1aunstructured_document_info\x18\x01 \x01(\v2O.google.cloud.discoveryengine.v1alpha.Answer.Reference.UnstructuredDocumentInfoH\x00R\x18unstructuredDocumentInfo\x12a\n" +
	"\n" +
	"chunk_info\x18\x02 \x01(\v2@.google.cloud.discoveryengine.v1alpha.Answer.Reference.ChunkInfoH\x00R\tchunkInfo\x12\x89\x01\n" +
	"\x18structured_document_info\x18\x03 \x01(\v2M.google.cloud.discoveryengine.v1alpha.Answer.Reference.StructuredDocumentInfoH\x00R\x16structuredDocumentInfo\x1a\xe2\x03\n" +
	...
	"\x05title\x18\x03 \x01(\tR\x05title\x12\x83\x01\n" +
	"\x0echunk_contents\x18\x04 \x03(\v2\\.google.cloud.discoveryengine.v1alpha.Answer.Reference.UnstructuredDocumentInfo.ChunkContentR\rchunkContents\x128\n" +
	...
	"\x10_relevance_score\x1a\x92\x04\n" +
	"\tChunkInfo\x12?\n" +
	...
	"\x11document_metadata\x18\x04 \x01(\v2Q.google.cloud.discoveryengine.v1alpha.Answer.Reference.ChunkInfo.DocumentMetadataR\x10documentMetadata\x1a\xe7\x01\n" +
	...
	"\n" +
	"\x04Step\x12M\n" +
	"\x05state\x18\x01 \x01(\x0e27.google.cloud.discoveryengine.v1alpha.Answer.Step.StateR\x05state\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x18\n" +
	"\athought\x18\x03 \x01(\tR\athought\x12R\n" +
	"\aactions\x18\x04 \x03(\v28.google.cloud.discoveryengine.v1alpha.Answer.Step.ActionR\aactions\x1a\xf5\a\n" +
	"\x06Action\x12l\n" +
	"\rsearch_action\x18\x02 \x01(\v2E.google.cloud.discoveryengine.v1alpha.Answer.Step.Action.SearchActionH\x00R\fsearchAction\x12f\n" +
	"\vobservation\x18\x03 \x01(\v2D.google.cloud.discoveryengine.v1alpha.Answer.Step.Action.ObservationR\vobservation\x1a$\n" +
	"\fSearchAction\x12\x14\n" +
	"\x05query\x18\x01 \x01(\tR\x05query\x1a\xe4\x05\n" +
	"\vObservation\x12x\n" +
	"\x0esearch_results\x18\x02 \x03(\v2Q.google.cloud.discoveryengine.v1alpha.Answer.Step.Action.Observation.SearchResultR\rsearchResults\x1a\xda\x04\n" +
	"\fSearchResult\x12\x1a\n" +
	"\bdocument\x18\x01 \x01(\tR\bdocument\x12\x10\n" +
	"\x03uri\x18\x02 \x01(\tR\x03uri\x12\x14\n" +
	"\x05title\x18\x03 \x01(\tR\x05title\x12\x80\x01\n" +
	"\fsnippet_info\x18\x04 \x03(\v2].google.cloud.discoveryengine.v1alpha.Answer.Step.Action.Observation.SearchResult.SnippetInfoR\vsnippetInfo\x12z\n" +
	"\n" +
	"chunk_info\x18\x05 \x03(\v2[.google.cloud.discoveryengine.v1alpha.Answer.Step.Action.Observation.SearchResult.ChunkInfoR\tchunkInfo\x128\n" +
	...
	"\tSUCCEEDED\x10\x03\x1a\xcc\x03\n" +
	"\x16QueryUnderstandingInfo\x12\x97\x01\n" +
	"\x19query_classification_info\x18\x01 \x03(\v2[.google.cloud.discoveryengine.v1alpha.Answer.QueryUnderstandingInfo.QueryClassificationInfoR\x17queryClassificationInfo\x1a\x97\x02\n" +
	"\x17QueryClassificationInfo\x12t\n" +
	"\x04type\x18\x01 \x01(\x0e2`.google.cloud.discoveryengine.v1alpha.Answer.QueryUnderstandingInfo.QueryClassificationInfo.TypeR\x04type\x12\x1a\n" +
	"\bpositive\x18\x02 \x01(\bR\bpositive\"j\n" +
	"\x04Type\x12\x14\n" +
	...
	"\x19CUSTOMER_POLICY_VIOLATION\x10\a:\x85\x03\xeaA\x81\x03\n" +
...
func file_google_cloud_discoveryengine_v1alpha_answer_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1alpha_answer_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1alpha_answer_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_answer_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_answer_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1alpha_answer_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_answer_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_answer_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   18,
			NumExtensions: 0,
			NumServices:   0,
