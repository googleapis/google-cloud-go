...
func file_google_cloud_discoveryengine_v1alpha_answer_proto_init() {
	...
	file_google_cloud_discoveryengine_v1alpha_answer_proto_msgTypes[10].OneofWrappers = []any{
		(*Answer_Step_Action_SearchAction_)(nil),
	}
	file_google_cloud_discoveryengine_v1alpha_answer_proto_msgTypes[15].OneofWrappers = []any{}
	type x struct{}
