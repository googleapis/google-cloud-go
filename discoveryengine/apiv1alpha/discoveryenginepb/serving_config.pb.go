...
const file_google_cloud_discoveryengine_v1alpha_serving_config_proto_rawDesc = "" +
	"\n" +
	"9google/cloud/discoveryengine/v1alpha/serving_config.proto\x12$google.cloud.discoveryengine.v1alpha\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a1google/cloud/discoveryengine/v1alpha/common.proto\x1a9google/cloud/discoveryengine/v1alpha/search_service.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xaa\x11\n" +
	"\rServingConfig\x12d\n" +
	"\fmedia_config\x18\a \x01(\v2?.google.cloud.discoveryengine.v1alpha.ServingConfig.MediaConfigH\x00R\vmediaConfig\x12j\n" +
	"\x0egeneric_config\x18\n" +
	" \x01(\v2A.google.cloud.discoveryengine.v1alpha.ServingConfig.GenericConfigH\x00R\rgenericConfig\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x05R\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x02R\vdisplayName\x12_\n" +
	"\rsolution_type\x18\x03 \x01(\x0e22.google.cloud.discoveryengine.v1alpha.SolutionTypeB\x06\xe0A\x02\xe0A\x05R\fsolutionType\x12\x19\n" +
	"\bmodel_id\x18\x04 \x01(\tR\amodelId\x12'\n" +
	"\x0fdiversity_level\x18\x05 \x01(\tR\x0ediversityLevel\x12`\n" +
	"\x10embedding_config\x18\x14 \x01(\v25.google.cloud.discoveryengine.v1alpha.EmbeddingConfigR\x0fembeddingConfig\x12-\n" +
	"\x12ranking_expression\x18\x15 \x01(\tR\x11rankingExpression\x12d\n" +
	"\x12guided_search_spec\x18\x16 \x01(\v26.google.cloud.discoveryengine.v1alpha.GuidedSearchSpecR\x10guidedSearchSpec\x12q\n" +
	"\x17custom_fine_tuning_spec\x18\x18 \x01(\v2:.google.cloud.discoveryengine.v1alpha.CustomFineTuningSpecR\x14customFineTuningSpec\x12@\n" +
	...
	"\x12ignore_control_ids\x18\x13 \x03(\tR\x10ignoreControlIds\x1a\xba\x02\n" +
	"\vMediaConfig\x12Q\n" +
	...
	"\x13demotion_event_type\x18\x01 \x01(\tR\x11demotionEventType\x12A\n" +
	"\x1dcontent_freshness_cutoff_days\x18\x04 \x01(\x05R\x1acontentFreshnessCutoffDaysB\x18\n" +
	"\x16demote_content_watched\x1a\x86\x01\n" +
	"\rGenericConfig\x12u\n" +
	"\x13content_search_spec\x18\x01 \x01(\v2E.google.cloud.discoveryengine.v1alpha.SearchRequest.ContentSearchSpecR\x11contentSearchSpec:\x80\x03\xeaA\xfc\x02\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1alpha_serving_config_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1alpha_serving_config_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1alpha_serving_config_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1alpha_serving_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_serving_config_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_serving_config_proto_rawDesc)))
	})
...
var file_google_cloud_discoveryengine_v1alpha_serving_config_proto_goTypes = []any{
...
func file_google_cloud_discoveryengine_v1alpha_serving_config_proto_init() {
	...
	file_google_cloud_discoveryengine_v1alpha_serving_config_proto_msgTypes[0].OneofWrappers = []any{
		(*ServingConfig_MediaConfig_)(nil),
		(*ServingConfig_GenericConfig_)(nil),
	}
	file_google_cloud_discoveryengine_v1alpha_serving_config_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_serving_config_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_serving_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
