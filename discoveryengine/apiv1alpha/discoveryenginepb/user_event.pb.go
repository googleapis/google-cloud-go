...
const file_google_cloud_discoveryengine_v1alpha_user_event_proto_rawDesc = "" +
	"\n" +
	"5google/cloud/discoveryengine/v1alpha/user_event.proto\x12$google.cloud.discoveryengine.v1alpha\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a1google/cloud/discoveryengine/v1alpha/common.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe7\n" +
	"\n" +
	"\tUserEvent\x12\"\n" +
	"\n" +
	...
	"\n" +
	"event_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\teventTime\x12K\n" +
	"\tuser_info\x18\x04 \x01(\v2..google.cloud.discoveryengine.v1alpha.UserInfoR\buserInfo\x12.\n" +
	"\x13direct_user_request\x18\x05 \x01(\bR\x11directUserRequest\x12\x1d\n" +
	"\n" +
	"session_id\x18\x06 \x01(\tR\tsessionId\x12K\n" +
	"\tpage_info\x18\a \x01(\v2..google.cloud.discoveryengine.v1alpha.PageInfoR\bpageInfo\x12+\n" +
	"\x11attribution_token\x18\b \x01(\tR\x10attributionToken\x12\x16\n" +
	"\x06filter\x18\t \x01(\tR\x06filter\x12P\n" +
	"\tdocuments\x18\n" +
	" \x03(\v22.google.cloud.discoveryengine.v1alpha.DocumentInfoR\tdocuments\x12E\n" +
	"\x05panel\x18\v \x01(\v2/.google.cloud.discoveryengine.v1alpha.PanelInfoR\x05panel\x12Q\n" +
	"\vsearch_info\x18\f \x01(\v20.google.cloud.discoveryengine.v1alpha.SearchInfoR\n" +
	"searchInfo\x12]\n" +
	"\x0fcompletion_info\x18\r \x01(\v24.google.cloud.discoveryengine.v1alpha.CompletionInfoR\x0ecompletionInfo\x12`\n" +
	"\x10transaction_info\x18\x0e \x01(\v25.google.cloud.discoveryengine.v1alpha.TransactionInfoR\x0ftransactionInfo\x12\x17\n" +
	"\atag_ids\x18\x0f \x03(\tR\x06tagIds\x12#\n" +
	"\rpromotion_ids\x18\x10 \x03(\tR\fpromotionIds\x12_\n" +
	"\n" +
	"attributes\x18\x11 \x03(\v2?.google.cloud.discoveryengine.v1alpha.UserEvent.AttributesEntryR\n" +
	"attributes\x12N\n" +
	"\n" +
	"media_info\x18\x12 \x01(\v2/.google.cloud.discoveryengine.v1alpha.MediaInfoR\tmediaInfo\x1at\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12K\n" +
	"\x05value\x18\x02 \x01(\v25.google.cloud.discoveryengine.v1alpha.CustomAttributeR\x05value:\x028\x01\"\x85\x01\n" +
	"\bPageInfo\x12\x1f\n" +
	...
	"\ftotal_panels\x18\x05 \x01(\x05H\x01R\vtotalPanels\x88\x01\x01B\x11\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1alpha_user_event_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1alpha_user_event_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1alpha_user_event_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1alpha_user_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_user_event_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_user_event_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1alpha_user_event_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_user_event_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_user_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
