...
const file_google_cloud_discoveryengine_v1alpha_evaluation_service_proto_rawDesc = "" +
	...
	"\x17ListEvaluationsResponse\x12R\n" +
	"\vevaluations\x18\x01 \x03(\v20.google.cloud.discoveryengine.v1alpha.EvaluationR\vevaluations\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xb9\x01\n" +
	"\x17CreateEvaluationRequest\x12G\n" +
	"\x06parent\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'discoveryengine.googleapis.com/LocationR\x06parent\x12U\n" +
	"\n" +
	"evaluation\x18\x02 \x01(\v20.google.cloud.discoveryengine.v1alpha.EvaluationB\x03\xe0A\x02R\n" +
	"evaluation\"\x1a\n" +
	...
	"\x1dListEvaluationResultsResponse\x12\x83\x01\n" +
	"\x12evaluation_results\x18\x01 \x03(\v2T.google.cloud.discoveryengine.v1alpha.ListEvaluationResultsResponse.EvaluationResultR\x11evaluationResults\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x1a\xd1\x01\n" +
	"\x10EvaluationResult\x12Y\n" +
	"\fsample_query\x18\x01 \x01(\v21.google.cloud.discoveryengine.v1alpha.SampleQueryB\x03\xe0A\x03R\vsampleQuery\x12b\n" +
	"\x0fquality_metrics\x18\x02 \x01(\v24.google.cloud.discoveryengine.v1alpha.QualityMetricsB\x03\xe0A\x03R\x0equalityMetrics2\xc9\b\n" +
	...
	"/google.cloud.discoveryengine.v1alpha.Evaluation\x12=google.cloud.discoveryengine.v1alpha.CreateEvaluationMetadata\xdaA\x11parent,evaluation\x82\xd3\xe4\x93\x02B:\n" +
	"evaluation\"4/v1alpha/{parent=projects/*/locations/*}/evaluations\x12\xfd\x01\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1alpha_evaluation_service_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1alpha_evaluation_service_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1alpha_evaluation_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1alpha_evaluation_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_evaluation_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_evaluation_service_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1alpha_evaluation_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1alpha_evaluation_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1alpha_evaluation_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
