...
var newChunkClientHook clientHook
...
func defaultChunkCallOptions() *ChunkCallOptions {
...
func defaultChunkRESTCallOptions() *ChunkCallOptions {
	return &ChunkCallOptions{
		GetChunk:   []gax.CallOption{},
		ListChunks: []gax.CallOption{},
		CancelOperation: []gax.CallOption{
...
// internalChunkClient is an interface that defines the methods available from Discovery Engine API.
type internalChunkClient interface {
	Close() error
...
// ChunkClient is a client for interacting with Discovery Engine API.
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
//
// Service for displaying processed
// Chunk information of the
// customer’s unstructured data.
type ChunkClient struct {
	// The internal transport-dependent client.
	internalClient internalChunkClient
...
func (c *ChunkClient) setGoogleClientInfo(keyval ...string) {
...
func (c *ChunkClient) Connection() *grpc.ClientConn {
	return c.internalClient.Connection()
}

// GetChunk gets a Document.
func (c *ChunkClient) GetChunk(ctx context.Context, req *discoveryenginepb.GetChunkRequest, opts ...gax.CallOption) (*discoveryenginepb.Chunk, error) {
	return c.internalClient.GetChunk(ctx, req, opts...)
}

// ListChunks gets a list of Chunks.
func (c *ChunkClient) ListChunks(ctx context.Context, req *discoveryenginepb.ListChunksRequest, opts ...gax.CallOption) *ChunkIterator {
...
func (c *ChunkClient) ListOperations(ctx context.Context, req *longrunningpb.ListOperationsRequest, opts ...gax.CallOption) *OperationIterator {
	return c.internalClient.ListOperations(ctx, req, opts...)
}

// chunkGRPCClient is a client for interacting with Discovery Engine API over gRPC transport.
//
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type chunkGRPCClient struct {
	...
	// The gRPC API client.
	chunkClient discoveryenginepb.ChunkServiceClient
...
// Chunk information of the
// customer’s unstructured data.
func NewChunkClient(ctx context.Context, opts ...option.ClientOption) (*ChunkClient, error) {
	clientOpts := defaultChunkGRPCClientOptions()
	if newChunkClientHook != nil {
		hookOpts, err := newChunkClientHook(ctx, clientHookParams{})
		if err != nil {
			return nil, err
		}
	...
	client := ChunkClient{CallOptions: defaultChunkCallOptions()}
...
// Deprecated: Connections are now pooled so this method does not always
// return the same resource.
func (c *chunkGRPCClient) Connection() *grpc.ClientConn {
...
// Chunk information of the
// customer’s unstructured data.
func NewChunkRESTClient(ctx context.Context, opts ...option.ClientOption) (*ChunkClient, error) {
	clientOpts := append(defaultChunkRESTClientOptions(), opts...)
	httpClient, endpoint, err := httptransport.NewClient(ctx, clientOpts...)
	if err != nil {
		return nil, err
	}

	callOpts := defaultChunkRESTCallOptions()
	c := &chunkRESTClient{
		endpoint:    endpoint,
...
func defaultChunkRESTClientOptions() []option.ClientOption {
	return []option.ClientOption{
...
func (c *chunkRESTClient) Connection() *grpc.ClientConn {
	return nil
}
func (c *chunkGRPCClient) GetChunk(ctx context.Context, req *discoveryenginepb.GetChunkRequest, opts ...gax.CallOption) (*discoveryenginepb.Chunk, error) {
...
func (c *chunkGRPCClient) ListChunks(ctx context.Context, req *discoveryenginepb.ListChunksRequest, opts ...gax.CallOption) *ChunkIterator {
	...
	it := &ChunkIterator{}
	req = proto.Clone(req).(*discoveryenginepb.ListChunksRequest)
	it.InternalFetch = func(pageSize int, pageToken string) ([]*discoveryenginepb.Chunk, string, error) {
		resp := &discoveryenginepb.ListChunksResponse{}
		if pageToken != "" {
...
func (c *chunkGRPCClient) ListOperations(ctx context.Context, req *longrunningpb.ListOperationsRequest, opts ...gax.CallOption) *OperationIterator {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
...
// GetChunk gets a Document.
func (c *chunkRESTClient) GetChunk(ctx context.Context, req *discoveryenginepb.GetChunkRequest, opts ...gax.CallOption) (*discoveryenginepb.Chunk, error) {
...
// ListChunks gets a list of Chunks.
func (c *chunkRESTClient) ListChunks(ctx context.Context, req *discoveryenginepb.ListChunksRequest, opts ...gax.CallOption) *ChunkIterator {
	it := &ChunkIterator{}
	req = proto.Clone(req).(*discoveryenginepb.ListChunksRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*discoveryenginepb.Chunk, string, error) {
...
// GetOperation is a utility method from google.longrunning.Operations.
func (c *chunkRESTClient) GetOperation(ctx context.Context, req *longrunningpb.GetOperationRequest, opts ...gax.CallOption) (*longrunningpb.Operation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// ListOperations is a utility method from google.longrunning.Operations.
func (c *chunkRESTClient) ListOperations(ctx context.Context, req *longrunningpb.ListOperationsRequest, opts ...gax.CallOption) *OperationIterator {
	it := &OperationIterator{}
	req = proto.Clone(req).(*longrunningpb.ListOperationsRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*longrunningpb.Operation, string, error) {
