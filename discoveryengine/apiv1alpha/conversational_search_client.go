...
func (c *conversationalSearchGRPCClient) UpdateConversation(ctx context.Context, req *discoveryenginepb.UpdateConversationRequest, opts ...gax.CallOption) (*discoveryenginepb.Conversation, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.ConversationalSearchService/UpdateConversation")
	}
...
func (c *conversationalSearchGRPCClient) UpdateSession(ctx context.Context, req *discoveryenginepb.UpdateSessionRequest, opts ...gax.CallOption) (*discoveryenginepb.Session, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.ConversationalSearchService/UpdateSession")
	}
...
func (c *conversationalSearchRESTClient) ConverseConversation(ctx context.Context, req *discoveryenginepb.ConverseConversationRequest, opts ...gax.CallOption) (*discoveryenginepb.ConverseConversationResponse, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v:converse", req.GetName())
...
func (c *conversationalSearchRESTClient) CreateConversation(ctx context.Context, req *discoveryenginepb.CreateConversationRequest, opts ...gax.CallOption) (*discoveryenginepb.Conversation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v/conversations", req.GetParent())
...
func (c *conversationalSearchRESTClient) UpdateConversation(ctx context.Context, req *discoveryenginepb.UpdateConversationRequest, opts ...gax.CallOption) (*discoveryenginepb.Conversation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v", req.GetConversation().GetName())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.ConversationalSearchService/UpdateConversation")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1alpha/{conversation.name=projects/*/locations/*/dataStores/*/conversations/*}")
	}
	opts = append((*c.CallOptions).UpdateConversation[0:len((*c.CallOptions).UpdateConversation):len((*c.CallOptions).UpdateConversation)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &discoveryenginepb.Conversation{}
...
func (c *conversationalSearchRESTClient) AnswerQuery(ctx context.Context, req *discoveryenginepb.AnswerQueryRequest, opts ...gax.CallOption) (*discoveryenginepb.AnswerQueryResponse, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v:answer", req.GetServingConfig())
...
func (c *conversationalSearchRESTClient) CreateSession(ctx context.Context, req *discoveryenginepb.CreateSessionRequest, opts ...gax.CallOption) (*discoveryenginepb.Session, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v/sessions", req.GetParent())
...
func (c *conversationalSearchRESTClient) UpdateSession(ctx context.Context, req *discoveryenginepb.UpdateSessionRequest, opts ...gax.CallOption) (*discoveryenginepb.Session, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v", req.GetSession().GetName())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.ConversationalSearchService/UpdateSession")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1alpha/{session.name=projects/*/locations/*/dataStores/*/sessions/*}")
	}
	opts = append((*c.CallOptions).UpdateSession[0:len((*c.CallOptions).UpdateSession):len((*c.CallOptions).UpdateSession)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &discoveryenginepb.Session{}
