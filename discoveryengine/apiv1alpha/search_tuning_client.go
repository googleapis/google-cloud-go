...
func (c *searchTuningGRPCClient) TrainCustomModel(ctx context.Context, req *discoveryenginepb.TrainCustomModelRequest, opts ...gax.CallOption) (*TrainCustomModelOperation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.SearchTuningService/TrainCustomModel")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.searchTuningClient.TrainCustomModel, req, settings.GRPC, c.logger, "TrainCustomModel")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *searchTuningGRPCClient) ListCustomModels(ctx context.Context, req *discoveryenginepb.ListCustomModelsRequest, opts ...gax.CallOption) (*discoveryenginepb.ListCustomModelsResponse, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.SearchTuningService/ListCustomModels")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.searchTuningClient.ListCustomModels, req, settings.GRPC, c.logger, "ListCustomModels")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *searchTuningRESTClient) TrainCustomModel(ctx context.Context, req *discoveryenginepb.TrainCustomModelRequest, opts ...gax.CallOption) (*TrainCustomModelOperation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v:trainCustomModel", req.GetDataStore())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.SearchTuningService/TrainCustomModel")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1alpha/{data_store=projects/*/locations/*/collections/*/dataStores/*}:trainCustomModel")
	}
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "TrainCustomModel")
		if err != nil {
			return err
		}
...
func (c *searchTuningRESTClient) ListCustomModels(ctx context.Context, req *discoveryenginepb.ListCustomModelsRequest, opts ...gax.CallOption) (*discoveryenginepb.ListCustomModelsResponse, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v/customModels", req.GetDataStore())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.SearchTuningService/ListCustomModels")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1alpha/{data_store=projects/*/locations/*/collections/*/dataStores/*}/customModels")
	}
	opts = append((*c.CallOptions).ListCustomModels[0:len((*c.CallOptions).ListCustomModels):len((*c.CallOptions).ListCustomModels)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "ListCustomModels")
		if err != nil {
			return err
		}
