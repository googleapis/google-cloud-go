...
func (c *evaluationGRPCClient) GetEvaluation(ctx context.Context, req *discoveryenginepb.GetEvaluationRequest, opts ...gax.CallOption) (*discoveryenginepb.Evaluation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.EvaluationService/GetEvaluation")
	}
...
func (c *evaluationGRPCClient) ListEvaluations(ctx context.Context, req *discoveryenginepb.ListEvaluationsRequest, opts ...gax.CallOption) *EvaluationIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.EvaluationService/ListEvaluations")
	}
...
func (c *evaluationGRPCClient) CreateEvaluation(ctx context.Context, req *discoveryenginepb.CreateEvaluationRequest, opts ...gax.CallOption) (*CreateEvaluationOperation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.EvaluationService/CreateEvaluation")
	}
...
func (c *evaluationGRPCClient) ListEvaluationResults(ctx context.Context, req *discoveryenginepb.ListEvaluationResultsRequest, opts ...gax.CallOption) *ListEvaluationResultsResponse_EvaluationResultIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.EvaluationService/ListEvaluationResults")
	}
...
func (c *evaluationRESTClient) GetEvaluation(ctx context.Context, req *discoveryenginepb.GetEvaluationRequest, opts ...gax.CallOption) (*discoveryenginepb.Evaluation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.EvaluationService/GetEvaluation")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1alpha/{name=projects/*/locations/*/evaluations/*}")
	}
	opts = append((*c.CallOptions).GetEvaluation[0:len((*c.CallOptions).GetEvaluation):len((*c.CallOptions).GetEvaluation)], opts...)
...
func (c *evaluationRESTClient) CreateEvaluation(ctx context.Context, req *discoveryenginepb.CreateEvaluationRequest, opts ...gax.CallOption) (*CreateEvaluationOperation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.EvaluationService/CreateEvaluation")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1alpha/{parent=projects/*/locations/*}/evaluations")
	}
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
