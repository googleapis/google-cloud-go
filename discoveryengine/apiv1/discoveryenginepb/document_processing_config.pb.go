...
const file_google_cloud_discoveryengine_v1_document_processing_config_proto_rawDesc = "" +
	"\n" +
	"@google/cloud/discoveryengine/v1/document_processing_config.proto\x12\x1fgoogle.cloud.discoveryengine.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\xfc\x10\n" +
	"\x18DocumentProcessingConfig\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12q\n" +
	"\x0fchunking_config\x18\x03 \x01(\v2H.google.cloud.discoveryengine.v1.DocumentProcessingConfig.ChunkingConfigR\x0echunkingConfig\x12}\n" +
	"\x16default_parsing_config\x18\x04 \x01(\v2G.google.cloud.discoveryengine.v1.DocumentProcessingConfig.ParsingConfigR\x14defaultParsingConfig\x12\x8f\x01\n" +
	"\x18parsing_config_overrides\x18\x05 \x03(\v2U.google.cloud.discoveryengine.v1.DocumentProcessingConfig.ParsingConfigOverridesEntryR\x16parsingConfigOverrides\x1a\xbe\x02\n" +
	"\x0eChunkingConfig\x12\xa5\x01\n" +
	"\x1clayout_based_chunking_config\x18\x01 \x01(\v2b.google.cloud.discoveryengine.v1.DocumentProcessingConfig.ChunkingConfig.LayoutBasedChunkingConfigH\x00R\x19layoutBasedChunkingConfig\x1av\n" +
	...
	"\n" +
	"chunk_mode\x1a\xe4\a\n" +
	"\rParsingConfig\x12\x94\x01\n" +
	"\x16digital_parsing_config\x18\x01 \x01(\v2\\.google.cloud.discoveryengine.v1.DocumentProcessingConfig.ParsingConfig.DigitalParsingConfigH\x00R\x14digitalParsingConfig\x12\x88\x01\n" +
	"\x12ocr_parsing_config\x18\x02 \x01(\v2X.google.cloud.discoveryengine.v1.DocumentProcessingConfig.ParsingConfig.OcrParsingConfigH\x00R\x10ocrParsingConfig\x12\x91\x01\n" +
	"\x15layout_parsing_config\x18\x03 \x01(\v2[.google.cloud.discoveryengine.v1.DocumentProcessingConfig.ParsingConfig.LayoutParsingConfigH\x00R\x13layoutParsingConfig\x1a\x16\n" +
	...
	"\x0fuse_native_text\x18\x02 \x01(\bR\ruseNativeText\x1a\xed\x02\n" +
	...
	"\x10exclude_html_ids\x18\f \x03(\tB\x03\xe0A\x01R\x0eexcludeHtmlIdsB\x17\n" +
	"\x15type_dedicated_config\x1a\x92\x01\n" +
	"\x1bParsingConfigOverridesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12]\n" +
	"\x05value\x18\x02 \x01(\v2G.google.cloud.discoveryengine.v1.DocumentProcessingConfig.ParsingConfigR\x05value:\x028\x01:\x8a\x02\xeaA\x86\x02\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1_document_processing_config_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1_document_processing_config_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1_document_processing_config_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1_document_processing_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1_document_processing_config_proto_rawDesc), len(file_google_cloud_discoveryengine_v1_document_processing_config_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1_document_processing_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1_document_processing_config_proto_rawDesc), len(file_google_cloud_discoveryengine_v1_document_processing_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
