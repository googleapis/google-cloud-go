...
const file_google_cloud_discoveryengine_v1_user_event_proto_rawDesc = "" +
	"\n" +
	"0google/cloud/discoveryengine/v1/user_event.proto\x12\x1fgoogle.cloud.discoveryengine.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a,google/cloud/discoveryengine/v1/common.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xac\v\n" +
	"\tUserEvent\x12\"\n" +
	"\n" +
	"event_type\x18\x01 \x01(\tB\x03\xe0A\x02R\teventType\x12,\n" +
	"\x0fconversion_type\x18\x15 \x01(\tB\x03\xe0A\x01R\x0econversionType\x12)\n" +
	...
	"\n" +
	"event_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\teventTime\x12F\n" +
	"\tuser_info\x18\x04 \x01(\v2).google.cloud.discoveryengine.v1.UserInfoR\buserInfo\x12.\n" +
	"\x13direct_user_request\x18\x05 \x01(\bR\x11directUserRequest\x12\x1d\n" +
	"\n" +
	"session_id\x18\x06 \x01(\tR\tsessionId\x12F\n" +
	"\tpage_info\x18\a \x01(\v2).google.cloud.discoveryengine.v1.PageInfoR\bpageInfo\x12+\n" +
	"\x11attribution_token\x18\b \x01(\tR\x10attributionToken\x12\x16\n" +
	"\x06filter\x18\t \x01(\tR\x06filter\x12K\n" +
	"\tdocuments\x18\n" +
	" \x03(\v2-.google.cloud.discoveryengine.v1.DocumentInfoR\tdocuments\x12@\n" +
	"\x05panel\x18\v \x01(\v2*.google.cloud.discoveryengine.v1.PanelInfoR\x05panel\x12L\n" +
	"\vsearch_info\x18\f \x01(\v2+.google.cloud.discoveryengine.v1.SearchInfoR\n" +
	"searchInfo\x12X\n" +
	"\x0fcompletion_info\x18\r \x01(\v2/.google.cloud.discoveryengine.v1.CompletionInfoR\x0ecompletionInfo\x12[\n" +
	"\x10transaction_info\x18\x0e \x01(\v20.google.cloud.discoveryengine.v1.TransactionInfoR\x0ftransactionInfo\x12\x17\n" +
	"\atag_ids\x18\x0f \x03(\tR\x06tagIds\x12#\n" +
	"\rpromotion_ids\x18\x10 \x03(\tR\fpromotionIds\x12Z\n" +
	"\n" +
	"attributes\x18\x11 \x03(\v2:.google.cloud.discoveryengine.v1.UserEvent.AttributesEntryR\n" +
	"attributes\x12I\n" +
	"\n" +
	"media_info\x18\x12 \x01(\v2*.google.cloud.discoveryengine.v1.MediaInfoR\tmediaInfo\x12G\n" +
	"\x06panels\x18\x16 \x03(\v2*.google.cloud.discoveryengine.v1.PanelInfoB\x03\xe0A\x01R\x06panels\x1ao\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12F\n" +
	"\x05value\x18\x02 \x01(\v20.google.cloud.discoveryengine.v1.CustomAttributeR\x05value:\x028\x01\"\x85\x01\n" +
	"\bPageInfo\x12\x1f\n" +
	...
	"\x06joined\x18\x05 \x01(\bB\x03\xe0A\x03R\x06joined\x123\n" +
	"\x10conversion_value\x18\a \x01(\x02B\x03\xe0A\x01H\x02R\x0fconversionValue\x88\x01\x01B\x15\n" +
	"\x13document_descriptorB\v\n" +
	"\t_quantityB\x13\n" +
	"\x11_conversion_value\"\x98\x02\n" +
	"\tPanelInfo\x12\x1e\n" +
	...
	"\ftotal_panels\x18\x05 \x01(\x05H\x01R\vtotalPanels\x88\x01\x01\x12P\n" +
	"\tdocuments\x18\x06 \x03(\v2-.google.cloud.discoveryengine.v1.DocumentInfoB\x03\xe0A\x01R\tdocumentsB\x11\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1_user_event_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1_user_event_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1_user_event_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1_user_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1_user_event_proto_rawDesc), len(file_google_cloud_discoveryengine_v1_user_event_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1_user_event_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1_user_event_proto_rawDesc), len(file_google_cloud_discoveryengine_v1_user_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
