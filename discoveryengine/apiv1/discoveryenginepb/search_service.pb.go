...
const file_google_cloud_discoveryengine_v1_search_service_proto_rawDesc = "" +
	...
	"\x0fpage_categories\x18? \x03(\tB\x03\xe0A\x01R\x0epageCategories\x12Z\n" +
	"\vimage_query\x18\x13 \x01(\v29.google.cloud.discoveryengine.v1.SearchRequest.ImageQueryR\n" +
	"imageQuery\x12\x1b\n" +
	...
	"\tuser_info\x18\x15 \x01(\v2).google.cloud.discoveryengine.v1.UserInfoR\buserInfo\x12#\n" +
	"\rlanguage_code\x18# \x01(\tR\flanguageCode\x12Y\n" +
	"\vfacet_specs\x18\t \x03(\v28.google.cloud.discoveryengine.v1.SearchRequest.FacetSpecR\n" +
	"facetSpecs\x12W\n" +
	"\n" +
	"boost_spec\x18\n" +
	" \x01(\v28.google.cloud.discoveryengine.v1.SearchRequest.BoostSpecR\tboostSpec\x12R\n" +
	"\x06params\x18\v \x03(\v2:.google.cloud.discoveryengine.v1.SearchRequest.ParamsEntryR\x06params\x12s\n" +
	"\x14query_expansion_spec\x18\r \x01(\v2A.google.cloud.discoveryengine.v1.SearchRequest.QueryExpansionSpecR\x12queryExpansionSpec\x12v\n" +
	"\x15spell_correction_spec\x18\x0e \x01(\v2B.google.cloud.discoveryengine.v1.SearchRequest.SpellCorrectionSpecR\x13spellCorrectionSpec\x12)\n" +
	"\x0euser_pseudo_id\x18\x0f \x01(\tB\x03\xe0A\x01R\fuserPseudoId\x12p\n" +
	"\x13content_search_spec\x18\x18 \x01(\v2@.google.cloud.discoveryengine.v1.SearchRequest.ContentSearchSpecR\x11contentSearchSpec\x122\n" +
	"\x12ranking_expression\x18\x1a \x01(\tB\x03\xe0A\x01R\x11rankingExpression\x12\x8a\x01\n" +
	"\x1aranking_expression_backend\x185 \x01(\x0e2G.google.cloud.discoveryengine.v1.SearchRequest.RankingExpressionBackendB\x03\xe0A\x01R\x18rankingExpressionBackend\x12\x1f\n" +
	"\vsafe_search\x18\x14 \x01(\bR\n" +
	"safeSearch\x12_\n" +
	"\vuser_labels\x18\x16 \x03(\v2>.google.cloud.discoveryengine.v1.SearchRequest.UserLabelsEntryR\n" +
	"userLabels\x12\xb3\x01\n" +
	")natural_language_query_understanding_spec\x18\x1c \x01(\v2T.google.cloud.discoveryengine.v1.SearchRequest.NaturalLanguageQueryUnderstandingSpecB\x03\xe0A\x01R%naturalLanguageQueryUnderstandingSpec\x12x\n" +
	"\x17search_as_you_type_spec\x18\x1f \x01(\v2B.google.cloud.discoveryengine.v1.SearchRequest.SearchAsYouTypeSpecR\x13searchAsYouTypeSpec\x12b\n" +
	"\fdisplay_spec\x18& \x01(\v2:.google.cloud.discoveryengine.v1.SearchRequest.DisplaySpecB\x03\xe0A\x01R\vdisplaySpec\x12g\n" +
	"\x0ecrowding_specs\x18( \x03(\v2;.google.cloud.discoveryengine.v1.SearchRequest.CrowdingSpecB\x03\xe0A\x01R\rcrowdingSpecs\x12E\n" +
	...
	"\x13relevance_threshold\x18, \x01(\x0e2A.google.cloud.discoveryengine.v1.SearchRequest.RelevanceThresholdR\x12relevanceThreshold\x12x\n" +
	...
	"\x17enable_dynamic_position\x18\x04 \x01(\bR\x15enableDynamicPosition\x1a\x95\x02\n" +
	"\bFacetKey\x12\x15\n" +
	"\x03key\x18\x01 \x01(\tB\x03\xe0A\x02R\x03key\x12G\n" +
	"\tintervals\x18\x02 \x03(\v2).google.cloud.discoveryengine.v1.IntervalR\tintervals\x12+\n" +
	...
	"\border_by\x18\a \x01(\tR\aorderBy\x1a\xcf\b\n" +
	"\tBoostSpec\x12\x7f\n" +
	"\x15condition_boost_specs\x18\x01 \x03(\v2K.google.cloud.discoveryengine.v1.SearchRequest.BoostSpec.ConditionBoostSpecR\x13conditionBoostSpecs\x1a\xc0\a\n" +
	"\x12ConditionBoostSpec\x12\x1c\n" +
	"\tcondition\x18\x01 \x01(\tR\tcondition\x12\x14\n" +
	"\x05boost\x18\x02 \x01(\x02R\x05boost\x12\x8a\x01\n" +
	"\x12boost_control_spec\x18\x03 \x01(\v2\\.google.cloud.discoveryengine.v1.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpecR\x10boostControlSpec\x1a\xe8\x05\n" +
	"\x10BoostControlSpec\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x12\x91\x01\n" +
	"\x0eattribute_type\x18\x02 \x01(\x0e2j.google.cloud.discoveryengine.v1.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.AttributeTypeR\rattributeType\x12\x9d\x01\n" +
	"\x12interpolation_type\x18\x03 \x01(\x0e2n.google.cloud.discoveryengine.v1.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.InterpolationTypeR\x11interpolationType\x12\x90\x01\n" +
	"\x0econtrol_points\x18\x04 \x03(\v2i.google.cloud.discoveryengine.v1.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.ControlPointR\rcontrolPoints\x1aZ\n" +
	"\fControlPoint\x12'\n" +
	...
	"\n" +
	"\x06LINEAR\x10\x01\x1a\xf5\x01\n" +
	"\x12QueryExpansionSpec\x12i\n" +
	"\tcondition\x18\x01 \x01(\x0e2K.google.cloud.discoveryengine.v1.SearchRequest.QueryExpansionSpec.ConditionR\tcondition\x124\n" +
	...
	"\x04AUTO\x10\x02\x1a\xaf\x01\n" +
	"\x13SpellCorrectionSpec\x12[\n" +
	"\x04mode\x18\x01 \x01(\x0e2G.google.cloud.discoveryengine.v1.SearchRequest.SpellCorrectionSpec.ModeR\x04mode\";\n" +
	"\x04Mode\x12\x14\n" +
	"\x10MODE_UNSPECIFIED\x10\x00\x12\x13\n" +
	"\x0fSUGGESTION_ONLY\x10\x01\x12\b\n" +
	"\x04AUTO\x10\x02\x1a\x9c\x10\n" +
	"\x11ContentSearchSpec\x12o\n" +
	"\fsnippet_spec\x18\x01 \x01(\v2L.google.cloud.discoveryengine.v1.SearchRequest.ContentSearchSpec.SnippetSpecR\vsnippetSpec\x12o\n" +
	"\fsummary_spec\x18\x02 \x01(\v2L.google.cloud.discoveryengine.v1.SearchRequest.ContentSearchSpec.SummarySpecR\vsummarySpec\x12\x8e\x01\n" +
	"\x17extractive_content_spec\x18\x03 \x01(\v2V.google.cloud.discoveryengine.v1.SearchRequest.ContentSearchSpec.ExtractiveContentSpecR\x15extractiveContentSpec\x12\x7f\n" +
	"\x12search_result_mode\x18\x04 \x01(\x0e2Q.google.cloud.discoveryengine.v1.SearchRequest.ContentSearchSpec.SearchResultModeR\x10searchResultMode\x12i\n" +
	"\n" +
	"chunk_spec\x18\x05 \x01(\v2J.google.cloud.discoveryengine.v1.SearchRequest.ContentSearchSpec.ChunkSpecR\tchunkSpec\x1a\x8f\x01\n" +
	"\vSnippetSpec\x12.\n" +
	...
	"\x0ereturn_snippet\x18\x03 \x01(\bR\rreturnSnippet\x1a\x9c\x06\n" +
	"\vSummarySpec\x120\n" +
	...
	" \x01(\bB\x03\xe0A\x01R\x17ignoreJailBreakingQuery\x12\x88\x01\n" +
	"\x11model_prompt_spec\x18\x05 \x01(\v2\\.google.cloud.discoveryengine.v1.SearchRequest.ContentSearchSpec.SummarySpec.ModelPromptSpecR\x0fmodelPromptSpec\x12#\n" +
	"\rlanguage_code\x18\x06 \x01(\tR\flanguageCode\x12u\n" +
	"\n" +
	"model_spec\x18\a \x01(\v2V.google.cloud.discoveryengine.v1.SearchRequest.ContentSearchSpec.SummarySpec.ModelSpecR\tmodelSpec\x12.\n" +
	...
	"\n" +
	"\x06CHUNKS\x10\x02\x1a\xca\x05\n" +
	"%NaturalLanguageQueryUnderstandingSpec\x12\xae\x01\n" +
	"\x1bfilter_extraction_condition\x18\x01 \x01(\x0e2n.google.cloud.discoveryengine.v1.SearchRequest.NaturalLanguageQueryUnderstandingSpec.FilterExtractionConditionR\x19filterExtractionCondition\x12Q\n" +
	"&geo_search_query_detection_field_names\x18\x02 \x03(\tR!geoSearchQueryDetectionFieldNames\x12\xad\x01\n" +
	"\x19extracted_filter_behavior\x18\x03 \x01(\x0e2l.google.cloud.discoveryengine.v1.SearchRequest.NaturalLanguageQueryUnderstandingSpec.ExtractedFilterBehaviorB\x03\xe0A\x01R\x17extractedFilterBehavior\x123\n" +
	...
	"\x1aMATCH_HIGHLIGHTING_ENABLED\x10\x02\x1a\xf2\x01\n" +
	"\fCrowdingSpec\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12\x1b\n" +
	"\tmax_count\x18\x02 \x01(\x05R\bmaxCount\x12T\n" +
	"\x04mode\x18\x03 \x01(\x0e2@.google.cloud.discoveryengine.v1.SearchRequest.CrowdingSpec.ModeR\x04mode\"Y\n" +
	"\x04Mode\x12\x14\n" +
	...
	"\x16return_relevance_score\x18\x01 \x01(\bB\x03\xe0A\x01R\x14returnRelevanceScore\x1aQ\n" +
	...
	"\x06values\x18\x02 \x03(\v2@.google.cloud.discoveryengine.v1.SearchResponse.Facet.FacetValueR\x06values\x12#\n" +
	"\rdynamic_facet\x18\x03 \x01(\bR\fdynamicFacet\x1a\x92\x01\n" +
	"\n" +
	"FacetValue\x12\x16\n" +
	"\x05value\x18\x01 \x01(\tH\x00R\x05value\x12G\n" +
	"\binterval\x18\x02 \x01(\v2).google.cloud.discoveryengine.v1.IntervalH\x00R\binterval\x12\x14\n" +
	"\x05count\x18\x03 \x01(\x03R\x05countB\r\n" +
	"\vfacet_value\x1a\xa0\x0e\n" +
	"\aSummary\x12!\n" +
	"\fsummary_text\x18\x01 \x01(\tR\vsummaryText\x12\x84\x01\n" +
	"\x17summary_skipped_reasons\x18\x02 \x03(\x0e2L.google.cloud.discoveryengine.v1.SearchResponse.Summary.SummarySkippedReasonR\x15summarySkippedReasons\x12u\n" +
	"\x11safety_attributes\x18\x03 \x01(\v2H.google.cloud.discoveryengine.v1.SearchResponse.Summary.SafetyAttributesR\x10safetyAttributes\x12\x7f\n" +
	"\x15summary_with_metadata\x18\x04 \x01(\v2K.google.cloud.discoveryengine.v1.SearchResponse.Summary.SummaryWithMetadataR\x13summaryWithMetadata\x1aJ\n" +
	"\x10SafetyAttributes\x12\x1e\n" +
	"\n" +
	"categories\x18\x01 \x03(\tR\n" +
	"categories\x12\x16\n" +
	"\x06scores\x18\x02 \x03(\x02R\x06scores\x1ar\n" +
	"\x10CitationMetadata\x12^\n" +
	"\tcitations\x18\x01 \x03(\v2@.google.cloud.discoveryengine.v1.SearchResponse.Summary.CitationR\tcitations\x1a\xaa\x01\n" +
	"\bCitation\x12\x1f\n" +
	"\vstart_index\x18\x01 \x01(\x03R\n" +
	"startIndex\x12\x1b\n" +
	"\tend_index\x18\x02 \x01(\x03R\bendIndex\x12`\n" +
	"\asources\x18\x03 \x03(\v2F.google.cloud.discoveryengine.v1.SearchResponse.Summary.CitationSourceR\asources\x1a9\n" +
	"\x0eCitationSource\x12'\n" +
	"\x0freference_index\x18\x04 \x01(\x03R\x0ereferenceIndex\x1a\xca\x02\n" +
	"\tReference\x12\x14\n" +
	...
	"\x03uri\x18\x03 \x01(\tR\x03uri\x12u\n" +
	"\x0echunk_contents\x18\x04 \x03(\v2N.google.cloud.discoveryengine.v1.SearchResponse.Summary.Reference.ChunkContentR\rchunkContents\x1aQ\n" +
	"\fChunkContent\x12\x18\n" +
	"\acontent\x18\x01 \x01(\tR\acontent\x12'\n" +
	"\x0fpage_identifier\x18\x02 \x01(\tR\x0epageIdentifier\x1a\x89\x02\n" +
	"\x13SummaryWithMetadata\x12\x18\n" +
	"\asummary\x18\x01 \x01(\tR\asummary\x12u\n" +
	"\x11citation_metadata\x18\x02 \x01(\v2H.google.cloud.discoveryengine.v1.SearchResponse.Summary.CitationMetadataR\x10citationMetadata\x12a\n" +
	"\n" +
	"references\x18\x03 \x03(\v2A.google.cloud.discoveryengine.v1.SearchResponse.Summary.ReferenceR\n" +
	"references\"\xf1\x02\n" +
	...
	"\x13pinned_result_count\x18\x02 \x01(\x03R\x11pinnedResultCount\x1a\xbc\x13\n" +
	...
	"\x12classified_intents\x18\x05 \x03(\tR\x11classifiedIntents\x12\xaf\x01\n" +
	"\x1bstructured_extracted_filter\x18\x03 \x01(\v2o.google.cloud.discoveryengine.v1.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilterR\x19structuredExtractedFilter\x1a\xdb\x10\n" +
	"\x19StructuredExtractedFilter\x12\x9a\x01\n" +
	"\n" +
	"expression\x18\x01 \x01(\v2z.google.cloud.discoveryengine.v1.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.ExpressionR\n" +
	"expression\x1an\n" +
	"\x10StringConstraint\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x12\x16\n" +
	"\x06values\x18\x02 \x03(\tR\x06values\x12#\n" +
	"\rquery_segment\x18\x03 \x01(\tR\fquerySegment\x1a\xa2\x03\n" +
	"\x10NumberConstraint\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x12\xac\x01\n" +
	"\n" +
	"comparison\x18\x02 \x01(\x0e2\x8b\x01.google.cloud.discoveryengine.v1.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.NumberConstraint.ComparisonR\n" +
	"comparison\x12\x14\n" +
	...
	"\x10radius_in_meters\x18\x03 \x01(\x02R\x0eradiusInMeters\x1a\xae\x01\n" +
	"\rAndExpression\x12\x9c\x01\n" +
	"\vexpressions\x18\x01 \x03(\v2z.google.cloud.discoveryengine.v1.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.ExpressionR\vexpressions\x1a\xad\x01\n" +
	"\fOrExpression\x12\x9c\x01\n" +
	"\vexpressions\x18\x01 \x03(\v2z.google.cloud.discoveryengine.v1.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.ExpressionR\vexpressions\x1a\xf3\x06\n" +
	"\n" +
	"Expression\x12\xb0\x01\n" +
	"\x11string_constraint\x18\x01 \x01(\v2\x80\x01.google.cloud.discoveryengine.v1.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.StringConstraintH\x00R\x10stringConstraint\x12\xb0\x01\n" +
	"\x11number_constraint\x18\x02 \x01(\v2\x80\x01.google.cloud.discoveryengine.v1.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.NumberConstraintH\x00R\x10numberConstraint\x12\xbf\x01\n" +
	"\x16geolocation_constraint\x18\x03 \x01(\v2\x85\x01.google.cloud.discoveryengine.v1.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.GeolocationConstraintH\x00R\x15geolocationConstraint\x12\x9a\x01\n" +
	"\band_expr\x18\x04 \x01(\v2}.google.cloud.discoveryengine.v1.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.AndExpressionH\x00R\aandExpr\x12\x97\x01\n" +
	"\aor_expr\x18\x05 \x01(\v2|.google.cloud.discoveryengine.v1.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.OrExpressionH\x00R\x06orExprB\x06\n" +
	"\x04expr\x1a<\n" +
	"\vSessionInfo\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x19\n" +
	"\bquery_id\x18\x02 \x01(\tR\aqueryId\"J\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1_search_service_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1_search_service_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1_search_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1_search_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1_search_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1_search_service_proto_rawDesc)))
	})
