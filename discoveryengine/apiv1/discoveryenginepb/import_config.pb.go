...
func file_google_cloud_discoveryengine_v1_import_config_proto_init() {
	...
	file_google_cloud_discoveryengine_v1_import_config_proto_msgTypes[8].OneofWrappers = []any{
	...
	file_google_cloud_discoveryengine_v1_import_config_proto_msgTypes[13].OneofWrappers = []any{
	...
	file_google_cloud_discoveryengine_v1_import_config_proto_msgTypes[15].OneofWrappers = []any{
