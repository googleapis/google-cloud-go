...
var file_google_cloud_discoveryengine_v1_conversation_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xaf, 0x05, 0x0a, 0x0c, 0x43, 0x6f, 0x6e,
	...
	0x02, 0x3a, 0x86, 0x02, 0xea, 0x41, 0x82, 0x02, 0x0a, 0x2b, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76,
...
var file_google_cloud_discoveryengine_v1_conversation_proto_goTypes = []interface{}{
...
func file_google_cloud_discoveryengine_v1_conversation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_discoveryengine_v1_conversation_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_discoveryengine_v1_conversation_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Reply); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_cloud_discoveryengine_v1_conversation_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_discoveryengine_v1_conversation_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_discoveryengine_v1_conversation_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_discoveryengine_v1_conversation_proto_msgTypes[4].OneofWrappers = []interface{}{
