...
const file_google_cloud_discoveryengine_v1_data_store_service_proto_rawDesc = "" +
	"\n" +
	...
	")discoveryengine.googleapis.com/CollectionR\x06parent\x12N\n" +
	"\n" +
	"data_store\x18\x02 \x01(\v2*.google.cloud.discoveryengine.v1.DataStoreB\x03\xe0A\x02R\tdataStore\x12'\n" +
	...
	"\x16ListDataStoresResponse\x12K\n" +
	"\vdata_stores\x18\x01 \x03(\v2*.google.cloud.discoveryengine.v1.DataStoreR\n" +
	"dataStores\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"^\n" +
	"\x16DeleteDataStoreRequest\x12D\n" +
	"\x04name\x18\x01 \x01(\tB0\xe0A\x02\xfaA*\n" +
	"(discoveryengine.googleapis.com/DataStoreR\x04name\"\xa5\x01\n" +
	"\x16UpdateDataStoreRequest\x12N\n" +
	"\n" +
	"data_store\x18\x01 \x01(\v2*.google.cloud.discoveryengine.v1.DataStoreB\x03\xe0A\x02R\tdataStore\x12;\n" +
	...
	")google.cloud.discoveryengine.v1.DataStore\x127google.cloud.discoveryengine.v1.CreateDataStoreMetadata\xdaA\x1fparent,data_store,data_store_id\x82\xd3\xe4\x93\x02\x88\x01:\n" +
	"data_storeZJ:\n" +
	"data_store\"</v1/{parent=projects/*/locations/*/collections/*}/dataStores\"./v1/{parent=projects/*/locations/*}/dataStores\x12\xef\x01\n" +
	"\fGetDataStore\x124.google.cloud.discoveryengine.v1.GetDataStoreRequest\x1a*.google.cloud.discoveryengine.v1.DataStore\"}\xdaA\x04name\x82\xd3\xe4\x93\x02pZ>\x12</v1/{name=projects/*/locations/*/collections/*/dataStores/*}\x12./v1/{name=projects/*/locations/*/dataStores/*}\x12\x82\x02\n" +
	"\x0eListDataStores\x126.google.cloud.discoveryengine.v1.ListDataStoresRequest\x1a7.google.cloud.discoveryengine.v1.ListDataStoresResponse\"\x7f\xdaA\x06parent\x82\xd3\xe4\x93\x02pZ>\x12</v1/{parent=projects/*/locations/*/collections/*}/dataStores\x12./v1/{parent=projects/*/locations/*}/dataStores\x12\xbc\x02\n" +
	...
	"\x15google.protobuf.Empty\x127google.cloud.discoveryengine.v1.DeleteDataStoreMetadata\xdaA\x04name\x82\xd3\xe4\x93\x02pZ>*</v1/{name=projects/*/locations/*/collections/*/dataStores/*}*./v1/{name=projects/*/locations/*/dataStores/*}\x12\xb7\x02\n" +
	"\x0fUpdateDataStore\x127.google.cloud.discoveryengine.v1.UpdateDataStoreRequest\x1a*.google.cloud.discoveryengine.v1.DataStore\"\xbe\x01\xdaA\x16data_store,update_mask\x82\xd3\xe4\x93\x02\x9e\x01:\n" +
	"data_storeZU:\n" +
	"data_store2G/v1/{data_store.name=projects/*/locations/*/collections/*/dataStores/*}29/v1/{data_store.name=projects/*/locations/*/dataStores/*}\x1aR\xcaA\x1ediscoveryengine.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\x88\x02\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1_data_store_service_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1_data_store_service_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1_data_store_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1_data_store_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1_data_store_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1_data_store_service_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1_data_store_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1_data_store_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1_data_store_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
