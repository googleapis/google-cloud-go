...
const file_google_cloud_discoveryengine_v1_search_tuning_service_proto_rawDesc = "" +
	"\n" +
	";google/cloud/discoveryengine/v1/search_tuning_service.proto\x12\x1fgoogle.cloud.discoveryengine.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a9google/cloud/discoveryengine/v1/custom_tuning_model.proto\x1a3google/cloud/discoveryengine/v1/import_config.proto\x1a#google/longrunning/operations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"j\n" +
	"\x17ListCustomModelsRequest\x12O\n" +
	"\n" +
	"data_store\x18\x01 \x01(\tB0\xe0A\x02\xfaA*\n" +
	"(discoveryengine.googleapis.com/DataStoreR\tdataStore\"f\n" +
	"\x18ListCustomModelsResponse\x12J\n" +
	"\x06models\x18\x01 \x03(\v22.google.cloud.discoveryengine.v1.CustomTuningModelR\x06models\"\xbd\x04\n" +
	"\x17TrainCustomModelRequest\x12y\n" +
	"\x12gcs_training_input\x18\x02 \x01(\v2I.google.cloud.discoveryengine.v1.TrainCustomModelRequest.GcsTrainingInputH\x00R\x10gcsTrainingInput\x12O\n" +
	"\n" +
	"data_store\x18\x01 \x01(\tB0\xe0A\x02\xfaA*\n" +
	"(discoveryengine.googleapis.com/DataStoreR\tdataStore\x12\x1d\n" +
	"\n" +
	"model_type\x18\x03 \x01(\tR\tmodelType\x12U\n" +
	"\ferror_config\x18\x04 \x01(\v22.google.cloud.discoveryengine.v1.ImportErrorConfigR\verrorConfig\x12\x19\n" +
	...
	"\x0etraining_input\"\x8a\x03\n" +
	"\x18TrainCustomModelResponse\x127\n" +
	"\rerror_samples\x18\x01 \x03(\v2\x12.google.rpc.StatusR\ferrorSamples\x12U\n" +
	"\ferror_config\x18\x02 \x01(\v22.google.cloud.discoveryengine.v1.ImportErrorConfigR\verrorConfig\x12!\n" +
	"\fmodel_status\x18\x03 \x01(\tR\vmodelStatus\x12`\n" +
	"\ametrics\x18\x04 \x03(\v2F.google.cloud.discoveryengine.v1.TrainCustomModelResponse.MetricsEntryR\ametrics\x12\x1d\n" +
	"\n" +
	...
	"8google.cloud.discoveryengine.v1.TrainCustomModelResponse\x128google.cloud.discoveryengine.v1.TrainCustomModelMetadata\x82\xd3\xe4\x93\x02X:\x01*\"S/v1/{data_store=projects/*/locations/*/collections/*/dataStores/*}:trainCustomModel\x12\xe0\x01\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1_search_tuning_service_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1_search_tuning_service_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1_search_tuning_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1_search_tuning_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1_search_tuning_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1_search_tuning_service_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1_search_tuning_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1_search_tuning_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1_search_tuning_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
