...
const file_google_cloud_discoveryengine_v1_purge_config_proto_rawDesc = "" +
	"\n" +
	"2google/cloud/discoveryengine/v1/purge_config.proto\x12\x1fgoogle.cloud.discoveryengine.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a3google/cloud/discoveryengine/v1/import_config.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\x95\x01\n" +
	...
	"\vdestination\"\x89\x04\n" +
	"\x15PurgeDocumentsRequest\x12K\n" +
	"\n" +
	"gcs_source\x18\x05 \x01(\v2*.google.cloud.discoveryengine.v1.GcsSourceH\x00R\tgcsSource\x12j\n" +
	"\rinline_source\x18\x06 \x01(\v2C.google.cloud.discoveryengine.v1.PurgeDocumentsRequest.InlineSourceH\x00R\finlineSource\x12E\n" +
	"\x06parent\x18\x01 \x01(\tB-\xe0A\x02\xfaA'\n" +
	"%discoveryengine.googleapis.com/BranchR\x06parent\x12\x1b\n" +
	"\x06filter\x18\x02 \x01(\tB\x03\xe0A\x02R\x06filter\x12T\n" +
	"\ferror_config\x18\a \x01(\v21.google.cloud.discoveryengine.v1.PurgeErrorConfigR\verrorConfig\x12\x14\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1_purge_config_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1_purge_config_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1_purge_config_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1_purge_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1_purge_config_proto_rawDesc), len(file_google_cloud_discoveryengine_v1_purge_config_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1_purge_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1_purge_config_proto_rawDesc), len(file_google_cloud_discoveryengine_v1_purge_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
