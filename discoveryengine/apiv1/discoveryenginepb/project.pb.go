...
var file_google_cloud_discoveryengine_v1_project_proto_goTypes = []any{
...
func file_google_cloud_discoveryengine_v1_project_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_discoveryengine_v1_project_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_discoveryengine_v1_project_proto_msgTypes[1].Exporter = func(v any, i int) any {
