...
func NewSearchClient(ctx context.Context, opts ...option.ClientOption) (*SearchClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.SearchLite = append(client.CallOptions.SearchLite, gax.WithClientMetrics(metrics))
...
func NewSearchRESTClient(ctx context.Context, opts ...option.ClientOption) (*SearchClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.SearchLite = append(callOpts.SearchLite, gax.WithClientMetrics(metrics))
...
func (c *searchGRPCClient) Search(ctx context.Context, req *discoveryenginepb.SearchRequest, opts ...gax.CallOption) *SearchResponse_SearchResultIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1.SearchService/Search")
	}
...
func (c *searchGRPCClient) SearchLite(ctx context.Context, req *discoveryenginepb.SearchRequest, opts ...gax.CallOption) *SearchResponse_SearchResultIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1.SearchService/SearchLite")
	}
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*discoveryenginepb.SearchResponse_SearchResult, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.searchClient.SearchLite, req, settings.GRPC, c.logger, "SearchLite")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *searchRESTClient) SearchLite(ctx context.Context, req *discoveryenginepb.SearchRequest, opts ...gax.CallOption) *SearchResponse_SearchResultIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*discoveryenginepb.SearchResponse_SearchResult, string, error) {
		...
		e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			...
			buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "SearchLite")
			if err != nil {
				return err
			}
			if err := unm.Unmarshal(buf, resp); err != nil {
