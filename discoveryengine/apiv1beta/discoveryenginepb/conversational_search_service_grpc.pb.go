...
const (
	ConversationalSearchService_ConverseConversation_FullMethodName = "/google.cloud.discoveryengine.v1beta.ConversationalSearchService/ConverseConversation"
	ConversationalSearchService_CreateConversation_FullMethodName   = "/google.cloud.discoveryengine.v1beta.ConversationalSearchService/CreateConversation"
	ConversationalSearchService_DeleteConversation_FullMethodName   = "/google.cloud.discoveryengine.v1beta.ConversationalSearchService/DeleteConversation"
	ConversationalSearchService_UpdateConversation_FullMethodName   = "/google.cloud.discoveryengine.v1beta.ConversationalSearchService/UpdateConversation"
	ConversationalSearchService_GetConversation_FullMethodName      = "/google.cloud.discoveryengine.v1beta.ConversationalSearchService/GetConversation"
	ConversationalSearchService_ListConversations_FullMethodName    = "/google.cloud.discoveryengine.v1beta.ConversationalSearchService/ListConversations"
	ConversationalSearchService_AnswerQuery_FullMethodName          = "/google.cloud.discoveryengine.v1beta.ConversationalSearchService/AnswerQuery"
	ConversationalSearchService_StreamAnswerQuery_FullMethodName    = "/google.cloud.discoveryengine.v1beta.ConversationalSearchService/StreamAnswerQuery"
	ConversationalSearchService_GetAnswer_FullMethodName            = "/google.cloud.discoveryengine.v1beta.ConversationalSearchService/GetAnswer"
	ConversationalSearchService_CreateSession_FullMethodName        = "/google.cloud.discoveryengine.v1beta.ConversationalSearchService/CreateSession"
	ConversationalSearchService_DeleteSession_FullMethodName        = "/google.cloud.discoveryengine.v1beta.ConversationalSearchService/DeleteSession"
	ConversationalSearchService_UpdateSession_FullMethodName        = "/google.cloud.discoveryengine.v1beta.ConversationalSearchService/UpdateSession"
	ConversationalSearchService_GetSession_FullMethodName           = "/google.cloud.discoveryengine.v1beta.ConversationalSearchService/GetSession"
...
func (c *conversationalSearchServiceClient) StreamAnswerQuery(ctx context.Context, in *AnswerQueryRequest, opts ...grpc.CallOption) (ConversationalSearchService_StreamAnswerQueryClient, error) {
	stream, err := c.cc.NewStream(ctx, &ConversationalSearchService_ServiceDesc.Streams[0], ConversationalSearchService_StreamAnswerQuery_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &conversationalSearchServiceStreamAnswerQueryClient{stream}
...
type conversationalSearchServiceStreamAnswerQueryClient struct {
	grpc.ClientStream
}

func (x *conversationalSearchServiceStreamAnswerQueryClient) Recv() (*AnswerQueryResponse, error) {
	m := new(AnswerQueryResponse)
...
func (UnimplementedConversationalSearchServiceServer) StreamAnswerQuery(*AnswerQueryRequest, ConversationalSearchService_StreamAnswerQueryServer) error {
	return status.Errorf(codes.Unimplemented, "method StreamAnswerQuery not implemented")
}
...
func _ConversationalSearchService_StreamAnswerQuery_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(AnswerQueryRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ConversationalSearchServiceServer).StreamAnswerQuery(m, &conversationalSearchServiceStreamAnswerQueryServer{stream})
}
...
type conversationalSearchServiceStreamAnswerQueryServer struct {
	grpc.ServerStream
}

func (x *conversationalSearchServiceStreamAnswerQueryServer) Send(m *AnswerQueryResponse) error {
