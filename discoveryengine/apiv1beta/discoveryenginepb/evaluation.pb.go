...
const file_google_cloud_discoveryengine_v1beta_evaluation_proto_rawDesc = "" +
	"\n" +
	"4google/cloud/discoveryengine/v1beta/evaluation.proto\x12#google.cloud.discoveryengine.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a8google/cloud/discoveryengine/v1beta/search_service.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\xe7\b\n" +
	"\n" +
	"Evaluation\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12l\n" +
	"\x0fevaluation_spec\x18\x02 \x01(\v2>.google.cloud.discoveryengine.v1beta.Evaluation.EvaluationSpecB\x03\xe0A\x02R\x0eevaluationSpec\x12a\n" +
	"\x0fquality_metrics\x18\x03 \x01(\v23.google.cloud.discoveryengine.v1beta.QualityMetricsB\x03\xe0A\x03R\x0equalityMetrics\x12P\n" +
	"\x05state\x18\x04 \x01(\x0e25.google.cloud.discoveryengine.v1beta.Evaluation.StateB\x03\xe0A\x03R\x05state\x12-\n" +
	...
	"\rerror_samples\x18\b \x03(\v2\x12.google.rpc.StatusB\x03\xe0A\x03R\ferrorSamples\x1a\xea\x02\n" +
	"\x0eEvaluationSpec\x12`\n" +
	"\x0esearch_request\x18\x02 \x01(\v22.google.cloud.discoveryengine.v1beta.SearchRequestB\x03\xe0A\x02H\x00R\rsearchRequest\x12v\n" +
	"\x0equery_set_spec\x18\x01 \x01(\v2K.google.cloud.discoveryengine.v1beta.Evaluation.EvaluationSpec.QuerySetSpecB\x03\xe0A\x01R\fquerySetSpec\x1ao\n" +
	"\fQuerySetSpec\x12_\n" +
	"\x10sample_query_set\x18\x01 \x01(\tB5\xe0A\x01\xfaA/\n" +
	...
	")discoveryengine.googleapis.com/Evaluation\x12@projects/{project}/locations/{location}/evaluations/{evaluation}\"\xd7\x04\n" +
	"\x0eQualityMetrics\x12^\n" +
	"\n" +
	"doc_recall\x18\x01 \x01(\v2?.google.cloud.discoveryengine.v1beta.QualityMetrics.TopkMetricsR\tdocRecall\x12d\n" +
	"\rdoc_precision\x18\x02 \x01(\v2?.google.cloud.discoveryengine.v1beta.QualityMetrics.TopkMetricsR\fdocPrecision\x12Z\n" +
	"\bdoc_ndcg\x18\x03 \x01(\v2?.google.cloud.discoveryengine.v1beta.QualityMetrics.TopkMetricsR\adocNdcg\x12`\n" +
	"\vpage_recall\x18\x04 \x01(\v2?.google.cloud.discoveryengine.v1beta.QualityMetrics.TopkMetricsR\n" +
	"pageRecall\x12\\\n" +
	"\tpage_ndcg\x18\x05 \x01(\v2?.google.cloud.discoveryengine.v1beta.QualityMetrics.TopkMetricsR\bpageNdcg\x1ac\n" +
	...
	"\x06top_10\x18\x04 \x01(\x01R\x05top10B\x96\x02\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1beta_evaluation_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1beta_evaluation_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1beta_evaluation_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1beta_evaluation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_evaluation_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_evaluation_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1beta_evaluation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_evaluation_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_evaluation_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
