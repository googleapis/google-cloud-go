...
const file_google_cloud_discoveryengine_v1beta_search_tuning_service_proto_rawDesc = "" +
	"\n" +
	"?google/cloud/discoveryengine/v1beta/search_tuning_service.proto\x12#google.cloud.discoveryengine.v1beta\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a=google/cloud/discoveryengine/v1beta/custom_tuning_model.proto\x1a7google/cloud/discoveryengine/v1beta/import_config.proto\x1a#google/longrunning/operations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"j\n" +
	"\x17ListCustomModelsRequest\x12O\n" +
	"\n" +
	"data_store\x18\x01 \x01(\tB0\xe0A\x02\xfaA*\n" +
	"(discoveryengine.googleapis.com/DataStoreR\tdataStore\"j\n" +
	"\x18ListCustomModelsResponse\x12N\n" +
	"\x06models\x18\x01 \x03(\v26.google.cloud.discoveryengine.v1beta.CustomTuningModelR\x06models\"\xc5\x04\n" +
	"\x17TrainCustomModelRequest\x12}\n" +
	"\x12gcs_training_input\x18\x02 \x01(\v2M.google.cloud.discoveryengine.v1beta.TrainCustomModelRequest.GcsTrainingInputH\x00R\x10gcsTrainingInput\x12O\n" +
	"\n" +
	"data_store\x18\x01 \x01(\tB0\xe0A\x02\xfaA*\n" +
	"(discoveryengine.googleapis.com/DataStoreR\tdataStore\x12\x1d\n" +
	"\n" +
	"model_type\x18\x03 \x01(\tR\tmodelType\x12Y\n" +
	"\ferror_config\x18\x04 \x01(\v26.google.cloud.discoveryengine.v1beta.ImportErrorConfigR\verrorConfig\x12\x19\n" +
	...
	"\fmodel_status\x18\x03 \x01(\tR\vmodelStatus\x12d\n" +
	"\ametrics\x18\x04 \x03(\v2J.google.cloud.discoveryengine.v1beta.TrainCustomModelResponse.MetricsEntryR\ametrics\x12\x1d\n" +
	"\n" +
	...
	"<google.cloud.discoveryengine.v1beta.TrainCustomModelResponse\x12<google.cloud.discoveryengine.v1beta.TrainCustomModelMetadata\x82\xd3\xe4\x93\x02\\:\x01*\"W/v1beta/{data_store=projects/*/locations/*/collections/*/dataStores/*}:trainCustomModel\x12\xec\x01\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1beta_search_tuning_service_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1beta_search_tuning_service_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1beta_search_tuning_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1beta_search_tuning_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_search_tuning_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_search_tuning_service_proto_rawDesc)))
	})
...
var file_google_cloud_discoveryengine_v1beta_search_tuning_service_proto_goTypes = []any{
...
func file_google_cloud_discoveryengine_v1beta_search_tuning_service_proto_init() {
	...
	file_google_cloud_discoveryengine_v1beta_search_tuning_service_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_search_tuning_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_search_tuning_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
