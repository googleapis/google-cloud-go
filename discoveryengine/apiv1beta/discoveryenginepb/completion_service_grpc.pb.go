...
const (
	CompletionService_CompleteQuery_FullMethodName                   = "/google.cloud.discoveryengine.v1beta.CompletionService/CompleteQuery"
	CompletionService_AdvancedCompleteQuery_FullMethodName           = "/google.cloud.discoveryengine.v1beta.CompletionService/AdvancedCompleteQuery"
	CompletionService_ImportSuggestionDenyListEntries_FullMethodName = "/google.cloud.discoveryengine.v1beta.CompletionService/ImportSuggestionDenyListEntries"
	CompletionService_PurgeSuggestionDenyListEntries_FullMethodName  = "/google.cloud.discoveryengine.v1beta.CompletionService/PurgeSuggestionDenyListEntries"
	CompletionService_ImportCompletionSuggestions_FullMethodName     = "/google.cloud.discoveryengine.v1beta.CompletionService/ImportCompletionSuggestions"
	CompletionService_PurgeCompletionSuggestions_FullMethodName      = "/google.cloud.discoveryengine.v1beta.CompletionService/PurgeCompletionSuggestions"
	CompletionService_RemoveSuggestion_FullMethodName                = "/google.cloud.discoveryengine.v1beta.CompletionService/RemoveSuggestion"
)
...
type CompletionServiceClient interface {
	...
	RemoveSuggestion(ctx context.Context, in *RemoveSuggestionRequest, opts ...grpc.CallOption) (*RemoveSuggestionResponse, error)
}
...
func (c *completionServiceClient) AdvancedCompleteQuery(ctx context.Context, in *AdvancedCompleteQueryRequest, opts ...grpc.CallOption) (*AdvancedCompleteQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, CompletionService_AdvancedCompleteQuery_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *completionServiceClient) RemoveSuggestion(ctx context.Context, in *RemoveSuggestionRequest, opts ...grpc.CallOption) (*RemoveSuggestionResponse, error) {
	out := new(RemoveSuggestionResponse)
	err := c.cc.Invoke(ctx, CompletionService_RemoveSuggestion_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CompletionServiceServer interface {
	...
	// for this user. If the user searches the same suggestion again, the new
	// history will override and suggest this suggestion again.
	RemoveSuggestion(context.Context, *RemoveSuggestionRequest) (*RemoveSuggestionResponse, error)
}
...
func (UnimplementedCompletionServiceServer) RemoveSuggestion(context.Context, *RemoveSuggestionRequest) (*RemoveSuggestionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RemoveSuggestion not implemented")
}
...
func _CompletionService_AdvancedCompleteQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CompletionService_AdvancedCompleteQuery_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CompletionService_RemoveSuggestion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveSuggestionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CompletionServiceServer).RemoveSuggestion(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CompletionService_RemoveSuggestion_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CompletionServiceServer).RemoveSuggestion(ctx, req.(*RemoveSuggestionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CompletionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RemoveSuggestion",
			Handler:    _CompletionService_RemoveSuggestion_Handler,
		},
	},
