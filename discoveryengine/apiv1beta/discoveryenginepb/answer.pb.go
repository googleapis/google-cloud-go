...
type Answer_BlobAttachment_AttributionType int32

const (
	// Unspecified attribution type.
	Answer_BlobAttachment_ATTRIBUTION_TYPE_UNSPECIFIED Answer_BlobAttachment_AttributionType = 0
	// The attachment data is from the corpus.
	Answer_BlobAttachment_CORPUS Answer_BlobAttachment_AttributionType = 1
	// The attachment data is generated by the model through code
	// generation.
	Answer_BlobAttachment_GENERATED Answer_BlobAttachment_AttributionType = 2
)

// Enum value maps for Answer_BlobAttachment_AttributionType.
var (
	Answer_BlobAttachment_AttributionType_name = map[int32]string{
		0: "ATTRIBUTION_TYPE_UNSPECIFIED",
		1: "CORPUS",
		2: "GENERATED",
	}
	Answer_BlobAttachment_AttributionType_value = map[string]int32{
...
func (x Answer_BlobAttachment_AttributionType) Enum() *Answer_BlobAttachment_AttributionType {
	p := new(Answer_BlobAttachment_AttributionType)
	*p = x
	return p
}

func (x Answer_BlobAttachment_AttributionType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Answer_BlobAttachment_AttributionType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_enumTypes[2].Descriptor()
}

func (Answer_BlobAttachment_AttributionType) Type() protoreflect.EnumType {
	return &file_google_cloud_discoveryengine_v1beta_answer_proto_enumTypes[2]
}

func (x Answer_BlobAttachment_AttributionType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Answer_BlobAttachment_AttributionType.Descriptor instead.
func (Answer_BlobAttachment_AttributionType) EnumDescriptor() ([]byte, []int) {
...
func (Answer_Step_State) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP(), []int{0, 5, 0}
}
...
func (Answer_QueryUnderstandingInfo_QueryClassificationInfo_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_enumTypes[4].Descriptor()
}

func (Answer_QueryUnderstandingInfo_QueryClassificationInfo_Type) Type() protoreflect.EnumType {
	return &file_google_cloud_discoveryengine_v1beta_answer_proto_enumTypes[4]
}
...
func (Answer_QueryUnderstandingInfo_QueryClassificationInfo_Type) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP(), []int{0, 6, 0, 0}
}
...
type Answer struct {
	...
	BlobAttachments []*Answer_BlobAttachment `protobuf:"bytes,15,rep,name=blob_attachments,json=blobAttachments,proto3" json:"blob_attachments,omitempty"`
...
func (x *Answer) GetBlobAttachments() []*Answer_BlobAttachment {
	if x != nil {
...
type Answer_BlobAttachment struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Output only. The mime type and data of the blob.
	Data *Answer_BlobAttachment_Blob `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
	// Output only. The attribution type of the blob.
	AttributionType Answer_BlobAttachment_AttributionType `protobuf:"varint,2,opt,name=attribution_type,json=attributionType,proto3,enum=google.cloud.discoveryengine.v1beta.Answer_BlobAttachment_AttributionType" json:"attribution_type,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *Answer_BlobAttachment) Reset() {
	*x = Answer_BlobAttachment{}
	mi := &file_google_cloud_discoveryengine_v1beta_answer_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Answer_BlobAttachment) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Answer_BlobAttachment) ProtoMessage() {}

func (x *Answer_BlobAttachment) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_discoveryengine_v1beta_answer_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Answer_BlobAttachment.ProtoReflect.Descriptor instead.
func (*Answer_BlobAttachment) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP(), []int{0, 4}
}

func (x *Answer_BlobAttachment) GetData() *Answer_BlobAttachment_Blob {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *Answer_BlobAttachment) GetAttributionType() Answer_BlobAttachment_AttributionType {
	if x != nil {
		return x.AttributionType
	}
	return Answer_BlobAttachment_ATTRIBUTION_TYPE_UNSPECIFIED
}
...
func (*Answer_Step) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP(), []int{0, 5}
}
...
func (*Answer_QueryUnderstandingInfo) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP(), []int{0, 6}
}
...
type Answer_Reference_ChunkInfo struct {
	...
	BlobAttachmentIndexes []int64 `protobuf:"varint,5,rep,packed,name=blob_attachment_indexes,json=blobAttachmentIndexes,proto3" json:"blob_attachment_indexes,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (*Answer_Reference_ChunkInfo) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP(), []int{0, 3, 1}
}
...
func (x *Answer_Reference_ChunkInfo) GetBlobAttachmentIndexes() []int64 {
	if x != nil {
...
func (*Answer_Reference_StructuredDocumentInfo) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP(), []int{0, 3, 2}
}
...
func (x *Answer_Reference_UnstructuredDocumentInfo_ChunkContent) GetBlobAttachmentIndexes() []int64 {
	if x != nil {
		return x.BlobAttachmentIndexes
	}
	return nil
...
func (*Answer_Reference_ChunkInfo_DocumentMetadata) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP(), []int{0, 3, 1, 0}
}
...
type Answer_BlobAttachment_Blob struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *Answer_BlobAttachment_Blob) Reset() {
	*x = Answer_BlobAttachment_Blob{}
	mi := &file_google_cloud_discoveryengine_v1beta_answer_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Answer_BlobAttachment_Blob) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Answer_BlobAttachment_Blob) ProtoMessage() {}

func (x *Answer_BlobAttachment_Blob) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_discoveryengine_v1beta_answer_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Answer_BlobAttachment_Blob.ProtoReflect.Descriptor instead.
func (*Answer_BlobAttachment_Blob) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP(), []int{0, 4, 0}
}

func (x *Answer_BlobAttachment_Blob) GetMimeType() string {
	if x != nil {
		return x.MimeType
	}
	return ""
...
func (x *Answer_BlobAttachment_Blob) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (*Answer_Step_Action_SearchAction) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP(), []int{0, 5, 0, 0}
}
...
func (*Answer_Step_Action_Observation) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP(), []int{0, 5, 0, 1}
}
...
func (*Answer_Step_Action_Observation_SearchResult) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP(), []int{0, 5, 0, 1, 0}
}
...
func (x *Answer_Step_Action_Observation_SearchResult_SnippetInfo) Reset() {
	*x = Answer_Step_Action_Observation_SearchResult_SnippetInfo{}
	mi := &file_google_cloud_discoveryengine_v1beta_answer_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Answer_Step_Action_Observation_SearchResult_SnippetInfo) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP(), []int{0, 5, 0, 1, 0, 0}
}
...
func (x *Answer_Step_Action_Observation_SearchResult_ChunkInfo) Reset() {
	*x = Answer_Step_Action_Observation_SearchResult_ChunkInfo{}
	mi := &file_google_cloud_discoveryengine_v1beta_answer_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Answer_Step_Action_Observation_SearchResult_ChunkInfo) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP(), []int{0, 5, 0, 1, 0, 1}
}
...
func (x *Answer_QueryUnderstandingInfo_QueryClassificationInfo) Reset() {
	*x = Answer_QueryUnderstandingInfo_QueryClassificationInfo{}
	mi := &file_google_cloud_discoveryengine_v1beta_answer_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Answer_QueryUnderstandingInfo_QueryClassificationInfo) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP(), []int{0, 6, 0}
}
...
const file_google_cloud_discoveryengine_v1beta_answer_proto_rawDesc = "" +
	"\n" +
	"0google/cloud/discoveryengine/v1beta/answer.proto\x12#google.cloud.discoveryengine.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a0google/cloud/discoveryengine/v1beta/safety.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xeb3\n" +
	"\x06Answer\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x05R\x04name\x12G\n" +
	"\x05state\x18\x02 \x01(\x0e21.google.cloud.discoveryengine.v1beta.Answer.StateR\x05state\x12\x1f\n" +
	"\vanswer_text\x18\x03 \x01(\tR\n" +
	"answerText\x12,\n" +
	"\x0fgrounding_score\x18\f \x01(\x01H\x00R\x0egroundingScore\x88\x01\x01\x12R\n" +
	"\tcitations\x18\x04 \x03(\v24.google.cloud.discoveryengine.v1beta.Answer.CitationR\tcitations\x12p\n" +
	"\x12grounding_supports\x18\r \x03(\v2<.google.cloud.discoveryengine.v1beta.Answer.GroundingSupportB\x03\xe0A\x01R\x11groundingSupports\x12U\n" +
	"\n" +
	"references\x18\x05 \x03(\v25.google.cloud.discoveryengine.v1beta.Answer.ReferenceR\n" +
	"references\x12j\n" +
	"\x10blob_attachments\x18\x0f \x03(\v2:.google.cloud.discoveryengine.v1beta.Answer.BlobAttachmentB\x03\xe0A\x03R\x0fblobAttachments\x12+\n" +
	"\x11related_questions\x18\x06 \x03(\tR\x10relatedQuestions\x12F\n" +
	"\x05steps\x18\a \x03(\v20.google.cloud.discoveryengine.v1beta.Answer.StepR\x05steps\x12|\n" +
	"\x18query_understanding_info\x18\n" +
	" \x01(\v2B.google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfoR\x16queryUnderstandingInfo\x12u\n" +
	"\x16answer_skipped_reasons\x18\v \x03(\x0e2?.google.cloud.discoveryengine.v1beta.Answer.AnswerSkippedReasonR\x14answerSkippedReasons\x12@\n" +
	...
	"\x0esafety_ratings\x18\x0e \x03(\v21.google.cloud.discoveryengine.v1beta.SafetyRatingB\x03\xe0A\x01R\rsafetyRatings\x1a\x9e\x01\n" +
	"\bCitation\x12\x1f\n" +
	"\vstart_index\x18\x01 \x01(\x03R\n" +
	"startIndex\x12\x1b\n" +
	"\tend_index\x18\x02 \x01(\x03R\bendIndex\x12T\n" +
	"\asources\x18\x03 \x03(\v2:.google.cloud.discoveryengine.v1beta.Answer.CitationSourceR\asources\x1a3\n" +
	"\x0eCitationSource\x12!\n" +
	"\freference_id\x18\x01 \x01(\tR\vreferenceId\x1a\xd3\x02\n" +
	...
	"\x18grounding_check_required\x18\x04 \x01(\bH\x01R\x16groundingCheckRequired\x88\x01\x01\x12Y\n" +
	"\asources\x18\x05 \x03(\v2:.google.cloud.discoveryengine.v1beta.Answer.CitationSourceB\x03\xe0A\x01R\asourcesB\x12\n" +
	"\x10_grounding_scoreB\x1b\n" +
	"\x19_grounding_check_required\x1a\xd7\r\n" +
	"\tReference\x12\x8e\x01\n" +
	"\x1aunstructured_document_info\x18\x01 \x01(\v2N.google.cloud.discoveryengine.v1beta.Answer.Reference.UnstructuredDocumentInfoH\x00R\x18unstructuredDocumentInfo\x12`\n" +
	"\n" +
	"chunk_info\x18\x02 \x01(\v2?.google.cloud.discoveryengine.v1beta.Answer.Reference.ChunkInfoH\x00R\tchunkInfo\x12\x88\x01\n" +
	"\x18structured_document_info\x18\x03 \x01(\v2L.google.cloud.discoveryengine.v1beta.Answer.Reference.StructuredDocumentInfoH\x00R\x16structuredDocumentInfo\x1a\x9e\x04\n" +
	...
	"\x05title\x18\x03 \x01(\tR\x05title\x12\x82\x01\n" +
	"\x0echunk_contents\x18\x04 \x03(\v2[.google.cloud.discoveryengine.v1beta.Answer.Reference.UnstructuredDocumentInfo.ChunkContentR\rchunkContents\x128\n" +
	"\vstruct_data\x18\x05 \x01(\v2\x17.google.protobuf.StructR\n" +
	"structData\x1a\xd0\x01\n" +
	"\fChunkContent\x12\x18\n" +
	"\acontent\x18\x01 \x01(\tR\acontent\x12'\n" +
	"\x0fpage_identifier\x18\x02 \x01(\tR\x0epageIdentifier\x12,\n" +
	"\x0frelevance_score\x18\x03 \x01(\x02H\x00R\x0erelevanceScore\x88\x01\x01\x12;\n" +
	"\x17blob_attachment_indexes\x18\x04 \x03(\x03B\x03\xe0A\x03R\x15blobAttachmentIndexesB\x12\n" +
	"\x10_relevance_score\x1a\xce\x04\n" +
	"\tChunkInfo\x12?\n" +
	"\x05chunk\x18\x01 \x01(\tB)\xfaA&\n" +
	"$discoveryengine.googleapis.com/ChunkR\x05chunk\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontent\x12,\n" +
	"\x0frelevance_score\x18\x03 \x01(\x02H\x00R\x0erelevanceScore\x88\x01\x01\x12}\n" +
	"\x11document_metadata\x18\x04 \x01(\v2P.google.cloud.discoveryengine.v1beta.Answer.Reference.ChunkInfo.DocumentMetadataR\x10documentMetadata\x12;\n" +
	"\x17blob_attachment_indexes\x18\x05 \x03(\x03B\x03\xe0A\x03R\x15blobAttachmentIndexes\x1a\xe7\x01\n" +
	...
	"\acontent\x1a\xf9\x02\n" +
	"\x0eBlobAttachment\x12X\n" +
	"\x04data\x18\x01 \x01(\v2?.google.cloud.discoveryengine.v1beta.Answer.BlobAttachment.BlobB\x03\xe0A\x03R\x04data\x12z\n" +
	"\x10attribution_type\x18\x02 \x01(\x0e2J.google.cloud.discoveryengine.v1beta.Answer.BlobAttachment.AttributionTypeB\x03\xe0A\x03R\x0fattributionType\x1aA\n" +
	"\x04Blob\x12 \n" +
	...
	"\tGENERATED\x10\x02\x1a\xa1\n" +
	"\n" +
	"\x04Step\x12L\n" +
	"\x05state\x18\x01 \x01(\x0e26.google.cloud.discoveryengine.v1beta.Answer.Step.StateR\x05state\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x18\n" +
	"\athought\x18\x03 \x01(\tR\athought\x12Q\n" +
	"\aactions\x18\x04 \x03(\v27.google.cloud.discoveryengine.v1beta.Answer.Step.ActionR\aactions\x1a\xef\a\n" +
	"\x06Action\x12k\n" +
	"\rsearch_action\x18\x02 \x01(\v2D.google.cloud.discoveryengine.v1beta.Answer.Step.Action.SearchActionH\x00R\fsearchAction\x12e\n" +
	"\vobservation\x18\x03 \x01(\v2C.google.cloud.discoveryengine.v1beta.Answer.Step.Action.ObservationR\vobservation\x1a$\n" +
	"\fSearchAction\x12\x14\n" +
	"\x05query\x18\x01 \x01(\tR\x05query\x1a\xe0\x05\n" +
	"\vObservation\x12w\n" +
	"\x0esearch_results\x18\x02 \x03(\v2P.google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.SearchResultR\rsearchResults\x1a\xd7\x04\n" +
	"\fSearchResult\x12\x1a\n" +
	"\bdocument\x18\x01 \x01(\tR\bdocument\x12\x10\n" +
	"\x03uri\x18\x02 \x01(\tR\x03uri\x12\x14\n" +
	"\x05title\x18\x03 \x01(\tR\x05title\x12\x7f\n" +
	"\fsnippet_info\x18\x04 \x03(\v2\\.google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.SearchResult.SnippetInfoR\vsnippetInfo\x12y\n" +
	"\n" +
	"chunk_info\x18\x05 \x03(\v2Z.google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.SearchResult.ChunkInfoR\tchunkInfo\x128\n" +
	...
	"\tSUCCEEDED\x10\x03\x1a\x93\x04\n" +
	"\x16QueryUnderstandingInfo\x12\x96\x01\n" +
	"\x19query_classification_info\x18\x01 \x03(\v2Z.google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfo.QueryClassificationInfoR\x17queryClassificationInfo\x1a\xdf\x02\n" +
	"\x17QueryClassificationInfo\x12s\n" +
	"\x04type\x18\x01 \x01(\x0e2_.google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfo.QueryClassificationInfo.TypeR\x04type\x12\x1a\n" +
...
func file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_answer_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_answer_proto_rawDesc)))
	})
	return file_google_cloud_discoveryengine_v1beta_answer_proto_rawDescData
}

var file_google_cloud_discoveryengine_v1beta_answer_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_google_cloud_discoveryengine_v1beta_answer_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_google_cloud_discoveryengine_v1beta_answer_proto_goTypes = []any{
	...
	(Answer_BlobAttachment_AttributionType)(0),                      // 2: google.cloud.discoveryengine.v1beta.Answer.BlobAttachment.AttributionType
	(Answer_Step_State)(0),                                          // 3: google.cloud.discoveryengine.v1beta.Answer.Step.State
	(Answer_QueryUnderstandingInfo_QueryClassificationInfo_Type)(0), // 4: google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfo.QueryClassificationInfo.Type
	(*Answer)(nil),                                                  // 5: google.cloud.discoveryengine.v1beta.Answer
	(*Answer_Citation)(nil),                                         // 6: google.cloud.discoveryengine.v1beta.Answer.Citation
	(*Answer_CitationSource)(nil),                                   // 7: google.cloud.discoveryengine.v1beta.Answer.CitationSource
	(*Answer_GroundingSupport)(nil),                                 // 8: google.cloud.discoveryengine.v1beta.Answer.GroundingSupport
	(*Answer_Reference)(nil),                                        // 9: google.cloud.discoveryengine.v1beta.Answer.Reference
	(*Answer_BlobAttachment)(nil),                                   // 10: google.cloud.discoveryengine.v1beta.Answer.BlobAttachment
	(*Answer_Step)(nil),                                             // 11: google.cloud.discoveryengine.v1beta.Answer.Step
	(*Answer_QueryUnderstandingInfo)(nil),                           // 12: google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfo
	(*Answer_Reference_UnstructuredDocumentInfo)(nil),               // 13: google.cloud.discoveryengine.v1beta.Answer.Reference.UnstructuredDocumentInfo
	(*Answer_Reference_ChunkInfo)(nil),                              // 14: google.cloud.discoveryengine.v1beta.Answer.Reference.ChunkInfo
	(*Answer_Reference_StructuredDocumentInfo)(nil),                 // 15: google.cloud.discoveryengine.v1beta.Answer.Reference.StructuredDocumentInfo
	(*Answer_Reference_UnstructuredDocumentInfo_ChunkContent)(nil),  // 16: google.cloud.discoveryengine.v1beta.Answer.Reference.UnstructuredDocumentInfo.ChunkContent
	(*Answer_Reference_ChunkInfo_DocumentMetadata)(nil),             // 17: google.cloud.discoveryengine.v1beta.Answer.Reference.ChunkInfo.DocumentMetadata
	(*Answer_BlobAttachment_Blob)(nil),                              // 18: google.cloud.discoveryengine.v1beta.Answer.BlobAttachment.Blob
	(*Answer_Step_Action)(nil),                                      // 19: google.cloud.discoveryengine.v1beta.Answer.Step.Action
	(*Answer_Step_Action_SearchAction)(nil),                         // 20: google.cloud.discoveryengine.v1beta.Answer.Step.Action.SearchAction
	(*Answer_Step_Action_Observation)(nil),                          // 21: google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation
	(*Answer_Step_Action_Observation_SearchResult)(nil),             // 22: google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.SearchResult
	(*Answer_Step_Action_Observation_SearchResult_SnippetInfo)(nil), // 23: google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.SearchResult.SnippetInfo
	(*Answer_Step_Action_Observation_SearchResult_ChunkInfo)(nil),   // 24: google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.SearchResult.ChunkInfo
	(*Answer_QueryUnderstandingInfo_QueryClassificationInfo)(nil),   // 25: google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfo.QueryClassificationInfo
	(*timestamppb.Timestamp)(nil),                                   // 26: google.protobuf.Timestamp
	(*SafetyRating)(nil),                                            // 27: google.cloud.discoveryengine.v1beta.SafetyRating
...
var file_google_cloud_discoveryengine_v1beta_answer_proto_depIdxs = []int32{
	...
	6,  // 1: google.cloud.discoveryengine.v1beta.Answer.citations:type_name -> google.cloud.discoveryengine.v1beta.Answer.Citation
	8,  // 2: google.cloud.discoveryengine.v1beta.Answer.grounding_supports:type_name -> google.cloud.discoveryengine.v1beta.Answer.GroundingSupport
	9,  // 3: google.cloud.discoveryengine.v1beta.Answer.references:type_name -> google.cloud.discoveryengine.v1beta.Answer.Reference
	10, // 4: google.cloud.discoveryengine.v1beta.Answer.blob_attachments:type_name -> google.cloud.discoveryengine.v1beta.Answer.BlobAttachment
	11, // 5: google.cloud.discoveryengine.v1beta.Answer.steps:type_name -> google.cloud.discoveryengine.v1beta.Answer.Step
	12, // 6: google.cloud.discoveryengine.v1beta.Answer.query_understanding_info:type_name -> google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfo
	1,  // 7: google.cloud.discoveryengine.v1beta.Answer.answer_skipped_reasons:type_name -> google.cloud.discoveryengine.v1beta.Answer.AnswerSkippedReason
	26, // 8: google.cloud.discoveryengine.v1beta.Answer.create_time:type_name -> google.protobuf.Timestamp
	26, // 9: google.cloud.discoveryengine.v1beta.Answer.complete_time:type_name -> google.protobuf.Timestamp
	27, // 10: google.cloud.discoveryengine.v1beta.Answer.safety_ratings:type_name -> google.cloud.discoveryengine.v1beta.SafetyRating
	7,  // 11: google.cloud.discoveryengine.v1beta.Answer.Citation.sources:type_name -> google.cloud.discoveryengine.v1beta.Answer.CitationSource
	7,  // 12: google.cloud.discoveryengine.v1beta.Answer.GroundingSupport.sources:type_name -> google.cloud.discoveryengine.v1beta.Answer.CitationSource
	13, // 13: google.cloud.discoveryengine.v1beta.Answer.Reference.unstructured_document_info:type_name -> google.cloud.discoveryengine.v1beta.Answer.Reference.UnstructuredDocumentInfo
	14, // 14: google.cloud.discoveryengine.v1beta.Answer.Reference.chunk_info:type_name -> google.cloud.discoveryengine.v1beta.Answer.Reference.ChunkInfo
	15, // 15: google.cloud.discoveryengine.v1beta.Answer.Reference.structured_document_info:type_name -> google.cloud.discoveryengine.v1beta.Answer.Reference.StructuredDocumentInfo
	18, // 16: google.cloud.discoveryengine.v1beta.Answer.BlobAttachment.data:type_name -> google.cloud.discoveryengine.v1beta.Answer.BlobAttachment.Blob
	2,  // 17: google.cloud.discoveryengine.v1beta.Answer.BlobAttachment.attribution_type:type_name -> google.cloud.discoveryengine.v1beta.Answer.BlobAttachment.AttributionType
	3,  // 18: google.cloud.discoveryengine.v1beta.Answer.Step.state:type_name -> google.cloud.discoveryengine.v1beta.Answer.Step.State
	19, // 19: google.cloud.discoveryengine.v1beta.Answer.Step.actions:type_name -> google.cloud.discoveryengine.v1beta.Answer.Step.Action
	25, // 20: google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfo.query_classification_info:type_name -> google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfo.QueryClassificationInfo
	16, // 21: google.cloud.discoveryengine.v1beta.Answer.Reference.UnstructuredDocumentInfo.chunk_contents:type_name -> google.cloud.discoveryengine.v1beta.Answer.Reference.UnstructuredDocumentInfo.ChunkContent
	28, // 22: google.cloud.discoveryengine.v1beta.Answer.Reference.UnstructuredDocumentInfo.struct_data:type_name -> google.protobuf.Struct
	17, // 23: google.cloud.discoveryengine.v1beta.Answer.Reference.ChunkInfo.document_metadata:type_name -> google.cloud.discoveryengine.v1beta.Answer.Reference.ChunkInfo.DocumentMetadata
	28, // 24: google.cloud.discoveryengine.v1beta.Answer.Reference.StructuredDocumentInfo.struct_data:type_name -> google.protobuf.Struct
	28, // 25: google.cloud.discoveryengine.v1beta.Answer.Reference.ChunkInfo.DocumentMetadata.struct_data:type_name -> google.protobuf.Struct
	20, // 26: google.cloud.discoveryengine.v1beta.Answer.Step.Action.search_action:type_name -> google.cloud.discoveryengine.v1beta.Answer.Step.Action.SearchAction
	21, // 27: google.cloud.discoveryengine.v1beta.Answer.Step.Action.observation:type_name -> google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation
	22, // 28: google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.search_results:type_name -> google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.SearchResult
	23, // 29: google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.SearchResult.snippet_info:type_name -> google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.SearchResult.SnippetInfo
	24, // 30: google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.SearchResult.chunk_info:type_name -> google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.SearchResult.ChunkInfo
	28, // 31: google.cloud.discoveryengine.v1beta.Answer.Step.Action.Observation.SearchResult.struct_data:type_name -> google.protobuf.Struct
	4,  // 32: google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfo.QueryClassificationInfo.type:type_name -> google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfo.QueryClassificationInfo.Type
...
func file_google_cloud_discoveryengine_v1beta_answer_proto_init() {
	...
	file_google_cloud_discoveryengine_v1beta_answer_proto_msgTypes[0].OneofWrappers = []any{}
	file_google_cloud_discoveryengine_v1beta_answer_proto_msgTypes[3].OneofWrappers = []any{}
	file_google_cloud_discoveryengine_v1beta_answer_proto_msgTypes[4].OneofWrappers = []any{
	...
	file_google_cloud_discoveryengine_v1beta_answer_proto_msgTypes[14].OneofWrappers = []any{
		(*Answer_Step_Action_SearchAction_)(nil),
	}
	file_google_cloud_discoveryengine_v1beta_answer_proto_msgTypes[19].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_answer_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_answer_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   21,
			NumExtensions: 0,
			NumServices:   0,
