...
const file_google_cloud_discoveryengine_v1beta_sample_query_service_proto_rawDesc = "" +
	...
	"\x04name\x18\x01 \x01(\tB2\xe0A\x02\xfaA,\n" +
	"*discoveryengine.googleapis.com/SampleQueryR\x04name2\xe9\r\n" +
