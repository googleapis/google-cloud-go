...
type UserEvent struct {
	...
	Feedback *Feedback `protobuf:"bytes,23,opt,name=feedback,proto3" json:"feedback,omitempty"`
	...
	// prediction results.
	Entity        string `protobuf:"bytes,25,opt,name=entity,proto3" json:"entity,omitempty"`
...
func (x *UserEvent) GetFeedback() *Feedback {
	if x != nil {
		return x.Feedback
	}
	return nil
...
const file_google_cloud_discoveryengine_v1beta_user_event_proto_rawDesc = "" +
	"\n" +
	"4google/cloud/discoveryengine/v1beta/user_event.proto\x12#google.cloud.discoveryengine.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a0google/cloud/discoveryengine/v1beta/common.proto\x1a2google/cloud/discoveryengine/v1beta/feedback.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xca\f\n" +
	"\tUserEvent\x12\"\n" +
	"\n" +
	...
	"\x11attribution_token\x18\b \x01(\tR\x10attributionToken\x12\x1b\n" +
	"\x06filter\x18\t \x01(\tB\x03\xe0A\x01R\x06filter\x12O\n" +
	"\tdocuments\x18\n" +
	...
	"\x06panels\x18\x16 \x03(\v2..google.cloud.discoveryengine.v1beta.PanelInfoB\x03\xe0A\x01R\x06panels\x12N\n" +
	"\bfeedback\x18\x17 \x01(\v2-.google.cloud.discoveryengine.v1beta.FeedbackB\x03\xe0A\x01R\bfeedback\x12\x1b\n" +
	"\x06entity\x18\x19 \x01(\tB\x03\xe0A\x01R\x06entity\x1as\n" +
...
var file_google_cloud_discoveryengine_v1beta_user_event_proto_goTypes = []any{
	...
	(*Feedback)(nil),              // 11: google.cloud.discoveryengine.v1beta.Feedback
	(*durationpb.Duration)(nil),   // 12: google.protobuf.Duration
	(*CustomAttribute)(nil),       // 13: google.cloud.discoveryengine.v1beta.CustomAttribute
}
var file_google_cloud_discoveryengine_v1beta_user_event_proto_depIdxs = []int32{
	...
	11, // 11: google.cloud.discoveryengine.v1beta.UserEvent.feedback:type_name -> google.cloud.discoveryengine.v1beta.Feedback
	5,  // 12: google.cloud.discoveryengine.v1beta.PanelInfo.documents:type_name -> google.cloud.discoveryengine.v1beta.DocumentInfo
	12, // 13: google.cloud.discoveryengine.v1beta.MediaInfo.media_progress_duration:type_name -> google.protobuf.Duration
	13, // 14: google.cloud.discoveryengine.v1beta.UserEvent.AttributesEntry.value:type_name -> google.cloud.discoveryengine.v1beta.CustomAttribute
...
func file_google_cloud_discoveryengine_v1beta_user_event_proto_init() {
	...
	file_google_cloud_discoveryengine_v1beta_feedback_proto_init()
