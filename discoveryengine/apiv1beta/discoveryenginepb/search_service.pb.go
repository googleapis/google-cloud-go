...
const (
	...
	SearchRequest_BYOE SearchRequest_RankingExpressionBackend = 1
	// Deprecated: Use `RANK_BY_FORMULA` instead.
	// Ranking by custom formula. Legacy enum option, `RANK_BY_FORMULA` should
	// be used instead.
	//
	// Deprecated: Marked as deprecated in google/cloud/discoveryengine/v1beta/search_service.proto.
	SearchRequest_CLEARBOX SearchRequest_RankingExpressionBackend = 2
	// Ranking by custom embedding model, the default way to evaluate the
	// ranking expression.
...
type SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource int32

const (
	// Unspecified image source (multimodal feature is disabled by
	// default).
	SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_IMAGE_SOURCE_UNSPECIFIED SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource = 0
	// Behavior when service determines the pick from all available
	// sources.
	SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ALL_AVAILABLE_SOURCES SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource = 1
	// Includes image from corpus in the answer.
	SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_CORPUS_IMAGE_ONLY SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource = 2
	// Triggers figure generation in the answer.
	SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_FIGURE_GENERATION_ONLY SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource = 3
)

// Enum value maps for SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource.
var (
	SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource_name = map[int32]string{
		0: "IMAGE_SOURCE_UNSPECIFIED",
		1: "ALL_AVAILABLE_SOURCES",
		2: "CORPUS_IMAGE_ONLY",
		3: "FIGURE_GENERATION_ONLY",
	}
	SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource_value = map[string]int32{
...
func (x SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource) Enum() *SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource {
	p := new(SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource)
	*p = x
	return p
}

func (x SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[7].Descriptor()
}

func (SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource) Type() protoreflect.EnumType {
	return &file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[7]
}

func (x SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource.Descriptor instead.
func (SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{0, 6, 1, 0, 0}
}
...
type SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior int32
...
const (
	...
	SearchRequest_NaturalLanguageQueryUnderstandingSpec_EXTRACTED_FILTER_BEHAVIOR_UNSPECIFIED SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior = 0
	...
	// result set.
	SearchRequest_NaturalLanguageQueryUnderstandingSpec_HARD_FILTER SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior = 1
	...
	SearchRequest_NaturalLanguageQueryUnderstandingSpec_SOFT_BOOST SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior = 2
)

// Enum value maps for SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior.
var (
	SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior_name = map[int32]string{
		0: "EXTRACTED_FILTER_BEHAVIOR_UNSPECIFIED",
		1: "HARD_FILTER",
		2: "SOFT_BOOST",
	}
	SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior_value = map[string]int32{
...
func (x SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior) Enum() *SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior {
	p := new(SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior)
	*p = x
	return p
}

func (x SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[9].Descriptor()
}

func (SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior) Type() protoreflect.EnumType {
	return &file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[9]
}

func (x SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior.Descriptor instead.
func (SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{0, 8, 1}
}
...
func (SearchRequest_DisplaySpec_MatchHighlightingCondition) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{0, 10, 0}
}

// Enum describing the mode to use for documents that are crowded away.
// They can be dropped or demoted to the later pages.
type SearchRequest_CrowdingSpec_Mode int32
...
const (
	...
	SearchRequest_CrowdingSpec_MODE_UNSPECIFIED SearchRequest_CrowdingSpec_Mode = 0
	// Drop crowded results.
	SearchRequest_CrowdingSpec_DROP_CROWDED_RESULTS SearchRequest_CrowdingSpec_Mode = 1
	// Demote crowded results to the later pages.
	SearchRequest_CrowdingSpec_DEMOTE_CROWDED_RESULTS_TO_END SearchRequest_CrowdingSpec_Mode = 2
)

// Enum value maps for SearchRequest_CrowdingSpec_Mode.
var (
	SearchRequest_CrowdingSpec_Mode_name = map[int32]string{
		0: "MODE_UNSPECIFIED",
		1: "DROP_CROWDED_RESULTS",
		2: "DEMOTE_CROWDED_RESULTS_TO_END",
	}
	SearchRequest_CrowdingSpec_Mode_value = map[string]int32{
		"MODE_UNSPECIFIED":              0,
...
func (x SearchRequest_CrowdingSpec_Mode) Enum() *SearchRequest_CrowdingSpec_Mode {
	p := new(SearchRequest_CrowdingSpec_Mode)
	*p = x
	return p
}

func (x SearchRequest_CrowdingSpec_Mode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SearchRequest_CrowdingSpec_Mode) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[12].Descriptor()
}

func (SearchRequest_CrowdingSpec_Mode) Type() protoreflect.EnumType {
	return &file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[12]
}

func (x SearchRequest_CrowdingSpec_Mode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SearchRequest_CrowdingSpec_Mode.Descriptor instead.
func (SearchRequest_CrowdingSpec_Mode) EnumDescriptor() ([]byte, []int) {
...
func (SearchRequest_PersonalizationSpec_Mode) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[13].Descriptor()
}

func (SearchRequest_PersonalizationSpec_Mode) Type() protoreflect.EnumType {
	return &file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[13]
}
...
func (SearchRequest_PersonalizationSpec_Mode) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{0, 14, 0}
}

// Semantic state of the search response.
type SearchResponse_SemanticState int32

const (
	// Default value. Should not be used.
	SearchResponse_SEMANTIC_STATE_UNSPECIFIED SearchResponse_SemanticState = 0
	// Semantic search was disabled for this search response.
	SearchResponse_DISABLED SearchResponse_SemanticState = 1
	// Semantic search was enabled for this search response.
	SearchResponse_ENABLED SearchResponse_SemanticState = 2
)

// Enum value maps for SearchResponse_SemanticState.
var (
	SearchResponse_SemanticState_name = map[int32]string{
		0: "SEMANTIC_STATE_UNSPECIFIED",
		1: "DISABLED",
		2: "ENABLED",
	}
	SearchResponse_SemanticState_value = map[string]int32{
...
func (x SearchResponse_SemanticState) Enum() *SearchResponse_SemanticState {
	p := new(SearchResponse_SemanticState)
	*p = x
	return p
}

func (x SearchResponse_SemanticState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SearchResponse_SemanticState) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[14].Descriptor()
}

func (SearchResponse_SemanticState) Type() protoreflect.EnumType {
	return &file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[14]
}

func (x SearchResponse_SemanticState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SearchResponse_SemanticState.Descriptor instead.
func (SearchResponse_SemanticState) EnumDescriptor() ([]byte, []int) {
...
func (SearchResponse_Summary_SummarySkippedReason) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[15].Descriptor()
}

func (SearchResponse_Summary_SummarySkippedReason) Type() protoreflect.EnumType {
	return &file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[15]
}
...
type SearchResponse_Summary_BlobAttachment_AttributionType int32

const (
	// Unspecified attribution type.
	SearchResponse_Summary_BlobAttachment_ATTRIBUTION_TYPE_UNSPECIFIED SearchResponse_Summary_BlobAttachment_AttributionType = 0
	// The attachment data is from the corpus.
	SearchResponse_Summary_BlobAttachment_CORPUS SearchResponse_Summary_BlobAttachment_AttributionType = 1
	// The attachment data is generated by the model through code
	// generation.
	SearchResponse_Summary_BlobAttachment_GENERATED SearchResponse_Summary_BlobAttachment_AttributionType = 2
)

// Enum value maps for SearchResponse_Summary_BlobAttachment_AttributionType.
var (
	SearchResponse_Summary_BlobAttachment_AttributionType_name = map[int32]string{
		0: "ATTRIBUTION_TYPE_UNSPECIFIED",
		1: "CORPUS",
		2: "GENERATED",
	}
	SearchResponse_Summary_BlobAttachment_AttributionType_value = map[string]int32{
...
func (x SearchResponse_Summary_BlobAttachment_AttributionType) Enum() *SearchResponse_Summary_BlobAttachment_AttributionType {
	p := new(SearchResponse_Summary_BlobAttachment_AttributionType)
	*p = x
	return p
}

func (x SearchResponse_Summary_BlobAttachment_AttributionType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SearchResponse_Summary_BlobAttachment_AttributionType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[16].Descriptor()
}

func (SearchResponse_Summary_BlobAttachment_AttributionType) Type() protoreflect.EnumType {
	return &file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[16]
}

func (x SearchResponse_Summary_BlobAttachment_AttributionType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SearchResponse_Summary_BlobAttachment_AttributionType.Descriptor instead.
func (SearchResponse_Summary_BlobAttachment_AttributionType) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{1, 3, 5, 0}
}
...
func (SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_NumberConstraint_Comparison) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[17].Descriptor()
}
...
func (SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_NumberConstraint_Comparison) Type() protoreflect.EnumType {
	return &file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[17]
}
...
func (SearchResponse_OneBoxResult_OneBoxType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[18].Descriptor()
}

func (SearchResponse_OneBoxResult_OneBoxType) Type() protoreflect.EnumType {
	return &file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes[18]
}
...
type SearchRequest struct {
	...
	// > Founders Edition`
	PageCategories []string `protobuf:"bytes,63,rep,name=page_categories,json=pageCategories,proto3" json:"page_categories,omitempty"`
	// Raw image query.
	...
	// removed or demoted.
	CrowdingSpecs []*SearchRequest_CrowdingSpec `protobuf:"bytes,40,rep,name=crowding_specs,json=crowdingSpecs,proto3" json:"crowding_specs,omitempty"`
...
func (x *SearchRequest) GetCrowdingSpecs() []*SearchRequest_CrowdingSpec {
	if x != nil {
		return x.CrowdingSpecs
	}
	return nil
}
...
func (x *SearchRequest) GetRelevanceFilterSpec() *SearchRequest_RelevanceFilterSpec {
	if x != nil {
		return x.RelevanceFilterSpec
	}
	return nil
}
...
type SearchResponse struct {
	...
	SuggestedQuery string `protobuf:"bytes,24,opt,name=suggested_query,json=suggestedQuery,proto3" json:"suggested_query,omitempty"`
	...
	SemanticState SearchResponse_SemanticState `protobuf:"varint,36,opt,name=semantic_state,json=semanticState,proto3,enum=google.cloud.discoveryengine.v1beta.SearchResponse_SemanticState" json:"semantic_state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SearchResponse) GetSemanticState() SearchResponse_SemanticState {
	if x != nil {
		return x.SemanticState
	}
	return SearchResponse_SEMANTIC_STATE_UNSPECIFIED
}
...
type SearchRequest_NaturalLanguageQueryUnderstandingSpec struct {
	...
	ExtractedFilterBehavior SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior `protobuf:"varint,3,opt,name=extracted_filter_behavior,json=extractedFilterBehavior,proto3,enum=google.cloud.discoveryengine.v1beta.SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior" json:"extracted_filter_behavior,omitempty"`
	...
	AllowedFieldNames []string `protobuf:"bytes,4,rep,name=allowed_field_names,json=allowedFieldNames,proto3" json:"allowed_field_names,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *SearchRequest_NaturalLanguageQueryUnderstandingSpec) GetExtractedFilterBehavior() SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior {
	if x != nil {
		return x.ExtractedFilterBehavior
	}
	return SearchRequest_NaturalLanguageQueryUnderstandingSpec_EXTRACTED_FILTER_BEHAVIOR_UNSPECIFIED
}

func (x *SearchRequest_NaturalLanguageQueryUnderstandingSpec) GetAllowedFieldNames() []string {
	if x != nil {
		return x.AllowedFieldNames
	}
	return nil
}
...
type SearchRequest_DisplaySpec struct {
	...
	MatchHighlightingCondition SearchRequest_DisplaySpec_MatchHighlightingCondition `protobuf:"varint,1,opt,name=match_highlighting_condition,json=matchHighlightingCondition,proto3,enum=google.cloud.discoveryengine.v1beta.SearchRequest_DisplaySpec_MatchHighlightingCondition" json:"match_highlighting_condition,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
// across all pages.
type SearchRequest_CrowdingSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	Mode          SearchRequest_CrowdingSpec_Mode `protobuf:"varint,3,opt,name=mode,proto3,enum=google.cloud.discoveryengine.v1beta.SearchRequest_CrowdingSpec_Mode" json:"mode,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SearchRequest_CrowdingSpec) Reset() {
	*x = SearchRequest_CrowdingSpec{}
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SearchRequest_CrowdingSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SearchRequest_CrowdingSpec) ProtoMessage() {}

func (x *SearchRequest_CrowdingSpec) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SearchRequest_CrowdingSpec.ProtoReflect.Descriptor instead.
func (*SearchRequest_CrowdingSpec) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{0, 11}
}

func (x *SearchRequest_CrowdingSpec) GetField() string {
	if x != nil {
		return x.Field
	}
	return ""
...
func (x *SearchRequest_CrowdingSpec) GetMaxCount() int32 {
	if x != nil {
		return x.MaxCount
	}
	return 0
...
func (x *SearchRequest_CrowdingSpec) GetMode() SearchRequest_CrowdingSpec_Mode {
	if x != nil {
		return x.Mode
	}
	return SearchRequest_CrowdingSpec_MODE_UNSPECIFIED
}
...
func (*SearchRequest_SessionSpec) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{0, 12}
}
...
type SearchRequest_RelevanceFilterSpec struct {
	...
	KeywordSearchThreshold *SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec `protobuf:"bytes,1,opt,name=keyword_search_threshold,json=keywordSearchThreshold,proto3" json:"keyword_search_threshold,omitempty"`
	// Optional. Relevance filtering threshold specification for semantic
	// search.
	SemanticSearchThreshold *SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec `protobuf:"bytes,2,opt,name=semantic_search_threshold,json=semanticSearchThreshold,proto3" json:"semantic_search_threshold,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *SearchRequest_RelevanceFilterSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*SearchRequest_RelevanceFilterSpec) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{0, 13}
}
...
func (x *SearchRequest_RelevanceFilterSpec) GetKeywordSearchThreshold() *SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec {
	if x != nil {
		return x.KeywordSearchThreshold
	}
	return nil
}
...
func (*SearchRequest_PersonalizationSpec) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{0, 14}
}
...
func (*SearchRequest_RelevanceScoreSpec) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{0, 15}
}
...
func (*SearchRequest_SearchAddonSpec) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{0, 16}
}
...
func (*SearchRequest_CustomRankingParams) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{0, 17}
}
...
type SearchRequest_ContentSearchSpec_SummarySpec struct {
	...
	MultimodalSpec *SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec `protobuf:"bytes,11,opt,name=multimodal_spec,json=multimodalSpec,proto3" json:"multimodal_spec,omitempty"`
...
func (x *SearchRequest_ContentSearchSpec_SummarySpec) GetMultimodalSpec() *SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec {
	if x != nil {
...
type SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec struct {
	...
	ImageSource   SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource `protobuf:"varint,3,opt,name=image_source,json=imageSource,proto3,enum=google.cloud.discoveryengine.v1beta.SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource" json:"image_source,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec) Reset() {
	*x = SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec{}
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec) ProtoMessage() {}

func (x *SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[30]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec.ProtoReflect.Descriptor instead.
func (*SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{0, 6, 1, 0}
}

func (x *SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec) GetImageSource() SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource {
	if x != nil {
		return x.ImageSource
	}
	return SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_IMAGE_SOURCE_UNSPECIFIED
}
...
func (*SearchRequest_ContentSearchSpec_SummarySpec_ModelSpec) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{0, 6, 1, 2}
}
...
type SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec struct {
	...
	//
	// Types that are valid to be assigned to RelevanceThresholdSpec:
	//
	//	*SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec_RelevanceThreshold
	//	*SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec_SemanticRelevanceThreshold
	RelevanceThresholdSpec isSearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec_RelevanceThresholdSpec `protobuf_oneof:"relevance_threshold_spec"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{0, 13, 0}
}
...
func (x *SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec) GetRelevanceThresholdSpec() isSearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec_RelevanceThresholdSpec {
	if x != nil {
		return x.RelevanceThresholdSpec
	}
	return nil
}

func (x *SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec) GetRelevanceThreshold() SearchRequest_RelevanceThreshold {
	if x != nil {
		if x, ok := x.RelevanceThresholdSpec.(*SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec_RelevanceThreshold); ok {
			return x.RelevanceThreshold
		}
	}
	return SearchRequest_RELEVANCE_THRESHOLD_UNSPECIFIED
...
func (x *SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec) GetSemanticRelevanceThreshold() float32 {
	if x != nil {
		if x, ok := x.RelevanceThresholdSpec.(*SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec_SemanticRelevanceThreshold); ok {
			return x.SemanticRelevanceThreshold
		}
	}
	return 0
}

type isSearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec_RelevanceThresholdSpec interface {
	isSearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec_RelevanceThresholdSpec()
}

type SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec_RelevanceThreshold struct {
	// Pre-defined relevance threshold for the sub-search.
	RelevanceThreshold SearchRequest_RelevanceThreshold `protobuf:"varint,1,opt,name=relevance_threshold,json=relevanceThreshold,proto3,enum=google.cloud.discoveryengine.v1beta.SearchRequest_RelevanceThreshold,oneof"`
}

type SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec_SemanticRelevanceThreshold struct {
	// Custom relevance threshold for the sub-search.
	// The value must be in [0.0, 1.0].
	SemanticRelevanceThreshold float32 `protobuf:"fixed32,2,opt,name=semantic_relevance_threshold,json=semanticRelevanceThreshold,proto3,oneof"`
}

func (*SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec_RelevanceThreshold) isSearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec_RelevanceThresholdSpec() {
}

func (*SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec_SemanticRelevanceThreshold) isSearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec_RelevanceThresholdSpec() {
}
...
type SearchResponse_NaturalLanguageQueryUnderstandingInfo struct {
	...
	ClassifiedIntents []string `protobuf:"bytes,5,rep,name=classified_intents,json=classifiedIntents,proto3" json:"classified_intents,omitempty"`
...
func (x *SearchResponse_NaturalLanguageQueryUnderstandingInfo) GetClassifiedIntents() []string {
	if x != nil {
		return x.ClassifiedIntents
	}
	return nil
}
...
func (*SearchResponse_SearchResult_RankSignals) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{1, 0, 0}
}
...
func (*SearchResponse_SearchResult_RankSignals_CustomSignal) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{1, 0, 0, 0}
}
...
type SearchResponse_Summary_BlobAttachment struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Output only. The blob data.
	Data *SearchResponse_Summary_BlobAttachment_Blob `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
	// Output only. The attribution type of the blob.
	AttributionType SearchResponse_Summary_BlobAttachment_AttributionType `protobuf:"varint,2,opt,name=attribution_type,json=attributionType,proto3,enum=google.cloud.discoveryengine.v1beta.SearchResponse_Summary_BlobAttachment_AttributionType" json:"attribution_type,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *SearchResponse_Summary_BlobAttachment) Reset() {
	*x = SearchResponse_Summary_BlobAttachment{}
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[54]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SearchResponse_Summary_BlobAttachment) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SearchResponse_Summary_BlobAttachment) ProtoMessage() {}

func (x *SearchResponse_Summary_BlobAttachment) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[54]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SearchResponse_Summary_BlobAttachment.ProtoReflect.Descriptor instead.
func (*SearchResponse_Summary_BlobAttachment) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{1, 3, 5}
}

func (x *SearchResponse_Summary_BlobAttachment) GetData() *SearchResponse_Summary_BlobAttachment_Blob {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *SearchResponse_Summary_BlobAttachment) GetAttributionType() SearchResponse_Summary_BlobAttachment_AttributionType {
	if x != nil {
		return x.AttributionType
	}
	return SearchResponse_Summary_BlobAttachment_ATTRIBUTION_TYPE_UNSPECIFIED
}
...
type SearchResponse_Summary_SummaryWithMetadata struct {
	...
	BlobAttachments []*SearchResponse_Summary_BlobAttachment `protobuf:"bytes,4,rep,name=blob_attachments,json=blobAttachments,proto3" json:"blob_attachments,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *SearchResponse_Summary_SummaryWithMetadata) Reset() {
	*x = SearchResponse_Summary_SummaryWithMetadata{}
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[55]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SearchResponse_Summary_SummaryWithMetadata) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{1, 3, 6}
}
...
func (x *SearchResponse_Summary_SummaryWithMetadata) GetBlobAttachments() []*SearchResponse_Summary_BlobAttachment {
	if x != nil {
		return x.BlobAttachments
	}
	return nil
}
...
type SearchResponse_Summary_Reference_ChunkContent struct {
	...
	BlobAttachmentIndexes []int64 `protobuf:"varint,4,rep,packed,name=blob_attachment_indexes,json=blobAttachmentIndexes,proto3" json:"blob_attachment_indexes,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *SearchResponse_Summary_Reference_ChunkContent) Reset() {
	*x = SearchResponse_Summary_Reference_ChunkContent{}
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[56]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *SearchResponse_Summary_Reference_ChunkContent) GetBlobAttachmentIndexes() []int64 {
	if x != nil {
		return x.BlobAttachmentIndexes
	}
	return nil
}

// Stores type and data of the blob.
type SearchResponse_Summary_BlobAttachment_Blob struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *SearchResponse_Summary_BlobAttachment_Blob) Reset() {
	*x = SearchResponse_Summary_BlobAttachment_Blob{}
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[57]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SearchResponse_Summary_BlobAttachment_Blob) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SearchResponse_Summary_BlobAttachment_Blob) ProtoMessage() {}

func (x *SearchResponse_Summary_BlobAttachment_Blob) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[57]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SearchResponse_Summary_BlobAttachment_Blob.ProtoReflect.Descriptor instead.
func (*SearchResponse_Summary_BlobAttachment_Blob) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP(), []int{1, 3, 5, 0}
}

func (x *SearchResponse_Summary_BlobAttachment_Blob) GetMimeType() string {
	if x != nil {
		return x.MimeType
	}
	return ""
...
func (x *SearchResponse_Summary_BlobAttachment_Blob) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter) Reset() {
	*x = SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter{}
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[58]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_StringConstraint) Reset() {
	*x = SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_StringConstraint{}
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[59]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_NumberConstraint) Reset() {
	*x = SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_NumberConstraint{}
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_GeolocationConstraint) Reset() {
	*x = SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_GeolocationConstraint{}
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_AndExpression) Reset() {
	*x = SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_AndExpression{}
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[62]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_OrExpression) Reset() {
	*x = SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_OrExpression{}
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_Expression) Reset() {
	*x = SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_Expression{}
	mi := &file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[64]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x0fpage_categories\x18? \x03(\tB\x03\xe0A\x01R\x0epageCategories\x12^\n" +
	"\vimage_query\x18\x13 \x01(\v2=.google.cloud.discoveryengine.v1beta.SearchRequest.ImageQueryR\n" +
	"imageQuery\x12\x1b\n" +
	"\tpage_size\x18\x04 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x05 \x01(\tR\tpageToken\x12\x16\n" +
	"\x06offset\x18\x06 \x01(\x05R\x06offset\x12)\n" +
	"\x11one_box_page_size\x18/ \x01(\x05R\x0eoneBoxPageSize\x12j\n" +
	"\x10data_store_specs\x18  \x03(\v2@.google.cloud.discoveryengine.v1beta.SearchRequest.DataStoreSpecR\x0edataStoreSpecs\x12?\n" +
	...
	"\border_by\x18\b \x01(\tR\aorderBy\x12J\n" +
	"\tuser_info\x18\x15 \x01(\v2-.google.cloud.discoveryengine.v1beta.UserInfoR\buserInfo\x12#\n" +
	"\rlanguage_code\x18# \x01(\tR\flanguageCode\x12\x1f\n" +
	"\vregion_code\x18$ \x01(\tR\n" +
	"regionCode\x12]\n" +
	"\vfacet_specs\x18\t \x03(\v2<.google.cloud.discoveryengine.v1beta.SearchRequest.FacetSpecR\n" +
	"facetSpecs\x12[\n" +
	"\n" +
	"boost_spec\x18\n" +
	" \x01(\v2<.google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpecR\tboostSpec\x12V\n" +
	"\x06params\x18\v \x03(\v2>.google.cloud.discoveryengine.v1beta.SearchRequest.ParamsEntryR\x06params\x12w\n" +
	"\x14query_expansion_spec\x18\r \x01(\v2E.google.cloud.discoveryengine.v1beta.SearchRequest.QueryExpansionSpecR\x12queryExpansionSpec\x12z\n" +
	"\x15spell_correction_spec\x18\x0e \x01(\v2F.google.cloud.discoveryengine.v1beta.SearchRequest.SpellCorrectionSpecR\x13spellCorrectionSpec\x12)\n" +
	"\x0euser_pseudo_id\x18\x0f \x01(\tB\x03\xe0A\x01R\fuserPseudoId\x12t\n" +
	"\x13content_search_spec\x18\x18 \x01(\v2D.google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpecR\x11contentSearchSpec\x12g\n" +
	"\x0eembedding_spec\x18\x17 \x01(\v2@.google.cloud.discoveryengine.v1beta.SearchRequest.EmbeddingSpecR\rembeddingSpec\x122\n" +
	"\x12ranking_expression\x18\x1a \x01(\tB\x03\xe0A\x01R\x11rankingExpression\x12\x8e\x01\n" +
	"\x1aranking_expression_backend\x185 \x01(\x0e2K.google.cloud.discoveryengine.v1beta.SearchRequest.RankingExpressionBackendB\x03\xe0A\x01R\x18rankingExpressionBackend\x12\x1f\n" +
	"\vsafe_search\x18\x14 \x01(\bR\n" +
	"safeSearch\x12c\n" +
	"\vuser_labels\x18\x16 \x03(\v2B.google.cloud.discoveryengine.v1beta.SearchRequest.UserLabelsEntryR\n" +
	"userLabels\x12\xb7\x01\n" +
	")natural_language_query_understanding_spec\x18\x1c \x01(\v2X.google.cloud.discoveryengine.v1beta.SearchRequest.NaturalLanguageQueryUnderstandingSpecB\x03\xe0A\x01R%naturalLanguageQueryUnderstandingSpec\x12|\n" +
	"\x17search_as_you_type_spec\x18\x1f \x01(\v2F.google.cloud.discoveryengine.v1beta.SearchRequest.SearchAsYouTypeSpecR\x13searchAsYouTypeSpec\x12f\n" +
	"\fdisplay_spec\x18& \x01(\v2>.google.cloud.discoveryengine.v1beta.SearchRequest.DisplaySpecB\x03\xe0A\x01R\vdisplaySpec\x12k\n" +
	"\x0ecrowding_specs\x18( \x03(\v2?.google.cloud.discoveryengine.v1beta.SearchRequest.CrowdingSpecB\x03\xe0A\x01R\rcrowdingSpecs\x12E\n" +
	"\asession\x18) \x01(\tB+\xfaA(\n" +
	"&discoveryengine.googleapis.com/SessionR\asession\x12a\n" +
	"\fsession_spec\x18* \x01(\v2>.google.cloud.discoveryengine.v1beta.SearchRequest.SessionSpecR\vsessionSpec\x12v\n" +
	"\x13relevance_threshold\x18, \x01(\x0e2E.google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceThresholdR\x12relevanceThreshold\x12\x7f\n" +
	"\x15relevance_filter_spec\x18V \x01(\v2F.google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceFilterSpecB\x03\xe0A\x01R\x13relevanceFilterSpec\x12y\n" +
	"\x14personalization_spec\x18. \x01(\v2F.google.cloud.discoveryengine.v1beta.SearchRequest.PersonalizationSpecR\x13personalizationSpec\x12|\n" +
	"\x14relevance_score_spec\x184 \x01(\v2E.google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceScoreSpecB\x03\xe0A\x01R\x12relevanceScoreSpec\x12s\n" +
	"\x11search_addon_spec\x18> \x01(\v2B.google.cloud.discoveryengine.v1beta.SearchRequest.SearchAddonSpecB\x03\xe0A\x01R\x0fsearchAddonSpec\x12\x7f\n" +
	"\x15custom_ranking_params\x18@ \x01(\v2F.google.cloud.discoveryengine.v1beta.SearchRequest.CustomRankingParamsB\x03\xe0A\x01R\x13customRankingParams\x12\x1b\n" +
	"\x06entity\x18B \x01(\tB\x03\xe0A\x01R\x06entity\x1a8\n" +
	"\n" +
	"ImageQuery\x12!\n" +
	"\vimage_bytes\x18\x01 \x01(\tH\x00R\n" +
	"imageBytesB\a\n" +
	"\x05image\x1a\xc2\x02\n" +
	"\rDataStoreSpec\x12O\n" +
	"\n" +
	"data_store\x18\x01 \x01(\tB0\xe0A\x02\xfaA*\n" +
	"(discoveryengine.googleapis.com/DataStoreR\tdataStore\x12\x1b\n" +
	"\x06filter\x18\x05 \x01(\tB\x03\xe0A\x01R\x06filter\x12`\n" +
	"\n" +
	"boost_spec\x18\x06 \x01(\v2<.google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpecB\x03\xe0A\x01R\tboostSpec\x12;\n" +
	"\x17custom_search_operators\x18\a \x01(\tB\x03\xe0A\x01R\x15customSearchOperators\x12$\n" +
	"\vnum_results\x18\t \x01(\x05B\x03\xe0A\x01R\n" +
	"numResults\x1a\x90\x04\n" +
	"\tFacetSpec\x12g\n" +
	"\tfacet_key\x18\x01 \x01(\v2E.google.cloud.discoveryengine.v1beta.SearchRequest.FacetSpec.FacetKeyB\x03\xe0A\x02R\bfacetKey\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x05R\x05limit\x120\n" +
	"\x14excluded_filter_keys\x18\x03 \x03(\tR\x12excludedFilterKeys\x126\n" +
	"\x17enable_dynamic_position\x18\x04 \x01(\bR\x15enableDynamicPosition\x1a\x99\x02\n" +
	"\bFacetKey\x12\x15\n" +
	"\x03key\x18\x01 \x01(\tB\x03\xe0A\x02R\x03key\x12K\n" +
	"\tintervals\x18\x02 \x03(\v2-.google.cloud.discoveryengine.v1beta.IntervalR\tintervals\x12+\n" +
	...
	"\border_by\x18\a \x01(\tR\aorderBy\x1a\xe4\b\n" +
	"\tBoostSpec\x12\x83\x01\n" +
	"\x15condition_boost_specs\x18\x01 \x03(\v2O.google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpecR\x13conditionBoostSpecs\x1a\xd0\a\n" +
	"\x12ConditionBoostSpec\x12\x1c\n" +
	"\tcondition\x18\x01 \x01(\tR\tcondition\x12\x14\n" +
	"\x05boost\x18\x02 \x01(\x02R\x05boost\x12\x8e\x01\n" +
	"\x12boost_control_spec\x18\x03 \x01(\v2`.google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpecR\x10boostControlSpec\x1a\xf4\x05\n" +
	"\x10BoostControlSpec\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x12\x95\x01\n" +
	"\x0eattribute_type\x18\x02 \x01(\x0e2n.google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.AttributeTypeR\rattributeType\x12\xa1\x01\n" +
	"\x12interpolation_type\x18\x03 \x01(\x0e2r.google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.InterpolationTypeR\x11interpolationType\x12\x94\x01\n" +
	"\x0econtrol_points\x18\x04 \x03(\v2m.google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.ControlPointR\rcontrolPoints\x1aZ\n" +
	"\fControlPoint\x12'\n" +
	...
	"\n" +
	"\x06LINEAR\x10\x01\x1a\xf9\x01\n" +
	"\x12QueryExpansionSpec\x12m\n" +
	"\tcondition\x18\x01 \x01(\x0e2O.google.cloud.discoveryengine.v1beta.SearchRequest.QueryExpansionSpec.ConditionR\tcondition\x124\n" +
	...
	"\x04AUTO\x10\x02\x1a\xb3\x01\n" +
	"\x13SpellCorrectionSpec\x12_\n" +
	"\x04mode\x18\x01 \x01(\x0e2K.google.cloud.discoveryengine.v1beta.SearchRequest.SpellCorrectionSpec.ModeR\x04mode\";\n" +
	"\x04Mode\x12\x14\n" +
	"\x10MODE_UNSPECIFIED\x10\x00\x12\x13\n" +
	"\x0fSUGGESTION_ONLY\x10\x01\x12\b\n" +
	"\x04AUTO\x10\x02\x1a\xed\x13\n" +
	"\x11ContentSearchSpec\x12s\n" +
	"\fsnippet_spec\x18\x01 \x01(\v2P.google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SnippetSpecR\vsnippetSpec\x12s\n" +
	"\fsummary_spec\x18\x02 \x01(\v2P.google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpecR\vsummarySpec\x12\x92\x01\n" +
	"\x17extractive_content_spec\x18\x03 \x01(\v2Z.google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.ExtractiveContentSpecR\x15extractiveContentSpec\x12\x83\x01\n" +
	"\x12search_result_mode\x18\x04 \x01(\x0e2U.google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SearchResultModeR\x10searchResultMode\x12m\n" +
	"\n" +
	"chunk_spec\x18\x05 \x01(\v2N.google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.ChunkSpecR\tchunkSpec\x1a\x8f\x01\n" +
	"\vSnippetSpec\x12.\n" +
	...
	"\x0ereturn_snippet\x18\x03 \x01(\bR\rreturnSnippet\x1a\xd8\t\n" +
	"\vSummarySpec\x120\n" +
	...
	"\x1bignore_low_relevant_content\x18\t \x01(\bR\x18ignoreLowRelevantContent\x12@\n" +
	"\x1aignore_jail_breaking_query\x18\n" +
	" \x01(\bB\x03\xe0A\x01R\x17ignoreJailBreakingQuery\x12\x8d\x01\n" +
	"\x0fmultimodal_spec\x18\v \x01(\v2_.google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.MultiModalSpecB\x03\xe0A\x01R\x0emultimodalSpec\x12\x8c\x01\n" +
	"\x11model_prompt_spec\x18\x05 \x01(\v2`.google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.ModelPromptSpecR\x0fmodelPromptSpec\x12#\n" +
	"\rlanguage_code\x18\x06 \x01(\tR\flanguageCode\x12y\n" +
	"\n" +
	"model_spec\x18\a \x01(\v2Z.google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.ModelSpecR\tmodelSpec\x12.\n" +
	"\x13use_semantic_chunks\x18\b \x01(\bR\x11useSemanticChunks\x1a\xa1\x02\n" +
	"\x0eMultiModalSpec\x12\x93\x01\n" +
	"\fimage_source\x18\x03 \x01(\x0e2k.google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.MultiModalSpec.ImageSourceB\x03\xe0A\x01R\vimageSource\"y\n" +
	...
	"\x16FIGURE_GENERATION_ONLY\x10\x03\x1a-\n" +
	...
	"\n" +
	"\x06CHUNKS\x10\x02\x1a\xd8\x01\n" +
	"\rEmbeddingSpec\x12}\n" +
	"\x11embedding_vectors\x18\x01 \x03(\v2P.google.cloud.discoveryengine.v1beta.SearchRequest.EmbeddingSpec.EmbeddingVectorR\x10embeddingVectors\x1aH\n" +
	"\x0fEmbeddingVector\x12\x1d\n" +
	"\n" +
	"field_path\x18\x01 \x01(\tR\tfieldPath\x12\x16\n" +
	"\x06vector\x18\x02 \x03(\x02R\x06vector\x1a\xd2\x05\n" +
	"%NaturalLanguageQueryUnderstandingSpec\x12\xb2\x01\n" +
	"\x1bfilter_extraction_condition\x18\x01 \x01(\x0e2r.google.cloud.discoveryengine.v1beta.SearchRequest.NaturalLanguageQueryUnderstandingSpec.FilterExtractionConditionR\x19filterExtractionCondition\x12Q\n" +
	"&geo_search_query_detection_field_names\x18\x02 \x03(\tR!geoSearchQueryDetectionFieldNames\x12\xb1\x01\n" +
	"\x19extracted_filter_behavior\x18\x03 \x01(\x0e2p.google.cloud.discoveryengine.v1beta.SearchRequest.NaturalLanguageQueryUnderstandingSpec.ExtractedFilterBehaviorB\x03\xe0A\x01R\x17extractedFilterBehavior\x123\n" +
	"\x13allowed_field_names\x18\x04 \x03(\tB\x03\xe0A\x01R\x11allowedFieldNames\"Q\n" +
	"\x19FilterExtractionCondition\x12\x19\n" +
	"\x15CONDITION_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bDISABLED\x10\x01\x12\v\n" +
	"\aENABLED\x10\x02\"e\n" +
	"\x17ExtractedFilterBehavior\x12)\n" +
	"%EXTRACTED_FILTER_BEHAVIOR_UNSPECIFIED\x10\x00\x12\x0f\n" +
	"\vHARD_FILTER\x10\x01\x12\x0e\n" +
	"\n" +
	"SOFT_BOOST\x10\x02\x1a\xd2\x01\n" +
	"\x13SearchAsYouTypeSpec\x12n\n" +
	"\tcondition\x18\x01 \x01(\x0e2P.google.cloud.discoveryengine.v1beta.SearchRequest.SearchAsYouTypeSpec.ConditionR\tcondition\"K\n" +
	"\tCondition\x12\x19\n" +
	"\x15CONDITION_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bDISABLED\x10\x01\x12\v\n" +
	"\aENABLED\x10\x02\x12\b\n" +
	"\x04AUTO\x10\x03\x1a\xb9\x02\n" +
	"\vDisplaySpec\x12\x9b\x01\n" +
	"\x1cmatch_highlighting_condition\x18\x01 \x01(\x0e2Y.google.cloud.discoveryengine.v1beta.SearchRequest.DisplaySpec.MatchHighlightingConditionR\x1amatchHighlightingCondition\"\x8b\x01\n" +
	...
	"\x1aMATCH_HIGHLIGHTING_ENABLED\x10\x02\x1a\xf6\x01\n" +
	"\fCrowdingSpec\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12\x1b\n" +
	"\tmax_count\x18\x02 \x01(\x05R\bmaxCount\x12X\n" +
	"\x04mode\x18\x03 \x01(\x0e2D.google.cloud.discoveryengine.v1beta.SearchRequest.CrowdingSpec.ModeR\x04mode\"Y\n" +
	"\x04Mode\x12\x14\n" +
	"\x10MODE_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14DROP_CROWDED_RESULTS\x10\x01\x12!\n" +
	"\x1dDEMOTE_CROWDED_RESULTS_TO_END\x10\x02\x1a\x98\x01\n" +
	...
	" _search_result_persistence_count\x1a\xca\x04\n" +
	"\x13RelevanceFilterSpec\x12\x9c\x01\n" +
	"\x18keyword_search_threshold\x18\x01 \x01(\v2].google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceFilterSpec.RelevanceThresholdSpecB\x03\xe0A\x01R\x16keywordSearchThreshold\x12\x9e\x01\n" +
	"\x19semantic_search_threshold\x18\x02 \x01(\v2].google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceFilterSpec.RelevanceThresholdSpecB\x03\xe0A\x01R\x17semanticSearchThreshold\x1a\xf2\x01\n" +
	"\x16RelevanceThresholdSpec\x12x\n" +
	"\x13relevance_threshold\x18\x01 \x01(\x0e2E.google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceThresholdH\x00R\x12relevanceThreshold\x12B\n" +
	"\x1csemantic_relevance_threshold\x18\x02 \x01(\x02H\x00R\x1asemanticRelevanceThresholdB\x1a\n" +
	"\x18relevance_threshold_spec\x1a\xac\x01\n" +
	"\x13PersonalizationSpec\x12_\n" +
	"\x04mode\x18\x01 \x01(\x0e2K.google.cloud.discoveryengine.v1beta.SearchRequest.PersonalizationSpec.ModeR\x04mode\"4\n" +
	"\x04Mode\x12\x14\n" +
	"\x10MODE_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04AUTO\x10\x01\x12\f\n" +
	"\bDISABLED\x10\x02\x1aO\n" +
	...
	"&RANKING_EXPRESSION_BACKEND_UNSPECIFIED\x10\x00\x12\f\n" +
	"\x04BYOE\x10\x01\x1a\x02\b\x01\x12\x10\n" +
	"\bCLEARBOX\x10\x02\x1a\x02\b\x01\x12\x15\n" +
	...
	"\x04HIGH\x10\x04\"\xa0H\n" +
	"\x0eSearchResponse\x12Z\n" +
	"\aresults\x18\x01 \x03(\v2@.google.cloud.discoveryengine.v1beta.SearchResponse.SearchResultR\aresults\x12Q\n" +
	"\x06facets\x18\x02 \x03(\v29.google.cloud.discoveryengine.v1beta.SearchResponse.FacetR\x06facets\x12x\n" +
	"\x14guided_search_result\x18\b \x01(\v2F.google.cloud.discoveryengine.v1beta.SearchResponse.GuidedSearchResultR\x12guidedSearchResult\x12\x1d\n" +
	"\n" +
	...
	"\x0fcorrected_query\x18\a \x01(\tR\x0ecorrectedQuery\x12'\n" +
	"\x0fsuggested_query\x18\x18 \x01(\tR\x0esuggestedQuery\x12U\n" +
	"\asummary\x18\t \x01(\v2;.google.cloud.discoveryengine.v1beta.SearchResponse.SummaryR\asummary\x12)\n" +
	"\x10applied_controls\x18\n" +
	" \x03(\tR\x0fappliedControls\x12y\n" +
	"\x15geo_search_debug_info\x18\x10 \x03(\v2F.google.cloud.discoveryengine.v1beta.SearchResponse.GeoSearchDebugInfoR\x12geoSearchDebugInfo\x12x\n" +
	"\x14query_expansion_info\x18\x0e \x01(\v2F.google.cloud.discoveryengine.v1beta.SearchResponse.QueryExpansionInfoR\x12queryExpansionInfo\x12\xb8\x01\n" +
	")natural_language_query_understanding_info\x18\x0f \x01(\v2Y.google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfoB\x03\xe0A\x03R%naturalLanguageQueryUnderstandingInfo\x12b\n" +
	"\fsession_info\x18\x13 \x01(\v2?.google.cloud.discoveryengine.v1beta.SearchResponse.SessionInfoR\vsessionInfo\x12h\n" +
	"\x0fone_box_results\x18\x14 \x03(\v2@.google.cloud.discoveryengine.v1beta.SearchResponse.OneBoxResultR\roneBoxResults\x12n\n" +
	"\x16search_link_promotions\x18\x17 \x03(\v28.google.cloud.discoveryengine.v1beta.SearchLinkPromotionR\x14searchLinkPromotions\x12m\n" +
	"\x0esemantic_state\x18$ \x01(\x0e2A.google.cloud.discoveryengine.v1beta.SearchResponse.SemanticStateB\x03\xe0A\x03R\rsemanticState\x1a\xe7\n" +
	"\n" +
	"\fSearchResult\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12I\n" +
	"\bdocument\x18\x02 \x01(\v2-.google.cloud.discoveryengine.v1beta.DocumentR\bdocument\x12@\n" +
	"\x05chunk\x18\x12 \x01(\v2*.google.cloud.discoveryengine.v1beta.ChunkR\x05chunk\x12y\n" +
	"\fmodel_scores\x18\x04 \x03(\v2Q.google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult.ModelScoresEntryB\x03\xe0A\x03R\vmodelScores\x12t\n" +
	"\frank_signals\x18\a \x01(\v2L.google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult.RankSignalsB\x03\xe0A\x01R\vrankSignals\x1a\xd7\x06\n" +
	"\vRankSignals\x12B\n" +
	...
	"\fdefault_rank\x18  \x01(\x02B\x03\xe0A\x01R\vdefaultRank\x12\x85\x01\n" +
	"\x0ecustom_signals\x18! \x03(\v2Y.google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult.RankSignals.CustomSignalB\x03\xe0A\x01R\rcustomSignals\x12G\n" +
	...
	"\r_document_ageB\x12\n" +
	"\x10_boosting_factor\x1ao\n" +
	"\x10ModelScoresEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12E\n" +
	"\x05value\x18\x02 \x01(\v2/.google.cloud.discoveryengine.v1beta.DoubleListR\x05value:\x028\x01\x1a\xb5\x02\n" +
	"\x05Facet\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\\\n" +
	"\x06values\x18\x02 \x03(\v2D.google.cloud.discoveryengine.v1beta.SearchResponse.Facet.FacetValueR\x06values\x12#\n" +
	"\rdynamic_facet\x18\x03 \x01(\bR\fdynamicFacet\x1a\x96\x01\n" +
	"\n" +
	"FacetValue\x12\x16\n" +
	"\x05value\x18\x01 \x01(\tH\x00R\x05value\x12K\n" +
	"\binterval\x18\x02 \x01(\v2-.google.cloud.discoveryengine.v1beta.IntervalH\x00R\binterval\x12\x14\n" +
	"\x05count\x18\x03 \x01(\x03R\x05countB\r\n" +
	"\vfacet_value\x1a\xbb\x02\n" +
	"\x12GuidedSearchResult\x12\x8f\x01\n" +
	"\x15refinement_attributes\x18\x01 \x03(\v2Z.google.cloud.discoveryengine.v1beta.SearchResponse.GuidedSearchResult.RefinementAttributeR\x14refinementAttributes\x12.\n" +
	...
	"\x0fattribute_value\x18\x02 \x01(\tR\x0eattributeValue\x1a\x98\x13\n" +
	"\aSummary\x12!\n" +
	"\fsummary_text\x18\x01 \x01(\tR\vsummaryText\x12\x88\x01\n" +
	"\x17summary_skipped_reasons\x18\x02 \x03(\x0e2P.google.cloud.discoveryengine.v1beta.SearchResponse.Summary.SummarySkippedReasonR\x15summarySkippedReasons\x12y\n" +
	"\x11safety_attributes\x18\x03 \x01(\v2L.google.cloud.discoveryengine.v1beta.SearchResponse.Summary.SafetyAttributesR\x10safetyAttributes\x12\x83\x01\n" +
	"\x15summary_with_metadata\x18\x04 \x01(\v2O.google.cloud.discoveryengine.v1beta.SearchResponse.Summary.SummaryWithMetadataR\x13summaryWithMetadata\x1aJ\n" +
	"\x10SafetyAttributes\x12\x1e\n" +
	"\n" +
	"categories\x18\x01 \x03(\tR\n" +
	"categories\x12\x16\n" +
	"\x06scores\x18\x02 \x03(\x02R\x06scores\x1av\n" +
	"\x10CitationMetadata\x12b\n" +
	"\tcitations\x18\x01 \x03(\v2D.google.cloud.discoveryengine.v1beta.SearchResponse.Summary.CitationR\tcitations\x1a\xae\x01\n" +
	"\bCitation\x12\x1f\n" +
	"\vstart_index\x18\x01 \x01(\x03R\n" +
	"startIndex\x12\x1b\n" +
	"\tend_index\x18\x02 \x01(\x03R\bendIndex\x12d\n" +
	"\asources\x18\x03 \x03(\v2J.google.cloud.discoveryengine.v1beta.SearchResponse.Summary.CitationSourceR\asources\x1a9\n" +
	"\x0eCitationSource\x12'\n" +
	"\x0freference_index\x18\x04 \x01(\x03R\x0ereferenceIndex\x1a\x8c\x03\n" +
	"\tReference\x12\x14\n" +
	...
	"\x03uri\x18\x03 \x01(\tR\x03uri\x12y\n" +
	"\x0echunk_contents\x18\x04 \x03(\v2R.google.cloud.discoveryengine.v1beta.SearchResponse.Summary.Reference.ChunkContentR\rchunkContents\x1a\x8e\x01\n" +
	"\fChunkContent\x12\x18\n" +
	"\acontent\x18\x01 \x01(\tR\acontent\x12'\n" +
	"\x0fpage_identifier\x18\x02 \x01(\tR\x0epageIdentifier\x12;\n" +
	"\x17blob_attachment_indexes\x18\x04 \x03(\x03B\x03\xe0A\x03R\x15blobAttachmentIndexes\x1a\x9a\x03\n" +
	"\x0eBlobAttachment\x12h\n" +
	"\x04data\x18\x01 \x01(\v2O.google.cloud.discoveryengine.v1beta.SearchResponse.Summary.BlobAttachment.BlobB\x03\xe0A\x03R\x04data\x12\x8a\x01\n" +
	"\x10attribution_type\x18\x02 \x01(\x0e2Z.google.cloud.discoveryengine.v1beta.SearchResponse.Summary.BlobAttachment.AttributionTypeB\x03\xe0A\x03R\x0fattributionType\x1aA\n" +
	"\x04Blob\x12 \n" +
	"\tmime_type\x18\x01 \x01(\tB\x03\xe0A\x03R\bmimeType\x12\x17\n" +
	"\x04data\x18\x02 \x01(\fB\x03\xe0A\x03R\x04data\"N\n" +
	"\x0fAttributionType\x12 \n" +
	"\x1cATTRIBUTION_TYPE_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06CORPUS\x10\x01\x12\r\n" +
	"\tGENERATED\x10\x02\x1a\x8d\x03\n" +
	"\x13SummaryWithMetadata\x12\x18\n" +
	"\asummary\x18\x01 \x01(\tR\asummary\x12y\n" +
	"\x11citation_metadata\x18\x02 \x01(\v2L.google.cloud.discoveryengine.v1beta.SearchResponse.Summary.CitationMetadataR\x10citationMetadata\x12e\n" +
	"\n" +
	"references\x18\x03 \x03(\v2E.google.cloud.discoveryengine.v1beta.SearchResponse.Summary.ReferenceR\n" +
	"references\x12z\n" +
	"\x10blob_attachments\x18\x04 \x03(\v2J.google.cloud.discoveryengine.v1beta.SearchResponse.Summary.BlobAttachmentB\x03\xe0A\x03R\x0fblobAttachments\"\xf1\x02\n" +
	...
	"$NON_SUMMARY_SEEKING_QUERY_IGNORED_V2\x10\t\x12\f\n" +
	"\bTIME_OUT\x10\n" +
	"\x1ao\n" +
	...
	"\x13pinned_result_count\x18\x02 \x01(\x03R\x11pinnedResultCount\x1a\xe6\x13\n" +
	"%NaturalLanguageQueryUnderstandingInfo\x12+\n" +
	"\x11extracted_filters\x18\x01 \x01(\tR\x10extractedFilters\x12'\n" +
	"\x0frewritten_query\x18\x02 \x01(\tR\x0erewrittenQuery\x12-\n" +
	"\x12classified_intents\x18\x05 \x03(\tR\x11classifiedIntents\x12\xb3\x01\n" +
	"\x1bstructured_extracted_filter\x18\x03 \x01(\v2s.google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilterR\x19structuredExtractedFilter\x1a\x81\x11\n" +
	"\x19StructuredExtractedFilter\x12\x9e\x01\n" +
	"\n" +
	"expression\x18\x01 \x01(\v2~.google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.ExpressionR\n" +
	"expression\x1an\n" +
	"\x10StringConstraint\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x12\x16\n" +
	"\x06values\x18\x02 \x03(\tR\x06values\x12#\n" +
	"\rquery_segment\x18\x03 \x01(\tR\fquerySegment\x1a\xa6\x03\n" +
	"\x10NumberConstraint\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x12\xb0\x01\n" +
	"\n" +
	"comparison\x18\x02 \x01(\x0e2\x8f\x01.google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.NumberConstraint.ComparisonR\n" +
	"comparison\x12\x14\n" +
	...
	"\x10radius_in_meters\x18\x03 \x01(\x02R\x0eradiusInMeters\x1a\xb2\x01\n" +
	"\rAndExpression\x12\xa0\x01\n" +
	"\vexpressions\x18\x01 \x03(\v2~.google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.ExpressionR\vexpressions\x1a\xb1\x01\n" +
	"\fOrExpression\x12\xa0\x01\n" +
	"\vexpressions\x18\x01 \x03(\v2~.google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.ExpressionR\vexpressions\x1a\x89\a\n" +
	"\n" +
	"Expression\x12\xb4\x01\n" +
	"\x11string_constraint\x18\x01 \x01(\v2\x84\x01.google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.StringConstraintH\x00R\x10stringConstraint\x12\xb4\x01\n" +
	"\x11number_constraint\x18\x02 \x01(\v2\x84\x01.google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.NumberConstraintH\x00R\x10numberConstraint\x12\xc3\x01\n" +
	"\x16geolocation_constraint\x18\x03 \x01(\v2\x89\x01.google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.GeolocationConstraintH\x00R\x15geolocationConstraint\x12\x9f\x01\n" +
	"\band_expr\x18\x04 \x01(\v2\x81\x01.google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.AndExpressionH\x00R\aandExpr\x12\x9c\x01\n" +
	"\aor_expr\x18\x05 \x01(\v2\x80\x01.google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.OrExpressionH\x00R\x06orExprB\x06\n" +
	"\x04expr\x1a<\n" +
	"\vSessionInfo\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x19\n" +
	"\bquery_id\x18\x02 \x01(\tR\aqueryId\x1a\xd0\x02\n" +
	"\fOneBoxResult\x12m\n" +
	"\fone_box_type\x18\x01 \x01(\x0e2K.google.cloud.discoveryengine.v1beta.SearchResponse.OneBoxResult.OneBoxTypeR\n" +
	"oneBoxType\x12g\n" +
	"\x0esearch_results\x18\x02 \x03(\v2@.google.cloud.discoveryengine.v1beta.SearchResponse.SearchResultR\rsearchResults\"h\n" +
	"\n" +
	"OneBoxType\x12\x1c\n" +
	...
	"\x0fKNOWLEDGE_GRAPH\x10\x04\"J\n" +
	"\rSemanticState\x12\x1e\n" +
	"\x1aSEMANTIC_STATE_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bDISABLED\x10\x01\x12\v\n" +
	"\aENABLED\x10\x022\xfe\b\n" +
	"\rSearchService\x12\xa3\x03\n" +
	"\x06Search\x122.google.cloud.discoveryengine.v1beta.SearchRequest\x1a3.google.cloud.discoveryengine.v1beta.SearchResponse\"\xaf\x02\x82\xd3\xe4\x93\x02\xa8\x02:\x01*Zg:\x01*\"b/v1beta/{serving_config=projects/*/locations/*/collections/*/dataStores/*/servingConfigs/*}:searchZd:\x01*\"_/v1beta/{serving_config=projects/*/locations/*/collections/*/engines/*/servingConfigs/*}:search\"T/v1beta/{serving_config=projects/*/locations/*/dataStores/*/servingConfigs/*}:search\x12\xb3\x03\n" +
	"\n" +
	"SearchLite\x122.google.cloud.discoveryengine.v1beta.SearchRequest\x1a3.google.cloud.discoveryengine.v1beta.SearchResponse\"\xbb\x02\x82\xd3\xe4\x93\x02\xb4\x02:\x01*Zk:\x01*\"f/v1beta/{serving_config=projects/*/locations/*/collections/*/dataStores/*/servingConfigs/*}:searchLiteZh:\x01*\"c/v1beta/{serving_config=projects/*/locations/*/collections/*/engines/*/servingConfigs/*}:searchLite\"X/v1beta/{serving_config=projects/*/locations/*/dataStores/*/servingConfigs/*}:searchLite\x1a\x90\x02\xcaA\x1ediscoveryengine.googleapis.com\xd2A\xeb\x01https://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/discoveryengine.assist.readwrite,https://www.googleapis.com/auth/discoveryengine.readwrite,https://www.googleapis.com/auth/discoveryengine.serving.readwriteB\x99\x02\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDesc)))
	})
	return file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDescData
}

var file_google_cloud_discoveryengine_v1beta_search_service_proto_enumTypes = make([]protoimpl.EnumInfo, 19)
var file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes = make([]protoimpl.MessageInfo, 65)
var file_google_cloud_discoveryengine_v1beta_search_service_proto_goTypes = []any{
	(SearchRequest_RankingExpressionBackend)(0),                                                                     // 0: google.cloud.discoveryengine.v1beta.SearchRequest.RankingExpressionBackend
	(SearchRequest_RelevanceThreshold)(0),                                                                           // 1: google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceThreshold
	...
	(SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec_ImageSource)(0),                                     // 7: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.MultiModalSpec.ImageSource
	(SearchRequest_NaturalLanguageQueryUnderstandingSpec_FilterExtractionCondition)(0),                              // 8: google.cloud.discoveryengine.v1beta.SearchRequest.NaturalLanguageQueryUnderstandingSpec.FilterExtractionCondition
	(SearchRequest_NaturalLanguageQueryUnderstandingSpec_ExtractedFilterBehavior)(0),                                // 9: google.cloud.discoveryengine.v1beta.SearchRequest.NaturalLanguageQueryUnderstandingSpec.ExtractedFilterBehavior
	(SearchRequest_SearchAsYouTypeSpec_Condition)(0),                                                                // 10: google.cloud.discoveryengine.v1beta.SearchRequest.SearchAsYouTypeSpec.Condition
	(SearchRequest_DisplaySpec_MatchHighlightingCondition)(0),                                                       // 11: google.cloud.discoveryengine.v1beta.SearchRequest.DisplaySpec.MatchHighlightingCondition
	(SearchRequest_CrowdingSpec_Mode)(0),                                                                            // 12: google.cloud.discoveryengine.v1beta.SearchRequest.CrowdingSpec.Mode
	(SearchRequest_PersonalizationSpec_Mode)(0),                                                                     // 13: google.cloud.discoveryengine.v1beta.SearchRequest.PersonalizationSpec.Mode
	(SearchResponse_SemanticState)(0),                                                                               // 14: google.cloud.discoveryengine.v1beta.SearchResponse.SemanticState
	(SearchResponse_Summary_SummarySkippedReason)(0),                                                                // 15: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.SummarySkippedReason
	(SearchResponse_Summary_BlobAttachment_AttributionType)(0),                                                      // 16: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.BlobAttachment.AttributionType
	(SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_NumberConstraint_Comparison)(0), // 17: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.NumberConstraint.Comparison
	(SearchResponse_OneBoxResult_OneBoxType)(0),                                                                     // 18: google.cloud.discoveryengine.v1beta.SearchResponse.OneBoxResult.OneBoxType
	(*SearchRequest)(nil),                                       // 19: google.cloud.discoveryengine.v1beta.SearchRequest
	(*SearchResponse)(nil),                                      // 20: google.cloud.discoveryengine.v1beta.SearchResponse
	(*SearchRequest_ImageQuery)(nil),                            // 21: google.cloud.discoveryengine.v1beta.SearchRequest.ImageQuery
	(*SearchRequest_DataStoreSpec)(nil),                         // 22: google.cloud.discoveryengine.v1beta.SearchRequest.DataStoreSpec
	(*SearchRequest_FacetSpec)(nil),                             // 23: google.cloud.discoveryengine.v1beta.SearchRequest.FacetSpec
	(*SearchRequest_BoostSpec)(nil),                             // 24: google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec
	(*SearchRequest_QueryExpansionSpec)(nil),                    // 25: google.cloud.discoveryengine.v1beta.SearchRequest.QueryExpansionSpec
	(*SearchRequest_SpellCorrectionSpec)(nil),                   // 26: google.cloud.discoveryengine.v1beta.SearchRequest.SpellCorrectionSpec
	(*SearchRequest_ContentSearchSpec)(nil),                     // 27: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec
	(*SearchRequest_EmbeddingSpec)(nil),                         // 28: google.cloud.discoveryengine.v1beta.SearchRequest.EmbeddingSpec
	(*SearchRequest_NaturalLanguageQueryUnderstandingSpec)(nil), // 29: google.cloud.discoveryengine.v1beta.SearchRequest.NaturalLanguageQueryUnderstandingSpec
	(*SearchRequest_SearchAsYouTypeSpec)(nil),                   // 30: google.cloud.discoveryengine.v1beta.SearchRequest.SearchAsYouTypeSpec
	(*SearchRequest_DisplaySpec)(nil),                           // 31: google.cloud.discoveryengine.v1beta.SearchRequest.DisplaySpec
	(*SearchRequest_CrowdingSpec)(nil),                          // 32: google.cloud.discoveryengine.v1beta.SearchRequest.CrowdingSpec
	(*SearchRequest_SessionSpec)(nil),                           // 33: google.cloud.discoveryengine.v1beta.SearchRequest.SessionSpec
	(*SearchRequest_RelevanceFilterSpec)(nil),                   // 34: google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceFilterSpec
	(*SearchRequest_PersonalizationSpec)(nil),                   // 35: google.cloud.discoveryengine.v1beta.SearchRequest.PersonalizationSpec
	(*SearchRequest_RelevanceScoreSpec)(nil),                    // 36: google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceScoreSpec
	(*SearchRequest_SearchAddonSpec)(nil),                       // 37: google.cloud.discoveryengine.v1beta.SearchRequest.SearchAddonSpec
	(*SearchRequest_CustomRankingParams)(nil),                   // 38: google.cloud.discoveryengine.v1beta.SearchRequest.CustomRankingParams
	nil,                                      // 39: google.cloud.discoveryengine.v1beta.SearchRequest.ParamsEntry
	nil,                                      // 40: google.cloud.discoveryengine.v1beta.SearchRequest.UserLabelsEntry
	(*SearchRequest_FacetSpec_FacetKey)(nil), // 41: google.cloud.discoveryengine.v1beta.SearchRequest.FacetSpec.FacetKey
	(*SearchRequest_BoostSpec_ConditionBoostSpec)(nil),                               // 42: google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec
	(*SearchRequest_BoostSpec_ConditionBoostSpec_BoostControlSpec)(nil),              // 43: google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec
	(*SearchRequest_BoostSpec_ConditionBoostSpec_BoostControlSpec_ControlPoint)(nil), // 44: google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.ControlPoint
	(*SearchRequest_ContentSearchSpec_SnippetSpec)(nil),                              // 45: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SnippetSpec
	(*SearchRequest_ContentSearchSpec_SummarySpec)(nil),                              // 46: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec
	(*SearchRequest_ContentSearchSpec_ExtractiveContentSpec)(nil),                    // 47: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.ExtractiveContentSpec
	(*SearchRequest_ContentSearchSpec_ChunkSpec)(nil),                                // 48: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.ChunkSpec
	(*SearchRequest_ContentSearchSpec_SummarySpec_MultiModalSpec)(nil),               // 49: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.MultiModalSpec
	(*SearchRequest_ContentSearchSpec_SummarySpec_ModelPromptSpec)(nil),              // 50: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.ModelPromptSpec
	(*SearchRequest_ContentSearchSpec_SummarySpec_ModelSpec)(nil),                    // 51: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.ModelSpec
	(*SearchRequest_EmbeddingSpec_EmbeddingVector)(nil),                              // 52: google.cloud.discoveryengine.v1beta.SearchRequest.EmbeddingSpec.EmbeddingVector
	(*SearchRequest_RelevanceFilterSpec_RelevanceThresholdSpec)(nil),                 // 53: google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceFilterSpec.RelevanceThresholdSpec
	(*SearchResponse_SearchResult)(nil),                                              // 54: google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult
	(*SearchResponse_Facet)(nil),                                                     // 55: google.cloud.discoveryengine.v1beta.SearchResponse.Facet
	(*SearchResponse_GuidedSearchResult)(nil),                                        // 56: google.cloud.discoveryengine.v1beta.SearchResponse.GuidedSearchResult
	(*SearchResponse_Summary)(nil),                                                   // 57: google.cloud.discoveryengine.v1beta.SearchResponse.Summary
	(*SearchResponse_GeoSearchDebugInfo)(nil),                                        // 58: google.cloud.discoveryengine.v1beta.SearchResponse.GeoSearchDebugInfo
	(*SearchResponse_QueryExpansionInfo)(nil),                                        // 59: google.cloud.discoveryengine.v1beta.SearchResponse.QueryExpansionInfo
	(*SearchResponse_NaturalLanguageQueryUnderstandingInfo)(nil),                     // 60: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo
	(*SearchResponse_SessionInfo)(nil),                                               // 61: google.cloud.discoveryengine.v1beta.SearchResponse.SessionInfo
	(*SearchResponse_OneBoxResult)(nil),                                              // 62: google.cloud.discoveryengine.v1beta.SearchResponse.OneBoxResult
	(*SearchResponse_SearchResult_RankSignals)(nil),                                  // 63: google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult.RankSignals
	nil, // 64: google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult.ModelScoresEntry
	(*SearchResponse_SearchResult_RankSignals_CustomSignal)(nil),                                                 // 65: google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult.RankSignals.CustomSignal
	(*SearchResponse_Facet_FacetValue)(nil),                                                                      // 66: google.cloud.discoveryengine.v1beta.SearchResponse.Facet.FacetValue
	(*SearchResponse_GuidedSearchResult_RefinementAttribute)(nil),                                                // 67: google.cloud.discoveryengine.v1beta.SearchResponse.GuidedSearchResult.RefinementAttribute
	(*SearchResponse_Summary_SafetyAttributes)(nil),                                                              // 68: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.SafetyAttributes
	(*SearchResponse_Summary_CitationMetadata)(nil),                                                              // 69: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.CitationMetadata
	(*SearchResponse_Summary_Citation)(nil),                                                                      // 70: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.Citation
	(*SearchResponse_Summary_CitationSource)(nil),                                                                // 71: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.CitationSource
	(*SearchResponse_Summary_Reference)(nil),                                                                     // 72: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.Reference
	(*SearchResponse_Summary_BlobAttachment)(nil),                                                                // 73: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.BlobAttachment
	(*SearchResponse_Summary_SummaryWithMetadata)(nil),                                                           // 74: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.SummaryWithMetadata
	(*SearchResponse_Summary_Reference_ChunkContent)(nil),                                                        // 75: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.Reference.ChunkContent
	(*SearchResponse_Summary_BlobAttachment_Blob)(nil),                                                           // 76: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.BlobAttachment.Blob
	(*SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter)(nil),                       // 77: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter
	(*SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_StringConstraint)(nil),      // 78: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.StringConstraint
	(*SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_NumberConstraint)(nil),      // 79: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.NumberConstraint
	(*SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_GeolocationConstraint)(nil), // 80: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.GeolocationConstraint
	(*SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_AndExpression)(nil),         // 81: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.AndExpression
	(*SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_OrExpression)(nil),          // 82: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.OrExpression
	(*SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_Expression)(nil),            // 83: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.Expression
	(*UserInfo)(nil),            // 84: google.cloud.discoveryengine.v1beta.UserInfo
	(*SearchLinkPromotion)(nil), // 85: google.cloud.discoveryengine.v1beta.SearchLinkPromotion
	(*structpb.Value)(nil),      // 86: google.protobuf.Value
	(*Interval)(nil),            // 87: google.cloud.discoveryengine.v1beta.Interval
	(*Document)(nil),            // 88: google.cloud.discoveryengine.v1beta.Document
	(*Chunk)(nil),               // 89: google.cloud.discoveryengine.v1beta.Chunk
	(*DoubleList)(nil),          // 90: google.cloud.discoveryengine.v1beta.DoubleList
}
var file_google_cloud_discoveryengine_v1beta_search_service_proto_depIdxs = []int32{
	21, // 0: google.cloud.discoveryengine.v1beta.SearchRequest.image_query:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.ImageQuery
	22, // 1: google.cloud.discoveryengine.v1beta.SearchRequest.data_store_specs:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.DataStoreSpec
	84, // 2: google.cloud.discoveryengine.v1beta.SearchRequest.user_info:type_name -> google.cloud.discoveryengine.v1beta.UserInfo
	23, // 3: google.cloud.discoveryengine.v1beta.SearchRequest.facet_specs:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.FacetSpec
	24, // 4: google.cloud.discoveryengine.v1beta.SearchRequest.boost_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec
	39, // 5: google.cloud.discoveryengine.v1beta.SearchRequest.params:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.ParamsEntry
	25, // 6: google.cloud.discoveryengine.v1beta.SearchRequest.query_expansion_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.QueryExpansionSpec
	26, // 7: google.cloud.discoveryengine.v1beta.SearchRequest.spell_correction_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.SpellCorrectionSpec
	27, // 8: google.cloud.discoveryengine.v1beta.SearchRequest.content_search_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec
	28, // 9: google.cloud.discoveryengine.v1beta.SearchRequest.embedding_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.EmbeddingSpec
	0,  // 10: google.cloud.discoveryengine.v1beta.SearchRequest.ranking_expression_backend:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.RankingExpressionBackend
	40, // 11: google.cloud.discoveryengine.v1beta.SearchRequest.user_labels:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.UserLabelsEntry
	29, // 12: google.cloud.discoveryengine.v1beta.SearchRequest.natural_language_query_understanding_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.NaturalLanguageQueryUnderstandingSpec
	30, // 13: google.cloud.discoveryengine.v1beta.SearchRequest.search_as_you_type_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.SearchAsYouTypeSpec
	31, // 14: google.cloud.discoveryengine.v1beta.SearchRequest.display_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.DisplaySpec
	32, // 15: google.cloud.discoveryengine.v1beta.SearchRequest.crowding_specs:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.CrowdingSpec
	33, // 16: google.cloud.discoveryengine.v1beta.SearchRequest.session_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.SessionSpec
	1,  // 17: google.cloud.discoveryengine.v1beta.SearchRequest.relevance_threshold:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceThreshold
	34, // 18: google.cloud.discoveryengine.v1beta.SearchRequest.relevance_filter_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceFilterSpec
	35, // 19: google.cloud.discoveryengine.v1beta.SearchRequest.personalization_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.PersonalizationSpec
	36, // 20: google.cloud.discoveryengine.v1beta.SearchRequest.relevance_score_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceScoreSpec
	37, // 21: google.cloud.discoveryengine.v1beta.SearchRequest.search_addon_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.SearchAddonSpec
	38, // 22: google.cloud.discoveryengine.v1beta.SearchRequest.custom_ranking_params:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.CustomRankingParams
	54, // 23: google.cloud.discoveryengine.v1beta.SearchResponse.results:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult
	55, // 24: google.cloud.discoveryengine.v1beta.SearchResponse.facets:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.Facet
	56, // 25: google.cloud.discoveryengine.v1beta.SearchResponse.guided_search_result:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.GuidedSearchResult
	57, // 26: google.cloud.discoveryengine.v1beta.SearchResponse.summary:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.Summary
	58, // 27: google.cloud.discoveryengine.v1beta.SearchResponse.geo_search_debug_info:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.GeoSearchDebugInfo
	59, // 28: google.cloud.discoveryengine.v1beta.SearchResponse.query_expansion_info:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.QueryExpansionInfo
	60, // 29: google.cloud.discoveryengine.v1beta.SearchResponse.natural_language_query_understanding_info:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo
	61, // 30: google.cloud.discoveryengine.v1beta.SearchResponse.session_info:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.SessionInfo
	62, // 31: google.cloud.discoveryengine.v1beta.SearchResponse.one_box_results:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.OneBoxResult
	85, // 32: google.cloud.discoveryengine.v1beta.SearchResponse.search_link_promotions:type_name -> google.cloud.discoveryengine.v1beta.SearchLinkPromotion
	14, // 33: google.cloud.discoveryengine.v1beta.SearchResponse.semantic_state:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.SemanticState
	24, // 34: google.cloud.discoveryengine.v1beta.SearchRequest.DataStoreSpec.boost_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec
	41, // 35: google.cloud.discoveryengine.v1beta.SearchRequest.FacetSpec.facet_key:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.FacetSpec.FacetKey
	42, // 36: google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.condition_boost_specs:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec
	4,  // 37: google.cloud.discoveryengine.v1beta.SearchRequest.QueryExpansionSpec.condition:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.QueryExpansionSpec.Condition
	5,  // 38: google.cloud.discoveryengine.v1beta.SearchRequest.SpellCorrectionSpec.mode:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.SpellCorrectionSpec.Mode
	45, // 39: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.snippet_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SnippetSpec
	46, // 40: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.summary_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec
	47, // 41: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.extractive_content_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.ExtractiveContentSpec
	6,  // 42: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.search_result_mode:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SearchResultMode
	48, // 43: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.chunk_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.ChunkSpec
	52, // 44: google.cloud.discoveryengine.v1beta.SearchRequest.EmbeddingSpec.embedding_vectors:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.EmbeddingSpec.EmbeddingVector
	8,  // 45: google.cloud.discoveryengine.v1beta.SearchRequest.NaturalLanguageQueryUnderstandingSpec.filter_extraction_condition:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.NaturalLanguageQueryUnderstandingSpec.FilterExtractionCondition
	9,  // 46: google.cloud.discoveryengine.v1beta.SearchRequest.NaturalLanguageQueryUnderstandingSpec.extracted_filter_behavior:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.NaturalLanguageQueryUnderstandingSpec.ExtractedFilterBehavior
	10, // 47: google.cloud.discoveryengine.v1beta.SearchRequest.SearchAsYouTypeSpec.condition:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.SearchAsYouTypeSpec.Condition
	11, // 48: google.cloud.discoveryengine.v1beta.SearchRequest.DisplaySpec.match_highlighting_condition:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.DisplaySpec.MatchHighlightingCondition
	12, // 49: google.cloud.discoveryengine.v1beta.SearchRequest.CrowdingSpec.mode:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.CrowdingSpec.Mode
	53, // 50: google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceFilterSpec.keyword_search_threshold:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceFilterSpec.RelevanceThresholdSpec
	53, // 51: google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceFilterSpec.semantic_search_threshold:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceFilterSpec.RelevanceThresholdSpec
	13, // 52: google.cloud.discoveryengine.v1beta.SearchRequest.PersonalizationSpec.mode:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.PersonalizationSpec.Mode
	86, // 53: google.cloud.discoveryengine.v1beta.SearchRequest.ParamsEntry.value:type_name -> google.protobuf.Value
	87, // 54: google.cloud.discoveryengine.v1beta.SearchRequest.FacetSpec.FacetKey.intervals:type_name -> google.cloud.discoveryengine.v1beta.Interval
	43, // 55: google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec.boost_control_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec
	2,  // 56: google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.attribute_type:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.AttributeType
	3,  // 57: google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.interpolation_type:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.InterpolationType
	44, // 58: google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.control_points:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.ControlPoint
	49, // 59: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.multimodal_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.MultiModalSpec
	50, // 60: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.model_prompt_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.ModelPromptSpec
	51, // 61: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.model_spec:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.ModelSpec
	7,  // 62: google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.MultiModalSpec.image_source:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.ContentSearchSpec.SummarySpec.MultiModalSpec.ImageSource
	1,  // 63: google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceFilterSpec.RelevanceThresholdSpec.relevance_threshold:type_name -> google.cloud.discoveryengine.v1beta.SearchRequest.RelevanceThreshold
	88, // 64: google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult.document:type_name -> google.cloud.discoveryengine.v1beta.Document
	89, // 65: google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult.chunk:type_name -> google.cloud.discoveryengine.v1beta.Chunk
	64, // 66: google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult.model_scores:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult.ModelScoresEntry
	63, // 67: google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult.rank_signals:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult.RankSignals
	66, // 68: google.cloud.discoveryengine.v1beta.SearchResponse.Facet.values:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.Facet.FacetValue
	67, // 69: google.cloud.discoveryengine.v1beta.SearchResponse.GuidedSearchResult.refinement_attributes:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.GuidedSearchResult.RefinementAttribute
	15, // 70: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.summary_skipped_reasons:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.Summary.SummarySkippedReason
	68, // 71: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.safety_attributes:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.Summary.SafetyAttributes
	74, // 72: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.summary_with_metadata:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.Summary.SummaryWithMetadata
	77, // 73: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.structured_extracted_filter:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter
	18, // 74: google.cloud.discoveryengine.v1beta.SearchResponse.OneBoxResult.one_box_type:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.OneBoxResult.OneBoxType
	54, // 75: google.cloud.discoveryengine.v1beta.SearchResponse.OneBoxResult.search_results:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult
	65, // 76: google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult.RankSignals.custom_signals:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult.RankSignals.CustomSignal
	90, // 77: google.cloud.discoveryengine.v1beta.SearchResponse.SearchResult.ModelScoresEntry.value:type_name -> google.cloud.discoveryengine.v1beta.DoubleList
	87, // 78: google.cloud.discoveryengine.v1beta.SearchResponse.Facet.FacetValue.interval:type_name -> google.cloud.discoveryengine.v1beta.Interval
	70, // 79: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.CitationMetadata.citations:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.Summary.Citation
	71, // 80: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.Citation.sources:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.Summary.CitationSource
	75, // 81: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.Reference.chunk_contents:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.Summary.Reference.ChunkContent
	76, // 82: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.BlobAttachment.data:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.Summary.BlobAttachment.Blob
	16, // 83: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.BlobAttachment.attribution_type:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.Summary.BlobAttachment.AttributionType
	69, // 84: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.SummaryWithMetadata.citation_metadata:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.Summary.CitationMetadata
	72, // 85: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.SummaryWithMetadata.references:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.Summary.Reference
	73, // 86: google.cloud.discoveryengine.v1beta.SearchResponse.Summary.SummaryWithMetadata.blob_attachments:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.Summary.BlobAttachment
	83, // 87: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.expression:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.Expression
	17, // 88: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.NumberConstraint.comparison:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.NumberConstraint.Comparison
	83, // 89: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.AndExpression.expressions:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.Expression
	83, // 90: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.OrExpression.expressions:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.Expression
	78, // 91: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.Expression.string_constraint:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.StringConstraint
	79, // 92: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.Expression.number_constraint:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.NumberConstraint
	80, // 93: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.Expression.geolocation_constraint:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.GeolocationConstraint
	81, // 94: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.Expression.and_expr:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.AndExpression
	82, // 95: google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.Expression.or_expr:type_name -> google.cloud.discoveryengine.v1beta.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.OrExpression
	19, // 96: google.cloud.discoveryengine.v1beta.SearchService.Search:input_type -> google.cloud.discoveryengine.v1beta.SearchRequest
	19, // 97: google.cloud.discoveryengine.v1beta.SearchService.SearchLite:input_type -> google.cloud.discoveryengine.v1beta.SearchRequest
	20, // 98: google.cloud.discoveryengine.v1beta.SearchService.Search:output_type -> google.cloud.discoveryengine.v1beta.SearchResponse
	20, // 99: google.cloud.discoveryengine.v1beta.SearchService.SearchLite:output_type -> google.cloud.discoveryengine.v1beta.SearchResponse
...
func file_google_cloud_discoveryengine_v1beta_search_service_proto_init() {
	...
	file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[14].OneofWrappers = []any{}
	file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[34].OneofWrappers = []any{
	...
	file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[44].OneofWrappers = []any{}
	file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[47].OneofWrappers = []any{
		(*SearchResponse_Facet_FacetValue_Value)(nil),
		(*SearchResponse_Facet_FacetValue_Interval)(nil),
	}
	file_google_cloud_discoveryengine_v1beta_search_service_proto_msgTypes[64].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_search_service_proto_rawDesc)),
			NumEnums:      19,
			NumMessages:   65,
			NumExtensions: 0,
			NumServices:   1,
