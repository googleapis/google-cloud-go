...
func (Chunk_StructureType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_discoveryengine_v1beta_chunk_proto_enumTypes[0].Descriptor()
}

func (Chunk_StructureType) Type() protoreflect.EnumType {
	return &file_google_cloud_discoveryengine_v1beta_chunk_proto_enumTypes[0]
}
...
func (x *Chunk_DocumentMetadata) GetMimeType() string {
	if x != nil {
		return x.MimeType
	}
	return ""
...
type Chunk_StructuredContent struct {
	...
	StructureType Chunk_StructureType `protobuf:"varint,1,opt,name=structure_type,json=structureType,proto3,enum=google.cloud.discoveryengine.v1beta.Chunk_StructureType" json:"structure_type,omitempty"`
...
func (x *Chunk_StructuredContent) Reset() {
	*x = Chunk_StructuredContent{}
	mi := &file_google_cloud_discoveryengine_v1beta_chunk_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Chunk_StructuredContent) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_chunk_proto_rawDescGZIP(), []int{0, 3}
}
...
func (x *Chunk_AnnotationMetadata) Reset() {
	*x = Chunk_AnnotationMetadata{}
	mi := &file_google_cloud_discoveryengine_v1beta_chunk_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Chunk_AnnotationMetadata) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_chunk_proto_rawDescGZIP(), []int{0, 4}
}
...
const file_google_cloud_discoveryengine_v1beta_chunk_proto_rawDesc = "" +
	"\n" +
	"/google/cloud/discoveryengine/v1beta/chunk.proto\x12#google.cloud.discoveryengine.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xcd\x0e\n" +
	"\x05Chunk\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x18\n" +
	"\acontent\x18\x03 \x01(\tR\acontent\x121\n" +
	"\x0frelevance_score\x18\b \x01(\x01B\x03\xe0A\x03H\x00R\x0erelevanceScore\x88\x01\x01\x12h\n" +
	"\x11document_metadata\x18\x05 \x01(\v2;.google.cloud.discoveryengine.v1beta.Chunk.DocumentMetadataR\x10documentMetadata\x12L\n" +
	"\x13derived_struct_data\x18\x04 \x01(\v2\x17.google.protobuf.StructB\x03\xe0A\x03R\x11derivedStructData\x12P\n" +
	"\tpage_span\x18\x06 \x01(\v23.google.cloud.discoveryengine.v1beta.Chunk.PageSpanR\bpageSpan\x12d\n" +
	"\x0echunk_metadata\x18\a \x01(\v28.google.cloud.discoveryengine.v1beta.Chunk.ChunkMetadataB\x03\xe0A\x03R\rchunkMetadata\x12 \n" +
	"\tdata_urls\x18\t \x03(\tB\x03\xe0A\x03R\bdataUrls\x124\n" +
	"\x13annotation_contents\x18\v \x03(\tB\x03\xe0A\x03R\x12annotationContents\x12s\n" +
	"\x13annotation_metadata\x18\f \x03(\v2=.google.cloud.discoveryengine.v1beta.Chunk.AnnotationMetadataB\x03\xe0A\x03R\x12annotationMetadata\x1a\x91\x01\n" +
	...
	"\bpage_end\x18\x02 \x01(\x05R\apageEnd\x1a\xb1\x01\n" +
	"\rChunkMetadata\x12S\n" +
	"\x0fprevious_chunks\x18\x01 \x03(\v2*.google.cloud.discoveryengine.v1beta.ChunkR\x0epreviousChunks\x12K\n" +
	"\vnext_chunks\x18\x02 \x03(\v2*.google.cloud.discoveryengine.v1beta.ChunkR\n" +
	"nextChunks\x1a\x98\x01\n" +
	"\x11StructuredContent\x12d\n" +
	"\x0estructure_type\x18\x01 \x01(\x0e28.google.cloud.discoveryengine.v1beta.Chunk.StructureTypeB\x03\xe0A\x03R\rstructureType\x12\x1d\n" +
	"\acontent\x18\x02 \x01(\tB\x03\xe0A\x03R\acontent\x1a\xa6\x01\n" +
	"\x12AnnotationMetadata\x12p\n" +
	"\x12structured_content\x18\x01 \x01(\v2<.google.cloud.discoveryengine.v1beta.Chunk.StructuredContentB\x03\xe0A\x03R\x11structuredContent\x12\x1e\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1beta_chunk_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1beta_chunk_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1beta_chunk_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1beta_chunk_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_chunk_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_chunk_proto_rawDesc)))
	})
	return file_google_cloud_discoveryengine_v1beta_chunk_proto_rawDescData
}

var file_google_cloud_discoveryengine_v1beta_chunk_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_cloud_discoveryengine_v1beta_chunk_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_google_cloud_discoveryengine_v1beta_chunk_proto_goTypes = []any{
	(Chunk_StructureType)(0),         // 0: google.cloud.discoveryengine.v1beta.Chunk.StructureType
	(*Chunk)(nil),                    // 1: google.cloud.discoveryengine.v1beta.Chunk
	(*Chunk_DocumentMetadata)(nil),   // 2: google.cloud.discoveryengine.v1beta.Chunk.DocumentMetadata
	(*Chunk_PageSpan)(nil),           // 3: google.cloud.discoveryengine.v1beta.Chunk.PageSpan
	(*Chunk_ChunkMetadata)(nil),      // 4: google.cloud.discoveryengine.v1beta.Chunk.ChunkMetadata
	(*Chunk_StructuredContent)(nil),  // 5: google.cloud.discoveryengine.v1beta.Chunk.StructuredContent
	(*Chunk_AnnotationMetadata)(nil), // 6: google.cloud.discoveryengine.v1beta.Chunk.AnnotationMetadata
	(*structpb.Struct)(nil),          // 7: google.protobuf.Struct
}
var file_google_cloud_discoveryengine_v1beta_chunk_proto_depIdxs = []int32{
	2,  // 0: google.cloud.discoveryengine.v1beta.Chunk.document_metadata:type_name -> google.cloud.discoveryengine.v1beta.Chunk.DocumentMetadata
	7,  // 1: google.cloud.discoveryengine.v1beta.Chunk.derived_struct_data:type_name -> google.protobuf.Struct
	3,  // 2: google.cloud.discoveryengine.v1beta.Chunk.page_span:type_name -> google.cloud.discoveryengine.v1beta.Chunk.PageSpan
	4,  // 3: google.cloud.discoveryengine.v1beta.Chunk.chunk_metadata:type_name -> google.cloud.discoveryengine.v1beta.Chunk.ChunkMetadata
	6,  // 4: google.cloud.discoveryengine.v1beta.Chunk.annotation_metadata:type_name -> google.cloud.discoveryengine.v1beta.Chunk.AnnotationMetadata
	7,  // 5: google.cloud.discoveryengine.v1beta.Chunk.DocumentMetadata.struct_data:type_name -> google.protobuf.Struct
	1,  // 6: google.cloud.discoveryengine.v1beta.Chunk.ChunkMetadata.previous_chunks:type_name -> google.cloud.discoveryengine.v1beta.Chunk
	1,  // 7: google.cloud.discoveryengine.v1beta.Chunk.ChunkMetadata.next_chunks:type_name -> google.cloud.discoveryengine.v1beta.Chunk
	0,  // 8: google.cloud.discoveryengine.v1beta.Chunk.StructuredContent.structure_type:type_name -> google.cloud.discoveryengine.v1beta.Chunk.StructureType
	5,  // 9: google.cloud.discoveryengine.v1beta.Chunk.AnnotationMetadata.structured_content:type_name -> google.cloud.discoveryengine.v1beta.Chunk.StructuredContent
...
func file_google_cloud_discoveryengine_v1beta_chunk_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_chunk_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_chunk_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		...
		EnumInfos:         file_google_cloud_discoveryengine_v1beta_chunk_proto_enumTypes,
