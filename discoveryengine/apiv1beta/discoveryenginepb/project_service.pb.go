...
var file_google_cloud_discoveryengine_v1beta_project_service_proto_goTypes = []interface{}{
...
func file_google_cloud_discoveryengine_v1beta_project_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_discoveryengine_v1beta_project_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_discoveryengine_v1beta_project_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
