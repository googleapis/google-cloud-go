...
const file_google_cloud_discoveryengine_v1beta_engine_service_proto_rawDesc = "" +
	...
	"\x06engine\x18\x02 \x01(\v2+.google.cloud.discoveryengine.v1beta.EngineB\x03\xe0A\x02R\x06engine\x12 \n" +
	...
	"\x13ListEnginesResponse\x12E\n" +
	"\aengines\x18\x01 \x03(\v2+.google.cloud.discoveryengine.v1beta.EngineR\aengines\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\x9c\x01\n" +
	"\x13UpdateEngineRequest\x12H\n" +
	"\x06engine\x18\x01 \x01(\v2+.google.cloud.discoveryengine.v1beta.EngineB\x03\xe0A\x02R\x06engine\x12;\n" +
	...
	"\fDeleteEngine\x128.google.cloud.discoveryengine.v1beta.DeleteEngineRequest\x1a\x1d.google.longrunning.Operation\"\xa0\x01\xcaAQ\n" +
	...
	"\fUpdateEngine\x128.google.cloud.discoveryengine.v1beta.UpdateEngineRequest\x1a+.google.cloud.discoveryengine.v1beta.Engine\"i\xdaA\x12engine,update_mask\x82\xd3\xe4\x93\x02N:\x06engine2D/v1beta/{engine.name=projects/*/locations/*/collections/*/engines/*}\x12\xbd\x01\n" +
	...
	"\vListEngines\x127.google.cloud.discoveryengine.v1beta.ListEnginesRequest\x1a8.google.cloud.discoveryengine.v1beta.ListEnginesResponse\"N\xdaA\x06parent\x82\xd3\xe4\x93\x02?\x12=/v1beta/{parent=projects/*/locations/*/collections/*}/engines\x12\xca\x01\n" +
	"\vPauseEngine\x127.google.cloud.discoveryengine.v1beta.PauseEngineRequest\x1a+.google.cloud.discoveryengine.v1beta.Engine\"U\xdaA\x04name\x82\xd3\xe4\x93\x02H:\x01*\"C/v1beta/{name=projects/*/locations/*/collections/*/engines/*}:pause\x12\xcd\x01\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1beta_engine_service_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1beta_engine_service_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1beta_engine_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1beta_engine_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_engine_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_engine_service_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1beta_engine_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_engine_service_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_engine_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   1,
