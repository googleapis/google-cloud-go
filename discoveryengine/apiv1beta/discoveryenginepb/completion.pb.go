...
func (SuggestionDenyListEntry_MatchOperator) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_discoveryengine_v1beta_completion_proto_enumTypes[0].Descriptor()
}

func (SuggestionDenyListEntry_MatchOperator) Type() protoreflect.EnumType {
	return &file_google_cloud_discoveryengine_v1beta_completion_proto_enumTypes[0]
}
...
func (SuggestionDenyListEntry_MatchOperator) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_completion_proto_rawDescGZIP(), []int{0, 0}
}
...
type SuggestionDenyListEntry struct {
	...
	MatchOperator SuggestionDenyListEntry_MatchOperator `protobuf:"varint,2,opt,name=match_operator,json=matchOperator,proto3,enum=google.cloud.discoveryengine.v1beta.SuggestionDenyListEntry_MatchOperator" json:"match_operator,omitempty"`
}

func (x *SuggestionDenyListEntry) Reset() {
	*x = SuggestionDenyListEntry{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_cloud_discoveryengine_v1beta_completion_proto_msgTypes[0]
...
func (*SuggestionDenyListEntry) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_completion_proto_rawDescGZIP(), []int{0}
}
...
func (x *CompletionSuggestion) Reset() {
	*x = CompletionSuggestion{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_cloud_discoveryengine_v1beta_completion_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CompletionSuggestion) Descriptor() ([]byte, []int) {
	return file_google_cloud_discoveryengine_v1beta_completion_proto_rawDescGZIP(), []int{1}
}
...
var file_google_cloud_discoveryengine_v1beta_completion_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x76, 0x69, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x89, 0x02, 0x0a,
	0x17, 0x53, 0x75, 0x67, 0x67, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x65, 0x6e, 0x79, 0x4c,
	0x69, 0x73, 0x74, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x26, 0x0a, 0x0c, 0x62, 0x6c, 0x6f, 0x63,
	0x6b, 0x5f, 0x70, 0x68, 0x72, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x03,
	0xe0, 0x41, 0x02, 0x52, 0x0b, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x50, 0x68, 0x72, 0x61, 0x73, 0x65,
	0x12, 0x76, 0x0a, 0x0e, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74,
	0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x4a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	...
	,
	...
	0x28, 0x09, 0x52, 0x07, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x67,
	0x72, 0x6f, 0x75, 0x70, 0x5f, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x01,
	0x52, 0x0a, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x2f, 0x0a, 0x13,
	0x61, 0x6c, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x70, 0x68, 0x72, 0x61,
	0x73, 0x65, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x09, 0x52, 0x12, 0x61, 0x6c, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x74, 0x69, 0x76, 0x65, 0x50, 0x68, 0x72, 0x61, 0x73, 0x65, 0x73, 0x42, 0x0e, 0x0a,
	0x0c, 0x72, 0x61, 0x6e, 0x6b, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x42, 0x96, 0x02,
	...
	0x6e, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x42, 0x0f, 0x43, 0x6f, 0x6d, 0x70, 0x6c,
	0x65, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x51, 0x63, 0x6c,
...
var (
	file_google_cloud_discoveryengine_v1beta_completion_proto_rawDescOnce sync.Once
	file_google_cloud_discoveryengine_v1beta_completion_proto_rawDescData = file_google_cloud_discoveryengine_v1beta_completion_proto_rawDesc
)

func file_google_cloud_discoveryengine_v1beta_completion_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1beta_completion_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1beta_completion_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_cloud_discoveryengine_v1beta_completion_proto_rawDescData)
	})
	return file_google_cloud_discoveryengine_v1beta_completion_proto_rawDescData
}

var file_google_cloud_discoveryengine_v1beta_completion_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_cloud_discoveryengine_v1beta_completion_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_cloud_discoveryengine_v1beta_completion_proto_goTypes = []any{
	(SuggestionDenyListEntry_MatchOperator)(0), // 0: google.cloud.discoveryengine.v1beta.SuggestionDenyListEntry.MatchOperator
	(*SuggestionDenyListEntry)(nil),            // 1: google.cloud.discoveryengine.v1beta.SuggestionDenyListEntry
	(*CompletionSuggestion)(nil),               // 2: google.cloud.discoveryengine.v1beta.CompletionSuggestion
}
var file_google_cloud_discoveryengine_v1beta_completion_proto_depIdxs = []int32{
	0, // 0: google.cloud.discoveryengine.v1beta.SuggestionDenyListEntry.match_operator:type_name -> google.cloud.discoveryengine.v1beta.SuggestionDenyListEntry.MatchOperator
...
func init() { file_google_cloud_discoveryengine_v1beta_completion_proto_init() }
func file_google_cloud_discoveryengine_v1beta_completion_proto_init() {
	if File_google_cloud_discoveryengine_v1beta_completion_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_discoveryengine_v1beta_completion_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_discoveryengine_v1beta_completion_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	file_google_cloud_discoveryengine_v1beta_completion_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_cloud_discoveryengine_v1beta_completion_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_cloud_discoveryengine_v1beta_completion_proto_goTypes,
		DependencyIndexes: file_google_cloud_discoveryengine_v1beta_completion_proto_depIdxs,
		EnumInfos:         file_google_cloud_discoveryengine_v1beta_completion_proto_enumTypes,
		MessageInfos:      file_google_cloud_discoveryengine_v1beta_completion_proto_msgTypes,
	}.Build()
	File_google_cloud_discoveryengine_v1beta_completion_proto = out.File
	file_google_cloud_discoveryengine_v1beta_completion_proto_rawDesc = nil
	file_google_cloud_discoveryengine_v1beta_completion_proto_goTypes = nil
	file_google_cloud_discoveryengine_v1beta_completion_proto_depIdxs = nil
}
