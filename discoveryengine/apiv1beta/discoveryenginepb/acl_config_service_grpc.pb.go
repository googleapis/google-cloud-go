...
const (
	AclConfigService_UpdateAclConfig_FullMethodName = "/google.cloud.discoveryengine.v1beta.AclConfigService/UpdateAclConfig"
	AclConfigService_GetAclConfig_FullMethodName    = "/google.cloud.discoveryengine.v1beta.AclConfigService/GetAclConfig"
)
...
var AclConfigService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/cloud/discoveryengine/v1beta/acl_config_service.proto",
}
