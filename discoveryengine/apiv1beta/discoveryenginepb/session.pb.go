...
const file_google_cloud_discoveryengine_v1beta_session_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/discoveryengine/v1beta/session.proto\x12#google.cloud.discoveryengine.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a0google/cloud/discoveryengine/v1beta/answer.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd9\t\n" +
	"\aSession\x12\x17\n" +
	...
	"\x05turns\x18\x04 \x03(\v21.google.cloud.discoveryengine.v1beta.Session.TurnR\x05turns\x12>\n" +
	"\n" +
	...
	"\tis_pinned\x18\b \x01(\bB\x03\xe0A\x01R\bisPinned\x1a\x9b\x03\n" +
	"\x04Turn\x12E\n" +
	...
	"\x0fdetailed_answer\x18\a \x01(\v2+.google.cloud.discoveryengine.v1beta.AnswerB\x03\xe0A\x03R\x0edetailedAnswer\x12j\n" +
	"\fquery_config\x18\x10 \x03(\v2B.google.cloud.discoveryengine.v1beta.Session.Turn.QueryConfigEntryB\x03\xe0A\x01R\vqueryConfig\x1a>\n" +
