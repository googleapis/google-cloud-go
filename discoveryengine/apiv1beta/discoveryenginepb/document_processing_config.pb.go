...
type DocumentProcessingConfig_ParsingConfig_LayoutParsingConfig struct {
	...
	EnableGetProcessedDocument bool `protobuf:"varint,14,opt,name=enable_get_processed_document,json=enableGetProcessedDocument,proto3" json:"enable_get_processed_document,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *DocumentProcessingConfig_ParsingConfig_LayoutParsingConfig) GetEnableTableAnnotation() bool {
	if x != nil {
...
func (x *DocumentProcessingConfig_ParsingConfig_LayoutParsingConfig) GetEnableImageAnnotation() bool {
	if x != nil {
...
func (x *DocumentProcessingConfig_ParsingConfig_LayoutParsingConfig) GetEnableLlmLayoutParsing() bool {
	if x != nil {
...
func (x *DocumentProcessingConfig_ParsingConfig_LayoutParsingConfig) GetStructuredContentTypes() []string {
	if x != nil {
...
func (x *DocumentProcessingConfig_ParsingConfig_LayoutParsingConfig) GetExcludeHtmlElements() []string {
	if x != nil {
...
func (x *DocumentProcessingConfig_ParsingConfig_LayoutParsingConfig) GetExcludeHtmlClasses() []string {
	if x != nil {
...
func (x *DocumentProcessingConfig_ParsingConfig_LayoutParsingConfig) GetExcludeHtmlIds() []string {
	if x != nil {
...
func (x *DocumentProcessingConfig_ParsingConfig_LayoutParsingConfig) GetEnableGetProcessedDocument() bool {
	if x != nil {
...
const file_google_cloud_discoveryengine_v1beta_document_processing_config_proto_rawDesc = "" +
	"\n" +
	"Dgoogle/cloud/discoveryengine/v1beta/document_processing_config.proto\x12#google.cloud.discoveryengine.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\xa5\x12\n" +
	...
	"\x0fuse_native_text\x18\x02 \x01(\bR\ruseNativeText\x1a\xf5\x03\n" +
	"\x13LayoutParsingConfig\x12;\n" +
	"\x17enable_table_annotation\x18\x01 \x01(\bB\x03\xe0A\x01R\x15enableTableAnnotation\x12;\n" +
	"\x17enable_image_annotation\x18\x02 \x01(\bB\x03\xe0A\x01R\x15enableImageAnnotation\x12>\n" +
	"\x19enable_llm_layout_parsing\x18\x05 \x01(\bB\x03\xe0A\x01R\x16enableLlmLayoutParsing\x12=\n" +
	"\x18structured_content_types\x18\t \x03(\tB\x03\xe0A\x01R\x16structuredContentTypes\x127\n" +
	"\x15exclude_html_elements\x18\n" +
	" \x03(\tB\x03\xe0A\x01R\x13excludeHtmlElements\x125\n" +
	"\x14exclude_html_classes\x18\v \x03(\tB\x03\xe0A\x01R\x12excludeHtmlClasses\x12-\n" +
	"\x10exclude_html_ids\x18\f \x03(\tB\x03\xe0A\x01R\x0eexcludeHtmlIds\x12F\n" +
	"\x1denable_get_processed_document\x18\x0e \x01(\bB\x03\xe0A\x01R\x1aenableGetProcessedDocumentB\x17\n" +
