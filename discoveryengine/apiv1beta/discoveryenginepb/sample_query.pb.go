...
const file_google_cloud_discoveryengine_v1beta_sample_query_proto_rawDesc = "" +
	"\n" +
	"6google/cloud/discoveryengine/v1beta/sample_query.proto\x12#google.cloud.discoveryengine.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xdb\x04\n" +
	"\vSampleQuery\x12^\n" +
	"\vquery_entry\x18\x02 \x01(\v2;.google.cloud.discoveryengine.v1beta.SampleQuery.QueryEntryH\x00R\n" +
	"queryEntry\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12@\n" +
	"\vcreate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x1a\xe9\x01\n" +
	"\n" +
	"QueryEntry\x12\x19\n" +
	"\x05query\x18\x01 \x01(\tB\x03\xe0A\x02R\x05query\x12\\\n" +
	"\atargets\x18\x03 \x03(\v2B.google.cloud.discoveryengine.v1beta.SampleQuery.QueryEntry.TargetR\atargets\x1ab\n" +
	"\x06Target\x12\x10\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1beta_sample_query_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1beta_sample_query_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1beta_sample_query_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1beta_sample_query_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_sample_query_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_sample_query_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1beta_sample_query_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_sample_query_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_sample_query_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
