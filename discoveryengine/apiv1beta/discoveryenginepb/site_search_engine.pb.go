...
const file_google_cloud_discoveryengine_v1beta_site_search_engine_proto_rawDesc = "" +
	...
	"/discoveryengine.googleapis.com/SiteSearchEngine\x12Pprojects/{project}/locations/{location}/dataStores/{data_store}/siteSearchEngine\x12iprojects/{project}/locations/{location}/collections/{collection}/dataStores/{data_store}/siteSearchEngine\"\xdd\n" +
	"\n" +
	"\n" +
	"TargetSite\x12\x17\n" +
	...
	"\vexact_match\x18\x06 \x01(\bB\x03\xe0A\x04R\n" +
	"exactMatch\x127\n" +
	...
	"\bDELETING\x10\x04:\xa1\x02\xeaA\x9d\x02\n" +
