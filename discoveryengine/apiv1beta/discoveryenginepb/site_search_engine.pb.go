...
const file_google_cloud_discoveryengine_v1beta_site_search_engine_proto_rawDesc = "" +
	"\n" +
	"<google/cloud/discoveryengine/v1beta/site_search_engine.proto\x12#google.cloud.discoveryengine.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9b\x02\n" +
	"\x10SiteSearchEngine\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name:\xf2\x01\xeaA\xee\x01\n" +
	"/discoveryengine.googleapis.com/SiteSearchEngine\x12Pprojects/{project}/locations/{location}/dataStores/{data_store}/siteSearchEngine\x12iprojects/{project}/locations/{location}/collections/{collection}/dataStores/{data_store}/siteSearchEngine\"\xfe\n" +
	"\n" +
	"\n" +
	"TargetSite\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x128\n" +
	"\x14provided_uri_pattern\x18\x02 \x01(\tB\x06\xe0A\x02\xe0A\x04R\x12providedUriPattern\x12H\n" +
	"\x04type\x18\x03 \x01(\x0e24.google.cloud.discoveryengine.v1beta.TargetSite.TypeR\x04type\x12$\n" +
	...
	" \x01(\tB\x03\xe0A\x03R\rrootDomainUri\x12t\n" +
	"\x16site_verification_info\x18\a \x01(\v29.google.cloud.discoveryengine.v1beta.SiteVerificationInfoB\x03\xe0A\x03R\x14siteVerificationInfo\x12l\n" +
	"\x0findexing_status\x18\b \x01(\x0e2>.google.cloud.discoveryengine.v1beta.TargetSite.IndexingStatusB\x03\xe0A\x03R\x0eindexingStatus\x12@\n" +
	"\vupdate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12i\n" +
	"\x0efailure_reason\x18\t \x01(\v2=.google.cloud.discoveryengine.v1beta.TargetSite.FailureReasonB\x03\xe0A\x03R\rfailureReason\x1a\xcf\x01\n" +
	"\rFailureReason\x12q\n" +
	"\rquota_failure\x18\x01 \x01(\v2J.google.cloud.discoveryengine.v1beta.TargetSite.FailureReason.QuotaFailureH\x00R\fquotaFailure\x1a@\n" +
	"\fQuotaFailure\x120\n" +
	...
	")discoveryengine.googleapis.com/TargetSite\x12jprojects/{project}/locations/{location}/dataStores/{data_store}/siteSearchEngine/targetSites/{target_site}\x12\x83\x01projects/{project}/locations/{location}/collections/{collection}/dataStores/{data_store}/siteSearchEngine/targetSites/{target_site}\"\xcb\x02\n" +
	"\x14SiteVerificationInfo\x12\x87\x01\n" +
	"\x17site_verification_state\x18\x01 \x01(\x0e2O.google.cloud.discoveryengine.v1beta.SiteVerificationInfo.SiteVerificationStateR\x15siteVerificationState\x12;\n" +
...
var (
	...
	file_google_cloud_discoveryengine_v1beta_site_search_engine_proto_rawDescData []byte
)
...
func file_google_cloud_discoveryengine_v1beta_site_search_engine_proto_rawDescGZIP() []byte {
	file_google_cloud_discoveryengine_v1beta_site_search_engine_proto_rawDescOnce.Do(func() {
		file_google_cloud_discoveryengine_v1beta_site_search_engine_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_site_search_engine_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_site_search_engine_proto_rawDesc)))
	})
...
func file_google_cloud_discoveryengine_v1beta_site_search_engine_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_discoveryengine_v1beta_site_search_engine_proto_rawDesc), len(file_google_cloud_discoveryengine_v1beta_site_search_engine_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
