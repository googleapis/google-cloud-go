...
func NewGroundedGenerationClient(ctx context.Context, opts ...option.ClientOption) (*GroundedGenerationClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.StreamGenerateGroundedContent = append(client.CallOptions.StreamGenerateGroundedContent, gax.WithClientMetrics(metrics))
		client.CallOptions.GenerateGroundedContent = append(client.CallOptions.GenerateGroundedContent, gax.WithClientMetrics(metrics))
		client.CallOptions.CheckGrounding = append(client.CallOptions.CheckGrounding, gax.WithClientMetrics(metrics))
...
func NewGroundedGenerationRESTClient(ctx context.Context, opts ...option.ClientOption) (*GroundedGenerationClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.StreamGenerateGroundedContent = append(callOpts.StreamGenerateGroundedContent, gax.WithClientMetrics(metrics))
		callOpts.GenerateGroundedContent = append(callOpts.GenerateGroundedContent, gax.WithClientMetrics(metrics))
		callOpts.CheckGrounding = append(callOpts.CheckGrounding, gax.WithClientMetrics(metrics))
...
func (c *groundedGenerationGRPCClient) StreamGenerateGroundedContent(ctx context.Context, opts ...gax.CallOption) (discoveryenginepb.GroundedGenerationService_StreamGenerateGroundedContentClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1beta.GroundedGenerationService/StreamGenerateGroundedContent")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		c.logger.DebugContext(ctx, "api streaming client request", "serviceName", serviceName, "rpcName", "StreamGenerateGroundedContent")
		resp, err = c.groundedGenerationClient.StreamGenerateGroundedContent(ctx, settings.GRPC...)
		c.logger.DebugContext(ctx, "api streaming client response", "serviceName", serviceName, "rpcName", "StreamGenerateGroundedContent")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *groundedGenerationGRPCClient) GenerateGroundedContent(ctx context.Context, req *discoveryenginepb.GenerateGroundedContentRequest, opts ...gax.CallOption) (*discoveryenginepb.GenerateGroundedContentResponse, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1beta.GroundedGenerationService/GenerateGroundedContent")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.groundedGenerationClient.GenerateGroundedContent, req, settings.GRPC, c.logger, "GenerateGroundedContent")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *groundedGenerationGRPCClient) CheckGrounding(ctx context.Context, req *discoveryenginepb.CheckGroundingRequest, opts ...gax.CallOption) (*discoveryenginepb.CheckGroundingResponse, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1beta.GroundedGenerationService/CheckGrounding")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.groundedGenerationClient.CheckGrounding, req, settings.GRPC, c.logger, "CheckGrounding")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *groundedGenerationRESTClient) GenerateGroundedContent(ctx context.Context, req *discoveryenginepb.GenerateGroundedContentRequest, opts ...gax.CallOption) (*discoveryenginepb.GenerateGroundedContentResponse, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1beta.GroundedGenerationService/GenerateGroundedContent")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1beta/{location=projects/*/locations/*}:generateGroundedContent")
	}
	opts = append((*c.CallOptions).GenerateGroundedContent[0:len((*c.CallOptions).GenerateGroundedContent):len((*c.CallOptions).GenerateGroundedContent)], opts...)
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "GenerateGroundedContent")
		if err != nil {
			return err
		}
...
func (c *groundedGenerationRESTClient) CheckGrounding(ctx context.Context, req *discoveryenginepb.CheckGroundingRequest, opts ...gax.CallOption) (*discoveryenginepb.CheckGroundingResponse, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1beta.GroundedGenerationService/CheckGrounding")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1beta/{grounding_config=projects/*/locations/*/groundingConfigs/*}:check")
	}
	opts = append((*c.CallOptions).CheckGrounding[0:len((*c.CallOptions).CheckGrounding):len((*c.CallOptions).CheckGrounding)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "CheckGrounding")
		if err != nil {
			return err
		}
