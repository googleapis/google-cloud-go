...
func main() {
	...
	req := &discoveryenginepb.UpdateCmekConfigRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/discoveryengine/apiv1beta/discoveryenginepb#UpdateCmekConfigRequest.
	}
...
// [END discoveryengine_v1beta_generated_CmekConfigService_UpdateCmekConfig_sync]
