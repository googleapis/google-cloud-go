...
func NewCloudChannelReportsClient(ctx context.Context, opts ...option.ClientOption) (*CloudChannelReportsClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.RunReportJob = append(client.CallOptions.RunReportJob, gax.WithClientMetrics(metrics))
		client.CallOptions.FetchReportResults = append(client.CallOptions.FetchReportResults, gax.WithClientMetrics(metrics))
...
func NewCloudChannelReportsRESTClient(ctx context.Context, opts ...option.ClientOption) (*CloudChannelReportsClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.RunReportJob = append(callOpts.RunReportJob, gax.WithClientMetrics(metrics))
		callOpts.FetchReportResults = append(callOpts.FetchReportResults, gax.WithClientMetrics(metrics))
...
func (c *cloudChannelReportsGRPCClient) RunReportJob(ctx context.Context, req *channelpb.RunReportJobRequest, opts ...gax.CallOption) (*RunReportJobOperation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.channel.v1.CloudChannelReportsService/RunReportJob")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.cloudChannelReportsClient.RunReportJob, req, settings.GRPC, c.logger, "RunReportJob")
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	lro := longrunning.InternalNewOperationWithMetadata(*c.LROClient, resp, "*channel.RunReportJobOperation")
...
func (c *cloudChannelReportsGRPCClient) FetchReportResults(ctx context.Context, req *channelpb.FetchReportResultsRequest, opts ...gax.CallOption) *RowIterator {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "resource_name", fmt.Sprintf("//cloudchannel.googleapis.com/%v", req.GetReportJob()))
	}
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.channel.v1.CloudChannelReportsService/FetchReportResults")
	}
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*channelpb.Row, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.cloudChannelReportsClient.FetchReportResults, req, settings.GRPC, c.logger, "FetchReportResults")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *cloudChannelReportsGRPCClient) ListReports(ctx context.Context, req *channelpb.ListReportsRequest, opts ...gax.CallOption) *ReportIterator {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.channel.v1.CloudChannelReportsService/ListReports")
	}
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*channelpb.Report, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.cloudChannelReportsClient.ListReports, req, settings.GRPC, c.logger, "ListReports")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *cloudChannelReportsRESTClient) RunReportJob(ctx context.Context, req *channelpb.RunReportJobRequest, opts ...gax.CallOption) (*RunReportJobOperation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.channel.v1.CloudChannelReportsService/RunReportJob")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1/{name=accounts/*/reports/*}:run")
	}
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "RunReportJob")
		if err != nil {
			return err
		}
...
func (c *cloudChannelReportsRESTClient) FetchReportResults(ctx context.Context, req *channelpb.FetchReportResultsRequest, opts ...gax.CallOption) *RowIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*channelpb.Row, string, error) {
		...
		e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			...
			buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "FetchReportResults")
			if err != nil {
				return err
			}
			if err := unm.Unmarshal(buf, resp); err != nil {
...
func (c *cloudChannelReportsGRPCClient) RunReportJobOperation(name string) *RunReportJobOperation {
	return &RunReportJobOperation{
		lro: longrunning.InternalNewOperationWithMetadata(*c.LROClient, &longrunningpb.Operation{Name: name}, "*channel.RunReportJobOperation"),
	}
}
