...
func (Mutation_TimestampOrigin) Descriptor() protoreflect.EnumDescriptor {
	return file_google_bigtable_v2_data_proto_enumTypes[0].Descriptor()
}

func (Mutation_TimestampOrigin) Type() protoreflect.EnumType {
	return &file_google_bigtable_v2_data_proto_enumTypes[0]
}
...
type Mutation struct {
	...
	TimestampOrigin Mutation_TimestampOrigin `protobuf:"varint,7,opt,name=timestamp_origin,json=timestampOrigin,proto3,enum=google.bigtable.v2.Mutation_TimestampOrigin" json:"timestamp_origin,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_google_bigtable_v2_data_proto_rawDesc = "" +
	"\n" +
	"\x1dgoogle/bigtable/v2/data.proto\x12\x12google.bigtable.v2\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1egoogle/bigtable/v2/types.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x16google/type/date.proto\"O\n" +
	"\x03Row\x12\x10\n" +
	"\x03key\x18\x01 \x01(\fR\x03key\x126\n" +
	"\bfamilies\x18\x02 \x03(\v2\x1a.google.bigtable.v2.FamilyR\bfamilies\"R\n" +
	"\x06Family\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x124\n" +
	"\acolumns\x18\x02 \x03(\v2\x1a.google.bigtable.v2.ColumnR\acolumns\"V\n" +
	"\x06Column\x12\x1c\n" +
	"\tqualifier\x18\x01 \x01(\fR\tqualifier\x12.\n" +
	"\x05cells\x18\x02 \x03(\v2\x18.google.bigtable.v2.CellR\x05cells\"_\n" +
	"\x04Cell\x12)\n" +
	"\x10timestamp_micros\x18\x01 \x01(\x03R\x0ftimestampMicros\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value\x12\x16\n" +
	"\x06labels\x18\x03 \x03(\tR\x06labels\"\xf9\x03\n" +
	"\x05Value\x12,\n" +
	"\x04type\x18\a \x01(\v2\x18.google.bigtable.v2.TypeR\x04type\x12\x1d\n" +
	...
	"\n" +
	"date_value\x18\r \x01(\v2\x11.google.type.DateH\x00R\tdateValue\x12A\n" +
	"\varray_value\x18\x04 \x01(\v2\x1e.google.bigtable.v2.ArrayValueH\x00R\n" +
	"arrayValueB\x06\n" +
	"\x04kind\"?\n" +
	"\n" +
	"ArrayValue\x121\n" +
	"\x06values\x18\x01 \x03(\v2\x19.google.bigtable.v2.ValueR\x06values\"\xc2\x01\n" +
	"\bRowRange\x12*\n" +
	...
	"\aend_key\"`\n" +
	"\x06RowSet\x12\x19\n" +
	"\brow_keys\x18\x01 \x03(\fR\arowKeys\x12;\n" +
	"\n" +
	"row_ranges\x18\x02 \x03(\v2\x1c.google.bigtable.v2.RowRangeR\trowRanges\"\xa2\x02\n" +
	...
	"\n" +
	"interleave\x18\x02 \x01(\v2(.google.bigtable.v2.RowFilter.InterleaveH\x00R\n" +
	"interleave\x12G\n" +
	"\tcondition\x18\x03 \x01(\v2'.google.bigtable.v2.RowFilter.ConditionH\x00R\tcondition\x12\x14\n" +
	...
	"\x1dcolumn_qualifier_regex_filter\x18\x06 \x01(\fH\x00R\x1acolumnQualifierRegexFilter\x12Q\n" +
	"\x13column_range_filter\x18\a \x01(\v2\x1f.google.bigtable.v2.ColumnRangeH\x00R\x11columnRangeFilter\x12Z\n" +
	"\x16timestamp_range_filter\x18\b \x01(\v2\".google.bigtable.v2.TimestampRangeH\x00R\x14timestampRangeFilter\x12.\n" +
	"\x12value_regex_filter\x18\t \x01(\fH\x00R\x10valueRegexFilter\x12N\n" +
	"\x12value_range_filter\x18\x0f \x01(\v2\x1e.google.bigtable.v2.ValueRangeH\x00R\x10valueRangeFilter\x12>\n" +
	...
	"\n" +
	"Interleave\x127\n" +
	"\afilters\x18\x01 \x03(\v2\x1d.google.bigtable.v2.RowFilterR\afilters\x1a\xd7\x01\n" +
	"\tCondition\x12H\n" +
	"\x10predicate_filter\x18\x01 \x01(\v2\x1d.google.bigtable.v2.RowFilterR\x0fpredicateFilter\x12>\n" +
	"\vtrue_filter\x18\x02 \x01(\v2\x1d.google.bigtable.v2.RowFilterR\n" +
	"trueFilter\x12@\n" +
	"\ffalse_filter\x18\x03 \x01(\v2\x1d.google.bigtable.v2.RowFilterR\vfalseFilterB\b\n" +
	"\x06filter\"\x8c\f\n" +
	"\bMutation\x12A\n" +
	"\bset_cell\x18\x01 \x01(\v2$.google.bigtable.v2.Mutation.SetCellH\x00R\asetCell\x12H\n" +
	"\vadd_to_cell\x18\x05 \x01(\v2&.google.bigtable.v2.Mutation.AddToCellH\x00R\taddToCell\x12N\n" +
	"\rmerge_to_cell\x18\x06 \x01(\v2(.google.bigtable.v2.Mutation.MergeToCellH\x00R\vmergeToCell\x12]\n" +
	"\x12delete_from_column\x18\x02 \x01(\v2-.google.bigtable.v2.Mutation.DeleteFromColumnH\x00R\x10deleteFromColumn\x12]\n" +
	"\x12delete_from_family\x18\x03 \x01(\v2-.google.bigtable.v2.Mutation.DeleteFromFamilyH\x00R\x10deleteFromFamily\x12T\n" +
	"\x0fdelete_from_row\x18\x04 \x01(\v2*.google.bigtable.v2.Mutation.DeleteFromRowH\x00R\rdeleteFromRow\x12\\\n" +
	"\x10timestamp_origin\x18\a \x01(\x0e2,.google.bigtable.v2.Mutation.TimestampOriginB\x03\xe0A\x01R\x0ftimestampOrigin\x1a\x96\x01\n" +
	"\aSetCell\x12\x1f\n" +
	"\vfamily_name\x18\x01 \x01(\tR\n" +
	"familyName\x12)\n" +
	"\x10column_qualifier\x18\x02 \x01(\fR\x0fcolumnQualifier\x12)\n" +
	"\x10timestamp_micros\x18\x03 \x01(\x03R\x0ftimestampMicros\x12\x14\n" +
	"\x05value\x18\x04 \x01(\fR\x05value\x1a\xdc\x01\n" +
	"\tAddToCell\x12\x1f\n" +
	"\vfamily_name\x18\x01 \x01(\tR\n" +
	"familyName\x12D\n" +
	"\x10column_qualifier\x18\x02 \x01(\v2\x19.google.bigtable.v2.ValueR\x0fcolumnQualifier\x127\n" +
	"\ttimestamp\x18\x03 \x01(\v2\x19.google.bigtable.v2.ValueR\ttimestamp\x12/\n" +
	"\x05input\x18\x04 \x01(\v2\x19.google.bigtable.v2.ValueR\x05input\x1a\xde\x01\n" +
	"\vMergeToCell\x12\x1f\n" +
	"\vfamily_name\x18\x01 \x01(\tR\n" +
	"familyName\x12D\n" +
	"\x10column_qualifier\x18\x02 \x01(\v2\x19.google.bigtable.v2.ValueR\x0fcolumnQualifier\x127\n" +
	"\ttimestamp\x18\x03 \x01(\v2\x19.google.bigtable.v2.ValueR\ttimestamp\x12/\n" +
	"\x05input\x18\x04 \x01(\v2\x19.google.bigtable.v2.ValueR\x05input\x1a\xa1\x01\n" +
	"\x10DeleteFromColumn\x12\x1f\n" +
	"\vfamily_name\x18\x01 \x01(\tR\n" +
	"familyName\x12)\n" +
	"\x10column_qualifier\x18\x02 \x01(\fR\x0fcolumnQualifier\x12A\n" +
	"\n" +
	"time_range\x18\x03 \x01(\v2\".google.bigtable.v2.TimestampRangeR\ttimeRange\x1a3\n" +
	...
	"\trow_range\x18\x01 \x01(\v2\x1c.google.bigtable.v2.RowRangeR\browRange\"_\n" +
	"\x18StreamContinuationTokens\x12C\n" +
	"\x06tokens\x18\x01 \x03(\v2+.google.bigtable.v2.StreamContinuationTokenR\x06tokens\"r\n" +
	"\x17StreamContinuationToken\x12A\n" +
	"\tpartition\x18\x01 \x01(\v2#.google.bigtable.v2.StreamPartitionR\tpartition\x12\x14\n" +
	"\x05token\x18\x02 \x01(\tR\x05token\"\r\n" +
	"\vProtoFormat\"R\n" +
	"\x0eColumnMetadata\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12,\n" +
	"\x04type\x18\x02 \x01(\v2\x18.google.bigtable.v2.TypeR\x04type\"K\n" +
	"\vProtoSchema\x12<\n" +
	"\acolumns\x18\x01 \x03(\v2\".google.bigtable.v2.ColumnMetadataR\acolumns\"c\n" +
	"\x11ResultSetMetadata\x12D\n" +
	"\fproto_schema\x18\x01 \x01(\v2\x1f.google.bigtable.v2.ProtoSchemaH\x00R\vprotoSchemaB\b\n" +
	"\x06schema\">\n" +
	"\tProtoRows\x121\n" +
	"\x06values\x18\x02 \x03(\v2\x19.google.bigtable.v2.ValueR\x06values\"/\n" +
	"\x0eProtoRowsBatch\x12\x1d\n" +
	"\n" +
	"batch_data\x18\x01 \x01(\fR\tbatchData\"\x9c\x02\n" +
	"\x10PartialResultSet\x12N\n" +
	"\x10proto_rows_batch\x18\x03 \x01(\v2\".google.bigtable.v2.ProtoRowsBatchH\x00R\x0eprotoRowsBatch\x12*\n" +
	...
	"\n" +
	"start_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTimeB\xb3\x01\n" +
...
var (
	...
	file_google_bigtable_v2_data_proto_rawDescData []byte
)

func file_google_bigtable_v2_data_proto_rawDescGZIP() []byte {
	file_google_bigtable_v2_data_proto_rawDescOnce.Do(func() {
		file_google_bigtable_v2_data_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_bigtable_v2_data_proto_rawDesc), len(file_google_bigtable_v2_data_proto_rawDesc)))
	})
	return file_google_bigtable_v2_data_proto_rawDescData
}

var file_google_bigtable_v2_data_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_google_bigtable_v2_data_proto_goTypes = []any{
	(Mutation_TimestampOrigin)(0),     // 0: google.bigtable.v2.Mutation.TimestampOrigin
	(*Row)(nil),                       // 1: google.bigtable.v2.Row
	(*Family)(nil),                    // 2: google.bigtable.v2.Family
	(*Column)(nil),                    // 3: google.bigtable.v2.Column
	(*Cell)(nil),                      // 4: google.bigtable.v2.Cell
	(*Value)(nil),                     // 5: google.bigtable.v2.Value
	(*ArrayValue)(nil),                // 6: google.bigtable.v2.ArrayValue
	(*RowRange)(nil),                  // 7: google.bigtable.v2.RowRange
	(*RowSet)(nil),                    // 8: google.bigtable.v2.RowSet
	(*ColumnRange)(nil),               // 9: google.bigtable.v2.ColumnRange
	(*TimestampRange)(nil),            // 10: google.bigtable.v2.TimestampRange
	(*ValueRange)(nil),                // 11: google.bigtable.v2.ValueRange
	(*ValueBitmask)(nil),              // 12: google.bigtable.v2.ValueBitmask
	(*RowFilter)(nil),                 // 13: google.bigtable.v2.RowFilter
	(*Mutation)(nil),                  // 14: google.bigtable.v2.Mutation
	(*ReadModifyWriteRule)(nil),       // 15: google.bigtable.v2.ReadModifyWriteRule
	(*StreamPartition)(nil),           // 16: google.bigtable.v2.StreamPartition
	(*StreamContinuationTokens)(nil),  // 17: google.bigtable.v2.StreamContinuationTokens
	(*StreamContinuationToken)(nil),   // 18: google.bigtable.v2.StreamContinuationToken
	(*ProtoFormat)(nil),               // 19: google.bigtable.v2.ProtoFormat
	(*ColumnMetadata)(nil),            // 20: google.bigtable.v2.ColumnMetadata
	(*ProtoSchema)(nil),               // 21: google.bigtable.v2.ProtoSchema
	(*ResultSetMetadata)(nil),         // 22: google.bigtable.v2.ResultSetMetadata
	(*ProtoRows)(nil),                 // 23: google.bigtable.v2.ProtoRows
	(*ProtoRowsBatch)(nil),            // 24: google.bigtable.v2.ProtoRowsBatch
	(*PartialResultSet)(nil),          // 25: google.bigtable.v2.PartialResultSet
	(*Idempotency)(nil),               // 26: google.bigtable.v2.Idempotency
	(*RowFilter_Chain)(nil),           // 27: google.bigtable.v2.RowFilter.Chain
	(*RowFilter_Interleave)(nil),      // 28: google.bigtable.v2.RowFilter.Interleave
	(*RowFilter_Condition)(nil),       // 29: google.bigtable.v2.RowFilter.Condition
	(*Mutation_SetCell)(nil),          // 30: google.bigtable.v2.Mutation.SetCell
	(*Mutation_AddToCell)(nil),        // 31: google.bigtable.v2.Mutation.AddToCell
	(*Mutation_MergeToCell)(nil),      // 32: google.bigtable.v2.Mutation.MergeToCell
	(*Mutation_DeleteFromColumn)(nil), // 33: google.bigtable.v2.Mutation.DeleteFromColumn
	(*Mutation_DeleteFromFamily)(nil), // 34: google.bigtable.v2.Mutation.DeleteFromFamily
	(*Mutation_DeleteFromRow)(nil),    // 35: google.bigtable.v2.Mutation.DeleteFromRow
	(*Type)(nil),                      // 36: google.bigtable.v2.Type
	(*timestamppb.Timestamp)(nil),     // 37: google.protobuf.Timestamp
	(*date.Date)(nil),                 // 38: google.type.Date
}
var file_google_bigtable_v2_data_proto_depIdxs = []int32{
	2,  // 0: google.bigtable.v2.Row.families:type_name -> google.bigtable.v2.Family
	3,  // 1: google.bigtable.v2.Family.columns:type_name -> google.bigtable.v2.Column
	4,  // 2: google.bigtable.v2.Column.cells:type_name -> google.bigtable.v2.Cell
	36, // 3: google.bigtable.v2.Value.type:type_name -> google.bigtable.v2.Type
	37, // 4: google.bigtable.v2.Value.timestamp_value:type_name -> google.protobuf.Timestamp
	38, // 5: google.bigtable.v2.Value.date_value:type_name -> google.type.Date
	6,  // 6: google.bigtable.v2.Value.array_value:type_name -> google.bigtable.v2.ArrayValue
	5,  // 7: google.bigtable.v2.ArrayValue.values:type_name -> google.bigtable.v2.Value
	7,  // 8: google.bigtable.v2.RowSet.row_ranges:type_name -> google.bigtable.v2.RowRange
	27, // 9: google.bigtable.v2.RowFilter.chain:type_name -> google.bigtable.v2.RowFilter.Chain
	28, // 10: google.bigtable.v2.RowFilter.interleave:type_name -> google.bigtable.v2.RowFilter.Interleave
	29, // 11: google.bigtable.v2.RowFilter.condition:type_name -> google.bigtable.v2.RowFilter.Condition
	9,  // 12: google.bigtable.v2.RowFilter.column_range_filter:type_name -> google.bigtable.v2.ColumnRange
	10, // 13: google.bigtable.v2.RowFilter.timestamp_range_filter:type_name -> google.bigtable.v2.TimestampRange
	11, // 14: google.bigtable.v2.RowFilter.value_range_filter:type_name -> google.bigtable.v2.ValueRange
	12, // 15: google.bigtable.v2.RowFilter.value_bitmask_filter:type_name -> google.bigtable.v2.ValueBitmask
	30, // 16: google.bigtable.v2.Mutation.set_cell:type_name -> google.bigtable.v2.Mutation.SetCell
	31, // 17: google.bigtable.v2.Mutation.add_to_cell:type_name -> google.bigtable.v2.Mutation.AddToCell
	32, // 18: google.bigtable.v2.Mutation.merge_to_cell:type_name -> google.bigtable.v2.Mutation.MergeToCell
	33, // 19: google.bigtable.v2.Mutation.delete_from_column:type_name -> google.bigtable.v2.Mutation.DeleteFromColumn
	34, // 20: google.bigtable.v2.Mutation.delete_from_family:type_name -> google.bigtable.v2.Mutation.DeleteFromFamily
	35, // 21: google.bigtable.v2.Mutation.delete_from_row:type_name -> google.bigtable.v2.Mutation.DeleteFromRow
	0,  // 22: google.bigtable.v2.Mutation.timestamp_origin:type_name -> google.bigtable.v2.Mutation.TimestampOrigin
	7,  // 23: google.bigtable.v2.StreamPartition.row_range:type_name -> google.bigtable.v2.RowRange
	18, // 24: google.bigtable.v2.StreamContinuationTokens.tokens:type_name -> google.bigtable.v2.StreamContinuationToken
	16, // 25: google.bigtable.v2.StreamContinuationToken.partition:type_name -> google.bigtable.v2.StreamPartition
	36, // 26: google.bigtable.v2.ColumnMetadata.type:type_name -> google.bigtable.v2.Type
	20, // 27: google.bigtable.v2.ProtoSchema.columns:type_name -> google.bigtable.v2.ColumnMetadata
	21, // 28: google.bigtable.v2.ResultSetMetadata.proto_schema:type_name -> google.bigtable.v2.ProtoSchema
	5,  // 29: google.bigtable.v2.ProtoRows.values:type_name -> google.bigtable.v2.Value
	24, // 30: google.bigtable.v2.PartialResultSet.proto_rows_batch:type_name -> google.bigtable.v2.ProtoRowsBatch
	37, // 31: google.bigtable.v2.Idempotency.start_time:type_name -> google.protobuf.Timestamp
	13, // 32: google.bigtable.v2.RowFilter.Chain.filters:type_name -> google.bigtable.v2.RowFilter
	13, // 33: google.bigtable.v2.RowFilter.Interleave.filters:type_name -> google.bigtable.v2.RowFilter
	13, // 34: google.bigtable.v2.RowFilter.Condition.predicate_filter:type_name -> google.bigtable.v2.RowFilter
	13, // 35: google.bigtable.v2.RowFilter.Condition.true_filter:type_name -> google.bigtable.v2.RowFilter
	13, // 36: google.bigtable.v2.RowFilter.Condition.false_filter:type_name -> google.bigtable.v2.RowFilter
	5,  // 37: google.bigtable.v2.Mutation.AddToCell.column_qualifier:type_name -> google.bigtable.v2.Value
	5,  // 38: google.bigtable.v2.Mutation.AddToCell.timestamp:type_name -> google.bigtable.v2.Value
	5,  // 39: google.bigtable.v2.Mutation.AddToCell.input:type_name -> google.bigtable.v2.Value
	5,  // 40: google.bigtable.v2.Mutation.MergeToCell.column_qualifier:type_name -> google.bigtable.v2.Value
	5,  // 41: google.bigtable.v2.Mutation.MergeToCell.timestamp:type_name -> google.bigtable.v2.Value
	5,  // 42: google.bigtable.v2.Mutation.MergeToCell.input:type_name -> google.bigtable.v2.Value
	10, // 43: google.bigtable.v2.Mutation.DeleteFromColumn.time_range:type_name -> google.bigtable.v2.TimestampRange
...
func file_google_bigtable_v2_data_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_google_bigtable_v2_data_proto_enumTypes,
