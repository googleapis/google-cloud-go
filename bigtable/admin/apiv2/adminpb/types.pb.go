...
const file_google_bigtable_admin_v2_types_proto_rawDesc = "" +
	"\n" +
	"$google/bigtable/admin/v2/types.proto\x12\x18google.bigtable.admin.v2\x1a\x1fgoogle/api/field_behavior.proto\"\xd3\x1d\n" +
	"\x04Type\x12E\n" +
	"\n" +
	"bytes_type\x18\x01 \x01(\v2$.google.bigtable.admin.v2.Type.BytesH\x00R\tbytesType\x12H\n" +
	"\vstring_type\x18\x02 \x01(\v2%.google.bigtable.admin.v2.Type.StringH\x00R\n" +
	"stringType\x12E\n" +
	"\n" +
	"int64_type\x18\x05 \x01(\v2$.google.bigtable.admin.v2.Type.Int64H\x00R\tint64Type\x12K\n" +
	"\ffloat32_type\x18\f \x01(\v2&.google.bigtable.admin.v2.Type.Float32H\x00R\vfloat32Type\x12K\n" +
	"\ffloat64_type\x18\t \x01(\v2&.google.bigtable.admin.v2.Type.Float64H\x00R\vfloat64Type\x12B\n" +
	"\tbool_type\x18\b \x01(\v2#.google.bigtable.admin.v2.Type.BoolH\x00R\bboolType\x12Q\n" +
	"\x0etimestamp_type\x18\n" +
	" \x01(\v2(.google.bigtable.admin.v2.Type.TimestampH\x00R\rtimestampType\x12B\n" +
	"\tdate_type\x18\v \x01(\v2#.google.bigtable.admin.v2.Type.DateH\x00R\bdateType\x12Q\n" +
	"\x0eaggregate_type\x18\x06 \x01(\v2(.google.bigtable.admin.v2.Type.AggregateH\x00R\raggregateType\x12H\n" +
	"\vstruct_type\x18\a \x01(\v2%.google.bigtable.admin.v2.Type.StructH\x00R\n" +
	"structType\x12E\n" +
	"\n" +
	"array_type\x18\x03 \x01(\v2$.google.bigtable.admin.v2.Type.ArrayH\x00R\tarrayType\x12?\n" +
	"\bmap_type\x18\x04 \x01(\v2\".google.bigtable.admin.v2.Type.MapH\x00R\amapType\x12E\n" +
	"\n" +
	"proto_type\x18\r \x01(\v2$.google.bigtable.admin.v2.Type.ProtoH\x00R\tprotoType\x12B\n" +
	"\tenum_type\x18\x0e \x01(\v2#.google.bigtable.admin.v2.Type.EnumH\x00R\benumType\x1a\xb8\x01\n" +
	"\x05Bytes\x12I\n" +
	"\bencoding\x18\x01 \x01(\v2-.google.bigtable.admin.v2.Type.Bytes.EncodingR\bencoding\x1ad\n" +
	"\bEncoding\x12E\n" +
	"\x03raw\x18\x01 \x01(\v21.google.bigtable.admin.v2.Type.Bytes.Encoding.RawH\x00R\x03raw\x1a\x05\n" +
	"\x03RawB\n" +
	"\n" +
	"\bencoding\x1a\xbd\x02\n" +
	"\x06String\x12J\n" +
	"\bencoding\x18\x01 \x01(\v2..google.bigtable.admin.v2.Type.String.EncodingR\bencoding\x1a\xe6\x01\n" +
	"\bEncoding\x12W\n" +
	"\butf8_raw\x18\x01 \x01(\v26.google.bigtable.admin.v2.Type.String.Encoding.Utf8RawB\x02\x18\x01H\x00R\autf8Raw\x12Y\n" +
	"\n" +
	"utf8_bytes\x18\x02 \x01(\v28.google.bigtable.admin.v2.Type.String.Encoding.Utf8BytesH\x00R\tutf8Bytes\x1a\r\n" +
	"\aUtf8Raw:\x02\x18\x01\x1a\v\n" +
	"\tUtf8BytesB\n" +
	"\n" +
	"\bencoding\x1a\xb4\x03\n" +
	"\x05Int64\x12I\n" +
	"\bencoding\x18\x01 \x01(\v2-.google.bigtable.admin.v2.Type.Int64.EncodingR\bencoding\x1a\xdf\x02\n" +
	"\bEncoding\x12h\n" +
	"\x10big_endian_bytes\x18\x01 \x01(\v2<.google.bigtable.admin.v2.Type.Int64.Encoding.BigEndianBytesH\x00R\x0ebigEndianBytes\x12n\n" +
	"\x12ordered_code_bytes\x18\x02 \x01(\v2>.google.bigtable.admin.v2.Type.Int64.Encoding.OrderedCodeBytesH\x00R\x10orderedCodeBytes\x1aY\n" +
	"\x0eBigEndianBytes\x12G\n" +
	"\n" +
	"bytes_type\x18\x01 \x01(\v2$.google.bigtable.admin.v2.Type.BytesB\x02\x18\x01R\tbytesType\x1a\x12\n" +
	"\x10OrderedCodeBytesB\n" +
	"\n" +
	"\bencoding\x1a\x06\n" +
	"\x04Bool\x1a\t\n" +
	"\aFloat32\x1a\t\n" +
	"\aFloat64\x1a\xcf\x01\n" +
	"\tTimestamp\x12M\n" +
	"\bencoding\x18\x01 \x01(\v21.google.bigtable.admin.v2.Type.Timestamp.EncodingR\bencoding\x1as\n" +
	"\bEncoding\x12[\n" +
	"\x11unix_micros_int64\x18\x01 \x01(\v2-.google.bigtable.admin.v2.Type.Int64.EncodingH\x00R\x0funixMicrosInt64B\n" +
	"\n" +
	"\bencoding\x1a\x06\n" +
	"\x04Date\x1a\x94\x05\n" +
	"\x06Struct\x12C\n" +
	"\x06fields\x18\x01 \x03(\v2+.google.bigtable.admin.v2.Type.Struct.FieldR\x06fields\x12J\n" +
	"\bencoding\x18\x02 \x01(\v2..google.bigtable.admin.v2.Type.Struct.EncodingR\bencoding\x1aZ\n" +
	"\x05Field\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x122\n" +
	"\x04type\x18\x02 \x01(\v2\x1e.google.bigtable.admin.v2.TypeR\x04type\x1a\x9c\x03\n" +
	"\bEncoding\x12X\n" +
	"\tsingleton\x18\x01 \x01(\v28.google.bigtable.admin.v2.Type.Struct.Encoding.SingletonH\x00R\tsingleton\x12h\n" +
	"\x0fdelimited_bytes\x18\x02 \x01(\v2=.google.bigtable.admin.v2.Type.Struct.Encoding.DelimitedBytesH\x00R\x0edelimitedBytes\x12o\n" +
	"\x12ordered_code_bytes\x18\x03 \x01(\v2?.google.bigtable.admin.v2.Type.Struct.Encoding.OrderedCodeBytesH\x00R\x10orderedCodeBytes\x1a\v\n" +
	"\tSingleton\x1a.\n" +
	...
	"\tenum_name\x18\x02 \x01(\tR\benumName\x1aJ\n" +
	"\x05Array\x12A\n" +
	"\felement_type\x18\x01 \x01(\v2\x1e.google.bigtable.admin.v2.TypeR\velementType\x1a\x7f\n" +
	"\x03Map\x129\n" +
	"\bkey_type\x18\x01 \x01(\v2\x1e.google.bigtable.admin.v2.TypeR\akeyType\x12=\n" +
	"\n" +
	"value_type\x18\x02 \x01(\v2\x1e.google.bigtable.admin.v2.TypeR\tvalueType\x1a\x92\x04\n" +
	"\tAggregate\x12=\n" +
	"\n" +
	"input_type\x18\x01 \x01(\v2\x1e.google.bigtable.admin.v2.TypeR\tinputType\x12B\n" +
	"\n" +
	"state_type\x18\x02 \x01(\v2\x1e.google.bigtable.admin.v2.TypeB\x03\xe0A\x03R\tstateType\x12@\n" +
	"\x03sum\x18\x04 \x01(\v2,.google.bigtable.admin.v2.Type.Aggregate.SumH\x00R\x03sum\x12w\n" +
	"\x12hllpp_unique_count\x18\x05 \x01(\v2G.google.bigtable.admin.v2.Type.Aggregate.HyperLogLogPlusPlusUniqueCountH\x00R\x10hllppUniqueCount\x12@\n" +
	"\x03max\x18\x06 \x01(\v2,.google.bigtable.admin.v2.Type.Aggregate.MaxH\x00R\x03max\x12@\n" +
	"\x03min\x18\a \x01(\v2,.google.bigtable.admin.v2.Type.Aggregate.MinH\x00R\x03min\x1a\x05\n" +
	"\x03Sum\x1a\x05\n" +
	"\x03Max\x1a\x05\n" +
	"\x03Min\x1a \n" +
...
var (
	...
	file_google_bigtable_admin_v2_types_proto_rawDescData []byte
)
...
func file_google_bigtable_admin_v2_types_proto_rawDescGZIP() []byte {
	file_google_bigtable_admin_v2_types_proto_rawDescOnce.Do(func() {
		file_google_bigtable_admin_v2_types_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_bigtable_admin_v2_types_proto_rawDesc), len(file_google_bigtable_admin_v2_types_proto_rawDesc)))
	})
...
func file_google_bigtable_admin_v2_types_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_bigtable_admin_v2_types_proto_rawDesc), len(file_google_bigtable_admin_v2_types_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   33,
			NumExtensions: 0,
			NumServices:   0,
