...
func file_google_cloud_gkebackup_v1_gkebackup_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_gkebackup_v1_gkebackup_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_gkebackup_v1_gkebackup_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
