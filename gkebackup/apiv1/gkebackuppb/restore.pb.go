...
func file_google_cloud_gkebackup_v1_restore_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_gkebackup_v1_restore_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_gkebackup_v1_restore_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_gkebackup_v1_restore_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_gkebackup_v1_restore_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_gkebackup_v1_restore_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_gkebackup_v1_restore_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_gkebackup_v1_restore_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_gkebackup_v1_restore_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*VolumeDataRestorePolicyOverride_SelectedPvcs)(nil),
	}
	file_google_cloud_gkebackup_v1_restore_proto_msgTypes[12].OneofWrappers = []interface{}{
