...
// NewRESTClient creates a new app connectors service rest client.
//
// API OverviewThe beyondcorp.googleapis.com service implements the Google Cloud
// BeyondCorp API.
//
...
// ListAppConnectors lists AppConnectors in a given project and location.
func (c *restClient) ListAppConnectors(ctx context.Context, req *appconnectorspb.ListAppConnectorsRequest, opts ...gax.CallOption) *AppConnectorIterator {
	it := &AppConnectorIterator{}
	req = proto.Clone(req).(*appconnectorspb.ListAppConnectorsRequest)
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*appconnectorspb.AppConnector, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v1/%v/appConnectors", req.GetParent())
...
// GetAppConnector gets details of a single AppConnector.
func (c *restClient) GetAppConnector(ctx context.Context, req *appconnectorspb.GetAppConnectorRequest, opts ...gax.CallOption) (*appconnectorspb.AppConnector, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	opts = append((*c.CallOptions).GetAppConnector[0:len((*c.CallOptions).GetAppConnector):len((*c.CallOptions).GetAppConnector)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &appconnectorspb.AppConnector{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
// CreateAppConnector creates a new AppConnector in a given project and location.
func (c *restClient) CreateAppConnector(ctx context.Context, req *appconnectorspb.CreateAppConnectorRequest, opts ...gax.CallOption) (*CreateAppConnectorOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetAppConnector()
...
// UpdateAppConnector updates the parameters of a single AppConnector.
func (c *restClient) UpdateAppConnector(ctx context.Context, req *appconnectorspb.UpdateAppConnectorRequest, opts ...gax.CallOption) (*UpdateAppConnectorOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetAppConnector()
	jsonReq, err := m.Marshal(body)
	if err != nil {
	...
	baseUrl.Path += fmt.Sprintf("/v1/%v", req.GetAppConnector().GetName())
...
// DeleteAppConnector deletes a single AppConnector.
func (c *restClient) DeleteAppConnector(ctx context.Context, req *appconnectorspb.DeleteAppConnectorRequest, opts ...gax.CallOption) (*DeleteAppConnectorOperation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// ReportStatus report status for a given connector.
func (c *restClient) ReportStatus(ctx context.Context, req *appconnectorspb.ReportStatusRequest, opts ...gax.CallOption) (*ReportStatusOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	...
	baseUrl.Path += fmt.Sprintf("/v1/%v:reportStatus", req.GetAppConnector())
...
// CreateAppConnectorOperation returns a new CreateAppConnectorOperation from a given name.
// The name must be that of a previously created CreateAppConnectorOperation, possibly from a different process.
func (c *restClient) CreateAppConnectorOperation(name string) *CreateAppConnectorOperation {
...
// DeleteAppConnectorOperation returns a new DeleteAppConnectorOperation from a given name.
// The name must be that of a previously created DeleteAppConnectorOperation, possibly from a different process.
func (c *restClient) DeleteAppConnectorOperation(name string) *DeleteAppConnectorOperation {
	override := fmt.Sprintf("/v1/%s", name)
	return &DeleteAppConnectorOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
...
// ReportStatusOperation returns a new ReportStatusOperation from a given name.
// The name must be that of a previously created ReportStatusOperation, possibly from a different process.
func (c *restClient) ReportStatusOperation(name string) *ReportStatusOperation {
	override := fmt.Sprintf("/v1/%s", name)
	return &ReportStatusOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
...
// UpdateAppConnectorOperation returns a new UpdateAppConnectorOperation from a given name.
// The name must be that of a previously created UpdateAppConnectorOperation, possibly from a different process.
func (c *restClient) UpdateAppConnectorOperation(name string) *UpdateAppConnectorOperation {
	override := fmt.Sprintf("/v1/%s", name)
	return &UpdateAppConnectorOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
