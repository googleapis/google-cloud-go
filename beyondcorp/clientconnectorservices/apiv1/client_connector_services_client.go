...
func NewClient(ctx context.Context, opts ...option.ClientOption) (*Client, error) {
	...
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		clientOpts = append(clientOpts, internaloption.WithTelemetryAttributes(map[string]string{
			"gcp.client.service":  "beyondcorp",
			"gcp.client.version":  getVersionClient(),
			"gcp.client.repo":     "googleapis/google-cloud-go",
			"gcp.client.artifact": "cloud.google.com/go/beyondcorp/clientconnectorservices/apiv1",
			"gcp.client.language": "go",
			"url.domain":          "beyondcorp.googleapis.com",
		}))
	}
	...
	if gax.IsFeatureEnabled("METRICS") {
		metrics := gax.NewClientMetrics(
			...
			gax.WithTelemetryAttributes(map[string]string{
				...
				gax.ClientArtifact: "cloud.google.com/go/beyondcorp/clientconnectorservices/apiv1",
				gax.RPCSystem:      "grpc",
				gax.URLDomain:      "beyondcorp.googleapis.com",
			}),
		)

		client.CallOptions.ListClientConnectorServices = append(client.CallOptions.ListClientConnectorServices, gax.WithClientMetrics(metrics))
		client.CallOptions.GetClientConnectorService = append(client.CallOptions.GetClientConnectorService, gax.WithClientMetrics(metrics))
		client.CallOptions.CreateClientConnectorService = append(client.CallOptions.CreateClientConnectorService, gax.WithClientMetrics(metrics))
		client.CallOptions.UpdateClientConnectorService = append(client.CallOptions.UpdateClientConnectorService, gax.WithClientMetrics(metrics))
		client.CallOptions.DeleteClientConnectorService = append(client.CallOptions.DeleteClientConnectorService, gax.WithClientMetrics(metrics))
...
func (c *gRPCClient) ListClientConnectorServices(ctx context.Context, req *clientconnectorservicespb.ListClientConnectorServicesRequest, opts ...gax.CallOption) *ClientConnectorServiceIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorServicesService/ListClientConnectorServices")
	}
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*clientconnectorservicespb.ClientConnectorService, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.client.ListClientConnectorServices, req, settings.GRPC, c.logger, "ListClientConnectorServices")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *gRPCClient) GetClientConnectorService(ctx context.Context, req *clientconnectorservicespb.GetClientConnectorServiceRequest, opts ...gax.CallOption) (*clientconnectorservicespb.ClientConnectorService, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorServicesService/GetClientConnectorService")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.GetClientConnectorService, req, settings.GRPC, c.logger, "GetClientConnectorService")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) CreateClientConnectorService(ctx context.Context, req *clientconnectorservicespb.CreateClientConnectorServiceRequest, opts ...gax.CallOption) (*CreateClientConnectorServiceOperation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorServicesService/CreateClientConnectorService")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.CreateClientConnectorService, req, settings.GRPC, c.logger, "CreateClientConnectorService")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) UpdateClientConnectorService(ctx context.Context, req *clientconnectorservicespb.UpdateClientConnectorServiceRequest, opts ...gax.CallOption) (*UpdateClientConnectorServiceOperation, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorServicesService/UpdateClientConnectorService")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.UpdateClientConnectorService, req, settings.GRPC, c.logger, "UpdateClientConnectorService")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) DeleteClientConnectorService(ctx context.Context, req *clientconnectorservicespb.DeleteClientConnectorServiceRequest, opts ...gax.CallOption) (*DeleteClientConnectorServiceOperation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorServicesService/DeleteClientConnectorService")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.DeleteClientConnectorService, req, settings.GRPC, c.logger, "DeleteClientConnectorService")
		return err
	}, opts...)
	if err != nil {
		return nil, err
