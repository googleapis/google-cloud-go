...
// NewRESTClient creates a new client connector services service rest client.
//
// API OverviewThe beyondcorp.googleapis.com service implements the Google Cloud
// BeyondCorp API.
//
...
func defaultRESTClientOptions() []option.ClientOption {
	return []option.ClientOption{
		internaloption.WithDefaultEndpoint("https://beyondcorp.googleapis.com"),
		internaloption.WithDefaultMTLSEndpoint("https://beyondcorp.mtls.googleapis.com"),
		internaloption.WithDefaultAudience("https://beyondcorp.googleapis.com/"),
		internaloption.WithDefaultScopes(DefaultAuthScopes()...),
	}
}
...
// ListClientConnectorServices lists ClientConnectorServices in a given project and location.
func (c *restClient) ListClientConnectorServices(ctx context.Context, req *clientconnectorservicespb.ListClientConnectorServicesRequest, opts ...gax.CallOption) *ClientConnectorServiceIterator {
	it := &ClientConnectorServiceIterator{}
	req = proto.Clone(req).(*clientconnectorservicespb.ListClientConnectorServicesRequest)
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*clientconnectorservicespb.ClientConnectorService, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v1/%v/clientConnectorServices", req.GetParent())
...
// GetClientConnectorService gets details of a single ClientConnectorService.
func (c *restClient) GetClientConnectorService(ctx context.Context, req *clientconnectorservicespb.GetClientConnectorServiceRequest, opts ...gax.CallOption) (*clientconnectorservicespb.ClientConnectorService, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	opts = append((*c.CallOptions).GetClientConnectorService[0:len((*c.CallOptions).GetClientConnectorService):len((*c.CallOptions).GetClientConnectorService)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &clientconnectorservicespb.ClientConnectorService{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
// CreateClientConnectorService creates a new ClientConnectorService in a given project and location.
func (c *restClient) CreateClientConnectorService(ctx context.Context, req *clientconnectorservicespb.CreateClientConnectorServiceRequest, opts ...gax.CallOption) (*CreateClientConnectorServiceOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetClientConnectorService()
	...
	params := url.Values{}
	if req.GetClientConnectorServiceId() != "" {
		params.Add("clientConnectorServiceId", fmt.Sprintf("%v", req.GetClientConnectorServiceId()))
	}
	if req.GetRequestId() != "" {
...
// UpdateClientConnectorService updates the parameters of a single ClientConnectorService.
func (c *restClient) UpdateClientConnectorService(ctx context.Context, req *clientconnectorservicespb.UpdateClientConnectorServiceRequest, opts ...gax.CallOption) (*UpdateClientConnectorServiceOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetClientConnectorService()
	jsonReq, err := m.Marshal(body)
	if err != nil {
	...
	baseUrl.Path += fmt.Sprintf("/v1/%v", req.GetClientConnectorService().GetName())
...
// DeleteClientConnectorService deletes a single ClientConnectorService.
func (c *restClient) DeleteClientConnectorService(ctx context.Context, req *clientconnectorservicespb.DeleteClientConnectorServiceRequest, opts ...gax.CallOption) (*DeleteClientConnectorServiceOperation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// CreateClientConnectorServiceOperation returns a new CreateClientConnectorServiceOperation from a given name.
// The name must be that of a previously created CreateClientConnectorServiceOperation, possibly from a different process.
func (c *restClient) CreateClientConnectorServiceOperation(name string) *CreateClientConnectorServiceOperation {
...
// DeleteClientConnectorServiceOperation returns a new DeleteClientConnectorServiceOperation from a given name.
// The name must be that of a previously created DeleteClientConnectorServiceOperation, possibly from a different process.
func (c *restClient) DeleteClientConnectorServiceOperation(name string) *DeleteClientConnectorServiceOperation {
	override := fmt.Sprintf("/v1/%s", name)
	return &DeleteClientConnectorServiceOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
...
// UpdateClientConnectorServiceOperation returns a new UpdateClientConnectorServiceOperation from a given name.
// The name must be that of a previously created UpdateClientConnectorServiceOperation, possibly from a different process.
func (c *restClient) UpdateClientConnectorServiceOperation(name string) *UpdateClientConnectorServiceOperation {
	override := fmt.Sprintf("/v1/%s", name)
	return &UpdateClientConnectorServiceOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
