...
// NewRESTClient creates a new app gateways service rest client.
//
// API OverviewThe beyondcorp.googleapis.com service implements the Google Cloud
// BeyondCorp API.
//
...
// ListAppGateways lists AppGateways in a given project and location.
func (c *restClient) ListAppGateways(ctx context.Context, req *appgatewayspb.ListAppGatewaysRequest, opts ...gax.CallOption) *AppGatewayIterator {
	it := &AppGatewayIterator{}
	req = proto.Clone(req).(*appgatewayspb.ListAppGatewaysRequest)
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*appgatewayspb.AppGateway, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v1/%v/appGateways", req.GetParent())
...
// GetAppGateway gets details of a single AppGateway.
func (c *restClient) GetAppGateway(ctx context.Context, req *appgatewayspb.GetAppGatewayRequest, opts ...gax.CallOption) (*appgatewayspb.AppGateway, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// CreateAppGateway creates a new AppGateway in a given project and location.
func (c *restClient) CreateAppGateway(ctx context.Context, req *appgatewayspb.CreateAppGatewayRequest, opts ...gax.CallOption) (*CreateAppGatewayOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetAppGateway()
	...
	params := url.Values{}
	if req.GetAppGatewayId() != "" {
		params.Add("appGatewayId", fmt.Sprintf("%v", req.GetAppGatewayId()))
	}
	if req.GetRequestId() != "" {
...
// DeleteAppGateway deletes a single AppGateway.
func (c *restClient) DeleteAppGateway(ctx context.Context, req *appgatewayspb.DeleteAppGatewayRequest, opts ...gax.CallOption) (*DeleteAppGatewayOperation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// CreateAppGatewayOperation returns a new CreateAppGatewayOperation from a given name.
// The name must be that of a previously created CreateAppGatewayOperation, possibly from a different process.
func (c *restClient) CreateAppGatewayOperation(name string) *CreateAppGatewayOperation {
...
// DeleteAppGatewayOperation returns a new DeleteAppGatewayOperation from a given name.
// The name must be that of a previously created DeleteAppGatewayOperation, possibly from a different process.
func (c *restClient) DeleteAppGatewayOperation(name string) *DeleteAppGatewayOperation {
	override := fmt.Sprintf("/v1/%s", name)
	return &DeleteAppGatewayOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
