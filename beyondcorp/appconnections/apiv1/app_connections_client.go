...
func NewClient(ctx context.Context, opts ...option.ClientOption) (*Client, error) {
	...
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		clientOpts = append(clientOpts, internaloption.WithTelemetryAttributes(map[string]string{
			...
			"gcp.client.artifact": "cloud.google.com/go/beyondcorp/appconnections/apiv1",
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.ListAppConnections = append(client.CallOptions.ListAppConnections, gax.WithClientMetrics(metrics))
		client.CallOptions.GetAppConnection = append(client.CallOptions.GetAppConnection, gax.WithClientMetrics(metrics))
		client.CallOptions.CreateAppConnection = append(client.CallOptions.CreateAppConnection, gax.WithClientMetrics(metrics))
		client.CallOptions.UpdateAppConnection = append(client.CallOptions.UpdateAppConnection, gax.WithClientMetrics(metrics))
		client.CallOptions.DeleteAppConnection = append(client.CallOptions.DeleteAppConnection, gax.WithClientMetrics(metrics))
		client.CallOptions.ResolveAppConnections = append(client.CallOptions.ResolveAppConnections, gax.WithClientMetrics(metrics))
...
func (c *gRPCClient) ListAppConnections(ctx context.Context, req *appconnectionspb.ListAppConnectionsRequest, opts ...gax.CallOption) *AppConnectionIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*appconnectionspb.AppConnection, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.client.ListAppConnections, req, settings.GRPC, c.logger, "ListAppConnections")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *gRPCClient) GetAppConnection(ctx context.Context, req *appconnectionspb.GetAppConnectionRequest, opts ...gax.CallOption) (*appconnectionspb.AppConnection, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.GetAppConnection, req, settings.GRPC, c.logger, "GetAppConnection")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) CreateAppConnection(ctx context.Context, req *appconnectionspb.CreateAppConnectionRequest, opts ...gax.CallOption) (*CreateAppConnectionOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.CreateAppConnection, req, settings.GRPC, c.logger, "CreateAppConnection")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) UpdateAppConnection(ctx context.Context, req *appconnectionspb.UpdateAppConnectionRequest, opts ...gax.CallOption) (*UpdateAppConnectionOperation, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.beyondcorp.appconnections.v1.AppConnectionsService/UpdateAppConnection")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.UpdateAppConnection, req, settings.GRPC, c.logger, "UpdateAppConnection")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) DeleteAppConnection(ctx context.Context, req *appconnectionspb.DeleteAppConnectionRequest, opts ...gax.CallOption) (*DeleteAppConnectionOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.DeleteAppConnection, req, settings.GRPC, c.logger, "DeleteAppConnection")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) ResolveAppConnections(ctx context.Context, req *appconnectionspb.ResolveAppConnectionsRequest, opts ...gax.CallOption) *ResolveAppConnectionsResponse_AppConnectionDetailsIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*appconnectionspb.ResolveAppConnectionsResponse_AppConnectionDetails, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.client.ResolveAppConnections, req, settings.GRPC, c.logger, "ResolveAppConnections")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
