...
func NewClient(ctx context.Context, opts ...option.ClientOption) (*Client, error) {
	...
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		clientOpts = append(clientOpts, internaloption.WithTelemetryAttributes(map[string]string{
			...
			"gcp.client.artifact": "cloud.google.com/go/beyondcorp/clientgateways/apiv1",
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.ListClientGateways = append(client.CallOptions.ListClientGateways, gax.WithClientMetrics(metrics))
		client.CallOptions.GetClientGateway = append(client.CallOptions.GetClientGateway, gax.WithClientMetrics(metrics))
		client.CallOptions.CreateClientGateway = append(client.CallOptions.CreateClientGateway, gax.WithClientMetrics(metrics))
		client.CallOptions.DeleteClientGateway = append(client.CallOptions.DeleteClientGateway, gax.WithClientMetrics(metrics))
...
func (c *gRPCClient) ListClientGateways(ctx context.Context, req *clientgatewayspb.ListClientGatewaysRequest, opts ...gax.CallOption) *ClientGatewayIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*clientgatewayspb.ClientGateway, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.client.ListClientGateways, req, settings.GRPC, c.logger, "ListClientGateways")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *gRPCClient) GetClientGateway(ctx context.Context, req *clientgatewayspb.GetClientGatewayRequest, opts ...gax.CallOption) (*clientgatewayspb.ClientGateway, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.GetClientGateway, req, settings.GRPC, c.logger, "GetClientGateway")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) CreateClientGateway(ctx context.Context, req *clientgatewayspb.CreateClientGatewayRequest, opts ...gax.CallOption) (*CreateClientGatewayOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.CreateClientGateway, req, settings.GRPC, c.logger, "CreateClientGateway")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) DeleteClientGateway(ctx context.Context, req *clientgatewayspb.DeleteClientGatewayRequest, opts ...gax.CallOption) (*DeleteClientGatewayOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.DeleteClientGateway, req, settings.GRPC, c.logger, "DeleteClientGateway")
		return err
	}, opts...)
	if err != nil {
		return nil, err
