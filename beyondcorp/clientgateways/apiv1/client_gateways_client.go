...
// NewRESTClient creates a new client gateways service rest client.
//
// API OverviewThe beyondcorp.googleapis.com service implements the Google Cloud
// BeyondCorp API.
//
...
// ListClientGateways lists ClientGateways in a given project and location.
func (c *restClient) ListClientGateways(ctx context.Context, req *clientgatewayspb.ListClientGatewaysRequest, opts ...gax.CallOption) *ClientGatewayIterator {
	it := &ClientGatewayIterator{}
	req = proto.Clone(req).(*clientgatewayspb.ListClientGatewaysRequest)
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*clientgatewayspb.ClientGateway, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v1/%v/clientGateways", req.GetParent())
...
// GetClientGateway gets details of a single ClientGateway.
func (c *restClient) GetClientGateway(ctx context.Context, req *clientgatewayspb.GetClientGatewayRequest, opts ...gax.CallOption) (*clientgatewayspb.ClientGateway, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	opts = append((*c.CallOptions).GetClientGateway[0:len((*c.CallOptions).GetClientGateway):len((*c.CallOptions).GetClientGateway)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &clientgatewayspb.ClientGateway{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
// CreateClientGateway creates a new ClientGateway in a given project and location.
func (c *restClient) CreateClientGateway(ctx context.Context, req *clientgatewayspb.CreateClientGatewayRequest, opts ...gax.CallOption) (*CreateClientGatewayOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetClientGateway()
...
// DeleteClientGateway deletes a single ClientGateway.
func (c *restClient) DeleteClientGateway(ctx context.Context, req *clientgatewayspb.DeleteClientGatewayRequest, opts ...gax.CallOption) (*DeleteClientGatewayOperation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// CreateClientGatewayOperation returns a new CreateClientGatewayOperation from a given name.
// The name must be that of a previously created CreateClientGatewayOperation, possibly from a different process.
func (c *restClient) CreateClientGatewayOperation(name string) *CreateClientGatewayOperation {
...
// DeleteClientGatewayOperation returns a new DeleteClientGatewayOperation from a given name.
// The name must be that of a previously created DeleteClientGatewayOperation, possibly from a different process.
func (c *restClient) DeleteClientGatewayOperation(name string) *DeleteClientGatewayOperation {
	override := fmt.Sprintf("/v1/%s", name)
	return &DeleteClientGatewayOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
