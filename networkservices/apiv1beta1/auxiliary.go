...
// CreateExtensionBindingOperation manages a long-running operation from CreateExtensionBinding.
type CreateExtensionBindingOperation struct {
	lro      *longrunning.Operation
	pollPath string
}
...
//
// See documentation of Poll for error-handling information.
func (op *CreateExtensionBindingOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*networkservicespb.ExtensionBinding, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *CreateExtensionBindingOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*networkservicespb.ExtensionBinding, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp networkservicespb.ExtensionBinding
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *CreateExtensionBindingOperation) Metadata() (*networkservicespb.OperationMetadata, error) {
	var meta networkservicespb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *CreateExtensionBindingOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *CreateExtensionBindingOperation) Name() string {
	return op.lro.Name()
}
...
// DeleteExtensionBindingOperation manages a long-running operation from DeleteExtensionBinding.
type DeleteExtensionBindingOperation struct {
	lro      *longrunning.Operation
	pollPath string
}
...
//
// See documentation of Poll for error-handling information.
func (op *DeleteExtensionBindingOperation) Wait(ctx context.Context, opts ...gax.CallOption) error {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	return op.lro.WaitWithInterval(ctx, nil, time.Minute, opts...)
}
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *DeleteExtensionBindingOperation) Poll(ctx context.Context, opts ...gax.CallOption) error {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	return op.lro.Poll(ctx, nil, opts...)
}
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *DeleteExtensionBindingOperation) Metadata() (*networkservicespb.OperationMetadata, error) {
	var meta networkservicespb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *DeleteExtensionBindingOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *DeleteExtensionBindingOperation) Name() string {
	return op.lro.Name()
}
...
// UpdateExtensionBindingOperation manages a long-running operation from UpdateExtensionBinding.
type UpdateExtensionBindingOperation struct {
	lro      *longrunning.Operation
	pollPath string
}
...
//
// See documentation of Poll for error-handling information.
func (op *UpdateExtensionBindingOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*networkservicespb.ExtensionBinding, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp networkservicespb.ExtensionBinding
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *UpdateExtensionBindingOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*networkservicespb.ExtensionBinding, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp networkservicespb.ExtensionBinding
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *UpdateExtensionBindingOperation) Metadata() (*networkservicespb.OperationMetadata, error) {
	var meta networkservicespb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *UpdateExtensionBindingOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *UpdateExtensionBindingOperation) Name() string {
	return op.lro.Name()
}
...
// All returns an iterator. If an error is returned by the iterator, the
// iterator will stop after that iteration.
func (it *ExtensionBindingIterator) All() iter.Seq2[*networkservicespb.ExtensionBinding, error] {
	return gaxiter.RangeAdapter(it.Next)
}

// ExtensionBindingIterator manages a stream of *networkservicespb.ExtensionBinding.
type ExtensionBindingIterator struct {
	items    []*networkservicespb.ExtensionBinding
	pageInfo *iterator.PageInfo
	nextFunc func() error
	...
	// The number of results is no greater than pageSize.
	// If there are no more results, nextPageToken is empty and err is nil.
	InternalFetch func(pageSize int, pageToken string) (results []*networkservicespb.ExtensionBinding, nextPageToken string, err error)
}

// PageInfo supports pagination. See the [google.golang.org/api/iterator] package for details.
func (it *ExtensionBindingIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *ExtensionBindingIterator) Next() (*networkservicespb.ExtensionBinding, error) {
	var item *networkservicespb.ExtensionBinding
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *ExtensionBindingIterator) bufLen() int {
	return len(it.items)
}

func (it *ExtensionBindingIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
