...
const file_google_cloud_networkservices_v1beta1_common_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/networkservices/v1beta1/common.proto\x12$google.cloud.networkservices.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd5\x02\n" +
	...
	"\x05ports\x18\x01 \x03(\tB\x03\xe0A\x01R\x05ports\"\xb6\x05\n" +
	"\x0fEndpointMatcher\x12\x82\x01\n" +
	"\x16metadata_label_matcher\x18\x01 \x01(\v2J.google.cloud.networkservices.v1beta1.EndpointMatcher.MetadataLabelMatcherH\x00R\x14metadataLabelMatcher\x1a\x8d\x04\n" +
	"\x14MetadataLabelMatcher\x12\xa8\x01\n" +
	"\x1dmetadata_label_match_criteria\x18\x01 \x01(\x0e2e.google.cloud.networkservices.v1beta1.EndpointMatcher.MetadataLabelMatcher.MetadataLabelMatchCriteriaR\x1ametadataLabelMatchCriteria\x12\x82\x01\n" +
	"\x0fmetadata_labels\x18\x02 \x03(\v2Y.google.cloud.networkservices.v1beta1.EndpointMatcher.MetadataLabelMatcher.MetadataLabelsR\x0emetadataLabels\x1aZ\n" +
	...
	"\fmatcher_typeB\x85\x02\n" +
	"(com.google.cloud.networkservices.v1beta1B\vCommonProtoP\x01ZRcloud.google.com/go/networkservices/apiv1beta1/networkservicespb;networkservicespb\xaa\x02$Google.Cloud.NetworkServices.V1Beta1\xca\x02$Google\\Cloud\\NetworkServices\\V1beta1\xea\x02'Google::Cloud::NetworkServices::V1beta1b\x06proto3"

var (
	file_google_cloud_networkservices_v1beta1_common_proto_rawDescOnce sync.Once
	file_google_cloud_networkservices_v1beta1_common_proto_rawDescData []byte
)
...
func file_google_cloud_networkservices_v1beta1_common_proto_rawDescGZIP() []byte {
	file_google_cloud_networkservices_v1beta1_common_proto_rawDescOnce.Do(func() {
		file_google_cloud_networkservices_v1beta1_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_networkservices_v1beta1_common_proto_rawDesc), len(file_google_cloud_networkservices_v1beta1_common_proto_rawDesc)))
	})
...
var file_google_cloud_networkservices_v1beta1_common_proto_goTypes = []any{
...
func file_google_cloud_networkservices_v1beta1_common_proto_init() {
	...
	file_google_cloud_networkservices_v1beta1_common_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_networkservices_v1beta1_common_proto_rawDesc), len(file_google_cloud_networkservices_v1beta1_common_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
