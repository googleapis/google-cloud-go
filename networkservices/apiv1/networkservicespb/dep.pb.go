...
const (
	...
	WireFormat_EXT_AUTHZ_GRPC WireFormat = 3
)
...
const (
	// Default value. Do not use.
	BodySendMode_BODY_SEND_MODE_UNSPECIFIED BodySendMode = 0
	...
	BodySendMode_BODY_SEND_MODE_STREAMED BodySendMode = 1
	...
	BodySendMode_BODY_SEND_MODE_FULL_DUPLEX_STREAMED BodySendMode = 2
)

// Enum value maps for BodySendMode.
var (
	BodySendMode_name = map[int32]string{
		0: "BODY_SEND_MODE_UNSPECIFIED",
		1: "BODY_SEND_MODE_STREAMED",
		2: "BODY_SEND_MODE_FULL_DUPLEX_STREAMED",
	}
...
func (BodySendMode) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_networkservices_v1_dep_proto_enumTypes[3].Descriptor()
}

func (BodySendMode) Type() protoreflect.EnumType {
	return &file_google_cloud_networkservices_v1_dep_proto_enumTypes[3]
}
...
type AuthzExtension struct {
	...
	// attribute name.
	ForwardAttributes []string `protobuf:"bytes,13,rep,name=forward_attributes,json=forwardAttributes,proto3" json:"forward_attributes,omitempty"`
...
func (x *AuthzExtension) GetForwardAttributes() []string {
	if x != nil {
		return x.ForwardAttributes
	}
	return nil
}
...
type ExtensionChain_Extension struct {
	...
	// attributes are sent. Each element is a string indicating the
	// attribute name.
	ForwardAttributes []string `protobuf:"bytes,8,rep,name=forward_attributes,json=forwardAttributes,proto3" json:"forward_attributes,omitempty"`
	// Optional. The metadata provided here is included as part of the
	// `metadata_context` (of type `google.protobuf.Struct`) in the
	// `ProcessingRequest` message sent to the extension server.
	//
	...
	RequestBodySendMode BodySendMode `protobuf:"varint,14,opt,name=request_body_send_mode,json=requestBodySendMode,proto3,enum=google.cloud.networkservices.v1.BodySendMode" json:"request_body_send_mode,omitempty"`
	...
	ResponseBodySendMode BodySendMode `protobuf:"varint,15,opt,name=response_body_send_mode,json=responseBodySendMode,proto3,enum=google.cloud.networkservices.v1.BodySendMode" json:"response_body_send_mode,omitempty"`
	...
	// resources.
	ObservabilityMode bool `protobuf:"varint,16,opt,name=observability_mode,json=observabilityMode,proto3" json:"observability_mode,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ExtensionChain_Extension) GetForwardAttributes() []string {
	if x != nil {
		return x.ForwardAttributes
	}
	return nil
...
func (x *ExtensionChain_Extension) GetRequestBodySendMode() BodySendMode {
	if x != nil {
		return x.RequestBodySendMode
	}
	return BodySendMode_BODY_SEND_MODE_UNSPECIFIED
}

func (x *ExtensionChain_Extension) GetResponseBodySendMode() BodySendMode {
	if x != nil {
		return x.ResponseBodySendMode
	}
	return BodySendMode_BODY_SEND_MODE_UNSPECIFIED
}

func (x *ExtensionChain_Extension) GetObservabilityMode() bool {
	if x != nil {
...
const file_google_cloud_networkservices_v1_dep_proto_rawDesc = "" +
	...
	"\x0ecel_expression\x18\x01 \x01(\tB\x03\xe0A\x02R\rcelExpression\x1a\xc2\x05\n" +
	"\tExtension\x12\x17\n" +
	...
	"\x0fforward_headers\x18\a \x03(\tB\x03\xe0A\x01R\x0eforwardHeaders\x122\n" +
	"\x12forward_attributes\x18\b \x03(\tB\x03\xe0A\x01R\x11forwardAttributes\x128\n" +
	"\bmetadata\x18\t \x01(\v2\x17.google.protobuf.StructB\x03\xe0A\x01R\bmetadata\x12g\n" +
	"\x16request_body_send_mode\x18\x0e \x01(\x0e2-.google.cloud.networkservices.v1.BodySendModeB\x03\xe0A\x01R\x13requestBodySendMode\x12i\n" +
	"\x17response_body_send_mode\x18\x0f \x01(\x0e2-.google.cloud.networkservices.v1.BodySendModeB\x03\xe0A\x01R\x14responseBodySendMode\x122\n" +
	"\x12observability_mode\x18\x10 \x01(\bB\x03\xe0A\x01R\x11observabilityMode\"\xe5\x06\n" +
	...
	"\n" +
	"request_id\x18\x02 \x01(\tB\v\xe0A\x01\xe2\x8c\xcf\xd7\b\x02\b\x01R\trequestId\"\x8a\b\n" +
	...
	"\x15load_balancing_scheme\x18\x06 \x01(\x0e24.google.cloud.networkservices.v1.LoadBalancingSchemeB\x03\xe0A\x01R\x13loadBalancingScheme\x12!\n" +
	"\tauthority\x18\a \x01(\tB\x03\xe0A\x01R\tauthority\x12\x1d\n" +
	...
	"\x0fforward_headers\x18\f \x03(\tB\x03\xe0A\x01R\x0eforwardHeaders\x122\n" +
	"\x12forward_attributes\x18\r \x03(\tB\x03\xe0A\x01R\x11forwardAttributes\x12Q\n" +
	...
	"\x10EXTERNAL_MANAGED\x10\x02*P\n" +
	"\n" +
	"WireFormat\x12\x1b\n" +
	"\x17WIRE_FORMAT_UNSPECIFIED\x10\x00\x12\x11\n" +
	"\rEXT_PROC_GRPC\x10\x01\x12\x12\n" +
	"\x0eEXT_AUTHZ_GRPC\x10\x03*t\n" +
	"\fBodySendMode\x12\x1e\n" +
	"\x1aBODY_SEND_MODE_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17BODY_SEND_MODE_STREAMED\x10\x01\x12'\n" +
	"#BODY_SEND_MODE_FULL_DUPLEX_STREAMED\x10\x022\xf9'\n" +
	"\n" +
...
var file_google_cloud_networkservices_v1_dep_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_google_cloud_networkservices_v1_dep_proto_goTypes = []any{
	...
	(BodySendMode)(0),                       // 3: google.cloud.networkservices.v1.BodySendMode
	(*ExtensionChain)(nil),                  // 4: google.cloud.networkservices.v1.ExtensionChain
	(*LbTrafficExtension)(nil),              // 5: google.cloud.networkservices.v1.LbTrafficExtension
	(*ListLbTrafficExtensionsRequest)(nil),  // 6: google.cloud.networkservices.v1.ListLbTrafficExtensionsRequest
	(*ListLbTrafficExtensionsResponse)(nil), // 7: google.cloud.networkservices.v1.ListLbTrafficExtensionsResponse
	(*GetLbTrafficExtensionRequest)(nil),    // 8: google.cloud.networkservices.v1.GetLbTrafficExtensionRequest
	(*CreateLbTrafficExtensionRequest)(nil), // 9: google.cloud.networkservices.v1.CreateLbTrafficExtensionRequest
	(*UpdateLbTrafficExtensionRequest)(nil), // 10: google.cloud.networkservices.v1.UpdateLbTrafficExtensionRequest
	(*DeleteLbTrafficExtensionRequest)(nil), // 11: google.cloud.networkservices.v1.DeleteLbTrafficExtensionRequest
	(*LbRouteExtension)(nil),                // 12: google.cloud.networkservices.v1.LbRouteExtension
	(*ListLbRouteExtensionsRequest)(nil),    // 13: google.cloud.networkservices.v1.ListLbRouteExtensionsRequest
	(*ListLbRouteExtensionsResponse)(nil),   // 14: google.cloud.networkservices.v1.ListLbRouteExtensionsResponse
	(*GetLbRouteExtensionRequest)(nil),      // 15: google.cloud.networkservices.v1.GetLbRouteExtensionRequest
	(*CreateLbRouteExtensionRequest)(nil),   // 16: google.cloud.networkservices.v1.CreateLbRouteExtensionRequest
	(*UpdateLbRouteExtensionRequest)(nil),   // 17: google.cloud.networkservices.v1.UpdateLbRouteExtensionRequest
	(*DeleteLbRouteExtensionRequest)(nil),   // 18: google.cloud.networkservices.v1.DeleteLbRouteExtensionRequest
	(*LbEdgeExtension)(nil),                 // 19: google.cloud.networkservices.v1.LbEdgeExtension
	(*ListLbEdgeExtensionsRequest)(nil),     // 20: google.cloud.networkservices.v1.ListLbEdgeExtensionsRequest
	(*ListLbEdgeExtensionsResponse)(nil),    // 21: google.cloud.networkservices.v1.ListLbEdgeExtensionsResponse
	(*GetLbEdgeExtensionRequest)(nil),       // 22: google.cloud.networkservices.v1.GetLbEdgeExtensionRequest
	(*CreateLbEdgeExtensionRequest)(nil),    // 23: google.cloud.networkservices.v1.CreateLbEdgeExtensionRequest
	(*UpdateLbEdgeExtensionRequest)(nil),    // 24: google.cloud.networkservices.v1.UpdateLbEdgeExtensionRequest
	(*DeleteLbEdgeExtensionRequest)(nil),    // 25: google.cloud.networkservices.v1.DeleteLbEdgeExtensionRequest
	(*AuthzExtension)(nil),                  // 26: google.cloud.networkservices.v1.AuthzExtension
	(*ListAuthzExtensionsRequest)(nil),      // 27: google.cloud.networkservices.v1.ListAuthzExtensionsRequest
	(*ListAuthzExtensionsResponse)(nil),     // 28: google.cloud.networkservices.v1.ListAuthzExtensionsResponse
	(*GetAuthzExtensionRequest)(nil),        // 29: google.cloud.networkservices.v1.GetAuthzExtensionRequest
	(*CreateAuthzExtensionRequest)(nil),     // 30: google.cloud.networkservices.v1.CreateAuthzExtensionRequest
	(*UpdateAuthzExtensionRequest)(nil),     // 31: google.cloud.networkservices.v1.UpdateAuthzExtensionRequest
	(*DeleteAuthzExtensionRequest)(nil),     // 32: google.cloud.networkservices.v1.DeleteAuthzExtensionRequest
	(*ExtensionChain_MatchCondition)(nil),   // 33: google.cloud.networkservices.v1.ExtensionChain.MatchCondition
	(*ExtensionChain_Extension)(nil),        // 34: google.cloud.networkservices.v1.ExtensionChain.Extension
	nil,                                     // 35: google.cloud.networkservices.v1.LbTrafficExtension.LabelsEntry
	nil,                                     // 36: google.cloud.networkservices.v1.LbRouteExtension.LabelsEntry
	nil,                                     // 37: google.cloud.networkservices.v1.LbEdgeExtension.LabelsEntry
	nil,                                     // 38: google.cloud.networkservices.v1.AuthzExtension.LabelsEntry
...
var file_google_cloud_networkservices_v1_dep_proto_depIdxs = []int32{
	33, // 0: google.cloud.networkservices.v1.ExtensionChain.match_condition:type_name -> google.cloud.networkservices.v1.ExtensionChain.MatchCondition
	34, // 1: google.cloud.networkservices.v1.ExtensionChain.extensions:type_name -> google.cloud.networkservices.v1.ExtensionChain.Extension
	39, // 2: google.cloud.networkservices.v1.LbTrafficExtension.create_time:type_name -> google.protobuf.Timestamp
	39, // 3: google.cloud.networkservices.v1.LbTrafficExtension.update_time:type_name -> google.protobuf.Timestamp
	35, // 4: google.cloud.networkservices.v1.LbTrafficExtension.labels:type_name -> google.cloud.networkservices.v1.LbTrafficExtension.LabelsEntry
	4,  // 5: google.cloud.networkservices.v1.LbTrafficExtension.extension_chains:type_name -> google.cloud.networkservices.v1.ExtensionChain
	...
	40, // 7: google.cloud.networkservices.v1.LbTrafficExtension.metadata:type_name -> google.protobuf.Struct
	5,  // 8: google.cloud.networkservices.v1.ListLbTrafficExtensionsResponse.lb_traffic_extensions:type_name -> google.cloud.networkservices.v1.LbTrafficExtension
	5,  // 9: google.cloud.networkservices.v1.CreateLbTrafficExtensionRequest.lb_traffic_extension:type_name -> google.cloud.networkservices.v1.LbTrafficExtension
	41, // 10: google.cloud.networkservices.v1.UpdateLbTrafficExtensionRequest.update_mask:type_name -> google.protobuf.FieldMask
	5,  // 11: google.cloud.networkservices.v1.UpdateLbTrafficExtensionRequest.lb_traffic_extension:type_name -> google.cloud.networkservices.v1.LbTrafficExtension
	39, // 12: google.cloud.networkservices.v1.LbRouteExtension.create_time:type_name -> google.protobuf.Timestamp
	39, // 13: google.cloud.networkservices.v1.LbRouteExtension.update_time:type_name -> google.protobuf.Timestamp
	36, // 14: google.cloud.networkservices.v1.LbRouteExtension.labels:type_name -> google.cloud.networkservices.v1.LbRouteExtension.LabelsEntry
	4,  // 15: google.cloud.networkservices.v1.LbRouteExtension.extension_chains:type_name -> google.cloud.networkservices.v1.ExtensionChain
	...
	40, // 17: google.cloud.networkservices.v1.LbRouteExtension.metadata:type_name -> google.protobuf.Struct
	12, // 18: google.cloud.networkservices.v1.ListLbRouteExtensionsResponse.lb_route_extensions:type_name -> google.cloud.networkservices.v1.LbRouteExtension
	12, // 19: google.cloud.networkservices.v1.CreateLbRouteExtensionRequest.lb_route_extension:type_name -> google.cloud.networkservices.v1.LbRouteExtension
	41, // 20: google.cloud.networkservices.v1.UpdateLbRouteExtensionRequest.update_mask:type_name -> google.protobuf.FieldMask
	12, // 21: google.cloud.networkservices.v1.UpdateLbRouteExtensionRequest.lb_route_extension:type_name -> google.cloud.networkservices.v1.LbRouteExtension
	39, // 22: google.cloud.networkservices.v1.LbEdgeExtension.create_time:type_name -> google.protobuf.Timestamp
	39, // 23: google.cloud.networkservices.v1.LbEdgeExtension.update_time:type_name -> google.protobuf.Timestamp
	37, // 24: google.cloud.networkservices.v1.LbEdgeExtension.labels:type_name -> google.cloud.networkservices.v1.LbEdgeExtension.LabelsEntry
	4,  // 25: google.cloud.networkservices.v1.LbEdgeExtension.extension_chains:type_name -> google.cloud.networkservices.v1.ExtensionChain
	...
	19, // 27: google.cloud.networkservices.v1.ListLbEdgeExtensionsResponse.lb_edge_extensions:type_name -> google.cloud.networkservices.v1.LbEdgeExtension
	19, // 28: google.cloud.networkservices.v1.CreateLbEdgeExtensionRequest.lb_edge_extension:type_name -> google.cloud.networkservices.v1.LbEdgeExtension
	41, // 29: google.cloud.networkservices.v1.UpdateLbEdgeExtensionRequest.update_mask:type_name -> google.protobuf.FieldMask
	19, // 30: google.cloud.networkservices.v1.UpdateLbEdgeExtensionRequest.lb_edge_extension:type_name -> google.cloud.networkservices.v1.LbEdgeExtension
	39, // 31: google.cloud.networkservices.v1.AuthzExtension.create_time:type_name -> google.protobuf.Timestamp
	39, // 32: google.cloud.networkservices.v1.AuthzExtension.update_time:type_name -> google.protobuf.Timestamp
	38, // 33: google.cloud.networkservices.v1.AuthzExtension.labels:type_name -> google.cloud.networkservices.v1.AuthzExtension.LabelsEntry
	...
	42, // 35: google.cloud.networkservices.v1.AuthzExtension.timeout:type_name -> google.protobuf.Duration
	40, // 36: google.cloud.networkservices.v1.AuthzExtension.metadata:type_name -> google.protobuf.Struct
	2,  // 37: google.cloud.networkservices.v1.AuthzExtension.wire_format:type_name -> google.cloud.networkservices.v1.WireFormat
	26, // 38: google.cloud.networkservices.v1.ListAuthzExtensionsResponse.authz_extensions:type_name -> google.cloud.networkservices.v1.AuthzExtension
	26, // 39: google.cloud.networkservices.v1.CreateAuthzExtensionRequest.authz_extension:type_name -> google.cloud.networkservices.v1.AuthzExtension
	41, // 40: google.cloud.networkservices.v1.UpdateAuthzExtensionRequest.update_mask:type_name -> google.protobuf.FieldMask
	26, // 41: google.cloud.networkservices.v1.UpdateAuthzExtensionRequest.authz_extension:type_name -> google.cloud.networkservices.v1.AuthzExtension
	...
	42, // 43: google.cloud.networkservices.v1.ExtensionChain.Extension.timeout:type_name -> google.protobuf.Duration
	40, // 44: google.cloud.networkservices.v1.ExtensionChain.Extension.metadata:type_name -> google.protobuf.Struct
	3,  // 45: google.cloud.networkservices.v1.ExtensionChain.Extension.request_body_send_mode:type_name -> google.cloud.networkservices.v1.BodySendMode
	3,  // 46: google.cloud.networkservices.v1.ExtensionChain.Extension.response_body_send_mode:type_name -> google.cloud.networkservices.v1.BodySendMode
	6,  // 47: google.cloud.networkservices.v1.DepService.ListLbTrafficExtensions:input_type -> google.cloud.networkservices.v1.ListLbTrafficExtensionsRequest
	8,  // 48: google.cloud.networkservices.v1.DepService.GetLbTrafficExtension:input_type -> google.cloud.networkservices.v1.GetLbTrafficExtensionRequest
	9,  // 49: google.cloud.networkservices.v1.DepService.CreateLbTrafficExtension:input_type -> google.cloud.networkservices.v1.CreateLbTrafficExtensionRequest
	10, // 50: google.cloud.networkservices.v1.DepService.UpdateLbTrafficExtension:input_type -> google.cloud.networkservices.v1.UpdateLbTrafficExtensionRequest
	11, // 51: google.cloud.networkservices.v1.DepService.DeleteLbTrafficExtension:input_type -> google.cloud.networkservices.v1.DeleteLbTrafficExtensionRequest
	13, // 52: google.cloud.networkservices.v1.DepService.ListLbRouteExtensions:input_type -> google.cloud.networkservices.v1.ListLbRouteExtensionsRequest
	15, // 53: google.cloud.networkservices.v1.DepService.GetLbRouteExtension:input_type -> google.cloud.networkservices.v1.GetLbRouteExtensionRequest
	16, // 54: google.cloud.networkservices.v1.DepService.CreateLbRouteExtension:input_type -> google.cloud.networkservices.v1.CreateLbRouteExtensionRequest
	17, // 55: google.cloud.networkservices.v1.DepService.UpdateLbRouteExtension:input_type -> google.cloud.networkservices.v1.UpdateLbRouteExtensionRequest
	18, // 56: google.cloud.networkservices.v1.DepService.DeleteLbRouteExtension:input_type -> google.cloud.networkservices.v1.DeleteLbRouteExtensionRequest
	20, // 57: google.cloud.networkservices.v1.DepService.ListLbEdgeExtensions:input_type -> google.cloud.networkservices.v1.ListLbEdgeExtensionsRequest
	22, // 58: google.cloud.networkservices.v1.DepService.GetLbEdgeExtension:input_type -> google.cloud.networkservices.v1.GetLbEdgeExtensionRequest
	23, // 59: google.cloud.networkservices.v1.DepService.CreateLbEdgeExtension:input_type -> google.cloud.networkservices.v1.CreateLbEdgeExtensionRequest
	24, // 60: google.cloud.networkservices.v1.DepService.UpdateLbEdgeExtension:input_type -> google.cloud.networkservices.v1.UpdateLbEdgeExtensionRequest
	25, // 61: google.cloud.networkservices.v1.DepService.DeleteLbEdgeExtension:input_type -> google.cloud.networkservices.v1.DeleteLbEdgeExtensionRequest
	27, // 62: google.cloud.networkservices.v1.DepService.ListAuthzExtensions:input_type -> google.cloud.networkservices.v1.ListAuthzExtensionsRequest
	29, // 63: google.cloud.networkservices.v1.DepService.GetAuthzExtension:input_type -> google.cloud.networkservices.v1.GetAuthzExtensionRequest
	30, // 64: google.cloud.networkservices.v1.DepService.CreateAuthzExtension:input_type -> google.cloud.networkservices.v1.CreateAuthzExtensionRequest
	31, // 65: google.cloud.networkservices.v1.DepService.UpdateAuthzExtension:input_type -> google.cloud.networkservices.v1.UpdateAuthzExtensionRequest
	32, // 66: google.cloud.networkservices.v1.DepService.DeleteAuthzExtension:input_type -> google.cloud.networkservices.v1.DeleteAuthzExtensionRequest
	7,  // 67: google.cloud.networkservices.v1.DepService.ListLbTrafficExtensions:output_type -> google.cloud.networkservices.v1.ListLbTrafficExtensionsResponse
	5,  // 68: google.cloud.networkservices.v1.DepService.GetLbTrafficExtension:output_type -> google.cloud.networkservices.v1.LbTrafficExtension
	43, // 69: google.cloud.networkservices.v1.DepService.CreateLbTrafficExtension:output_type -> google.longrunning.Operation
	43, // 70: google.cloud.networkservices.v1.DepService.UpdateLbTrafficExtension:output_type -> google.longrunning.Operation
	43, // 71: google.cloud.networkservices.v1.DepService.DeleteLbTrafficExtension:output_type -> google.longrunning.Operation
	14, // 72: google.cloud.networkservices.v1.DepService.ListLbRouteExtensions:output_type -> google.cloud.networkservices.v1.ListLbRouteExtensionsResponse
	12, // 73: google.cloud.networkservices.v1.DepService.GetLbRouteExtension:output_type -> google.cloud.networkservices.v1.LbRouteExtension
	43, // 74: google.cloud.networkservices.v1.DepService.CreateLbRouteExtension:output_type -> google.longrunning.Operation
	43, // 75: google.cloud.networkservices.v1.DepService.UpdateLbRouteExtension:output_type -> google.longrunning.Operation
	43, // 76: google.cloud.networkservices.v1.DepService.DeleteLbRouteExtension:output_type -> google.longrunning.Operation
	21, // 77: google.cloud.networkservices.v1.DepService.ListLbEdgeExtensions:output_type -> google.cloud.networkservices.v1.ListLbEdgeExtensionsResponse
	19, // 78: google.cloud.networkservices.v1.DepService.GetLbEdgeExtension:output_type -> google.cloud.networkservices.v1.LbEdgeExtension
	43, // 79: google.cloud.networkservices.v1.DepService.CreateLbEdgeExtension:output_type -> google.longrunning.Operation
	43, // 80: google.cloud.networkservices.v1.DepService.UpdateLbEdgeExtension:output_type -> google.longrunning.Operation
	43, // 81: google.cloud.networkservices.v1.DepService.DeleteLbEdgeExtension:output_type -> google.longrunning.Operation
	28, // 82: google.cloud.networkservices.v1.DepService.ListAuthzExtensions:output_type -> google.cloud.networkservices.v1.ListAuthzExtensionsResponse
	26, // 83: google.cloud.networkservices.v1.DepService.GetAuthzExtension:output_type -> google.cloud.networkservices.v1.AuthzExtension
	43, // 84: google.cloud.networkservices.v1.DepService.CreateAuthzExtension:output_type -> google.longrunning.Operation
	43, // 85: google.cloud.networkservices.v1.DepService.UpdateAuthzExtension:output_type -> google.longrunning.Operation
	43, // 86: google.cloud.networkservices.v1.DepService.DeleteAuthzExtension:output_type -> google.longrunning.Operation
