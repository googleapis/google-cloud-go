...
var file_google_cloud_security_publicca_v1_resources_proto_goTypes = []interface{}{
...
func file_google_cloud_security_publicca_v1_resources_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_security_publicca_v1_resources_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
