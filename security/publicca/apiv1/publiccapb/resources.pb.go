...
const file_google_cloud_security_publicca_v1_resources_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/security/publicca/v1/resources.proto\x12!google.cloud.security.publicca.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\xf5\x01\n" +
...
var (
	...
	file_google_cloud_security_publicca_v1_resources_proto_rawDescData []byte
)
...
func file_google_cloud_security_publicca_v1_resources_proto_rawDescGZIP() []byte {
	file_google_cloud_security_publicca_v1_resources_proto_rawDescOnce.Do(func() {
		file_google_cloud_security_publicca_v1_resources_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_security_publicca_v1_resources_proto_rawDesc), len(file_google_cloud_security_publicca_v1_resources_proto_rawDesc)))
	})
...
func file_google_cloud_security_publicca_v1_resources_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_security_publicca_v1_resources_proto_rawDesc), len(file_google_cloud_security_publicca_v1_resources_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
