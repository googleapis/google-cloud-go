...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/workloadidentity.svg)](https://pkg.go.dev/cloud.google.com/go/workloadidentity)

Go Client Library for Workload Identity API.

## Install

```bash
go get cloud.google.com/go/workloadidentity
```
