...
const file_google_cloud_notebooks_v1beta1_environment_proto_rawDesc = "" +
	"\n" +
	"0google/cloud/notebooks/v1beta1/environment.proto\x12\x1egoogle.cloud.notebooks.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe6\x03\n" +
	"\vEnvironment\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12D\n" +
	"\bvm_image\x18\x06 \x01(\v2'.google.cloud.notebooks.v1beta1.VmImageH\x00R\avmImage\x12Y\n" +
	"\x0fcontainer_image\x18\a \x01(\v2..google.cloud.notebooks.v1beta1.ContainerImageH\x00R\x0econtainerImage\x12.\n" +
	...
	"repository\x12\x10\n" +
	"\x03tag\x18\x02 \x01(\tR\x03tagB\xe0\x01\n" +
...
var (
	...
	file_google_cloud_notebooks_v1beta1_environment_proto_rawDescData []byte
)
...
func file_google_cloud_notebooks_v1beta1_environment_proto_rawDescGZIP() []byte {
	file_google_cloud_notebooks_v1beta1_environment_proto_rawDescOnce.Do(func() {
		file_google_cloud_notebooks_v1beta1_environment_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_notebooks_v1beta1_environment_proto_rawDesc), len(file_google_cloud_notebooks_v1beta1_environment_proto_rawDesc)))
	})
...
var file_google_cloud_notebooks_v1beta1_environment_proto_goTypes = []any{
...
func file_google_cloud_notebooks_v1beta1_environment_proto_init() {
	...
	file_google_cloud_notebooks_v1beta1_environment_proto_msgTypes[0].OneofWrappers = []any{
		(*Environment_VmImage)(nil),
		(*Environment_ContainerImage)(nil),
	}
	file_google_cloud_notebooks_v1beta1_environment_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_notebooks_v1beta1_environment_proto_rawDesc), len(file_google_cloud_notebooks_v1beta1_environment_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
