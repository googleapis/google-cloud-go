...
const file_google_cloud_notebooks_v2_event_proto_rawDesc = "" +
	"\n" +
	"%google/cloud/notebooks/v2/event.proto\x12\x19google.cloud.notebooks.v2\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8c\x03\n" +
	"\x05Event\x12@\n" +
	"\vreport_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x01R\n" +
	"reportTime\x12C\n" +
	"\x04type\x18\x02 \x01(\x0e2*.google.cloud.notebooks.v2.Event.EventTypeB\x03\xe0A\x01R\x04type\x12L\n" +
	"\adetails\x18\x03 \x03(\v2-.google.cloud.notebooks.v2.Event.DetailsEntryB\x03\xe0A\x01R\adetails\x1a:\n" +
...
var (
	...
	file_google_cloud_notebooks_v2_event_proto_rawDescData []byte
)
...
func file_google_cloud_notebooks_v2_event_proto_rawDescGZIP() []byte {
	file_google_cloud_notebooks_v2_event_proto_rawDescOnce.Do(func() {
		file_google_cloud_notebooks_v2_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_notebooks_v2_event_proto_rawDesc), len(file_google_cloud_notebooks_v2_event_proto_rawDesc)))
	})
...
func file_google_cloud_notebooks_v2_event_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_notebooks_v2_event_proto_rawDesc), len(file_google_cloud_notebooks_v2_event_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
