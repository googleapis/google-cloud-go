...
var file_google_cloud_notebooks_v2_event_proto_goTypes = []interface{}{
...
func file_google_cloud_notebooks_v2_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_notebooks_v2_event_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Event); i {
			case 0:
				return &v.state
			case 1:
