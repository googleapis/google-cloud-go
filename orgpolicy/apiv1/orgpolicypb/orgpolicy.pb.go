...
func (x *Policy) GetListPolicy() *Policy_ListPolicy {
	if x != nil {
		if x, ok := x.PolicyType.(*Policy_ListPolicy_); ok {
			return x.ListPolicy
		}
	}
	return nil
...
func (x *Policy) GetBooleanPolicy() *Policy_BooleanPolicy {
	if x != nil {
		if x, ok := x.PolicyType.(*Policy_BooleanPolicy_); ok {
...
func (x *Policy) GetRestoreDefault() *Policy_RestoreDefault {
	if x != nil {
		if x, ok := x.PolicyType.(*Policy_RestoreDefault_); ok {
...
const file_google_cloud_orgpolicy_v1_orgpolicy_proto_rawDesc = "" +
	"\n" +
	")google/cloud/orgpolicy/v1/orgpolicy.proto\x12\x19google.cloud.orgpolicy.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb2\x06\n" +
	"\x06Policy\x12\x18\n" +
	"\aversion\x18\x01 \x01(\x05R\aversion\x12\x1e\n" +
	"\n" +
	"constraint\x18\x02 \x01(\tR\n" +
	"constraint\x12\x12\n" +
	"\x04etag\x18\x03 \x01(\fR\x04etag\x12;\n" +
	"\vupdate_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\x12O\n" +
	"\vlist_policy\x18\x05 \x01(\v2,.google.cloud.orgpolicy.v1.Policy.ListPolicyH\x00R\n" +
	"listPolicy\x12X\n" +
	"\x0eboolean_policy\x18\x06 \x01(\v2/.google.cloud.orgpolicy.v1.Policy.BooleanPolicyH\x00R\rbooleanPolicy\x12[\n" +
	"\x0frestore_default\x18\a \x01(\v20.google.cloud.orgpolicy.v1.Policy.RestoreDefaultH\x00R\x0erestoreDefault\x1a\xc6\x02\n" +
	"\n" +
	"ListPolicy\x12%\n" +
	"\x0eallowed_values\x18\x01 \x03(\tR\rallowedValues\x12#\n" +
	"\rdenied_values\x18\x02 \x03(\tR\fdeniedValues\x12U\n" +
	"\n" +
	"all_values\x18\x03 \x01(\x0e26.google.cloud.orgpolicy.v1.Policy.ListPolicy.AllValuesR\tallValues\x12'\n" +
	"\x0fsuggested_value\x18\x04 \x01(\tR\x0esuggestedValue\x12.\n" +
	"\x13inherit_from_parent\x18\x05 \x01(\bR\x11inheritFromParent\"<\n" +
	"\tAllValues\x12\x1a\n" +
	"\x16ALL_VALUES_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05ALLOW\x10\x01\x12\b\n" +
	"\x04DENY\x10\x02\x1a+\n" +
	"\rBooleanPolicy\x12\x1a\n" +
	"\benforced\x18\x01 \x01(\bR\benforced\x1a\x10\n" +
	"\x0eRestoreDefaultB\r\n" +
	"\vpolicy_typeB\xc5\x01\n" +
...
var (
	...
	file_google_cloud_orgpolicy_v1_orgpolicy_proto_rawDescData []byte
)
...
func file_google_cloud_orgpolicy_v1_orgpolicy_proto_rawDescGZIP() []byte {
	file_google_cloud_orgpolicy_v1_orgpolicy_proto_rawDescOnce.Do(func() {
		file_google_cloud_orgpolicy_v1_orgpolicy_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_orgpolicy_v1_orgpolicy_proto_rawDesc), len(file_google_cloud_orgpolicy_v1_orgpolicy_proto_rawDesc)))
	})
...
var file_google_cloud_orgpolicy_v1_orgpolicy_proto_goTypes = []any{
...
func file_google_cloud_orgpolicy_v1_orgpolicy_proto_init() {
	...
	file_google_cloud_orgpolicy_v1_orgpolicy_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_orgpolicy_v1_orgpolicy_proto_rawDesc), len(file_google_cloud_orgpolicy_v1_orgpolicy_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
