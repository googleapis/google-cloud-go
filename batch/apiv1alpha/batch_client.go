...
type CallOptions struct {
	...
	CreateResourceAllowance []gax.CallOption
	GetResourceAllowance    []gax.CallOption
	DeleteResourceAllowance []gax.CallOption
	ListResourceAllowances  []gax.CallOption
	UpdateResourceAllowance []gax.CallOption
...
type internalClient interface {
	...
	UpdateJob(context.Context, *batchpb.UpdateJobRequest, ...gax.CallOption) (*batchpb.Job, error)
	...
	CreateResourceAllowance(context.Context, *batchpb.CreateResourceAllowanceRequest, ...gax.CallOption) (*batchpb.ResourceAllowance, error)
	GetResourceAllowance(context.Context, *batchpb.GetResourceAllowanceRequest, ...gax.CallOption) (*batchpb.ResourceAllowance, error)
	DeleteResourceAllowance(context.Context, *batchpb.DeleteResourceAllowanceRequest, ...gax.CallOption) (*DeleteResourceAllowanceOperation, error)
	DeleteResourceAllowanceOperation(name string) *DeleteResourceAllowanceOperation
	ListResourceAllowances(context.Context, *batchpb.ListResourceAllowancesRequest, ...gax.CallOption) *ResourceAllowanceIterator
	UpdateResourceAllowance(context.Context, *batchpb.UpdateResourceAllowanceRequest, ...gax.CallOption) (*batchpb.ResourceAllowance, error)
...
func (c *Client) UpdateJob(ctx context.Context, req *batchpb.UpdateJobRequest, opts ...gax.CallOption) (*batchpb.Job, error) {
...
// CreateResourceAllowance create a Resource Allowance.
func (c *Client) CreateResourceAllowance(ctx context.Context, req *batchpb.CreateResourceAllowanceRequest, opts ...gax.CallOption) (*batchpb.ResourceAllowance, error) {
	return c.internalClient.CreateResourceAllowance(ctx, req, opts...)
}

// GetResourceAllowance get a ResourceAllowance specified by its resource name.
func (c *Client) GetResourceAllowance(ctx context.Context, req *batchpb.GetResourceAllowanceRequest, opts ...gax.CallOption) (*batchpb.ResourceAllowance, error) {
	return c.internalClient.GetResourceAllowance(ctx, req, opts...)
}

// DeleteResourceAllowance delete a ResourceAllowance.
func (c *Client) DeleteResourceAllowance(ctx context.Context, req *batchpb.DeleteResourceAllowanceRequest, opts ...gax.CallOption) (*DeleteResourceAllowanceOperation, error) {
	return c.internalClient.DeleteResourceAllowance(ctx, req, opts...)
}

// DeleteResourceAllowanceOperation returns a new DeleteResourceAllowanceOperation from a given name.
// The name must be that of a previously created DeleteResourceAllowanceOperation, possibly from a different process.
func (c *Client) DeleteResourceAllowanceOperation(name string) *DeleteResourceAllowanceOperation {
	return c.internalClient.DeleteResourceAllowanceOperation(name)
}

// ListResourceAllowances list all ResourceAllowances for a project within a region.
func (c *Client) ListResourceAllowances(ctx context.Context, req *batchpb.ListResourceAllowancesRequest, opts ...gax.CallOption) *ResourceAllowanceIterator {
	return c.internalClient.ListResourceAllowances(ctx, req, opts...)
}

// UpdateResourceAllowance update a Resource Allowance.
func (c *Client) UpdateResourceAllowance(ctx context.Context, req *batchpb.UpdateResourceAllowanceRequest, opts ...gax.CallOption) (*batchpb.ResourceAllowance, error) {
	return c.internalClient.UpdateResourceAllowance(ctx, req, opts...)
}
...
func (c *gRPCClient) CancelJob(ctx context.Context, req *batchpb.CancelJobRequest, opts ...gax.CallOption) (*CancelJobOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.CancelJob(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) UpdateJob(ctx context.Context, req *batchpb.UpdateJobRequest, opts ...gax.CallOption) (*batchpb.Job, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.UpdateJob(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) CreateResourceAllowance(ctx context.Context, req *batchpb.CreateResourceAllowanceRequest, opts ...gax.CallOption) (*batchpb.ResourceAllowance, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).CreateResourceAllowance[0:len((*c.CallOptions).CreateResourceAllowance):len((*c.CallOptions).CreateResourceAllowance)], opts...)
	var resp *batchpb.ResourceAllowance
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.CreateResourceAllowance(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) GetResourceAllowance(ctx context.Context, req *batchpb.GetResourceAllowanceRequest, opts ...gax.CallOption) (*batchpb.ResourceAllowance, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).GetResourceAllowance[0:len((*c.CallOptions).GetResourceAllowance):len((*c.CallOptions).GetResourceAllowance)], opts...)
	var resp *batchpb.ResourceAllowance
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.GetResourceAllowance(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) DeleteResourceAllowance(ctx context.Context, req *batchpb.DeleteResourceAllowanceRequest, opts ...gax.CallOption) (*DeleteResourceAllowanceOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).DeleteResourceAllowance[0:len((*c.CallOptions).DeleteResourceAllowance):len((*c.CallOptions).DeleteResourceAllowance)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.DeleteResourceAllowance(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	return &DeleteResourceAllowanceOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, resp),
	}, nil
}

func (c *gRPCClient) ListResourceAllowances(ctx context.Context, req *batchpb.ListResourceAllowancesRequest, opts ...gax.CallOption) *ResourceAllowanceIterator {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).ListResourceAllowances[0:len((*c.CallOptions).ListResourceAllowances):len((*c.CallOptions).ListResourceAllowances)], opts...)
	it := &ResourceAllowanceIterator{}
	req = proto.Clone(req).(*batchpb.ListResourceAllowancesRequest)
	it.InternalFetch = func(pageSize int, pageToken string) ([]*batchpb.ResourceAllowance, string, error) {
		resp := &batchpb.ListResourceAllowancesResponse{}
		if pageToken != "" {
			req.PageToken = pageToken
		}
		if pageSize > math.MaxInt32 {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = c.client.ListResourceAllowances(ctx, req, settings.GRPC...)
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
		...
		it.Response = resp
		return resp.GetResourceAllowances(), resp.GetNextPageToken(), nil
	}
	fetch := func(pageSize int, pageToken string) (string, error) {
		items, nextPageToken, err := it.InternalFetch(pageSize, pageToken)
		if err != nil {
...
func (c *gRPCClient) UpdateResourceAllowance(ctx context.Context, req *batchpb.UpdateResourceAllowanceRequest, opts ...gax.CallOption) (*batchpb.ResourceAllowance, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "resource_allowance.name", url.QueryEscape(req.GetResourceAllowance().GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).UpdateResourceAllowance[0:len((*c.CallOptions).UpdateResourceAllowance):len((*c.CallOptions).UpdateResourceAllowance)], opts...)
	var resp *batchpb.ResourceAllowance
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.UpdateResourceAllowance(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *restClient) CreateJob(ctx context.Context, req *batchpb.CreateJobRequest, opts ...gax.CallOption) (*batchpb.Job, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v/jobs", req.GetParent())
...
// UpdateJob update a Job.
func (c *restClient) UpdateJob(ctx context.Context, req *batchpb.UpdateJobRequest, opts ...gax.CallOption) (*batchpb.Job, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetJob()
	jsonReq, err := m.Marshal(body)
	if err != nil {
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v", req.GetJob().GetName())
...
func (c *restClient) ListTasks(ctx context.Context, req *batchpb.ListTasksRequest, opts ...gax.CallOption) *TaskIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*batchpb.Task, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v1alpha/%v/tasks", req.GetParent())
...
// CreateResourceAllowance create a Resource Allowance.
func (c *restClient) CreateResourceAllowance(ctx context.Context, req *batchpb.CreateResourceAllowanceRequest, opts ...gax.CallOption) (*batchpb.ResourceAllowance, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetResourceAllowance()
	jsonReq, err := m.Marshal(body)
	if err != nil {
		return nil, err
	}
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v/resourceAllowances", req.GetParent())
	...
	if req.GetResourceAllowanceId() != "" {
		params.Add("resourceAllowanceId", fmt.Sprintf("%v", req.GetResourceAllowanceId()))
	}
	...
	opts = append((*c.CallOptions).CreateResourceAllowance[0:len((*c.CallOptions).CreateResourceAllowance):len((*c.CallOptions).CreateResourceAllowance)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &batchpb.ResourceAllowance{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
// GetResourceAllowance get a ResourceAllowance specified by its resource name.
func (c *restClient) GetResourceAllowance(ctx context.Context, req *batchpb.GetResourceAllowanceRequest, opts ...gax.CallOption) (*batchpb.ResourceAllowance, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// DeleteResourceAllowance delete a ResourceAllowance.
func (c *restClient) DeleteResourceAllowance(ctx context.Context, req *batchpb.DeleteResourceAllowanceRequest, opts ...gax.CallOption) (*DeleteResourceAllowanceOperation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// ListResourceAllowances list all ResourceAllowances for a project within a region.
func (c *restClient) ListResourceAllowances(ctx context.Context, req *batchpb.ListResourceAllowancesRequest, opts ...gax.CallOption) *ResourceAllowanceIterator {
	it := &ResourceAllowanceIterator{}
	req = proto.Clone(req).(*batchpb.ListResourceAllowancesRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*batchpb.ResourceAllowance, string, error) {
...
// UpdateResourceAllowance update a Resource Allowance.
func (c *restClient) UpdateResourceAllowance(ctx context.Context, req *batchpb.UpdateResourceAllowanceRequest, opts ...gax.CallOption) (*batchpb.ResourceAllowance, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetResourceAllowance()
	jsonReq, err := m.Marshal(body)
	if err != nil {
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v", req.GetResourceAllowance().GetName())
...
// DeleteResourceAllowanceOperation returns a new DeleteResourceAllowanceOperation from a given name.
// The name must be that of a previously created DeleteResourceAllowanceOperation, possibly from a different process.
func (c *gRPCClient) DeleteResourceAllowanceOperation(name string) *DeleteResourceAllowanceOperation {
	return &DeleteResourceAllowanceOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
	}
}
...
// DeleteResourceAllowanceOperation returns a new DeleteResourceAllowanceOperation from a given name.
// The name must be that of a previously created DeleteResourceAllowanceOperation, possibly from a different process.
func (c *restClient) DeleteResourceAllowanceOperation(name string) *DeleteResourceAllowanceOperation {
	override := fmt.Sprintf("/v1alpha/%s", name)
	return &DeleteResourceAllowanceOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
