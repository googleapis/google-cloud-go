...
type CloudFilestoreManagerCallOptions struct {
	...
	ListShares      []gax.CallOption
	GetShare        []gax.CallOption
	CreateShare     []gax.CallOption
	DeleteShare     []gax.CallOption
	UpdateShare     []gax.CallOption
...
type internalCloudFilestoreManagerClient interface {
	...
	ListShares(context.Context, *filestorepb.ListSharesRequest, ...gax.CallOption) *ShareIterator
	GetShare(context.Context, *filestorepb.GetShareRequest, ...gax.CallOption) (*filestorepb.Share, error)
	CreateShare(context.Context, *filestorepb.CreateShareRequest, ...gax.CallOption) (*CreateShareOperation, error)
	CreateShareOperation(name string) *CreateShareOperation
	DeleteShare(context.Context, *filestorepb.DeleteShareRequest, ...gax.CallOption) (*DeleteShareOperation, error)
	DeleteShareOperation(name string) *DeleteShareOperation
	UpdateShare(context.Context, *filestorepb.UpdateShareRequest, ...gax.CallOption) (*UpdateShareOperation, error)
	UpdateShareOperation(name string) *UpdateShareOperation
...
// ListShares lists all shares for a specified instance.
func (c *CloudFilestoreManagerClient) ListShares(ctx context.Context, req *filestorepb.ListSharesRequest, opts ...gax.CallOption) *ShareIterator {
	return c.internalClient.ListShares(ctx, req, opts...)
}

// GetShare gets the details of a specific share.
func (c *CloudFilestoreManagerClient) GetShare(ctx context.Context, req *filestorepb.GetShareRequest, opts ...gax.CallOption) (*filestorepb.Share, error) {
	return c.internalClient.GetShare(ctx, req, opts...)
}

// CreateShare creates a share.
func (c *CloudFilestoreManagerClient) CreateShare(ctx context.Context, req *filestorepb.CreateShareRequest, opts ...gax.CallOption) (*CreateShareOperation, error) {
	return c.internalClient.CreateShare(ctx, req, opts...)
}

// CreateShareOperation returns a new CreateShareOperation from a given name.
// The name must be that of a previously created CreateShareOperation, possibly from a different process.
func (c *CloudFilestoreManagerClient) CreateShareOperation(name string) *CreateShareOperation {
	return c.internalClient.CreateShareOperation(name)
}

// DeleteShare deletes a share.
func (c *CloudFilestoreManagerClient) DeleteShare(ctx context.Context, req *filestorepb.DeleteShareRequest, opts ...gax.CallOption) (*DeleteShareOperation, error) {
	return c.internalClient.DeleteShare(ctx, req, opts...)
}

// DeleteShareOperation returns a new DeleteShareOperation from a given name.
// The name must be that of a previously created DeleteShareOperation, possibly from a different process.
func (c *CloudFilestoreManagerClient) DeleteShareOperation(name string) *DeleteShareOperation {
	return c.internalClient.DeleteShareOperation(name)
}

// UpdateShare updates the settings of a specific share.
func (c *CloudFilestoreManagerClient) UpdateShare(ctx context.Context, req *filestorepb.UpdateShareRequest, opts ...gax.CallOption) (*UpdateShareOperation, error) {
	return c.internalClient.UpdateShare(ctx, req, opts...)
}

// UpdateShareOperation returns a new UpdateShareOperation from a given name.
// The name must be that of a previously created UpdateShareOperation, possibly from a different process.
func (c *CloudFilestoreManagerClient) UpdateShareOperation(name string) *UpdateShareOperation {
	return c.internalClient.UpdateShareOperation(name)
}
...
func (c *cloudFilestoreManagerGRPCClient) ListShares(ctx context.Context, req *filestorepb.ListSharesRequest, opts ...gax.CallOption) *ShareIterator {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).ListShares[0:len((*c.CallOptions).ListShares):len((*c.CallOptions).ListShares)], opts...)
	it := &ShareIterator{}
	req = proto.Clone(req).(*filestorepb.ListSharesRequest)
	it.InternalFetch = func(pageSize int, pageToken string) ([]*filestorepb.Share, string, error) {
		resp := &filestorepb.ListSharesResponse{}
		if pageToken != "" {
			req.PageToken = pageToken
		}
		if pageSize > math.MaxInt32 {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = c.cloudFilestoreManagerClient.ListShares(ctx, req, settings.GRPC...)
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
		...
		it.Response = resp
		return resp.GetShares(), resp.GetNextPageToken(), nil
	}
	fetch := func(pageSize int, pageToken string) (string, error) {
		items, nextPageToken, err := it.InternalFetch(pageSize, pageToken)
		if err != nil {
...
func (c *cloudFilestoreManagerGRPCClient) GetShare(ctx context.Context, req *filestorepb.GetShareRequest, opts ...gax.CallOption) (*filestorepb.Share, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).GetShare[0:len((*c.CallOptions).GetShare):len((*c.CallOptions).GetShare)], opts...)
	var resp *filestorepb.Share
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.cloudFilestoreManagerClient.GetShare(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *cloudFilestoreManagerGRPCClient) CreateShare(ctx context.Context, req *filestorepb.CreateShareRequest, opts ...gax.CallOption) (*CreateShareOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).CreateShare[0:len((*c.CallOptions).CreateShare):len((*c.CallOptions).CreateShare)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.cloudFilestoreManagerClient.CreateShare(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	return &CreateShareOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, resp),
	}, nil
}

func (c *cloudFilestoreManagerGRPCClient) DeleteShare(ctx context.Context, req *filestorepb.DeleteShareRequest, opts ...gax.CallOption) (*DeleteShareOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).DeleteShare[0:len((*c.CallOptions).DeleteShare):len((*c.CallOptions).DeleteShare)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.cloudFilestoreManagerClient.DeleteShare(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *cloudFilestoreManagerGRPCClient) UpdateShare(ctx context.Context, req *filestorepb.UpdateShareRequest, opts ...gax.CallOption) (*UpdateShareOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "share.name", url.QueryEscape(req.GetShare().GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).UpdateShare[0:len((*c.CallOptions).UpdateShare):len((*c.CallOptions).UpdateShare)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.cloudFilestoreManagerClient.UpdateShare(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	return &UpdateShareOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, resp),
	}, nil
}
...
func (c *cloudFilestoreManagerRESTClient) RevertInstance(ctx context.Context, req *filestorepb.RevertInstanceRequest, opts ...gax.CallOption) (*RevertInstanceOperation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1beta1/%v:revert", req.GetName())
...
func (c *cloudFilestoreManagerRESTClient) ListSnapshots(ctx context.Context, req *filestorepb.ListSnapshotsRequest, opts ...gax.CallOption) *SnapshotIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*filestorepb.Snapshot, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v1beta1/%v/snapshots", req.GetParent())
...
func (c *cloudFilestoreManagerRESTClient) UpdateSnapshot(ctx context.Context, req *filestorepb.UpdateSnapshotRequest, opts ...gax.CallOption) (*UpdateSnapshotOperation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1beta1/%v", req.GetSnapshot().GetName())
...
func (c *cloudFilestoreManagerRESTClient) ListBackups(ctx context.Context, req *filestorepb.ListBackupsRequest, opts ...gax.CallOption) *BackupIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*filestorepb.Backup, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v1beta1/%v/backups", req.GetParent())
...
func (c *cloudFilestoreManagerRESTClient) UpdateBackup(ctx context.Context, req *filestorepb.UpdateBackupRequest, opts ...gax.CallOption) (*UpdateBackupOperation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1beta1/%v", req.GetBackup().GetName())
...
// ListShares lists all shares for a specified instance.
func (c *cloudFilestoreManagerRESTClient) ListShares(ctx context.Context, req *filestorepb.ListSharesRequest, opts ...gax.CallOption) *ShareIterator {
	it := &ShareIterator{}
	req = proto.Clone(req).(*filestorepb.ListSharesRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*filestorepb.Share, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v1beta1/%v/shares", req.GetParent())
...
// GetShare gets the details of a specific share.
func (c *cloudFilestoreManagerRESTClient) GetShare(ctx context.Context, req *filestorepb.GetShareRequest, opts ...gax.CallOption) (*filestorepb.Share, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// CreateShare creates a share.
func (c *cloudFilestoreManagerRESTClient) CreateShare(ctx context.Context, req *filestorepb.CreateShareRequest, opts ...gax.CallOption) (*CreateShareOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetShare()
	jsonReq, err := m.Marshal(body)
	if err != nil {
	...
	params := url.Values{}
	params.Add("$alt", "json;enum-encoding=int")
	params.Add("shareId", fmt.Sprintf("%v", req.GetShareId()))
...
// DeleteShare deletes a share.
func (c *cloudFilestoreManagerRESTClient) DeleteShare(ctx context.Context, req *filestorepb.DeleteShareRequest, opts ...gax.CallOption) (*DeleteShareOperation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// UpdateShare updates the settings of a specific share.
func (c *cloudFilestoreManagerRESTClient) UpdateShare(ctx context.Context, req *filestorepb.UpdateShareRequest, opts ...gax.CallOption) (*UpdateShareOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetShare()
	jsonReq, err := m.Marshal(body)
	if err != nil {
	...
	baseUrl.Path += fmt.Sprintf("/v1beta1/%v", req.GetShare().GetName())
...
// CreateShareOperation returns a new CreateShareOperation from a given name.
// The name must be that of a previously created CreateShareOperation, possibly from a different process.
func (c *cloudFilestoreManagerGRPCClient) CreateShareOperation(name string) *CreateShareOperation {
	return &CreateShareOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
	}
}
...
// CreateShareOperation returns a new CreateShareOperation from a given name.
// The name must be that of a previously created CreateShareOperation, possibly from a different process.
func (c *cloudFilestoreManagerRESTClient) CreateShareOperation(name string) *CreateShareOperation {
	override := fmt.Sprintf("/v1beta1/%s", name)
	return &CreateShareOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
...
// DeleteShareOperation returns a new DeleteShareOperation from a given name.
// The name must be that of a previously created DeleteShareOperation, possibly from a different process.
func (c *cloudFilestoreManagerGRPCClient) DeleteShareOperation(name string) *DeleteShareOperation {
	return &DeleteShareOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
	}
}
...
// DeleteShareOperation returns a new DeleteShareOperation from a given name.
// The name must be that of a previously created DeleteShareOperation, possibly from a different process.
func (c *cloudFilestoreManagerRESTClient) DeleteShareOperation(name string) *DeleteShareOperation {
	override := fmt.Sprintf("/v1beta1/%s", name)
	return &DeleteShareOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
...
// UpdateShareOperation returns a new UpdateShareOperation from a given name.
// The name must be that of a previously created UpdateShareOperation, possibly from a different process.
func (c *cloudFilestoreManagerGRPCClient) UpdateShareOperation(name string) *UpdateShareOperation {
	return &UpdateShareOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
	}
}
...
// UpdateShareOperation returns a new UpdateShareOperation from a given name.
// The name must be that of a previously created UpdateShareOperation, possibly from a different process.
func (c *cloudFilestoreManagerRESTClient) UpdateShareOperation(name string) *UpdateShareOperation {
	override := fmt.Sprintf("/v1beta1/%s", name)
	return &UpdateShareOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
