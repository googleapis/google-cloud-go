...
// CreateShareOperation manages a long-running operation from CreateShare.
type CreateShareOperation struct {
	lro      *longrunning.Operation
	pollPath string
}
...
//
// See documentation of Poll for error-handling information.
func (op *CreateShareOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*filestorepb.Share, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *CreateShareOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*filestorepb.Share, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp filestorepb.Share
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *CreateShareOperation) Metadata() (*commonpb.OperationMetadata, error) {
	var meta commonpb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *CreateShareOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *CreateShareOperation) Name() string {
	return op.lro.Name()
}
...
// DeleteShareOperation manages a long-running operation from DeleteShare.
type DeleteShareOperation struct {
	lro      *longrunning.Operation
	pollPath string
}
...
//
// See documentation of Poll for error-handling information.
func (op *DeleteShareOperation) Wait(ctx context.Context, opts ...gax.CallOption) error {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	return op.lro.WaitWithInterval(ctx, nil, time.Minute, opts...)
}
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *DeleteShareOperation) Poll(ctx context.Context, opts ...gax.CallOption) error {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	return op.lro.Poll(ctx, nil, opts...)
}
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *DeleteShareOperation) Metadata() (*commonpb.OperationMetadata, error) {
	var meta commonpb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *DeleteShareOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *DeleteShareOperation) Name() string {
	return op.lro.Name()
}
...
// UpdateShareOperation manages a long-running operation from UpdateShare.
type UpdateShareOperation struct {
	lro      *longrunning.Operation
	pollPath string
}
...
//
// See documentation of Poll for error-handling information.
func (op *UpdateShareOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*filestorepb.Share, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp filestorepb.Share
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *UpdateShareOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*filestorepb.Share, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp filestorepb.Share
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *UpdateShareOperation) Metadata() (*commonpb.OperationMetadata, error) {
	var meta commonpb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *UpdateShareOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *UpdateShareOperation) Name() string {
	return op.lro.Name()
}
...
// ShareIterator manages a stream of *filestorepb.Share.
type ShareIterator struct {
	items    []*filestorepb.Share
	pageInfo *iterator.PageInfo
	nextFunc func() error
	...
	// The number of results is no greater than pageSize.
	// If there are no more results, nextPageToken is empty and err is nil.
	InternalFetch func(pageSize int, pageToken string) (results []*filestorepb.Share, nextPageToken string, err error)
}

// PageInfo supports pagination. See the google.golang.org/api/iterator package for details.
func (it *ShareIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *ShareIterator) Next() (*filestorepb.Share, error) {
	var item *filestorepb.Share
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *ShareIterator) bufLen() int {
	return len(it.items)
}

func (it *ShareIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
