...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/agentregistry.svg)](https://pkg.go.dev/cloud.google.com/go/agentregistry)

Go Client Library for Agent Registry API.

## Install

```bash
go get cloud.google.com/go/agentregistry
```
