...
func NewClient(ctx context.Context, opts ...option.ClientOption) (*Client, error) {
	...
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		clientOpts = append(clientOpts, internaloption.WithTelemetryAttributes(map[string]string{
			"gcp.client.service":  "edgecontainer",
			"gcp.client.version":  getVersionClient(),
			"gcp.client.repo":     "googleapis/google-cloud-go",
			"gcp.client.artifact": "cloud.google.com/go/edgecontainer/apiv1",
			"gcp.client.language": "go",
			"url.domain":          "edgecontainer.googleapis.com",
		}))
	}
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.GenerateOfflineCredential = append(client.CallOptions.GenerateOfflineCredential, gax.WithClientMetrics(metrics))
		client.CallOptions.ListNodePools = append(client.CallOptions.ListNodePools, gax.WithClientMetrics(metrics))
		client.CallOptions.GetNodePool = append(client.CallOptions.GetNodePool, gax.WithClientMetrics(metrics))
		client.CallOptions.CreateNodePool = append(client.CallOptions.CreateNodePool, gax.WithClientMetrics(metrics))
		client.CallOptions.UpdateNodePool = append(client.CallOptions.UpdateNodePool, gax.WithClientMetrics(metrics))
		client.CallOptions.DeleteNodePool = append(client.CallOptions.DeleteNodePool, gax.WithClientMetrics(metrics))
		client.CallOptions.ListMachines = append(client.CallOptions.ListMachines, gax.WithClientMetrics(metrics))
		client.CallOptions.GetMachine = append(client.CallOptions.GetMachine, gax.WithClientMetrics(metrics))
		client.CallOptions.ListVpnConnections = append(client.CallOptions.ListVpnConnections, gax.WithClientMetrics(metrics))
		client.CallOptions.GetVpnConnection = append(client.CallOptions.GetVpnConnection, gax.WithClientMetrics(metrics))
		client.CallOptions.CreateVpnConnection = append(client.CallOptions.CreateVpnConnection, gax.WithClientMetrics(metrics))
		client.CallOptions.DeleteVpnConnection = append(client.CallOptions.DeleteVpnConnection, gax.WithClientMetrics(metrics))
		client.CallOptions.GetServerConfig = append(client.CallOptions.GetServerConfig, gax.WithClientMetrics(metrics))
...
func NewRESTClient(ctx context.Context, opts ...option.ClientOption) (*Client, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.GenerateOfflineCredential = append(callOpts.GenerateOfflineCredential, gax.WithClientMetrics(metrics))
		callOpts.ListNodePools = append(callOpts.ListNodePools, gax.WithClientMetrics(metrics))
		callOpts.GetNodePool = append(callOpts.GetNodePool, gax.WithClientMetrics(metrics))
		callOpts.CreateNodePool = append(callOpts.CreateNodePool, gax.WithClientMetrics(metrics))
		callOpts.UpdateNodePool = append(callOpts.UpdateNodePool, gax.WithClientMetrics(metrics))
		callOpts.DeleteNodePool = append(callOpts.DeleteNodePool, gax.WithClientMetrics(metrics))
		callOpts.ListMachines = append(callOpts.ListMachines, gax.WithClientMetrics(metrics))
		callOpts.GetMachine = append(callOpts.GetMachine, gax.WithClientMetrics(metrics))
		callOpts.ListVpnConnections = append(callOpts.ListVpnConnections, gax.WithClientMetrics(metrics))
		callOpts.GetVpnConnection = append(callOpts.GetVpnConnection, gax.WithClientMetrics(metrics))
		callOpts.CreateVpnConnection = append(callOpts.CreateVpnConnection, gax.WithClientMetrics(metrics))
		callOpts.DeleteVpnConnection = append(callOpts.DeleteVpnConnection, gax.WithClientMetrics(metrics))
		callOpts.GetServerConfig = append(callOpts.GetServerConfig, gax.WithClientMetrics(metrics))
...
func (c *gRPCClient) UpdateCluster(ctx context.Context, req *edgecontainerpb.UpdateClusterRequest, opts ...gax.CallOption) (*UpdateClusterOperation, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.edgecontainer.v1.EdgeContainer/UpdateCluster")
	}
...
func (c *gRPCClient) UpgradeCluster(ctx context.Context, req *edgecontainerpb.UpgradeClusterRequest, opts ...gax.CallOption) (*UpgradeClusterOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.UpgradeCluster, req, settings.GRPC, c.logger, "UpgradeCluster")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) GenerateOfflineCredential(ctx context.Context, req *edgecontainerpb.GenerateOfflineCredentialRequest, opts ...gax.CallOption) (*edgecontainerpb.GenerateOfflineCredentialResponse, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.GenerateOfflineCredential, req, settings.GRPC, c.logger, "GenerateOfflineCredential")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) ListNodePools(ctx context.Context, req *edgecontainerpb.ListNodePoolsRequest, opts ...gax.CallOption) *NodePoolIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*edgecontainerpb.NodePool, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.client.ListNodePools, req, settings.GRPC, c.logger, "ListNodePools")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *gRPCClient) GetNodePool(ctx context.Context, req *edgecontainerpb.GetNodePoolRequest, opts ...gax.CallOption) (*edgecontainerpb.NodePool, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.GetNodePool, req, settings.GRPC, c.logger, "GetNodePool")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) CreateNodePool(ctx context.Context, req *edgecontainerpb.CreateNodePoolRequest, opts ...gax.CallOption) (*CreateNodePoolOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.CreateNodePool, req, settings.GRPC, c.logger, "CreateNodePool")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) UpdateNodePool(ctx context.Context, req *edgecontainerpb.UpdateNodePoolRequest, opts ...gax.CallOption) (*UpdateNodePoolOperation, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.edgecontainer.v1.EdgeContainer/UpdateNodePool")
	}
	opts = append((*c.CallOptions).UpdateNodePool[0:len((*c.CallOptions).UpdateNodePool):len((*c.CallOptions).UpdateNodePool)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.UpdateNodePool, req, settings.GRPC, c.logger, "UpdateNodePool")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) DeleteNodePool(ctx context.Context, req *edgecontainerpb.DeleteNodePoolRequest, opts ...gax.CallOption) (*DeleteNodePoolOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.DeleteNodePool, req, settings.GRPC, c.logger, "DeleteNodePool")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) ListMachines(ctx context.Context, req *edgecontainerpb.ListMachinesRequest, opts ...gax.CallOption) *MachineIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*edgecontainerpb.Machine, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.client.ListMachines, req, settings.GRPC, c.logger, "ListMachines")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *gRPCClient) GetMachine(ctx context.Context, req *edgecontainerpb.GetMachineRequest, opts ...gax.CallOption) (*edgecontainerpb.Machine, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.GetMachine, req, settings.GRPC, c.logger, "GetMachine")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) ListVpnConnections(ctx context.Context, req *edgecontainerpb.ListVpnConnectionsRequest, opts ...gax.CallOption) *VpnConnectionIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*edgecontainerpb.VpnConnection, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.client.ListVpnConnections, req, settings.GRPC, c.logger, "ListVpnConnections")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *gRPCClient) GetVpnConnection(ctx context.Context, req *edgecontainerpb.GetVpnConnectionRequest, opts ...gax.CallOption) (*edgecontainerpb.VpnConnection, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.GetVpnConnection, req, settings.GRPC, c.logger, "GetVpnConnection")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) CreateVpnConnection(ctx context.Context, req *edgecontainerpb.CreateVpnConnectionRequest, opts ...gax.CallOption) (*CreateVpnConnectionOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.CreateVpnConnection, req, settings.GRPC, c.logger, "CreateVpnConnection")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) DeleteVpnConnection(ctx context.Context, req *edgecontainerpb.DeleteVpnConnectionRequest, opts ...gax.CallOption) (*DeleteVpnConnectionOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.DeleteVpnConnection, req, settings.GRPC, c.logger, "DeleteVpnConnection")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) GetServerConfig(ctx context.Context, req *edgecontainerpb.GetServerConfigRequest, opts ...gax.CallOption) (*edgecontainerpb.ServerConfig, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.GetServerConfig, req, settings.GRPC, c.logger, "GetServerConfig")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *restClient) GenerateAccessToken(ctx context.Context, req *edgecontainerpb.GenerateAccessTokenRequest, opts ...gax.CallOption) (*edgecontainerpb.GenerateAccessTokenResponse, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "GenerateAccessToken")
		if err != nil {
			return err
		}
...
func (c *restClient) GenerateOfflineCredential(ctx context.Context, req *edgecontainerpb.GenerateOfflineCredentialRequest, opts ...gax.CallOption) (*edgecontainerpb.GenerateOfflineCredentialResponse, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "GenerateOfflineCredential")
		if err != nil {
			return err
		}
...
func (c *restClient) UpdateNodePool(ctx context.Context, req *edgecontainerpb.UpdateNodePoolRequest, opts ...gax.CallOption) (*UpdateNodePoolOperation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.edgecontainer.v1.EdgeContainer/UpdateNodePool")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1/{node_pool.name=projects/*/locations/*/clusters/*/nodePools/*}")
	}
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &longrunningpb.Operation{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
...
func (c *restClient) ListMachines(ctx context.Context, req *edgecontainerpb.ListMachinesRequest, opts ...gax.CallOption) *MachineIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*edgecontainerpb.Machine, string, error) {
		...
		e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			...
			buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "ListMachines")
			if err != nil {
				return err
			}
			if err := unm.Unmarshal(buf, resp); err != nil {
...
func (c *restClient) GetMachine(ctx context.Context, req *edgecontainerpb.GetMachineRequest, opts ...gax.CallOption) (*edgecontainerpb.Machine, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "GetMachine")
		if err != nil {
			return err
		}
...
func (c *restClient) ListVpnConnections(ctx context.Context, req *edgecontainerpb.ListVpnConnectionsRequest, opts ...gax.CallOption) *VpnConnectionIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*edgecontainerpb.VpnConnection, string, error) {
		...
		e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			...
			buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "ListVpnConnections")
			if err != nil {
				return err
			}
			if err := unm.Unmarshal(buf, resp); err != nil {
...
func (c *restClient) GetVpnConnection(ctx context.Context, req *edgecontainerpb.GetVpnConnectionRequest, opts ...gax.CallOption) (*edgecontainerpb.VpnConnection, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "GetVpnConnection")
		if err != nil {
			return err
		}
...
func (c *restClient) CreateVpnConnection(ctx context.Context, req *edgecontainerpb.CreateVpnConnectionRequest, opts ...gax.CallOption) (*CreateVpnConnectionOperation, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "CreateVpnConnection")
		if err != nil {
			return err
		}
		if err := unm.Unmarshal(buf, resp); err != nil {
...
func (c *restClient) DeleteVpnConnection(ctx context.Context, req *edgecontainerpb.DeleteVpnConnectionRequest, opts ...gax.CallOption) (*DeleteVpnConnectionOperation, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "DeleteVpnConnection")
		if err != nil {
			return err
		}
		if err := unm.Unmarshal(buf, resp); err != nil {
