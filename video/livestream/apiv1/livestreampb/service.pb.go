...
func file_google_cloud_video_livestream_v1_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_video_livestream_v1_service_proto_msgTypes[26].Exporter = func(v any, i int) any {
			switch v := v.(*ListClipsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_google_cloud_video_livestream_v1_service_proto_msgTypes[28].Exporter = func(v any, i int) any {
		...
		file_google_cloud_video_livestream_v1_service_proto_msgTypes[29].Exporter = func(v any, i int) any {
		...
		file_google_cloud_video_livestream_v1_service_proto_msgTypes[30].Exporter = func(v any, i int) any {
		...
		file_google_cloud_video_livestream_v1_service_proto_msgTypes[31].Exporter = func(v any, i int) any {
		...
		file_google_cloud_video_livestream_v1_service_proto_msgTypes[32].Exporter = func(v any, i int) any {
