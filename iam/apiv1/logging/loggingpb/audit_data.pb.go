...
type AuditData struct {
	...
	PolicyDelta *iampb.PolicyDelta `protobuf:"bytes,2,opt,name=policy_delta,json=policyDelta,proto3" json:"policy_delta,omitempty"`
}
...
func (x *AuditData) GetPolicyDelta() *iampb.PolicyDelta {
	if x != nil {
...
var file_google_iam_v1_logging_audit_data_proto_rawDesc = []byte{
	...
	0x63, 0x79, 0x44, 0x65, 0x6c, 0x74, 0x61, 0x42, 0x86, 0x01, 0x0a, 0x19, 0x63, 0x6f, 0x6d, 0x2e,
	...
	0x2f, 0x61, 0x70, 0x69, 0x76, 0x31, 0x2f, 0x6c, 0x6f, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x2f, 0x6c,
	...
	0x64, 0x2e, 0x49, 0x61, 0x6d, 0x2e, 0x56, 0x31, 0x2e, 0x4c, 0x6f, 0x67, 0x67, 0x69, 0x6e, 0x67,
...
var file_google_iam_v1_logging_audit_data_proto_goTypes = []any{
	...
	(*iampb.PolicyDelta)(nil), // 1: google.iam.v1.PolicyDelta
}
...
func file_google_iam_v1_logging_audit_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_iam_v1_logging_audit_data_proto_msgTypes[0].Exporter = func(v any, i int) any {
