...
func file_google_iam_admin_v1_audit_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_iam_admin_v1_audit_data_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_iam_admin_v1_audit_data_proto_msgTypes[1].Exporter = func(v any, i int) any {
