...
func (op *CreateAccessPolicyOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*iampb.AccessPolicy, error) {
...
func (op *CreateAccessPolicyOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*iampb.AccessPolicy, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp iampb.AccessPolicy
...
func (op *CreateAccessPolicyOperation) Metadata() (*iampb.OperationMetadata, error) {
	var meta iampb.OperationMetadata
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *DeleteAccessPolicyOperation) Metadata() (*iampb.OperationMetadata, error) {
	var meta iampb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
//
// See documentation of Poll for error-handling information.
func (op *UpdateAccessPolicyOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*iampb.AccessPolicy, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp iampb.AccessPolicy
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *UpdateAccessPolicyOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*iampb.AccessPolicy, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp iampb.AccessPolicy
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *UpdateAccessPolicyOperation) Metadata() (*iampb.OperationMetadata, error) {
	var meta iampb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
type AccessPolicyIterator struct {
	...
	InternalFetch func(pageSize int, pageToken string) (results []*iampb.AccessPolicy, nextPageToken string, err error)
}
...
func (it *AccessPolicyIterator) Next() (*iampb.AccessPolicy, error) {
	var item *iampb.AccessPolicy
...
func (it *PolicyBindingIterator) bufLen() int {
	return len(it.items)
}

func (it *PolicyBindingIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type PrincipalAccessBoundaryPolicyIterator struct {
	items    []*iampb.PrincipalAccessBoundaryPolicy
	pageInfo *iterator.PageInfo
	nextFunc func() error
...
func (it *PrincipalAccessBoundaryPolicyIterator) Next() (*iampb.PrincipalAccessBoundaryPolicy, error) {
	var item *iampb.PrincipalAccessBoundaryPolicy
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *PrincipalAccessBoundaryPolicyIterator) bufLen() int {
	return len(it.items)
}

func (it *PrincipalAccessBoundaryPolicyIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
