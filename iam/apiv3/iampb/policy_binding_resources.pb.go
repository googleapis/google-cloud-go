...
const file_google_iam_v3_policy_binding_resources_proto_rawDesc = "" +
	"\n" +
	",google/iam/v3/policy_binding_resources.proto\x12\rgoogle.iam.v3\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/api/field_info.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x16google/type/expr.proto\"\xe5\b\n" +
	...
	"\fdisplay_name\x18\x04 \x01(\tB\x03\xe0A\x01R\vdisplayName\x12T\n" +
	"\vannotations\x18\x05 \x03(\v2-.google.iam.v3.PolicyBinding.AnnotationsEntryB\x03\xe0A\x01R\vannotations\x12C\n" +
	"\x06target\x18\x06 \x01(\v2#.google.iam.v3.PolicyBinding.TargetB\x06\xe0A\x05\xe0A\x02R\x06target\x12M\n" +
	"\vpolicy_kind\x18\v \x01(\x0e2'.google.iam.v3.PolicyBinding.PolicyKindB\x03\xe0A\x05R\n" +
	"policyKind\x12\x1e\n" +
...
var (
	...
	file_google_iam_v3_policy_binding_resources_proto_rawDescData []byte
)
...
func file_google_iam_v3_policy_binding_resources_proto_rawDescGZIP() []byte {
	file_google_iam_v3_policy_binding_resources_proto_rawDescOnce.Do(func() {
		file_google_iam_v3_policy_binding_resources_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_iam_v3_policy_binding_resources_proto_rawDesc), len(file_google_iam_v3_policy_binding_resources_proto_rawDesc)))
	})
...
func file_google_iam_v3_policy_binding_resources_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_iam_v3_policy_binding_resources_proto_rawDesc), len(file_google_iam_v3_policy_binding_resources_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
