...
func file_google_cloud_asset_v1p5beta1_asset_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_asset_v1p5beta1_asset_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_asset_v1p5beta1_asset_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
