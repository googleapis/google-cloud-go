...
func (x *OutputResult) GetGcsResult() *GcsOutputResult {
	if x != nil {
		if x, ok := x.Result.(*OutputResult_GcsResult); ok {
			return x.GcsResult
		}
	}
	return nil
...
func (x *GcsDestination) GetUriPrefix() string {
	if x != nil {
		if x, ok := x.ObjectUri.(*GcsDestination_UriPrefix); ok {
			return x.UriPrefix
		}
	}
	return ""
...
func (x *IamPolicyAnalysisOutputConfig) GetDestination() isIamPolicyAnalysisOutputConfig_Destination {
	if x != nil {
		return x.Destination
	}
	return nil
...
func (x *IamPolicyAnalysisOutputConfig) GetGcsDestination() *IamPolicyAnalysisOutputConfig_GcsDestination {
	if x != nil {
		if x, ok := x.Destination.(*IamPolicyAnalysisOutputConfig_GcsDestination_); ok {
			return x.GcsDestination
		}
	}
	return nil
...
func (x *IamPolicyAnalysisOutputConfig) GetBigqueryDestination() *IamPolicyAnalysisOutputConfig_BigQueryDestination {
	if x != nil {
		if x, ok := x.Destination.(*IamPolicyAnalysisOutputConfig_BigqueryDestination); ok {
			return x.BigqueryDestination
		}
	}
	return nil
...
func (x *MoveAnalysis) GetResult() isMoveAnalysis_Result {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *MoveAnalysis) GetAnalysis() *MoveAnalysisResult {
	if x != nil {
		if x, ok := x.Result.(*MoveAnalysis_Analysis); ok {
			return x.Analysis
		}
	}
	return nil
...
func (x *MoveAnalysis) GetError() *status.Status {
	if x != nil {
		if x, ok := x.Result.(*MoveAnalysis_Error); ok {
			return x.Error
		}
	}
	return nil
...
func (x *QueryAssetsRequest) GetQuery() isQueryAssetsRequest_Query {
	if x != nil {
		return x.Query
	}
	return nil
...
func (x *QueryAssetsRequest) GetStatement() string {
	if x != nil {
		if x, ok := x.Query.(*QueryAssetsRequest_Statement); ok {
			return x.Statement
		}
	}
	return ""
...
func (x *QueryAssetsRequest) GetJobReference() string {
	if x != nil {
		if x, ok := x.Query.(*QueryAssetsRequest_JobReference); ok {
...
func (x *QueryAssetsRequest) GetTime() isQueryAssetsRequest_Time {
	if x != nil {
		return x.Time
	}
	return nil
...
func (x *QueryAssetsRequest) GetReadTimeWindow() *TimeWindow {
	if x != nil {
		if x, ok := x.Time.(*QueryAssetsRequest_ReadTimeWindow); ok {
			return x.ReadTimeWindow
		}
	}
	return nil
...
func (x *QueryAssetsRequest) GetReadTime() *timestamppb.Timestamp {
	if x != nil {
		if x, ok := x.Time.(*QueryAssetsRequest_ReadTime); ok {
			return x.ReadTime
		}
	}
	return nil
...
func (x *QueryAssetsResponse) GetResponse() isQueryAssetsResponse_Response {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *QueryAssetsResponse) GetError() *status.Status {
	if x != nil {
		if x, ok := x.Response.(*QueryAssetsResponse_Error); ok {
			return x.Error
		}
	}
	return nil
...
func (x *QueryAssetsResponse) GetQueryResult() *QueryResult {
	if x != nil {
		if x, ok := x.Response.(*QueryAssetsResponse_QueryResult); ok {
...
func (x *QueryAssetsResponse) GetOutputConfig() *QueryAssetsOutputConfig {
	if x != nil {
		if x, ok := x.Response.(*QueryAssetsResponse_OutputConfig); ok {
			return x.OutputConfig
		}
	}
	return nil
...
func (x *AnalyzerOrgPolicyConstraint) GetConstraintDefinition() isAnalyzerOrgPolicyConstraint_ConstraintDefinition {
	if x != nil {
		return x.ConstraintDefinition
	}
	return nil
}
...
func (x *AnalyzerOrgPolicyConstraint) GetGoogleDefinedConstraint() *AnalyzerOrgPolicyConstraint_Constraint {
	if x != nil {
		if x, ok := x.ConstraintDefinition.(*AnalyzerOrgPolicyConstraint_GoogleDefinedConstraint); ok {
...
func (x *AnalyzerOrgPolicyConstraint) GetCustomConstraint() *AnalyzerOrgPolicyConstraint_CustomConstraint {
	if x != nil {
		if x, ok := x.ConstraintDefinition.(*AnalyzerOrgPolicyConstraint_CustomConstraint_); ok {
...
func (x *IamPolicyAnalysisQuery_ConditionContext) GetTimeContext() isIamPolicyAnalysisQuery_ConditionContext_TimeContext {
	if x != nil {
...
func (x *IamPolicyAnalysisQuery_ConditionContext) GetAccessTime() *timestamppb.Timestamp {
	if x != nil {
		if x, ok := x.TimeContext.(*IamPolicyAnalysisQuery_ConditionContext_AccessTime); ok {
			return x.AccessTime
		}
	}
	return nil
...
func (x *SavedQuery_QueryContent) GetQueryContent() isSavedQuery_QueryContent_QueryContent {
	if x != nil {
...
func (x *SavedQuery_QueryContent) GetIamPolicyAnalysisQuery() *IamPolicyAnalysisQuery {
	if x != nil {
		if x, ok := x.QueryContent.(*SavedQuery_QueryContent_IamPolicyAnalysisQuery); ok {
...
func (x *AnalyzerOrgPolicy_Rule) GetKind() isAnalyzerOrgPolicy_Rule_Kind {
	if x != nil {
		return x.Kind
	}
	return nil
...
func (x *AnalyzerOrgPolicy_Rule) GetValues() *AnalyzerOrgPolicy_Rule_StringValues {
	if x != nil {
		if x, ok := x.Kind.(*AnalyzerOrgPolicy_Rule_Values); ok {
			return x.Values
		}
	}
	return nil
...
func (x *AnalyzerOrgPolicy_Rule) GetAllowAll() bool {
	if x != nil {
		if x, ok := x.Kind.(*AnalyzerOrgPolicy_Rule_AllowAll); ok {
			return x.AllowAll
		}
	}
	return false
...
func (x *AnalyzerOrgPolicy_Rule) GetDenyAll() bool {
	if x != nil {
		if x, ok := x.Kind.(*AnalyzerOrgPolicy_Rule_DenyAll); ok {
			return x.DenyAll
		}
	}
	return false
...
func (x *AnalyzerOrgPolicy_Rule) GetEnforce() bool {
	if x != nil {
		if x, ok := x.Kind.(*AnalyzerOrgPolicy_Rule_Enforce); ok {
			return x.Enforce
		}
	}
	return false
...
func (x *AnalyzerOrgPolicyConstraint_Constraint) GetConstraintType() isAnalyzerOrgPolicyConstraint_Constraint_ConstraintType {
	if x != nil {
...
func (x *AnalyzerOrgPolicyConstraint_Constraint) GetListConstraint() *AnalyzerOrgPolicyConstraint_Constraint_ListConstraint {
	if x != nil {
		if x, ok := x.ConstraintType.(*AnalyzerOrgPolicyConstraint_Constraint_ListConstraint_); ok {
...
func (x *AnalyzerOrgPolicyConstraint_Constraint) GetBooleanConstraint() *AnalyzerOrgPolicyConstraint_Constraint_BooleanConstraint {
	if x != nil {
		if x, ok := x.ConstraintType.(*AnalyzerOrgPolicyConstraint_Constraint_BooleanConstraint_); ok {
...
func (x *AnalyzeOrgPolicyGovernedAssetsResponse_GovernedAsset) GetGovernedAsset() isAnalyzeOrgPolicyGovernedAssetsResponse_GovernedAsset_GovernedAsset {
	if x != nil {
		return x.GovernedAsset
	}
	return nil
}
...
func (x *AnalyzeOrgPolicyGovernedAssetsResponse_GovernedAsset) GetGovernedResource() *AnalyzeOrgPolicyGovernedAssetsResponse_GovernedResource {
	if x != nil {
		if x, ok := x.GovernedAsset.(*AnalyzeOrgPolicyGovernedAssetsResponse_GovernedAsset_GovernedResource); ok {
...
func (x *AnalyzeOrgPolicyGovernedAssetsResponse_GovernedAsset) GetGovernedIamPolicy() *AnalyzeOrgPolicyGovernedAssetsResponse_GovernedIamPolicy {
	if x != nil {
		if x, ok := x.GovernedAsset.(*AnalyzeOrgPolicyGovernedAssetsResponse_GovernedAsset_GovernedIamPolicy); ok {
...
const file_google_cloud_asset_v1_asset_service_proto_rawDesc = "" +
	...
	"assetTypes\x12E\n" +
	"\fcontent_type\x18\x04 \x01(\x0e2\".google.cloud.asset.v1.ContentTypeR\vcontentType\x12M\n" +
	"\routput_config\x18\x05 \x01(\v2#.google.cloud.asset.v1.OutputConfigB\x03\xe0A\x02R\foutputConfig\x12-\n" +
	"\x12relationship_types\x18\x06 \x03(\tR\x11relationshipTypes\"\xe3\x01\n" +
	"\x14ExportAssetsResponse\x127\n" +
	"\tread_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\breadTime\x12H\n" +
	"\routput_config\x18\x02 \x01(\v2#.google.cloud.asset.v1.OutputConfigR\foutputConfig\x12H\n" +
	"\routput_result\x18\x03 \x01(\v2#.google.cloud.asset.v1.OutputResultR\foutputResult\"\xe0\x02\n" +
	"\x11ListAssetsRequest\x12?\n" +
	"\x06parent\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\x12\x1fcloudasset.googleapis.com/AssetR\x06parent\x127\n" +
	"\tread_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\breadTime\x12\x1f\n" +
	"\vasset_types\x18\x03 \x03(\tR\n" +
	"assetTypes\x12E\n" +
	"\fcontent_type\x18\x04 \x01(\x0e2\".google.cloud.asset.v1.ContentTypeR\vcontentType\x12\x1b\n" +
	"\tpage_size\x18\x05 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x06 \x01(\tR\tpageToken\x12-\n" +
	"\x12relationship_types\x18\a \x03(\tR\x11relationshipTypes\"\xab\x01\n" +
	"\x12ListAssetsResponse\x127\n" +
	"\tread_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\breadTime\x124\n" +
	"\x06assets\x18\x02 \x03(\v2\x1c.google.cloud.asset.v1.AssetR\x06assets\x12&\n" +
	"\x0fnext_page_token\x18\x03 \x01(\tR\rnextPageToken\"\xd2\x02\n" +
	"\x1cBatchGetAssetsHistoryRequest\x12?\n" +
	"\x06parent\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\x12\x1fcloudasset.googleapis.com/AssetR\x06parent\x12\x1f\n" +
	"\vasset_names\x18\x02 \x03(\tR\n" +
	"assetNames\x12J\n" +
	"\fcontent_type\x18\x03 \x01(\x0e2\".google.cloud.asset.v1.ContentTypeB\x03\xe0A\x01R\vcontentType\x12P\n" +
	"\x10read_time_window\x18\x04 \x01(\v2!.google.cloud.asset.v1.TimeWindowB\x03\xe0A\x01R\x0ereadTimeWindow\x122\n" +
	"\x12relationship_types\x18\x05 \x03(\tB\x03\xe0A\x01R\x11relationshipTypes\"]\n" +
	"\x1dBatchGetAssetsHistoryResponse\x12<\n" +
	"\x06assets\x18\x01 \x03(\v2$.google.cloud.asset.v1.TemporalAssetR\x06assets\"\x84\x01\n" +
	"\x11CreateFeedRequest\x12\x1b\n" +
	"\x06parent\x18\x01 \x01(\tB\x03\xe0A\x02R\x06parent\x12\x1c\n" +
	"\afeed_id\x18\x02 \x01(\tB\x03\xe0A\x02R\x06feedId\x124\n" +
	"\x04feed\x18\x03 \x01(\v2\x1b.google.cloud.asset.v1.FeedB\x03\xe0A\x02R\x04feed\"L\n" +
	...
	"\x05feeds\x18\x01 \x03(\v2\x1b.google.cloud.asset.v1.FeedR\x05feeds\"\x8b\x01\n" +
	"\x11UpdateFeedRequest\x124\n" +
	"\x04feed\x18\x01 \x01(\v2\x1b.google.cloud.asset.v1.FeedB\x03\xe0A\x02R\x04feed\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"O\n" +
	"\x11DeleteFeedRequest\x12:\n" +
	"\x04name\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1ecloudasset.googleapis.com/FeedR\x04name\"\xd0\x01\n" +
	"\fOutputConfig\x12P\n" +
	"\x0fgcs_destination\x18\x01 \x01(\v2%.google.cloud.asset.v1.GcsDestinationH\x00R\x0egcsDestination\x12_\n" +
	"\x14bigquery_destination\x18\x02 \x01(\v2*.google.cloud.asset.v1.BigQueryDestinationH\x00R\x13bigqueryDestinationB\r\n" +
	"\vdestination\"a\n" +
	"\fOutputResult\x12G\n" +
	"\n" +
	"gcs_result\x18\x01 \x01(\v2&.google.cloud.asset.v1.GcsOutputResultH\x00R\tgcsResultB\b\n" +
	"\x06result\"%\n" +
	...
	"\n" +
	"uri_prefix\x18\x02 \x01(\tH\x00R\turiPrefixB\f\n" +
	"\n" +
	"object_uri\"\xf6\x01\n" +
	"\x13BigQueryDestination\x12\x1d\n" +
	"\adataset\x18\x01 \x01(\tB\x03\xe0A\x02R\adataset\x12\x19\n" +
	"\x05table\x18\x02 \x01(\tB\x03\xe0A\x02R\x05table\x12\x14\n" +
	"\x05force\x18\x03 \x01(\bR\x05force\x12K\n" +
	"\x0epartition_spec\x18\x04 \x01(\v2$.google.cloud.asset.v1.PartitionSpecR\rpartitionSpec\x12B\n" +
	"\x1eseparate_tables_per_asset_type\x18\x05 \x01(\bR\x1aseparateTablesPerAssetType\"\xb7\x01\n" +
	"\rPartitionSpec\x12V\n" +
	"\rpartition_key\x18\x01 \x01(\x0e21.google.cloud.asset.v1.PartitionSpec.PartitionKeyR\fpartitionKey\"N\n" +
	"\fPartitionKey\x12\x1d\n" +
	"\x19PARTITION_KEY_UNSPECIFIED\x10\x00\x12\r\n" +
	"\tREAD_TIME\x10\x01\x12\x10\n" +
	"\fREQUEST_TIME\x10\x02\")\n" +
	"\x11PubsubDestination\x12\x14\n" +
	"\x05topic\x18\x01 \x01(\tR\x05topic\"|\n" +
	"\x10FeedOutputConfig\x12Y\n" +
	"\x12pubsub_destination\x18\x01 \x01(\v2(.google.cloud.asset.v1.PubsubDestinationH\x00R\x11pubsubDestinationB\r\n" +
	"\vdestination\"\xf8\x03\n" +
	"\x04Feed\x12\x17\n" +
	...
	"\vasset_types\x18\x03 \x03(\tR\n" +
	"assetTypes\x12E\n" +
	"\fcontent_type\x18\x04 \x01(\x0e2\".google.cloud.asset.v1.ContentTypeR\vcontentType\x12Z\n" +
	"\x12feed_output_config\x18\x05 \x01(\v2'.google.cloud.asset.v1.FeedOutputConfigB\x03\xe0A\x02R\x10feedOutputConfig\x12/\n" +
	"\tcondition\x18\x06 \x01(\v2\x11.google.type.ExprR\tcondition\x12-\n" +
	"\x12relationship_types\x18\a \x03(\tR\x11relationshipTypes:\x91\x01\xeaA\x8d\x01\n" +
	"\x1ecloudasset.googleapis.com/Feed\x12\x1fprojects/{project}/feeds/{feed}\x12\x1dfolders/{folder}/feeds/{feed}\x12)organizations/{organization}/feeds/{feed} \x01\"\x9b\x02\n" +
	"\x19SearchAllResourcesRequest\x12\x19\n" +
	"\x05scope\x18\x01 \x01(\tB\x03\xe0A\x02R\x05scope\x12\x19\n" +
	"\x05query\x18\x02 \x01(\tB\x03\xe0A\x01R\x05query\x12$\n" +
	"\vasset_types\x18\x03 \x03(\tB\x03\xe0A\x01R\n" +
	"assetTypes\x12 \n" +
	"\tpage_size\x18\x04 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x05 \x01(\tB\x03\xe0A\x01R\tpageToken\x12\x1e\n" +
	"\border_by\x18\x06 \x01(\tB\x03\xe0A\x01R\aorderBy\x12<\n" +
	"\tread_mask\x18\b \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x01R\breadMask\"\x8b\x01\n" +
	"\x1aSearchAllResourcesResponse\x12E\n" +
	"\aresults\x18\x01 \x03(\v2+.google.cloud.asset.v1.ResourceSearchResultR\aresults\x12&\n" +
	...
	"\vasset_types\x18\x05 \x03(\tB\x03\xe0A\x01R\n" +
	"assetTypes\x12\x1e\n" +
	"\border_by\x18\a \x01(\tB\x03\xe0A\x01R\aorderBy\"\x8e\x01\n" +
	"\x1cSearchAllIamPoliciesResponse\x12F\n" +
	"\aresults\x18\x01 \x03(\v2,.google.cloud.asset.v1.IamPolicySearchResultR\aresults\x12&\n" +
	...
	"\x11resource_selector\x18\x02 \x01(\v2>.google.cloud.asset.v1.IamPolicyAnalysisQuery.ResourceSelectorB\x03\xe0A\x01R\x10resourceSelector\x12p\n" +
	"\x11identity_selector\x18\x03 \x01(\v2>.google.cloud.asset.v1.IamPolicyAnalysisQuery.IdentitySelectorB\x03\xe0A\x01R\x10identitySelector\x12j\n" +
	"\x0faccess_selector\x18\x04 \x01(\v2<.google.cloud.asset.v1.IamPolicyAnalysisQuery.AccessSelectorB\x03\xe0A\x01R\x0eaccessSelector\x12T\n" +
	"\aoptions\x18\x05 \x01(\v25.google.cloud.asset.v1.IamPolicyAnalysisQuery.OptionsB\x03\xe0A\x01R\aoptions\x12p\n" +
	"\x11condition_context\x18\x06 \x01(\v2>.google.cloud.asset.v1.IamPolicyAnalysisQuery.ConditionContextB\x03\xe0A\x01R\x10conditionContext\x1aE\n" +
	"\x10ResourceSelector\x121\n" +
	"\x12full_resource_name\x18\x01 \x01(\tB\x03\xe0A\x02R\x10fullResourceName\x1a3\n" +
	"\x10IdentitySelector\x12\x1f\n" +
	"\bidentity\x18\x01 \x01(\tB\x03\xe0A\x02R\bidentity\x1aR\n" +
	"\x0eAccessSelector\x12\x19\n" +
	"\x05roles\x18\x01 \x03(\tB\x03\xe0A\x01R\x05roles\x12%\n" +
	"\vpermissions\x18\x02 \x03(\tB\x03\xe0A\x01R\vpermissions\x1a\xcf\x02\n" +
	"\aOptions\x12(\n" +
	"\rexpand_groups\x18\x01 \x01(\bB\x03\xe0A\x01R\fexpandGroups\x12&\n" +
	"\fexpand_roles\x18\x02 \x01(\bB\x03\xe0A\x01R\vexpandRoles\x12.\n" +
	"\x10expand_resources\x18\x03 \x01(\bB\x03\xe0A\x01R\x0fexpandResources\x127\n" +
	"\x15output_resource_edges\x18\x04 \x01(\bB\x03\xe0A\x01R\x13outputResourceEdges\x121\n" +
	"\x12output_group_edges\x18\x05 \x01(\bB\x03\xe0A\x01R\x10outputGroupEdges\x12V\n" +
	"%analyze_service_account_impersonation\x18\x06 \x01(\bB\x03\xe0A\x01R\"analyzeServiceAccountImpersonation\x1a`\n" +
	"\x10ConditionContext\x12=\n" +
	"\vaccess_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampH\x00R\n" +
	"accessTimeB\r\n" +
	"\vTimeContext\"\xf8\x01\n" +
	"\x17AnalyzeIamPolicyRequest\x12Y\n" +
	"\x0eanalysis_query\x18\x01 \x01(\v2-.google.cloud.asset.v1.IamPolicyAnalysisQueryB\x03\xe0A\x02R\ranalysisQuery\x125\n" +
	"\x14saved_analysis_query\x18\x03 \x01(\tB\x03\xe0A\x01R\x12savedAnalysisQuery\x12K\n" +
	"\x11execution_timeout\x18\x02 \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x01R\x10executionTimeout\"\x8f\x05\n" +
	"\x18AnalyzeIamPolicyResponse\x12f\n" +
	"\rmain_analysis\x18\x01 \x01(\v2A.google.cloud.asset.v1.AnalyzeIamPolicyResponse.IamPolicyAnalysisR\fmainAnalysis\x12\x96\x01\n" +
	"&service_account_impersonation_analysis\x18\x02 \x03(\v2A.google.cloud.asset.v1.AnalyzeIamPolicyResponse.IamPolicyAnalysisR#serviceAccountImpersonationAnalysis\x12%\n" +
	"\x0efully_explored\x18\x03 \x01(\bR\rfullyExplored\x1a\xca\x02\n" +
	"\x11IamPolicyAnalysis\x12T\n" +
	"\x0eanalysis_query\x18\x01 \x01(\v2-.google.cloud.asset.v1.IamPolicyAnalysisQueryR\ranalysisQuery\x12Y\n" +
	"\x10analysis_results\x18\x02 \x03(\v2..google.cloud.asset.v1.IamPolicyAnalysisResultR\x0fanalysisResults\x12%\n" +
	"\x0efully_explored\x18\x03 \x01(\bR\rfullyExplored\x12]\n" +
	"\x13non_critical_errors\x18\x05 \x03(\v2-.google.cloud.asset.v1.IamPolicyAnalysisStateR\x11nonCriticalErrors\"\x94\x05\n" +
	"\x1dIamPolicyAnalysisOutputConfig\x12n\n" +
	"\x0fgcs_destination\x18\x01 \x01(\v2C.google.cloud.asset.v1.IamPolicyAnalysisOutputConfig.GcsDestinationH\x00R\x0egcsDestination\x12}\n" +
	"\x14bigquery_destination\x18\x02 \x01(\v2H.google.cloud.asset.v1.IamPolicyAnalysisOutputConfig.BigQueryDestinationH\x00R\x13bigqueryDestination\x1a'\n" +
	"\x0eGcsDestination\x12\x15\n" +
	"\x03uri\x18\x01 \x01(\tB\x03\xe0A\x02R\x03uri\x1a\xcb\x02\n" +
	"\x13BigQueryDestination\x12\x1d\n" +
	"\adataset\x18\x01 \x01(\tB\x03\xe0A\x02R\adataset\x12&\n" +
	"\ftable_prefix\x18\x02 \x01(\tB\x03\xe0A\x02R\vtablePrefix\x12z\n" +
	"\rpartition_key\x18\x03 \x01(\x0e2U.google.cloud.asset.v1.IamPolicyAnalysisOutputConfig.BigQueryDestination.PartitionKeyR\fpartitionKey\x120\n" +
	"\x11write_disposition\x18\x04 \x01(\tB\x03\xe0A\x01R\x10writeDisposition\"?\n" +
	"\fPartitionKey\x12\x1d\n" +
	"\x19PARTITION_KEY_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fREQUEST_TIME\x10\x01B\r\n" +
	"\vdestination\"\x96\x02\n" +
	"\"AnalyzeIamPolicyLongrunningRequest\x12Y\n" +
	"\x0eanalysis_query\x18\x01 \x01(\v2-.google.cloud.asset.v1.IamPolicyAnalysisQueryB\x03\xe0A\x02R\ranalysisQuery\x125\n" +
	"\x14saved_analysis_query\x18\x03 \x01(\tB\x03\xe0A\x01R\x12savedAnalysisQuery\x12^\n" +
	"\routput_config\x18\x02 \x01(\v24.google.cloud.asset.v1.IamPolicyAnalysisOutputConfigB\x03\xe0A\x02R\foutputConfig\"%\n" +
	"#AnalyzeIamPolicyLongrunningResponse\"\xb2\x06\n" +
	"\n" +
	"SavedQuery\x12\x12\n" +
	...
	"createTime\x12\x1d\n" +
	"\acreator\x18\x04 \x01(\tB\x03\xe0A\x03R\acreator\x12I\n" +
	"\x10last_update_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\x0elastUpdateTime\x12&\n" +
	"\flast_updater\x18\x06 \x01(\tB\x03\xe0A\x03R\vlastUpdater\x12E\n" +
	"\x06labels\x18\a \x03(\v2-.google.cloud.asset.v1.SavedQuery.LabelsEntryR\x06labels\x12H\n" +
	"\acontent\x18\b \x01(\v2..google.cloud.asset.v1.SavedQuery.QueryContentR\acontent\x1a\x8b\x01\n" +
	"\fQueryContent\x12j\n" +
	"\x19iam_policy_analysis_query\x18\x01 \x01(\v2-.google.cloud.asset.v1.IamPolicyAnalysisQueryH\x00R\x16iamPolicyAnalysisQueryB\x0f\n" +
	"\rquery_content\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\xbf\x01\xeaA\xbb\x01\n" +
	"$cloudasset.googleapis.com/SavedQuery\x12-projects/{project}/savedQueries/{saved_query}\x12+folders/{folder}/savedQueries/{saved_query}\x127organizations/{organization}/savedQueries/{saved_query}\"\xd3\x01\n" +
	"\x17CreateSavedQueryRequest\x12D\n" +
	"\x06parent\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\x12$cloudasset.googleapis.com/SavedQueryR\x06parent\x12G\n" +
	"\vsaved_query\x18\x02 \x01(\v2!.google.cloud.asset.v1.SavedQueryB\x03\xe0A\x02R\n" +
	"savedQuery\x12)\n" +
	"\x0esaved_query_id\x18\x03 \x01(\tB\x03\xe0A\x02R\fsavedQueryId\"X\n" +
	"\x14GetSavedQueryRequest\x12@\n" +
	"\x04name\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\n" +
	"$cloudasset.googleapis.com/SavedQueryR\x04name\"\xc2\x01\n" +
	"\x17ListSavedQueriesRequest\x12D\n" +
	"\x06parent\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\x12$cloudasset.googleapis.com/SavedQueryR\x06parent\x12\x1b\n" +
	"\x06filter\x18\x04 \x01(\tB\x03\xe0A\x01R\x06filter\x12 \n" +
	"\tpage_size\x18\x02 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tB\x03\xe0A\x01R\tpageToken\"\x8a\x01\n" +
	"\x18ListSavedQueriesResponse\x12F\n" +
	"\rsaved_queries\x18\x01 \x03(\v2!.google.cloud.asset.v1.SavedQueryR\fsavedQueries\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xa4\x01\n" +
	"\x17UpdateSavedQueryRequest\x12G\n" +
	"\vsaved_query\x18\x01 \x01(\v2!.google.cloud.asset.v1.SavedQueryB\x03\xe0A\x02R\n" +
	"savedQuery\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"[\n" +
	"\x17DeleteSavedQueryRequest\x12@\n" +
	"\x04name\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\n" +
	"$cloudasset.googleapis.com/SavedQueryR\x04name\"\xaf\x02\n" +
	"\x12AnalyzeMoveRequest\x12O\n" +
	"\bresource\x18\x01 \x01(\tB3\xe0A\x02\xfaA-\n" +
	"+cloudresourcemanager.googleapis.com/ProjectR\bresource\x128\n" +
	"\x12destination_parent\x18\x02 \x01(\tB\t\xe0A\x02\xfaA\x03\n" +
	"\x01*R\x11destinationParent\x12J\n" +
	"\x04view\x18\x03 \x01(\x0e26.google.cloud.asset.v1.AnalyzeMoveRequest.AnalysisViewR\x04view\"B\n" +
	"\fAnalysisView\x12\x1d\n" +
	"\x19ANALYSIS_VIEW_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04FULL\x10\x01\x12\t\n" +
	"\x05BASIC\x10\x02\"_\n" +
	"\x13AnalyzeMoveResponse\x12H\n" +
	"\rmove_analysis\x18\x01 \x03(\v2#.google.cloud.asset.v1.MoveAnalysisR\fmoveAnalysis\"\xb0\x01\n" +
	"\fMoveAnalysis\x12!\n" +
	"\fdisplay_name\x18\x01 \x01(\tR\vdisplayName\x12G\n" +
	"\banalysis\x18\x02 \x01(\v2).google.cloud.asset.v1.MoveAnalysisResultH\x00R\banalysis\x12*\n" +
	"\x05error\x18\x03 \x01(\v2\x12.google.rpc.StatusH\x00R\x05errorB\b\n" +
	"\x06result\"\x92\x01\n" +
	"\x12MoveAnalysisResult\x12=\n" +
	"\bblockers\x18\x01 \x03(\v2!.google.cloud.asset.v1.MoveImpactR\bblockers\x12=\n" +
	"\bwarnings\x18\x02 \x03(\v2!.google.cloud.asset.v1.MoveImpactR\bwarnings\"$\n" +
	"\n" +
	"MoveImpact\x12\x16\n" +
	"\x06detail\x18\x01 \x01(\tR\x06detail\"\x8e\x02\n" +
	"\x17QueryAssetsOutputConfig\x12u\n" +
	"\x14bigquery_destination\x18\x01 \x01(\v2B.google.cloud.asset.v1.QueryAssetsOutputConfig.BigQueryDestinationR\x13bigqueryDestination\x1a|\n" +
	"\x13BigQueryDestination\x12\x1d\n" +
	"\adataset\x18\x01 \x01(\tB\x03\xe0A\x02R\adataset\x12\x19\n" +
	"\x05table\x18\x02 \x01(\tB\x03\xe0A\x02R\x05table\x12+\n" +
	"\x11write_disposition\x18\x03 \x01(\tR\x10writeDisposition\"\xa5\x04\n" +
	"\x12QueryAssetsRequest\x12?\n" +
	"\x06parent\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\x12\x1fcloudasset.googleapis.com/AssetR\x06parent\x12#\n" +
	"\tstatement\x18\x02 \x01(\tB\x03\xe0A\x01H\x00R\tstatement\x12*\n" +
	"\rjob_reference\x18\x03 \x01(\tB\x03\xe0A\x01H\x00R\fjobReference\x12 \n" +
	"\tpage_size\x18\x04 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x05 \x01(\tB\x03\xe0A\x01R\tpageToken\x128\n" +
	"\atimeout\x18\x06 \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x01R\atimeout\x12R\n" +
	"\x10read_time_window\x18\a \x01(\v2!.google.cloud.asset.v1.TimeWindowB\x03\xe0A\x01H\x01R\x0ereadTimeWindow\x12>\n" +
	"\tread_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x01H\x01R\breadTime\x12X\n" +
	"\routput_config\x18\t \x01(\v2..google.cloud.asset.v1.QueryAssetsOutputConfigB\x03\xe0A\x01R\foutputConfigB\a\n" +
	"\x05queryB\x06\n" +
	"\x04time\"\xa6\x02\n" +
	"\x13QueryAssetsResponse\x12#\n" +
	"\rjob_reference\x18\x01 \x01(\tR\fjobReference\x12\x12\n" +
	"\x04done\x18\x02 \x01(\bR\x04done\x12*\n" +
	"\x05error\x18\x03 \x01(\v2\x12.google.rpc.StatusH\x00R\x05error\x12G\n" +
	"\fquery_result\x18\x04 \x01(\v2\".google.cloud.asset.v1.QueryResultH\x00R\vqueryResult\x12U\n" +
	"\routput_config\x18\x05 \x01(\v2..google.cloud.asset.v1.QueryAssetsOutputConfigH\x00R\foutputConfigB\n" +
	"\n" +
	"\bresponse\"\xbd\x01\n" +
	"\vQueryResult\x12+\n" +
	"\x04rows\x18\x01 \x03(\v2\x17.google.protobuf.StructR\x04rows\x12:\n" +
	"\x06schema\x18\x02 \x01(\v2\".google.cloud.asset.v1.TableSchemaR\x06schema\x12&\n" +
	"\x0fnext_page_token\x18\x03 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	"total_rows\x18\x04 \x01(\x03R\ttotalRows\"N\n" +
	"\vTableSchema\x12?\n" +
	"\x06fields\x18\x01 \x03(\v2'.google.cloud.asset.v1.TableFieldSchemaR\x06fields\"\x91\x01\n" +
	"\x10TableFieldSchema\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x12\n" +
	"\x04mode\x18\x03 \x01(\tR\x04mode\x12?\n" +
	"\x06fields\x18\x04 \x03(\v2'.google.cloud.asset.v1.TableFieldSchemaR\x06fields\"g\n" +
	"#BatchGetEffectiveIamPoliciesRequest\x12\x1f\n" +
	"\x05scope\x18\x01 \x01(\tB\t\xe0A\x02\xfaA\x03\x12\x01*R\x05scope\x12\x1f\n" +
	"\x05names\x18\x03 \x03(\tB\t\xe0A\x02\xfaA\x03\n" +
	"\x01*R\x05names\"\xc3\x03\n" +
	"$BatchGetEffectiveIamPoliciesResponse\x12u\n" +
	"\x0epolicy_results\x18\x02 \x03(\v2N.google.cloud.asset.v1.BatchGetEffectiveIamPoliciesResponse.EffectiveIamPolicyR\rpolicyResults\x1a\xa3\x02\n" +
	"\x12EffectiveIamPolicy\x12,\n" +
	"\x12full_resource_name\x18\x01 \x01(\tR\x10fullResourceName\x12u\n" +
	"\bpolicies\x18\x02 \x03(\v2Y.google.cloud.asset.v1.BatchGetEffectiveIamPoliciesResponse.EffectiveIamPolicy.PolicyInfoR\bpolicies\x1ah\n" +
	"\n" +
	"PolicyInfo\x12+\n" +
	"\x11attached_resource\x18\x01 \x01(\tR\x10attachedResource\x12-\n" +
	"\x06policy\x18\x02 \x01(\v2\x15.google.iam.v1.PolicyR\x06policy\"\xa1\x05\n" +
	"\x11AnalyzerOrgPolicy\x12+\n" +
	"\x11attached_resource\x18\x01 \x01(\tR\x10attachedResource\x12)\n" +
	"\x10applied_resource\x18\x05 \x01(\tR\x0fappliedResource\x12C\n" +
	"\x05rules\x18\x02 \x03(\v2-.google.cloud.asset.v1.AnalyzerOrgPolicy.RuleR\x05rules\x12.\n" +
	"\x13inherit_from_parent\x18\x03 \x01(\bR\x11inheritFromParent\x12\x14\n" +
	"\x05reset\x18\x04 \x01(\bR\x05reset\x1a\xa8\x03\n" +
	"\x04Rule\x12T\n" +
	"\x06values\x18\x03 \x01(\v2:.google.cloud.asset.v1.AnalyzerOrgPolicy.Rule.StringValuesH\x00R\x06values\x12\x1d\n" +
	"\tallow_all\x18\x04 \x01(\bH\x00R\ballowAll\x12\x1b\n" +
	"\bdeny_all\x18\x05 \x01(\bH\x00R\adenyAll\x12\x1a\n" +
	"\aenforce\x18\x06 \x01(\bH\x00R\aenforce\x12/\n" +
	"\tcondition\x18\a \x01(\v2\x11.google.type.ExprR\tcondition\x12]\n" +
	"\x14condition_evaluation\x18\b \x01(\v2*.google.cloud.asset.v1.ConditionEvaluationR\x13conditionEvaluation\x1aZ\n" +
	"\fStringValues\x12%\n" +
	...
	"\x19google_defined_constraint\x18\x01 \x01(\v2=.google.cloud.asset.v1.AnalyzerOrgPolicyConstraint.ConstraintH\x00R\x17googleDefinedConstraint\x12r\n" +
	"\x11custom_constraint\x18\x02 \x01(\v2C.google.cloud.asset.v1.AnalyzerOrgPolicyConstraint.CustomConstraintH\x00R\x10customConstraint\x1a\xb1\x05\n" +
	"\n" +
	"Constraint\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12~\n" +
	"\x12constraint_default\x18\x04 \x01(\x0e2O.google.cloud.asset.v1.AnalyzerOrgPolicyConstraint.Constraint.ConstraintDefaultR\x11constraintDefault\x12w\n" +
	"\x0flist_constraint\x18\x05 \x01(\v2L.google.cloud.asset.v1.AnalyzerOrgPolicyConstraint.Constraint.ListConstraintH\x00R\x0elistConstraint\x12\x80\x01\n" +
	"\x12boolean_constraint\x18\x06 \x01(\v2O.google.cloud.asset.v1.AnalyzerOrgPolicyConstraint.Constraint.BooleanConstraintH\x00R\x11booleanConstraint\x1aX\n" +
	"\x0eListConstraint\x12\x1f\n" +
	"\vsupports_in\x18\x01 \x01(\bR\n" +
	"supportsIn\x12%\n" +
	"\x0esupports_under\x18\x02 \x01(\bR\rsupportsUnder\x1a\x13\n" +
	...
	"\x0fconstraint_type\x1a\xc6\x04\n" +
	"\x10CustomConstraint\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12%\n" +
	"\x0eresource_types\x18\x02 \x03(\tR\rresourceTypes\x12q\n" +
	"\fmethod_types\x18\x03 \x03(\x0e2N.google.cloud.asset.v1.AnalyzerOrgPolicyConstraint.CustomConstraint.MethodTypeR\vmethodTypes\x12\x1c\n" +
	"\tcondition\x18\x04 \x01(\tR\tcondition\x12o\n" +
	"\vaction_type\x18\x05 \x01(\x0e2N.google.cloud.asset.v1.AnalyzerOrgPolicyConstraint.CustomConstraint.ActionTypeR\n" +
	"actionType\x12!\n" +
	...
	"\x05scope\x18\x01 \x01(\tB\x03\xe0A\x02R\x05scope\x12#\n" +
	"\n" +
	"constraint\x18\x02 \x01(\tB\x03\xe0A\x02R\n" +
	"constraint\x12\x16\n" +
	"\x06filter\x18\x03 \x01(\tR\x06filter\x12 \n" +
	"\tpage_size\x18\x04 \x01(\x05H\x00R\bpageSize\x88\x01\x01\x12\x1d\n" +
	"\n" +
	"page_token\x18\x05 \x01(\tR\tpageTokenB\f\n" +
	"\n" +
	"_page_size\"\x9f\x04\n" +
	"\x1aAnalyzeOrgPoliciesResponse\x12o\n" +
	"\x12org_policy_results\x18\x01 \x03(\v2A.google.cloud.asset.v1.AnalyzeOrgPoliciesResponse.OrgPolicyResultR\x10orgPolicyResults\x12R\n" +
	"\n" +
	"constraint\x18\x02 \x01(\v22.google.cloud.asset.v1.AnalyzerOrgPolicyConstraintR\n" +
	"constraint\x12&\n" +
	"\x0fnext_page_token\x18\x03 \x01(\tR\rnextPageToken\x1a\x93\x02\n" +
	"\x0fOrgPolicyResult\x12Y\n" +
	"\x13consolidated_policy\x18\x01 \x01(\v2(.google.cloud.asset.v1.AnalyzerOrgPolicyR\x12consolidatedPolicy\x12M\n" +
	"\rpolicy_bundle\x18\x02 \x03(\v2(.google.cloud.asset.v1.AnalyzerOrgPolicyR\fpolicyBundle\x12\x18\n" +
	"\aproject\x18\x03 \x01(\tR\aproject\x12\x18\n" +
	"\afolders\x18\x04 \x03(\tR\afolders\x12\"\n" +
	"\forganization\x18\x05 \x01(\tR\forganization\"\xd2\x01\n" +
	...
	"\n" +
	"_page_size\"\xe0\x05\n" +
	"*AnalyzeOrgPolicyGovernedContainersResponse\x12\x84\x01\n" +
	"\x13governed_containers\x18\x01 \x03(\v2S.google.cloud.asset.v1.AnalyzeOrgPolicyGovernedContainersResponse.GovernedContainerR\x12governedContainers\x12R\n" +
	"\n" +
	"constraint\x18\x02 \x01(\v22.google.cloud.asset.v1.AnalyzerOrgPolicyConstraintR\n" +
	"constraint\x12&\n" +
	"\x0fnext_page_token\x18\x03 \x01(\tR\rnextPageToken\x1a\xae\x03\n" +
	"\x11GovernedContainer\x12,\n" +
	"\x12full_resource_name\x18\x01 \x01(\tR\x10fullResourceName\x12\x16\n" +
	"\x06parent\x18\x02 \x01(\tR\x06parent\x12Y\n" +
	"\x13consolidated_policy\x18\x03 \x01(\v2(.google.cloud.asset.v1.AnalyzerOrgPolicyR\x12consolidatedPolicy\x12M\n" +
	"\rpolicy_bundle\x18\x04 \x03(\v2(.google.cloud.asset.v1.AnalyzerOrgPolicyR\fpolicyBundle\x12\x18\n" +
	"\aproject\x18\x05 \x01(\tR\aproject\x12\x18\n" +
	"\afolders\x18\x06 \x03(\tR\afolders\x12\"\n" +
	"\forganization\x18\a \x01(\tR\forganization\x12Q\n" +
	"\x0eeffective_tags\x18\b \x03(\v2*.google.cloud.asset.v1.EffectiveTagDetailsR\reffectiveTags\"\xce\x01\n" +
	...
	"\x0fgoverned_assets\x18\x01 \x03(\v2K.google.cloud.asset.v1.AnalyzeOrgPolicyGovernedAssetsResponse.GovernedAssetR\x0egovernedAssets\x12R\n" +
	"\n" +
	"constraint\x18\x02 \x01(\v22.google.cloud.asset.v1.AnalyzerOrgPolicyConstraintR\n" +
	"constraint\x12&\n" +
	"\x0fnext_page_token\x18\x03 \x01(\tR\rnextPageToken\x1a\xa2\x02\n" +
	"\x10GovernedResource\x12,\n" +
	"\x12full_resource_name\x18\x01 \x01(\tR\x10fullResourceName\x12\x16\n" +
	"\x06parent\x18\x02 \x01(\tR\x06parent\x12\x18\n" +
	"\aproject\x18\x05 \x01(\tR\aproject\x12\x18\n" +
	"\afolders\x18\x06 \x03(\tR\afolders\x12\"\n" +
	"\forganization\x18\a \x01(\tR\forganization\x12\x1d\n" +
	"\n" +
	"asset_type\x18\b \x01(\tR\tassetType\x12Q\n" +
	"\x0eeffective_tags\x18\t \x03(\v2*.google.cloud.asset.v1.EffectiveTagDetailsR\reffectiveTags\x1a\xe6\x01\n" +
	"\x11GovernedIamPolicy\x12+\n" +
	"\x11attached_resource\x18\x01 \x01(\tR\x10attachedResource\x12-\n" +
	"\x06policy\x18\x02 \x01(\v2\x15.google.iam.v1.PolicyR\x06policy\x12\x18\n" +
	"\aproject\x18\x05 \x01(\tR\aproject\x12\x18\n" +
	"\afolders\x18\x06 \x03(\tR\afolders\x12\"\n" +
	"\forganization\x18\a \x01(\tR\forganization\x12\x1d\n" +
	"\n" +
	"asset_type\x18\b \x01(\tR\tassetType\x1a\xce\x03\n" +
	"\rGovernedAsset\x12}\n" +
	"\x11governed_resource\x18\x01 \x01(\v2N.google.cloud.asset.v1.AnalyzeOrgPolicyGovernedAssetsResponse.GovernedResourceH\x00R\x10governedResource\x12\x81\x01\n" +
	"\x13governed_iam_policy\x18\x02 \x01(\v2O.google.cloud.asset.v1.AnalyzeOrgPolicyGovernedAssetsResponse.GovernedIamPolicyH\x00R\x11governedIamPolicy\x12Y\n" +
	"\x13consolidated_policy\x18\x03 \x01(\v2(.google.cloud.asset.v1.AnalyzerOrgPolicyR\x12consolidatedPolicy\x12M\n" +
	"\rpolicy_bundle\x18\x04 \x03(\v2(.google.cloud.asset.v1.AnalyzerOrgPolicyR\fpolicyBundleB\x10\n" +
	...
	"\fOS_INVENTORY\x10\x06\x12\x10\n" +
	"\fRELATIONSHIP\x10\a2\xd1 \n" +
	"\fAssetService\x12\xde\x01\n" +
	"\fExportAssets\x12*.google.cloud.asset.v1.ExportAssetsRequest\x1a\x1d.google.longrunning.Operation\"\x82\x01\xcaAW\n" +
	"*google.cloud.asset.v1.ExportAssetsResponse\x12)google.cloud.asset.v1.ExportAssetsRequest\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/v1/{parent=*/*}:exportAssets\x12\x8b\x01\n" +
	"\n" +
	...
	"\n" +
	"CreateFeed\x12(.google.cloud.asset.v1.CreateFeedRequest\x1a\x1b.google.cloud.asset.v1.Feed\"*\xdaA\x06parent\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/v1/{parent=*/*}/feeds\x12t\n" +
	"\aGetFeed\x12%.google.cloud.asset.v1.GetFeedRequest\x1a\x1b.google.cloud.asset.v1.Feed\"%\xdaA\x04name\x82\xd3\xe4\x93\x02\x18\x12\x16/v1/{name=*/*/feeds/*}\x12\x87\x01\n" +
	...
	"\n" +
	"UpdateFeed\x12(.google.cloud.asset.v1.UpdateFeedRequest\x1a\x1b.google.cloud.asset.v1.Feed\"-\xdaA\x04feed\x82\xd3\xe4\x93\x02 :\x01*2\x1b/v1/{feed.name=*/*/feeds/*}\x12u\n" +
	"\n" +
	...
	"\x14SearchAllIamPolicies\x122.google.cloud.asset.v1.SearchAllIamPoliciesRequest\x1a3.google.cloud.asset.v1.SearchAllIamPoliciesResponse\":\xdaA\vscope,query\x82\xd3\xe4\x93\x02&\x12$/v1/{scope=*/*}:searchAllIamPolicies\x12\xac\x01\n" +
	...
	"9google.cloud.asset.v1.AnalyzeIamPolicyLongrunningResponse\x129google.cloud.asset.v1.AnalyzeIamPolicyLongrunningMetadata\x82\xd3\xe4\x93\x02?:\x01*\":/v1/{analysis_query.scope=*/*}:analyzeIamPolicyLongrunning\x12\x8c\x01\n" +
	"\vAnalyzeMove\x12).google.cloud.asset.v1.AnalyzeMoveRequest\x1a*.google.cloud.asset.v1.AnalyzeMoveResponse\"&\x82\xd3\xe4\x93\x02 \x12\x1e/v1/{resource=*/*}:analyzeMove\x12\x8d\x01\n" +
	"\vQueryAssets\x12).google.cloud.asset.v1.QueryAssetsRequest\x1a*.google.cloud.asset.v1.QueryAssetsResponse\"'\x82\xd3\xe4\x93\x02!:\x01*\"\x1c/v1/{parent=*/*}:queryAssets\x12\xbd\x01\n" +
	"\x10CreateSavedQuery\x12..google.cloud.asset.v1.CreateSavedQueryRequest\x1a!.google.cloud.asset.v1.SavedQuery\"V\xdaA!parent,saved_query,saved_query_id\x82\xd3\xe4\x93\x02,:\vsaved_query\"\x1d/v1/{parent=*/*}/savedQueries\x12\x8d\x01\n" +
	...
	"\x10UpdateSavedQuery\x12..google.cloud.asset.v1.UpdateSavedQueryRequest\x1a!.google.cloud.asset.v1.SavedQuery\"X\xdaA\x17saved_query,update_mask\x82\xd3\xe4\x93\x028:\vsaved_query2)/v1/{saved_query.name=*/*/savedQueries/*}\x12\x88\x01\n" +
...
var (
	...
	file_google_cloud_asset_v1_asset_service_proto_rawDescData []byte
)
...
func file_google_cloud_asset_v1_asset_service_proto_rawDescGZIP() []byte {
	file_google_cloud_asset_v1_asset_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_asset_v1_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_asset_v1_asset_service_proto_rawDesc), len(file_google_cloud_asset_v1_asset_service_proto_rawDesc)))
	})
...
func file_google_cloud_asset_v1_asset_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_asset_v1_asset_service_proto_rawDesc), len(file_google_cloud_asset_v1_asset_service_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   84,
			NumExtensions: 0,
			NumServices:   1,
