...
type Shipment struct {
	...
	// considered as null.
	LoadDemands map[string]*Shipment_Load `protobuf:"bytes,14,rep,name=load_demands,json=loadDemands,proto3" json:"load_demands,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type Vehicle struct {
	...
	LoadLimits map[string]*Vehicle_LoadLimit `protobuf:"bytes,30,rep,name=load_limits,json=loadLimits,proto3" json:"load_limits,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	// type in the map.
	ExtraVisitDurationForVisitType map[string]*durationpb.Duration `protobuf:"bytes,24,rep,name=extra_visit_duration_for_visit_type,json=extraVisitDurationForVisitType,proto3" json:"extra_visit_duration_for_visit_type,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type ShipmentRoute struct {
	...
	RouteCosts map[string]float64 `protobuf:"bytes,17,rep,name=route_costs,json=routeCosts,proto3" json:"route_costs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"fixed64,2,opt,name=value"`
...
type AggregatedMetrics struct {
	...
	MaxLoads map[string]*ShipmentRoute_VehicleLoad `protobuf:"bytes,9,rep,name=max_loads,json=maxLoads,proto3" json:"max_loads,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Deprecated: Use
	...
	//
	// Deprecated: Marked as deprecated in google/cloud/optimization/v1/fleet_routing.proto.
	Costs map[string]float64 `protobuf:"bytes,10,rep,name=costs,proto3" json:"costs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"fixed64,2,opt,name=value"`
	// Deprecated: Use
...
type Shipment_VisitRequest struct {
	...
	// [Shipment.load_demands][google.cloud.optimization.v1.Shipment.load_demands].
	LoadDemands map[string]*Shipment_Load `protobuf:"bytes,12,rep,name=load_demands,json=loadDemands,proto3" json:"load_demands,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type ShipmentRoute_Visit struct {
	...
	// (see this field).
	LoadDemands map[string]*Shipment_Load `protobuf:"bytes,11,rep,name=load_demands,json=loadDemands,proto3" json:"load_demands,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type ShipmentRoute_Transition struct {
	...
	VehicleLoads map[string]*ShipmentRoute_VehicleLoad `protobuf:"bytes,11,rep,name=vehicle_loads,json=vehicleLoads,proto3" json:"vehicle_loads,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Deprecated: Use
	// [Transition.vehicle_loads][google.cloud.optimization.v1.ShipmentRoute.Transition.vehicle_loads]
	// instead.
	//
...
type OptimizeToursValidationError_FieldReference struct {
	...
	// Types that are valid to be assigned to IndexOrKey:
	//
...
func (x *OptimizeToursValidationError_FieldReference) GetIndexOrKey() isOptimizeToursValidationError_FieldReference_IndexOrKey {
	if x != nil {
		return x.IndexOrKey
	}
	return nil
...
func (x *OptimizeToursValidationError_FieldReference) GetIndex() int32 {
	if x != nil {
		if x, ok := x.IndexOrKey.(*OptimizeToursValidationError_FieldReference_Index); ok {
			return x.Index
		}
	}
	return 0
...
func (x *OptimizeToursValidationError_FieldReference) GetKey() string {
	if x != nil {
		if x, ok := x.IndexOrKey.(*OptimizeToursValidationError_FieldReference_Key); ok {
			return x.Key
		}
	}
	return ""
...
const file_google_cloud_optimization_v1_fleet_routing_proto_rawDesc = "" +
	"\n" +
	...
	"\x14OptimizeToursRequest\x12\x1b\n" +
	"\x06parent\x18\x01 \x01(\tB\x03\xe0A\x02R\x06parent\x123\n" +
	"\atimeout\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x12A\n" +
	"\x05model\x18\x03 \x01(\v2+.google.cloud.optimization.v1.ShipmentModelR\x05model\x12a\n" +
	"\fsolving_mode\x18\x04 \x01(\x0e2>.google.cloud.optimization.v1.OptimizeToursRequest.SolvingModeR\vsolvingMode\x12^\n" +
	"\vsearch_mode\x18\x06 \x01(\x0e2=.google.cloud.optimization.v1.OptimizeToursRequest.SearchModeR\n" +
	"searchMode\x12p\n" +
	"\x1einjected_first_solution_routes\x18\a \x03(\v2+.google.cloud.optimization.v1.ShipmentRouteR\x1binjectedFirstSolutionRoutes\x12z\n" +
	"\x1cinjected_solution_constraint\x18\b \x01(\v28.google.cloud.optimization.v1.InjectedSolutionConstraintR\x1ainjectedSolutionConstraint\x12a\n" +
	"\x16refresh_details_routes\x18\t \x03(\v2+.google.cloud.optimization.v1.ShipmentRouteR\x14refreshDetailsRoutes\x12X\n" +
	")interpret_injected_solutions_using_labels\x18\n" +
	" \x01(\bR%interpretInjectedSolutionsUsingLabels\x122\n" +
	"\x15consider_road_traffic\x18\v \x01(\bR\x13considerRoadTraffic\x12-\n" +
	"\x12populate_polylines\x18\f \x01(\bR\x11populatePolylines\x12B\n" +
	"\x1dpopulate_transition_polylines\x18\r \x01(\bR\x1bpopulateTransitionPolylines\x12a\n" +
	".allow_large_deadline_despite_interruption_risk\x18\x0e \x01(\bR)allowLargeDeadlineDespiteInterruptionRisk\x124\n" +
	"\x16use_geodesic_distances\x18\x0f \x01(\bR\x14useGeodesicDistances\x12@\n" +
	"\x1ageodesic_meters_per_second\x18\x10 \x01(\x01H\x00R\x17geodesicMetersPerSecond\x88\x01\x01\x127\n" +
	"\x15max_validation_errors\x18\x05 \x01(\x05H\x01R\x13maxValidationErrors\x88\x01\x01\x12\x14\n" +
	"\x05label\x18\x11 \x01(\tR\x05label\x12G\n" +
	"\x1epopulate_travel_step_polylines\x18\x14 \x01(\bB\x02\x18\x01R\x1bpopulateTravelStepPolylines\"Y\n" +
	"\vSolvingMode\x12\x11\n" +
	...
	"\vRETURN_FAST\x10\x01\x12\x1e\n" +
	"\x1aCONSUME_ALL_AVAILABLE_TIME\x10\x02B\x1d\n" +
	"\x1b_geodesic_meters_per_secondB\x18\n" +
	"\x16_max_validation_errors\"\x93\b\n" +
	"\x15OptimizeToursResponse\x12C\n" +
	"\x06routes\x18\x01 \x03(\v2+.google.cloud.optimization.v1.ShipmentRouteR\x06routes\x12#\n" +
	"\rrequest_label\x18\x03 \x01(\tR\frequestLabel\x12Z\n" +
	"\x11skipped_shipments\x18\x04 \x03(\v2-.google.cloud.optimization.v1.SkippedShipmentR\x10skippedShipments\x12g\n" +
	"\x11validation_errors\x18\x05 \x03(\v2:.google.cloud.optimization.v1.OptimizeToursValidationErrorR\x10validationErrors\x12U\n" +
	"\ametrics\x18\x06 \x01(\v2;.google.cloud.optimization.v1.OptimizeToursResponse.MetricsR\ametrics\x12!\n" +
	"\n" +
	"total_cost\x18\x02 \x01(\x01B\x02\x18\x01R\ttotalCost\x1a\xd0\x04\n" +
	"\aMetrics\x12i\n" +
	"\x18aggregated_route_metrics\x18\x01 \x01(\v2/.google.cloud.optimization.v1.AggregatedMetricsR\x16aggregatedRouteMetrics\x12G\n" +
	" skipped_mandatory_shipment_count\x18\x02 \x01(\x05R\x1dskippedMandatoryShipmentCount\x12,\n" +
	"\x12used_vehicle_count\x18\x03 \x01(\x05R\x10usedVehicleCount\x12Y\n" +
	"\x1bearliest_vehicle_start_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x18earliestVehicleStartTime\x12Q\n" +
	"\x17latest_vehicle_end_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x14latestVehicleEndTime\x12\\\n" +
	"\x05costs\x18\n" +
	" \x03(\v2F.google.cloud.optimization.v1.OptimizeToursResponse.Metrics.CostsEntryR\x05costs\x12\x1d\n" +
	"\n" +
	"total_cost\x18\x06 \x01(\x01R\ttotalCost\x1a8\n" +
	"\n" +
	"CostsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01\"\xbc\x03\n" +
	"\x19BatchOptimizeToursRequest\x12\x1b\n" +
	"\x06parent\x18\x01 \x01(\tB\x03\xe0A\x02R\x06parent\x12r\n" +
	"\rmodel_configs\x18\x02 \x03(\v2H.google.cloud.optimization.v1.BatchOptimizeToursRequest.AsyncModelConfigB\x03\xe0A\x02R\fmodelConfigs\x1a\x8d\x02\n" +
	"\x10AsyncModelConfig\x12!\n" +
	"\fdisplay_name\x18\x01 \x01(\tR\vdisplayName\x12Q\n" +
	"\finput_config\x18\x02 \x01(\v2).google.cloud.optimization.v1.InputConfigB\x03\xe0A\x02R\vinputConfig\x12T\n" +
	"\routput_config\x18\x03 \x01(\v2*.google.cloud.optimization.v1.OutputConfigB\x03\xe0A\x02R\foutputConfig\x12-\n" +
	"\x12enable_checkpoints\x18\x04 \x01(\bR\x11enableCheckpoints\"\x1c\n" +
	"\x1aBatchOptimizeToursResponse\"\xb8\x13\n" +
	"\rShipmentModel\x12D\n" +
	"\tshipments\x18\x01 \x03(\v2&.google.cloud.optimization.v1.ShipmentR\tshipments\x12A\n" +
	"\bvehicles\x18\x02 \x03(\v2%.google.cloud.optimization.v1.VehicleR\bvehicles\x123\n" +
	"\x13max_active_vehicles\x18\x04 \x01(\x05H\x00R\x11maxActiveVehicles\x88\x01\x01\x12F\n" +
	"\x11global_start_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x0fglobalStartTime\x12B\n" +
	"\x0fglobal_end_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\rglobalEndTime\x12@\n" +
	"\x1dglobal_duration_cost_per_hour\x18\a \x01(\x01R\x19globalDurationCostPerHour\x12\x80\x01\n" +
	"\x1aduration_distance_matrices\x18\b \x03(\v2B.google.cloud.optimization.v1.ShipmentModel.DurationDistanceMatrixR\x18durationDistanceMatrices\x12H\n" +
	"!duration_distance_matrix_src_tags\x18\t \x03(\tR\x1ddurationDistanceMatrixSrcTags\x12H\n" +
	"!duration_distance_matrix_dst_tags\x18\n" +
	" \x03(\tR\x1ddurationDistanceMatrixDstTags\x12g\n" +
	"\x15transition_attributes\x18\v \x03(\v22.google.cloud.optimization.v1.TransitionAttributesR\x14transitionAttributes\x12\x81\x01\n" +
	"\x1fshipment_type_incompatibilities\x18\f \x03(\v29.google.cloud.optimization.v1.ShipmentTypeIncompatibilityR\x1dshipmentTypeIncompatibilities\x12s\n" +
	"\x1ashipment_type_requirements\x18\r \x03(\v25.google.cloud.optimization.v1.ShipmentTypeRequirementR\x18shipmentTypeRequirements\x12e\n" +
	"\x10precedence_rules\x18\x0e \x03(\v2:.google.cloud.optimization.v1.ShipmentModel.PrecedenceRuleR\x0fprecedenceRules\x12Z\n" +
	"\vbreak_rules\x18\x0f \x03(\v25.google.cloud.optimization.v1.ShipmentModel.BreakRuleB\x02\x18\x01R\n" +
	"breakRules\x1a\xf8\x01\n" +
	"\x16DurationDistanceMatrix\x12Z\n" +
	"\x04rows\x18\x01 \x03(\v2F.google.cloud.optimization.v1.ShipmentModel.DurationDistanceMatrix.RowR\x04rows\x12*\n" +
	"\x11vehicle_start_tag\x18\x02 \x01(\tR\x0fvehicleStartTag\x1aV\n" +
	"\x03Row\x127\n" +
	"\tdurations\x18\x01 \x03(\v2\x19.google.protobuf.DurationR\tdurations\x12\x16\n" +
	"\x06meters\x18\x02 \x03(\x01R\x06meters\x1a\x9d\x02\n" +
	"\x0ePrecedenceRule\x12$\n" +
	"\vfirst_index\x18\x01 \x01(\x05H\x00R\n" +
	"firstIndex\x88\x01\x01\x12*\n" +
	"\x11first_is_delivery\x18\x03 \x01(\bR\x0ffirstIsDelivery\x12&\n" +
	"\fsecond_index\x18\x02 \x01(\x05H\x01R\vsecondIndex\x88\x01\x01\x12,\n" +
	"\x12second_is_delivery\x18\x04 \x01(\bR\x10secondIsDelivery\x12B\n" +
	"\x0foffset_duration\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\x0eoffsetDurationB\x0e\n" +
	"\f_first_indexB\x0f\n" +
	"\r_second_index\x1a\xab\x05\n" +
	"\tBreakRule\x12i\n" +
	"\x0ebreak_requests\x18\x01 \x03(\v2B.google.cloud.optimization.v1.ShipmentModel.BreakRule.BreakRequestR\rbreakRequests\x12~\n" +
	"\x15frequency_constraints\x18\x02 \x03(\v2I.google.cloud.optimization.v1.ShipmentModel.BreakRule.FrequencyConstraintR\x14frequencyConstraints\x1a\xef\x01\n" +
	"\fBreakRequest\x12O\n" +
	"\x13earliest_start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x02R\x11earliestStartTime\x12K\n" +
	"\x11latest_start_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x02R\x0flatestStartTime\x12A\n" +
	"\fmin_duration\x18\x03 \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x02R\vminDuration\x1a\xbc\x01\n" +
	"\x13FrequencyConstraint\x12L\n" +
	"\x12min_break_duration\x18\x01 \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x02R\x10minBreakDuration\x12W\n" +
	"\x18max_inter_break_duration\x18\x02 \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x02R\x15maxInterBreakDuration:\x02\x18\x01B\x16\n" +
	"\x14_max_active_vehicles\"\xae\x0f\n" +
	"\bShipment\x12M\n" +
	"\apickups\x18\x01 \x03(\v23.google.cloud.optimization.v1.Shipment.VisitRequestR\apickups\x12S\n" +
	"\n" +
	"deliveries\x18\x02 \x03(\v23.google.cloud.optimization.v1.Shipment.VisitRequestR\n" +
	"deliveries\x12Z\n" +
	"\fload_demands\x18\x0e \x03(\v27.google.cloud.optimization.v1.Shipment.LoadDemandsEntryR\vloadDemands\x12&\n" +
	"\fpenalty_cost\x18\x04 \x01(\x01H\x00R\vpenaltyCost\x88\x01\x01\x126\n" +
	"\x17allowed_vehicle_indices\x18\x05 \x03(\x05R\x15allowedVehicleIndices\x12*\n" +
	"\x11costs_per_vehicle\x18\x06 \x03(\x01R\x0fcostsPerVehicle\x129\n" +
	"\x19costs_per_vehicle_indices\x18\a \x03(\x05R\x16costsPerVehicleIndices\x12Z\n" +
	"(pickup_to_delivery_relative_detour_limit\x18\b \x01(\x01H\x01R#pickupToDeliveryRelativeDetourLimit\x88\x01\x01\x12p\n" +
	"(pickup_to_delivery_absolute_detour_limit\x18\t \x01(\v2\x19.google.protobuf.DurationR#pickupToDeliveryAbsoluteDetourLimit\x12[\n" +
	"\x1dpickup_to_delivery_time_limit\x18\n" +
	" \x01(\v2\x19.google.protobuf.DurationR\x19pickupToDeliveryTimeLimit\x12#\n" +
	"\rshipment_type\x18\v \x01(\tR\fshipmentType\x12\x14\n" +
	"\x05label\x18\f \x01(\tR\x05label\x12\x16\n" +
	"\x06ignore\x18\r \x01(\bR\x06ignore\x12L\n" +
	"\ademands\x18\x03 \x03(\v2..google.cloud.optimization.v1.CapacityQuantityB\x02\x18\x01R\ademands\x1a\xc3\x06\n" +
	"\fVisitRequest\x12>\n" +
	"\x10arrival_location\x18\x01 \x01(\v2\x13.google.type.LatLngR\x0farrivalLocation\x12Q\n" +
	"\x10arrival_waypoint\x18\x02 \x01(\v2&.google.cloud.optimization.v1.WaypointR\x0farrivalWaypoint\x12B\n" +
	"\x12departure_location\x18\x03 \x01(\v2\x13.google.type.LatLngR\x11departureLocation\x12U\n" +
	"\x12departure_waypoint\x18\x04 \x01(\v2&.google.cloud.optimization.v1.WaypointR\x11departureWaypoint\x12\x12\n" +
	"\x04tags\x18\x05 \x03(\tR\x04tags\x12K\n" +
	"\ftime_windows\x18\x06 \x03(\v2(.google.cloud.optimization.v1.TimeWindowR\vtimeWindows\x125\n" +
	"\bduration\x18\a \x01(\v2\x19.google.protobuf.DurationR\bduration\x12\x12\n" +
	"\x04cost\x18\b \x01(\x01R\x04cost\x12g\n" +
	"\fload_demands\x18\f \x03(\v2D.google.cloud.optimization.v1.Shipment.VisitRequest.LoadDemandsEntryR\vloadDemands\x12\x1f\n" +
	"\vvisit_types\x18\n" +
	" \x03(\tR\n" +
	"visitTypes\x12\x14\n" +
	"\x05label\x18\v \x01(\tR\x05label\x12L\n" +
	"\ademands\x18\t \x03(\v2..google.cloud.optimization.v1.CapacityQuantityB\x02\x18\x01R\ademands\x1ak\n" +
	"\x10LoadDemandsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12A\n" +
	"\x05value\x18\x02 \x01(\v2+.google.cloud.optimization.v1.Shipment.LoadR\x05value:\x028\x01\x1a\x1e\n" +
	"\x04Load\x12\x16\n" +
	"\x06amount\x18\x02 \x01(\x03R\x06amount\x1ak\n" +
	"\x10LoadDemandsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12A\n" +
	"\x05value\x18\x02 \x01(\v2+.google.cloud.optimization.v1.Shipment.LoadR\x05value:\x028\x01B\x0f\n" +
	"\r_penalty_costB+\n" +
	")_pickup_to_delivery_relative_detour_limit\"\xbf\x02\n" +
	"\x1bShipmentTypeIncompatibility\x12\x14\n" +
	"\x05types\x18\x01 \x03(\tR\x05types\x12\x80\x01\n" +
	"\x14incompatibility_mode\x18\x02 \x01(\x0e2M.google.cloud.optimization.v1.ShipmentTypeIncompatibility.IncompatibilityModeR\x13incompatibilityMode\"\x86\x01\n" +
	"\x13IncompatibilityMode\x12$\n" +
	" INCOMPATIBILITY_MODE_UNSPECIFIED\x10\x00\x12!\n" +
	"\x1dNOT_PERFORMED_BY_SAME_VEHICLE\x10\x01\x12&\n" +
	"\"NOT_IN_SAME_VEHICLE_SIMULTANEOUSLY\x10\x02\"\xb3\x03\n" +
	"\x17ShipmentTypeRequirement\x12M\n" +
	"#required_shipment_type_alternatives\x18\x01 \x03(\tR requiredShipmentTypeAlternatives\x128\n" +
	"\x18dependent_shipment_types\x18\x02 \x03(\tR\x16dependentShipmentTypes\x12p\n" +
	"\x10requirement_mode\x18\x03 \x01(\x0e2E.google.cloud.optimization.v1.ShipmentTypeRequirement.RequirementModeR\x0frequirementMode\"\x9c\x01\n" +
	...
	" IN_SAME_VEHICLE_AT_DELIVERY_TIME\x10\x03\"\xa5\x01\n" +
	"\x0eRouteModifiers\x12\x1f\n" +
	"\vavoid_tolls\x18\x02 \x01(\bR\n" +
	"avoidTolls\x12%\n" +
	"\x0eavoid_highways\x18\x03 \x01(\bR\ravoidHighways\x12#\n" +
	"\ravoid_ferries\x18\x04 \x01(\bR\favoidFerries\x12&\n" +
	"\favoid_indoor\x18\x05 \x01(\bB\x03\xe0A\x01R\vavoidIndoor\"\xd6\x1a\n" +
	"\aVehicle\x12Q\n" +
	"\vtravel_mode\x18\x01 \x01(\x0e20.google.cloud.optimization.v1.Vehicle.TravelModeR\n" +
	"travelMode\x12Z\n" +
	"\x0froute_modifiers\x18\x02 \x01(\v2,.google.cloud.optimization.v1.RouteModifiersB\x03\xe0A\x01R\x0erouteModifiers\x12:\n" +
	"\x0estart_location\x18\x03 \x01(\v2\x13.google.type.LatLngR\rstartLocation\x12M\n" +
	"\x0estart_waypoint\x18\x04 \x01(\v2&.google.cloud.optimization.v1.WaypointR\rstartWaypoint\x126\n" +
	"\fend_location\x18\x05 \x01(\v2\x13.google.type.LatLngR\vendLocation\x12I\n" +
	"\fend_waypoint\x18\x06 \x01(\v2&.google.cloud.optimization.v1.WaypointR\vendWaypoint\x12\x1d\n" +
	"\n" +
	"start_tags\x18\a \x03(\tR\tstartTags\x12\x19\n" +
	"\bend_tags\x18\b \x03(\tR\aendTags\x12V\n" +
	"\x12start_time_windows\x18\t \x03(\v2(.google.cloud.optimization.v1.TimeWindowR\x10startTimeWindows\x12R\n" +
	"\x10end_time_windows\x18\n" +
	" \x03(\v2(.google.cloud.optimization.v1.TimeWindowR\x0eendTimeWindows\x12=\n" +
	"\x18travel_duration_multiple\x18\v \x01(\x01H\x00R\x16travelDurationMultiple\x88\x01\x01\x12`\n" +
	"\x10unloading_policy\x18\f \x01(\x0e25.google.cloud.optimization.v1.Vehicle.UnloadingPolicyR\x0funloadingPolicy\x12V\n" +
	"\vload_limits\x18\x1e \x03(\v25.google.cloud.optimization.v1.Vehicle.LoadLimitsEntryR\n" +
	"loadLimits\x12\"\n" +
	"\rcost_per_hour\x18\x10 \x01(\x01R\vcostPerHour\x123\n" +
	"\x16cost_per_traveled_hour\x18\x11 \x01(\x01R\x13costPerTraveledHour\x12,\n" +
	"\x12cost_per_kilometer\x18\x12 \x01(\x01R\x10costPerKilometer\x12\x1d\n" +
	"\n" +
	"fixed_cost\x18\x13 \x01(\x01R\tfixedCost\x122\n" +
	"\x16used_if_route_is_empty\x18\x14 \x01(\bR\x12usedIfRouteIsEmpty\x12e\n" +
	"\x14route_duration_limit\x18\x15 \x01(\v23.google.cloud.optimization.v1.Vehicle.DurationLimitR\x12routeDurationLimit\x12g\n" +
	"\x15travel_duration_limit\x18\x16 \x01(\v23.google.cloud.optimization.v1.Vehicle.DurationLimitR\x13travelDurationLimit\x12]\n" +
	"\x14route_distance_limit\x18\x17 \x01(\v2+.google.cloud.optimization.v1.DistanceLimitR\x12routeDistanceLimit\x12\x96\x01\n" +
	"#extra_visit_duration_for_visit_type\x18\x18 \x03(\v2I.google.cloud.optimization.v1.Vehicle.ExtraVisitDurationForVisitTypeEntryR\x1eextraVisitDurationForVisitType\x12F\n" +
	"\n" +
	"break_rule\x18\x19 \x01(\v2'.google.cloud.optimization.v1.BreakRuleR\tbreakRule\x12\x14\n" +
	"\x05label\x18\x1b \x01(\tR\x05label\x12\x16\n" +
	"\x06ignore\x18\x1c \x01(\bR\x06ignore\x120\n" +
	"\x12break_rule_indices\x18\x1d \x03(\x05B\x02\x18\x01R\x10breakRuleIndices\x12R\n" +
	"\n" +
	"capacities\x18\r \x03(\v2..google.cloud.optimization.v1.CapacityQuantityB\x02\x18\x01R\n" +
	"capacities\x12l\n" +
	"\x14start_load_intervals\x18\x0e \x03(\v26.google.cloud.optimization.v1.CapacityQuantityIntervalB\x02\x18\x01R\x12startLoadIntervals\x12h\n" +
	"\x12end_load_intervals\x18\x0f \x03(\v26.google.cloud.optimization.v1.CapacityQuantityIntervalB\x02\x18\x01R\x10endLoadIntervals\x1a\xa8\x03\n" +
	"\tLoadLimit\x12\x1e\n" +
	"\bmax_load\x18\x01 \x01(\x03H\x00R\amaxLoad\x88\x01\x01\x12\"\n" +
	"\rsoft_max_load\x18\x02 \x01(\x03R\vsoftMaxLoad\x12=\n" +
	"\x1ccost_per_unit_above_soft_max\x18\x03 \x01(\x01R\x17costPerUnitAboveSoftMax\x12h\n" +
	"\x13start_load_interval\x18\x04 \x01(\v28.google.cloud.optimization.v1.Vehicle.LoadLimit.IntervalR\x11startLoadInterval\x12d\n" +
	"\x11end_load_interval\x18\x05 \x01(\v28.google.cloud.optimization.v1.Vehicle.LoadLimit.IntervalR\x0fendLoadInterval\x1a;\n" +
	"\bInterval\x12\x10\n" +
	"\x03min\x18\x01 \x01(\x03R\x03min\x12\x15\n" +
	"\x03max\x18\x02 \x01(\x03H\x00R\x03max\x88\x01\x01B\x06\n" +
	"\x04_maxB\v\n" +
	"\t_max_load\x1a\xe9\x03\n" +
	"\rDurationLimit\x12<\n" +
	"\fmax_duration\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\vmaxDuration\x12E\n" +
	"\x11soft_max_duration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x0fsoftMaxDuration\x12B\n" +
	"\x1ccost_per_hour_after_soft_max\x18\x03 \x01(\x01H\x00R\x17costPerHourAfterSoftMax\x88\x01\x01\x12X\n" +
	"\x1bquadratic_soft_max_duration\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\x18quadraticSoftMaxDuration\x12b\n" +
	"-cost_per_square_hour_after_quadratic_soft_max\x18\x05 \x01(\x01H\x01R&costPerSquareHourAfterQuadraticSoftMax\x88\x01\x01B\x1f\n" +
	"\x1d_cost_per_hour_after_soft_maxB0\n" +
	"._cost_per_square_hour_after_quadratic_soft_max\x1an\n" +
	"\x0fLoadLimitsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12E\n" +
	"\x05value\x18\x02 \x01(\v2/.google.cloud.optimization.v1.Vehicle.LoadLimitR\x05value:\x028\x01\x1al\n" +
	"#ExtraVisitDurationForVisitTypeEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12/\n" +
	"\x05value\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x05value:\x028\x01\"C\n" +
	"\n" +
	"TravelMode\x12\x1b\n" +
	"\x17TRAVEL_MODE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aDRIVING\x10\x01\x12\v\n" +
	"\aWALKING\x10\x02\"b\n" +
	...
	"\x19_travel_duration_multiple\"\xf1\x03\n" +
	"\n" +
	"TimeWindow\x129\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x125\n" +
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\x12B\n" +
	"\x0fsoft_start_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\rsoftStartTime\x12>\n" +
	"\rsoft_end_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\vsoftEndTime\x12Q\n" +
	"$cost_per_hour_before_soft_start_time\x18\x05 \x01(\x01H\x00R\x1ecostPerHourBeforeSoftStartTime\x88\x01\x01\x12K\n" +
	"!cost_per_hour_after_soft_end_time\x18\x06 \x01(\x01H\x01R\x1bcostPerHourAfterSoftEndTime\x88\x01\x01B'\n" +
	"%_cost_per_hour_before_soft_start_timeB$\n" +
	"\"_cost_per_hour_after_soft_end_time\"@\n" +
	"\x10CapacityQuantity\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x02\x18\x01\"\x92\x01\n" +
	"\x18CapacityQuantityInterval\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12 \n" +
	"\tmin_value\x18\x02 \x01(\x03H\x00R\bminValue\x88\x01\x01\x12 \n" +
	"\tmax_value\x18\x03 \x01(\x03H\x01R\bmaxValue\x88\x01\x01:\x02\x18\x01B\f\n" +
	"\n" +
	"_min_valueB\f\n" +
	"\n" +
	"_max_value\"\xeb\x02\n" +
	"\rDistanceLimit\x12\"\n" +
	"\n" +
	"max_meters\x18\x01 \x01(\x03H\x00R\tmaxMeters\x88\x01\x01\x12+\n" +
	"\x0fsoft_max_meters\x18\x02 \x01(\x03H\x01R\rsoftMaxMeters\x88\x01\x01\x12L\n" +
	"!cost_per_kilometer_below_soft_max\x18\x04 \x01(\x01H\x02R\x1ccostPerKilometerBelowSoftMax\x88\x01\x01\x12L\n" +
	"!cost_per_kilometer_above_soft_max\x18\x03 \x01(\x01H\x03R\x1ccostPerKilometerAboveSoftMax\x88\x01\x01B\r\n" +
	"\v_max_metersB\x12\n" +
	"\x10_soft_max_metersB$\n" +
	"\"_cost_per_kilometer_below_soft_maxB$\n" +
	"\"_cost_per_kilometer_above_soft_max\"\xe3\x02\n" +
	"\x14TransitionAttributes\x12\x17\n" +
	"\asrc_tag\x18\x01 \x01(\tR\x06srcTag\x12(\n" +
	"\x10excluded_src_tag\x18\x02 \x01(\tR\x0eexcludedSrcTag\x12\x17\n" +
	"\adst_tag\x18\x03 \x01(\tR\x06dstTag\x12(\n" +
	"\x10excluded_dst_tag\x18\x04 \x01(\tR\x0eexcludedDstTag\x12\x12\n" +
	"\x04cost\x18\x05 \x01(\x01R\x04cost\x12,\n" +
	"\x12cost_per_kilometer\x18\x06 \x01(\x01R\x10costPerKilometer\x12R\n" +
	"\x0edistance_limit\x18\a \x01(\v2+.google.cloud.optimization.v1.DistanceLimitR\rdistanceLimit\x12/\n" +
	"\x05delay\x18\b \x01(\v2\x19.google.protobuf.DurationR\x05delay\"\xa0\x01\n" +
	"\bWaypoint\x12D\n" +
	"\blocation\x18\x01 \x01(\v2&.google.cloud.optimization.v1.LocationH\x00R\blocation\x12\x1b\n" +
	"\bplace_id\x18\x02 \x01(\tH\x00R\aplaceId\x12 \n" +
	"\fside_of_road\x18\x03 \x01(\bR\n" +
	"sideOfRoadB\x0f\n" +
	"\rlocation_type\"c\n" +
	"\bLocation\x12,\n" +
	"\alat_lng\x18\x01 \x01(\v2\x13.google.type.LatLngR\x06latLng\x12\x1d\n" +
	"\aheading\x18\x02 \x01(\x05H\x00R\aheading\x88\x01\x01B\n" +
	"\n" +
	"\b_heading\"\x8b\x05\n" +
	"\tBreakRule\x12[\n" +
	"\x0ebreak_requests\x18\x01 \x03(\v24.google.cloud.optimization.v1.BreakRule.BreakRequestR\rbreakRequests\x12p\n" +
	"\x15frequency_constraints\x18\x02 \x03(\v2;.google.cloud.optimization.v1.BreakRule.FrequencyConstraintR\x14frequencyConstraints\x1a\xef\x01\n" +
	"\fBreakRequest\x12O\n" +
	"\x13earliest_start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x02R\x11earliestStartTime\x12K\n" +
	"\x11latest_start_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x02R\x0flatestStartTime\x12A\n" +
	"\fmin_duration\x18\x03 \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x02R\vminDuration\x1a\xbc\x01\n" +
	"\x13FrequencyConstraint\x12L\n" +
	"\x12min_break_duration\x18\x01 \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x02R\x10minBreakDuration\x12W\n" +
	"\x18max_inter_break_duration\x18\x02 \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x02R\x15maxInterBreakDuration\"\x81\x1c\n" +
	"\rShipmentRoute\x12#\n" +
	"\rvehicle_index\x18\x01 \x01(\x05R\fvehicleIndex\x12#\n" +
	"\rvehicle_label\x18\x02 \x01(\tR\fvehicleLabel\x12H\n" +
	"\x12vehicle_start_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x10vehicleStartTime\x12D\n" +
	"\x10vehicle_end_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x0evehicleEndTime\x12I\n" +
	"\x06visits\x18\a \x03(\v21.google.cloud.optimization.v1.ShipmentRoute.VisitR\x06visits\x12X\n" +
	"\vtransitions\x18\b \x03(\v26.google.cloud.optimization.v1.ShipmentRoute.TransitionR\vtransitions\x12>\n" +
	"\x1bhas_traffic_infeasibilities\x18\t \x01(\bR\x19hasTrafficInfeasibilities\x12b\n" +
	"\x0eroute_polyline\x18\n" +
	" \x01(\v2;.google.cloud.optimization.v1.ShipmentRoute.EncodedPolylineR\rroutePolyline\x12I\n" +
	"\x06breaks\x18\v \x03(\v21.google.cloud.optimization.v1.ShipmentRoute.BreakR\x06breaks\x12I\n" +
	"\ametrics\x18\f \x01(\v2/.google.cloud.optimization.v1.AggregatedMetricsR\ametrics\x12\\\n" +
	"\vroute_costs\x18\x11 \x03(\v2;.google.cloud.optimization.v1.ShipmentRoute.RouteCostsEntryR\n" +
	"routeCosts\x12(\n" +
	"\x10route_total_cost\x18\x12 \x01(\x01R\x0erouteTotalCost\x12O\n" +
	"\tend_loads\x18\r \x03(\v2..google.cloud.optimization.v1.CapacityQuantityB\x02\x18\x01R\bendLoads\x12]\n" +
	"\ftravel_steps\x18\x0e \x03(\v26.google.cloud.optimization.v1.ShipmentRoute.TravelStepB\x02\x18\x01R\vtravelSteps\x12D\n" +
	"\x0evehicle_detour\x18\x0f \x01(\v2\x19.google.protobuf.DurationB\x02\x18\x01R\rvehicleDetour\x12n\n" +
	"\x18delay_before_vehicle_end\x18\x10 \x01(\v21.google.cloud.optimization.v1.ShipmentRoute.DelayB\x02\x18\x01R\x15delayBeforeVehicleEnd\x1a}\n" +
	"\x05Delay\x129\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x125\n" +
	"\bduration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\bduration:\x02\x18\x01\x1a\x91\x06\n" +
	"\x05Visit\x12%\n" +
	"\x0eshipment_index\x18\x01 \x01(\x05R\rshipmentIndex\x12\x1b\n" +
	"\tis_pickup\x18\x02 \x01(\bR\bisPickup\x12.\n" +
	"\x13visit_request_index\x18\x03 \x01(\x05R\x11visitRequestIndex\x129\n" +
	"\n" +
	"start_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x12e\n" +
	"\fload_demands\x18\v \x03(\v2B.google.cloud.optimization.v1.ShipmentRoute.Visit.LoadDemandsEntryR\vloadDemands\x121\n" +
	"\x06detour\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\x06detour\x12%\n" +
	"\x0eshipment_label\x18\a \x01(\tR\rshipmentLabel\x12\x1f\n" +
	"\vvisit_label\x18\b \x01(\tR\n" +
	"visitLabel\x12W\n" +
	"\rarrival_loads\x18\t \x03(\v2..google.cloud.optimization.v1.CapacityQuantityB\x02\x18\x01R\farrivalLoads\x12c\n" +
	"\x12delay_before_start\x18\n" +
	" \x01(\v21.google.cloud.optimization.v1.ShipmentRoute.DelayB\x02\x18\x01R\x10delayBeforeStart\x12L\n" +
	"\ademands\x18\x05 \x03(\v2..google.cloud.optimization.v1.CapacityQuantityB\x02\x18\x01R\ademands\x1ak\n" +
	"\x10LoadDemandsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12A\n" +
	"\x05value\x18\x02 \x01(\v2+.google.cloud.optimization.v1.Shipment.LoadR\x05value:\x028\x01\x1a\x98\a\n" +
	"\n" +
	"Transition\x12B\n" +
	"\x0ftravel_duration\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\x0etravelDuration\x124\n" +
	"\x16travel_distance_meters\x18\x02 \x01(\x01R\x14travelDistanceMeters\x128\n" +
	"\x18traffic_info_unavailable\x18\x03 \x01(\bR\x16trafficInfoUnavailable\x12@\n" +
	"\x0edelay_duration\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\rdelayDuration\x12@\n" +
	"\x0ebreak_duration\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\rbreakDuration\x12>\n" +
	"\rwait_duration\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\fwaitDuration\x12@\n" +
	"\x0etotal_duration\x18\a \x01(\v2\x19.google.protobuf.DurationR\rtotalDuration\x129\n" +
	"\n" +
	"start_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x12b\n" +
	"\x0eroute_polyline\x18\t \x01(\v2;.google.cloud.optimization.v1.ShipmentRoute.EncodedPolylineR\rroutePolyline\x12m\n" +
	"\rvehicle_loads\x18\v \x03(\v2H.google.cloud.optimization.v1.ShipmentRoute.Transition.VehicleLoadsEntryR\fvehicleLoads\x12H\n" +
	"\x05loads\x18\n" +
	" \x03(\v2..google.cloud.optimization.v1.CapacityQuantityB\x02\x18\x01R\x05loads\x1ax\n" +
	"\x11VehicleLoadsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12M\n" +
	"\x05value\x18\x02 \x01(\v27.google.cloud.optimization.v1.ShipmentRoute.VehicleLoadR\x05value:\x028\x01\x1a%\n" +
	"\vVehicleLoad\x12\x16\n" +
	"\x06amount\x18\x01 \x01(\x03R\x06amount\x1a)\n" +
	"\x0fEncodedPolyline\x12\x16\n" +
	"\x06points\x18\x01 \x01(\tR\x06points\x1ay\n" +
	"\x05Break\x129\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x125\n" +
	"\bduration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\bduration\x1a\x8e\x02\n" +
	"\n" +
	"TravelStep\x125\n" +
	"\bduration\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\bduration\x12'\n" +
	"\x0fdistance_meters\x18\x02 \x01(\x01R\x0edistanceMeters\x128\n" +
	"\x18traffic_info_unavailable\x18\x03 \x01(\bR\x16trafficInfoUnavailable\x12b\n" +
	"\x0eroute_polyline\x18\x04 \x01(\v2;.google.cloud.optimization.v1.ShipmentRoute.EncodedPolylineR\rroutePolyline:\x02\x18\x01\x1a=\n" +
	"\x0fRouteCostsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01\"\xcd\x05\n" +
	"\x0fSkippedShipment\x12\x14\n" +
	"\x05index\x18\x01 \x01(\x05R\x05index\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x12N\n" +
	"\areasons\x18\x03 \x03(\v24.google.cloud.optimization.v1.SkippedShipment.ReasonR\areasons\x1a\xbd\x04\n" +
	"\x06Reason\x12M\n" +
	"\x04code\x18\x01 \x01(\x0e29.google.cloud.optimization.v1.SkippedShipment.Reason.CodeR\x04code\x127\n" +
	"\x15example_vehicle_index\x18\x02 \x01(\x05H\x00R\x13exampleVehicleIndex\x88\x01\x01\x12C\n" +
	"\x1eexample_exceeded_capacity_type\x18\x03 \x01(\tR\x1bexampleExceededCapacityType\"\xcb\x02\n" +
	"\x04Code\x12\x14\n" +
	...
	"\x13VEHICLE_NOT_ALLOWED\x10\aB\x18\n" +
	"\x16_example_vehicle_index\"\x94\a\n" +
	"\x11AggregatedMetrics\x128\n" +
	"\x18performed_shipment_count\x18\x01 \x01(\x05R\x16performedShipmentCount\x12B\n" +
	"\x0ftravel_duration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x0etravelDuration\x12>\n" +
	"\rwait_duration\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\fwaitDuration\x12@\n" +
	"\x0edelay_duration\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\rdelayDuration\x12@\n" +
	"\x0ebreak_duration\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\rbreakDuration\x12@\n" +
	"\x0evisit_duration\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\rvisitDuration\x12@\n" +
	"\x0etotal_duration\x18\a \x01(\v2\x19.google.protobuf.DurationR\rtotalDuration\x124\n" +
	"\x16travel_distance_meters\x18\b \x01(\x01R\x14travelDistanceMeters\x12Z\n" +
	"\tmax_loads\x18\t \x03(\v2=.google.cloud.optimization.v1.AggregatedMetrics.MaxLoadsEntryR\bmaxLoads\x12T\n" +
	"\x05costs\x18\n" +
	" \x03(\v2:.google.cloud.optimization.v1.AggregatedMetrics.CostsEntryB\x02\x18\x01R\x05costs\x12!\n" +
	"\n" +
	"total_cost\x18\v \x01(\x01B\x02\x18\x01R\ttotalCost\x1at\n" +
	"\rMaxLoadsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12M\n" +
	"\x05value\x18\x02 \x01(\v27.google.cloud.optimization.v1.ShipmentRoute.VehicleLoadR\x05value:\x028\x01\x1a8\n" +
	"\n" +
	"CostsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01\"\x99\a\n" +
	"\x1aInjectedSolutionConstraint\x12C\n" +
	"\x06routes\x18\x01 \x03(\v2+.google.cloud.optimization.v1.ShipmentRouteR\x06routes\x12Z\n" +
	"\x11skipped_shipments\x18\x02 \x03(\v2-.google.cloud.optimization.v1.SkippedShipmentR\x10skippedShipments\x12\x84\x01\n" +
	"\x16constraint_relaxations\x18\x03 \x03(\v2M.google.cloud.optimization.v1.InjectedSolutionConstraint.ConstraintRelaxationR\x15constraintRelaxations\x1a\xd2\x04\n" +
	"\x14ConstraintRelaxation\x12z\n" +
	"\vrelaxations\x18\x01 \x03(\v2X.google.cloud.optimization.v1.InjectedSolutionConstraint.ConstraintRelaxation.RelaxationR\vrelaxations\x12'\n" +
	"\x0fvehicle_indices\x18\x02 \x03(\x05R\x0evehicleIndices\x1a\x94\x03\n" +
	"\n" +
	"Relaxation\x12t\n" +
	"\x05level\x18\x01 \x01(\x0e2^.google.cloud.optimization.v1.InjectedSolutionConstraint.ConstraintRelaxation.Relaxation.LevelR\x05level\x12A\n" +
	"\x0ethreshold_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\rthresholdTime\x122\n" +
	"\x15threshold_visit_count\x18\x03 \x01(\x05R\x13thresholdVisitCount\"\x98\x01\n" +
	"\x05Level\x12\x15\n" +
	...
	"\x19RELAX_ALL_AFTER_THRESHOLD\x10\x03\"\xd3\x03\n" +
	"\x1cOptimizeToursValidationError\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x12a\n" +
	"\x06fields\x18\x03 \x03(\v2I.google.cloud.optimization.v1.OptimizeToursValidationError.FieldReferenceR\x06fields\x12#\n" +
	"\rerror_message\x18\x04 \x01(\tR\ferrorMessage\x12)\n" +
	"\x10offending_values\x18\x05 \x01(\tR\x0foffendingValues\x1a\xc8\x01\n" +
	"\x0eFieldReference\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x16\n" +
	"\x05index\x18\x02 \x01(\x05H\x00R\x05index\x12\x12\n" +
	"\x03key\x18\x04 \x01(\tH\x00R\x03key\x12f\n" +
	"\tsub_field\x18\x03 \x01(\v2I.google.cloud.optimization.v1.OptimizeToursValidationError.FieldReferenceR\bsubFieldB\x0e\n" +
	"\findex_or_key2\xe0\x04\n" +
	"\fFleetRouting\x12\xe2\x01\n" +
	"\rOptimizeTours\x122.google.cloud.optimization.v1.OptimizeToursRequest\x1a3.google.cloud.optimization.v1.OptimizeToursResponse\"h\x82\xd3\xe4\x93\x02b:\x01*Z*:\x01*\"%/v1/{parent=projects/*}:optimizeTours\"1/v1/{parent=projects/*/locations/*}:optimizeTours\x12\x94\x02\n" +
	...
	"\x1aBatchOptimizeToursResponse\x12\x12AsyncModelMetadata\x82\xd3\xe4\x93\x02l:\x01*Z/:\x01*\"*/v1/{parent=projects/*}:batchOptimizeTours\"6/v1/{parent=projects/*/locations/*}:batchOptimizeTours\x1aT\xcaA cloudoptimization.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB}\n" +
...
var (
	...
	file_google_cloud_optimization_v1_fleet_routing_proto_rawDescData []byte
)
...
func file_google_cloud_optimization_v1_fleet_routing_proto_rawDescGZIP() []byte {
	file_google_cloud_optimization_v1_fleet_routing_proto_rawDescOnce.Do(func() {
		file_google_cloud_optimization_v1_fleet_routing_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_optimization_v1_fleet_routing_proto_rawDesc), len(file_google_cloud_optimization_v1_fleet_routing_proto_rawDesc)))
	})
...
func file_google_cloud_optimization_v1_fleet_routing_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_optimization_v1_fleet_routing_proto_rawDesc), len(file_google_cloud_optimization_v1_fleet_routing_proto_rawDesc)),
			NumEnums:      8,
			NumMessages:   59,
			NumExtensions: 0,
			NumServices:   1,
