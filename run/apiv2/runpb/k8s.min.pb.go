...
func file_google_cloud_run_v2_k8s_min_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_run_v2_k8s_min_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_run_v2_k8s_min_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_run_v2_k8s_min_proto_msgTypes[14].OneofWrappers = []interface{}{
		(*Probe_HttpGet)(nil),
		(*Probe_TcpSocket)(nil),
		(*Probe_Grpc)(nil),
	}
