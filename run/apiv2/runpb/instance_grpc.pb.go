...
const (
	Instances_CreateInstance_FullMethodName = "/google.cloud.run.v2.Instances/CreateInstance"
	Instances_DeleteInstance_FullMethodName = "/google.cloud.run.v2.Instances/DeleteInstance"
	Instances_GetInstance_FullMethodName    = "/google.cloud.run.v2.Instances/GetInstance"
	Instances_ListInstances_FullMethodName  = "/google.cloud.run.v2.Instances/ListInstances"
	Instances_StopInstance_FullMethodName   = "/google.cloud.run.v2.Instances/StopInstance"
	Instances_StartInstance_FullMethodName  = "/google.cloud.run.v2.Instances/StartInstance"
)
...
func (c *instancesClient) CreateInstance(ctx context.Context, in *CreateInstanceRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	...
	err := c.cc.Invoke(ctx, Instances_CreateInstance_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *instancesClient) StopInstance(ctx context.Context, in *StopInstanceRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, Instances_StopInstance_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *instancesClient) StartInstance(ctx context.Context, in *StartInstanceRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, Instances_StartInstance_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Instances_CreateInstance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Instances_CreateInstance_FullMethodName,
	}
...
func _Instances_StopInstance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Instances_StopInstance_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Instances_StartInstance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Instances_StartInstance_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Instances_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/cloud/run/v2/instance.proto",
}
