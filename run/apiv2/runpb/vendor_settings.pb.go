...
func file_google_cloud_run_v2_vendor_settings_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_run_v2_vendor_settings_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_run_v2_vendor_settings_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
