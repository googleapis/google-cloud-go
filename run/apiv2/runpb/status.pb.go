...
const file_google_cloud_run_v2_status_proto_rawDesc = "" +
	"\n" +
	" google/cloud/run/v2/status.proto\x12\x13google.cloud.run.v2\"T\n" +
	"\x15RevisionScalingStatus\x12;\n" +
	"\x1adesired_min_instance_count\x18\x01 \x01(\x05R\x17desiredMinInstanceCountBS\n" +
	"\x17com.google.cloud.run.v2B\vStatusProtoP\x01Z)cloud.google.com/go/run/apiv2/runpb;runpbb\x06proto3"

var (
	file_google_cloud_run_v2_status_proto_rawDescOnce sync.Once
	file_google_cloud_run_v2_status_proto_rawDescData []byte
)

func file_google_cloud_run_v2_status_proto_rawDescGZIP() []byte {
	file_google_cloud_run_v2_status_proto_rawDescOnce.Do(func() {
		file_google_cloud_run_v2_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_run_v2_status_proto_rawDesc), len(file_google_cloud_run_v2_status_proto_rawDesc)))
	})
...
func file_google_cloud_run_v2_status_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_run_v2_status_proto_rawDesc), len(file_google_cloud_run_v2_status_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
