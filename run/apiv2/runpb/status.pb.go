...
var file_google_cloud_run_v2_status_proto_goTypes = []interface{}{
...
func file_google_cloud_run_v2_status_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_run_v2_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RevisionScalingStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
