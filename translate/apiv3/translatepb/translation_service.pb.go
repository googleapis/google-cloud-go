...
func file_google_cloud_translate_v3_translation_service_proto_init() {
	...
	file_google_cloud_translate_v3_translation_service_proto_msgTypes[4].OneofWrappers = []any{
		(*DetectLanguageRequest_Content)(nil),
	}
	file_google_cloud_translate_v3_translation_service_proto_msgTypes[11].OneofWrappers = []any{
		(*InputConfig_GcsSource)(nil),
	}
	file_google_cloud_translate_v3_translation_service_proto_msgTypes[13].OneofWrappers = []any{
	...
	file_google_cloud_translate_v3_translation_service_proto_msgTypes[15].OneofWrappers = []any{
		(*DocumentOutputConfig_GcsDestination)(nil),
	}
	file_google_cloud_translate_v3_translation_service_proto_msgTypes[22].OneofWrappers = []any{
		(*GlossaryInputConfig_GcsSource)(nil),
	}
	file_google_cloud_translate_v3_translation_service_proto_msgTypes[23].OneofWrappers = []any{
		(*Glossary_LanguagePair)(nil),
		(*Glossary_LanguageCodesSet_)(nil),
	}
	file_google_cloud_translate_v3_translation_service_proto_msgTypes[33].OneofWrappers = []any{
		(*BatchDocumentInputConfig_GcsSource)(nil),
	}
	file_google_cloud_translate_v3_translation_service_proto_msgTypes[34].OneofWrappers = []any{
