...
func (x *AggregationQuery) GetQueryType() isAggregationQuery_QueryType {
	if x != nil {
		return x.QueryType
	}
	return nil
...
func (x *AggregationQuery) GetNestedQuery() *Query {
	if x != nil {
		if x, ok := x.QueryType.(*AggregationQuery_NestedQuery); ok {
...
func (x *Filter) GetCompositeFilter() *CompositeFilter {
	if x != nil {
		if x, ok := x.FilterType.(*Filter_CompositeFilter); ok {
...
func (x *Filter) GetPropertyFilter() *PropertyFilter {
	if x != nil {
		if x, ok := x.FilterType.(*Filter_PropertyFilter); ok {
...
type GqlQuery struct {
	...
	NamedBindings map[string]*GqlQueryParameter `protobuf:"bytes,5,rep,name=named_bindings,json=namedBindings,proto3" json:"named_bindings,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *GqlQueryParameter) GetParameterType() isGqlQueryParameter_ParameterType {
	if x != nil {
...
func (x *GqlQueryParameter) GetValue() *Value {
	if x != nil {
		if x, ok := x.ParameterType.(*GqlQueryParameter_Value); ok {
			return x.Value
		}
	}
	return nil
...
func (x *GqlQueryParameter) GetCursor() []byte {
	if x != nil {
		if x, ok := x.ParameterType.(*GqlQueryParameter_Cursor); ok {
			return x.Cursor
		}
	}
	return nil
...
func (x *AggregationQuery_Aggregation) GetOperator() isAggregationQuery_Aggregation_Operator {
	if x != nil {
		return x.Operator
	}
	return nil
...
func (x *AggregationQuery_Aggregation) GetCount() *AggregationQuery_Aggregation_Count {
	if x != nil {
		if x, ok := x.Operator.(*AggregationQuery_Aggregation_Count_); ok {
			return x.Count
		}
	}
	return nil
...
func (x *AggregationQuery_Aggregation) GetSum() *AggregationQuery_Aggregation_Sum {
	if x != nil {
		if x, ok := x.Operator.(*AggregationQuery_Aggregation_Sum_); ok {
			return x.Sum
		}
	}
	return nil
...
func (x *AggregationQuery_Aggregation) GetAvg() *AggregationQuery_Aggregation_Avg {
	if x != nil {
		if x, ok := x.Operator.(*AggregationQuery_Aggregation_Avg_); ok {
			return x.Avg
		}
	}
	return nil
...
const file_google_datastore_v1_query_proto_rawDesc = "" +
	"\n" +
	"\x1fgoogle/datastore/v1/query.proto\x12\x13google.datastore.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a google/datastore/v1/entity.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xc2\x02\n" +
	"\fEntityResult\x123\n" +
	"\x06entity\x18\x01 \x01(\v2\x1b.google.datastore.v1.EntityR\x06entity\x12\x18\n" +
	...
	"\bKEY_ONLY\x10\x03\"\x90\x04\n" +
	"\x05Query\x12?\n" +
	"\n" +
	"projection\x18\x02 \x03(\v2\x1f.google.datastore.v1.ProjectionR\n" +
	"projection\x127\n" +
	"\x04kind\x18\x03 \x03(\v2#.google.datastore.v1.KindExpressionR\x04kind\x123\n" +
	"\x06filter\x18\x04 \x01(\v2\x1b.google.datastore.v1.FilterR\x06filter\x128\n" +
	"\x05order\x18\x05 \x03(\v2\".google.datastore.v1.PropertyOrderR\x05order\x12G\n" +
	"\vdistinct_on\x18\x06 \x03(\v2&.google.datastore.v1.PropertyReferenceR\n" +
	"distinctOn\x12!\n" +
	"\fstart_cursor\x18\a \x01(\fR\vstartCursor\x12\x1d\n" +
	"\n" +
	"end_cursor\x18\b \x01(\fR\tendCursor\x12\x16\n" +
	"\x06offset\x18\n" +
	" \x01(\x05R\x06offset\x121\n" +
	"\x05limit\x18\f \x01(\v2\x1b.google.protobuf.Int32ValueR\x05limit\x12H\n" +
	"\ffind_nearest\x18\r \x01(\v2 .google.datastore.v1.FindNearestB\x03\xe0A\x01R\vfindNearest\"\xb1\x05\n" +
	"\x10AggregationQuery\x12?\n" +
	"\fnested_query\x18\x01 \x01(\v2\x1a.google.datastore.v1.QueryH\x00R\vnestedQuery\x12Z\n" +
	"\faggregations\x18\x03 \x03(\v21.google.datastore.v1.AggregationQuery.AggregationB\x03\xe0A\x01R\faggregations\x1a\xf1\x03\n" +
	"\vAggregation\x12O\n" +
	"\x05count\x18\x01 \x01(\v27.google.datastore.v1.AggregationQuery.Aggregation.CountH\x00R\x05count\x12I\n" +
	"\x03sum\x18\x02 \x01(\v25.google.datastore.v1.AggregationQuery.Aggregation.SumH\x00R\x03sum\x12I\n" +
	"\x03avg\x18\x03 \x01(\v25.google.datastore.v1.AggregationQuery.Aggregation.AvgH\x00R\x03avg\x12\x19\n" +
	"\x05alias\x18\a \x01(\tB\x03\xe0A\x01R\x05alias\x1a>\n" +
	"\x05Count\x125\n" +
	"\x05up_to\x18\x01 \x01(\v2\x1b.google.protobuf.Int64ValueB\x03\xe0A\x01R\x04upTo\x1aI\n" +
	"\x03Sum\x12B\n" +
	"\bproperty\x18\x01 \x01(\v2&.google.datastore.v1.PropertyReferenceR\bproperty\x1aI\n" +
	"\x03Avg\x12B\n" +
	"\bproperty\x18\x01 \x01(\v2&.google.datastore.v1.PropertyReferenceR\bpropertyB\n" +
	"\n" +
	"\boperatorB\f\n" +
	"\n" +
	"query_type\"$\n" +
	...
	"\n" +
	"Projection\x12B\n" +
	"\bproperty\x18\x01 \x01(\v2&.google.datastore.v1.PropertyReferenceR\bproperty\"\xe6\x01\n" +
	"\rPropertyOrder\x12B\n" +
	"\bproperty\x18\x01 \x01(\v2&.google.datastore.v1.PropertyReferenceR\bproperty\x12J\n" +
	"\tdirection\x18\x02 \x01(\x0e2,.google.datastore.v1.PropertyOrder.DirectionR\tdirection\"E\n" +
	"\tDirection\x12\x19\n" +
	...
	"\x06Filter\x12Q\n" +
	"\x10composite_filter\x18\x01 \x01(\v2$.google.datastore.v1.CompositeFilterH\x00R\x0fcompositeFilter\x12N\n" +
	"\x0fproperty_filter\x18\x02 \x01(\v2#.google.datastore.v1.PropertyFilterH\x00R\x0epropertyFilterB\r\n" +
	"\vfilter_type\"\xbe\x01\n" +
	"\x0fCompositeFilter\x12=\n" +
	"\x02op\x18\x01 \x01(\x0e2-.google.datastore.v1.CompositeFilter.OperatorR\x02op\x125\n" +
	"\afilters\x18\x02 \x03(\v2\x1b.google.datastore.v1.FilterR\afilters\"5\n" +
	"\bOperator\x12\x18\n" +
	"\x14OPERATOR_UNSPECIFIED\x10\x00\x12\a\n" +
	"\x03AND\x10\x01\x12\x06\n" +
	"\x02OR\x10\x02\"\xff\x02\n" +
	"\x0ePropertyFilter\x12B\n" +
	"\bproperty\x18\x01 \x01(\v2&.google.datastore.v1.PropertyReferenceR\bproperty\x12<\n" +
	"\x02op\x18\x02 \x01(\x0e2,.google.datastore.v1.PropertyFilter.OperatorR\x02op\x120\n" +
	"\x05value\x18\x03 \x01(\v2\x1a.google.datastore.v1.ValueR\x05value\"\xb8\x01\n" +
	"\bOperator\x12\x18\n" +
	...
	"\fHAS_ANCESTOR\x10\v\x12\n" +
	"\n" +
	"\x06NOT_IN\x10\r\"\xb3\x04\n" +
	"\vFindNearest\x12T\n" +
	"\x0fvector_property\x18\x01 \x01(\v2&.google.datastore.v1.PropertyReferenceB\x03\xe0A\x02R\x0evectorProperty\x12B\n" +
	"\fquery_vector\x18\x02 \x01(\v2\x1a.google.datastore.v1.ValueB\x03\xe0A\x02R\vqueryVector\x12`\n" +
	"\x10distance_measure\x18\x03 \x01(\x0e20.google.datastore.v1.FindNearest.DistanceMeasureB\x03\xe0A\x02R\x0fdistanceMeasure\x126\n" +
	"\x05limit\x18\x04 \x01(\v2\x1b.google.protobuf.Int32ValueB\x03\xe0A\x02R\x05limit\x12=\n" +
	"\x18distance_result_property\x18\x05 \x01(\tB\x03\xe0A\x01R\x16distanceResultProperty\x12P\n" +
	...
	"\vDOT_PRODUCT\x10\x03\"\xf0\x02\n" +
	"\bGqlQuery\x12!\n" +
	"\fquery_string\x18\x01 \x01(\tR\vqueryString\x12%\n" +
	"\x0eallow_literals\x18\x02 \x01(\bR\rallowLiterals\x12W\n" +
	"\x0enamed_bindings\x18\x05 \x03(\v20.google.datastore.v1.GqlQuery.NamedBindingsEntryR\rnamedBindings\x12W\n" +
	"\x13positional_bindings\x18\x04 \x03(\v2&.google.datastore.v1.GqlQueryParameterR\x12positionalBindings\x1ah\n" +
	"\x12NamedBindingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12<\n" +
	"\x05value\x18\x02 \x01(\v2&.google.datastore.v1.GqlQueryParameterR\x05value:\x028\x01\"s\n" +
	"\x11GqlQueryParameter\x122\n" +
	"\x05value\x18\x02 \x01(\v2\x1a.google.datastore.v1.ValueH\x00R\x05value\x12\x18\n" +
	"\x06cursor\x18\x03 \x01(\fH\x00R\x06cursorB\x10\n" +
	"\x0eparameter_type\"\x80\x05\n" +
	"\x10QueryResultBatch\x12'\n" +
	"\x0fskipped_results\x18\x06 \x01(\x05R\x0eskippedResults\x12%\n" +
	"\x0eskipped_cursor\x18\x03 \x01(\fR\rskippedCursor\x12Z\n" +
	"\x12entity_result_type\x18\x01 \x01(\x0e2,.google.datastore.v1.EntityResult.ResultTypeR\x10entityResultType\x12H\n" +
	"\x0eentity_results\x18\x02 \x03(\v2!.google.datastore.v1.EntityResultR\rentityResults\x12\x1d\n" +
	"\n" +
	"end_cursor\x18\x04 \x01(\fR\tendCursor\x12X\n" +
	"\fmore_results\x18\x05 \x01(\x0e25.google.datastore.v1.QueryResultBatch.MoreResultsTypeR\vmoreResults\x12)\n" +
	"\x10snapshot_version\x18\a \x01(\x03R\x0fsnapshotVersion\x127\n" +
	"\tread_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\breadTime\"\x98\x01\n" +
	"\x0fMoreResultsType\x12!\n" +
	"\x1dMORE_RESULTS_TYPE_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fNOT_FINISHED\x10\x01\x12\x1c\n" +
...
var (
	...
	file_google_datastore_v1_query_proto_rawDescData []byte
)

func file_google_datastore_v1_query_proto_rawDescGZIP() []byte {
	file_google_datastore_v1_query_proto_rawDescOnce.Do(func() {
		file_google_datastore_v1_query_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_datastore_v1_query_proto_rawDesc), len(file_google_datastore_v1_query_proto_rawDesc)))
	})
...
func file_google_datastore_v1_query_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_datastore_v1_query_proto_rawDesc), len(file_google_datastore_v1_query_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   19,
			NumExtensions: 0,
			NumServices:   0,
