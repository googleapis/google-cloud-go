...
func (c *Client) PutWithOptions(ctx context.Context, req *PutRequest) (*Key, error) {
...
// err may be a MultiError. See ExampleMultiError to check it.
func (c *Client) PutMultiWithOptions(ctx context.Context, reqs []*PutRequest) (ret []*Key, err error) {
	var keys []*Key
