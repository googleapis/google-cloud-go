...
func (client *fakeClient) GetNamespace() string {
	return ""
}

func (client *fakeClient) Call(method string, req proto.Message, resp proto.Message) (err error) {
	return client.Handler(req, resp)
}
...
func TestSimpleQuery(t *testing.T) {
	...
	for _, tc := range testCases {
		nCall := 0
		c := &fakeClient{Handler: func(in proto.Message, out proto.Message) error {
			nCall++
