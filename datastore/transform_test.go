...
func TestIncrement(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			pt, err := Increment("fieldName", tc.value)
			if (err != nil) != tc.wantErr {
				t.Errorf("Increment() error = %v, wantErr %v", err, tc.wantErr)
				return
			}
			if err == nil {
...
func TestMaximum(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			pt, err := Maximum("fieldName", tc.value)
			if (err != nil) != tc.wantErr {
				t.Errorf("Maximum() error = %v, wantErr %v", err, tc.wantErr)
				return
			}
			if err == nil {
...
func TestMinimum(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			pt, err := Minimum("fieldName", tc.value)
			if (err != nil) != tc.wantErr {
				t.Errorf("Minimum() error = %v, wantErr %v", err, tc.wantErr)
				return
			}
			if err == nil {
...
func TestAppendMissingElements(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			pt, err := AppendMissingElements("fieldName", tc.elements...)
			if (err != nil) != tc.wantErr {
				t.Errorf("AppendMissingElements() error = %v, wantErr %v", err, tc.wantErr)
				return
			}
			if err == nil {
...
func TestRemoveAllFromArray(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			pt, err := RemoveAllFromArray("fieldName", tc.elements...)
			if (err != nil) != tc.wantErr {
				t.Errorf("RemoveAllFromArray() error = %v, wantErr %v", err, tc.wantErr)
				return
			}
			if err == nil {
