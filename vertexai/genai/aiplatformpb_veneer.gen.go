...
func (v *GenerationConfig) toProto() *pb.GenerationConfig {
	...
	return &pb.GenerationConfig{
		...
		ThinkingConfig:   v.ThinkingConfig.toProto(),
	}
}
...
func (GenerationConfig) fromProto(p *pb.GenerationConfig) *GenerationConfig {
	...
	return &GenerationConfig{
		...
		ThinkingConfig:   (ThinkingConfig{}).fromProto(p.ThinkingConfig),
	}
}
...
func (v *ThinkingConfig) toProto() *pb.GenerationConfig_ThinkingConfig {
	if v == nil {
		return nil
	}
	return &pb.GenerationConfig_ThinkingConfig{
		IncludeThoughts: v.IncludeThoughts,
		ThinkingBudget:  v.ThinkingBudget,
	}
}

func (ThinkingConfig) fromProto(p *pb.GenerationConfig_ThinkingConfig) *ThinkingConfig {
	if p == nil {
		return nil
	}
