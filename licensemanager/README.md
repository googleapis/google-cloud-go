...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/licensemanager.svg)](https://pkg.go.dev/cloud.google.com/go/licensemanager)

Go Client Library for License Manager API.

## Install

```bash
go get cloud.google.com/go/licensemanager
```
