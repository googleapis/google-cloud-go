...
func (x *Conversation) Reset() {
	*x = Conversation{}
	mi := &file_google_cloud_geminidataanalytics_v1_conversation_proto_msgTypes[0]
...
func (*Conversation) Descriptor() ([]byte, []int) {
	return file_google_cloud_geminidataanalytics_v1_conversation_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateConversationRequest) Reset() {
	*x = CreateConversationRequest{}
	mi := &file_google_cloud_geminidataanalytics_v1_conversation_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateConversationRequest) Descriptor() ([]byte, []int) {
	return file_google_cloud_geminidataanalytics_v1_conversation_proto_rawDescGZIP(), []int{1}
}
...
var File_google_cloud_geminidataanalytics_v1_conversation_proto protoreflect.FileDescriptor
...
const file_google_cloud_geminidataanalytics_v1_conversation_proto_rawDesc = "" +
	...
	"\rconversations\x18\x01 \x03(\v21.google.cloud.geminidataanalytics.v1.ConversationR\rconversations\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"h\n" +
	"\x19DeleteConversationRequest\x12K\n" +
	"\x04name\x18\x01 \x01(\tB7\xe0A\x02\xfaA1\n" +
	"/geminidataanalytics.googleapis.com/ConversationR\x04nameB\xa1\x03\xeaA\x8f\x01\n" +
	...
	"'com.google.cloud.geminidataanalytics.v1B\x11ConversationProtoP\x01ZYcloud.google.com/go/geminidataanalytics/apiv1/geminidataanalyticspb;geminidataanalyticspb\xaa\x02#Google.Cloud.GeminiDataAnalytics.V1\xca\x02#Google\\Cloud\\GeminiDataAnalytics\\V1\xea\x02&Google::Cloud::GeminiDataAnalytics::V1b\x06proto3"

var (
	file_google_cloud_geminidataanalytics_v1_conversation_proto_rawDescOnce sync.Once
	file_google_cloud_geminidataanalytics_v1_conversation_proto_rawDescData []byte
)

func file_google_cloud_geminidataanalytics_v1_conversation_proto_rawDescGZIP() []byte {
	file_google_cloud_geminidataanalytics_v1_conversation_proto_rawDescOnce.Do(func() {
		file_google_cloud_geminidataanalytics_v1_conversation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_geminidataanalytics_v1_conversation_proto_rawDesc), len(file_google_cloud_geminidataanalytics_v1_conversation_proto_rawDesc)))
	})
...
func file_google_cloud_geminidataanalytics_v1_conversation_proto_init() {
	if File_google_cloud_geminidataanalytics_v1_conversation_proto != nil {
		return
	}
	file_google_cloud_geminidataanalytics_v1_conversation_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_google_cloud_geminidataanalytics_v1_conversation_proto_goTypes,
		DependencyIndexes: file_google_cloud_geminidataanalytics_v1_conversation_proto_depIdxs,
		MessageInfos:      file_google_cloud_geminidataanalytics_v1_conversation_proto_msgTypes,
	}.Build()
	File_google_cloud_geminidataanalytics_v1_conversation_proto = out.File
	file_google_cloud_geminidataanalytics_v1_conversation_proto_goTypes = nil
	file_google_cloud_geminidataanalytics_v1_conversation_proto_depIdxs = nil
}
