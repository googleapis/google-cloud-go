...
const (
	DataChatService_Chat_FullMethodName               = "/google.cloud.geminidataanalytics.v1.DataChatService/Chat"
	DataChatService_CreateConversation_FullMethodName = "/google.cloud.geminidataanalytics.v1.DataChatService/CreateConversation"
	DataChatService_DeleteConversation_FullMethodName = "/google.cloud.geminidataanalytics.v1.DataChatService/DeleteConversation"
	DataChatService_UpdateConversation_FullMethodName = "/google.cloud.geminidataanalytics.v1.DataChatService/UpdateConversation"
	DataChatService_GetConversation_FullMethodName    = "/google.cloud.geminidataanalytics.v1.DataChatService/GetConversation"
	DataChatService_ListConversations_FullMethodName  = "/google.cloud.geminidataanalytics.v1.DataChatService/ListConversations"
	DataChatService_ListMessages_FullMethodName       = "/google.cloud.geminidataanalytics.v1.DataChatService/ListMessages"
)
...
func (c *dataChatServiceClient) UpdateConversation(ctx context.Context, in *UpdateConversationRequest, opts ...grpc.CallOption) (*Conversation, error) {
	out := new(Conversation)
	err := c.cc.Invoke(ctx, DataChatService_UpdateConversation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDataChatServiceServer) UpdateConversation(context.Context, *UpdateConversationRequest) (*Conversation, error) {
...
func _DataChatService_UpdateConversation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateConversationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataChatServiceServer).UpdateConversation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DataChatService_UpdateConversation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataChatServiceServer).UpdateConversation(ctx, req.(*UpdateConversationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DataChatService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DataChatService_UpdateConversation_Handler,
		},
		{
	...
	Metadata: "google/cloud/geminidataanalytics/v1/data_chat_service.proto",
}
