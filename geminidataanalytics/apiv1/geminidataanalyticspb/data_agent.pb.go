...
func (x *DataAgent) Reset() {
	*x = DataAgent{}
	mi := &file_google_cloud_geminidataanalytics_v1_data_agent_proto_msgTypes[0]
...
func (*DataAgent) Descriptor() ([]byte, []int) {
	return file_google_cloud_geminidataanalytics_v1_data_agent_proto_rawDescGZIP(), []int{0}
}
...
func (x *DataAgent) GetKmsKey() string {
...
var File_google_cloud_geminidataanalytics_v1_data_agent_proto protoreflect.FileDescriptor
...
const file_google_cloud_geminidataanalytics_v1_data_agent_proto_rawDesc = "" +
	...
	"\vdescription\x18\x04 \x01(\tB\x03\xe0A\x01R\vdescription\x12W\n" +
	"\x06labels\x18\x05 \x03(\v2:.google.cloud.geminidataanalytics.v1.DataAgent.LabelsEntryB\x03\xe0A\x01R\x06labels\x12@\n" +
...
var (
	file_google_cloud_geminidataanalytics_v1_data_agent_proto_rawDescOnce sync.Once
	file_google_cloud_geminidataanalytics_v1_data_agent_proto_rawDescData []byte
)

func file_google_cloud_geminidataanalytics_v1_data_agent_proto_rawDescGZIP() []byte {
	file_google_cloud_geminidataanalytics_v1_data_agent_proto_rawDescOnce.Do(func() {
		file_google_cloud_geminidataanalytics_v1_data_agent_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_geminidataanalytics_v1_data_agent_proto_rawDesc), len(file_google_cloud_geminidataanalytics_v1_data_agent_proto_rawDesc)))
	})
	return file_google_cloud_geminidataanalytics_v1_data_agent_proto_rawDescData
}
...
var file_google_cloud_geminidataanalytics_v1_data_agent_proto_depIdxs = []int32{
	...
	1, // 1: google.cloud.geminidataanalytics.v1.DataAgent.labels:type_name -> google.cloud.geminidataanalytics.v1.DataAgent.LabelsEntry
	3, // 2: google.cloud.geminidataanalytics.v1.DataAgent.create_time:type_name -> google.protobuf.Timestamp
...
func file_google_cloud_geminidataanalytics_v1_data_agent_proto_init() {
	if File_google_cloud_geminidataanalytics_v1_data_agent_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_geminidataanalytics_v1_data_agent_proto_rawDesc), len(file_google_cloud_geminidataanalytics_v1_data_agent_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_cloud_geminidataanalytics_v1_data_agent_proto_goTypes,
		DependencyIndexes: file_google_cloud_geminidataanalytics_v1_data_agent_proto_depIdxs,
		MessageInfos:      file_google_cloud_geminidataanalytics_v1_data_agent_proto_msgTypes,
	}.Build()
	File_google_cloud_geminidataanalytics_v1_data_agent_proto = out.File
	file_google_cloud_geminidataanalytics_v1_data_agent_proto_goTypes = nil
	file_google_cloud_geminidataanalytics_v1_data_agent_proto_depIdxs = nil
}
