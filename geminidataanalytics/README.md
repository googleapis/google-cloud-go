...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/geminidataanalytics.svg)](https://pkg.go.dev/cloud.google.com/go/geminidataanalytics)

Go Client Library for Data Analytics API with Gemini.

## Install

```bash
go get cloud.google.com/go/geminidataanalytics
```
