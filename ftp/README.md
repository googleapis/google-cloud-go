...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/ftp.svg)](https://pkg.go.dev/cloud.google.com/go/ftp)

Go Client Library for Cloud FTP API.

## Install

```bash
go get cloud.google.com/go/ftp
```
