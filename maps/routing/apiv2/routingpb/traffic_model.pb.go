...
var (
	...
	file_google_maps_routing_v2_traffic_model_proto_rawDescData []byte
)
...
func file_google_maps_routing_v2_traffic_model_proto_rawDescGZIP() []byte {
	file_google_maps_routing_v2_traffic_model_proto_rawDescOnce.Do(func() {
		file_google_maps_routing_v2_traffic_model_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_maps_routing_v2_traffic_model_proto_rawDesc), len(file_google_maps_routing_v2_traffic_model_proto_rawDesc)))
	})
...
func file_google_maps_routing_v2_traffic_model_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_maps_routing_v2_traffic_model_proto_rawDesc), len(file_google_maps_routing_v2_traffic_model_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
