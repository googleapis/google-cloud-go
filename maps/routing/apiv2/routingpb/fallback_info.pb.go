...
var file_google_maps_routing_v2_fallback_info_proto_rawDesc = []byte{
	...
	0x5f, 0x41, 0x57, 0x41, 0x52, 0x45, 0x10, 0x02, 0x42, 0xc3, 0x01, 0x0a, 0x1a, 0x63, 0x6f, 0x6d,
...
func file_google_maps_routing_v2_fallback_info_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_maps_routing_v2_fallback_info_proto_msgTypes[0].Exporter = func(v any, i int) any {
