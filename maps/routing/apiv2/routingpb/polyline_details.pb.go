...
func file_google_maps_routing_v2_polyline_details_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_maps_routing_v2_polyline_details_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*PolylineDetails); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_google_maps_routing_v2_polyline_details_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*PolylineDetails_PolylinePointIndex); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_google_maps_routing_v2_polyline_details_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*PolylineDetails_FlyoverInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_google_maps_routing_v2_polyline_details_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*PolylineDetails_NarrowRoadInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
