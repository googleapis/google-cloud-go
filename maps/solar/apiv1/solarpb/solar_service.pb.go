...
const file_google_maps_solar_v1_solar_service_proto_rawDesc = "" +
	...
	"\fbounding_box\x18\t \x01(\v2\x1f.google.maps.solar.v1.LatLngBoxR\vboundingBox\x124\n" +
	"\fimagery_date\x18\x03 \x01(\v2\x11.google.type.DateR\vimageryDate\x12G\n" +
	"\x16imagery_processed_date\x18\v \x01(\v2\x11.google.type.DateR\x14imageryProcessedDate\x12\x1f\n" +
	"\vpostal_code\x18\x04 \x01(\tR\n" +
	"postalCode\x12/\n" +
	"\x13administrative_area\x18\x05 \x01(\tR\x12administrativeArea\x12)\n" +
	"\x10statistical_area\x18\x06 \x01(\tR\x0fstatisticalArea\x12\x1f\n" +
	...
	" \x01(\x02R\x11panelHeightMeters\x12,\n" +
	"\x12panel_width_meters\x18\v \x01(\x02R\x10panelWidthMeters\x120\n" +
	"\x14panel_lifetime_years\x18\f \x01(\x05R\x12panelLifetimeYears\x123\n" +
	"\x16max_array_area_meters2\x18\x02 \x01(\x02R\x13maxArrayAreaMeters2\x12<\n" +
	"\x1bmax_sunshine_hours_per_year\x18\x03 \x01(\x02R\x17maxSunshineHoursPerYear\x12C\n" +
	"\x1fcarbon_offset_factor_kg_per_mwh\x18\x04 \x01(\x02R\x1acarbonOffsetFactorKgPerMwh\x12T\n" +
	"\x10whole_roof_stats\x18\x05 \x01(\v2*.google.maps.solar.v1.SizeAndSunshineStatsR\x0ewholeRoofStats\x12Q\n" +
	"\x0ebuilding_stats\x18\r \x01(\v2*.google.maps.solar.v1.SizeAndSunshineStatsR\rbuildingStats\x12c\n" +
	"\x12roof_segment_stats\x18\x06 \x03(\v25.google.maps.solar.v1.RoofSegmentSizeAndSunshineStatsR\x10roofSegmentStats\x12C\n" +
	"\fsolar_panels\x18\x0e \x03(\v2 .google.maps.solar.v1.SolarPanelR\vsolarPanels\x12V\n" +
	"\x13solar_panel_configs\x18\a \x03(\v2&.google.maps.solar.v1.SolarPanelConfigR\x11solarPanelConfigs\x12V\n" +
	"\x12financial_analyses\x18\b \x03(\v2'.google.maps.solar.v1.FinancialAnalysisR\x11financialAnalyses\"\xbb\x03\n" +
	"\x1fRoofSegmentSizeAndSunshineStats\x12(\n" +
	"\rpitch_degrees\x18\x01 \x01(\x02H\x00R\fpitchDegrees\x88\x01\x01\x12,\n" +
	"\x0fazimuth_degrees\x18\x02 \x01(\x02H\x01R\x0eazimuthDegrees\x88\x01\x01\x12@\n" +
	"\x05stats\x18\x03 \x01(\v2*.google.maps.solar.v1.SizeAndSunshineStatsR\x05stats\x12+\n" +
	"\x06center\x18\x04 \x01(\v2\x13.google.type.LatLngR\x06center\x12B\n" +
	"\fbounding_box\x18\x05 \x01(\v2\x1f.google.maps.solar.v1.LatLngBoxR\vboundingBox\x12E\n" +
	"\x1dplane_height_at_center_meters\x18\x06 \x01(\x02H\x02R\x19planeHeightAtCenterMeters\x88\x01\x01B\x10\n" +
	"\x0e_pitch_degreesB\x12\n" +
	"\x10_azimuth_degreesB \n" +
	"\x1e_plane_height_at_center_meters\"\x98\x01\n" +
	"\x14SizeAndSunshineStats\x12!\n" +
	"\farea_meters2\x18\x01 \x01(\x02R\vareaMeters2\x12-\n" +
	"\x12sunshine_quantiles\x18\x02 \x03(\x02R\x11sunshineQuantiles\x12.\n" +
	"\x13ground_area_meters2\x18\x03 \x01(\x02R\x11groundAreaMeters2\"\xf5\x01\n" +
	"\n" +
	"SolarPanel\x12+\n" +
	"\x06center\x18\x01 \x01(\v2\x13.google.type.LatLngR\x06center\x12M\n" +
	"\vorientation\x18\x02 \x01(\x0e2+.google.maps.solar.v1.SolarPanelOrientationR\vorientation\x12/\n" +
	"\x14yearly_energy_dc_kwh\x18\x03 \x01(\x02R\x11yearlyEnergyDcKwh\x12(\n" +
	"\rsegment_index\x18\x04 \x01(\x05H\x00R\fsegmentIndex\x88\x01\x01B\x10\n" +
	"\x0e_segment_index\"\xc6\x01\n" +
	"\x10SolarPanelConfig\x12!\n" +
	"\fpanels_count\x18\x01 \x01(\x05R\vpanelsCount\x12/\n" +
	"\x14yearly_energy_dc_kwh\x18\x02 \x01(\x02R\x11yearlyEnergyDcKwh\x12^\n" +
	"\x16roof_segment_summaries\x18\x04 \x03(\v2(.google.maps.solar.v1.RoofSegmentSummaryR\x14roofSegmentSummaries\"\xa2\x02\n" +
	"\x12RoofSegmentSummary\x12(\n" +
	"\rpitch_degrees\x18\x02 \x01(\x02H\x00R\fpitchDegrees\x88\x01\x01\x12,\n" +
	"\x0fazimuth_degrees\x18\x03 \x01(\x02H\x01R\x0eazimuthDegrees\x88\x01\x01\x12!\n" +
	"\fpanels_count\x18\a \x01(\x05R\vpanelsCount\x12/\n" +
	"\x14yearly_energy_dc_kwh\x18\b \x01(\x02R\x11yearlyEnergyDcKwh\x12(\n" +
	"\rsegment_index\x18\t \x01(\x05H\x02R\fsegmentIndex\x88\x01\x01B\x10\n" +
	"\x0e_pitch_degreesB\x12\n" +
	"\x10_azimuth_degreesB\x10\n" +
	"\x0e_segment_index\"\xd8\x04\n" +
	"\x11FinancialAnalysis\x125\n" +
	"\fmonthly_bill\x18\x03 \x01(\v2\x12.google.type.MoneyR\vmonthlyBill\x12!\n" +
	"\fdefault_bill\x18\x04 \x01(\bR\vdefaultBill\x121\n" +
	"\x15average_kwh_per_month\x18\x05 \x01(\x02R\x12averageKwhPerMonth\x121\n" +
	"\x12panel_config_index\x18\x06 \x01(\x05H\x00R\x10panelConfigIndex\x88\x01\x01\x12S\n" +
	"\x11financial_details\x18\a \x01(\v2&.google.maps.solar.v1.FinancialDetailsR\x10financialDetails\x12M\n" +
	"\x0fleasing_savings\x18\b \x01(\v2$.google.maps.solar.v1.LeasingSavingsR\x0eleasingSavings\x12]\n" +
	"\x15cash_purchase_savings\x18\t \x01(\v2).google.maps.solar.v1.CashPurchaseSavingsR\x13cashPurchaseSavings\x12i\n" +
	"\x19financed_purchase_savings\x18\n" +
	" \x01(\v2-.google.maps.solar.v1.FinancedPurchaseSavingsR\x17financedPurchaseSavingsB\x15\n" +
	"\x13_panel_config_index\"\xdf\x05\n" +
	"\x10FinancialDetails\x124\n" +
	"\x17initial_ac_kwh_per_year\x18\x01 \x01(\x02R\x13initialAcKwhPerYear\x12Y\n" +
	"\x1fremaining_lifetime_utility_bill\x18\x02 \x01(\v2\x12.google.type.MoneyR\x1cremainingLifetimeUtilityBill\x12?\n" +
	"\x11federal_incentive\x18\x03 \x01(\v2\x12.google.type.MoneyR\x10federalIncentive\x12;\n" +
	"\x0fstate_incentive\x18\x04 \x01(\v2\x12.google.type.MoneyR\x0estateIncentive\x12?\n" +
	"\x11utility_incentive\x18\x05 \x01(\v2\x12.google.type.MoneyR\x10utilityIncentive\x12B\n" +
	"\x13lifetime_srec_total\x18\x06 \x01(\v2\x12.google.type.MoneyR\x11lifetimeSrecTotal\x12\\\n" +
	"!cost_of_electricity_without_solar\x18\a \x01(\v2\x12.google.type.MoneyR\x1dcostOfElectricityWithoutSolar\x120\n" +
	"\x14net_metering_allowed\x18\b \x01(\bR\x12netMeteringAllowed\x12.\n" +
	"\x10solar_percentage\x18\t \x01(\x02H\x00R\x0fsolarPercentage\x88\x01\x01\x12B\n" +
	"\x1bpercentage_exported_to_grid\x18\n" +
	" \x01(\x02H\x01R\x18percentageExportedToGrid\x88\x01\x01B\x13\n" +
	"\x11_solar_percentageB\x1e\n" +
	"\x1c_percentage_exported_to_grid\"\xab\x03\n" +
	"\x0fSavingsOverTime\x127\n" +
	"\rsavings_year1\x18\x01 \x01(\v2\x12.google.type.MoneyR\fsavingsYear1\x129\n" +
	"\x0esavings_year20\x18\x02 \x01(\v2\x12.google.type.MoneyR\rsavingsYear20\x12X\n" +
	"\x1fpresent_value_of_savings_year20\x18\x03 \x01(\v2\x12.google.type.MoneyR\x1bpresentValueOfSavingsYear20\x12=\n" +
	"\x10savings_lifetime\x18\x05 \x01(\v2\x12.google.type.MoneyR\x0fsavingsLifetime\x12\\\n" +
	"!present_value_of_savings_lifetime\x18\x06 \x01(\v2\x12.google.type.MoneyR\x1dpresentValueOfSavingsLifetime\x12-\n" +
	"\x12financially_viable\x18\x04 \x01(\bR\x11financiallyViable\"\xe7\x01\n" +
	"\x0eLeasingSavings\x12%\n" +
	"\x0eleases_allowed\x18\x01 \x01(\bR\rleasesAllowed\x12)\n" +
	"\x10leases_supported\x18\x02 \x01(\bR\x0fleasesSupported\x12B\n" +
	"\x13annual_leasing_cost\x18\x03 \x01(\v2\x12.google.type.MoneyR\x11annualLeasingCost\x12?\n" +
	"\asavings\x18\x04 \x01(\v2%.google.maps.solar.v1.SavingsOverTimeR\asavings\"\xc1\x02\n" +
	"\x13CashPurchaseSavings\x12?\n" +
	"\x12out_of_pocket_cost\x18\x01 \x01(\v2\x12.google.type.MoneyR\x0foutOfPocketCost\x125\n" +
	"\fupfront_cost\x18\x02 \x01(\v2\x12.google.type.MoneyR\vupfrontCost\x125\n" +
	"\frebate_value\x18\x03 \x01(\v2\x12.google.type.MoneyR\vrebateValue\x12(\n" +
	"\rpayback_years\x18\x04 \x01(\x02H\x00R\fpaybackYears\x88\x01\x01\x12?\n" +
	"\asavings\x18\x05 \x01(\v2%.google.maps.solar.v1.SavingsOverTimeR\asavingsB\x10\n" +
	"\x0e_payback_years\"\x83\x02\n" +
	"\x17FinancedPurchaseSavings\x12B\n" +
	"\x13annual_loan_payment\x18\x01 \x01(\v2\x12.google.type.MoneyR\x11annualLoanPayment\x125\n" +
	"\frebate_value\x18\x02 \x01(\v2\x12.google.type.MoneyR\vrebateValue\x12,\n" +
	"\x12loan_interest_rate\x18\x03 \x01(\x02R\x10loanInterestRate\x12?\n" +
	"\asavings\x18\x04 \x01(\v2%.google.maps.solar.v1.SavingsOverTimeR\asavings\"\xbf\x03\n" +
	"\x14GetDataLayersRequest\x124\n" +
	"\blocation\x18\x01 \x01(\v2\x13.google.type.LatLngB\x03\xe0A\x02R\blocation\x12(\n" +
	"\rradius_meters\x18\x02 \x01(\x02B\x03\xe0A\x02R\fradiusMeters\x12<\n" +
	"\x04view\x18\x03 \x01(\x0e2#.google.maps.solar.v1.DataLayerViewB\x03\xe0A\x01R\x04view\x12T\n" +
	"\x10required_quality\x18\x05 \x01(\x0e2$.google.maps.solar.v1.ImageryQualityB\x03\xe0A\x01R\x0frequiredQuality\x12/\n" +
	"\x11pixel_size_meters\x18\x06 \x01(\x02B\x03\xe0A\x01R\x0fpixelSizeMeters\x129\n" +
	"\x16exact_quality_required\x18\a \x01(\bB\x03\xe0A\x01R\x14exactQualityRequired\x12G\n" +
	"\vexperiments\x18\b \x03(\x0e2 .google.maps.solar.v1.ExperimentB\x03\xe0A\x01R\vexperiments\"\xa5\x03\n" +
	"\n" +
	"DataLayers\x124\n" +
	"\fimagery_date\x18\x01 \x01(\v2\x11.google.type.DateR\vimageryDate\x12G\n" +
	"\x16imagery_processed_date\x18\x02 \x01(\v2\x11.google.type.DateR\x14imageryProcessedDate\x12\x17\n" +
	"\adsm_url\x18\x03 \x01(\tR\x06dsmUrl\x12\x17\n" +
	"\argb_url\x18\x04 \x01(\tR\x06rgbUrl\x12\x19\n" +
	"\bmask_url\x18\x05 \x01(\tR\amaskUrl\x12&\n" +
	"\x0fannual_flux_url\x18\x06 \x01(\tR\rannualFluxUrl\x12(\n" +
	"\x10monthly_flux_url\x18\a \x01(\tR\x0emonthlyFluxUrl\x12*\n" +
	...
	"\vFULL_LAYERS\x10\x05*Z\n" +
	"\x0eImageryQuality\x12\x1f\n" +
	"\x1bIMAGERY_QUALITY_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04HIGH\x10\x01\x12\n" +
	"\n" +
	...
	"\x18com.google.maps.solar.v1B\x11SolarServiceProtoP\x01Z4cloud.google.com/go/maps/solar/apiv1/solarpb;solarpb\xa2\x02\aGGMPV1A\xaa\x02\x14Google.Maps.Solar.V1\xca\x02\x14Google\\Maps\\Solar\\V1\xea\x02\x17Google::Maps::Solar::V1b\x06proto3"

var (
	file_google_maps_solar_v1_solar_service_proto_rawDescOnce sync.Once
	file_google_maps_solar_v1_solar_service_proto_rawDescData []byte
)
...
func file_google_maps_solar_v1_solar_service_proto_rawDescGZIP() []byte {
	file_google_maps_solar_v1_solar_service_proto_rawDescOnce.Do(func() {
		file_google_maps_solar_v1_solar_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_maps_solar_v1_solar_service_proto_rawDesc), len(file_google_maps_solar_v1_solar_service_proto_rawDesc)))
	})
