...
package playablelocationspb

import (
	samplepb "cloud.google.com/go/maps/playablelocations/apiv3/sample/samplepb"
	unitypb "cloud.google.com/go/maps/unity/unitypb"
	context "context"
...
type SamplePlayableLocationsRequest struct {
	...
	AreaFilter *samplepb.AreaFilter `protobuf:"bytes,1,opt,name=area_filter,json=areaFilter,proto3" json:"area_filter,omitempty"`
	// Required. Specifies one or more (up to 5) criteria for filtering the
	// returned playable locations.
	Criteria []*samplepb.Criterion `protobuf:"bytes,2,rep,name=criteria,proto3" json:"criteria,omitempty"`
}
...
func (x *SamplePlayableLocationsRequest) GetAreaFilter() *samplepb.AreaFilter {
	if x != nil {
		return x.AreaFilter
	}
	return nil
...
func (x *SamplePlayableLocationsRequest) GetCriteria() []*samplepb.Criterion {
	if x != nil {
		return x.Criteria
	}
	return nil
...
type SamplePlayableLocationsResponse struct {
	...
	// in the request.
	LocationsPerGameObjectType map[int32]*samplepb.PlayableLocationList `protobuf:"bytes,1,rep,name=locations_per_game_object_type,json=locationsPerGameObjectType,proto3" json:"locations_per_game_object_type,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *SamplePlayableLocationsResponse) GetLocationsPerGameObjectType() map[int32]*samplepb.PlayableLocationList {
	if x != nil {
...
type LogPlayerReportsRequest struct {
	...
	ClientInfo *unitypb.ClientInfo `protobuf:"bytes,3,opt,name=client_info,json=clientInfo,proto3" json:"client_info,omitempty"`
}
...
func (x *LogPlayerReportsRequest) GetClientInfo() *unitypb.ClientInfo {
	if x != nil {
		return x.ClientInfo
	}
	return nil
...
func (x *LogImpressionsRequest) GetClientInfo() *unitypb.ClientInfo {
	if x != nil {
		return x.ClientInfo
	}
	return nil
...
var file_google_maps_playablelocations_v3_playablelocations_proto_rawDesc = []byte{
	...
	0x1b, 0x2f, 0x76, 0x33, 0x3a, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x50, 0x6c, 0x61, 0x79, 0x61,
	0x62, 0x6c, 0x65, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0xaa, 0x01, 0x0a,
	...
	0x3a, 0x01, 0x2a, 0x22, 0x14, 0x2f, 0x76, 0x33, 0x3a, 0x6c, 0x6f, 0x67, 0x50, 0x6c, 0x61, 0x79,
	0x65, 0x72, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x12, 0xa2, 0x01, 0x0a, 0x0e, 0x4c, 0x6f,
	...
	0x1d, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x17, 0x3a, 0x01, 0x2a, 0x22, 0x12, 0x2f, 0x76, 0x33, 0x3a,
	0x6c, 0x6f, 0x67, 0x49, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x23,
	...
	0x63, 0x6f, 0x6d, 0x42, 0xe7, 0x01, 0x0a, 0x24, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x6d, 0x61, 0x70, 0x73, 0x2e, 0x70, 0x6c, 0x61, 0x79, 0x61, 0x62, 0x6c, 0x65,
	...
	,
...
var file_google_maps_playablelocations_v3_playablelocations_proto_goTypes = []any{
	...
	(*samplepb.AreaFilter)(nil),             // 7: google.maps.playablelocations.v3.sample.AreaFilter
	(*samplepb.Criterion)(nil),              // 8: google.maps.playablelocations.v3.sample.Criterion
	(*durationpb.Duration)(nil),             // 9: google.protobuf.Duration
	(*PlayerReport)(nil),                    // 10: google.maps.playablelocations.v3.PlayerReport
	(*unitypb.ClientInfo)(nil),              // 11: google.maps.unity.ClientInfo
	(*Impression)(nil),                      // 12: google.maps.playablelocations.v3.Impression
	(*samplepb.PlayableLocationList)(nil),   // 13: google.maps.playablelocations.v3.sample.PlayableLocationList
}
...
func file_google_maps_playablelocations_v3_playablelocations_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_maps_playablelocations_v3_playablelocations_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_maps_playablelocations_v3_playablelocations_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_maps_playablelocations_v3_playablelocations_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_maps_playablelocations_v3_playablelocations_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_maps_playablelocations_v3_playablelocations_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_google_maps_playablelocations_v3_playablelocations_proto_msgTypes[5].Exporter = func(v any, i int) any {
