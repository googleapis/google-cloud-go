...
import (
	_type "google.golang.org/genproto/googleapis/geo/type"
...
type Geocode struct {
	...
	Bounds *_type.Viewport `protobuf:"bytes,4,opt,name=bounds,proto3" json:"bounds,omitempty"`
...
func (x *Geocode) GetBounds() *_type.Viewport {
	if x != nil {
		return x.Bounds
	}
	return nil
...
var file_google_maps_addressvalidation_v1_geocode_proto_goTypes = []interface{}{
	...
	(*_type.Viewport)(nil), // 3: google.geo.type.Viewport
}
