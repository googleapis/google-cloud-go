...
const file_google_maps_addressvalidation_v1_address_proto_rawDesc = "" +
	"\n" +
	".google/maps/addressvalidation/v1/address.proto\x12 google.maps.addressvalidation.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a google/type/postal_address.proto\"\x86\x03\n" +
	"\aAddress\x12+\n" +
	"\x11formatted_address\x18\x02 \x01(\tR\x10formattedAddress\x12A\n" +
	"\x0epostal_address\x18\x03 \x01(\v2\x1a.google.type.PostalAddressR\rpostalAddress\x12f\n" +
	"\x12address_components\x18\x04 \x03(\v22.google.maps.addressvalidation.v1.AddressComponentB\x03\xe0A\x06R\x11addressComponents\x126\n" +
	"\x17missing_component_types\x18\x05 \x03(\tR\x15missingComponentTypes\x12>\n" +
	"\x1bunconfirmed_component_types\x18\x06 \x03(\tR\x19unconfirmedComponentTypes\x12+\n" +
	"\x11unresolved_tokens\x18\a \x03(\tR\x10unresolvedTokens\"\x8f\x04\n" +
	"\x10AddressComponent\x12V\n" +
	"\x0ecomponent_name\x18\x01 \x01(\v2/.google.maps.addressvalidation.v1.ComponentNameR\rcomponentName\x12%\n" +
	"\x0ecomponent_type\x18\x02 \x01(\tR\rcomponentType\x12s\n" +
	"\x12confirmation_level\x18\x03 \x01(\x0e2D.google.maps.addressvalidation.v1.AddressComponent.ConfirmationLevelR\x11confirmationLevel\x12\x1a\n" +
	"\binferred\x18\x04 \x01(\bR\binferred\x12'\n" +
	"\x0fspell_corrected\x18\x05 \x01(\bR\x0espellCorrected\x12\x1a\n" +
	"\breplaced\x18\x06 \x01(\bR\breplaced\x12\x1e\n" +
	"\n" +
	"unexpected\x18\a \x01(\bR\n" +
	"unexpected\"\x85\x01\n" +
	...
	"\x1aUNCONFIRMED_AND_SUSPICIOUS\x10\x03\"H\n" +
	"\rComponentName\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12#\n" +
	"\rlanguage_code\x18\x02 \x01(\tR\flanguageCodeB\x86\x02\n" +
	"$com.google.maps.addressvalidation.v1B\fAddressProtoP\x01ZXcloud.google.com/go/maps/addressvalidation/apiv1/addressvalidationpb;addressvalidationpb\xa2\x02\aGMPAVV1\xaa\x02 Google.Maps.AddressValidation.V1\xca\x02 Google\\Maps\\AddressValidation\\V1\xea\x02#Google::Maps::AddressValidation::V1b\x06proto3"

var (
	file_google_maps_addressvalidation_v1_address_proto_rawDescOnce sync.Once
	file_google_maps_addressvalidation_v1_address_proto_rawDescData []byte
)
...
func file_google_maps_addressvalidation_v1_address_proto_rawDescGZIP() []byte {
	file_google_maps_addressvalidation_v1_address_proto_rawDescOnce.Do(func() {
		file_google_maps_addressvalidation_v1_address_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_maps_addressvalidation_v1_address_proto_rawDesc), len(file_google_maps_addressvalidation_v1_address_proto_rawDesc)))
	})
...
func file_google_maps_addressvalidation_v1_address_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_maps_addressvalidation_v1_address_proto_rawDesc), len(file_google_maps_addressvalidation_v1_address_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
