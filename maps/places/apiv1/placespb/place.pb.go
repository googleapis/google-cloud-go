...
func file_google_maps_places_v1_place_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_maps_places_v1_place_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_maps_places_v1_place_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_maps_places_v1_place_proto_msgTypes[13].OneofWrappers = []interface{}{}
	type x struct{}
