...
func ExampleVehicleClient_DeleteVehicle() {
	ctx := context.Background()
	// This snippet has been automatically generated and should be regarded as a code template only.
	// It will require modifications to work:
	// - It may require correct/in-range values for request initialization.
	...
	req := &fleetenginepb.DeleteVehicleRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/maps/fleetengine/apiv1/fleetenginepb#DeleteVehicleRequest.
	}
	err = c.DeleteVehicle(ctx, req)
	if err != nil {
		// TODO: Handle error.
	}
}
