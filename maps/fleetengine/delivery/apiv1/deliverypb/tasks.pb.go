...
func (x *TaskTrackingViewConfig_VisibilityOption) GetVisibilityOption() isTaskTrackingViewConfig_VisibilityOption_VisibilityOption {
	if x != nil {
		return x.VisibilityOption
	}
	return nil
}
...
func (x *TaskTrackingViewConfig_VisibilityOption) GetRemainingStopCountThreshold() int32 {
	if x != nil {
		if x, ok := x.VisibilityOption.(*TaskTrackingViewConfig_VisibilityOption_RemainingStopCountThreshold); ok {
...
func (x *TaskTrackingViewConfig_VisibilityOption) GetDurationUntilEstimatedArrivalTimeThreshold() *durationpb.Duration {
	if x != nil {
		if x, ok := x.VisibilityOption.(*TaskTrackingViewConfig_VisibilityOption_DurationUntilEstimatedArrivalTimeThreshold); ok {
...
func (x *TaskTrackingViewConfig_VisibilityOption) GetRemainingDrivingDistanceMetersThreshold() int32 {
	if x != nil {
		if x, ok := x.VisibilityOption.(*TaskTrackingViewConfig_VisibilityOption_RemainingDrivingDistanceMetersThreshold); ok {
...
func (x *TaskTrackingViewConfig_VisibilityOption) GetAlways() bool {
	if x != nil {
		if x, ok := x.VisibilityOption.(*TaskTrackingViewConfig_VisibilityOption_Always); ok {
			return x.Always
		}
	}
	return false
...
func (x *TaskTrackingViewConfig_VisibilityOption) GetNever() bool {
	if x != nil {
		if x, ok := x.VisibilityOption.(*TaskTrackingViewConfig_VisibilityOption_Never); ok {
			return x.Never
		}
	}
	return false
...
const file_google_maps_fleetengine_delivery_v1_tasks_proto_rawDesc = "" +
	"\n" +
	"/google/maps/fleetengine/delivery/v1/tasks.proto\x12\x1cmaps.fleetengine.delivery.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a0google/maps/fleetengine/delivery/v1/common.proto\x1a;google/maps/fleetengine/delivery/v1/delivery_vehicles.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe7\x0e\n" +
	"\x04Task\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12C\n" +
	"\x04type\x18\x02 \x01(\x0e2'.maps.fleetengine.delivery.v1.Task.TypeB\x06\xe0A\x02\xe0A\x05R\x04type\x12C\n" +
	"\x05state\x18\x03 \x01(\x0e2(.maps.fleetengine.delivery.v1.Task.StateB\x03\xe0A\x02R\x05state\x12Q\n" +
	"\ftask_outcome\x18\t \x01(\x0e2..maps.fleetengine.delivery.v1.Task.TaskOutcomeR\vtaskOutcome\x12F\n" +
	"\x11task_outcome_time\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\x0ftaskOutcomeTime\x12^\n" +
	"\x15task_outcome_location\x18\v \x01(\v2*.maps.fleetengine.delivery.v1.LocationInfoR\x13taskOutcomeLocation\x12}\n" +
	"\x1ctask_outcome_location_source\x18\f \x01(\x0e2<.maps.fleetengine.delivery.v1.Task.TaskOutcomeLocationSourceR\x19taskOutcomeLocationSource\x12$\n" +
	"\vtracking_id\x18\x04 \x01(\tB\x03\xe0A\x05R\n" +
	"trackingId\x123\n" +
	"\x13delivery_vehicle_id\x18\x05 \x01(\tB\x03\xe0A\x03R\x11deliveryVehicleId\x12Z\n" +
	"\x10planned_location\x18\x06 \x01(\v2*.maps.fleetengine.delivery.v1.LocationInfoB\x03\xe0A\x05R\x0fplannedLocation\x12F\n" +
	"\rtask_duration\x18\a \x01(\v2\x19.google.protobuf.DurationB\x06\xe0A\x02\xe0A\x05R\ftaskDuration\x12V\n" +
	"\x12target_time_window\x18\x0e \x01(\v2(.maps.fleetengine.delivery.v1.TimeWindowR\x10targetTimeWindow\x12l\n" +
	"\x14journey_sharing_info\x18\b \x01(\v25.maps.fleetengine.delivery.v1.Task.JourneySharingInfoB\x03\xe0A\x03R\x12journeySharingInfo\x12o\n" +
	"\x19task_tracking_view_config\x18\r \x01(\v24.maps.fleetengine.delivery.v1.TaskTrackingViewConfigR\x16taskTrackingViewConfig\x12K\n" +
	"\n" +
	"attributes\x18\x0f \x03(\v2+.maps.fleetengine.delivery.v1.TaskAttributeR\n" +
	"attributes\x1a\xab\x02\n" +
	"\x12JourneySharingInfo\x12\x80\x01\n" +
	"\"remaining_vehicle_journey_segments\x18\x01 \x03(\v23.maps.fleetengine.delivery.v1.VehicleJourneySegmentR\x1fremainingVehicleJourneySegments\x12Z\n" +
	"\rlast_location\x18\x02 \x01(\v25.maps.fleetengine.delivery.v1.DeliveryVehicleLocationR\flastLocation\x126\n" +
	"\x17last_location_snappable\x18\x03 \x01(\bR\x15lastLocationSnappable\"[\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06PICKUP\x10\x01\x12\f\n" +
	"\bDELIVERY\x10\x02\x12\x12\n" +
	"\x0eSCHEDULED_STOP\x10\x03\x12\x0f\n" +
	"\vUNAVAILABLE\x10\x04\"4\n" +
	"\x05State\x12\x15\n" +
	...
	"(TASK_OUTCOME_LOCATION_SOURCE_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bPROVIDER\x10\x02\x12\x19\n" +
	"\x15LAST_VEHICLE_LOCATION\x10\x03:G\xeaAD\n" +
	"\x1ffleetengine.googleapis.com/Task\x12!providers/{provider}/tasks/{task}\"\x96\n" +
	"\n" +
	"\x16TaskTrackingViewConfig\x12\x8e\x01\n" +
	" route_polyline_points_visibility\x18\x01 \x01(\v2E.maps.fleetengine.delivery.v1.TaskTrackingViewConfig.VisibilityOptionR\x1droutePolylinePointsVisibility\x12\x90\x01\n" +
	"!estimated_arrival_time_visibility\x18\x02 \x01(\v2E.maps.fleetengine.delivery.v1.TaskTrackingViewConfig.VisibilityOptionR\x1eestimatedArrivalTimeVisibility\x12\x9f\x01\n" +
	")estimated_task_completion_time_visibility\x18\x03 \x01(\v2E.maps.fleetengine.delivery.v1.TaskTrackingViewConfig.VisibilityOptionR%estimatedTaskCompletionTimeVisibility\x12\x98\x01\n" +
	"%remaining_driving_distance_visibility\x18\x04 \x01(\v2E.maps.fleetengine.delivery.v1.TaskTrackingViewConfig.VisibilityOptionR\"remainingDrivingDistanceVisibility\x12\x8c\x01\n" +
	"\x1fremaining_stop_count_visibility\x18\x05 \x01(\v2E.maps.fleetengine.delivery.v1.TaskTrackingViewConfig.VisibilityOptionR\x1cremainingStopCountVisibility\x12\x85\x01\n" +
	"\x1bvehicle_location_visibility\x18\x06 \x01(\v2E.maps.fleetengine.delivery.v1.TaskTrackingViewConfig.VisibilityOptionR\x19vehicleLocationVisibility\x1a\x83\x03\n" +
	"\x10VisibilityOption\x12E\n" +
	"\x1eremaining_stop_count_threshold\x18\x01 \x01(\x05H\x00R\x1bremainingStopCountThreshold\x12\x80\x01\n" +
	"/duration_until_estimated_arrival_time_threshold\x18\x02 \x01(\v2\x19.google.protobuf.DurationH\x00R*durationUntilEstimatedArrivalTimeThreshold\x12^\n" +
	"+remaining_driving_distance_meters_threshold\x18\x03 \x01(\x05H\x00R'remainingDrivingDistanceMetersThreshold\x12\x18\n" +
	"\x06always\x18\x04 \x01(\bH\x00R\x06always\x12\x16\n" +
	"\x05never\x18\x05 \x01(\bH\x00R\x05neverB\x13\n" +
...
var (
	...
	file_google_maps_fleetengine_delivery_v1_tasks_proto_rawDescData []byte
)
...
func file_google_maps_fleetengine_delivery_v1_tasks_proto_rawDescGZIP() []byte {
	file_google_maps_fleetengine_delivery_v1_tasks_proto_rawDescOnce.Do(func() {
		file_google_maps_fleetengine_delivery_v1_tasks_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_maps_fleetengine_delivery_v1_tasks_proto_rawDesc), len(file_google_maps_fleetengine_delivery_v1_tasks_proto_rawDesc)))
	})
...
func file_google_maps_fleetengine_delivery_v1_tasks_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_maps_fleetengine_delivery_v1_tasks_proto_rawDesc), len(file_google_maps_fleetengine_delivery_v1_tasks_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
