...
// internalIamPolicyClient is an interface that defines the methods available from VM Migration API.
...
// iamPolicyGRPCClient is a client for interacting with VM Migration API over gRPC transport.
//
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
