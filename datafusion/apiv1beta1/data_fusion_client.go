...
func (c *restClient) RestartInstance(ctx context.Context, req *datafusionpb.RestartInstanceRequest, opts ...gax.CallOption) (*RestartInstanceOperation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1beta1/%v:restart", req.GetName())
...
// UpgradeInstance upgrade a single Data Fusion instance.
// At the end of an operation instance is fully upgraded.
func (c *restClient) UpgradeInstance(ctx context.Context, req *datafusionpb.UpgradeInstanceRequest, opts ...gax.CallOption) (*UpgradeInstanceOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
...
// RemoveIamPolicy remove IAM policy that is currently set on the given resource.
func (c *restClient) RemoveIamPolicy(ctx context.Context, req *datafusionpb.RemoveIamPolicyRequest, opts ...gax.CallOption) (*datafusionpb.RemoveIamPolicyResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v1beta1/%v:removeIamPolicy", req.GetResource())
	...
	opts = append((*c.CallOptions).RemoveIamPolicy[0:len((*c.CallOptions).RemoveIamPolicy):len((*c.CallOptions).RemoveIamPolicy)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &datafusionpb.RemoveIamPolicyResponse{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
// ListNamespaces list namespaces in a given instance
func (c *restClient) ListNamespaces(ctx context.Context, req *datafusionpb.ListNamespacesRequest, opts ...gax.CallOption) *NamespaceIterator {
	it := &NamespaceIterator{}
	req = proto.Clone(req).(*datafusionpb.ListNamespacesRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*datafusionpb.Namespace, string, error) {
...
// AddDnsPeering add DNS peering on the given resource.
func (c *restClient) AddDnsPeering(ctx context.Context, req *datafusionpb.AddDnsPeeringRequest, opts ...gax.CallOption) (*datafusionpb.AddDnsPeeringResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v1beta1/%v/dnsPeerings:add", req.GetParent())
	...
	opts = append((*c.CallOptions).AddDnsPeering[0:len((*c.CallOptions).AddDnsPeering):len((*c.CallOptions).AddDnsPeering)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &datafusionpb.AddDnsPeeringResponse{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
// RemoveDnsPeering remove DNS peering on the given resource.
func (c *restClient) RemoveDnsPeering(ctx context.Context, req *datafusionpb.RemoveDnsPeeringRequest, opts ...gax.CallOption) (*datafusionpb.RemoveDnsPeeringResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v1beta1/%v/dnsPeerings:remove", req.GetParent())
	...
	opts = append((*c.CallOptions).RemoveDnsPeering[0:len((*c.CallOptions).RemoveDnsPeering):len((*c.CallOptions).RemoveDnsPeering)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &datafusionpb.RemoveDnsPeeringResponse{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
// ListDnsPeerings list DNS peering for a given resource.
func (c *restClient) ListDnsPeerings(ctx context.Context, req *datafusionpb.ListDnsPeeringsRequest, opts ...gax.CallOption) *DnsPeeringIterator {
	it := &DnsPeeringIterator{}
	req = proto.Clone(req).(*datafusionpb.ListDnsPeeringsRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*datafusionpb.DnsPeering, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v1beta1/%v/dnsPeerings:list", req.GetParent())
...
// UpgradeInstanceOperation returns a new UpgradeInstanceOperation from a given name.
// The name must be that of a previously created UpgradeInstanceOperation, possibly from a different process.
func (c *restClient) UpgradeInstanceOperation(name string) *UpgradeInstanceOperation {
	override := fmt.Sprintf("/v1beta1/%s", name)
	return &UpgradeInstanceOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
