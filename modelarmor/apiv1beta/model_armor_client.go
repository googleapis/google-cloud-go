...
func NewClient(ctx context.Context, opts ...option.ClientOption) (*Client, error) {
	...
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		clientOpts = append(clientOpts, internaloption.WithTelemetryAttributes(map[string]string{
			...
			"gcp.client.artifact": "cloud.google.com/go/modelarmor/apiv1beta",
...
func (c *gRPCClient) UpdateTemplate(ctx context.Context, req *modelarmorpb.UpdateTemplateRequest, opts ...gax.CallOption) (*modelarmorpb.Template, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.modelarmor.v1beta.ModelArmor/UpdateTemplate")
	}
...
func (c *gRPCClient) UpdateFloorSetting(ctx context.Context, req *modelarmorpb.UpdateFloorSettingRequest, opts ...gax.CallOption) (*modelarmorpb.FloorSetting, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.modelarmor.v1beta.ModelArmor/UpdateFloorSetting")
	}
...
func (c *restClient) ListTemplates(ctx context.Context, req *modelarmorpb.ListTemplatesRequest, opts ...gax.CallOption) *TemplateIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*modelarmorpb.Template, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v1beta/%v/templates", req.GetParent())
...
func (c *restClient) UpdateTemplate(ctx context.Context, req *modelarmorpb.UpdateTemplateRequest, opts ...gax.CallOption) (*modelarmorpb.Template, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1beta/%v", req.GetTemplate().GetName())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.modelarmor.v1beta.ModelArmor/UpdateTemplate")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1beta/{template.name=projects/*/locations/*/templates/*}")
	}
	opts = append((*c.CallOptions).UpdateTemplate[0:len((*c.CallOptions).UpdateTemplate):len((*c.CallOptions).UpdateTemplate)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &modelarmorpb.Template{}
...
func (c *restClient) UpdateFloorSetting(ctx context.Context, req *modelarmorpb.UpdateFloorSettingRequest, opts ...gax.CallOption) (*modelarmorpb.FloorSetting, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1beta/%v", req.GetFloorSetting().GetName())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.modelarmor.v1beta.ModelArmor/UpdateFloorSetting")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1beta/{floor_setting.name=projects/*/locations/*/floorSetting}")
	}
	opts = append((*c.CallOptions).UpdateFloorSetting[0:len((*c.CallOptions).UpdateFloorSetting):len((*c.CallOptions).UpdateFloorSetting)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &modelarmorpb.FloorSetting{}
...
func (c *restClient) SanitizeUserPrompt(ctx context.Context, req *modelarmorpb.SanitizeUserPromptRequest, opts ...gax.CallOption) (*modelarmorpb.SanitizeUserPromptResponse, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1beta/%v:sanitizeUserPrompt", req.GetName())
...
func (c *restClient) SanitizeModelResponse(ctx context.Context, req *modelarmorpb.SanitizeModelResponseRequest, opts ...gax.CallOption) (*modelarmorpb.SanitizeModelResponseResponse, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1beta/%v:sanitizeModelResponse", req.GetName())
