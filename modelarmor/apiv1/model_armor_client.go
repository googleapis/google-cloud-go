...
func defaultGRPCClientOptions() []option.ClientOption {
	return []option.ClientOption{
		internaloption.WithDefaultEndpoint("modelarmor.googleapis.com:443"),
		internaloption.WithDefaultEndpointTemplate("modelarmor.UNIVERSE_DOMAIN:443"),
		internaloption.WithDefaultMTLSEndpoint("modelarmor.mtls.googleapis.com:443"),
		internaloption.WithDefaultUniverseDomain("googleapis.com"),
		internaloption.WithDefaultAudience("https://modelarmor.googleapis.com/"),
...
// internalClient is an interface that defines the methods available from Model Armor API.
type internalClient interface {
	Close() error
	setGoogleClientInfo(...string)
	Connection() *grpc.ClientConn
	ListTemplates(context.Context, *modelarmorpb.ListTemplatesRequest, ...gax.CallOption) *TemplateIterator
	GetTemplate(context.Context, *modelarmorpb.GetTemplateRequest, ...gax.CallOption) (*modelarmorpb.Template, error)
	CreateTemplate(context.Context, *modelarmorpb.CreateTemplateRequest, ...gax.CallOption) (*modelarmorpb.Template, error)
	UpdateTemplate(context.Context, *modelarmorpb.UpdateTemplateRequest, ...gax.CallOption) (*modelarmorpb.Template, error)
	DeleteTemplate(context.Context, *modelarmorpb.DeleteTemplateRequest, ...gax.CallOption) error
	GetFloorSetting(context.Context, *modelarmorpb.GetFloorSettingRequest, ...gax.CallOption) (*modelarmorpb.FloorSetting, error)
...
// Client is a client for interacting with Model Armor API.
...
func (c *Client) ListTemplates(ctx context.Context, req *modelarmorpb.ListTemplatesRequest, opts ...gax.CallOption) *TemplateIterator {
	return c.internalClient.ListTemplates(ctx, req, opts...)
}

// GetTemplate gets details of a single Template.
func (c *Client) GetTemplate(ctx context.Context, req *modelarmorpb.GetTemplateRequest, opts ...gax.CallOption) (*modelarmorpb.Template, error) {
	return c.internalClient.GetTemplate(ctx, req, opts...)
}

// CreateTemplate creates a new Template in a given project and location.
func (c *Client) CreateTemplate(ctx context.Context, req *modelarmorpb.CreateTemplateRequest, opts ...gax.CallOption) (*modelarmorpb.Template, error) {
	return c.internalClient.CreateTemplate(ctx, req, opts...)
}

// UpdateTemplate updates the parameters of a single Template.
func (c *Client) UpdateTemplate(ctx context.Context, req *modelarmorpb.UpdateTemplateRequest, opts ...gax.CallOption) (*modelarmorpb.Template, error) {
	return c.internalClient.UpdateTemplate(ctx, req, opts...)
}

// DeleteTemplate deletes a single Template.
func (c *Client) DeleteTemplate(ctx context.Context, req *modelarmorpb.DeleteTemplateRequest, opts ...gax.CallOption) error {
	return c.internalClient.DeleteTemplate(ctx, req, opts...)
}

// GetFloorSetting gets details of a single floor setting of a project
func (c *Client) GetFloorSetting(ctx context.Context, req *modelarmorpb.GetFloorSettingRequest, opts ...gax.CallOption) (*modelarmorpb.FloorSetting, error) {
	return c.internalClient.GetFloorSetting(ctx, req, opts...)
}

// UpdateFloorSetting updates the parameters of a single floor setting of a project
func (c *Client) UpdateFloorSetting(ctx context.Context, req *modelarmorpb.UpdateFloorSettingRequest, opts ...gax.CallOption) (*modelarmorpb.FloorSetting, error) {
	return c.internalClient.UpdateFloorSetting(ctx, req, opts...)
}

// SanitizeUserPrompt sanitizes User Prompt.
func (c *Client) SanitizeUserPrompt(ctx context.Context, req *modelarmorpb.SanitizeUserPromptRequest, opts ...gax.CallOption) (*modelarmorpb.SanitizeUserPromptResponse, error) {
	return c.internalClient.SanitizeUserPrompt(ctx, req, opts...)
}

// SanitizeModelResponse sanitizes Model Response.
func (c *Client) SanitizeModelResponse(ctx context.Context, req *modelarmorpb.SanitizeModelResponseRequest, opts ...gax.CallOption) (*modelarmorpb.SanitizeModelResponseResponse, error) {
...
// gRPCClient is a client for interacting with Model Armor API over gRPC transport.
//
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type gRPCClient struct {
	...
	// The gRPC API client.
	client modelarmorpb.ModelArmorClient
...
// NewClient creates a new model armor client based on gRPC.
...
func NewClient(ctx context.Context, opts ...option.ClientOption) (*Client, error) {
	...
	c := &gRPCClient{
		connPool:        connPool,
		client:          modelarmorpb.NewModelArmorClient(connPool),
...
// NewRESTClient creates a new model armor rest client.
//
// Service describing handlers for resources
...
func defaultRESTClientOptions() []option.ClientOption {
	return []option.ClientOption{
		internaloption.WithDefaultEndpoint("https://modelarmor.googleapis.com"),
		internaloption.WithDefaultEndpointTemplate("https://modelarmor.UNIVERSE_DOMAIN"),
		internaloption.WithDefaultMTLSEndpoint("https://modelarmor.mtls.googleapis.com"),
		internaloption.WithDefaultUniverseDomain("googleapis.com"),
		internaloption.WithDefaultAudience("https://modelarmor.googleapis.com/"),
		internaloption.WithDefaultScopes(DefaultAuthScopes()...),
		internaloption.EnableNewAuthLibrary(),
...
func (c *gRPCClient) ListTemplates(ctx context.Context, req *modelarmorpb.ListTemplatesRequest, opts ...gax.CallOption) *TemplateIterator {
...
func (c *gRPCClient) GetTemplate(ctx context.Context, req *modelarmorpb.GetTemplateRequest, opts ...gax.CallOption) (*modelarmorpb.Template, error) {
...
func (c *gRPCClient) CreateTemplate(ctx context.Context, req *modelarmorpb.CreateTemplateRequest, opts ...gax.CallOption) (*modelarmorpb.Template, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}
...
func (c *gRPCClient) UpdateTemplate(ctx context.Context, req *modelarmorpb.UpdateTemplateRequest, opts ...gax.CallOption) (*modelarmorpb.Template, error) {
...
func (c *gRPCClient) DeleteTemplate(ctx context.Context, req *modelarmorpb.DeleteTemplateRequest, opts ...gax.CallOption) error {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
...
func (c *gRPCClient) GetFloorSetting(ctx context.Context, req *modelarmorpb.GetFloorSettingRequest, opts ...gax.CallOption) (*modelarmorpb.FloorSetting, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.GetFloorSetting, req, settings.GRPC, c.logger, "GetFloorSetting")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) UpdateFloorSetting(ctx context.Context, req *modelarmorpb.UpdateFloorSettingRequest, opts ...gax.CallOption) (*modelarmorpb.FloorSetting, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "floor_setting.name", url.QueryEscape(req.GetFloorSetting().GetName()))}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.UpdateFloorSetting, req, settings.GRPC, c.logger, "UpdateFloorSetting")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) SanitizeUserPrompt(ctx context.Context, req *modelarmorpb.SanitizeUserPromptRequest, opts ...gax.CallOption) (*modelarmorpb.SanitizeUserPromptResponse, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.SanitizeUserPrompt, req, settings.GRPC, c.logger, "SanitizeUserPrompt")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) SanitizeModelResponse(ctx context.Context, req *modelarmorpb.SanitizeModelResponseRequest, opts ...gax.CallOption) (*modelarmorpb.SanitizeModelResponseResponse, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
...
func (c *gRPCClient) StreamSanitizeUserPrompt(ctx context.Context, opts ...gax.CallOption) (modelarmorpb.ModelArmor_StreamSanitizeUserPromptClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.modelarmor.v1.ModelArmor/StreamSanitizeUserPrompt")
	}
...
func (c *gRPCClient) StreamSanitizeModelResponse(ctx context.Context, opts ...gax.CallOption) (modelarmorpb.ModelArmor_StreamSanitizeModelResponseClient, error) {
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, c.xGoogHeaders...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.modelarmor.v1.ModelArmor/StreamSanitizeModelResponse")
	}
...
// GetTemplate gets details of a single Template.
func (c *restClient) GetTemplate(ctx context.Context, req *modelarmorpb.GetTemplateRequest, opts ...gax.CallOption) (*modelarmorpb.Template, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// CreateTemplate creates a new Template in a given project and location.
func (c *restClient) CreateTemplate(ctx context.Context, req *modelarmorpb.CreateTemplateRequest, opts ...gax.CallOption) (*modelarmorpb.Template, error) {
...
// UpdateTemplate updates the parameters of a single Template.
func (c *restClient) UpdateTemplate(ctx context.Context, req *modelarmorpb.UpdateTemplateRequest, opts ...gax.CallOption) (*modelarmorpb.Template, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetTemplate()
	jsonReq, err := m.Marshal(body)
	if err != nil {
...
// DeleteTemplate deletes a single Template.
func (c *restClient) DeleteTemplate(ctx context.Context, req *modelarmorpb.DeleteTemplateRequest, opts ...gax.CallOption) error {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return err
	}
...
// GetFloorSetting gets details of a single floor setting of a project
func (c *restClient) GetFloorSetting(ctx context.Context, req *modelarmorpb.GetFloorSettingRequest, opts ...gax.CallOption) (*modelarmorpb.FloorSetting, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "GetFloorSetting")
		if err != nil {
			return err
		}
...
// UpdateFloorSetting updates the parameters of a single floor setting of a project
func (c *restClient) UpdateFloorSetting(ctx context.Context, req *modelarmorpb.UpdateFloorSettingRequest, opts ...gax.CallOption) (*modelarmorpb.FloorSetting, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetFloorSetting()
	jsonReq, err := m.Marshal(body)
	if err != nil {
		return nil, err
	}
	...
	baseUrl.Path += fmt.Sprintf("/v1/%v", req.GetFloorSetting().GetName())
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "UpdateFloorSetting")
		if err != nil {
			return err
		}
...
// SanitizeUserPrompt sanitizes User Prompt.
func (c *restClient) SanitizeUserPrompt(ctx context.Context, req *modelarmorpb.SanitizeUserPromptRequest, opts ...gax.CallOption) (*modelarmorpb.SanitizeUserPromptResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	...
	baseUrl.Path += fmt.Sprintf("/v1/%v:sanitizeUserPrompt", req.GetName())
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "SanitizeUserPrompt")
		if err != nil {
			return err
		}
...
// SanitizeModelResponse sanitizes Model Response.
func (c *restClient) SanitizeModelResponse(ctx context.Context, req *modelarmorpb.SanitizeModelResponseRequest, opts ...gax.CallOption) (*modelarmorpb.SanitizeModelResponseResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v1/%v:sanitizeModelResponse", req.GetName())
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "SanitizeModelResponse")
		if err != nil {
			return err
		}
