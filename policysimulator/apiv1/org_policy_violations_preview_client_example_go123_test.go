...
func ExampleOrgPolicyViolationsPreviewClient_ListOrgPolicyViolations_all() {
	...
	for resp, err := range c.ListOrgPolicyViolations(ctx, req).All() {
		if err != nil {
...
func ExampleOrgPolicyViolationsPreviewClient_ListOrgPolicyViolationsPreviews_all() {
	ctx := context.Background()
	// This snippet has been automatically generated and should be regarded as a code template only.
	// It will require modifications to work:
	// - It may require correct/in-range values for request initialization.
	...
	for resp, err := range c.ListOrgPolicyViolationsPreviews(ctx, req).All() {
		if err != nil {
			// TODO: Handle error and break/return/continue. Iteration will stop after any error.
		}
		// TODO: Use resp.
...
func ExampleOrgPolicyViolationsPreviewClient_ListOperations_all() {
	ctx := context.Background()
	// This snippet has been automatically generated and should be regarded as a code template only.
	// It will require modifications to work:
	// - It may require correct/in-range values for request initialization.
