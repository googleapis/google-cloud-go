...
func (x *AgentCard) Reset() {
	*x = AgentCard{}
	mi := &file_google_cloud_ces_v1_agent_card_proto_msgTypes[0]
...
func (*AgentCard) Descriptor() ([]byte, []int) {
	return file_google_cloud_ces_v1_agent_card_proto_rawDescGZIP(), []int{0}
}
...
func (x *AgentInterface) Reset() {
	*x = AgentInterface{}
	mi := &file_google_cloud_ces_v1_agent_card_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AgentInterface) Descriptor() ([]byte, []int) {
	return file_google_cloud_ces_v1_agent_card_proto_rawDescGZIP(), []int{1}
}
...
func (x *AgentSkill) Reset() {
	*x = AgentSkill{}
	mi := &file_google_cloud_ces_v1_agent_card_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AgentSkill) Descriptor() ([]byte, []int) {
	return file_google_cloud_ces_v1_agent_card_proto_rawDescGZIP(), []int{2}
}
...
func (x *RemoteAgentTool) Reset() {
	*x = RemoteAgentTool{}
	mi := &file_google_cloud_ces_v1_agent_card_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RemoteAgentTool) Descriptor() ([]byte, []int) {
	return file_google_cloud_ces_v1_agent_card_proto_rawDescGZIP(), []int{3}
}
...
var File_google_cloud_ces_v1_agent_card_proto protoreflect.FileDescriptor

const file_google_cloud_ces_v1_agent_card_proto_rawDesc = "" +
	"\n" +
	"$google/cloud/ces/v1/agent_card.proto\x12\x13google.cloud.ces.v1\x1a\x1fgoogle/api/field_behavior.proto\"\x85\x02\n" +
	"\tAgentCard\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x12%\n" +
	"\vdescription\x18\x02 \x01(\tB\x03\xe0A\x02R\vdescription\x12[\n" +
	"\x14supported_interfaces\x18\x03 \x03(\v2#.google.cloud.ces.v1.AgentInterfaceB\x03\xe0A\x02R\x13supportedInterfaces\x12\x1d\n" +
	"\aversion\x18\x05 \x01(\tB\x03\xe0A\x02R\aversion\x12<\n" +
	"\x06skills\x18\x06 \x03(\v2\x1f.google.cloud.ces.v1.AgentSkillB\x03\xe0A\x02R\x06skills\"\x9f\x01\n" +
	...
	"inputModes\x12!\n" +
	"\foutput_modes\x18\a \x03(\tR\voutputModes\"\x95\x01\n" +
	"\x0fRemoteAgentTool\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x12%\n" +
	"\vdescription\x18\x02 \x01(\tB\x03\xe0A\x02R\vdescription\x12B\n" +
	"\n" +
	"agent_card\x18\x03 \x01(\v2\x1e.google.cloud.ces.v1.AgentCardB\x03\xe0A\x02R\tagentCardBV\n" +
	"\x17com.google.cloud.ces.v1B\x0eAgentCardProtoP\x01Z)cloud.google.com/go/ces/apiv1/cespb;cespbb\x06proto3"

var (
	file_google_cloud_ces_v1_agent_card_proto_rawDescOnce sync.Once
	file_google_cloud_ces_v1_agent_card_proto_rawDescData []byte
)

func file_google_cloud_ces_v1_agent_card_proto_rawDescGZIP() []byte {
	file_google_cloud_ces_v1_agent_card_proto_rawDescOnce.Do(func() {
		file_google_cloud_ces_v1_agent_card_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_ces_v1_agent_card_proto_rawDesc), len(file_google_cloud_ces_v1_agent_card_proto_rawDesc)))
	})
	return file_google_cloud_ces_v1_agent_card_proto_rawDescData
}

var file_google_cloud_ces_v1_agent_card_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_cloud_ces_v1_agent_card_proto_goTypes = []any{
	(*AgentCard)(nil),       // 0: google.cloud.ces.v1.AgentCard
	(*AgentInterface)(nil),  // 1: google.cloud.ces.v1.AgentInterface
	(*AgentSkill)(nil),      // 2: google.cloud.ces.v1.AgentSkill
	(*RemoteAgentTool)(nil), // 3: google.cloud.ces.v1.RemoteAgentTool
}
var file_google_cloud_ces_v1_agent_card_proto_depIdxs = []int32{
	1, // 0: google.cloud.ces.v1.AgentCard.supported_interfaces:type_name -> google.cloud.ces.v1.AgentInterface
	2, // 1: google.cloud.ces.v1.AgentCard.skills:type_name -> google.cloud.ces.v1.AgentSkill
	0, // 2: google.cloud.ces.v1.RemoteAgentTool.agent_card:type_name -> google.cloud.ces.v1.AgentCard
...
func init() { file_google_cloud_ces_v1_agent_card_proto_init() }
func file_google_cloud_ces_v1_agent_card_proto_init() {
	if File_google_cloud_ces_v1_agent_card_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_ces_v1_agent_card_proto_rawDesc), len(file_google_cloud_ces_v1_agent_card_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_cloud_ces_v1_agent_card_proto_goTypes,
		DependencyIndexes: file_google_cloud_ces_v1_agent_card_proto_depIdxs,
		MessageInfos:      file_google_cloud_ces_v1_agent_card_proto_msgTypes,
	}.Build()
	File_google_cloud_ces_v1_agent_card_proto = out.File
	file_google_cloud_ces_v1_agent_card_proto_goTypes = nil
	file_google_cloud_ces_v1_agent_card_proto_depIdxs = nil
}
