...
const file_google_cloud_ces_v1_agent_proto_rawDesc = "" +
	"\n" +
	"\x1fgoogle/cloud/ces/v1/agent.proto\x12\x13google.cloud.ces.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a)google/cloud/ces/v1/agent_transfers.proto\x1a google/cloud/ces/v1/common.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfd\x12\n" +
	"\x05Agent\x12G\n" +
	...
	"\x0etransfer_rules\x18\x1e \x03(\v2!.google.cloud.ces.v1.TransferRuleB\x03\xe0A\x01R\rtransferRules\x1a\n" +
	"\n" +
	"\bLlmAgent\x1a\xaa\x05\n" +
	...
	"&respect_response_interruption_settings\x18\x06 \x01(\bB\x03\xe0A\x01R#respectResponseInterruptionSettings\x1aG\n" +
