...
const file_google_cloud_ces_v1_conversation_proto_rawDesc = "" +
	...
	"\bend_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\aendTime\x12A\n" +
	"\x05turns\x18\x06 \x03(\v2&.google.cloud.ces.v1.Conversation.TurnB\x03\xe0A\x02R\x05turns\x12\"\n" +
	"\n" +
	"turn_count\x18\a \x01(\x05B\x03\xe0A\x03R\tturnCount\x12T\n" +
	"\fchannel_type\x18\b \x01(\x0e2-.google.cloud.ces.v1.Conversation.ChannelTypeB\x02\x18\x01R\vchannelType\x12E\n" +
	"\x06source\x18\t \x01(\x0e2(.google.cloud.ces.v1.Conversation.SourceB\x03\xe0A\x03R\x06source\x12Q\n" +
	"\vinput_types\x18\n" +
	" \x03(\x0e2+.google.cloud.ces.v1.Conversation.InputTypeB\x03\xe0A\x03R\n" +
	"inputTypes\x12A\n" +
	...
	"\bmessages\x18\x02 \x03(\v2\x1c.google.cloud.ces.v1.MessageB\x02\x18\x01R\bmessages\x1a\x82\x01\n" +
	"\x04Turn\x12=\n" +
	"\bmessages\x18\x01 \x03(\v2\x1c.google.cloud.ces.v1.MessageB\x03\xe0A\x01R\bmessages\x12;\n" +
	"\troot_span\x18\x02 \x01(\v2\x19.google.cloud.ces.v1.SpanB\x03\xe0A\x01R\brootSpan\"P\n" +
	...
	"\x1fces.googleapis.com/Conversation\x12Oprojects/{project}/locations/{location}/apps/{app}/conversations/{conversation}*\rconversations2\fconversationBY\n" +
	"\x17com.google.cloud.ces.v1B\x11ConversationProtoP\x01Z)cloud.google.com/go/ces/apiv1/cespb;cespbb\x06proto3"

var (
	file_google_cloud_ces_v1_conversation_proto_rawDescOnce sync.Once
	file_google_cloud_ces_v1_conversation_proto_rawDescData []byte
)
...
func file_google_cloud_ces_v1_conversation_proto_rawDescGZIP() []byte {
	file_google_cloud_ces_v1_conversation_proto_rawDescOnce.Do(func() {
		file_google_cloud_ces_v1_conversation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_ces_v1_conversation_proto_rawDesc), len(file_google_cloud_ces_v1_conversation_proto_rawDesc)))
	})
...
func file_google_cloud_ces_v1_conversation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_ces_v1_conversation_proto_rawDesc), len(file_google_cloud_ces_v1_conversation_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
