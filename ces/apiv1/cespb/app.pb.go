...
const file_google_cloud_ces_v1_app_proto_rawDesc = "" +
	"\n" +
	"\x1dgoogle/cloud/ces/v1/app.proto\x12\x13google.cloud.ces.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a)google/cloud/ces/v1/bigquery_export.proto\x1a google/cloud/ces/v1/common.proto\x1a google/cloud/ces/v1/schema.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9b\x12\n" +
	"\x03App\x12\x17\n" +
	...
	"\x1bclient_certificate_settings\x18\x19 \x01(\v2..google.cloud.ces.v1.ClientCertificateSettingsB\x03\xe0A\x01R\x19clientCertificateSettings\x12\x1b\n" +
	"\x06locked\x18\x1d \x01(\bB\x03\xe0A\x01R\x06locked\x1a\x8f\x01\n" +
	...
	"\x15llm_metrics_opted_out\x18\x01 \x01(\bB\x03\xe0A\x01R\x12llmMetricsOptedOut\"\x81\x06\n" +
	...
	"\x16audio_recording_config\x18\x02 \x01(\v2).google.cloud.ces.v1.AudioRecordingConfigB\x03\xe0A\x01R\x14audioRecordingConfig\x12j\n" +
	"\x18bigquery_export_settings\x18\x03 \x01(\v2+.google.cloud.ces.v1.BigQueryExportSettingsB\x03\xe0A\x01R\x16bigqueryExportSettings\x12d\n" +
	...
	"\x18metric_analysis_settings\x18\a \x01(\v2+.google.cloud.ces.v1.MetricAnalysisSettingsB\x03\xe0A\x01R\x16metricAnalysisSettings\"\x8a\x02\n" +
	"\x15ErrorHandlingSettings\x12}\n" +
	"\x17error_handling_strategy\x18\x01 \x01(\x0e2@.google.cloud.ces.v1.ErrorHandlingSettings.ErrorHandlingStrategyB\x03\xe0A\x01R\x15errorHandlingStrategy\"r\n" +
