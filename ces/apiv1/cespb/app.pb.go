...
func (DataStoreSettings_Engine_Type) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_ces_v1_app_proto_rawDescGZIP(), []int{17, 0, 0}
}
...
func (*DataStoreSettings) Descriptor() ([]byte, []int) {
	return file_google_cloud_ces_v1_app_proto_rawDescGZIP(), []int{17}
}
...
func (x *App_VariableDeclaration) Reset() {
	*x = App_VariableDeclaration{}
	mi := &file_google_cloud_ces_v1_app_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *EvaluationMetricsThresholds_ToolMatchingSettings) Reset() {
	*x = EvaluationMetricsThresholds_ToolMatchingSettings{}
	mi := &file_google_cloud_ces_v1_app_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_TurnLevelMetricsThresholds) Reset() {
	*x = EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_TurnLevelMetricsThresholds{}
	mi := &file_google_cloud_ces_v1_app_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ExpectationLevelMetricsThresholds) Reset() {
	*x = EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ExpectationLevelMetricsThresholds{}
	mi := &file_google_cloud_ces_v1_app_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *DataStoreSettings_Engine) Reset() {
	*x = DataStoreSettings_Engine{}
	mi := &file_google_cloud_ces_v1_app_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DataStoreSettings_Engine) Descriptor() ([]byte, []int) {
	return file_google_cloud_ces_v1_app_proto_rawDescGZIP(), []int{17, 0}
}
...
const file_google_cloud_ces_v1_app_proto_rawDesc = "" +
	"\n" +
	"\x1dgoogle/cloud/ces/v1/app.proto\x12\x13google.cloud.ces.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a)google/cloud/ces/v1/bigquery_export.proto\x1a google/cloud/ces/v1/common.proto\x1a google/cloud/ces/v1/schema.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9e\x13\n" +
	"\x03App\x12\x17\n" +
	...
	"\x18ces.googleapis.com/AgentR\trootAgent\x12W\n" +
	"\x11language_settings\x18\x12 \x01(\v2%.google.cloud.ces.v1.LanguageSettingsB\x03\xe0A\x01R\x10languageSettings\x12X\n" +
	"\x12time_zone_settings\x18\x1b \x01(\v2%.google.cloud.ces.v1.TimeZoneSettingsB\x03\xe0A\x01R\x10timeZoneSettings\x12g\n" +
	"\x17audio_processing_config\x18\a \x01(\v2*.google.cloud.ces.v1.AudioProcessingConfigB\x03\xe0A\x01R\x15audioProcessingConfig\x12T\n" +
	"\x10logging_settings\x18\b \x01(\v2$.google.cloud.ces.v1.LoggingSettingsB\x03\xe0A\x01R\x0floggingSettings\x12g\n" +
	"\x17error_handling_settings\x18\" \x01(\v2*.google.cloud.ces.v1.ErrorHandlingSettingsB\x03\xe0A\x01R\x15errorHandlingSettings\x12N\n" +
	"\x0emodel_settings\x18\r \x01(\v2\".google.cloud.ces.v1.ModelSettingsB\x03\xe0A\x01R\rmodelSettings\x12_\n" +
	"\x13tool_execution_mode\x18  \x01(\x0e2*.google.cloud.ces.v1.App.ToolExecutionModeB\x03\xe0A\x01R\x11toolExecutionMode\x12y\n" +
	"\x1devaluation_metrics_thresholds\x18\x18 \x01(\v20.google.cloud.ces.v1.EvaluationMetricsThresholdsB\x03\xe0A\x01R\x1bevaluationMetricsThresholds\x12f\n" +
	"\x15variable_declarations\x18\x0e \x03(\v2,.google.cloud.ces.v1.App.VariableDeclarationB\x03\xe0A\x01R\x14variableDeclarations\x12{\n" +
	" predefined_variable_declarations\x18\x1c \x03(\v2,.google.cloud.ces.v1.App.VariableDeclarationB\x03\xe0A\x03R\x1epredefinedVariableDeclarations\x122\n" +
	...
	"guardrails\x12[\n" +
	"\x13data_store_settings\x18\x0f \x01(\v2&.google.cloud.ces.v1.DataStoreSettingsB\x03\xe0A\x01R\x11dataStoreSettings\x12`\n" +
	"\x17default_channel_profile\x18\x16 \x01(\v2#.google.cloud.ces.v1.ChannelProfileB\x03\xe0A\x01R\x15defaultChannelProfile\x12G\n" +
	"\bmetadata\x18\v \x03(\v2&.google.cloud.ces.v1.App.MetadataEntryB\x03\xe0A\x01R\bmetadata\x12@\n" +
	...
	"\x10deployment_count\x18\x17 \x01(\x05B\x03\xe0A\x03R\x0fdeploymentCount\x12s\n" +
	"\x1bclient_certificate_settings\x18\x19 \x01(\v2..google.cloud.ces.v1.ClientCertificateSettingsB\x03\xe0A\x01R\x19clientCertificateSettings\x12O\n" +
	"\x0fvpc_sc_settings\x18\x1a \x01(\v2\".google.cloud.ces.v1.VpcScSettingsB\x03\xe0A\x01R\rvpcScSettings\x12\x1b\n" +
	"\x06locked\x18\x1d \x01(\bB\x03\xe0A\x01R\x06locked\x120\n" +
	"\x11validation_errors\x18' \x03(\tB\x03\xe0A\x03R\x10validationErrors\x1a\x8f\x01\n" +
	"\x13VariableDeclaration\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x12%\n" +
	"\vdescription\x18\x02 \x01(\tB\x03\xe0A\x02R\vdescription\x128\n" +
	"\x06schema\x18\x03 \x01(\v2\x1b.google.cloud.ces.v1.SchemaB\x03\xe0A\x02R\x06schema\x1a;\n" +
	...
	"\x0ffallback_action\x18\x04 \x01(\tB\x05\xe0A\x01\x18\x01R\x0efallbackAction\"\x9b\x04\n" +
	"\x15AudioProcessingConfig\x12\x88\x01\n" +
	"\x19synthesize_speech_configs\x18\x01 \x03(\v2G.google.cloud.ces.v1.AudioProcessingConfig.SynthesizeSpeechConfigsEntryB\x03\xe0A\x01R\x17synthesizeSpeechConfigs\x12O\n" +
	"\x0fbarge_in_config\x18\x03 \x01(\v2\".google.cloud.ces.v1.BargeInConfigB\x03\xe0A\x01R\rbargeInConfig\x12M\n" +
	"\x12inactivity_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x01R\x11inactivityTimeout\x12^\n" +
	"\x14ambient_sound_config\x18\x05 \x01(\v2'.google.cloud.ces.v1.AmbientSoundConfigB\x03\xe0A\x01R\x12ambientSoundConfig\x1aw\n" +
	"\x1cSynthesizeSpeechConfigsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12A\n" +
	"\x05value\x18\x02 \x01(\v2+.google.cloud.ces.v1.SynthesizeSpeechConfigR\x05value:\x028\x01\"\x97\x03\n" +
	"\x12AmbientSoundConfig\x12{\n" +
	"\x16prebuilt_ambient_noise\x18\x01 \x01(\x0e2<.google.cloud.ces.v1.AmbientSoundConfig.PrebuiltAmbientNoiseB\x05\xe0A\x01\x18\x01H\x00R\x14prebuiltAmbientNoise\x12\x1e\n" +
	...
	"\x15llm_metrics_opted_out\x18\x01 \x01(\bB\x03\xe0A\x01R\x12llmMetricsOptedOut\"\xfd\a\n" +
	"\x0fLoggingSettings\x12T\n" +
	"\x10redaction_config\x18\x01 \x01(\v2$.google.cloud.ces.v1.RedactionConfigB\x03\xe0A\x01R\x0fredactionConfig\x12d\n" +
	"\x16audio_recording_config\x18\x02 \x01(\v2).google.cloud.ces.v1.AudioRecordingConfigB\x03\xe0A\x01R\x14audioRecordingConfig\x12y\n" +
	"!unredacted_audio_recording_config\x18\b \x01(\v2).google.cloud.ces.v1.AudioRecordingConfigB\x03\xe0A\x01R\x1eunredactedAudioRecordingConfig\x12j\n" +
	"\x18bigquery_export_settings\x18\x03 \x01(\v2+.google.cloud.ces.v1.BigQueryExportSettingsB\x03\xe0A\x01R\x16bigqueryExportSettings\x12\x7f\n" +
	"#unredacted_bigquery_export_settings\x18\t \x01(\v2+.google.cloud.ces.v1.BigQueryExportSettingsB\x03\xe0A\x01R unredactedBigqueryExportSettings\x12d\n" +
	"\x16cloud_logging_settings\x18\x04 \x01(\v2).google.cloud.ces.v1.CloudLoggingSettingsB\x03\xe0A\x01R\x14cloudLoggingSettings\x12y\n" +
	"\x1dconversation_logging_settings\x18\x05 \x01(\v20.google.cloud.ces.v1.ConversationLoggingSettingsB\x03\xe0A\x01R\x1bconversationLoggingSettings\x12y\n" +
	"!evaluation_audio_recording_config\x18\x06 \x01(\v2).google.cloud.ces.v1.AudioRecordingConfigB\x03\xe0A\x01R\x1eevaluationAudioRecordingConfig\x12j\n" +
	"\x18metric_analysis_settings\x18\a \x01(\v2+.google.cloud.ces.v1.MetricAnalysisSettingsB\x03\xe0A\x01R\x16metricAnalysisSettings\"\x99\a\n" +
	"\x15ErrorHandlingSettings\x12}\n" +
	"\x17error_handling_strategy\x18\x01 \x01(\x0e2@.google.cloud.ces.v1.ErrorHandlingSettings.ErrorHandlingStrategyB\x03\xe0A\x01R\x15errorHandlingStrategy\x12\x80\x01\n" +
	"\x18fallback_response_config\x18\x02 \x01(\v2A.google.cloud.ces.v1.ErrorHandlingSettings.FallbackResponseConfigB\x03\xe0A\x01R\x16fallbackResponseConfig\x12n\n" +
	"\x12end_session_config\x18\x03 \x01(\v2;.google.cloud.ces.v1.ErrorHandlingSettings.EndSessionConfigB\x03\xe0A\x01R\x10endSessionConfig\x1a\xbb\x02\n" +
	"\x16FallbackResponseConfig\x12\x9c\x01\n" +
	"\x18custom_fallback_messages\x18\x01 \x03(\v2].google.cloud.ces.v1.ErrorHandlingSettings.FallbackResponseConfig.CustomFallbackMessagesEntryB\x03\xe0A\x01R\x16customFallbackMessages\x127\n" +
	...
	"\vEND_SESSION\x10\x03\"\x91\x13\n" +
	"\x1bEvaluationMetricsThresholds\x12\xa8\x01\n" +
	"$golden_evaluation_metrics_thresholds\x18\x01 \x01(\v2R.google.cloud.ces.v1.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholdsB\x03\xe0A\x01R!goldenEvaluationMetricsThresholds\x12\x97\x01\n" +
	"\x1dhallucination_metric_behavior\x18\x03 \x01(\x0e2L.google.cloud.ces.v1.EvaluationMetricsThresholds.HallucinationMetricBehaviorB\x05\xe0A\x01\x18\x01R\x1bhallucinationMetricBehavior\x12\xa2\x01\n" +
	"$golden_hallucination_metric_behavior\x18\x05 \x01(\x0e2L.google.cloud.ces.v1.EvaluationMetricsThresholds.HallucinationMetricBehaviorB\x03\xe0A\x01R!goldenHallucinationMetricBehavior\x12\xa6\x01\n" +
	"&scenario_hallucination_metric_behavior\x18\x04 \x01(\x0e2L.google.cloud.ces.v1.EvaluationMetricsThresholds.HallucinationMetricBehaviorB\x03\xe0A\x01R#scenarioHallucinationMetricBehavior\x1a\xe8\n" +
	"\n" +
	"!GoldenEvaluationMetricsThresholds\x12\xb5\x01\n" +
	"\x1dturn_level_metrics_thresholds\x18\x01 \x01(\v2m.google.cloud.ces.v1.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds.TurnLevelMetricsThresholdsB\x03\xe0A\x01R\x1aturnLevelMetricsThresholds\x12\xca\x01\n" +
	"$expectation_level_metrics_thresholds\x18\x02 \x01(\v2t.google.cloud.ces.v1.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds.ExpectationLevelMetricsThresholdsB\x03\xe0A\x01R!expectationLevelMetricsThresholds\x12\x80\x01\n" +
	"\x16tool_matching_settings\x18\x03 \x01(\v2E.google.cloud.ces.v1.EvaluationMetricsThresholds.ToolMatchingSettingsB\x03\xe0A\x01R\x14toolMatchingSettings\x1a\xf0\x04\n" +
	...
	"-overall_tool_invocation_correctness_threshold\x18\x02 \x01(\x02B\x03\xe0A\x01H\x01R)overallToolInvocationCorrectnessThreshold\x88\x01\x01\x12\xcd\x01\n" +
	"\x1bsemantic_similarity_channel\x18\x03 \x01(\x0e2\x87\x01.google.cloud.ces.v1.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds.TurnLevelMetricsThresholds.SemanticSimilarityChannelB\x03\xe0A\x01R\x19semanticSimilarityChannel\"]\n" +
	...
	"0_tool_invocation_parameter_correctness_threshold\x1a\x8a\x02\n" +
	"\x14ToolMatchingSettings\x12\x99\x01\n" +
	"\x18extra_tool_call_behavior\x18\x01 \x01(\x0e2[.google.cloud.ces.v1.EvaluationMetricsThresholds.ToolMatchingSettings.ExtraToolCallBehaviorB\x03\xe0A\x01R\x15extraToolCallBehavior\"V\n" +
	...
	"%dlp.googleapis.com/DeidentifyTemplateR\x12deidentifyTemplate\"\xc8\x02\n" +
	"\x11DataStoreSettings\x12L\n" +
	"\aengines\x18\x03 \x03(\v2-.google.cloud.ces.v1.DataStoreSettings.EngineB\x03\xe0A\x03R\aengines\x1a\xe4\x01\n" +
	"\x06Engine\x12A\n" +
	"\x04name\x18\x01 \x01(\tB-\xe0A\x03\xfaA'\n" +
	"%discoveryengine.googleapis.com/EngineR\x04name\x12K\n" +
	"\x04type\x18\x02 \x01(\x0e22.google.cloud.ces.v1.DataStoreSettings.Engine.TypeB\x03\xe0A\x03R\x04type\"J\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\x16\n" +
	"\x12ENGINE_TYPE_SEARCH\x10\x01\x12\x14\n" +
	"\x10ENGINE_TYPE_CHAT\x10\x02B\xf4\x04\xeaA\xc8\x01\n" +
	...
	"\x17com.google.cloud.ces.v1B\bAppProtoP\x01Z)cloud.google.com/go/ces/apiv1/cespb;cespbb\x06proto3"

var (
	file_google_cloud_ces_v1_app_proto_rawDescOnce sync.Once
	file_google_cloud_ces_v1_app_proto_rawDescData []byte
)

func file_google_cloud_ces_v1_app_proto_rawDescGZIP() []byte {
	file_google_cloud_ces_v1_app_proto_rawDescOnce.Do(func() {
		file_google_cloud_ces_v1_app_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_ces_v1_app_proto_rawDesc), len(file_google_cloud_ces_v1_app_proto_rawDesc)))
	})
...
var file_google_cloud_ces_v1_app_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_google_cloud_ces_v1_app_proto_goTypes = []any{
	...
	(*VpcScSettings)(nil),                                // 19: google.cloud.ces.v1.VpcScSettings
	(*ConversationLoggingSettings)(nil),                  // 20: google.cloud.ces.v1.ConversationLoggingSettings
	(*CloudLoggingSettings)(nil),                         // 21: google.cloud.ces.v1.CloudLoggingSettings
	(*AudioRecordingConfig)(nil),                         // 22: google.cloud.ces.v1.AudioRecordingConfig
	(*RedactionConfig)(nil),                              // 23: google.cloud.ces.v1.RedactionConfig
	(*DataStoreSettings)(nil),                            // 24: google.cloud.ces.v1.DataStoreSettings
	(*App_VariableDeclaration)(nil),                      // 25: google.cloud.ces.v1.App.VariableDeclaration
	nil,                                                  // 26: google.cloud.ces.v1.App.MetadataEntry
	nil,                                                  // 27: google.cloud.ces.v1.AudioProcessingConfig.SynthesizeSpeechConfigsEntry
	(*ErrorHandlingSettings_FallbackResponseConfig)(nil), // 28: google.cloud.ces.v1.ErrorHandlingSettings.FallbackResponseConfig
	(*ErrorHandlingSettings_EndSessionConfig)(nil),       // 29: google.cloud.ces.v1.ErrorHandlingSettings.EndSessionConfig
	nil, // 30: google.cloud.ces.v1.ErrorHandlingSettings.FallbackResponseConfig.CustomFallbackMessagesEntry
	(*EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds)(nil),                                   // 31: google.cloud.ces.v1.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds
	(*EvaluationMetricsThresholds_ToolMatchingSettings)(nil),                                                // 32: google.cloud.ces.v1.EvaluationMetricsThresholds.ToolMatchingSettings
	(*EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_TurnLevelMetricsThresholds)(nil),        // 33: google.cloud.ces.v1.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds.TurnLevelMetricsThresholds
	(*EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ExpectationLevelMetricsThresholds)(nil), // 34: google.cloud.ces.v1.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds.ExpectationLevelMetricsThresholds
	(*DataStoreSettings_Engine)(nil),                                                                        // 35: google.cloud.ces.v1.DataStoreSettings.Engine
	(*ModelSettings)(nil),                                                                                   // 36: google.cloud.ces.v1.ModelSettings
	(*ChannelProfile)(nil),                                                                                  // 37: google.cloud.ces.v1.ChannelProfile
	(*timestamppb.Timestamp)(nil),                                                                           // 38: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),                                                                             // 39: google.protobuf.Duration
	(*BigQueryExportSettings)(nil),                                                                          // 40: google.cloud.ces.v1.BigQueryExportSettings
	(*Schema)(nil),                                                                                          // 41: google.cloud.ces.v1.Schema
}
var file_google_cloud_ces_v1_app_proto_depIdxs = []int32{
	...
	36, // 5: google.cloud.ces.v1.App.model_settings:type_name -> google.cloud.ces.v1.ModelSettings
	...
	25, // 8: google.cloud.ces.v1.App.variable_declarations:type_name -> google.cloud.ces.v1.App.VariableDeclaration
	25, // 9: google.cloud.ces.v1.App.predefined_variable_declarations:type_name -> google.cloud.ces.v1.App.VariableDeclaration
	24, // 10: google.cloud.ces.v1.App.data_store_settings:type_name -> google.cloud.ces.v1.DataStoreSettings
	37, // 11: google.cloud.ces.v1.App.default_channel_profile:type_name -> google.cloud.ces.v1.ChannelProfile
	26, // 12: google.cloud.ces.v1.App.metadata:type_name -> google.cloud.ces.v1.App.MetadataEntry
	38, // 13: google.cloud.ces.v1.App.create_time:type_name -> google.protobuf.Timestamp
	38, // 14: google.cloud.ces.v1.App.update_time:type_name -> google.protobuf.Timestamp
	18, // 15: google.cloud.ces.v1.App.client_certificate_settings:type_name -> google.cloud.ces.v1.ClientCertificateSettings
	19, // 16: google.cloud.ces.v1.App.vpc_sc_settings:type_name -> google.cloud.ces.v1.VpcScSettings
	27, // 17: google.cloud.ces.v1.AudioProcessingConfig.synthesize_speech_configs:type_name -> google.cloud.ces.v1.AudioProcessingConfig.SynthesizeSpeechConfigsEntry
	12, // 18: google.cloud.ces.v1.AudioProcessingConfig.barge_in_config:type_name -> google.cloud.ces.v1.BargeInConfig
	39, // 19: google.cloud.ces.v1.AudioProcessingConfig.inactivity_timeout:type_name -> google.protobuf.Duration
	11, // 20: google.cloud.ces.v1.AudioProcessingConfig.ambient_sound_config:type_name -> google.cloud.ces.v1.AmbientSoundConfig
	1,  // 21: google.cloud.ces.v1.AmbientSoundConfig.prebuilt_ambient_noise:type_name -> google.cloud.ces.v1.AmbientSoundConfig.PrebuiltAmbientNoise
	23, // 22: google.cloud.ces.v1.LoggingSettings.redaction_config:type_name -> google.cloud.ces.v1.RedactionConfig
	22, // 23: google.cloud.ces.v1.LoggingSettings.audio_recording_config:type_name -> google.cloud.ces.v1.AudioRecordingConfig
	22, // 24: google.cloud.ces.v1.LoggingSettings.unredacted_audio_recording_config:type_name -> google.cloud.ces.v1.AudioRecordingConfig
	40, // 25: google.cloud.ces.v1.LoggingSettings.bigquery_export_settings:type_name -> google.cloud.ces.v1.BigQueryExportSettings
	40, // 26: google.cloud.ces.v1.LoggingSettings.unredacted_bigquery_export_settings:type_name -> google.cloud.ces.v1.BigQueryExportSettings
	21, // 27: google.cloud.ces.v1.LoggingSettings.cloud_logging_settings:type_name -> google.cloud.ces.v1.CloudLoggingSettings
	20, // 28: google.cloud.ces.v1.LoggingSettings.conversation_logging_settings:type_name -> google.cloud.ces.v1.ConversationLoggingSettings
	22, // 29: google.cloud.ces.v1.LoggingSettings.evaluation_audio_recording_config:type_name -> google.cloud.ces.v1.AudioRecordingConfig
	14, // 30: google.cloud.ces.v1.LoggingSettings.metric_analysis_settings:type_name -> google.cloud.ces.v1.MetricAnalysisSettings
	2,  // 31: google.cloud.ces.v1.ErrorHandlingSettings.error_handling_strategy:type_name -> google.cloud.ces.v1.ErrorHandlingSettings.ErrorHandlingStrategy
	28, // 32: google.cloud.ces.v1.ErrorHandlingSettings.fallback_response_config:type_name -> google.cloud.ces.v1.ErrorHandlingSettings.FallbackResponseConfig
	29, // 33: google.cloud.ces.v1.ErrorHandlingSettings.end_session_config:type_name -> google.cloud.ces.v1.ErrorHandlingSettings.EndSessionConfig
	31, // 34: google.cloud.ces.v1.EvaluationMetricsThresholds.golden_evaluation_metrics_thresholds:type_name -> google.cloud.ces.v1.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds
	3,  // 35: google.cloud.ces.v1.EvaluationMetricsThresholds.hallucination_metric_behavior:type_name -> google.cloud.ces.v1.EvaluationMetricsThresholds.HallucinationMetricBehavior
	3,  // 36: google.cloud.ces.v1.EvaluationMetricsThresholds.golden_hallucination_metric_behavior:type_name -> google.cloud.ces.v1.EvaluationMetricsThresholds.HallucinationMetricBehavior
	3,  // 37: google.cloud.ces.v1.EvaluationMetricsThresholds.scenario_hallucination_metric_behavior:type_name -> google.cloud.ces.v1.EvaluationMetricsThresholds.HallucinationMetricBehavior
	39, // 38: google.cloud.ces.v1.ConversationLoggingSettings.retention_window:type_name -> google.protobuf.Duration
	35, // 39: google.cloud.ces.v1.DataStoreSettings.engines:type_name -> google.cloud.ces.v1.DataStoreSettings.Engine
	41, // 40: google.cloud.ces.v1.App.VariableDeclaration.schema:type_name -> google.cloud.ces.v1.Schema
	13, // 41: google.cloud.ces.v1.AudioProcessingConfig.SynthesizeSpeechConfigsEntry.value:type_name -> google.cloud.ces.v1.SynthesizeSpeechConfig
	30, // 42: google.cloud.ces.v1.ErrorHandlingSettings.FallbackResponseConfig.custom_fallback_messages:type_name -> google.cloud.ces.v1.ErrorHandlingSettings.FallbackResponseConfig.CustomFallbackMessagesEntry
	33, // 43: google.cloud.ces.v1.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds.turn_level_metrics_thresholds:type_name -> google.cloud.ces.v1.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds.TurnLevelMetricsThresholds
	34, // 44: google.cloud.ces.v1.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds.expectation_level_metrics_thresholds:type_name -> google.cloud.ces.v1.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds.ExpectationLevelMetricsThresholds
	32, // 45: google.cloud.ces.v1.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds.tool_matching_settings:type_name -> google.cloud.ces.v1.EvaluationMetricsThresholds.ToolMatchingSettings
	5,  // 46: google.cloud.ces.v1.EvaluationMetricsThresholds.ToolMatchingSettings.extra_tool_call_behavior:type_name -> google.cloud.ces.v1.EvaluationMetricsThresholds.ToolMatchingSettings.ExtraToolCallBehavior
	4,  // 47: google.cloud.ces.v1.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds.TurnLevelMetricsThresholds.semantic_similarity_channel:type_name -> google.cloud.ces.v1.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds.TurnLevelMetricsThresholds.SemanticSimilarityChannel
	6,  // 48: google.cloud.ces.v1.DataStoreSettings.Engine.type:type_name -> google.cloud.ces.v1.DataStoreSettings.Engine.Type
...
func file_google_cloud_ces_v1_app_proto_init() {
	...
	file_google_cloud_ces_v1_app_proto_msgTypes[26].OneofWrappers = []any{}
	file_google_cloud_ces_v1_app_proto_msgTypes[27].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_ces_v1_app_proto_rawDesc), len(file_google_cloud_ces_v1_app_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   29,
			NumExtensions: 0,
			NumServices:   0,
