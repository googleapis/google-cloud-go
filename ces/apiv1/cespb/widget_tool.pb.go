...
const file_google_cloud_ces_v1_widget_tool_proto_rawDesc = "" +
	...
	"WidgetTool\x12B\n" +
	"\n" +
	"parameters\x18\x04 \x01(\v2\x1b.google.cloud.ces.v1.SchemaB\x03\xe0A\x01H\x00R\n" +
	"parameters\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x12%\n" +
	"\vdescription\x18\x02 \x01(\tB\x03\xe0A\x01R\vdescription\x12P\n" +
	...
	"\x0fpython_function\x18\x05 \x01(\v2#.google.cloud.ces.v1.PythonFunctionB\x03\xe0A\x01R\x0epythonFunction\x12I\n" +
	"\x04mode\x18\x04 \x01(\x0e20.google.cloud.ces.v1.WidgetTool.DataMapping.ModeB\x03\xe0A\x01R\x04mode\x12'\n" +
	...
	"\x05inputBW\n" +
	"\x17com.google.cloud.ces.v1B\x0fWidgetToolProtoP\x01Z)cloud.google.com/go/ces/apiv1/cespb;cespbb\x06proto3"

var (
	file_google_cloud_ces_v1_widget_tool_proto_rawDescOnce sync.Once
	file_google_cloud_ces_v1_widget_tool_proto_rawDescData []byte
)
...
func file_google_cloud_ces_v1_widget_tool_proto_rawDescGZIP() []byte {
	file_google_cloud_ces_v1_widget_tool_proto_rawDescOnce.Do(func() {
		file_google_cloud_ces_v1_widget_tool_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_ces_v1_widget_tool_proto_rawDesc), len(file_google_cloud_ces_v1_widget_tool_proto_rawDesc)))
	})
