...
func (*ChannelProfile_WhatsAppConfig) Descriptor() ([]byte, []int) {
	return file_google_cloud_ces_v1_common_proto_rawDescGZIP(), []int{5, 2}
}
...
func (x *ChannelProfile_InstagramConfig) Reset() {
	*x = ChannelProfile_InstagramConfig{}
	mi := &file_google_cloud_ces_v1_common_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChannelProfile_InstagramConfig) Descriptor() ([]byte, []int) {
	return file_google_cloud_ces_v1_common_proto_rawDescGZIP(), []int{5, 3}
}
...
func (x *ChannelProfile_WebWidgetConfig_SecuritySettings) Reset() {
	*x = ChannelProfile_WebWidgetConfig_SecuritySettings{}
	mi := &file_google_cloud_ces_v1_common_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_google_cloud_ces_v1_common_proto_rawDesc = "" +
	...
	"'servicedirectory.googleapis.com/ServiceR\aservice\"\x89\x12\n" +
	...
	"\x17noise_suppression_level\x18\b \x01(\tB\x03\xe0A\x01R\x15noiseSuppressionLevel\x12`\n" +
	"\x0fwhatsapp_config\x18\t \x01(\v22.google.cloud.ces.v1.ChannelProfile.WhatsAppConfigB\x03\xe0A\x01R\x0ewhatsappConfig\x12c\n" +
	"\x10instagram_config\x18\n" +
	" \x01(\v23.google.cloud.ces.v1.ChannelProfile.InstagramConfigB\x03\xe0A\x01R\x0finstagramConfig\x1a\x9e\x01\n" +
...
var file_google_cloud_ces_v1_common_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_google_cloud_ces_v1_common_proto_goTypes = []any{
	...
	(*ChannelProfile_WhatsAppConfig)(nil),                   // 19: google.cloud.ces.v1.ChannelProfile.WhatsAppConfig
	(*ChannelProfile_InstagramConfig)(nil),                  // 20: google.cloud.ces.v1.ChannelProfile.InstagramConfig
	(*ChannelProfile_WebWidgetConfig_SecuritySettings)(nil), // 21: google.cloud.ces.v1.ChannelProfile.WebWidgetConfig.SecuritySettings
...
var file_google_cloud_ces_v1_common_proto_depIdxs = []int32{
	...
	19, // 7: google.cloud.ces.v1.ChannelProfile.whatsapp_config:type_name -> google.cloud.ces.v1.ChannelProfile.WhatsAppConfig
	20, // 8: google.cloud.ces.v1.ChannelProfile.instagram_config:type_name -> google.cloud.ces.v1.ChannelProfile.InstagramConfig
	22, // 9: google.cloud.ces.v1.Span.start_time:type_name -> google.protobuf.Timestamp
	22, // 10: google.cloud.ces.v1.Span.end_time:type_name -> google.protobuf.Timestamp
	23, // 11: google.cloud.ces.v1.Span.duration:type_name -> google.protobuf.Duration
	24, // 12: google.cloud.ces.v1.Span.attributes:type_name -> google.protobuf.Struct
	11, // 13: google.cloud.ces.v1.Span.child_spans:type_name -> google.cloud.ces.v1.Span
	12, // 14: google.cloud.ces.v1.TriggerAction.RespondImmediately.responses:type_name -> google.cloud.ces.v1.TriggerAction.Response
	2,  // 15: google.cloud.ces.v1.ChannelProfile.PersonaProperty.persona:type_name -> google.cloud.ces.v1.ChannelProfile.PersonaProperty.Persona
	3,  // 16: google.cloud.ces.v1.ChannelProfile.WebWidgetConfig.modality:type_name -> google.cloud.ces.v1.ChannelProfile.WebWidgetConfig.Modality
	4,  // 17: google.cloud.ces.v1.ChannelProfile.WebWidgetConfig.theme:type_name -> google.cloud.ces.v1.ChannelProfile.WebWidgetConfig.Theme
	21, // 18: google.cloud.ces.v1.ChannelProfile.WebWidgetConfig.security_settings:type_name -> google.cloud.ces.v1.ChannelProfile.WebWidgetConfig.SecuritySettings
