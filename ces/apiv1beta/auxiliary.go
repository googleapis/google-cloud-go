...
func (op *DeleteEvaluationRunOperation) Metadata() (*cespb.DeleteEvaluationRunOperationMetadata, error) {
	var meta cespb.DeleteEvaluationRunOperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
		return nil, err
...
// ExportEvaluationResultsOperation manages a long-running operation from ExportEvaluationResults.
type ExportEvaluationResultsOperation struct {
	lro      *longrunning.Operation
	pollPath string
}
...
//
// See documentation of Poll for error-handling information.
func (op *ExportEvaluationResultsOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*cespb.ExportEvaluationResultsResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp cespb.ExportEvaluationResultsResponse
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
	return &resp, nil
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *ExportEvaluationResultsOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*cespb.ExportEvaluationResultsResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp cespb.ExportEvaluationResultsResponse
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *ExportEvaluationResultsOperation) Metadata() (*cespb.ExportEvaluationResultsOperationMetadata, error) {
	var meta cespb.ExportEvaluationResultsOperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
		return nil, err
...
// Done reports whether the long-running operation has completed.
func (op *ExportEvaluationResultsOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *ExportEvaluationResultsOperation) Name() string {
	return op.lro.Name()
}

// ExportEvaluationRunsOperation manages a long-running operation from ExportEvaluationRuns.
type ExportEvaluationRunsOperation struct {
	lro      *longrunning.Operation
	pollPath string
}
...
//
// See documentation of Poll for error-handling information.
func (op *ExportEvaluationRunsOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*cespb.ExportEvaluationRunsResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp cespb.ExportEvaluationRunsResponse
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
	return &resp, nil
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *ExportEvaluationRunsOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*cespb.ExportEvaluationRunsResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp cespb.ExportEvaluationRunsResponse
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *ExportEvaluationRunsOperation) Metadata() (*cespb.ExportEvaluationRunsOperationMetadata, error) {
	var meta cespb.ExportEvaluationRunsOperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
		return nil, err
...
// Done reports whether the long-running operation has completed.
func (op *ExportEvaluationRunsOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *ExportEvaluationRunsOperation) Name() string {
	return op.lro.Name()
}
...
//
// See documentation of Poll for error-handling information.
func (op *ExportEvaluationsOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*cespb.ExportEvaluationsResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp cespb.ExportEvaluationsResponse
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
	return &resp, nil
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *ExportEvaluationsOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*cespb.ExportEvaluationsResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp cespb.ExportEvaluationsResponse
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *ExportEvaluationsOperation) Metadata() (*cespb.OperationMetadata, error) {
	var meta cespb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *ExportEvaluationsOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *ExportEvaluationsOperation) Name() string {
	return op.lro.Name()
}
...
//
// See documentation of Poll for error-handling information.
func (op *GenerateAppResourceOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*cespb.GenerateAppResourceResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp cespb.GenerateAppResourceResponse
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
	return &resp, nil
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *GenerateAppResourceOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*cespb.GenerateAppResourceResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp cespb.GenerateAppResourceResponse
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *GenerateAppResourceOperation) Metadata() (*cespb.GenerateAppResourceOperationMetadata, error) {
	var meta cespb.GenerateAppResourceOperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
		return nil, err
...
// Done reports whether the long-running operation has completed.
func (op *GenerateAppResourceOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *GenerateAppResourceOperation) Name() string {
	return op.lro.Name()
}
...
func (op *GenerateEvaluationOperation) Metadata() (*cespb.GenerateEvaluationOperationMetadata, error) {
	var meta cespb.GenerateEvaluationOperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
		return nil, err
...
func (op *ImportEvaluationsOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*cespb.ImportEvaluationsResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp cespb.ImportEvaluationsResponse
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
	return &resp, nil
...
func (op *ImportEvaluationsOperation) Metadata() (*cespb.ImportEvaluationsOperationMetadata, error) {
	var meta cespb.ImportEvaluationsOperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
		return nil, err
...
func (op *RunEvaluationOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*cespb.RunEvaluationResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp cespb.RunEvaluationResponse
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
	return &resp, nil
...
func (op *RunEvaluationOperation) Metadata() (*cespb.RunEvaluationOperationMetadata, error) {
	var meta cespb.RunEvaluationOperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
		return nil, err
...
// RunEvaluationResultMetricsOperation manages a long-running operation from RunEvaluationResultMetrics.
type RunEvaluationResultMetricsOperation struct {
	lro      *longrunning.Operation
	pollPath string
}
...
//
// See documentation of Poll for error-handling information.
func (op *RunEvaluationResultMetricsOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*cespb.RunEvaluationResultMetricsResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp cespb.RunEvaluationResultMetricsResponse
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
	return &resp, nil
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *RunEvaluationResultMetricsOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*cespb.RunEvaluationResultMetricsResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp cespb.RunEvaluationResultMetricsResponse
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *RunEvaluationResultMetricsOperation) Metadata() (*cespb.RunEvaluationResultMetricsOperationMetadata, error) {
	var meta cespb.RunEvaluationResultMetricsOperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
		return nil, err
...
// Done reports whether the long-running operation has completed.
func (op *RunEvaluationResultMetricsOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *RunEvaluationResultMetricsOperation) Name() string {
	return op.lro.Name()
}
...
func (it *EvaluationDatasetIterator) Next() (*cespb.EvaluationDataset, error) {
	var item *cespb.EvaluationDataset
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *EvaluationDatasetIterator) bufLen() int {
	return len(it.items)
}

func (it *EvaluationDatasetIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type EvaluationExpectationIterator struct {
	items    []*cespb.EvaluationExpectation
	pageInfo *iterator.PageInfo
	nextFunc func() error
...
func (it *EvaluationExpectationIterator) Next() (*cespb.EvaluationExpectation, error) {
	var item *cespb.EvaluationExpectation
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *EvaluationExpectationIterator) bufLen() int {
	return len(it.items)
}

func (it *EvaluationExpectationIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
func (it *EvaluationResultIterator) Next() (*cespb.EvaluationResult, error) {
	var item *cespb.EvaluationResult
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *EvaluationResultIterator) bufLen() int {
	return len(it.items)
}

func (it *EvaluationResultIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
func (it *EvaluationRunIterator) bufLen() int {
	return len(it.items)
}

func (it *EvaluationRunIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type ScheduledEvaluationRunIterator struct {
	items    []*cespb.ScheduledEvaluationRun
	pageInfo *iterator.PageInfo
	nextFunc func() error
...
func (it *ScheduledEvaluationRunIterator) Next() (*cespb.ScheduledEvaluationRun, error) {
	var item *cespb.ScheduledEvaluationRun
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *ScheduledEvaluationRunIterator) bufLen() int {
	return len(it.items)
}

func (it *ScheduledEvaluationRunIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
