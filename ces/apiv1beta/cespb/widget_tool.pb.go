...
func (WidgetTool_DataMapping_Mode) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_ces_v1beta_widget_tool_proto_enumTypes[2].Descriptor()
}

func (WidgetTool_DataMapping_Mode) Type() protoreflect.EnumType {
	return &file_google_cloud_ces_v1beta_widget_tool_proto_enumTypes[2]
}
...
func (WidgetTool_DataMapping_Mode) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_ces_v1beta_widget_tool_proto_rawDescGZIP(), []int{0, 1, 0}
}
...
type WidgetTool_TextResponseConfig struct {
	...
	Type WidgetTool_TextResponseConfig_Type `protobuf:"varint,1,opt,name=type,proto3,enum=google.cloud.ces.v1beta.WidgetTool_TextResponseConfig_Type" json:"type,omitempty"`
...
func (x *WidgetTool_DataMapping) Reset() {
	*x = WidgetTool_DataMapping{}
	mi := &file_google_cloud_ces_v1beta_widget_tool_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WidgetTool_DataMapping) Descriptor() ([]byte, []int) {
	return file_google_cloud_ces_v1beta_widget_tool_proto_rawDescGZIP(), []int{0, 1}
}
...
const file_google_cloud_ces_v1beta_widget_tool_proto_rawDesc = "" +
	"\n" +
	")google/cloud/ces/v1beta/widget_tool.proto\x12\x17google.cloud.ces.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a-google/cloud/ces/v1beta/python_function.proto\x1a$google/cloud/ces/v1beta/schema.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xc4\f\n" +
	"\n" +
	"WidgetTool\x12F\n" +
	"\n" +
	...
	"\fdata_mapping\x18\x06 \x01(\v2/.google.cloud.ces.v1beta.WidgetTool.DataMappingB\x03\xe0A\x01R\vdataMapping\x12m\n" +
	"\x14text_response_config\x18\a \x01(\v26.google.cloud.ces.v1beta.WidgetTool.TextResponseConfigB\x03\xe0A\x01R\x12textResponseConfig\x1a\x98\x02\n" +
	"\x12TextResponseConfig\x12T\n" +
	"\x04type\x18\x01 \x01(\x0e2;.google.cloud.ces.v1beta.WidgetTool.TextResponseConfig.TypeB\x03\xe0A\x01R\x04type\x12$\n" +
...
var file_google_cloud_ces_v1beta_widget_tool_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_google_cloud_ces_v1beta_widget_tool_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_cloud_ces_v1beta_widget_tool_proto_goTypes = []any{
	...
	(WidgetTool_TextResponseConfig_Type)(0), // 1: google.cloud.ces.v1beta.WidgetTool.TextResponseConfig.Type
	(WidgetTool_DataMapping_Mode)(0),        // 2: google.cloud.ces.v1beta.WidgetTool.DataMapping.Mode
	(*WidgetTool)(nil),                      // 3: google.cloud.ces.v1beta.WidgetTool
	(*WidgetTool_TextResponseConfig)(nil),   // 4: google.cloud.ces.v1beta.WidgetTool.TextResponseConfig
	(*WidgetTool_DataMapping)(nil),          // 5: google.cloud.ces.v1beta.WidgetTool.DataMapping
	nil,                                     // 6: google.cloud.ces.v1beta.WidgetTool.DataMapping.FieldMappingsEntry
	(*Schema)(nil),                          // 7: google.cloud.ces.v1beta.Schema
	(*structpb.Struct)(nil),                 // 8: google.protobuf.Struct
	(*PythonFunction)(nil),                  // 9: google.cloud.ces.v1beta.PythonFunction
}
var file_google_cloud_ces_v1beta_widget_tool_proto_depIdxs = []int32{
	7, // 0: google.cloud.ces.v1beta.WidgetTool.parameters:type_name -> google.cloud.ces.v1beta.Schema
	0, // 1: google.cloud.ces.v1beta.WidgetTool.widget_type:type_name -> google.cloud.ces.v1beta.WidgetTool.WidgetType
	8, // 2: google.cloud.ces.v1beta.WidgetTool.ui_config:type_name -> google.protobuf.Struct
	5, // 3: google.cloud.ces.v1beta.WidgetTool.data_mapping:type_name -> google.cloud.ces.v1beta.WidgetTool.DataMapping
	4, // 4: google.cloud.ces.v1beta.WidgetTool.text_response_config:type_name -> google.cloud.ces.v1beta.WidgetTool.TextResponseConfig
	1, // 5: google.cloud.ces.v1beta.WidgetTool.TextResponseConfig.type:type_name -> google.cloud.ces.v1beta.WidgetTool.TextResponseConfig.Type
	6, // 6: google.cloud.ces.v1beta.WidgetTool.DataMapping.field_mappings:type_name -> google.cloud.ces.v1beta.WidgetTool.DataMapping.FieldMappingsEntry
	9, // 7: google.cloud.ces.v1beta.WidgetTool.DataMapping.python_function:type_name -> google.cloud.ces.v1beta.PythonFunction
	2, // 8: google.cloud.ces.v1beta.WidgetTool.DataMapping.mode:type_name -> google.cloud.ces.v1beta.WidgetTool.DataMapping.Mode
