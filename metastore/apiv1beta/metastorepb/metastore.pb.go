...
const file_google_cloud_metastore_v1beta_metastore_proto_rawDesc = "" +
	"\n" +
	...
	"\aService\x12h\n" +
	"\x15hive_metastore_config\x18\x05 \x01(\v22.google.cloud.metastore.v1beta.HiveMetastoreConfigH\x00R\x13hiveMetastoreConfig\x12\x17\n" +
	...
	"updateTime\x12J\n" +
	"\x06labels\x18\x04 \x03(\v22.google.cloud.metastore.v1beta.Service.LabelsEntryR\x06labels\x12@\n" +
	...
	"\x04port\x18\t \x01(\x05R\x04port\x12G\n" +
	"\x05state\x18\n" +
	" \x01(\x0e2,.google.cloud.metastore.v1beta.Service.StateB\x03\xe0A\x03R\x05state\x12(\n" +
	...
	"\x04tier\x18\r \x01(\x0e2+.google.cloud.metastore.v1beta.Service.TierR\x04tier\x12e\n" +
	"\x14metadata_integration\x18\x0e \x01(\v22.google.cloud.metastore.v1beta.MetadataIntegrationR\x13metadataIntegration\x12_\n" +
	"\x12maintenance_window\x18\x0f \x01(\v20.google.cloud.metastore.v1beta.MaintenanceWindowR\x11maintenanceWindow\x12\x15\n" +
	"\x03uid\x18\x10 \x01(\tB\x03\xe0A\x03R\x03uid\x12\x80\x01\n" +
	"\x1cmetadata_management_activity\x18\x11 \x01(\v29.google.cloud.metastore.v1beta.MetadataManagementActivityB\x03\xe0A\x03R\x1ametadataManagementActivity\x12c\n" +
	"\x0frelease_channel\x18\x13 \x01(\x0e25.google.cloud.metastore.v1beta.Service.ReleaseChannelB\x03\xe0A\x05R\x0ereleaseChannel\x12a\n" +
	"\x11encryption_config\x18\x14 \x01(\v2/.google.cloud.metastore.v1beta.EncryptionConfigB\x03\xe0A\x05R\x10encryptionConfig\x12S\n" +
	"\x0enetwork_config\x18\x15 \x01(\v2,.google.cloud.metastore.v1beta.NetworkConfigR\rnetworkConfig\x12]\n" +
	"\rdatabase_type\x18\x16 \x01(\x0e23.google.cloud.metastore.v1beta.Service.DatabaseTypeB\x03\xe0A\x05R\fdatabaseType\x12Y\n" +
	"\x10telemetry_config\x18\x17 \x01(\v2..google.cloud.metastore.v1beta.TelemetryConfigR\x0ftelemetryConfig\x12S\n" +
	"\x0escaling_config\x18\x18 \x01(\v2,.google.cloud.metastore.v1beta.ScalingConfigR\rscalingConfig\x1a9\n" +
	...
	"\x10metastore_config\"\xcf\x01\n" +
	"\x13MetadataIntegration\x12`\n" +
	"\x13data_catalog_config\x18\x01 \x01(\v20.google.cloud.metastore.v1beta.DataCatalogConfigR\x11dataCatalogConfig\x12V\n" +
	"\x0fdataplex_config\x18\x02 \x01(\v2-.google.cloud.metastore.v1beta.DataplexConfigR\x0edataplexConfig\"-\n" +
	"\x11DataCatalogConfig\x12\x18\n" +
	"\aenabled\x18\x02 \x01(\bR\aenabled\"\xe0\x01\n" +
	"\x0eDataplexConfig\x12g\n" +
	"\x0elake_resources\x18\x01 \x03(\v2@.google.cloud.metastore.v1beta.DataplexConfig.LakeResourcesEntryR\rlakeResources\x1ae\n" +
	"\x12LakeResourcesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x129\n" +
	"\x05value\x18\x02 \x01(\v2#.google.cloud.metastore.v1beta.LakeR\x05value:\x028\x01\"=\n" +
	"\x04Lake\x125\n" +
	...
	"\vday_of_week\x18\x02 \x01(\x0e2\x16.google.type.DayOfWeekR\tdayOfWeek\"\xfa\x05\n" +
	"\x13HiveMetastoreConfig\x12\x1d\n" +
	"\aversion\x18\x01 \x01(\tB\x03\xe0A\x05R\aversion\x12r\n" +
	"\x10config_overrides\x18\x02 \x03(\v2G.google.cloud.metastore.v1beta.HiveMetastoreConfig.ConfigOverridesEntryR\x0fconfigOverrides\x12V\n" +
	"\x0fkerberos_config\x18\x03 \x01(\v2-.google.cloud.metastore.v1beta.KerberosConfigR\x0ekerberosConfig\x12p\n" +
	"\x11endpoint_protocol\x18\x04 \x01(\x0e2C.google.cloud.metastore.v1beta.HiveMetastoreConfig.EndpointProtocolR\x10endpointProtocol\x12x\n" +
	"\x12auxiliary_versions\x18\x05 \x03(\v2I.google.cloud.metastore.v1beta.HiveMetastoreConfig.AuxiliaryVersionsEntryR\x11auxiliaryVersions\x1aB\n" +
	"\x14ConfigOverridesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1a{\n" +
	"\x16AuxiliaryVersionsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12K\n" +
	"\x05value\x18\x02 \x01(\v25.google.cloud.metastore.v1beta.AuxiliaryVersionConfigR\x05value:\x028\x01\"K\n" +
	"\x10EndpointProtocol\x12!\n" +
	"\x1dENDPOINT_PROTOCOL_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06THRIFT\x10\x01\x12\b\n" +
	"\x04GRPC\x10\x02\"\x9c\x01\n" +
	"\x0eKerberosConfig\x12=\n" +
	"\x06keytab\x18\x01 \x01(\v2%.google.cloud.metastore.v1beta.SecretR\x06keytab\x12\x1c\n" +
	...
	"\akms_key\x18\x01 \x01(\tR\x06kmsKey\"\xc7\x02\n" +
	"\x16AuxiliaryVersionConfig\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\x12u\n" +
	"\x10config_overrides\x18\x02 \x03(\v2J.google.cloud.metastore.v1beta.AuxiliaryVersionConfig.ConfigOverridesEntryR\x0fconfigOverrides\x12X\n" +
	"\x0enetwork_config\x18\x03 \x01(\v2,.google.cloud.metastore.v1beta.NetworkConfigB\x03\xe0A\x03R\rnetworkConfig\x1aB\n" +
	"\x14ConfigOverridesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x87\x03\n" +
	"\rNetworkConfig\x12X\n" +
	"\tconsumers\x18\x01 \x03(\v25.google.cloud.metastore.v1beta.NetworkConfig.ConsumerB\x03\xe0A\x05R\tconsumers\x122\n" +
	...
	"\fvpc_resource\"\xa9\x01\n" +
	"\x0fTelemetryConfig\x12W\n" +
	"\n" +
	"log_format\x18\x01 \x01(\x0e28.google.cloud.metastore.v1beta.TelemetryConfig.LogFormatR\tlogFormat\"=\n" +
	"\tLogFormat\x12\x1a\n" +
	"\x16LOG_FORMAT_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06LEGACY\x10\x01\x12\b\n" +
	"\x04JSON\x10\x02\"\xc4\x01\n" +
	"\x1aMetadataManagementActivity\x12]\n" +
	"\x10metadata_exports\x18\x01 \x03(\v2-.google.cloud.metastore.v1beta.MetadataExportB\x03\xe0A\x03R\x0fmetadataExports\x12G\n" +
	"\brestores\x18\x02 \x03(\v2&.google.cloud.metastore.v1beta.RestoreB\x03\xe0A\x03R\brestores\"\x85\b\n" +
	"\x0eMetadataImport\x12f\n" +
	"\rdatabase_dump\x18\x06 \x01(\v2:.google.cloud.metastore.v1beta.MetadataImport.DatabaseDumpB\x03\xe0A\x05H\x00R\fdatabaseDump\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x05R\x04name\x12 \n" +
	...
	"updateTime\x12:\n" +
	"\bend_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\aendTime\x12N\n" +
	"\x05state\x18\x05 \x01(\x0e23.google.cloud.metastore.v1beta.MetadataImport.StateB\x03\xe0A\x03R\x05state\x1a\xcf\x02\n" +
	"\fDatabaseDump\x12p\n" +
	"\rdatabase_type\x18\x01 \x01(\x0e2G.google.cloud.metastore.v1beta.MetadataImport.DatabaseDump.DatabaseTypeB\x02\x18\x01R\fdatabaseType\x12\x17\n" +
	"\agcs_uri\x18\x02 \x01(\tR\x06gcsUri\x12+\n" +
	"\x0fsource_database\x18\x03 \x01(\tB\x02\x18\x01R\x0esourceDatabase\x12M\n" +
	"\x04type\x18\x04 \x01(\x0e24.google.cloud.metastore.v1beta.DatabaseDumpSpec.TypeB\x03\xe0A\x01R\x04type\"8\n" +
	"\fDatabaseType\x12\x1d\n" +
	"\x19DATABASE_TYPE_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05MYSQL\x10\x01\"T\n" +
	"\x05State\x12\x15\n" +
	...
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\aendTime\x12N\n" +
	"\x05state\x18\x03 \x01(\x0e23.google.cloud.metastore.v1beta.MetadataExport.StateB\x03\xe0A\x03R\x05state\x12g\n" +
	"\x12database_dump_type\x18\x05 \x01(\x0e24.google.cloud.metastore.v1beta.DatabaseDumpSpec.TypeB\x03\xe0A\x03R\x10databaseDumpType\"U\n" +
	"\x05State\x12\x15\n" +
	"\x11STATE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aRUNNING\x10\x01\x12\r\n" +
	...
	"\x05state\x18\x04 \x01(\x0e2+.google.cloud.metastore.v1beta.Backup.StateB\x03\xe0A\x03R\x05state\x12V\n" +
	"\x10service_revision\x18\x05 \x01(\v2&.google.cloud.metastore.v1beta.ServiceB\x03\xe0A\x03R\x0fserviceRevision\x12 \n" +
	...
	"\x1fmetastore.googleapis.com/Backup\x12Kprojects/{project}/locations/{location}/services/{service}/backups/{backup}\"\x9c\x04\n" +
	"\aRestore\x12>\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tstartTime\x12:\n" +
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\aendTime\x12G\n" +
	"\x05state\x18\x03 \x01(\x0e2,.google.cloud.metastore.v1beta.Restore.StateB\x03\xe0A\x03R\x05state\x12?\n" +
	"\x06backup\x18\x04 \x01(\tB'\xe0A\x03\xfaA!\n" +
	"\x1fmetastore.googleapis.com/BackupR\x06backup\x12K\n" +
	"\x04type\x18\x05 \x01(\x0e22.google.cloud.metastore.v1beta.Restore.RestoreTypeB\x03\xe0A\x03R\x04type\x12\x1d\n" +
	...
	"\rMETADATA_ONLY\x10\x02\"\x9e\x02\n" +
	"\rScalingConfig\x12`\n" +
	"\rinstance_size\x18\x01 \x01(\x0e29.google.cloud.metastore.v1beta.ScalingConfig.InstanceSizeH\x00R\finstanceSize\x12'\n" +
	...
	"\bservices\x18\x01 \x03(\v2&.google.cloud.metastore.v1beta.ServiceR\bservices\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12 \n" +
	"\vunreachable\x18\x03 \x03(\tR\vunreachable\"Q\n" +
	"\x11GetServiceRequest\x12<\n" +
	"\x04name\x18\x01 \x01(\tB(\xe0A\x02\xfaA\"\n" +
	" metastore.googleapis.com/ServiceR\x04name\"\xe7\x01\n" +
	"\x14CreateServiceRequest\x12@\n" +
	"\x06parent\x18\x01 \x01(\tB(\xe0A\x02\xfaA\"\x12 metastore.googleapis.com/ServiceR\x06parent\x12\"\n" +
	"\n" +
	"service_id\x18\x02 \x01(\tB\x03\xe0A\x02R\tserviceId\x12E\n" +
	"\aservice\x18\x03 \x01(\v2&.google.cloud.metastore.v1beta.ServiceB\x03\xe0A\x02R\aservice\x12\"\n" +
	"\n" +
	...
	"updateMask\x12E\n" +
	"\aservice\x18\x02 \x01(\v2&.google.cloud.metastore.v1beta.ServiceB\x03\xe0A\x02R\aservice\x12\"\n" +
	"\n" +
	...
	"\x10metadata_imports\x18\x01 \x03(\v2-.google.cloud.metastore.v1beta.MetadataImportR\x0fmetadataImports\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12 \n" +
	"\vunreachable\x18\x03 \x03(\tR\vunreachable\"_\n" +
	"\x18GetMetadataImportRequest\x12C\n" +
	"\x04name\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'metastore.googleapis.com/MetadataImportR\x04name\"\x9a\x02\n" +
	...
	"\x0fmetadata_import\x18\x03 \x01(\v2-.google.cloud.metastore.v1beta.MetadataImportB\x03\xe0A\x02R\x0emetadataImport\x12\"\n" +
	"\n" +
	"request_id\x18\x04 \x01(\tB\x03\xe0A\x01R\trequestId\"\xe0\x01\n" +
	"\x1bUpdateMetadataImportRequest\x12@\n" +
	"\vupdate_mask\x18\x01 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\x12[\n" +
	"\x0fmetadata_import\x18\x02 \x01(\v2-.google.cloud.metastore.v1beta.MetadataImportB\x03\xe0A\x02R\x0emetadataImport\x12\"\n" +
	"\n" +
	...
	"\abackups\x18\x01 \x03(\v2%.google.cloud.metastore.v1beta.BackupR\abackups\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12 \n" +
	"\vunreachable\x18\x03 \x03(\tR\vunreachable\"O\n" +
	"\x10GetBackupRequest\x12;\n" +
	"\x04name\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\n" +
	"\x1fmetastore.googleapis.com/BackupR\x04name\"\xe0\x01\n" +
	"\x13CreateBackupRequest\x12?\n" +
	"\x06parent\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\x12\x1fmetastore.googleapis.com/BackupR\x06parent\x12 \n" +
	"\tbackup_id\x18\x02 \x01(\tB\x03\xe0A\x02R\bbackupId\x12B\n" +
	"\x06backup\x18\x03 \x01(\v2%.google.cloud.metastore.v1beta.BackupB\x03\xe0A\x02R\x06backup\x12\"\n" +
	"\n" +
	...
	"\n" +
	"request_id\x18\x02 \x01(\tB\x03\xe0A\x01R\trequestId\"\xaf\x02\n" +
	...
	"\n" +
	"request_id\x18\x03 \x01(\tB\x03\xe0A\x01R\trequestId\x12g\n" +
	"\x12database_dump_type\x18\x04 \x01(\x0e24.google.cloud.metastore.v1beta.DatabaseDumpSpec.TypeB\x03\xe0A\x01R\x10databaseDumpTypeB\r\n" +
	"\vdestination\"\x9c\x02\n" +
	"\x15RestoreServiceRequest\x12B\n" +
	"\aservice\x18\x01 \x01(\tB(\xe0A\x02\xfaA\"\n" +
	" metastore.googleapis.com/ServiceR\aservice\x12?\n" +
	"\x06backup\x18\x02 \x01(\tB'\xe0A\x02\xfaA!\n" +
	"\x1fmetastore.googleapis.com/BackupR\x06backup\x12Z\n" +
	"\frestore_type\x18\x03 \x01(\x0e22.google.cloud.metastore.v1beta.Restore.RestoreTypeB\x03\xe0A\x01R\vrestoreType\x12\"\n" +
	"\n" +
	...
	"!supported_hive_metastore_versions\x18\x01 \x03(\v2D.google.cloud.metastore.v1beta.LocationMetadata.HiveMetastoreVersionR\x1esupportedHiveMetastoreVersions\x1aO\n" +
	...
	"\x13result_manifest_uri\x18\x01 \x01(\tR\x11resultManifestUri\"\x9e\x01\n" +
	"\fErrorDetails\x12R\n" +
	"\adetails\x18\x01 \x03(\v28.google.cloud.metastore.v1beta.ErrorDetails.DetailsEntryR\adetails\x1a:\n" +
	...
	"\fListServices\x122.google.cloud.metastore.v1beta.ListServicesRequest\x1a3.google.cloud.metastore.v1beta.ListServicesResponse\"A\xdaA\x06parent\x82\xd3\xe4\x93\x022\x120/v1beta/{parent=projects/*/locations/*}/services\x12\xa7\x01\n" +
	"\n" +
	...
	"\aService\x12/google.cloud.metastore.v1beta.OperationMetadata\xdaA\x19parent,service,service_id\x82\xd3\xe4\x93\x02;:\aservice\"0/v1beta/{parent=projects/*/locations/*}/services\x12\x82\x02\n" +
	"\rUpdateService\x123.google.cloud.metastore.v1beta.UpdateServiceRequest\x1a\x1d.google.longrunning.Operation\"\x9c\x01\xcaA:\n" +
	"\aService\x12/google.cloud.metastore.v1beta.OperationMetadata\xdaA\x13service,update_mask\x82\xd3\xe4\x93\x02C:\aservice28/v1beta/{service.name=projects/*/locations/*/services/*}\x12\xf0\x01\n" +
	...
	"\x0eMetadataImport\x12/google.cloud.metastore.v1beta.OperationMetadata\xdaA)parent,metadata_import,metadata_import_id\x82\xd3\xe4\x93\x02U:\x0fmetadata_import\"B/v1beta/{parent=projects/*/locations/*/services/*}/metadataImports\x12\xc1\x02\n" +
	...
	"\x0eMetadataImport\x12/google.cloud.metastore.v1beta.OperationMetadata\xdaA\x1bmetadata_import,update_mask\x82\xd3\xe4\x93\x02e:\x0fmetadata_import2R/v1beta/{metadata_import.name=projects/*/locations/*/services/*/metadataImports/*}\x12\xf9\x01\n" +
	...
	"\x0eMetadataExport\x12/google.cloud.metastore.v1beta.OperationMetadata\x82\xd3\xe4\x93\x02G:\x01*\"B/v1beta/{service=projects/*/locations/*/services/*}:exportMetadata\x12\xfc\x01\n" +
	...
	"\aRestore\x12/google.cloud.metastore.v1beta.OperationMetadata\xdaA\x0eservice,backup\x82\xd3\xe4\x93\x02@:\x01*\";/v1beta/{service=projects/*/locations/*/services/*}:restore\x12\xc1\x01\n" +
	"\vListBackups\x121.google.cloud.metastore.v1beta.ListBackupsRequest\x1a2.google.cloud.metastore.v1beta.ListBackupsResponse\"K\xdaA\x06parent\x82\xd3\xe4\x93\x02<\x12:/v1beta/{parent=projects/*/locations/*/services/*}/backups\x12\xae\x01\n" +
	...
	"\fCreateBackup\x122.google.cloud.metastore.v1beta.CreateBackupRequest\x1a\x1d.google.longrunning.Operation\"\xa0\x01\xcaA9\n" +
	"\x06Backup\x12/google.cloud.metastore.v1beta.OperationMetadata\xdaA\x17parent,backup,backup_id\x82\xd3\xe4\x93\x02D:\x06backup\":/v1beta/{parent=projects/*/locations/*/services/*}/backups\x12\xf8\x01\n" +
	"\fDeleteBackup\x122.google.cloud.metastore.v1beta.DeleteBackupRequest\x1a\x1d.google.longrunning.Operation\"\x94\x01\xcaAH\n" +
	...
	"\x0fRemoveIamPolicy\x125.google.cloud.metastore.v1beta.RemoveIamPolicyRequest\x1a6.google.cloud.metastore.v1beta.RemoveIamPolicyResponse\"R\x82\xd3\xe4\x93\x02L:\x01*\"G/v1beta/{resource=projects/*/locations/*/services/*/**}:removeIamPolicy\x12\xfd\x01\n" +
	...
	"\x15QueryMetadataResponse\x12/google.cloud.metastore.v1beta.OperationMetadata\x82\xd3\xe4\x93\x02F:\x01*\"A/v1beta/{service=projects/*/locations/*/services/*}:queryMetadata\x12\x95\x02\n" +
	...
	"\x1bMoveTableToDatabaseResponse\x12/google.cloud.metastore.v1beta.OperationMetadata\x82\xd3\xe4\x93\x02L:\x01*\"G/v1beta/{service=projects/*/locations/*/services/*}:moveTableToDatabase\x12\xad\x02\n" +
	...
	"%AlterMetadataResourceLocationResponse\x12/google.cloud.metastore.v1beta.OperationMetadata\x82\xd3\xe4\x93\x02F:\x01*\"A/v1beta/{service=projects/*/locations/*/services/*}:alterLocation\x1aL\xcaA\x18metastore.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xa2\x03\xeaAN\n" +
	...
	"!com.google.cloud.metastore.v1betaB\x0eMetastoreProtoP\x01Z?cloud.google.com/go/metastore/apiv1beta/metastorepb;metastorepb\xca\x02\x1dGoogle\\Cloud\\Metastore\\V1betab\x06proto3"

var (
	file_google_cloud_metastore_v1beta_metastore_proto_rawDescOnce sync.Once
	file_google_cloud_metastore_v1beta_metastore_proto_rawDescData []byte
)
...
func file_google_cloud_metastore_v1beta_metastore_proto_rawDescGZIP() []byte {
	file_google_cloud_metastore_v1beta_metastore_proto_rawDescOnce.Do(func() {
		file_google_cloud_metastore_v1beta_metastore_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_metastore_v1beta_metastore_proto_rawDesc), len(file_google_cloud_metastore_v1beta_metastore_proto_rawDesc)))
	})
...
func file_google_cloud_metastore_v1beta_metastore_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_metastore_v1beta_metastore_proto_rawDesc), len(file_google_cloud_metastore_v1beta_metastore_proto_rawDesc)),
			NumEnums:      14,
			NumMessages:   58,
			NumExtensions: 0,
			NumServices:   1,
