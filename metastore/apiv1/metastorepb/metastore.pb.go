...
const file_google_cloud_metastore_v1_metastore_proto_rawDesc = "" +
	"\n" +
	...
	"\aService\x12d\n" +
	"\x15hive_metastore_config\x18\x05 \x01(\v2..google.cloud.metastore.v1.HiveMetastoreConfigH\x00R\x13hiveMetastoreConfig\x12\x17\n" +
	...
	"updateTime\x12F\n" +
	"\x06labels\x18\x04 \x03(\v2..google.cloud.metastore.v1.Service.LabelsEntryR\x06labels\x12@\n" +
	...
	"\x04port\x18\t \x01(\x05R\x04port\x12C\n" +
	"\x05state\x18\n" +
	" \x01(\x0e2(.google.cloud.metastore.v1.Service.StateB\x03\xe0A\x03R\x05state\x12(\n" +
	...
	"\x04tier\x18\r \x01(\x0e2'.google.cloud.metastore.v1.Service.TierR\x04tier\x12[\n" +
	"\x12maintenance_window\x18\x0f \x01(\v2,.google.cloud.metastore.v1.MaintenanceWindowR\x11maintenanceWindow\x12\x15\n" +
	"\x03uid\x18\x10 \x01(\tB\x03\xe0A\x03R\x03uid\x12|\n" +
	"\x1cmetadata_management_activity\x18\x11 \x01(\v25.google.cloud.metastore.v1.MetadataManagementActivityB\x03\xe0A\x03R\x1ametadataManagementActivity\x12_\n" +
	"\x0frelease_channel\x18\x13 \x01(\x0e21.google.cloud.metastore.v1.Service.ReleaseChannelB\x03\xe0A\x05R\x0ereleaseChannel\x12]\n" +
	"\x11encryption_config\x18\x14 \x01(\v2+.google.cloud.metastore.v1.EncryptionConfigB\x03\xe0A\x05R\x10encryptionConfig\x12O\n" +
	"\x0enetwork_config\x18\x15 \x01(\v2(.google.cloud.metastore.v1.NetworkConfigR\rnetworkConfig\x12Y\n" +
	"\rdatabase_type\x18\x16 \x01(\x0e2/.google.cloud.metastore.v1.Service.DatabaseTypeB\x03\xe0A\x05R\fdatabaseType\x12U\n" +
	"\x10telemetry_config\x18\x17 \x01(\v2*.google.cloud.metastore.v1.TelemetryConfigR\x0ftelemetryConfig\x12O\n" +
	"\x0escaling_config\x18\x18 \x01(\v2(.google.cloud.metastore.v1.ScalingConfigR\rscalingConfig\x1a9\n" +
	...
	"\vday_of_week\x18\x02 \x01(\x0e2\x16.google.type.DayOfWeekR\tdayOfWeek\"\xe6\x05\n" +
	"\x13HiveMetastoreConfig\x12\x1d\n" +
	"\aversion\x18\x01 \x01(\tB\x03\xe0A\x05R\aversion\x12n\n" +
	"\x10config_overrides\x18\x02 \x03(\v2C.google.cloud.metastore.v1.HiveMetastoreConfig.ConfigOverridesEntryR\x0fconfigOverrides\x12R\n" +
	"\x0fkerberos_config\x18\x03 \x01(\v2).google.cloud.metastore.v1.KerberosConfigR\x0ekerberosConfig\x12l\n" +
	"\x11endpoint_protocol\x18\x04 \x01(\x0e2?.google.cloud.metastore.v1.HiveMetastoreConfig.EndpointProtocolR\x10endpointProtocol\x12t\n" +
	"\x12auxiliary_versions\x18\x05 \x03(\v2E.google.cloud.metastore.v1.HiveMetastoreConfig.AuxiliaryVersionsEntryR\x11auxiliaryVersions\x1aB\n" +
	"\x14ConfigOverridesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aw\n" +
	"\x16AuxiliaryVersionsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12G\n" +
	"\x05value\x18\x02 \x01(\v21.google.cloud.metastore.v1.AuxiliaryVersionConfigR\x05value:\x028\x01\"K\n" +
	"\x10EndpointProtocol\x12!\n" +
	"\x1dENDPOINT_PROTOCOL_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06THRIFT\x10\x01\x12\b\n" +
	"\x04GRPC\x10\x02\"\x98\x01\n" +
	"\x0eKerberosConfig\x129\n" +
	"\x06keytab\x18\x01 \x01(\v2!.google.cloud.metastore.v1.SecretR\x06keytab\x12\x1c\n" +
	...
	"\akms_key\x18\x01 \x01(\tR\x06kmsKey\"\xbf\x02\n" +
	"\x16AuxiliaryVersionConfig\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\x12q\n" +
	"\x10config_overrides\x18\x02 \x03(\v2F.google.cloud.metastore.v1.AuxiliaryVersionConfig.ConfigOverridesEntryR\x0fconfigOverrides\x12T\n" +
	"\x0enetwork_config\x18\x03 \x01(\v2(.google.cloud.metastore.v1.NetworkConfigB\x03\xe0A\x03R\rnetworkConfig\x1aB\n" +
	"\x14ConfigOverridesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xcf\x02\n" +
	"\rNetworkConfig\x12T\n" +
	"\tconsumers\x18\x01 \x03(\v21.google.cloud.metastore.v1.NetworkConfig.ConsumerB\x03\xe0A\x05R\tconsumers\x1a\xe7\x01\n" +
	"\bConsumer\x12K\n" +
	"\n" +
	...
	"\fvpc_resource\"\xa5\x01\n" +
	"\x0fTelemetryConfig\x12S\n" +
	"\n" +
	"log_format\x18\x01 \x01(\x0e24.google.cloud.metastore.v1.TelemetryConfig.LogFormatR\tlogFormat\"=\n" +
	"\tLogFormat\x12\x1a\n" +
	"\x16LOG_FORMAT_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06LEGACY\x10\x01\x12\b\n" +
	"\x04JSON\x10\x02\"\xbc\x01\n" +
	"\x1aMetadataManagementActivity\x12Y\n" +
	"\x10metadata_exports\x18\x01 \x03(\v2).google.cloud.metastore.v1.MetadataExportB\x03\xe0A\x03R\x0fmetadataExports\x12C\n" +
	"\brestores\x18\x02 \x03(\v2\".google.cloud.metastore.v1.RestoreB\x03\xe0A\x03R\brestores\"\xf5\a\n" +
	"\x0eMetadataImport\x12b\n" +
	"\rdatabase_dump\x18\x06 \x01(\v26.google.cloud.metastore.v1.MetadataImport.DatabaseDumpB\x03\xe0A\x05H\x00R\fdatabaseDump\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x05R\x04name\x12 \n" +
	...
	"\x05state\x18\x05 \x01(\x0e2/.google.cloud.metastore.v1.MetadataImport.StateB\x03\xe0A\x03R\x05state\x1a\xc7\x02\n" +
	"\fDatabaseDump\x12l\n" +
	"\rdatabase_type\x18\x01 \x01(\x0e2C.google.cloud.metastore.v1.MetadataImport.DatabaseDump.DatabaseTypeB\x02\x18\x01R\fdatabaseType\x12\x17\n" +
	"\agcs_uri\x18\x02 \x01(\tR\x06gcsUri\x12+\n" +
	"\x0fsource_database\x18\x03 \x01(\tB\x02\x18\x01R\x0esourceDatabase\x12I\n" +
	"\x04type\x18\x04 \x01(\x0e20.google.cloud.metastore.v1.DatabaseDumpSpec.TypeB\x03\xe0A\x01R\x04type\"8\n" +
	"\fDatabaseType\x12\x1d\n" +
	"\x19DATABASE_TYPE_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05MYSQL\x10\x01\"T\n" +
	"\x05State\x12\x15\n" +
	...
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\aendTime\x12J\n" +
	"\x05state\x18\x03 \x01(\x0e2/.google.cloud.metastore.v1.MetadataExport.StateB\x03\xe0A\x03R\x05state\x12c\n" +
	"\x12database_dump_type\x18\x05 \x01(\x0e20.google.cloud.metastore.v1.DatabaseDumpSpec.TypeB\x03\xe0A\x03R\x10databaseDumpType\"U\n" +
	"\x05State\x12\x15\n" +
	"\x11STATE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aRUNNING\x10\x01\x12\r\n" +
	...
	"\tCANCELLED\x10\x04B\r\n" +
	"\vdestination\"\xe3\x04\n" +
	"\x06Backup\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x05R\x04name\x12@\n" +
	"\vcreate_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12:\n" +
	"\bend_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\aendTime\x12B\n" +
	"\x05state\x18\x04 \x01(\x0e2'.google.cloud.metastore.v1.Backup.StateB\x03\xe0A\x03R\x05state\x12R\n" +
	"\x10service_revision\x18\x05 \x01(\v2\".google.cloud.metastore.v1.ServiceB\x03\xe0A\x03R\x0fserviceRevision\x12 \n" +
	...
	"\x1fmetastore.googleapis.com/Backup\x12Kprojects/{project}/locations/{location}/services/{service}/backups/{backup}\"\x94\x04\n" +
	"\aRestore\x12>\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tstartTime\x12:\n" +
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\aendTime\x12C\n" +
	"\x05state\x18\x03 \x01(\x0e2(.google.cloud.metastore.v1.Restore.StateB\x03\xe0A\x03R\x05state\x12?\n" +
	"\x06backup\x18\x04 \x01(\tB'\xe0A\x03\xfaA!\n" +
	"\x1fmetastore.googleapis.com/BackupR\x06backup\x12G\n" +
	"\x04type\x18\x05 \x01(\x0e2..google.cloud.metastore.v1.Restore.RestoreTypeB\x03\xe0A\x03R\x04type\x12\x1d\n" +
	...
	"\rMETADATA_ONLY\x10\x02\"\x9a\x02\n" +
	"\rScalingConfig\x12\\\n" +
	"\rinstance_size\x18\x01 \x01(\x0e25.google.cloud.metastore.v1.ScalingConfig.InstanceSizeH\x00R\finstanceSize\x12'\n" +
	...
	"\bservices\x18\x01 \x03(\v2\".google.cloud.metastore.v1.ServiceR\bservices\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12 \n" +
	"\vunreachable\x18\x03 \x03(\tR\vunreachable\"Q\n" +
	"\x11GetServiceRequest\x12<\n" +
	"\x04name\x18\x01 \x01(\tB(\xe0A\x02\xfaA\"\n" +
	" metastore.googleapis.com/ServiceR\x04name\"\xe3\x01\n" +
	"\x14CreateServiceRequest\x12@\n" +
	"\x06parent\x18\x01 \x01(\tB(\xe0A\x02\xfaA\"\x12 metastore.googleapis.com/ServiceR\x06parent\x12\"\n" +
	"\n" +
	"service_id\x18\x02 \x01(\tB\x03\xe0A\x02R\tserviceId\x12A\n" +
	"\aservice\x18\x03 \x01(\v2\".google.cloud.metastore.v1.ServiceB\x03\xe0A\x02R\aservice\x12\"\n" +
	"\n" +
	...
	"updateMask\x12A\n" +
	"\aservice\x18\x02 \x01(\v2\".google.cloud.metastore.v1.ServiceB\x03\xe0A\x02R\aservice\x12\"\n" +
	"\n" +
	...
	"\x10metadata_imports\x18\x01 \x03(\v2).google.cloud.metastore.v1.MetadataImportR\x0fmetadataImports\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12 \n" +
	"\vunreachable\x18\x03 \x03(\tR\vunreachable\"_\n" +
	"\x18GetMetadataImportRequest\x12C\n" +
	"\x04name\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'metastore.googleapis.com/MetadataImportR\x04name\"\x96\x02\n" +
	...
	"\x12metadata_import_id\x18\x02 \x01(\tB\x03\xe0A\x02R\x10metadataImportId\x12W\n" +
	"\x0fmetadata_import\x18\x03 \x01(\v2).google.cloud.metastore.v1.MetadataImportB\x03\xe0A\x02R\x0emetadataImport\x12\"\n" +
	"\n" +
	"request_id\x18\x04 \x01(\tB\x03\xe0A\x01R\trequestId\"\xdc\x01\n" +
	"\x1bUpdateMetadataImportRequest\x12@\n" +
	"\vupdate_mask\x18\x01 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\x12W\n" +
	"\x0fmetadata_import\x18\x02 \x01(\v2).google.cloud.metastore.v1.MetadataImportB\x03\xe0A\x02R\x0emetadataImport\x12\"\n" +
	"\n" +
	...
	"\abackups\x18\x01 \x03(\v2!.google.cloud.metastore.v1.BackupR\abackups\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12 \n" +
	"\vunreachable\x18\x03 \x03(\tR\vunreachable\"O\n" +
	"\x10GetBackupRequest\x12;\n" +
	"\x04name\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\n" +
	"\x1fmetastore.googleapis.com/BackupR\x04name\"\xdc\x01\n" +
	"\x13CreateBackupRequest\x12?\n" +
	"\x06parent\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\x12\x1fmetastore.googleapis.com/BackupR\x06parent\x12 \n" +
	"\tbackup_id\x18\x02 \x01(\tB\x03\xe0A\x02R\bbackupId\x12>\n" +
	"\x06backup\x18\x03 \x01(\v2!.google.cloud.metastore.v1.BackupB\x03\xe0A\x02R\x06backup\x12\"\n" +
	"\n" +
	...
	"\n" +
	"request_id\x18\x02 \x01(\tB\x03\xe0A\x01R\trequestId\"\xab\x02\n" +
	...
	"\n" +
	"request_id\x18\x03 \x01(\tB\x03\xe0A\x01R\trequestId\x12c\n" +
	"\x12database_dump_type\x18\x04 \x01(\x0e20.google.cloud.metastore.v1.DatabaseDumpSpec.TypeB\x03\xe0A\x01R\x10databaseDumpTypeB\r\n" +
	"\vdestination\"\x98\x02\n" +
	"\x15RestoreServiceRequest\x12B\n" +
	"\aservice\x18\x01 \x01(\tB(\xe0A\x02\xfaA\"\n" +
	" metastore.googleapis.com/ServiceR\aservice\x12?\n" +
	"\x06backup\x18\x02 \x01(\tB'\xe0A\x02\xfaA!\n" +
	"\x1fmetastore.googleapis.com/BackupR\x06backup\x12V\n" +
	"\frestore_type\x18\x03 \x01(\x0e2..google.cloud.metastore.v1.Restore.RestoreTypeB\x03\xe0A\x01R\vrestoreType\x12\"\n" +
	"\n" +
	...
	"!supported_hive_metastore_versions\x18\x01 \x03(\v2@.google.cloud.metastore.v1.LocationMetadata.HiveMetastoreVersionR\x1esupportedHiveMetastoreVersions\x1aO\n" +
	...
	"\x13result_manifest_uri\x18\x01 \x01(\tR\x11resultManifestUri\"\x9a\x01\n" +
	"\fErrorDetails\x12N\n" +
	"\adetails\x18\x01 \x03(\v24.google.cloud.metastore.v1.ErrorDetails.DetailsEntryR\adetails\x1a:\n" +
	...
	"\fListServices\x12..google.cloud.metastore.v1.ListServicesRequest\x1a/.google.cloud.metastore.v1.ListServicesResponse\"=\xdaA\x06parent\x82\xd3\xe4\x93\x02.\x12,/v1/{parent=projects/*/locations/*}/services\x12\x9b\x01\n" +
	"\n" +
	...
	"\aService\x12+google.cloud.metastore.v1.OperationMetadata\xdaA\x19parent,service,service_id\x82\xd3\xe4\x93\x027:\aservice\",/v1/{parent=projects/*/locations/*}/services\x12\xf6\x01\n" +
	"\rUpdateService\x12/.google.cloud.metastore.v1.UpdateServiceRequest\x1a\x1d.google.longrunning.Operation\"\x94\x01\xcaA6\n" +
	"\aService\x12+google.cloud.metastore.v1.OperationMetadata\xdaA\x13service,update_mask\x82\xd3\xe4\x93\x02?:\aservice24/v1/{service.name=projects/*/locations/*/services/*}\x12\xe4\x01\n" +
	...
	"\x0eMetadataImport\x12+google.cloud.metastore.v1.OperationMetadata\xdaA)parent,metadata_import,metadata_import_id\x82\xd3\xe4\x93\x02Q:\x0fmetadata_import\">/v1/{parent=projects/*/locations/*/services/*}/metadataImports\x12\xb5\x02\n" +
	...
	"\x0eMetadataImport\x12+google.cloud.metastore.v1.OperationMetadata\xdaA\x1bmetadata_import,update_mask\x82\xd3\xe4\x93\x02a:\x0fmetadata_import2N/v1/{metadata_import.name=projects/*/locations/*/services/*/metadataImports/*}\x12\xed\x01\n" +
	"\x0eExportMetadata\x120.google.cloud.metastore.v1.ExportMetadataRequest\x1a\x1d.google.longrunning.Operation\"\x89\x01\xcaA=\n" +
	"\x0eMetadataExport\x12+google.cloud.metastore.v1.OperationMetadata\x82\xd3\xe4\x93\x02C:\x01*\">/v1/{service=projects/*/locations/*/services/*}:exportMetadata\x12\xf0\x01\n" +
	...
	"\aRestore\x12+google.cloud.metastore.v1.OperationMetadata\xdaA\x0eservice,backup\x82\xd3\xe4\x93\x02<:\x01*\"7/v1/{service=projects/*/locations/*/services/*}:restore\x12\xb5\x01\n" +
	"\vListBackups\x12-.google.cloud.metastore.v1.ListBackupsRequest\x1a..google.cloud.metastore.v1.ListBackupsResponse\"G\xdaA\x06parent\x82\xd3\xe4\x93\x028\x126/v1/{parent=projects/*/locations/*/services/*}/backups\x12\xa2\x01\n" +
	...
	"\fCreateBackup\x12..google.cloud.metastore.v1.CreateBackupRequest\x1a\x1d.google.longrunning.Operation\"\x98\x01\xcaA5\n" +
	"\x06Backup\x12+google.cloud.metastore.v1.OperationMetadata\xdaA\x17parent,backup,backup_id\x82\xd3\xe4\x93\x02@:\x06backup\"6/v1/{parent=projects/*/locations/*/services/*}/backups\x12\xec\x01\n" +
	"\fDeleteBackup\x12..google.cloud.metastore.v1.DeleteBackupRequest\x1a\x1d.google.longrunning.Operation\"\x8c\x01\xcaAD\n" +
	...
	"\x15QueryMetadataResponse\x12+google.cloud.metastore.v1.OperationMetadata\x82\xd3\xe4\x93\x02B:\x01*\"=/v1/{service=projects/*/locations/*/services/*}:queryMetadata\x12\x89\x02\n" +
	...
	"\x1bMoveTableToDatabaseResponse\x12+google.cloud.metastore.v1.OperationMetadata\x82\xd3\xe4\x93\x02H:\x01*\"C/v1/{service=projects/*/locations/*/services/*}:moveTableToDatabase\x12\xa1\x02\n" +
	...
	"%AlterMetadataResourceLocationResponse\x12+google.cloud.metastore.v1.OperationMetadata\x82\xd3\xe4\x93\x02B:\x01*\"=/v1/{service=projects/*/locations/*/services/*}:alterLocation\x1aL\xcaA\x18metastore.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\x96\x03\xeaAN\n" +
	...
	"\x1dcom.google.cloud.metastore.v1B\x0eMetastoreProtoP\x01Z;cloud.google.com/go/metastore/apiv1/metastorepb;metastorepb\xca\x02\x19Google\\Cloud\\Metastore\\V1b\x06proto3"

var (
	file_google_cloud_metastore_v1_metastore_proto_rawDescOnce sync.Once
	file_google_cloud_metastore_v1_metastore_proto_rawDescData []byte
)
...
func file_google_cloud_metastore_v1_metastore_proto_rawDescGZIP() []byte {
	file_google_cloud_metastore_v1_metastore_proto_rawDescOnce.Do(func() {
		file_google_cloud_metastore_v1_metastore_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_metastore_v1_metastore_proto_rawDesc), len(file_google_cloud_metastore_v1_metastore_proto_rawDesc)))
	})
...
func file_google_cloud_metastore_v1_metastore_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_metastore_v1_metastore_proto_rawDesc), len(file_google_cloud_metastore_v1_metastore_proto_rawDesc)),
			NumEnums:      14,
			NumMessages:   51,
			NumExtensions: 0,
			NumServices:   1,
