...
const file_google_cloud_metastore_v1_metastore_federation_proto_rawDesc = "" +
	...
	"updateTime\x12I\n" +
	"\x06labels\x18\x04 \x03(\v21.google.cloud.metastore.v1.Federation.LabelsEntryR\x06labels\x12\x1d\n" +
	"\aversion\x18\x05 \x01(\tB\x03\xe0A\x05R\aversion\x12k\n" +
	"\x12backend_metastores\x18\x06 \x03(\v2<.google.cloud.metastore.v1.Federation.BackendMetastoresEntryR\x11backendMetastores\x12&\n" +
	"\fendpoint_uri\x18\a \x01(\tB\x03\xe0A\x03R\vendpointUri\x12F\n" +
	"\x05state\x18\b \x01(\x0e2+.google.cloud.metastore.v1.Federation.StateB\x03\xe0A\x03R\x05state\x12(\n" +
	...
	"\x03key\x18\x01 \x01(\x05R\x03key\x12A\n" +
	"\x05value\x18\x02 \x01(\v2+.google.cloud.metastore.v1.BackendMetastoreR\x05value:\x028\x01\"_\n" +
	"\x05State\x12\x15\n" +
	...
	"#metastore.googleapis.com/Federation\x12@projects/{project}/locations/{location}/federations/{federation}\"\xdf\x01\n" +
	"\x10BackendMetastore\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12`\n" +
	"\x0emetastore_type\x18\x02 \x01(\x0e29.google.cloud.metastore.v1.BackendMetastore.MetastoreTypeR\rmetastoreType\"U\n" +
	...
	"\vfederations\x18\x01 \x03(\v2%.google.cloud.metastore.v1.FederationR\vfederations\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12 \n" +
	"\vunreachable\x18\x03 \x03(\tR\vunreachable\"W\n" +
	"\x14GetFederationRequest\x12?\n" +
	"\x04name\x18\x01 \x01(\tB+\xe0A\x02\xfaA%\n" +
	"#metastore.googleapis.com/FederationR\x04name\"\xf8\x01\n" +
	"\x17CreateFederationRequest\x12C\n" +
	"\x06parent\x18\x01 \x01(\tB+\xe0A\x02\xfaA%\x12#metastore.googleapis.com/FederationR\x06parent\x12(\n" +
	"\rfederation_id\x18\x02 \x01(\tB\x03\xe0A\x02R\ffederationId\x12J\n" +
	"\n" +
	"federation\x18\x03 \x01(\v2%.google.cloud.metastore.v1.FederationB\x03\xe0A\x02R\n" +
	"federation\x12\"\n" +
	"\n" +
	...
	"updateMask\x12J\n" +
	"\n" +
	"federation\x18\x02 \x01(\v2%.google.cloud.metastore.v1.FederationB\x03\xe0A\x02R\n" +
	"federation\x12\"\n" +
	"\n" +
	...
	"\n" +
	"request_id\x18\x02 \x01(\tB\x03\xe0A\x01R\trequestId2\xdc\t\n" +
	...
	"\n" +
	"Federation\x12+google.cloud.metastore.v1.OperationMetadata\xdaA\x1fparent,federation,federation_id\x82\xd3\xe4\x93\x02=:\n" +
	"federation\"//v1/{parent=projects/*/locations/*}/federations\x12\x8b\x02\n" +
	...
	"\n" +
	"Federation\x12+google.cloud.metastore.v1.OperationMetadata\xdaA\x16federation,update_mask\x82\xd3\xe4\x93\x02H:\n" +
	"federation2:/v1/{federation.name=projects/*/locations/*/federations/*}\x12\xed\x01\n" +
...
var (
	...
	file_google_cloud_metastore_v1_metastore_federation_proto_rawDescData []byte
)
...
func file_google_cloud_metastore_v1_metastore_federation_proto_rawDescGZIP() []byte {
	file_google_cloud_metastore_v1_metastore_federation_proto_rawDescOnce.Do(func() {
		file_google_cloud_metastore_v1_metastore_federation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_metastore_v1_metastore_federation_proto_rawDesc), len(file_google_cloud_metastore_v1_metastore_federation_proto_rawDesc)))
	})
...
func file_google_cloud_metastore_v1_metastore_federation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_metastore_v1_metastore_federation_proto_rawDesc), len(file_google_cloud_metastore_v1_metastore_federation_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
