...
func NewApiHubDependenciesRESTClient(ctx context.Context, opts ...option.ClientOption) (*ApiHubDependenciesClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.CreateDependency = append(callOpts.CreateDependency, gax.WithClientMetrics(metrics))
		callOpts.GetDependency = append(callOpts.GetDependency, gax.WithClientMetrics(metrics))
		callOpts.UpdateDependency = append(callOpts.UpdateDependency, gax.WithClientMetrics(metrics))
		callOpts.DeleteDependency = append(callOpts.DeleteDependency, gax.WithClientMetrics(metrics))
		callOpts.ListDependencies = append(callOpts.ListDependencies, gax.WithClientMetrics(metrics))
...
func (c *apiHubDependenciesRESTClient) CreateDependency(ctx context.Context, req *apihubpb.CreateDependencyRequest, opts ...gax.CallOption) (*apihubpb.Dependency, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "CreateDependency")
		if err != nil {
			return err
		}
...
func (c *apiHubDependenciesRESTClient) GetDependency(ctx context.Context, req *apihubpb.GetDependencyRequest, opts ...gax.CallOption) (*apihubpb.Dependency, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "GetDependency")
		if err != nil {
			return err
		}
...
func (c *apiHubDependenciesRESTClient) UpdateDependency(ctx context.Context, req *apihubpb.UpdateDependencyRequest, opts ...gax.CallOption) (*apihubpb.Dependency, error) {
	...
	headers := gax.BuildHeaders(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.apihub.v1.ApiHubDependencies/UpdateDependency")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1/{dependency.name=projects/*/locations/*/dependencies/*}")
	}
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "UpdateDependency")
		if err != nil {
			return err
		}
...
func (c *apiHubDependenciesRESTClient) DeleteDependency(ctx context.Context, req *apihubpb.DeleteDependencyRequest, opts ...gax.CallOption) error {
	...
	return gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		_, err = executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "DeleteDependency")
		return err
	}, opts...)
}
...
func (c *apiHubDependenciesRESTClient) ListDependencies(ctx context.Context, req *apihubpb.ListDependenciesRequest, opts ...gax.CallOption) *DependencyIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*apihubpb.Dependency, string, error) {
		...
		e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			...
			buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "ListDependencies")
			if err != nil {
				return err
			}
			if err := unm.Unmarshal(buf, resp); err != nil {
