...
// provisioningGRPCClient is a client for interacting with API hub API over gRPC transport.
//
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type provisioningGRPCClient struct {
	...
	// The gRPC API client.
	provisioningClient apihubpb.ProvisioningClient
...
func NewProvisioningClient(ctx context.Context, opts ...option.ClientOption) (*ProvisioningClient, error) {
	...
	c := &provisioningGRPCClient{
		connPool:           connPool,
		provisioningClient: apihubpb.NewProvisioningClient(connPool),
...
func (c *provisioningGRPCClient) CreateApiHubInstance(ctx context.Context, req *apihubpb.CreateApiHubInstanceRequest, opts ...gax.CallOption) (*CreateApiHubInstanceOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).CreateApiHubInstance[0:len((*c.CallOptions).CreateApiHubInstance):len((*c.CallOptions).CreateApiHubInstance)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.provisioningClient.CreateApiHubInstance(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *provisioningGRPCClient) GetApiHubInstance(ctx context.Context, req *apihubpb.GetApiHubInstanceRequest, opts ...gax.CallOption) (*apihubpb.ApiHubInstance, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.provisioningClient.GetApiHubInstance(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *provisioningGRPCClient) LookupApiHubInstance(ctx context.Context, req *apihubpb.LookupApiHubInstanceRequest, opts ...gax.CallOption) (*apihubpb.LookupApiHubInstanceResponse, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}
	...
	var resp *apihubpb.LookupApiHubInstanceResponse
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.provisioningClient.LookupApiHubInstance(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
// CreateApiHubInstanceOperation returns a new CreateApiHubInstanceOperation from a given name.
// The name must be that of a previously created CreateApiHubInstanceOperation, possibly from a different process.
func (c *provisioningGRPCClient) CreateApiHubInstanceOperation(name string) *CreateApiHubInstanceOperation {
	return &CreateApiHubInstanceOperation{
