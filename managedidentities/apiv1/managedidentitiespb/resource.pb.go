...
func file_google_cloud_managedidentities_v1_resource_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_managedidentities_v1_resource_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Domain); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_cloud_managedidentities_v1_resource_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Trust); i {
			case 0:
				return &v.state
			case 1:
