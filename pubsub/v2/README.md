...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/pubsub/v2.svg)](https://pkg.go.dev/cloud.google.com/go/pubsub/v2)

Go Client Library for Cloud Pub/Sub API.
