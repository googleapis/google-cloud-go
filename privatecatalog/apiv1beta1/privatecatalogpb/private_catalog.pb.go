...
type Product struct {
	...
	DisplayMetadata *_struct.Struct `protobuf:"bytes,3,opt,name=display_metadata,json=displayMetadata,proto3" json:"display_metadata,omitempty"`
...
func (x *Product) GetDisplayMetadata() *_struct.Struct {
	if x != nil {
...
func (x *Product) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *Product) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *AssetReference) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *AssetReference) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *Inputs) GetParameters() *_struct.Struct {
	if x != nil {
		return x.Parameters
	}
	return nil
...
func (x *GcsSource) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *Version) GetAsset() *_struct.Struct {
	if x != nil {
		return x.Asset
	}
	return nil
