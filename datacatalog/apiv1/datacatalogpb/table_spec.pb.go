...
const file_google_cloud_datacatalog_v1_table_spec_proto_rawDesc = "" +
	"\n" +
	",google/cloud/datacatalog/v1/table_spec.proto\x12\x1bgoogle.cloud.datacatalog.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\x8e\x02\n" +
	"\x11BigQueryTableSpec\x12]\n" +
	"\x11table_source_type\x18\x01 \x01(\x0e2,.google.cloud.datacatalog.v1.TableSourceTypeB\x03\xe0A\x03R\x0ftableSourceType\x12D\n" +
	"\tview_spec\x18\x02 \x01(\v2%.google.cloud.datacatalog.v1.ViewSpecH\x00R\bviewSpec\x12G\n" +
	"\n" +
	"table_spec\x18\x03 \x01(\v2&.google.cloud.datacatalog.v1.TableSpecH\x00R\ttableSpecB\v\n" +
	"\ttype_spec\".\n" +
	"\bViewSpec\x12\"\n" +
	"\n" +
	...
	" datacatalog.googleapis.com/EntryR\fgroupedEntry\"\xe4\x01\n" +
	...
	"shardCount\x127\n" +
	"\x15latest_shard_resource\x18\x04 \x01(\tB\x03\xe0A\x03R\x13latestShardResource*{\n" +
	...
	"\x1aBIGQUERY_MATERIALIZED_VIEW\x10\aB\xc3\x01\n" +
...
var (
	...
	file_google_cloud_datacatalog_v1_table_spec_proto_rawDescData []byte
)
...
func file_google_cloud_datacatalog_v1_table_spec_proto_rawDescGZIP() []byte {
	file_google_cloud_datacatalog_v1_table_spec_proto_rawDescOnce.Do(func() {
		file_google_cloud_datacatalog_v1_table_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_datacatalog_v1_table_spec_proto_rawDesc), len(file_google_cloud_datacatalog_v1_table_spec_proto_rawDesc)))
	})
...
var file_google_cloud_datacatalog_v1_table_spec_proto_goTypes = []any{
...
func file_google_cloud_datacatalog_v1_table_spec_proto_init() {
	...
	file_google_cloud_datacatalog_v1_table_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_datacatalog_v1_table_spec_proto_rawDesc), len(file_google_cloud_datacatalog_v1_table_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
