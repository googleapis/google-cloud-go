...
var file_google_cloud_datacatalog_v1_table_spec_proto_rawDesc = []byte{
	...
	0x44, 0x5f, 0x56, 0x49, 0x45, 0x57, 0x10, 0x07, 0x42, 0xc3, 0x01, 0x0a, 0x1f, 0x63, 0x6f, 0x6d,
...
func file_google_cloud_datacatalog_v1_table_spec_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_datacatalog_v1_table_spec_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_datacatalog_v1_table_spec_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_datacatalog_v1_table_spec_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_datacatalog_v1_table_spec_proto_msgTypes[3].Exporter = func(v any, i int) any {
