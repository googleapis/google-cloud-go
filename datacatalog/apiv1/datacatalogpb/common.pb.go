...
const file_google_cloud_datacatalog_v1_common_proto_rawDesc = "" +
	"\n" +
	"(google/cloud/datacatalog/v1/common.proto\x12\x1bgoogle.cloud.datacatalog.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"d\n" +
	"\x0fPersonalDetails\x12\x18\n" +
	"\astarred\x18\x01 \x01(\bR\astarred\x127\n" +
	"\tstar_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\bstarTime*\xcc\x01\n" +
	"\x10IntegratedSystem\x12!\n" +
	"\x1dINTEGRATED_SYSTEM_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bBIGQUERY\x10\x01\x12\x10\n" +
	"\fCLOUD_PUBSUB\x10\x02\x12\x16\n" +
	"\x12DATAPROC_METASTORE\x10\x03\x12\f\n" +
	"\bDATAPLEX\x10\x04\x12\x11\n" +
	"\rCLOUD_SPANNER\x10\x06\x12\x12\n" +
	"\x0eCLOUD_BIGTABLE\x10\a\x12\r\n" +
	"\tCLOUD_SQL\x10\b\x12\n" +
	"\n" +
	"\x06LOOKER\x10\t\x12\r\n" +
	"\tVERTEX_AI\x10\n" +
...
var (
	...
	file_google_cloud_datacatalog_v1_common_proto_rawDescData []byte
)
...
func file_google_cloud_datacatalog_v1_common_proto_rawDescGZIP() []byte {
	file_google_cloud_datacatalog_v1_common_proto_rawDescOnce.Do(func() {
		file_google_cloud_datacatalog_v1_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_datacatalog_v1_common_proto_rawDesc), len(file_google_cloud_datacatalog_v1_common_proto_rawDesc)))
	})
...
func file_google_cloud_datacatalog_v1_common_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_datacatalog_v1_common_proto_rawDesc), len(file_google_cloud_datacatalog_v1_common_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
