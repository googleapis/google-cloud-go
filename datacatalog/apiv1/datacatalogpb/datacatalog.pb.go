...
func file_google_cloud_datacatalog_v1_datacatalog_proto_init() {
	...
	file_google_cloud_datacatalog_v1_datacatalog_proto_msgTypes[55].OneofWrappers = []any{
		(*ImportEntriesRequest_GcsBucketPath)(nil),
	}
	file_google_cloud_datacatalog_v1_datacatalog_proto_msgTypes[56].OneofWrappers = []any{}
	file_google_cloud_datacatalog_v1_datacatalog_proto_msgTypes[62].OneofWrappers = []any{
