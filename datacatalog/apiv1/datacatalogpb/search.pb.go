...
func (x *SearchCatalogResult) GetSystem() isSearchCatalogResult_System {
	if x != nil {
		return x.System
	}
	return nil
...
func (x *SearchCatalogResult) GetIntegratedSystem() IntegratedSystem {
	if x != nil {
		if x, ok := x.System.(*SearchCatalogResult_IntegratedSystem); ok {
...
func (x *SearchCatalogResult) GetUserSpecifiedSystem() string {
	if x != nil {
		if x, ok := x.System.(*SearchCatalogResult_UserSpecifiedSystem); ok {
...
const file_google_cloud_datacatalog_v1_search_proto_rawDesc = "" +
	"\n" +
	"(google/cloud/datacatalog/v1/search.proto\x12\x1bgoogle.cloud.datacatalog.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a(google/cloud/datacatalog/v1/common.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xdc\x04\n" +
	"\x13SearchCatalogResult\x12[\n" +
	"\x12search_result_type\x18\x01 \x01(\x0e2-.google.cloud.datacatalog.v1.SearchResultTypeR\x10searchResultType\x122\n" +
	...
	"modifyTime\x12a\n" +
	"\x11integrated_system\x18\b \x01(\x0e2-.google.cloud.datacatalog.v1.IntegratedSystemB\x03\xe0A\x03H\x00R\x10integratedSystem\x124\n" +
	"\x15user_specified_system\x18\t \x01(\tH\x00R\x13userSpecifiedSystem\x120\n" +
	"\x14fully_qualified_name\x18\n" +
	" \x01(\tR\x12fullyQualifiedName\x12!\n" +
	"\fdisplay_name\x18\f \x01(\tR\vdisplayName\x12 \n" +
	"\vdescription\x18\r \x01(\tR\vdescriptionB\b\n" +
	"\x06system*d\n" +
...
var (
	...
	file_google_cloud_datacatalog_v1_search_proto_rawDescData []byte
)
...
func file_google_cloud_datacatalog_v1_search_proto_rawDescGZIP() []byte {
	file_google_cloud_datacatalog_v1_search_proto_rawDescOnce.Do(func() {
		file_google_cloud_datacatalog_v1_search_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_datacatalog_v1_search_proto_rawDesc), len(file_google_cloud_datacatalog_v1_search_proto_rawDesc)))
	})
...
func file_google_cloud_datacatalog_v1_search_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_datacatalog_v1_search_proto_rawDesc), len(file_google_cloud_datacatalog_v1_search_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
