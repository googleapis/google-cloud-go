...
func (x *PhysicalSchema) GetSchema() isPhysicalSchema_Schema {
	if x != nil {
		return x.Schema
	}
	return nil
...
func (x *PhysicalSchema) GetAvro() *PhysicalSchema_AvroSchema {
	if x != nil {
		if x, ok := x.Schema.(*PhysicalSchema_Avro); ok {
			return x.Avro
		}
	}
	return nil
...
func (x *PhysicalSchema) GetThrift() *PhysicalSchema_ThriftSchema {
	if x != nil {
		if x, ok := x.Schema.(*PhysicalSchema_Thrift); ok {
			return x.Thrift
		}
	}
	return nil
...
func (x *PhysicalSchema) GetProtobuf() *PhysicalSchema_ProtobufSchema {
	if x != nil {
		if x, ok := x.Schema.(*PhysicalSchema_Protobuf); ok {
			return x.Protobuf
		}
	}
	return nil
...
func (x *PhysicalSchema) GetParquet() *PhysicalSchema_ParquetSchema {
	if x != nil {
		if x, ok := x.Schema.(*PhysicalSchema_Parquet); ok {
			return x.Parquet
		}
	}
	return nil
...
func (x *PhysicalSchema) GetOrc() *PhysicalSchema_OrcSchema {
	if x != nil {
		if x, ok := x.Schema.(*PhysicalSchema_Orc); ok {
			return x.Orc
		}
	}
	return nil
...
func (x *PhysicalSchema) GetCsv() *PhysicalSchema_CsvSchema {
	if x != nil {
		if x, ok := x.Schema.(*PhysicalSchema_Csv); ok {
			return x.Csv
		}
	}
	return nil
...
const file_google_cloud_datacatalog_v1_physical_schema_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/datacatalog/v1/physical_schema.proto\x12\x1bgoogle.cloud.datacatalog.v1\"\x9a\x05\n" +
	"\x0ePhysicalSchema\x12L\n" +
	"\x04avro\x18\x01 \x01(\v26.google.cloud.datacatalog.v1.PhysicalSchema.AvroSchemaH\x00R\x04avro\x12R\n" +
	"\x06thrift\x18\x02 \x01(\v28.google.cloud.datacatalog.v1.PhysicalSchema.ThriftSchemaH\x00R\x06thrift\x12X\n" +
	"\bprotobuf\x18\x03 \x01(\v2:.google.cloud.datacatalog.v1.PhysicalSchema.ProtobufSchemaH\x00R\bprotobuf\x12U\n" +
	"\aparquet\x18\x04 \x01(\v29.google.cloud.datacatalog.v1.PhysicalSchema.ParquetSchemaH\x00R\aparquet\x12I\n" +
	"\x03orc\x18\x05 \x01(\v25.google.cloud.datacatalog.v1.PhysicalSchema.OrcSchemaH\x00R\x03orc\x12I\n" +
	"\x03csv\x18\x06 \x01(\v25.google.cloud.datacatalog.v1.PhysicalSchema.CsvSchemaH\x00R\x03csv\x1a \n" +
	"\n" +
	"AvroSchema\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x1a\"\n" +
	"\fThriftSchema\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x1a$\n" +
	"\x0eProtobufSchema\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x1a\x0f\n" +
	"\rParquetSchema\x1a\v\n" +
	"\tOrcSchema\x1a\v\n" +
	"\tCsvSchemaB\b\n" +
	"\x06schemaB\xd8\x01\n" +
...
var (
	...
	file_google_cloud_datacatalog_v1_physical_schema_proto_rawDescData []byte
)
...
func file_google_cloud_datacatalog_v1_physical_schema_proto_rawDescGZIP() []byte {
	file_google_cloud_datacatalog_v1_physical_schema_proto_rawDescOnce.Do(func() {
		file_google_cloud_datacatalog_v1_physical_schema_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_datacatalog_v1_physical_schema_proto_rawDesc), len(file_google_cloud_datacatalog_v1_physical_schema_proto_rawDesc)))
	})
...
func file_google_cloud_datacatalog_v1_physical_schema_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_datacatalog_v1_physical_schema_proto_rawDesc), len(file_google_cloud_datacatalog_v1_physical_schema_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
