...
const file_google_cloud_datacatalog_v1_policytagmanager_proto_rawDesc = "" +
	...
	"\x10policy_tag_count\x18\x04 \x01(\x05B\x03\xe0A\x03R\x0epolicyTagCount\x12c\n" +
	"\x13taxonomy_timestamps\x18\x05 \x01(\v2-.google.cloud.datacatalog.v1.SystemTimestampsB\x03\xe0A\x03R\x12taxonomyTimestamps\x12k\n" +
	"\x16activated_policy_types\x18\x06 \x03(\x0e20.google.cloud.datacatalog.v1.Taxonomy.PolicyTypeB\x03\xe0A\x01R\x14activatedPolicyTypes\x12L\n" +
	"\aservice\x18\a \x01(\v2-.google.cloud.datacatalog.v1.Taxonomy.ServiceB\x03\xe0A\x03R\aservice\x1af\n" +
	"\aService\x12?\n" +
	"\x04name\x18\x01 \x01(\x0e2+.google.cloud.datacatalog.v1.ManagingSystemR\x04name\x12\x1a\n" +
	...
	"$datacatalog.googleapis.com/PolicyTag\x12Uprojects/{project}/locations/{location}/taxonomies/{taxonomy}/policyTags/{policy_tag}\"\x9f\x01\n" +
	"\x15CreateTaxonomyRequest\x12C\n" +
	"\x06parent\x18\x01 \x01(\tB+\xe0A\x02\xfaA%\x12#datacatalog.googleapis.com/TaxonomyR\x06parent\x12A\n" +
	"\btaxonomy\x18\x02 \x01(\v2%.google.cloud.datacatalog.v1.TaxonomyR\btaxonomy\"X\n" +
	"\x15DeleteTaxonomyRequest\x12?\n" +
	"\x04name\x18\x01 \x01(\tB+\xe0A\x02\xfaA%\n" +
	"#datacatalog.googleapis.com/TaxonomyR\x04name\"\x97\x01\n" +
	"\x15UpdateTaxonomyRequest\x12A\n" +
	"\btaxonomy\x18\x01 \x01(\v2%.google.cloud.datacatalog.v1.TaxonomyR\btaxonomy\x12;\n" +
	...
	"\x16ListTaxonomiesResponse\x12E\n" +
	"\n" +
	...
	"\x04name\x18\x01 \x01(\tB+\xe0A\x02\xfaA%\n" +
	"#datacatalog.googleapis.com/TaxonomyR\x04name\"\xa5\x01\n" +
	"\x16CreatePolicyTagRequest\x12D\n" +
	"\x06parent\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\x12$datacatalog.googleapis.com/PolicyTagR\x06parent\x12E\n" +
	"\n" +
	"policy_tag\x18\x02 \x01(\v2&.google.cloud.datacatalog.v1.PolicyTagR\tpolicyTag\"Z\n" +
	"\x16DeletePolicyTagRequest\x12@\n" +
	"\x04name\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\n" +
	"$datacatalog.googleapis.com/PolicyTagR\x04name\"\x9c\x01\n" +
	"\x16UpdatePolicyTagRequest\x12E\n" +
	"\n" +
	"policy_tag\x18\x01 \x01(\v2&.google.cloud.datacatalog.v1.PolicyTagR\tpolicyTag\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"\x99\x01\n" +
	...
	"\vpolicy_tags\x18\x01 \x03(\v2&.google.cloud.datacatalog.v1.PolicyTagR\n" +
	"policyTags\x12&\n" +
	...
	"\x0eCreateTaxonomy\x122.google.cloud.datacatalog.v1.CreateTaxonomyRequest\x1a%.google.cloud.datacatalog.v1.Taxonomy\"R\xdaA\x0fparent,taxonomy\x82\xd3\xe4\x93\x02::\btaxonomy\"./v1/{parent=projects/*/locations/*}/taxonomies\x12\x9b\x01\n" +
	...
	"\x0eUpdateTaxonomy\x122.google.cloud.datacatalog.v1.UpdateTaxonomyRequest\x1a%.google.cloud.datacatalog.v1.Taxonomy\"T\xdaA\btaxonomy\x82\xd3\xe4\x93\x02C:\btaxonomy27/v1/{taxonomy.name=projects/*/locations/*/taxonomies/*}\x12\xba\x01\n" +
	...
	"\vGetTaxonomy\x12/.google.cloud.datacatalog.v1.GetTaxonomyRequest\x1a%.google.cloud.datacatalog.v1.Taxonomy\"=\xdaA\x04name\x82\xd3\xe4\x93\x020\x12./v1/{name=projects/*/locations/*/taxonomies/*}\x12\xd3\x01\n" +
	"\x0fCreatePolicyTag\x123.google.cloud.datacatalog.v1.CreatePolicyTagRequest\x1a&.google.cloud.datacatalog.v1.PolicyTag\"c\xdaA\x11parent,policy_tag\x82\xd3\xe4\x93\x02I:\n" +
	"policy_tag\";/v1/{parent=projects/*/locations/*/taxonomies/*}/policyTags\x12\xaa\x01\n" +
	...
	"policy_tag\x82\xd3\xe4\x93\x02T:\n" +
	"policy_tag2F/v1/{policy_tag.name=projects/*/locations/*/taxonomies/*/policyTags/*}\x12\xc7\x01\n" +
	...
	"\fGetPolicyTag\x120.google.cloud.datacatalog.v1.GetPolicyTagRequest\x1a&.google.cloud.datacatalog.v1.PolicyTag\"J\xdaA\x04name\x82\xd3\xe4\x93\x02=\x12;/v1/{name=projects/*/locations/*/taxonomies/*/policyTags/*}\x12\xea\x01\n" +
	"\fGetIamPolicy\x12\".google.iam.v1.GetIamPolicyRequest\x1a\x15.google.iam.v1.Policy\"\x9e\x01\x82\xd3\xe4\x93\x02\x97\x01:\x01*ZQ:\x01*\"L/v1/{resource=projects/*/locations/*/taxonomies/*/policyTags/*}:getIamPolicy\"?/v1/{resource=projects/*/locations/*/taxonomies/*}:getIamPolicy\x12\xea\x01\n" +
	"\fSetIamPolicy\x12\".google.iam.v1.SetIamPolicyRequest\x1a\x15.google.iam.v1.Policy\"\x9e\x01\x82\xd3\xe4\x93\x02\x97\x01:\x01*ZQ:\x01*\"L/v1/{resource=projects/*/locations/*/taxonomies/*/policyTags/*}:setIamPolicy\"?/v1/{resource=projects/*/locations/*/taxonomies/*}:setIamPolicy\x12\x96\x02\n" +
	"\x12TestIamPermissions\x12(.google.iam.v1.TestIamPermissionsRequest\x1a).google.iam.v1.TestIamPermissionsResponse\"\xaa\x01\x82\xd3\xe4\x93\x02\xa3\x01:\x01*ZW:\x01*\"R/v1/{resource=projects/*/locations/*/taxonomies/*/policyTags/*}:testIamPermissions\"E/v1/{resource=projects/*/locations/*/taxonomies/*}:testIamPermissions\x1aN\xcaA\x1adatacatalog.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xda\x01\n" +
...
var (
	...
	file_google_cloud_datacatalog_v1_policytagmanager_proto_rawDescData []byte
)
...
func file_google_cloud_datacatalog_v1_policytagmanager_proto_rawDescGZIP() []byte {
	file_google_cloud_datacatalog_v1_policytagmanager_proto_rawDescOnce.Do(func() {
		file_google_cloud_datacatalog_v1_policytagmanager_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_datacatalog_v1_policytagmanager_proto_rawDesc), len(file_google_cloud_datacatalog_v1_policytagmanager_proto_rawDesc)))
	})
...
func file_google_cloud_datacatalog_v1_policytagmanager_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_datacatalog_v1_policytagmanager_proto_rawDesc), len(file_google_cloud_datacatalog_v1_policytagmanager_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   1,
