...
type UsageSignal struct {
	...
	CommonUsageWithinTimeRange map[string]*CommonUsageStats `protobuf:"bytes,3,rep,name=common_usage_within_time_range,json=commonUsageWithinTimeRange,proto3" json:"common_usage_within_time_range,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_google_cloud_datacatalog_v1_usage_proto_rawDesc = "" +
	"\n" +
	"'google/cloud/datacatalog/v1/usage.proto\x12\x1bgoogle.cloud.datacatalog.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xee\x01\n" +
	"\n" +
	"UsageStats\x12+\n" +
	...
	"+total_execution_time_for_completions_millis\x18\x04 \x01(\x02R&totalExecutionTimeForCompletionsMillis\"E\n" +
	"\x10CommonUsageStats\x12\"\n" +
	"\n" +
	"view_count\x18\x01 \x01(\x03H\x00R\tviewCount\x88\x01\x01B\r\n" +
	"\v_view_count\"\x88\x05\n" +
	"\vUsageSignal\x12;\n" +
	"\vupdate_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\x12~\n" +
	"\x17usage_within_time_range\x18\x02 \x03(\v2B.google.cloud.datacatalog.v1.UsageSignal.UsageWithinTimeRangeEntryB\x03\xe0A\x03R\x14usageWithinTimeRange\x12\x8c\x01\n" +
	"\x1ecommon_usage_within_time_range\x18\x03 \x03(\v2H.google.cloud.datacatalog.v1.UsageSignal.CommonUsageWithinTimeRangeEntryR\x1acommonUsageWithinTimeRange\x12*\n" +
	"\x0efavorite_count\x18\x04 \x01(\x03H\x00R\rfavoriteCount\x88\x01\x01\x1ap\n" +
	"\x19UsageWithinTimeRangeEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12=\n" +
	"\x05value\x18\x02 \x01(\v2'.google.cloud.datacatalog.v1.UsageStatsR\x05value:\x028\x01\x1a|\n" +
	"\x1fCommonUsageWithinTimeRangeEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12C\n" +
	"\x05value\x18\x02 \x01(\v2-.google.cloud.datacatalog.v1.CommonUsageStatsR\x05value:\x028\x01B\x11\n" +
...
var (
	...
	file_google_cloud_datacatalog_v1_usage_proto_rawDescData []byte
)
...
func file_google_cloud_datacatalog_v1_usage_proto_rawDescGZIP() []byte {
	file_google_cloud_datacatalog_v1_usage_proto_rawDescOnce.Do(func() {
		file_google_cloud_datacatalog_v1_usage_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_datacatalog_v1_usage_proto_rawDesc), len(file_google_cloud_datacatalog_v1_usage_proto_rawDesc)))
	})
...
func file_google_cloud_datacatalog_v1_usage_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_datacatalog_v1_usage_proto_rawDesc), len(file_google_cloud_datacatalog_v1_usage_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
