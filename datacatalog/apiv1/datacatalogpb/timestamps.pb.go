...
var file_google_cloud_datacatalog_v1_timestamps_proto_rawDesc = []byte{
	...
	0x41, 0x03, 0x52, 0x0a, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x42, 0xc3,
...
func file_google_cloud_datacatalog_v1_timestamps_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_datacatalog_v1_timestamps_proto_msgTypes[0].Exporter = func(v any, i int) any {
