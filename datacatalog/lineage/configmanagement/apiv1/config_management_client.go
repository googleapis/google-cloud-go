...
type internalClient interface {
	...
	GetConfig(context.Context, *configmanagementpb.GetConfigRequest, ...gax.CallOption) (*configmanagementpb.Config, error)
	UpdateConfig(context.Context, *configmanagementpb.UpdateConfigRequest, ...gax.CallOption) (*configmanagementpb.Config, error)
...
// GetConfig get the Config for a given resource.
func (c *Client) GetConfig(ctx context.Context, req *configmanagementpb.GetConfigRequest, opts ...gax.CallOption) (*configmanagementpb.Config, error) {
	return c.internalClient.GetConfig(ctx, req, opts...)
}

// UpdateConfig update the Config for a given resource.
func (c *Client) UpdateConfig(ctx context.Context, req *configmanagementpb.UpdateConfigRequest, opts ...gax.CallOption) (*configmanagementpb.Config, error) {
...
type gRPCClient struct {
	...
	// The gRPC API client.
	client configmanagementpb.ConfigManagementServiceClient
...
// NewClient creates a new config management service client based on gRPC.
...
func NewClient(ctx context.Context, opts ...option.ClientOption) (*Client, error) {
	...
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		clientOpts = append(clientOpts, internaloption.WithTelemetryAttributes(map[string]string{
			...
			"gcp.client.artifact": "cloud.google.com/go/datacatalog/lineage/configmanagement/apiv1",
	...
	c := &gRPCClient{
		connPool:         connPool,
		client:           configmanagementpb.NewConfigManagementServiceClient(connPool),
...
// NewRESTClient creates a new config management service rest client.
//
// Lineage Config Management service. Config Management service is used to
// manage the configuration for Data Lineage. These Configs define different
// configuration options for Lineage customers to control behaviour of lineage
...
func (c *gRPCClient) GetConfig(ctx context.Context, req *configmanagementpb.GetConfigRequest, opts ...gax.CallOption) (*configmanagementpb.Config, error) {
	...
	var resp *configmanagementpb.Config
...
func (c *gRPCClient) UpdateConfig(ctx context.Context, req *configmanagementpb.UpdateConfigRequest, opts ...gax.CallOption) (*configmanagementpb.Config, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "config.name", url.QueryEscape(req.GetConfig().GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.datacatalog.lineage.configmanagement.v1.ConfigManagementService/UpdateConfig")
	}
...
// GetConfig get the Config for a given resource.
func (c *restClient) GetConfig(ctx context.Context, req *configmanagementpb.GetConfigRequest, opts ...gax.CallOption) (*configmanagementpb.Config, error) {
	...
	resp := &configmanagementpb.Config{}
...
// UpdateConfig update the Config for a given resource.
func (c *restClient) UpdateConfig(ctx context.Context, req *configmanagementpb.UpdateConfigRequest, opts ...gax.CallOption) (*configmanagementpb.Config, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.datacatalog.lineage.configmanagement.v1.ConfigManagementService/UpdateConfig")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1/{config.name=projects/*/locations/*/config}")
	}
	opts = append((*c.CallOptions).UpdateConfig[0:len((*c.CallOptions).UpdateConfig):len((*c.CallOptions).UpdateConfig)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &configmanagementpb.Config{}
