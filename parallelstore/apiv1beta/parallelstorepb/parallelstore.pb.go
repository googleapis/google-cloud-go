...
func file_google_cloud_parallelstore_v1beta_parallelstore_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_parallelstore_v1beta_parallelstore_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_parallelstore_v1beta_parallelstore_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_parallelstore_v1beta_parallelstore_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_parallelstore_v1beta_parallelstore_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_parallelstore_v1beta_parallelstore_proto_msgTypes[12].OneofWrappers = []interface{}{
		(*ImportDataRequest_SourceGcsBucket)(nil),
		(*ImportDataRequest_DestinationParallelstore)(nil),
	}
	file_google_cloud_parallelstore_v1beta_parallelstore_proto_msgTypes[13].OneofWrappers = []interface{}{
		(*ExportDataRequest_SourceParallelstore)(nil),
		(*ExportDataRequest_DestinationGcsBucket)(nil),
	}
	file_google_cloud_parallelstore_v1beta_parallelstore_proto_msgTypes[18].OneofWrappers = []interface{}{
