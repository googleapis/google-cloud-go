...
func defaultGRPCClientOptions() []option.ClientOption {
	return []option.ClientOption{
		internaloption.WithDefaultEndpoint("hypercomputecluster.googleapis.com:443"),
		internaloption.WithDefaultEndpointTemplate("hypercomputecluster.UNIVERSE_DOMAIN:443"),
		internaloption.WithDefaultMTLSEndpoint("hypercomputecluster.mtls.googleapis.com:443"),
		internaloption.WithDefaultUniverseDomain("googleapis.com"),
		internaloption.WithDefaultAudience("https://hypercomputecluster.googleapis.com/"),
...
// internalClient is an interface that defines the methods available from Cluster Director API.
type internalClient interface {
	Close() error
	setGoogleClientInfo(...string)
	Connection() *grpc.ClientConn
	ListClusters(context.Context, *hypercomputeclusterpb.ListClustersRequest, ...gax.CallOption) *ClusterIterator
	GetCluster(context.Context, *hypercomputeclusterpb.GetClusterRequest, ...gax.CallOption) (*hypercomputeclusterpb.Cluster, error)
	CreateCluster(context.Context, *hypercomputeclusterpb.CreateClusterRequest, ...gax.CallOption) (*CreateClusterOperation, error)
	CreateClusterOperation(name string) *CreateClusterOperation
	UpdateCluster(context.Context, *hypercomputeclusterpb.UpdateClusterRequest, ...gax.CallOption) (*UpdateClusterOperation, error)
	UpdateClusterOperation(name string) *UpdateClusterOperation
	DeleteCluster(context.Context, *hypercomputeclusterpb.DeleteClusterRequest, ...gax.CallOption) (*DeleteClusterOperation, error)
...
// Client is a client for interacting with Cluster Director API.
...
func (c *Client) ListClusters(ctx context.Context, req *hypercomputeclusterpb.ListClustersRequest, opts ...gax.CallOption) *ClusterIterator {
	return c.internalClient.ListClusters(ctx, req, opts...)
}

// GetCluster gets details of a single Cluster.
func (c *Client) GetCluster(ctx context.Context, req *hypercomputeclusterpb.GetClusterRequest, opts ...gax.CallOption) (*hypercomputeclusterpb.Cluster, error) {
	return c.internalClient.GetCluster(ctx, req, opts...)
}

// CreateCluster creates a new Cluster in a given project and location.
func (c *Client) CreateCluster(ctx context.Context, req *hypercomputeclusterpb.CreateClusterRequest, opts ...gax.CallOption) (*CreateClusterOperation, error) {
...
func (c *Client) UpdateCluster(ctx context.Context, req *hypercomputeclusterpb.UpdateClusterRequest, opts ...gax.CallOption) (*UpdateClusterOperation, error) {
...
func (c *Client) DeleteCluster(ctx context.Context, req *hypercomputeclusterpb.DeleteClusterRequest, opts ...gax.CallOption) (*DeleteClusterOperation, error) {
...
// gRPCClient is a client for interacting with Cluster Director API over gRPC transport.
//
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type gRPCClient struct {
	...
	// The gRPC API client.
	client hypercomputeclusterpb.HypercomputeClusterClient
...
// NewClient creates a new hypercompute cluster client based on gRPC.
...
func NewClient(ctx context.Context, opts ...option.ClientOption) (*Client, error) {
	...
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		clientOpts = append(clientOpts, internaloption.WithTelemetryAttributes(map[string]string{
			"gcp.client.service":  "hypercomputecluster",
			"gcp.client.version":  getVersionClient(),
			"gcp.client.repo":     "googleapis/google-cloud-go",
			"gcp.client.artifact": "cloud.google.com/go/hypercomputecluster/apiv1",
			"gcp.client.language": "go",
			"url.domain":          "hypercomputecluster.googleapis.com",
		}))
	}
	...
	c := &gRPCClient{
		connPool:         connPool,
		client:           hypercomputeclusterpb.NewHypercomputeClusterClient(connPool),
	...
	if gax.IsFeatureEnabled("METRICS") {
		metrics := gax.NewClientMetrics(
			...
			gax.WithTelemetryAttributes(map[string]string{
				...
				gax.ClientArtifact: "cloud.google.com/go/hypercomputecluster/apiv1",
				gax.RPCSystem:      "grpc",
...
// NewRESTClient creates a new hypercompute cluster rest client.
//
// Service describing handlers for resources
...
func defaultRESTClientOptions() []option.ClientOption {
	return []option.ClientOption{
		internaloption.WithDefaultEndpoint("https://hypercomputecluster.googleapis.com"),
		internaloption.WithDefaultEndpointTemplate("https://hypercomputecluster.UNIVERSE_DOMAIN"),
		internaloption.WithDefaultMTLSEndpoint("https://hypercomputecluster.mtls.googleapis.com"),
		internaloption.WithDefaultUniverseDomain("googleapis.com"),
		internaloption.WithDefaultAudience("https://hypercomputecluster.googleapis.com/"),
		internaloption.WithDefaultScopes(DefaultAuthScopes()...),
		internaloption.EnableNewAuthLibrary(),
...
func (c *gRPCClient) ListClusters(ctx context.Context, req *hypercomputeclusterpb.ListClustersRequest, opts ...gax.CallOption) *ClusterIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.hypercomputecluster.v1.HypercomputeCluster/ListClusters")
	}
	opts = append((*c.CallOptions).ListClusters[0:len((*c.CallOptions).ListClusters):len((*c.CallOptions).ListClusters)], opts...)
	it := &ClusterIterator{}
	req = proto.Clone(req).(*hypercomputeclusterpb.ListClustersRequest)
	it.InternalFetch = func(pageSize int, pageToken string) ([]*hypercomputeclusterpb.Cluster, string, error) {
		resp := &hypercomputeclusterpb.ListClustersResponse{}
		if pageToken != "" {
...
func (c *gRPCClient) GetCluster(ctx context.Context, req *hypercomputeclusterpb.GetClusterRequest, opts ...gax.CallOption) (*hypercomputeclusterpb.Cluster, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.hypercomputecluster.v1.HypercomputeCluster/GetCluster")
	}
	opts = append((*c.CallOptions).GetCluster[0:len((*c.CallOptions).GetCluster):len((*c.CallOptions).GetCluster)], opts...)
	var resp *hypercomputeclusterpb.Cluster
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
...
func (c *gRPCClient) CreateCluster(ctx context.Context, req *hypercomputeclusterpb.CreateClusterRequest, opts ...gax.CallOption) (*CreateClusterOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.hypercomputecluster.v1.HypercomputeCluster/CreateCluster")
	}
...
func (c *gRPCClient) UpdateCluster(ctx context.Context, req *hypercomputeclusterpb.UpdateClusterRequest, opts ...gax.CallOption) (*UpdateClusterOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "cluster.name", url.QueryEscape(req.GetCluster().GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.hypercomputecluster.v1.HypercomputeCluster/UpdateCluster")
	}
...
func (c *gRPCClient) DeleteCluster(ctx context.Context, req *hypercomputeclusterpb.DeleteClusterRequest, opts ...gax.CallOption) (*DeleteClusterOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.hypercomputecluster.v1.HypercomputeCluster/DeleteCluster")
	}
...
// ListClusters lists Clusters in a given project and location.
func (c *restClient) ListClusters(ctx context.Context, req *hypercomputeclusterpb.ListClustersRequest, opts ...gax.CallOption) *ClusterIterator {
	it := &ClusterIterator{}
	req = proto.Clone(req).(*hypercomputeclusterpb.ListClustersRequest)
...
// GetCluster gets details of a single Cluster.
func (c *restClient) GetCluster(ctx context.Context, req *hypercomputeclusterpb.GetClusterRequest, opts ...gax.CallOption) (*hypercomputeclusterpb.Cluster, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	opts = append((*c.CallOptions).GetCluster[0:len((*c.CallOptions).GetCluster):len((*c.CallOptions).GetCluster)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &hypercomputeclusterpb.Cluster{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
// CreateCluster creates a new Cluster in a given project and location.
func (c *restClient) CreateCluster(ctx context.Context, req *hypercomputeclusterpb.CreateClusterRequest, opts ...gax.CallOption) (*CreateClusterOperation, error) {
...
// UpdateCluster updates the parameters of a single Cluster.
func (c *restClient) UpdateCluster(ctx context.Context, req *hypercomputeclusterpb.UpdateClusterRequest, opts ...gax.CallOption) (*UpdateClusterOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetCluster()
	jsonReq, err := m.Marshal(body)
	if err != nil {
...
// DeleteCluster deletes a single Cluster.
func (c *restClient) DeleteCluster(ctx context.Context, req *hypercomputeclusterpb.DeleteClusterRequest, opts ...gax.CallOption) (*DeleteClusterOperation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
