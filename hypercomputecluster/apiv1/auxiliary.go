...
func (op *CreateClusterOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*hypercomputeclusterpb.Cluster, error) {
...
func (op *CreateClusterOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*hypercomputeclusterpb.Cluster, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp hypercomputeclusterpb.Cluster
...
func (op *CreateClusterOperation) Metadata() (*hypercomputeclusterpb.OperationMetadata, error) {
	var meta hypercomputeclusterpb.OperationMetadata
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *DeleteClusterOperation) Metadata() (*hypercomputeclusterpb.OperationMetadata, error) {
	var meta hypercomputeclusterpb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
//
// See documentation of Poll for error-handling information.
func (op *UpdateClusterOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*hypercomputeclusterpb.Cluster, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp hypercomputeclusterpb.Cluster
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *UpdateClusterOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*hypercomputeclusterpb.Cluster, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp hypercomputeclusterpb.Cluster
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *UpdateClusterOperation) Metadata() (*hypercomputeclusterpb.OperationMetadata, error) {
	var meta hypercomputeclusterpb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
type ClusterIterator struct {
	...
	InternalFetch func(pageSize int, pageToken string) (results []*hypercomputeclusterpb.Cluster, nextPageToken string, err error)
}
...
func (it *ClusterIterator) Next() (*hypercomputeclusterpb.Cluster, error) {
	var item *hypercomputeclusterpb.Cluster
