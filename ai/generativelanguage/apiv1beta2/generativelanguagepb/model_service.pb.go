...
const file_google_ai_generativelanguage_v1beta2_model_service_proto_rawDesc = "" +
	"\n" +
	"8google/ai/generativelanguage/v1beta2/model_service.proto\x12$google.ai.generativelanguage.v1beta2\x1a0google/ai/generativelanguage/v1beta2/model.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"V\n" +
	...
	"\x06models\x18\x01 \x03(\v2+.google.ai.generativelanguage.v1beta2.ModelR\x06models\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken2\x80\x03\n" +
	"\fModelService\x12\x97\x01\n" +
	"\bGetModel\x125.google.ai.generativelanguage.v1beta2.GetModelRequest\x1a+.google.ai.generativelanguage.v1beta2.Model\"'\xdaA\x04name\x82\xd3\xe4\x93\x02\x1a\x12\x18/v1beta2/{name=models/*}\x12\xaf\x01\n" +
	"\n" +
...
var (
	...
	file_google_ai_generativelanguage_v1beta2_model_service_proto_rawDescData []byte
)
...
func file_google_ai_generativelanguage_v1beta2_model_service_proto_rawDescGZIP() []byte {
	file_google_ai_generativelanguage_v1beta2_model_service_proto_rawDescOnce.Do(func() {
		file_google_ai_generativelanguage_v1beta2_model_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta2_model_service_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta2_model_service_proto_rawDesc)))
	})
...
func file_google_ai_generativelanguage_v1beta2_model_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta2_model_service_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta2_model_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
