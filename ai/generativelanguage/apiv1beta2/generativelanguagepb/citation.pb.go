...
const file_google_ai_generativelanguage_v1beta2_citation_proto_rawDesc = "" +
	"\n" +
	"3google/ai/generativelanguage/v1beta2/citation.proto\x12$google.ai.generativelanguage.v1beta2\x1a\x1fgoogle/api/field_behavior.proto\"s\n" +
	"\x10CitationMetadata\x12_\n" +
	"\x10citation_sources\x18\x01 \x03(\v24.google.ai.generativelanguage.v1beta2.CitationSourceR\x0fcitationSources\"\xd4\x01\n" +
...
var (
	...
	file_google_ai_generativelanguage_v1beta2_citation_proto_rawDescData []byte
)
...
func file_google_ai_generativelanguage_v1beta2_citation_proto_rawDescGZIP() []byte {
	file_google_ai_generativelanguage_v1beta2_citation_proto_rawDescOnce.Do(func() {
		file_google_ai_generativelanguage_v1beta2_citation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta2_citation_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta2_citation_proto_rawDesc)))
	})
...
func file_google_ai_generativelanguage_v1beta2_citation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta2_citation_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta2_citation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
