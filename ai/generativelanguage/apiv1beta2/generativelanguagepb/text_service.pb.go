...
const file_google_ai_generativelanguage_v1beta2_text_service_proto_rawDesc = "" +
	"\n" +
	"7google/ai/generativelanguage/v1beta2/text_service.proto\x12$google.ai.generativelanguage.v1beta2\x1a3google/ai/generativelanguage/v1beta2/citation.proto\x1a1google/ai/generativelanguage/v1beta2/safety.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\xb8\x04\n" +
	"\x13GenerateTextRequest\x12E\n" +
	"\x05model\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'generativelanguage.googleapis.com/ModelR\x05model\x12M\n" +
	"\x06prompt\x18\x02 \x01(\v20.google.ai.generativelanguage.v1beta2.TextPromptB\x03\xe0A\x02R\x06prompt\x12%\n" +
	"\vtemperature\x18\x03 \x01(\x02H\x00R\vtemperature\x88\x01\x01\x12,\n" +
	"\x0fcandidate_count\x18\x04 \x01(\x05H\x01R\x0ecandidateCount\x88\x01\x01\x12/\n" +
	"\x11max_output_tokens\x18\x05 \x01(\x05H\x02R\x0fmaxOutputTokens\x88\x01\x01\x12\x18\n" +
	"\x05top_p\x18\x06 \x01(\x02H\x03R\x04topP\x88\x01\x01\x12\x18\n" +
	"\x05top_k\x18\a \x01(\x05H\x04R\x04topK\x88\x01\x01\x12\\\n" +
	"\x0fsafety_settings\x18\b \x03(\v23.google.ai.generativelanguage.v1beta2.SafetySettingR\x0esafetySettings\x12%\n" +
	...
	"\n" +
	"candidates\x18\x01 \x03(\v24.google.ai.generativelanguage.v1beta2.TextCompletionR\n" +
	"candidates\x12M\n" +
	"\afilters\x18\x03 \x03(\v23.google.ai.generativelanguage.v1beta2.ContentFilterR\afilters\x12]\n" +
	"\x0fsafety_feedback\x18\x04 \x03(\v24.google.ai.generativelanguage.v1beta2.SafetyFeedbackR\x0esafetyFeedback\"%\n" +
	"\n" +
	"TextPrompt\x12\x17\n" +
	...
	"\x0esafety_ratings\x18\x02 \x03(\v22.google.ai.generativelanguage.v1beta2.SafetyRatingR\rsafetyRatings\x12m\n" +
	...
	"\x04text\x18\x02 \x01(\tB\x03\xe0A\x02R\x04text\"z\n" +
	"\x11EmbedTextResponse\x12W\n" +
	"\tembedding\x18\x01 \x01(\v2/.google.ai.generativelanguage.v1beta2.EmbeddingB\x03\xe0A\x03H\x00R\tembedding\x88\x01\x01B\f\n" +
	"\n" +
	"_embedding\"!\n" +
	"\tEmbedding\x12\x14\n" +
	"\x05value\x18\x01 \x03(\x02R\x05value2\xf3\x03\n" +
	"\vTextService\x12\x81\x02\n" +
	"\fGenerateText\x129.google.ai.generativelanguage.v1beta2.GenerateTextRequest\x1a:.google.ai.generativelanguage.v1beta2.GenerateTextResponse\"z\xdaAFmodel,prompt,temperature,candidate_count,max_output_tokens,top_p,top_k\x82\xd3\xe4\x93\x02+:\x01*\"&/v1beta2/{model=models/*}:generateText\x12\xb9\x01\n" +
	...
	"model,text\x82\xd3\xe4\x93\x02(:\x01*\"#/v1beta2/{model=models/*}:embedText\x1a$\xcaA!generativelanguage.googleapis.comB\x9e\x01\n" +
...
var (
	...
	file_google_ai_generativelanguage_v1beta2_text_service_proto_rawDescData []byte
)
...
func file_google_ai_generativelanguage_v1beta2_text_service_proto_rawDescGZIP() []byte {
	file_google_ai_generativelanguage_v1beta2_text_service_proto_rawDescOnce.Do(func() {
		file_google_ai_generativelanguage_v1beta2_text_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta2_text_service_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta2_text_service_proto_rawDesc)))
	})
...
var file_google_ai_generativelanguage_v1beta2_text_service_proto_goTypes = []any{
...
func file_google_ai_generativelanguage_v1beta2_text_service_proto_init() {
	...
	file_google_ai_generativelanguage_v1beta2_text_service_proto_msgTypes[0].OneofWrappers = []any{}
	file_google_ai_generativelanguage_v1beta2_text_service_proto_msgTypes[3].OneofWrappers = []any{}
	file_google_ai_generativelanguage_v1beta2_text_service_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta2_text_service_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta2_text_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
