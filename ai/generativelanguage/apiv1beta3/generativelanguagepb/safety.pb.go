...
func (HarmCategory) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ai_generativelanguage_v1beta3_safety_proto_enumTypes[0].Descriptor()
}

func (HarmCategory) Type() protoreflect.EnumType {
	return &file_google_ai_generativelanguage_v1beta3_safety_proto_enumTypes[0]
}
...
func (HarmCategory) EnumDescriptor() ([]byte, []int) {
	return file_google_ai_generativelanguage_v1beta3_safety_proto_rawDescGZIP(), []int{0}
}
...
func (ContentFilter_BlockedReason) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ai_generativelanguage_v1beta3_safety_proto_enumTypes[1].Descriptor()
}

func (ContentFilter_BlockedReason) Type() protoreflect.EnumType {
	return &file_google_ai_generativelanguage_v1beta3_safety_proto_enumTypes[1]
}
...
func (ContentFilter_BlockedReason) EnumDescriptor() ([]byte, []int) {
	return file_google_ai_generativelanguage_v1beta3_safety_proto_rawDescGZIP(), []int{0, 0}
}
...
func (SafetyRating_HarmProbability) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ai_generativelanguage_v1beta3_safety_proto_enumTypes[2].Descriptor()
}

func (SafetyRating_HarmProbability) Type() protoreflect.EnumType {
	return &file_google_ai_generativelanguage_v1beta3_safety_proto_enumTypes[2]
}
...
func (SafetyRating_HarmProbability) EnumDescriptor() ([]byte, []int) {
	return file_google_ai_generativelanguage_v1beta3_safety_proto_rawDescGZIP(), []int{2, 0}
}
...
func (SafetySetting_HarmBlockThreshold) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ai_generativelanguage_v1beta3_safety_proto_enumTypes[3].Descriptor()
}

func (SafetySetting_HarmBlockThreshold) Type() protoreflect.EnumType {
	return &file_google_ai_generativelanguage_v1beta3_safety_proto_enumTypes[3]
}
...
func (SafetySetting_HarmBlockThreshold) EnumDescriptor() ([]byte, []int) {
	return file_google_ai_generativelanguage_v1beta3_safety_proto_rawDescGZIP(), []int{3, 0}
}
...
type ContentFilter struct {
	...
	Reason ContentFilter_BlockedReason `protobuf:"varint,1,opt,name=reason,proto3,enum=google.ai.generativelanguage.v1beta3.ContentFilter_BlockedReason" json:"reason,omitempty"`
...
func (x *ContentFilter) Reset() {
	*x = ContentFilter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ai_generativelanguage_v1beta3_safety_proto_msgTypes[0]
...
func (x *SafetyFeedback) Reset() {
	*x = SafetyFeedback{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ai_generativelanguage_v1beta3_safety_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SafetyFeedback) Descriptor() ([]byte, []int) {
	return file_google_ai_generativelanguage_v1beta3_safety_proto_rawDescGZIP(), []int{1}
}
...
type SafetyRating struct {
	...
	Category HarmCategory `protobuf:"varint,3,opt,name=category,proto3,enum=google.ai.generativelanguage.v1beta3.HarmCategory" json:"category,omitempty"`
	// Required. The probability of harm for this content.
	Probability SafetyRating_HarmProbability `protobuf:"varint,4,opt,name=probability,proto3,enum=google.ai.generativelanguage.v1beta3.SafetyRating_HarmProbability" json:"probability,omitempty"`
}

func (x *SafetyRating) Reset() {
	*x = SafetyRating{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ai_generativelanguage_v1beta3_safety_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SafetyRating) Descriptor() ([]byte, []int) {
	return file_google_ai_generativelanguage_v1beta3_safety_proto_rawDescGZIP(), []int{2}
}
...
type SafetySetting struct {
	...
	Threshold SafetySetting_HarmBlockThreshold `protobuf:"varint,4,opt,name=threshold,proto3,enum=google.ai.generativelanguage.v1beta3.SafetySetting_HarmBlockThreshold" json:"threshold,omitempty"`
}

func (x *SafetySetting) Reset() {
	*x = SafetySetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ai_generativelanguage_v1beta3_safety_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SafetySetting) Descriptor() ([]byte, []int) {
	return file_google_ai_generativelanguage_v1beta3_safety_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ai_generativelanguage_v1beta3_safety_proto protoreflect.FileDescriptor

var file_google_ai_generativelanguage_v1beta3_safety_proto_rawDesc = []byte{
	...
	0x31, 0x62, 0x65, 0x74, 0x61, 0x33, 0x2f, 0x73, 0x61, 0x66, 0x65, 0x74, 0x79, 0x2e, 0x70, 0x72,
	...
	0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x33, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	...
	0x74, 0x61, 0x33, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x46, 0x69, 0x6c, 0x74, 0x65,
	...
	0x65, 0x74, 0x61, 0x33, 0x2e, 0x53, 0x61, 0x66, 0x65, 0x74, 0x79, 0x52, 0x61, 0x74, 0x69, 0x6e,
	...
	0x33, 0x2e, 0x53, 0x61, 0x66, 0x65, 0x74, 0x79, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x52,
	...
	0x61, 0x33, 0x2e, 0x48, 0x61, 0x72, 0x6d, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x42,
	...
	0x67, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x33, 0x2e, 0x53, 0x61, 0x66, 0x65, 0x74,
	...
	0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x33, 0x2e, 0x48, 0x61, 0x72, 0x6d, 0x43, 0x61, 0x74,
	...
	0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x33, 0x2e, 0x53,
	...
	0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x33, 0x42, 0x0b, 0x53, 0x61, 0x66,
	...
	0x67, 0x75, 0x61, 0x67, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x33,
...
var (
	file_google_ai_generativelanguage_v1beta3_safety_proto_rawDescOnce sync.Once
	file_google_ai_generativelanguage_v1beta3_safety_proto_rawDescData = file_google_ai_generativelanguage_v1beta3_safety_proto_rawDesc
)

func file_google_ai_generativelanguage_v1beta3_safety_proto_rawDescGZIP() []byte {
	file_google_ai_generativelanguage_v1beta3_safety_proto_rawDescOnce.Do(func() {
		file_google_ai_generativelanguage_v1beta3_safety_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ai_generativelanguage_v1beta3_safety_proto_rawDescData)
	})
	return file_google_ai_generativelanguage_v1beta3_safety_proto_rawDescData
}

var file_google_ai_generativelanguage_v1beta3_safety_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_google_ai_generativelanguage_v1beta3_safety_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ai_generativelanguage_v1beta3_safety_proto_goTypes = []any{
	(HarmCategory)(0),                     // 0: google.ai.generativelanguage.v1beta3.HarmCategory
	(ContentFilter_BlockedReason)(0),      // 1: google.ai.generativelanguage.v1beta3.ContentFilter.BlockedReason
	(SafetyRating_HarmProbability)(0),     // 2: google.ai.generativelanguage.v1beta3.SafetyRating.HarmProbability
	(SafetySetting_HarmBlockThreshold)(0), // 3: google.ai.generativelanguage.v1beta3.SafetySetting.HarmBlockThreshold
	(*ContentFilter)(nil),                 // 4: google.ai.generativelanguage.v1beta3.ContentFilter
	(*SafetyFeedback)(nil),                // 5: google.ai.generativelanguage.v1beta3.SafetyFeedback
	(*SafetyRating)(nil),                  // 6: google.ai.generativelanguage.v1beta3.SafetyRating
	(*SafetySetting)(nil),                 // 7: google.ai.generativelanguage.v1beta3.SafetySetting
}
var file_google_ai_generativelanguage_v1beta3_safety_proto_depIdxs = []int32{
	1, // 0: google.ai.generativelanguage.v1beta3.ContentFilter.reason:type_name -> google.ai.generativelanguage.v1beta3.ContentFilter.BlockedReason
	6, // 1: google.ai.generativelanguage.v1beta3.SafetyFeedback.rating:type_name -> google.ai.generativelanguage.v1beta3.SafetyRating
	7, // 2: google.ai.generativelanguage.v1beta3.SafetyFeedback.setting:type_name -> google.ai.generativelanguage.v1beta3.SafetySetting
	0, // 3: google.ai.generativelanguage.v1beta3.SafetyRating.category:type_name -> google.ai.generativelanguage.v1beta3.HarmCategory
	2, // 4: google.ai.generativelanguage.v1beta3.SafetyRating.probability:type_name -> google.ai.generativelanguage.v1beta3.SafetyRating.HarmProbability
	0, // 5: google.ai.generativelanguage.v1beta3.SafetySetting.category:type_name -> google.ai.generativelanguage.v1beta3.HarmCategory
	3, // 6: google.ai.generativelanguage.v1beta3.SafetySetting.threshold:type_name -> google.ai.generativelanguage.v1beta3.SafetySetting.HarmBlockThreshold
...
func init() { file_google_ai_generativelanguage_v1beta3_safety_proto_init() }
func file_google_ai_generativelanguage_v1beta3_safety_proto_init() {
	if File_google_ai_generativelanguage_v1beta3_safety_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ai_generativelanguage_v1beta3_safety_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_ai_generativelanguage_v1beta3_safety_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_ai_generativelanguage_v1beta3_safety_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_ai_generativelanguage_v1beta3_safety_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_google_ai_generativelanguage_v1beta3_safety_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ai_generativelanguage_v1beta3_safety_proto_rawDesc,
			NumEnums:      4,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ai_generativelanguage_v1beta3_safety_proto_goTypes,
		DependencyIndexes: file_google_ai_generativelanguage_v1beta3_safety_proto_depIdxs,
		EnumInfos:         file_google_ai_generativelanguage_v1beta3_safety_proto_enumTypes,
		MessageInfos:      file_google_ai_generativelanguage_v1beta3_safety_proto_msgTypes,
	}.Build()
	File_google_ai_generativelanguage_v1beta3_safety_proto = out.File
	file_google_ai_generativelanguage_v1beta3_safety_proto_rawDesc = nil
	file_google_ai_generativelanguage_v1beta3_safety_proto_goTypes = nil
	file_google_ai_generativelanguage_v1beta3_safety_proto_depIdxs = nil
}
