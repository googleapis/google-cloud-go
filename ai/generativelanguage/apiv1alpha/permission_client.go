...
func NewPermissionClient(ctx context.Context, opts ...option.ClientOption) (*PermissionClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.CreatePermission = append(client.CallOptions.CreatePermission, gax.WithClientMetrics(metrics))
		client.CallOptions.GetPermission = append(client.CallOptions.GetPermission, gax.WithClientMetrics(metrics))
		client.CallOptions.ListPermissions = append(client.CallOptions.ListPermissions, gax.WithClientMetrics(metrics))
		client.CallOptions.UpdatePermission = append(client.CallOptions.UpdatePermission, gax.WithClientMetrics(metrics))
		client.CallOptions.DeletePermission = append(client.CallOptions.DeletePermission, gax.WithClientMetrics(metrics))
		client.CallOptions.TransferOwnership = append(client.CallOptions.TransferOwnership, gax.WithClientMetrics(metrics))
...
func NewPermissionRESTClient(ctx context.Context, opts ...option.ClientOption) (*PermissionClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.CreatePermission = append(callOpts.CreatePermission, gax.WithClientMetrics(metrics))
		callOpts.GetPermission = append(callOpts.GetPermission, gax.WithClientMetrics(metrics))
		callOpts.ListPermissions = append(callOpts.ListPermissions, gax.WithClientMetrics(metrics))
		callOpts.UpdatePermission = append(callOpts.UpdatePermission, gax.WithClientMetrics(metrics))
		callOpts.DeletePermission = append(callOpts.DeletePermission, gax.WithClientMetrics(metrics))
		callOpts.TransferOwnership = append(callOpts.TransferOwnership, gax.WithClientMetrics(metrics))
...
func (c *permissionGRPCClient) UpdatePermission(ctx context.Context, req *generativelanguagepb.UpdatePermissionRequest, opts ...gax.CallOption) (*generativelanguagepb.Permission, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.ai.generativelanguage.v1alpha.PermissionService/UpdatePermission")
	}
...
func (c *permissionGRPCClient) GetOperation(ctx context.Context, req *longrunningpb.GetOperationRequest, opts ...gax.CallOption) (*longrunningpb.Operation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
...
func (c *permissionGRPCClient) ListOperations(ctx context.Context, req *longrunningpb.ListOperationsRequest, opts ...gax.CallOption) *OperationIterator {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
...
func (c *permissionRESTClient) CreatePermission(ctx context.Context, req *generativelanguagepb.CreatePermissionRequest, opts ...gax.CallOption) (*generativelanguagepb.Permission, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v/permissions", req.GetParent())
...
func (c *permissionRESTClient) UpdatePermission(ctx context.Context, req *generativelanguagepb.UpdatePermissionRequest, opts ...gax.CallOption) (*generativelanguagepb.Permission, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v", req.GetPermission().GetName())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.ai.generativelanguage.v1alpha.PermissionService/UpdatePermission")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1alpha/{permission.name=tunedModels/*/permissions/*}")
	}
	opts = append((*c.CallOptions).UpdatePermission[0:len((*c.CallOptions).UpdatePermission):len((*c.CallOptions).UpdatePermission)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &generativelanguagepb.Permission{}
...
func (c *permissionRESTClient) TransferOwnership(ctx context.Context, req *generativelanguagepb.TransferOwnershipRequest, opts ...gax.CallOption) (*generativelanguagepb.TransferOwnershipResponse, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha/%v:transferOwnership", req.GetName())
...
// GetOperation is a utility method from google.longrunning.Operations.
func (c *permissionRESTClient) GetOperation(ctx context.Context, req *longrunningpb.GetOperationRequest, opts ...gax.CallOption) (*longrunningpb.Operation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
