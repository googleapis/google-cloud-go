...
const file_google_ai_generativelanguage_v1alpha_safety_proto_rawDesc = "" +
	"\n" +
	"1google/ai/generativelanguage/v1alpha/safety.proto\x12$google.ai.generativelanguage.v1alpha\x1a\x1fgoogle/api/field_behavior.proto\"\xdd\x01\n" +
	"\rContentFilter\x12Y\n" +
	"\x06reason\x18\x01 \x01(\x0e2A.google.ai.generativelanguage.v1alpha.ContentFilter.BlockedReasonR\x06reason\x12\x1d\n" +
	...
	"\x06rating\x18\x01 \x01(\v22.google.ai.generativelanguage.v1alpha.SafetyRatingR\x06rating\x12M\n" +
	"\asetting\x18\x02 \x01(\v23.google.ai.generativelanguage.v1alpha.SafetySettingR\asetting\"\xcc\x02\n" +
	"\fSafetyRating\x12S\n" +
	"\bcategory\x18\x03 \x01(\x0e22.google.ai.generativelanguage.v1alpha.HarmCategoryB\x03\xe0A\x02R\bcategory\x12i\n" +
	"\vprobability\x18\x04 \x01(\x0e2B.google.ai.generativelanguage.v1alpha.SafetyRating.HarmProbabilityB\x03\xe0A\x02R\vprobability\x12\x18\n" +
	...
	"\rSafetySetting\x12S\n" +
	"\bcategory\x18\x03 \x01(\x0e22.google.ai.generativelanguage.v1alpha.HarmCategoryB\x03\xe0A\x02R\bcategory\x12i\n" +
	"\tthreshold\x18\x04 \x01(\x0e2F.google.ai.generativelanguage.v1alpha.SafetySetting.HarmBlockThresholdB\x03\xe0A\x02R\tthreshold\"\x9d\x01\n" +
	...
	"\x12!\n" +
	"\x1dHARM_CATEGORY_CIVIC_INTEGRITY\x10\vB\x99\x01\n" +
	"(com.google.ai.generativelanguage.v1alphaB\vSafetyProtoP\x01Z^cloud.google.com/go/ai/generativelanguage/apiv1alpha/generativelanguagepb;generativelanguagepbb\x06proto3"

var (
	file_google_ai_generativelanguage_v1alpha_safety_proto_rawDescOnce sync.Once
	file_google_ai_generativelanguage_v1alpha_safety_proto_rawDescData []byte
)
...
func file_google_ai_generativelanguage_v1alpha_safety_proto_rawDescGZIP() []byte {
	file_google_ai_generativelanguage_v1alpha_safety_proto_rawDescOnce.Do(func() {
		file_google_ai_generativelanguage_v1alpha_safety_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1alpha_safety_proto_rawDesc), len(file_google_ai_generativelanguage_v1alpha_safety_proto_rawDesc)))
	})
...
func file_google_ai_generativelanguage_v1alpha_safety_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1alpha_safety_proto_rawDesc), len(file_google_ai_generativelanguage_v1alpha_safety_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
