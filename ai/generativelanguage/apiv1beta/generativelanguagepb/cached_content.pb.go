...
var file_google_ai_generativelanguage_v1beta_cached_content_proto_goTypes = []interface{}{
...
func file_google_ai_generativelanguage_v1beta_cached_content_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ai_generativelanguage_v1beta_cached_content_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ai_generativelanguage_v1beta_cached_content_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ai_generativelanguage_v1beta_cached_content_proto_msgTypes[0].OneofWrappers = []interface{}{
