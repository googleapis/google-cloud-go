...
const file_google_ai_generativelanguage_v1beta_cache_service_proto_rawDesc = "" +
	"\n" +
	"7google/ai/generativelanguage/v1beta/cache_service.proto\x12#google.ai.generativelanguage.v1beta\x1a8google/ai/generativelanguage/v1beta/cached_content.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\"a\n" +
	"\x19ListCachedContentsRequest\x12 \n" +
	"\tpage_size\x18\x01 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tB\x03\xe0A\x01R\tpageToken\"\xa1\x01\n" +
	"\x1aListCachedContentsResponse\x12[\n" +
	"\x0fcached_contents\x18\x01 \x03(\v22.google.ai.generativelanguage.v1beta.CachedContentR\x0ecachedContents\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"|\n" +
	"\x1aCreateCachedContentRequest\x12^\n" +
	"\x0ecached_content\x18\x01 \x01(\v22.google.ai.generativelanguage.v1beta.CachedContentB\x03\xe0A\x02R\rcachedContent\"f\n" +
	"\x17GetCachedContentRequest\x12K\n" +
	"\x04name\x18\x01 \x01(\tB7\xe0A\x02\xfaA1\n" +
	"/generativelanguage.googleapis.com/CachedContentR\x04name\"\xb9\x01\n" +
	"\x1aUpdateCachedContentRequest\x12^\n" +
	"\x0ecached_content\x18\x01 \x01(\v22.google.ai.generativelanguage.v1beta.CachedContentB\x03\xe0A\x02R\rcachedContent\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"i\n" +
	"\x1aDeleteCachedContentRequest\x12K\n" +
	"\x04name\x18\x01 \x01(\tB7\xe0A\x02\xfaA1\n" +
	"/generativelanguage.googleapis.com/CachedContentR\x04name2\x87\b\n" +
	"\fCacheService\x12\xb8\x01\n" +
	...
	"\x13CreateCachedContent\x12?.google.ai.generativelanguage.v1beta.CreateCachedContentRequest\x1a2.google.ai.generativelanguage.v1beta.CachedContent\"?\xdaA\x0ecached_content\x82\xd3\xe4\x93\x02(:\x0ecached_content\"\x16/v1beta/cachedContents\x12\xb4\x01\n" +
	...
	"\x13UpdateCachedContent\x12?.google.ai.generativelanguage.v1beta.UpdateCachedContentRequest\x1a2.google.ai.generativelanguage.v1beta.CachedContent\"c\xdaA\x1acached_content,update_mask\x82\xd3\xe4\x93\x02@:\x0ecached_content2./v1beta/{cached_content.name=cachedContents/*}\x12\x9e\x01\n" +
...
var (
	...
	file_google_ai_generativelanguage_v1beta_cache_service_proto_rawDescData []byte
)
...
func file_google_ai_generativelanguage_v1beta_cache_service_proto_rawDescGZIP() []byte {
	file_google_ai_generativelanguage_v1beta_cache_service_proto_rawDescOnce.Do(func() {
		file_google_ai_generativelanguage_v1beta_cache_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta_cache_service_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta_cache_service_proto_rawDesc)))
	})
...
func file_google_ai_generativelanguage_v1beta_cache_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta_cache_service_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta_cache_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
