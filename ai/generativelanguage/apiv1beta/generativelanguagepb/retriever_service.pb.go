...
const file_google_ai_generativelanguage_v1beta_retriever_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x06corpus\x18\x01 \x01(\v2+.google.ai.generativelanguage.v1beta.CorpusB\x03\xe0A\x02R\x06corpus\"X\n" +
	"\x10GetCorpusRequest\x12D\n" +
	"\x04name\x18\x01 \x01(\tB0\xe0A\x02\xfaA*\n" +
	"(generativelanguage.googleapis.com/CorpusR\x04name\"\xa1\x01\n" +
	"\x13UpdateCorpusRequest\x12H\n" +
	"\x06corpus\x18\x01 \x01(\v2+.google.ai.generativelanguage.v1beta.CorpusB\x03\xe0A\x02R\x06corpus\x12@\n" +
	...
	"\n" +
	"page_token\x18\x02 \x01(\tB\x03\xe0A\x01R\tpageToken\"\x84\x01\n" +
	"\x13ListCorporaResponse\x12E\n" +
	"\acorpora\x18\x01 \x03(\v2+.google.ai.generativelanguage.v1beta.CorpusR\acorpora\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\x84\x02\n" +
	"\x12QueryCorpusRequest\x12D\n" +
	"\x04name\x18\x01 \x01(\tB0\xe0A\x02\xfaA*\n" +
	"(generativelanguage.googleapis.com/CorpusR\x04name\x12\x19\n" +
	"\x05query\x18\x02 \x01(\tB\x03\xe0A\x02R\x05query\x12c\n" +
	"\x10metadata_filters\x18\x03 \x03(\v23.google.ai.generativelanguage.v1beta.MetadataFilterB\x03\xe0A\x01R\x0fmetadataFilters\x12(\n" +
	"\rresults_count\x18\x04 \x01(\x05B\x03\xe0A\x01R\fresultsCount\"r\n" +
	"\x13QueryCorpusResponse\x12[\n" +
	"\x0frelevant_chunks\x18\x01 \x03(\v22.google.ai.generativelanguage.v1beta.RelevantChunkR\x0erelevantChunks\"\xd0\x01\n" +
	"\rRelevantChunk\x122\n" +
	"\x15chunk_relevance_score\x18\x01 \x01(\x02R\x13chunkRelevanceScore\x12@\n" +
	"\x05chunk\x18\x02 \x01(\v2*.google.ai.generativelanguage.v1beta.ChunkR\x05chunk\x12I\n" +
	"\bdocument\x18\x03 \x01(\v2-.google.ai.generativelanguage.v1beta.DocumentR\bdocument\"\xb3\x01\n" +
	"\x15CreateDocumentRequest\x12J\n" +
	"\x06parent\x18\x01 \x01(\tB2\xe0A\x02\xfaA,\x12*generativelanguage.googleapis.com/DocumentR\x06parent\x12N\n" +
	"\bdocument\x18\x02 \x01(\v2-.google.ai.generativelanguage.v1beta.DocumentB\x03\xe0A\x02R\bdocument\"\\\n" +
	"\x12GetDocumentRequest\x12F\n" +
	"\x04name\x18\x01 \x01(\tB2\xe0A\x02\xfaA,\n" +
	"*generativelanguage.googleapis.com/DocumentR\x04name\"\xa9\x01\n" +
	"\x15UpdateDocumentRequest\x12N\n" +
	"\bdocument\x18\x01 \x01(\v2-.google.ai.generativelanguage.v1beta.DocumentB\x03\xe0A\x02R\bdocument\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"z\n" +
	...
	"\tdocuments\x18\x01 \x03(\v2-.google.ai.generativelanguage.v1beta.DocumentR\tdocuments\x12&\n" +
	...
	"\rresults_count\x18\x03 \x01(\x05B\x03\xe0A\x01R\fresultsCount\x12c\n" +
	"\x10metadata_filters\x18\x04 \x03(\v23.google.ai.generativelanguage.v1beta.MetadataFilterB\x03\xe0A\x01R\x0fmetadataFilters\"t\n" +
	"\x15QueryDocumentResponse\x12[\n" +
	"\x0frelevant_chunks\x18\x01 \x03(\v22.google.ai.generativelanguage.v1beta.RelevantChunkR\x0erelevantChunks\"\xa4\x01\n" +
	"\x12CreateChunkRequest\x12G\n" +
	"\x06parent\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\x12'generativelanguage.googleapis.com/ChunkR\x06parent\x12E\n" +
	"\x05chunk\x18\x02 \x01(\v2*.google.ai.generativelanguage.v1beta.ChunkB\x03\xe0A\x02R\x05chunk\"\xbd\x01\n" +
	"\x18BatchCreateChunksRequest\x12G\n" +
	"\x06parent\x18\x01 \x01(\tB/\xe0A\x01\xfaA)\x12'generativelanguage.googleapis.com/ChunkR\x06parent\x12X\n" +
	"\brequests\x18\x02 \x03(\v27.google.ai.generativelanguage.v1beta.CreateChunkRequestB\x03\xe0A\x02R\brequests\"_\n" +
	"\x19BatchCreateChunksResponse\x12B\n" +
	"\x06chunks\x18\x01 \x03(\v2*.google.ai.generativelanguage.v1beta.ChunkR\x06chunks\"V\n" +
	"\x0fGetChunkRequest\x12C\n" +
	"\x04name\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'generativelanguage.googleapis.com/ChunkR\x04name\"\x9d\x01\n" +
	"\x12UpdateChunkRequest\x12E\n" +
	"\x05chunk\x18\x01 \x01(\v2*.google.ai.generativelanguage.v1beta.ChunkB\x03\xe0A\x02R\x05chunk\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"\xbd\x01\n" +
	"\x18BatchUpdateChunksRequest\x12G\n" +
	"\x06parent\x18\x01 \x01(\tB/\xe0A\x01\xfaA)\x12'generativelanguage.googleapis.com/ChunkR\x06parent\x12X\n" +
	"\brequests\x18\x02 \x03(\v27.google.ai.generativelanguage.v1beta.UpdateChunkRequestB\x03\xe0A\x02R\brequests\"_\n" +
	"\x19BatchUpdateChunksResponse\x12B\n" +
	"\x06chunks\x18\x01 \x03(\v2*.google.ai.generativelanguage.v1beta.ChunkR\x06chunks\"Y\n" +
	"\x12DeleteChunkRequest\x12C\n" +
	"\x04name\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'generativelanguage.googleapis.com/ChunkR\x04name\"\xbd\x01\n" +
	"\x18BatchDeleteChunksRequest\x12G\n" +
	"\x06parent\x18\x01 \x01(\tB/\xe0A\x01\xfaA)\x12'generativelanguage.googleapis.com/ChunkR\x06parent\x12X\n" +
	"\brequests\x18\x02 \x03(\v27.google.ai.generativelanguage.v1beta.DeleteChunkRequestB\x03\xe0A\x02R\brequests\"\xa2\x01\n" +
	...
	"\x06chunks\x18\x01 \x03(\v2*.google.ai.generativelanguage.v1beta.ChunkR\x06chunks\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken2\xf4\x1c\n" +
	"\x10RetrieverService\x12\x9f\x01\n" +
	"\fCreateCorpus\x128.google.ai.generativelanguage.v1beta.CreateCorpusRequest\x1a+.google.ai.generativelanguage.v1beta.Corpus\"(\xdaA\x06corpus\x82\xd3\xe4\x93\x02\x19:\x06corpus\"\x0f/v1beta/corpora\x12\x98\x01\n" +
	...
	"\fUpdateCorpus\x128.google.ai.generativelanguage.v1beta.UpdateCorpusRequest\x1a+.google.ai.generativelanguage.v1beta.Corpus\"D\xdaA\x12corpus,update_mask\x82\xd3\xe4\x93\x02):\x06corpus2\x1f/v1beta/{corpus.name=corpora/*}\x12\x89\x01\n" +
	"\fDeleteCorpus\x128.google.ai.generativelanguage.v1beta.DeleteCorpusRequest\x1a\x16.google.protobuf.Empty\"'\xdaA\x04name\x82\xd3\xe4\x93\x02\x1a*\x18/v1beta/{name=corpora/*}\x12\x99\x01\n" +
	"\vListCorpora\x127.google.ai.generativelanguage.v1beta.ListCorporaRequest\x1a8.google.ai.generativelanguage.v1beta.ListCorporaResponse\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/v1beta/corpora\x12\xab\x01\n" +
	"\vQueryCorpus\x127.google.ai.generativelanguage.v1beta.QueryCorpusRequest\x1a8.google.ai.generativelanguage.v1beta.QueryCorpusResponse\")\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/v1beta/{name=corpora/*}:query\x12\xc5\x01\n" +
	"\x0eCreateDocument\x12:.google.ai.generativelanguage.v1beta.CreateDocumentRequest\x1a-.google.ai.generativelanguage.v1beta.Document\"H\xdaA\x0fparent,document\x82\xd3\xe4\x93\x020:\bdocument\"$/v1beta/{parent=corpora/*}/documents\x12\xaa\x01\n" +
	"\vGetDocument\x127.google.ai.generativelanguage.v1beta.GetDocumentRequest\x1a-.google.ai.generativelanguage.v1beta.Document\"3\xdaA\x04name\x82\xd3\xe4\x93\x02&\x12$/v1beta/{name=corpora/*/documents/*}\x12\xd3\x01\n" +
	"\x0eUpdateDocument\x12:.google.ai.generativelanguage.v1beta.UpdateDocumentRequest\x1a-.google.ai.generativelanguage.v1beta.Document\"V\xdaA\x14document,update_mask\x82\xd3\xe4\x93\x029:\bdocument2-/v1beta/{document.name=corpora/*/documents/*}\x12\x99\x01\n" +
	...
	"\rQueryDocument\x129.google.ai.generativelanguage.v1beta.QueryDocumentRequest\x1a:.google.ai.generativelanguage.v1beta.QueryDocumentResponse\"5\x82\xd3\xe4\x93\x02/:\x01*\"*/v1beta/{name=corpora/*/documents/*}:query\x12\xbf\x01\n" +
	"\vCreateChunk\x127.google.ai.generativelanguage.v1beta.CreateChunkRequest\x1a*.google.ai.generativelanguage.v1beta.Chunk\"K\xdaA\fparent,chunk\x82\xd3\xe4\x93\x026:\x05chunk\"-/v1beta/{parent=corpora/*/documents/*}/chunks\x12\xd8\x01\n" +
	"\x11BatchCreateChunks\x12=.google.ai.generativelanguage.v1beta.BatchCreateChunksRequest\x1a>.google.ai.generativelanguage.v1beta.BatchCreateChunksResponse\"D\x82\xd3\xe4\x93\x02>:\x01*\"9/v1beta/{parent=corpora/*/documents/*}/chunks:batchCreate\x12\xaa\x01\n" +
	"\bGetChunk\x124.google.ai.generativelanguage.v1beta.GetChunkRequest\x1a*.google.ai.generativelanguage.v1beta.Chunk\"<\xdaA\x04name\x82\xd3\xe4\x93\x02/\x12-/v1beta/{name=corpora/*/documents/*/chunks/*}\x12\xca\x01\n" +
	"\vUpdateChunk\x127.google.ai.generativelanguage.v1beta.UpdateChunkRequest\x1a*.google.ai.generativelanguage.v1beta.Chunk\"V\xdaA\x11chunk,update_mask\x82\xd3\xe4\x93\x02<:\x05chunk23/v1beta/{chunk.name=corpora/*/documents/*/chunks/*}\x12\xd8\x01\n" +
	"\x11BatchUpdateChunks\x12=.google.ai.generativelanguage.v1beta.BatchUpdateChunksRequest\x1a>.google.ai.generativelanguage.v1beta.BatchUpdateChunksResponse\"D\x82\xd3\xe4\x93\x02>:\x01*\"9/v1beta/{parent=corpora/*/documents/*}/chunks:batchUpdate\x12\x9c\x01\n" +
	"\vDeleteChunk\x127.google.ai.generativelanguage.v1beta.DeleteChunkRequest\x1a\x16.google.protobuf.Empty\"<\xdaA\x04name\x82\xd3\xe4\x93\x02/*-/v1beta/{name=corpora/*/documents/*/chunks/*}\x12\xb0\x01\n" +
	"\x11BatchDeleteChunks\x12=.google.ai.generativelanguage.v1beta.BatchDeleteChunksRequest\x1a\x16.google.protobuf.Empty\"D\x82\xd3\xe4\x93\x02>:\x01*\"9/v1beta/{parent=corpora/*/documents/*}/chunks:batchDelete\x12\xbd\x01\n" +
	"\n" +
...
var (
	...
	file_google_ai_generativelanguage_v1beta_retriever_service_proto_rawDescData []byte
)
...
func file_google_ai_generativelanguage_v1beta_retriever_service_proto_rawDescGZIP() []byte {
	file_google_ai_generativelanguage_v1beta_retriever_service_proto_rawDescOnce.Do(func() {
		file_google_ai_generativelanguage_v1beta_retriever_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta_retriever_service_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta_retriever_service_proto_rawDesc)))
	})
...
func file_google_ai_generativelanguage_v1beta_retriever_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta_retriever_service_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta_retriever_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   28,
			NumExtensions: 0,
			NumServices:   1,
