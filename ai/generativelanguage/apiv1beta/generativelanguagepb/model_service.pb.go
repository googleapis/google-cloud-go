...
const file_google_ai_generativelanguage_v1beta_model_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x06models\x18\x01 \x03(\v2*.google.ai.generativelanguage.v1beta.ModelR\x06models\x12&\n" +
	...
	"\ftuned_models\x18\x01 \x03(\v2/.google.ai.generativelanguage.v1beta.TunedModelR\vtunedModels\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xb3\x01\n" +
	"\x17CreateTunedModelRequest\x12.\n" +
	"\x0etuned_model_id\x18\x01 \x01(\tB\x03\xe0A\x01H\x00R\ftunedModelId\x88\x01\x01\x12U\n" +
	"\vtuned_model\x18\x02 \x01(\v2/.google.ai.generativelanguage.v1beta.TunedModelB\x03\xe0A\x02R\n" +
	"tunedModelB\x11\n" +
	"\x0f_tuned_model_id\"\xb8\x02\n" +
	...
	"\tsnapshots\x18\x04 \x03(\v23.google.ai.generativelanguage.v1beta.TuningSnapshotR\tsnapshots\"\xb2\x01\n" +
	"\x17UpdateTunedModelRequest\x12U\n" +
	"\vtuned_model\x18\x01 \x01(\v2/.google.ai.generativelanguage.v1beta.TunedModelB\x03\xe0A\x02R\n" +
	"tunedModel\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x01R\n" +
	"updateMask\"c\n" +
	"\x17DeleteTunedModelRequest\x12H\n" +
	"\x04name\x18\x01 \x01(\tB4\xe0A\x02\xfaA.\n" +
	",generativelanguage.googleapis.com/TunedModelR\x04name2\xcd\n" +
	"\n" +
	"\fModelService\x12\x94\x01\n" +
	"\bGetModel\x124.google.ai.generativelanguage.v1beta.GetModelRequest\x1a*.google.ai.generativelanguage.v1beta.Model\"&\xdaA\x04name\x82\xd3\xe4\x93\x02\x19\x12\x17/v1beta/{name=models/*}\x12\xac\x01\n" +
	"\n" +
	...
	"\x10UpdateTunedModel\x12<.google.ai.generativelanguage.v1beta.UpdateTunedModelRequest\x1a/.google.ai.generativelanguage.v1beta.TunedModel\"W\xdaA\x17tuned_model,update_mask\x82\xd3\xe4\x93\x027:\vtuned_model2(/v1beta/{tuned_model.name=tunedModels/*}\x12\x95\x01\n" +
...
var (
	...
	file_google_ai_generativelanguage_v1beta_model_service_proto_rawDescData []byte
)
...
func file_google_ai_generativelanguage_v1beta_model_service_proto_rawDescGZIP() []byte {
	file_google_ai_generativelanguage_v1beta_model_service_proto_rawDescOnce.Do(func() {
		file_google_ai_generativelanguage_v1beta_model_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta_model_service_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta_model_service_proto_rawDesc)))
	})
...
func file_google_ai_generativelanguage_v1beta_model_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta_model_service_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta_model_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
