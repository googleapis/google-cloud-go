...
const (
	...
	//
	// Deprecated: Marked as deprecated in google/ai/generativelanguage/v1beta/safety.proto.
...
const file_google_ai_generativelanguage_v1beta_safety_proto_rawDesc = "" +
	"\n" +
	"0google/ai/generativelanguage/v1beta/safety.proto\x12#google.ai.generativelanguage.v1beta\x1a\x1fgoogle/api/field_behavior.proto\"\xdc\x01\n" +
	"\rContentFilter\x12X\n" +
	"\x06reason\x18\x01 \x01(\x0e2@.google.ai.generativelanguage.v1beta.ContentFilter.BlockedReasonR\x06reason\x12\x1d\n" +
	...
	"\x06rating\x18\x01 \x01(\v21.google.ai.generativelanguage.v1beta.SafetyRatingR\x06rating\x12L\n" +
	"\asetting\x18\x02 \x01(\v22.google.ai.generativelanguage.v1beta.SafetySettingR\asetting\"\xca\x02\n" +
	"\fSafetyRating\x12R\n" +
	"\bcategory\x18\x03 \x01(\x0e21.google.ai.generativelanguage.v1beta.HarmCategoryB\x03\xe0A\x02R\bcategory\x12h\n" +
	"\vprobability\x18\x04 \x01(\x0e2A.google.ai.generativelanguage.v1beta.SafetyRating.HarmProbabilityB\x03\xe0A\x02R\vprobability\x12\x18\n" +
	...
	"\rSafetySetting\x12R\n" +
	"\bcategory\x18\x03 \x01(\x0e21.google.ai.generativelanguage.v1beta.HarmCategoryB\x03\xe0A\x02R\bcategory\x12h\n" +
	"\tthreshold\x18\x04 \x01(\x0e2E.google.ai.generativelanguage.v1beta.SafetySetting.HarmBlockThresholdB\x03\xe0A\x02R\tthreshold\"\x9d\x01\n" +
	...
	"\x12%\n" +
	"\x1dHARM_CATEGORY_CIVIC_INTEGRITY\x10\v\x1a\x02\b\x01B\x97\x01\n" +
	"'com.google.ai.generativelanguage.v1betaB\vSafetyProtoP\x01Z]cloud.google.com/go/ai/generativelanguage/apiv1beta/generativelanguagepb;generativelanguagepbb\x06proto3"

var (
	file_google_ai_generativelanguage_v1beta_safety_proto_rawDescOnce sync.Once
	file_google_ai_generativelanguage_v1beta_safety_proto_rawDescData []byte
)
...
func file_google_ai_generativelanguage_v1beta_safety_proto_rawDescGZIP() []byte {
	file_google_ai_generativelanguage_v1beta_safety_proto_rawDescOnce.Do(func() {
		file_google_ai_generativelanguage_v1beta_safety_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta_safety_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta_safety_proto_rawDesc)))
	})
...
func file_google_ai_generativelanguage_v1beta_safety_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta_safety_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta_safety_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
