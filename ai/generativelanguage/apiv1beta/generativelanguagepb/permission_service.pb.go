...
const file_google_ai_generativelanguage_v1beta_permission_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x06parent\x18\x01 \x01(\tB4\xe0A\x02\xfaA.\x12,generativelanguage.googleapis.com/PermissionR\x06parent\x12T\n" +
	"\n" +
	"permission\x18\x02 \x01(\v2/.google.ai.generativelanguage.v1beta.PermissionB\x03\xe0A\x02R\n" +
	"permission\"`\n" +
	...
	"\vpermissions\x18\x01 \x03(\v2/.google.ai.generativelanguage.v1beta.PermissionR\vpermissions\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xb1\x01\n" +
	"\x17UpdatePermissionRequest\x12T\n" +
	"\n" +
	"permission\x18\x01 \x01(\v2/.google.ai.generativelanguage.v1beta.PermissionB\x03\xe0A\x02R\n" +
	"permission\x12@\n" +
	...
	"\x19TransferOwnershipResponse2\xec\v\n" +
	"\x11PermissionService\x12\x8c\x02\n" +
	"\x10CreatePermission\x12<.google.ai.generativelanguage.v1beta.CreatePermissionRequest\x1a/.google.ai.generativelanguage.v1beta.Permission\"\x88\x01\xdaA\x11parent,permission\x82\xd3\xe4\x93\x02n:\n" +
	"permissionZ4:\n" +
	"permission\"&/v1beta/{parent=corpora/*}/permissions\"*/v1beta/{parent=tunedModels/*}/permissions\x12\xe0\x01\n" +
	"\rGetPermission\x129.google.ai.generativelanguage.v1beta.GetPermissionRequest\x1a/.google.ai.generativelanguage.v1beta.Permission\"c\xdaA\x04name\x82\xd3\xe4\x93\x02VZ(\x12&/v1beta/{name=corpora/*/permissions/*}\x12*/v1beta/{name=tunedModels/*/permissions/*}\x12\xf3\x01\n" +
	"\x0fListPermissions\x12;.google.ai.generativelanguage.v1beta.ListPermissionsRequest\x1a<.google.ai.generativelanguage.v1beta.ListPermissionsResponse\"e\xdaA\x06parent\x82\xd3\xe4\x93\x02VZ(\x12&/v1beta/{parent=corpora/*}/permissions\x12*/v1beta/{parent=tunedModels/*}/permissions\x12\xa8\x02\n" +
	"\x10UpdatePermission\x12<.google.ai.generativelanguage.v1beta.UpdatePermissionRequest\x1a/.google.ai.generativelanguage.v1beta.Permission\"\xa4\x01\xdaA\x16permission,update_mask\x82\xd3\xe4\x93\x02\x84\x01:\n" +
	"permissionZ?:\n" +
	"permission21/v1beta/{permission.name=corpora/*/permissions/*}25/v1beta/{permission.name=tunedModels/*/permissions/*}\x12\xcd\x01\n" +
	"\x10DeletePermission\x12<.google.ai.generativelanguage.v1beta.DeletePermissionRequest\x1a\x16.google.protobuf.Empty\"c\xdaA\x04name\x82\xd3\xe4\x93\x02VZ(*&/v1beta/{name=corpora/*/permissions/*}**/v1beta/{name=tunedModels/*/permissions/*}\x12\xcd\x01\n" +
	"\x11TransferOwnership\x12=.google.ai.generativelanguage.v1beta.TransferOwnershipRequest\x1a>.google.ai.generativelanguage.v1beta.TransferOwnershipResponse\"9\x82\xd3\xe4\x93\x023:\x01*\"./v1beta/{name=tunedModels/*}:transferOwnership\x1a$\xcaA!generativelanguage.googleapis.comB\xa2\x01\n" +
...
var (
	...
	file_google_ai_generativelanguage_v1beta_permission_service_proto_rawDescData []byte
)
...
func file_google_ai_generativelanguage_v1beta_permission_service_proto_rawDescGZIP() []byte {
	file_google_ai_generativelanguage_v1beta_permission_service_proto_rawDescOnce.Do(func() {
		file_google_ai_generativelanguage_v1beta_permission_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta_permission_service_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta_permission_service_proto_rawDesc)))
	})
...
func file_google_ai_generativelanguage_v1beta_permission_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta_permission_service_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta_permission_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
