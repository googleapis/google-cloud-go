...
const file_google_ai_generativelanguage_v1beta_model_proto_rawDesc = "" +
	"\n" +
	"/google/ai/generativelanguage/v1beta/model.proto\x12#google.ai.generativelanguage.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\xe4\x04\n" +
	"\x05Model\x12\x17\n" +
...
var (
	...
	file_google_ai_generativelanguage_v1beta_model_proto_rawDescData []byte
)
...
func file_google_ai_generativelanguage_v1beta_model_proto_rawDescGZIP() []byte {
	file_google_ai_generativelanguage_v1beta_model_proto_rawDescOnce.Do(func() {
		file_google_ai_generativelanguage_v1beta_model_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta_model_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta_model_proto_rawDesc)))
	})
...
func file_google_ai_generativelanguage_v1beta_model_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta_model_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta_model_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
