...
const file_google_ai_generativelanguage_v1beta_discuss_service_proto_rawDesc = "" +
	...
	"\n" +
	"candidates\x18\x01 \x03(\v2,.google.ai.generativelanguage.v1beta.MessageR\n" +
	"candidates\x12H\n" +
	"\bmessages\x18\x02 \x03(\v2,.google.ai.generativelanguage.v1beta.MessageR\bmessages\x12L\n" +
	"\afilters\x18\x03 \x03(\v22.google.ai.generativelanguage.v1beta.ContentFilterR\afilters\"\xc9\x01\n" +
	"\aMessage\x12\x1b\n" +
	"\x06author\x18\x01 \x01(\tB\x03\xe0A\x01R\x06author\x12\x1d\n" +
	"\acontent\x18\x02 \x01(\tB\x03\xe0A\x02R\acontent\x12l\n" +
	...
	"\x12_citation_metadata\"\xcc\x01\n" +
	"\rMessagePrompt\x12\x1d\n" +
	"\acontext\x18\x01 \x01(\tB\x03\xe0A\x01R\acontext\x12M\n" +
	"\bexamples\x18\x02 \x03(\v2,.google.ai.generativelanguage.v1beta.ExampleB\x03\xe0A\x01R\bexamples\x12M\n" +
	"\bmessages\x18\x03 \x03(\v2,.google.ai.generativelanguage.v1beta.MessageB\x03\xe0A\x02R\bmessages\"\x9d\x01\n" +
	"\aExample\x12G\n" +
	"\x05input\x18\x01 \x01(\v2,.google.ai.generativelanguage.v1beta.MessageB\x03\xe0A\x02R\x05input\x12I\n" +
	"\x06output\x18\x02 \x01(\v2,.google.ai.generativelanguage.v1beta.MessageB\x03\xe0A\x02R\x06output\"\xb3\x01\n" +
	"\x19CountMessageTokensRequest\x12E\n" +
	"\x05model\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'generativelanguage.googleapis.com/ModelR\x05model\x12O\n" +
	"\x06prompt\x18\x02 \x01(\v22.google.ai.generativelanguage.v1beta.MessagePromptB\x03\xe0A\x02R\x06prompt\"=\n" +
	"\x1aCountMessageTokensResponse\x12\x1f\n" +
	"\vtoken_count\x18\x01 \x01(\x05R\n" +
	"tokenCount2\x90\x04\n" +
	"\x0eDiscussService\x12\xf8\x01\n" +
	"\x0fGenerateMessage\x12;.google.ai.generativelanguage.v1beta.GenerateMessageRequest\x1a<.google.ai.generativelanguage.v1beta.GenerateMessageResponse\"j\xdaA4model,prompt,temperature,candidate_count,top_p,top_k\x82\xd3\xe4\x93\x02-:\x01*\"(/v1beta/{model=models/*}:generateMessage\x12\xdc\x01\n" +
	"\x12CountMessageTokens\x12>.google.ai.generativelanguage.v1beta.CountMessageTokensRequest\x1a?.google.ai.generativelanguage.v1beta.CountMessageTokensResponse\"E\xdaA\fmodel,prompt\x82\xd3\xe4\x93\x020:\x01*\"+/v1beta/{model=models/*}:countMessageTokens\x1a$\xcaA!generativelanguage.googleapis.comB\x9f\x01\n" +
...
var (
	...
	file_google_ai_generativelanguage_v1beta_discuss_service_proto_rawDescData []byte
)
...
func file_google_ai_generativelanguage_v1beta_discuss_service_proto_rawDescGZIP() []byte {
	file_google_ai_generativelanguage_v1beta_discuss_service_proto_rawDescOnce.Do(func() {
		file_google_ai_generativelanguage_v1beta_discuss_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta_discuss_service_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta_discuss_service_proto_rawDesc)))
	})
...
func file_google_ai_generativelanguage_v1beta_discuss_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ai_generativelanguage_v1beta_discuss_service_proto_rawDesc), len(file_google_ai_generativelanguage_v1beta_discuss_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
