...
func file_google_ai_generativelanguage_v1beta_file_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_ai_generativelanguage_v1beta_file_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ai_generativelanguage_v1beta_file_proto_msgTypes[0].OneofWrappers = []interface{}{
