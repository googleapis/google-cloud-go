...
type CloudLocationIterator struct {
	items    []*locationfinderpb.CloudLocation
...
func (it *CloudLocationIterator) Next() (*locationfinderpb.CloudLocation, error) {
	var item *locationfinderpb.CloudLocation
...
func (it *CloudLocationIterator) bufLen() int {
	return len(it.items)
}

func (it *CloudLocationIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
