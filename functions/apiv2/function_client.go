...
func NewFunctionClient(ctx context.Context, opts ...option.ClientOption) (*FunctionClient, error) {
	...
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		clientOpts = append(clientOpts, internaloption.WithTelemetryAttributes(map[string]string{
			...
			"gcp.client.artifact": "cloud.google.com/go/functions/apiv2",
...
func NewFunctionRESTClient(ctx context.Context, opts ...option.ClientOption) (*FunctionClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.ListRuntimes = append(callOpts.ListRuntimes, gax.WithClientMetrics(metrics))
...
func (c *functionGRPCClient) GetFunction(ctx context.Context, req *functionspb.GetFunctionRequest, opts ...gax.CallOption) (*functionspb.Function, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.functionClient.GetFunction, req, settings.GRPC, c.logger, "GetFunction")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *functionGRPCClient) ListFunctions(ctx context.Context, req *functionspb.ListFunctionsRequest, opts ...gax.CallOption) *FunctionIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*functionspb.Function, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.functionClient.ListFunctions, req, settings.GRPC, c.logger, "ListFunctions")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *functionGRPCClient) CreateFunction(ctx context.Context, req *functionspb.CreateFunctionRequest, opts ...gax.CallOption) (*CreateFunctionOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.functionClient.CreateFunction, req, settings.GRPC, c.logger, "CreateFunction")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *functionGRPCClient) UpdateFunction(ctx context.Context, req *functionspb.UpdateFunctionRequest, opts ...gax.CallOption) (*UpdateFunctionOperation, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.functions.v2.FunctionService/UpdateFunction")
	}
	opts = append((*c.CallOptions).UpdateFunction[0:len((*c.CallOptions).UpdateFunction):len((*c.CallOptions).UpdateFunction)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.functionClient.UpdateFunction, req, settings.GRPC, c.logger, "UpdateFunction")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *functionGRPCClient) DeleteFunction(ctx context.Context, req *functionspb.DeleteFunctionRequest, opts ...gax.CallOption) (*DeleteFunctionOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.functionClient.DeleteFunction, req, settings.GRPC, c.logger, "DeleteFunction")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *functionGRPCClient) GenerateUploadUrl(ctx context.Context, req *functionspb.GenerateUploadUrlRequest, opts ...gax.CallOption) (*functionspb.GenerateUploadUrlResponse, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.functionClient.GenerateUploadUrl, req, settings.GRPC, c.logger, "GenerateUploadUrl")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *functionGRPCClient) GenerateDownloadUrl(ctx context.Context, req *functionspb.GenerateDownloadUrlRequest, opts ...gax.CallOption) (*functionspb.GenerateDownloadUrlResponse, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.functionClient.GenerateDownloadUrl, req, settings.GRPC, c.logger, "GenerateDownloadUrl")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *functionGRPCClient) ListRuntimes(ctx context.Context, req *functionspb.ListRuntimesRequest, opts ...gax.CallOption) (*functionspb.ListRuntimesResponse, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.functionClient.ListRuntimes, req, settings.GRPC, c.logger, "ListRuntimes")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *functionRESTClient) UpdateFunction(ctx context.Context, req *functionspb.UpdateFunctionRequest, opts ...gax.CallOption) (*UpdateFunctionOperation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.functions.v2.FunctionService/UpdateFunction")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2/{function.name=projects/*/locations/*/functions/*}")
	}
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &longrunningpb.Operation{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
...
func (c *functionRESTClient) ListRuntimes(ctx context.Context, req *functionspb.ListRuntimesRequest, opts ...gax.CallOption) (*functionspb.ListRuntimesResponse, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "ListRuntimes")
		if err != nil {
			return err
		}
