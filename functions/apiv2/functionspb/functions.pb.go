...
const file_google_cloud_functions_v2_functions_proto_rawDesc = "" +
	"\n" +
	...
	"\fbuild_config\x18\x03 \x01(\v2&.google.cloud.functions.v2.BuildConfigR\vbuildConfig\x12O\n" +
	"\x0eservice_config\x18\x04 \x01(\v2(.google.cloud.functions.v2.ServiceConfigR\rserviceConfig\x12L\n" +
	"\revent_trigger\x18\x05 \x01(\v2'.google.cloud.functions.v2.EventTriggerR\feventTrigger\x12D\n" +
	"\x05state\x18\x06 \x01(\x0e2).google.cloud.functions.v2.Function.StateB\x03\xe0A\x03R\x05state\x12@\n" +
	"\vupdate_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12G\n" +
	"\x06labels\x18\b \x03(\v2/.google.cloud.functions.v2.Function.LabelsEntryR\x06labels\x12S\n" +
	"\x0estate_messages\x18\t \x03(\v2'.google.cloud.functions.v2.StateMessageB\x03\xe0A\x03R\rstateMessages\x12H\n" +
	"\venvironment\x18\n" +
	" \x01(\x0e2&.google.cloud.functions.v2.EnvironmentR\venvironment\x12\x15\n" +
	...
	"&cloudfunctions.googleapis.com/Function\x12<projects/{project}/locations/{location}/functions/{function}*\tfunctions2\bfunction\"\xd2\x01\n" +
	"\fStateMessage\x12L\n" +
	"\bseverity\x18\x01 \x01(\x0e20.google.cloud.functions.v2.StateMessage.SeverityR\bseverity\x12\x12\n" +
	...
	"\brevision\"\xca\x01\n" +
	"\x06Source\x12Q\n" +
	"\x0estorage_source\x18\x01 \x01(\v2(.google.cloud.functions.v2.StorageSourceH\x00R\rstorageSource\x12H\n" +
	"\vrepo_source\x18\x02 \x01(\v2%.google.cloud.functions.v2.RepoSourceH\x00R\n" +
	"repoSource\x12\x19\n" +
	"\agit_uri\x18\x03 \x01(\tH\x00R\x06gitUriB\b\n" +
	"\x06source\"\xe6\x01\n" +
	"\x10SourceProvenance\x12`\n" +
	"\x17resolved_storage_source\x18\x01 \x01(\v2(.google.cloud.functions.v2.StorageSourceR\x15resolvedStorageSource\x12W\n" +
	"\x14resolved_repo_source\x18\x02 \x01(\v2%.google.cloud.functions.v2.RepoSourceR\x12resolvedRepoSource\x12\x17\n" +
	"\agit_uri\x18\x03 \x01(\tR\x06gitUri\"\xe9\b\n" +
	"\vBuildConfig\x12j\n" +
	"\x17automatic_update_policy\x18( \x01(\v20.google.cloud.functions.v2.AutomaticUpdatePolicyH\x00R\x15automaticUpdatePolicy\x12h\n" +
	"\x17on_deploy_update_policy\x18) \x01(\v2/.google.cloud.functions.v2.OnDeployUpdatePolicyH\x00R\x14onDeployUpdatePolicy\x12=\n" +
	...
	"entryPoint\x129\n" +
	"\x06source\x18\x04 \x01(\v2!.google.cloud.functions.v2.SourceR\x06source\x12]\n" +
	"\x11source_provenance\x18\b \x01(\v2+.google.cloud.functions.v2.SourceProvenanceB\x03\xe0A\x03R\x10sourceProvenance\x12J\n" +
	"\vworker_pool\x18\x05 \x01(\tB)\xfaA&\n" +
	"$cloudbuild.googleapis.com/WorkerPoolR\n" +
	"workerPool\x12u\n" +
	"\x15environment_variables\x18\x06 \x03(\v2@.google.cloud.functions.v2.BuildConfig.EnvironmentVariablesEntryR\x14environmentVariables\x12b\n" +
	"\x0fdocker_registry\x18\n" +
	" \x01(\x0e25.google.cloud.functions.v2.BuildConfig.DockerRegistryB\x02\x18\x01R\x0edockerRegistry\x12\\\n" +
	...
	"\ravailable_cpu\x18\x16 \x01(\tR\favailableCpu\x12w\n" +
	"\x15environment_variables\x18\x04 \x03(\v2B.google.cloud.functions.v2.ServiceConfig.EnvironmentVariablesEntryR\x14environmentVariables\x12,\n" +
	...
	"\"vpcaccess.googleapis.com/ConnectorR\fvpcConnector\x12\x86\x01\n" +
	"\x1dvpc_connector_egress_settings\x18\a \x01(\x0e2C.google.cloud.functions.v2.ServiceConfig.VpcConnectorEgressSettingsR\x1avpcConnectorEgressSettings\x12c\n" +
	"\x10ingress_settings\x18\b \x01(\x0e28.google.cloud.functions.v2.ServiceConfig.IngressSettingsR\x0fingressSettings\x12\x15\n" +
	"\x03uri\x18\t \x01(\tB\x03\xe0A\x03R\x03uri\x122\n" +
	"\x15service_account_email\x18\n" +
	" \x01(\tR\x13serviceAccountEmail\x12B\n" +
	"\x1eall_traffic_on_latest_revision\x18\x10 \x01(\bR\x1aallTrafficOnLatestRevision\x12i\n" +
	"\x1csecret_environment_variables\x18\x11 \x03(\v2'.google.cloud.functions.v2.SecretEnvVarR\x1asecretEnvironmentVariables\x12N\n" +
	"\x0esecret_volumes\x18\x13 \x03(\v2'.google.cloud.functions.v2.SecretVolumeR\rsecretVolumes\x12\x1f\n" +
	"\brevision\x18\x12 \x01(\tB\x03\xe0A\x03R\brevision\x12G\n" +
	" max_instance_request_concurrency\x18\x14 \x01(\x05R\x1dmaxInstanceRequestConcurrency\x12]\n" +
	"\x0esecurity_level\x18\x15 \x01(\x0e26.google.cloud.functions.v2.ServiceConfig.SecurityLevelR\rsecurityLevel\x12C\n" +
	...
	"\bversions\x18\x04 \x03(\v25.google.cloud.functions.v2.SecretVolume.SecretVersionR\bversions\x1a=\n" +
	"\rSecretVersion\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\x12\x12\n" +
	"\x04path\x18\x02 \x01(\tR\x04path\"\x8d\x05\n" +
	"\fEventTrigger\x12A\n" +
	...
	"\n" +
	"event_type\x18\x03 \x01(\tB\x03\xe0A\x02R\teventType\x12K\n" +
	"\revent_filters\x18\x04 \x03(\v2&.google.cloud.functions.v2.EventFilterR\feventFilters\x12F\n" +
	"\fpubsub_topic\x18\x05 \x01(\tB#\xe0A\x01\xfaA\x1d\n" +
	"\x1bpubsub.googleapis.com/TopicR\vpubsubTopic\x127\n" +
	"\x15service_account_email\x18\x06 \x01(\tB\x03\xe0A\x01R\x13serviceAccountEmail\x12[\n" +
	"\fretry_policy\x18\a \x01(\x0e23.google.cloud.functions.v2.EventTrigger.RetryPolicyB\x03\xe0A\x01R\vretryPolicy\x12A\n" +
	...
	"\x15ListFunctionsResponse\x12A\n" +
	"\tfunctions\x18\x01 \x03(\v2#.google.cloud.functions.v2.FunctionR\tfunctions\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12 \n" +
	"\vunreachable\x18\x03 \x03(\tR\vunreachable\"\xc1\x01\n" +
	"\x15CreateFunctionRequest\x12A\n" +
	"\x06parent\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!locations.googleapis.com/LocationR\x06parent\x12D\n" +
	"\bfunction\x18\x02 \x01(\v2#.google.cloud.functions.v2.FunctionB\x03\xe0A\x02R\bfunction\x12\x1f\n" +
	"\vfunction_id\x18\x03 \x01(\tR\n" +
	"functionId\"\x9a\x01\n" +
	"\x15UpdateFunctionRequest\x12D\n" +
	"\bfunction\x18\x01 \x01(\v2#.google.cloud.functions.v2.FunctionB\x03\xe0A\x02R\bfunction\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"[\n" +
	"\x15DeleteFunctionRequest\x12B\n" +
	"\x04name\x18\x01 \x01(\tB.\xe0A\x02\xfaA(\n" +
	"&cloudfunctions.googleapis.com/FunctionR\x04name\"\xf1\x01\n" +
	...
	"!cloudkms.googleapis.com/CryptoKeyR\n" +
	"kmsKeyName\x12H\n" +
	"\venvironment\x18\x03 \x01(\x0e2&.google.cloud.functions.v2.EnvironmentR\venvironment\"\x8b\x01\n" +
	"\x19GenerateUploadUrlResponse\x12\x1d\n" +
	"\n" +
	"upload_url\x18\x01 \x01(\tR\tuploadUrl\x12O\n" +
	"\x0estorage_source\x18\x02 \x01(\v2(.google.cloud.functions.v2.StorageSourceR\rstorageSource\"`\n" +
	...
	"\x06filter\x18\x02 \x01(\tR\x06filter\"\xe7\x04\n" +
	"\x14ListRuntimesResponse\x12S\n" +
	"\bruntimes\x18\x01 \x03(\v27.google.cloud.functions.v2.ListRuntimesResponse.RuntimeR\bruntimes\x1a\xf8\x02\n" +
	"\aRuntime\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12!\n" +
	"\fdisplay_name\x18\x05 \x01(\tR\vdisplayName\x12R\n" +
	"\x05stage\x18\x02 \x01(\x0e2<.google.cloud.functions.v2.ListRuntimesResponse.RuntimeStageR\x05stage\x12\x1a\n" +
	"\bwarnings\x18\x03 \x03(\tR\bwarnings\x12H\n" +
	"\venvironment\x18\x04 \x01(\x0e2&.google.cloud.functions.v2.EnvironmentR\venvironment\x12<\n" +
	...
	"\x0fruntime_version\x18\x01 \x01(\tB\x03\xe0A\x03R\x0eruntimeVersion\"\xb2\x04\n" +
	...
	"apiVersion\x12?\n" +
	"\x10request_resource\x18\b \x01(\v2\x14.google.protobuf.AnyR\x0frequestResource\x128\n" +
	"\x06stages\x18\t \x03(\v2 .google.cloud.functions.v2.StageR\x06stages\x12!\n" +
	"\fsource_token\x18\n" +
	" \x01(\tR\vsourceToken\x12\x1d\n" +
	"\n" +
	"build_name\x18\r \x01(\tR\tbuildName\x12O\n" +
	"\x0eoperation_type\x18\v \x01(\x0e2(.google.cloud.functions.v2.OperationTypeR\roperationType\"^\n" +
	"\x10LocationMetadata\x12J\n" +
	"\fenvironments\x18\x01 \x03(\x0e2&.google.cloud.functions.v2.EnvironmentR\fenvironments\"\x80\x04\n" +
	"\x05Stage\x129\n" +
	"\x04name\x18\x01 \x01(\x0e2%.google.cloud.functions.v2.Stage.NameR\x04name\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12<\n" +
	"\x05state\x18\x03 \x01(\x0e2&.google.cloud.functions.v2.Stage.StateR\x05state\x12\x1a\n" +
	"\bresource\x18\x04 \x01(\tR\bresource\x12!\n" +
	"\fresource_uri\x18\x05 \x01(\tR\vresourceUri\x12N\n" +
	"\x0estate_messages\x18\x06 \x03(\v2'.google.cloud.functions.v2.StateMessageR\rstateMessages\"\x84\x01\n" +
	"\x04Name\x12\x14\n" +
	...
	"\vGetFunction\x12-.google.cloud.functions.v2.GetFunctionRequest\x1a#.google.cloud.functions.v2.Function\"<\xdaA\x04name\x82\xd3\xe4\x93\x02/\x12-/v2/{name=projects/*/locations/*/functions/*}\x12\xb2\x01\n" +
	...
	"\"google.cloud.functions.v2.Function\x12+google.cloud.functions.v2.OperationMetadata\xdaA\x1bparent,function,function_id\x82\xd3\xe4\x93\x029:\bfunction\"-/v2/{parent=projects/*/locations/*}/functions\x12\x97\x02\n" +
	...
	"\"google.cloud.functions.v2.Function\x12+google.cloud.functions.v2.OperationMetadata\xdaA\x14function,update_mask\x82\xd3\xe4\x93\x02B:\bfunction26/v2/{function.name=projects/*/locations/*/functions/*}\x12\xe7\x01\n" +
	...
	"\x11GenerateUploadUrl\x123.google.cloud.functions.v2.GenerateUploadUrlRequest\x1a4.google.cloud.functions.v2.GenerateUploadUrlResponse\"J\x82\xd3\xe4\x93\x02D:\x01*\"?/v2/{parent=projects/*/locations/*}/functions:generateUploadUrl\x12\xd2\x01\n" +
	"\x13GenerateDownloadUrl\x125.google.cloud.functions.v2.GenerateDownloadUrlRequest\x1a6.google.cloud.functions.v2.GenerateDownloadUrlResponse\"L\x82\xd3\xe4\x93\x02F:\x01*\"A/v2/{name=projects/*/locations/*/functions/*}:generateDownloadUrl\x12\xae\x01\n" +
	"\fListRuntimes\x12..google.cloud.functions.v2.ListRuntimesRequest\x1a/.google.cloud.functions.v2.ListRuntimesResponse\"=\xdaA\x06parent\x82\xd3\xe4\x93\x02.\x12,/v2/{parent=projects/*/locations/*}/runtimes\x1aQ\xcaA\x1dcloudfunctions.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xee\a\xeaAo\n" +
	...
	"\x1dcom.google.cloud.functions.v2B\x0eFunctionsProtoP\x01Z;cloud.google.com/go/functions/apiv2/functionspb;functionspb\xa2\x02\x03GCFb\x06proto3"

var (
	file_google_cloud_functions_v2_functions_proto_rawDescOnce sync.Once
	file_google_cloud_functions_v2_functions_proto_rawDescData []byte
)
...
func file_google_cloud_functions_v2_functions_proto_rawDescGZIP() []byte {
	file_google_cloud_functions_v2_functions_proto_rawDescOnce.Do(func() {
		file_google_cloud_functions_v2_functions_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_functions_v2_functions_proto_rawDesc), len(file_google_cloud_functions_v2_functions_proto_rawDesc)))
	})
...
func file_google_cloud_functions_v2_functions_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_functions_v2_functions_proto_rawDesc), len(file_google_cloud_functions_v2_functions_proto_rawDesc)),
			NumEnums:      12,
			NumMessages:   34,
			NumExtensions: 0,
			NumServices:   1,
