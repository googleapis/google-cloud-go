...
func file_google_cloud_vmwareengine_v1_vmwareengine_resources_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_vmwareengine_v1_vmwareengine_resources_proto_msgTypes[27].Exporter = func(v any, i int) any {
		...
		file_google_cloud_vmwareengine_v1_vmwareengine_resources_proto_msgTypes[34].Exporter = func(v any, i int) any {
		...
		file_google_cloud_vmwareengine_v1_vmwareengine_resources_proto_msgTypes[35].Exporter = func(v any, i int) any {
		...
		file_google_cloud_vmwareengine_v1_vmwareengine_resources_proto_msgTypes[36].Exporter = func(v any, i int) any {
