...
const file_google_cloud_talent_v4_event_proto_rawDesc = "" +
	"\n" +
	"\"google/cloud/talent/v4/event.proto\x12\x16google.cloud.talent.v4\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf9\x01\n" +
	...
	"createTime\x12?\n" +
	"\tjob_event\x18\x05 \x01(\v2 .google.cloud.talent.v4.JobEventH\x00R\bjobEvent\x12\x1f\n" +
	"\vevent_notes\x18\t \x01(\tR\n" +
	"eventNotesB\a\n" +
	"\x05event\"\xec\x03\n" +
	"\bJobEvent\x12F\n" +
	"\x04type\x18\x01 \x01(\x0e2-.google.cloud.talent.v4.JobEvent.JobEventTypeB\x03\xe0A\x02R\x04type\x12\x17\n" +
	"\x04jobs\x18\x02 \x03(\tB\x03\xe0A\x02R\x04jobs\"\xfe\x02\n" +
...
var (
	...
	file_google_cloud_talent_v4_event_proto_rawDescData []byte
)

func file_google_cloud_talent_v4_event_proto_rawDescGZIP() []byte {
	file_google_cloud_talent_v4_event_proto_rawDescOnce.Do(func() {
		file_google_cloud_talent_v4_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4_event_proto_rawDesc), len(file_google_cloud_talent_v4_event_proto_rawDesc)))
	})
...
var file_google_cloud_talent_v4_event_proto_goTypes = []any{
...
func file_google_cloud_talent_v4_event_proto_init() {
	...
	file_google_cloud_talent_v4_event_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4_event_proto_rawDesc), len(file_google_cloud_talent_v4_event_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
