...
const file_google_cloud_talent_v4_filters_proto_rawDesc = "" +
	"\n" +
	"$google/cloud/talent/v4/filters.proto\x12\x16google.cloud.talent.v4\x1a\x1fgoogle/api/field_behavior.proto\x1a#google/cloud/talent/v4/common.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x18google/type/latlng.proto\x1a\x1bgoogle/type/timeofday.proto\"\xc9\x06\n" +
	"\bJobQuery\x12\x14\n" +
	"\x05query\x18\x01 \x01(\tR\x05query\x12.\n" +
	"\x13query_language_code\x18\x0e \x01(\tR\x11queryLanguageCode\x12\x1c\n" +
	"\tcompanies\x18\x02 \x03(\tR\tcompanies\x12Q\n" +
	"\x10location_filters\x18\x03 \x03(\v2&.google.cloud.talent.v4.LocationFilterR\x0flocationFilters\x12J\n" +
	"\x0ejob_categories\x18\x04 \x03(\x0e2#.google.cloud.talent.v4.JobCategoryR\rjobCategories\x12L\n" +
	"\x0ecommute_filter\x18\x05 \x01(\v2%.google.cloud.talent.v4.CommuteFilterR\rcommuteFilter\x122\n" +
	"\x15company_display_names\x18\x06 \x03(\tR\x13companyDisplayNames\x12[\n" +
	"\x13compensation_filter\x18\a \x01(\v2*.google.cloud.talent.v4.CompensationFilterR\x12compensationFilter\x126\n" +
	"\x17custom_attribute_filter\x18\b \x01(\tR\x15customAttributeFilter\x12.\n" +
	"\x13disable_spell_check\x18\t \x01(\bR\x11disableSpellCheck\x12Q\n" +
	"\x10employment_types\x18\n" +
	" \x03(\x0e2&.google.cloud.talent.v4.EmploymentTypeR\x0femploymentTypes\x12%\n" +
	"\x0elanguage_codes\x18\v \x03(\tR\rlanguageCodes\x12T\n" +
	"\x12publish_time_range\x18\f \x01(\v2&.google.cloud.talent.v4.TimestampRangeR\x10publishTimeRange\x12#\n" +
	"\rexcluded_jobs\x18\r \x03(\tR\fexcludedJobs\"\xb2\x03\n" +
	...
	"\x11distance_in_miles\x18\x04 \x01(\x01R\x0fdistanceInMiles\x12s\n" +
	"\x16telecommute_preference\x18\x05 \x01(\x0e2<.google.cloud.talent.v4.LocationFilter.TelecommutePreferenceR\x15telecommutePreference\"\x95\x01\n" +
	...
	"\x19TELECOMMUTE_JOBS_EXCLUDED\x10\x03\"\xfc\x03\n" +
	"\x12CompensationFilter\x12N\n" +
	"\x04type\x18\x01 \x01(\x0e25.google.cloud.talent.v4.CompensationFilter.FilterTypeB\x03\xe0A\x02R\x04type\x12T\n" +
	"\x05units\x18\x02 \x03(\x0e29.google.cloud.talent.v4.CompensationInfo.CompensationUnitB\x03\xe0A\x02R\x05units\x12P\n" +
	"\x05range\x18\x03 \x01(\v2:.google.cloud.talent.v4.CompensationInfo.CompensationRangeR\x05range\x12e\n" +
	...
	"\x17ANNUALIZED_TOTAL_AMOUNT\x10\x04\"\xa7\x04\n" +
	"\rCommuteFilter\x12Q\n" +
	"\x0ecommute_method\x18\x01 \x01(\x0e2%.google.cloud.talent.v4.CommuteMethodB\x03\xe0A\x02R\rcommuteMethod\x12E\n" +
	...
	"\x19allow_imprecise_addresses\x18\x04 \x01(\bR\x17allowImpreciseAddresses\x12V\n" +
	"\froad_traffic\x18\x05 \x01(\x0e21.google.cloud.talent.v4.CommuteFilter.RoadTrafficH\x00R\vroadTraffic\x12?\n" +
	...
	"\x0etraffic_optionBf\n" +
	"\x1acom.google.cloud.talent.v4B\fFiltersProtoP\x01Z2cloud.google.com/go/talent/apiv4/talentpb;talentpb\xa2\x02\x03CTSb\x06proto3"

var (
	file_google_cloud_talent_v4_filters_proto_rawDescOnce sync.Once
	file_google_cloud_talent_v4_filters_proto_rawDescData []byte
)
...
func file_google_cloud_talent_v4_filters_proto_rawDescGZIP() []byte {
	file_google_cloud_talent_v4_filters_proto_rawDescOnce.Do(func() {
		file_google_cloud_talent_v4_filters_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4_filters_proto_rawDesc), len(file_google_cloud_talent_v4_filters_proto_rawDesc)))
	})
...
var file_google_cloud_talent_v4_filters_proto_goTypes = []any{
...
func file_google_cloud_talent_v4_filters_proto_init() {
	...
	file_google_cloud_talent_v4_filters_proto_msgTypes[3].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4_filters_proto_rawDesc), len(file_google_cloud_talent_v4_filters_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
