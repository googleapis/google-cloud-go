...
const file_google_cloud_talent_v4_completion_service_proto_rawDesc = "" +
	"\n" +
	"/google/cloud/talent/v4/completion_service.proto\x12\x16google.cloud.talent.v4\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a#google/cloud/talent/v4/common.proto\"\xc6\x04\n" +
	"\x14CompleteQueryRequest\x12:\n" +
	"\x06tenant\x18\x01 \x01(\tB\"\xe0A\x02\xfaA\x1c\n" +
	"\x1ajobs.googleapis.com/TenantR\x06tenant\x12\x19\n" +
	...
	"\x1bjobs.googleapis.com/CompanyR\acompany\x12R\n" +
	"\x05scope\x18\x06 \x01(\x0e2<.google.cloud.talent.v4.CompleteQueryRequest.CompletionScopeR\x05scope\x12O\n" +
	"\x04type\x18\a \x01(\x0e2;.google.cloud.talent.v4.CompleteQueryRequest.CompletionTypeR\x04type\"K\n" +
	...
	"\bCOMBINED\x10\x03\"\xef\x02\n" +
	"\x15CompleteQueryResponse\x12m\n" +
	"\x12completion_results\x18\x01 \x03(\v2>.google.cloud.talent.v4.CompleteQueryResponse.CompletionResultR\x11completionResults\x12D\n" +
	"\bmetadata\x18\x02 \x01(\v2(.google.cloud.talent.v4.ResponseMetadataR\bmetadata\x1a\xa0\x01\n" +
	"\x10CompletionResult\x12\x1e\n" +
	"\n" +
	"suggestion\x18\x01 \x01(\tR\n" +
	"suggestion\x12O\n" +
	"\x04type\x18\x02 \x01(\x0e2;.google.cloud.talent.v4.CompleteQueryRequest.CompletionTypeR\x04type\x12\x1b\n" +
	"\timage_uri\x18\x03 \x01(\tR\bimageUri2\xa2\x02\n" +
	"\n" +
...
var (
	...
	file_google_cloud_talent_v4_completion_service_proto_rawDescData []byte
)
...
func file_google_cloud_talent_v4_completion_service_proto_rawDescGZIP() []byte {
	file_google_cloud_talent_v4_completion_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_talent_v4_completion_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4_completion_service_proto_rawDesc), len(file_google_cloud_talent_v4_completion_service_proto_rawDesc)))
	})
...
func file_google_cloud_talent_v4_completion_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4_completion_service_proto_rawDesc), len(file_google_cloud_talent_v4_completion_service_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
