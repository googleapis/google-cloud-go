...
var file_google_cloud_talent_v4_completion_service_proto_rawDesc = []byte{
	...
	0x73, 0x42, 0x7a, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
...
var file_google_cloud_talent_v4_completion_service_proto_goTypes = []interface{}{
...
func file_google_cloud_talent_v4_completion_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_talent_v4_completion_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_talent_v4_completion_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_talent_v4_completion_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
