...
const file_google_cloud_talent_v4_job_proto_rawDesc = "" +
	"\n" +
	" google/cloud/talent/v4/job.proto\x12\x16google.cloud.talent.v4\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a#google/cloud/talent/v4/common.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9e\x13\n" +
	"\x03Job\x12\x12\n" +
	...
	"\x10application_info\x18\a \x01(\v2+.google.cloud.talent.v4.Job.ApplicationInfoR\x0fapplicationInfo\x12E\n" +
	"\fjob_benefits\x18\b \x03(\x0e2\".google.cloud.talent.v4.JobBenefitR\vjobBenefits\x12U\n" +
	"\x11compensation_info\x18\t \x01(\v2(.google.cloud.talent.v4.CompensationInfoR\x10compensationInfo\x12^\n" +
	"\x11custom_attributes\x18\n" +
	" \x03(\v21.google.cloud.talent.v4.Job.CustomAttributesEntryR\x10customAttributes\x12E\n" +
	"\fdegree_types\x18\v \x03(\x0e2\".google.cloud.talent.v4.DegreeTypeR\vdegreeTypes\x12\x1e\n" +
	"\n" +
	"department\x18\f \x01(\tR\n" +
	"department\x12Q\n" +
	"\x10employment_types\x18\r \x03(\x0e2&.google.cloud.talent.v4.EmploymentTypeR\x0femploymentTypes\x12\x1e\n" +
	"\n" +
	"incentives\x18\x0e \x01(\tR\n" +
	"incentives\x12#\n" +
	"\rlanguage_code\x18\x0f \x01(\tR\flanguageCode\x12=\n" +
	"\tjob_level\x18\x10 \x01(\x0e2 .google.cloud.talent.v4.JobLevelR\bjobLevel\x12'\n" +
	...
	"\x0eposting_region\x18\x14 \x01(\x0e2%.google.cloud.talent.v4.PostingRegionR\rpostingRegion\x12F\n" +
	"\n" +
	"visibility\x18\x15 \x01(\x0e2\".google.cloud.talent.v4.VisibilityB\x02\x18\x01R\n" +
	"visibility\x12@\n" +
	...
	"\x14company_display_name\x18\x1c \x01(\tB\x03\xe0A\x03R\x12companyDisplayName\x12O\n" +
	"\fderived_info\x18\x1d \x01(\v2'.google.cloud.talent.v4.Job.DerivedInfoB\x03\xe0A\x03R\vderivedInfo\x12\\\n" +
	"\x12processing_options\x18\x1e \x01(\v2-.google.cloud.talent.v4.Job.ProcessingOptionsR\x11processingOptions\x1a_\n" +
	...
	"\vDerivedInfo\x12>\n" +
	"\tlocations\x18\x01 \x03(\v2 .google.cloud.talent.v4.LocationR\tlocations\x12J\n" +
	"\x0ejob_categories\x18\x03 \x03(\x0e2#.google.cloud.talent.v4.JobCategoryR\rjobCategories\x1a\xb5\x01\n" +
	"\x11ProcessingOptions\x12I\n" +
	"!disable_street_address_resolution\x18\x01 \x01(\bR\x1edisableStreetAddressResolution\x12U\n" +
	"\x11html_sanitization\x18\x02 \x01(\x0e2(.google.cloud.talent.v4.HtmlSanitizationR\x10htmlSanitization\x1al\n" +
	"\x15CustomAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12=\n" +
	"\x05value\x18\x02 \x01(\v2'.google.cloud.talent.v4.CustomAttributeR\x05value:\x028\x01:L\xeaAI\n" +
	"\x17jobs.googleapis.com/Job\x12.projects/{project}/tenants/{tenant}/jobs/{job}Bb\n" +
	"\x1acom.google.cloud.talent.v4B\bJobProtoP\x01Z2cloud.google.com/go/talent/apiv4/talentpb;talentpb\xa2\x02\x03CTSb\x06proto3"

var (
	file_google_cloud_talent_v4_job_proto_rawDescOnce sync.Once
	file_google_cloud_talent_v4_job_proto_rawDescData []byte
)

func file_google_cloud_talent_v4_job_proto_rawDescGZIP() []byte {
	file_google_cloud_talent_v4_job_proto_rawDescOnce.Do(func() {
		file_google_cloud_talent_v4_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4_job_proto_rawDesc), len(file_google_cloud_talent_v4_job_proto_rawDesc)))
	})
...
var file_google_cloud_talent_v4_job_proto_goTypes = []any{
...
func file_google_cloud_talent_v4_job_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4_job_proto_rawDesc), len(file_google_cloud_talent_v4_job_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
