...
const file_google_cloud_talent_v4_tenant_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x06tenant\x18\x02 \x01(\v2\x1e.google.cloud.talent.v4.TenantB\x03\xe0A\x02R\x06tenant\"J\n" +
	"\x10GetTenantRequest\x126\n" +
	"\x04name\x18\x01 \x01(\tB\"\xe0A\x02\xfaA\x1c\n" +
	"\x1ajobs.googleapis.com/TenantR\x04name\"\x8f\x01\n" +
	"\x13UpdateTenantRequest\x12;\n" +
	"\x06tenant\x18\x01 \x01(\v2\x1e.google.cloud.talent.v4.TenantB\x03\xe0A\x02R\x06tenant\x12;\n" +
	...
	"\atenants\x18\x01 \x03(\v2\x1e.google.cloud.talent.v4.TenantR\atenants\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12D\n" +
	"\bmetadata\x18\x03 \x01(\v2(.google.cloud.talent.v4.ResponseMetadataR\bmetadata2\xf0\x06\n" +
	"\rTenantService\x12\x9c\x01\n" +
	"\fCreateTenant\x12+.google.cloud.talent.v4.CreateTenantRequest\x1a\x1e.google.cloud.talent.v4.Tenant\"?\xdaA\rparent,tenant\x82\xd3\xe4\x93\x02):\x06tenant\"\x1f/v4/{parent=projects/*}/tenants\x12\x85\x01\n" +
	...
	"\fUpdateTenant\x12+.google.cloud.talent.v4.UpdateTenantRequest\x1a\x1e.google.cloud.talent.v4.Tenant\"K\xdaA\x12tenant,update_mask\x82\xd3\xe4\x93\x020:\x06tenant2&/v4/{tenant.name=projects/*/tenants/*}\x12\x83\x01\n" +
	"\fDeleteTenant\x12+.google.cloud.talent.v4.DeleteTenantRequest\x1a\x16.google.protobuf.Empty\".\xdaA\x04name\x82\xd3\xe4\x93\x02!*\x1f/v4/{name=projects/*/tenants/*}\x12\x98\x01\n" +
	"\vListTenants\x12*.google.cloud.talent.v4.ListTenantsRequest\x1a+.google.cloud.talent.v4.ListTenantsResponse\"0\xdaA\x06parent\x82\xd3\xe4\x93\x02!\x12\x1f/v4/{parent=projects/*}/tenants\x1al\xcaA\x13jobs.googleapis.com\xd2AShttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/jobsBl\n" +
...
var (
	...
	file_google_cloud_talent_v4_tenant_service_proto_rawDescData []byte
)
...
func file_google_cloud_talent_v4_tenant_service_proto_rawDescGZIP() []byte {
	file_google_cloud_talent_v4_tenant_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_talent_v4_tenant_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4_tenant_service_proto_rawDesc), len(file_google_cloud_talent_v4_tenant_service_proto_rawDesc)))
	})
...
func file_google_cloud_talent_v4_tenant_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4_tenant_service_proto_rawDesc), len(file_google_cloud_talent_v4_tenant_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
