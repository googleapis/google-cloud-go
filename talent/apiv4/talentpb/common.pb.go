...
const file_google_cloud_talent_v4_common_proto_rawDesc = "" +
	"\n" +
	"#google/cloud/talent/v4/common.proto\x12\x16google.cloud.talent.v4\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x18google/type/latlng.proto\x1a\x17google/type/money.proto\x1a google/type/postal_address.proto\"\x82\x01\n" +
	"\x0eTimestampRange\x129\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x125\n" +
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\"\xe4\x03\n" +
	"\bLocation\x12R\n" +
	"\rlocation_type\x18\x01 \x01(\x0e2-.google.cloud.talent.v4.Location.LocationTypeR\flocationType\x12A\n" +
	...
	"\x11allow_missing_ids\x18\x04 \x01(\bR\x0fallowMissingIds\x12C\n" +
	"\vdevice_info\x18\x05 \x01(\v2\".google.cloud.talent.v4.DeviceInfoR\n" +
	"deviceInfo\"1\n" +
	...
	"\n" +
	"DeviceInfo\x12N\n" +
	"\vdevice_type\x18\x01 \x01(\x0e2-.google.cloud.talent.v4.DeviceInfo.DeviceTypeR\n" +
	"deviceType\x12\x0e\n" +
	...
	"\x0ecorrected_html\x18\x03 \x01(\tR\rcorrectedHtml\"\xb7\n" +
	"\n" +
	"\x10CompensationInfo\x12T\n" +
	"\aentries\x18\x01 \x03(\v2:.google.cloud.talent.v4.CompensationInfo.CompensationEntryR\aentries\x12\x8c\x01\n" +
	"\"annualized_base_compensation_range\x18\x02 \x01(\v2:.google.cloud.talent.v4.CompensationInfo.CompensationRangeB\x03\xe0A\x03R\x1fannualizedBaseCompensationRange\x12\x8e\x01\n" +
	"#annualized_total_compensation_range\x18\x03 \x01(\v2:.google.cloud.talent.v4.CompensationInfo.CompensationRangeB\x03\xe0A\x03R annualizedTotalCompensationRange\x1a\xc1\x03\n" +
	"\x11CompensationEntry\x12M\n" +
	"\x04type\x18\x01 \x01(\x0e29.google.cloud.talent.v4.CompensationInfo.CompensationTypeR\x04type\x12M\n" +
	"\x04unit\x18\x02 \x01(\x0e29.google.cloud.talent.v4.CompensationInfo.CompensationUnitR\x04unit\x12,\n" +
	"\x06amount\x18\x03 \x01(\v2\x12.google.type.MoneyH\x00R\x06amount\x12R\n" +
	"\x05range\x18\x04 \x01(\v2:.google.cloud.talent.v4.CompensationInfo.CompensationRangeH\x00R\x05range\x12 \n" +
	...
	"\x17OTHER_COMPENSATION_UNIT\x10\a\"\xa9\x04\n" +
	"\x16BatchOperationMetadata\x12J\n" +
	"\x05state\x18\x01 \x01(\x0e24.google.cloud.talent.v4.BatchOperationMetadata.StateR\x05state\x12+\n" +
	...
	"\aCYCLING\x10\x04\x12\x16\n" +
	"\x12TRANSIT_ACCESSIBLE\x10\x05Be\n" +
	"\x1acom.google.cloud.talent.v4B\vCommonProtoP\x01Z2cloud.google.com/go/talent/apiv4/talentpb;talentpb\xa2\x02\x03CTSb\x06proto3"

var (
	file_google_cloud_talent_v4_common_proto_rawDescOnce sync.Once
	file_google_cloud_talent_v4_common_proto_rawDescData []byte
)
...
func file_google_cloud_talent_v4_common_proto_rawDescGZIP() []byte {
	file_google_cloud_talent_v4_common_proto_rawDescOnce.Do(func() {
		file_google_cloud_talent_v4_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4_common_proto_rawDesc), len(file_google_cloud_talent_v4_common_proto_rawDesc)))
	})
...
func file_google_cloud_talent_v4_common_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4_common_proto_rawDesc), len(file_google_cloud_talent_v4_common_proto_rawDesc)),
			NumEnums:      15,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
