...
const file_google_cloud_talent_v4beta1_job_service_proto_rawDesc = "" +
	...
	"\bjob_view\x18\x05 \x01(\x0e2$.google.cloud.talent.v4beta1.JobViewR\ajobView\"\xbb\x01\n" +
	"\x10ListJobsResponse\x124\n" +
	"\x04jobs\x18\x01 \x03(\v2 .google.cloud.talent.v4beta1.JobR\x04jobs\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12I\n" +
	"\bmetadata\x18\x03 \x01(\v2-.google.cloud.talent.v4beta1.ResponseMetadataR\bmetadata\"\xab\x0f\n" +
	"\x11SearchJobsRequest\x127\n" +
	"\x06parent\x18\x01 \x01(\tB\x1f\xe0A\x02\xfaA\x19\x12\x17jobs.googleapis.com/JobR\x06parent\x12Z\n" +
	"\vsearch_mode\x18\x02 \x01(\x0e29.google.cloud.talent.v4beta1.SearchJobsRequest.SearchModeR\n" +
	"searchMode\x12\\\n" +
	"\x10request_metadata\x18\x03 \x01(\v2,.google.cloud.talent.v4beta1.RequestMetadataB\x03\xe0A\x02R\x0frequestMetadata\x12B\n" +
	"\tjob_query\x18\x04 \x01(\v2%.google.cloud.talent.v4beta1.JobQueryR\bjobQuery\x12+\n" +
	"\x11enable_broadening\x18\x05 \x01(\bR\x10enableBroadening\x12A\n" +
	"\x1brequire_precise_result_size\x18\x06 \x01(\bB\x02\x18\x01R\x18requirePreciseResultSize\x12X\n" +
	"\x11histogram_queries\x18\a \x03(\v2+.google.cloud.talent.v4beta1.HistogramQueryR\x10histogramQueries\x12?\n" +
	"\bjob_view\x18\b \x01(\x0e2$.google.cloud.talent.v4beta1.JobViewR\ajobView\x12\x16\n" +
	"\x06offset\x18\t \x01(\x05R\x06offset\x12\x1b\n" +
	"\tpage_size\x18\n" +
	" \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\v \x01(\tR\tpageToken\x12\x19\n" +
	"\border_by\x18\f \x01(\tR\aorderBy\x12x\n" +
	"\x15diversification_level\x18\r \x01(\x0e2C.google.cloud.talent.v4beta1.SearchJobsRequest.DiversificationLevelR\x14diversificationLevel\x12p\n" +
	"\x13custom_ranking_info\x18\x0e \x01(\v2@.google.cloud.talent.v4beta1.SearchJobsRequest.CustomRankingInfoR\x11customRankingInfo\x122\n" +
	"\x15disable_keyword_match\x18\x10 \x01(\bR\x13disableKeywordMatch\x12m\n" +
	"\x12keyword_match_mode\x18\x12 \x01(\x0e2?.google.cloud.talent.v4beta1.SearchJobsRequest.KeywordMatchModeR\x10keywordMatchMode\x12w\n" +
	"\x13relevance_threshold\x18\x13 \x01(\x0e2A.google.cloud.talent.v4beta1.SearchJobsRequest.RelevanceThresholdB\x03\xe0A\x01R\x12relevanceThreshold\x1a\xbf\x02\n" +
	"\x11CustomRankingInfo\x12\x80\x01\n" +
	"\x10importance_level\x18\x01 \x01(\x0e2P.google.cloud.talent.v4beta1.SearchJobsRequest.CustomRankingInfo.ImportanceLevelB\x03\xe0A\x02R\x0fimportanceLevel\x122\n" +
	...
	"\x04HIGH\x10\x04\"\xcf\b\n" +
	"\x12SearchJobsResponse\x12`\n" +
	"\rmatching_jobs\x18\x01 \x03(\v2;.google.cloud.talent.v4beta1.SearchJobsResponse.MatchingJobR\fmatchingJobs\x12i\n" +
	"\x17histogram_query_results\x18\x02 \x03(\v21.google.cloud.talent.v4beta1.HistogramQueryResultR\x15histogramQueryResults\x12&\n" +
	"\x0fnext_page_token\x18\x03 \x01(\tR\rnextPageToken\x12P\n" +
	"\x10location_filters\x18\x04 \x03(\v2%.google.cloud.talent.v4beta1.LocationR\x0flocationFilters\x120\n" +
	"\x14estimated_total_size\x18\x05 \x01(\x05R\x12estimatedTotalSize\x12\x1d\n" +
	"\n" +
	"total_size\x18\x06 \x01(\x05R\ttotalSize\x12I\n" +
	"\bmetadata\x18\a \x01(\v2-.google.cloud.talent.v4beta1.ResponseMetadataR\bmetadata\x12;\n" +
	"\x1abroadened_query_jobs_count\x18\b \x01(\x05R\x17broadenedQueryJobsCount\x12Z\n" +
	"\x10spell_correction\x18\t \x01(\v2/.google.cloud.talent.v4beta1.SpellingCorrectionR\x0fspellCorrection\x1a\x9e\x02\n" +
	"\vMatchingJob\x122\n" +
	"\x03job\x18\x01 \x01(\v2 .google.cloud.talent.v4beta1.JobR\x03job\x12\x1f\n" +
	...
	"\fcommute_info\x18\x05 \x01(\v2;.google.cloud.talent.v4beta1.SearchJobsResponse.CommuteInfoR\vcommuteInfo\x1a\x9b\x01\n" +
	"\vCommuteInfo\x12H\n" +
	"\fjob_location\x18\x01 \x01(\v2%.google.cloud.talent.v4beta1.LocationR\vjobLocation\x12B\n" +
	"\x0ftravel_duration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x0etravelDuration\"\x8c\x01\n" +
	"\x16BatchCreateJobsRequest\x127\n" +
	"\x06parent\x18\x01 \x01(\tB\x1f\xe0A\x02\xfaA\x19\x12\x17jobs.googleapis.com/JobR\x06parent\x129\n" +
	"\x04jobs\x18\x02 \x03(\v2 .google.cloud.talent.v4beta1.JobB\x03\xe0A\x02R\x04jobs\"\xc9\x01\n" +
	"\x16BatchUpdateJobsRequest\x127\n" +
	"\x06parent\x18\x01 \x01(\tB\x1f\xe0A\x02\xfaA\x19\x12\x17jobs.googleapis.com/JobR\x06parent\x129\n" +
	"\x04jobs\x18\x02 \x03(\v2 .google.cloud.talent.v4beta1.JobB\x03\xe0A\x02R\x04jobs\x12;\n" +
	"\vupdate_mask\x18\x03 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"\xdd\x01\n" +
	"\x12JobOperationResult\x12Z\n" +
	"\vjob_results\x18\x01 \x03(\v29.google.cloud.talent.v4beta1.JobOperationResult.JobResultR\n" +
	"jobResults\x1ak\n" +
	"\tJobResult\x122\n" +
	"\x03job\x18\x01 \x01(\v2 .google.cloud.talent.v4beta1.JobR\x03job\x12*\n" +
	...
	"parent,job\x82\xd3\xe4\x93\x02X:\x01*Z&:\x01*\"!/v4beta1/{parent=projects/*}/jobs\"+/v4beta1/{parent=projects/*/tenants/*}/jobs\x12\x9b\x02\n" +
	...
	"\x12JobOperationResult\x12\x16BatchOperationMetadata\xdaA\vparent,jobs\x82\xd3\xe4\x93\x02p:\x01*Z2:\x01*\"-/v4beta1/{parent=projects/*}/jobs:batchCreate\"7/v4beta1/{parent=projects/*/tenants/*}/jobs:batchCreate\x12\xb7\x01\n" +
	"\x06GetJob\x12*.google.cloud.talent.v4beta1.GetJobRequest\x1a .google.cloud.talent.v4beta1.Job\"_\xdaA\x04name\x82\xd3\xe4\x93\x02RZ#\x12!/v4beta1/{name=projects/*/jobs/*}\x12+/v4beta1/{name=projects/*/tenants/*/jobs/*}\x12\xca\x01\n" +
	"\tUpdateJob\x12-.google.cloud.talent.v4beta1.UpdateJobRequest\x1a .google.cloud.talent.v4beta1.Job\"l\xdaA\x03job\x82\xd3\xe4\x93\x02`:\x01*Z*:\x01*2%/v4beta1/{job.name=projects/*/jobs/*}2//v4beta1/{job.name=projects/*/tenants/*/jobs/*}\x12\x9b\x02\n" +
	...
	"\x12JobOperationResult\x12\x16BatchOperationMetadata\xdaA\vparent,jobs\x82\xd3\xe4\x93\x02p:\x01*Z2:\x01*\"-/v4beta1/{parent=projects/*}/jobs:batchUpdate\"7/v4beta1/{parent=projects/*/tenants/*}/jobs:batchUpdate\x12\xb3\x01\n" +
	"\tDeleteJob\x12-.google.cloud.talent.v4beta1.DeleteJobRequest\x1a\x16.google.protobuf.Empty\"_\xdaA\x04name\x82\xd3\xe4\x93\x02RZ#*!/v4beta1/{name=projects/*/jobs/*}*+/v4beta1/{name=projects/*/tenants/*/jobs/*}\x12\xe4\x01\n" +
	"\x0fBatchDeleteJobs\x123.google.cloud.talent.v4beta1.BatchDeleteJobsRequest\x1a\x16.google.protobuf.Empty\"\x83\x01\xdaA\rparent,filter\x82\xd3\xe4\x93\x02m:\x01*Z/\"-/v4beta1/{parent=projects/*}/jobs:batchDelete\"7/v4beta1/{parent=projects/*/tenants/*}/jobs:batchDelete\x12\xd1\x01\n" +
	"\bListJobs\x12,.google.cloud.talent.v4beta1.ListJobsRequest\x1a-.google.cloud.talent.v4beta1.ListJobsResponse\"h\xdaA\rparent,filter\x82\xd3\xe4\x93\x02RZ#\x12!/v4beta1/{parent=projects/*}/jobs\x12+/v4beta1/{parent=projects/*/tenants/*}/jobs\x12\xdb\x01\n" +
	"\n" +
	"SearchJobs\x12..google.cloud.talent.v4beta1.SearchJobsRequest\x1a/.google.cloud.talent.v4beta1.SearchJobsResponse\"l\x82\xd3\xe4\x93\x02f:\x01*Z-:\x01*\"(/v4beta1/{parent=projects/*}/jobs:search\"2/v4beta1/{parent=projects/*/tenants/*}/jobs:search\x12\xf3\x01\n" +
	"\x12SearchJobsForAlert\x12..google.cloud.talent.v4beta1.SearchJobsRequest\x1a/.google.cloud.talent.v4beta1.SearchJobsResponse\"|\x82\xd3\xe4\x93\x02v:\x01*Z5:\x01*\"0/v4beta1/{parent=projects/*}/jobs:searchForAlert\":/v4beta1/{parent=projects/*/tenants/*}/jobs:searchForAlert\x1al\xcaA\x13jobs.googleapis.com\xd2AShttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/jobsBs\n" +
...
var (
	...
	file_google_cloud_talent_v4beta1_job_service_proto_rawDescData []byte
)
...
func file_google_cloud_talent_v4beta1_job_service_proto_rawDescGZIP() []byte {
	file_google_cloud_talent_v4beta1_job_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_talent_v4beta1_job_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4beta1_job_service_proto_rawDesc), len(file_google_cloud_talent_v4beta1_job_service_proto_rawDesc)))
	})
...
func file_google_cloud_talent_v4beta1_job_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4beta1_job_service_proto_rawDesc), len(file_google_cloud_talent_v4beta1_job_service_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   1,
