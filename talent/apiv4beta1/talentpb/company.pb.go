...
const file_google_cloud_talent_v4beta1_company_proto_rawDesc = "" +
	"\n" +
	")google/cloud/talent/v4beta1/company.proto\x12\x1bgoogle.cloud.talent.v4beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a(google/cloud/talent/v4beta1/common.proto\"\xca\x06\n" +
	"\aCompany\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x02R\vdisplayName\x12$\n" +
	"\vexternal_id\x18\x03 \x01(\tB\x03\xe0A\x02R\n" +
	"externalId\x12<\n" +
	"\x04size\x18\x04 \x01(\x0e2(.google.cloud.talent.v4beta1.CompanySizeR\x04size\x121\n" +
	...
	"(keyword_searchable_job_custom_attributes\x18\v \x03(\tB\x02\x18\x01R$keywordSearchableJobCustomAttributes\x12X\n" +
	"\fderived_info\x18\f \x01(\v20.google.cloud.talent.v4beta1.Company.DerivedInfoB\x03\xe0A\x03R\vderivedInfo\x12!\n" +
	"\tsuspended\x18\r \x01(\bB\x03\xe0A\x03R\tsuspended\x1ai\n" +
	"\vDerivedInfo\x12Z\n" +
	"\x15headquarters_location\x18\x01 \x01(\v2%.google.cloud.talent.v4beta1.LocationR\x14headquartersLocation:\x81\x01\xeaA~\n" +
...
var (
	...
	file_google_cloud_talent_v4beta1_company_proto_rawDescData []byte
)
...
func file_google_cloud_talent_v4beta1_company_proto_rawDescGZIP() []byte {
	file_google_cloud_talent_v4beta1_company_proto_rawDescOnce.Do(func() {
		file_google_cloud_talent_v4beta1_company_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4beta1_company_proto_rawDesc), len(file_google_cloud_talent_v4beta1_company_proto_rawDesc)))
	})
...
var file_google_cloud_talent_v4beta1_company_proto_goTypes = []any{
...
func file_google_cloud_talent_v4beta1_company_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4beta1_company_proto_rawDesc), len(file_google_cloud_talent_v4beta1_company_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
