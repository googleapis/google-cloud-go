...
//
// Deprecated: Marked as deprecated in google/cloud/talent/v4beta1/common.proto.
...
func (x *CompensationInfo_CompensationEntry) GetCompensationAmount() isCompensationInfo_CompensationEntry_CompensationAmount {
	if x != nil {
...
func (x *CompensationInfo_CompensationEntry) GetAmount() *money.Money {
	if x != nil {
		if x, ok := x.CompensationAmount.(*CompensationInfo_CompensationEntry_Amount); ok {
			return x.Amount
		}
	}
	return nil
...
func (x *CompensationInfo_CompensationEntry) GetRange() *CompensationInfo_CompensationRange {
	if x != nil {
		if x, ok := x.CompensationAmount.(*CompensationInfo_CompensationEntry_Range); ok {
			return x.Range
		}
	}
	return nil
...
const file_google_cloud_talent_v4beta1_common_proto_rawDesc = "" +
	"\n" +
	"(google/cloud/talent/v4beta1/common.proto\x12\x1bgoogle.cloud.talent.v4beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x18google/type/latlng.proto\x1a\x17google/type/money.proto\x1a google/type/postal_address.proto\"\x82\x01\n" +
	"\x0eTimestampRange\x129\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x125\n" +
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\"\xe9\x03\n" +
	"\bLocation\x12W\n" +
	"\rlocation_type\x18\x01 \x01(\x0e22.google.cloud.talent.v4beta1.Location.LocationTypeR\flocationType\x12A\n" +
	"\x0epostal_address\x18\x02 \x01(\v2\x1a.google.type.PostalAddressR\rpostalAddress\x12,\n" +
	"\alat_lng\x18\x03 \x01(\v2\x13.google.type.LatLngR\x06latLng\x12!\n" +
	"\fradius_miles\x18\x04 \x01(\x01R\vradiusMiles\"\xef\x01\n" +
	"\fLocationType\x12\x1d\n" +
	"\x19LOCATION_TYPE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aCOUNTRY\x10\x01\x12\x17\n" +
	"\x13ADMINISTRATIVE_AREA\x10\x02\x12\x1b\n" +
	"\x17SUB_ADMINISTRATIVE_AREA\x10\x03\x12\f\n" +
	"\bLOCALITY\x10\x04\x12\x0f\n" +
	"\vPOSTAL_CODE\x10\x05\x12\x10\n" +
	"\fSUB_LOCALITY\x10\x06\x12\x12\n" +
	"\x0eSUB_LOCALITY_1\x10\a\x12\x12\n" +
	"\x0eSUB_LOCALITY_2\x10\b\x12\x10\n" +
	"\fNEIGHBORHOOD\x10\t\x12\x12\n" +
	...
	"\x11allow_missing_ids\x18\x04 \x01(\bR\x0fallowMissingIds\x12H\n" +
	"\vdevice_info\x18\x05 \x01(\v2'.google.cloud.talent.v4beta1.DeviceInfoR\n" +
	"deviceInfo\"1\n" +
	...
	"\n" +
	"DeviceInfo\x12S\n" +
	"\vdevice_type\x18\x01 \x01(\x0e22.google.cloud.talent.v4beta1.DeviceInfo.DeviceTypeR\n" +
	"deviceType\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\"l\n" +
	"\n" +
	"DeviceType\x12\x1b\n" +
	"\x17DEVICE_TYPE_UNSPECIFIED\x10\x00\x12\a\n" +
	"\x03WEB\x10\x01\x12\x0e\n" +
	"\n" +
	"MOBILE_WEB\x10\x02\x12\v\n" +
	"\aANDROID\x10\x03\x12\a\n" +
	"\x03IOS\x10\x04\x12\a\n" +
	"\x03BOT\x10\x05\x12\t\n" +
	"\x05OTHER\x10\x06\"\xa6\x01\n" +
	"\x0fCustomAttribute\x12#\n" +
	"\rstring_values\x18\x01 \x03(\tR\fstringValues\x12\x1f\n" +
	"\vlong_values\x18\x02 \x03(\x03R\n" +
	"longValues\x12\x1e\n" +
	"\n" +
	"filterable\x18\x03 \x01(\bR\n" +
	"filterable\x12-\n" +
	"\x12keyword_searchable\x18\x04 \x01(\bR\x11keywordSearchable\"\x80\x01\n" +
	"\x12SpellingCorrection\x12\x1c\n" +
	"\tcorrected\x18\x01 \x01(\bR\tcorrected\x12%\n" +
	"\x0ecorrected_text\x18\x02 \x01(\tR\rcorrectedText\x12%\n" +
	"\x0ecorrected_html\x18\x03 \x01(\tR\rcorrectedHtml\"\xd5\n" +
	"\n" +
	"\x10CompensationInfo\x12Y\n" +
	"\aentries\x18\x01 \x03(\v2?.google.cloud.talent.v4beta1.CompensationInfo.CompensationEntryR\aentries\x12\x91\x01\n" +
	"\"annualized_base_compensation_range\x18\x02 \x01(\v2?.google.cloud.talent.v4beta1.CompensationInfo.CompensationRangeB\x03\xe0A\x03R\x1fannualizedBaseCompensationRange\x12\x93\x01\n" +
	"#annualized_total_compensation_range\x18\x03 \x01(\v2?.google.cloud.talent.v4beta1.CompensationInfo.CompensationRangeB\x03\xe0A\x03R annualizedTotalCompensationRange\x1a\xd0\x03\n" +
	"\x11CompensationEntry\x12R\n" +
	"\x04type\x18\x01 \x01(\x0e2>.google.cloud.talent.v4beta1.CompensationInfo.CompensationTypeR\x04type\x12R\n" +
	"\x04unit\x18\x02 \x01(\x0e2>.google.cloud.talent.v4beta1.CompensationInfo.CompensationUnitR\x04unit\x12,\n" +
	"\x06amount\x18\x03 \x01(\v2\x12.google.type.MoneyH\x00R\x06amount\x12W\n" +
	"\x05range\x18\x04 \x01(\v2?.google.cloud.talent.v4beta1.CompensationInfo.CompensationRangeH\x00R\x05range\x12 \n" +
	"\vdescription\x18\x05 \x01(\tR\vdescription\x12S\n" +
	"\x17expected_units_per_year\x18\x06 \x01(\v2\x1c.google.protobuf.DoubleValueR\x14expectedUnitsPerYearB\x15\n" +
	"\x13compensation_amount\x1a\x91\x01\n" +
	"\x11CompensationRange\x12=\n" +
	"\x10max_compensation\x18\x02 \x01(\v2\x12.google.type.MoneyR\x0fmaxCompensation\x12=\n" +
	"\x10min_compensation\x18\x01 \x01(\v2\x12.google.type.MoneyR\x0fminCompensation\"\xb5\x01\n" +
	"\x10CompensationType\x12!\n" +
	"\x1dCOMPENSATION_TYPE_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04BASE\x10\x01\x12\t\n" +
	...
	"\vCOMMISSIONS\x10\x06\x12\b\n" +
	"\x04TIPS\x10\a\x12\x1b\n" +
	"\x17OTHER_COMPENSATION_TYPE\x10\b\"\x9c\x01\n" +
	...
	"\bONE_TIME\x10\x06\x12\x1b\n" +
	"\x17OTHER_COMPENSATION_UNIT\x10\a\"\xae\x04\n" +
	"\x16BatchOperationMetadata\x12O\n" +
	"\x05state\x18\x01 \x01(\x0e29.google.cloud.talent.v4beta1.BatchOperationMetadata.StateR\x05state\x12+\n" +
	"\x11state_description\x18\x02 \x01(\tR\x10stateDescription\x12#\n" +
	"\rsuccess_count\x18\x03 \x01(\x05R\fsuccessCount\x12#\n" +
	"\rfailure_count\x18\x04 \x01(\x05R\ffailureCount\x12\x1f\n" +
	...
	"updateTime\x125\n" +
	"\bend_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\"z\n" +
	"\x05State\x12\x15\n" +
	...
	"\x18COMPANY_SIZE_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04MINI\x10\x01\x12\t\n" +
	"\x05SMALL\x10\x02\x12\v\n" +
	"\aSMEDIUM\x10\x03\x12\n" +
	"\n" +
	"\x06MEDIUM\x10\x04\x12\a\n" +
	"\x03BIG\x10\x05\x12\n" +
	"\n" +
	"\x06BIGGER\x10\x06\x12\t\n" +
	"\x05GIANT\x10\a*\xe2\x01\n" +
	"\n" +
	"JobBenefit\x12\x1b\n" +
	...
	"\x0eFLEXIBLE_HOURS\x10\x04\x12\v\n" +
	"\aMEDICAL\x10\x05\x12\x12\n" +
	"\x0eLIFE_INSURANCE\x10\x06\x12\x12\n" +
	"\x0ePARENTAL_LEAVE\x10\a\x12\x13\n" +
	"\x0fRETIREMENT_PLAN\x10\b\x12\r\n" +
	"\tSICK_DAYS\x10\t\x12\f\n" +
	"\bVACATION\x10\n" +
	"\x12\n" +
	"\n" +
	"\x06VISION\x10\v*\x8e\x02\n" +
	"\n" +
	"DegreeType\x12\x1b\n" +
	...
	"\x15MASTERS_OR_EQUIVALENT\x10\a\x12\x1a\n" +
	"\x16DOCTORAL_OR_EQUIVALENT\x10\b*\xdc\x01\n" +
	...
	"\tVOLUNTEER\x10\a\x12\f\n" +
	"\bPER_DIEM\x10\b\x12\x12\n" +
	"\x0eFLY_IN_FLY_OUT\x10\t\x12\x19\n" +
	"\x15OTHER_EMPLOYMENT_TYPE\x10\n" +
	"*q\n" +
	"\bJobLevel\x12\x19\n" +
	"\x15JOB_LEVEL_UNSPECIFIED\x10\x00\x12\x0f\n" +
	"\vENTRY_LEVEL\x10\x01\x12\x0f\n" +
	"\vEXPERIENCED\x10\x02\x12\v\n" +
	"\aMANAGER\x10\x03\x12\f\n" +
	"\bDIRECTOR\x10\x04\x12\r\n" +
	"\tEXECUTIVE\x10\x05*\xba\x06\n" +
	"\vJobCategory\x12\x1c\n" +
	...
	"\vANIMAL_CARE\x10\x04\x12\x1a\n" +
	"\x16ART_FASHION_AND_DESIGN\x10\x05\x12\x17\n" +
	"\x13BUSINESS_OPERATIONS\x10\x06\x12\x1b\n" +
	"\x17CLEANING_AND_FACILITIES\x10\a\x12\x13\n" +
	"\x0fCOMPUTER_AND_IT\x10\b\x12\x10\n" +
	"\fCONSTRUCTION\x10\t\x12\x14\n" +
	"\x10CUSTOMER_SERVICE\x10\n" +
	"\x12\r\n" +
	"\tEDUCATION\x10\v\x12\x1c\n" +
	"\x18ENTERTAINMENT_AND_TRAVEL\x10\f\x12\x18\n" +
	...
	"\vTELECOMMUTE\x10\x03*n\n" +
	"\n" +
	"Visibility\x12\x1a\n" +
	"\x16VISIBILITY_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fACCOUNT_ONLY\x10\x01\x12\x16\n" +
	...
	"\x1aCOMMUTE_METHOD_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aDRIVING\x10\x01\x12\v\n" +
	"\aTRANSIT\x10\x02\x12\v\n" +
	"\aWALKING\x10\x03\x12\v\n" +
	"\aCYCLING\x10\x04Bo\n" +
	"\x1fcom.google.cloud.talent.v4beta1B\vCommonProtoP\x01Z7cloud.google.com/go/talent/apiv4beta1/talentpb;talentpb\xa2\x02\x03CTSb\x06proto3"

var (
	file_google_cloud_talent_v4beta1_common_proto_rawDescOnce sync.Once
	file_google_cloud_talent_v4beta1_common_proto_rawDescData []byte
)
...
func file_google_cloud_talent_v4beta1_common_proto_rawDescGZIP() []byte {
	file_google_cloud_talent_v4beta1_common_proto_rawDescOnce.Do(func() {
		file_google_cloud_talent_v4beta1_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4beta1_common_proto_rawDesc), len(file_google_cloud_talent_v4beta1_common_proto_rawDesc)))
	})
...
var file_google_cloud_talent_v4beta1_common_proto_goTypes = []any{
...
func file_google_cloud_talent_v4beta1_common_proto_init() {
	...
	file_google_cloud_talent_v4beta1_common_proto_msgTypes[9].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4beta1_common_proto_rawDesc), len(file_google_cloud_talent_v4beta1_common_proto_rawDesc)),
			NumEnums:      15,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
