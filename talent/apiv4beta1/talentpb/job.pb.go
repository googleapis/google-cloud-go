...
var file_google_cloud_talent_v4beta1_job_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x88, 0x14, 0x0a, 0x03,
	...
	0x2f, 0x7b, 0x6a, 0x6f, 0x62, 0x7d, 0x42, 0x74, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x74, 0x61, 0x6c, 0x65, 0x6e,
	0x74, 0x2e, 0x76, 0x34, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x10, 0x4a, 0x6f, 0x62, 0x52, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x37, 0x63,
...
func file_google_cloud_talent_v4beta1_job_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_talent_v4beta1_job_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Job); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_cloud_talent_v4beta1_job_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_talent_v4beta1_job_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_talent_v4beta1_job_proto_msgTypes[3].Exporter = func(v any, i int) any {
