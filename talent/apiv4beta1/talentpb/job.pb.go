...
type Job struct {
	...
	// is 50KB.
	CustomAttributes map[string]*CustomAttribute `protobuf:"bytes,10,rep,name=custom_attributes,json=customAttributes,proto3" json:"custom_attributes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_google_cloud_talent_v4beta1_job_proto_rawDesc = "" +
	"\n" +
	"%google/cloud/talent/v4beta1/job.proto\x12\x1bgoogle.cloud.talent.v4beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a(google/cloud/talent/v4beta1/common.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x88\x14\n" +
	"\x03Job\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12=\n" +
	"\acompany\x18\x02 \x01(\tB#\xe0A\x02\xfaA\x1d\n" +
	"\x1bjobs.googleapis.com/CompanyR\acompany\x12*\n" +
	"\x0erequisition_id\x18\x03 \x01(\tB\x03\xe0A\x02R\rrequisitionId\x12\x19\n" +
	"\x05title\x18\x04 \x01(\tB\x03\xe0A\x02R\x05title\x12%\n" +
	"\vdescription\x18\x05 \x01(\tB\x03\xe0A\x02R\vdescription\x12\x1c\n" +
	"\taddresses\x18\x06 \x03(\tR\taddresses\x12[\n" +
	"\x10application_info\x18\a \x01(\v20.google.cloud.talent.v4beta1.Job.ApplicationInfoR\x0fapplicationInfo\x12J\n" +
	"\fjob_benefits\x18\b \x03(\x0e2'.google.cloud.talent.v4beta1.JobBenefitR\vjobBenefits\x12Z\n" +
	"\x11compensation_info\x18\t \x01(\v2-.google.cloud.talent.v4beta1.CompensationInfoR\x10compensationInfo\x12c\n" +
	"\x11custom_attributes\x18\n" +
	" \x03(\v26.google.cloud.talent.v4beta1.Job.CustomAttributesEntryR\x10customAttributes\x12J\n" +
	"\fdegree_types\x18\v \x03(\x0e2'.google.cloud.talent.v4beta1.DegreeTypeR\vdegreeTypes\x12\x1e\n" +
	"\n" +
	"department\x18\f \x01(\tR\n" +
	"department\x12V\n" +
	"\x10employment_types\x18\r \x03(\x0e2+.google.cloud.talent.v4beta1.EmploymentTypeR\x0femploymentTypes\x12\x1e\n" +
	"\n" +
	"incentives\x18\x0e \x01(\tR\n" +
	"incentives\x12#\n" +
	"\rlanguage_code\x18\x0f \x01(\tR\flanguageCode\x12B\n" +
	"\tjob_level\x18\x10 \x01(\x0e2%.google.cloud.talent.v4beta1.JobLevelR\bjobLevel\x12'\n" +
	...
	"\x0eposting_region\x18\x14 \x01(\x0e2*.google.cloud.talent.v4beta1.PostingRegionR\rpostingRegion\x12K\n" +
	"\n" +
	"visibility\x18\x15 \x01(\x0e2'.google.cloud.talent.v4beta1.VisibilityB\x02\x18\x01R\n" +
	"visibility\x12@\n" +
	"\x0ejob_start_time\x18\x16 \x01(\v2\x1a.google.protobuf.TimestampR\fjobStartTime\x12<\n" +
	"\fjob_end_time\x18\x17 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"jobEndTime\x12L\n" +
	"\x14posting_publish_time\x18\x18 \x01(\v2\x1a.google.protobuf.TimestampR\x12postingPublishTime\x12J\n" +
	"\x13posting_expire_time\x18\x19 \x01(\v2\x1a.google.protobuf.TimestampR\x11postingExpireTime\x12O\n" +
	"\x13posting_create_time\x18\x1a \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\x11postingCreateTime\x12O\n" +
	"\x13posting_update_time\x18\x1b \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\x11postingUpdateTime\x125\n" +
	"\x14company_display_name\x18\x1c \x01(\tB\x03\xe0A\x03R\x12companyDisplayName\x12T\n" +
	"\fderived_info\x18\x1d \x01(\v2,.google.cloud.talent.v4beta1.Job.DerivedInfoB\x03\xe0A\x03R\vderivedInfo\x12a\n" +
	"\x12processing_options\x18\x1e \x01(\v22.google.cloud.talent.v4beta1.Job.ProcessingOptionsR\x11processingOptions\x1a_\n" +
	"\x0fApplicationInfo\x12\x16\n" +
	...
	"\vDerivedInfo\x12C\n" +
	"\tlocations\x18\x01 \x03(\v2%.google.cloud.talent.v4beta1.LocationR\tlocations\x12O\n" +
	"\x0ejob_categories\x18\x03 \x03(\x0e2(.google.cloud.talent.v4beta1.JobCategoryR\rjobCategories\x1a\xba\x01\n" +
	"\x11ProcessingOptions\x12I\n" +
	"!disable_street_address_resolution\x18\x01 \x01(\bR\x1edisableStreetAddressResolution\x12Z\n" +
	"\x11html_sanitization\x18\x02 \x01(\x0e2-.google.cloud.talent.v4beta1.HtmlSanitizationR\x10htmlSanitization\x1aq\n" +
	"\x15CustomAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12B\n" +
	"\x05value\x18\x02 \x01(\v2,.google.cloud.talent.v4beta1.CustomAttributeR\x05value:\x028\x01:k\xeaAh\n" +
...
var (
	...
	file_google_cloud_talent_v4beta1_job_proto_rawDescData []byte
)
...
func file_google_cloud_talent_v4beta1_job_proto_rawDescGZIP() []byte {
	file_google_cloud_talent_v4beta1_job_proto_rawDescOnce.Do(func() {
		file_google_cloud_talent_v4beta1_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4beta1_job_proto_rawDesc), len(file_google_cloud_talent_v4beta1_job_proto_rawDesc)))
	})
...
var file_google_cloud_talent_v4beta1_job_proto_goTypes = []any{
...
func file_google_cloud_talent_v4beta1_job_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_talent_v4beta1_job_proto_rawDesc), len(file_google_cloud_talent_v4beta1_job_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
