...
type ProfileIterator struct {
	items    []*gkerecommenderpb.Profile
	...
	InternalFetch func(pageSize int, pageToken string) (results []*gkerecommenderpb.Profile, nextPageToken string, err error)
}
...
func (it *ProfileIterator) Next() (*gkerecommenderpb.Profile, error) {
	var item *gkerecommenderpb.Profile
