...
func ExampleGkeInferenceQuickstartClient_FetchModelServerVersions_all() {
	...
	c, err := gkerecommender.NewGkeInferenceQuickstartClient(ctx)
	if err != nil {
		// TODO: Handle error.
	}
	defer c.Close()
	...
	for resp, err := range c.FetchModelServerVersions(ctx, req).All() {
		if err != nil {
...
func ExampleGkeInferenceQuickstartClient_FetchModelServers_all() {
	ctx := context.Background()
	// This snippet has been automatically generated and should be regarded as a code template only.
	// It will require modifications to work:
	// - It may require correct/in-range values for request initialization.
	...
	for resp, err := range c.FetchModelServers(ctx, req).All() {
		if err != nil {
			// TODO: Handle error and break/return/continue. Iteration will stop after any error.
		}
		// TODO: Use resp.
...
func ExampleGkeInferenceQuickstartClient_FetchModels_all() {
	ctx := context.Background()
	// This snippet has been automatically generated and should be regarded as a code template only.
	// It will require modifications to work:
	// - It may require correct/in-range values for request initialization.
	...
	for resp, err := range c.FetchModels(ctx, req).All() {
		if err != nil {
			// TODO: Handle error and break/return/continue. Iteration will stop after any error.
		}
		// TODO: Use resp.
...
func ExampleGkeInferenceQuickstartClient_FetchProfiles_all() {
	ctx := context.Background()
	// This snippet has been automatically generated and should be regarded as a code template only.
	// It will require modifications to work:
	// - It may require correct/in-range values for request initialization.
	...
	for resp, err := range c.FetchProfiles(ctx, req).All() {
		if err != nil {
			// TODO: Handle error and break/return/continue. Iteration will stop after any error.
		}
		// TODO: Use resp.
