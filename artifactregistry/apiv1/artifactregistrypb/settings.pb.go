...
const file_google_devtools_artifactregistry_v1_settings_proto_rawDesc = "" +
	"\n" +
	"2google/devtools/artifactregistry/v1/settings.proto\x12#google.devtools.artifactregistry.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a google/protobuf/field_mask.proto\"\xb3\x04\n" +
	"\x0fProjectSettings\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x7f\n" +
	"\x18legacy_redirection_state\x18\x02 \x01(\x0e2E.google.devtools.artifactregistry.v1.ProjectSettings.RedirectionStateR\x16legacyRedirectionState\x12!\n" +
	"\fpull_percent\x18\x03 \x01(\x05R\vpullPercent\"\x8d\x02\n" +
	...
	"!REDIRECTION_FROM_GCR_IO_FINALIZED\x10\x03\x1a\x02\b\x01\x12/\n" +
	...
	"/artifactregistry.googleapis.com/ProjectSettingsR\x04name\"\xbc\x01\n" +
	"\x1cUpdateProjectSettingsRequest\x12_\n" +
	"\x10project_settings\x18\x02 \x01(\v24.google.devtools.artifactregistry.v1.ProjectSettingsR\x0fprojectSettings\x12;\n" +
...
var (
	...
	file_google_devtools_artifactregistry_v1_settings_proto_rawDescData []byte
)
...
func file_google_devtools_artifactregistry_v1_settings_proto_rawDescGZIP() []byte {
	file_google_devtools_artifactregistry_v1_settings_proto_rawDescOnce.Do(func() {
		file_google_devtools_artifactregistry_v1_settings_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_devtools_artifactregistry_v1_settings_proto_rawDesc), len(file_google_devtools_artifactregistry_v1_settings_proto_rawDesc)))
	})
...
func file_google_devtools_artifactregistry_v1_settings_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_devtools_artifactregistry_v1_settings_proto_rawDesc), len(file_google_devtools_artifactregistry_v1_settings_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
