...
func file_google_devtools_artifactregistry_v1_vpcsc_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_devtools_artifactregistry_v1_vpcsc_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_devtools_artifactregistry_v1_vpcsc_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_devtools_artifactregistry_v1_vpcsc_config_proto_msgTypes[2].Exporter = func(v any, i int) any {
