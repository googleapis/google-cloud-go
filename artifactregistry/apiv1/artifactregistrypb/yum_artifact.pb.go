...
const file_google_devtools_artifactregistry_v1_yum_artifact_proto_rawDesc = "" +
	"\n" +
	"6google/devtools/artifactregistry/v1/yum_artifact.proto\x12#google.devtools.artifactregistry.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x17google/rpc/status.proto\"\xb5\x03\n" +
	...
	"\fpackage_type\x18\x03 \x01(\x0e2<.google.devtools.artifactregistry.v1.YumArtifact.PackageTypeB\x03\xe0A\x03R\vpackageType\x12'\n" +
	...
	"\x19ImportYumArtifactsRequest\x12a\n" +
	"\n" +
	"gcs_source\x18\x02 \x01(\v2@.google.devtools.artifactregistry.v1.ImportYumArtifactsGcsSourceH\x00R\tgcsSource\x12\x16\n" +
	"\x06parent\x18\x01 \x01(\tR\x06parentB\b\n" +
	"\x06source\"\xb4\x01\n" +
	"\x1bImportYumArtifactsErrorInfo\x12a\n" +
	"\n" +
	"gcs_source\x18\x01 \x01(\v2@.google.devtools.artifactregistry.v1.ImportYumArtifactsGcsSourceH\x00R\tgcsSource\x12(\n" +
	"\x05error\x18\x02 \x01(\v2\x12.google.rpc.StatusR\x05errorB\b\n" +
	"\x06source\"\xcd\x01\n" +
	"\x1aImportYumArtifactsResponse\x12U\n" +
	"\ryum_artifacts\x18\x01 \x03(\v20.google.devtools.artifactregistry.v1.YumArtifactR\fyumArtifacts\x12X\n" +
	"\x06errors\x18\x02 \x03(\v2@.google.devtools.artifactregistry.v1.ImportYumArtifactsErrorInfoR\x06errors\"\x1c\n" +
...
var (
	...
	file_google_devtools_artifactregistry_v1_yum_artifact_proto_rawDescData []byte
)
...
func file_google_devtools_artifactregistry_v1_yum_artifact_proto_rawDescGZIP() []byte {
	file_google_devtools_artifactregistry_v1_yum_artifact_proto_rawDescOnce.Do(func() {
		file_google_devtools_artifactregistry_v1_yum_artifact_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_devtools_artifactregistry_v1_yum_artifact_proto_rawDesc), len(file_google_devtools_artifactregistry_v1_yum_artifact_proto_rawDesc)))
	})
...
var file_google_devtools_artifactregistry_v1_yum_artifact_proto_goTypes = []any{
...
func file_google_devtools_artifactregistry_v1_yum_artifact_proto_init() {
	...
	file_google_devtools_artifactregistry_v1_yum_artifact_proto_msgTypes[2].OneofWrappers = []any{
		(*ImportYumArtifactsRequest_GcsSource)(nil),
	}
	file_google_devtools_artifactregistry_v1_yum_artifact_proto_msgTypes[3].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_devtools_artifactregistry_v1_yum_artifact_proto_rawDesc), len(file_google_devtools_artifactregistry_v1_yum_artifact_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
