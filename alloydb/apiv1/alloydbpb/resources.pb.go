...
func file_google_cloud_alloydb_v1_resources_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_alloydb_v1_resources_proto_msgTypes[22].Exporter = func(v any, i int) any {
		...
		file_google_cloud_alloydb_v1_resources_proto_msgTypes[29].Exporter = func(v any, i int) any {
	...
	file_google_cloud_alloydb_v1_resources_proto_msgTypes[10].OneofWrappers = []any{
		(*Cluster_BackupSource)(nil),
		(*Cluster_MigrationSource)(nil),
	}
	file_google_cloud_alloydb_v1_resources_proto_msgTypes[14].OneofWrappers = []any{
		(*SupportedDatabaseFlag_StringRestrictions_)(nil),
		(*SupportedDatabaseFlag_IntegerRestrictions_)(nil),
	}
	file_google_cloud_alloydb_v1_resources_proto_msgTypes[27].OneofWrappers = []any{}
	type x struct{}
