...
const file_google_cloud_alloydb_v1beta_data_model_proto_rawDesc = "" +
	"\n" +
	",google/cloud/alloydb/v1beta/data_model.proto\x12\x1bgoogle.cloud.alloydb.v1beta\"\x92\x01\n" +
	"\tSqlResult\x12F\n" +
	"\acolumns\x18\x01 \x03(\v2,.google.cloud.alloydb.v1beta.SqlResultColumnR\acolumns\x12=\n" +
	"\x04rows\x18\x02 \x03(\v2).google.cloud.alloydb.v1beta.SqlResultRowR\x04rows\"9\n" +
	"\x0fSqlResultColumn\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\"S\n" +
	"\fSqlResultRow\x12C\n" +
	"\x06values\x18\x01 \x03(\v2+.google.cloud.alloydb.v1beta.SqlResultValueR\x06values\"h\n" +
...
var (
	...
	file_google_cloud_alloydb_v1beta_data_model_proto_rawDescData []byte
)
...
func file_google_cloud_alloydb_v1beta_data_model_proto_rawDescGZIP() []byte {
	file_google_cloud_alloydb_v1beta_data_model_proto_rawDescOnce.Do(func() {
		file_google_cloud_alloydb_v1beta_data_model_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_alloydb_v1beta_data_model_proto_rawDesc), len(file_google_cloud_alloydb_v1beta_data_model_proto_rawDesc)))
	})
...
func file_google_cloud_alloydb_v1beta_data_model_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_alloydb_v1beta_data_model_proto_rawDesc), len(file_google_cloud_alloydb_v1beta_data_model_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
