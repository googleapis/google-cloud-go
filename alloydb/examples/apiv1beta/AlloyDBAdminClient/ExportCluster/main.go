...
func main() {
	...
	req := &alloydbpb.ExportClusterRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/alloydb/apiv1beta/alloydbpb#ExportClusterRequest.
	}
	op, err := c.ExportCluster(ctx, req)
	if err != nil {
		// TODO: Handle error.
	}
...
// [END alloydb_v1beta_generated_AlloyDBAdmin_ExportCluster_sync]
