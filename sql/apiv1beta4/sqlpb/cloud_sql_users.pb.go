...
func (User_SqlUserType) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_sql_v1beta4_cloud_sql_users_proto_rawDescGZIP(), []int{7, 0}
}
...
func (User_DualPasswordType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_sql_v1beta4_cloud_sql_users_proto_enumTypes[1].Descriptor()
}

func (User_DualPasswordType) Type() protoreflect.EnumType {
	return &file_google_cloud_sql_v1beta4_cloud_sql_users_proto_enumTypes[1]
}
...
func (User_DualPasswordType) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_sql_v1beta4_cloud_sql_users_proto_rawDescGZIP(), []int{7, 1}
}
...
func (User_IamStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_sql_v1beta4_cloud_sql_users_proto_enumTypes[2].Descriptor()
}

func (User_IamStatus) Type() protoreflect.EnumType {
	return &file_google_cloud_sql_v1beta4_cloud_sql_users_proto_enumTypes[2]
}
...
func (User_IamStatus) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_sql_v1beta4_cloud_sql_users_proto_rawDescGZIP(), []int{7, 2}
}
...
type User struct {
	...
	DualPasswordType *User_DualPasswordType `protobuf:"varint,13,opt,name=dual_password_type,json=dualPasswordType,proto3,enum=google.cloud.sql.v1beta4.User_DualPasswordType,oneof" json:"dual_password_type,omitempty"`
	// Indicates if a group is active or inactive for IAM database authentication.
	IamStatus *User_IamStatus `protobuf:"varint,14,opt,name=iam_status,json=iamStatus,proto3,enum=google.cloud.sql.v1beta4.User_IamStatus,oneof" json:"iam_status,omitempty"`
...
func (x *UsersListResponse) Reset() {
	*x = UsersListResponse{}
	mi := &file_google_cloud_sql_v1beta4_cloud_sql_users_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UsersListResponse) Descriptor() ([]byte, []int) {
	return file_google_cloud_sql_v1beta4_cloud_sql_users_proto_rawDescGZIP(), []int{9}
}
...
const file_google_cloud_sql_v1beta4_cloud_sql_users_proto_rawDesc = "" +
	...
	"\x1cenable_failed_attempts_check\x18\x03 \x01(\bR\x19enableFailedAttemptsCheck\x12E\n" +
	"\x06status\x18\x04 \x01(\v2(.google.cloud.sql.v1beta4.PasswordStatusB\x03\xe0A\x03R\x06status\x12@\n" +
	...
	"\x18password_expiration_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x16passwordExpirationTime\"\xae\t\n" +
	"\x04User\x12\x12\n" +
	...
	"\x04type\x18\b \x01(\x0e2*.google.cloud.sql.v1beta4.User.SqlUserTypeR\x04type\x12f\n" +
	"\x16sqlserver_user_details\x18\t \x01(\v2..google.cloud.sql.v1beta4.SqlServerUserDetailsH\x00R\x14sqlserverUserDetails\x12 \n" +
	"\tiam_email\x18\v \x01(\tB\x03\xe0A\x01R\biamEmail\x12_\n" +
	"\x0fpassword_policy\x18\f \x01(\v26.google.cloud.sql.v1beta4.UserPasswordValidationPolicyR\x0epasswordPolicy\x12b\n" +
	"\x12dual_password_type\x18\r \x01(\x0e2/.google.cloud.sql.v1beta4.User.DualPasswordTypeH\x01R\x10dualPasswordType\x88\x01\x01\x12L\n" +
	"\n" +
	"iam_status\x18\x0e \x01(\x0e2(.google.cloud.sql.v1beta4.User.IamStatusH\x02R\tiamStatus\x88\x01\x01\x12*\n" +
	...
	"\fserver_roles\x18\x02 \x03(\tR\vserverRoles\"\x89\x01\n" +
	"\x11UsersListResponse\x12\x12\n" +
	"\x04kind\x18\x01 \x01(\tR\x04kind\x124\n" +
	"\x05items\x18\x02 \x03(\v2\x1e.google.cloud.sql.v1beta4.UserR\x05items\x12*\n" +
	"\x0fnext_page_token\x18\x03 \x01(\tB\x02\x18\x01R\rnextPageToken2\xd4\a\n" +
	...
	"\x06Insert\x12/.google.cloud.sql.v1beta4.SqlUsersInsertRequest\x1a#.google.cloud.sql.v1beta4.Operation\"H\x82\xd3\xe4\x93\x02B:\x04body\":/sql/v1beta4/projects/{project}/instances/{instance}/users\x12\xa6\x01\n" +
	...
	"\x06Update\x12/.google.cloud.sql.v1beta4.SqlUsersUpdateRequest\x1a#.google.cloud.sql.v1beta4.Operation\"H\x82\xd3\xe4\x93\x02B:\x04body\x1a:/sql/v1beta4/projects/{project}/instances/{instance}/users\x1a|\xcaA\x17sqladmin.googleapis.com\xd2A_https://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/sqlservice.adminBd\n" +
...
var (
	...
	file_google_cloud_sql_v1beta4_cloud_sql_users_proto_rawDescData []byte
)
...
func file_google_cloud_sql_v1beta4_cloud_sql_users_proto_rawDescGZIP() []byte {
	file_google_cloud_sql_v1beta4_cloud_sql_users_proto_rawDescOnce.Do(func() {
		file_google_cloud_sql_v1beta4_cloud_sql_users_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_sql_v1beta4_cloud_sql_users_proto_rawDesc), len(file_google_cloud_sql_v1beta4_cloud_sql_users_proto_rawDesc)))
	})
	return file_google_cloud_sql_v1beta4_cloud_sql_users_proto_rawDescData
}

var file_google_cloud_sql_v1beta4_cloud_sql_users_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_google_cloud_sql_v1beta4_cloud_sql_users_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_google_cloud_sql_v1beta4_cloud_sql_users_proto_goTypes = []any{
	(User_SqlUserType)(0),                // 0: google.cloud.sql.v1beta4.User.SqlUserType
	(User_DualPasswordType)(0),           // 1: google.cloud.sql.v1beta4.User.DualPasswordType
	(User_IamStatus)(0),                  // 2: google.cloud.sql.v1beta4.User.IamStatus
	(*SqlUsersDeleteRequest)(nil),        // 3: google.cloud.sql.v1beta4.SqlUsersDeleteRequest
	(*SqlUsersGetRequest)(nil),           // 4: google.cloud.sql.v1beta4.SqlUsersGetRequest
	(*SqlUsersInsertRequest)(nil),        // 5: google.cloud.sql.v1beta4.SqlUsersInsertRequest
	(*SqlUsersListRequest)(nil),          // 6: google.cloud.sql.v1beta4.SqlUsersListRequest
	(*SqlUsersUpdateRequest)(nil),        // 7: google.cloud.sql.v1beta4.SqlUsersUpdateRequest
	(*UserPasswordValidationPolicy)(nil), // 8: google.cloud.sql.v1beta4.UserPasswordValidationPolicy
	(*PasswordStatus)(nil),               // 9: google.cloud.sql.v1beta4.PasswordStatus
	(*User)(nil),                         // 10: google.cloud.sql.v1beta4.User
	(*SqlServerUserDetails)(nil),         // 11: google.cloud.sql.v1beta4.SqlServerUserDetails
	(*UsersListResponse)(nil),            // 12: google.cloud.sql.v1beta4.UsersListResponse
	(*durationpb.Duration)(nil),          // 13: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),        // 14: google.protobuf.Timestamp
	(*Operation)(nil),                    // 15: google.cloud.sql.v1beta4.Operation
}
var file_google_cloud_sql_v1beta4_cloud_sql_users_proto_depIdxs = []int32{
	10, // 0: google.cloud.sql.v1beta4.SqlUsersInsertRequest.body:type_name -> google.cloud.sql.v1beta4.User
	10, // 1: google.cloud.sql.v1beta4.SqlUsersUpdateRequest.body:type_name -> google.cloud.sql.v1beta4.User
	13, // 2: google.cloud.sql.v1beta4.UserPasswordValidationPolicy.password_expiration_duration:type_name -> google.protobuf.Duration
	9,  // 3: google.cloud.sql.v1beta4.UserPasswordValidationPolicy.status:type_name -> google.cloud.sql.v1beta4.PasswordStatus
	14, // 4: google.cloud.sql.v1beta4.PasswordStatus.password_expiration_time:type_name -> google.protobuf.Timestamp
	0,  // 5: google.cloud.sql.v1beta4.User.type:type_name -> google.cloud.sql.v1beta4.User.SqlUserType
	11, // 6: google.cloud.sql.v1beta4.User.sqlserver_user_details:type_name -> google.cloud.sql.v1beta4.SqlServerUserDetails
	8,  // 7: google.cloud.sql.v1beta4.User.password_policy:type_name -> google.cloud.sql.v1beta4.UserPasswordValidationPolicy
	1,  // 8: google.cloud.sql.v1beta4.User.dual_password_type:type_name -> google.cloud.sql.v1beta4.User.DualPasswordType
	2,  // 9: google.cloud.sql.v1beta4.User.iam_status:type_name -> google.cloud.sql.v1beta4.User.IamStatus
	10, // 10: google.cloud.sql.v1beta4.UsersListResponse.items:type_name -> google.cloud.sql.v1beta4.User
	3,  // 11: google.cloud.sql.v1beta4.SqlUsersService.Delete:input_type -> google.cloud.sql.v1beta4.SqlUsersDeleteRequest
	4,  // 12: google.cloud.sql.v1beta4.SqlUsersService.Get:input_type -> google.cloud.sql.v1beta4.SqlUsersGetRequest
	5,  // 13: google.cloud.sql.v1beta4.SqlUsersService.Insert:input_type -> google.cloud.sql.v1beta4.SqlUsersInsertRequest
	6,  // 14: google.cloud.sql.v1beta4.SqlUsersService.List:input_type -> google.cloud.sql.v1beta4.SqlUsersListRequest
	7,  // 15: google.cloud.sql.v1beta4.SqlUsersService.Update:input_type -> google.cloud.sql.v1beta4.SqlUsersUpdateRequest
	15, // 16: google.cloud.sql.v1beta4.SqlUsersService.Delete:output_type -> google.cloud.sql.v1beta4.Operation
	10, // 17: google.cloud.sql.v1beta4.SqlUsersService.Get:output_type -> google.cloud.sql.v1beta4.User
	15, // 18: google.cloud.sql.v1beta4.SqlUsersService.Insert:output_type -> google.cloud.sql.v1beta4.Operation
	12, // 19: google.cloud.sql.v1beta4.SqlUsersService.List:output_type -> google.cloud.sql.v1beta4.UsersListResponse
	15, // 20: google.cloud.sql.v1beta4.SqlUsersService.Update:output_type -> google.cloud.sql.v1beta4.Operation
...
func file_google_cloud_sql_v1beta4_cloud_sql_users_proto_init() {
	...
	file_google_cloud_sql_v1beta4_cloud_sql_users_proto_msgTypes[4].OneofWrappers = []any{}
	file_google_cloud_sql_v1beta4_cloud_sql_users_proto_msgTypes[7].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_sql_v1beta4_cloud_sql_users_proto_rawDesc), len(file_google_cloud_sql_v1beta4_cloud_sql_users_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
