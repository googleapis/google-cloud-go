...
func (ConnectSettings_CaMode) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_enumTypes[0].Descriptor()
}

func (ConnectSettings_CaMode) Type() protoreflect.EnumType {
	return &file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_enumTypes[0]
}
...
func (ConnectSettings_CaMode) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_rawDescGZIP(), []int{2, 0}
}
...
func (ConnectSettings_MdxProtocolSupport) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_enumTypes[1].Descriptor()
}

func (ConnectSettings_MdxProtocolSupport) Type() protoreflect.EnumType {
	return &file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_enumTypes[1]
}
...
func (ConnectSettings_MdxProtocolSupport) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_rawDescGZIP(), []int{2, 1}
}
...
type ConnectSettings struct {
	...
	ServerCaMode ConnectSettings_CaMode `protobuf:"varint,35,opt,name=server_ca_mode,json=serverCaMode,proto3,enum=google.cloud.sql.v1beta4.ConnectSettings_CaMode" json:"server_ca_mode,omitempty"`
	...
	MdxProtocolSupport []ConnectSettings_MdxProtocolSupport `protobuf:"varint,39,rep,packed,name=mdx_protocol_support,json=mdxProtocolSupport,proto3,enum=google.cloud.sql.v1beta4.ConnectSettings_MdxProtocolSupport" json:"mdx_protocol_support,omitempty"`
...
func (x *GenerateEphemeralCertResponse) Reset() {
	*x = GenerateEphemeralCertResponse{}
	mi := &file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenerateEphemeralCertResponse) Descriptor() ([]byte, []int) {
	return file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_rawDescGZIP(), []int{4}
}
...
func (x *ConnectSettings_ConnectPoolNodeConfig) Reset() {
	*x = ConnectSettings_ConnectPoolNodeConfig{}
	mi := &file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_rawDesc = "" +
	...
	"\blocation\x18\x02 \x01(\tB\x03\xe0A\x02R\blocation\"\xb2\v\n" +
	"\x0fConnectSettings\x12\x12\n" +
	"\x04kind\x18\x01 \x01(\tR\x04kind\x12G\n" +
	"\x0eserver_ca_cert\x18\x02 \x01(\v2!.google.cloud.sql.v1beta4.SslCertR\fserverCaCert\x12F\n" +
	"\fip_addresses\x18\x03 \x03(\v2#.google.cloud.sql.v1beta4.IpMappingR\vipAddresses\x12\x16\n" +
	"\x06region\x18\x04 \x01(\tR\x06region\x12W\n" +
	"\x10database_version\x18\x1f \x01(\x0e2,.google.cloud.sql.v1beta4.SqlDatabaseVersionR\x0fdatabaseVersion\x12K\n" +
	"\fbackend_type\x18  \x01(\x0e2(.google.cloud.sql.v1beta4.SqlBackendTypeR\vbackendType\x12\x1f\n" +
	"\vpsc_enabled\x18! \x01(\bR\n" +
	"pscEnabled\x12\x19\n" +
	"\bdns_name\x18\" \x01(\tR\adnsName\x12V\n" +
	"\x0eserver_ca_mode\x18# \x01(\x0e20.google.cloud.sql.v1beta4.ConnectSettings.CaModeR\fserverCaMode\x12G\n" +
	" custom_subject_alternative_names\x18% \x03(\tR\x1dcustomSubjectAlternativeNames\x12J\n" +
	"\tdns_names\x18& \x03(\v2(.google.cloud.sql.v1beta4.DnsNameMappingB\x03\xe0A\x03R\bdnsNames\x12\"\n" +
	"\n" +
	"node_count\x18? \x01(\x05H\x00R\tnodeCount\x88\x01\x01\x12Z\n" +
	"\x05nodes\x18@ \x03(\v2?.google.cloud.sql.v1beta4.ConnectSettings.ConnectPoolNodeConfigB\x03\xe0A\x03R\x05nodes\x12v\n" +
	"\x14mdx_protocol_support\x18' \x03(\x0e2<.google.cloud.sql.v1beta4.ConnectSettings.MdxProtocolSupportB\x06\xe0A\x03\xe0A\x01R\x12mdxProtocolSupport\x12/\n" +
	"\x0fconnection_name\x18( \x01(\tB\x06\xe0A\x03\xe0A\x01R\x0econnectionName\x1a\x89\x02\n" +
	"\x15ConnectPoolNodeConfig\x12\x1c\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03H\x00R\x04name\x88\x01\x01\x12K\n" +
	"\fip_addresses\x18\x02 \x03(\v2#.google.cloud.sql.v1beta4.IpMappingB\x03\xe0A\x03R\vipAddresses\x12#\n" +
	"\bdns_name\x18\x03 \x01(\tB\x03\xe0A\x03H\x01R\adnsName\x88\x01\x01\x12J\n" +
	"\tdns_names\x18\x04 \x03(\v2(.google.cloud.sql.v1beta4.DnsNameMappingB\x03\xe0A\x03R\bdnsNamesB\a\n" +
	"\x05_nameB\v\n" +
	"\t_dns_name\"y\n" +
	"\x06CaMode\x12\x17\n" +
	...
	"\x0evalid_duration\x18\f \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x01R\rvalidDuration\"i\n" +
	"\x1dGenerateEphemeralCertResponse\x12H\n" +
	"\x0eephemeral_cert\x18\x01 \x01(\v2!.google.cloud.sql.v1beta4.SslCertR\rephemeralCert2\x88\x06\n" +
	"\x11SqlConnectService\x12\xc2\x01\n" +
	"\x12GetConnectSettings\x123.google.cloud.sql.v1beta4.GetConnectSettingsRequest\x1a).google.cloud.sql.v1beta4.ConnectSettings\"L\x82\xd3\xe4\x93\x02F\x12D/sql/v1beta4/projects/{project}/instances/{instance}/connectSettings\x12\xcd\x01\n" +
	"\x16ResolveConnectSettings\x127.google.cloud.sql.v1beta4.ResolveConnectSettingsRequest\x1a).google.cloud.sql.v1beta4.ConnectSettings\"O\x82\xd3\xe4\x93\x02I\x12G/sql/v1beta4/locations/{location}/dns/{dns_name}:resolveConnectSettings\x12\xdf\x01\n" +
	"\x15GenerateEphemeralCert\x126.google.cloud.sql.v1beta4.GenerateEphemeralCertRequest\x1a7.google.cloud.sql.v1beta4.GenerateEphemeralCertResponse\"U\x82\xd3\xe4\x93\x02O:\x01*\"J/sql/v1beta4/projects/{project}/instances/{instance}:generateEphemeralCert\x1a|\xcaA\x17sqladmin.googleapis.com\xd2A_https://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/sqlservice.adminBf\n" +
...
var (
	...
	file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_rawDescData []byte
)
...
func file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_rawDescGZIP() []byte {
	file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_rawDescOnce.Do(func() {
		file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_rawDesc), len(file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_rawDesc)))
	})
	return file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_rawDescData
}

var file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_goTypes = []any{
	(ConnectSettings_CaMode)(0),                   // 0: google.cloud.sql.v1beta4.ConnectSettings.CaMode
	(ConnectSettings_MdxProtocolSupport)(0),       // 1: google.cloud.sql.v1beta4.ConnectSettings.MdxProtocolSupport
	(*GetConnectSettingsRequest)(nil),             // 2: google.cloud.sql.v1beta4.GetConnectSettingsRequest
	(*ResolveConnectSettingsRequest)(nil),         // 3: google.cloud.sql.v1beta4.ResolveConnectSettingsRequest
	(*ConnectSettings)(nil),                       // 4: google.cloud.sql.v1beta4.ConnectSettings
	(*GenerateEphemeralCertRequest)(nil),          // 5: google.cloud.sql.v1beta4.GenerateEphemeralCertRequest
	(*GenerateEphemeralCertResponse)(nil),         // 6: google.cloud.sql.v1beta4.GenerateEphemeralCertResponse
	(*ConnectSettings_ConnectPoolNodeConfig)(nil), // 7: google.cloud.sql.v1beta4.ConnectSettings.ConnectPoolNodeConfig
	(*timestamppb.Timestamp)(nil),                 // 8: google.protobuf.Timestamp
	(*SslCert)(nil),                               // 9: google.cloud.sql.v1beta4.SslCert
	(*IpMapping)(nil),                             // 10: google.cloud.sql.v1beta4.IpMapping
	(SqlDatabaseVersion)(0),                       // 11: google.cloud.sql.v1beta4.SqlDatabaseVersion
	(SqlBackendType)(0),                           // 12: google.cloud.sql.v1beta4.SqlBackendType
	(*DnsNameMapping)(nil),                        // 13: google.cloud.sql.v1beta4.DnsNameMapping
	(*durationpb.Duration)(nil),                   // 14: google.protobuf.Duration
}
var file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_depIdxs = []int32{
	8,  // 0: google.cloud.sql.v1beta4.GetConnectSettingsRequest.read_time:type_name -> google.protobuf.Timestamp
	9,  // 1: google.cloud.sql.v1beta4.ConnectSettings.server_ca_cert:type_name -> google.cloud.sql.v1beta4.SslCert
	10, // 2: google.cloud.sql.v1beta4.ConnectSettings.ip_addresses:type_name -> google.cloud.sql.v1beta4.IpMapping
	11, // 3: google.cloud.sql.v1beta4.ConnectSettings.database_version:type_name -> google.cloud.sql.v1beta4.SqlDatabaseVersion
	12, // 4: google.cloud.sql.v1beta4.ConnectSettings.backend_type:type_name -> google.cloud.sql.v1beta4.SqlBackendType
	0,  // 5: google.cloud.sql.v1beta4.ConnectSettings.server_ca_mode:type_name -> google.cloud.sql.v1beta4.ConnectSettings.CaMode
	13, // 6: google.cloud.sql.v1beta4.ConnectSettings.dns_names:type_name -> google.cloud.sql.v1beta4.DnsNameMapping
	7,  // 7: google.cloud.sql.v1beta4.ConnectSettings.nodes:type_name -> google.cloud.sql.v1beta4.ConnectSettings.ConnectPoolNodeConfig
	1,  // 8: google.cloud.sql.v1beta4.ConnectSettings.mdx_protocol_support:type_name -> google.cloud.sql.v1beta4.ConnectSettings.MdxProtocolSupport
	8,  // 9: google.cloud.sql.v1beta4.GenerateEphemeralCertRequest.read_time:type_name -> google.protobuf.Timestamp
	14, // 10: google.cloud.sql.v1beta4.GenerateEphemeralCertRequest.valid_duration:type_name -> google.protobuf.Duration
	9,  // 11: google.cloud.sql.v1beta4.GenerateEphemeralCertResponse.ephemeral_cert:type_name -> google.cloud.sql.v1beta4.SslCert
	10, // 12: google.cloud.sql.v1beta4.ConnectSettings.ConnectPoolNodeConfig.ip_addresses:type_name -> google.cloud.sql.v1beta4.IpMapping
	13, // 13: google.cloud.sql.v1beta4.ConnectSettings.ConnectPoolNodeConfig.dns_names:type_name -> google.cloud.sql.v1beta4.DnsNameMapping
	2,  // 14: google.cloud.sql.v1beta4.SqlConnectService.GetConnectSettings:input_type -> google.cloud.sql.v1beta4.GetConnectSettingsRequest
	3,  // 15: google.cloud.sql.v1beta4.SqlConnectService.ResolveConnectSettings:input_type -> google.cloud.sql.v1beta4.ResolveConnectSettingsRequest
	5,  // 16: google.cloud.sql.v1beta4.SqlConnectService.GenerateEphemeralCert:input_type -> google.cloud.sql.v1beta4.GenerateEphemeralCertRequest
	4,  // 17: google.cloud.sql.v1beta4.SqlConnectService.GetConnectSettings:output_type -> google.cloud.sql.v1beta4.ConnectSettings
	4,  // 18: google.cloud.sql.v1beta4.SqlConnectService.ResolveConnectSettings:output_type -> google.cloud.sql.v1beta4.ConnectSettings
	6,  // 19: google.cloud.sql.v1beta4.SqlConnectService.GenerateEphemeralCert:output_type -> google.cloud.sql.v1beta4.GenerateEphemeralCertResponse
...
func file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_init() {
	...
	file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_msgTypes[2].OneofWrappers = []any{}
	file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_rawDesc), len(file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		...
		EnumInfos:         file_google_cloud_sql_v1beta4_cloud_sql_connect_proto_enumTypes,
