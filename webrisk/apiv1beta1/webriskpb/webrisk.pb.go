...
const file_google_cloud_webrisk_v1beta1_webrisk_proto_rawDesc = "" +
	"\n" +
	"*google/cloud/webrisk/v1beta1/webrisk.proto\x12\x1cgoogle.cloud.webrisk.v1beta1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd4\x03\n" +
	"\x1cComputeThreatListDiffRequest\x12N\n" +
	"\vthreat_type\x18\x01 \x01(\x0e2(.google.cloud.webrisk.v1beta1.ThreatTypeB\x03\xe0A\x02R\n" +
	"threatType\x12#\n" +
	"\rversion_token\x18\x02 \x01(\fR\fversionToken\x12m\n" +
	"\vconstraints\x18\x03 \x01(\v2F.google.cloud.webrisk.v1beta1.ComputeThreatListDiffRequest.ConstraintsB\x03\xe0A\x02R\vconstraints\x1a\xcf\x01\n" +
	"\vConstraints\x12(\n" +
	"\x10max_diff_entries\x18\x01 \x01(\x05R\x0emaxDiffEntries\x120\n" +
	"\x14max_database_entries\x18\x02 \x01(\x05R\x12maxDatabaseEntries\x12d\n" +
	"\x16supported_compressions\x18\x03 \x03(\x0e2-.google.cloud.webrisk.v1beta1.CompressionTypeR\x15supportedCompressions\"\xf5\x04\n" +
	"\x1dComputeThreatListDiffResponse\x12m\n" +
	"\rresponse_type\x18\x04 \x01(\x0e2H.google.cloud.webrisk.v1beta1.ComputeThreatListDiffResponse.ResponseTypeR\fresponseType\x12P\n" +
	"\tadditions\x18\x05 \x01(\v22.google.cloud.webrisk.v1beta1.ThreatEntryAdditionsR\tadditions\x12M\n" +
	"\bremovals\x18\x06 \x01(\v21.google.cloud.webrisk.v1beta1.ThreatEntryRemovalsR\bremovals\x12*\n" +
	"\x11new_version_token\x18\a \x01(\fR\x0fnewVersionToken\x12`\n" +
	"\bchecksum\x18\b \x01(\v2D.google.cloud.webrisk.v1beta1.ComputeThreatListDiffResponse.ChecksumR\bchecksum\x12N\n" +
	...
	"\x03uri\x18\x01 \x01(\tB\x03\xe0A\x02R\x03uri\x12P\n" +
	"\fthreat_types\x18\x02 \x03(\x0e2(.google.cloud.webrisk.v1beta1.ThreatTypeB\x03\xe0A\x02R\vthreatTypes\"\x80\x02\n" +
	"\x12SearchUrisResponse\x12R\n" +
	"\x06threat\x18\x01 \x01(\v2:.google.cloud.webrisk.v1beta1.SearchUrisResponse.ThreatUriR\x06threat\x1a\x95\x01\n" +
	"\tThreatUri\x12K\n" +
	"\fthreat_types\x18\x01 \x03(\x0e2(.google.cloud.webrisk.v1beta1.ThreatTypeR\vthreatTypes\x12;\n" +
	"\vexpire_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"expireTime\"\x88\x01\n" +
	"\x13SearchHashesRequest\x12\x1f\n" +
	"\vhash_prefix\x18\x01 \x01(\fR\n" +
	"hashPrefix\x12P\n" +
	"\fthreat_types\x18\x02 \x03(\x0e2(.google.cloud.webrisk.v1beta1.ThreatTypeB\x03\xe0A\x02R\vthreatTypes\"\xea\x02\n" +
	"\x14SearchHashesResponse\x12W\n" +
	"\athreats\x18\x01 \x03(\v2=.google.cloud.webrisk.v1beta1.SearchHashesResponse.ThreatHashR\athreats\x12L\n" +
	"\x14negative_expire_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x12negativeExpireTime\x1a\xaa\x01\n" +
	"\n" +
	"ThreatHash\x12K\n" +
	"\fthreat_types\x18\x01 \x03(\x0e2(.google.cloud.webrisk.v1beta1.ThreatTypeR\vthreatTypes\x12\x12\n" +
	"\x04hash\x18\x02 \x01(\fR\x04hash\x12;\n" +
	"\vexpire_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"expireTime\"\xb0\x01\n" +
	"\x14ThreatEntryAdditions\x12F\n" +
	"\n" +
	"raw_hashes\x18\x01 \x03(\v2'.google.cloud.webrisk.v1beta1.RawHashesR\trawHashes\x12P\n" +
	"\vrice_hashes\x18\x02 \x01(\v2/.google.cloud.webrisk.v1beta1.RiceDeltaEncodingR\n" +
	"riceHashes\"\xb4\x01\n" +
	"\x13ThreatEntryRemovals\x12I\n" +
	"\vraw_indices\x18\x01 \x01(\v2(.google.cloud.webrisk.v1beta1.RawIndicesR\n" +
	"rawIndices\x12R\n" +
	"\frice_indices\x18\x02 \x01(\v2/.google.cloud.webrisk.v1beta1.RiceDeltaEncodingR\vriceIndices\"&\n" +
	"\n" +
	"RawIndices\x12\x18\n" +
	...
	"entryCount\x12!\n" +
	"\fencoded_data\x18\x04 \x01(\fR\vencodedData*e\n" +
	"\n" +
	"ThreatType\x12\x1b\n" +
	...
	"\fSearchHashes\x121.google.cloud.webrisk.v1beta1.SearchHashesRequest\x1a2.google.cloud.webrisk.v1beta1.SearchHashesResponse\"9\xdaA\x18hash_prefix,threat_types\x82\xd3\xe4\x93\x02\x18\x12\x16/v1beta1/hashes:search\x1aJ\xcaA\x16webrisk.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xcf\x01\n" +
	"\x1acom.google.webrisk.v1beta1B\fWebRiskProtoP\x01Z:cloud.google.com/go/webrisk/apiv1beta1/webriskpb;webriskpb\xa2\x02\x04GCWR\xaa\x02\x1cGoogle.Cloud.WebRisk.V1Beta1\xca\x02\x1cGoogle\\Cloud\\WebRisk\\V1beta1\xea\x02\x1fGoogle::Cloud::WebRisk::V1beta1b\x06proto3"

var (
	file_google_cloud_webrisk_v1beta1_webrisk_proto_rawDescOnce sync.Once
	file_google_cloud_webrisk_v1beta1_webrisk_proto_rawDescData []byte
)
...
func file_google_cloud_webrisk_v1beta1_webrisk_proto_rawDescGZIP() []byte {
	file_google_cloud_webrisk_v1beta1_webrisk_proto_rawDescOnce.Do(func() {
		file_google_cloud_webrisk_v1beta1_webrisk_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_webrisk_v1beta1_webrisk_proto_rawDesc), len(file_google_cloud_webrisk_v1beta1_webrisk_proto_rawDesc)))
	})
...
var file_google_cloud_webrisk_v1beta1_webrisk_proto_goTypes = []any{
...
func file_google_cloud_webrisk_v1beta1_webrisk_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_webrisk_v1beta1_webrisk_proto_rawDesc), len(file_google_cloud_webrisk_v1beta1_webrisk_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   1,
