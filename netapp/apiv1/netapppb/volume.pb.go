...
func file_google_cloud_netapp_v1_volume_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_netapp_v1_volume_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_netapp_v1_volume_proto_msgTypes[18].OneofWrappers = []interface{}{}
	type x struct{}
