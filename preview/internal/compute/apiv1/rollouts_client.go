...
var newRolloutsClientHook clientHook
...
type RolloutsClient struct {
	...
	internalClient internalRolloutsClient
...
func (c *RolloutsClient) setGoogleClientInfo(keyval ...string) {
...
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type rolloutsRESTClient struct {
	...
	// Points back to the CallOptions field of the containing RolloutsClient
	CallOptions **RolloutsCallOptions
...
func NewRolloutsRESTClient(ctx context.Context, opts ...option.ClientOption) (*RolloutsClient, error) {
	...
	callOpts := defaultRolloutsRESTCallOptions()
	c := &rolloutsRESTClient{
		endpoint:    endpoint,
	...
	return &RolloutsClient{internalClient: c, CallOptions: callOpts}, nil
}

func defaultRolloutsRESTClientOptions() []option.ClientOption {
...
// the `x-goog-api-client` header passed on each request. Intended for
// use by Google-written clients.
func (c *rolloutsRESTClient) setGoogleClientInfo(keyval ...string) {
...
func (c *rolloutsRESTClient) Advance(ctx context.Context, req *computepb.AdvanceRolloutRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/global/rollouts/%v/advance", req.GetProject(), req.GetRollout())
	...
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "resource_name", fmt.Sprintf("//compute.googleapis.com/projects/%v/global/rollouts/%v", req.GetProject(), req.GetRollout()))
	}
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1.Rollouts/Advance")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/v1/projects/{project}/global/rollouts/{rollout}/advance")
	}
...
// Cancel cancels a Rollout.
func (c *rolloutsRESTClient) Cancel(ctx context.Context, req *computepb.CancelRolloutRequest, opts ...gax.CallOption) (*Operation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/global/rollouts/%v", req.GetProject(), req.GetRollout())

	params := url.Values{}
	if req != nil && req.RequestId != nil {
		params.Add("requestId", fmt.Sprintf("%v", req.GetRequestId()))
	}
	if req != nil && req.Rollback != nil {
		params.Add("rollback", fmt.Sprintf("%v", req.GetRollback()))
	}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1.Rollouts/Cancel")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/v1/projects/{project}/global/rollouts/{rollout}")
	}
...
// Delete deletes a Rollout.
func (c *rolloutsRESTClient) Delete(ctx context.Context, req *computepb.DeleteRolloutRequest, opts ...gax.CallOption) (*Operation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1.Rollouts/Delete")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/v1/projects/{project}/global/rollouts/{rollout}")
	}
...
// Get gets details of a single project-scoped Rollout.
func (c *rolloutsRESTClient) Get(ctx context.Context, req *computepb.GetRolloutRequest, opts ...gax.CallOption) (*computepb.Rollout, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1.Rollouts/Get")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/v1/projects/{project}/global/rollouts/{rollout}")
	}
...
func (c *rolloutsRESTClient) List(ctx context.Context, req *computepb.ListRolloutsRequest, opts ...gax.CallOption) *RolloutIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*computepb.Rollout, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/global/rollouts", req.GetProject())
...
func (c *rolloutsRESTClient) Pause(ctx context.Context, req *computepb.PauseRolloutRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/global/rollouts/%v/pause", req.GetProject(), req.GetRollout())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1.Rollouts/Pause")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/v1/projects/{project}/global/rollouts/{rollout}/pause")
	}
...
func (c *rolloutsRESTClient) Resume(ctx context.Context, req *computepb.ResumeRolloutRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/global/rollouts/%v/resume", req.GetProject(), req.GetRollout())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1.Rollouts/Resume")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/v1/projects/{project}/global/rollouts/{rollout}/resume")
	}
