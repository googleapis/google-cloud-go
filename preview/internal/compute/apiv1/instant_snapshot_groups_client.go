...
// internalInstantSnapshotGroupsClient is an interface that defines the methods available from Compute Engine API.
...
// InstantSnapshotGroupsClient is a client for interacting with Compute Engine API.
...
func (c *instantSnapshotGroupsRESTClient) Delete(ctx context.Context, req *computepb.DeleteInstantSnapshotGroupRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/zones/%v/instantSnapshotGroups/%v", req.GetProject(), req.GetZone(), req.GetInstantSnapshotGroup())
...
func (c *instantSnapshotGroupsRESTClient) GetIamPolicy(ctx context.Context, req *computepb.GetIamPolicyInstantSnapshotGroupRequest, opts ...gax.CallOption) (*computepb.Policy, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/zones/%v/instantSnapshotGroups/%v/getIamPolicy", req.GetProject(), req.GetZone(), req.GetResource())
...
func (c *instantSnapshotGroupsRESTClient) Insert(ctx context.Context, req *computepb.InsertInstantSnapshotGroupRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/zones/%v/instantSnapshotGroups", req.GetProject(), req.GetZone())
...
func (c *instantSnapshotGroupsRESTClient) SetIamPolicy(ctx context.Context, req *computepb.SetIamPolicyInstantSnapshotGroupRequest, opts ...gax.CallOption) (*computepb.Policy, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/zones/%v/instantSnapshotGroups/%v/setIamPolicy", req.GetProject(), req.GetZone(), req.GetResource())
...
func (c *instantSnapshotGroupsRESTClient) TestIamPermissions(ctx context.Context, req *computepb.TestIamPermissionsInstantSnapshotGroupRequest, opts ...gax.CallOption) (*computepb.TestPermissionsResponse, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/zones/%v/instantSnapshotGroups/%v/testIamPermissions", req.GetProject(), req.GetZone(), req.GetResource())
