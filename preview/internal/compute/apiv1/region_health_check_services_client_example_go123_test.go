...
func ExampleRegionHealthCheckServicesClient_AggregatedList_all() {
	...
	req := &computepb.AggregatedListRegionHealthCheckServicesRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/compute/apiv1/computepb#AggregatedListRegionHealthCheckServicesRequest.
	}
...
func ExampleRegionHealthCheckServicesClient_List_all() {
	ctx := context.Background()
	// This snippet has been automatically generated and should be regarded as a code template only.
	// It will require modifications to work:
	// - It may require correct/in-range values for request initialization.
