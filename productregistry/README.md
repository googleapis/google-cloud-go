...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/productregistry.svg)](https://pkg.go.dev/cloud.google.com/go/productregistry)

Go Client Library for Cloud Product Registry API.

## Install

```bash
go get cloud.google.com/go/productregistry
```
