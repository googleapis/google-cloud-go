...
// The type of data.
type RequestStatusPerDestination_DataType int32

const (
	// The data type is unspecified.
	RequestStatusPerDestination_DATA_TYPE_UNSPECIFIED RequestStatusPerDestination_DataType = 0
	// The data is an email address.
	RequestStatusPerDestination_EMAIL RequestStatusPerDestination_DataType = 1
	// The data is a phone number.
	RequestStatusPerDestination_PHONE_NUMBER RequestStatusPerDestination_DataType = 2
	// The data is a physical address.
	RequestStatusPerDestination_ADDRESS RequestStatusPerDestination_DataType = 3
	// The data is an IP address.
	RequestStatusPerDestination_IP_ADDRESS RequestStatusPerDestination_DataType = 4
)

// Enum value maps for RequestStatusPerDestination_DataType.
var (
	RequestStatusPerDestination_DataType_name = map[int32]string{
	...
	RequestStatusPerDestination_DataType_value = map[string]int32{
...
func (x RequestStatusPerDestination_DataType) Enum() *RequestStatusPerDestination_DataType {
	p := new(RequestStatusPerDestination_DataType)
	*p = x
	return p
}

func (x RequestStatusPerDestination_DataType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RequestStatusPerDestination_DataType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_datamanager_v1_request_status_per_destination_proto_enumTypes[1].Descriptor()
}

func (RequestStatusPerDestination_DataType) Type() protoreflect.EnumType {
	return &file_google_ads_datamanager_v1_request_status_per_destination_proto_enumTypes[1]
}

func (x RequestStatusPerDestination_DataType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RequestStatusPerDestination_DataType.Descriptor instead.
func (RequestStatusPerDestination_DataType) EnumDescriptor() ([]byte, []int) {
...
func (x *RequestStatusPerDestination_IngestAudienceMembersStatus) GetCompositeDataIngestionStatus() *RequestStatusPerDestination_IngestCompositeDataStatus {
	if x != nil {
		if x, ok := x.Status.(*RequestStatusPerDestination_IngestAudienceMembersStatus_CompositeDataIngestionStatus); ok {
			return x.CompositeDataIngestionStatus
		}
	}
	return nil
}
...
type RequestStatusPerDestination_IngestAudienceMembersStatus_CompositeDataIngestionStatus struct {
...
func (x *RequestStatusPerDestination_RemoveAudienceMembersStatus) GetCompositeDataRemovalStatus() *RequestStatusPerDestination_RemoveCompositeDataStatus {
	if x != nil {
		if x, ok := x.Status.(*RequestStatusPerDestination_RemoveAudienceMembersStatus_CompositeDataRemovalStatus); ok {
			return x.CompositeDataRemovalStatus
		}
	}
	return nil
}
...
type RequestStatusPerDestination_RemoveAudienceMembersStatus_CompositeDataRemovalStatus struct {
...
// stats related to the ingestion.
type RequestStatusPerDestination_IngestCompositeDataStatus struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The total count of audience members sent in the upload request for the
	// destination. Includes all audience members in the request, regardless of
	// whether they were successfully ingested or not.
	...
	// not.
	DataTypeCounts []*RequestStatusPerDestination_DataTypeCount `protobuf:"bytes,2,rep,name=data_type_counts,json=dataTypeCounts,proto3" json:"data_type_counts,omitempty"`
	// The match rate range of the upload.
	UploadMatchRateRange MatchRateRange `protobuf:"varint,3,opt,name=upload_match_rate_range,json=uploadMatchRateRange,proto3,enum=google.ads.datamanager.v1.MatchRateRange" json:"upload_match_rate_range,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
...
func (x *RequestStatusPerDestination_IngestCompositeDataStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RequestStatusPerDestination_IngestCompositeDataStatus) GetDataTypeCounts() []*RequestStatusPerDestination_DataTypeCount {
	if x != nil {
		return x.DataTypeCounts
	}
	return nil
}

func (x *RequestStatusPerDestination_IngestCompositeDataStatus) GetUploadMatchRateRange() MatchRateRange {
	if x != nil {
		return x.UploadMatchRateRange
	}
	return MatchRateRange_MATCH_RATE_RANGE_UNKNOWN
...
// The status of the composite data removal from the destination.
type RequestStatusPerDestination_RemoveCompositeDataStatus struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The total count of audience members sent in the removal request. Includes
	// all audience members in the request, regardless of whether they were
	// successfully removed or not.
...
func (x *RequestStatusPerDestination_RemoveCompositeDataStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RequestStatusPerDestination_RemoveCompositeDataStatus) GetDataTypeCounts() []*RequestStatusPerDestination_DataTypeCount {
	if x != nil {
		return x.DataTypeCounts
	}
	return nil
...
type RequestStatusPerDestination_DataTypeCount struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The type of data.
	Type RequestStatusPerDestination_DataType `protobuf:"varint,1,opt,name=type,proto3,enum=google.ads.datamanager.v1.RequestStatusPerDestination_DataType" json:"type,omitempty"`
...
func (x *RequestStatusPerDestination_DataTypeCount) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RequestStatusPerDestination_DataTypeCount) GetType() RequestStatusPerDestination_DataType {
	...
	return RequestStatusPerDestination_DATA_TYPE_UNSPECIFIED
}

func (x *RequestStatusPerDestination_DataTypeCount) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
const file_google_ads_datamanager_v1_request_status_per_destination_proto_rawDesc = "" +
	...
	"\frecord_count\x18\x01 \x01(\x03R\vrecordCount\x12\x1d\n" +
	"\n" +
	"ppid_count\x18\x02 \x01(\x03R\tppidCount\x1a\x90\x02\n" +
	"\x19IngestCompositeDataStatus\x12!\n" +
	"\frecord_count\x18\x01 \x01(\x03R\vrecordCount\x12n\n" +
	"\x10data_type_counts\x18\x02 \x03(\v2D.google.ads.datamanager.v1.RequestStatusPerDestination.DataTypeCountR\x0edataTypeCounts\x12`\n" +
	...
	"\aADDRESS\x10\x03\x12\x0e\n" +
	"\n" +
	"IP_ADDRESS\x10\x04B\b\n" +
	"\x06statusB\xdd\x01\n" +
