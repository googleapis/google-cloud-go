...
type IngestionServiceClient interface {
	...
	IngestAdEvents(ctx context.Context, in *IngestAdEventsRequest, opts ...grpc.CallOption) (*IngestAdEventsResponse, error)
...
type IngestionServiceServer interface {
	...
	//
	// This feature is only available to accounts on an allowlist.
	IngestAdEvents(context.Context, *IngestAdEventsRequest) (*IngestAdEventsResponse, error)
	// Gets the status of a request given request id.
...
func _IngestionService_IngestAdEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(IngestionServiceServer).IngestAdEvents(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IngestionService_IngestAdEvents_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IngestionServiceServer).IngestAdEvents(ctx, req.(*IngestAdEventsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var IngestionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _IngestionService_IngestAdEvents_Handler,
		},
		{
