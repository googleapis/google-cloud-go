...
const (
	...
	EventSource_MESSAGE EventSource = 6
...
type Event struct {
	...
	// advertiser data.
	ThirdPartyUserData *UserData `protobuf:"bytes,20,opt,name=third_party_user_data,json=thirdPartyUserData,proto3" json:"third_party_user_data,omitempty"`
	// Optional. Information gathered about the location of the user when this
	// event occurred.
	EventLocation *EventLocation `protobuf:"bytes,21,opt,name=event_location,json=eventLocation,proto3" json:"event_location,omitempty"`
	// Optional. A unique identifier for the user instance of an app client for
	// this GA4 app stream.
	AppInstanceId string `protobuf:"bytes,22,opt,name=app_instance_id,json=appInstanceId,proto3" json:"app_instance_id,omitempty"`
...
func (x *Event) GetThirdPartyUserData() *UserData {
	if x != nil {
		return x.ThirdPartyUserData
	}
	return nil
}

func (x *Event) GetEventLocation() *EventLocation {
	if x != nil {
...
func (x *Event) GetAppInstanceId() string {
	if x != nil {
...
func (x *AdIdentifiers) GetMobileDeviceId() string {
	if x != nil {
...
type EventLocation struct {
	...
	SubdivisionCode string `protobuf:"bytes,3,opt,name=subdivision_code,json=subdivisionCode,proto3" json:"subdivision_code,omitempty"`
	...
	SubcontinentCode string `protobuf:"bytes,5,opt,name=subcontinent_code,json=subcontinentCode,proto3" json:"subcontinent_code,omitempty"`
...
func (x *EventLocation) Reset() {
	*x = EventLocation{}
	mi := &file_google_ads_datamanager_v1_event_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EventLocation) Descriptor() ([]byte, []int) {
	return file_google_ads_datamanager_v1_event_proto_rawDescGZIP(), []int{4}
}

func (x *EventLocation) GetStoreId() string {
	if x != nil {
		return x.StoreId
	}
	return ""
...
func (x *EventLocation) GetSubdivisionCode() string {
	if x != nil {
...
func (x *EventLocation) GetRegionCode() string {
	if x != nil {
		return x.RegionCode
	}
	return ""
...
func (x *EventLocation) GetSubcontinentCode() string {
	if x != nil {
		return x.SubcontinentCode
	}
	return ""
}

func (x *EventLocation) GetContinentCode() string {
	if x != nil {
...
const file_google_ads_datamanager_v1_event_proto_rawDesc = "" +
	...
	"\x1badditional_event_parameters\x18\x13 \x03(\v2).google.ads.datamanager.v1.EventParameterB\x03\xe0A\x01R\x19additionalEventParameters\x12[\n" +
	...
	"\x05value\x18\x02 \x01(\tB\x03\xe0A\x02R\x05value\"\xfc\x01\n" +
	"\rEventLocation\x12\x1e\n" +
	"\bstore_id\x18\x01 \x01(\tB\x03\xe0A\x01R\astoreId\x12\x17\n" +
	"\x04city\x18\x02 \x01(\tB\x03\xe0A\x01R\x04city\x12.\n" +
	"\x10subdivision_code\x18\x03 \x01(\tB\x03\xe0A\x01R\x0fsubdivisionCode\x12$\n" +
	"\vregion_code\x18\x04 \x01(\tB\x03\xe0A\x01R\n" +
	"regionCode\x120\n" +
	"\x11subcontinent_code\x18\x05 \x01(\tB\x03\xe0A\x01R\x10subcontinentCode\x12*\n" +
	"\x0econtinent_code\x18\x06 \x01(\tB\x03\xe0A\x01R\rcontinentCode*n\n" +
...
var file_google_ads_datamanager_v1_event_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_datamanager_v1_event_proto_goTypes = []any{
	...
	(*EventLocation)(nil),         // 5: google.ads.datamanager.v1.EventLocation
	(*timestamppb.Timestamp)(nil), // 6: google.protobuf.Timestamp
	(*UserData)(nil),              // 7: google.ads.datamanager.v1.UserData
	(*Consent)(nil),               // 8: google.ads.datamanager.v1.Consent
	(*DeviceInfo)(nil),            // 9: google.ads.datamanager.v1.DeviceInfo
...
var file_google_ads_datamanager_v1_event_proto_depIdxs = []int32{
	...
	6,  // 1: google.ads.datamanager.v1.Event.last_updated_timestamp:type_name -> google.protobuf.Timestamp
	7,  // 2: google.ads.datamanager.v1.Event.user_data:type_name -> google.ads.datamanager.v1.UserData
	8,  // 3: google.ads.datamanager.v1.Event.consent:type_name -> google.ads.datamanager.v1.Consent
	...
	9,  // 6: google.ads.datamanager.v1.Event.event_device_info:type_name -> google.ads.datamanager.v1.DeviceInfo
	10, // 7: google.ads.datamanager.v1.Event.cart_data:type_name -> google.ads.datamanager.v1.CartData
	3,  // 8: google.ads.datamanager.v1.Event.custom_variables:type_name -> google.ads.datamanager.v1.CustomVariable
	11, // 9: google.ads.datamanager.v1.Event.experimental_fields:type_name -> google.ads.datamanager.v1.ExperimentalField
	12, // 10: google.ads.datamanager.v1.Event.user_properties:type_name -> google.ads.datamanager.v1.UserProperties
