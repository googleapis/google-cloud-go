...
const file_google_cloud_cloudcontrolspartner_v1beta_access_approval_requests_proto_rawDesc = "" +
	"\n" +
	"Ggoogle/cloud/cloudcontrolspartner/v1beta/access_approval_requests.proto\x12(google.cloud.cloudcontrolspartner.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xaa\x04\n" +
	"\x15AccessApprovalRequest\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12=\n" +
	"\frequest_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\vrequestTime\x12a\n" +
	"\x10requested_reason\x18\x03 \x01(\v26.google.cloud.cloudcontrolspartner.v1beta.AccessReasonR\x0frequestedReason\x12V\n" +
	...
	"\border_by\x18\x05 \x01(\tB\x03\xe0A\x01R\aorderBy\"\xe9\x01\n" +
	"\"ListAccessApprovalRequestsResponse\x12y\n" +
	"\x18access_approval_requests\x18\x01 \x03(\v2?.google.cloud.cloudcontrolspartner.v1beta.AccessApprovalRequestR\x16accessApprovalRequests\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12 \n" +
	"\vunreachable\x18\x03 \x03(\tR\vunreachable\"\xd4\x02\n" +
	"\fAccessReason\x12O\n" +
	"\x04type\x18\x01 \x01(\x0e2;.google.cloud.cloudcontrolspartner.v1beta.AccessReason.TypeR\x04type\x12\x16\n" +
...
var (
	...
	file_google_cloud_cloudcontrolspartner_v1beta_access_approval_requests_proto_rawDescData []byte
)
...
func file_google_cloud_cloudcontrolspartner_v1beta_access_approval_requests_proto_rawDescGZIP() []byte {
	file_google_cloud_cloudcontrolspartner_v1beta_access_approval_requests_proto_rawDescOnce.Do(func() {
		file_google_cloud_cloudcontrolspartner_v1beta_access_approval_requests_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_cloudcontrolspartner_v1beta_access_approval_requests_proto_rawDesc), len(file_google_cloud_cloudcontrolspartner_v1beta_access_approval_requests_proto_rawDesc)))
	})
...
func file_google_cloud_cloudcontrolspartner_v1beta_access_approval_requests_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_cloudcontrolspartner_v1beta_access_approval_requests_proto_rawDesc), len(file_google_cloud_cloudcontrolspartner_v1beta_access_approval_requests_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
