...
const (
	...
	//
	// Deprecated: Marked as deprecated in google/cloud/cloudcontrolspartner/v1beta/partners.proto.
...
const file_google_cloud_cloudcontrolspartner_v1beta_partners_proto_rawDesc = "" +
	"\n" +
	"7google/cloud/cloudcontrolspartner/v1beta/partners.proto\x12(google.cloud.cloudcontrolspartner.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9f\x04\n" +
	"\aPartner\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12A\n" +
	"\x04skus\x18\x03 \x03(\v2-.google.cloud.cloudcontrolspartner.v1beta.SkuR\x04skus\x12Z\n" +
	"\rekm_solutions\x18\x04 \x03(\v25.google.cloud.cloudcontrolspartner.v1beta.EkmMetadataR\fekmSolutions\x124\n" +
	...
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\"\x81\x02\n" +
	"\vEkmMetadata\x12d\n" +
	"\fekm_solution\x18\x01 \x01(\x0e2A.google.cloud.cloudcontrolspartner.v1beta.EkmMetadata.EkmSolutionR\vekmSolution\x12(\n" +
	...
	"\x06VIRTRU\x10\x04\x1a\x02\b\x01B\xa5\x02\n" +
...
var (
	...
	file_google_cloud_cloudcontrolspartner_v1beta_partners_proto_rawDescData []byte
)
...
func file_google_cloud_cloudcontrolspartner_v1beta_partners_proto_rawDescGZIP() []byte {
	file_google_cloud_cloudcontrolspartner_v1beta_partners_proto_rawDescOnce.Do(func() {
		file_google_cloud_cloudcontrolspartner_v1beta_partners_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_cloudcontrolspartner_v1beta_partners_proto_rawDesc), len(file_google_cloud_cloudcontrolspartner_v1beta_partners_proto_rawDesc)))
	})
...
func file_google_cloud_cloudcontrolspartner_v1beta_partners_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_cloudcontrolspartner_v1beta_partners_proto_rawDesc), len(file_google_cloud_cloudcontrolspartner_v1beta_partners_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
