...
const file_google_cloud_cloudcontrolspartner_v1beta_partner_permissions_proto_rawDesc = "" +
	"\n" +
	"Bgoogle/cloud/cloudcontrolspartner/v1beta/partner_permissions.proto\x12(google.cloud.cloudcontrolspartner.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\xd3\x04\n" +
	"\x12PartnerPermissions\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12x\n" +
	"\x13partner_permissions\x18\x02 \x03(\x0e2G.google.cloud.cloudcontrolspartner.v1beta.PartnerPermissions.PermissionR\x12partnerPermissions\"\xfa\x01\n" +
	"\n" +
	"Permission\x12\x1a\n" +
	...
	"6cloudcontrolspartner.googleapis.com/PartnerPermissionsR\x04nameB\xaf\x02\n" +
...
var (
	...
	file_google_cloud_cloudcontrolspartner_v1beta_partner_permissions_proto_rawDescData []byte
)
...
func file_google_cloud_cloudcontrolspartner_v1beta_partner_permissions_proto_rawDescGZIP() []byte {
	file_google_cloud_cloudcontrolspartner_v1beta_partner_permissions_proto_rawDescOnce.Do(func() {
		file_google_cloud_cloudcontrolspartner_v1beta_partner_permissions_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_cloudcontrolspartner_v1beta_partner_permissions_proto_rawDesc), len(file_google_cloud_cloudcontrolspartner_v1beta_partner_permissions_proto_rawDesc)))
	})
...
func file_google_cloud_cloudcontrolspartner_v1beta_partner_permissions_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_cloudcontrolspartner_v1beta_partner_permissions_proto_rawDesc), len(file_google_cloud_cloudcontrolspartner_v1beta_partner_permissions_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
