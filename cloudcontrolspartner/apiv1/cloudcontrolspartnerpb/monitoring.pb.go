...
const file_google_cloud_cloudcontrolspartner_v1_monitoring_proto_rawDesc = "" +
	"\n" +
	...
	"\fGetViolation\x129.google.cloud.cloudcontrolspartner.v1.GetViolationRequest\x1a/.google.cloud.cloudcontrolspartner.v1.Violation\"Z\xdaA\x04name\x82\xd3\xe4\x93\x02M\x12K/v1/{name=organizations/*/locations/*/customers/*/workloads/*/violations/*}\x1aW\xcaA#cloudcontrolspartner.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\x93\x02\n" +
...
func file_google_cloud_cloudcontrolspartner_v1_monitoring_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_cloudcontrolspartner_v1_monitoring_proto_rawDesc), len(file_google_cloud_cloudcontrolspartner_v1_monitoring_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
