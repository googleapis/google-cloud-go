...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/cloudcontrolspartner.svg)](https://pkg.go.dev/cloud.google.com/go/cloudcontrolspartner)

Go Client Library for Cloud Controls Partner API.
