...
const file_google_appengine_v1_domain_mapping_proto_rawDesc = "" +
	"\n" +
	"(google/appengine/v1/domain_mapping.proto\x12\x13google.appengine.v1\"\xc8\x01\n" +
	"\rDomainMapping\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12C\n" +
	"\fssl_settings\x18\x03 \x01(\v2 .google.appengine.v1.SslSettingsR\vsslSettings\x12N\n" +
	"\x10resource_records\x18\x04 \x03(\v2#.google.appengine.v1.ResourceRecordR\x0fresourceRecords\"\xb2\x02\n" +
	"\vSslSettings\x12%\n" +
	"\x0ecertificate_id\x18\x01 \x01(\tR\rcertificateId\x12b\n" +
	"\x13ssl_management_type\x18\x03 \x01(\x0e22.google.appengine.v1.SslSettings.SslManagementTypeR\x11sslManagementType\x12C\n" +
	...
	"\x06rrdata\x18\x02 \x01(\tR\x06rrdata\x12B\n" +
	"\x04type\x18\x03 \x01(\x0e2..google.appengine.v1.ResourceRecord.RecordTypeR\x04type\"E\n" +
	"\n" +
	"RecordType\x12\x1b\n" +
...
var (
	...
	file_google_appengine_v1_domain_mapping_proto_rawDescData []byte
)
...
func file_google_appengine_v1_domain_mapping_proto_rawDescGZIP() []byte {
	file_google_appengine_v1_domain_mapping_proto_rawDescOnce.Do(func() {
		file_google_appengine_v1_domain_mapping_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_appengine_v1_domain_mapping_proto_rawDesc), len(file_google_appengine_v1_domain_mapping_proto_rawDesc)))
	})
...
var file_google_appengine_v1_domain_mapping_proto_goTypes = []any{
...
func file_google_appengine_v1_domain_mapping_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_appengine_v1_domain_mapping_proto_rawDesc), len(file_google_appengine_v1_domain_mapping_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
