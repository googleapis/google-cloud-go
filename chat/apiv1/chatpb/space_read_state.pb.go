...
var file_google_chat_v1_space_read_state_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x4d, 0x61, 0x73, 0x6b, 0x42, 0x9e, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x67,
...
var file_google_chat_v1_space_read_state_proto_goTypes = []interface{}{
...
func file_google_chat_v1_space_read_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_chat_v1_space_read_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_chat_v1_space_read_state_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_chat_v1_space_read_state_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
