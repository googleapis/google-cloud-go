...
var file_google_chat_v1_group_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x95, 0x01, 0x0a, 0x12, 0x63, 0x6f,
...
var file_google_chat_v1_group_proto_goTypes = []interface{}{
...
func file_google_chat_v1_group_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_chat_v1_group_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Group); i {
			case 0:
				return &v.state
			case 1:
