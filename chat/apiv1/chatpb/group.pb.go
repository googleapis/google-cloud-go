...
const file_google_chat_v1_group_proto_rawDesc = "" +
	"\n" +
	"\x1agoogle/chat/v1/group.proto\x12\x0egoogle.chat.v1\"\x1b\n" +
	"\x05Group\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04nameB\xa3\x01\n" +
	"\x12com.google.chat.v1B\n" +
	"GroupProtoP\x01Z,cloud.google.com/go/chat/apiv1/chatpb;chatpb\xa2\x02\vDYNAPIProto\xaa\x02\x13Google.Apps.Chat.V1\xca\x02\x13Google\\Apps\\Chat\\V1\xea\x02\x16Google::Apps::Chat::V1b\x06proto3"

var (
	file_google_chat_v1_group_proto_rawDescOnce sync.Once
	file_google_chat_v1_group_proto_rawDescData []byte
)

func file_google_chat_v1_group_proto_rawDescGZIP() []byte {
	file_google_chat_v1_group_proto_rawDescOnce.Do(func() {
		file_google_chat_v1_group_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_chat_v1_group_proto_rawDesc), len(file_google_chat_v1_group_proto_rawDesc)))
	})
...
func file_google_chat_v1_group_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_chat_v1_group_proto_rawDesc), len(file_google_chat_v1_group_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
