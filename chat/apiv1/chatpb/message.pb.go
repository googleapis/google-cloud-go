...
type CreateMessageNotificationOptions_NotificationType int32
...
const (
	...
	// human sender.
	CreateMessageNotificationOptions_NOTIFICATION_TYPE_NONE CreateMessageNotificationOptions_NotificationType = 0
	...
	CreateMessageNotificationOptions_NOTIFICATION_TYPE_FORCE_NOTIFY CreateMessageNotificationOptions_NotificationType = 2
	...
	// Requires [app authentication]
	// (https://developers.google.com/workspace/chat/authenticate-authorize-chat-app).
	CreateMessageNotificationOptions_NOTIFICATION_TYPE_SILENT CreateMessageNotificationOptions_NotificationType = 3
)

// Enum value maps for CreateMessageNotificationOptions_NotificationType.
var (
	CreateMessageNotificationOptions_NotificationType_name = map[int32]string{
		0: "NOTIFICATION_TYPE_NONE",
		2: "NOTIFICATION_TYPE_FORCE_NOTIFY",
		3: "NOTIFICATION_TYPE_SILENT",
	}
	CreateMessageNotificationOptions_NotificationType_value = map[string]int32{
...
func (x CreateMessageNotificationOptions_NotificationType) Enum() *CreateMessageNotificationOptions_NotificationType {
	p := new(CreateMessageNotificationOptions_NotificationType)
	*p = x
	return p
}

func (x CreateMessageNotificationOptions_NotificationType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CreateMessageNotificationOptions_NotificationType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_chat_v1_message_proto_enumTypes[3].Descriptor()
}

func (CreateMessageNotificationOptions_NotificationType) Type() protoreflect.EnumType {
	return &file_google_chat_v1_message_proto_enumTypes[3]
}

func (x CreateMessageNotificationOptions_NotificationType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CreateMessageNotificationOptions_NotificationType.Descriptor instead.
func (CreateMessageNotificationOptions_NotificationType) EnumDescriptor() ([]byte, []int) {
	return file_google_chat_v1_message_proto_rawDescGZIP(), []int{12, 0}
}

// The kinds of view that are supported for partial search results.
type SearchMessagesRequest_SearchMessagesView int32

const (
	// The default / unset value.
	// The API will default to the BASIC view.
	SearchMessagesRequest_SEARCH_MESSAGES_VIEW_UNSPECIFIED SearchMessagesRequest_SearchMessagesView = 0
	// Includes only the matched messages in the results, but no additional
	// metadata. This is the default value.
	SearchMessagesRequest_SEARCH_MESSAGES_VIEW_BASIC SearchMessagesRequest_SearchMessagesView = 1
	// Includes everything in the results: the matched messages and additional
	// metadata.
	SearchMessagesRequest_SEARCH_MESSAGES_VIEW_FULL SearchMessagesRequest_SearchMessagesView = 2
)

// Enum value maps for SearchMessagesRequest_SearchMessagesView.
var (
	SearchMessagesRequest_SearchMessagesView_name = map[int32]string{
		0: "SEARCH_MESSAGES_VIEW_UNSPECIFIED",
		1: "SEARCH_MESSAGES_VIEW_BASIC",
		2: "SEARCH_MESSAGES_VIEW_FULL",
	}
	SearchMessagesRequest_SearchMessagesView_value = map[string]int32{
...
func (x SearchMessagesRequest_SearchMessagesView) Enum() *SearchMessagesRequest_SearchMessagesView {
	p := new(SearchMessagesRequest_SearchMessagesView)
	*p = x
	return p
}

func (x SearchMessagesRequest_SearchMessagesView) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SearchMessagesRequest_SearchMessagesView) Descriptor() protoreflect.EnumDescriptor {
	return file_google_chat_v1_message_proto_enumTypes[4].Descriptor()
}

func (SearchMessagesRequest_SearchMessagesView) Type() protoreflect.EnumType {
	return &file_google_chat_v1_message_proto_enumTypes[4]
}

func (x SearchMessagesRequest_SearchMessagesView) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SearchMessagesRequest_SearchMessagesView.Descriptor instead.
func (SearchMessagesRequest_SearchMessagesView) EnumDescriptor() ([]byte, []int) {
	return file_google_chat_v1_message_proto_rawDescGZIP(), []int{18, 0}
}
...
type Message struct {
	...
	Silent bool `protobuf:"varint,46,opt,name=silent,proto3" json:"silent,omitempty"`
...
func (x *AccessoryWidget) GetAction() isAccessoryWidget_Action {
	if x != nil {
		return x.Action
	}
	return nil
...
func (x *AccessoryWidget) GetButtonList() *v1.ButtonList {
	if x != nil {
		if x, ok := x.Action.(*AccessoryWidget_ButtonList); ok {
			return x.ButtonList
		}
	}
	return nil
...
type CreateMessageRequest struct {
	...
	CreateMessageNotificationOptions *CreateMessageNotificationOptions `protobuf:"bytes,10,opt,name=create_message_notification_options,json=createMessageNotificationOptions,proto3" json:"create_message_notification_options,omitempty"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
func (x *CreateMessageRequest) GetCreateMessageNotificationOptions() *CreateMessageNotificationOptions {
	if x != nil {
		return x.CreateMessageNotificationOptions
	}
	return nil
}

// Options for the notification behavior when the message is posted.
type CreateMessageNotificationOptions struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The notification type for the message.
	NotificationType CreateMessageNotificationOptions_NotificationType `protobuf:"varint,1,opt,name=notification_type,json=notificationType,proto3,enum=google.chat.v1.CreateMessageNotificationOptions_NotificationType" json:"notification_type,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *CreateMessageNotificationOptions) Reset() {
	*x = CreateMessageNotificationOptions{}
	mi := &file_google_chat_v1_message_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CreateMessageNotificationOptions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateMessageNotificationOptions) ProtoMessage() {}

func (x *CreateMessageNotificationOptions) ProtoReflect() protoreflect.Message {
	mi := &file_google_chat_v1_message_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateMessageNotificationOptions.ProtoReflect.Descriptor instead.
func (*CreateMessageNotificationOptions) Descriptor() ([]byte, []int) {
	return file_google_chat_v1_message_proto_rawDescGZIP(), []int{12}
}

func (x *CreateMessageNotificationOptions) GetNotificationType() CreateMessageNotificationOptions_NotificationType {
	if x != nil {
		return x.NotificationType
	}
	return CreateMessageNotificationOptions_NOTIFICATION_TYPE_NONE
}
...
func (x *DialogAction) GetAction() isDialogAction_Action {
	if x != nil {
		return x.Action
	}
	return nil
...
func (x *DialogAction) GetDialog() *Dialog {
	if x != nil {
		if x, ok := x.Action.(*DialogAction_Dialog); ok {
			return x.Dialog
		}
	}
	return nil
...
func (*CardWithId) Descriptor() ([]byte, []int) {
	return file_google_chat_v1_message_proto_rawDescGZIP(), []int{17}
}
...
func (*SearchMessagesRequest) Descriptor() ([]byte, []int) {
	return file_google_chat_v1_message_proto_rawDescGZIP(), []int{18}
}
...
func (x *SearchMessagesRequest) GetOrderBy() string {
	if x != nil {
		return x.OrderBy
	}
	return ""
...
func (x *SearchMessagesRequest) GetView() SearchMessagesRequest_SearchMessagesView {
	...
	return SearchMessagesRequest_SEARCH_MESSAGES_VIEW_UNSPECIFIED
}
...
type SearchMessagesResponse struct {
	...
	Results []*SearchMessageResult `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
...
func (x *SearchMessagesResponse) Reset() {
	*x = SearchMessagesResponse{}
	mi := &file_google_chat_v1_message_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SearchMessagesResponse) Descriptor() ([]byte, []int) {
	return file_google_chat_v1_message_proto_rawDescGZIP(), []int{19}
}
...
type SearchMessageResult struct {
	...
	//   - `https://www.googleapis.com/auth/chat.users.readstate.readonly`
	//   - `https://www.googleapis.com/auth/chat.users.readstate`
	Read *bool `protobuf:"varint,3,opt,name=read,proto3,oneof" json:"read,omitempty"`
	...
	SpaceMuteSetting SpaceNotificationSetting_MuteSetting `protobuf:"varint,4,opt,name=space_mute_setting,json=spaceMuteSetting,proto3,enum=google.chat.v1.SpaceNotificationSetting_MuteSetting" json:"space_mute_setting,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *SearchMessageResult) Reset() {
	*x = SearchMessageResult{}
	mi := &file_google_chat_v1_message_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SearchMessageResult) Descriptor() ([]byte, []int) {
	return file_google_chat_v1_message_proto_rawDescGZIP(), []int{20}
}

func (x *SearchMessageResult) GetMessage() *Message {
	if x != nil {
		return x.Message
	}
	return nil
...
func (x *SearchMessageResult) GetRead() bool {
	if x != nil && x.Read != nil {
		return *x.Read
	}
	return false
...
func (x *SearchMessageResult) GetSpaceMuteSetting() SpaceNotificationSetting_MuteSetting {
	if x != nil {
		return x.SpaceMuteSetting
	}
...
func (x *ActionResponse_SelectionItems) Reset() {
	*x = ActionResponse_SelectionItems{}
	mi := &file_google_chat_v1_message_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ActionResponse_UpdatedWidget struct {
	...
	//
	// Types that are valid to be assigned to UpdatedWidget:
	//
...
func (x *ActionResponse_UpdatedWidget) Reset() {
	*x = ActionResponse_UpdatedWidget{}
	mi := &file_google_chat_v1_message_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ActionResponse_UpdatedWidget) GetUpdatedWidget() isActionResponse_UpdatedWidget_UpdatedWidget {
	if x != nil {
		return x.UpdatedWidget
	}
	return nil
...
func (x *ActionResponse_UpdatedWidget) GetSuggestions() *ActionResponse_SelectionItems {
	if x != nil {
		if x, ok := x.UpdatedWidget.(*ActionResponse_UpdatedWidget_Suggestions); ok {
...
const file_google_chat_v1_message_proto_rawDesc = "" +
	...
	"\vcreate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x06\xe0A\x05\xe0A\x01R\n" +
	"createTime\x12I\n" +
	"\x10last_update_time\x18\x17 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\x0elastUpdateTime\x12@\n" +
	"\vdelete_time\x18\x1a \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"deleteTime\x12\x17\n" +
	"\x04text\x18\x04 \x01(\tB\x03\xe0A\x01R\x04text\x12*\n" +
	"\x0eformatted_text\x18+ \x01(\tB\x03\xe0A\x03R\rformattedText\x12D\n" +
	"\x05cards\x18\x05 \x03(\v2*.google.chat.v1.ContextualAddOnMarkup.CardB\x02\x18\x01R\x05cards\x12:\n" +
	"\bcards_v2\x18\x16 \x03(\v2\x1a.google.chat.v1.CardWithIdB\x03\xe0A\x01R\acardsV2\x12A\n" +
	"\vannotations\x18\n" +
	" \x03(\v2\x1a.google.chat.v1.AnnotationB\x03\xe0A\x03R\vannotations\x12.\n" +
	"\x06thread\x18\v \x01(\v2\x16.google.chat.v1.ThreadR\x06thread\x120\n" +
	"\x05space\x18\f \x01(\v2\x15.google.chat.v1.SpaceB\x03\xe0A\x03R\x05space\x12(\n" +
	"\rfallback_text\x18\r \x01(\tB\x03\xe0A\x01R\ffallbackText\x12L\n" +
	"\x0faction_response\x18\x0e \x01(\v2\x1e.google.chat.v1.ActionResponseB\x03\xe0A\x04R\x0eactionResponse\x12(\n" +
	"\rargument_text\x18\x0f \x01(\tB\x03\xe0A\x03R\fargumentText\x12F\n" +
	"\rslash_command\x18\x11 \x01(\v2\x1c.google.chat.v1.SlashCommandB\x03\xe0A\x03R\fslashCommand\x12?\n" +
	"\n" +
	"attachment\x18\x12 \x03(\v2\x1a.google.chat.v1.AttachmentB\x03\xe0A\x01R\n" +
	"attachment\x12@\n" +
	"\vmatched_url\x18\x14 \x01(\v2\x1a.google.chat.v1.MatchedUrlB\x03\xe0A\x03R\n" +
	"matchedUrl\x12&\n" +
	"\fthread_reply\x18\x19 \x01(\bB\x03\xe0A\x03R\vthreadReply\x12\x1b\n" +
	"\x06silent\x18. \x01(\bB\x03\xe0A\x03R\x06silent\x12@\n" +
	"\x1aclient_assigned_message_id\x18  \x01(\tB\x03\xe0A\x01R\x17clientAssignedMessageId\x12c\n" +
	"\x18emoji_reaction_summaries\x18! \x03(\v2$.google.chat.v1.EmojiReactionSummaryB\x03\xe0A\x03R\x16emojiReactionSummaries\x12R\n" +
	"\x16private_message_viewer\x18$ \x01(\v2\x14.google.chat.v1.UserB\x06\xe0A\x05\xe0A\x01R\x14privateMessageViewer\x12R\n" +
	...
	"\x10last_update_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x02R\x0elastUpdateTime\x12S\n" +
	"\n" +
	...
	"\x04text\x18\x02 \x01(\tB\x03\xe0A\x03R\x04text\x12*\n" +
	"\x0eformatted_text\x18\x03 \x01(\tB\x03\xe0A\x03R\rformattedText\x12A\n" +
	"\vannotations\x18\x04 \x03(\v2\x1a.google.chat.v1.AnnotationB\x03\xe0A\x03R\vannotations\x12A\n" +
	"\vattachments\x18\x05 \x03(\v2\x1a.google.chat.v1.AttachmentB\x03\xe0A\x03R\vattachments\"\x7f\n" +
	...
	"\rdialog_action\x18\x03 \x01(\v2\x1c.google.chat.v1.DialogActionB\x03\xe0A\x04R\fdialogAction\x12X\n" +
	"\x0eupdated_widget\x18\x04 \x01(\v2,.google.chat.v1.ActionResponse.UpdatedWidgetB\x03\xe0A\x04R\rupdatedWidget\x1aY\n" +
	"\x0eSelectionItems\x12G\n" +
	"\x05items\x18\x01 \x03(\v21.google.apps.card.v1.SelectionInput.SelectionItemR\x05items\x1a\x8c\x01\n" +
	"\rUpdatedWidget\x12Q\n" +
	"\vsuggestions\x18\x01 \x01(\v2-.google.chat.v1.ActionResponse.SelectionItemsH\x00R\vsuggestions\x12\x16\n" +
	"\x06widget\x18\x02 \x01(\tR\x06widgetB\x10\n" +
	"\x0eupdated_widget\"\x9b\x01\n" +
	"\fResponseType\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\x0f\n" +
	"\vNEW_MESSAGE\x10\x01\x12\x12\n" +
	...
	"\amessage\x18\x01 \x01(\v2\x17.google.chat.v1.MessageB\x03\xe0A\x02R\amessage\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\x12(\n" +
	"\rallow_missing\x18\x04 \x01(\bB\x03\xe0A\x01R\fallowMissing\"\xf1\x04\n" +
	"\x14CreateMessageRequest\x12;\n" +
	"\x06parent\x18\x01 \x01(\tB#\xe0A\x02\xfaA\x1d\x12\x1bchat.googleapis.com/MessageR\x06parent\x126\n" +
	"\amessage\x18\x04 \x01(\v2\x17.google.chat.v1.MessageB\x03\xe0A\x02R\amessage\x12$\n" +
	"\n" +
	"thread_key\x18\x06 \x01(\tB\x05\xe0A\x01\x18\x01R\tthreadKey\x12\"\n" +
	"\n" +
	"request_id\x18\a \x01(\tB\x03\xe0A\x01R\trequestId\x12n\n" +
	"\x14message_reply_option\x18\b \x01(\x0e27.google.chat.v1.CreateMessageRequest.MessageReplyOptionB\x03\xe0A\x01R\x12messageReplyOption\x12\"\n" +
	"\n" +
	"message_id\x18\t \x01(\tB\x03\xe0A\x01R\tmessageId\x12\x84\x01\n" +
	"#create_message_notification_options\x18\n" +
	" \x01(\v20.google.chat.v1.CreateMessageNotificationOptionsB\x03\xe0A\x01R createMessageNotificationOptions\"\x7f\n" +
	...
	"\x15REPLY_MESSAGE_OR_FAIL\x10\x02\"\x84\x02\n" +
	" CreateMessageNotificationOptions\x12n\n" +
	"\x11notification_type\x18\x01 \x01(\x0e2A.google.chat.v1.CreateMessageNotificationOptions.NotificationTypeR\x10notificationType\"p\n" +
	...
	"\fDialogAction\x125\n" +
	"\x06dialog\x18\x01 \x01(\v2\x16.google.chat.v1.DialogB\x03\xe0A\x04H\x00R\x06dialog\x12F\n" +
	"\raction_status\x18\x02 \x01(\v2\x1c.google.chat.v1.ActionStatusB\x03\xe0A\x04R\factionStatusB\b\n" +
	"\x06action\"<\n" +
	"\x06Dialog\x122\n" +
	"\x04body\x18\x01 \x01(\v2\x19.google.apps.card.v1.CardB\x03\xe0A\x04R\x04body\"T\n" +
	"\n" +
	"CardWithId\x12\x17\n" +
	...
	"\x19SEARCH_MESSAGES_VIEW_FULL\x10\x02\"\x7f\n" +
	"\x16SearchMessagesResponse\x12=\n" +
	"\aresults\x18\x01 \x03(\v2#.google.chat.v1.SearchMessageResultR\aresults\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xce\x01\n" +
	"\x13SearchMessageResult\x121\n" +
	"\amessage\x18\x01 \x01(\v2\x17.google.chat.v1.MessageR\amessage\x12\x17\n" +
	"\x04read\x18\x03 \x01(\bH\x00R\x04read\x88\x01\x01\x12b\n" +
	"\x12space_mute_setting\x18\x04 \x01(\x0e24.google.chat.v1.SpaceNotificationSetting.MuteSettingR\x10spaceMuteSettingB\a\n" +
	"\x05_readB\xa5\x01\n" +
	"\x12com.google.chat.v1B\fMessageProtoP\x01Z,cloud.google.com/go/chat/apiv1/chatpb;chatpb\xa2\x02\vDYNAPIProto\xaa\x02\x13Google.Apps.Chat.V1\xca\x02\x13Google\\Apps\\Chat\\V1\xea\x02\x16Google::Apps::Chat::V1b\x06proto3"

var (
	file_google_chat_v1_message_proto_rawDescOnce sync.Once
	file_google_chat_v1_message_proto_rawDescData []byte
)

func file_google_chat_v1_message_proto_rawDescGZIP() []byte {
	file_google_chat_v1_message_proto_rawDescOnce.Do(func() {
		file_google_chat_v1_message_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_chat_v1_message_proto_rawDesc), len(file_google_chat_v1_message_proto_rawDesc)))
	})
	return file_google_chat_v1_message_proto_rawDescData
}

var file_google_chat_v1_message_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_google_chat_v1_message_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_google_chat_v1_message_proto_goTypes = []any{
	...
	(CreateMessageNotificationOptions_NotificationType)(0), // 3: google.chat.v1.CreateMessageNotificationOptions.NotificationType
	(SearchMessagesRequest_SearchMessagesView)(0),          // 4: google.chat.v1.SearchMessagesRequest.SearchMessagesView
	(*Message)(nil),                           // 5: google.chat.v1.Message
	(*AttachedGif)(nil),                       // 6: google.chat.v1.AttachedGif
	(*QuotedMessageMetadata)(nil),             // 7: google.chat.v1.QuotedMessageMetadata
	(*QuotedMessageSnapshot)(nil),             // 8: google.chat.v1.QuotedMessageSnapshot
	(*ForwardedMetadata)(nil),                 // 9: google.chat.v1.ForwardedMetadata
	(*Thread)(nil),                            // 10: google.chat.v1.Thread
	(*ActionResponse)(nil),                    // 11: google.chat.v1.ActionResponse
	(*AccessoryWidget)(nil),                   // 12: google.chat.v1.AccessoryWidget
	(*GetMessageRequest)(nil),                 // 13: google.chat.v1.GetMessageRequest
	(*DeleteMessageRequest)(nil),              // 14: google.chat.v1.DeleteMessageRequest
	(*UpdateMessageRequest)(nil),              // 15: google.chat.v1.UpdateMessageRequest
	(*CreateMessageRequest)(nil),              // 16: google.chat.v1.CreateMessageRequest
	(*CreateMessageNotificationOptions)(nil),  // 17: google.chat.v1.CreateMessageNotificationOptions
	(*ListMessagesRequest)(nil),               // 18: google.chat.v1.ListMessagesRequest
	(*ListMessagesResponse)(nil),              // 19: google.chat.v1.ListMessagesResponse
	(*DialogAction)(nil),                      // 20: google.chat.v1.DialogAction
	(*Dialog)(nil),                            // 21: google.chat.v1.Dialog
	(*CardWithId)(nil),                        // 22: google.chat.v1.CardWithId
	(*SearchMessagesRequest)(nil),             // 23: google.chat.v1.SearchMessagesRequest
	(*SearchMessagesResponse)(nil),            // 24: google.chat.v1.SearchMessagesResponse
	(*SearchMessageResult)(nil),               // 25: google.chat.v1.SearchMessageResult
	(*ActionResponse_SelectionItems)(nil),     // 26: google.chat.v1.ActionResponse.SelectionItems
	(*ActionResponse_UpdatedWidget)(nil),      // 27: google.chat.v1.ActionResponse.UpdatedWidget
	(*User)(nil),                              // 28: google.chat.v1.User
	(*timestamppb.Timestamp)(nil),             // 29: google.protobuf.Timestamp
	(*ContextualAddOnMarkup_Card)(nil),        // 30: google.chat.v1.ContextualAddOnMarkup.Card
	(*Annotation)(nil),                        // 31: google.chat.v1.Annotation
	(*Space)(nil),                             // 32: google.chat.v1.Space
	(*SlashCommand)(nil),                      // 33: google.chat.v1.SlashCommand
...
var file_google_chat_v1_message_proto_depIdxs = []int32{
	...
	29, // 1: google.chat.v1.Message.create_time:type_name -> google.protobuf.Timestamp
	29, // 2: google.chat.v1.Message.last_update_time:type_name -> google.protobuf.Timestamp
	29, // 3: google.chat.v1.Message.delete_time:type_name -> google.protobuf.Timestamp
	30, // 4: google.chat.v1.Message.cards:type_name -> google.chat.v1.ContextualAddOnMarkup.Card
	22, // 5: google.chat.v1.Message.cards_v2:type_name -> google.chat.v1.CardWithId
	31, // 6: google.chat.v1.Message.annotations:type_name -> google.chat.v1.Annotation
	10, // 7: google.chat.v1.Message.thread:type_name -> google.chat.v1.Thread
	32, // 8: google.chat.v1.Message.space:type_name -> google.chat.v1.Space
	11, // 9: google.chat.v1.Message.action_response:type_name -> google.chat.v1.ActionResponse
	33, // 10: google.chat.v1.Message.slash_command:type_name -> google.chat.v1.SlashCommand
	34, // 11: google.chat.v1.Message.attachment:type_name -> google.chat.v1.Attachment
	35, // 12: google.chat.v1.Message.matched_url:type_name -> google.chat.v1.MatchedUrl
	36, // 13: google.chat.v1.Message.emoji_reaction_summaries:type_name -> google.chat.v1.EmojiReactionSummary
	28, // 14: google.chat.v1.Message.private_message_viewer:type_name -> google.chat.v1.User
	37, // 15: google.chat.v1.Message.deletion_metadata:type_name -> google.chat.v1.DeletionMetadata
...
func file_google_chat_v1_message_proto_init() {
	...
	file_google_chat_v1_message_proto_msgTypes[15].OneofWrappers = []any{
		(*DialogAction_Dialog)(nil),
	}
	file_google_chat_v1_message_proto_msgTypes[20].OneofWrappers = []any{}
	file_google_chat_v1_message_proto_msgTypes[22].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_chat_v1_message_proto_rawDesc), len(file_google_chat_v1_message_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   23,
			NumExtensions: 0,
			NumServices:   0,
