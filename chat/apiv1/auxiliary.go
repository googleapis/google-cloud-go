...
// All returns an iterator. If an error is returned by the iterator, the
// iterator will stop after that iteration.
func (it *MessagePinIterator) All() iter.Seq2[*chatpb.MessagePin, error] {
	return gaxiter.RangeAdapter(it.Next)
}

// MessagePinIterator manages a stream of *chatpb.MessagePin.
type MessagePinIterator struct {
	items    []*chatpb.MessagePin
	pageInfo *iterator.PageInfo
	nextFunc func() error
	...
	// The number of results is no greater than pageSize.
	// If there are no more results, nextPageToken is empty and err is nil.
	InternalFetch func(pageSize int, pageToken string) (results []*chatpb.MessagePin, nextPageToken string, err error)
}

// PageInfo supports pagination. See the [google.golang.org/api/iterator] package for details.
func (it *MessagePinIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *MessagePinIterator) Next() (*chatpb.MessagePin, error) {
	var item *chatpb.MessagePin
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *MessagePinIterator) bufLen() int {
	return len(it.items)
}

func (it *MessagePinIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type SearchMessageResultIterator struct {
	...
	// The number of results is no greater than pageSize.
	// If there are no more results, nextPageToken is empty and err is nil.
	InternalFetch func(pageSize int, pageToken string) (results []*chatpb.SearchMessageResult, nextPageToken string, err error)
}

// PageInfo supports pagination. See the [google.golang.org/api/iterator] package for details.
func (it *SearchMessageResultIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *SearchMessageResultIterator) Next() (*chatpb.SearchMessageResult, error) {
	var item *chatpb.SearchMessageResult
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *SearchMessageResultIterator) bufLen() int {
	return len(it.items)
}

func (it *SearchMessageResultIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type SectionItemIterator struct {
	items    []*chatpb.SectionItem
	pageInfo *iterator.PageInfo
	nextFunc func() error
	...
	// The number of results is no greater than pageSize.
	// If there are no more results, nextPageToken is empty and err is nil.
	InternalFetch func(pageSize int, pageToken string) (results []*chatpb.SectionItem, nextPageToken string, err error)
}

// PageInfo supports pagination. See the [google.golang.org/api/iterator] package for details.
func (it *SectionItemIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *SectionItemIterator) Next() (*chatpb.SectionItem, error) {
	var item *chatpb.SectionItem
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *SectionItemIterator) bufLen() int {
	return len(it.items)
}

func (it *SectionItemIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type SectionIterator struct {
	...
	// The number of results is no greater than pageSize.
	// If there are no more results, nextPageToken is empty and err is nil.
	InternalFetch func(pageSize int, pageToken string) (results []*chatpb.Section, nextPageToken string, err error)
}

// PageInfo supports pagination. See the [google.golang.org/api/iterator] package for details.
func (it *SectionIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *SectionIterator) Next() (*chatpb.Section, error) {
	var item *chatpb.Section
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *SectionIterator) bufLen() int {
	return len(it.items)
}

func (it *SectionIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
