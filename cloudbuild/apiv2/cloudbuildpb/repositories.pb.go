...
func file_google_devtools_cloudbuild_v2_repositories_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_devtools_cloudbuild_v2_repositories_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_devtools_cloudbuild_v2_repositories_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
