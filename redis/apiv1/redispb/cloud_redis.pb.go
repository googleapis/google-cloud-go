...
func file_google_cloud_redis_v1_cloud_redis_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_redis_v1_cloud_redis_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_redis_v1_cloud_redis_proto_msgTypes[17].OneofWrappers = []interface{}{
		(*InputConfig_GcsSource)(nil),
	}
	file_google_cloud_redis_v1_cloud_redis_proto_msgTypes[20].OneofWrappers = []interface{}{
