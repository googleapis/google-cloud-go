...
const file_google_cloud_documentai_v1_barcode_proto_rawDesc = "" +
	"\n" +
	"(google/cloud/documentai/v1/barcode.proto\x12\x1agoogle.cloud.documentai.v1\"a\n" +
	"\aBarcode\x12\x16\n" +
	"\x06format\x18\x01 \x01(\tR\x06format\x12!\n" +
	"\fvalue_format\x18\x02 \x01(\tR\vvalueFormat\x12\x1b\n" +
	"\traw_value\x18\x03 \x01(\tR\brawValueB\xca\x01\n" +
	"\x1ecom.google.cloud.documentai.v1B\fBarcodeProtoP\x01Z>cloud.google.com/go/documentai/apiv1/documentaipb;documentaipb\xaa\x02\x1aGoogle.Cloud.DocumentAI.V1\xca\x02\x1aGoogle\\Cloud\\DocumentAI\\V1\xea\x02\x1dGoogle::Cloud::DocumentAI::V1b\x06proto3"

var (
	file_google_cloud_documentai_v1_barcode_proto_rawDescOnce sync.Once
	file_google_cloud_documentai_v1_barcode_proto_rawDescData []byte
)
...
func file_google_cloud_documentai_v1_barcode_proto_rawDescGZIP() []byte {
	file_google_cloud_documentai_v1_barcode_proto_rawDescOnce.Do(func() {
		file_google_cloud_documentai_v1_barcode_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_documentai_v1_barcode_proto_rawDesc), len(file_google_cloud_documentai_v1_barcode_proto_rawDesc)))
	})
...
var file_google_cloud_documentai_v1_barcode_proto_goTypes = []any{
...
func file_google_cloud_documentai_v1_barcode_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_documentai_v1_barcode_proto_rawDesc), len(file_google_cloud_documentai_v1_barcode_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
