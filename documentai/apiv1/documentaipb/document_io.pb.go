...
const file_google_cloud_documentai_v1_document_io_proto_rawDesc = "" +
	"\n" +
	...
	"\fGcsDocuments\x12E\n" +
	"\tdocuments\x18\x01 \x03(\v2'.google.cloud.documentai.v1.GcsDocumentR\tdocuments\"1\n" +
	"\tGcsPrefix\x12$\n" +
	"\x0egcs_uri_prefix\x18\x01 \x01(\tR\fgcsUriPrefix\"\xbe\x01\n" +
	"\x19BatchDocumentsInputConfig\x12F\n" +
	"\n" +
	"gcs_prefix\x18\x01 \x01(\v2%.google.cloud.documentai.v1.GcsPrefixH\x00R\tgcsPrefix\x12O\n" +
	"\rgcs_documents\x18\x02 \x01(\v2(.google.cloud.documentai.v1.GcsDocumentsH\x00R\fgcsDocumentsB\b\n" +
	"\x06source\"\xd6\x03\n" +
	"\x14DocumentOutputConfig\x12n\n" +
	"\x11gcs_output_config\x18\x01 \x01(\v2@.google.cloud.documentai.v1.DocumentOutputConfig.GcsOutputConfigH\x00R\x0fgcsOutputConfig\x1a\xbe\x02\n" +
	"\x0fGcsOutputConfig\x12\x17\n" +
	"\agcs_uri\x18\x01 \x01(\tR\x06gcsUri\x129\n" +
	"\n" +
	"field_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\tfieldMask\x12x\n" +
	"\x0fsharding_config\x18\x03 \x01(\v2O.google.cloud.documentai.v1.DocumentOutputConfig.GcsOutputConfig.ShardingConfigR\x0eshardingConfig\x1a]\n" +
	...
	"\vdestination\"\xdf\x05\n" +
	"\tOcrConfig\x12A\n" +
	"\x05hints\x18\x02 \x01(\v2+.google.cloud.documentai.v1.OcrConfig.HintsR\x05hints\x129\n" +
	...
	" \x01(\bR\x1edisableCharacterBoxesDetection\x12`\n" +
	"\x10premium_features\x18\v \x01(\v25.google.cloud.documentai.v1.OcrConfig.PremiumFeaturesR\x0fpremiumFeatures\x1a.\n" +
	"\x05Hints\x12%\n" +
	...
	"\x0fenable_math_ocr\x18\x05 \x01(\bR\renableMathOcrB\xcd\x01\n" +
...
var (
	...
	file_google_cloud_documentai_v1_document_io_proto_rawDescData []byte
)
...
func file_google_cloud_documentai_v1_document_io_proto_rawDescGZIP() []byte {
	file_google_cloud_documentai_v1_document_io_proto_rawDescOnce.Do(func() {
		file_google_cloud_documentai_v1_document_io_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_documentai_v1_document_io_proto_rawDesc), len(file_google_cloud_documentai_v1_document_io_proto_rawDesc)))
	})
...
func file_google_cloud_documentai_v1_document_io_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_documentai_v1_document_io_proto_rawDesc), len(file_google_cloud_documentai_v1_document_io_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
