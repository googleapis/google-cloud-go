...
func file_google_cloud_documentai_v1_document_processor_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_documentai_v1_document_processor_service_proto_msgTypes[58].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_documentai_v1_document_processor_service_proto_msgTypes[59].Exporter = func(v interface{}, i int) interface{} {
