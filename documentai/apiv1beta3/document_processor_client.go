...
func NewDocumentProcessorClient(ctx context.Context, opts ...option.ClientOption) (*DocumentProcessorClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.ImportProcessorVersion = append(client.CallOptions.ImportProcessorVersion, gax.WithClientMetrics(metrics))
...
func NewDocumentProcessorRESTClient(ctx context.Context, opts ...option.ClientOption) (*DocumentProcessorClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.ImportProcessorVersion = append(callOpts.ImportProcessorVersion, gax.WithClientMetrics(metrics))
...
func (c *documentProcessorGRPCClient) ImportProcessorVersion(ctx context.Context, req *documentaipb.ImportProcessorVersionRequest, opts ...gax.CallOption) (*ImportProcessorVersionOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.documentProcessorClient.ImportProcessorVersion, req, settings.GRPC, c.logger, "ImportProcessorVersion")
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	lro := longrunning.InternalNewOperationWithMetadata(*c.LROClient, resp, "*documentai.ImportProcessorVersionOperation")
	if gax.IsFeatureEnabled("TRACING") {
		lro.SetParentSpanContext(trace.SpanContextFromContext(ctx))
	}
...
func (c *documentProcessorRESTClient) ImportProcessorVersion(ctx context.Context, req *documentaipb.ImportProcessorVersionRequest, opts ...gax.CallOption) (*ImportProcessorVersionOperation, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "ImportProcessorVersion")
		if err != nil {
			return err
		}
		if err := unm.Unmarshal(buf, resp); err != nil {
...
func (c *documentProcessorGRPCClient) ImportProcessorVersionOperation(name string) *ImportProcessorVersionOperation {
	return &ImportProcessorVersionOperation{
		lro: longrunning.InternalNewOperationWithMetadata(*c.LROClient, &longrunningpb.Operation{Name: name}, "*documentai.ImportProcessorVersionOperation"),
	}
}
