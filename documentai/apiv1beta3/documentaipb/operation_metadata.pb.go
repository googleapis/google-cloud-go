...
const file_google_cloud_documentai_v1beta3_operation_metadata_proto_rawDesc = "" +
	"\n" +
	"8google/cloud/documentai/v1beta3/operation_metadata.proto\x12\x1fgoogle.cloud.documentai.v1beta3\x1a\x1fgoogle/protobuf/timestamp.proto\"\x91\x03\n" +
	"\x17CommonOperationMetadata\x12T\n" +
	"\x05state\x18\x01 \x01(\x0e2>.google.cloud.documentai.v1beta3.CommonOperationMetadata.StateR\x05state\x12#\n" +
...
var (
	...
	file_google_cloud_documentai_v1beta3_operation_metadata_proto_rawDescData []byte
)
...
func file_google_cloud_documentai_v1beta3_operation_metadata_proto_rawDescGZIP() []byte {
	file_google_cloud_documentai_v1beta3_operation_metadata_proto_rawDescOnce.Do(func() {
		file_google_cloud_documentai_v1beta3_operation_metadata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_documentai_v1beta3_operation_metadata_proto_rawDesc), len(file_google_cloud_documentai_v1beta3_operation_metadata_proto_rawDesc)))
	})
...
func file_google_cloud_documentai_v1beta3_operation_metadata_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_documentai_v1beta3_operation_metadata_proto_rawDesc), len(file_google_cloud_documentai_v1beta3_operation_metadata_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
