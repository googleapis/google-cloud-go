...
func file_google_cloud_documentai_v1beta3_processor_type_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_documentai_v1beta3_processor_type_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_documentai_v1beta3_processor_type_proto_msgTypes[1].Exporter = func(v any, i int) any {
