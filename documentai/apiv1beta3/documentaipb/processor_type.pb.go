...
const file_google_cloud_documentai_v1beta3_processor_type_proto_rawDesc = "" +
	"\n" +
	"4google/cloud/documentai/v1beta3/processor_type.proto\x12\x1fgoogle.cloud.documentai.v1beta3\x1a\x1dgoogle/api/launch_stage.proto\x1a\x19google/api/resource.proto\"\xfe\x03\n" +
	"\rProcessorType\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x1a\n" +
	"\bcategory\x18\x03 \x01(\tR\bcategory\x12l\n" +
	"\x13available_locations\x18\x04 \x03(\v2;.google.cloud.documentai.v1beta3.ProcessorType.LocationInfoR\x12availableLocations\x12%\n" +
...
var (
	...
	file_google_cloud_documentai_v1beta3_processor_type_proto_rawDescData []byte
)
...
func file_google_cloud_documentai_v1beta3_processor_type_proto_rawDescGZIP() []byte {
	file_google_cloud_documentai_v1beta3_processor_type_proto_rawDescOnce.Do(func() {
		file_google_cloud_documentai_v1beta3_processor_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_documentai_v1beta3_processor_type_proto_rawDesc), len(file_google_cloud_documentai_v1beta3_processor_type_proto_rawDesc)))
	})
...
var file_google_cloud_documentai_v1beta3_processor_type_proto_goTypes = []any{
...
func file_google_cloud_documentai_v1beta3_processor_type_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_documentai_v1beta3_processor_type_proto_rawDesc), len(file_google_cloud_documentai_v1beta3_processor_type_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
