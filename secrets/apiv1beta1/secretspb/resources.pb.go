...
var file_google_cloud_secrets_v1beta1_resources_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0xf1, 0x01, 0x0a, 0x26, 0x63,
	...
	0x72, 0x65, 0x74, 0x73, 0x2f, 0x61, 0x70, 0x69, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f,
	0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x70, 0x62, 0x3b, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74,
	0x73, 0x70, 0x62, 0xf8, 0x01, 0x01, 0xa2, 0x02, 0x03, 0x47, 0x53, 0x4d, 0xaa, 0x02, 0x22, 0x47,
...
var file_google_cloud_secrets_v1beta1_resources_proto_goTypes = []any{
...
func file_google_cloud_secrets_v1beta1_resources_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_secrets_v1beta1_resources_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Secret); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_cloud_secrets_v1beta1_resources_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_secrets_v1beta1_resources_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_secrets_v1beta1_resources_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_cloud_secrets_v1beta1_resources_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_google_cloud_secrets_v1beta1_resources_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_google_cloud_secrets_v1beta1_resources_proto_msgTypes[7].Exporter = func(v any, i int) any {
	...
	file_google_cloud_secrets_v1beta1_resources_proto_msgTypes[2].OneofWrappers = []any{
