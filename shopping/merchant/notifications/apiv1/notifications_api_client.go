...
type NotificationsApiCallOptions struct {
	...
	GetNotificationSubscriptionHealthMetrics []gax.CallOption
}
...
type internalNotificationsApiClient interface {
	...
	GetNotificationSubscriptionHealthMetrics(context.Context, *notificationspb.GetNotificationSubscriptionHealthMetricsRequest, ...gax.CallOption) (*notificationspb.NotificationSubscriptionHealthMetrics, error)
}
...
// GetNotificationSubscriptionHealthMetrics retrieves notification subscription health metrics for a merchant.
// We recommend calling this periodically (hourly or daily) to monitor health
// of your callback endpoint.
func (c *NotificationsApiClient) GetNotificationSubscriptionHealthMetrics(ctx context.Context, req *notificationspb.GetNotificationSubscriptionHealthMetricsRequest, opts ...gax.CallOption) (*notificationspb.NotificationSubscriptionHealthMetrics, error) {
	return c.internalClient.GetNotificationSubscriptionHealthMetrics(ctx, req, opts...)
}
...
func NewNotificationsApiClient(ctx context.Context, opts ...option.ClientOption) (*NotificationsApiClient, error) {
	...
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		clientOpts = append(clientOpts, internaloption.WithTelemetryAttributes(map[string]string{
			...
			"gcp.client.artifact": "cloud.google.com/go/shopping/merchant/notifications/apiv1",
...
func (c *notificationsApiGRPCClient) UpdateNotificationSubscription(ctx context.Context, req *notificationspb.UpdateNotificationSubscriptionRequest, opts ...gax.CallOption) (*notificationspb.NotificationSubscription, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.notifications.v1.NotificationsApiService/UpdateNotificationSubscription")
	}
...
func (c *notificationsApiGRPCClient) GetNotificationSubscriptionHealthMetrics(ctx context.Context, req *notificationspb.GetNotificationSubscriptionHealthMetricsRequest, opts ...gax.CallOption) (*notificationspb.NotificationSubscriptionHealthMetrics, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
	...
	opts = append((*c.CallOptions).GetNotificationSubscriptionHealthMetrics[0:len((*c.CallOptions).GetNotificationSubscriptionHealthMetrics):len((*c.CallOptions).GetNotificationSubscriptionHealthMetrics)], opts...)
	var resp *notificationspb.NotificationSubscriptionHealthMetrics
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.notificationsApiClient.GetNotificationSubscriptionHealthMetrics, req, settings.GRPC, c.logger, "GetNotificationSubscriptionHealthMetrics")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *notificationsApiRESTClient) GetNotificationSubscription(ctx context.Context, req *notificationspb.GetNotificationSubscriptionRequest, opts ...gax.CallOption) (*notificationspb.NotificationSubscription, error) {
	...
	baseUrl.Path += fmt.Sprintf("/notifications/v1/%v", req.GetName())
...
func (c *notificationsApiRESTClient) CreateNotificationSubscription(ctx context.Context, req *notificationspb.CreateNotificationSubscriptionRequest, opts ...gax.CallOption) (*notificationspb.NotificationSubscription, error) {
	...
	baseUrl.Path += fmt.Sprintf("/notifications/v1/%v/notificationsubscriptions", req.GetParent())
...
func (c *notificationsApiRESTClient) UpdateNotificationSubscription(ctx context.Context, req *notificationspb.UpdateNotificationSubscriptionRequest, opts ...gax.CallOption) (*notificationspb.NotificationSubscription, error) {
	...
	baseUrl.Path += fmt.Sprintf("/notifications/v1/%v", req.GetNotificationSubscription().GetName())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.notifications.v1.NotificationsApiService/UpdateNotificationSubscription")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/notifications/v1/{notification_subscription.name=accounts/*/notificationsubscriptions/*}")
	}
	opts = append((*c.CallOptions).UpdateNotificationSubscription[0:len((*c.CallOptions).UpdateNotificationSubscription):len((*c.CallOptions).UpdateNotificationSubscription)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &notificationspb.NotificationSubscription{}
...
// We recommend calling this periodically (hourly or daily) to monitor health
// of your callback endpoint.
func (c *notificationsApiRESTClient) GetNotificationSubscriptionHealthMetrics(ctx context.Context, req *notificationspb.GetNotificationSubscriptionHealthMetricsRequest, opts ...gax.CallOption) (*notificationspb.NotificationSubscriptionHealthMetrics, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	baseUrl.Path += fmt.Sprintf("/notifications/v1/%v:getHealth", req.GetName())
	...
	opts = append((*c.CallOptions).GetNotificationSubscriptionHealthMetrics[0:len((*c.CallOptions).GetNotificationSubscriptionHealthMetrics):len((*c.CallOptions).GetNotificationSubscriptionHealthMetrics)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &notificationspb.NotificationSubscriptionHealthMetrics{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "GetNotificationSubscriptionHealthMetrics")
		if err != nil {
			return err
		}
