...
type internalClient interface {
	...
	ListQuotaGroups(context.Context, *quotapb.ListQuotaGroupsRequest, ...gax.CallOption) *QuotaGroupIterator
}
...
// ListQuotaGroups lists the daily call quota and usage per group for your Merchant
// Center account.
...
// NewClient creates a new quota service client based on gRPC.
...
func NewClient(ctx context.Context, opts ...option.ClientOption) (*Client, error) {
	...
	c := &gRPCClient{
		connPool:    connPool,
		client:      quotapb.NewQuotaServiceClient(connPool),
...
func (c *gRPCClient) ListQuotaGroups(ctx context.Context, req *quotapb.ListQuotaGroupsRequest, opts ...gax.CallOption) *QuotaGroupIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.quota.v1.QuotaService/ListQuotaGroups")
	}
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*quotapb.QuotaGroup, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.client.ListQuotaGroups, req, settings.GRPC, c.logger, "ListQuotaGroups")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *restClient) ListQuotaGroups(ctx context.Context, req *quotapb.ListQuotaGroupsRequest, opts ...gax.CallOption) *QuotaGroupIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*quotapb.QuotaGroup, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/quota/v1/%v/quotas", req.GetParent())
