...
import (
	...
	quota "cloud.google.com/go/shopping/merchant/quota/apiv1beta"
...
func ExampleClient_ListQuotaGroups() {
	ctx := context.Background()
	// This snippet has been automatically generated and should be regarded as a code template only.
	// It will require modifications to work:
	// - It may require correct/in-range values for request initialization.
	...
	req := &quotapb.ListQuotaGroupsRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/shopping/merchant/quota/apiv1beta/quotapb#ListQuotaGroupsRequest.
	}
