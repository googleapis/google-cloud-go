...
func (x *RenderedIssue) GetPrerenderedContent() string {
	if x != nil {
		if x, ok := x.Content.(*RenderedIssue_PrerenderedContent); ok {
...
func (x *RenderedIssue) GetOutOfCourtDisputeSettlement() isRenderedIssue_OutOfCourtDisputeSettlement {
	if x != nil {
		return x.OutOfCourtDisputeSettlement
	}
	return nil
}
...
func (x *RenderedIssue) GetPrerenderedOutOfCourtDisputeSettlement() string {
	if x != nil {
		if x, ok := x.OutOfCourtDisputeSettlement.(*RenderedIssue_PrerenderedOutOfCourtDisputeSettlement); ok {
...
func (x *Action) GetBuiltinSimpleAction() *BuiltInSimpleAction {
	if x != nil {
		if x, ok := x.Action.(*Action_BuiltinSimpleAction); ok {
...
func (x *Action) GetExternalAction() *ExternalAction {
	if x != nil {
		if x, ok := x.Action.(*Action_ExternalAction); ok {
...
func (x *Action) GetBuiltinUserInputAction() *BuiltInUserInputAction {
	if x != nil {
		if x, ok := x.Action.(*Action_BuiltinUserInputAction); ok {
...
func (x *InputField) GetTextInput() *InputField_TextInput {
	if x != nil {
		if x, ok := x.ValueInput.(*InputField_TextInput_); ok {
			return x.TextInput
		}
	}
	return nil
...
func (x *InputField) GetChoiceInput() *InputField_ChoiceInput {
	if x != nil {
		if x, ok := x.ValueInput.(*InputField_ChoiceInput_); ok {
...
func (x *InputField) GetCheckboxInput() *InputField_CheckboxInput {
	if x != nil {
		if x, ok := x.ValueInput.(*InputField_CheckboxInput_); ok {
...
func (x *TextWithTooltip) GetSimpleValue() string {
	if x != nil {
		if x, ok := x.Value.(*TextWithTooltip_SimpleValue); ok {
...
func (x *TextWithTooltip) GetSimpleTooltipValue() string {
	if x != nil {
		if x, ok := x.TooltipValue.(*TextWithTooltip_SimpleTooltipValue); ok {
...
func (x *InputValue) GetTextInputValue() *InputValue_TextInputValue {
	if x != nil {
		if x, ok := x.Value.(*InputValue_TextInputValue_); ok {
...
func (x *InputValue) GetChoiceInputValue() *InputValue_ChoiceInputValue {
	if x != nil {
		if x, ok := x.Value.(*InputValue_ChoiceInputValue_); ok {
...
func (x *InputValue) GetCheckboxInputValue() *InputValue_CheckboxInputValue {
	if x != nil {
		if x, ok := x.Value.(*InputValue_CheckboxInputValue_); ok {
...
const file_google_shopping_merchant_issueresolution_v1beta_issueresolution_proto_rawDesc = "" +
	"\n" +
	"Egoogle/shopping/merchant/issueresolution/v1beta/issueresolution.proto\x12/google.shopping.merchant.issueresolution.v1beta\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\x86\x01\n" +
	"\x1bRenderAccountIssuesResponse\x12g\n" +
	"\x0frendered_issues\x18\x01 \x03(\v2>.google.shopping.merchant.issueresolution.v1beta.RenderedIssueR\x0erenderedIssues\"\x94\x02\n" +
	"\x1aRenderAccountIssuesRequest\x12>\n" +
	"\x04name\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\n" +
	"\"merchantapi.googleapis.com/AccountR\x04name\x12(\n" +
	"\rlanguage_code\x18\x02 \x01(\tB\x03\xe0A\x01R\flanguageCode\x12 \n" +
	"\ttime_zone\x18\x03 \x01(\tB\x03\xe0A\x01R\btimeZone\x12j\n" +
	"\apayload\x18\x04 \x01(\v2K.google.shopping.merchant.issueresolution.v1beta.RenderIssuesRequestPayloadB\x03\xe0A\x01R\apayload\"\xd2\x02\n" +
	"\x1aRenderIssuesRequestPayload\x12o\n" +
	"\x0econtent_option\x18\x01 \x01(\x0e2>.google.shopping.merchant.issueresolution.v1beta.ContentOptionB\x03\xe0A\x01H\x00R\rcontentOption\x88\x01\x01\x12\x92\x01\n" +
	"\x18user_input_action_option\x18\x02 \x01(\x0e2O.google.shopping.merchant.issueresolution.v1beta.UserInputActionRenderingOptionB\x03\xe0A\x01H\x01R\x15userInputActionOption\x88\x01\x01B\x11\n" +
	"\x0f_content_optionB\x1b\n" +
	"\x19_user_input_action_option\"\x86\x01\n" +
	"\x1bRenderProductIssuesResponse\x12g\n" +
	"\x0frendered_issues\x18\x01 \x03(\v2>.google.shopping.merchant.issueresolution.v1beta.RenderedIssueR\x0erenderedIssues\"\x94\x02\n" +
	"\x1aRenderProductIssuesRequest\x12>\n" +
	"\x04name\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\n" +
	"\"merchantapi.googleapis.com/ProductR\x04name\x12(\n" +
	"\rlanguage_code\x18\x02 \x01(\tB\x03\xe0A\x01R\flanguageCode\x12 \n" +
	"\ttime_zone\x18\x03 \x01(\tB\x03\xe0A\x01R\btimeZone\x12j\n" +
	"\apayload\x18\x04 \x01(\v2K.google.shopping.merchant.issueresolution.v1beta.RenderIssuesRequestPayloadB\x03\xe0A\x01R\apayload\"\x89\x03\n" +
	"\rRenderedIssue\x121\n" +
	"\x13prerendered_content\x18\x03 \x01(\tH\x00R\x12prerenderedContent\x12]\n" +
	"+prerendered_out_of_court_dispute_settlement\x18\x05 \x01(\tH\x01R&prerenderedOutOfCourtDisputeSettlement\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12O\n" +
	"\x06impact\x18\x02 \x01(\v27.google.shopping.merchant.issueresolution.v1beta.ImpactR\x06impact\x12Q\n" +
	"\aactions\x18\x04 \x03(\v27.google.shopping.merchant.issueresolution.v1beta.ActionR\aactionsB\t\n" +
	"\acontentB!\n" +
	"\x1fout_of_court_dispute_settlement\"\xda\x01\n" +
	"\x06Impact\x12\x1d\n" +
	"\amessage\x18\x01 \x01(\tB\x03\xe0A\x01R\amessage\x12U\n" +
	"\bseverity\x18\x02 \x01(\x0e29.google.shopping.merchant.issueresolution.v1beta.SeverityR\bseverity\x12Z\n" +
	"\n" +
	"breakdowns\x18\x03 \x03(\v2:.google.shopping.merchant.issueresolution.v1beta.BreakdownR\n" +
	"breakdowns\"\xb4\x01\n" +
	"\tBreakdown\x12[\n" +
	"\aregions\x18\x01 \x03(\v2A.google.shopping.merchant.issueresolution.v1beta.Breakdown.RegionR\aregions\x12\x18\n" +
	"\adetails\x18\x04 \x03(\tR\adetails\x1a0\n" +
	"\x06Region\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"\xd4\x05\n" +
	"\x06Action\x12z\n" +
	"\x15builtin_simple_action\x18\x02 \x01(\v2D.google.shopping.merchant.issueresolution.v1beta.BuiltInSimpleActionH\x00R\x13builtinSimpleAction\x12j\n" +
	"\x0fexternal_action\x18\x03 \x01(\v2?.google.shopping.merchant.issueresolution.v1beta.ExternalActionH\x00R\x0eexternalAction\x12\x84\x01\n" +
	"\x19builtin_user_input_action\x18\a \x01(\v2G.google.shopping.merchant.issueresolution.v1beta.BuiltInUserInputActionH\x00R\x16builtinUserInputAction\x12!\n" +
	"\fbutton_label\x18\x04 \x01(\tR\vbuttonLabel\x12!\n" +
	"\fis_available\x18\x05 \x01(\bR\visAvailable\x12X\n" +
	"\areasons\x18\x06 \x03(\v2>.google.shopping.merchant.issueresolution.v1beta.Action.ReasonR\areasons\x1a\xb0\x01\n" +
	"\x06Reason\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12\x1b\n" +
	"\x06detail\x18\x02 \x01(\tH\x00R\x06detail\x88\x01\x01\x12Y\n" +
	"\x06action\x18\x03 \x01(\v27.google.shopping.merchant.issueresolution.v1beta.ActionB\x03\xe0A\x01H\x01R\x06action\x88\x01\x01B\t\n" +
	"\a_detailB\t\n" +
	"\a_actionB\b\n" +
	"\x06action\"\xd4\x05\n" +
	"\x13BuiltInSimpleAction\x12p\n" +
	"\x04type\x18\x01 \x01(\x0e2\\.google.shopping.merchant.issueresolution.v1beta.BuiltInSimpleAction.BuiltInSimpleActionTypeR\x04type\x12*\n" +
	"\x0eattribute_code\x18\x02 \x01(\tH\x00R\rattributeCode\x88\x01\x01\x12\x8a\x01\n" +
	"\x12additional_content\x18\x03 \x01(\v2V.google.shopping.merchant.issueresolution.v1beta.BuiltInSimpleAction.AdditionalContentH\x01R\x11additionalContent\x88\x01\x01\x1aI\n" +
	"\x11AdditionalContent\x12\x14\n" +
	...
	"\fVERIFY_PHONE\x10\x01\x12\x11\n" +
	"\rCLAIM_WEBSITE\x10\x02\x12\x10\n" +
	"\fADD_PRODUCTS\x10\x03\x12\x14\n" +
	"\x10ADD_CONTACT_INFO\x10\x04\x12\x14\n" +
	"\x10LINK_ADS_ACCOUNT\x10\x05\x12$\n" +
	" ADD_BUSINESS_REGISTRATION_NUMBER\x10\x06\x12\x17\n" +
	"\x13EDIT_ITEM_ATTRIBUTE\x10\a\x12\x15\n" +
	"\x11FIX_ACCOUNT_ISSUE\x10\b\x12\x1b\n" +
	"\x17SHOW_ADDITIONAL_CONTENT\x10\tB\x11\n" +
	"\x0f_attribute_codeB\x15\n" +
	"\x13_additional_content\"\x92\x01\n" +
	"\x16BuiltInUserInputAction\x12%\n" +
	"\x0eaction_context\x18\x01 \x01(\tR\ractionContext\x12Q\n" +
	"\x05flows\x18\x03 \x03(\v2;.google.shopping.merchant.issueresolution.v1beta.ActionFlowR\x05flows\"\xd4\x03\n" +
	"\n" +
	"ActionFlow\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x12S\n" +
	"\x06inputs\x18\x03 \x03(\v2;.google.shopping.merchant.issueresolution.v1beta.InputFieldR\x06inputs\x12!\n" +
	"\fdialog_title\x18\x04 \x01(\tR\vdialogTitle\x12l\n" +
	"\x0edialog_message\x18\a \x01(\v2@.google.shopping.merchant.issueresolution.v1beta.TextWithTooltipH\x00R\rdialogMessage\x88\x01\x01\x12d\n" +
	"\x0edialog_callout\x18\b \x01(\v28.google.shopping.merchant.issueresolution.v1beta.CalloutH\x01R\rdialogCallout\x88\x01\x01\x12.\n" +
	"\x13dialog_button_label\x18\t \x01(\tR\x11dialogButtonLabelB\x11\n" +
	"\x0f_dialog_messageB\x11\n" +
	"\x0f_dialog_callout\"\xc4\n" +
	"\n" +
	"\n" +
	"InputField\x12f\n" +
	"\n" +
	"text_input\x18\x04 \x01(\v2E.google.shopping.merchant.issueresolution.v1beta.InputField.TextInputH\x00R\ttextInput\x12l\n" +
	"\fchoice_input\x18\x05 \x01(\v2G.google.shopping.merchant.issueresolution.v1beta.InputField.ChoiceInputH\x00R\vchoiceInput\x12r\n" +
	"\x0echeckbox_input\x18\x06 \x01(\v2I.google.shopping.merchant.issueresolution.v1beta.InputField.CheckboxInputH\x00R\rcheckboxInput\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12V\n" +
	"\x05label\x18\x02 \x01(\v2@.google.shopping.merchant.issueresolution.v1beta.TextWithTooltipR\x05label\x12\x1a\n" +
	"\brequired\x18\x03 \x01(\bR\brequired\x1a\xc2\x03\n" +
	"\tTextInput\x12g\n" +
	"\x04type\x18\x01 \x01(\x0e2S.google.shopping.merchant.issueresolution.v1beta.InputField.TextInput.TextInputTypeR\x04type\x12n\n" +
	"\x0fadditional_info\x18\x02 \x01(\v2@.google.shopping.merchant.issueresolution.v1beta.TextWithTooltipH\x00R\x0eadditionalInfo\x88\x01\x01\x12$\n" +
	"\vformat_info\x18\x03 \x01(\tH\x01R\n" +
	"formatInfo\x88\x01\x01\x12\"\n" +
	"\n" +
	"aria_label\x18\x04 \x01(\tH\x02R\tariaLabel\x88\x01\x01\"_\n" +
	...
	"\f_format_infoB\r\n" +
	"\v_aria_label\x1a\x82\x03\n" +
	"\vChoiceInput\x12s\n" +
	"\aoptions\x18\x01 \x03(\v2Y.google.shopping.merchant.issueresolution.v1beta.InputField.ChoiceInput.ChoiceInputOptionR\aoptions\x1a\xfd\x01\n" +
	"\x11ChoiceInputOption\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12V\n" +
	"\x05label\x18\x02 \x01(\v2@.google.shopping.merchant.issueresolution.v1beta.TextWithTooltipR\x05label\x12k\n" +
	"\x10additional_input\x18\x03 \x01(\v2;.google.shopping.merchant.issueresolution.v1beta.InputFieldH\x00R\x0fadditionalInput\x88\x01\x01B\x13\n" +
	"\x11_additional_input\x1a\x0f\n" +
	"\rCheckboxInputB\r\n" +
	"\vvalue_input\"\xd5\x02\n" +
	"\x0fTextWithTooltip\x12#\n" +
	"\fsimple_value\x18\x01 \x01(\tH\x00R\vsimpleValue\x122\n" +
	"\x14simple_tooltip_value\x18\x02 \x01(\tH\x01R\x12simpleTooltipValue\x12\x7f\n" +
	"\x12tooltip_icon_style\x18\x03 \x01(\x0e2Q.google.shopping.merchant.issueresolution.v1beta.TextWithTooltip.TooltipIconStyleR\x10tooltipIconStyle\"N\n" +
	"\x10TooltipIconStyle\x12\"\n" +
	"\x1eTOOLTIP_ICON_STYLE_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04INFO\x10\x01\x12\f\n" +
	"\bQUESTION\x10\x02B\a\n" +
	"\x05valueB\x0f\n" +
	"\rtooltip_value\"\xb2\x02\n" +
	"\aCallout\x12h\n" +
	"\n" +
	"style_hint\x18\x01 \x01(\x0e2I.google.shopping.merchant.issueresolution.v1beta.Callout.CalloutStyleHintR\tstyleHint\x12c\n" +
	"\ffull_message\x18\x03 \x01(\v2@.google.shopping.merchant.issueresolution.v1beta.TextWithTooltipR\vfullMessage\"X\n" +
	"\x10CalloutStyleHint\x12\"\n" +
	"\x1eCALLOUT_STYLE_HINT_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05ERROR\x10\x01\x12\v\n" +
	"\aWARNING\x10\x02\x12\b\n" +
	"\x04INFO\x10\x03\"\xea\x02\n" +
	"\x0eExternalAction\x12f\n" +
	"\x04type\x18\x01 \x01(\x0e2R.google.shopping.merchant.issueresolution.v1beta.ExternalAction.ExternalActionTypeR\x04type\x12\x10\n" +
	...
	"\"VERIFY_IDENTITY_IN_MERCHANT_CENTER\x10\x04\"\xe6\x01\n" +
	"\x14TriggerActionRequest\x12>\n" +
	"\x04name\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\n" +
	"\"merchantapi.googleapis.com/AccountR\x04name\x12d\n" +
	"\apayload\x18\x02 \x01(\v2E.google.shopping.merchant.issueresolution.v1beta.TriggerActionPayloadB\x03\xe0A\x02R\apayload\x12(\n" +
	"\rlanguage_code\x18\x03 \x01(\tB\x03\xe0A\x01R\flanguageCode\"\xa8\x01\n" +
	"\x14TriggerActionPayload\x12*\n" +
	"\x0eaction_context\x18\x01 \x01(\tB\x03\xe0A\x02R\ractionContext\x12d\n" +
	"\faction_input\x18\x02 \x01(\v2<.google.shopping.merchant.issueresolution.v1beta.ActionInputB\x03\xe0A\x02R\vactionInput\"1\n" +
	"\x15TriggerActionResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"\x9d\x01\n" +
	"\vActionInput\x12)\n" +
	"\x0eaction_flow_id\x18\x01 \x01(\tB\x03\xe0A\x02R\factionFlowId\x12c\n" +
	"\finput_values\x18\x02 \x03(\v2;.google.shopping.merchant.issueresolution.v1beta.InputValueB\x03\xe0A\x02R\vinputValues\"\xe7\x04\n" +
	"\n" +
	"InputValue\x12v\n" +
	"\x10text_input_value\x18\x02 \x01(\v2J.google.shopping.merchant.issueresolution.v1beta.InputValue.TextInputValueH\x00R\x0etextInputValue\x12|\n" +
	"\x12choice_input_value\x18\x03 \x01(\v2L.google.shopping.merchant.issueresolution.v1beta.InputValue.ChoiceInputValueH\x00R\x10choiceInputValue\x12\x82\x01\n" +
	"\x14checkbox_input_value\x18\x04 \x01(\v2N.google.shopping.merchant.issueresolution.v1beta.InputValue.CheckboxInputValueH\x00R\x12checkboxInputValue\x12)\n" +
	"\x0einput_field_id\x18\x01 \x01(\tB\x03\xe0A\x02R\finputFieldId\x1a+\n" +
	"\x0eTextInputValue\x12\x19\n" +
	"\x05value\x18\x01 \x01(\tB\x03\xe0A\x02R\x05value\x1aL\n" +
	"\x10ChoiceInputValue\x128\n" +
	"\x16choice_input_option_id\x18\x01 \x01(\tB\x03\xe0A\x02R\x13choiceInputOptionId\x1a/\n" +
	"\x12CheckboxInputValue\x12\x19\n" +
	"\x05value\x18\x01 \x01(\bB\x03\xe0A\x02R\x05valueB\a\n" +
	"\x05value*F\n" +
	"\bSeverity\x12\x18\n" +
	...
	"\x13RenderAccountIssues\x12K.google.shopping.merchant.issueresolution.v1beta.RenderAccountIssuesRequest\x1aL.google.shopping.merchant.issueresolution.v1beta.RenderAccountIssuesResponse\"U\xdaA\x04name\x82\xd3\xe4\x93\x02H:\apayload\"=/issueresolution/v1beta/{name=accounts/*}:renderaccountissues\x12\x92\x02\n" +
	"\x13RenderProductIssues\x12K.google.shopping.merchant.issueresolution.v1beta.RenderProductIssuesRequest\x1aL.google.shopping.merchant.issueresolution.v1beta.RenderProductIssuesResponse\"`\xdaA\x04name\x82\xd3\xe4\x93\x02S:\apayload\"H/issueresolution/v1beta/{name=accounts/*/products/*}:renderproductissues\x12\xef\x01\n" +
	"\rTriggerAction\x12E.google.shopping.merchant.issueresolution.v1beta.TriggerActionRequest\x1aF.google.shopping.merchant.issueresolution.v1beta.TriggerActionResponse\"O\xdaA\x04name\x82\xd3\xe4\x93\x02B:\apayload\"7/issueresolution/v1beta/{name=accounts/*}:triggeraction\x1aG\xcaA\x1amerchantapi.googleapis.com\xd2A'https://www.googleapis.com/auth/contentB\xd5\x03\xeaA8\n" +
...
var (
	...
	file_google_shopping_merchant_issueresolution_v1beta_issueresolution_proto_rawDescData []byte
)
...
func file_google_shopping_merchant_issueresolution_v1beta_issueresolution_proto_rawDescGZIP() []byte {
	file_google_shopping_merchant_issueresolution_v1beta_issueresolution_proto_rawDescOnce.Do(func() {
		file_google_shopping_merchant_issueresolution_v1beta_issueresolution_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_issueresolution_v1beta_issueresolution_proto_rawDesc), len(file_google_shopping_merchant_issueresolution_v1beta_issueresolution_proto_rawDesc)))
	})
...
func file_google_shopping_merchant_issueresolution_v1beta_issueresolution_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_issueresolution_v1beta_issueresolution_proto_rawDesc), len(file_google_shopping_merchant_issueresolution_v1beta_issueresolution_proto_rawDesc)),
			NumEnums:      8,
			NumMessages:   31,
			NumExtensions: 0,
			NumServices:   1,
