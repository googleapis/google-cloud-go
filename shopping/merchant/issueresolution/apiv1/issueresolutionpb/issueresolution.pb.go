...
const file_google_shopping_merchant_issueresolution_v1_issueresolution_proto_rawDesc = "" +
	"\n" +
	"Agoogle/shopping/merchant/issueresolution/v1/issueresolution.proto\x12+google.shopping.merchant.issueresolution.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\x82\x01\n" +
	"\x1bRenderAccountIssuesResponse\x12c\n" +
	"\x0frendered_issues\x18\x01 \x03(\v2:.google.shopping.merchant.issueresolution.v1.RenderedIssueR\x0erenderedIssues\"\x90\x02\n" +
	...
	"\ttime_zone\x18\x03 \x01(\tB\x03\xe0A\x01R\btimeZone\x12f\n" +
	"\apayload\x18\x04 \x01(\v2G.google.shopping.merchant.issueresolution.v1.RenderIssuesRequestPayloadB\x03\xe0A\x01R\apayload\"\xca\x02\n" +
	"\x1aRenderIssuesRequestPayload\x12k\n" +
	"\x0econtent_option\x18\x01 \x01(\x0e2:.google.shopping.merchant.issueresolution.v1.ContentOptionB\x03\xe0A\x01H\x00R\rcontentOption\x88\x01\x01\x12\x8e\x01\n" +
	"\x18user_input_action_option\x18\x02 \x01(\x0e2K.google.shopping.merchant.issueresolution.v1.UserInputActionRenderingOptionB\x03\xe0A\x01H\x01R\x15userInputActionOption\x88\x01\x01B\x11\n" +
	"\x0f_content_optionB\x1b\n" +
	"\x19_user_input_action_option\"\x82\x01\n" +
	"\x1bRenderProductIssuesResponse\x12c\n" +
	"\x0frendered_issues\x18\x01 \x03(\v2:.google.shopping.merchant.issueresolution.v1.RenderedIssueR\x0erenderedIssues\"\x90\x02\n" +
	...
	"\rlanguage_code\x18\x02 \x01(\tB\x03\xe0A\x01R\flanguageCode\x12 \n" +
	"\ttime_zone\x18\x03 \x01(\tB\x03\xe0A\x01R\btimeZone\x12f\n" +
	"\apayload\x18\x04 \x01(\v2G.google.shopping.merchant.issueresolution.v1.RenderIssuesRequestPayloadB\x03\xe0A\x01R\apayload\"\x81\x03\n" +
	"\rRenderedIssue\x121\n" +
	...
	"\x06impact\x18\x02 \x01(\v23.google.shopping.merchant.issueresolution.v1.ImpactR\x06impact\x12M\n" +
	"\aactions\x18\x04 \x03(\v23.google.shopping.merchant.issueresolution.v1.ActionR\aactionsB\t\n" +
	"\acontentB!\n" +
	"\x1fout_of_court_dispute_settlement\"\xd2\x01\n" +
	"\x06Impact\x12\x1d\n" +
	"\amessage\x18\x01 \x01(\tB\x03\xe0A\x01R\amessage\x12Q\n" +
	"\bseverity\x18\x02 \x01(\x0e25.google.shopping.merchant.issueresolution.v1.SeverityR\bseverity\x12V\n" +
	"\n" +
	"breakdowns\x18\x03 \x03(\v26.google.shopping.merchant.issueresolution.v1.BreakdownR\n" +
	"breakdowns\"\xb0\x01\n" +
	"\tBreakdown\x12W\n" +
	"\aregions\x18\x01 \x03(\v2=.google.shopping.merchant.issueresolution.v1.Breakdown.RegionR\aregions\x12\x18\n" +
	"\adetails\x18\x04 \x03(\tR\adetails\x1a0\n" +
	"\x06Region\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"\xc0\x05\n" +
	"\x06Action\x12v\n" +
	"\x15builtin_simple_action\x18\x02 \x01(\v2@.google.shopping.merchant.issueresolution.v1.BuiltInSimpleActionH\x00R\x13builtinSimpleAction\x12f\n" +
	"\x0fexternal_action\x18\x03 \x01(\v2;.google.shopping.merchant.issueresolution.v1.ExternalActionH\x00R\x0eexternalAction\x12\x80\x01\n" +
	"\x19builtin_user_input_action\x18\a \x01(\v2C.google.shopping.merchant.issueresolution.v1.BuiltInUserInputActionH\x00R\x16builtinUserInputAction\x12!\n" +
	"\fbutton_label\x18\x04 \x01(\tR\vbuttonLabel\x12!\n" +
	"\fis_available\x18\x05 \x01(\bR\visAvailable\x12T\n" +
	"\areasons\x18\x06 \x03(\v2:.google.shopping.merchant.issueresolution.v1.Action.ReasonR\areasons\x1a\xac\x01\n" +
	"\x06Reason\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12\x1b\n" +
	"\x06detail\x18\x02 \x01(\tH\x00R\x06detail\x88\x01\x01\x12U\n" +
	"\x06action\x18\x03 \x01(\v23.google.shopping.merchant.issueresolution.v1.ActionB\x03\xe0A\x01H\x01R\x06action\x88\x01\x01B\t\n" +
	"\a_detailB\t\n" +
	"\a_actionB\b\n" +
	"\x06action\"\xcc\x05\n" +
	"\x13BuiltInSimpleAction\x12l\n" +
	"\x04type\x18\x01 \x01(\x0e2X.google.shopping.merchant.issueresolution.v1.BuiltInSimpleAction.BuiltInSimpleActionTypeR\x04type\x12*\n" +
	"\x0eattribute_code\x18\x02 \x01(\tH\x00R\rattributeCode\x88\x01\x01\x12\x86\x01\n" +
	"\x12additional_content\x18\x03 \x01(\v2R.google.shopping.merchant.issueresolution.v1.BuiltInSimpleAction.AdditionalContentH\x01R\x11additionalContent\x88\x01\x01\x1aI\n" +
	...
	"\x13_additional_content\"\x8e\x01\n" +
	"\x16BuiltInUserInputAction\x12%\n" +
	"\x0eaction_context\x18\x01 \x01(\tR\ractionContext\x12M\n" +
	"\x05flows\x18\x03 \x03(\v27.google.shopping.merchant.issueresolution.v1.ActionFlowR\x05flows\"\xc8\x03\n" +
	"\n" +
	"ActionFlow\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x12O\n" +
	"\x06inputs\x18\x03 \x03(\v27.google.shopping.merchant.issueresolution.v1.InputFieldR\x06inputs\x12!\n" +
	"\fdialog_title\x18\x04 \x01(\tR\vdialogTitle\x12h\n" +
	"\x0edialog_message\x18\a \x01(\v2<.google.shopping.merchant.issueresolution.v1.TextWithTooltipH\x00R\rdialogMessage\x88\x01\x01\x12`\n" +
	"\x0edialog_callout\x18\b \x01(\v24.google.shopping.merchant.issueresolution.v1.CalloutH\x01R\rdialogCallout\x88\x01\x01\x12.\n" +
	"\x13dialog_button_label\x18\t \x01(\tR\x11dialogButtonLabelB\x11\n" +
	"\x0f_dialog_messageB\x11\n" +
	"\x0f_dialog_callout\"\xa0\n" +
	"\n" +
	"\n" +
	"InputField\x12b\n" +
	"\n" +
	"text_input\x18\x04 \x01(\v2A.google.shopping.merchant.issueresolution.v1.InputField.TextInputH\x00R\ttextInput\x12h\n" +
	"\fchoice_input\x18\x05 \x01(\v2C.google.shopping.merchant.issueresolution.v1.InputField.ChoiceInputH\x00R\vchoiceInput\x12n\n" +
	"\x0echeckbox_input\x18\x06 \x01(\v2E.google.shopping.merchant.issueresolution.v1.InputField.CheckboxInputH\x00R\rcheckboxInput\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12R\n" +
	"\x05label\x18\x02 \x01(\v2<.google.shopping.merchant.issueresolution.v1.TextWithTooltipR\x05label\x12\x1a\n" +
	"\brequired\x18\x03 \x01(\bR\brequired\x1a\xba\x03\n" +
	"\tTextInput\x12c\n" +
	"\x04type\x18\x01 \x01(\x0e2O.google.shopping.merchant.issueresolution.v1.InputField.TextInput.TextInputTypeR\x04type\x12j\n" +
	"\x0fadditional_info\x18\x02 \x01(\v2<.google.shopping.merchant.issueresolution.v1.TextWithTooltipH\x00R\x0eadditionalInfo\x88\x01\x01\x12$\n" +
	...
	"\f_format_infoB\r\n" +
	"\v_aria_label\x1a\xf6\x02\n" +
	"\vChoiceInput\x12o\n" +
	"\aoptions\x18\x01 \x03(\v2U.google.shopping.merchant.issueresolution.v1.InputField.ChoiceInput.ChoiceInputOptionR\aoptions\x1a\xf5\x01\n" +
	"\x11ChoiceInputOption\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12R\n" +
	"\x05label\x18\x02 \x01(\v2<.google.shopping.merchant.issueresolution.v1.TextWithTooltipR\x05label\x12g\n" +
	"\x10additional_input\x18\x03 \x01(\v27.google.shopping.merchant.issueresolution.v1.InputFieldH\x00R\x0fadditionalInput\x88\x01\x01B\x13\n" +
	"\x11_additional_input\x1a\x0f\n" +
	"\rCheckboxInputB\r\n" +
	"\vvalue_input\"\xd1\x02\n" +
	"\x0fTextWithTooltip\x12#\n" +
	"\fsimple_value\x18\x01 \x01(\tH\x00R\vsimpleValue\x122\n" +
	"\x14simple_tooltip_value\x18\x02 \x01(\tH\x01R\x12simpleTooltipValue\x12{\n" +
	"\x12tooltip_icon_style\x18\x03 \x01(\x0e2M.google.shopping.merchant.issueresolution.v1.TextWithTooltip.TooltipIconStyleR\x10tooltipIconStyle\"N\n" +
	"\x10TooltipIconStyle\x12\"\n" +
	"\x1eTOOLTIP_ICON_STYLE_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04INFO\x10\x01\x12\f\n" +
	"\bQUESTION\x10\x02B\a\n" +
	"\x05valueB\x0f\n" +
	"\rtooltip_value\"\xaa\x02\n" +
	"\aCallout\x12d\n" +
	"\n" +
	"style_hint\x18\x01 \x01(\x0e2E.google.shopping.merchant.issueresolution.v1.Callout.CalloutStyleHintR\tstyleHint\x12_\n" +
	"\ffull_message\x18\x03 \x01(\v2<.google.shopping.merchant.issueresolution.v1.TextWithTooltipR\vfullMessage\"X\n" +
	"\x10CalloutStyleHint\x12\"\n" +
	"\x1eCALLOUT_STYLE_HINT_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05ERROR\x10\x01\x12\v\n" +
	"\aWARNING\x10\x02\x12\b\n" +
	"\x04INFO\x10\x03\"\xe6\x02\n" +
	"\x0eExternalAction\x12b\n" +
	"\x04type\x18\x01 \x01(\x0e2N.google.shopping.merchant.issueresolution.v1.ExternalAction.ExternalActionTypeR\x04type\x12\x10\n" +
	...
	"\"VERIFY_IDENTITY_IN_MERCHANT_CENTER\x10\x04\"\xe2\x01\n" +
	"\x14TriggerActionRequest\x12>\n" +
	"\x04name\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\n" +
	"\"merchantapi.googleapis.com/AccountR\x04name\x12`\n" +
	"\apayload\x18\x02 \x01(\v2A.google.shopping.merchant.issueresolution.v1.TriggerActionPayloadB\x03\xe0A\x02R\apayload\x12(\n" +
	"\rlanguage_code\x18\x03 \x01(\tB\x03\xe0A\x01R\flanguageCode\"\xa4\x01\n" +
	"\x14TriggerActionPayload\x12*\n" +
	"\x0eaction_context\x18\x01 \x01(\tB\x03\xe0A\x02R\ractionContext\x12`\n" +
	"\faction_input\x18\x02 \x01(\v28.google.shopping.merchant.issueresolution.v1.ActionInputB\x03\xe0A\x02R\vactionInput\"1\n" +
	"\x15TriggerActionResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"\x99\x01\n" +
	"\vActionInput\x12)\n" +
	"\x0eaction_flow_id\x18\x01 \x01(\tB\x03\xe0A\x02R\factionFlowId\x12_\n" +
	"\finput_values\x18\x02 \x03(\v27.google.shopping.merchant.issueresolution.v1.InputValueB\x03\xe0A\x02R\vinputValues\"\xda\x04\n" +
	"\n" +
	"InputValue\x12r\n" +
	"\x10text_input_value\x18\x02 \x01(\v2F.google.shopping.merchant.issueresolution.v1.InputValue.TextInputValueH\x00R\x0etextInputValue\x12x\n" +
	"\x12choice_input_value\x18\x03 \x01(\v2H.google.shopping.merchant.issueresolution.v1.InputValue.ChoiceInputValueH\x00R\x10choiceInputValue\x12~\n" +
	"\x14checkbox_input_value\x18\x04 \x01(\v2J.google.shopping.merchant.issueresolution.v1.InputValue.CheckboxInputValueH\x00R\x12checkboxInputValue\x12)\n" +
	...
	"\x13RenderAccountIssues\x12G.google.shopping.merchant.issueresolution.v1.RenderAccountIssuesRequest\x1aH.google.shopping.merchant.issueresolution.v1.RenderAccountIssuesResponse\"Q\xdaA\x04name\x82\xd3\xe4\x93\x02D:\apayload\"9/issueresolution/v1/{name=accounts/*}:renderaccountissues\x12\x86\x02\n" +
	"\x13RenderProductIssues\x12G.google.shopping.merchant.issueresolution.v1.RenderProductIssuesRequest\x1aH.google.shopping.merchant.issueresolution.v1.RenderProductIssuesResponse\"\\\xdaA\x04name\x82\xd3\xe4\x93\x02O:\apayload\"D/issueresolution/v1/{name=accounts/*/products/*}:renderproductissues\x12\xe3\x01\n" +
	"\rTriggerAction\x12A.google.shopping.merchant.issueresolution.v1.TriggerActionRequest\x1aB.google.shopping.merchant.issueresolution.v1.TriggerActionResponse\"K\xdaA\x04name\x82\xd3\xe4\x93\x02>:\apayload\"3/issueresolution/v1/{name=accounts/*}:triggeraction\x1aG\xcaA\x1amerchantapi.googleapis.com\xd2A'https://www.googleapis.com/auth/contentB\xc1\x03\xeaA8\n" +
...
var (
	...
	file_google_shopping_merchant_issueresolution_v1_issueresolution_proto_rawDescData []byte
)
...
func file_google_shopping_merchant_issueresolution_v1_issueresolution_proto_rawDescGZIP() []byte {
	file_google_shopping_merchant_issueresolution_v1_issueresolution_proto_rawDescOnce.Do(func() {
		file_google_shopping_merchant_issueresolution_v1_issueresolution_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_issueresolution_v1_issueresolution_proto_rawDesc), len(file_google_shopping_merchant_issueresolution_v1_issueresolution_proto_rawDesc)))
	})
...
func file_google_shopping_merchant_issueresolution_v1_issueresolution_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_issueresolution_v1_issueresolution_proto_rawDesc), len(file_google_shopping_merchant_issueresolution_v1_issueresolution_proto_rawDesc)),
			NumEnums:      8,
			NumMessages:   31,
			NumExtensions: 0,
			NumServices:   1,
