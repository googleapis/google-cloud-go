...
const (
	AggregateProductStatusesService_ListAggregateProductStatuses_FullMethodName = "/google.shopping.merchant.issueresolution.v1.AggregateProductStatusesService/ListAggregateProductStatuses"
)
