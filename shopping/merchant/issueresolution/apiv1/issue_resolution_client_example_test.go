...
func ExampleClient_RenderAccountIssues() {
	...
	req := &issueresolutionpb.RenderAccountIssuesRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/shopping/merchant/issueresolution/apiv1/issueresolutionpb#RenderAccountIssuesRequest.
	}
...
func ExampleClient_TriggerAction() {
	...
	req := &issueresolutionpb.TriggerActionRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/shopping/merchant/issueresolution/apiv1/issueresolutionpb#TriggerActionRequest.
	}
