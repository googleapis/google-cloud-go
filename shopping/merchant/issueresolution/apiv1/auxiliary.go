...
func (it *AggregateProductStatusIterator) Next() (*issueresolutionpb.AggregateProductStatus, error) {
	var item *issueresolutionpb.AggregateProductStatus
...
func (it *AggregateProductStatusIterator) bufLen() int {
	return len(it.items)
}

func (it *AggregateProductStatusIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
