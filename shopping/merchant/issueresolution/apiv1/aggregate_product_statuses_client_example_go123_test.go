...
func ExampleAggregateProductStatusesClient_ListAggregateProductStatuses_all() {
	...
	req := &issueresolutionpb.ListAggregateProductStatusesRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/shopping/merchant/issueresolution/apiv1/issueresolutionpb#ListAggregateProductStatusesRequest.
	}
