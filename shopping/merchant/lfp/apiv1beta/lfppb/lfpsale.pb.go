...
var file_google_shopping_merchant_lfp_v1beta_lfpsale_proto_goTypes = []interface{}{
...
func file_google_shopping_merchant_lfp_v1beta_lfpsale_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_shopping_merchant_lfp_v1beta_lfpsale_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_shopping_merchant_lfp_v1beta_lfpsale_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_shopping_merchant_lfp_v1beta_lfpsale_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
