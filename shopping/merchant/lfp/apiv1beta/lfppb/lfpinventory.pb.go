...
const file_google_shopping_merchant_lfp_v1beta_lfpinventory_proto_rawDesc = "" +
	"\n" +
	...
	"\x0e_pickup_methodB\r\n" +
	"\v_pickup_slaB\r\n" +
	"\v_feed_label\"\xc1\x01\n" +
	"\x19InsertLfpInventoryRequest\x12G\n" +
	"\x06parent\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\x12'merchantapi.googleapis.com/LfpInventoryR\x06parent\x12[\n" +
	"\rlfp_inventory\x18\x02 \x01(\v21.google.shopping.merchant.lfp.v1beta.LfpInventoryB\x03\xe0A\x02R\flfpInventory2\xb6\x02\n" +
	"\x13LfpInventoryService\x12\xd5\x01\n" +
	"\x12InsertLfpInventory\x12>.google.shopping.merchant.lfp.v1beta.InsertLfpInventoryRequest\x1a1.google.shopping.merchant.lfp.v1beta.LfpInventory\"L\x82\xd3\xe4\x93\x02F:\rlfp_inventory\"5/lfp/v1beta/{parent=accounts/*}/lfpInventories:insert\x1aG\xcaA\x1amerchantapi.googleapis.com\xd2A'https://www.googleapis.com/auth/contentB\xba\x01\xeaA8\n" +
	"\"merchantapi.googleapis.com/Account\x12\x12accounts/{account}\n" +
	"'com.google.shopping.merchant.lfp.v1betaB\x11LfpInventoryProtoP\x01Z?cloud.google.com/go/shopping/merchant/lfp/apiv1beta/lfppb;lfppbb\x06proto3"

var (
	file_google_shopping_merchant_lfp_v1beta_lfpinventory_proto_rawDescOnce sync.Once
	file_google_shopping_merchant_lfp_v1beta_lfpinventory_proto_rawDescData []byte
)
...
func file_google_shopping_merchant_lfp_v1beta_lfpinventory_proto_rawDescGZIP() []byte {
	file_google_shopping_merchant_lfp_v1beta_lfpinventory_proto_rawDescOnce.Do(func() {
		file_google_shopping_merchant_lfp_v1beta_lfpinventory_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_lfp_v1beta_lfpinventory_proto_rawDesc), len(file_google_shopping_merchant_lfp_v1beta_lfpinventory_proto_rawDesc)))
	})
...
func file_google_shopping_merchant_lfp_v1beta_lfpinventory_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_lfp_v1beta_lfpinventory_proto_rawDesc), len(file_google_shopping_merchant_lfp_v1beta_lfpinventory_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
