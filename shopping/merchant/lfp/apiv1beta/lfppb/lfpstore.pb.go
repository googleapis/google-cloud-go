...
const file_google_shopping_merchant_lfp_v1beta_lfpstore_proto_rawDesc = "" +
	"\n" +
	"2google/shopping/merchant/lfp/v1beta/lfpstore.proto\x12#google.shopping.merchant.lfp.v1beta\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\"\xf1\x06\n" +
	"\bLfpStore\x12\x1a\n" +
	...
	"\bplace_id\x18\t \x01(\tB\x03\xe0A\x01H\x03R\aplaceId\x88\x01\x01\x12o\n" +
	"\x0ematching_state\x18\n" +
	" \x01(\x0e2@.google.shopping.merchant.lfp.v1beta.LfpStore.StoreMatchingStateB\x06\xe0A\x01\xe0A\x03R\rmatchingState\x12;\n" +
	...
	"#merchantapi.googleapis.com/LfpStoreR\x04name\"\xad\x01\n" +
	"\x15InsertLfpStoreRequest\x12C\n" +
	"\x06parent\x18\x01 \x01(\tB+\xe0A\x02\xfaA%\x12#merchantapi.googleapis.com/LfpStoreR\x06parent\x12O\n" +
	"\tlfp_store\x18\x02 \x01(\v2-.google.shopping.merchant.lfp.v1beta.LfpStoreB\x03\xe0A\x02R\blfpStore\"X\n" +
	...
	"\x15ListLfpStoresResponse\x12L\n" +
	"\n" +
	"lfp_stores\x18\x01 \x03(\v2-.google.shopping.merchant.lfp.v1beta.LfpStoreR\tlfpStores\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken2\xc8\x06\n" +
	"\x0fLfpStoreService\x12\xaf\x01\n" +
	"\vGetLfpStore\x127.google.shopping.merchant.lfp.v1beta.GetLfpStoreRequest\x1a-.google.shopping.merchant.lfp.v1beta.LfpStore\"8\xdaA\x04name\x82\xd3\xe4\x93\x02+\x12)/lfp/v1beta/{name=accounts/*/lfpStores/*}\x12\xd3\x01\n" +
	"\x0eInsertLfpStore\x12:.google.shopping.merchant.lfp.v1beta.InsertLfpStoreRequest\x1a-.google.shopping.merchant.lfp.v1beta.LfpStore\"V\xdaA\x10parent,lfp_store\x82\xd3\xe4\x93\x02=:\tlfp_store\"0/lfp/v1beta/{parent=accounts/*}/lfpStores:insert\x12\x9e\x01\n" +
...
var (
	...
	file_google_shopping_merchant_lfp_v1beta_lfpstore_proto_rawDescData []byte
)
...
func file_google_shopping_merchant_lfp_v1beta_lfpstore_proto_rawDescGZIP() []byte {
	file_google_shopping_merchant_lfp_v1beta_lfpstore_proto_rawDescOnce.Do(func() {
		file_google_shopping_merchant_lfp_v1beta_lfpstore_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_lfp_v1beta_lfpstore_proto_rawDesc), len(file_google_shopping_merchant_lfp_v1beta_lfpstore_proto_rawDesc)))
	})
...
func file_google_shopping_merchant_lfp_v1beta_lfpstore_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_lfp_v1beta_lfpstore_proto_rawDesc), len(file_google_shopping_merchant_lfp_v1beta_lfpstore_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
