...
type LocalInventoryIterator struct {
	...
	InternalFetch func(pageSize int, pageToken string) (results []*inventoriespb.LocalInventory, nextPageToken string, err error)
}

// PageInfo supports pagination. See the google.golang.org/api/iterator package for details.
func (it *LocalInventoryIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *LocalInventoryIterator) Next() (*inventoriespb.LocalInventory, error) {
	var item *inventoriespb.LocalInventory
...
func (it *LocalInventoryIterator) bufLen() int {
	return len(it.items)
}

func (it *LocalInventoryIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
