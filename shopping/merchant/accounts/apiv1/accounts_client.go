...
// CreateAndConfigureAccount creates a Merchant Center account with additional configuration. Adds the
...
// UpdateAccount updates an account regardless of its type: standalone, advanced account or
...
// ListAccounts note: For the accounts.list method, quota and limits usage are charged
...
// ListSubAccounts list all sub-accounts for a given advanced account. This is a
...
func (c *restClient) CreateAndConfigureAccount(ctx context.Context, req *accountspb.CreateAndConfigureAccountRequest, opts ...gax.CallOption) (*accountspb.Account, error) {
	...
	baseUrl.Path += fmt.Sprintf("/accounts/v1/accounts:createAndConfigure")
...
func (c *restClient) UpdateAccount(ctx context.Context, req *accountspb.UpdateAccountRequest, opts ...gax.CallOption) (*accountspb.Account, error) {
	...
	baseUrl.Path += fmt.Sprintf("/accounts/v1/%v", req.GetAccount().GetName())
...
func (c *restClient) ListAccounts(ctx context.Context, req *accountspb.ListAccountsRequest, opts ...gax.CallOption) *AccountIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*accountspb.Account, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/accounts/v1/accounts")
...
func (c *restClient) ListSubAccounts(ctx context.Context, req *accountspb.ListSubAccountsRequest, opts ...gax.CallOption) *AccountIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*accountspb.Account, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/accounts/v1/%v:listSubaccounts", req.GetProvider())
