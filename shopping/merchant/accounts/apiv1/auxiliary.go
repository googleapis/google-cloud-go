...
type AccountRelationshipIterator struct {
	items    []*accountspb.AccountRelationship
	pageInfo *iterator.PageInfo
	nextFunc func() error
...
func (it *AccountRelationshipIterator) Next() (*accountspb.AccountRelationship, error) {
	var item *accountspb.AccountRelationship
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *AccountRelationshipIterator) bufLen() int {
	return len(it.items)
}

func (it *AccountRelationshipIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type AccountServiceIterator struct {
	items    []*accountspb.AccountService
	pageInfo *iterator.PageInfo
	nextFunc func() error
...
func (it *AccountServiceIterator) Next() (*accountspb.AccountService, error) {
	var item *accountspb.AccountService
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *AccountServiceIterator) bufLen() int {
	return len(it.items)
}

func (it *AccountServiceIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
