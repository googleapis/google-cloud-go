...
const file_google_shopping_merchant_accounts_v1beta_termsofserviceagreementstate_proto_rawDesc = "" +
	"\n" +
	...
	"regionCode\x12o\n" +
	"\x15terms_of_service_kind\x18\x03 \x01(\x0e2<.google.shopping.merchant.accounts.v1beta.TermsOfServiceKindR\x12termsOfServiceKind\x12S\n" +
	"\baccepted\x18\x04 \x01(\v22.google.shopping.merchant.accounts.v1beta.AcceptedH\x00R\baccepted\x88\x01\x01\x12S\n" +
	"\brequired\x18\x05 \x01(\v22.google.shopping.merchant.accounts.v1beta.RequiredH\x01R\brequired\x88\x01\x01:\xb9\x01\xeaA\xb5\x01\n" +
	...
	")merchantapi.googleapis.com/TermsOfServiceR\x0etermsOfService\x12H\n" +
	"\vaccepted_by\x18\x02 \x01(\tB'\xfaA$\n" +
	"\"merchantapi.googleapis.com/AccountR\n" +
	"acceptedBy\x127\n" +
	"\vvalid_until\x18\x03 \x01(\v2\x11.google.type.DateH\x00R\n" +
	"validUntil\x88\x01\x01B\x0e\n" +
	"\f_valid_until\"\x86\x01\n" +
	"\bRequired\x12X\n" +
	"\x10terms_of_service\x18\x01 \x01(\tB.\xfaA+\n" +
	")merchantapi.googleapis.com/TermsOfServiceR\x0etermsOfService\x12 \n" +
	"\ftos_file_uri\x18\x02 \x01(\tR\n" +
	"tosFileUri\"}\n" +
	...
	"\x06parent\x18\x01 \x01(\tB?\xe0A\x02\xfaA9\x127merchantapi.googleapis.com/TermsOfServiceAgreementStateR\x06parent2\xcf\x05\n" +
...
var (
	...
	file_google_shopping_merchant_accounts_v1beta_termsofserviceagreementstate_proto_rawDescData []byte
)
...
func file_google_shopping_merchant_accounts_v1beta_termsofserviceagreementstate_proto_rawDescGZIP() []byte {
	file_google_shopping_merchant_accounts_v1beta_termsofserviceagreementstate_proto_rawDescOnce.Do(func() {
		file_google_shopping_merchant_accounts_v1beta_termsofserviceagreementstate_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_accounts_v1beta_termsofserviceagreementstate_proto_rawDesc), len(file_google_shopping_merchant_accounts_v1beta_termsofserviceagreementstate_proto_rawDesc)))
	})
...
func file_google_shopping_merchant_accounts_v1beta_termsofserviceagreementstate_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_accounts_v1beta_termsofserviceagreementstate_proto_rawDesc), len(file_google_shopping_merchant_accounts_v1beta_termsofserviceagreementstate_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
