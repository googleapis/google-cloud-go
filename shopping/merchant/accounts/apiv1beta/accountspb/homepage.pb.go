...
const file_google_shopping_merchant_accounts_v1beta_homepage_proto_rawDesc = "" +
	"\n" +
	"7google/shopping/merchant/accounts/v1beta/homepage.proto\x12(google.shopping.merchant.accounts.v1beta\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a google/protobuf/field_mask.proto\"\xc2\x01\n" +
	"\bHomepage\x12\x17\n" +
	...
	"#merchantapi.googleapis.com/HomepageR\x04name\"\xae\x01\n" +
	"\x15UpdateHomepageRequest\x12S\n" +
	"\bhomepage\x18\x01 \x01(\v22.google.shopping.merchant.accounts.v1beta.HomepageB\x03\xe0A\x02R\bhomepage\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"W\n" +
	"\x14ClaimHomepageRequest\x12?\n" +
	"\x04name\x18\x01 \x01(\tB+\xe0A\x02\xfaA%\n" +
	"#merchantapi.googleapis.com/HomepageR\x04name\"Y\n" +
	"\x16UnclaimHomepageRequest\x12?\n" +
	"\x04name\x18\x01 \x01(\tB+\xe0A\x02\xfaA%\n" +
	"#merchantapi.googleapis.com/HomepageR\x04name2\x8d\a\n" +
	"\x0fHomepageService\x12\xbb\x01\n" +
	"\vGetHomepage\x12<.google.shopping.merchant.accounts.v1beta.GetHomepageRequest\x1a2.google.shopping.merchant.accounts.v1beta.Homepage\":\xdaA\x04name\x82\xd3\xe4\x93\x02-\x12+/accounts/v1beta/{name=accounts/*/homepage}\x12\xe4\x01\n" +
	"\x0eUpdateHomepage\x12?.google.shopping.merchant.accounts.v1beta.UpdateHomepageRequest\x1a2.google.shopping.merchant.accounts.v1beta.Homepage\"]\xdaA\x14homepage,update_mask\x82\xd3\xe4\x93\x02@:\bhomepage24/accounts/v1beta/{homepage.name=accounts/*/homepage}\x12\xc1\x01\n" +
	"\rClaimHomepage\x12>.google.shopping.merchant.accounts.v1beta.ClaimHomepageRequest\x1a2.google.shopping.merchant.accounts.v1beta.Homepage\"<\x82\xd3\xe4\x93\x026:\x01*\"1/accounts/v1beta/{name=accounts/*/homepage}:claim\x12\xc7\x01\n" +
	"\x0fUnclaimHomepage\x12@.google.shopping.merchant.accounts.v1beta.UnclaimHomepageRequest\x1a2.google.shopping.merchant.accounts.v1beta.Homepage\">\x82\xd3\xe4\x93\x028:\x01*\"3/accounts/v1beta/{name=accounts/*/homepage}:unclaim\x1aG\xcaA\x1amerchantapi.googleapis.com\xd2A'https://www.googleapis.com/auth/contentB\x8f\x01\n" +
...
var (
	...
	file_google_shopping_merchant_accounts_v1beta_homepage_proto_rawDescData []byte
)
...
func file_google_shopping_merchant_accounts_v1beta_homepage_proto_rawDescGZIP() []byte {
	file_google_shopping_merchant_accounts_v1beta_homepage_proto_rawDescOnce.Do(func() {
		file_google_shopping_merchant_accounts_v1beta_homepage_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_accounts_v1beta_homepage_proto_rawDesc), len(file_google_shopping_merchant_accounts_v1beta_homepage_proto_rawDesc)))
	})
...
func file_google_shopping_merchant_accounts_v1beta_homepage_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_accounts_v1beta_homepage_proto_rawDesc), len(file_google_shopping_merchant_accounts_v1beta_homepage_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
