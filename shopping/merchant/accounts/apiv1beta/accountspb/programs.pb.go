...
const file_google_shopping_merchant_accounts_v1beta_programs_proto_rawDesc = "" +
	"\n" +
	"7google/shopping/merchant/accounts/v1beta/programs.proto\x12(google.shopping.merchant.accounts.v1beta\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\x96\x05\n" +
	"\aProgram\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x120\n" +
	"\x11documentation_uri\x18\x02 \x01(\tB\x03\xe0A\x03R\x10documentationUri\x12R\n" +
	"\x05state\x18\x03 \x01(\x0e27.google.shopping.merchant.accounts.v1beta.Program.StateB\x03\xe0A\x03R\x05state\x123\n" +
	"\x13active_region_codes\x18\x04 \x03(\tB\x03\xe0A\x03R\x11activeRegionCodes\x12q\n" +
	"\x12unmet_requirements\x18\x05 \x03(\v2=.google.shopping.merchant.accounts.v1beta.Program.RequirementB\x03\xe0A\x03R\x11unmetRequirements\x1a\x93\x01\n" +
	...
	"\x14ListProgramsResponse\x12M\n" +
	"\bprograms\x18\x01 \x03(\v21.google.shopping.merchant.accounts.v1beta.ProgramR\bprograms\x12&\n" +
	...
	"\x04name\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\n" +
	"\"merchantapi.googleapis.com/ProgramR\x04name2\x84\a\n" +
	...
	"\fListPrograms\x12=.google.shopping.merchant.accounts.v1beta.ListProgramsRequest\x1a>.google.shopping.merchant.accounts.v1beta.ListProgramsResponse\">\xdaA\x06parent\x82\xd3\xe4\x93\x02/\x12-/accounts/v1beta/{parent=accounts/*}/programs\x12\xca\x01\n" +
	"\rEnableProgram\x12>.google.shopping.merchant.accounts.v1beta.EnableProgramRequest\x1a1.google.shopping.merchant.accounts.v1beta.Program\"F\xdaA\x04name\x82\xd3\xe4\x93\x029:\x01*\"4/accounts/v1beta/{name=accounts/*/programs/*}:enable\x12\xcd\x01\n" +
	"\x0eDisableProgram\x12?.google.shopping.merchant.accounts.v1beta.DisableProgramRequest\x1a1.google.shopping.merchant.accounts.v1beta.Program\"G\xdaA\x04name\x82\xd3\xe4\x93\x02::\x01*\"5/accounts/v1beta/{name=accounts/*/programs/*}:disable\x1aG\xcaA\x1amerchantapi.googleapis.com\xd2A'https://www.googleapis.com/auth/contentB\x8f\x01\n" +
...
var (
	...
	file_google_shopping_merchant_accounts_v1beta_programs_proto_rawDescData []byte
)
...
func file_google_shopping_merchant_accounts_v1beta_programs_proto_rawDescGZIP() []byte {
	file_google_shopping_merchant_accounts_v1beta_programs_proto_rawDescOnce.Do(func() {
		file_google_shopping_merchant_accounts_v1beta_programs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_accounts_v1beta_programs_proto_rawDesc), len(file_google_shopping_merchant_accounts_v1beta_programs_proto_rawDesc)))
	})
...
func file_google_shopping_merchant_accounts_v1beta_programs_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_accounts_v1beta_programs_proto_rawDesc), len(file_google_shopping_merchant_accounts_v1beta_programs_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
