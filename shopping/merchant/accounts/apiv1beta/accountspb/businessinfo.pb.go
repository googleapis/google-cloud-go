...
var file_google_shopping_merchant_accounts_v1beta_businessinfo_proto_rawDesc = []byte{
	...
	0x6e, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x42, 0x03, 0xe0, 0x41, 0x01, 0x48, 0x01, 0x52,
...
var file_google_shopping_merchant_accounts_v1beta_businessinfo_proto_goTypes = []interface{}{
...
func file_google_shopping_merchant_accounts_v1beta_businessinfo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_shopping_merchant_accounts_v1beta_businessinfo_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_shopping_merchant_accounts_v1beta_businessinfo_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_shopping_merchant_accounts_v1beta_businessinfo_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_shopping_merchant_accounts_v1beta_businessinfo_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
