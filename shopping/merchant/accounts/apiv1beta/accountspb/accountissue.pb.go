...
const file_google_shopping_merchant_accounts_v1beta_accountissue_proto_rawDesc = "" +
	"\n" +
	";google/shopping/merchant/accounts/v1beta/accountissue.proto\x12(google.shopping.merchant.accounts.v1beta\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a google/shopping/type/types.proto\"\xb0\a\n" +
	"\fAccountIssue\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12[\n" +
	"\bseverity\x18\x03 \x01(\x0e2?.google.shopping.merchant.accounts.v1beta.AccountIssue.SeverityR\bseverity\x12\x7f\n" +
	"\x15impacted_destinations\x18\x04 \x03(\v2J.google.shopping.merchant.accounts.v1beta.AccountIssue.ImpactedDestinationR\x14impactedDestinations\x12\x16\n" +
	"\x06detail\x18\x05 \x01(\tR\x06detail\x12+\n" +
	"\x11documentation_uri\x18\x06 \x01(\tR\x10documentationUri\x1a\x90\x03\n" +
	"\x13ImpactedDestination\x12m\n" +
	"\x11reporting_context\x18\x01 \x01(\x0e2;.google.shopping.type.ReportingContext.ReportingContextEnumH\x00R\x10reportingContext\x88\x01\x01\x12k\n" +
	"\aimpacts\x18\x02 \x03(\v2Q.google.shopping.merchant.accounts.v1beta.AccountIssue.ImpactedDestination.ImpactR\aimpacts\x1a\x86\x01\n" +
	"\x06Impact\x12\x1f\n" +
	"\vregion_code\x18\x01 \x01(\tR\n" +
	"regionCode\x12[\n" +
	"\bseverity\x18\x02 \x01(\x0e2?.google.shopping.merchant.accounts.v1beta.AccountIssue.SeverityR\bseverityB\x14\n" +
	...
	"\ttime_zone\x18\x05 \x01(\tB\x03\xe0A\x01R\btimeZone\"\xa2\x01\n" +
	"\x19ListAccountIssuesResponse\x12]\n" +
	"\x0eaccount_issues\x18\x01 \x03(\v26.google.shopping.merchant.accounts.v1beta.AccountIssueR\raccountIssues\x12&\n" +
...
var (
	...
	file_google_shopping_merchant_accounts_v1beta_accountissue_proto_rawDescData []byte
)
...
func file_google_shopping_merchant_accounts_v1beta_accountissue_proto_rawDescGZIP() []byte {
	file_google_shopping_merchant_accounts_v1beta_accountissue_proto_rawDescOnce.Do(func() {
		file_google_shopping_merchant_accounts_v1beta_accountissue_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_accounts_v1beta_accountissue_proto_rawDesc), len(file_google_shopping_merchant_accounts_v1beta_accountissue_proto_rawDesc)))
	})
...
func file_google_shopping_merchant_accounts_v1beta_accountissue_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_accounts_v1beta_accountissue_proto_rawDesc), len(file_google_shopping_merchant_accounts_v1beta_accountissue_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
