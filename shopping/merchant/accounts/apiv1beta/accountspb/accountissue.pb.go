...
var file_google_shopping_merchant_accounts_v1beta_accountissue_proto_goTypes = []interface{}{
...
func file_google_shopping_merchant_accounts_v1beta_accountissue_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_shopping_merchant_accounts_v1beta_accountissue_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_shopping_merchant_accounts_v1beta_accountissue_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_shopping_merchant_accounts_v1beta_accountissue_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_shopping_merchant_accounts_v1beta_accountissue_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_shopping_merchant_accounts_v1beta_accountissue_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_shopping_merchant_accounts_v1beta_accountissue_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
