...
func (c *gbpAccountsGRPCClient) ListGbpAccounts(ctx context.Context, req *accountspb.ListGbpAccountsRequest, opts ...gax.CallOption) *GbpAccountIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.accounts.v1beta.GbpAccountsService/ListGbpAccounts")
	}
...
func (c *gbpAccountsGRPCClient) LinkGbpAccount(ctx context.Context, req *accountspb.LinkGbpAccountRequest, opts ...gax.CallOption) (*accountspb.LinkGbpAccountResponse, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.accounts.v1beta.GbpAccountsService/LinkGbpAccount")
	}
...
func (c *gbpAccountsRESTClient) LinkGbpAccount(ctx context.Context, req *accountspb.LinkGbpAccountRequest, opts ...gax.CallOption) (*accountspb.LinkGbpAccountResponse, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.accounts.v1beta.GbpAccountsService/LinkGbpAccount")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/accounts/v1beta/{parent=accounts/*}/gbpAccounts:linkGbpAccount")
	}
	opts = append((*c.CallOptions).LinkGbpAccount[0:len((*c.CallOptions).LinkGbpAccount):len((*c.CallOptions).LinkGbpAccount)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
