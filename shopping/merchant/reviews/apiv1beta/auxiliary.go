...
func (it *MerchantReviewIterator) Next() (*reviewspb.MerchantReview, error) {
	var item *reviewspb.MerchantReview
...
func (it *MerchantReviewIterator) bufLen() int {
	return len(it.items)
}

func (it *MerchantReviewIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
func (it *ProductReviewIterator) Next() (*reviewspb.ProductReview, error) {
	var item *reviewspb.ProductReview
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *ProductReviewIterator) bufLen() int {
	return len(it.items)
}

func (it *ProductReviewIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
