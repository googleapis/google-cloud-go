...
type PromotionIterator struct {
	...
	InternalFetch func(pageSize int, pageToken string) (results []*promotionspb.Promotion, nextPageToken string, err error)
}
...
func (it *PromotionIterator) Next() (*promotionspb.Promotion, error) {
	var item *promotionspb.Promotion
...
func (it *PromotionIterator) bufLen() int {
	return len(it.items)
}

func (it *PromotionIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
