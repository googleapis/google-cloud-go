...
const file_google_shopping_merchant_products_v1beta_products_common_proto_rawDesc = "" +
	"\n" +
	">google/shopping/merchant/products/v1beta/products_common.proto\x12(google.shopping.merchant.products.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/shopping/type/types.proto\x1a\x1agoogle/type/interval.proto\"\x934\n" +
	"\n" +
	"Attributes\x120\n" +
	...
	"\x05adult\x18\x11 \x01(\bH\bR\x05adult\x88\x01\x01\x12 \n" +
	"\tage_group\x18\x12 \x01(\tH\tR\bageGroup\x88\x01\x01\x12'\n" +
	"\favailability\x18\x13 \x01(\tH\n" +
	...
	"\x05color\x18\x16 \x01(\tH\fR\x05color\x88\x01\x01\x12!\n" +
	"\tcondition\x18\x17 \x01(\tH\rR\tcondition\x88\x01\x01\x12\x1b\n" +
	"\x06gender\x18\x18 \x01(\tH\x0eR\x06gender\x88\x01\x01\x12;\n" +
	"\x17google_product_category\x18\x19 \x01(\tH\x0fR\x15googleProductCategory\x88\x01\x01\x12\x16\n" +
	"\x04gtin\x18\x1a \x03(\tB\x02\x18\x01R\x04gtin\x12\x15\n" +
	...
	"\x14maximum_retail_price\x18\x8b\x01 \x01(\v2\x1b.google.shopping.type.PriceR\x12maximumRetailPrice\x12W\n" +
	"\vinstallment\x18  \x01(\v25.google.shopping.merchant.products.v1beta.InstallmentR\vinstallment\x12g\n" +
	"\x11subscription_cost\x18! \x01(\v2:.google.shopping.merchant.products.v1beta.SubscriptionCostR\x10subscriptionCost\x12^\n" +
	"\x0eloyalty_points\x18\" \x01(\v27.google.shopping.merchant.products.v1beta.LoyaltyPointsR\rloyaltyPoints\x12d\n" +
	"\x10loyalty_programs\x18\x88\x01 \x03(\v28.google.shopping.merchant.products.v1beta.LoyaltyProgramR\x0floyaltyPrograms\x12#\n" +
	...
	"\x17sell_on_google_quantity\x18& \x01(\x03H\x14R\x14sellOnGoogleQuantity\x88\x01\x01\x12a\n" +
	"\x0eproduct_height\x18w \x01(\v2:.google.shopping.merchant.products.v1beta.ProductDimensionR\rproductHeight\x12a\n" +
	"\x0eproduct_length\x18x \x01(\v2:.google.shopping.merchant.products.v1beta.ProductDimensionR\rproductLength\x12_\n" +
	"\rproduct_width\x18y \x01(\v2:.google.shopping.merchant.products.v1beta.ProductDimensionR\fproductWidth\x12^\n" +
	"\x0eproduct_weight\x18z \x01(\v27.google.shopping.merchant.products.v1beta.ProductWeightR\rproductWeight\x12N\n" +
	"\bshipping\x18' \x03(\v22.google.shopping.merchant.products.v1beta.ShippingR\bshipping\x12x\n" +
	"\x17free_shipping_threshold\x18\x87\x01 \x03(\v2?.google.shopping.merchant.products.v1beta.FreeShippingThresholdR\x15freeShippingThreshold\x12a\n" +
	"\x0fshipping_weight\x18( \x01(\v28.google.shopping.merchant.products.v1beta.ShippingWeightR\x0eshippingWeight\x12d\n" +
	"\x0fshipping_length\x18) \x01(\v2;.google.shopping.merchant.products.v1beta.ShippingDimensionR\x0eshippingLength\x12b\n" +
	"\x0eshipping_width\x18* \x01(\v2;.google.shopping.merchant.products.v1beta.ShippingDimensionR\rshippingWidth\x12d\n" +
	"\x0fshipping_height\x18+ \x01(\v2;.google.shopping.merchant.products.v1beta.ShippingDimensionR\x0eshippingHeight\x12/\n" +
	"\x11max_handling_time\x18, \x01(\x03H\x15R\x0fmaxHandlingTime\x88\x01\x01\x12/\n" +
	"\x11min_handling_time\x18- \x01(\x03H\x16R\x0fminHandlingTime\x88\x01\x01\x12*\n" +
	...
	"\x04size\x180 \x01(\tH\x19R\x04size\x88\x01\x01\x12$\n" +
	"\vsize_system\x181 \x01(\tH\x1aR\n" +
	"sizeSystem\x88\x01\x01\x12\x1d\n" +
	"\n" +
	"size_types\x182 \x03(\tR\tsizeTypes\x12G\n" +
	"\x05taxes\x183 \x03(\v2-.google.shopping.merchant.products.v1beta.TaxB\x02\x18\x01R\x05taxes\x12*\n" +
	"\ftax_category\x184 \x01(\tB\x02\x18\x01H\x1bR\vtaxCategory\x88\x01\x01\x12;\n" +
	"\x17energy_efficiency_class\x185 \x01(\tH\x1cR\x15energyEfficiencyClass\x88\x01\x01\x12B\n" +
	"\x1bmin_energy_efficiency_class\x186 \x01(\tH\x1dR\x18minEnergyEfficiencyClass\x88\x01\x01\x12B\n" +
	"\x1bmax_energy_efficiency_class\x187 \x01(\tH\x1eR\x18maxEnergyEfficiencyClass\x88\x01\x01\x12n\n" +
	"\x14unit_pricing_measure\x188 \x01(\v2<.google.shopping.merchant.products.v1beta.UnitPricingMeasureR\x12unitPricingMeasure\x12{\n" +
	"\x19unit_pricing_base_measure\x189 \x01(\v2@.google.shopping.merchant.products.v1beta.UnitPricingBaseMeasureR\x16unitPricingBaseMeasure\x12!\n" +
	...
	"\x0fproduct_details\x18? \x03(\v27.google.shopping.merchant.products.v1beta.ProductDetailR\x0eproductDetails\x12-\n" +
	...
	"\rpickup_method\x18P \x01(\tH&R\fpickupMethod\x88\x01\x01\x12\"\n" +
	"\n" +
	"pickup_sla\x18Q \x01(\tH'R\tpickupSla\x88\x01\x01\x12(\n" +
	...
	"\x0ecustom_label_4\x18K \x01(\tH.R\fcustomLabel4\x88\x01\x01\x123\n" +
	"\x15included_destinations\x18L \x03(\tR\x14includedDestinations\x123\n" +
	"\x15excluded_destinations\x18M \x03(\tR\x14excludedDestinations\x12E\n" +
	"\x1fshopping_ads_excluded_countries\x18N \x03(\tR\x1cshoppingAdsExcludedCountries\x121\n" +
	"\x12external_seller_id\x18\x01 \x01(\tH/R\x10externalSellerId\x88\x01\x01\x12\x19\n" +
	"\x05pause\x18\r \x01(\tH0R\x05pause\x88\x01\x01\x122\n" +
	"\x15lifestyle_image_links\x18\x0e \x03(\tR\x13lifestyleImageLinks\x12\x96\x01\n" +
	"\"cloud_export_additional_properties\x18T \x03(\v2I.google.shopping.merchant.products.v1beta.CloudExportAdditionalPropertiesR\x1fcloudExportAdditionalProperties\x122\n" +
	"\x12virtual_model_link\x18\x82\x01 \x01(\tH1R\x10virtualModelLink\x88\x01\x01\x12_\n" +
	"\x0ecertifications\x18{ \x03(\v27.google.shopping.merchant.products.v1beta.CertificationR\x0ecertifications\x12q\n" +
	"\x10structured_title\x18\x84\x01 \x01(\v2@.google.shopping.merchant.products.v1beta.ProductStructuredTitleH2R\x0fstructuredTitle\x88\x01\x01\x12\x83\x01\n" +
	"\x16structured_description\x18\x85\x01 \x01(\v2F.google.shopping.merchant.products.v1beta.ProductStructuredDescriptionH3R\x15structuredDescription\x88\x01\x01\x12P\n" +
	"\x16auto_pricing_min_price\x18| \x01(\v2\x1b.google.shopping.type.PriceR\x13autoPricingMinPrice\x12\x86\x01\n" +
	"\x19sustainability_incentives\x18\x8a\x01 \x03(\v2H.google.shopping.merchant.products.v1beta.ProductSustainabilityIncentiveR\x18sustainabilityIncentivesB\x14\n" +
	...
	"\x17_structured_description\"\xa8\x01\n" +
	"\x03Tax\x12\x12\n" +
	"\x04rate\x18\x01 \x01(\x01R\x04rate\x12\x18\n" +
	"\acountry\x18\x02 \x01(\tR\acountry\x12\x16\n" +
	"\x06region\x18\x03 \x01(\tR\x06region\x12\x19\n" +
	"\btax_ship\x18\x04 \x01(\bR\ataxShip\x12\x1f\n" +
	...
	"\x05value\x18\x01 \x01(\x01R\x05value\x12\x12\n" +
	"\x04unit\x18\x02 \x01(\tR\x04unit\"\xc2\x01\n" +
	"\x10SubscriptionCost\x12T\n" +
	"\x06period\x18\x01 \x01(\x0e2<.google.shopping.merchant.products.v1beta.SubscriptionPeriodR\x06period\x12#\n" +
	"\rperiod_length\x18\x02 \x01(\x03R\fperiodLength\x123\n" +
	"\x06amount\x18\x03 \x01(\v2\x1b.google.shopping.type.PriceR\x06amount\"\xe4\x01\n" +
	"\vInstallment\x12\x16\n" +
	"\x06months\x18\x01 \x01(\x03R\x06months\x123\n" +
	"\x06amount\x18\x02 \x01(\v2\x1b.google.shopping.type.PriceR\x06amount\x12B\n" +
	"\vdownpayment\x18\x03 \x01(\v2\x1b.google.shopping.type.PriceH\x00R\vdownpayment\x88\x01\x01\x12$\n" +
	"\vcredit_type\x18\x04 \x01(\tH\x01R\n" +
	...
	"\x10max_transit_time\x18\v \x01(\x03H\x03R\x0emaxTransitTime\x88\x01\x01B\x14\n" +
	"\x12_min_handling_timeB\x14\n" +
	"\x12_max_handling_timeB\x13\n" +
	"\x11_min_transit_timeB\x13\n" +
	"\x11_max_transit_time\"\xa1\x01\n" +
	...
	"\x0fattribute_value\x18\x03 \x01(\tR\x0eattributeValue\"\xcd\x02\n" +
	"\rCertification\x12<\n" +
	"\x17certification_authority\x18\x01 \x01(\tH\x00R\x16certificationAuthority\x88\x01\x01\x122\n" +
	"\x12certification_name\x18\x02 \x01(\tH\x01R\x11certificationName\x88\x01\x01\x122\n" +
	...
	"\x14_certification_value\"\x90\x01\n" +
	"\x16ProductStructuredTitle\x123\n" +
	"\x13digital_source_type\x18\x01 \x01(\tH\x00R\x11digitalSourceType\x88\x01\x01\x12\x1d\n" +
	"\acontent\x18\x02 \x01(\tH\x01R\acontent\x88\x01\x01B\x16\n" +
	"\x14_digital_source_typeB\n" +
	"\n" +
	"\b_content\"\x96\x01\n" +
	"\x1cProductStructuredDescription\x123\n" +
	"\x13digital_source_type\x18\x01 \x01(\tH\x00R\x11digitalSourceType\x88\x01\x01\x12\x1d\n" +
	"\acontent\x18\x02 \x01(\tH\x01R\acontent\x88\x01\x01B\x16\n" +
	"\x14_digital_source_typeB\n" +
	"\n" +
	...
	"\x05value\x18\x01 \x01(\x01B\x03\xe0A\x02R\x05value\x12\x17\n" +
	"\x04unit\x18\x02 \x01(\tB\x03\xe0A\x02R\x04unit\"\x90\n" +
	"\n" +
	"\rProductStatus\x12|\n" +
	"\x14destination_statuses\x18\x03 \x03(\v2I.google.shopping.merchant.products.v1beta.ProductStatus.DestinationStatusR\x13destinationStatuses\x12r\n" +
	"\x11item_level_issues\x18\x04 \x03(\v2F.google.shopping.merchant.products.v1beta.ProductStatus.ItemLevelIssueR\x0fitemLevelIssues\x12?\n" +
	...
	"\x15disapproved_countries\x18\x04 \x03(\tR\x14disapprovedCountries\x1a\xa2\x04\n" +
	"\x0eItemLevelIssue\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\x12k\n" +
	"\bseverity\x18\x02 \x01(\x0e2O.google.shopping.merchant.products.v1beta.ProductStatus.ItemLevelIssue.SeverityR\bseverity\x12\x1e\n" +
	"\n" +
	...
	"percentage\x12f\n" +
	"\x04type\x18\x01 \x01(\x0e2M.google.shopping.merchant.products.v1beta.ProductSustainabilityIncentive.TypeH\x01R\x04type\x88\x01\x01\"F\n" +
	"\x04Type\x12\x14\n" +
...
var (
	...
	file_google_shopping_merchant_products_v1beta_products_common_proto_rawDescData []byte
)
...
func file_google_shopping_merchant_products_v1beta_products_common_proto_rawDescGZIP() []byte {
	file_google_shopping_merchant_products_v1beta_products_common_proto_rawDescOnce.Do(func() {
		file_google_shopping_merchant_products_v1beta_products_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_products_v1beta_products_common_proto_rawDesc), len(file_google_shopping_merchant_products_v1beta_products_common_proto_rawDesc)))
	})
...
func file_google_shopping_merchant_products_v1beta_products_common_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_products_v1beta_products_common_proto_rawDesc), len(file_google_shopping_merchant_products_v1beta_products_common_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   24,
			NumExtensions: 0,
			NumServices:   0,
