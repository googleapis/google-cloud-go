...
func ExampleClient_GetProduct() {
	...
	req := &productspb.GetProductRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/shopping/merchant/products/apiv1/productspb#GetProductRequest.
	}
...
func ExampleClient_ListProducts() {
	...
	req := &productspb.ListProductsRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/shopping/merchant/products/apiv1/productspb#ListProductsRequest.
	}
