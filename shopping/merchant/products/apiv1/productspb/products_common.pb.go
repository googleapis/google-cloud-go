...
// information.
type ProductAttributes_VehicleBodyStyle int32

const (
	// Unspecified vehicle body style.
	ProductAttributes_VEHICLE_BODY_STYLE_UNSPECIFIED ProductAttributes_VehicleBodyStyle = 0
	// ATV Sport.
	ProductAttributes_ATV_SPORT ProductAttributes_VehicleBodyStyle = 1
	// ATV Touring.
	ProductAttributes_ATV_TOURING ProductAttributes_VehicleBodyStyle = 2
	// ATV Utility.
	ProductAttributes_ATV_UTILITY ProductAttributes_VehicleBodyStyle = 3
	// ATV Youth.
	ProductAttributes_ATV_YOUTH ProductAttributes_VehicleBodyStyle = 4
	// City car.
	ProductAttributes_CITY_CAR ProductAttributes_VehicleBodyStyle = 5
	// Class A motorhome.
	ProductAttributes_CLASS_A_MOTORHOME ProductAttributes_VehicleBodyStyle = 6
	// Class B motorhome.
	ProductAttributes_CLASS_B_MOTORHOME ProductAttributes_VehicleBodyStyle = 7
	// Class C motorhome.
	ProductAttributes_CLASS_C_MOTORHOME ProductAttributes_VehicleBodyStyle = 8
	// Compact SUV.
	ProductAttributes_COMPACT_SUV ProductAttributes_VehicleBodyStyle = 9
	// Convertible.
	ProductAttributes_CONVERTIBLE ProductAttributes_VehicleBodyStyle = 10
	// Coupe.
	ProductAttributes_COUPE ProductAttributes_VehicleBodyStyle = 11
	// Crossover.
	ProductAttributes_CROSSOVER ProductAttributes_VehicleBodyStyle = 12
	// Fifth wheel.
	ProductAttributes_FIFTH_WHEEL ProductAttributes_VehicleBodyStyle = 13
	// Full size van.
	ProductAttributes_FULL_SIZE_VAN ProductAttributes_VehicleBodyStyle = 14
	// Hatchback.
	ProductAttributes_HATCHBACK ProductAttributes_VehicleBodyStyle = 15
	// Limousine.
	ProductAttributes_LIMOUSINE ProductAttributes_VehicleBodyStyle = 16
	// Minivan.
	ProductAttributes_MINIVAN ProductAttributes_VehicleBodyStyle = 17
	// Notchback.
	ProductAttributes_NOTCHBACK ProductAttributes_VehicleBodyStyle = 18
	// Pop up camper.
	ProductAttributes_POP_UP_CAMPER ProductAttributes_VehicleBodyStyle = 19
	// Sedan.
	ProductAttributes_SEDAN ProductAttributes_VehicleBodyStyle = 20
	// Side by side.
	ProductAttributes_SIDE_BY_SIDE ProductAttributes_VehicleBodyStyle = 21
	// Station wagon.
	ProductAttributes_STATION_WAGON ProductAttributes_VehicleBodyStyle = 22
	// SUV.
	ProductAttributes_SUV ProductAttributes_VehicleBodyStyle = 23
	// Travel trailer.
	ProductAttributes_TRAVEL_TRAILER ProductAttributes_VehicleBodyStyle = 24
	// Truck.
	ProductAttributes_TRUCK ProductAttributes_VehicleBodyStyle = 25
	// Truck camper.
	ProductAttributes_TRUCK_CAMPER ProductAttributes_VehicleBodyStyle = 26
	// Ute.
	ProductAttributes_UTE ProductAttributes_VehicleBodyStyle = 27
	// UTV Recreational utility.
	ProductAttributes_UTV_RECREATIONAL_UTILITY ProductAttributes_VehicleBodyStyle = 28
	// UTV Sport.
	ProductAttributes_UTV_SPORT ProductAttributes_VehicleBodyStyle = 29
	// UTV Utility.
	ProductAttributes_UTV_UTILITY ProductAttributes_VehicleBodyStyle = 30
	// UTV Youth.
	ProductAttributes_UTV_YOUTH ProductAttributes_VehicleBodyStyle = 31
)

// Enum value maps for ProductAttributes_VehicleBodyStyle.
var (
	ProductAttributes_VehicleBodyStyle_name = map[int32]string{
		0:  "VEHICLE_BODY_STYLE_UNSPECIFIED",
		1:  "ATV_SPORT",
		2:  "ATV_TOURING",
		3:  "ATV_UTILITY",
		4:  "ATV_YOUTH",
		...
		26: "TRUCK_CAMPER",
		27: "UTE",
		28: "UTV_RECREATIONAL_UTILITY",
		29: "UTV_SPORT",
		30: "UTV_UTILITY",
		31: "UTV_YOUTH",
	}
	ProductAttributes_VehicleBodyStyle_value = map[string]int32{
...
func (x ProductAttributes_VehicleBodyStyle) Enum() *ProductAttributes_VehicleBodyStyle {
	p := new(ProductAttributes_VehicleBodyStyle)
	*p = x
	return p
}

func (x ProductAttributes_VehicleBodyStyle) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ProductAttributes_VehicleBodyStyle) Descriptor() protoreflect.EnumDescriptor {
	return file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[17].Descriptor()
}

func (ProductAttributes_VehicleBodyStyle) Type() protoreflect.EnumType {
	return &file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[17]
}

func (x ProductAttributes_VehicleBodyStyle) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProductAttributes_VehicleBodyStyle.Descriptor instead.
func (ProductAttributes_VehicleBodyStyle) EnumDescriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 1}
}

// The engine type of the vehicle.
type ProductAttributes_EngineType int32

const (
	// Unspecified engine type.
	ProductAttributes_ENGINE_TYPE_UNSPECIFIED ProductAttributes_EngineType = 0
	// Gasoline.
	ProductAttributes_GASOLINE ProductAttributes_EngineType = 1
	// Diesel.
	ProductAttributes_DIESEL ProductAttributes_EngineType = 2
	// Electric.
	ProductAttributes_ELECTRIC ProductAttributes_EngineType = 3
	// Hybrid.
	ProductAttributes_HYBRID ProductAttributes_EngineType = 4
	// Plug-in hybrid.
	ProductAttributes_PLUG_IN_HYBRID ProductAttributes_EngineType = 5
	// Natural gas.
	ProductAttributes_NATURAL_GAS ProductAttributes_EngineType = 6
	// LPG.
	ProductAttributes_LPG ProductAttributes_EngineType = 7
	// Methane.
	ProductAttributes_METHANE ProductAttributes_EngineType = 8
	// Other.
	ProductAttributes_OTHER ProductAttributes_EngineType = 9
)

// Enum value maps for ProductAttributes_EngineType.
var (
	ProductAttributes_EngineType_name = map[int32]string{
	...
	ProductAttributes_EngineType_value = map[string]int32{
...
func (x ProductAttributes_EngineType) Enum() *ProductAttributes_EngineType {
	p := new(ProductAttributes_EngineType)
	*p = x
	return p
}

func (x ProductAttributes_EngineType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ProductAttributes_EngineType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[18].Descriptor()
}

func (ProductAttributes_EngineType) Type() protoreflect.EnumType {
	return &file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[18]
}

func (x ProductAttributes_EngineType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProductAttributes_EngineType.Descriptor instead.
func (ProductAttributes_EngineType) EnumDescriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 2}
}

// The emission standard of the vehicle.
type ProductAttributes_EmissionsStandard int32

const (
	// Unspecified emission standard.
	ProductAttributes_EMISSIONS_STANDARD_UNSPECIFIED ProductAttributes_EmissionsStandard = 0
	// Zero emissions.
	ProductAttributes_ZERO_EMISSIONS ProductAttributes_EmissionsStandard = 1
	// Euro 1.
	ProductAttributes_EURO1 ProductAttributes_EmissionsStandard = 2
	// Euro 2.
	ProductAttributes_EURO2 ProductAttributes_EmissionsStandard = 3
	// Euro 3.
	ProductAttributes_EURO3 ProductAttributes_EmissionsStandard = 4
	// Euro 4.
	ProductAttributes_EURO4 ProductAttributes_EmissionsStandard = 5
	// Euro 5.
	ProductAttributes_EURO5 ProductAttributes_EmissionsStandard = 6
	// Euro 5b.
	ProductAttributes_EURO5B ProductAttributes_EmissionsStandard = 7
	// Euro 6.
	ProductAttributes_EURO6 ProductAttributes_EmissionsStandard = 8
	// Euro 6c.
	ProductAttributes_EURO6C ProductAttributes_EmissionsStandard = 9
	// Euro 6d.
	ProductAttributes_EURO6D ProductAttributes_EmissionsStandard = 10
	// Euro 6d-TEMP.
	ProductAttributes_EURO6D_TEMP ProductAttributes_EmissionsStandard = 11
	// Euro 6e.
	ProductAttributes_EURO6E ProductAttributes_EmissionsStandard = 12
)

// Enum value maps for ProductAttributes_EmissionsStandard.
var (
	ProductAttributes_EmissionsStandard_name = map[int32]string{
		0:  "EMISSIONS_STANDARD_UNSPECIFIED",
		1:  "ZERO_EMISSIONS",
		2:  "EURO1",
		3:  "EURO2",
		4:  "EURO3",
	...
	ProductAttributes_EmissionsStandard_value = map[string]int32{
...
func (x ProductAttributes_EmissionsStandard) Enum() *ProductAttributes_EmissionsStandard {
	p := new(ProductAttributes_EmissionsStandard)
	*p = x
	return p
}

func (x ProductAttributes_EmissionsStandard) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ProductAttributes_EmissionsStandard) Descriptor() protoreflect.EnumDescriptor {
	return file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[19].Descriptor()
}

func (ProductAttributes_EmissionsStandard) Type() protoreflect.EnumType {
	return &file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[19]
}

func (x ProductAttributes_EmissionsStandard) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProductAttributes_EmissionsStandard.Descriptor instead.
func (ProductAttributes_EmissionsStandard) EnumDescriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 3}
}

// The vehicle price type.
type ProductAttributes_VehiclePriceType int32

const (
	// Unspecified vehicle price type.
	ProductAttributes_VEHICLE_PRICE_TYPE_UNSPECIFIED ProductAttributes_VehiclePriceType = 0
	// All in price.
	ProductAttributes_ALL_IN_PRICE ProductAttributes_VehiclePriceType = 1
	// Drive away price.
	ProductAttributes_DRIVE_AWAY_PRICE ProductAttributes_VehiclePriceType = 2
	// Estimated drive away price.
	ProductAttributes_ESTIMATED_DRIVE_AWAY_PRICE ProductAttributes_VehiclePriceType = 3
	// Excluding government charges price.
	ProductAttributes_EXCLUDING_GOVERNMENT_CHARGES_PRICE ProductAttributes_VehiclePriceType = 4
	// Vehicle base price.
	ProductAttributes_VEHICLE_BASE_PRICE ProductAttributes_VehiclePriceType = 5
)

// Enum value maps for ProductAttributes_VehiclePriceType.
var (
	ProductAttributes_VehiclePriceType_name = map[int32]string{
		0: "VEHICLE_PRICE_TYPE_UNSPECIFIED",
		1: "ALL_IN_PRICE",
		2: "DRIVE_AWAY_PRICE",
		3: "ESTIMATED_DRIVE_AWAY_PRICE",
		4: "EXCLUDING_GOVERNMENT_CHARGES_PRICE",
		5: "VEHICLE_BASE_PRICE",
	}
	ProductAttributes_VehiclePriceType_value = map[string]int32{
...
func (x ProductAttributes_VehiclePriceType) Enum() *ProductAttributes_VehiclePriceType {
	p := new(ProductAttributes_VehiclePriceType)
	*p = x
	return p
}

func (x ProductAttributes_VehiclePriceType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ProductAttributes_VehiclePriceType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[20].Descriptor()
}

func (ProductAttributes_VehiclePriceType) Type() protoreflect.EnumType {
	return &file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[20]
}

func (x ProductAttributes_VehiclePriceType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProductAttributes_VehiclePriceType.Descriptor instead.
func (ProductAttributes_VehiclePriceType) EnumDescriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 4}
}

// The property type.
type ProductAttributes_PropertyType int32

const (
	// Unspecified property type.
	ProductAttributes_PROPERTY_TYPE_UNSPECIFIED ProductAttributes_PropertyType = 0
	// Apartment.
	ProductAttributes_APARTMENT ProductAttributes_PropertyType = 1
	// Condo.
	ProductAttributes_CONDO ProductAttributes_PropertyType = 2
	// Loft.
	ProductAttributes_LOFT ProductAttributes_PropertyType = 3
	// Multi-family home.
	ProductAttributes_MULTI_FAMILY_HOME ProductAttributes_PropertyType = 4
	// Penthouse.
	ProductAttributes_PENTHOUSE ProductAttributes_PropertyType = 5
	// Room.
	ProductAttributes_ROOM ProductAttributes_PropertyType = 6
	// Single-family home.
	ProductAttributes_SINGLE_FAMILY_HOME ProductAttributes_PropertyType = 7
	// Studio.
	ProductAttributes_STUDIO ProductAttributes_PropertyType = 8
	// Townhouse.
	ProductAttributes_TOWNHOUSE ProductAttributes_PropertyType = 9
)

// Enum value maps for ProductAttributes_PropertyType.
var (
	ProductAttributes_PropertyType_name = map[int32]string{
		...
		5: "PENTHOUSE",
		6: "ROOM",
		7: "SINGLE_FAMILY_HOME",
		8: "STUDIO",
		9: "TOWNHOUSE",
	}
	ProductAttributes_PropertyType_value = map[string]int32{
...
func (x ProductAttributes_PropertyType) Enum() *ProductAttributes_PropertyType {
	p := new(ProductAttributes_PropertyType)
	*p = x
	return p
}

func (x ProductAttributes_PropertyType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ProductAttributes_PropertyType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[21].Descriptor()
}

func (ProductAttributes_PropertyType) Type() protoreflect.EnumType {
	return &file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[21]
}

func (x ProductAttributes_PropertyType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProductAttributes_PropertyType.Descriptor instead.
func (ProductAttributes_PropertyType) EnumDescriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 5}
}

// The amenity features for the property.
type ProductAttributes_AmenityFeature int32

const (
	// Unspecified amenity feature.
	ProductAttributes_AMENITY_FEATURE_UNSPECIFIED ProductAttributes_AmenityFeature = 0
	// Balcony.
	ProductAttributes_BALCONY ProductAttributes_AmenityFeature = 1
	// Basement.
	ProductAttributes_BASEMENT ProductAttributes_AmenityFeature = 2
	// Basketball court.
	ProductAttributes_BASKETBALL_COURT ProductAttributes_AmenityFeature = 3
	// Bike storage.
	ProductAttributes_BIKE_STORAGE ProductAttributes_AmenityFeature = 4
	// Central air conditioning.
	ProductAttributes_CENTRAL_AC ProductAttributes_AmenityFeature = 5
	// Dishwasher.
	ProductAttributes_DISHWASHER ProductAttributes_AmenityFeature = 6
	// Dog park.
	ProductAttributes_DOG_PARK ProductAttributes_AmenityFeature = 7
	// Elevator.
	ProductAttributes_ELEVATOR ProductAttributes_AmenityFeature = 8
	// EV charging.
	ProductAttributes_EV_CHARGING ProductAttributes_AmenityFeature = 9
	// Fenced lot.
	ProductAttributes_FENCED_LOT ProductAttributes_AmenityFeature = 10
	// Fireplace.
	ProductAttributes_FIREPLACE ProductAttributes_AmenityFeature = 11
	// Fitness center.
	ProductAttributes_FITNESS_CENTER ProductAttributes_AmenityFeature = 12
	// Forced air heating.
	ProductAttributes_FORCED_AIR_HEATING ProductAttributes_AmenityFeature = 13
	// Fully furnished.
	ProductAttributes_FULLY_FURNISHED ProductAttributes_AmenityFeature = 14
	// Garage.
	ProductAttributes_GARAGE ProductAttributes_AmenityFeature = 15
	// Gated community.
	ProductAttributes_GATED_COMMUNITY ProductAttributes_AmenityFeature = 16
	// Hardwood floors.
	ProductAttributes_HARDWOOD_FLOORS ProductAttributes_AmenityFeature = 17
	// High speed internet.
	ProductAttributes_HIGH_SPEED_INTERNET ProductAttributes_AmenityFeature = 18
	// Intercom.
	ProductAttributes_INTERCOM ProductAttributes_AmenityFeature = 19
	// In-unit washer and dryer.
	ProductAttributes_IN_UNIT_WASHER_DRYER ProductAttributes_AmenityFeature = 20
	// Kitchen.
	ProductAttributes_KITCHEN ProductAttributes_AmenityFeature = 21
	// Large closets.
	ProductAttributes_LARGE_CLOSETS ProductAttributes_AmenityFeature = 22
	// Multisport court.
	ProductAttributes_MULTISPORT_COURT ProductAttributes_AmenityFeature = 23
	// Onsite laundry.
	ProductAttributes_ONSITE_LAUNDRY ProductAttributes_AmenityFeature = 24
	// Outdoor lounge.
	ProductAttributes_OUTDOOR_LOUNGE ProductAttributes_AmenityFeature = 25
	// Parking.
	ProductAttributes_PARKING ProductAttributes_AmenityFeature = 26
	// Patio.
	ProductAttributes_PATIO ProductAttributes_AmenityFeature = 27
	// Pickleball court.
	ProductAttributes_PICKLEBALL_COURT ProductAttributes_AmenityFeature = 28
	// Pool.
	ProductAttributes_POOL ProductAttributes_AmenityFeature = 29
	// Refrigerator.
	ProductAttributes_REFRIGERATOR ProductAttributes_AmenityFeature = 30
	// Soccer field.
	ProductAttributes_SOCCER_FIELD ProductAttributes_AmenityFeature = 31
	// Tennis court.
	ProductAttributes_TENNIS_COURT ProductAttributes_AmenityFeature = 32
	// Walk-in closets.
	ProductAttributes_WALK_IN_CLOSETS ProductAttributes_AmenityFeature = 33
	// Wheelchair accessibility.
	ProductAttributes_WHEELCHAIR_ACCESS ProductAttributes_AmenityFeature = 34
)

// Enum value maps for ProductAttributes_AmenityFeature.
var (
	ProductAttributes_AmenityFeature_name = map[int32]string{
		0:  "AMENITY_FEATURE_UNSPECIFIED",
		1:  "BALCONY",
		2:  "BASEMENT",
		3:  "BASKETBALL_COURT",
		4:  "BIKE_STORAGE",
		...
		11: "FIREPLACE",
		12: "FITNESS_CENTER",
		13: "FORCED_AIR_HEATING",
		14: "FULLY_FURNISHED",
		15: "GARAGE",
		16: "GATED_COMMUNITY",
		17: "HARDWOOD_FLOORS",
		18: "HIGH_SPEED_INTERNET",
		19: "INTERCOM",
		20: "IN_UNIT_WASHER_DRYER",
		21: "KITCHEN",
		22: "LARGE_CLOSETS",
		23: "MULTISPORT_COURT",
		24: "ONSITE_LAUNDRY",
		...
		32: "TENNIS_COURT",
		33: "WALK_IN_CLOSETS",
		34: "WHEELCHAIR_ACCESS",
	}
	ProductAttributes_AmenityFeature_value = map[string]int32{
...
func (x ProductAttributes_AmenityFeature) Enum() *ProductAttributes_AmenityFeature {
	p := new(ProductAttributes_AmenityFeature)
	*p = x
	return p
}

func (x ProductAttributes_AmenityFeature) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ProductAttributes_AmenityFeature) Descriptor() protoreflect.EnumDescriptor {
	return file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[22].Descriptor()
}

func (ProductAttributes_AmenityFeature) Type() protoreflect.EnumType {
	return &file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[22]
}

func (x ProductAttributes_AmenityFeature) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProductAttributes_AmenityFeature.Descriptor instead.
func (ProductAttributes_AmenityFeature) EnumDescriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 6}
}

// The utilities included for the property.
type ProductAttributes_UtilitiesIncluded int32

const (
	// Unspecified utilities included.
	ProductAttributes_UTILITIES_INCLUDED_UNSPECIFIED ProductAttributes_UtilitiesIncluded = 0
	// Electricity.
	ProductAttributes_ELECTRICITY ProductAttributes_UtilitiesIncluded = 1
	// Gas.
	ProductAttributes_GAS ProductAttributes_UtilitiesIncluded = 2
	// Internet.
	ProductAttributes_INTERNET ProductAttributes_UtilitiesIncluded = 3
	// Trash.
	ProductAttributes_TRASH ProductAttributes_UtilitiesIncluded = 4
	// Water.
	ProductAttributes_WATER ProductAttributes_UtilitiesIncluded = 5
)

// Enum value maps for ProductAttributes_UtilitiesIncluded.
var (
	ProductAttributes_UtilitiesIncluded_name = map[int32]string{
		0: "UTILITIES_INCLUDED_UNSPECIFIED",
		1: "ELECTRICITY",
		2: "GAS",
		3: "INTERNET",
		4: "TRASH",
	...
	ProductAttributes_UtilitiesIncluded_value = map[string]int32{
...
func (x ProductAttributes_UtilitiesIncluded) Enum() *ProductAttributes_UtilitiesIncluded {
	p := new(ProductAttributes_UtilitiesIncluded)
	*p = x
	return p
}

func (x ProductAttributes_UtilitiesIncluded) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ProductAttributes_UtilitiesIncluded) Descriptor() protoreflect.EnumDescriptor {
	return file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[23].Descriptor()
}

func (ProductAttributes_UtilitiesIncluded) Type() protoreflect.EnumType {
	return &file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[23]
}

func (x ProductAttributes_UtilitiesIncluded) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProductAttributes_UtilitiesIncluded.Descriptor instead.
func (ProductAttributes_UtilitiesIncluded) EnumDescriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 7}
}

// The specialty housing type for the property.
type ProductAttributes_SpecialtyHousingType int32

const (
	// Unspecified specialty housing type.
	ProductAttributes_SPECIALTY_HOUSING_TYPE_UNSPECIFIED ProductAttributes_SpecialtyHousingType = 0
	// Corporate housing.
	ProductAttributes_CORPORATE ProductAttributes_SpecialtyHousingType = 1
	// Low income housing.
	ProductAttributes_LOW_INCOME ProductAttributes_SpecialtyHousingType = 2
	// Military housing.
	ProductAttributes_MILITARY ProductAttributes_SpecialtyHousingType = 3
	// Senior housing.
	ProductAttributes_SENIOR ProductAttributes_SpecialtyHousingType = 4
	// Short term housing.
	ProductAttributes_SHORT_TERM ProductAttributes_SpecialtyHousingType = 5
	// Student housing.
	ProductAttributes_STUDENT ProductAttributes_SpecialtyHousingType = 6
)

// Enum value maps for ProductAttributes_SpecialtyHousingType.
var (
	ProductAttributes_SpecialtyHousingType_name = map[int32]string{
		0: "SPECIALTY_HOUSING_TYPE_UNSPECIFIED",
		1: "CORPORATE",
		2: "LOW_INCOME",
		3: "MILITARY",
		4: "SENIOR",
	...
	ProductAttributes_SpecialtyHousingType_value = map[string]int32{
...
func (x ProductAttributes_SpecialtyHousingType) Enum() *ProductAttributes_SpecialtyHousingType {
	p := new(ProductAttributes_SpecialtyHousingType)
	*p = x
	return p
}

func (x ProductAttributes_SpecialtyHousingType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ProductAttributes_SpecialtyHousingType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[24].Descriptor()
}

func (ProductAttributes_SpecialtyHousingType) Type() protoreflect.EnumType {
	return &file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[24]
}

func (x ProductAttributes_SpecialtyHousingType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProductAttributes_SpecialtyHousingType.Descriptor instead.
func (ProductAttributes_SpecialtyHousingType) EnumDescriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 8}
}

// The unit of the mileage.
type ProductAttributes_Mileage_Unit int32

const (
	// Unspecified unit.
	ProductAttributes_Mileage_UNIT_UNSPECIFIED ProductAttributes_Mileage_Unit = 0
	// Miles.
	ProductAttributes_Mileage_MILES ProductAttributes_Mileage_Unit = 1
	// Kilometers.
	ProductAttributes_Mileage_KM ProductAttributes_Mileage_Unit = 2
)

// Enum value maps for ProductAttributes_Mileage_Unit.
var (
	ProductAttributes_Mileage_Unit_name = map[int32]string{
		0: "UNIT_UNSPECIFIED",
		1: "MILES",
		2: "KM",
	}
	ProductAttributes_Mileage_Unit_value = map[string]int32{
		"UNIT_UNSPECIFIED": 0,
		"MILES":            1,
		"KM":               2,
	}
...
func (x ProductAttributes_Mileage_Unit) Enum() *ProductAttributes_Mileage_Unit {
	p := new(ProductAttributes_Mileage_Unit)
	*p = x
	return p
}

func (x ProductAttributes_Mileage_Unit) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ProductAttributes_Mileage_Unit) Descriptor() protoreflect.EnumDescriptor {
	return file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[25].Descriptor()
}

func (ProductAttributes_Mileage_Unit) Type() protoreflect.EnumType {
	return &file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[25]
}

func (x ProductAttributes_Mileage_Unit) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProductAttributes_Mileage_Unit.Descriptor instead.
func (ProductAttributes_Mileage_Unit) EnumDescriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 2, 0}
}

// The unit of the fuel consumption.
type ProductAttributes_FuelConsumption_Unit int32

const (
	// Unspecified unit.
	ProductAttributes_FuelConsumption_UNIT_UNSPECIFIED ProductAttributes_FuelConsumption_Unit = 0
	// Liter per 100 kilometers.
	ProductAttributes_FuelConsumption_LPER100KM ProductAttributes_FuelConsumption_Unit = 1
	// Kilograms per 100 kilometers.
	ProductAttributes_FuelConsumption_KGPER100KM ProductAttributes_FuelConsumption_Unit = 2
)

// Enum value maps for ProductAttributes_FuelConsumption_Unit.
var (
	ProductAttributes_FuelConsumption_Unit_name = map[int32]string{
		0: "UNIT_UNSPECIFIED",
		1: "LPER100KM",
		2: "KGPER100KM",
	}
	ProductAttributes_FuelConsumption_Unit_value = map[string]int32{
		"UNIT_UNSPECIFIED": 0,
		"LPER100KM":        1,
		"KGPER100KM":       2,
	}
...
func (x ProductAttributes_FuelConsumption_Unit) Enum() *ProductAttributes_FuelConsumption_Unit {
	p := new(ProductAttributes_FuelConsumption_Unit)
	*p = x
	return p
}

func (x ProductAttributes_FuelConsumption_Unit) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ProductAttributes_FuelConsumption_Unit) Descriptor() protoreflect.EnumDescriptor {
	return file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[26].Descriptor()
}

func (ProductAttributes_FuelConsumption_Unit) Type() protoreflect.EnumType {
	return &file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[26]
}

func (x ProductAttributes_FuelConsumption_Unit) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProductAttributes_FuelConsumption_Unit.Descriptor instead.
func (ProductAttributes_FuelConsumption_Unit) EnumDescriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 3, 0}
}

// The unit of the energy consumption.
type ProductAttributes_EnergyConsumption_Unit int32

const (
	// Unspecified unit.
	ProductAttributes_EnergyConsumption_UNIT_UNSPECIFIED ProductAttributes_EnergyConsumption_Unit = 0
	// Kilowatt hours per 100 kilometers.
	ProductAttributes_EnergyConsumption_KWHPER100KM ProductAttributes_EnergyConsumption_Unit = 1
)

// Enum value maps for ProductAttributes_EnergyConsumption_Unit.
var (
	ProductAttributes_EnergyConsumption_Unit_name = map[int32]string{
		0: "UNIT_UNSPECIFIED",
		1: "KWHPER100KM",
	}
	ProductAttributes_EnergyConsumption_Unit_value = map[string]int32{
		"UNIT_UNSPECIFIED": 0,
		"KWHPER100KM":      1,
	}
)

func (x ProductAttributes_EnergyConsumption_Unit) Enum() *ProductAttributes_EnergyConsumption_Unit {
	p := new(ProductAttributes_EnergyConsumption_Unit)
	*p = x
	return p
}

func (x ProductAttributes_EnergyConsumption_Unit) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ProductAttributes_EnergyConsumption_Unit) Descriptor() protoreflect.EnumDescriptor {
	return file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[27].Descriptor()
}

func (ProductAttributes_EnergyConsumption_Unit) Type() protoreflect.EnumType {
	return &file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[27]
}

func (x ProductAttributes_EnergyConsumption_Unit) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProductAttributes_EnergyConsumption_Unit.Descriptor instead.
func (ProductAttributes_EnergyConsumption_Unit) EnumDescriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 4, 0}
}

// The unit of the co2 emission.
type ProductAttributes_Co2Emissions_Unit int32

const (
	// Unspecified unit.
	ProductAttributes_Co2Emissions_UNIT_UNSPECIFIED ProductAttributes_Co2Emissions_Unit = 0
	// Grams per kilometer.
	ProductAttributes_Co2Emissions_GPERKM ProductAttributes_Co2Emissions_Unit = 1
)

// Enum value maps for ProductAttributes_Co2Emissions_Unit.
var (
	ProductAttributes_Co2Emissions_Unit_name = map[int32]string{
		0: "UNIT_UNSPECIFIED",
		1: "GPERKM",
	}
	ProductAttributes_Co2Emissions_Unit_value = map[string]int32{
		"UNIT_UNSPECIFIED": 0,
		"GPERKM":           1,
	}
)

func (x ProductAttributes_Co2Emissions_Unit) Enum() *ProductAttributes_Co2Emissions_Unit {
	p := new(ProductAttributes_Co2Emissions_Unit)
	*p = x
	return p
}

func (x ProductAttributes_Co2Emissions_Unit) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ProductAttributes_Co2Emissions_Unit) Descriptor() protoreflect.EnumDescriptor {
	return file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[28].Descriptor()
}

func (ProductAttributes_Co2Emissions_Unit) Type() protoreflect.EnumType {
	return &file_google_shopping_merchant_products_v1_products_common_proto_enumTypes[28]
}

func (x ProductAttributes_Co2Emissions_Unit) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProductAttributes_Co2Emissions_Unit.Descriptor instead.
func (ProductAttributes_Co2Emissions_Unit) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	ProductAttributes_ProductFee_FEE_TYPE_UNSPECIFIED ProductAttributes_ProductFee_FeeType = 0
	// Admin fee.
	ProductAttributes_ProductFee_ADMIN_FEE ProductAttributes_ProductFee_FeeType = 1
	// Application fee.
	ProductAttributes_ProductFee_APPLICATION_FEE ProductAttributes_ProductFee_FeeType = 2
	// Security deposit.
	ProductAttributes_ProductFee_SECURITY_DEPOSIT ProductAttributes_ProductFee_FeeType = 3
)

// Enum value maps for ProductAttributes_ProductFee_FeeType.
var (
	ProductAttributes_ProductFee_FeeType_name = map[int32]string{
		0: "FEE_TYPE_UNSPECIFIED",
		1: "ADMIN_FEE",
		2: "APPLICATION_FEE",
		3: "SECURITY_DEPOSIT",
	}
	ProductAttributes_ProductFee_FeeType_value = map[string]int32{
...
func (x ProductAttributes_ProductFee_FeeType) Enum() *ProductAttributes_ProductFee_FeeType {
	p := new(ProductAttributes_ProductFee_FeeType)
	*p = x
	return p
}

func (x ProductAttributes_ProductFee_FeeType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
// Deprecated: Use ProductAttributes_ProductFee_FeeType.Descriptor instead.
func (ProductAttributes_ProductFee_FeeType) EnumDescriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 7, 0}
}

// The unit of area.
type ProductAttributes_UnitArea_Unit int32

const (
	// Unspecified unit.
	ProductAttributes_UnitArea_UNIT_UNSPECIFIED ProductAttributes_UnitArea_Unit = 0
	// Square meters.
	ProductAttributes_UnitArea_SQM ProductAttributes_UnitArea_Unit = 1
	// Square feet.
	ProductAttributes_UnitArea_SQFT ProductAttributes_UnitArea_Unit = 2
)

// Enum value maps for ProductAttributes_UnitArea_Unit.
var (
	ProductAttributes_UnitArea_Unit_name = map[int32]string{
		0: "UNIT_UNSPECIFIED",
		1: "SQM",
		2: "SQFT",
	}
	ProductAttributes_UnitArea_Unit_value = map[string]int32{
		"UNIT_UNSPECIFIED": 0,
		"SQM":              1,
		"SQFT":             2,
	}
...
func (x ProductAttributes_UnitArea_Unit) Enum() *ProductAttributes_UnitArea_Unit {
	p := new(ProductAttributes_UnitArea_Unit)
	*p = x
	return p
}

func (x ProductAttributes_UnitArea_Unit) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
// Deprecated: Use ProductAttributes_UnitArea_Unit.Descriptor instead.
func (ProductAttributes_UnitArea_Unit) EnumDescriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 9, 0}
}

// The pet types.
type ProductAttributes_PetPolicy_PetType int32

const (
	// Unspecified pet type.
	ProductAttributes_PetPolicy_PET_TYPE_UNSPECIFIED ProductAttributes_PetPolicy_PetType = 0
	// Cats.
	ProductAttributes_PetPolicy_CATS ProductAttributes_PetPolicy_PetType = 1
	// Large dogs.
	ProductAttributes_PetPolicy_LARGE_DOGS ProductAttributes_PetPolicy_PetType = 2
	// Small dogs.
	ProductAttributes_PetPolicy_SMALL_DOGS ProductAttributes_PetPolicy_PetType = 3
)

// Enum value maps for ProductAttributes_PetPolicy_PetType.
var (
	ProductAttributes_PetPolicy_PetType_name = map[int32]string{
		0: "PET_TYPE_UNSPECIFIED",
		1: "CATS",
		2: "LARGE_DOGS",
		3: "SMALL_DOGS",
	}
	ProductAttributes_PetPolicy_PetType_value = map[string]int32{
...
func (x ProductAttributes_PetPolicy_PetType) Enum() *ProductAttributes_PetPolicy_PetType {
	p := new(ProductAttributes_PetPolicy_PetType)
	*p = x
	return p
}

func (x ProductAttributes_PetPolicy_PetType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
// related product.
type ProductAttributes_RelatedProduct_RelationshipType int32

const (
	// The relationship type is unspecified.
	ProductAttributes_RelatedProduct_RELATIONSHIP_TYPE_UNSPECIFIED ProductAttributes_RelatedProduct_RelationshipType = 0
	// Part of a set of products that are often purchased together.
	ProductAttributes_RelatedProduct_PART_OF_SET ProductAttributes_RelatedProduct_RelationshipType = 1
	// Part that is necessary for the product to function, for example a
	// battery for a battery-operated lamp.
	ProductAttributes_RelatedProduct_REQUIRED_PART ProductAttributes_RelatedProduct_RelationshipType = 2
	// A product that this product is often purchased together with, for
	// example a phone case with a phone.
	ProductAttributes_RelatedProduct_OFTEN_BOUGHT_WITH ProductAttributes_RelatedProduct_RelationshipType = 3
	// Product that this product can be substituted for. For example a printer
	// comparable in function to another printer.
	ProductAttributes_RelatedProduct_SUBSTITUTE ProductAttributes_RelatedProduct_RelationshipType = 4
	// An identical product sold under a different brand, for example a
	// cheaper house brand.
	ProductAttributes_RelatedProduct_DIFFERENT_BRAND ProductAttributes_RelatedProduct_RelationshipType = 5
	// An accessory to this product, for example a side table that matches the
	// style of a couch.
	ProductAttributes_RelatedProduct_ACCESSORY ProductAttributes_RelatedProduct_RelationshipType = 6
)

// Enum value maps for ProductAttributes_RelatedProduct_RelationshipType.
var (
	ProductAttributes_RelatedProduct_RelationshipType_name = map[int32]string{
	...
	ProductAttributes_RelatedProduct_RelationshipType_value = map[string]int32{
...
func (x ProductAttributes_RelatedProduct_RelationshipType) Enum() *ProductAttributes_RelatedProduct_RelationshipType {
	p := new(ProductAttributes_RelatedProduct_RelationshipType)
	*p = x
	return p
}

func (x ProductAttributes_RelatedProduct_RelationshipType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
type ProductAttributes_RelatedProduct_IdType int32

const (
	// The identifier type is unspecified.
	ProductAttributes_RelatedProduct_ID_TYPE_UNSPECIFIED ProductAttributes_RelatedProduct_IdType = 0
	// The identifier is a GTIN.
	ProductAttributes_RelatedProduct_GTIN ProductAttributes_RelatedProduct_IdType = 1
	// The identifier is a product ID in the feed.
	ProductAttributes_RelatedProduct_ID ProductAttributes_RelatedProduct_IdType = 2
)

// Enum value maps for ProductAttributes_RelatedProduct_IdType.
var (
	ProductAttributes_RelatedProduct_IdType_name = map[int32]string{
		0: "ID_TYPE_UNSPECIFIED",
		1: "GTIN",
		2: "ID",
	}
	ProductAttributes_RelatedProduct_IdType_value = map[string]int32{
...
func (x ProductAttributes_RelatedProduct_IdType) Enum() *ProductAttributes_RelatedProduct_IdType {
	p := new(ProductAttributes_RelatedProduct_IdType)
	*p = x
	return p
}

func (x ProductAttributes_RelatedProduct_IdType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
type ProductMinimumOrderValue_Surface int32

const (
	// Surface is unspecified.
	ProductMinimumOrderValue_SURFACE_UNSPECIFIED ProductMinimumOrderValue_Surface = 0
	// Surface value to indicate online purchases.
	ProductMinimumOrderValue_ONLINE ProductMinimumOrderValue_Surface = 1
	// Surface value to indicate local purchases.
	ProductMinimumOrderValue_LOCAL ProductMinimumOrderValue_Surface = 2
	// Surface value to indicate online and local purchases.
	ProductMinimumOrderValue_ONLINE_LOCAL ProductMinimumOrderValue_Surface = 3
)

// Enum value maps for ProductMinimumOrderValue_Surface.
var (
	ProductMinimumOrderValue_Surface_name = map[int32]string{
		0: "SURFACE_UNSPECIFIED",
		1: "ONLINE",
		2: "LOCAL",
		3: "ONLINE_LOCAL",
	}
	ProductMinimumOrderValue_Surface_value = map[string]int32{
...
func (x ProductMinimumOrderValue_Surface) Enum() *ProductMinimumOrderValue_Surface {
	p := new(ProductMinimumOrderValue_Surface)
	*p = x
	return p
}

func (x ProductMinimumOrderValue_Surface) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
// Deprecated: Use ProductMinimumOrderValue_Surface.Descriptor instead.
func (ProductMinimumOrderValue_Surface) EnumDescriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{23, 0}
}
...
type ProductAttributes struct {
	...
	PickupCost *PickupCost `protobuf:"bytes,172,opt,name=pickup_cost,json=pickupCost,proto3,oneof" json:"pickup_cost,omitempty"`
	...
	// vehicle.
	Vin string `protobuf:"bytes,147,opt,name=vin,proto3" json:"vin,omitempty"`
	// The [Model](https://support.google.com/google-ads/answer/14154511) of the
	// vehicle, such as `LX`, `EX`, and others.
	Model string `protobuf:"bytes,148,opt,name=model,proto3" json:"model,omitempty"`
	// The [Trim](https://support.google.com/google-ads/answer/14154176) of the
	// vehicle model, such as `S`, `SV`, `SL` and others.
	Trim string `protobuf:"bytes,149,opt,name=trim,proto3" json:"trim,omitempty"`
	// The [body style](https://support.google.com/google-ads/answer/14157085) of
	// the vehicle.
	BodyStyle ProductAttributes_VehicleBodyStyle `protobuf:"varint,150,opt,name=body_style,json=bodyStyle,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_VehicleBodyStyle" json:"body_style,omitempty"`
	// The [Year](https://support.google.com/google-ads/answer/14152816) of the
	// vehicle model.
	Year int64 `protobuf:"varint,151,opt,name=year,proto3" json:"year,omitempty"`
	// The number of miles/kms on the vehicle. See the
	// [Mileage](https://support.google.com/google-ads/answer/14156166) for more
	// information.
	Mileage *ProductAttributes_Mileage `protobuf:"bytes,152,opt,name=mileage,proto3" json:"mileage,omitempty"`
	// The [electric range](https://support.google.com/google-ads/answer/15162232)
	// of the vehicle in miles/kms.
	ElectricRange *ProductAttributes_Mileage `protobuf:"bytes,153,opt,name=electric_range,json=electricRange,proto3" json:"electric_range,omitempty"`
	// The [fuel
	// consumption](https://support.google.com/google-ads/answer/14543580) of the
	// vehicle.
	FuelConsumption *ProductAttributes_FuelConsumption `protobuf:"bytes,154,opt,name=fuel_consumption,json=fuelConsumption,proto3" json:"fuel_consumption,omitempty"`
	...
	// information.
	FuelConsumptionDischargedBattery *ProductAttributes_FuelConsumption `protobuf:"bytes,155,opt,name=fuel_consumption_discharged_battery,json=fuelConsumptionDischargedBattery,proto3" json:"fuel_consumption_discharged_battery,omitempty"`
	// The [energy
	// consumption](https://support.google.com/google-ads/answer/14546149) of the
	// vehicle.
	EnergyConsumption *ProductAttributes_EnergyConsumption `protobuf:"bytes,156,opt,name=energy_consumption,json=energyConsumption,proto3" json:"energy_consumption,omitempty"`
	// The [co2 emission](https://support.google.com/google-ads/answer/14546146)
	// of the vehicle.
	Co2Emissions *ProductAttributes_Co2Emissions `protobuf:"bytes,157,opt,name=co2_emissions,json=co2Emissions,proto3" json:"co2_emissions,omitempty"`
	...
	// information.
	DateFirstRegistered string `protobuf:"bytes,158,opt,name=date_first_registered,json=dateFirstRegistered,proto3" json:"date_first_registered,omitempty"`
	// The [engine](https://support.google.com/google-ads/answer/14156068) type of
	// the vehicle.
	Engine ProductAttributes_EngineType `protobuf:"varint,159,opt,name=engine,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_EngineType" json:"engine,omitempty"`
	// The [emission
	// standard](https://support.google.com/google-ads/answer/14869021) of the
	// vehicle.
	EmissionsStandard ProductAttributes_EmissionsStandard `protobuf:"varint,160,opt,name=emissions_standard,json=emissionsStandard,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_EmissionsStandard" json:"emissions_standard,omitempty"`
	// Whether the vehicle is OEM [certified
	// pre-owned](https://support.google.com/google-ads/answer/14156475).
	CertifiedPreOwned bool `protobuf:"varint,161,opt,name=certified_pre_owned,json=certifiedPreOwned,proto3" json:"certified_pre_owned,omitempty"`
	...
	// information.
	VehicleMsrp *typepb.Price `protobuf:"bytes,162,opt,name=vehicle_msrp,json=vehicleMsrp,proto3" json:"vehicle_msrp,omitempty"`
	...
	// information.
	VehicleAllInPrice *typepb.Price `protobuf:"bytes,163,opt,name=vehicle_all_in_price,json=vehicleAllInPrice,proto3" json:"vehicle_all_in_price,omitempty"`
	// The [price type](https://support.google.com/google-ads/answer/14592783) of
	// the vehicle.
	VehiclePriceType ProductAttributes_VehiclePriceType `protobuf:"varint,164,opt,name=vehicle_price_type,json=vehiclePriceType,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_VehiclePriceType" json:"vehicle_price_type,omitempty"`
	...
	// information.`
	VehicleMandatoryInspectionIncluded bool `protobuf:"varint,166,opt,name=vehicle_mandatory_inspection_included,json=vehicleMandatoryInspectionIncluded,proto3" json:"vehicle_mandatory_inspection_included,omitempty"`
	...
	Latitude *float64 `protobuf:"fixed64,180,opt,name=latitude,proto3,oneof" json:"latitude,omitempty"`
	// The longitude of the property. The value must be between -180 (inclusive)
	// and 180 (inclusive), up to 6 decimal places.
	Longitude *float64 `protobuf:"fixed64,181,opt,name=longitude,proto3,oneof" json:"longitude,omitempty"`
	// The neighborhood (locality) of the property, such as `Wallingford`,
	// `Greenwood`, etc.
	Neighborhood string `protobuf:"bytes,182,opt,name=neighborhood,proto3" json:"neighborhood,omitempty"`
	// The unit area of the property, such as `1000 sqft`.
	UnitArea *ProductAttributes_UnitArea `protobuf:"bytes,183,opt,name=unit_area,json=unitArea,proto3" json:"unit_area,omitempty"`
	// The number of units available for a specific floor plan of the property.
	// The value must be greater than 0.
	NumberOfUnits *int64 `protobuf:"varint,184,opt,name=number_of_units,json=numberOfUnits,proto3,oneof" json:"number_of_units,omitempty"`
	// The name of the property.
	PropertyName string `protobuf:"bytes,185,opt,name=property_name,json=propertyName,proto3" json:"property_name,omitempty"`
	// The number of bedrooms in the property. The value must be greater than or
	// equal to 0 and a multiple of 1.0.
	NumberOfBedrooms *float64 `protobuf:"fixed64,186,opt,name=number_of_bedrooms,json=numberOfBedrooms,proto3,oneof" json:"number_of_bedrooms,omitempty"`
	// The number of bathrooms in the property. The value must be greater than 0
	// and a multiple of 0.5.
	NumberOfBathrooms *float64 `protobuf:"fixed64,187,opt,name=number_of_bathrooms,json=numberOfBathrooms,proto3,oneof" json:"number_of_bathrooms,omitempty"`
	// The type of property.
	PropertyType ProductAttributes_PropertyType `protobuf:"varint,188,opt,name=property_type,json=propertyType,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_PropertyType" json:"property_type,omitempty"`
	// The amenity features for the property.
	AmenityFeature []ProductAttributes_AmenityFeature `protobuf:"varint,189,rep,packed,name=amenity_feature,json=amenityFeature,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_AmenityFeature" json:"amenity_feature,omitempty"`
	// The utilities included for the property.
	UtilitiesIncluded []ProductAttributes_UtilitiesIncluded `protobuf:"varint,190,rep,packed,name=utilities_included,json=utilitiesIncluded,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_UtilitiesIncluded" json:"utilities_included,omitempty"`
	// The pet policy for the property.
	PetPolicy *ProductAttributes_PetPolicy `protobuf:"bytes,191,opt,name=pet_policy,json=petPolicy,proto3" json:"pet_policy,omitempty"`
	// The specialty housing type for the property.
	SpecialtyHousingType ProductAttributes_SpecialtyHousingType `protobuf:"varint,192,opt,name=specialty_housing_type,json=specialtyHousingType,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_SpecialtyHousingType" json:"specialty_housing_type,omitempty"`
	...
	// characters.
	QuestionsAndAnswers []*ProductAttributes_QuestionAndAnswer `protobuf:"bytes,173,rep,name=questions_and_answers,json=questionsAndAnswers,proto3" json:"questions_and_answers,omitempty"`
	...
	// (highest).
	PopularityRank float32 `protobuf:"fixed32,174,opt,name=popularity_rank,json=popularityRank,proto3" json:"popularity_rank,omitempty"`
	...
	ItemGroupTitle string `protobuf:"bytes,175,opt,name=item_group_title,json=itemGroupTitle,proto3" json:"item_group_title,omitempty"`
	...
	DocumentLinks []string `protobuf:"bytes,176,rep,name=document_links,json=documentLinks,proto3" json:"document_links,omitempty"`
	// Optional. Contains the [list of all variant-identifying
	// options](https://support.google.com/merchants/answer/17085214) of this
	// product.
	VariantOptions []*ProductAttributes_VariantOption `protobuf:"bytes,177,rep,name=variant_options,json=variantOptions,proto3" json:"variant_options,omitempty"`
	// Optional. Specifies how other [products are
	// related](https://support.google.com/merchants/answer/17085213) to this
	// product.
	RelatedProducts []*ProductAttributes_RelatedProduct `protobuf:"bytes,178,rep,name=related_products,json=relatedProducts,proto3" json:"related_products,omitempty"`
...
func (x *ProductAttributes) GetPickupCost() *PickupCost {
	if x != nil {
		return x.PickupCost
	}
	return nil
...
func (x *ProductAttributes) GetMinimumOrderValues() []*ProductMinimumOrderValue {
	if x != nil {
		return x.MinimumOrderValues
	}
	return nil
}
...
func (x *ProductAttributes) GetTrim() string {
	if x != nil {
		return x.Trim
	}
	return ""
...
func (x *ProductAttributes) GetBodyStyle() ProductAttributes_VehicleBodyStyle {
	if x != nil {
		return x.BodyStyle
	}
	return ProductAttributes_VEHICLE_BODY_STYLE_UNSPECIFIED
}

func (x *ProductAttributes) GetYear() int64 {
	if x != nil {
		return x.Year
	}
	return 0
...
func (x *ProductAttributes) GetMileage() *ProductAttributes_Mileage {
	if x != nil {
		return x.Mileage
	}
	return nil
...
func (x *ProductAttributes) GetElectricRange() *ProductAttributes_Mileage {
	if x != nil {
		return x.ElectricRange
	}
	return nil
}

func (x *ProductAttributes) GetFuelConsumption() *ProductAttributes_FuelConsumption {
	if x != nil {
...
func (x *ProductAttributes) GetFuelConsumptionDischargedBattery() *ProductAttributes_FuelConsumption {
	if x != nil {
		return x.FuelConsumptionDischargedBattery
	}
	return nil
}

func (x *ProductAttributes) GetEnergyConsumption() *ProductAttributes_EnergyConsumption {
	if x != nil {
...
func (x *ProductAttributes) GetCo2Emissions() *ProductAttributes_Co2Emissions {
	if x != nil {
...
func (x *ProductAttributes) GetDateFirstRegistered() string {
	if x != nil {
		return x.DateFirstRegistered
	}
	return ""
}

func (x *ProductAttributes) GetEngine() ProductAttributes_EngineType {
	if x != nil {
		return x.Engine
	}
	return ProductAttributes_ENGINE_TYPE_UNSPECIFIED
}

func (x *ProductAttributes) GetEmissionsStandard() ProductAttributes_EmissionsStandard {
	if x != nil {
		return x.EmissionsStandard
	}
	return ProductAttributes_EMISSIONS_STANDARD_UNSPECIFIED
}

func (x *ProductAttributes) GetCertifiedPreOwned() bool {
	if x != nil {
		return x.CertifiedPreOwned
	}
	return false
}

func (x *ProductAttributes) GetVehicleMsrp() *typepb.Price {
	if x != nil {
		return x.VehicleMsrp
	}
	return nil
}

func (x *ProductAttributes) GetVehicleAllInPrice() *typepb.Price {
	if x != nil {
		return x.VehicleAllInPrice
	}
	return nil
}

func (x *ProductAttributes) GetVehiclePriceType() ProductAttributes_VehiclePriceType {
	if x != nil {
		return x.VehiclePriceType
	}
	return ProductAttributes_VEHICLE_PRICE_TYPE_UNSPECIFIED
}

func (x *ProductAttributes) GetVehicleMandatoryInspectionIncluded() bool {
	if x != nil {
		return x.VehicleMandatoryInspectionIncluded
	}
	return false
}

func (x *ProductAttributes) GetVehicleExpenses() *typepb.Price {
	if x != nil {
		return x.VehicleExpenses
	}
	return nil
}
...
func (x *ProductAttributes) GetDisplayAddress() *ProductAttributes_DisplayAddress {
	if x != nil {
...
func (x *ProductAttributes) GetLatitude() float64 {
...
func (x *ProductAttributes) GetLongitude() float64 {
...
func (x *ProductAttributes) GetNeighborhood() string {
	if x != nil {
...
func (x *ProductAttributes) GetUnitArea() *ProductAttributes_UnitArea {
	if x != nil {
		return x.UnitArea
	}
	return nil
...
func (x *ProductAttributes) GetNumberOfUnits() int64 {
	if x != nil && x.NumberOfUnits != nil {
		return *x.NumberOfUnits
	}
	return 0
}

func (x *ProductAttributes) GetPropertyName() string {
	if x != nil {
...
func (x *ProductAttributes) GetNumberOfBedrooms() float64 {
	if x != nil && x.NumberOfBedrooms != nil {
		return *x.NumberOfBedrooms
	}
	return 0
}

func (x *ProductAttributes) GetNumberOfBathrooms() float64 {
	if x != nil && x.NumberOfBathrooms != nil {
		return *x.NumberOfBathrooms
	}
	return 0
}

func (x *ProductAttributes) GetPropertyType() ProductAttributes_PropertyType {
	if x != nil {
		return x.PropertyType
	}
	return ProductAttributes_PROPERTY_TYPE_UNSPECIFIED
}

func (x *ProductAttributes) GetAmenityFeature() []ProductAttributes_AmenityFeature {
	if x != nil {
		return x.AmenityFeature
	}
	return nil
}

func (x *ProductAttributes) GetUtilitiesIncluded() []ProductAttributes_UtilitiesIncluded {
	if x != nil {
		return x.UtilitiesIncluded
	}
	return nil
}

func (x *ProductAttributes) GetPetPolicy() *ProductAttributes_PetPolicy {
	if x != nil {
		return x.PetPolicy
	}
	return nil
...
func (x *ProductAttributes) GetSpecialtyHousingType() ProductAttributes_SpecialtyHousingType {
	if x != nil {
		return x.SpecialtyHousingType
	}
	return ProductAttributes_SPECIALTY_HOUSING_TYPE_UNSPECIFIED
}

func (x *ProductAttributes) GetProductFee() []*ProductAttributes_ProductFee {
	if x != nil {
		return x.ProductFee
	}
	return nil
...
func (x *ProductAttributes) GetShortTitle() string {
...
func (x *ProductAttributes) GetPopularityRank() float32 {
	if x != nil {
...
func (x *ProductAttributes) GetItemGroupTitle() string {
	if x != nil {
		return x.ItemGroupTitle
	}
	return ""
}

func (x *ProductAttributes) GetDocumentLinks() []string {
	if x != nil {
...
func (x *ProductAttributes) GetVariantOptions() []*ProductAttributes_VariantOption {
	if x != nil {
...
func (x *ProductAttributes) GetRelatedProducts() []*ProductAttributes_RelatedProduct {
	if x != nil {
...
func (x *ProductInstallment) GetTotalAmount() *typepb.Price {
	if x != nil {
...
type Shipping struct {
	...
	// specified tier.
	LoyaltyProgramLabel string `protobuf:"bytes,14,opt,name=loyalty_program_label,json=loyaltyProgramLabel,proto3" json:"loyalty_program_label,omitempty"`
	// Optional. The label of the [loyalty
	...
	// this shipping option is only applicable to loyalty program members of the
	// specified tier.
	LoyaltyTierLabel string `protobuf:"bytes,15,opt,name=loyalty_tier_label,json=loyaltyTierLabel,proto3" json:"loyalty_tier_label,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *Shipping) GetLoyaltyProgramLabel() string {
	if x != nil {
		return x.LoyaltyProgramLabel
	}
	return ""
}

func (x *Shipping) GetLoyaltyTierLabel() string {
	if x != nil {
		return x.LoyaltyTierLabel
	}
	return ""
}
...
func (x *ProductSustainabilityIncentive) GetValue() isProductSustainabilityIncentive_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *ProductSustainabilityIncentive) GetAmount() *typepb.Price {
	if x != nil {
		if x, ok := x.Value.(*ProductSustainabilityIncentive_Amount); ok {
			return x.Amount
		}
	}
	return nil
...
func (x *ProductSustainabilityIncentive) GetPercentage() float64 {
	if x != nil {
		if x, ok := x.Value.(*ProductSustainabilityIncentive_Percentage); ok {
			return x.Percentage
		}
	}
	return 0
...
type PickupCost struct {
	...
	FlatRate *typepb.Price `protobuf:"bytes,1,opt,name=flat_rate,json=flatRate,proto3,oneof" json:"flat_rate,omitempty"`
	// Optional. The price threshold above which pickup is free of charge.
	FreeThreshold *typepb.Price `protobuf:"bytes,2,opt,name=free_threshold,json=freeThreshold,proto3,oneof" json:"free_threshold,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PickupCost) Reset() {
	*x = PickupCost{}
...
func (x *PickupCost) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PickupCost) ProtoMessage() {}

func (x *PickupCost) ProtoReflect() protoreflect.Message {
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PickupCost.ProtoReflect.Descriptor instead.
func (*PickupCost) Descriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{21}
}

func (x *PickupCost) GetFlatRate() *typepb.Price {
	if x != nil {
		return x.FlatRate
	}
	return nil
...
func (x *PickupCost) GetFreeThreshold() *typepb.Price {
	if x != nil {
...
func (*HandlingCutoffTime) Descriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{22}
}
...
type ProductMinimumOrderValue struct {
	...
	Surface *ProductMinimumOrderValue_Surface `protobuf:"varint,3,opt,name=surface,proto3,enum=google.shopping.merchant.products.v1.ProductMinimumOrderValue_Surface,oneof" json:"surface,omitempty"`
	// Required. The minimum cart or basket value before the checkout is
	// permitted.
	Price         *typepb.Price `protobuf:"bytes,4,opt,name=price,proto3,oneof" json:"price,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ProductMinimumOrderValue) Reset() {
	*x = ProductMinimumOrderValue{}
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProductMinimumOrderValue) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductMinimumOrderValue) ProtoMessage() {}

func (x *ProductMinimumOrderValue) ProtoReflect() protoreflect.Message {
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductMinimumOrderValue.ProtoReflect.Descriptor instead.
func (*ProductMinimumOrderValue) Descriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{23}
}

func (x *ProductMinimumOrderValue) GetCountry() string {
	if x != nil && x.Country != nil {
		return *x.Country
	}
	return ""
...
func (x *ProductMinimumOrderValue) GetService() string {
...
func (x *ProductMinimumOrderValue) GetSurface() ProductMinimumOrderValue_Surface {
	if x != nil && x.Surface != nil {
		return *x.Surface
	}
	return ProductMinimumOrderValue_SURFACE_UNSPECIFIED
}

func (x *ProductMinimumOrderValue) GetPrice() *typepb.Price {
	if x != nil {
		return x.Price
	}
	return nil
...
type ProductAttributes_Mileage struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The distance value.
	Value *int64 `protobuf:"varint,1,opt,name=value,proto3,oneof" json:"value,omitempty"`
	// The unit of the mileage.
	Unit          ProductAttributes_Mileage_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_Mileage_Unit" json:"unit,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ProductAttributes_Mileage) Reset() {
	*x = ProductAttributes_Mileage{}
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProductAttributes_Mileage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductAttributes_Mileage) ProtoMessage() {}

func (x *ProductAttributes_Mileage) ProtoReflect() protoreflect.Message {
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[26]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductAttributes_Mileage.ProtoReflect.Descriptor instead.
func (*ProductAttributes_Mileage) Descriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 2}
}

func (x *ProductAttributes_Mileage) GetValue() int64 {
...
func (x *ProductAttributes_Mileage) GetUnit() ProductAttributes_Mileage_Unit {
	if x != nil {
		return x.Unit
	}
	return ProductAttributes_Mileage_UNIT_UNSPECIFIED
}

// The fuel consumption of the vehicle.
type ProductAttributes_FuelConsumption struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The fuel consumption value.
	Value *float64 `protobuf:"fixed64,1,opt,name=value,proto3,oneof" json:"value,omitempty"`
	// The unit of the fuel consumption.
	Unit          ProductAttributes_FuelConsumption_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_FuelConsumption_Unit" json:"unit,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ProductAttributes_FuelConsumption) Reset() {
	*x = ProductAttributes_FuelConsumption{}
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProductAttributes_FuelConsumption) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductAttributes_FuelConsumption) ProtoMessage() {}

func (x *ProductAttributes_FuelConsumption) ProtoReflect() protoreflect.Message {
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[27]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductAttributes_FuelConsumption.ProtoReflect.Descriptor instead.
func (*ProductAttributes_FuelConsumption) Descriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 3}
}

func (x *ProductAttributes_FuelConsumption) GetValue() float64 {
	if x != nil && x.Value != nil {
		return *x.Value
	}
	return 0
...
func (x *ProductAttributes_FuelConsumption) GetUnit() ProductAttributes_FuelConsumption_Unit {
	if x != nil {
		return x.Unit
	}
	return ProductAttributes_FuelConsumption_UNIT_UNSPECIFIED
}

// The energy consumption of the vehicle.
type ProductAttributes_EnergyConsumption struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The energy consumption value.
	Value *float64 `protobuf:"fixed64,1,opt,name=value,proto3,oneof" json:"value,omitempty"`
	// The unit of the energy consumption.
	Unit          ProductAttributes_EnergyConsumption_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_EnergyConsumption_Unit" json:"unit,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ProductAttributes_EnergyConsumption) Reset() {
	*x = ProductAttributes_EnergyConsumption{}
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProductAttributes_EnergyConsumption) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductAttributes_EnergyConsumption) ProtoMessage() {}

func (x *ProductAttributes_EnergyConsumption) ProtoReflect() protoreflect.Message {
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[28]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductAttributes_EnergyConsumption.ProtoReflect.Descriptor instead.
func (*ProductAttributes_EnergyConsumption) Descriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 4}
}

func (x *ProductAttributes_EnergyConsumption) GetValue() float64 {
	if x != nil && x.Value != nil {
		return *x.Value
	}
	return 0
...
func (x *ProductAttributes_EnergyConsumption) GetUnit() ProductAttributes_EnergyConsumption_Unit {
	if x != nil {
		return x.Unit
	}
	return ProductAttributes_EnergyConsumption_UNIT_UNSPECIFIED
}

// The co2 emission of the vehicle.
type ProductAttributes_Co2Emissions struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The co2 emission value.
	Value *int64 `protobuf:"varint,1,opt,name=value,proto3,oneof" json:"value,omitempty"`
	// The unit of the co2 emission.
	Unit          ProductAttributes_Co2Emissions_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_Co2Emissions_Unit" json:"unit,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ProductAttributes_Co2Emissions) Reset() {
	*x = ProductAttributes_Co2Emissions{}
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProductAttributes_Co2Emissions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductAttributes_Co2Emissions) ProtoMessage() {}

func (x *ProductAttributes_Co2Emissions) ProtoReflect() protoreflect.Message {
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[29]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductAttributes_Co2Emissions.ProtoReflect.Descriptor instead.
func (*ProductAttributes_Co2Emissions) Descriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 5}
}

func (x *ProductAttributes_Co2Emissions) GetValue() int64 {
	if x != nil && x.Value != nil {
		return *x.Value
	}
	return 0
...
func (x *ProductAttributes_Co2Emissions) GetUnit() ProductAttributes_Co2Emissions_Unit {
	if x != nil {
		return x.Unit
	}
	return ProductAttributes_Co2Emissions_UNIT_UNSPECIFIED
}
...
func (x *ProductAttributes_Warranty) Reset() {
	*x = ProductAttributes_Warranty{}
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProductAttributes_Warranty) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductAttributes_Warranty) ProtoMessage() {}

func (x *ProductAttributes_Warranty) ProtoReflect() protoreflect.Message {
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[30]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductAttributes_Warranty.ProtoReflect.Descriptor instead.
func (*ProductAttributes_Warranty) Descriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 6}
}

func (x *ProductAttributes_Warranty) GetDuration() int64 {
	if x != nil {
		return x.Duration
	}
	return 0
...
func (x *ProductAttributes_Warranty) GetMileage() *ProductAttributes_Mileage {
	if x != nil {
		return x.Mileage
	}
	return nil
...
type ProductAttributes_ProductFee struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The type of product fee.
	Type ProductAttributes_ProductFee_FeeType `protobuf:"varint,1,opt,name=type,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_ProductFee_FeeType" json:"type,omitempty"`
...
func (x *ProductAttributes_ProductFee) Reset() {
	*x = ProductAttributes_ProductFee{}
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProductAttributes_ProductFee) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductAttributes_ProductFee) ProtoMessage() {}

func (x *ProductAttributes_ProductFee) ProtoReflect() protoreflect.Message {
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[31]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductAttributes_ProductFee.ProtoReflect.Descriptor instead.
func (*ProductAttributes_ProductFee) Descriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 7}
}

func (x *ProductAttributes_ProductFee) GetType() ProductAttributes_ProductFee_FeeType {
	if x != nil {
		return x.Type
	}
	return ProductAttributes_ProductFee_FEE_TYPE_UNSPECIFIED
}

func (x *ProductAttributes_ProductFee) GetAmount() *typepb.Price {
	if x != nil {
		return x.Amount
	}
	return nil
...
// The display address of the property.
type ProductAttributes_DisplayAddress struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The street number.
...
func (x *ProductAttributes_DisplayAddress) Reset() {
	*x = ProductAttributes_DisplayAddress{}
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProductAttributes_DisplayAddress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductAttributes_DisplayAddress) ProtoMessage() {}

func (x *ProductAttributes_DisplayAddress) ProtoReflect() protoreflect.Message {
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[32]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductAttributes_DisplayAddress.ProtoReflect.Descriptor instead.
func (*ProductAttributes_DisplayAddress) Descriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 8}
}

func (x *ProductAttributes_DisplayAddress) GetStreetNumber() string {
	if x != nil {
...
func (x *ProductAttributes_DisplayAddress) GetStreetName() string {
	if x != nil {
		return x.StreetName
	}
	return ""
...
func (x *ProductAttributes_DisplayAddress) GetCity() string {
	if x != nil {
		return x.City
	}
	return ""
...
func (x *ProductAttributes_DisplayAddress) GetRegion() string {
	if x != nil {
		return x.Region
	}
	return ""
...
func (x *ProductAttributes_DisplayAddress) GetPostalCode() string {
	if x != nil {
		return x.PostalCode
	}
	return ""
...
type ProductAttributes_UnitArea struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The area value.
	Value *float64 `protobuf:"fixed64,1,opt,name=value,proto3,oneof" json:"value,omitempty"`
	// The unit of area.
	Unit          ProductAttributes_UnitArea_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_UnitArea_Unit" json:"unit,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ProductAttributes_UnitArea) Reset() {
	*x = ProductAttributes_UnitArea{}
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProductAttributes_UnitArea) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductAttributes_UnitArea) ProtoMessage() {}

func (x *ProductAttributes_UnitArea) ProtoReflect() protoreflect.Message {
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[33]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductAttributes_UnitArea.ProtoReflect.Descriptor instead.
func (*ProductAttributes_UnitArea) Descriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 9}
}

func (x *ProductAttributes_UnitArea) GetValue() float64 {
	if x != nil && x.Value != nil {
		return *x.Value
	}
	return 0
...
func (x *ProductAttributes_UnitArea) GetUnit() ProductAttributes_UnitArea_Unit {
	if x != nil {
		return x.Unit
	}
	return ProductAttributes_UnitArea_UNIT_UNSPECIFIED
}

// The pet policy of the property.
type ProductAttributes_PetPolicy struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Whether pets are allowed.
	PetsAllowed bool `protobuf:"varint,1,opt,name=pets_allowed,json=petsAllowed,proto3" json:"pets_allowed,omitempty"`
	// The pet types allowed.
	PetTypes      []ProductAttributes_PetPolicy_PetType `protobuf:"varint,2,rep,packed,name=pet_types,json=petTypes,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_PetPolicy_PetType" json:"pet_types,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ProductAttributes_PetPolicy) Reset() {
	*x = ProductAttributes_PetPolicy{}
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProductAttributes_PetPolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductAttributes_PetPolicy) ProtoMessage() {}

func (x *ProductAttributes_PetPolicy) ProtoReflect() protoreflect.Message {
	mi := &file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[34]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductAttributes_PetPolicy.ProtoReflect.Descriptor instead.
func (*ProductAttributes_PetPolicy) Descriptor() ([]byte, []int) {
	return file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP(), []int{0, 10}
}

func (x *ProductAttributes_PetPolicy) GetPetsAllowed() bool {
	if x != nil {
...
func (x *ProductAttributes_PetPolicy) GetPetTypes() []ProductAttributes_PetPolicy_PetType {
	if x != nil {
		return x.PetTypes
	}
	return nil
...
func (x *ProductAttributes_QuestionAndAnswer) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ProductAttributes_QuestionAndAnswer) GetAnswer() string {
	if x != nil {
		return x.Answer
	}
	return ""
...
type ProductAttributes_VariantOption struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ProductAttributes_VariantOption) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ProductAttributes_VariantOption) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
type ProductAttributes_RelatedProduct struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Required. The type of the relationship between this product and the
	// related product.
	RelationshipType ProductAttributes_RelatedProduct_RelationshipType `protobuf:"varint,1,opt,name=relationship_type,json=relationshipType,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_RelatedProduct_RelationshipType" json:"relationship_type,omitempty"`
	...
	IdType ProductAttributes_RelatedProduct_IdType `protobuf:"varint,2,opt,name=id_type,json=idType,proto3,enum=google.shopping.merchant.products.v1.ProductAttributes_RelatedProduct_IdType" json:"id_type,omitempty"`
...
func (x *ProductAttributes_RelatedProduct) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ProductAttributes_RelatedProduct) GetRelationshipType() ProductAttributes_RelatedProduct_RelationshipType {
	...
	return ProductAttributes_RelatedProduct_RELATIONSHIP_TYPE_UNSPECIFIED
}

func (x *ProductAttributes_RelatedProduct) GetIdType() ProductAttributes_RelatedProduct_IdType {
	if x != nil {
		return x.IdType
	}
	return ProductAttributes_RelatedProduct_ID_TYPE_UNSPECIFIED
}

func (x *ProductAttributes_RelatedProduct) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
const file_google_shopping_merchant_products_v1_products_common_proto_rawDesc = "" +
	...
	"\x05title\x18\x06 \x01(\tH\x02R\x05title\x88\x01\x01\x12%\n" +
	"\vdescription\x18\a \x01(\tH\x03R\vdescription\x88\x01\x01\x12\x17\n" +
	"\x04link\x18\b \x01(\tH\x04R\x04link\x88\x01\x01\x12$\n" +
	"\vmobile_link\x18\t \x01(\tH\x05R\n" +
	"mobileLink\x88\x01\x01\x12*\n" +
	"\x0ecanonical_link\x18\n" +
	" \x01(\tH\x06R\rcanonicalLink\x88\x01\x01\x12\"\n" +
	"\n" +
	"image_link\x18\v \x01(\tH\aR\timageLink\x88\x01\x01\x124\n" +
	"\x16additional_image_links\x18\f \x03(\tR\x14additionalImageLinks\x12C\n" +
	"\x0fexpiration_date\x18\x10 \x01(\v2\x1a.google.protobuf.TimestampR\x0eexpirationDate\x12C\n" +
	"\x0fdisclosure_date\x18O \x01(\v2\x1a.google.protobuf.TimestampR\x0edisclosureDate\x12\x19\n" +
	"\x05adult\x18\x11 \x01(\bH\bR\x05adult\x88\x01\x01\x12P\n" +
	"\tage_group\x18\x12 \x01(\x0e2..google.shopping.merchant.products.v1.AgeGroupH\tR\bageGroup\x88\x01\x01\x12[\n" +
	"\favailability\x18\x13 \x01(\x0e22.google.shopping.merchant.products.v1.AvailabilityH\n" +
	"R\favailability\x88\x01\x01\x12G\n" +
	"\x11availability_date\x18\x14 \x01(\v2\x1a.google.protobuf.TimestampR\x10availabilityDate\x12\x19\n" +
	"\x05brand\x18\x15 \x01(\tH\vR\x05brand\x88\x01\x01\x12\x19\n" +
	"\x05color\x18\x16 \x01(\tH\fR\x05color\x88\x01\x01\x12R\n" +
	"\tcondition\x18\x17 \x01(\x0e2/.google.shopping.merchant.products.v1.ConditionH\rR\tcondition\x88\x01\x01\x12I\n" +
	"\x06gender\x18\x18 \x01(\x0e2,.google.shopping.merchant.products.v1.GenderH\x0eR\x06gender\x88\x01\x01\x12;\n" +
	"\x17google_product_category\x18\x19 \x01(\tH\x0fR\x15googleProductCategory\x88\x01\x01\x12\x15\n" +
	"\x05gtins\x18\x8c\x01 \x03(\tR\x05gtins\x12'\n" +
	"\ritem_group_id\x18\x1b \x01(\tH\x10R\vitemGroupId\x88\x01\x01\x12\x1f\n" +
	"\bmaterial\x18\x1c \x01(\tH\x11R\bmaterial\x88\x01\x01\x12\x15\n" +
	"\x03mpn\x18\x1d \x01(\tH\x12R\x03mpn\x88\x01\x01\x12\x1d\n" +
	"\apattern\x18\x1e \x01(\tH\x13R\apattern\x88\x01\x01\x121\n" +
	"\x05price\x18\x1f \x01(\v2\x1b.google.shopping.type.PriceR\x05price\x12N\n" +
	"\x14maximum_retail_price\x18\x8b\x01 \x01(\v2\x1b.google.shopping.type.PriceR\x12maximumRetailPrice\x12Z\n" +
	"\vinstallment\x18  \x01(\v28.google.shopping.merchant.products.v1.ProductInstallmentR\vinstallment\x12c\n" +
	"\x11subscription_cost\x18! \x01(\v26.google.shopping.merchant.products.v1.SubscriptionCostR\x10subscriptionCost\x12Z\n" +
	"\x0eloyalty_points\x18\" \x01(\v23.google.shopping.merchant.products.v1.LoyaltyPointsR\rloyaltyPoints\x12`\n" +
	"\x10loyalty_programs\x18\x88\x01 \x03(\v24.google.shopping.merchant.products.v1.LoyaltyProgramR\x0floyaltyPrograms\x12#\n" +
	"\rproduct_types\x18# \x03(\tR\fproductTypes\x12:\n" +
	"\n" +
	"sale_price\x18$ \x01(\v2\x1b.google.shopping.type.PriceR\tsalePrice\x12P\n" +
	"\x19sale_price_effective_date\x18% \x01(\v2\x15.google.type.IntervalR\x16salePriceEffectiveDate\x12:\n" +
	"\x17sell_on_google_quantity\x18& \x01(\x03H\x14R\x14sellOnGoogleQuantity\x88\x01\x01\x12]\n" +
	"\x0eproduct_height\x18w \x01(\v26.google.shopping.merchant.products.v1.ProductDimensionR\rproductHeight\x12]\n" +
	"\x0eproduct_length\x18x \x01(\v26.google.shopping.merchant.products.v1.ProductDimensionR\rproductLength\x12[\n" +
	"\rproduct_width\x18y \x01(\v26.google.shopping.merchant.products.v1.ProductDimensionR\fproductWidth\x12Z\n" +
	"\x0eproduct_weight\x18z \x01(\v23.google.shopping.merchant.products.v1.ProductWeightR\rproductWeight\x12J\n" +
	"\bshipping\x18' \x03(\v2..google.shopping.merchant.products.v1.ShippingR\bshipping\x12s\n" +
	"\x10carrier_shipping\x18\x8e\x01 \x03(\v2G.google.shopping.merchant.products.v1.ProductAttributes.CarrierShippingR\x0fcarrierShipping\x12t\n" +
	"\x17free_shipping_threshold\x18\x87\x01 \x03(\v2;.google.shopping.merchant.products.v1.FreeShippingThresholdR\x15freeShippingThreshold\x12]\n" +
	"\x0fshipping_weight\x18( \x01(\v24.google.shopping.merchant.products.v1.ShippingWeightR\x0eshippingWeight\x12`\n" +
	"\x0fshipping_length\x18) \x01(\v27.google.shopping.merchant.products.v1.ShippingDimensionR\x0eshippingLength\x12^\n" +
	"\x0eshipping_width\x18* \x01(\v27.google.shopping.merchant.products.v1.ShippingDimensionR\rshippingWidth\x12`\n" +
	"\x0fshipping_height\x18+ \x01(\v27.google.shopping.merchant.products.v1.ShippingDimensionR\x0eshippingHeight\x12/\n" +
	"\x11max_handling_time\x18, \x01(\x03H\x15R\x0fmaxHandlingTime\x88\x01\x01\x12/\n" +
	"\x11min_handling_time\x18- \x01(\x03H\x16R\x0fminHandlingTime\x88\x01\x01\x12\x9a\x01\n" +
	...
	"\vpickup_cost\x18\xac\x01 \x01(\v20.google.shopping.merchant.products.v1.PickupCostB\x03\xe0A\x01H(R\n" +
	"pickupCost\x88\x01\x01\x12(\n" +
	...
	"\x12external_seller_id\x18\x01 \x01(\tH0R\x10externalSellerId\x88\x01\x01\x12F\n" +
	"\x05pause\x18\r \x01(\x0e2+.google.shopping.merchant.products.v1.PauseH1R\x05pause\x88\x01\x01\x122\n" +
	...
	"\x12virtual_model_link\x18\x82\x01 \x01(\tH2R\x10virtualModelLink\x88\x01\x01\x12b\n" +
	"\x0ecertifications\x18{ \x03(\v2:.google.shopping.merchant.products.v1.ProductCertificationR\x0ecertifications\x12f\n" +
	"\x10structured_title\x18\x84\x01 \x01(\v25.google.shopping.merchant.products.v1.StructuredTitleH3R\x0fstructuredTitle\x88\x01\x01\x12x\n" +
	"\x16structured_description\x18\x85\x01 \x01(\v2;.google.shopping.merchant.products.v1.StructuredDescriptionH4R\x15structuredDescription\x88\x01\x01\x12P\n" +
	...
	"\n" +
	"body_style\x18\x96\x01 \x01(\x0e2H.google.shopping.merchant.products.v1.ProductAttributes.VehicleBodyStyleR\tbodyStyle\x12\x13\n" +
	"\x04year\x18\x97\x01 \x01(\x03R\x04year\x12Z\n" +
	"\amileage\x18\x98\x01 \x01(\v2?.google.shopping.merchant.products.v1.ProductAttributes.MileageR\amileage\x12g\n" +
	"\x0eelectric_range\x18\x99\x01 \x01(\v2?.google.shopping.merchant.products.v1.ProductAttributes.MileageR\relectricRange\x12s\n" +
	"\x10fuel_consumption\x18\x9a\x01 \x01(\v2G.google.shopping.merchant.products.v1.ProductAttributes.FuelConsumptionR\x0ffuelConsumption\x12\x97\x01\n" +
	"#fuel_consumption_discharged_battery\x18\x9b\x01 \x01(\v2G.google.shopping.merchant.products.v1.ProductAttributes.FuelConsumptionR fuelConsumptionDischargedBattery\x12y\n" +
	"\x12energy_consumption\x18\x9c\x01 \x01(\v2I.google.shopping.merchant.products.v1.ProductAttributes.EnergyConsumptionR\x11energyConsumption\x12j\n" +
	"\rco2_emissions\x18\x9d\x01 \x01(\v2D.google.shopping.merchant.products.v1.ProductAttributes.Co2EmissionsR\fco2Emissions\x123\n" +
	"\x15date_first_registered\x18\x9e\x01 \x01(\tR\x13dateFirstRegistered\x12[\n" +
	"\x06engine\x18\x9f\x01 \x01(\x0e2B.google.shopping.merchant.products.v1.ProductAttributes.EngineTypeR\x06engine\x12y\n" +
	"\x12emissions_standard\x18\xa0\x01 \x01(\x0e2I.google.shopping.merchant.products.v1.ProductAttributes.EmissionsStandardR\x11emissionsStandard\x12/\n" +
	"\x13certified_pre_owned\x18\xa1\x01 \x01(\bR\x11certifiedPreOwned\x12?\n" +
	"\fvehicle_msrp\x18\xa2\x01 \x01(\v2\x1b.google.shopping.type.PriceR\vvehicleMsrp\x12M\n" +
	...
	"\fneighborhood\x18\xb6\x01 \x01(\tR\fneighborhood\x12^\n" +
	"\tunit_area\x18\xb7\x01 \x01(\v2@.google.shopping.merchant.products.v1.ProductAttributes.UnitAreaR\bunitArea\x12,\n" +
	"\x0fnumber_of_units\x18\xb8\x01 \x01(\x03H7R\rnumberOfUnits\x88\x01\x01\x12$\n" +
	"\rproperty_name\x18\xb9\x01 \x01(\tR\fpropertyName\x122\n" +
	"\x12number_of_bedrooms\x18\xba\x01 \x01(\x01H8R\x10numberOfBedrooms\x88\x01\x01\x124\n" +
	"\x13number_of_bathrooms\x18\xbb\x01 \x01(\x01H9R\x11numberOfBathrooms\x88\x01\x01\x12j\n" +
	"\rproperty_type\x18\xbc\x01 \x01(\x0e2D.google.shopping.merchant.products.v1.ProductAttributes.PropertyTypeR\fpropertyType\x12p\n" +
	"\x0famenity_feature\x18\xbd\x01 \x03(\x0e2F.google.shopping.merchant.products.v1.ProductAttributes.AmenityFeatureR\x0eamenityFeature\x12y\n" +
	"\x12utilities_included\x18\xbe\x01 \x03(\x0e2I.google.shopping.merchant.products.v1.ProductAttributes.UtilitiesIncludedR\x11utilitiesIncluded\x12a\n" +
	"\n" +
	"pet_policy\x18\xbf\x01 \x01(\v2A.google.shopping.merchant.products.v1.ProductAttributes.PetPolicyR\tpetPolicy\x12\x83\x01\n" +
	"\x16specialty_housing_type\x18\xc0\x01 \x01(\x0e2L.google.shopping.merchant.products.v1.ProductAttributes.SpecialtyHousingTypeR\x14specialtyHousingType\x12d\n" +
	...
	"\x0edocument_links\x18\xb0\x01 \x03(\tB\x03\xe0A\x01R\rdocumentLinks\x12t\n" +
	"\x0fvariant_options\x18\xb1\x01 \x03(\v2E.google.shopping.merchant.products.v1.ProductAttributes.VariantOptionB\x03\xe0A\x01R\x0evariantOptions\x12w\n" +
	"\x10related_products\x18\xb2\x01 \x03(\v2F.google.shopping.merchant.products.v1.ProductAttributes.RelatedProductB\x03\xe0A\x01R\x0frelatedProducts\x1a\x83\x01\n" +
	...
	"\n" +
	"\b_countryB\x10\n" +
	"\x0e_business_days\x1a\x87\t\n" +
	"\x0fCarrierShipping\x12\x1d\n" +
	...
	"\x12origin_postal_code\x18\x04 \x01(\tH\x03R\x10originPostalCode\x88\x01\x01\x12?\n" +
	"\n" +
	"flat_price\x18\x05 \x01(\v2\x1b.google.shopping.type.PriceH\x04R\tflatPrice\x88\x01\x01\x12t\n" +
	"\rcarrier_price\x18\x06 \x01(\x0e2J.google.shopping.merchant.products.v1.ProductAttributes.CarrierPriceOptionH\x05R\fcarrierPrice\x88\x01\x01\x12c\n" +
	"\x1dcarrier_price_flat_adjustment\x18\a \x01(\v2\x1b.google.shopping.type.PriceH\x06R\x1acarrierPriceFlatAdjustment\x88\x01\x01\x12R\n" +
	"#carrier_price_percentage_adjustment\x18\b \x01(\x01H\aR carrierPricePercentageAdjustment\x88\x01\x01\x12/\n" +
	"\x11min_handling_time\x18\t \x01(\x03H\bR\x0fminHandlingTime\x88\x01\x01\x12/\n" +
	"\x11max_handling_time\x18\n" +
	" \x01(\x03H\tR\x0fmaxHandlingTime\x88\x01\x01\x128\n" +
	"\x16fixed_min_transit_time\x18\v \x01(\x03H\n" +
	"R\x13fixedMinTransitTime\x88\x01\x01\x128\n" +
	"\x16fixed_max_transit_time\x18\f \x01(\x03H\vR\x13fixedMaxTransitTime\x88\x01\x01\x12u\n" +
	"\x14carrier_transit_time\x18\r \x01(\x0e2>.google.shopping.merchant.products.v1.CarrierTransitTimeOptionH\fR\x12carrierTransitTime\x88\x01\x01B\n" +
	"\n" +
	"\b_countryB\t\n" +
	"\a_regionB\x0e\n" +
	"\f_postal_codeB\x15\n" +
	...
	"\x15_carrier_transit_time\x1a\xb9\x01\n" +
	"\aMileage\x12\x19\n" +
	"\x05value\x18\x01 \x01(\x03H\x00R\x05value\x88\x01\x01\x12X\n" +
	"\x04unit\x18\x02 \x01(\x0e2D.google.shopping.merchant.products.v1.ProductAttributes.Mileage.UnitR\x04unit\"/\n" +
	"\x04Unit\x12\x14\n" +
	"\x10UNIT_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05MILES\x10\x01\x12\x06\n" +
	"\x02KM\x10\x02B\b\n" +
	"\x06_value\x1a\xd5\x01\n" +
	"\x0fFuelConsumption\x12\x19\n" +
	"\x05value\x18\x01 \x01(\x01H\x00R\x05value\x88\x01\x01\x12`\n" +
	"\x04unit\x18\x02 \x01(\x0e2L.google.shopping.merchant.products.v1.ProductAttributes.FuelConsumption.UnitR\x04unit\";\n" +
	"\x04Unit\x12\x14\n" +
	"\x10UNIT_UNSPECIFIED\x10\x00\x12\r\n" +
	"\tLPER100KM\x10\x01\x12\x0e\n" +
	"\n" +
	"KGPER100KM\x10\x02B\b\n" +
	"\x06_value\x1a\xcb\x01\n" +
	"\x11EnergyConsumption\x12\x19\n" +
	"\x05value\x18\x01 \x01(\x01H\x00R\x05value\x88\x01\x01\x12b\n" +
	"\x04unit\x18\x02 \x01(\x0e2N.google.shopping.merchant.products.v1.ProductAttributes.EnergyConsumption.UnitR\x04unit\"-\n" +
	"\x04Unit\x12\x14\n" +
	"\x10UNIT_UNSPECIFIED\x10\x00\x12\x0f\n" +
	"\vKWHPER100KM\x10\x01B\b\n" +
	"\x06_value\x1a\xbc\x01\n" +
	"\fCo2Emissions\x12\x19\n" +
	"\x05value\x18\x01 \x01(\x03H\x00R\x05value\x88\x01\x01\x12]\n" +
	"\x04unit\x18\x02 \x01(\x0e2I.google.shopping.merchant.products.v1.ProductAttributes.Co2Emissions.UnitR\x04unit\"(\n" +
	"\x04Unit\x12\x14\n" +
	"\x10UNIT_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	...
	"\x06amount\x18\x02 \x01(\v2\x1b.google.shopping.type.PriceR\x06amount\"]\n" +
	"\aFeeType\x12\x18\n" +
	"\x14FEE_TYPE_UNSPECIFIED\x10\x00\x12\r\n" +
	"\tADMIN_FEE\x10\x01\x12\x13\n" +
	"\x0fAPPLICATION_FEE\x10\x02\x12\x14\n" +
	"\x10SECURITY_DEPOSIT\x10\x03\x1a\xa3\x01\n" +
	"\x0eDisplayAddress\x12#\n" +
	"\rstreet_number\x18\x01 \x01(\tR\fstreetNumber\x12\x1f\n" +
	"\vstreet_name\x18\x02 \x01(\tR\n" +
	"streetName\x12\x12\n" +
	"\x04city\x18\x03 \x01(\tR\x04city\x12\x16\n" +
	"\x06region\x18\x04 \x01(\tR\x06region\x12\x1f\n" +
	"\vpostal_code\x18\x05 \x01(\tR\n" +
	"postalCode\x1a\xbb\x01\n" +
	"\bUnitArea\x12\x19\n" +
	"\x05value\x18\x01 \x01(\x01H\x00R\x05value\x88\x01\x01\x12Y\n" +
	"\x04unit\x18\x02 \x01(\x0e2E.google.shopping.merchant.products.v1.ProductAttributes.UnitArea.UnitR\x04unit\"/\n" +
	"\x04Unit\x12\x14\n" +
	"\x10UNIT_UNSPECIFIED\x10\x00\x12\a\n" +
	"\x03SQM\x10\x01\x12\b\n" +
	"\x04SQFT\x10\x02B\b\n" +
	"\x06_value\x1a\xe5\x01\n" +
	"\tPetPolicy\x12!\n" +
	"\fpets_allowed\x18\x01 \x01(\bR\vpetsAllowed\x12f\n" +
	"\tpet_types\x18\x02 \x03(\x0e2I.google.shopping.merchant.products.v1.ProductAttributes.PetPolicy.PetTypeR\bpetTypes\"M\n" +
	"\aPetType\x12\x18\n" +
	"\x14PET_TYPE_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04CATS\x10\x01\x12\x0e\n" +
	"\n" +
	...
	"\rVariantOption\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x12\x19\n" +
	"\x05value\x18\x02 \x01(\tB\x03\xe0A\x02R\x05value\x1a\xfa\x03\n" +
	"\x0eRelatedProduct\x12\x89\x01\n" +
	"\x11relationship_type\x18\x01 \x01(\x0e2W.google.shopping.merchant.products.v1.ProductAttributes.RelatedProduct.RelationshipTypeB\x03\xe0A\x02R\x10relationshipType\x12k\n" +
	"\aid_type\x18\x02 \x01(\x0e2M.google.shopping.merchant.products.v1.ProductAttributes.RelatedProduct.IdTypeB\x03\xe0A\x02R\x06idType\x12\x13\n" +
	"\x02id\x18\x03 \x01(\tB\x03\xe0A\x02R\x02id\"\xa4\x01\n" +
	"\x10RelationshipType\x12!\n" +
	"\x1dRELATIONSHIP_TYPE_UNSPECIFIED\x10\x00\x12\x0f\n" +
	"\vPART_OF_SET\x10\x01\x12\x11\n" +
	"\rREQUIRED_PART\x10\x02\x12\x15\n" +
	"\x11OFTEN_BOUGHT_WITH\x10\x03\x12\x0e\n" +
	"\n" +
	"SUBSTITUTE\x10\x04\x12\x13\n" +
	"\x0fDIFFERENT_BRAND\x10\x05\x12\r\n" +
	"\tACCESSORY\x10\x06\"3\n" +
	"\x06IdType\x12\x17\n" +
	"\x13ID_TYPE_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04GTIN\x10\x01\x12\x06\n" +
	"\x02ID\x10\x02\"\x88\f\n" +
	"\x12CarrierPriceOption\x12$\n" +
	" CARRIER_PRICE_OPTION_UNSPECIFIED\x10\x00\x12\x1a\n" +
	"\x16AUSTRALIA_POST_REGULAR\x10\x01\x12\x1a\n" +
	"\x16AUSTRALIA_POST_EXPRESS\x10\x02\x12\x1c\n" +
	"\x18AUSTRALIA_POST_REGULAR_S\x10\x03\x12\x1c\n" +
	"\x18AUSTRALIA_POST_REGULAR_M\x10\x04\x12\x1c\n" +
	"\x18AUSTRALIA_POST_REGULAR_L\x10\x05\x12\x1d\n" +
	"\x19AUSTRALIA_POST_REGULAR_XL\x10\x06\x12\x1c\n" +
	"\x18AUSTRALIA_POST_EXPRESS_S\x10\a\x12\x1c\n" +
	"\x18AUSTRALIA_POST_EXPRESS_M\x10\b\x12\x1c\n" +
	"\x18AUSTRALIA_POST_EXPRESS_L\x10\t\x12\x1d\n" +
	"\x19AUSTRALIA_POST_EXPRESS_XL\x10\n" +
	"\x12\x14\n" +
	"\x10TNT_ROAD_EXPRESS\x10\v\x12\x19\n" +
	"\x15TNT_OVERNIGHT_EXPRESS\x10\f\x12\x16\n" +
	"\x12TOLL_ROAD_DELIVERY\x10\r\x12\x1b\n" +
	"\x17TOLL_OVERNIGHT_PRIORITY\x10\x0e\x12\r\n" +
	"\tDHL_PAKET\x10\x0f\x12\x10\n" +
	"\fDHL_PACKCHEN\x10\x10\x12\x12\n" +
	"\x0eDPD_EXPRESS_12\x10\x11\x12\x0f\n" +
	"\vDPD_EXPRESS\x10\x12\x12\x16\n" +
	"\x12DPD_CLASSIC_PARCEL\x10\x13\x12\x13\n" +
	...
	"\vUPS_EXPRESS\x10\x18\x12\x15\n" +
	"\x11UPS_EXPRESS_SAVER\x10\x19\x12\x18\n" +
	"\x14UPS_EXPRESS_STANDARD\x10\x1a\x12\x0f\n" +
	"\vDHL_EXPRESS\x10\x1b\x12\x12\n" +
	"\x0eDHL_EXPRESS_12\x10\x1c\x12\x10\n" +
	"\fDPD_NEXT_DAY\x10\x1d\x12\x19\n" +
	"\x15DPD_STANDARD_NEXT_DAY\x10\x1e\x12\x18\n" +
	"\x14DPD_STANDARD_TWO_DAY\x10\x1f\x12\x17\n" +
	...
	"\fFEDEX_GROUND\x10*\x12\x17\n" +
	"\x13FEDEX_HOME_DELIVERY\x10+\x12\x17\n" +
	"\x13FEDEX_EXPRESS_SAVER\x10,\x12\x19\n" +
	"\x15FEDEX_FIRST_OVERNIGHT\x10-\x12\x1c\n" +
	"\x18FEDEX_PRIORITY_OVERNIGHT\x10.\x12\x1c\n" +
	"\x18FEDEX_STANDARD_OVERNIGHT\x10/\x12\x0e\n" +
	"\n" +
	"FEDEX_2DAY\x100\x12\x10\n" +
	"\fUPS_STANDARD\x101\x12\x13\n" +
	"\x0fUPS_2ND_DAY_AIR\x102\x12\x12\n" +
	"\x0eUPS_2ND_DAY_AM\x103\x12\x14\n" +
	"\x10UPS_3_DAY_SELECT\x104\x12\x0e\n" +
	"\n" +
	"UPS_GROUND\x105\x12\x14\n" +
	"\x10UPS_NEXT_DAY_AIR\x106\x12\x1d\n" +
	"\x19UPS_NEXT_DAY_AIR_EARLY_AM\x107\x12\x1a\n" +
	"\x16UPS_NEXT_DAY_AIR_SAVER\x108\x12\x1e\n" +
	"\x1aUSPS_PRIORITY_MAIL_EXPRESS\x109\x12\x13\n" +
	"\x0fUSPS_MEDIA_MAIL\x10:\x12 \n" +
	"\x1cUSPS_GROUND_ADVANTAGE_RETAIL\x10;\x12\x16\n" +
	"\x12USPS_PRIORITY_MAIL\x10<\x12$\n" +
	" USPS_GROUND_ADVANTAGE_COMMERCIAL\x10=\"\xb6\x04\n" +
	"\x10VehicleBodyStyle\x12\"\n" +
	"\x1eVEHICLE_BODY_STYLE_UNSPECIFIED\x10\x00\x12\r\n" +
	"\tATV_SPORT\x10\x01\x12\x0f\n" +
	"\vATV_TOURING\x10\x02\x12\x0f\n" +
	"\vATV_UTILITY\x10\x03\x12\r\n" +
	"\tATV_YOUTH\x10\x04\x12\f\n" +
	"\bCITY_CAR\x10\x05\x12\x15\n" +
	"\x11CLASS_A_MOTORHOME\x10\x06\x12\x15\n" +
	"\x11CLASS_B_MOTORHOME\x10\a\x12\x15\n" +
	"\x11CLASS_C_MOTORHOME\x10\b\x12\x0f\n" +
	"\vCOMPACT_SUV\x10\t\x12\x0f\n" +
	"\vCONVERTIBLE\x10\n" +
	"\x12\t\n" +
	"\x05COUPE\x10\v\x12\r\n" +
	"\tCROSSOVER\x10\f\x12\x0f\n" +
	"\vFIFTH_WHEEL\x10\r\x12\x11\n" +
	"\rFULL_SIZE_VAN\x10\x0e\x12\r\n" +
	"\tHATCHBACK\x10\x0f\x12\r\n" +
	"\tLIMOUSINE\x10\x10\x12\v\n" +
	"\aMINIVAN\x10\x11\x12\r\n" +
	"\tNOTCHBACK\x10\x12\x12\x11\n" +
	"\rPOP_UP_CAMPER\x10\x13\x12\t\n" +
	"\x05SEDAN\x10\x14\x12\x10\n" +
	"\fSIDE_BY_SIDE\x10\x15\x12\x11\n" +
	"\rSTATION_WAGON\x10\x16\x12\a\n" +
	"\x03SUV\x10\x17\x12\x12\n" +
	"\x0eTRAVEL_TRAILER\x10\x18\x12\t\n" +
	"\x05TRUCK\x10\x19\x12\x10\n" +
	"\fTRUCK_CAMPER\x10\x1a\x12\a\n" +
	"\x03UTE\x10\x1b\x12\x1c\n" +
	"\x18UTV_RECREATIONAL_UTILITY\x10\x1c\x12\r\n" +
	"\tUTV_SPORT\x10\x1d\x12\x0f\n" +
	"\vUTV_UTILITY\x10\x1e\x12\r\n" +
	"\tUTV_YOUTH\x10\x1f\"\xa3\x01\n" +
	"\n" +
	"EngineType\x12\x1b\n" +
	"\x17ENGINE_TYPE_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bGASOLINE\x10\x01\x12\n" +
	"\n" +
	"\x06DIESEL\x10\x02\x12\f\n" +
	"\bELECTRIC\x10\x03\x12\n" +
	"\n" +
	"\x06HYBRID\x10\x04\x12\x12\n" +
	"\x0ePLUG_IN_HYBRID\x10\x05\x12\x0f\n" +
	"\vNATURAL_GAS\x10\x06\x12\a\n" +
	"\x03LPG\x10\a\x12\v\n" +
	"\aMETHANE\x10\b\x12\t\n" +
	"\x05OTHER\x10\t\"\xce\x01\n" +
	"\x11EmissionsStandard\x12\"\n" +
	"\x1eEMISSIONS_STANDARD_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eZERO_EMISSIONS\x10\x01\x12\t\n" +
	"\x05EURO1\x10\x02\x12\t\n" +
	"\x05EURO2\x10\x03\x12\t\n" +
	"\x05EURO3\x10\x04\x12\t\n" +
	"\x05EURO4\x10\x05\x12\t\n" +
	"\x05EURO5\x10\x06\x12\n" +
	"\n" +
	"\x06EURO5B\x10\a\x12\t\n" +
	"\x05EURO6\x10\b\x12\n" +
	"\n" +
	...
	"\x06EURO6D\x10\n" +
	"\x12\x0f\n" +
	"\vEURO6D_TEMP\x10\v\x12\n" +
	"\n" +
	"\x06EURO6E\x10\f\"\xbe\x01\n" +
	"\x10VehiclePriceType\x12\"\n" +
	"\x1eVEHICLE_PRICE_TYPE_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fALL_IN_PRICE\x10\x01\x12\x14\n" +
	"\x10DRIVE_AWAY_PRICE\x10\x02\x12\x1e\n" +
	"\x1aESTIMATED_DRIVE_AWAY_PRICE\x10\x03\x12&\n" +
	"\"EXCLUDING_GOVERNMENT_CHARGES_PRICE\x10\x04\x12\x16\n" +
	"\x12VEHICLE_BASE_PRICE\x10\x05\"\xb4\x01\n" +
	"\fPropertyType\x12\x1d\n" +
	"\x19PROPERTY_TYPE_UNSPECIFIED\x10\x00\x12\r\n" +
	"\tAPARTMENT\x10\x01\x12\t\n" +
	"\x05CONDO\x10\x02\x12\b\n" +
	"\x04LOFT\x10\x03\x12\x15\n" +
	"\x11MULTI_FAMILY_HOME\x10\x04\x12\r\n" +
	"\tPENTHOUSE\x10\x05\x12\b\n" +
	"\x04ROOM\x10\x06\x12\x16\n" +
	"\x12SINGLE_FAMILY_HOME\x10\a\x12\n" +
	"\n" +
	"\x06STUDIO\x10\b\x12\r\n" +
	"\tTOWNHOUSE\x10\t\"\x90\x05\n" +
	"\x0eAmenityFeature\x12\x1f\n" +
	"\x1bAMENITY_FEATURE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aBALCONY\x10\x01\x12\f\n" +
	"\bBASEMENT\x10\x02\x12\x14\n" +
	"\x10BASKETBALL_COURT\x10\x03\x12\x10\n" +
	"\fBIKE_STORAGE\x10\x04\x12\x0e\n" +
	"\n" +
	"CENTRAL_AC\x10\x05\x12\x0e\n" +
	"\n" +
	"DISHWASHER\x10\x06\x12\f\n" +
	"\bDOG_PARK\x10\a\x12\f\n" +
	"\bELEVATOR\x10\b\x12\x0f\n" +
	"\vEV_CHARGING\x10\t\x12\x0e\n" +
	"\n" +
	"FENCED_LOT\x10\n" +
	"\x12\r\n" +
	"\tFIREPLACE\x10\v\x12\x12\n" +
	"\x0eFITNESS_CENTER\x10\f\x12\x16\n" +
	"\x12FORCED_AIR_HEATING\x10\r\x12\x13\n" +
	"\x0fFULLY_FURNISHED\x10\x0e\x12\n" +
	"\n" +
	"\x06GARAGE\x10\x0f\x12\x13\n" +
	"\x0fGATED_COMMUNITY\x10\x10\x12\x13\n" +
	"\x0fHARDWOOD_FLOORS\x10\x11\x12\x17\n" +
	"\x13HIGH_SPEED_INTERNET\x10\x12\x12\f\n" +
	"\bINTERCOM\x10\x13\x12\x18\n" +
	"\x14IN_UNIT_WASHER_DRYER\x10\x14\x12\v\n" +
	"\aKITCHEN\x10\x15\x12\x11\n" +
	"\rLARGE_CLOSETS\x10\x16\x12\x14\n" +
	"\x10MULTISPORT_COURT\x10\x17\x12\x12\n" +
	"\x0eONSITE_LAUNDRY\x10\x18\x12\x12\n" +
	"\x0eOUTDOOR_LOUNGE\x10\x19\x12\v\n" +
	"\aPARKING\x10\x1a\x12\t\n" +
	"\x05PATIO\x10\x1b\x12\x14\n" +
	"\x10PICKLEBALL_COURT\x10\x1c\x12\b\n" +
	"\x04POOL\x10\x1d\x12\x10\n" +
	"\fREFRIGERATOR\x10\x1e\x12\x10\n" +
	"\fSOCCER_FIELD\x10\x1f\x12\x10\n" +
	"\fTENNIS_COURT\x10 \x12\x13\n" +
	"\x0fWALK_IN_CLOSETS\x10!\x12\x15\n" +
	"\x11WHEELCHAIR_ACCESS\x10\"\"u\n" +
	"\x11UtilitiesIncluded\x12\"\n" +
	"\x1eUTILITIES_INCLUDED_UNSPECIFIED\x10\x00\x12\x0f\n" +
	"\vELECTRICITY\x10\x01\x12\a\n" +
	"\x03GAS\x10\x02\x12\f\n" +
	"\bINTERNET\x10\x03\x12\t\n" +
	"\x05TRASH\x10\x04\x12\t\n" +
	"\x05WATER\x10\x05\"\x94\x01\n" +
	"\x14SpecialtyHousingType\x12&\n" +
	"\"SPECIALTY_HOUSING_TYPE_UNSPECIFIED\x10\x00\x12\r\n" +
	"\tCORPORATE\x10\x01\x12\x0e\n" +
	"\n" +
	"LOW_INCOME\x10\x02\x12\f\n" +
	"\bMILITARY\x10\x03\x12\n" +
	"\n" +
	"\x06SENIOR\x10\x04\x12\x0e\n" +
	"\n" +
	"SHORT_TERM\x10\x05\x12\v\n" +
	"\aSTUDENT\x10\x06B\x14\n" +
	"\x12_identifier_existsB\f\n" +
	"\n" +
	"_is_bundleB\b\n" +
	"\x06_titleB\x0e\n" +
	"\f_descriptionB\a\n" +
	...
	"\x1c_max_energy_efficiency_classB\f\n" +
	"\n" +
	"_multipackB\x0f\n" +
	"\r_ads_groupingB\x0f\n" +
	"\r_ads_redirectB\x11\n" +
	...
	"\x13_external_seller_idB\b\n" +
	"\x06_pauseB\x15\n" +
	"\x13_virtual_model_linkB\x13\n" +
	"\x11_structured_titleB\x19\n" +
	"\x17_structured_descriptionB\v\n" +
	"\t_latitudeB\f\n" +
	"\n" +
	"_longitudeB\x12\n" +
	"\x10_number_of_unitsB\x15\n" +
	"\x13_number_of_bedroomsB\x16\n" +
	"\x14_number_of_bathroomsB\x0e\n" +
	"\f_short_title\":\n" +
	"\x0eShippingWeight\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x01R\x05value\x12\x12\n" +
	"\x04unit\x18\x02 \x01(\tR\x04unit\"=\n" +
	"\x11ShippingDimension\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x01R\x05value\x12\x12\n" +
	"\x04unit\x18\x02 \x01(\tR\x04unit\"B\n" +
	"\x16UnitPricingBaseMeasure\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x03R\x05value\x12\x12\n" +
	"\x04unit\x18\x02 \x01(\tR\x04unit\">\n" +
	"\x12UnitPricingMeasure\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x01R\x05value\x12\x12\n" +
	"\x04unit\x18\x02 \x01(\tR\x04unit\"\xbe\x01\n" +
	...
	"\x05ratio\x18\x03 \x01(\x01R\x05ratio\"\xaf\x04\n" +
	...
	"\x0eloyalty_points\x18\x05 \x01(\x03H\x04R\rloyaltyPoints\x88\x01\x01\x12Y\n" +
	"\x1bmember_price_effective_date\x18\x06 \x01(\v2\x15.google.type.IntervalH\x05R\x18memberPriceEffectiveDate\x88\x01\x01\x12*\n" +
	...
	"\x0f_shipping_label\"\xa9\x06\n" +
	"\bShipping\x121\n" +
	"\x05price\x18\x01 \x01(\v2\x1b.google.shopping.type.PriceR\x05price\x12\x18\n" +
	"\acountry\x18\x02 \x01(\tR\acountry\x12\x16\n" +
	"\x06region\x18\x03 \x01(\tR\x06region\x12\x18\n" +
	"\aservice\x18\x04 \x01(\tR\aservice\x12\x1f\n" +
	"\vlocation_id\x18\x05 \x01(\x03R\n" +
	"locationId\x12.\n" +
	"\x13location_group_name\x18\x06 \x01(\tR\x11locationGroupName\x12\x1f\n" +
	"\vpostal_code\x18\a \x01(\tR\n" +
	"postalCode\x12/\n" +
	"\x11min_handling_time\x18\b \x01(\x03H\x00R\x0fminHandlingTime\x88\x01\x01\x12/\n" +
	"\x11max_handling_time\x18\t \x01(\x03H\x01R\x0fmaxHandlingTime\x88\x01\x01\x12-\n" +
	"\x10min_transit_time\x18\n" +
	" \x01(\x03H\x02R\x0eminTransitTime\x88\x01\x01\x12-\n" +
	"\x10max_transit_time\x18\v \x01(\x03H\x03R\x0emaxTransitTime\x88\x01\x01\x125\n" +
	"\x14handling_cutoff_time\x18\f \x01(\tH\x04R\x12handlingCutoffTime\x88\x01\x01\x12=\n" +
	"\x18handling_cutoff_timezone\x18\r \x01(\tH\x05R\x16handlingCutoffTimezone\x88\x01\x01\x127\n" +
	"\x15loyalty_program_label\x18\x0e \x01(\tB\x03\xe0A\x01R\x13loyaltyProgramLabel\x121\n" +
	"\x12loyalty_tier_label\x18\x0f \x01(\tB\x03\xe0A\x01R\x10loyaltyTierLabelB\x14\n" +
	"\x12_min_handling_timeB\x14\n" +
	"\x12_max_handling_timeB\x13\n" +
	"\x11_min_transit_timeB\x13\n" +
	"\x11_max_transit_timeB\x17\n" +
	"\x15_handling_cutoff_timeB\x1b\n" +
	"\x19_handling_cutoff_timezone\"\xa1\x01\n" +
	"\x15FreeShippingThreshold\x12\x1d\n" +
	"\acountry\x18\x01 \x01(\tH\x00R\acountry\x88\x01\x01\x12I\n" +
	"\x0fprice_threshold\x18\x02 \x01(\v2\x1b.google.shopping.type.PriceH\x01R\x0epriceThreshold\x88\x01\x01B\n" +
	"\n" +
	"\b_countryB\x12\n" +
	"\x10_price_threshold\"\x82\x01\n" +
	"\rProductDetail\x12!\n" +
	...
	"\x05value\x18\x01 \x01(\x01B\x03\xe0A\x02R\x05value\x12\x17\n" +
	"\x04unit\x18\x02 \x01(\tB\x03\xe0A\x02R\x04unit\"\x84\n" +
	"\n" +
	"\rProductStatus\x12x\n" +
	"\x14destination_statuses\x18\x03 \x03(\v2E.google.shopping.merchant.products.v1.ProductStatus.DestinationStatusR\x13destinationStatuses\x12n\n" +
	"\x11item_level_issues\x18\x04 \x03(\v2B.google.shopping.merchant.products.v1.ProductStatus.ItemLevelIssueR\x0fitemLevelIssues\x12?\n" +
	...
	"\x16google_expiration_date\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x14googleExpirationDate\x1a\x8e\x02\n" +
	"\x11DestinationStatus\x12h\n" +
	"\x11reporting_context\x18\x01 \x01(\x0e2;.google.shopping.type.ReportingContext.ReportingContextEnumR\x10reportingContext\x12-\n" +
	"\x12approved_countries\x18\x02 \x03(\tR\x11approvedCountries\x12+\n" +
	"\x11pending_countries\x18\x03 \x03(\tR\x10pendingCountries\x123\n" +
	"\x15disapproved_countries\x18\x04 \x03(\tR\x14disapprovedCountries\x1a\x9e\x04\n" +
	"\x0eItemLevelIssue\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\x12g\n" +
	"\bseverity\x18\x02 \x01(\x0e2K.google.shopping.merchant.products.v1.ProductStatus.ItemLevelIssue.SeverityR\bseverity\x12\x1e\n" +
	"\n" +
	"resolution\x18\x03 \x01(\tR\n" +
	"resolution\x12\x1c\n" +
	"\tattribute\x18\x04 \x01(\tR\tattribute\x12h\n" +
	"\x11reporting_context\x18\x05 \x01(\x0e2;.google.shopping.type.ReportingContext.ReportingContextEnumR\x10reportingContext\x12 \n" +
	...
	"\x14applicable_countries\x18\t \x03(\tR\x13applicableCountries\"T\n" +
	"\bSeverity\x12\x18\n" +
	"\x14SEVERITY_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fNOT_IMPACTED\x10\x01\x12\v\n" +
	"\aDEMOTED\x10\x02\x12\x0f\n" +
	"\vDISAPPROVED\x10\x03\"\xfd\x02\n" +
	"\x1fCloudExportAdditionalProperties\x12(\n" +
	"\rproperty_name\x18\x01 \x01(\tH\x00R\fpropertyName\x88\x01\x01\x12\x1d\n" +
	"\n" +
	"text_value\x18\x02 \x03(\tR\ttextValue\x12\"\n" +
	"\n" +
	"bool_value\x18\x03 \x01(\bH\x01R\tboolValue\x88\x01\x01\x12\x1b\n" +
	"\tint_value\x18\x04 \x03(\x03R\bintValue\x12\x1f\n" +
	"\vfloat_value\x18\x05 \x03(\x02R\n" +
	"floatValue\x12 \n" +
	"\tmin_value\x18\x06 \x01(\x02H\x02R\bminValue\x88\x01\x01\x12 \n" +
	"\tmax_value\x18\a \x01(\x02H\x03R\bmaxValue\x88\x01\x01\x12 \n" +
	"\tunit_code\x18\b \x01(\tH\x04R\bunitCode\x88\x01\x01B\x10\n" +
	"\x0e_property_nameB\r\n" +
	"\v_bool_valueB\f\n" +
	"\n" +
	"_min_valueB\f\n" +
	...
	"\n" +
	"_unit_code\"\xb7\x02\n" +
	"\x1eProductSustainabilityIncentive\x125\n" +
	"\x06amount\x18\x02 \x01(\v2\x1b.google.shopping.type.PriceH\x00R\x06amount\x12 \n" +
	"\n" +
	"percentage\x18\x03 \x01(\x01H\x00R\n" +
	"percentage\x12b\n" +
	"\x04type\x18\x01 \x01(\x0e2I.google.shopping.merchant.products.v1.ProductSustainabilityIncentive.TypeH\x01R\x04type\x88\x01\x01\"F\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\x11\n" +
	"\rEV_TAX_CREDIT\x10\x01\x12\x15\n" +
	"\x11EV_PRICE_DISCOUNT\x10\x02B\a\n" +
	"\x05valueB\a\n" +
	"\x05_type\"\xe1\x01\n" +
	"\x12AutomatedDiscounts\x12<\n" +
	"\vprior_price\x18\x01 \x01(\v2\x1b.google.shopping.type.PriceR\n" +
	"priorPrice\x12S\n" +
	"\x17prior_price_progressive\x18\x02 \x01(\v2\x1b.google.shopping.type.PriceR\x15priorPriceProgressive\x128\n" +
	"\tgad_price\x18\x03 \x01(\v2\x1b.google.shopping.type.PriceR\bgadPrice\"\xbf\x01\n" +
	"\n" +
	"PickupCost\x12B\n" +
	"\tflat_rate\x18\x01 \x01(\v2\x1b.google.shopping.type.PriceB\x03\xe0A\x02H\x00R\bflatRate\x88\x01\x01\x12L\n" +
	"\x0efree_threshold\x18\x02 \x01(\v2\x1b.google.shopping.type.PriceB\x03\xe0A\x01H\x01R\rfreeThreshold\x88\x01\x01B\f\n" +
	"\n" +
	"_flat_rateB\x11\n" +
	"\x0f_free_threshold\"\xa1\x02\n" +
	"\x12HandlingCutoffTime\x12\x1d\n" +
	"\acountry\x18\x01 \x01(\tH\x00R\acountry\x88\x01\x01\x12$\n" +
	"\vcutoff_time\x18\x02 \x01(\tH\x01R\n" +
	"cutoffTime\x88\x01\x01\x12,\n" +
	"\x0fcutoff_timezone\x18\x03 \x01(\tH\x02R\x0ecutoffTimezone\x88\x01\x01\x12F\n" +
	"\x1ddisable_delivery_after_cutoff\x18\x04 \x01(\bH\x03R\x1adisableDeliveryAfterCutoff\x88\x01\x01B\n" +
	"\n" +
	"\b_countryB\x0e\n" +
	"\f_cutoff_timeB\x12\n" +
	"\x10_cutoff_timezoneB \n" +
	"\x1e_disable_delivery_after_cutoff\"\xfc\x02\n" +
	"\x18ProductMinimumOrderValue\x12\"\n" +
	"\acountry\x18\x01 \x01(\tB\x03\xe0A\x02H\x00R\acountry\x88\x01\x01\x12\x1d\n" +
	"\aservice\x18\x02 \x01(\tH\x01R\aservice\x88\x01\x01\x12e\n" +
	"\asurface\x18\x03 \x01(\x0e2F.google.shopping.merchant.products.v1.ProductMinimumOrderValue.SurfaceH\x02R\asurface\x88\x01\x01\x12;\n" +
	"\x05price\x18\x04 \x01(\v2\x1b.google.shopping.type.PriceB\x03\xe0A\x02H\x03R\x05price\x88\x01\x01\"K\n" +
	"\aSurface\x12\x17\n" +
	"\x13SURFACE_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06ONLINE\x10\x01\x12\t\n" +
	"\x05LOCAL\x10\x02\x12\x10\n" +
	"\fONLINE_LOCAL\x10\x03B\n" +
	"\n" +
	"\b_countryB\n" +
	"\n" +
	"\b_serviceB\n" +
	...
	"\x04YEAR\x10\x02\x12\b\n" +
	"\x04WEEK\x10\x03*`\n" +
	"\bAgeGroup\x12\x19\n" +
	"\x15AGE_GROUP_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05ADULT\x10\x01\x12\b\n" +
	"\x04KIDS\x10\x02\x12\v\n" +
	"\aTODDLER\x10\x03\x12\n" +
	"\n" +
	"\x06INFANT\x10\x04\x12\v\n" +
	"\aNEWBORN\x10\x05*\x83\x01\n" +
	"\fAvailability\x12\x1c\n" +
	"\x18AVAILABILITY_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bIN_STOCK\x10\x01\x12\x10\n" +
	"\fOUT_OF_STOCK\x10\x02\x12\f\n" +
	"\bPREORDER\x10\x03\x12\x18\n" +
	"\x14LIMITED_AVAILABILITY\x10\x04\x12\r\n" +
	"\tBACKORDER\x10\x05*J\n" +
	"\tCondition\x12\x19\n" +
	"\x15CONDITION_UNSPECIFIED\x10\x00\x12\a\n" +
	"\x03NEW\x10\x01\x12\b\n" +
	"\x04USED\x10\x02\x12\x0f\n" +
	"\vREFURBISHED\x10\x03*B\n" +
	"\x06Gender\x12\x16\n" +
	...
	"\n" +
	"CreditType\x12\x1b\n" +
	"\x17CREDIT_TYPE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aFINANCE\x10\x01\x12\t\n" +
	"\x05LEASE\x10\x02*\x82\x01\n" +
	"\n" +
	"SizeSystem\x12\x1b\n" +
	"\x17SIZE_SYSTEM_UNSPECIFIED\x10\x00\x12\x06\n" +
	"\x02AU\x10\x01\x12\x06\n" +
	"\x02BR\x10\x02\x12\x06\n" +
	"\x02CN\x10\x03\x12\x06\n" +
	"\x02DE\x10\x04\x12\x06\n" +
	"\x02EU\x10\x05\x12\x06\n" +
	"\x02FR\x10\x06\x12\x06\n" +
	"\x02IT\x10\a\x12\x06\n" +
	"\x02JP\x10\b\x12\a\n" +
	"\x03MEX\x10\t\x12\x06\n" +
	"\x02UK\x10\n" +
	...
	"\x02US\x10\v*j\n" +
	"\bSizeType\x12\x19\n" +
	"\x15SIZE_TYPE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aREGULAR\x10\x01\x12\n" +
	"\n" +
	"\x06PETITE\x10\x02\x12\r\n" +
	"\tMATERNITY\x10\x03\x12\a\n" +
	"\x03BIG\x10\x04\x12\b\n" +
	"\x04TALL\x10\x05\x12\b\n" +
	"\x04PLUS\x10\x06*\x8c\x01\n" +
	"\x15EnergyEfficiencyClass\x12'\n" +
	"#ENERGY_EFFICIENCY_CLASS_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04APPP\x10\x01\x12\a\n" +
	"\x03APP\x10\x02\x12\x06\n" +
	"\x02AP\x10\x03\x12\x05\n" +
	"\x01A\x10\x04\x12\x05\n" +
	"\x01B\x10\x05\x12\x05\n" +
	"\x01C\x10\x06\x12\x05\n" +
	"\x01D\x10\a\x12\x05\n" +
	"\x01E\x10\b\x12\x05\n" +
	"\x01F\x10\t\x12\x05\n" +
	"\x01G\x10\n" +
	...
	"\rNOT_SUPPORTED\x10\x01\x12\a\n" +
	"\x03BUY\x10\x02\x12\v\n" +
	"\aRESERVE\x10\x03\x12\x11\n" +
	...
	"\aSIX_DAY\x10\a\x12\x0e\n" +
	"\n" +
	"MULTI_WEEK\x10\b*0\n" +
	"\x05Pause\x12\x15\n" +
	"\x11PAUSE_UNSPECIFIED\x10\x00\x12\a\n" +
	"\x03ADS\x10\x01\x12\a\n" +
	"\x03ALL\x10\x02*g\n" +
	"\x16CertificationAuthority\x12'\n" +
	"#CERTIFICATION_AUTHORITY_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05ADEME\x10\x01\x12\b\n" +
	"\x04BMWK\x10\x02\x12\a\n" +
	"\x03EPA\x10\x03\x12\x06\n" +
	"\x02EC\x10\x04*\xd5\x01\n" +
	"\x11CertificationName\x12\"\n" +
	"\x1eCERTIFICATION_NAME_UNSPECIFIED\x10\x00\x12\x0f\n" +
	"\vENERGY_STAR\x10\x01\x12\x1e\n" +
	"\x1aENERGY_STAR_MOST_EFFICIENT\x10\x02\x12\t\n" +
	"\x05EPREL\x10\x03\x12\x0f\n" +
	"\vEU_ECOLABEL\x10\x04\x12\x1d\n" +
	"\x19VEHICLE_ENERGY_EFFICIENCY\x10\x05\x120\n" +
	",VEHICLE_ENERGY_EFFICIENCY_DISCHARGED_BATTERY\x10\x06*d\n" +
	"\x11DigitalSourceType\x12#\n" +
	"\x1fDIGITAL_SOURCE_TYPE_UNSPECIFIED\x10\x00\x12\x1d\n" +
	"\x19TRAINED_ALGORITHMIC_MEDIA\x10\x01\x12\v\n" +
	"\aDEFAULT\x10\x02*\xc8\a\n" +
	"\x18CarrierTransitTimeOption\x12+\n" +
	"'CARRIER_TRANSIT_TIME_OPTION_UNSPECIFIED\x10\x00\x12\r\n" +
	"\tDHL_PAKET\x10\x01\x12\x10\n" +
	"\fDHL_PACKCHEN\x10\x02\x12\x13\n" +
	"\x0fDHL_EXPRESSEASY\x10\x03\x12\x0f\n" +
	"\vDPD_EXPRESS\x10\x04\x12\x16\n" +
	"\x12DPD_CLASSIC_PARCEL\x10\x05\x12\x12\n" +
	"\x0eHERMES_HAUSTUR\x10\x06\x12\x14\n" +
	"\x10HERMES_PAKETSHOP\x10\a\x12\x10\n" +
	"\fGLS_BUSINESS\x10\b\x12\x0f\n" +
	"\vGLS_EXPRESS\x10\t\x12\x0f\n" +
	"\vGLS_PRIVATE\x10\n" +
	"\x12\x16\n" +
	"\x12COLISSIMO_DOMICILE\x10\v\x12\x14\n" +
	"\x10DHL_EXPRESS_12AM\x10\f\x12\x13\n" +
	"\x0fDHL_EXPRESS_9AM\x10\r\x12\x12\n" +
	...
	"\fFEDEX_GROUND\x10\x14\x12\x17\n" +
	"\x13FEDEX_HOME_DELIVERY\x10\x15\x12\x17\n" +
	"\x13FEDEX_EXPRESS_SAVER\x10\x16\x12\x19\n" +
	"\x15FEDEX_FIRST_OVERNIGHT\x10\x17\x12\x1c\n" +
	"\x18FEDEX_PRIORITY_OVERNIGHT\x10\x18\x12\x1c\n" +
	"\x18FEDEX_STANDARD_OVERNIGHT\x10\x19\x12\x0e\n" +
	"\n" +
...
var (
	...
	file_google_shopping_merchant_products_v1_products_common_proto_rawDescData []byte
)
...
func file_google_shopping_merchant_products_v1_products_common_proto_rawDescGZIP() []byte {
	file_google_shopping_merchant_products_v1_products_common_proto_rawDescOnce.Do(func() {
		file_google_shopping_merchant_products_v1_products_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_products_v1_products_common_proto_rawDesc), len(file_google_shopping_merchant_products_v1_products_common_proto_rawDesc)))
	})
...
var file_google_shopping_merchant_products_v1_products_common_proto_goTypes = []any{
	...
	(ProductAttributes_VehicleBodyStyle)(0),                // 17: google.shopping.merchant.products.v1.ProductAttributes.VehicleBodyStyle
	(ProductAttributes_EngineType)(0),                      // 18: google.shopping.merchant.products.v1.ProductAttributes.EngineType
	(ProductAttributes_EmissionsStandard)(0),               // 19: google.shopping.merchant.products.v1.ProductAttributes.EmissionsStandard
	(ProductAttributes_VehiclePriceType)(0),                // 20: google.shopping.merchant.products.v1.ProductAttributes.VehiclePriceType
	(ProductAttributes_PropertyType)(0),                    // 21: google.shopping.merchant.products.v1.ProductAttributes.PropertyType
	(ProductAttributes_AmenityFeature)(0),                  // 22: google.shopping.merchant.products.v1.ProductAttributes.AmenityFeature
	(ProductAttributes_UtilitiesIncluded)(0),               // 23: google.shopping.merchant.products.v1.ProductAttributes.UtilitiesIncluded
	(ProductAttributes_SpecialtyHousingType)(0),            // 24: google.shopping.merchant.products.v1.ProductAttributes.SpecialtyHousingType
	(ProductAttributes_Mileage_Unit)(0),                    // 25: google.shopping.merchant.products.v1.ProductAttributes.Mileage.Unit
...
func file_google_shopping_merchant_products_v1_products_common_proto_init() {
	...
	file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[24].OneofWrappers = []any{}
	file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[25].OneofWrappers = []any{}
	file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[26].OneofWrappers = []any{}
	file_google_shopping_merchant_products_v1_products_common_proto_msgTypes[27].OneofWrappers = []any{}
