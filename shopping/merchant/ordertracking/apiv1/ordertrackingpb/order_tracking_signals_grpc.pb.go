...
const (
	OrderTrackingSignalsService_CreateOrderTrackingSignal_FullMethodName = "/google.shopping.merchant.ordertracking.v1.OrderTrackingSignalsService/CreateOrderTrackingSignal"
)
