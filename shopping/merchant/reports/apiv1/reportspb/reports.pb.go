...
const file_google_shopping_merchant_reports_v1_reports_proto_rawDesc = "" +
	"\n" +
	...
	"\n" +
	"page_token\x18\x04 \x01(\tB\x03\xe0A\x01R\tpageToken\"\x82\x01\n" +
	"\x0eSearchResponse\x12H\n" +
	"\aresults\x18\x01 \x03(\v2..google.shopping.merchant.reports.v1.ReportRowR\aresults\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xcc\n" +
	"\n" +
	"\tReportRow\x12u\n" +
	"\x18product_performance_view\x18\x01 \x01(\v2;.google.shopping.merchant.reports.v1.ProductPerformanceViewR\x16productPerformanceView\x12\x7f\n" +
	"\x1cnon_product_performance_view\x18\a \x01(\v2>.google.shopping.merchant.reports.v1.NonProductPerformanceViewR\x19nonProductPerformanceView\x12S\n" +
	"\fproduct_view\x18\x02 \x01(\v20.google.shopping.merchant.reports.v1.ProductViewR\vproductView\x12\x91\x01\n" +
	"\"price_competitiveness_product_view\x18\x03 \x01(\v2D.google.shopping.merchant.reports.v1.PriceCompetitivenessProductViewR\x1fpriceCompetitivenessProductView\x12|\n" +
	"\x1bprice_insights_product_view\x18\x04 \x01(\v2=.google.shopping.merchant.reports.v1.PriceInsightsProductViewR\x18priceInsightsProductView\x12\x8c\x01\n" +
	"!best_sellers_product_cluster_view\x18\x05 \x01(\v2B.google.shopping.merchant.reports.v1.BestSellersProductClusterViewR\x1dbestSellersProductClusterView\x12p\n" +
	"\x17best_sellers_brand_view\x18\x06 \x01(\v29.google.shopping.merchant.reports.v1.BestSellersBrandViewR\x14bestSellersBrandView\x12\x9d\x01\n" +
	...
	"\bseverity\x18\x02 \x01(\v2L.google.shopping.merchant.reports.v1.ProductView.ItemIssue.ItemIssueSeverityR\bseverity\x12s\n" +
	"\n" +
	"resolution\x18\x03 \x01(\x0e2N.google.shopping.merchant.reports.v1.ProductView.ItemIssue.ItemIssueResolutionH\x00R\n" +
	...
	"\x05_codeB\x16\n" +
	"\x14_canonical_attribute\x1a\xfa\x05\n" +
	"\x11ItemIssueSeverity\x12\xb2\x01\n" +
	"\x1eseverity_per_reporting_context\x18\x01 \x03(\v2m.google.shopping.merchant.reports.v1.ProductView.ItemIssue.ItemIssueSeverity.IssueSeverityPerReportingContextR\x1bseverityPerReportingContext\x12\x9a\x01\n" +
	"\x13aggregated_severity\x18\x02 \x01(\x0e2d.google.shopping.merchant.reports.v1.ProductView.ItemIssue.ItemIssueSeverity.AggregatedIssueSeverityH\x00R\x12aggregatedSeverity\x88\x01\x01\x1a\x89\x02\n" +
	...
	"%predicted_conversions_change_fraction\x18\x13 \x01(\x01H\x10R\"predictedConversionsChangeFraction\x88\x01\x01\x12q\n" +
	"\reffectiveness\x18\x16 \x01(\x0e2K.google.shopping.merchant.reports.v1.PriceInsightsProductView.EffectivenessR\reffectiveness\"M\n" +
	...
	"&_predicted_conversions_change_fraction\"\xf1\r\n" +
	"\x1dBestSellersProductClusterView\x122\n" +
	"\vreport_date\x18\x01 \x01(\v2\x11.google.type.DateR\n" +
	"reportDate\x12\x80\x01\n" +
	"\x12report_granularity\x18\x02 \x01(\x0e2L.google.shopping.merchant.reports.v1.ReportGranularity.ReportGranularityEnumH\x00R\x11reportGranularity\x88\x01\x01\x123\n" +
	...
	"\vcategory_l5\x18\f \x01(\tH\tR\n" +
	"categoryL5\x88\x01\x01\x12#\n" +
	"\rvariant_gtins\x18\r \x03(\tR\fvariantGtins\x12\x82\x01\n" +
	"\x10inventory_status\x18\x0e \x01(\x0e2R.google.shopping.merchant.reports.v1.BestSellersProductClusterView.InventoryStatusH\n" +
	"R\x0finventoryStatus\x88\x01\x01\x12\x8d\x01\n" +
	"\x16brand_inventory_status\x18\x0f \x01(\x0e2R.google.shopping.merchant.reports.v1.BestSellersProductClusterView.InventoryStatusH\vR\x14brandInventoryStatus\x88\x01\x01\x12\x17\n" +
	"\x04rank\x18\x10 \x01(\x03H\fR\x04rank\x88\x01\x01\x12(\n" +
	"\rprevious_rank\x18\x11 \x01(\x03H\rR\fpreviousRank\x88\x01\x01\x12t\n" +
	"\x0frelative_demand\x18\x12 \x01(\x0e2F.google.shopping.merchant.reports.v1.RelativeDemand.RelativeDemandEnumH\x0eR\x0erelativeDemand\x88\x01\x01\x12\x85\x01\n" +
	"\x18previous_relative_demand\x18\x13 \x01(\x0e2F.google.shopping.merchant.reports.v1.RelativeDemand.RelativeDemandEnumH\x0fR\x16previousRelativeDemand\x88\x01\x01\x12\x95\x01\n" +
	"\x16relative_demand_change\x18\x14 \x01(\x0e2Z.google.shopping.merchant.reports.v1.RelativeDemandChangeType.RelativeDemandChangeTypeEnumH\x10R\x14relativeDemandChange\x88\x01\x01\"i\n" +
	...
	"\x17_relative_demand_change\"\xe0\a\n" +
	...
	"\rprevious_rank\x18\b \x01(\x03H\x05R\fpreviousRank\x88\x01\x01\x12t\n" +
	"\x0frelative_demand\x18\t \x01(\x0e2F.google.shopping.merchant.reports.v1.RelativeDemand.RelativeDemandEnumH\x06R\x0erelativeDemand\x88\x01\x01\x12\x85\x01\n" +
	"\x18previous_relative_demand\x18\n" +
	" \x01(\x0e2F.google.shopping.merchant.reports.v1.RelativeDemand.RelativeDemandEnumH\aR\x16previousRelativeDemand\x88\x01\x01\x12\x95\x01\n" +
	"\x16relative_demand_change\x18\v \x01(\x0e2Z.google.shopping.merchant.reports.v1.RelativeDemandChangeType.RelativeDemandChangeTypeEnumH\bR\x14relativeDemandChange\x88\x01\x01B\x15\n" +
	"\x13_report_granularityB\x16\n" +
	"\x14_report_country_codeB\x15\n" +
	"\x13_report_category_idB\b\n" +
	"\x06_brandB\a\n" +
	...
	"\a_clicksB\x0e\n" +
	"\f_impressionsB\x15\n" +
	"\x13_click_through_rate\"\x9c\x06\n" +
	...
	"\x12report_category_id\x18\x05 \x01(\x03H\x03R\x10reportCategoryId\x88\x01\x01\x12p\n" +
	"\x0etraffic_source\x18\x06 \x01(\x0e2D.google.shopping.merchant.reports.v1.TrafficSource.TrafficSourceEnumH\x04R\rtrafficSource\x88\x01\x01\x12\x17\n" +
	...
	"\x14_relative_visibility\"\xcf\x05\n" +
	...
	"\x12_ads_organic_ratioB\x14\n" +
	"\x12_page_overlap_rateB\x17\n" +
	"\x15_higher_position_rate\"\xca\x04\n" +
	...
	"\x12report_category_id\x18\x03 \x01(\x03H\x01R\x10reportCategoryId\x88\x01\x01\x12p\n" +
	"\x0etraffic_source\x18\x04 \x01(\x0e2D.google.shopping.merchant.reports.v1.TrafficSource.TrafficSourceEnumH\x02R\rtrafficSource\x88\x01\x01\x12D\n" +
	...
	"\x03ALL\x10\x032\x90\x02\n" +
	"\rReportService\x12\xb5\x01\n" +
	"\x06Search\x122.google.shopping.merchant.reports.v1.SearchRequest\x1a3.google.shopping.merchant.reports.v1.SearchResponse\"B\xdaA\x06parent\x82\xd3\xe4\x93\x023:\x01*\"./reports/v1/{parent=accounts/*}/reports:search\x1aG\xcaA\x1amerchantapi.googleapis.com\xd2A'https://www.googleapis.com/auth/contentB\xf8\x01\n" +
	"'com.google.shopping.merchant.reports.v1B\fReportsProtoP\x01ZGcloud.google.com/go/shopping/merchant/reports/apiv1/reportspb;reportspb\xaa\x02#Google.Shopping.Merchant.Reports.V1\xca\x02#Google\\Shopping\\Merchant\\Reports\\V1\xea\x02'Google::Shopping::Merchant::Reports::V1b\x06proto3"

var (
	file_google_shopping_merchant_reports_v1_reports_proto_rawDescOnce sync.Once
	file_google_shopping_merchant_reports_v1_reports_proto_rawDescData []byte
)
...
func file_google_shopping_merchant_reports_v1_reports_proto_rawDescGZIP() []byte {
	file_google_shopping_merchant_reports_v1_reports_proto_rawDescOnce.Do(func() {
		file_google_shopping_merchant_reports_v1_reports_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_reports_v1_reports_proto_rawDesc), len(file_google_shopping_merchant_reports_v1_reports_proto_rawDesc)))
	})
