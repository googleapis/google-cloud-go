...
var file_google_shopping_merchant_datasources_v1beta_datasources_proto_rawDesc = []byte{
	...
	0x68, 0x2f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x42, 0xb0, 0x02, 0xea, 0x41, 0x38, 0x0a,
	...
	0x61, 0x74, 0x61, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_google_shopping_merchant_datasources_v1beta_datasources_proto_goTypes = []interface{}{
...
func file_google_shopping_merchant_datasources_v1beta_datasources_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_shopping_merchant_datasources_v1beta_datasources_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_shopping_merchant_datasources_v1beta_datasources_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_shopping_merchant_datasources_v1beta_datasources_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_shopping_merchant_datasources_v1beta_datasources_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_shopping_merchant_datasources_v1beta_datasources_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_shopping_merchant_datasources_v1beta_datasources_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_shopping_merchant_datasources_v1beta_datasources_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_shopping_merchant_datasources_v1beta_datasources_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_shopping_merchant_datasources_v1beta_datasources_proto_msgTypes[0].OneofWrappers = []interface{}{
