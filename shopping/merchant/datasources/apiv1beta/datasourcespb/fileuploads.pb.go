...
const file_google_shopping_merchant_datasources_v1beta_fileuploads_proto_rawDesc = "" +
	"\n" +
	"=google/shopping/merchant/datasources/v1beta/fileuploads.proto\x12+google.shopping.merchant.datasources.v1beta\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa8\b\n" +
	"\n" +
	"FileUpload\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12)\n" +
	"\x0edata_source_id\x18\x02 \x01(\x03B\x03\xe0A\x03R\fdataSourceId\x12w\n" +
	"\x10processing_state\x18\x03 \x01(\x0e2G.google.shopping.merchant.datasources.v1beta.FileUpload.ProcessingStateB\x03\xe0A\x03R\x0fprocessingState\x12Z\n" +
	"\x06issues\x18\x04 \x03(\v2=.google.shopping.merchant.datasources.v1beta.FileUpload.IssueB\x03\xe0A\x03R\x06issues\x12$\n" +
	...
	"\x05count\x18\x04 \x01(\x03B\x03\xe0A\x03R\x05count\x12g\n" +
	"\bseverity\x18\x05 \x01(\x0e2F.google.shopping.merchant.datasources.v1beta.FileUpload.Issue.SeverityB\x03\xe0A\x03R\bseverity\x120\n" +
	...
	"%merchantapi.googleapis.com/FileUploadR\x04name2\xbd\x02\n" +
...
var (
	...
	file_google_shopping_merchant_datasources_v1beta_fileuploads_proto_rawDescData []byte
)
...
func file_google_shopping_merchant_datasources_v1beta_fileuploads_proto_rawDescGZIP() []byte {
	file_google_shopping_merchant_datasources_v1beta_fileuploads_proto_rawDescOnce.Do(func() {
		file_google_shopping_merchant_datasources_v1beta_fileuploads_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_datasources_v1beta_fileuploads_proto_rawDesc), len(file_google_shopping_merchant_datasources_v1beta_fileuploads_proto_rawDesc)))
	})
...
func file_google_shopping_merchant_datasources_v1beta_fileuploads_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_shopping_merchant_datasources_v1beta_fileuploads_proto_rawDesc), len(file_google_shopping_merchant_datasources_v1beta_fileuploads_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
