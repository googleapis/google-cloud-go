...
var file_google_shopping_merchant_datasources_v1beta_fileinputs_proto_rawDesc = []byte{
	...
	0x47, 0x4c, 0x45, 0x5f, 0x53, 0x48, 0x45, 0x45, 0x54, 0x53, 0x10, 0x03, 0x42, 0x9d, 0x01, 0x0a,
...
var file_google_shopping_merchant_datasources_v1beta_fileinputs_proto_goTypes = []interface{}{
...
func file_google_shopping_merchant_datasources_v1beta_fileinputs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_shopping_merchant_datasources_v1beta_fileinputs_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_shopping_merchant_datasources_v1beta_fileinputs_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
