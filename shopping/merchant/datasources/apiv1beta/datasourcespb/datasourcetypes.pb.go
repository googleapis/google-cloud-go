...
func file_google_shopping_merchant_datasources_v1beta_datasourcetypes_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_shopping_merchant_datasources_v1beta_datasourcetypes_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_google_shopping_merchant_datasources_v1beta_datasourcetypes_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*PrimaryProductDataSource_DefaultRule); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
