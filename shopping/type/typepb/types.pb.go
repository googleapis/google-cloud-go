...
func file_google_shopping_type_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_shopping_type_types_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_shopping_type_types_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
