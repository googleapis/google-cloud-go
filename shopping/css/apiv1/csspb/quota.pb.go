...
const file_google_shopping_css_v1_quota_proto_rawDesc = "" +
	"\n" +
	"\"google/shopping/css/v1/quota.proto\x12\x16google.shopping.css.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\xe2\x02\n" +
	"\n" +
	"QuotaGroup\x12\x17\n" +
	...
	"quotaLimit\x121\n" +
	"\x12quota_minute_limit\x18\x05 \x01(\x03B\x03\xe0A\x03R\x10quotaMinuteLimit\x12Q\n" +
	"\x0emethod_details\x18\x04 \x03(\v2%.google.shopping.css.v1.MethodDetailsB\x03\xe0A\x03R\rmethodDetails:i\xeaAf\n" +
	"\x1dcss.googleapis.com/QuotaGroup\x12,accounts/{account}/quotaGroups/{quota_group}*\vquotaGroups2\n" +
	"quotaGroup\"\x81\x01\n" +
	...
	"\x04path\x18\x04 \x01(\tB\x03\xe0A\x03R\x04path\"\x9d\x01\n" +
	"\x16ListQuotaGroupsRequest\x12=\n" +
	"\x06parent\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\x12\x1dcss.googleapis.com/QuotaGroupR\x06parent\x12 \n" +
	"\tpage_size\x18\x02 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tB\x03\xe0A\x01R\tpageToken\"\x88\x01\n" +
	"\x17ListQuotaGroupsResponse\x12E\n" +
	"\fquota_groups\x18\x01 \x03(\v2\".google.shopping.css.v1.QuotaGroupR\vquotaGroups\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken2\xf5\x01\n" +
	"\fQuotaService\x12\xa3\x01\n" +
...
var (
	...
	file_google_shopping_css_v1_quota_proto_rawDescData []byte
)

func file_google_shopping_css_v1_quota_proto_rawDescGZIP() []byte {
	file_google_shopping_css_v1_quota_proto_rawDescOnce.Do(func() {
		file_google_shopping_css_v1_quota_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_shopping_css_v1_quota_proto_rawDesc), len(file_google_shopping_css_v1_quota_proto_rawDesc)))
	})
...
func file_google_shopping_css_v1_quota_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_shopping_css_v1_quota_proto_rawDesc), len(file_google_shopping_css_v1_quota_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
