...
const file_google_cloud_securitycenter_v1beta1_finding_proto_rawDesc = "" +
	"\n" +
	...
	"\rresource_name\x18\x03 \x01(\tR\fresourceName\x12H\n" +
	"\x05state\x18\x04 \x01(\x0e22.google.cloud.securitycenter.v1beta1.Finding.StateR\x05state\x12\x1a\n" +
	"\bcategory\x18\x05 \x01(\tR\bcategory\x12!\n" +
	"\fexternal_uri\x18\x06 \x01(\tR\vexternalUri\x12o\n" +
	"\x11source_properties\x18\a \x03(\v2B.google.cloud.securitycenter.v1beta1.Finding.SourcePropertiesEntryR\x10sourceProperties\x12^\n" +
	"\x0esecurity_marks\x18\b \x01(\v22.google.cloud.securitycenter.v1beta1.SecurityMarksB\x03\xe0A\x03R\rsecurityMarks\x129\n" +
	"\n" +
...
var (
	...
	file_google_cloud_securitycenter_v1beta1_finding_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v1beta1_finding_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v1beta1_finding_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v1beta1_finding_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1beta1_finding_proto_rawDesc), len(file_google_cloud_securitycenter_v1beta1_finding_proto_rawDesc)))
	})
...
var file_google_cloud_securitycenter_v1beta1_finding_proto_goTypes = []any{
...
func file_google_cloud_securitycenter_v1beta1_finding_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1beta1_finding_proto_rawDesc), len(file_google_cloud_securitycenter_v1beta1_finding_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
