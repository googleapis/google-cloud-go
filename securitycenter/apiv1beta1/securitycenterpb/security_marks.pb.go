...
const file_google_cloud_securitycenter_v1beta1_security_marks_proto_rawDesc = "" +
	"\n" +
	"8google/cloud/securitycenter/v1beta1/security_marks.proto\x12#google.cloud.securitycenter.v1beta1\x1a\x19google/api/resource.proto\"\xf1\x02\n" +
	"\rSecurityMarks\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12S\n" +
	"\x05marks\x18\x02 \x03(\v2=.google.cloud.securitycenter.v1beta1.SecurityMarks.MarksEntryR\x05marks\x1a8\n" +
	"\n" +
	"MarksEntry\x12\x10\n" +
...
var (
	...
	file_google_cloud_securitycenter_v1beta1_security_marks_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v1beta1_security_marks_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v1beta1_security_marks_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v1beta1_security_marks_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1beta1_security_marks_proto_rawDesc), len(file_google_cloud_securitycenter_v1beta1_security_marks_proto_rawDesc)))
	})
...
var file_google_cloud_securitycenter_v1beta1_security_marks_proto_goTypes = []any{
...
func file_google_cloud_securitycenter_v1beta1_security_marks_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1beta1_security_marks_proto_rawDesc), len(file_google_cloud_securitycenter_v1beta1_security_marks_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
