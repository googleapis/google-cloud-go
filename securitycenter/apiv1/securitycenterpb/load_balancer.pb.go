...
var file_google_cloud_securitycenter_v1_load_balancer_proto_goTypes = []interface{}{
...
func file_google_cloud_securitycenter_v1_load_balancer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_securitycenter_v1_load_balancer_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
