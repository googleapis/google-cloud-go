...
const file_google_cloud_securitycenter_v1_security_posture_proto_rawDesc = "" +
	"\n" +
	"5google/cloud/securitycenter/v1/security_posture.proto\x12\x1egoogle.cloud.securitycenter.v1\"\x83\x04\n" +
	...
	"\x14policy_drift_details\x18\b \x03(\v2B.google.cloud.securitycenter.v1.SecurityPosture.PolicyDriftDetailsR\x12policyDriftDetails\x1ax\n" +
...
var (
	...
	file_google_cloud_securitycenter_v1_security_posture_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v1_security_posture_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v1_security_posture_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v1_security_posture_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_security_posture_proto_rawDesc), len(file_google_cloud_securitycenter_v1_security_posture_proto_rawDesc)))
	})
...
func file_google_cloud_securitycenter_v1_security_posture_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_security_posture_proto_rawDesc), len(file_google_cloud_securitycenter_v1_security_posture_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
