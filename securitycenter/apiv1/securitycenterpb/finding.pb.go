...
type Finding struct {
	...
	ExternalSystems map[string]*ExternalSystem `protobuf:"bytes,22,rep,name=external_systems,json=externalSystems,proto3" json:"external_systems,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	//	  }
	//	}
	Contacts map[string]*ContactDetails `protobuf:"bytes,33,rep,name=contacts,proto3" json:"contacts,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	Agent *Agent `protobuf:"bytes,88,opt,name=agent,proto3" json:"agent,omitempty"`
	// Conversational session(s) where the finding occurred.
	AgentSessions []*AgentSession `protobuf:"bytes,89,rep,name=agent_sessions,json=agentSessions,proto3" json:"agent_sessions,omitempty"`
	// Details about behavior anomalies detected in AI agents.
	AgentAnomaly  *AgentAnomaly `protobuf:"bytes,90,opt,name=agent_anomaly,json=agentAnomaly,proto3" json:"agent_anomaly,omitempty"`
...
const file_google_cloud_securitycenter_v1_finding_proto_rawDesc = "" +
	"\n" +
	",google/cloud/securitycenter/v1/finding.proto\x12\x1egoogle.cloud.securitycenter.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a+google/cloud/securitycenter/v1/access.proto\x1a*google/cloud/securitycenter/v1/agent.proto\x1a2google/cloud/securitycenter/v1/agent_anomaly.proto\x1a2google/cloud/securitycenter/v1/agent_session.proto\x1a0google/cloud/securitycenter/v1/application.proto\x1a4google/cloud/securitycenter/v1/attack_exposure.proto\x1a=google/cloud/securitycenter/v1/backup_disaster_recovery.proto\x1a/google/cloud/securitycenter/v1/chokepoint.proto\x1a0google/cloud/securitycenter/v1/cloud_armor.proto\x1a;google/cloud/securitycenter/v1/cloud_dlp_data_profile.proto\x1a9google/cloud/securitycenter/v1/cloud_dlp_inspection.proto\x1a/google/cloud/securitycenter/v1/compliance.proto\x1a/google/cloud/securitycenter/v1/connection.proto\x1a4google/cloud/securitycenter/v1/contact_details.proto\x1a.google/cloud/securitycenter/v1/container.proto\x1a-google/cloud/securitycenter/v1/database.proto\x1a1google/cloud/securitycenter/v1/exfiltration.proto\x1a6google/cloud/securitycenter/v1/external_exposure.proto\x1a4google/cloud/securitycenter/v1/external_system.proto\x1a)google/cloud/securitycenter/v1/file.proto\x1a5google/cloud/securitycenter/v1/group_membership.proto\x1a0google/cloud/securitycenter/v1/iam_binding.proto\x1a.google/cloud/securitycenter/v1/indicator.proto\x1a3google/cloud/securitycenter/v1/kernel_rootkit.proto\x1a/google/cloud/securitycenter/v1/kubernetes.proto\x1a2google/cloud/securitycenter/v1/load_balancer.proto\x1a.google/cloud/securitycenter/v1/log_entry.proto\x1a1google/cloud/securitycenter/v1/mitre_attack.proto\x1a-google/cloud/securitycenter/v1/notebook.proto\x1a/google/cloud/securitycenter/v1/org_policy.proto\x1a,google/cloud/securitycenter/v1/process.proto\x1a3google/cloud/securitycenter/v1/security_marks.proto\x1a5google/cloud/securitycenter/v1/security_posture.proto\x1a6google/cloud/securitycenter/v1/toxic_combination.proto\x1a2google/cloud/securitycenter/v1/vulnerability.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xdb*\n" +
	"\aFinding\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x16\n" +
	"\x06parent\x18\x02 \x01(\tR\x06parent\x12#\n" +
	"\rresource_name\x18\x03 \x01(\tR\fresourceName\x12C\n" +
	"\x05state\x18\x04 \x01(\x0e2-.google.cloud.securitycenter.v1.Finding.StateR\x05state\x12\x1a\n" +
	"\bcategory\x18\x05 \x01(\tR\bcategory\x12!\n" +
	"\fexternal_uri\x18\x06 \x01(\tR\vexternalUri\x12j\n" +
	"\x11source_properties\x18\a \x03(\v2=.google.cloud.securitycenter.v1.Finding.SourcePropertiesEntryR\x10sourceProperties\x12Y\n" +
	"\x0esecurity_marks\x18\b \x01(\v2-.google.cloud.securitycenter.v1.SecurityMarksB\x03\xe0A\x03R\rsecurityMarks\x129\n" +
	"\n" +
	"event_time\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\teventTime\x12;\n" +
	"\vcreate_time\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x12L\n" +
	"\bseverity\x18\f \x01(\x0e20.google.cloud.securitycenter.v1.Finding.SeverityR\bseverity\x12%\n" +
	"\x0ecanonical_name\x18\x0e \x01(\tR\rcanonicalName\x12@\n" +
	"\x04mute\x18\x0f \x01(\x0e2,.google.cloud.securitycenter.v1.Finding.MuteR\x04mute\x12Y\n" +
	"\rfinding_class\x18\x11 \x01(\x0e24.google.cloud.securitycenter.v1.Finding.FindingClassR\ffindingClass\x12G\n" +
	"\tindicator\x18\x12 \x01(\v2).google.cloud.securitycenter.v1.IndicatorR\tindicator\x12S\n" +
	"\rvulnerability\x18\x14 \x01(\v2-.google.cloud.securitycenter.v1.VulnerabilityR\rvulnerability\x12I\n" +
	"\x10mute_update_time\x18\x15 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\x0emuteUpdateTime\x12l\n" +
	"\x10external_systems\x18\x16 \x03(\v2<.google.cloud.securitycenter.v1.Finding.ExternalSystemsEntryB\x03\xe0A\x03R\x0fexternalSystems\x12N\n" +
	"\fmitre_attack\x18\x19 \x01(\v2+.google.cloud.securitycenter.v1.MitreAttackR\vmitreAttack\x12>\n" +
	"\x06access\x18\x1a \x01(\v2&.google.cloud.securitycenter.v1.AccessR\x06access\x12L\n" +
	"\vconnections\x18\x1f \x03(\v2*.google.cloud.securitycenter.v1.ConnectionR\vconnections\x12%\n" +
	"\x0emute_initiator\x18\x1c \x01(\tR\rmuteInitiator\x12R\n" +
	"\tmute_info\x18= \x01(\v20.google.cloud.securitycenter.v1.Finding.MuteInfoB\x03\xe0A\x03R\bmuteInfo\x12E\n" +
	"\tprocesses\x18\x1e \x03(\v2'.google.cloud.securitycenter.v1.ProcessR\tprocesses\x12V\n" +
	"\bcontacts\x18! \x03(\v25.google.cloud.securitycenter.v1.Finding.ContactsEntryB\x03\xe0A\x03R\bcontacts\x12L\n" +
	"\vcompliances\x18\" \x03(\v2*.google.cloud.securitycenter.v1.ComplianceR\vcompliances\x123\n" +
	"\x13parent_display_name\x18$ \x01(\tB\x03\xe0A\x03R\x11parentDisplayName\x12 \n" +
	"\vdescription\x18% \x01(\tR\vdescription\x12P\n" +
	"\fexfiltration\x18& \x01(\v2,.google.cloud.securitycenter.v1.ExfiltrationR\fexfiltration\x12M\n" +
	"\fiam_bindings\x18' \x03(\v2*.google.cloud.securitycenter.v1.IamBindingR\viamBindings\x12\x1d\n" +
	"\n" +
	"next_steps\x18( \x01(\tR\tnextSteps\x12\x1f\n" +
	"\vmodule_name\x18) \x01(\tR\n" +
	"moduleName\x12I\n" +
	"\n" +
	"containers\x18* \x03(\v2).google.cloud.securitycenter.v1.ContainerR\n" +
	"containers\x12J\n" +
	"\n" +
	"kubernetes\x18+ \x01(\v2*.google.cloud.securitycenter.v1.KubernetesR\n" +
	"kubernetes\x12D\n" +
	"\bdatabase\x18, \x01(\v2(.google.cloud.securitycenter.v1.DatabaseR\bdatabase\x12W\n" +
	"\x0fattack_exposure\x18- \x01(\v2..google.cloud.securitycenter.v1.AttackExposureR\x0eattackExposure\x12:\n" +
	"\x05files\x18. \x03(\v2$.google.cloud.securitycenter.v1.FileR\x05files\x12d\n" +
	"\x14cloud_dlp_inspection\x180 \x01(\v22.google.cloud.securitycenter.v1.CloudDlpInspectionR\x12cloudDlpInspection\x12h\n" +
	"\x16cloud_dlp_data_profile\x181 \x01(\v23.google.cloud.securitycenter.v1.CloudDlpDataProfileR\x13cloudDlpDataProfile\x12T\n" +
	"\x0ekernel_rootkit\x182 \x01(\v2-.google.cloud.securitycenter.v1.KernelRootkitR\rkernelRootkit\x12L\n" +
	"\forg_policies\x183 \x03(\v2).google.cloud.securitycenter.v1.OrgPolicyR\vorgPolicies\x12M\n" +
	"\vapplication\x185 \x01(\v2+.google.cloud.securitycenter.v1.ApplicationR\vapplication\x12p\n" +
	"\x18backup_disaster_recovery\x187 \x01(\v26.google.cloud.securitycenter.v1.BackupDisasterRecoveryR\x16backupDisasterRecovery\x12Z\n" +
	"\x10security_posture\x188 \x01(\v2/.google.cloud.securitycenter.v1.SecurityPostureR\x0fsecurityPosture\x12I\n" +
	"\vlog_entries\x189 \x03(\v2(.google.cloud.securitycenter.v1.LogEntryR\n" +
	"logEntries\x12S\n" +
	"\x0eload_balancers\x18: \x03(\v2,.google.cloud.securitycenter.v1.LoadBalancerR\rloadBalancers\x12K\n" +
	"\vcloud_armor\x18; \x01(\v2*.google.cloud.securitycenter.v1.CloudArmorR\n" +
	"cloudArmor\x12D\n" +
	"\bnotebook\x18? \x01(\v2(.google.cloud.securitycenter.v1.NotebookR\bnotebook\x12]\n" +
	"\x11toxic_combination\x18@ \x01(\v20.google.cloud.securitycenter.v1.ToxicCombinationR\x10toxicCombination\x12\\\n" +
	"\x11group_memberships\x18A \x03(\v2/.google.cloud.securitycenter.v1.GroupMembershipR\x10groupMemberships\x12J\n" +
	"\n" +
	"chokepoint\x18M \x01(\v2*.google.cloud.securitycenter.v1.ChokepointR\n" +
	"chokepoint\x12]\n" +
	"\x11external_exposure\x18T \x01(\v20.google.cloud.securitycenter.v1.ExternalExposureR\x10externalExposure\x12;\n" +
	"\x05agent\x18X \x01(\v2%.google.cloud.securitycenter.v1.AgentR\x05agent\x12S\n" +
	"\x0eagent_sessions\x18Y \x03(\v2,.google.cloud.securitycenter.v1.AgentSessionR\ragentSessions\x12Q\n" +
	"\ragent_anomaly\x18Z \x01(\v2,.google.cloud.securitycenter.v1.AgentAnomalyR\fagentAnomaly\x1a\xdd\x03\n" +
	"\bMuteInfo\x12\\\n" +
	"\vstatic_mute\x18\x01 \x01(\v2;.google.cloud.securitycenter.v1.Finding.MuteInfo.StaticMuteR\n" +
	"staticMute\x12t\n" +
	"\x14dynamic_mute_records\x18\x02 \x03(\v2B.google.cloud.securitycenter.v1.Finding.MuteInfo.DynamicMuteRecordR\x12dynamicMuteRecords\x1a\x8b\x01\n" +
	"\n" +
	"StaticMute\x12B\n" +
	"\x05state\x18\x01 \x01(\x0e2,.google.cloud.securitycenter.v1.Finding.MuteR\x05state\x129\n" +
	"\n" +
	...
	"\x05value\x18\x02 \x01(\v2..google.cloud.securitycenter.v1.ExternalSystemR\x05value:\x028\x01\x1ak\n" +
	"\rContactsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12D\n" +
	"\x05value\x18\x02 \x01(\v2..google.cloud.securitycenter.v1.ContactDetailsR\x05value:\x028\x01\"8\n" +
	"\x05State\x12\x15\n" +
	...
	"\x11EXTERNAL_EXPOSURE\x10\n" +
	":\xee\x01\xeaA\xea\x01\n" +
	"%securitycenter.googleapis.com/Finding\x12@organizations/{organization}/sources/{source}/findings/{finding}\x124folders/{folder}/sources/{source}/findings/{finding}\x126projects/{project}/sources/{source}/findings/{finding}*\bfindings2\afindingB\xd8\x01\n" +
...
var (
	...
	file_google_cloud_securitycenter_v1_finding_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v1_finding_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v1_finding_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v1_finding_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_finding_proto_rawDesc), len(file_google_cloud_securitycenter_v1_finding_proto_rawDesc)))
	})
...
var file_google_cloud_securitycenter_v1_finding_proto_goTypes = []any{
	...
	(*Agent)(nil),                              // 42: google.cloud.securitycenter.v1.Agent
	(*AgentSession)(nil),                       // 43: google.cloud.securitycenter.v1.AgentSession
	(*AgentAnomaly)(nil),                       // 44: google.cloud.securitycenter.v1.AgentAnomaly
	(*structpb.Value)(nil),                     // 45: google.protobuf.Value
	(*ExternalSystem)(nil),                     // 46: google.cloud.securitycenter.v1.ExternalSystem
	(*ContactDetails)(nil),                     // 47: google.cloud.securitycenter.v1.ContactDetails
}
var file_google_cloud_securitycenter_v1_finding_proto_depIdxs = []int32{
	...
	42, // 41: google.cloud.securitycenter.v1.Finding.agent:type_name -> google.cloud.securitycenter.v1.Agent
	43, // 42: google.cloud.securitycenter.v1.Finding.agent_sessions:type_name -> google.cloud.securitycenter.v1.AgentSession
	44, // 43: google.cloud.securitycenter.v1.Finding.agent_anomaly:type_name -> google.cloud.securitycenter.v1.AgentAnomaly
	9,  // 44: google.cloud.securitycenter.v1.Finding.MuteInfo.static_mute:type_name -> google.cloud.securitycenter.v1.Finding.MuteInfo.StaticMute
	10, // 45: google.cloud.securitycenter.v1.Finding.MuteInfo.dynamic_mute_records:type_name -> google.cloud.securitycenter.v1.Finding.MuteInfo.DynamicMuteRecord
	45, // 46: google.cloud.securitycenter.v1.Finding.SourcePropertiesEntry.value:type_name -> google.protobuf.Value
	46, // 47: google.cloud.securitycenter.v1.Finding.ExternalSystemsEntry.value:type_name -> google.cloud.securitycenter.v1.ExternalSystem
	47, // 48: google.cloud.securitycenter.v1.Finding.ContactsEntry.value:type_name -> google.cloud.securitycenter.v1.ContactDetails
	2,  // 49: google.cloud.securitycenter.v1.Finding.MuteInfo.StaticMute.state:type_name -> google.cloud.securitycenter.v1.Finding.Mute
	12, // 50: google.cloud.securitycenter.v1.Finding.MuteInfo.StaticMute.apply_time:type_name -> google.protobuf.Timestamp
	12, // 51: google.cloud.securitycenter.v1.Finding.MuteInfo.DynamicMuteRecord.match_time:type_name -> google.protobuf.Timestamp
...
func file_google_cloud_securitycenter_v1_finding_proto_init() {
	...
	file_google_cloud_securitycenter_v1_agent_proto_init()
	file_google_cloud_securitycenter_v1_agent_anomaly_proto_init()
	file_google_cloud_securitycenter_v1_agent_session_proto_init()
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_finding_proto_rawDesc), len(file_google_cloud_securitycenter_v1_finding_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
