...
var file_google_cloud_securitycenter_v1_log_entry_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x42, 0x0d, 0x4c, 0x6f, 0x67, 0x45, 0x6e,
...
var (
	...
	file_google_cloud_securitycenter_v1_log_entry_proto_rawDescData = file_google_cloud_securitycenter_v1_log_entry_proto_rawDesc
)
...
func file_google_cloud_securitycenter_v1_log_entry_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v1_log_entry_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v1_log_entry_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_cloud_securitycenter_v1_log_entry_proto_rawDescData)
	})
...
var file_google_cloud_securitycenter_v1_log_entry_proto_goTypes = []interface{}{
...
func file_google_cloud_securitycenter_v1_log_entry_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_securitycenter_v1_log_entry_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_securitycenter_v1_log_entry_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_securitycenter_v1_log_entry_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_cloud_securitycenter_v1_log_entry_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_google_cloud_securitycenter_v1_log_entry_proto_rawDesc = nil
