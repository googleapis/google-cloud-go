...
const file_google_cloud_securitycenter_v1_group_membership_proto_rawDesc = "" +
	"\n" +
	"5google/cloud/securitycenter/v1/group_membership.proto\x12\x1egoogle.cloud.securitycenter.v1\"\xec\x01\n" +
	"\x0fGroupMembership\x12X\n" +
	"\n" +
	"group_type\x18\x01 \x01(\x0e29.google.cloud.securitycenter.v1.GroupMembership.GroupTypeR\tgroupType\x12\x19\n" +
...
var (
	...
	file_google_cloud_securitycenter_v1_group_membership_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v1_group_membership_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v1_group_membership_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v1_group_membership_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_group_membership_proto_rawDesc), len(file_google_cloud_securitycenter_v1_group_membership_proto_rawDesc)))
	})
...
func file_google_cloud_securitycenter_v1_group_membership_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_group_membership_proto_rawDesc), len(file_google_cloud_securitycenter_v1_group_membership_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
