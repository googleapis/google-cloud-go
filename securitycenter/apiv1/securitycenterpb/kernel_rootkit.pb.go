...
const file_google_cloud_securitycenter_v1_kernel_rootkit_proto_rawDesc = "" +
	"\n" +
	"3google/cloud/securitycenter/v1/kernel_rootkit.proto\x12\x1egoogle.cloud.securitycenter.v1\"\xc2\x04\n" +
...
var (
	...
	file_google_cloud_securitycenter_v1_kernel_rootkit_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v1_kernel_rootkit_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v1_kernel_rootkit_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v1_kernel_rootkit_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_kernel_rootkit_proto_rawDesc), len(file_google_cloud_securitycenter_v1_kernel_rootkit_proto_rawDesc)))
	})
...
func file_google_cloud_securitycenter_v1_kernel_rootkit_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_kernel_rootkit_proto_rawDesc), len(file_google_cloud_securitycenter_v1_kernel_rootkit_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
