...
func (Connection_Protocol) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_securitycenter_v1_connection_proto_enumTypes[0].Descriptor()
}

func (Connection_Protocol) Type() protoreflect.EnumType {
	return &file_google_cloud_securitycenter_v1_connection_proto_enumTypes[0]
}
...
func (Connection_Protocol) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_securitycenter_v1_connection_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *Connection) Reset() {
	*x = Connection{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_cloud_securitycenter_v1_connection_proto_msgTypes[0]
...
func (*Connection) Descriptor() ([]byte, []int) {
	return file_google_cloud_securitycenter_v1_connection_proto_rawDescGZIP(), []int{0}
}
...
var file_google_cloud_securitycenter_v1_connection_proto_rawDesc = []byte{
	...
	0x31, 0x22, 0xc1, 0x02, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x69, 0x74, 0x79, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x42, 0x0f, 0x43, 0x6f,
	...
	0x74, 0x65, 0x72, 0x2f, 0x61, 0x70, 0x69, 0x76, 0x31, 0x2f, 0x73, 0x65, 0x63, 0x75, 0x72, 0x69,
...
var (
	file_google_cloud_securitycenter_v1_connection_proto_rawDescOnce sync.Once
	file_google_cloud_securitycenter_v1_connection_proto_rawDescData = file_google_cloud_securitycenter_v1_connection_proto_rawDesc
)

func file_google_cloud_securitycenter_v1_connection_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v1_connection_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v1_connection_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_cloud_securitycenter_v1_connection_proto_rawDescData)
	})
	return file_google_cloud_securitycenter_v1_connection_proto_rawDescData
}

var file_google_cloud_securitycenter_v1_connection_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_cloud_securitycenter_v1_connection_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_cloud_securitycenter_v1_connection_proto_goTypes = []interface{}{
	(Connection_Protocol)(0), // 0: google.cloud.securitycenter.v1.Connection.Protocol
	(*Connection)(nil),       // 1: google.cloud.securitycenter.v1.Connection
}
var file_google_cloud_securitycenter_v1_connection_proto_depIdxs = []int32{
	0, // 0: google.cloud.securitycenter.v1.Connection.protocol:type_name -> google.cloud.securitycenter.v1.Connection.Protocol
...
func init() { file_google_cloud_securitycenter_v1_connection_proto_init() }
func file_google_cloud_securitycenter_v1_connection_proto_init() {
	if File_google_cloud_securitycenter_v1_connection_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_securitycenter_v1_connection_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_cloud_securitycenter_v1_connection_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_cloud_securitycenter_v1_connection_proto_goTypes,
		DependencyIndexes: file_google_cloud_securitycenter_v1_connection_proto_depIdxs,
		EnumInfos:         file_google_cloud_securitycenter_v1_connection_proto_enumTypes,
		MessageInfos:      file_google_cloud_securitycenter_v1_connection_proto_msgTypes,
	}.Build()
	File_google_cloud_securitycenter_v1_connection_proto = out.File
	file_google_cloud_securitycenter_v1_connection_proto_rawDesc = nil
	file_google_cloud_securitycenter_v1_connection_proto_goTypes = nil
	file_google_cloud_securitycenter_v1_connection_proto_depIdxs = nil
}
