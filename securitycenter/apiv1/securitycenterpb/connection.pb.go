...
var file_google_cloud_securitycenter_v1_connection_proto_goTypes = []any{
...
func file_google_cloud_securitycenter_v1_connection_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_securitycenter_v1_connection_proto_msgTypes[0].Exporter = func(v any, i int) any {
