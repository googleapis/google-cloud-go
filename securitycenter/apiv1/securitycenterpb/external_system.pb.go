...
const file_google_cloud_securitycenter_v1_external_system_proto_rawDesc = "" +
	"\n" +
	"4google/cloud/securitycenter/v1/external_system.proto\x12\x1egoogle.cloud.securitycenter.v1\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe2\b\n" +
	...
	"\vticket_info\x18\b \x01(\v29.google.cloud.securitycenter.v1.ExternalSystem.TicketInfoR\n" +
...
var (
	...
	file_google_cloud_securitycenter_v1_external_system_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v1_external_system_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v1_external_system_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v1_external_system_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_external_system_proto_rawDesc), len(file_google_cloud_securitycenter_v1_external_system_proto_rawDesc)))
	})
...
func file_google_cloud_securitycenter_v1_external_system_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_external_system_proto_rawDesc), len(file_google_cloud_securitycenter_v1_external_system_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
