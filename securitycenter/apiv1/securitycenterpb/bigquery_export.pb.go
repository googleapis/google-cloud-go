...
const file_google_cloud_securitycenter_v1_bigquery_export_proto_rawDesc = "" +
	"\n" +
	"4google/cloud/securitycenter/v1/bigquery_export.proto\x12\x1egoogle.cloud.securitycenter.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb7\x04\n" +
	...
	"\tprincipal\x18\b \x01(\tB\x03\xe0A\x03R\tprincipal:\xe2\x01\xeaA\xde\x01\n" +
...
var (
	...
	file_google_cloud_securitycenter_v1_bigquery_export_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v1_bigquery_export_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v1_bigquery_export_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v1_bigquery_export_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_bigquery_export_proto_rawDesc), len(file_google_cloud_securitycenter_v1_bigquery_export_proto_rawDesc)))
	})
...
var file_google_cloud_securitycenter_v1_bigquery_export_proto_goTypes = []any{
...
func file_google_cloud_securitycenter_v1_bigquery_export_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_bigquery_export_proto_rawDesc), len(file_google_cloud_securitycenter_v1_bigquery_export_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
