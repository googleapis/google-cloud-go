...
const file_google_cloud_securitycenter_v1_database_proto_rawDesc = "" +
	"\n" +
	"-google/cloud/securitycenter/v1/database.proto\x12\x1egoogle.cloud.securitycenter.v1\"\xaa\x01\n" +
	"\bDatabase\x12\x12\n" +
...
var (
	...
	file_google_cloud_securitycenter_v1_database_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v1_database_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v1_database_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v1_database_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_database_proto_rawDesc), len(file_google_cloud_securitycenter_v1_database_proto_rawDesc)))
	})
...
func file_google_cloud_securitycenter_v1_database_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_database_proto_rawDesc), len(file_google_cloud_securitycenter_v1_database_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
