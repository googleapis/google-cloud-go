...
const file_google_cloud_securitycenter_v1_notification_message_proto_rawDesc = "" +
	"\n" +
	"9google/cloud/securitycenter/v1/notification_message.proto\x12\x1egoogle.cloud.securitycenter.v1\x1a,google/cloud/securitycenter/v1/finding.proto\x1a-google/cloud/securitycenter/v1/resource.proto\"\xe3\x01\n" +
	"\x13NotificationMessage\x128\n" +
	"\x18notification_config_name\x18\x01 \x01(\tR\x16notificationConfigName\x12C\n" +
	"\afinding\x18\x02 \x01(\v2'.google.cloud.securitycenter.v1.FindingH\x00R\afinding\x12D\n" +
	"\bresource\x18\x03 \x01(\v2(.google.cloud.securitycenter.v1.ResourceR\bresourceB\a\n" +
	"\x05eventB\xf2\x01\n" +
...
var (
	...
	file_google_cloud_securitycenter_v1_notification_message_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v1_notification_message_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v1_notification_message_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v1_notification_message_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_notification_message_proto_rawDesc), len(file_google_cloud_securitycenter_v1_notification_message_proto_rawDesc)))
	})
...
var file_google_cloud_securitycenter_v1_notification_message_proto_goTypes = []any{
...
func file_google_cloud_securitycenter_v1_notification_message_proto_init() {
	...
	file_google_cloud_securitycenter_v1_notification_message_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_notification_message_proto_rawDesc), len(file_google_cloud_securitycenter_v1_notification_message_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
