...
const file_google_cloud_securitycenter_v1_process_proto_rawDesc = "" +
	"\n" +
	",google/cloud/securitycenter/v1/process.proto\x12\x1egoogle.cloud.securitycenter.v1\x1a)google/cloud/securitycenter/v1/file.proto\"\xe5\x03\n" +
	"\aProcess\x12\x12\n" +
	"\x04name\x18\f \x01(\tR\x04name\x12<\n" +
	"\x06binary\x18\x03 \x01(\v2$.google.cloud.securitycenter.v1.FileR\x06binary\x12B\n" +
	"\tlibraries\x18\x04 \x03(\v2$.google.cloud.securitycenter.v1.FileR\tlibraries\x12<\n" +
	"\x06script\x18\x05 \x01(\v2$.google.cloud.securitycenter.v1.FileR\x06script\x12\x12\n" +
	"\x04args\x18\x06 \x03(\tR\x04args\x12/\n" +
	"\x13arguments_truncated\x18\a \x01(\bR\x12argumentsTruncated\x12X\n" +
	"\renv_variables\x18\b \x03(\v23.google.cloud.securitycenter.v1.EnvironmentVariableR\fenvVariables\x126\n" +
	"\x17env_variables_truncated\x18\t \x01(\bR\x15envVariablesTruncated\x12\x10\n" +
	"\x03pid\x18\n" +
	" \x01(\x03R\x03pid\x12\x1d\n" +
	"\n" +
	"parent_pid\x18\v \x01(\x03R\tparentPid\";\n" +
	"\x13EnvironmentVariable\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x10\n" +
	"\x03val\x18\x02 \x01(\tR\x03valB\xe6\x01\n" +
	"\"com.google.cloud.securitycenter.v1B\fProcessProtoP\x01ZJcloud.google.com/go/securitycenter/apiv1/securitycenterpb;securitycenterpb\xaa\x02\x1eGoogle.Cloud.SecurityCenter.V1\xca\x02\x1eGoogle\\Cloud\\SecurityCenter\\V1\xea\x02!Google::Cloud::SecurityCenter::V1b\x06proto3"

var (
	file_google_cloud_securitycenter_v1_process_proto_rawDescOnce sync.Once
	file_google_cloud_securitycenter_v1_process_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v1_process_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v1_process_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v1_process_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_process_proto_rawDesc), len(file_google_cloud_securitycenter_v1_process_proto_rawDesc)))
	})
...
var file_google_cloud_securitycenter_v1_process_proto_goTypes = []any{
...
func file_google_cloud_securitycenter_v1_process_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1_process_proto_rawDesc), len(file_google_cloud_securitycenter_v1_process_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
