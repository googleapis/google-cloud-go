...
func ExampleSecurityCenterSettingsClient_ListComponents_all() {
	...
	for resp, err := range c.ListComponents(ctx, req).All() {
		if err != nil {
			// TODO: Handle error.
		}
		// TODO: Use resp.
...
func ExampleSecurityCenterSettingsClient_ListDetectors_all() {
	ctx := context.Background()
	// This snippet has been automatically generated and should be regarded as a code template only.
	// It will require modifications to work:
	// - It may require correct/in-range values for request initialization.
	...
	for resp, err := range c.ListDetectors(ctx, req).All() {
		if err != nil {
			// TODO: Handle error.
		}
		// TODO: Use resp.
