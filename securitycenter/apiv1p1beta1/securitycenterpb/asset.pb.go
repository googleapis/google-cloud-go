...
const file_google_cloud_securitycenter_v1p1beta1_asset_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/securitycenter/v1p1beta1/asset.proto\x12%google.cloud.securitycenter.v1p1beta1\x1a\x19google/api/resource.proto\x1a2google/cloud/securitycenter/v1p1beta1/folder.proto\x1a:google/cloud/securitycenter/v1p1beta1/security_marks.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfc\n" +
	"\n" +
	"\x05Asset\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x83\x01\n" +
	"\x1asecurity_center_properties\x18\x02 \x01(\v2E.google.cloud.securitycenter.v1p1beta1.Asset.SecurityCenterPropertiesR\x18securityCenterProperties\x12u\n" +
	"\x13resource_properties\x18\a \x03(\v2D.google.cloud.securitycenter.v1p1beta1.Asset.ResourcePropertiesEntryR\x12resourceProperties\x12[\n" +
	"\x0esecurity_marks\x18\b \x01(\v24.google.cloud.securitycenter.v1p1beta1.SecurityMarksR\rsecurityMarks\x12;\n" +
	...
	"updateTime\x12U\n" +
	"\n" +
	"iam_policy\x18\v \x01(\v26.google.cloud.securitycenter.v1p1beta1.Asset.IamPolicyR\tiamPolicy\x12%\n" +
	"\x0ecanonical_name\x18\r \x01(\tR\rcanonicalName\x1a\xe2\x03\n" +
	...
	"\x1dresource_project_display_name\x18\b \x01(\tR\x1aresourceProjectDisplayName\x12G\n" +
	"\afolders\x18\n" +
	" \x03(\v2-.google.cloud.securitycenter.v1p1beta1.FolderR\afolders\x1a,\n" +
	"\tIamPolicy\x12\x1f\n" +
	"\vpolicy_blob\x18\x01 \x01(\tR\n" +
	"policyBlob\x1a]\n" +
	"\x17ResourcePropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value:\x028\x01:\x9a\x01\xeaA\x96\x01\n" +
...
var (
	...
	file_google_cloud_securitycenter_v1p1beta1_asset_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v1p1beta1_asset_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v1p1beta1_asset_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v1p1beta1_asset_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1p1beta1_asset_proto_rawDesc), len(file_google_cloud_securitycenter_v1p1beta1_asset_proto_rawDesc)))
	})
...
var file_google_cloud_securitycenter_v1p1beta1_asset_proto_goTypes = []any{
...
func file_google_cloud_securitycenter_v1p1beta1_asset_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1p1beta1_asset_proto_rawDesc), len(file_google_cloud_securitycenter_v1p1beta1_asset_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
