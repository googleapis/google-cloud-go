...
const file_google_cloud_securitycenter_v1p1beta1_notification_config_proto_rawDesc = "" +
	"\n" +
	"?google/cloud/securitycenter/v1p1beta1/notification_config.proto\x12%google.cloud.securitycenter.v1p1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\x8a\x05\n" +
	"\x12NotificationConfig\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12b\n" +
	"\n" +
	"event_type\x18\x03 \x01(\x0e2C.google.cloud.securitycenter.v1p1beta1.NotificationConfig.EventTypeR\teventType\x12C\n" +
	"\fpubsub_topic\x18\x04 \x01(\tB \xfaA\x1d\n" +
	"\x1bpubsub.googleapis.com/TopicR\vpubsubTopic\x12,\n" +
	"\x0fservice_account\x18\x05 \x01(\tB\x03\xe0A\x03R\x0eserviceAccount\x12v\n" +
	"\x10streaming_config\x18\x06 \x01(\v2I.google.cloud.securitycenter.v1p1beta1.NotificationConfig.StreamingConfigH\x00R\x0fstreamingConfig\x1a)\n" +
	"\x0fStreamingConfig\x12\x16\n" +
	"\x06filter\x18\x01 \x01(\tR\x06filter\"4\n" +
	"\tEventType\x12\x1a\n" +
	"\x16EVENT_TYPE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aFINDING\x10\x01:}\xeaAz\n" +
...
var (
	...
	file_google_cloud_securitycenter_v1p1beta1_notification_config_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v1p1beta1_notification_config_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v1p1beta1_notification_config_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v1p1beta1_notification_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1p1beta1_notification_config_proto_rawDesc), len(file_google_cloud_securitycenter_v1p1beta1_notification_config_proto_rawDesc)))
	})
...
var file_google_cloud_securitycenter_v1p1beta1_notification_config_proto_goTypes = []any{
...
func file_google_cloud_securitycenter_v1p1beta1_notification_config_proto_init() {
	...
	file_google_cloud_securitycenter_v1p1beta1_notification_config_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v1p1beta1_notification_config_proto_rawDesc), len(file_google_cloud_securitycenter_v1p1beta1_notification_config_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
