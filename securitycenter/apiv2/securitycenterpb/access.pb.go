...
type Access struct {
	...
	ServiceAccountKeyName string `protobuf:"bytes,9,opt,name=service_account_key_name,json=serviceAccountKeyName,proto3" json:"service_account_key_name,omitempty"`
	...
	ServiceAccountDelegationInfo []*ServiceAccountDelegationInfo `protobuf:"bytes,10,rep,name=service_account_delegation_info,json=serviceAccountDelegationInfo,proto3" json:"service_account_delegation_info,omitempty"`
...
func (x *Access) Reset() {
	*x = Access{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_cloud_securitycenter_v2_access_proto_msgTypes[0]
...
func (*Access) Descriptor() ([]byte, []int) {
	return file_google_cloud_securitycenter_v2_access_proto_rawDescGZIP(), []int{0}
}
...
func (x *ServiceAccountDelegationInfo) Reset() {
	*x = ServiceAccountDelegationInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_cloud_securitycenter_v2_access_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ServiceAccountDelegationInfo) Descriptor() ([]byte, []int) {
	return file_google_cloud_securitycenter_v2_access_proto_rawDescGZIP(), []int{1}
}
...
func (x *Geolocation) Reset() {
	*x = Geolocation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_cloud_securitycenter_v2_access_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Geolocation) Descriptor() ([]byte, []int) {
	return file_google_cloud_securitycenter_v2_access_proto_rawDescGZIP(), []int{2}
}
...
var file_google_cloud_securitycenter_v2_access_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x74, 0x79, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x76, 0x32, 0x22, 0xb7, 0x04,
	...
	0x74, 0x65, 0x72, 0x2e, 0x76, 0x32, 0x2e, 0x47, 0x65, 0x6f, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69,
	...
	0x0b, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x07, 0x20, 0x01,
	...
	0x65, 0x63, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x70, 0x72, 0x69, 0x6e, 0x63,
	...
	0x65, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x15, 0x73,
	...
	0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3c,
	...
	0x72, 0x2e, 0x76, 0x32, 0x42, 0x0b, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x50, 0x72, 0x6f, 0x74,
...
var (
	file_google_cloud_securitycenter_v2_access_proto_rawDescOnce sync.Once
	file_google_cloud_securitycenter_v2_access_proto_rawDescData = file_google_cloud_securitycenter_v2_access_proto_rawDesc
)

func file_google_cloud_securitycenter_v2_access_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v2_access_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v2_access_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_cloud_securitycenter_v2_access_proto_rawDescData)
	})
	return file_google_cloud_securitycenter_v2_access_proto_rawDescData
}

var file_google_cloud_securitycenter_v2_access_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_cloud_securitycenter_v2_access_proto_goTypes = []interface{}{
	(*Access)(nil),                       // 0: google.cloud.securitycenter.v2.Access
	(*ServiceAccountDelegationInfo)(nil), // 1: google.cloud.securitycenter.v2.ServiceAccountDelegationInfo
	(*Geolocation)(nil),                  // 2: google.cloud.securitycenter.v2.Geolocation
}
var file_google_cloud_securitycenter_v2_access_proto_depIdxs = []int32{
	2, // 0: google.cloud.securitycenter.v2.Access.caller_ip_geo:type_name -> google.cloud.securitycenter.v2.Geolocation
	1, // 1: google.cloud.securitycenter.v2.Access.service_account_delegation_info:type_name -> google.cloud.securitycenter.v2.ServiceAccountDelegationInfo
...
func init() { file_google_cloud_securitycenter_v2_access_proto_init() }
func file_google_cloud_securitycenter_v2_access_proto_init() {
	if File_google_cloud_securitycenter_v2_access_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_securitycenter_v2_access_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Access); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_cloud_securitycenter_v2_access_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_securitycenter_v2_access_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_cloud_securitycenter_v2_access_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_cloud_securitycenter_v2_access_proto_goTypes,
		DependencyIndexes: file_google_cloud_securitycenter_v2_access_proto_depIdxs,
		MessageInfos:      file_google_cloud_securitycenter_v2_access_proto_msgTypes,
	}.Build()
	File_google_cloud_securitycenter_v2_access_proto = out.File
	file_google_cloud_securitycenter_v2_access_proto_rawDesc = nil
	file_google_cloud_securitycenter_v2_access_proto_goTypes = nil
	file_google_cloud_securitycenter_v2_access_proto_depIdxs = nil
}
