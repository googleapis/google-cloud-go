...
const file_google_cloud_securitycenter_v2_backup_disaster_recovery_proto_rawDesc = "" +
	"\n" +
	"=google/cloud/securitycenter/v2/backup_disaster_recovery.proto\x12\x1egoogle.cloud.securitycenter.v2\x1a\x1fgoogle/protobuf/timestamp.proto\"\x82\x03\n" +
...
var (
	...
	file_google_cloud_securitycenter_v2_backup_disaster_recovery_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v2_backup_disaster_recovery_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v2_backup_disaster_recovery_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v2_backup_disaster_recovery_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_backup_disaster_recovery_proto_rawDesc), len(file_google_cloud_securitycenter_v2_backup_disaster_recovery_proto_rawDesc)))
	})
...
func file_google_cloud_securitycenter_v2_backup_disaster_recovery_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_backup_disaster_recovery_proto_rawDesc), len(file_google_cloud_securitycenter_v2_backup_disaster_recovery_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
