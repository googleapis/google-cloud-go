...
var file_google_cloud_securitycenter_v2_file_proto_goTypes = []interface{}{
...
func file_google_cloud_securitycenter_v2_file_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_securitycenter_v2_file_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*File); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_cloud_securitycenter_v2_file_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
