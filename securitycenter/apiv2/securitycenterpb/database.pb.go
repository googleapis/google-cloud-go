...
var file_google_cloud_securitycenter_v2_database_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x32, 0x42, 0x0d, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x50, 0x72, 0x6f,
...
var (
	...
	file_google_cloud_securitycenter_v2_database_proto_rawDescData = file_google_cloud_securitycenter_v2_database_proto_rawDesc
)
...
func file_google_cloud_securitycenter_v2_database_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v2_database_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v2_database_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_cloud_securitycenter_v2_database_proto_rawDescData)
	})
...
var file_google_cloud_securitycenter_v2_database_proto_goTypes = []interface{}{
...
func file_google_cloud_securitycenter_v2_database_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_securitycenter_v2_database_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_cloud_securitycenter_v2_database_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_google_cloud_securitycenter_v2_database_proto_rawDesc = nil
