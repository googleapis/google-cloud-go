...
const file_google_cloud_securitycenter_v2_mute_config_proto_rawDesc = "" +
	"\n" +
	"0google/cloud/securitycenter/v2/mute_config.proto\x12\x1egoogle.cloud.securitycenter.v2\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xab\a\n" +
	"\n" +
	"MuteConfig\x12\x17\n" +
	...
	"updateTime\x121\n" +
	"\x12most_recent_editor\x18\x06 \x01(\tB\x03\xe0A\x03R\x10mostRecentEditor\x12R\n" +
	"\x04type\x18\b \x01(\x0e29.google.cloud.securitycenter.v2.MuteConfig.MuteConfigTypeB\x03\xe0A\x02R\x04type\x12@\n" +
...
var (
	...
	file_google_cloud_securitycenter_v2_mute_config_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v2_mute_config_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v2_mute_config_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v2_mute_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_mute_config_proto_rawDesc), len(file_google_cloud_securitycenter_v2_mute_config_proto_rawDesc)))
	})
...
func file_google_cloud_securitycenter_v2_mute_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_mute_config_proto_rawDesc), len(file_google_cloud_securitycenter_v2_mute_config_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
