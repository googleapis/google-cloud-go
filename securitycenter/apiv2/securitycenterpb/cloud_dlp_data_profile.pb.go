...
var file_google_cloud_securitycenter_v2_cloud_dlp_data_profile_proto_goTypes = []interface{}{
...
func file_google_cloud_securitycenter_v2_cloud_dlp_data_profile_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_securitycenter_v2_cloud_dlp_data_profile_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
