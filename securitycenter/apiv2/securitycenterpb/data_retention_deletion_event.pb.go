...
const file_google_cloud_securitycenter_v2_data_retention_deletion_event_proto_rawDesc = "" +
	"\n" +
	"Bgoogle/cloud/securitycenter/v2/data_retention_deletion_event.proto\x12\x1egoogle.cloud.securitycenter.v2\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x94\x03\n" +
	"\x1aDataRetentionDeletionEvent\x12L\n" +
	"\x14event_detection_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x12eventDetectionTime\x12*\n" +
	"\x11data_object_count\x18\x03 \x01(\x03R\x0fdataObjectCount\x12M\n" +
	"\x15max_retention_allowed\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\x13maxRetentionAllowed\x12c\n" +
	"\n" +
	"event_type\x18\x05 \x01(\x0e2D.google.cloud.securitycenter.v2.DataRetentionDeletionEvent.EventTypeR\teventType\"H\n" +
	"\tEventType\x12\x1a\n" +
...
var (
	...
	file_google_cloud_securitycenter_v2_data_retention_deletion_event_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v2_data_retention_deletion_event_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v2_data_retention_deletion_event_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v2_data_retention_deletion_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_data_retention_deletion_event_proto_rawDesc), len(file_google_cloud_securitycenter_v2_data_retention_deletion_event_proto_rawDesc)))
	})
...
func file_google_cloud_securitycenter_v2_data_retention_deletion_event_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_data_retention_deletion_event_proto_rawDesc), len(file_google_cloud_securitycenter_v2_data_retention_deletion_event_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
