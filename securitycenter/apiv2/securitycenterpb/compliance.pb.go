...
func (x *Compliance) Reset() {
	*x = Compliance{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_cloud_securitycenter_v2_compliance_proto_msgTypes[0]
...
func (*Compliance) Descriptor() ([]byte, []int) {
	return file_google_cloud_securitycenter_v2_compliance_proto_rawDescGZIP(), []int{0}
}
...
var file_google_cloud_securitycenter_v2_compliance_proto_rawDesc = []byte{
	...
	0x32, 0x22, 0x54, 0x0a, 0x0a, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x69, 0x61, 0x6e, 0x63, 0x65, 0x12,
	...
	0x75, 0x72, 0x69, 0x74, 0x79, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x76, 0x32, 0x42, 0x0f,
...
var (
	file_google_cloud_securitycenter_v2_compliance_proto_rawDescOnce sync.Once
	file_google_cloud_securitycenter_v2_compliance_proto_rawDescData = file_google_cloud_securitycenter_v2_compliance_proto_rawDesc
)

func file_google_cloud_securitycenter_v2_compliance_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v2_compliance_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v2_compliance_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_cloud_securitycenter_v2_compliance_proto_rawDescData)
	})
	return file_google_cloud_securitycenter_v2_compliance_proto_rawDescData
}

var file_google_cloud_securitycenter_v2_compliance_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_cloud_securitycenter_v2_compliance_proto_goTypes = []interface{}{
	(*Compliance)(nil), // 0: google.cloud.securitycenter.v2.Compliance
}
var file_google_cloud_securitycenter_v2_compliance_proto_depIdxs = []int32{
...
func init() { file_google_cloud_securitycenter_v2_compliance_proto_init() }
func file_google_cloud_securitycenter_v2_compliance_proto_init() {
	if File_google_cloud_securitycenter_v2_compliance_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_securitycenter_v2_compliance_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_cloud_securitycenter_v2_compliance_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_cloud_securitycenter_v2_compliance_proto_goTypes,
		DependencyIndexes: file_google_cloud_securitycenter_v2_compliance_proto_depIdxs,
		MessageInfos:      file_google_cloud_securitycenter_v2_compliance_proto_msgTypes,
	}.Build()
	File_google_cloud_securitycenter_v2_compliance_proto = out.File
	file_google_cloud_securitycenter_v2_compliance_proto_rawDesc = nil
	file_google_cloud_securitycenter_v2_compliance_proto_goTypes = nil
	file_google_cloud_securitycenter_v2_compliance_proto_depIdxs = nil
}
