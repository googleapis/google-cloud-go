...
var file_google_cloud_securitycenter_v2_compliance_proto_goTypes = []any{
...
func file_google_cloud_securitycenter_v2_compliance_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_securitycenter_v2_compliance_proto_msgTypes[0].Exporter = func(v any, i int) any {
