...
const file_google_cloud_securitycenter_v2_indicator_proto_rawDesc = "" +
	"\n" +
	".google/cloud/securitycenter/v2/indicator.proto\x12\x1egoogle.cloud.securitycenter.v2\"\xfa\a\n" +
	"\tIndicator\x12!\n" +
	"\fip_addresses\x18\x01 \x03(\tR\vipAddresses\x12\x18\n" +
	"\adomains\x18\x02 \x03(\tR\adomains\x12Z\n" +
	"\n" +
	"signatures\x18\x03 \x03(\v2:.google.cloud.securitycenter.v2.Indicator.ProcessSignatureR\n" +
	"signatures\x12\x12\n" +
	"\x04uris\x18\x04 \x03(\tR\x04uris\x1a\xbf\x06\n" +
	"\x10ProcessSignature\x12\x84\x01\n" +
	"\x15memory_hash_signature\x18\x06 \x01(\v2N.google.cloud.securitycenter.v2.Indicator.ProcessSignature.MemoryHashSignatureH\x00R\x13memoryHashSignature\x12~\n" +
	"\x13yara_rule_signature\x18\a \x01(\v2L.google.cloud.securitycenter.v2.Indicator.ProcessSignature.YaraRuleSignatureH\x00R\x11yaraRuleSignature\x12o\n" +
	"\x0esignature_type\x18\b \x01(\x0e2H.google.cloud.securitycenter.v2.Indicator.ProcessSignature.SignatureTypeR\rsignatureType\x1a\x8d\x02\n" +
	"\x13MemoryHashSignature\x12#\n" +
	"\rbinary_family\x18\x01 \x01(\tR\fbinaryFamily\x12x\n" +
	"\n" +
	"detections\x18\x04 \x03(\v2X.google.cloud.securitycenter.v2.Indicator.ProcessSignature.MemoryHashSignature.DetectionR\n" +
	"detections\x1aW\n" +
	"\tDetection\x12\x16\n" +
...
var (
	...
	file_google_cloud_securitycenter_v2_indicator_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v2_indicator_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v2_indicator_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v2_indicator_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_indicator_proto_rawDesc), len(file_google_cloud_securitycenter_v2_indicator_proto_rawDesc)))
	})
...
func file_google_cloud_securitycenter_v2_indicator_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_indicator_proto_rawDesc), len(file_google_cloud_securitycenter_v2_indicator_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
