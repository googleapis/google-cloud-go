...
type Finding struct {
	...
	Agent *Agent `protobuf:"bytes,81,opt,name=agent,proto3" json:"agent,omitempty"`
	// Conversational session(s) where the finding occurred.
	AgentSessions []*AgentSession `protobuf:"bytes,82,rep,name=agent_sessions,json=agentSessions,proto3" json:"agent_sessions,omitempty"`
	// Details about behavior anomalies detected in AI agents.
	AgentAnomaly  *AgentAnomaly `protobuf:"bytes,83,opt,name=agent_anomaly,json=agentAnomaly,proto3" json:"agent_anomaly,omitempty"`
...
func (x *Finding) GetAgentSessions() []*AgentSession {
	if x != nil {
...
func (x *Finding) GetAgentAnomaly() *AgentAnomaly {
	if x != nil {
		return x.AgentAnomaly
	}
	return nil
}
...
const file_google_cloud_securitycenter_v2_finding_proto_rawDesc = "" +
	...
	"chokepoint\x12E\n" +
	"\tvertex_ai\x18H \x01(\v2(.google.cloud.securitycenter.v2.VertexAiR\bvertexAi\x12;\n" +
	"\x05agent\x18Q \x01(\v2%.google.cloud.securitycenter.v2.AgentR\x05agent\x12S\n" +
	"\x0eagent_sessions\x18R \x03(\v2,.google.cloud.securitycenter.v2.AgentSessionR\ragentSessions\x12Q\n" +
	"\ragent_anomaly\x18S \x01(\v2,.google.cloud.securitycenter.v2.AgentAnomalyR\fagentAnomaly\x1a\xdd\x03\n" +
	"\bMuteInfo\x12\\\n" +
...
var file_google_cloud_securitycenter_v2_finding_proto_goTypes = []any{
	...
	(*Agent)(nil),                              // 51: google.cloud.securitycenter.v2.Agent
	(*AgentSession)(nil),                       // 52: google.cloud.securitycenter.v2.AgentSession
	(*AgentAnomaly)(nil),                       // 53: google.cloud.securitycenter.v2.AgentAnomaly
	(*structpb.Value)(nil),                     // 54: google.protobuf.Value
	(*ExternalSystem)(nil),                     // 55: google.cloud.securitycenter.v2.ExternalSystem
	(*ContactDetails)(nil),                     // 56: google.cloud.securitycenter.v2.ContactDetails
}
var file_google_cloud_securitycenter_v2_finding_proto_depIdxs = []int32{
	...
	51, // 50: google.cloud.securitycenter.v2.Finding.agent:type_name -> google.cloud.securitycenter.v2.Agent
	52, // 51: google.cloud.securitycenter.v2.Finding.agent_sessions:type_name -> google.cloud.securitycenter.v2.AgentSession
	53, // 52: google.cloud.securitycenter.v2.Finding.agent_anomaly:type_name -> google.cloud.securitycenter.v2.AgentAnomaly
	9,  // 53: google.cloud.securitycenter.v2.Finding.MuteInfo.static_mute:type_name -> google.cloud.securitycenter.v2.Finding.MuteInfo.StaticMute
	10, // 54: google.cloud.securitycenter.v2.Finding.MuteInfo.dynamic_mute_records:type_name -> google.cloud.securitycenter.v2.Finding.MuteInfo.DynamicMuteRecord
	54, // 55: google.cloud.securitycenter.v2.Finding.SourcePropertiesEntry.value:type_name -> google.protobuf.Value
	55, // 56: google.cloud.securitycenter.v2.Finding.ExternalSystemsEntry.value:type_name -> google.cloud.securitycenter.v2.ExternalSystem
	56, // 57: google.cloud.securitycenter.v2.Finding.ContactsEntry.value:type_name -> google.cloud.securitycenter.v2.ContactDetails
	2,  // 58: google.cloud.securitycenter.v2.Finding.MuteInfo.StaticMute.state:type_name -> google.cloud.securitycenter.v2.Finding.Mute
	12, // 59: google.cloud.securitycenter.v2.Finding.MuteInfo.StaticMute.apply_time:type_name -> google.protobuf.Timestamp
	12, // 60: google.cloud.securitycenter.v2.Finding.MuteInfo.DynamicMuteRecord.match_time:type_name -> google.protobuf.Timestamp
...
func file_google_cloud_securitycenter_v2_finding_proto_init() {
	...
	file_google_cloud_securitycenter_v2_agent_proto_init()
	file_google_cloud_securitycenter_v2_agent_anomaly_proto_init()
	file_google_cloud_securitycenter_v2_agent_session_proto_init()
