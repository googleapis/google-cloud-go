...
func (x *KernelRootkit) Reset() {
	*x = KernelRootkit{}
	mi := &file_google_cloud_securitycenter_v2_kernel_rootkit_proto_msgTypes[0]
...
func (*KernelRootkit) Descriptor() ([]byte, []int) {
	return file_google_cloud_securitycenter_v2_kernel_rootkit_proto_rawDescGZIP(), []int{0}
}
...
const file_google_cloud_securitycenter_v2_kernel_rootkit_proto_rawDesc = "" +
	"\n" +
	"3google/cloud/securitycenter/v2/kernel_rootkit.proto\x12\x1egoogle.cloud.securitycenter.v2\"\xc2\x04\n" +
	"\rKernelRootkit\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12@\n" +
	"\x1cunexpected_code_modification\x18\x02 \x01(\bR\x1aunexpectedCodeModification\x12R\n" +
	"&unexpected_read_only_data_modification\x18\x03 \x01(\bR\"unexpectedReadOnlyDataModification\x12:\n" +
	"\x19unexpected_ftrace_handler\x18\x04 \x01(\bR\x17unexpectedFtraceHandler\x12:\n" +
	"\x19unexpected_kprobe_handler\x18\x05 \x01(\bR\x17unexpectedKprobeHandler\x12?\n" +
	"\x1cunexpected_kernel_code_pages\x18\x06 \x01(\bR\x19unexpectedKernelCodePages\x12C\n" +
	"\x1eunexpected_system_call_handler\x18\a \x01(\bR\x1bunexpectedSystemCallHandler\x12@\n" +
	"\x1cunexpected_interrupt_handler\x18\b \x01(\bR\x1aunexpectedInterruptHandler\x12G\n" +
	" unexpected_processes_in_runqueue\x18\t \x01(\bR\x1dunexpectedProcessesInRunqueueB\xec\x01\n" +
...
var (
	file_google_cloud_securitycenter_v2_kernel_rootkit_proto_rawDescOnce sync.Once
	file_google_cloud_securitycenter_v2_kernel_rootkit_proto_rawDescData []byte
)

func file_google_cloud_securitycenter_v2_kernel_rootkit_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v2_kernel_rootkit_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v2_kernel_rootkit_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_kernel_rootkit_proto_rawDesc), len(file_google_cloud_securitycenter_v2_kernel_rootkit_proto_rawDesc)))
	})
	return file_google_cloud_securitycenter_v2_kernel_rootkit_proto_rawDescData
}

var file_google_cloud_securitycenter_v2_kernel_rootkit_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_cloud_securitycenter_v2_kernel_rootkit_proto_goTypes = []any{
	(*KernelRootkit)(nil), // 0: google.cloud.securitycenter.v2.KernelRootkit
}
var file_google_cloud_securitycenter_v2_kernel_rootkit_proto_depIdxs = []int32{
...
func init() { file_google_cloud_securitycenter_v2_kernel_rootkit_proto_init() }
func file_google_cloud_securitycenter_v2_kernel_rootkit_proto_init() {
	if File_google_cloud_securitycenter_v2_kernel_rootkit_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_kernel_rootkit_proto_rawDesc), len(file_google_cloud_securitycenter_v2_kernel_rootkit_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_cloud_securitycenter_v2_kernel_rootkit_proto_goTypes,
		DependencyIndexes: file_google_cloud_securitycenter_v2_kernel_rootkit_proto_depIdxs,
		MessageInfos:      file_google_cloud_securitycenter_v2_kernel_rootkit_proto_msgTypes,
	}.Build()
	File_google_cloud_securitycenter_v2_kernel_rootkit_proto = out.File
	file_google_cloud_securitycenter_v2_kernel_rootkit_proto_goTypes = nil
	file_google_cloud_securitycenter_v2_kernel_rootkit_proto_depIdxs = nil
}
