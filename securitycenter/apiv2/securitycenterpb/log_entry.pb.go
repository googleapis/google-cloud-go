...
const file_google_cloud_securitycenter_v2_log_entry_proto_rawDesc = "" +
	"\n" +
	".google/cloud/securitycenter/v2/log_entry.proto\x12\x1egoogle.cloud.securitycenter.v2\x1a\x1fgoogle/protobuf/timestamp.proto\"|\n" +
	"\bLogEntry\x12c\n" +
	"\x13cloud_logging_entry\x18\x01 \x01(\v21.google.cloud.securitycenter.v2.CloudLoggingEntryH\x00R\x11cloudLoggingEntryB\v\n" +
	"\tlog_entry\"\xb0\x01\n" +
...
var (
	...
	file_google_cloud_securitycenter_v2_log_entry_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v2_log_entry_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v2_log_entry_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v2_log_entry_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_log_entry_proto_rawDesc), len(file_google_cloud_securitycenter_v2_log_entry_proto_rawDesc)))
	})
...
func file_google_cloud_securitycenter_v2_log_entry_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_log_entry_proto_rawDesc), len(file_google_cloud_securitycenter_v2_log_entry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
