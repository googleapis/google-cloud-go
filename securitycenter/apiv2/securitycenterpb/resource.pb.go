...
func (x *Resource) GetGcpMetadata() *GcpMetadata {
	if x != nil {
		if x, ok := x.CloudProviderMetadata.(*Resource_GcpMetadata); ok {
...
const file_google_cloud_securitycenter_v2_resource_proto_rawDesc = "" +
	"\n" +
	"-google/cloud/securitycenter/v2/resource.proto\x12\x1egoogle.cloud.securitycenter.v2\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a+google/cloud/securitycenter/v2/folder.proto\"\xfd\x04\n" +
	"\bResource\x12\x12\n" +
	...
	"\x17cloud_provider_metadata\"\x8c\x02\n" +
	"\vGcpMetadata\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\x120\n" +
	"\x14project_display_name\x18\x02 \x01(\tR\x12projectDisplayName\x12\x16\n" +
	"\x06parent\x18\x03 \x01(\tR\x06parent\x12.\n" +
	"\x13parent_display_name\x18\x04 \x01(\tR\x11parentDisplayName\x12E\n" +
	"\afolders\x18\x05 \x03(\v2&.google.cloud.securitycenter.v2.FolderB\x03\xe0A\x03R\afolders\x12\"\n" +
	"\forganization\x18\x06 \x01(\tR\forganization\"\xc8\x03\n" +
	"\vAwsMetadata\x12_\n" +
	"\forganization\x18\x01 \x01(\v2;.google.cloud.securitycenter.v2.AwsMetadata.AwsOrganizationR\forganization\x12t\n" +
	"\x14organizational_units\x18\x02 \x03(\v2A.google.cloud.securitycenter.v2.AwsMetadata.AwsOrganizationalUnitR\x13organizationalUnits\x12P\n" +
	"\aaccount\x18\x03 \x01(\v26.google.cloud.securitycenter.v2.AwsMetadata.AwsAccountR\aaccount\x1a!\n" +
	...
	"AwsAccount\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"\xb0\x05\n" +
	"\rAzureMetadata\x12o\n" +
	"\x11management_groups\x18\x01 \x03(\v2B.google.cloud.securitycenter.v2.AzureMetadata.AzureManagementGroupR\x10managementGroups\x12c\n" +
	"\fsubscription\x18\x02 \x01(\v2?.google.cloud.securitycenter.v2.AzureMetadata.AzureSubscriptionR\fsubscription\x12g\n" +
	"\x0eresource_group\x18\x03 \x01(\v2@.google.cloud.securitycenter.v2.AzureMetadata.AzureResourceGroupR\rresourceGroup\x12Q\n" +
	"\x06tenant\x18\a \x01(\v29.google.cloud.securitycenter.v2.AzureMetadata.AzureTenantR\x06tenant\x1aI\n" +
	"\x14AzureManagementGroup\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x1aF\n" +
	"\x11AzureSubscription\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x1a8\n" +
	"\x12AzureResourceGroup\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x1a@\n" +
	"\vAzureTenant\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\"\x96\x04\n" +
	"\fResourcePath\x12S\n" +
	"\x05nodes\x18\x01 \x03(\v2=.google.cloud.securitycenter.v2.ResourcePath.ResourcePathNodeR\x05nodes\x1a\xa5\x01\n" +
	"\x10ResourcePathNode\x12^\n" +
	"\tnode_type\x18\x01 \x01(\x0e2A.google.cloud.securitycenter.v2.ResourcePath.ResourcePathNodeTypeR\bnodeType\x12\x0e\n" +
...
var (
	...
	file_google_cloud_securitycenter_v2_resource_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v2_resource_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v2_resource_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v2_resource_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_resource_proto_rawDesc), len(file_google_cloud_securitycenter_v2_resource_proto_rawDesc)))
	})
...
func file_google_cloud_securitycenter_v2_resource_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_resource_proto_rawDesc), len(file_google_cloud_securitycenter_v2_resource_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   0,
