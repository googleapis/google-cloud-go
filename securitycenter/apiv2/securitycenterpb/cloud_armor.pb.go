...
var file_google_cloud_securitycenter_v2_cloud_armor_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x76, 0x32, 0x42, 0x0f, 0x43, 0x6c, 0x6f, 0x75, 0x64,
...
func file_google_cloud_securitycenter_v2_cloud_armor_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_securitycenter_v2_cloud_armor_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_securitycenter_v2_cloud_armor_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_securitycenter_v2_cloud_armor_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_securitycenter_v2_cloud_armor_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_cloud_securitycenter_v2_cloud_armor_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Attack); i {
			case 0:
				return &v.state
			case 1:
