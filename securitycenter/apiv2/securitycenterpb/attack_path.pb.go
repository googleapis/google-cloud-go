...
const file_google_cloud_securitycenter_v2_attack_path_proto_rawDesc = "" +
	"\n" +
	"0google/cloud/securitycenter/v2/attack_path.proto\x12\x1egoogle.cloud.securitycenter.v2\x1a\x19google/api/resource.proto\"\xce\f\n" +
	"\n" +
	"AttackPath\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12X\n" +
	"\n" +
	"path_nodes\x18\x02 \x03(\v29.google.cloud.securitycenter.v2.AttackPath.AttackPathNodeR\tpathNodes\x12O\n" +
	"\x05edges\x18\x03 \x03(\v29.google.cloud.securitycenter.v2.AttackPath.AttackPathEdgeR\x05edges\x1a\xee\a\n" +
	...
	"\x13associated_findings\x18\x04 \x03(\v2S.google.cloud.securitycenter.v2.AttackPath.AttackPathNode.PathNodeAssociatedFindingR\x12associatedFindings\x12\x12\n" +
	"\x04uuid\x18\x05 \x01(\tR\x04uuid\x12k\n" +
	"\fattack_steps\x18\x06 \x03(\v2H.google.cloud.securitycenter.v2.AttackPath.AttackPathNode.AttackStepNodeR\vattackSteps\x1a\x87\x01\n" +
	...
	"\x04type\x18\x02 \x01(\x0e2B.google.cloud.securitycenter.v2.AttackPath.AttackPathNode.NodeTypeR\x04type\x12!\n" +
	"\fdisplay_name\x18\x03 \x01(\tR\vdisplayName\x12l\n" +
	"\x06labels\x18\x04 \x03(\v2T.google.cloud.securitycenter.v2.AttackPath.AttackPathNode.AttackStepNode.LabelsEntryR\x06labels\x12 \n" +
	...
	"\vdestination\x18\x02 \x01(\tR\vdestination:\xc3\x02\xeaA\xbf\x02\n" +
	"(securitycenter.googleapis.com/AttackPath\x12qorganizations/{organization}/simulations/{simulation}/valuedResources/{valued_resource}/attackPaths/{attack_path}\x12\x86\x01organizations/{organization}/locations/{location}/simulations/{simulation}/valuedResources/{valued_resource}/attackPaths/{attack_path}*\vattackPaths2\n" +
	"attackPathB\xe9\x01\n" +
...
var (
	...
	file_google_cloud_securitycenter_v2_attack_path_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v2_attack_path_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v2_attack_path_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v2_attack_path_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_attack_path_proto_rawDesc), len(file_google_cloud_securitycenter_v2_attack_path_proto_rawDesc)))
	})
...
func file_google_cloud_securitycenter_v2_attack_path_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_attack_path_proto_rawDesc), len(file_google_cloud_securitycenter_v2_attack_path_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
