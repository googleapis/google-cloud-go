...
const file_google_cloud_securitycenter_v2_kubernetes_proto_rawDesc = "" +
	"\n" +
	"/google/cloud/securitycenter/v2/kubernetes.proto\x12\x1egoogle.cloud.securitycenter.v2\x1a.google/cloud/securitycenter/v2/container.proto\x1a*google/cloud/securitycenter/v2/label.proto\"\x8a\x0e\n" +
	"\n" +
	"Kubernetes\x12B\n" +
	"\x04pods\x18\x01 \x03(\v2..google.cloud.securitycenter.v2.Kubernetes.PodR\x04pods\x12E\n" +
	"\x05nodes\x18\x02 \x03(\v2/.google.cloud.securitycenter.v2.Kubernetes.NodeR\x05nodes\x12R\n" +
	"\n" +
	"node_pools\x18\x03 \x03(\v23.google.cloud.securitycenter.v2.Kubernetes.NodePoolR\tnodePools\x12E\n" +
	"\x05roles\x18\x04 \x03(\v2/.google.cloud.securitycenter.v2.Kubernetes.RoleR\x05roles\x12N\n" +
	"\bbindings\x18\x05 \x03(\v22.google.cloud.securitycenter.v2.Kubernetes.BindingR\bbindings\x12^\n" +
	"\x0eaccess_reviews\x18\x06 \x03(\v27.google.cloud.securitycenter.v2.Kubernetes.AccessReviewR\raccessReviews\x12K\n" +
	"\aobjects\x18\a \x03(\v21.google.cloud.securitycenter.v2.Kubernetes.ObjectR\aobjects\x1a\xb3\x01\n" +
	"\x03Pod\x12\x0e\n" +
	"\x02ns\x18\x01 \x01(\tR\x02ns\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12=\n" +
	"\x06labels\x18\x03 \x03(\v2%.google.cloud.securitycenter.v2.LabelR\x06labels\x12I\n" +
	"\n" +
	"containers\x18\x04 \x03(\v2).google.cloud.securitycenter.v2.ContainerR\n" +
	"containers\x1a\x1a\n" +
	"\x04Node\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x1ae\n" +
	"\bNodePool\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12E\n" +
	"\x05nodes\x18\x02 \x03(\v2/.google.cloud.securitycenter.v2.Kubernetes.NodeR\x05nodes\x1a\xae\x01\n" +
	"\x04Role\x12H\n" +
	"\x04kind\x18\x01 \x01(\x0e24.google.cloud.securitycenter.v2.Kubernetes.Role.KindR\x04kind\x12\x0e\n" +
	"\x02ns\x18\x02 \x01(\tR\x02ns\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\"8\n" +
	"\x04Kind\x12\x14\n" +
	"\x10KIND_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04ROLE\x10\x01\x12\x10\n" +
	"\fCLUSTER_ROLE\x10\x02\x1a\xc2\x01\n" +
	"\aBinding\x12\x0e\n" +
	"\x02ns\x18\x01 \x01(\tR\x02ns\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12C\n" +
	"\x04role\x18\x03 \x01(\v2/.google.cloud.securitycenter.v2.Kubernetes.RoleR\x04role\x12N\n" +
	"\bsubjects\x18\x04 \x03(\v22.google.cloud.securitycenter.v2.Kubernetes.SubjectR\bsubjects\x1a\xce\x01\n" +
	"\aSubject\x12O\n" +
	"\x04kind\x18\x01 \x01(\x0e2;.google.cloud.securitycenter.v2.Kubernetes.Subject.AuthTypeR\x04kind\x12\x0e\n" +
	"\x02ns\x18\x02 \x01(\tR\x02ns\x12\x12\n" +
	...
	"\fAccessReview\x12\x14\n" +
	"\x05group\x18\x01 \x01(\tR\x05group\x12\x0e\n" +
	"\x02ns\x18\x02 \x01(\tR\x02ns\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x1a\n" +
	"\bresource\x18\x04 \x01(\tR\bresource\x12 \n" +
	"\vsubresource\x18\x05 \x01(\tR\vsubresource\x12\x12\n" +
	"\x04verb\x18\x06 \x01(\tR\x04verb\x12\x18\n" +
	"\aversion\x18\a \x01(\tR\aversion\x1a\xa1\x01\n" +
	"\x06Object\x12\x14\n" +
	"\x05group\x18\x01 \x01(\tR\x05group\x12\x12\n" +
	"\x04kind\x18\x02 \x01(\tR\x04kind\x12\x0e\n" +
	"\x02ns\x18\x03 \x01(\tR\x02ns\x12\x12\n" +
	"\x04name\x18\x04 \x01(\tR\x04name\x12I\n" +
	"\n" +
	"containers\x18\x05 \x03(\v2).google.cloud.securitycenter.v2.ContainerR\n" +
	"containersB\xe9\x01\n" +
...
var (
	...
	file_google_cloud_securitycenter_v2_kubernetes_proto_rawDescData []byte
)
...
func file_google_cloud_securitycenter_v2_kubernetes_proto_rawDescGZIP() []byte {
	file_google_cloud_securitycenter_v2_kubernetes_proto_rawDescOnce.Do(func() {
		file_google_cloud_securitycenter_v2_kubernetes_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_kubernetes_proto_rawDesc), len(file_google_cloud_securitycenter_v2_kubernetes_proto_rawDesc)))
	})
...
func file_google_cloud_securitycenter_v2_kubernetes_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_securitycenter_v2_kubernetes_proto_rawDesc), len(file_google_cloud_securitycenter_v2_kubernetes_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
