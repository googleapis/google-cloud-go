...
func ExampleIcebergCatalogClient_ListIcebergCatalogs_all() {
	...
	for resp, err := range c.ListIcebergCatalogs(ctx, req).All() {
		if err != nil {
...
func ExampleIcebergCatalogClient_ListIcebergNamespaces_all() {
	ctx := context.Background()
	// This snippet has been automatically generated and should be regarded as a code template only.
	// It will require modifications to work:
	// - It may require correct/in-range values for request initialization.
	...
	for resp, err := range c.ListIcebergNamespaces(ctx, req).All() {
		if err != nil {
			// TODO: Handle error and break/return/continue. Iteration will stop after any error.
		}
		// TODO: Use resp.
...
func ExampleIcebergCatalogClient_ListIcebergTableIdentifiers_all() {
	ctx := context.Background()
	// This snippet has been automatically generated and should be regarded as a code template only.
	// It will require modifications to work:
	// - It may require correct/in-range values for request initialization.
	...
	for resp, err := range c.ListIcebergTableIdentifiers(ctx, req).All() {
		if err != nil {
			// TODO: Handle error and break/return/continue. Iteration will stop after any error.
		}
		// TODO: Use resp.
