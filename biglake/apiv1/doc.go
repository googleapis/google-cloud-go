...
// Package biglake is an auto-generated package for the
// Lakehouse API.
//
...
// engines—including Apache Spark, Google Managed Spark, Apache Flink,
// Trino and BigQuery—share tables and metadata for key open formats
// (Apache Iceberg, Apache Hive), and query the same copy of data. Plus,
// through the Lakehouse runtime catalog federation seamlessly unite your
// lakehouse ecosystem, letting Iceberg compatible engines on Google Cloud
// (BigQuery, Google Managed Spark) discover and analyze enterprise data
// across Snowflake, Databricks, and AWS Glue.
//
...
//
//	// go get cloud.google.com/go/biglake/apiv1@latest
...
// # Use of Context
//
// The ctx passed to NewIcebergCatalogClient is used for authentication requests and
...
package biglake // import "cloud.google.com/go/biglake/apiv1"
