...
var file_google_cloud_dialogflow_v2_context_proto_rawDesc = []byte{
	...
	0x92, 0x01, 0x0a, 0x1e, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63,
	...
	0x70, 0x62, 0xa2, 0x02, 0x02, 0x44, 0x46, 0xaa, 0x02, 0x1a, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
...
func file_google_cloud_dialogflow_v2_context_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_dialogflow_v2_context_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_dialogflow_v2_context_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_dialogflow_v2_context_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_dialogflow_v2_context_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_cloud_dialogflow_v2_context_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_google_cloud_dialogflow_v2_context_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_google_cloud_dialogflow_v2_context_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_google_cloud_dialogflow_v2_context_proto_msgTypes[7].Exporter = func(v any, i int) any {
