...
const file_google_cloud_dialogflow_v2_entity_type_proto_rawDesc = "" +
	"\n" +
	",google/cloud/dialogflow/v2/entity_type.proto\x12\x1agoogle.cloud.dialogflow.v2\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a#google/longrunning/operations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xa1\x06\n" +
	"\n" +
	"EntityType\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x02R\vdisplayName\x12D\n" +
	"\x04kind\x18\x03 \x01(\x0e2+.google.cloud.dialogflow.v2.EntityType.KindB\x03\xe0A\x02R\x04kind\x12m\n" +
	"\x13auto_expansion_mode\x18\x04 \x01(\x0e28.google.cloud.dialogflow.v2.EntityType.AutoExpansionModeB\x03\xe0A\x01R\x11autoExpansionMode\x12N\n" +
	"\bentities\x18\x06 \x03(\v2-.google.cloud.dialogflow.v2.EntityType.EntityB\x03\xe0A\x01R\bentities\x12;\n" +
	"\x17enable_fuzzy_extraction\x18\a \x01(\bB\x03\xe0A\x01R\x15enableFuzzyExtraction\x1aD\n" +
	"\x06Entity\x12\x19\n" +
	"\x05value\x18\x01 \x01(\tB\x03\xe0A\x02R\x05value\x12\x1f\n" +
	"\bsynonyms\x18\x02 \x03(\tB\x03\xe0A\x02R\bsynonyms\"J\n" +
	"\x04Kind\x12\x14\n" +
	...
	"\n" +
	"page_token\x18\x04 \x01(\tB\x03\xe0A\x01R\tpageToken\"\x8c\x01\n" +
	"\x17ListEntityTypesResponse\x12I\n" +
	"\fentity_types\x18\x01 \x03(\v2&.google.cloud.dialogflow.v2.EntityTypeR\ventityTypes\x12&\n" +
	...
	"\rlanguage_code\x18\x02 \x01(\tB\x03\xe0A\x01R\flanguageCode\"\xd7\x01\n" +
	"\x17CreateEntityTypeRequest\x12D\n" +
	"\x06parent\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\x12$dialogflow.googleapis.com/EntityTypeR\x06parent\x12L\n" +
	"\ventity_type\x18\x02 \x01(\v2&.google.cloud.dialogflow.v2.EntityTypeB\x03\xe0A\x02R\n" +
	"entityType\x12(\n" +
	"\rlanguage_code\x18\x03 \x01(\tB\x03\xe0A\x01R\flanguageCode\"\xd3\x01\n" +
	"\x17UpdateEntityTypeRequest\x12L\n" +
	"\ventity_type\x18\x01 \x01(\v2&.google.cloud.dialogflow.v2.EntityTypeB\x03\xe0A\x02R\n" +
	"entityType\x12(\n" +
	"\rlanguage_code\x18\x02 \x01(\tB\x03\xe0A\x01R\flanguageCode\x12@\n" +
	...
	"\x04name\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\n" +
	"$dialogflow.googleapis.com/EntityTypeR\x04name\"\x83\x03\n" +
	...
	"\x15entity_type_batch_uri\x18\x02 \x01(\tH\x00R\x12entityTypeBatchUri\x12f\n" +
	"\x18entity_type_batch_inline\x18\x03 \x01(\v2+.google.cloud.dialogflow.v2.EntityTypeBatchH\x00R\x15entityTypeBatchInline\x12(\n" +
	...
	"updateMaskB\x13\n" +
	"\x11entity_type_batch\"k\n" +
	"\x1eBatchUpdateEntityTypesResponse\x12I\n" +
	"\fentity_types\x18\x01 \x03(\v2&.google.cloud.dialogflow.v2.EntityTypeR\ventityTypes\"\x96\x01\n" +
	"\x1dBatchDeleteEntityTypesRequest\x12D\n" +
	"\x06parent\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\x12$dialogflow.googleapis.com/EntityTypeR\x06parent\x12/\n" +
	"\x11entity_type_names\x18\x02 \x03(\tB\x03\xe0A\x02R\x0fentityTypeNames\"\xdc\x01\n" +
	"\x1aBatchCreateEntitiesRequest\x12D\n" +
	"\x06parent\x18\x01 \x01(\tB,\xe0A\x02\xfaA&\n" +
	"$dialogflow.googleapis.com/EntityTypeR\x06parent\x12N\n" +
	"\bentities\x18\x02 \x03(\v2-.google.cloud.dialogflow.v2.EntityType.EntityB\x03\xe0A\x02R\bentities\x12(\n" +
	...
	"\rlanguage_code\x18\x03 \x01(\tB\x03\xe0A\x01R\flanguageCode\"\\\n" +
	"\x0fEntityTypeBatch\x12I\n" +
	"\fentity_types\x18\x01 \x03(\v2&.google.cloud.dialogflow.v2.EntityTypeR\ventityTypes2\xd6\x19\n" +
	"\vEntityTypes\x12\x87\x02\n" +
	"\x0fListEntityTypes\x122.google.cloud.dialogflow.v2.ListEntityTypesRequest\x1a3.google.cloud.dialogflow.v2.ListEntityTypesResponse\"\x8a\x01\xdaA\x06parent\xdaA\x14parent,language_code\x82\xd3\xe4\x93\x02dZ7\x125/v2/{parent=projects/*/locations/*/agent}/entityTypes\x12)/v2/{parent=projects/*/agent}/entityTypes\x12\xf2\x01\n" +
	"\rGetEntityType\x120.google.cloud.dialogflow.v2.GetEntityTypeRequest\x1a&.google.cloud.dialogflow.v2.EntityType\"\x86\x01\xdaA\x04name\xdaA\x12name,language_code\x82\xd3\xe4\x93\x02dZ7\x125/v2/{name=projects/*/locations/*/agent/entityTypes/*}\x12)/v2/{name=projects/*/agent/entityTypes/*}\x12\xae\x02\n" +
	"\x10CreateEntityType\x123.google.cloud.dialogflow.v2.CreateEntityTypeRequest\x1a&.google.cloud.dialogflow.v2.EntityType\"\xbc\x01\xdaA\x12parent,entity_type\xdaA parent,entity_type,language_code\x82\xd3\xe4\x93\x02~:\ventity_typeZD:\ventity_type\"5/v2/{parent=projects/*/locations/*/agent}/entityTypes\")/v2/{parent=projects/*/agent}/entityTypes\x12\xb9\x02\n" +
	"\x10UpdateEntityType\x123.google.cloud.dialogflow.v2.UpdateEntityTypeRequest\x1a&.google.cloud.dialogflow.v2.EntityType\"\xc7\x01\xdaA\ventity_type\xdaA\x19entity_type,language_code\x82\xd3\xe4\x93\x02\x96\x01:\ventity_typeZP:\ventity_type2A/v2/{entity_type.name=projects/*/locations/*/agent/entityTypes/*}25/v2/{entity_type.name=projects/*/agent/entityTypes/*}\x12\xd2\x01\n" +
	"\x10DeleteEntityType\x123.google.cloud.dialogflow.v2.DeleteEntityTypeRequest\x1a\x16.google.protobuf.Empty\"q\xdaA\x04name\x82\xd3\xe4\x93\x02dZ7*5/v2/{name=projects/*/locations/*/agent/entityTypes/*}*)/v2/{name=projects/*/agent/entityTypes/*}\x12\xd4\x02\n" +
	...
	"9google.cloud.dialogflow.v2.BatchUpdateEntityTypesResponse\x12\x16google.protobuf.Struct\x82\xd3\xe4\x93\x02\x82\x01:\x01*ZF:\x01*\"A/v2/{parent=projects/*/locations/*/agent}/entityTypes:batchUpdate\"5/v2/{parent=projects/*/agent}/entityTypes:batchUpdate\x12\xcb\x02\n" +
	...
	"\x15google.protobuf.Empty\x12\x16google.protobuf.Struct\xdaA\x18parent,entity_type_names\x82\xd3\xe4\x93\x02\x82\x01:\x01*ZF:\x01*\"A/v2/{parent=projects/*/locations/*/agent}/entityTypes:batchDelete\"5/v2/{parent=projects/*/agent}/entityTypes:batchDelete\x12\xf2\x02\n" +
	...
	"\x15google.protobuf.Empty\x12\x16google.protobuf.Struct\xdaA\x0fparent,entities\xdaA\x1dparent,entities,language_code\x82\xd3\xe4\x93\x02\x98\x01:\x01*ZQ:\x01*\"L/v2/{parent=projects/*/locations/*/agent/entityTypes/*}/entities:batchCreate\"@/v2/{parent=projects/*/agent/entityTypes/*}/entities:batchCreate\x12\xf2\x02\n" +
	...
	"\x15google.protobuf.Empty\x12\x16google.protobuf.Struct\xdaA\x0fparent,entities\xdaA\x1dparent,entities,language_code\x82\xd3\xe4\x93\x02\x98\x01:\x01*ZQ:\x01*\"L/v2/{parent=projects/*/locations/*/agent/entityTypes/*}/entities:batchUpdate\"@/v2/{parent=projects/*/agent/entityTypes/*}/entities:batchUpdate\x12\xfc\x02\n" +
...
var (
	...
	file_google_cloud_dialogflow_v2_entity_type_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_v2_entity_type_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_v2_entity_type_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_v2_entity_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2_entity_type_proto_rawDesc), len(file_google_cloud_dialogflow_v2_entity_type_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_v2_entity_type_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2_entity_type_proto_rawDesc), len(file_google_cloud_dialogflow_v2_entity_type_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   1,
