...
const file_google_cloud_dialogflow_v2_session_entity_type_proto_rawDesc = "" +
	...
	"+dialogflow.googleapis.com/SessionEntityType\x12Eprojects/{project}/agent/sessions/{session}/entityTypes/{entity_type}\x12mprojects/{project}/agent/environments/{environment}/users/{user}/sessions/{session}/entityTypes/{entity_type}\x12Zprojects/{project}/locations/{location}/agent/sessions/{session}/entityTypes/{entity_type}\x12\x82\x01projects/{project}/locations/{location}/agent/environments/{environment}/users/{user}/sessions/{session}/entityTypes/{entity_type}\"\xb2\x01\n" +
	"\x1dListSessionEntityTypesRequest\x12K\n" +
	"\x06parent\x18\x01 \x01(\tB3\xe0A\x02\xfaA-\x12+dialogflow.googleapis.com/SessionEntityTypeR\x06parent\x12 \n" +
	"\tpage_size\x18\x02 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tB\x03\xe0A\x01R\tpageToken\"\xa9\x01\n" +
	"\x1eListSessionEntityTypesResponse\x12_\n" +
	"\x14session_entity_types\x18\x01 \x03(\v2-.google.cloud.dialogflow.v2.SessionEntityTypeR\x12sessionEntityTypes\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"f\n" +
	"\x1bGetSessionEntityTypeRequest\x12G\n" +
	"\x04name\x18\x01 \x01(\tB3\xe0A\x02\xfaA-\n" +
	"+dialogflow.googleapis.com/SessionEntityTypeR\x04name\"\xd1\x01\n" +
	"\x1eCreateSessionEntityTypeRequest\x12K\n" +
	"\x06parent\x18\x01 \x01(\tB3\xe0A\x02\xfaA-\x12+dialogflow.googleapis.com/SessionEntityTypeR\x06parent\x12b\n" +
	"\x13session_entity_type\x18\x02 \x01(\v2-.google.cloud.dialogflow.v2.SessionEntityTypeB\x03\xe0A\x02R\x11sessionEntityType\"\xc6\x01\n" +
	"\x1eUpdateSessionEntityTypeRequest\x12b\n" +
	"\x13session_entity_type\x18\x01 \x01(\v2-.google.cloud.dialogflow.v2.SessionEntityTypeB\x03\xe0A\x02R\x11sessionEntityType\x12@\n" +
	...
	"\x16ListSessionEntityTypes\x129.google.cloud.dialogflow.v2.ListSessionEntityTypesRequest\x1a:.google.cloud.dialogflow.v2.ListSessionEntityTypesResponse\"\xb4\x02\xdaA\x06parent\x82\xd3\xe4\x93\x02\xa4\x02ZM\x12K/v2/{parent=projects/*/agent/environments/*/users/*/sessions/*}/entityTypesZB\x12@/v2/{parent=projects/*/locations/*/agent/sessions/*}/entityTypesZY\x12W/v2/{parent=projects/*/locations/*/agent/environments/*/users/*/sessions/*}/entityTypes\x124/v2/{parent=projects/*/agent/sessions/*}/entityTypes\x12\xb3\x03\n" +
	"\x14GetSessionEntityType\x127.google.cloud.dialogflow.v2.GetSessionEntityTypeRequest\x1a-.google.cloud.dialogflow.v2.SessionEntityType\"\xb2\x02\xdaA\x04name\x82\xd3\xe4\x93\x02\xa4\x02ZM\x12K/v2/{name=projects/*/agent/environments/*/users/*/sessions/*/entityTypes/*}ZB\x12@/v2/{name=projects/*/locations/*/agent/sessions/*/entityTypes/*}ZY\x12W/v2/{name=projects/*/locations/*/agent/environments/*/users/*/sessions/*/entityTypes/*}\x124/v2/{name=projects/*/agent/sessions/*/entityTypes/*}\x12\xa3\x04\n" +
	"\x17CreateSessionEntityType\x12:.google.cloud.dialogflow.v2.CreateSessionEntityTypeRequest\x1a-.google.cloud.dialogflow.v2.SessionEntityType\"\x9c\x03\xdaA\x1aparent,session_entity_type\x82\xd3\xe4\x93\x02\xf8\x02:\x13session_entity_typeZb:\x13session_entity_type\"K/v2/{parent=projects/*/agent/environments/*/users/*/sessions/*}/entityTypesZW:\x13session_entity_type\"@/v2/{parent=projects/*/locations/*/agent/sessions/*}/entityTypesZn:\x13session_entity_type\"W/v2/{parent=projects/*/locations/*/agent/environments/*/users/*/sessions/*}/entityTypes\"4/v2/{parent=projects/*/agent/sessions/*}/entityTypes\x12\x8f\x05\n" +
	"\x17UpdateSessionEntityType\x12:.google.cloud.dialogflow.v2.UpdateSessionEntityTypeRequest\x1a-.google.cloud.dialogflow.v2.SessionEntityType\"\x88\x04\xdaA\x13session_entity_type\xdaA\x1fsession_entity_type,update_mask\x82\xd3\xe4\x93\x02\xc9\x03:\x13session_entity_typeZv:\x13session_entity_type2_/v2/{session_entity_type.name=projects/*/agent/environments/*/users/*/sessions/*/entityTypes/*}Zk:\x13session_entity_type2T/v2/{session_entity_type.name=projects/*/locations/*/agent/sessions/*/entityTypes/*}Z\x82\x01:\x13session_entity_type2k/v2/{session_entity_type.name=projects/*/locations/*/agent/environments/*/users/*/sessions/*/entityTypes/*}2H/v2/{session_entity_type.name=projects/*/agent/sessions/*/entityTypes/*}\x12\xa2\x03\n" +
	"\x17DeleteSessionEntityType\x12:.google.cloud.dialogflow.v2.DeleteSessionEntityTypeRequest\x1a\x16.google.protobuf.Empty\"\xb2\x02\xdaA\x04name\x82\xd3\xe4\x93\x02\xa4\x02ZM*K/v2/{name=projects/*/agent/environments/*/users/*/sessions/*/entityTypes/*}ZB*@/v2/{name=projects/*/locations/*/agent/sessions/*/entityTypes/*}ZY*W/v2/{name=projects/*/locations/*/agent/environments/*/users/*/sessions/*/entityTypes/*}*4/v2/{name=projects/*/agent/sessions/*/entityTypes/*}\x1ax\xcaA\x19dialogflow.googleapis.com\xd2AYhttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflowB\x9c\x01\n" +
...
var (
	...
	file_google_cloud_dialogflow_v2_session_entity_type_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_v2_session_entity_type_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_v2_session_entity_type_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_v2_session_entity_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2_session_entity_type_proto_rawDesc), len(file_google_cloud_dialogflow_v2_session_entity_type_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_v2_session_entity_type_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2_session_entity_type_proto_rawDesc), len(file_google_cloud_dialogflow_v2_session_entity_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
