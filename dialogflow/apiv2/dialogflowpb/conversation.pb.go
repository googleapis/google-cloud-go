...
const file_google_cloud_dialogflow_v2_conversation_proto_rawDesc = "" +
	...
	"\fphone_number\x18\x04 \x01(\v23.google.cloud.dialogflow.v2.ConversationPhoneNumberB\x03\xe0A\x03R\vphoneNumber\x12>\n" +
	"\n" +
	"start_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tstartTime\x12:\n" +
	"\bend_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\aendTime\x12n\n" +
	"\x12conversation_stage\x18\a \x01(\x0e2:.google.cloud.dialogflow.v2.Conversation.ConversationStageB\x03\xe0A\x01R\x11conversationStage\x12\x81\x01\n" +
	"\x19telephony_connection_info\x18\n" +
	" \x01(\v2@.google.cloud.dialogflow.v2.Conversation.TelephonyConnectionInfoB\x03\xe0A\x03R\x17telephonyConnectionInfo\x12y\n" +
	"\x1cinitial_conversation_profile\x18\x0f \x01(\v2/.google.cloud.dialogflow.v2.ConversationProfileB\x06\xe0A\x01\xe0A\x03R\x1ainitialConversationProfile\x12\x8c\x01\n" +
	"\x1bingested_context_references\x18\x11 \x03(\v2G.google.cloud.dialogflow.v2.Conversation.IngestedContextReferencesEntryB\x03\xe0A\x03R\x19ingestedContextReferences\x12\x89\x01\n" +
	"\x1ainitial_generator_contexts\x18\x12 \x03(\v2F.google.cloud.dialogflow.v2.Conversation.InitialGeneratorContextsEntryB\x03\xe0A\x03R\x18initialGeneratorContexts\x1a\xe1\x03\n" +
	"\x17TelephonyConnectionInfo\x12(\n" +
	"\rdialed_number\x18\x02 \x01(\tB\x03\xe0A\x03R\fdialedNumber\x12\x15\n" +
	"\x03sdp\x18\x05 \x01(\tB\x03\xe0A\x01R\x03sdp\x12p\n" +
	"\vsip_headers\x18\f \x03(\v2J.google.cloud.dialogflow.v2.Conversation.TelephonyConnectionInfo.SipHeaderB\x03\xe0A\x03R\n" +
	"sipHeaders\x12\x81\x01\n" +
	"\x13extra_mime_contents\x18\r \x03(\v2L.google.cloud.dialogflow.v2.Conversation.TelephonyConnectionInfo.MimeContentB\x03\xe0A\x03R\x11extraMimeContents\x1a?\n" +
	"\tSipHeader\x12\x17\n" +
	...
	"\tOVERWRITE\x10\x02\x1a\xb5\x02\n" +
	"\x10GeneratorContext\x12s\n" +
	"\x0egenerator_type\x18\x01 \x01(\x0e2G.google.cloud.dialogflow.v2.Conversation.GeneratorContext.GeneratorTypeB\x03\xe0A\x03R\rgeneratorType\"\xab\x01\n" +
	...
	"\x1bCUSTOMER_MESSAGE_GENERATION\x10\x06\x1a\x87\x01\n" +
	"\x1eIngestedContextReferencesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12O\n" +
	"\x05value\x18\x02 \x01(\v29.google.cloud.dialogflow.v2.Conversation.ContextReferenceR\x05value:\x028\x01\x1a\x86\x01\n" +
	"\x1dInitialGeneratorContextsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12O\n" +
	"\x05value\x18\x02 \x01(\v29.google.cloud.dialogflow.v2.Conversation.GeneratorContextR\x05value:\x028\x01\"Q\n" +
	...
	"&dialogflow.googleapis.com/Conversation\x12/projects/{project}/conversations/{conversation}\x12Dprojects/{project}/locations/{location}/conversations/{conversation}*\rconversations2\fconversation\"\xe4\x01\n" +
	"\x19CreateConversationRequest\x12F\n" +
	"\x06parent\x18\x01 \x01(\tB.\xe0A\x02\xfaA(\x12&dialogflow.googleapis.com/ConversationR\x06parent\x12Q\n" +
	"\fconversation\x18\x02 \x01(\v2(.google.cloud.dialogflow.v2.ConversationB\x03\xe0A\x02R\fconversation\x12,\n" +
	...
	"\x06filter\x18\x04 \x01(\tB\x03\xe0A\x01R\x06filter\"\x93\x01\n" +
	"\x19ListConversationsResponse\x12N\n" +
	"\rconversations\x18\x01 \x03(\v2(.google.cloud.dialogflow.v2.ConversationR\rconversations\x12&\n" +
	...
	"\x04name\x18\x01 \x01(\tB.\xe0A\x02\xfaA(\n" +
	"&dialogflow.googleapis.com/ConversationR\x04name\"\xbb\x01\n" +
	...
	"\bmessages\x18\x01 \x03(\v2#.google.cloud.dialogflow.v2.MessageR\bmessages\x12&\n" +
	...
	"\fphone_number\x18\x03 \x01(\tB\x03\xe0A\x03R\vphoneNumber\"\xfd\x02\n" +
	"\x1eIngestContextReferencesRequest\x12R\n" +
	"\fconversation\x18\x01 \x01(\tB.\xe0A\x02\xfaA(\n" +
	"&dialogflow.googleapis.com/ConversationR\fconversation\x12\x85\x01\n" +
	"\x12context_references\x18\x02 \x03(\v2Q.google.cloud.dialogflow.v2.IngestContextReferencesRequest.ContextReferencesEntryB\x03\xe0A\x02R\x11contextReferences\x1a\x7f\n" +
	"\x16ContextReferencesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12O\n" +
	"\x05value\x18\x02 \x01(\v29.google.cloud.dialogflow.v2.Conversation.ContextReferenceR\x05value:\x028\x01\"\xc8\x02\n" +
	"\x1fIngestContextReferencesResponse\x12\x9a\x01\n" +
	"\x1bingested_context_references\x18\x01 \x03(\v2Z.google.cloud.dialogflow.v2.IngestContextReferencesResponse.IngestedContextReferencesEntryR\x19ingestedContextReferences\x1a\x87\x01\n" +
	"\x1eIngestedContextReferencesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12O\n" +
	"\x05value\x18\x02 \x01(\v29.google.cloud.dialogflow.v2.Conversation.ContextReferenceR\x05value:\x028\x01\"\xd9\x02\n" +
	...
	"\fcontext_size\x18\x04 \x01(\x05B\x03\xe0A\x01R\vcontextSize\x12f\n" +
	"\x13assist_query_params\x18\x05 \x01(\v21.google.cloud.dialogflow.v2.AssistQueryParametersB\x03\xe0A\x01R\x11assistQueryParams\"\xba\x06\n" +
	"\"SuggestConversationSummaryResponse\x12`\n" +
	"\asummary\x18\x01 \x01(\v2F.google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.SummaryR\asummary\x12M\n" +
	"\x0elatest_message\x18\x02 \x01(\tB&\xfaA#\n" +
	"!dialogflow.googleapis.com/MessageR\rlatestMessage\x12!\n" +
	"\fcontext_size\x18\x03 \x01(\x05R\vcontextSize\x1a\xbf\x04\n" +
	"\aSummary\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12}\n" +
	"\rtext_sections\x18\x04 \x03(\v2X.google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.TextSectionsEntryR\ftextSections\x12\x87\x01\n" +
	"\x14sorted_text_sections\x18\x06 \x03(\v2U.google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.SummarySectionR\x12sortedTextSections\x12P\n" +
	...
	"\x1fGenerateStatelessSummaryRequest\x12\x8b\x01\n" +
	"\x16stateless_conversation\x18\x01 \x01(\v2O.google.cloud.dialogflow.v2.GenerateStatelessSummaryRequest.MinimalConversationB\x03\xe0A\x02R\x15statelessConversation\x12g\n" +
	"\x14conversation_profile\x18\x02 \x01(\v2/.google.cloud.dialogflow.v2.ConversationProfileB\x03\xe0A\x02R\x13conversationProfile\x12P\n" +
	"\x0elatest_message\x18\x03 \x01(\tB)\xe0A\x01\xfaA#\n" +
	"!dialogflow.googleapis.com/MessageR\rlatestMessage\x12-\n" +
	"\x10max_context_size\x18\x04 \x01(\x05B\x03\xe0A\x01R\x0emaxContextSize\x1a\x9e\x01\n" +
	"\x13MinimalConversation\x12D\n" +
	"\bmessages\x18\x01 \x03(\v2#.google.cloud.dialogflow.v2.MessageB\x03\xe0A\x02R\bmessages\x12A\n" +
	"\x06parent\x18\x02 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!locations.googleapis.com/LocationR\x06parent\"\x88\x04\n" +
	" GenerateStatelessSummaryResponse\x12^\n" +
	"\asummary\x18\x01 \x01(\v2D.google.cloud.dialogflow.v2.GenerateStatelessSummaryResponse.SummaryR\asummary\x12M\n" +
	"\x0elatest_message\x18\x02 \x01(\tB&\xfaA#\n" +
	"!dialogflow.googleapis.com/MessageR\rlatestMessage\x12!\n" +
	"\fcontext_size\x18\x03 \x01(\x05R\vcontextSize\x1a\x91\x02\n" +
	"\aSummary\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12{\n" +
	"\rtext_sections\x18\x02 \x03(\v2V.google.cloud.dialogflow.v2.GenerateStatelessSummaryResponse.Summary.TextSectionsEntryR\ftextSections\x124\n" +
	...
	"\tgenerator\x18\x02 \x01(\v2%.google.cloud.dialogflow.v2.GeneratorH\x00R\tgenerator\x12'\n" +
	"\x0egenerator_name\x18\x03 \x01(\tH\x00R\rgeneratorName\x12\x89\x01\n" +
	"\x12context_references\x18\x04 \x03(\v2U.google.cloud.dialogflow.v2.GenerateStatelessSuggestionRequest.ContextReferencesEntryB\x03\xe0A\x01R\x11contextReferences\x12g\n" +
	"\x14conversation_context\x18\x05 \x01(\v2/.google.cloud.dialogflow.v2.ConversationContextB\x03\xe0A\x01R\x13conversationContext\x12T\n" +
	"\x0etrigger_events\x18\x06 \x03(\x0e2(.google.cloud.dialogflow.v2.TriggerEventB\x03\xe0A\x01R\rtriggerEvents\x120\n" +
	"\x11security_settings\x18\b \x01(\tB\x03\xe0A\x01R\x10securitySettings\x1a\x7f\n" +
	"\x16ContextReferencesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12O\n" +
	"\x05value\x18\x02 \x01(\v29.google.cloud.dialogflow.v2.Conversation.ContextReferenceR\x05value:\x028\x01B\x14\n" +
	"\x12generator_resource\"\x8e\x01\n" +
	"#GenerateStatelessSuggestionResponse\x12g\n" +
	"\x14generator_suggestion\x18\x01 \x01(\v2/.google.cloud.dialogflow.v2.GeneratorSuggestionB\x03\xe0A\x02R\x13generatorSuggestion\"\xf2\x14\n" +
	"\x16SearchKnowledgeRequest\x12\x1b\n" +
	"\x06parent\x18\x06 \x01(\tB\x03\xe0A\x02R\x06parent\x12@\n" +
	"\x05query\x18\x01 \x01(\v2%.google.cloud.dialogflow.v2.TextInputB\x03\xe0A\x02R\x05query\x12h\n" +
	...
	"!dialogflow.googleapis.com/MessageR\rlatestMessage\x12f\n" +
	"\fquery_source\x18\a \x01(\x0e2>.google.cloud.dialogflow.v2.SearchKnowledgeRequest.QuerySourceB\x03\xe0A\x01R\vquerySource\x12H\n" +
	"\x11end_user_metadata\x18\t \x01(\v2\x17.google.protobuf.StructB\x03\xe0A\x01R\x0fendUserMetadata\x12i\n" +
	"\rsearch_config\x18\v \x01(\v2?.google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfigB\x03\xe0A\x01R\fsearchConfig\x12&\n" +
	"\fexact_search\x18\x0e \x01(\bB\x03\xe0A\x01R\vexactSearch\x1a\xac\x0e\n" +
	"\fSearchConfig\x12p\n" +
	"\vboost_specs\x18\x01 \x03(\v2J.google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecsB\x03\xe0A\x01R\n" +
	"boostSpecs\x12s\n" +
	"\ffilter_specs\x18\x02 \x03(\v2K.google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.FilterSpecsB\x03\xe0A\x01R\vfilterSpecs\x1a\xe2\v\n" +
	"\n" +
	"BoostSpecs\x12Q\n" +
	"\vdata_stores\x18\x01 \x03(\tB0\xe0A\x01\xfaA*\n" +
	"(discoveryengine.googleapis.com/DataStoreR\n" +
	"dataStores\x12m\n" +
	"\x04spec\x18\x02 \x03(\v2T.google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpecB\x03\xe0A\x01R\x04spec\x1a\x91\n" +
	"\n" +
	"\tBoostSpec\x12\xa0\x01\n" +
	"\x15condition_boost_specs\x18\x01 \x03(\v2g.google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec.ConditionBoostSpecB\x03\xe0A\x01R\x13conditionBoostSpecs\x1a\xe0\b\n" +
	"\x12ConditionBoostSpec\x12!\n" +
	"\tcondition\x18\x01 \x01(\tB\x03\xe0A\x01R\tcondition\x12\x19\n" +
	"\x05boost\x18\x02 \x01(\x02B\x03\xe0A\x01R\x05boost\x12\xab\x01\n" +
	"\x12boost_control_spec\x18\x04 \x01(\v2x.google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec.ConditionBoostSpec.BoostControlSpecB\x03\xe0A\x01R\x10boostControlSpec\x1a\xdd\x06\n" +
	"\x10BoostControlSpec\x12\"\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tB\x03\xe0A\x01R\tfieldName\x12\xb3\x01\n" +
	"\x0eattribute_type\x18\x02 \x01(\x0e2\x86\x01.google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec.ConditionBoostSpec.BoostControlSpec.AttributeTypeB\x03\xe0A\x01R\rattributeType\x12\xbf\x01\n" +
	"\x12interpolation_type\x18\x03 \x01(\x0e2\x8a\x01.google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec.ConditionBoostSpec.BoostControlSpec.InterpolationTypeB\x03\xe0A\x01R\x11interpolationType\x12\xb2\x01\n" +
	"\x0econtrol_points\x18\x04 \x03(\v2\x85\x01.google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec.ConditionBoostSpec.BoostControlSpec.ControlPointB\x03\xe0A\x01R\rcontrolPoints\x1ad\n" +
	"\fControlPoint\x12,\n" +
	...
	"\x0fSUGGESTED_QUERY\x10\x02\"\xa0\x06\n" +
	"\x18SearchKnowledgeDebugInfo\x12o\n" +
	"\x19datastore_response_reason\x18\x01 \x01(\x0e23.google.cloud.dialogflow.v2.DatastoreResponseReasonR\x17datastoreResponseReason\x12\x88\x01\n" +
	"\x19search_knowledge_behavior\x18\x02 \x01(\v2L.google.cloud.dialogflow.v2.SearchKnowledgeDebugInfo.SearchKnowledgeBehaviorR\x17searchKnowledgeBehavior\x12\x8f\x01\n" +
	"%ingested_context_reference_debug_info\x18\x03 \x01(\v2=.google.cloud.dialogflow.v2.IngestedContextReferenceDebugInfoR!ingestedContextReferenceDebugInfo\x12S\n" +
	"\x0fservice_latency\x18\x04 \x01(\v2*.google.cloud.dialogflow.v2.ServiceLatencyR\x0eserviceLatency\x12B\n" +
	...
	"\x1dthird_party_connector_allowed\x18\x04 \x01(\bR\x1athirdPartyConnectorAllowed\"\x84\x02\n" +
	...
	"answerType\x12e\n" +
	"\x0eanswer_sources\x18\x03 \x03(\v2>.google.cloud.dialogflow.v2.SearchKnowledgeAnswer.AnswerSourceR\ranswerSources\x12P\n" +
	...
	"!dialogflow.googleapis.com/MessageR\rlatestMessage\x12T\n" +
	"\x0etrigger_events\x18\x03 \x03(\x0e2(.google.cloud.dialogflow.v2.TriggerEventB\x03\xe0A\x01R\rtriggerEvents2\xa6\x1a\n" +
	"\rConversations\x12\x8c\x02\n" +
	"\x12CreateConversation\x125.google.cloud.dialogflow.v2.CreateConversationRequest\x1a(.google.cloud.dialogflow.v2.Conversation\"\x94\x01\xdaA\x13parent,conversation\x82\xd3\xe4\x93\x02x:\fconversationZA:\fconversation\"1/v2/{parent=projects/*/locations/*}/conversations\"%/v2/{parent=projects/*}/conversations\x12\xed\x01\n" +
	"\x11ListConversations\x124.google.cloud.dialogflow.v2.ListConversationsRequest\x1a5.google.cloud.dialogflow.v2.ListConversationsResponse\"k\xdaA\x06parent\x82\xd3\xe4\x93\x02\\Z3\x121/v2/{parent=projects/*/locations/*}/conversations\x12%/v2/{parent=projects/*}/conversations\x12\xda\x01\n" +
	"\x0fGetConversation\x122.google.cloud.dialogflow.v2.GetConversationRequest\x1a(.google.cloud.dialogflow.v2.Conversation\"i\xdaA\x04name\x82\xd3\xe4\x93\x02\\Z3\x121/v2/{name=projects/*/locations/*/conversations/*}\x12%/v2/{name=projects/*/conversations/*}\x12\xfd\x01\n" +
	"\x14CompleteConversation\x127.google.cloud.dialogflow.v2.CompleteConversationRequest\x1a(.google.cloud.dialogflow.v2.Conversation\"\x81\x01\xdaA\x04name\x82\xd3\xe4\x93\x02t:\x01*Z?:\x01*\":/v2/{name=projects/*/locations/*/conversations/*}:complete\"./v2/{name=projects/*/conversations/*}:complete\x12\x92\x02\n" +
	"\x17IngestContextReferences\x12:.google.cloud.dialogflow.v2.IngestContextReferencesRequest\x1a;.google.cloud.dialogflow.v2.IngestContextReferencesResponse\"~\xdaA\x1fconversation,context_references\x82\xd3\xe4\x93\x02V:\x01*\"Q/v2/{conversation=projects/*/locations/*/conversations/*}:ingestContextReferences\x12\xf5\x01\n" +
	"\fListMessages\x12/.google.cloud.dialogflow.v2.ListMessagesRequest\x1a0.google.cloud.dialogflow.v2.ListMessagesResponse\"\x81\x01\xdaA\x06parent\x82\xd3\xe4\x93\x02rZ>\x12</v2/{parent=projects/*/locations/*/conversations/*}/messages\x120/v2/{parent=projects/*/conversations/*}/messages\x12\xf4\x02\n" +
	"\x1aSuggestConversationSummary\x12=.google.cloud.dialogflow.v2.SuggestConversationSummaryRequest\x1a>.google.cloud.dialogflow.v2.SuggestConversationSummaryResponse\"\xd6\x01\xdaA\fconversation\x82\xd3\xe4\x93\x02\xc0\x01:\x01*Ze:\x01*\"`/v2/{conversation=projects/*/locations/*/conversations/*}/suggestions:suggestConversationSummary\"T/v2/{conversation=projects/*/conversations/*}/suggestions:suggestConversationSummary\x12\xdd\x02\n" +
	"\x18GenerateStatelessSummary\x12;.google.cloud.dialogflow.v2.GenerateStatelessSummaryRequest\x1a<.google.cloud.dialogflow.v2.GenerateStatelessSummaryResponse\"\xc5\x01\x82\xd3\xe4\x93\x02\xbe\x01:\x01*Zd:\x01*\"_/v2/{stateless_conversation.parent=projects/*/locations/*}/suggestions:generateStatelessSummary\"S/v2/{stateless_conversation.parent=projects/*}/suggestions:generateStatelessSummary\x12\xeb\x01\n" +
	"\x1bGenerateStatelessSuggestion\x12>.google.cloud.dialogflow.v2.GenerateStatelessSuggestionRequest\x1a?.google.cloud.dialogflow.v2.GenerateStatelessSuggestionResponse\"K\x82\xd3\xe4\x93\x02E:\x01*\"@/v2/{parent=projects/*/locations/*}/statelessSuggestion:generate\x12\xae\x03\n" +
	"\x0fSearchKnowledge\x122.google.cloud.dialogflow.v2.SearchKnowledgeRequest\x1a3.google.cloud.dialogflow.v2.SearchKnowledgeResponse\"\xb1\x02\x82\xd3\xe4\x93\x02\xaa\x02:\x01*ZD:\x01*\"?/v2/{parent=projects/*/locations/*}/suggestions:searchKnowledgeZN:\x01*\"I/v2/{conversation=projects/*/conversations/*}/suggestions:searchKnowledgeZZ:\x01*\"U/v2/{conversation=projects/*/locations/*/conversations/*}/suggestions:searchKnowledge\"3/v2/{parent=projects/*}/suggestions:searchKnowledge\x12\xbb\x02\n" +
	"\x13GenerateSuggestions\x126.google.cloud.dialogflow.v2.GenerateSuggestionsRequest\x1a7.google.cloud.dialogflow.v2.GenerateSuggestionsResponse\"\xb2\x01\xdaA\fconversation\x82\xd3\xe4\x93\x02\x9c\x01:\x01*ZS:\x01*\"N/v2/{conversation=projects/*/locations/*/conversations/*}/suggestions:generate\"B/v2/{conversation=projects/*/conversations/*}/suggestions:generate\x1ax\xcaA\x19dialogflow.googleapis.com\xd2AYhttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflowB\xbd\x03\xeaA\xc5\x01\n" +
	...
	"\x1ecom.google.cloud.dialogflow.v2B\x11ConversationProtoP\x01Z>cloud.google.com/go/dialogflow/apiv2/dialogflowpb;dialogflowpb\xa2\x02\x02DF\xaa\x02\x1aGoogle.Cloud.Dialogflow.V2b\x06proto3"

var (
	file_google_cloud_dialogflow_v2_conversation_proto_rawDescOnce sync.Once
	file_google_cloud_dialogflow_v2_conversation_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_v2_conversation_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_v2_conversation_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_v2_conversation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2_conversation_proto_rawDesc), len(file_google_cloud_dialogflow_v2_conversation_proto_rawDesc)))
	})
...
var file_google_cloud_dialogflow_v2_conversation_proto_depIdxs = []int32{
	...
	66, // 32: google.cloud.dialogflow.v2.SearchKnowledgeDebugInfo.ces_debug_info:type_name -> google.protobuf.Struct
	29, // 33: google.cloud.dialogflow.v2.SearchKnowledgeResponse.answers:type_name -> google.cloud.dialogflow.v2.SearchKnowledgeAnswer
	27, // 34: google.cloud.dialogflow.v2.SearchKnowledgeResponse.search_knowledge_debug_info:type_name -> google.cloud.dialogflow.v2.SearchKnowledgeDebugInfo
	8,  // 35: google.cloud.dialogflow.v2.SearchKnowledgeAnswer.answer_type:type_name -> google.cloud.dialogflow.v2.SearchKnowledgeAnswer.AnswerType
	56, // 36: google.cloud.dialogflow.v2.SearchKnowledgeAnswer.answer_sources:type_name -> google.cloud.dialogflow.v2.SearchKnowledgeAnswer.AnswerSource
	63, // 37: google.cloud.dialogflow.v2.GenerateSuggestionsRequest.trigger_events:type_name -> google.cloud.dialogflow.v2.TriggerEvent
	36, // 38: google.cloud.dialogflow.v2.Conversation.TelephonyConnectionInfo.sip_headers:type_name -> google.cloud.dialogflow.v2.Conversation.TelephonyConnectionInfo.SipHeader
	37, // 39: google.cloud.dialogflow.v2.Conversation.TelephonyConnectionInfo.extra_mime_contents:type_name -> google.cloud.dialogflow.v2.Conversation.TelephonyConnectionInfo.MimeContent
	38, // 40: google.cloud.dialogflow.v2.Conversation.ContextReference.context_contents:type_name -> google.cloud.dialogflow.v2.Conversation.ContextReference.ContextContent
	2,  // 41: google.cloud.dialogflow.v2.Conversation.ContextReference.update_mode:type_name -> google.cloud.dialogflow.v2.Conversation.ContextReference.UpdateMode
	57, // 42: google.cloud.dialogflow.v2.Conversation.ContextReference.create_time:type_name -> google.protobuf.Timestamp
	4,  // 43: google.cloud.dialogflow.v2.Conversation.GeneratorContext.generator_type:type_name -> google.cloud.dialogflow.v2.Conversation.GeneratorContext.GeneratorType
	32, // 44: google.cloud.dialogflow.v2.Conversation.IngestedContextReferencesEntry.value:type_name -> google.cloud.dialogflow.v2.Conversation.ContextReference
	33, // 45: google.cloud.dialogflow.v2.Conversation.InitialGeneratorContextsEntry.value:type_name -> google.cloud.dialogflow.v2.Conversation.GeneratorContext
	3,  // 46: google.cloud.dialogflow.v2.Conversation.ContextReference.ContextContent.content_format:type_name -> google.cloud.dialogflow.v2.Conversation.ContextReference.ContextContent.ContentFormat
	57, // 47: google.cloud.dialogflow.v2.Conversation.ContextReference.ContextContent.ingestion_time:type_name -> google.protobuf.Timestamp
	32, // 48: google.cloud.dialogflow.v2.IngestContextReferencesRequest.ContextReferencesEntry.value:type_name -> google.cloud.dialogflow.v2.Conversation.ContextReference
	32, // 49: google.cloud.dialogflow.v2.IngestContextReferencesResponse.IngestedContextReferencesEntry.value:type_name -> google.cloud.dialogflow.v2.Conversation.ContextReference
	43, // 50: google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.text_sections:type_name -> google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.TextSectionsEntry
	42, // 51: google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.sorted_text_sections:type_name -> google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.SummarySection
	59, // 52: google.cloud.dialogflow.v2.GenerateStatelessSummaryRequest.MinimalConversation.messages:type_name -> google.cloud.dialogflow.v2.Message
	46, // 53: google.cloud.dialogflow.v2.GenerateStatelessSummaryResponse.Summary.text_sections:type_name -> google.cloud.dialogflow.v2.GenerateStatelessSummaryResponse.Summary.TextSectionsEntry
	32, // 54: google.cloud.dialogflow.v2.GenerateStatelessSuggestionRequest.ContextReferencesEntry.value:type_name -> google.cloud.dialogflow.v2.Conversation.ContextReference
	49, // 55: google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.boost_specs:type_name -> google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs
	50, // 56: google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.filter_specs:type_name -> google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.FilterSpecs
	51, // 57: google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.spec:type_name -> google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec
	52, // 58: google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec.condition_boost_specs:type_name -> google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec.ConditionBoostSpec
	53, // 59: google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec.ConditionBoostSpec.boost_control_spec:type_name -> google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec.ConditionBoostSpec.BoostControlSpec
	6,  // 60: google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec.ConditionBoostSpec.BoostControlSpec.attribute_type:type_name -> google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec.ConditionBoostSpec.BoostControlSpec.AttributeType
	7,  // 61: google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec.ConditionBoostSpec.BoostControlSpec.interpolation_type:type_name -> google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec.ConditionBoostSpec.BoostControlSpec.InterpolationType
	54, // 62: google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec.ConditionBoostSpec.BoostControlSpec.control_points:type_name -> google.cloud.dialogflow.v2.SearchKnowledgeRequest.SearchConfig.BoostSpecs.BoostSpec.ConditionBoostSpec.BoostControlSpec.ControlPoint
	66, // 63: google.cloud.dialogflow.v2.SearchKnowledgeAnswer.AnswerSource.metadata:type_name -> google.protobuf.Struct
	10, // 64: google.cloud.dialogflow.v2.Conversations.CreateConversation:input_type -> google.cloud.dialogflow.v2.CreateConversationRequest
	11, // 65: google.cloud.dialogflow.v2.Conversations.ListConversations:input_type -> google.cloud.dialogflow.v2.ListConversationsRequest
	13, // 66: google.cloud.dialogflow.v2.Conversations.GetConversation:input_type -> google.cloud.dialogflow.v2.GetConversationRequest
	14, // 67: google.cloud.dialogflow.v2.Conversations.CompleteConversation:input_type -> google.cloud.dialogflow.v2.CompleteConversationRequest
	18, // 68: google.cloud.dialogflow.v2.Conversations.IngestContextReferences:input_type -> google.cloud.dialogflow.v2.IngestContextReferencesRequest
	15, // 69: google.cloud.dialogflow.v2.Conversations.ListMessages:input_type -> google.cloud.dialogflow.v2.ListMessagesRequest
	20, // 70: google.cloud.dialogflow.v2.Conversations.SuggestConversationSummary:input_type -> google.cloud.dialogflow.v2.SuggestConversationSummaryRequest
	22, // 71: google.cloud.dialogflow.v2.Conversations.GenerateStatelessSummary:input_type -> google.cloud.dialogflow.v2.GenerateStatelessSummaryRequest
	24, // 72: google.cloud.dialogflow.v2.Conversations.GenerateStatelessSuggestion:input_type -> google.cloud.dialogflow.v2.GenerateStatelessSuggestionRequest
	26, // 73: google.cloud.dialogflow.v2.Conversations.SearchKnowledge:input_type -> google.cloud.dialogflow.v2.SearchKnowledgeRequest
	30, // 74: google.cloud.dialogflow.v2.Conversations.GenerateSuggestions:input_type -> google.cloud.dialogflow.v2.GenerateSuggestionsRequest
	9,  // 75: google.cloud.dialogflow.v2.Conversations.CreateConversation:output_type -> google.cloud.dialogflow.v2.Conversation
	12, // 76: google.cloud.dialogflow.v2.Conversations.ListConversations:output_type -> google.cloud.dialogflow.v2.ListConversationsResponse
	9,  // 77: google.cloud.dialogflow.v2.Conversations.GetConversation:output_type -> google.cloud.dialogflow.v2.Conversation
	9,  // 78: google.cloud.dialogflow.v2.Conversations.CompleteConversation:output_type -> google.cloud.dialogflow.v2.Conversation
	19, // 79: google.cloud.dialogflow.v2.Conversations.IngestContextReferences:output_type -> google.cloud.dialogflow.v2.IngestContextReferencesResponse
	16, // 80: google.cloud.dialogflow.v2.Conversations.ListMessages:output_type -> google.cloud.dialogflow.v2.ListMessagesResponse
	21, // 81: google.cloud.dialogflow.v2.Conversations.SuggestConversationSummary:output_type -> google.cloud.dialogflow.v2.SuggestConversationSummaryResponse
	23, // 82: google.cloud.dialogflow.v2.Conversations.GenerateStatelessSummary:output_type -> google.cloud.dialogflow.v2.GenerateStatelessSummaryResponse
	25, // 83: google.cloud.dialogflow.v2.Conversations.GenerateStatelessSuggestion:output_type -> google.cloud.dialogflow.v2.GenerateStatelessSuggestionResponse
	28, // 84: google.cloud.dialogflow.v2.Conversations.SearchKnowledge:output_type -> google.cloud.dialogflow.v2.SearchKnowledgeResponse
	70, // 85: google.cloud.dialogflow.v2.Conversations.GenerateSuggestions:output_type -> google.cloud.dialogflow.v2.GenerateSuggestionsResponse
...
func file_google_cloud_dialogflow_v2_conversation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2_conversation_proto_rawDesc), len(file_google_cloud_dialogflow_v2_conversation_proto_rawDesc)),
			NumEnums:      9,
			NumMessages:   48,
			NumExtensions: 0,
			NumServices:   1,
