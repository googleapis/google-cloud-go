...
type Tool struct {
	...
	// method_type is GET.
	ActionConfirmationRequirement map[string]Tool_ConfirmationRequirement `protobuf:"bytes,17,rep,name=action_confirmation_requirement,json=actionConfirmationRequirement,proto3" json:"action_confirmation_requirement,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value,enum=google.cloud.dialogflow.v2.Tool_ConfirmationRequirement"`
...
const file_google_cloud_dialogflow_v2_tool_proto_rawDesc = "" +
	"\n" +
	...
	"\x06parent\x18\x01 \x01(\tB&\xe0A\x02\xfaA \x12\x1edialogflow.googleapis.com/ToolR\x06parent\x129\n" +
	"\x04tool\x18\x02 \x01(\v2 .google.cloud.dialogflow.v2.ToolB\x03\xe0A\x02R\x04tool\x12\x1c\n" +
	...
	"\x05tools\x18\x01 \x03(\v2 .google.cloud.dialogflow.v2.ToolR\x05tools\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"O\n" +
	"\x11DeleteToolRequest\x12:\n" +
	"\x04name\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1edialogflow.googleapis.com/ToolR\x04name\"\x90\x01\n" +
	"\x11UpdateToolRequest\x129\n" +
	"\x04tool\x18\x01 \x01(\v2 .google.cloud.dialogflow.v2.ToolB\x03\xe0A\x02R\x04tool\x12@\n" +
	...
	"\vdescription\x18\x03 \x01(\tB\x03\xe0A\x01R\vdescription\x12\x90\x01\n" +
	"\x1faction_confirmation_requirement\x18\x11 \x03(\v2C.google.cloud.dialogflow.v2.Tool.ActionConfirmationRequirementEntryB\x03\xe0A\x01R\x1dactionConfirmationRequirement\x12[\n" +
	"\x0eextension_spec\x18\x04 \x01(\v2..google.cloud.dialogflow.v2.Tool.ExtensionToolB\x02\x18\x01H\x00R\rextensionSpec\x12T\n" +
	"\rfunction_spec\x18\r \x01(\v2-.google.cloud.dialogflow.v2.Tool.FunctionToolH\x00R\ffunctionSpec\x12W\n" +
	"\x0econnector_spec\x18\x12 \x01(\v2..google.cloud.dialogflow.v2.Tool.ConnectorToolH\x00R\rconnectorSpec\x12R\n" +
	"\ropen_api_spec\x18\x14 \x01(\v2,.google.cloud.dialogflow.v2.Tool.OpenApiToolH\x00R\vopenApiSpec\x12@\n" +
	...
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x1a\xe5\x01\n" +
	"\fFunctionTool\x12?\n" +
	"\finput_schema\x18\x01 \x01(\v2\x17.google.protobuf.StructB\x03\xe0A\x01R\vinputSchema\x12A\n" +
	"\routput_schema\x18\x02 \x01(\v2\x17.google.protobuf.StructB\x03\xe0A\x01R\foutputSchema\x12Q\n" +
	"\vmethod_type\x18\x04 \x01(\x0e2+.google.cloud.dialogflow.v2.Tool.MethodTypeB\x03\xe0A\x01R\n" +
	"methodType\x1a\xe5\x02\n" +
	"\vOpenApiTool\x12&\n" +
	"\vtext_schema\x18\x01 \x01(\tB\x03\xe0A\x02H\x00R\n" +
	"textSchema\x12\\\n" +
	"\x0eauthentication\x18\x02 \x01(\v2/.google.cloud.dialogflow.v2.Tool.AuthenticationB\x03\xe0A\x01R\x0eauthentication\x12N\n" +
	"\n" +
	"tls_config\x18\x03 \x01(\v2*.google.cloud.dialogflow.v2.Tool.TLSConfigB\x03\xe0A\x01R\ttlsConfig\x12v\n" +
	"\x18service_directory_config\x18\x04 \x01(\v27.google.cloud.dialogflow.v2.Tool.ServiceDirectoryConfigB\x03\xe0A\x01R\x16serviceDirectoryConfigB\b\n" +
	"\x06schema\x1a\xa8\x05\n" +
	"\rConnectorTool\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x12T\n" +
	"\aactions\x18\x02 \x03(\v25.google.cloud.dialogflow.v2.Tool.ConnectorTool.ActionB\x03\xe0A\x02R\aactions\x1a\xa7\x04\n" +
	"\x06Action\x122\n" +
	"\x14connection_action_id\x18\x04 \x01(\tH\x00R\x12connectionActionId\x12r\n" +
	"\x10entity_operation\x18\x05 \x01(\v2E.google.cloud.dialogflow.v2.Tool.ConnectorTool.Action.EntityOperationH\x00R\x0fentityOperation\x12&\n" +
	"\finput_fields\x18\x02 \x03(\tB\x03\xe0A\x01R\vinputFields\x12(\n" +
	"\routput_fields\x18\x03 \x03(\tB\x03\xe0A\x01R\foutputFields\x1a\x93\x02\n" +
	"\x0fEntityOperation\x12 \n" +
	"\tentity_id\x18\x01 \x01(\tB\x03\xe0A\x02R\bentityId\x12v\n" +
	"\toperation\x18\x02 \x01(\x0e2S.google.cloud.dialogflow.v2.Tool.ConnectorTool.Action.EntityOperation.OperationTypeB\x03\xe0A\x02R\toperation\"f\n" +
	...
	"\n" +
	"\x06DELETE\x10\x05B\r\n" +
	"\vaction_spec\x1a\xea\r\n" +
	"\x0eAuthentication\x12d\n" +
	"\x0eapi_key_config\x18\x01 \x01(\v2<.google.cloud.dialogflow.v2.Tool.Authentication.ApiKeyConfigH\x00R\fapiKeyConfig\x12`\n" +
	"\foauth_config\x18\x02 \x01(\v2;.google.cloud.dialogflow.v2.Tool.Authentication.OAuthConfigH\x00R\voauthConfig\x12\x83\x01\n" +
	"\x19service_agent_auth_config\x18\x03 \x01(\v2F.google.cloud.dialogflow.v2.Tool.Authentication.ServiceAgentAuthConfigH\x00R\x16serviceAgentAuthConfig\x12s\n" +
	"\x13bearer_token_config\x18\x04 \x01(\v2A.google.cloud.dialogflow.v2.Tool.Authentication.BearerTokenConfigH\x00R\x11bearerTokenConfig\x1a\xad\x02\n" +
	...
	"*secretmanager.googleapis.com/SecretVersionR\x16secretVersionForApiKey\x12o\n" +
	"\x10request_location\x18\x03 \x01(\x0e2?.google.cloud.dialogflow.v2.Tool.Authentication.RequestLocationB\x03\xe0A\x02R\x0frequestLocation\x1a\xe4\x03\n" +
	"\vOAuthConfig\x12y\n" +
	"\x10oauth_grant_type\x18\x01 \x01(\x0e2J.google.cloud.dialogflow.v2.Tool.Authentication.OAuthConfig.OauthGrantTypeB\x03\xe0A\x02R\x0eoauthGrantType\x12 \n" +
	...
	"\x11CLIENT_CREDENTIAL\x10\x01\x1a\xfd\x01\n" +
	"\x16ServiceAgentAuthConfig\x12\x8a\x01\n" +
	"\x12service_agent_auth\x18\x01 \x01(\x0e2W.google.cloud.dialogflow.v2.Tool.Authentication.ServiceAgentAuthConfig.ServiceAgentAuthB\x03\xe0A\x01R\x10serviceAgentAuth\"V\n" +
	...
	"\vauth_config\x1a\xa9\x01\n" +
	"\tTLSConfig\x12Q\n" +
	"\bca_certs\x18\x01 \x03(\v21.google.cloud.dialogflow.v2.Tool.TLSConfig.CACertB\x03\xe0A\x02R\acaCerts\x1aI\n" +
	"\x06CACert\x12&\n" +
	...
	"'servicedirectory.googleapis.com/ServiceR\aservice\x1a\x8a\x01\n" +
	"\"ActionConfirmationRequirementEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12N\n" +
	"\x05value\x18\x02 \x01(\x0e28.google.cloud.dialogflow.v2.Tool.ConfirmationRequirementR\x05value:\x028\x01\"c\n" +
	...
	"\x0e_satisfies_pzi2\xac\a\n" +
	"\x05Tools\x12\xac\x01\n" +
	"\n" +
	"CreateTool\x12-.google.cloud.dialogflow.v2.CreateToolRequest\x1a .google.cloud.dialogflow.v2.Tool\"M\xdaA\x13parent,tool,tool_id\x82\xd3\xe4\x93\x021:\x04tool\")/v2/{parent=projects/*/locations/*}/tools\x12\x91\x01\n" +
	"\aGetTool\x12*.google.cloud.dialogflow.v2.GetToolRequest\x1a .google.cloud.dialogflow.v2.Tool\"8\xdaA\x04name\x82\xd3\xe4\x93\x02+\x12)/v2/{name=projects/*/locations/*/tools/*}\x12\xa4\x01\n" +
	"\tListTools\x12,.google.cloud.dialogflow.v2.ListToolsRequest\x1a-.google.cloud.dialogflow.v2.ListToolsResponse\":\xdaA\x06parent\x82\xd3\xe4\x93\x02+\x12)/v2/{parent=projects/*/locations/*}/tools\x12\x8d\x01\n" +
	"\n" +
	"DeleteTool\x12-.google.cloud.dialogflow.v2.DeleteToolRequest\x1a\x16.google.protobuf.Empty\"8\xdaA\x04name\x82\xd3\xe4\x93\x02+*)/v2/{name=projects/*/locations/*/tools/*}\x12\xae\x01\n" +
	"\n" +
	"UpdateTool\x12-.google.cloud.dialogflow.v2.UpdateToolRequest\x1a .google.cloud.dialogflow.v2.Tool\"O\xdaA\x10tool,update_mask\x82\xd3\xe4\x93\x026:\x04tool2./v2/{tool.name=projects/*/locations/*/tools/*}\x1ax\xcaA\x19dialogflow.googleapis.com\xd2AYhttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflowB\xf6\x01\xeaAd\n" +
	"*secretmanager.googleapis.com/SecretVersion\x126projects/{project}/secrets/{secret}/versions/{version}\n" +
	"\x1ecom.google.cloud.dialogflow.v2B\tToolProtoP\x01Z>cloud.google.com/go/dialogflow/apiv2/dialogflowpb;dialogflowpb\xa2\x02\x02DF\xaa\x02\x1aGoogle.Cloud.Dialogflow.V2b\x06proto3"

var (
	file_google_cloud_dialogflow_v2_tool_proto_rawDescOnce sync.Once
	file_google_cloud_dialogflow_v2_tool_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_v2_tool_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_v2_tool_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_v2_tool_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2_tool_proto_rawDesc), len(file_google_cloud_dialogflow_v2_tool_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_v2_tool_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2_tool_proto_rawDesc), len(file_google_cloud_dialogflow_v2_tool_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   1,
