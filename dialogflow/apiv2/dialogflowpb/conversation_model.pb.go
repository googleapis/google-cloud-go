...
func (x *ConversationModel) GetModelMetadata() isConversationModel_ModelMetadata {
	if x != nil {
...
func (x *ConversationModel) GetArticleSuggestionModelMetadata() *ArticleSuggestionModelMetadata {
	if x != nil {
		if x, ok := x.ModelMetadata.(*ConversationModel_ArticleSuggestionModelMetadata); ok {
...
func (x *ConversationModel) GetSmartReplyModelMetadata() *SmartReplyModelMetadata {
	if x != nil {
		if x, ok := x.ModelMetadata.(*ConversationModel_SmartReplyModelMetadata); ok {
...
func (x *ConversationModelEvaluation) GetMetrics() isConversationModelEvaluation_Metrics {
	if x != nil {
		return x.Metrics
	}
	return nil
...
func (x *ConversationModelEvaluation) GetSmartReplyMetrics() *SmartReplyMetrics {
	if x != nil {
		if x, ok := x.Metrics.(*ConversationModelEvaluation_SmartReplyMetrics); ok {
...
type EvaluationConfig struct {
	...
	//
	// Types that are valid to be assigned to ModelSpecificConfig:
	//
...
func (x *EvaluationConfig) GetModelSpecificConfig() isEvaluationConfig_ModelSpecificConfig {
	if x != nil {
		return x.ModelSpecificConfig
	}
	return nil
}
...
func (x *EvaluationConfig) GetSmartReplyConfig() *EvaluationConfig_SmartReplyConfig {
	if x != nil {
		if x, ok := x.ModelSpecificConfig.(*EvaluationConfig_SmartReplyConfig_); ok {
...
func (x *EvaluationConfig) GetSmartComposeConfig() *EvaluationConfig_SmartComposeConfig {
	if x != nil {
		if x, ok := x.ModelSpecificConfig.(*EvaluationConfig_SmartComposeConfig_); ok {
...
const file_google_cloud_dialogflow_v2_conversation_model_proto_rawDesc = "" +
	"\n" +
	...
	"createTime\x12I\n" +
	"\bdatasets\x18\x04 \x03(\v2(.google.cloud.dialogflow.v2.InputDatasetB\x03\xe0A\x02R\bdatasets\x12N\n" +
	"\x05state\x18\a \x01(\x0e23.google.cloud.dialogflow.v2.ConversationModel.StateB\x03\xe0A\x03R\x05state\x12#\n" +
	"\rlanguage_code\x18\x13 \x01(\tR\flanguageCode\x12\x87\x01\n" +
	"!article_suggestion_model_metadata\x18\b \x01(\v2:.google.cloud.dialogflow.v2.ArticleSuggestionModelMetadataH\x00R\x1earticleSuggestionModelMetadata\x12r\n" +
	"\x1asmart_reply_model_metadata\x18\t \x01(\v23.google.cloud.dialogflow.v2.SmartReplyModelMetadataH\x00R\x17smartReplyModelMetadata\x12-\n" +
	"\rsatisfies_pzs\x18\x19 \x01(\bB\x03\xe0A\x03H\x01R\fsatisfiesPzs\x88\x01\x01\x12-\n" +
	"\rsatisfies_pzi\x18\x1a \x01(\bB\x03\xe0A\x03H\x02R\fsatisfiesPzi\x88\x01\x01\"\x91\x01\n" +
	"\x05State\x12\x15\n" +
	...
	"\x0e_satisfies_pzi\"\xac\x05\n" +
	"\x1bConversationModelEvaluation\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x01R\vdisplayName\x12^\n" +
	"\x11evaluation_config\x18\x06 \x01(\v2,.google.cloud.dialogflow.v2.EvaluationConfigB\x03\xe0A\x01R\x10evaluationConfig\x12@\n" +
	"\vcreate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12d\n" +
	"\x13smart_reply_metrics\x18\x05 \x01(\v2-.google.cloud.dialogflow.v2.SmartReplyMetricsB\x03\xe0A\x03H\x00R\x11smartReplyMetrics\x12A\n" +
	"\x1braw_human_eval_template_csv\x18\b \x01(\tB\x03\xe0A\x03R\x17rawHumanEvalTemplateCsv:\xfa\x01\xeaA\xf6\x01\n" +
	...
	"\bdatasets\x18\x03 \x03(\v2(.google.cloud.dialogflow.v2.InputDatasetB\x03\xe0A\x02R\bdatasets\x12m\n" +
	"\x12smart_reply_config\x18\x02 \x01(\v2=.google.cloud.dialogflow.v2.EvaluationConfig.SmartReplyConfigH\x00R\x10smartReplyConfig\x12s\n" +
	"\x14smart_compose_config\x18\x04 \x01(\v2?.google.cloud.dialogflow.v2.EvaluationConfig.SmartComposeConfigH\x00R\x12smartComposeConfig\x1a\x99\x01\n" +
	"\x10SmartReplyConfig\x12V\n" +
	"\x12allowlist_document\x18\x01 \x01(\tB'\xfaA$\n" +
	"\"dialogflow.googleapis.com/DocumentR\x11allowlistDocument\x12-\n" +
	"\x10max_result_count\x18\x02 \x01(\x05B\x03\xe0A\x02R\x0emaxResultCount\x1a\x9b\x01\n" +
	"\x12SmartComposeConfig\x12V\n" +
	"\x12allowlist_document\x18\x01 \x01(\tB'\xfaA$\n" +
	"\"dialogflow.googleapis.com/DocumentR\x11allowlistDocument\x12-\n" +
	"\x10max_result_count\x18\x02 \x01(\x05B\x03\xe0A\x02R\x0emaxResultCountB\x17\n" +
	"\x15model_specific_config\"_\n" +
	"\fInputDataset\x12O\n" +
	"\adataset\x18\x01 \x01(\tB5\xe0A\x02\xfaA/\n" +
	"-dialogflow.googleapis.com/ConversationDatasetR\adataset\"\x8e\x01\n" +
	"\x1eArticleSuggestionModelMetadata\x12l\n" +
	"\x13training_model_type\x18\x03 \x01(\x0e27.google.cloud.dialogflow.v2.ConversationModel.ModelTypeB\x03\xe0A\x01R\x11trainingModelType\"\x87\x01\n" +
	"\x17SmartReplyModelMetadata\x12l\n" +
	"\x13training_model_type\x18\x06 \x01(\x0e27.google.cloud.dialogflow.v2.ConversationModel.ModelTypeB\x03\xe0A\x01R\x11trainingModelType\"\x85\x02\n" +
	"\x11SmartReplyMetrics\x12-\n" +
	"\x12allowlist_coverage\x18\x01 \x01(\x02R\x11allowlistCoverage\x12]\n" +
	"\rtop_n_metrics\x18\x02 \x03(\v29.google.cloud.dialogflow.v2.SmartReplyMetrics.TopNMetricsR\vtopNMetrics\x12-\n" +
	"\x12conversation_count\x18\x03 \x01(\x03R\x11conversationCount\x1a3\n" +
	"\vTopNMetrics\x12\f\n" +
	"\x01n\x18\x01 \x01(\x05R\x01n\x12\x16\n" +
	"\x06recall\x18\x02 \x01(\x02R\x06recall\"\x9b\x01\n" +
	"\x1eCreateConversationModelRequest\x12\x16\n" +
	"\x06parent\x18\x01 \x01(\tR\x06parent\x12a\n" +
	"\x12conversation_model\x18\x02 \x01(\v2-.google.cloud.dialogflow.v2.ConversationModelB\x03\xe0A\x02R\x11conversationModel\"6\n" +
	"\x1bGetConversationModelRequest\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\"\x82\x01\n" +
	"\x1dListConversationModelsRequest\x12\x1b\n" +
	"\x06parent\x18\x01 \x01(\tB\x03\xe0A\x02R\x06parent\x12 \n" +
	"\tpage_size\x18\x02 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tB\x03\xe0A\x01R\tpageToken\"\xa8\x01\n" +
	"\x1eListConversationModelsResponse\x12^\n" +
	"\x13conversation_models\x18\x01 \x03(\v2-.google.cloud.dialogflow.v2.ConversationModelR\x12conversationModels\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"9\n" +
	"\x1eDeleteConversationModelRequest\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\"9\n" +
	"\x1eDeployConversationModelRequest\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\";\n" +
	" UndeployConversationModelRequest\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\"@\n" +
	"%GetConversationModelEvaluationRequest\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\"\x8c\x01\n" +
	"'ListConversationModelEvaluationsRequest\x12\x1b\n" +
	"\x06parent\x18\x01 \x01(\tB\x03\xe0A\x02R\x06parent\x12 \n" +
	"\tpage_size\x18\x02 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tB\x03\xe0A\x01R\tpageToken\"\xd1\x01\n" +
	"(ListConversationModelEvaluationsResponse\x12}\n" +
	"\x1econversation_model_evaluations\x18\x01 \x03(\v27.google.cloud.dialogflow.v2.ConversationModelEvaluationR\x1cconversationModelEvaluations\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\x84\x02\n" +
	"(CreateConversationModelEvaluationRequest\x12U\n" +
	"\x06parent\x18\x01 \x01(\tB=\xe0A\x02\xfaA7\x125dialogflow.googleapis.com/ConversationModelEvaluationR\x06parent\x12\x80\x01\n" +
	"\x1dconversation_model_evaluation\x18\x02 \x01(\v27.google.cloud.dialogflow.v2.ConversationModelEvaluationB\x03\xe0A\x02R\x1bconversationModelEvaluation\"\xa6\x03\n" +
	"(CreateConversationModelOperationMetadata\x12-\n" +
	"\x12conversation_model\x18\x01 \x01(\tR\x11conversationModel\x12`\n" +
	"\x05state\x18\x02 \x01(\x0e2J.google.cloud.dialogflow.v2.CreateConversationModelOperationMetadata.StateR\x05state\x12;\n" +
	"\vcreate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x127\n" +
	"\tdone_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\bdoneTime\"s\n" +
	"\x05State\x12\x15\n" +
	...
	"\bTRAINING\x10\x06\"\xcf\x01\n" +
	"(DeployConversationModelOperationMetadata\x12-\n" +
	"\x12conversation_model\x18\x01 \x01(\tR\x11conversationModel\x12;\n" +
	"\vcreate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x127\n" +
	"\tdone_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\bdoneTime\"\xd1\x01\n" +
	"*UndeployConversationModelOperationMetadata\x12-\n" +
	"\x12conversation_model\x18\x01 \x01(\tR\x11conversationModel\x12;\n" +
	"\vcreate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x127\n" +
	"\tdone_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\bdoneTime\"\xcf\x01\n" +
	"(DeleteConversationModelOperationMetadata\x12-\n" +
	"\x12conversation_model\x18\x01 \x01(\tR\x11conversationModel\x12;\n" +
	"\vcreate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x127\n" +
	"\tdone_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\bdoneTime\"\xb9\x03\n" +
	"2CreateConversationModelEvaluationOperationMetadata\x12B\n" +
	"\x1dconversation_model_evaluation\x18\x01 \x01(\tR\x1bconversationModelEvaluation\x12-\n" +
	"\x12conversation_model\x18\x04 \x01(\tR\x11conversationModel\x12j\n" +
	"\x05state\x18\x02 \x01(\x0e2T.google.cloud.dialogflow.v2.CreateConversationModelEvaluationOperationMetadata.StateR\x05state\x12;\n" +
	"\vcreate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\"g\n" +
	"\x05State\x12\x15\n" +
	...
	"\x11ConversationModel\x12(CreateConversationModelOperationMetadata\xdaA\x19parent,conversation_model\x82\xd3\xe4\x93\x02\x8e\x01:\x12conversation_modelZL:\x12conversation_model\"6/v2/{parent=projects/*/locations/*}/conversationModels\"*/v2/{parent=projects/*}/conversationModels\x12\xf3\x01\n" +
	"\x14GetConversationModel\x127.google.cloud.dialogflow.v2.GetConversationModelRequest\x1a-.google.cloud.dialogflow.v2.ConversationModel\"s\xdaA\x04name\x82\xd3\xe4\x93\x02fZ8\x126/v2/{name=projects/*/locations/*/conversationModels/*}\x12*/v2/{name=projects/*/conversationModels/*}\x12\x86\x02\n" +
	"\x16ListConversationModels\x129.google.cloud.dialogflow.v2.ListConversationModelsRequest\x1a:.google.cloud.dialogflow.v2.ListConversationModelsResponse\"u\xdaA\x06parent\x82\xd3\xe4\x93\x02fZ8\x126/v2/{parent=projects/*/locations/*}/conversationModels\x12*/v2/{parent=projects/*}/conversationModels\x12\xae\x02\n" +
	...
	"\x15google.protobuf.Empty\x12(DeleteConversationModelOperationMetadata\xdaA\x04name\x82\xd3\xe4\x93\x02fZ8*6/v2/{name=projects/*/locations/*/conversationModels/*}**/v2/{name=projects/*/conversationModels/*}\x12\xbb\x02\n" +
	...
	"\x15google.protobuf.Empty\x12(DeployConversationModelOperationMetadata\x82\xd3\xe4\x93\x02z:\x01*ZB:\x01*\"=/v2/{name=projects/*/locations/*/conversationModels/*}:deploy\"1/v2/{name=projects/*/conversationModels/*}:deploy\x12\xc5\x02\n" +
	...
	"\x15google.protobuf.Empty\x12*UndeployConversationModelOperationMetadata\x82\xd3\xe4\x93\x02~:\x01*ZD:\x01*\"?/v2/{name=projects/*/locations/*/conversationModels/*}:undeploy\"3/v2/{name=projects/*/conversationModels/*}:undeploy\x12\xaf\x02\n" +
	"\x1eGetConversationModelEvaluation\x12A.google.cloud.dialogflow.v2.GetConversationModelEvaluationRequest\x1a7.google.cloud.dialogflow.v2.ConversationModelEvaluation\"\x90\x01\xdaA\x04name\x82\xd3\xe4\x93\x02\x82\x01ZF\x12D/v2/{name=projects/*/locations/*/conversationModels/*/evaluations/*}\x128/v2/{name=projects/*/conversationModels/*/evaluations/*}\x12\xc2\x02\n" +
	" ListConversationModelEvaluations\x12C.google.cloud.dialogflow.v2.ListConversationModelEvaluationsRequest\x1aD.google.cloud.dialogflow.v2.ListConversationModelEvaluationsResponse\"\x92\x01\xdaA\x06parent\x82\xd3\xe4\x93\x02\x82\x01ZF\x12D/v2/{parent=projects/*/locations/*/conversationModels/*}/evaluations\x128/v2/{parent=projects/*/conversationModels/*}/evaluations\x12\xd5\x02\n" +
	...
	"\x1bConversationModelEvaluation\x122CreateConversationModelEvaluationOperationMetadata\xdaA$parent,conversation_model_evaluation\x82\xd3\xe4\x93\x02I:\x01*\"D/v2/{parent=projects/*/locations/*/conversationModels/*}/evaluations\x1ax\xcaA\x19dialogflow.googleapis.com\xd2AYhttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflowB\x9c\x01\n" +
...
var (
	...
	file_google_cloud_dialogflow_v2_conversation_model_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_v2_conversation_model_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_v2_conversation_model_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_v2_conversation_model_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2_conversation_model_proto_rawDesc), len(file_google_cloud_dialogflow_v2_conversation_model_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_v2_conversation_model_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2_conversation_model_proto_rawDesc), len(file_google_cloud_dialogflow_v2_conversation_model_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   26,
			NumExtensions: 0,
			NumServices:   1,
