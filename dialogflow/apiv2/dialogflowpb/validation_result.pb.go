...
const file_google_cloud_dialogflow_v2_validation_result_proto_rawDesc = "" +
	"\n" +
	"2google/cloud/dialogflow/v2/validation_result.proto\x12\x1agoogle.cloud.dialogflow.v2\"\xf8\x01\n" +
	"\x0fValidationError\x12P\n" +
	"\bseverity\x18\x01 \x01(\x0e24.google.cloud.dialogflow.v2.ValidationError.SeverityR\bseverity\x12\x18\n" +
	...
	"\x11validation_errors\x18\x01 \x03(\v2+.google.cloud.dialogflow.v2.ValidationErrorR\x10validationErrorsB\x9b\x01\n" +
...
var (
	...
	file_google_cloud_dialogflow_v2_validation_result_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_v2_validation_result_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_v2_validation_result_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_v2_validation_result_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2_validation_result_proto_rawDesc), len(file_google_cloud_dialogflow_v2_validation_result_proto_rawDesc)))
	})
...
var file_google_cloud_dialogflow_v2_validation_result_proto_goTypes = []any{
...
func file_google_cloud_dialogflow_v2_validation_result_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2_validation_result_proto_rawDesc), len(file_google_cloud_dialogflow_v2_validation_result_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
