...
const file_google_cloud_dialogflow_v2_agent_proto_rawDesc = "" +
	"\n" +
	...
	"\x15default_language_code\x18\x03 \x01(\tB\x03\xe0A\x02R\x13defaultLanguageCode\x12=\n" +
	"\x18supported_language_codes\x18\x04 \x03(\tB\x03\xe0A\x01R\x16supportedLanguageCodes\x12 \n" +
	"\ttime_zone\x18\x05 \x01(\tB\x03\xe0A\x02R\btimeZone\x12%\n" +
	"\vdescription\x18\x06 \x01(\tB\x03\xe0A\x01R\vdescription\x12\"\n" +
	"\n" +
	"avatar_uri\x18\a \x01(\tB\x03\xe0A\x01R\tavatarUri\x12*\n" +
	"\x0eenable_logging\x18\b \x01(\bB\x03\xe0A\x01R\renableLogging\x12Q\n" +
	"\n" +
	"match_mode\x18\t \x01(\x0e2+.google.cloud.dialogflow.v2.Agent.MatchModeB\x05\xe0A\x01\x18\x01R\tmatchMode\x12>\n" +
	"\x18classification_threshold\x18\n" +
	" \x01(\x02B\x03\xe0A\x01R\x17classificationThreshold\x12R\n" +
	"\vapi_version\x18\x0e \x01(\x0e2,.google.cloud.dialogflow.v2.Agent.ApiVersionB\x03\xe0A\x01R\n" +
	"apiVersion\x12?\n" +
	"\x04tier\x18\x0f \x01(\x0e2&.google.cloud.dialogflow.v2.Agent.TierB\x03\xe0A\x01R\x04tier\"V\n" +
	"\tMatchMode\x12\x1a\n" +
	...
	"\x05agent\x18\x01 \x01(\v2!.google.cloud.dialogflow.v2.AgentB\x03\xe0A\x02R\x05agent\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x01R\n" +
	"updateMask\"U\n" +
	"\x12DeleteAgentRequest\x12?\n" +
	"\x06parent\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\x12\x1fdialogflow.googleapis.com/AgentR\x06parent\"\x97\x01\n" +
	...
	"\x14SearchAgentsResponse\x129\n" +
	"\x06agents\x18\x01 \x03(\v2!.google.cloud.dialogflow.v2.AgentR\x06agents\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"T\n" +
	"\x11TrainAgentRequest\x12?\n" +
	"\x06parent\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\x12\x1fdialogflow.googleapis.com/AgentR\x06parent\"w\n" +
	"\x12ExportAgentRequest\x12?\n" +
	"\x06parent\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\x12\x1fdialogflow.googleapis.com/AgentR\x06parent\x12 \n" +
	"\tagent_uri\x18\x02 \x01(\tB\x03\xe0A\x02R\bagentUri\"d\n" +
	...
	"\x06parent\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\x12\x1fdialogflow.googleapis.com/AgentR\x06parent\x12(\n" +
	"\rlanguage_code\x18\x03 \x01(\tB\x03\xe0A\x01R\flanguageCode2\xaa\x11\n" +
	"\x06Agents\x12\xb7\x01\n" +
	"\bGetAgent\x12+.google.cloud.dialogflow.v2.GetAgentRequest\x1a!.google.cloud.dialogflow.v2.Agent\"[\xdaA\x06parent\x82\xd3\xe4\x93\x02LZ+\x12)/v2/{parent=projects/*/locations/*}/agent\x12\x1d/v2/{parent=projects/*}/agent\x12\xd0\x01\n" +
	"\bSetAgent\x12+.google.cloud.dialogflow.v2.SetAgentRequest\x1a!.google.cloud.dialogflow.v2.Agent\"t\xdaA\x05agent\x82\xd3\xe4\x93\x02f:\x05agentZ8:\x05agent\"//v2/{agent.parent=projects/*/locations/*}/agent\"#/v2/{agent.parent=projects/*}/agent\x12\xb2\x01\n" +
	"\vDeleteAgent\x12..google.cloud.dialogflow.v2.DeleteAgentRequest\x1a\x16.google.protobuf.Empty\"[\xdaA\x06parent\x82\xd3\xe4\x93\x02LZ+*)/v2/{parent=projects/*/locations/*}/agent*\x1d/v2/{parent=projects/*}/agent\x12\xdc\x01\n" +
	"\fSearchAgents\x12/.google.cloud.dialogflow.v2.SearchAgentsRequest\x1a0.google.cloud.dialogflow.v2.SearchAgentsResponse\"i\xdaA\x06parent\x82\xd3\xe4\x93\x02ZZ2\x120/v2/{parent=projects/*/locations/*}/agent:search\x12$/v2/{parent=projects/*}/agent:search\x12\xfc\x01\n" +
	"\n" +
	"TrainAgent\x12-.google.cloud.dialogflow.v2.TrainAgentRequest\x1a\x1d.google.longrunning.Operation\"\x9f\x01\xcaA/\n" +
	"\x15google.protobuf.Empty\x12\x16google.protobuf.Struct\xdaA\x06parent\x82\xd3\xe4\x93\x02^:\x01*Z4:\x01*\"//v2/{parent=projects/*/locations/*}/agent:train\"#/v2/{parent=projects/*}/agent:train\x12\x99\x02\n" +
	"\vExportAgent\x12..google.cloud.dialogflow.v2.ExportAgentRequest\x1a\x1d.google.longrunning.Operation\"\xba\x01\xcaAH\n" +
	".google.cloud.dialogflow.v2.ExportAgentResponse\x12\x16google.protobuf.Struct\xdaA\x06parent\x82\xd3\xe4\x93\x02`:\x01*Z5:\x01*\"0/v2/{parent=projects/*/locations/*}/agent:export\"$/v2/{parent=projects/*}/agent:export\x12\xf7\x01\n" +
	"\vImportAgent\x12..google.cloud.dialogflow.v2.ImportAgentRequest\x1a\x1d.google.longrunning.Operation\"\x98\x01\xcaA/\n" +
	"\x15google.protobuf.Empty\x12\x16google.protobuf.Struct\x82\xd3\xe4\x93\x02`:\x01*Z5:\x01*\"0/v2/{parent=projects/*/locations/*}/agent:import\"$/v2/{parent=projects/*}/agent:import\x12\xfb\x01\n" +
	"\fRestoreAgent\x12/.google.cloud.dialogflow.v2.RestoreAgentRequest\x1a\x1d.google.longrunning.Operation\"\x9a\x01\xcaA/\n" +
	"\x15google.protobuf.Empty\x12\x16google.protobuf.Struct\x82\xd3\xe4\x93\x02b:\x01*Z6:\x01*\"1/v2/{parent=projects/*/locations/*}/agent:restore\"%/v2/{parent=projects/*}/agent:restore\x12\xf1\x01\n" +
	"\x13GetValidationResult\x126.google.cloud.dialogflow.v2.GetValidationResultRequest\x1a,.google.cloud.dialogflow.v2.ValidationResult\"t\x82\xd3\xe4\x93\x02nZ<\x12:/v2/{parent=projects/*/locations/*}/agent/validationResult\x12./v2/{parent=projects/*}/agent/validationResult\x1ax\xcaA\x19dialogflow.googleapis.com\xd2AYhttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflowB\x90\x01\n" +
...
var (
	...
	file_google_cloud_dialogflow_v2_agent_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_v2_agent_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_v2_agent_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_v2_agent_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2_agent_proto_rawDesc), len(file_google_cloud_dialogflow_v2_agent_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_v2_agent_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2_agent_proto_rawDesc), len(file_google_cloud_dialogflow_v2_agent_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   1,
