...
func NewFulfillmentsClient(ctx context.Context, opts ...option.ClientOption) (*FulfillmentsClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.GetFulfillment = append(client.CallOptions.GetFulfillment, gax.WithClientMetrics(metrics))
		client.CallOptions.UpdateFulfillment = append(client.CallOptions.UpdateFulfillment, gax.WithClientMetrics(metrics))
...
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type fulfillmentsRESTClient struct {
...
func NewFulfillmentsRESTClient(ctx context.Context, opts ...option.ClientOption) (*FulfillmentsClient, error) {
	...
	callOpts := defaultFulfillmentsRESTCallOptions()
	c := &fulfillmentsRESTClient{
		endpoint:    endpoint,
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.GetFulfillment = append(callOpts.GetFulfillment, gax.WithClientMetrics(metrics))
		callOpts.UpdateFulfillment = append(callOpts.UpdateFulfillment, gax.WithClientMetrics(metrics))
...
// Close closes the connection to the API service. The user should invoke this when
// the client is no longer required.
func (c *fulfillmentsRESTClient) Close() error {
...
func (c *fulfillmentsRESTClient) Connection() *grpc.ClientConn {
	return nil
}
func (c *fulfillmentsGRPCClient) GetFulfillment(ctx context.Context, req *dialogflowpb.GetFulfillmentRequest, opts ...gax.CallOption) (*dialogflowpb.Fulfillment, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2.Fulfillments/GetFulfillment")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.fulfillmentsClient.GetFulfillment, req, settings.GRPC, c.logger, "GetFulfillment")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *fulfillmentsGRPCClient) UpdateFulfillment(ctx context.Context, req *dialogflowpb.UpdateFulfillmentRequest, opts ...gax.CallOption) (*dialogflowpb.Fulfillment, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "fulfillment.name", url.QueryEscape(req.GetFulfillment().GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2.Fulfillments/UpdateFulfillment")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.fulfillmentsClient.UpdateFulfillment, req, settings.GRPC, c.logger, "UpdateFulfillment")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
// GetFulfillment retrieves the fulfillment.
func (c *fulfillmentsRESTClient) GetFulfillment(ctx context.Context, req *dialogflowpb.GetFulfillmentRequest, opts ...gax.CallOption) (*dialogflowpb.Fulfillment, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2.Fulfillments/GetFulfillment")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2/{name=projects/*/agent/fulfillment}")
	}
	opts = append((*c.CallOptions).GetFulfillment[0:len((*c.CallOptions).GetFulfillment):len((*c.CallOptions).GetFulfillment)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &dialogflowpb.Fulfillment{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "GetFulfillment")
		if err != nil {
			return err
		}
...
// UpdateFulfillment updates the fulfillment.
func (c *fulfillmentsRESTClient) UpdateFulfillment(ctx context.Context, req *dialogflowpb.UpdateFulfillmentRequest, opts ...gax.CallOption) (*dialogflowpb.Fulfillment, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetFulfillment()
	...
	baseUrl.Path += fmt.Sprintf("/v2/%v", req.GetFulfillment().GetName())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2.Fulfillments/UpdateFulfillment")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2/{fulfillment.name=projects/*/agent/fulfillment}")
	}
	opts = append((*c.CallOptions).UpdateFulfillment[0:len((*c.CallOptions).UpdateFulfillment):len((*c.CallOptions).UpdateFulfillment)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &dialogflowpb.Fulfillment{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "UpdateFulfillment")
		if err != nil {
			return err
		}
...
// GetLocation gets information about a location.
func (c *fulfillmentsRESTClient) GetLocation(ctx context.Context, req *locationpb.GetLocationRequest, opts ...gax.CallOption) (*locationpb.Location, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// incorporated into the request path based on the specific service
// implementation and version.
func (c *fulfillmentsRESTClient) ListLocations(ctx context.Context, req *locationpb.ListLocationsRequest, opts ...gax.CallOption) *LocationIterator {
	it := &LocationIterator{}
	req = proto.Clone(req).(*locationpb.ListLocationsRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*locationpb.Location, string, error) {
...
// CancelOperation is a utility method from google.longrunning.Operations.
func (c *fulfillmentsRESTClient) CancelOperation(ctx context.Context, req *longrunningpb.CancelOperationRequest, opts ...gax.CallOption) error {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return err
	}
...
// GetOperation is a utility method from google.longrunning.Operations.
func (c *fulfillmentsRESTClient) GetOperation(ctx context.Context, req *longrunningpb.GetOperationRequest, opts ...gax.CallOption) (*longrunningpb.Operation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
