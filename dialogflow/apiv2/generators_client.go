...
type internalGeneratorsClient interface {
	...
	CreateGenerator(context.Context, *dialogflowpb.CreateGeneratorRequest, ...gax.CallOption) (*dialogflowpb.Generator, error)
	GetGenerator(context.Context, *dialogflowpb.GetGeneratorRequest, ...gax.CallOption) (*dialogflowpb.Generator, error)
	ListGenerators(context.Context, *dialogflowpb.ListGeneratorsRequest, ...gax.CallOption) *GeneratorIterator
	DeleteGenerator(context.Context, *dialogflowpb.DeleteGeneratorRequest, ...gax.CallOption) error
	UpdateGenerator(context.Context, *dialogflowpb.UpdateGeneratorRequest, ...gax.CallOption) (*dialogflowpb.Generator, error)
...
type generatorsGRPCClient struct {
	...
	// The gRPC API client.
	generatorsClient dialogflowpb.GeneratorsClient
...
func NewGeneratorsClient(ctx context.Context, opts ...option.ClientOption) (*GeneratorsClient, error) {
	...
	c := &generatorsGRPCClient{
		connPool:         connPool,
		generatorsClient: dialogflowpb.NewGeneratorsClient(connPool),
...
func (c *generatorsGRPCClient) CreateGenerator(ctx context.Context, req *dialogflowpb.CreateGeneratorRequest, opts ...gax.CallOption) (*dialogflowpb.Generator, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2.Generators/CreateGenerator")
	}
	opts = append((*c.CallOptions).CreateGenerator[0:len((*c.CallOptions).CreateGenerator):len((*c.CallOptions).CreateGenerator)], opts...)
	var resp *dialogflowpb.Generator
...
func (c *generatorsGRPCClient) GetGenerator(ctx context.Context, req *dialogflowpb.GetGeneratorRequest, opts ...gax.CallOption) (*dialogflowpb.Generator, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2.Generators/GetGenerator")
	}
...
func (c *generatorsGRPCClient) ListGenerators(ctx context.Context, req *dialogflowpb.ListGeneratorsRequest, opts ...gax.CallOption) *GeneratorIterator {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2.Generators/ListGenerators")
	}
...
func (c *generatorsGRPCClient) DeleteGenerator(ctx context.Context, req *dialogflowpb.DeleteGeneratorRequest, opts ...gax.CallOption) error {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2.Generators/DeleteGenerator")
	}
...
func (c *generatorsGRPCClient) UpdateGenerator(ctx context.Context, req *dialogflowpb.UpdateGeneratorRequest, opts ...gax.CallOption) (*dialogflowpb.Generator, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "generator.name", url.QueryEscape(req.GetGenerator().GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2.Generators/UpdateGenerator")
	}
...
// CreateGenerator creates a generator.
func (c *generatorsRESTClient) CreateGenerator(ctx context.Context, req *dialogflowpb.CreateGeneratorRequest, opts ...gax.CallOption) (*dialogflowpb.Generator, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v2/%v/generators", req.GetParent())

	params := url.Values{}
	params.Add("$alt", "json;enum-encoding=int")
	if req.GetGeneratorId() != "" {
		params.Add("generatorId", fmt.Sprintf("%v", req.GetGeneratorId()))
	}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2.Generators/CreateGenerator")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2/{parent=projects/*/locations/*}/generators")
	}
	opts = append((*c.CallOptions).CreateGenerator[0:len((*c.CallOptions).CreateGenerator):len((*c.CallOptions).CreateGenerator)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &dialogflowpb.Generator{}
...
// GetGenerator retrieves a generator.
func (c *generatorsRESTClient) GetGenerator(ctx context.Context, req *dialogflowpb.GetGeneratorRequest, opts ...gax.CallOption) (*dialogflowpb.Generator, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2.Generators/GetGenerator")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2/{name=projects/*/locations/*/generators/*}")
	}
	opts = append((*c.CallOptions).GetGenerator[0:len((*c.CallOptions).GetGenerator):len((*c.CallOptions).GetGenerator)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &dialogflowpb.Generator{}
...
// DeleteGenerator deletes a generator.
func (c *generatorsRESTClient) DeleteGenerator(ctx context.Context, req *dialogflowpb.DeleteGeneratorRequest, opts ...gax.CallOption) error {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return err
	}
...
// UpdateGenerator updates a generator.
func (c *generatorsRESTClient) UpdateGenerator(ctx context.Context, req *dialogflowpb.UpdateGeneratorRequest, opts ...gax.CallOption) (*dialogflowpb.Generator, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetGenerator()
	jsonReq, err := m.Marshal(body)
	if err != nil {
	...
	baseUrl.Path += fmt.Sprintf("/v2/%v", req.GetGenerator().GetName())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2.Generators/UpdateGenerator")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2/{generator.name=projects/*/locations/*/generators/*}")
	}
	opts = append((*c.CallOptions).UpdateGenerator[0:len((*c.CallOptions).UpdateGenerator):len((*c.CallOptions).UpdateGenerator)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &dialogflowpb.Generator{}
