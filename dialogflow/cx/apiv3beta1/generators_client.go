...
func NewGeneratorsClient(ctx context.Context, opts ...option.ClientOption) (*GeneratorsClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.ListGenerators = append(client.CallOptions.ListGenerators, gax.WithClientMetrics(metrics))
		client.CallOptions.GetGenerator = append(client.CallOptions.GetGenerator, gax.WithClientMetrics(metrics))
		client.CallOptions.CreateGenerator = append(client.CallOptions.CreateGenerator, gax.WithClientMetrics(metrics))
		client.CallOptions.UpdateGenerator = append(client.CallOptions.UpdateGenerator, gax.WithClientMetrics(metrics))
		client.CallOptions.DeleteGenerator = append(client.CallOptions.DeleteGenerator, gax.WithClientMetrics(metrics))
...
func NewGeneratorsRESTClient(ctx context.Context, opts ...option.ClientOption) (*GeneratorsClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.ListGenerators = append(callOpts.ListGenerators, gax.WithClientMetrics(metrics))
		callOpts.GetGenerator = append(callOpts.GetGenerator, gax.WithClientMetrics(metrics))
		callOpts.CreateGenerator = append(callOpts.CreateGenerator, gax.WithClientMetrics(metrics))
		callOpts.UpdateGenerator = append(callOpts.UpdateGenerator, gax.WithClientMetrics(metrics))
		callOpts.DeleteGenerator = append(callOpts.DeleteGenerator, gax.WithClientMetrics(metrics))
...
func (c *generatorsGRPCClient) ListGenerators(ctx context.Context, req *cxpb.ListGeneratorsRequest, opts ...gax.CallOption) *GeneratorIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.cx.v3beta1.Generators/ListGenerators")
	}
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*cxpb.Generator, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.generatorsClient.ListGenerators, req, settings.GRPC, c.logger, "ListGenerators")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *generatorsGRPCClient) GetGenerator(ctx context.Context, req *cxpb.GetGeneratorRequest, opts ...gax.CallOption) (*cxpb.Generator, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.cx.v3beta1.Generators/GetGenerator")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.generatorsClient.GetGenerator, req, settings.GRPC, c.logger, "GetGenerator")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *generatorsGRPCClient) CreateGenerator(ctx context.Context, req *cxpb.CreateGeneratorRequest, opts ...gax.CallOption) (*cxpb.Generator, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.cx.v3beta1.Generators/CreateGenerator")
	}
	opts = append((*c.CallOptions).CreateGenerator[0:len((*c.CallOptions).CreateGenerator):len((*c.CallOptions).CreateGenerator)], opts...)
	var resp *cxpb.Generator
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.generatorsClient.CreateGenerator, req, settings.GRPC, c.logger, "CreateGenerator")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *generatorsGRPCClient) UpdateGenerator(ctx context.Context, req *cxpb.UpdateGeneratorRequest, opts ...gax.CallOption) (*cxpb.Generator, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.cx.v3beta1.Generators/UpdateGenerator")
	}
	opts = append((*c.CallOptions).UpdateGenerator[0:len((*c.CallOptions).UpdateGenerator):len((*c.CallOptions).UpdateGenerator)], opts...)
	var resp *cxpb.Generator
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.generatorsClient.UpdateGenerator, req, settings.GRPC, c.logger, "UpdateGenerator")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *generatorsGRPCClient) DeleteGenerator(ctx context.Context, req *cxpb.DeleteGeneratorRequest, opts ...gax.CallOption) error {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.cx.v3beta1.Generators/DeleteGenerator")
	}
	opts = append((*c.CallOptions).DeleteGenerator[0:len((*c.CallOptions).DeleteGenerator):len((*c.CallOptions).DeleteGenerator)], opts...)
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		_, err = executeRPC(ctx, c.generatorsClient.DeleteGenerator, req, settings.GRPC, c.logger, "DeleteGenerator")
		return err
	}, opts...)
	return err
}
...
func (c *generatorsRESTClient) ListGenerators(ctx context.Context, req *cxpb.ListGeneratorsRequest, opts ...gax.CallOption) *GeneratorIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*cxpb.Generator, string, error) {
		...
		e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			...
			buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "ListGenerators")
			if err != nil {
				return err
			}
...
func (c *generatorsRESTClient) GetGenerator(ctx context.Context, req *cxpb.GetGeneratorRequest, opts ...gax.CallOption) (*cxpb.Generator, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.cx.v3beta1.Generators/GetGenerator")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v3beta1/{name=projects/*/locations/*/agents/*/generators/*}")
	}
	opts = append((*c.CallOptions).GetGenerator[0:len((*c.CallOptions).GetGenerator):len((*c.CallOptions).GetGenerator)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &cxpb.Generator{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "GetGenerator")
		if err != nil {
			return err
		}
...
func (c *generatorsRESTClient) CreateGenerator(ctx context.Context, req *cxpb.CreateGeneratorRequest, opts ...gax.CallOption) (*cxpb.Generator, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.cx.v3beta1.Generators/CreateGenerator")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v3beta1/{parent=projects/*/locations/*/agents/*}/generators")
	}
	opts = append((*c.CallOptions).CreateGenerator[0:len((*c.CallOptions).CreateGenerator):len((*c.CallOptions).CreateGenerator)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &cxpb.Generator{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "CreateGenerator")
		if err != nil {
			return err
		}
...
func (c *generatorsRESTClient) UpdateGenerator(ctx context.Context, req *cxpb.UpdateGeneratorRequest, opts ...gax.CallOption) (*cxpb.Generator, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.cx.v3beta1.Generators/UpdateGenerator")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v3beta1/{generator.name=projects/*/locations/*/agents/*/generators/*}")
	}
	opts = append((*c.CallOptions).UpdateGenerator[0:len((*c.CallOptions).UpdateGenerator):len((*c.CallOptions).UpdateGenerator)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &cxpb.Generator{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "UpdateGenerator")
		if err != nil {
			return err
		}
...
func (c *generatorsRESTClient) DeleteGenerator(ctx context.Context, req *cxpb.DeleteGeneratorRequest, opts ...gax.CallOption) error {
	...
	return gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		_, err = executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "DeleteGenerator")
		return err
	}, opts...)
}
