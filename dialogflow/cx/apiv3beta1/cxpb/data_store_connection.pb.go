...
const file_google_cloud_dialogflow_cx_v3beta1_data_store_connection_proto_rawDesc = "" +
	"\n" +
	">google/cloud/dialogflow/cx/v3beta1/data_store_connection.proto\x12\"google.cloud.dialogflow.cx.v3beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x85\x02\n" +
	"\x13DataStoreConnection\x12Y\n" +
	"\x0fdata_store_type\x18\x01 \x01(\x0e21.google.cloud.dialogflow.cx.v3beta1.DataStoreTypeR\rdataStoreType\x12\x1d\n" +
	"\n" +
	"data_store\x18\x02 \x01(\tR\tdataStore\x12t\n" +
	"\x18document_processing_mode\x18\x04 \x01(\x0e2:.google.cloud.dialogflow.cx.v3beta1.DocumentProcessingModeR\x16documentProcessingMode\"\x9c\x16\n" +
	"\x1aDataStoreConnectionSignals\x12\x9b\x01\n" +
	"\x1brewriter_model_call_signals\x18\x01 \x01(\v2W.google.cloud.dialogflow.cx.v3beta1.DataStoreConnectionSignals.RewriterModelCallSignalsB\x03\xe0A\x01R\x18rewriterModelCallSignals\x12,\n" +
	"\x0frewritten_query\x18\x02 \x01(\tB\x03\xe0A\x01R\x0erewrittenQuery\x12z\n" +
	"\x0fsearch_snippets\x18\x03 \x03(\v2L.google.cloud.dialogflow.cx.v3beta1.DataStoreConnectionSignals.SearchSnippetB\x03\xe0A\x01R\x0esearchSnippets\x12\xb4\x01\n" +
	"$answer_generation_model_call_signals\x18\x04 \x01(\v2_.google.cloud.dialogflow.cx.v3beta1.DataStoreConnectionSignals.AnswerGenerationModelCallSignalsB\x03\xe0A\x01R answerGenerationModelCallSignals\x12\x1b\n" +
	"\x06answer\x18\x05 \x01(\tB\x03\xe0A\x01R\x06answer\x12q\n" +
	"\fanswer_parts\x18\x06 \x03(\v2I.google.cloud.dialogflow.cx.v3beta1.DataStoreConnectionSignals.AnswerPartB\x03\xe0A\x01R\vanswerParts\x12w\n" +
	"\x0ecited_snippets\x18\a \x03(\v2K.google.cloud.dialogflow.cx.v3beta1.DataStoreConnectionSignals.CitedSnippetB\x03\xe0A\x01R\rcitedSnippets\x12\x81\x01\n" +
	"\x11grounding_signals\x18\b \x01(\v2O.google.cloud.dialogflow.cx.v3beta1.DataStoreConnectionSignals.GroundingSignalsB\x03\xe0A\x01R\x10groundingSignals\x12x\n" +
	"\x0esafety_signals\x18\t \x01(\v2L.google.cloud.dialogflow.cx.v3beta1.DataStoreConnectionSignals.SafetySignalsB\x03\xe0A\x01R\rsafetySignals\x1a|\n" +
	...
	"\x12supporting_indices\x18\x02 \x03(\x05R\x11supportingIndices\x1a\xa8\x01\n" +
	"\fCitedSnippet\x12s\n" +
	"\x0esearch_snippet\x18\x01 \x01(\v2L.google.cloud.dialogflow.cx.v3beta1.DataStoreConnectionSignals.SearchSnippetR\rsearchSnippet\x12#\n" +
	"\rsnippet_index\x18\x02 \x01(\x05R\fsnippetIndex\x1a\xf8\x03\n" +
	"\x10GroundingSignals\x12}\n" +
	"\bdecision\x18\x01 \x01(\x0e2a.google.cloud.dialogflow.cx.v3beta1.DataStoreConnectionSignals.GroundingSignals.GroundingDecisionR\bdecision\x12z\n" +
	"\x05score\x18\x02 \x01(\x0e2d.google.cloud.dialogflow.cx.v3beta1.DataStoreConnectionSignals.GroundingSignals.GroundingScoreBucketR\x05score\"m\n" +
	...
	"\x04HIGH\x10\x05\x12\r\n" +
	"\tVERY_HIGH\x10\x06\x1a\xd6\x04\n" +
	"\rSafetySignals\x12w\n" +
	"\bdecision\x18\x01 \x01(\x0e2[.google.cloud.dialogflow.cx.v3beta1.DataStoreConnectionSignals.SafetySignals.SafetyDecisionR\bdecision\x12\x8e\x01\n" +
	"\x13banned_phrase_match\x18\x02 \x01(\x0e2^.google.cloud.dialogflow.cx.v3beta1.DataStoreConnectionSignals.SafetySignals.BannedPhraseMatchR\x11bannedPhraseMatch\x122\n" +
...
var (
	...
	file_google_cloud_dialogflow_cx_v3beta1_data_store_connection_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_cx_v3beta1_data_store_connection_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_cx_v3beta1_data_store_connection_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_cx_v3beta1_data_store_connection_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3beta1_data_store_connection_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3beta1_data_store_connection_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_cx_v3beta1_data_store_connection_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3beta1_data_store_connection_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3beta1_data_store_connection_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
