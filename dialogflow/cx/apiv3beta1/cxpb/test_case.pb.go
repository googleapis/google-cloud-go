...
const file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_rawDesc = "" +
	...
	"\vtest_config\x18\r \x01(\v2..google.cloud.dialogflow.cx.v3beta1.TestConfigR\n" +
	"testConfig\x12u\n" +
	"\x1ctest_case_conversation_turns\x18\x05 \x03(\v24.google.cloud.dialogflow.cx.v3beta1.ConversationTurnR\x19testCaseConversationTurns\x12D\n" +
	"\rcreation_time\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\fcreationTime\x12\\\n" +
	"\x10last_test_result\x18\f \x01(\v22.google.cloud.dialogflow.cx.v3beta1.TestCaseResultR\x0elastTestResult:u\xeaAr\n" +
	...
	"%dialogflow.googleapis.com/EnvironmentR\venvironment\x12c\n" +
	"\x12conversation_turns\x18\x03 \x03(\v24.google.cloud.dialogflow.cx.v3beta1.ConversationTurnR\x11conversationTurns\x12O\n" +
	"\vtest_result\x18\x04 \x01(\x0e2..google.cloud.dialogflow.cx.v3beta1.TestResultR\n" +
	"testResult\x127\n" +
	...
	"\x1edialogflow.googleapis.com/PageR\x04page\"\xac\b\n" +
	"\x10ConversationTurn\x12]\n" +
	"\n" +
	"user_input\x18\x01 \x01(\v2>.google.cloud.dialogflow.cx.v3beta1.ConversationTurn.UserInputR\tuserInput\x12y\n" +
	"\x14virtual_agent_output\x18\x02 \x01(\v2G.google.cloud.dialogflow.cx.v3beta1.ConversationTurn.VirtualAgentOutputR\x12virtualAgentOutput\x1a\x85\x02\n" +
	"\tUserInput\x12D\n" +
	"\x05input\x18\x05 \x01(\v2..google.cloud.dialogflow.cx.v3beta1.QueryInputR\x05input\x12H\n" +
	...
	"\x19enable_sentiment_analysis\x18\a \x01(\bR\x17enableSentimentAnalysis\x1a\xb5\x04\n" +
	"\x12VirtualAgentOutput\x12F\n" +
	"\x12session_parameters\x18\x04 \x01(\v2\x17.google.protobuf.StructR\x11sessionParameters\x12\\\n" +
	"\vdifferences\x18\x05 \x03(\v25.google.cloud.dialogflow.cx.v3beta1.TestRunDifferenceB\x03\xe0A\x03R\vdifferences\x12H\n" +
	"\x0fdiagnostic_info\x18\x06 \x01(\v2\x17.google.protobuf.StructB\x06\xe0A\x02\xe0A\x04R\x0ediagnosticInfo\x12U\n" +
	"\x10triggered_intent\x18\a \x01(\v2*.google.cloud.dialogflow.cx.v3beta1.IntentR\x0ftriggeredIntent\x12K\n" +
	"\fcurrent_page\x18\b \x01(\v2(.google.cloud.dialogflow.cx.v3beta1.PageR\vcurrentPage\x12_\n" +
	"\x0etext_responses\x18\t \x03(\v28.google.cloud.dialogflow.cx.v3beta1.ResponseMessage.TextR\rtextResponses\x12*\n" +
	"\x06status\x18\n" +
	" \x01(\v2\x12.google.rpc.StatusR\x06status\"\xef\x01\n" +
	"\x11TestRunDifference\x12R\n" +
	"\x04type\x18\x01 \x01(\x0e2>.google.cloud.dialogflow.cx.v3beta1.TestRunDifference.DiffTypeR\x04type\x12 \n" +
	...
	"\x04FLOW\x10\x05\"\xfd\x05\n" +
	"\x12TransitionCoverage\x12c\n" +
	"\vtransitions\x18\x01 \x03(\v2A.google.cloud.dialogflow.cx.v3beta1.TransitionCoverage.TransitionR\vtransitions\x12%\n" +
	"\x0ecoverage_score\x18\x02 \x01(\x02R\rcoverageScore\x1a\x98\x01\n" +
	"\x0eTransitionNode\x12>\n" +
	"\x04page\x18\x01 \x01(\v2(.google.cloud.dialogflow.cx.v3beta1.PageH\x00R\x04page\x12>\n" +
	"\x04flow\x18\x02 \x01(\v2(.google.cloud.dialogflow.cx.v3beta1.FlowH\x00R\x04flowB\x06\n" +
	"\x04kind\x1a\xbf\x03\n" +
	"\n" +
	"Transition\x12]\n" +
	"\x06source\x18\x01 \x01(\v2E.google.cloud.dialogflow.cx.v3beta1.TransitionCoverage.TransitionNodeR\x06source\x12\x14\n" +
	"\x05index\x18\x04 \x01(\x05R\x05index\x12]\n" +
	"\x06target\x18\x02 \x01(\v2E.google.cloud.dialogflow.cx.v3beta1.TransitionCoverage.TransitionNodeR\x06target\x12\x18\n" +
	"\acovered\x18\x03 \x01(\bR\acovered\x12`\n" +
	"\x10transition_route\x18\x05 \x01(\v23.google.cloud.dialogflow.cx.v3beta1.TransitionRouteH\x00R\x0ftransitionRoute\x12W\n" +
	"\revent_handler\x18\x06 \x01(\v20.google.cloud.dialogflow.cx.v3beta1.EventHandlerH\x00R\feventHandlerB\b\n" +
	"\x06detail\"\xbe\x04\n" +
	"\x1cTransitionRouteGroupCoverage\x12g\n" +
	"\tcoverages\x18\x01 \x03(\v2I.google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroupCoverage.CoverageR\tcoverages\x12%\n" +
	"\x0ecoverage_score\x18\x02 \x01(\x02R\rcoverageScore\x1a\x8d\x03\n" +
	"\bCoverage\x12Y\n" +
	"\vroute_group\x18\x01 \x01(\v28.google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroupR\n" +
	"routeGroup\x12v\n" +
	"\vtransitions\x18\x02 \x03(\v2T.google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroupCoverage.Coverage.TransitionR\vtransitions\x12%\n" +
	"\x0ecoverage_score\x18\x03 \x01(\x02R\rcoverageScore\x1a\x86\x01\n" +
	"\n" +
	"Transition\x12^\n" +
	"\x10transition_route\x18\x01 \x01(\v23.google.cloud.dialogflow.cx.v3beta1.TransitionRouteR\x0ftransitionRoute\x12\x18\n" +
	"\acovered\x18\x02 \x01(\bR\acovered\"\xef\x01\n" +
	"\x0eIntentCoverage\x12S\n" +
	"\aintents\x18\x01 \x03(\v29.google.cloud.dialogflow.cx.v3beta1.IntentCoverage.IntentR\aintents\x12%\n" +
	...
	"\acovered\x18\x02 \x01(\bR\acovered\"\xa9\x02\n" +
	"\x18CalculateCoverageRequest\x12=\n" +
	"\x05agent\x18\x03 \x01(\tB'\xe0A\x02\xfaA!\n" +
	"\x1fdialogflow.googleapis.com/AgentR\x05agent\x12b\n" +
	"\x04type\x18\x02 \x01(\x0e2I.google.cloud.dialogflow.cx.v3beta1.CalculateCoverageRequest.CoverageTypeB\x03\xe0A\x02R\x04type\"j\n" +
	...
	"\x0fintent_coverage\x18\x02 \x01(\v22.google.cloud.dialogflow.cx.v3beta1.IntentCoverageH\x00R\x0eintentCoverage\x12i\n" +
	"\x13transition_coverage\x18\x04 \x01(\v26.google.cloud.dialogflow.cx.v3beta1.TransitionCoverageH\x00R\x12transitionCoverage\x12t\n" +
	"\x14route_group_coverage\x18\x06 \x01(\v2@.google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroupCoverageH\x00R\x12routeGroupCoverageB\x0f\n" +
	"\rcoverage_type\"\xb6\x02\n" +
	...
	"\x04view\x18\x04 \x01(\x0e2E.google.cloud.dialogflow.cx.v3beta1.ListTestCasesRequest.TestCaseViewR\x04view\"C\n" +
	"\fTestCaseView\x12\x1e\n" +
	"\x1aTEST_CASE_VIEW_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05BASIC\x10\x01\x12\b\n" +
	"\x04FULL\x10\x02\"\x8c\x01\n" +
	"\x15ListTestCasesResponse\x12K\n" +
	"\n" +
	"test_cases\x18\x01 \x03(\v2,.google.cloud.dialogflow.cx.v3beta1.TestCaseR\ttestCases\x12&\n" +
	...
	"\"dialogflow.googleapis.com/TestCaseR\x05names\"\xab\x01\n" +
	"\x15CreateTestCaseRequest\x12B\n" +
	"\x06parent\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\x12\"dialogflow.googleapis.com/TestCaseR\x06parent\x12N\n" +
	"\ttest_case\x18\x02 \x01(\v2,.google.cloud.dialogflow.cx.v3beta1.TestCaseB\x03\xe0A\x02R\btestCase\"\xa9\x01\n" +
	"\x15UpdateTestCaseRequest\x12N\n" +
	"\ttest_case\x18\x01 \x01(\v2,.google.cloud.dialogflow.cx.v3beta1.TestCaseB\x03\xe0A\x02R\btestCase\x12@\n" +
	...
	"%dialogflow.googleapis.com/EnvironmentR\venvironment\"a\n" +
	"\x13RunTestCaseResponse\x12J\n" +
	"\x06result\x18\x02 \x01(\v22.google.cloud.dialogflow.cx.v3beta1.TestCaseResultR\x06result\"\x15\n" +
	...
	"\x19BatchRunTestCasesResponse\x12L\n" +
	"\aresults\x18\x01 \x03(\v22.google.cloud.dialogflow.cx.v3beta1.TestCaseResultR\aresults\"b\n" +
	"\x19BatchRunTestCasesMetadata\x12E\n" +
	"\x06errors\x18\x01 \x03(\v2-.google.cloud.dialogflow.cx.v3beta1.TestErrorR\x06errors\"\xb6\x01\n" +
	"\tTestError\x12D\n" +
	...
	"\x06errors\x18\x01 \x03(\v21.google.cloud.dialogflow.cx.v3beta1.TestCaseErrorR\x06errors\"\x86\x01\n" +
	"\rTestCaseError\x12I\n" +
	"\ttest_case\x18\x01 \x01(\v2,.google.cloud.dialogflow.cx.v3beta1.TestCaseR\btestCase\x12*\n" +
	"\x06status\x18\x02 \x01(\v2\x12.google.rpc.StatusR\x06status\"\xc5\x02\n" +
	"\x16ExportTestCasesRequest\x12B\n" +
	"\x06parent\x18\x01 \x01(\tB*\xe0A\x02\xfaA$\x12\"dialogflow.googleapis.com/TestCaseR\x06parent\x12\x19\n" +
	"\agcs_uri\x18\x02 \x01(\tH\x00R\x06gcsUri\x12f\n" +
	"\vdata_format\x18\x03 \x01(\x0e2E.google.cloud.dialogflow.cx.v3beta1.ExportTestCasesRequest.DataFormatR\n" +
	"dataFormat\x12\x16\n" +
	...
	"\x11test_case_results\x18\x01 \x03(\v22.google.cloud.dialogflow.cx.v3beta1.TestCaseResultR\x0ftestCaseResults\x12&\n" +
	...
	"\x14BatchDeleteTestCases\x12?.google.cloud.dialogflow.cx.v3beta1.BatchDeleteTestCasesRequest\x1a\x16.google.protobuf.Empty\"[\xdaA\x06parent\x82\xd3\xe4\x93\x02L:\x01*\"G/v3beta1/{parent=projects/*/locations/*/agents/*}/testCases:batchDelete\x12\xbf\x01\n" +
	"\vGetTestCase\x126.google.cloud.dialogflow.cx.v3beta1.GetTestCaseRequest\x1a,.google.cloud.dialogflow.cx.v3beta1.TestCase\"J\xdaA\x04name\x82\xd3\xe4\x93\x02=\x12;/v3beta1/{name=projects/*/locations/*/agents/*/testCases/*}\x12\xdc\x01\n" +
	"\x0eCreateTestCase\x129.google.cloud.dialogflow.cx.v3beta1.CreateTestCaseRequest\x1a,.google.cloud.dialogflow.cx.v3beta1.TestCase\"a\xdaA\x10parent,test_case\x82\xd3\xe4\x93\x02H:\ttest_case\";/v3beta1/{parent=projects/*/locations/*/agents/*}/testCases\x12\xeb\x01\n" +
	"\x0eUpdateTestCase\x129.google.cloud.dialogflow.cx.v3beta1.UpdateTestCaseRequest\x1a,.google.cloud.dialogflow.cx.v3beta1.TestCase\"p\xdaA\x15test_case,update_mask\x82\xd3\xe4\x93\x02R:\ttest_case2E/v3beta1/{test_case.name=projects/*/locations/*/agents/*/testCases/*}\x12\xdd\x01\n" +
	"\vRunTestCase\x126.google.cloud.dialogflow.cx.v3beta1.RunTestCaseRequest\x1a\x1d.google.longrunning.Operation\"w\xcaA*\n" +
	"\x13RunTestCaseResponse\x12\x13RunTestCaseMetadata\x82\xd3\xe4\x93\x02D:\x01*\"?/v3beta1/{name=projects/*/locations/*/agents/*/testCases/*}:run\x12\xfb\x01\n" +
	...
	"\x19BatchRunTestCasesResponse\x12\x19BatchRunTestCasesMetadata\x82\xd3\xe4\x93\x02I:\x01*\"D/v3beta1/{parent=projects/*/locations/*/agents/*}/testCases:batchRun\x12\xe6\x01\n" +
	...
	"\x17ImportTestCasesResponse\x12\x17ImportTestCasesMetadata\x82\xd3\xe4\x93\x02G:\x01*\"B/v3beta1/{parent=projects/*/locations/*/agents/*}/testCases:import\x12\xf1\x01\n" +
	...
	"\x17ExportTestCasesResponse\x12\x17ExportTestCasesMetadata\x82\xd3\xe4\x93\x02G:\x01*\"B/v3beta1/{parent=projects/*/locations/*/agents/*}/testCases:export\x12\xee\x01\n" +
...
var (
	...
	file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_rawDesc)))
	})
...
var file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_goTypes = []any{
...
func file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_init() {
	...
	file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_msgTypes[9].OneofWrappers = []any{
	...
	file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_msgTypes[23].OneofWrappers = []any{
		(*ImportTestCasesRequest_GcsUri)(nil),
		(*ImportTestCasesRequest_Content)(nil),
	}
	file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_msgTypes[27].OneofWrappers = []any{
		(*ExportTestCasesRequest_GcsUri)(nil),
	}
	file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_msgTypes[28].OneofWrappers = []any{
		(*ExportTestCasesResponse_GcsUri)(nil),
		(*ExportTestCasesResponse_Content)(nil),
	}
	file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_msgTypes[35].OneofWrappers = []any{
		(*TransitionCoverage_TransitionNode_Page)(nil),
		(*TransitionCoverage_TransitionNode_Flow)(nil),
	}
	file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_msgTypes[36].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3beta1_test_case_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   40,
			NumExtensions: 0,
			NumServices:   1,
