...
const file_google_cloud_dialogflow_cx_v3beta1_session_proto_rawDesc = "" +
	...
	"responseId\x12`\n" +
	"\x0fanswer_feedback\x18\x03 \x01(\v22.google.cloud.dialogflow.cx.v3beta1.AnswerFeedbackB\x03\xe0A\x02R\x0eanswerFeedback\x12@\n" +
	"\vupdate_mask\x18\x04 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x01R\n" +
	"updateMask\"\xd7\x03\n" +
	"\x13DetectIntentRequest\x12C\n" +
	"\asession\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!dialogflow.googleapis.com/SessionR\asession\x12V\n" +
	"\fquery_params\x18\x02 \x01(\v23.google.cloud.dialogflow.cx.v3beta1.QueryParametersR\vqueryParams\x12T\n" +
	"\vquery_input\x18\x03 \x01(\v2..google.cloud.dialogflow.cx.v3beta1.QueryInputB\x03\xe0A\x02R\n" +
	"queryInput\x12e\n" +
	"\x13output_audio_config\x18\x04 \x01(\v25.google.cloud.dialogflow.cx.v3beta1.OutputAudioConfigR\x11outputAudioConfig\x12f\n" +
	"\rresponse_view\x18\t \x01(\x0e2<.google.cloud.dialogflow.cx.v3beta1.DetectIntentResponseViewB\x03\xe0A\x01R\fresponseView\"\xf7\x03\n" +
	"\x14DetectIntentResponse\x12\x1f\n" +
	"\vresponse_id\x18\x01 \x01(\tR\n" +
	"responseId\x12R\n" +
	"\fquery_result\x18\x02 \x01(\v2/.google.cloud.dialogflow.cx.v3beta1.QueryResultR\vqueryResult\x12!\n" +
	"\foutput_audio\x18\x04 \x01(\fR\voutputAudio\x12e\n" +
	"\x13output_audio_config\x18\x05 \x01(\v25.google.cloud.dialogflow.cx.v3beta1.OutputAudioConfigR\x11outputAudioConfig\x12j\n" +
	"\rresponse_type\x18\x06 \x01(\x0e2E.google.cloud.dialogflow.cx.v3beta1.DetectIntentResponse.ResponseTypeR\fresponseType\x12-\n" +
	...
	"\vquery_input\x18\x03 \x01(\v2..google.cloud.dialogflow.cx.v3beta1.QueryInputB\x03\xe0A\x02R\n" +
	"queryInput\x12e\n" +
	"\x13output_audio_config\x18\x04 \x01(\v25.google.cloud.dialogflow.cx.v3beta1.OutputAudioConfigR\x11outputAudioConfig\x126\n" +
	"\x17enable_partial_response\x18\x05 \x01(\bR\x15enablePartialResponse\x122\n" +
	"\x15enable_debugging_info\x18\b \x01(\bR\x13enableDebuggingInfo\x12f\n" +
	"\rresponse_view\x18\x10 \x01(\x0e2<.google.cloud.dialogflow.cx.v3beta1.DetectIntentResponseViewB\x03\xe0A\x01R\fresponseView\"\xd5\n" +
	"\n" +
	...
	"'client_half_close_streaming_time_offset\x18\x12 \x01(\v2\x19.google.protobuf.DurationR\"clientHalfCloseStreamingTimeOffset\"\xf9\x02\n" +
	"\x1dStreamingDetectIntentResponse\x12o\n" +
	"\x12recognition_result\x18\x01 \x01(\v2>.google.cloud.dialogflow.cx.v3beta1.StreamingRecognitionResultH\x00R\x11recognitionResult\x12p\n" +
	"\x16detect_intent_response\x18\x02 \x01(\v28.google.cloud.dialogflow.cx.v3beta1.DetectIntentResponseH\x00R\x14detectIntentResponse\x12i\n" +
	"\x0edebugging_info\x18\x04 \x01(\v2B.google.cloud.dialogflow.cx.v3beta1.CloudConversationDebuggingInfoR\rdebuggingInfoB\n" +
	"\n" +
	"\bresponse\"\xa8\x04\n" +
	"\x1aStreamingRecognitionResult\x12m\n" +
	"\fmessage_type\x18\x01 \x01(\x0e2J.google.cloud.dialogflow.cx.v3beta1.StreamingRecognitionResult.MessageTypeR\vmessageType\x12\x1e\n" +
	"\n" +
	...
	"\x10speech_word_info\x18\a \x03(\v22.google.cloud.dialogflow.cx.v3beta1.SpeechWordInfoR\x0espeechWordInfo\x12E\n" +
	...
	"\x17END_OF_SINGLE_UTTERANCE\x10\x02\"\xb4\n" +
	"\n" +
	"\x0fQueryParameters\x12\x1b\n" +
	"\ttime_zone\x18\x01 \x01(\tR\btimeZone\x126\n" +
	"\fgeo_location\x18\x02 \x01(\v2\x13.google.type.LatLngR\vgeoLocation\x12g\n" +
	"\x14session_entity_types\x18\x03 \x03(\v25.google.cloud.dialogflow.cx.v3beta1.SessionEntityTypeR\x12sessionEntityTypes\x121\n" +
	...
	"\x1canalyze_query_text_sentiment\x18\b \x01(\bR\x19analyzeQueryTextSentiment\x12p\n" +
	"\x0fwebhook_headers\x18\n" +
	" \x03(\v2G.google.cloud.dialogflow.cx.v3beta1.QueryParameters.WebhookHeadersEntryR\x0ewebhookHeaders\x12K\n" +
	...
	"\"dialogflow.googleapis.com/PlaybookR\x0fcurrentPlaybook\x12g\n" +
	"\x12llm_model_settings\x18\x15 \x01(\v24.google.cloud.dialogflow.cx.v3beta1.LlmModelSettingsB\x03\xe0A\x01R\x10llmModelSettings\x12\x18\n" +
	"\achannel\x18\x0f \x01(\tR\achannel\x12?\n" +
	"\vsession_ttl\x18\x10 \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x01R\n" +
	"sessionTtl\x12H\n" +
	"\x11end_user_metadata\x18\x12 \x01(\v2\x17.google.protobuf.StructB\x03\xe0A\x01R\x0fendUserMetadata\x12Z\n" +
	"\rsearch_config\x18\x14 \x01(\v20.google.cloud.dialogflow.cx.v3beta1.SearchConfigB\x03\xe0A\x01R\fsearchConfig\x12Y\n" +
	...
	"\fSearchConfig\x12T\n" +
	"\vboost_specs\x18\x01 \x03(\v2..google.cloud.dialogflow.cx.v3beta1.BoostSpecsB\x03\xe0A\x01R\n" +
	"boostSpecs\x12W\n" +
	"\ffilter_specs\x18\x02 \x03(\v2/.google.cloud.dialogflow.cx.v3beta1.FilterSpecsB\x03\xe0A\x01R\vfilterSpecs\"\xca\b\n" +
	"\tBoostSpec\x12y\n" +
	"\x15condition_boost_specs\x18\x01 \x03(\v2@.google.cloud.dialogflow.cx.v3beta1.BoostSpec.ConditionBoostSpecB\x03\xe0A\x01R\x13conditionBoostSpecs\x1a\xc1\a\n" +
	"\x12ConditionBoostSpec\x12!\n" +
	"\tcondition\x18\x01 \x01(\tB\x03\xe0A\x01R\tcondition\x12\x19\n" +
	"\x05boost\x18\x02 \x01(\x02B\x03\xe0A\x01R\x05boost\x12\x84\x01\n" +
	"\x12boost_control_spec\x18\x04 \x01(\v2Q.google.cloud.dialogflow.cx.v3beta1.BoostSpec.ConditionBoostSpec.BoostControlSpecB\x03\xe0A\x01R\x10boostControlSpec\x1a\xe5\x05\n" +
	"\x10BoostControlSpec\x12\"\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tB\x03\xe0A\x01R\tfieldName\x12\x8b\x01\n" +
	"\x0eattribute_type\x18\x02 \x01(\x0e2_.google.cloud.dialogflow.cx.v3beta1.BoostSpec.ConditionBoostSpec.BoostControlSpec.AttributeTypeB\x03\xe0A\x01R\rattributeType\x12\x97\x01\n" +
	"\x12interpolation_type\x18\x03 \x01(\x0e2c.google.cloud.dialogflow.cx.v3beta1.BoostSpec.ConditionBoostSpec.BoostControlSpec.InterpolationTypeB\x03\xe0A\x01R\x11interpolationType\x12\x8a\x01\n" +
	"\x0econtrol_points\x18\x04 \x03(\v2^.google.cloud.dialogflow.cx.v3beta1.BoostSpec.ConditionBoostSpec.BoostControlSpec.ControlPointB\x03\xe0A\x01R\rcontrolPoints\x1ad\n" +
	"\fControlPoint\x12,\n" +
	...
	"\n" +
	"\x06LINEAR\x10\x01\"\xa7\x01\n" +
	"\n" +
	"BoostSpecs\x12Q\n" +
	"\vdata_stores\x18\x01 \x03(\tB0\xe0A\x01\xfaA*\n" +
	"(discoveryengine.googleapis.com/DataStoreR\n" +
	"dataStores\x12F\n" +
	"\x04spec\x18\x02 \x03(\v2-.google.cloud.dialogflow.cx.v3beta1.BoostSpecB\x03\xe0A\x01R\x04spec\"}\n" +
	"\vFilterSpecs\x12Q\n" +
	"\vdata_stores\x18\x01 \x03(\tB0\xe0A\x01\xfaA*\n" +
	"(discoveryengine.googleapis.com/DataStoreR\n" +
	"dataStores\x12\x1b\n" +
	"\x06filter\x18\x02 \x01(\tB\x03\xe0A\x01R\x06filter\"\x84\x04\n" +
	"\n" +
	"QueryInput\x12C\n" +
	"\x04text\x18\x02 \x01(\v2-.google.cloud.dialogflow.cx.v3beta1.TextInputH\x00R\x04text\x12I\n" +
	"\x06intent\x18\x03 \x01(\v2/.google.cloud.dialogflow.cx.v3beta1.IntentInputH\x00R\x06intent\x12F\n" +
	"\x05audio\x18\x05 \x01(\v2..google.cloud.dialogflow.cx.v3beta1.AudioInputH\x00R\x05audio\x12F\n" +
	"\x05event\x18\x06 \x01(\v2..google.cloud.dialogflow.cx.v3beta1.EventInputH\x00R\x05event\x12C\n" +
	"\x04dtmf\x18\a \x01(\v2-.google.cloud.dialogflow.cx.v3beta1.DtmfInputH\x00R\x04dtmf\x12^\n" +
	"\x10tool_call_result\x18\v \x01(\v22.google.cloud.dialogflow.cx.v3beta1.ToolCallResultH\x00R\x0etoolCallResult\x12(\n" +
	"\rlanguage_code\x18\x04 \x01(\tB\x03\xe0A\x02R\flanguageCodeB\a\n" +
	"\x05input\"\x9a\x01\n" +
	"\x0eGenerativeInfo\x12+\n" +
	"\x11current_playbooks\x18\x01 \x03(\tR\x10currentPlaybooks\x12[\n" +
	"\x13action_tracing_info\x18\x02 \x01(\v2+.google.cloud.dialogflow.cx.v3beta1.ExampleR\x11actionTracingInfo\"\x84\x0e\n" +
	...
	"transcript\x12%\n" +
	"\rtrigger_event\x18\x0e \x01(\tH\x00R\ftriggerEvent\x12C\n" +
	"\x04dtmf\x18\x17 \x01(\v2-.google.cloud.dialogflow.cx.v3beta1.DtmfInputH\x00R\x04dtmf\x12#\n" +
	"\rlanguage_code\x18\x02 \x01(\tR\flanguageCode\x127\n" +
	"\n" +
	"parameters\x18\x03 \x01(\v2\x17.google.protobuf.StructR\n" +
	"parameters\x12`\n" +
	"\x11response_messages\x18\x04 \x03(\v23.google.cloud.dialogflow.cx.v3beta1.ResponseMessageR\x10responseMessages\x12\x1f\n" +
	"\vwebhook_ids\x18\x19 \x03(\tR\n" +
	"webhookIds\x122\n" +
	"\x15webhook_display_names\x18\x1a \x03(\tR\x13webhookDisplayNames\x12F\n" +
	"\x11webhook_latencies\x18\x1b \x03(\v2\x19.google.protobuf.DurationR\x10webhookLatencies\x12!\n" +
	"\fwebhook_tags\x18\x1d \x03(\tR\vwebhookTags\x12=\n" +
	"\x10webhook_statuses\x18\r \x03(\v2\x12.google.rpc.StatusR\x0fwebhookStatuses\x12B\n" +
	"\x10webhook_payloads\x18\x06 \x03(\v2\x17.google.protobuf.StructR\x0fwebhookPayloads\x12K\n" +
	"\fcurrent_page\x18\a \x01(\v2(.google.cloud.dialogflow.cx.v3beta1.PageR\vcurrentPage\x12K\n" +
	"\fcurrent_flow\x18\x1f \x01(\v2(.google.cloud.dialogflow.cx.v3beta1.FlowR\vcurrentFlow\x12F\n" +
	"\x06intent\x18\b \x01(\v2*.google.cloud.dialogflow.cx.v3beta1.IntentB\x02\x18\x01R\x06intent\x12B\n" +
	"\x1bintent_detection_confidence\x18\t \x01(\x02B\x02\x18\x01R\x19intentDetectionConfidence\x12?\n" +
	"\x05match\x18\x0f \x01(\v2).google.cloud.dialogflow.cx.v3beta1.MatchR\x05match\x12@\n" +
	"\x0fdiagnostic_info\x18\n" +
	" \x01(\v2\x17.google.protobuf.StructR\x0ediagnosticInfo\x12[\n" +
	"\x0fgenerative_info\x18! \x01(\v22.google.cloud.dialogflow.cx.v3beta1.GenerativeInfoR\x0egenerativeInfo\x12w\n" +
	"\x19sentiment_analysis_result\x18\x11 \x01(\v2;.google.cloud.dialogflow.cx.v3beta1.SentimentAnalysisResultR\x17sentimentAnalysisResult\x12a\n" +
	"\x11advanced_settings\x18\x15 \x01(\v24.google.cloud.dialogflow.cx.v3beta1.AdvancedSettingsR\x10advancedSettings\x122\n" +
	"\x15allow_answer_feedback\x18  \x01(\bR\x13allowAnswerFeedback\x12\x86\x01\n" +
	"\x1ddata_store_connection_signals\x18# \x01(\v2>.google.cloud.dialogflow.cx.v3beta1.DataStoreConnectionSignalsB\x03\xe0A\x01R\x1adataStoreConnectionSignals\x12V\n" +
	"\ftrace_blocks\x18% \x03(\v2..google.cloud.dialogflow.cx.v3beta1.TraceBlockB\x03\xe0A\x01R\vtraceBlocksB\a\n" +
	"\x05query\"$\n" +
	"\tTextInput\x12\x17\n" +
	"\x04text\x18\x01 \x01(\tB\x03\xe0A\x02R\x04text\"O\n" +
	"\vIntentInput\x12@\n" +
	"\x06intent\x18\x01 \x01(\tB(\xe0A\x02\xfaA\"\n" +
	" dialogflow.googleapis.com/IntentR\x06intent\"u\n" +
	"\n" +
	"AudioInput\x12Q\n" +
	"\x06config\x18\x01 \x01(\v24.google.cloud.dialogflow.cx.v3beta1.InputAudioConfigB\x03\xe0A\x02R\x06config\x12\x14\n" +
	...
	"\ffinish_digit\x18\x02 \x01(\tR\vfinishDigit\"\xe3\x03\n" +
	"\x05Match\x12B\n" +
	"\x06intent\x18\x01 \x01(\v2*.google.cloud.dialogflow.cx.v3beta1.IntentR\x06intent\x12\x14\n" +
	...
	"\n" +
	"match_type\x18\x04 \x01(\x0e23.google.cloud.dialogflow.cx.v3beta1.Match.MatchTypeR\tmatchType\x12\x1e\n" +
	"\n" +
	...
	"\vquery_input\x18\x03 \x01(\v2..google.cloud.dialogflow.cx.v3beta1.QueryInputB\x03\xe0A\x02R\n" +
	"queryInput\x12:\n" +
	"\x19persist_parameter_changes\x18\x05 \x01(\bR\x17persistParameterChanges\"\xdf\x02\n" +
	...
	"transcript\x12%\n" +
	"\rtrigger_event\x18\x06 \x01(\tH\x00R\ftriggerEvent\x12C\n" +
	"\amatches\x18\x04 \x03(\v2).google.cloud.dialogflow.cx.v3beta1.MatchR\amatches\x12K\n" +
	"\fcurrent_page\x18\x05 \x01(\v2(.google.cloud.dialogflow.cx.v3beta1.PageR\vcurrentPageB\a\n" +
	"\x05query\"\xa8\x02\n" +
	"\x14FulfillIntentRequest\x12h\n" +
	"\x14match_intent_request\x18\x01 \x01(\v26.google.cloud.dialogflow.cx.v3beta1.MatchIntentRequestR\x12matchIntentRequest\x12?\n" +
	"\x05match\x18\x02 \x01(\v2).google.cloud.dialogflow.cx.v3beta1.MatchR\x05match\x12e\n" +
	"\x13output_audio_config\x18\x03 \x01(\v25.google.cloud.dialogflow.cx.v3beta1.OutputAudioConfigR\x11outputAudioConfig\"\x96\x02\n" +
	"\x15FulfillIntentResponse\x12\x1f\n" +
	"\vresponse_id\x18\x01 \x01(\tR\n" +
	"responseId\x12R\n" +
	"\fquery_result\x18\x02 \x01(\v2/.google.cloud.dialogflow.cx.v3beta1.QueryResultR\vqueryResult\x12!\n" +
	"\foutput_audio\x18\x03 \x01(\fR\voutputAudio\x12e\n" +
	"\x13output_audio_config\x18\x04 \x01(\v25.google.cloud.dialogflow.cx.v3beta1.OutputAudioConfigR\x11outputAudioConfig\"M\n" +
	...
	"#DETECT_INTENT_RESPONSE_VIEW_DEFAULT\x10\x032\xe3\x0e\n" +
	"\bSessions\x12\xba\x02\n" +
	"\fDetectIntent\x127.google.cloud.dialogflow.cx.v3beta1.DetectIntentRequest\x1a8.google.cloud.dialogflow.cx.v3beta1.DetectIntentResponse\"\xb6\x01\x82\xd3\xe4\x93\x02\xaf\x01:\x01*Z^:\x01*\"Y/v3beta1/{session=projects/*/locations/*/agents/*/environments/*/sessions/*}:detectIntent\"J/v3beta1/{session=projects/*/locations/*/agents/*/sessions/*}:detectIntent\x12\xe9\x02\n" +
	"\x1bServerStreamingDetectIntent\x127.google.cloud.dialogflow.cx.v3beta1.DetectIntentRequest\x1a8.google.cloud.dialogflow.cx.v3beta1.DetectIntentResponse\"\xd4\x01\x82\xd3\xe4\x93\x02\xcd\x01:\x01*Zm:\x01*\"h/v3beta1/{session=projects/*/locations/*/agents/*/environments/*/sessions/*}:serverStreamingDetectIntent\"Y/v3beta1/{session=projects/*/locations/*/agents/*/sessions/*}:serverStreamingDetectIntent0\x01\x12\xa2\x01\n" +
	...
	"\vMatchIntent\x126.google.cloud.dialogflow.cx.v3beta1.MatchIntentRequest\x1a7.google.cloud.dialogflow.cx.v3beta1.MatchIntentResponse\"\xb4\x01\x82\xd3\xe4\x93\x02\xad\x01:\x01*Z]:\x01*\"X/v3beta1/{session=projects/*/locations/*/agents/*/environments/*/sessions/*}:matchIntent\"I/v3beta1/{session=projects/*/locations/*/agents/*/sessions/*}:matchIntent\x12\xe9\x02\n" +
	"\rFulfillIntent\x128.google.cloud.dialogflow.cx.v3beta1.FulfillIntentRequest\x1a9.google.cloud.dialogflow.cx.v3beta1.FulfillIntentResponse\"\xe2\x01\x82\xd3\xe4\x93\x02\xdb\x01:\x01*Zt:\x01*\"o/v3beta1/{match_intent_request.session=projects/*/locations/*/agents/*/environments/*/sessions/*}:fulfillIntent\"`/v3beta1/{match_intent_request.session=projects/*/locations/*/agents/*/sessions/*}:fulfillIntent\x12\xea\x01\n" +
	"\x14SubmitAnswerFeedback\x12?.google.cloud.dialogflow.cx.v3beta1.SubmitAnswerFeedbackRequest\x1a2.google.cloud.dialogflow.cx.v3beta1.AnswerFeedback\"]\x82\xd3\xe4\x93\x02W:\x01*\"R/v3beta1/{session=projects/*/locations/*/agents/*/sessions/*}:submitAnswerFeedback\x1ax\xcaA\x19dialogflow.googleapis.com\xd2AYhttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflowB\xe4\x04\xeaA\xd4\x01\n" +
	...
	"&com.google.cloud.dialogflow.cx.v3beta1B\fSessionProtoP\x01Z6cloud.google.com/go/dialogflow/cx/apiv3beta1/cxpb;cxpb\xa2\x02\x02DF\xaa\x02\"Google.Cloud.Dialogflow.Cx.V3Beta1\xea\x02&Google::Cloud::Dialogflow::CX::V3beta1b\x06proto3"

var (
	file_google_cloud_dialogflow_cx_v3beta1_session_proto_rawDescOnce sync.Once
	file_google_cloud_dialogflow_cx_v3beta1_session_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_cx_v3beta1_session_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_cx_v3beta1_session_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_cx_v3beta1_session_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3beta1_session_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3beta1_session_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_cx_v3beta1_session_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3beta1_session_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3beta1_session_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   32,
			NumExtensions: 0,
			NumServices:   1,
