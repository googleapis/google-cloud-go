...
const file_google_cloud_dialogflow_cx_v3beta1_import_strategy_proto_rawDesc = "" +
	"\n" +
	"8google/cloud/dialogflow/cx/v3beta1/import_strategy.proto\x12\"google.cloud.dialogflow.cx.v3beta1*\xc4\x01\n" +
	...
	"\x1bIMPORT_STRATEGY_THROW_ERROR\x10\x05B\xca\x01\n" +
	"&com.google.cloud.dialogflow.cx.v3beta1B\x13ImportStrategyProtoP\x01Z6cloud.google.com/go/dialogflow/cx/apiv3beta1/cxpb;cxpb\xa2\x02\x02DF\xaa\x02\"Google.Cloud.Dialogflow.Cx.V3Beta1\xea\x02&Google::Cloud::Dialogflow::CX::V3beta1b\x06proto3"

var (
	file_google_cloud_dialogflow_cx_v3beta1_import_strategy_proto_rawDescOnce sync.Once
	file_google_cloud_dialogflow_cx_v3beta1_import_strategy_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_cx_v3beta1_import_strategy_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_cx_v3beta1_import_strategy_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_cx_v3beta1_import_strategy_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3beta1_import_strategy_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3beta1_import_strategy_proto_rawDesc)))
	})
...
var file_google_cloud_dialogflow_cx_v3beta1_import_strategy_proto_goTypes = []any{
...
func file_google_cloud_dialogflow_cx_v3beta1_import_strategy_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3beta1_import_strategy_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3beta1_import_strategy_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
