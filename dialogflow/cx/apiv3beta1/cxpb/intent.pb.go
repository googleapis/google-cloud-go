...
const file_google_cloud_dialogflow_cx_v3beta1_intent_proto_rawDesc = "" +
	"\n" +
	"/google/cloud/dialogflow/cx/v3beta1/intent.proto\x12\"google.cloud.dialogflow.cx.v3beta1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a/google/cloud/dialogflow/cx/v3beta1/inline.proto\x1a#google/longrunning/operations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\"\x8f\b\n" +
	"\x06Intent\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x02R\vdisplayName\x12d\n" +
	"\x10training_phrases\x18\x03 \x03(\v29.google.cloud.dialogflow.cx.v3beta1.Intent.TrainingPhraseR\x0ftrainingPhrases\x12T\n" +
	"\n" +
	"parameters\x18\x04 \x03(\v24.google.cloud.dialogflow.cx.v3beta1.Intent.ParameterR\n" +
	"parameters\x12\x1a\n" +
	"\bpriority\x18\x05 \x01(\x05R\bpriority\x12\x1f\n" +
	"\vis_fallback\x18\x06 \x01(\bR\n" +
	"isFallback\x12N\n" +
	"\x06labels\x18\a \x03(\v26.google.cloud.dialogflow.cx.v3beta1.Intent.LabelsEntryR\x06labels\x12 \n" +
	"\vdescription\x18\b \x01(\tR\vdescription\x12&\n" +
	"\fdtmf_pattern\x18\x10 \x01(\tB\x03\xe0A\x01R\vdtmfPattern\x1a\xe7\x01\n" +
	"\x0eTrainingPhrase\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x03R\x02id\x12Y\n" +
	"\x05parts\x18\x02 \x03(\v2>.google.cloud.dialogflow.cx.v3beta1.Intent.TrainingPhrase.PartB\x03\xe0A\x02R\x05parts\x12!\n" +
	...
	" dialogflow.googleapis.com/Intent\x12Gprojects/{project}/locations/{location}/agents/{agent}/intents/{intent}\"\x88\x02\n" +
	...
	"\vintent_view\x18\x05 \x01(\x0e2..google.cloud.dialogflow.cx.v3beta1.IntentViewR\n" +
	"intentView\x12\x1b\n" +
	"\tpage_size\x18\x03 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x04 \x01(\tR\tpageToken\"\x83\x01\n" +
	"\x13ListIntentsResponse\x12D\n" +
	"\aintents\x18\x01 \x03(\v2*.google.cloud.dialogflow.cx.v3beta1.IntentR\aintents\x12&\n" +
	...
	"\rlanguage_code\x18\x02 \x01(\tR\flanguageCode\"\xc5\x01\n" +
	"\x13CreateIntentRequest\x12@\n" +
	"\x06parent\x18\x01 \x01(\tB(\xe0A\x02\xfaA\"\x12 dialogflow.googleapis.com/IntentR\x06parent\x12G\n" +
	"\x06intent\x18\x02 \x01(\v2*.google.cloud.dialogflow.cx.v3beta1.IntentB\x03\xe0A\x02R\x06intent\x12#\n" +
	"\rlanguage_code\x18\x03 \x01(\tR\flanguageCode\"\xc0\x01\n" +
	"\x13UpdateIntentRequest\x12G\n" +
	"\x06intent\x18\x01 \x01(\v2*.google.cloud.dialogflow.cx.v3beta1.IntentB\x03\xe0A\x02R\x06intent\x12#\n" +
	"\rlanguage_code\x18\x02 \x01(\tR\flanguageCode\x12;\n" +
	"\vupdate_mask\x18\x03 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"S\n" +
	"\x13DeleteIntentRequest\x12<\n" +
	"\x04name\x18\x01 \x01(\tB(\xe0A\x02\xfaA\"\n" +
	" dialogflow.googleapis.com/IntentR\x04name\"\xcc\x03\n" +
	"\x14ImportIntentsRequest\x12@\n" +
	"\x06parent\x18\x01 \x01(\tB(\xe0A\x02\xfaA\"\x12 dialogflow.googleapis.com/IntentR\x06parent\x12!\n" +
	"\vintents_uri\x18\x02 \x01(\tH\x00R\n" +
	"intentsUri\x12[\n" +
	"\x0fintents_content\x18\x03 \x01(\v20.google.cloud.dialogflow.cx.v3beta1.InlineSourceH\x00R\x0eintentsContent\x12g\n" +
	"\fmerge_option\x18\x04 \x01(\x0e2D.google.cloud.dialogflow.cx.v3beta1.ImportIntentsRequest.MergeOptionR\vmergeOption\"~\n" +
	...
	" dialogflow.googleapis.com/IntentR\aintents\x12\x83\x01\n" +
	"\x15conflicting_resources\x18\x02 \x01(\v2N.google.cloud.dialogflow.cx.v3beta1.ImportIntentsResponse.ConflictingResourcesR\x14conflictingResources\x1az\n" +
	...
	"\x15ImportIntentsMetadata\"\x9e\x03\n" +
	...
	"intentsUri\x12;\n" +
	"\x16intents_content_inline\x18\x04 \x01(\bB\x03\xe0A\x01H\x00R\x14intentsContentInline\x12i\n" +
	"\vdata_format\x18\x05 \x01(\x0e2C.google.cloud.dialogflow.cx.v3beta1.ExportIntentsRequest.DataFormatB\x03\xe0A\x01R\n" +
	"dataFormat\"F\n" +
	"\n" +
	"DataFormat\x12\x1b\n" +
	...
	"intentsUri\x12`\n" +
	"\x0fintents_content\x18\x02 \x01(\v25.google.cloud.dialogflow.cx.v3beta1.InlineDestinationH\x00R\x0eintentsContentB\t\n" +
	"\aintents\"\x17\n" +
	...
	"\x10INTENT_VIEW_FULL\x10\x022\xb6\f\n" +
	"\aIntents\x12\xca\x01\n" +
	"\vListIntents\x126.google.cloud.dialogflow.cx.v3beta1.ListIntentsRequest\x1a7.google.cloud.dialogflow.cx.v3beta1.ListIntentsResponse\"J\xdaA\x06parent\x82\xd3\xe4\x93\x02;\x129/v3beta1/{parent=projects/*/locations/*/agents/*}/intents\x12\xb7\x01\n" +
	...
	"\fCreateIntent\x127.google.cloud.dialogflow.cx.v3beta1.CreateIntentRequest\x1a*.google.cloud.dialogflow.cx.v3beta1.Intent\"Y\xdaA\rparent,intent\x82\xd3\xe4\x93\x02C:\x06intent\"9/v3beta1/{parent=projects/*/locations/*/agents/*}/intents\x12\xda\x01\n" +
	"\fUpdateIntent\x127.google.cloud.dialogflow.cx.v3beta1.UpdateIntentRequest\x1a*.google.cloud.dialogflow.cx.v3beta1.Intent\"e\xdaA\x12intent,update_mask\x82\xd3\xe4\x93\x02J:\x06intent2@/v3beta1/{intent.name=projects/*/locations/*/agents/*/intents/*}\x12\xa9\x01\n" +
	"\fDeleteIntent\x127.google.cloud.dialogflow.cx.v3beta1.DeleteIntentRequest\x1a\x16.google.protobuf.Empty\"H\xdaA\x04name\x82\xd3\xe4\x93\x02;*9/v3beta1/{name=projects/*/locations/*/agents/*/intents/*}\x12\xe6\x01\n" +
	"\rImportIntents\x128.google.cloud.dialogflow.cx.v3beta1.ImportIntentsRequest\x1a\x1d.google.longrunning.Operation\"|\xcaA.\n" +
	"\x15ImportIntentsResponse\x12\x15ImportIntentsMetadata\x82\xd3\xe4\x93\x02E:\x01*\"@/v3beta1/{parent=projects/*/locations/*/agents/*}/intents:import\x12\xe6\x01\n" +
	"\rExportIntents\x128.google.cloud.dialogflow.cx.v3beta1.ExportIntentsRequest\x1a\x1d.google.longrunning.Operation\"|\xcaA.\n" +
	"\x15ExportIntentsResponse\x12\x15ExportIntentsMetadata\x82\xd3\xe4\x93\x02E:\x01*\"@/v3beta1/{parent=projects/*/locations/*/agents/*}/intents:export\x1ax\xcaA\x19dialogflow.googleapis.com\xd2AYhttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflowB\xc2\x01\n" +
	"&com.google.cloud.dialogflow.cx.v3beta1B\vIntentProtoP\x01Z6cloud.google.com/go/dialogflow/cx/apiv3beta1/cxpb;cxpb\xa2\x02\x02DF\xaa\x02\"Google.Cloud.Dialogflow.Cx.V3Beta1\xea\x02&Google::Cloud::Dialogflow::CX::V3beta1b\x06proto3"

var (
	file_google_cloud_dialogflow_cx_v3beta1_intent_proto_rawDescOnce sync.Once
	file_google_cloud_dialogflow_cx_v3beta1_intent_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_cx_v3beta1_intent_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_cx_v3beta1_intent_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_cx_v3beta1_intent_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3beta1_intent_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3beta1_intent_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_cx_v3beta1_intent_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3beta1_intent_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3beta1_intent_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   18,
			NumExtensions: 0,
			NumServices:   1,
