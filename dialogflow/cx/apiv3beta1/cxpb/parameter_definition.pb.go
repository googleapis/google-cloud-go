...
const file_google_cloud_dialogflow_cx_v3beta1_parameter_definition_proto_rawDesc = "" +
	"\n" +
	"=google/cloud/dialogflow/cx/v3beta1/parameter_definition.proto\x12\"google.cloud.dialogflow.cx.v3beta1\x1a\x1fgoogle/api/field_behavior.proto\"\xfb\x02\n" +
	"\x13ParameterDefinition\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x12]\n" +
	"\x04type\x18\x02 \x01(\x0e2E.google.cloud.dialogflow.cx.v3beta1.ParameterDefinition.ParameterTypeB\x02\x18\x01R\x04type\x12T\n" +
	"\vtype_schema\x18\x04 \x01(\v2..google.cloud.dialogflow.cx.v3beta1.TypeSchemaB\x03\xe0A\x01R\n" +
	"typeSchema\x12 \n" +
	...
	"\x04LIST\x10\x06\"\x9b\x02\n" +
	"\n" +
	"TypeSchema\x12W\n" +
	"\rinline_schema\x18\x01 \x01(\v20.google.cloud.dialogflow.cx.v3beta1.InlineSchemaH\x00R\finlineSchema\x12k\n" +
	"\x10schema_reference\x18\x02 \x01(\v2>.google.cloud.dialogflow.cx.v3beta1.TypeSchema.SchemaReferenceH\x00R\x0fschemaReference\x1a=\n" +
	"\x0fSchemaReference\x12\x12\n" +
	"\x04tool\x18\x01 \x01(\tR\x04tool\x12\x16\n" +
	"\x06schema\x18\x02 \x01(\tR\x06schemaB\b\n" +
	"\x06schema\"\x96\x01\n" +
	"\fInlineSchema\x12@\n" +
	"\x04type\x18\x01 \x01(\x0e2,.google.cloud.dialogflow.cx.v3beta1.DataTypeR\x04type\x12D\n" +
	"\x05items\x18\x02 \x01(\v2..google.cloud.dialogflow.cx.v3beta1.TypeSchemaR\x05items*U\n" +
	"\bDataType\x12\x19\n" +
	...
	"\x05ARRAY\x10\x06B|\n" +
	"&com.google.cloud.dialogflow.cx.v3beta1B\x18ParameterDefinitionProtoP\x01Z6cloud.google.com/go/dialogflow/cx/apiv3beta1/cxpb;cxpbb\x06proto3"

var (
	file_google_cloud_dialogflow_cx_v3beta1_parameter_definition_proto_rawDescOnce sync.Once
	file_google_cloud_dialogflow_cx_v3beta1_parameter_definition_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_cx_v3beta1_parameter_definition_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_cx_v3beta1_parameter_definition_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_cx_v3beta1_parameter_definition_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3beta1_parameter_definition_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3beta1_parameter_definition_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_cx_v3beta1_parameter_definition_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3beta1_parameter_definition_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3beta1_parameter_definition_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
