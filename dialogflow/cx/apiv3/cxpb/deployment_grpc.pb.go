...
const (
	Deployments_ListDeployments_FullMethodName = "/google.cloud.dialogflow.cx.v3.Deployments/ListDeployments"
	Deployments_GetDeployment_FullMethodName   = "/google.cloud.dialogflow.cx.v3.Deployments/GetDeployment"
)
