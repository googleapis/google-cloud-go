...
const (
	Changelogs_ListChangelogs_FullMethodName = "/google.cloud.dialogflow.cx.v3.Changelogs/ListChangelogs"
	Changelogs_GetChangelog_FullMethodName   = "/google.cloud.dialogflow.cx.v3.Changelogs/GetChangelog"
)
