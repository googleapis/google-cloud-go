...
const (
	...
	// MP3 audio at 64kbps.
	//
	// Deprecated: Marked as deprecated in google/cloud/dialogflow/cx/v3/audio_config.proto.
...
const file_google_cloud_dialogflow_cx_v3_audio_config_proto_rawDesc = "" +
	"\n" +
	"0google/cloud/dialogflow/cx/v3/audio_config.proto\x12\x1dgoogle.cloud.dialogflow.cx.v3\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1egoogle/protobuf/duration.proto\"\xbc\x01\n" +
	...
	"\x0etotal_duration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\rtotalDuration\"\x9e\x04\n" +
	"\x10InputAudioConfig\x12X\n" +
	"\x0eaudio_encoding\x18\x01 \x01(\x0e2,.google.cloud.dialogflow.cx.v3.AudioEncodingB\x03\xe0A\x02R\raudioEncoding\x12*\n" +
	...
	"\x05model\x18\a \x01(\tR\x05model\x12V\n" +
	"\rmodel_variant\x18\n" +
	" \x01(\x0e21.google.cloud.dialogflow.cx.v3.SpeechModelVariantR\fmodelVariant\x12)\n" +
	"\x10single_utterance\x18\b \x01(\bR\x0fsingleUtterance\x12T\n" +
	"\x0fbarge_in_config\x18\x0f \x01(\v2,.google.cloud.dialogflow.cx.v3.BargeInConfigR\rbargeInConfig\x12H\n" +
	"!opt_out_conformer_model_migration\x18\x1a \x01(\bR\x1doptOutConformerModelMigration\"{\n" +
	"\x14VoiceSelectionParams\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12O\n" +
	"\vssml_gender\x18\x02 \x01(\x0e2..google.cloud.dialogflow.cx.v3.SsmlVoiceGenderR\n" +
	"ssmlGender\"\xf2\x01\n" +
	...
	"\x12effects_profile_id\x18\x05 \x03(\tR\x10effectsProfileId\x12I\n" +
	"\x05voice\x18\x04 \x01(\v23.google.cloud.dialogflow.cx.v3.VoiceSelectionParamsR\x05voice\"\x90\x02\n" +
	"\x11OutputAudioConfig\x12^\n" +
	"\x0eaudio_encoding\x18\x01 \x01(\x0e22.google.cloud.dialogflow.cx.v3.OutputAudioEncodingB\x03\xe0A\x02R\raudioEncoding\x12*\n" +
	"\x11sample_rate_hertz\x18\x02 \x01(\x05R\x0fsampleRateHertz\x12o\n" +
	"\x18synthesize_speech_config\x18\x03 \x01(\v25.google.cloud.dialogflow.cx.v3.SynthesizeSpeechConfigR\x16synthesizeSpeechConfig\"\xa9\x02\n" +
	"\x14TextToSpeechSettings\x12\x8c\x01\n" +
	"\x19synthesize_speech_configs\x18\x01 \x03(\v2P.google.cloud.dialogflow.cx.v3.TextToSpeechSettings.SynthesizeSpeechConfigsEntryR\x17synthesizeSpeechConfigs\x1a\x81\x01\n" +
	"\x1cSynthesizeSpeechConfigsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12K\n" +
	"\x05value\x18\x02 \x01(\v25.google.cloud.dialogflow.cx.v3.SynthesizeSpeechConfigR\x05value:\x028\x01*\x94\x02\n" +
	...
	"\x1aOUTPUT_AUDIO_ENCODING_ALAW\x10\x06B\x8b\x02\xeaAU\n" +
	"\x1bautoml.googleapis.com/Model\x126projects/{project}/locations/{location}/models/{model}\n" +
	"!com.google.cloud.dialogflow.cx.v3B\x10AudioConfigProtoP\x01Z1cloud.google.com/go/dialogflow/cx/apiv3/cxpb;cxpb\xa2\x02\x02DF\xaa\x02\x1dGoogle.Cloud.Dialogflow.Cx.V3\xea\x02!Google::Cloud::Dialogflow::CX::V3b\x06proto3"

var (
	file_google_cloud_dialogflow_cx_v3_audio_config_proto_rawDescOnce sync.Once
	file_google_cloud_dialogflow_cx_v3_audio_config_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_cx_v3_audio_config_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_cx_v3_audio_config_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_cx_v3_audio_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3_audio_config_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3_audio_config_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_cx_v3_audio_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3_audio_config_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3_audio_config_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
