...
const file_google_cloud_dialogflow_cx_v3_changelog_proto_rawDesc = "" +
	"\n" +
	"-google/cloud/dialogflow/cx/v3/changelog.proto\x12\x1dgoogle.cloud.dialogflow.cx.v3\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb0\x01\n" +
	...
	"\n" +
	"changelogs\x18\x01 \x03(\v2(.google.cloud.dialogflow.cx.v3.ChangelogR\n" +
	"changelogs\x12&\n" +
...
var (
	...
	file_google_cloud_dialogflow_cx_v3_changelog_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_cx_v3_changelog_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_cx_v3_changelog_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_cx_v3_changelog_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3_changelog_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3_changelog_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_cx_v3_changelog_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3_changelog_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3_changelog_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
