...
var file_google_cloud_dialogflow_cx_v3_fulfillment_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0xb3, 0x01, 0x0a, 0x21, 0x63,
...
func file_google_cloud_dialogflow_cx_v3_fulfillment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_dialogflow_cx_v3_fulfillment_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_dialogflow_cx_v3_fulfillment_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_dialogflow_cx_v3_fulfillment_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_dialogflow_cx_v3_fulfillment_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_cloud_dialogflow_cx_v3_fulfillment_proto_msgTypes[4].Exporter = func(v any, i int) any {
	...
	file_google_cloud_dialogflow_cx_v3_fulfillment_proto_msgTypes[4].OneofWrappers = []any{
