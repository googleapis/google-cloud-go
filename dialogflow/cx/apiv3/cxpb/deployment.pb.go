...
const file_google_cloud_dialogflow_cx_v3_deployment_proto_rawDesc = "" +
	"\n" +
	".google/cloud/dialogflow/cx/v3/deployment.proto\x12\x1dgoogle.cloud.dialogflow.cx.v3\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8c\x06\n" +
	"\n" +
	"Deployment\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12I\n" +
	"\fflow_version\x18\x02 \x01(\tB&\xfaA#\n" +
	"!dialogflow.googleapis.com/VersionR\vflowVersion\x12E\n" +
	"\x05state\x18\x03 \x01(\x0e2/.google.cloud.dialogflow.cx.v3.Deployment.StateR\x05state\x12H\n" +
	"\x06result\x18\x04 \x01(\v20.google.cloud.dialogflow.cx.v3.Deployment.ResultR\x06result\x129\n" +
	"\n" +
	...
	"\vdeployments\x18\x01 \x03(\v2).google.cloud.dialogflow.cx.v3.DeploymentR\vdeployments\x12&\n" +
...
var (
	...
	file_google_cloud_dialogflow_cx_v3_deployment_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_cx_v3_deployment_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_cx_v3_deployment_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_cx_v3_deployment_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3_deployment_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3_deployment_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_cx_v3_deployment_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_cx_v3_deployment_proto_rawDesc), len(file_google_cloud_dialogflow_cx_v3_deployment_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
