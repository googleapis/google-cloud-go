...
type internalAnswerRecordsClient interface {
	...
	GetAnswerRecord(context.Context, *dialogflowpb.GetAnswerRecordRequest, ...gax.CallOption) (*dialogflowpb.AnswerRecord, error)
...
// GetAnswerRecord deprecated.
// Retrieves a specific answer record.
//
// Deprecated: GetAnswerRecord may be removed in a future version.
func (c *AnswerRecordsClient) GetAnswerRecord(ctx context.Context, req *dialogflowpb.GetAnswerRecordRequest, opts ...gax.CallOption) (*dialogflowpb.AnswerRecord, error) {
	return c.internalClient.GetAnswerRecord(ctx, req, opts...)
}
...
func NewAnswerRecordsClient(ctx context.Context, opts ...option.ClientOption) (*AnswerRecordsClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.GetAnswerRecord = append(client.CallOptions.GetAnswerRecord, gax.WithClientMetrics(metrics))
		client.CallOptions.ListAnswerRecords = append(client.CallOptions.ListAnswerRecords, gax.WithClientMetrics(metrics))
		client.CallOptions.UpdateAnswerRecord = append(client.CallOptions.UpdateAnswerRecord, gax.WithClientMetrics(metrics))
...
func NewAnswerRecordsRESTClient(ctx context.Context, opts ...option.ClientOption) (*AnswerRecordsClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.GetAnswerRecord = append(callOpts.GetAnswerRecord, gax.WithClientMetrics(metrics))
		callOpts.ListAnswerRecords = append(callOpts.ListAnswerRecords, gax.WithClientMetrics(metrics))
		callOpts.UpdateAnswerRecord = append(callOpts.UpdateAnswerRecord, gax.WithClientMetrics(metrics))
...
func (c *answerRecordsGRPCClient) GetAnswerRecord(ctx context.Context, req *dialogflowpb.GetAnswerRecordRequest, opts ...gax.CallOption) (*dialogflowpb.AnswerRecord, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2beta1.AnswerRecords/GetAnswerRecord")
	}
	opts = append((*c.CallOptions).GetAnswerRecord[0:len((*c.CallOptions).GetAnswerRecord):len((*c.CallOptions).GetAnswerRecord)], opts...)
	var resp *dialogflowpb.AnswerRecord
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.answerRecordsClient.GetAnswerRecord, req, settings.GRPC, c.logger, "GetAnswerRecord")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *answerRecordsGRPCClient) ListAnswerRecords(ctx context.Context, req *dialogflowpb.ListAnswerRecordsRequest, opts ...gax.CallOption) *AnswerRecordIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2beta1.AnswerRecords/ListAnswerRecords")
	}
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*dialogflowpb.AnswerRecord, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.answerRecordsClient.ListAnswerRecords, req, settings.GRPC, c.logger, "ListAnswerRecords")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *answerRecordsGRPCClient) UpdateAnswerRecord(ctx context.Context, req *dialogflowpb.UpdateAnswerRecordRequest, opts ...gax.CallOption) (*dialogflowpb.AnswerRecord, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2beta1.AnswerRecords/UpdateAnswerRecord")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.answerRecordsClient.UpdateAnswerRecord, req, settings.GRPC, c.logger, "UpdateAnswerRecord")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
//
// Deprecated: GetAnswerRecord may be removed in a future version.
func (c *answerRecordsRESTClient) GetAnswerRecord(ctx context.Context, req *dialogflowpb.GetAnswerRecordRequest, opts ...gax.CallOption) (*dialogflowpb.AnswerRecord, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2beta1.AnswerRecords/GetAnswerRecord")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2beta1/{name=projects/*/answerRecords/*}")
	}
	opts = append((*c.CallOptions).GetAnswerRecord[0:len((*c.CallOptions).GetAnswerRecord):len((*c.CallOptions).GetAnswerRecord)], opts...)
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "GetAnswerRecord")
		if err != nil {
			return err
		}
...
func (c *answerRecordsRESTClient) ListAnswerRecords(ctx context.Context, req *dialogflowpb.ListAnswerRecordsRequest, opts ...gax.CallOption) *AnswerRecordIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*dialogflowpb.AnswerRecord, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v2beta1/%v/answerRecords", req.GetParent())
		...
		e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			...
			buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "ListAnswerRecords")
			if err != nil {
				return err
			}
			if err := unm.Unmarshal(buf, resp); err != nil {
...
func (c *answerRecordsRESTClient) UpdateAnswerRecord(ctx context.Context, req *dialogflowpb.UpdateAnswerRecordRequest, opts ...gax.CallOption) (*dialogflowpb.AnswerRecord, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v2beta1/%v", req.GetAnswerRecord().GetName())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2beta1.AnswerRecords/UpdateAnswerRecord")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2beta1/{answer_record.name=projects/*/answerRecords/*}")
	}
	opts = append((*c.CallOptions).UpdateAnswerRecord[0:len((*c.CallOptions).UpdateAnswerRecord):len((*c.CallOptions).UpdateAnswerRecord)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &dialogflowpb.AnswerRecord{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "UpdateAnswerRecord")
		if err != nil {
			return err
		}
