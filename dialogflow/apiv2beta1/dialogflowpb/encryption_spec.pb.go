...
const file_google_cloud_dialogflow_v2beta1_encryption_spec_proto_rawDesc = "" +
	"\n" +
	"5google/cloud/dialogflow/v2beta1/encryption_spec.proto\x12\x1fgoogle.cloud.dialogflow.v2beta1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a#google/longrunning/operations.proto\"`\n" +
	...
	"(dialogflow.googleapis.com/EncryptionSpec\x126projects/{project}/locations/{location}/encryptionSpec*\x0fencryptionSpecs2\x0eencryptionSpec\"\x80\x01\n" +
	"\x1fInitializeEncryptionSpecRequest\x12]\n" +
	"\x0fencryption_spec\x18\x01 \x01(\v2/.google.cloud.dialogflow.v2beta1.EncryptionSpecB\x03\xe0A\x02R\x0eencryptionSpec\"\"\n" +
	" InitializeEncryptionSpecResponse\"\x83\x01\n" +
	" InitializeEncryptionSpecMetadata\x12_\n" +
	"\arequest\x18\x04 \x01(\v2@.google.cloud.dialogflow.v2beta1.InitializeEncryptionSpecRequestB\x03\xe0A\x03R\arequest2\x8e\x05\n" +
	...
	" InitializeEncryptionSpecResponse\x12 InitializeEncryptionSpecMetadata\xdaA\x0fencryption_spec\x82\xd3\xe4\x93\x02U:\x01*\"P/v2beta1/{encryption_spec.name=projects/*/locations/*/encryptionSpec}:initialize\x1ax\xcaA\x19dialogflow.googleapis.com\xd2AYhttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflowB\xa8\x01\n" +
...
var (
	...
	file_google_cloud_dialogflow_v2beta1_encryption_spec_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_v2beta1_encryption_spec_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_v2beta1_encryption_spec_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_v2beta1_encryption_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2beta1_encryption_spec_proto_rawDesc), len(file_google_cloud_dialogflow_v2beta1_encryption_spec_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_v2beta1_encryption_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2beta1_encryption_spec_proto_rawDesc), len(file_google_cloud_dialogflow_v2beta1_encryption_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
