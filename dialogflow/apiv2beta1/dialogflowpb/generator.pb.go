...
const file_google_cloud_dialogflow_v2beta1_generator_proto_rawDesc = "" +
	"\n" +
	"/google/cloud/dialogflow/v2beta1/generator.proto\x12\x1fgoogle.cloud.dialogflow.v2beta1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a@google/cloud/dialogflow/v2beta1/agent_coaching_instruction.proto\x1a-google/cloud/dialogflow/v2beta1/ces_app.proto\x1a.google/cloud/dialogflow/v2beta1/ces_tool.proto\x1a/google/cloud/dialogflow/v2beta1/tool_call.proto\x1a-google/cloud/dialogflow/v2beta1/toolset.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xdc\x01\n" +
	"\x16CreateGeneratorRequest\x12K\n" +
	"\x06parent\x18\x01 \x01(\tB3\xe0A\x02\xfaA-\n" +
	"+cloudresourcemanager.googleapis.com/ProjectR\x06parent\x12M\n" +
	"\tgenerator\x18\x02 \x01(\v2*.google.cloud.dialogflow.v2beta1.GeneratorB\x03\xe0A\x02R\tgenerator\x12&\n" +
	...
	"\x16ListGeneratorsResponse\x12J\n" +
	"\n" +
	"generators\x18\x01 \x03(\v2*.google.cloud.dialogflow.v2beta1.GeneratorR\n" +
	"generators\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"Y\n" +
	"\x16DeleteGeneratorRequest\x12?\n" +
	"\x04name\x18\x01 \x01(\tB+\xe0A\x02\xfaA%\n" +
	"#dialogflow.googleapis.com/GeneratorR\x04name\"\xa9\x01\n" +
	"\x16UpdateGeneratorRequest\x12M\n" +
	"\tgenerator\x18\x01 \x01(\v2*.google.cloud.dialogflow.v2beta1.GeneratorB\x03\xe0A\x02R\tgenerator\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x01R\n" +
	"updateMask\"\xb2\x02\n" +
	"\fMessageEntry\x12K\n" +
	"\x04role\x18\x01 \x01(\x0e22.google.cloud.dialogflow.v2beta1.MessageEntry.RoleB\x03\xe0A\x01R\x04role\x12\x17\n" +
	...
	"\x0fmessage_entries\x18\x01 \x03(\v2-.google.cloud.dialogflow.v2beta1.MessageEntryB\x03\xe0A\x01R\x0emessageEntries\"\x8d\x01\n" +
	"\x18SummarizationSectionList\x12q\n" +
	"\x16summarization_sections\x18\x01 \x03(\v25.google.cloud.dialogflow.v2beta1.SummarizationSectionB\x03\xe0A\x01R\x15summarizationSections\"\x82\x04\n" +
	"\x0eFewShotExample\x12l\n" +
	"\x14conversation_context\x18\x03 \x01(\v24.google.cloud.dialogflow.v2beta1.ConversationContextB\x03\xe0A\x01R\x13conversationContext\x12b\n" +
	"\n" +
	"extra_info\x18\x04 \x03(\v2>.google.cloud.dialogflow.v2beta1.FewShotExample.ExtraInfoEntryB\x03\xe0A\x01R\textraInfo\x12y\n" +
	"\x1asummarization_section_list\x18\x06 \x01(\v29.google.cloud.dialogflow.v2beta1.SummarizationSectionListH\x00R\x18summarizationSectionList\x12Q\n" +
	"\x06output\x18\a \x01(\v24.google.cloud.dialogflow.v2beta1.GeneratorSuggestionB\x03\xe0A\x02R\x06output\x1a<\n" +
	...
	"\x14overarching_guidance\x18\a \x01(\tB\x03\xe0A\x01R\x13overarchingGuidance\x12b\n" +
	"\finstructions\x18\x01 \x03(\v29.google.cloud.dialogflow.v2beta1.AgentCoachingInstructionB\x03\xe0A\x01R\finstructions\x12\x1d\n" +
	"\aversion\x18\x02 \x01(\tB\x03\xe0A\x01R\aversion\x125\n" +
	"\x14output_language_code\x18\t \x01(\tB\x03\xe0A\x01R\x12outputLanguageCode\"\xf8\x02\n" +
	"\x14SummarizationSection\x12\x15\n" +
	"\x03key\x18\x01 \x01(\tB\x03\xe0A\x01R\x03key\x12#\n" +
	"\n" +
	"definition\x18\x02 \x01(\tB\x03\xe0A\x01R\n" +
	"definition\x12S\n" +
	"\x04type\x18\x03 \x01(\x0e2:.google.cloud.dialogflow.v2beta1.SummarizationSection.TypeB\x03\xe0A\x01R\x04type\"\xce\x01\n" +
	"\x04Type\x12\x14\n" +
	...
	"\"\xc1\x02\n" +
	"\x14SummarizationContext\x12q\n" +
	"\x16summarization_sections\x18\x01 \x03(\v25.google.cloud.dialogflow.v2beta1.SummarizationSectionB\x03\xe0A\x01R\x15summarizationSections\x12`\n" +
	"\x11few_shot_examples\x18\x02 \x03(\v2/.google.cloud.dialogflow.v2beta1.FewShotExampleB\x03\xe0A\x01R\x0ffewShotExamples\x12\x1d\n" +
	...
	"\x04text\x18\x01 \x01(\tB\x03\xe0A\x01R\x04text\"\xe6\n" +
	"\n" +
	"\tGenerator\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xe0A\b\xe0A\x03R\x04name\x12%\n" +
	"\vdescription\x18\x02 \x01(\tB\x03\xe0A\x01R\vdescription\x12^\n" +
	"\x11free_form_context\x18\v \x01(\v20.google.cloud.dialogflow.v2beta1.FreeFormContextH\x00R\x0ffreeFormContext\x12m\n" +
	"\x16agent_coaching_context\x18\f \x01(\v25.google.cloud.dialogflow.v2beta1.AgentCoachingContextH\x00R\x14agentCoachingContext\x12l\n" +
	"\x15summarization_context\x18\r \x01(\v25.google.cloud.dialogflow.v2beta1.SummarizationContextH\x00R\x14summarizationContext\x12i\n" +
	"\x13inference_parameter\x18\x04 \x01(\v23.google.cloud.dialogflow.v2beta1.InferenceParameterB\x03\xe0A\x01R\x12inferenceParameter\x12W\n" +
	"\rtrigger_event\x18\x05 \x01(\x0e2-.google.cloud.dialogflow.v2beta1.TriggerEventB\x03\xe0A\x01R\ftriggerEvent\x12.\n" +
	...
	"\x1asuggestion_deduping_config\x18\x17 \x01(\v29.google.cloud.dialogflow.v2beta1.SuggestionDedupingConfigB\x03\xe0A\x01R\x18suggestionDedupingConfig\x12V\n" +
	"\rtoolset_tools\x18\x1b \x03(\v2,.google.cloud.dialogflow.v2beta1.ToolsetToolB\x03\xe0A\x01R\ftoolsetTools\x12W\n" +
	"\x0eces_tool_specs\x18\x1c \x03(\v2,.google.cloud.dialogflow.v2beta1.CesToolSpecB\x03\xe0A\x01R\fcesToolSpecs\x12T\n" +
	"\rces_app_specs\x18\x1d \x03(\v2+.google.cloud.dialogflow.v2beta1.CesAppSpecB\x03\xe0A\x01R\vcesAppSpecs:\x7f\xeaA|\n" +
	...
	"\bresponse\x18\x01 \x01(\tB\x03\xe0A\x02R\bresponse\"\xd6\x01\n" +
	"\x11SummarySuggestion\x12q\n" +
	"\x10summary_sections\x18\x01 \x03(\v2A.google.cloud.dialogflow.v2beta1.SummarySuggestion.SummarySectionB\x03\xe0A\x02R\x0fsummarySections\x1aN\n" +
	"\x0eSummarySection\x12\x1d\n" +
	"\asection\x18\x01 \x01(\tB\x03\xe0A\x02R\asection\x12\x1d\n" +
	"\asummary\x18\x02 \x01(\tB\x03\xe0A\x02R\asummary\"\xed\v\n" +
	"\x17AgentCoachingSuggestion\x12w\n" +
	"\x17applicable_instructions\x18\x01 \x03(\v29.google.cloud.dialogflow.v2beta1.AgentCoachingInstructionB\x03\xe0A\x01R\x16applicableInstructions\x12\x8d\x01\n" +
	"\x18agent_action_suggestions\x18\x02 \x03(\v2N.google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.AgentActionSuggestionB\x03\xe0A\x01R\x16agentActionSuggestions\x12w\n" +
	"\x10sample_responses\x18\x03 \x03(\v2G.google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.SampleResponseB\x03\xe0A\x01R\x0fsampleResponses\x1a?\n" +
	"\aSources\x124\n" +
	"\x13instruction_indexes\x18\x02 \x03(\x05B\x03\xe0A\x03R\x12instructionIndexes\x1a\xb7\x03\n" +
	"\x14DuplicateCheckResult\x12\x9b\x01\n" +
	"\x15duplicate_suggestions\x18\x01 \x03(\v2a.google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.DuplicateCheckResult.DuplicateSuggestionB\x03\xe0A\x03R\x14duplicateSuggestions\x1a\x80\x02\n" +
	"\x13DuplicateSuggestion\x12(\n" +
	"\ranswer_record\x18\x01 \x01(\tB\x03\xe0A\x03R\fanswerRecord\x12_\n" +
	"\asources\x18\x02 \x01(\v2@.google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.SourcesB\x03\xe0A\x03R\asources\x12.\n" +
	"\x10suggestion_index\x18\x03 \x01(\x05B\x03\xe0A\x03R\x0fsuggestionIndex\x12.\n" +
	"\x10similarity_score\x18\x04 \x01(\x02B\x03\xe0A\x03R\x0fsimilarityScore\x1a\xab\x02\n" +
	"\x15AgentActionSuggestion\x12&\n" +
	"\fagent_action\x18\x01 \x01(\tB\x03\xe0A\x01R\vagentAction\x12_\n" +
	"\asources\x18\x02 \x01(\v2@.google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.SourcesB\x03\xe0A\x03R\asources\x12\x88\x01\n" +
	"\x16duplicate_check_result\x18\x03 \x01(\v2M.google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.DuplicateCheckResultB\x03\xe0A\x03R\x14duplicateCheckResult\x1a\xa6\x02\n" +
	"\x0eSampleResponse\x12(\n" +
	"\rresponse_text\x18\x01 \x01(\tB\x03\xe0A\x01R\fresponseText\x12_\n" +
	"\asources\x18\x02 \x01(\v2@.google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.SourcesB\x03\xe0A\x03R\asources\x12\x88\x01\n" +
	"\x16duplicate_check_result\x18\x03 \x01(\v2M.google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.DuplicateCheckResultB\x03\xe0A\x03R\x14duplicateCheckResult\"\xa4\x05\n" +
	"\x13GeneratorSuggestion\x12l\n" +
	"\x14free_form_suggestion\x18\x01 \x01(\v23.google.cloud.dialogflow.v2beta1.FreeFormSuggestionB\x03\xe0A\x01H\x00R\x12freeFormSuggestion\x12h\n" +
	"\x12summary_suggestion\x18\x02 \x01(\v22.google.cloud.dialogflow.v2beta1.SummarySuggestionB\x03\xe0A\x01H\x00R\x11summarySuggestion\x12{\n" +
	"\x19agent_coaching_suggestion\x18\x03 \x01(\v28.google.cloud.dialogflow.v2beta1.AgentCoachingSuggestionB\x03\xe0A\x01H\x00R\x17agentCoachingSuggestion\x12l\n" +
	"\x0etool_call_info\x18\t \x03(\v2A.google.cloud.dialogflow.v2beta1.GeneratorSuggestion.ToolCallInfoB\x03\xe0A\x01R\ftoolCallInfo\x1a\xbb\x01\n" +
	"\fToolCallInfo\x12K\n" +
	"\ttool_call\x18\x01 \x01(\v2).google.cloud.dialogflow.v2beta1.ToolCallB\x03\xe0A\x02R\btoolCall\x12^\n" +
	"\x10tool_call_result\x18\x02 \x01(\v2/.google.cloud.dialogflow.v2beta1.ToolCallResultB\x03\xe0A\x02R\x0etoolCallResultB\f\n" +
	"\n" +
	"suggestion\"\x80\x01\n" +
	"\x18SuggestionDedupingConfig\x12,\n" +
	"\x0fenable_deduping\x18\x01 \x01(\bB\x03\xe0A\x01R\x0eenableDeduping\x126\n" +
	"\x14similarity_threshold\x18\x02 \x01(\x02B\x03\xe0A\x01R\x13similarityThreshold\"\xf8\x04\n" +
	"\vRaiSettings\x12p\n" +
	"\x14rai_category_configs\x18\x01 \x03(\v2>.google.cloud.dialogflow.v2beta1.RaiSettings.RaiCategoryConfigR\x12raiCategoryConfigs\x1a\xf6\x03\n" +
	"\x11RaiCategoryConfig\x12k\n" +
	"\bcategory\x18\x01 \x01(\x0e2J.google.cloud.dialogflow.v2beta1.RaiSettings.RaiCategoryConfig.RaiCategoryB\x03\xe0A\x01R\bcategory\x12\x81\x01\n" +
	"\x11sensitivity_level\x18\x02 \x01(\x0e2O.google.cloud.dialogflow.v2beta1.RaiSettings.RaiCategoryConfig.SensitivityLevelB\x03\xe0A\x01R\x10sensitivityLevel\"z\n" +
	...
	"\x0fCreateGenerator\x127.google.cloud.dialogflow.v2beta1.CreateGeneratorRequest\x1a*.google.cloud.dialogflow.v2beta1.Generator\"\x9c\x01\xdaA\x1dparent,generator,generator_id\x82\xd3\xe4\x93\x02v:\tgeneratorZ4:\tgenerator\"'/v2beta1/{parent=projects/*}/generators\"3/v2beta1/{parent=projects/*/locations/*}/generators\x12\xb4\x01\n" +
	"\fGetGenerator\x124.google.cloud.dialogflow.v2beta1.GetGeneratorRequest\x1a*.google.cloud.dialogflow.v2beta1.Generator\"B\xdaA\x04name\x82\xd3\xe4\x93\x025\x123/v2beta1/{name=projects/*/locations/*/generators/*}\x12\xf2\x01\n" +
	"\x0eListGenerators\x126.google.cloud.dialogflow.v2beta1.ListGeneratorsRequest\x1a7.google.cloud.dialogflow.v2beta1.ListGeneratorsResponse\"o\xdaA\x06parent\x82\xd3\xe4\x93\x02`Z)\x12'/v2beta1/{parent=projects/*}/generators\x123/v2beta1/{parent=projects/*/locations/*}/generators\x12\xa6\x01\n" +
	...
	"\x0fUpdateGenerator\x127.google.cloud.dialogflow.v2beta1.UpdateGeneratorRequest\x1a*.google.cloud.dialogflow.v2beta1.Generator\"h\xdaA\x15generator,update_mask\x82\xd3\xe4\x93\x02J:\tgenerator2=/v2beta1/{generator.name=projects/*/locations/*/generators/*}\x1ax\xcaA\x19dialogflow.googleapis.com\xd2AYhttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflowB\xa0\x02\xeaAz\n" +
...
var (
	...
	file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2beta1_generator_proto_rawDesc), len(file_google_cloud_dialogflow_v2beta1_generator_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_v2beta1_generator_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2beta1_generator_proto_rawDesc), len(file_google_cloud_dialogflow_v2beta1_generator_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   31,
			NumExtensions: 0,
			NumServices:   1,
