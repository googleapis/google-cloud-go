...
const file_google_cloud_dialogflow_v2beta1_session_proto_rawDesc = "" +
	"\n" +
	"-google/cloud/dialogflow/v2beta1/session.proto\x12\x1fgoogle.cloud.dialogflow.v2beta1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a+google/cloud/dialogflow/v2beta1/agent.proto\x1a2google/cloud/dialogflow/v2beta1/audio_config.proto\x1a-google/cloud/dialogflow/v2beta1/context.proto\x1a,google/cloud/dialogflow/v2beta1/intent.proto\x1a9google/cloud/dialogflow/v2beta1/session_entity_type.proto\x1a\x1egoogle/protobuf/duration.proto\x1a google/protobuf/field_mask.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x17google/rpc/status.proto\x1a\x18google/type/latlng.proto\"\xdc\x03\n" +
	"\x13DetectIntentRequest\x12C\n" +
	"\asession\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!dialogflow.googleapis.com/SessionR\asession\x12S\n" +
	"\fquery_params\x18\x02 \x01(\v20.google.cloud.dialogflow.v2beta1.QueryParametersR\vqueryParams\x12Q\n" +
	"\vquery_input\x18\x03 \x01(\v2+.google.cloud.dialogflow.v2beta1.QueryInputB\x03\xe0A\x02R\n" +
	"queryInput\x12b\n" +
	"\x13output_audio_config\x18\x04 \x01(\v22.google.cloud.dialogflow.v2beta1.OutputAudioConfigR\x11outputAudioConfig\x12S\n" +
	...
	"\x19alternative_query_results\x18\x05 \x03(\v2,.google.cloud.dialogflow.v2beta1.QueryResultR\x17alternativeQueryResults\x129\n" +
	"\x0ewebhook_status\x18\x03 \x01(\v2\x12.google.rpc.StatusR\rwebhookStatus\x12!\n" +
	"\foutput_audio\x18\x04 \x01(\fR\voutputAudio\x12b\n" +
	"\x13output_audio_config\x18\x06 \x01(\v22.google.cloud.dialogflow.v2beta1.OutputAudioConfigR\x11outputAudioConfig\"\xc3\x06\n" +
	"\x0fQueryParameters\x12\x1b\n" +
	"\ttime_zone\x18\x01 \x01(\tR\btimeZone\x126\n" +
	"\fgeo_location\x18\x02 \x01(\v2\x13.google.type.LatLngR\vgeoLocation\x12D\n" +
	"\bcontexts\x18\x03 \x03(\v2(.google.cloud.dialogflow.v2beta1.ContextR\bcontexts\x12%\n" +
	"\x0ereset_contexts\x18\x04 \x01(\bR\rresetContexts\x12d\n" +
	"\x14session_entity_types\x18\x05 \x03(\v22.google.cloud.dialogflow.v2beta1.SessionEntityTypeR\x12sessionEntityTypes\x121\n" +
	"\apayload\x18\x06 \x01(\v2\x17.google.protobuf.StructR\apayload\x120\n" +
	"\x14knowledge_base_names\x18\f \x03(\tR\x12knowledgeBaseNames\x12\x8a\x01\n" +
	"!sentiment_analysis_request_config\x18\n" +
	" \x01(\v2?.google.cloud.dialogflow.v2beta1.SentimentAnalysisRequestConfigR\x1esentimentAnalysisRequestConfig\x12H\n" +
	"\n" +
	"sub_agents\x18\r \x03(\v2).google.cloud.dialogflow.v2beta1.SubAgentR\tsubAgents\x12m\n" +
	"\x0fwebhook_headers\x18\x0e \x03(\v2D.google.cloud.dialogflow.v2beta1.QueryParameters.WebhookHeadersEntryR\x0ewebhookHeaders\x12\x1a\n" +
	...
	"\n" +
	"QueryInput\x12V\n" +
	"\faudio_config\x18\x01 \x01(\v21.google.cloud.dialogflow.v2beta1.InputAudioConfigH\x00R\vaudioConfig\x12@\n" +
	"\x04text\x18\x02 \x01(\v2*.google.cloud.dialogflow.v2beta1.TextInputH\x00R\x04text\x12C\n" +
	"\x05event\x18\x03 \x01(\v2+.google.cloud.dialogflow.v2beta1.EventInputH\x00R\x05event\x12J\n" +
	"\x04dtmf\x18\x04 \x01(\v24.google.cloud.dialogflow.v2beta1.TelephonyDtmfEventsH\x00R\x04dtmfB\a\n" +
	"\x05input\"\xbb\b\n" +
	...
	"\x10fulfillment_text\x18\x06 \x01(\tR\x0ffulfillmentText\x12b\n" +
	"\x14fulfillment_messages\x18\a \x03(\v2/.google.cloud.dialogflow.v2beta1.Intent.MessageR\x13fulfillmentMessages\x12%\n" +
	"\x0ewebhook_source\x18\b \x01(\tR\rwebhookSource\x12@\n" +
	"\x0fwebhook_payload\x18\t \x01(\v2\x17.google.protobuf.StructR\x0ewebhookPayload\x12Q\n" +
	"\x0foutput_contexts\x18\n" +
	" \x03(\v2(.google.cloud.dialogflow.v2beta1.ContextR\x0eoutputContexts\x12?\n" +
	"\x06intent\x18\v \x01(\v2'.google.cloud.dialogflow.v2beta1.IntentR\x06intent\x12>\n" +
	"\x1bintent_detection_confidence\x18\f \x01(\x02R\x19intentDetectionConfidence\x12@\n" +
	"\x0fdiagnostic_info\x18\x0e \x01(\v2\x17.google.protobuf.StructR\x0ediagnosticInfo\x12t\n" +
	"\x19sentiment_analysis_result\x18\x11 \x01(\v28.google.cloud.dialogflow.v2beta1.SentimentAnalysisResultR\x17sentimentAnalysisResult\x12^\n" +
	"\x11knowledge_answers\x18\x12 \x01(\v21.google.cloud.dialogflow.v2beta1.KnowledgeAnswersR\x10knowledgeAnswers\"\xfd\x03\n" +
	"\x10KnowledgeAnswers\x12R\n" +
	"\aanswers\x18\x01 \x03(\v28.google.cloud.dialogflow.v2beta1.KnowledgeAnswers.AnswerR\aanswers\x1a\x94\x03\n" +
	"\x06Answer\x12?\n" +
	"\x06source\x18\x01 \x01(\tB'\xfaA$\n" +
	"\"dialogflow.googleapis.com/DocumentR\x06source\x12!\n" +
	"\ffaq_question\x18\x02 \x01(\tR\vfaqQuestion\x12\x16\n" +
	"\x06answer\x18\x03 \x01(\tR\x06answer\x12\x83\x01\n" +
	"\x16match_confidence_level\x18\x04 \x01(\x0e2M.google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer.MatchConfidenceLevelR\x14matchConfidenceLevel\x12)\n" +
	"\x10match_confidence\x18\x05 \x01(\x02R\x0fmatchConfidence\"]\n" +
	"\x14MatchConfidenceLevel\x12&\n" +
	"\"MATCH_CONFIDENCE_LEVEL_UNSPECIFIED\x10\x00\x12\a\n" +
	"\x03LOW\x10\x01\x12\n" +
	"\n" +
	"\x06MEDIUM\x10\x02\x12\b\n" +
	"\x04HIGH\x10\x03\"\xc8\x04\n" +
	...
	"\vquery_input\x18\x03 \x01(\v2+.google.cloud.dialogflow.v2beta1.QueryInputB\x03\xe0A\x02R\n" +
	"queryInput\x12-\n" +
	"\x10single_utterance\x18\x04 \x01(\bB\x02\x18\x01R\x0fsingleUtterance\x12b\n" +
	"\x13output_audio_config\x18\x05 \x01(\v22.google.cloud.dialogflow.v2beta1.OutputAudioConfigR\x11outputAudioConfig\x12S\n" +
	"\x18output_audio_config_mask\x18\a \x01(\v2\x1a.google.protobuf.FieldMaskR\x15outputAudioConfigMask\x12\x1f\n" +
	...
	"'client_half_close_streaming_time_offset\x18\x12 \x01(\v2\x19.google.protobuf.DurationR\"clientHalfCloseStreamingTimeOffset\"\x91\x05\n" +
	"\x1dStreamingDetectIntentResponse\x12\x1f\n" +
	"\vresponse_id\x18\x01 \x01(\tR\n" +
	"responseId\x12j\n" +
	"\x12recognition_result\x18\x02 \x01(\v2;.google.cloud.dialogflow.v2beta1.StreamingRecognitionResultR\x11recognitionResult\x12O\n" +
	"\fquery_result\x18\x03 \x01(\v2,.google.cloud.dialogflow.v2beta1.QueryResultR\vqueryResult\x12h\n" +
	"\x19alternative_query_results\x18\a \x03(\v2,.google.cloud.dialogflow.v2beta1.QueryResultR\x17alternativeQueryResults\x129\n" +
	...
	"\x10speech_word_info\x18\a \x03(\v2/.google.cloud.dialogflow.v2beta1.SpeechWordInfoR\x0espeechWordInfo\x12E\n" +
	...
	"parameters\x12#\n" +
	"\rlanguage_code\x18\x03 \x01(\tR\flanguageCode\"a\n" +
	"\x1eSentimentAnalysisRequestConfig\x12?\n" +
	"\x1canalyze_query_text_sentiment\x18\x01 \x01(\bR\x19analyzeQueryTextSentiment\"w\n" +
	"\x17SentimentAnalysisResult\x12\\\n" +
	"\x14query_text_sentiment\x18\x01 \x01(\v2*.google.cloud.dialogflow.v2beta1.SentimentR\x12queryTextSentiment\"?\n" +
	"\tSentiment\x12\x14\n" +
	"\x05score\x18\x01 \x01(\x02R\x05score\x12\x1c\n" +
	"\tmagnitude\x18\x02 \x01(\x02R\tmagnitude2\x8d\x06\n" +
	"\bSessions\x12\xe7\x03\n" +
	"\fDetectIntent\x124.google.cloud.dialogflow.v2beta1.DetectIntentRequest\x1a5.google.cloud.dialogflow.v2beta1.DetectIntentResponse\"\xe9\x02\xdaA\x13session,query_input\x82\xd3\xe4\x93\x02\xcc\x02:\x01*ZW:\x01*\"R/v2beta1/{session=projects/*/agent/environments/*/users/*/sessions/*}:detectIntentZL:\x01*\"G/v2beta1/{session=projects/*/locations/*/agent/sessions/*}:detectIntentZc:\x01*\"^/v2beta1/{session=projects/*/locations/*/agent/environments/*/users/*/sessions/*}:detectIntent\";/v2beta1/{session=projects/*/agent/sessions/*}:detectIntent\x12\x9c\x01\n" +
	"\x15StreamingDetectIntent\x12=.google.cloud.dialogflow.v2beta1.StreamingDetectIntentRequest\x1a>.google.cloud.dialogflow.v2beta1.StreamingDetectIntentResponse\"\x00(\x010\x01\x1ax\xcaA\x19dialogflow.googleapis.com\xd2AYhttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflowB\xf6\x03\xeaA\xd1\x02\n" +
	...
	"#com.google.cloud.dialogflow.v2beta1B\fSessionProtoP\x01ZCcloud.google.com/go/dialogflow/apiv2beta1/dialogflowpb;dialogflowpb\xa2\x02\x02DF\xaa\x02\x1fGoogle.Cloud.Dialogflow.V2Beta1b\x06proto3"

var (
	file_google_cloud_dialogflow_v2beta1_session_proto_rawDescOnce sync.Once
	file_google_cloud_dialogflow_v2beta1_session_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_v2beta1_session_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_v2beta1_session_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_v2beta1_session_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2beta1_session_proto_rawDesc), len(file_google_cloud_dialogflow_v2beta1_session_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_v2beta1_session_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2beta1_session_proto_rawDesc), len(file_google_cloud_dialogflow_v2beta1_session_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   1,
