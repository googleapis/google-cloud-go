...
const (
	EncryptionSpecService_GetEncryptionSpec_FullMethodName        = "/google.cloud.dialogflow.v2beta1.EncryptionSpecService/GetEncryptionSpec"
	EncryptionSpecService_InitializeEncryptionSpec_FullMethodName = "/google.cloud.dialogflow.v2beta1.EncryptionSpecService/InitializeEncryptionSpec"
)
