...
func (x *Intent_Message) GetTelephonyPlayAudio() *Intent_Message_TelephonyPlayAudio {
	if x != nil {
		if x, ok := x.Message.(*Intent_Message_TelephonyPlayAudio_); ok {
...
func (x *Intent_Message) GetTelephonySynthesizeSpeech() *Intent_Message_TelephonySynthesizeSpeech {
	if x != nil {
		if x, ok := x.Message.(*Intent_Message_TelephonySynthesizeSpeech_); ok {
...
func (x *Intent_Message) GetTelephonyTransferCall() *Intent_Message_TelephonyTransferCall {
	if x != nil {
		if x, ok := x.Message.(*Intent_Message_TelephonyTransferCall_); ok {
...
func (x *Intent_Message) GetRbmText() *Intent_Message_RbmText {
	if x != nil {
		if x, ok := x.Message.(*Intent_Message_RbmText_); ok {
			return x.RbmText
		}
	}
	return nil
...
func (x *Intent_Message) GetRbmStandaloneRichCard() *Intent_Message_RbmStandaloneCard {
	if x != nil {
		if x, ok := x.Message.(*Intent_Message_RbmStandaloneRichCard); ok {
...
func (x *Intent_Message) GetRbmCarouselRichCard() *Intent_Message_RbmCarouselCard {
	if x != nil {
		if x, ok := x.Message.(*Intent_Message_RbmCarouselRichCard); ok {
...
func (x *Intent_Message_TelephonySynthesizeSpeech) GetSource() isIntent_Message_TelephonySynthesizeSpeech_Source {
	if x != nil {
		return x.Source
	}
	return nil
...
func (x *Intent_Message_TelephonySynthesizeSpeech) GetText() string {
	if x != nil {
		if x, ok := x.Source.(*Intent_Message_TelephonySynthesizeSpeech_Text); ok {
			return x.Text
		}
	}
	return ""
...
func (x *Intent_Message_TelephonySynthesizeSpeech) GetSsml() string {
	if x != nil {
		if x, ok := x.Source.(*Intent_Message_TelephonySynthesizeSpeech_Ssml); ok {
			return x.Ssml
		}
	}
	return ""
...
func (x *Intent_Message_RbmSuggestion) GetSuggestion() isIntent_Message_RbmSuggestion_Suggestion {
	if x != nil {
		return x.Suggestion
	}
	return nil
...
func (x *Intent_Message_RbmSuggestion) GetReply() *Intent_Message_RbmSuggestedReply {
	if x != nil {
		if x, ok := x.Suggestion.(*Intent_Message_RbmSuggestion_Reply); ok {
			return x.Reply
		}
	}
	return nil
...
func (x *Intent_Message_RbmSuggestion) GetAction() *Intent_Message_RbmSuggestedAction {
	if x != nil {
		if x, ok := x.Suggestion.(*Intent_Message_RbmSuggestion_Action); ok {
			return x.Action
		}
	}
	return nil
...
func (x *Intent_Message_RbmSuggestedAction) GetAction() isIntent_Message_RbmSuggestedAction_Action {
	if x != nil {
		return x.Action
	}
	return nil
...
func (x *Intent_Message_RbmSuggestedAction) GetDial() *Intent_Message_RbmSuggestedAction_RbmSuggestedActionDial {
	if x != nil {
		if x, ok := x.Action.(*Intent_Message_RbmSuggestedAction_Dial); ok {
			return x.Dial
		}
	}
	return nil
...
func (x *Intent_Message_RbmSuggestedAction) GetOpenUrl() *Intent_Message_RbmSuggestedAction_RbmSuggestedActionOpenUri {
	if x != nil {
		if x, ok := x.Action.(*Intent_Message_RbmSuggestedAction_OpenUrl); ok {
			return x.OpenUrl
		}
	}
	return nil
...
func (x *Intent_Message_RbmSuggestedAction) GetShareLocation() *Intent_Message_RbmSuggestedAction_RbmSuggestedActionShareLocation {
	if x != nil {
		if x, ok := x.Action.(*Intent_Message_RbmSuggestedAction_ShareLocation); ok {
...
const file_google_cloud_dialogflow_v2beta1_intent_proto_rawDesc = "" +
	"\n" +
	...
	"\rwebhook_state\x18\x06 \x01(\x0e24.google.cloud.dialogflow.v2beta1.Intent.WebhookStateB\x03\xe0A\x01R\fwebhookState\x12\x1f\n" +
	"\bpriority\x18\x03 \x01(\x05B\x03\xe0A\x01R\bpriority\x12$\n" +
	"\vis_fallback\x18\x04 \x01(\bB\x03\xe0A\x01R\n" +
	"isFallback\x12$\n" +
	"\n" +
	"ml_enabled\x18\x05 \x01(\bB\x05\xe0A\x01\x18\x01R\tmlEnabled\x12$\n" +
	...
	"\x06events\x18\b \x03(\tB\x03\xe0A\x01R\x06events\x12f\n" +
	"\x10training_phrases\x18\t \x03(\v26.google.cloud.dialogflow.v2beta1.Intent.TrainingPhraseB\x03\xe0A\x01R\x0ftrainingPhrases\x12\x1b\n" +
	"\x06action\x18\n" +
	" \x01(\tB\x03\xe0A\x01R\x06action\x12V\n" +
	"\x0foutput_contexts\x18\v \x03(\v2(.google.cloud.dialogflow.v2beta1.ContextB\x03\xe0A\x01R\x0eoutputContexts\x12*\n" +
	"\x0ereset_contexts\x18\f \x01(\bB\x03\xe0A\x01R\rresetContexts\x12V\n" +
	"\n" +
	"parameters\x18\r \x03(\v21.google.cloud.dialogflow.v2beta1.Intent.ParameterB\x03\xe0A\x01R\n" +
	"parameters\x12K\n" +
	"\bmessages\x18\x0e \x03(\v2/.google.cloud.dialogflow.v2beta1.Intent.MessageR\bmessages\x12{\n" +
	"\x1adefault_response_platforms\x18\x0f \x03(\x0e28.google.cloud.dialogflow.v2beta1.Intent.Message.PlatformB\x03\xe0A\x01R\x18defaultResponsePlatforms\x12>\n" +
	"\x19root_followup_intent_name\x18\x10 \x01(\tB\x03\xe0A\x03R\x16rootFollowupIntentName\x12B\n" +
	"\x1bparent_followup_intent_name\x18\x11 \x01(\tB\x03\xe0A\x01R\x18parentFollowupIntentName\x12q\n" +
	"\x14followup_intent_info\x18\x12 \x03(\v2:.google.cloud.dialogflow.v2beta1.Intent.FollowupIntentInfoB\x03\xe0A\x03R\x12followupIntentInfo\x1a\xbb\x03\n" +
	"\x0eTrainingPhrase\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12T\n" +
	"\x04type\x18\x02 \x01(\x0e2;.google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase.TypeB\x03\xe0A\x02R\x04type\x12V\n" +
	"\x05parts\x18\x03 \x03(\v2;.google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase.PartB\x03\xe0A\x02R\x05parts\x12/\n" +
	"\x11times_added_count\x18\x04 \x01(\x05B\x03\xe0A\x01R\x0ftimesAddedCount\x1at\n" +
	"\x04Part\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12\x1f\n" +
	"\ventity_type\x18\x02 \x01(\tR\n" +
	"entityType\x12\x14\n" +
	"\x05alias\x18\x03 \x01(\tR\x05alias\x12!\n" +
	"\fuser_defined\x18\x04 \x01(\bR\vuserDefined\";\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aEXAMPLE\x10\x01\x12\x10\n" +
	"\bTEMPLATE\x10\x02\x1a\x02\b\x01\x1a\x87\x02\n" +
	"\tParameter\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x12\x14\n" +
	"\x05value\x18\x03 \x01(\tR\x05value\x12#\n" +
	"\rdefault_value\x18\x04 \x01(\tR\fdefaultValue\x127\n" +
	"\x18entity_type_display_name\x18\x05 \x01(\tR\x15entityTypeDisplayName\x12\x1c\n" +
	"\tmandatory\x18\x06 \x01(\bR\tmandatory\x12\x18\n" +
	"\aprompts\x18\a \x03(\tR\aprompts\x12\x17\n" +
	"\ais_list\x18\b \x01(\bR\x06isList\x1a\xd1J\n" +
	"\aMessage\x12J\n" +
	"\x04text\x18\x01 \x01(\v24.google.cloud.dialogflow.v2beta1.Intent.Message.TextH\x00R\x04text\x12M\n" +
	"\x05image\x18\x02 \x01(\v25.google.cloud.dialogflow.v2beta1.Intent.Message.ImageH\x00R\x05image\x12c\n" +
	"\rquick_replies\x18\x03 \x01(\v2<.google.cloud.dialogflow.v2beta1.Intent.Message.QuickRepliesH\x00R\fquickReplies\x12J\n" +
	"\x04card\x18\x04 \x01(\v24.google.cloud.dialogflow.v2beta1.Intent.Message.CardH\x00R\x04card\x123\n" +
	"\apayload\x18\x05 \x01(\v2\x17.google.protobuf.StructH\x00R\apayload\x12l\n" +
	"\x10simple_responses\x18\a \x01(\v2?.google.cloud.dialogflow.v2beta1.Intent.Message.SimpleResponsesH\x00R\x0fsimpleResponses\x12Z\n" +
	"\n" +
	"basic_card\x18\b \x01(\v29.google.cloud.dialogflow.v2beta1.Intent.Message.BasicCardH\x00R\tbasicCard\x12_\n" +
	"\vsuggestions\x18\t \x01(\v2;.google.cloud.dialogflow.v2beta1.Intent.Message.SuggestionsH\x00R\vsuggestions\x12s\n" +
	"\x13link_out_suggestion\x18\n" +
	" \x01(\v2A.google.cloud.dialogflow.v2beta1.Intent.Message.LinkOutSuggestionH\x00R\x11linkOutSuggestion\x12]\n" +
	"\vlist_select\x18\v \x01(\v2:.google.cloud.dialogflow.v2beta1.Intent.Message.ListSelectH\x00R\n" +
	"listSelect\x12i\n" +
	"\x0fcarousel_select\x18\f \x01(\v2>.google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelectH\x00R\x0ecarouselSelect\x12v\n" +
	"\x14telephony_play_audio\x18\r \x01(\v2B.google.cloud.dialogflow.v2beta1.Intent.Message.TelephonyPlayAudioH\x00R\x12telephonyPlayAudio\x12\x8b\x01\n" +
	"\x1btelephony_synthesize_speech\x18\x0e \x01(\v2I.google.cloud.dialogflow.v2beta1.Intent.Message.TelephonySynthesizeSpeechH\x00R\x19telephonySynthesizeSpeech\x12\x7f\n" +
	"\x17telephony_transfer_call\x18\x0f \x01(\v2E.google.cloud.dialogflow.v2beta1.Intent.Message.TelephonyTransferCallH\x00R\x15telephonyTransferCall\x12T\n" +
	"\brbm_text\x18\x12 \x01(\v27.google.cloud.dialogflow.v2beta1.Intent.Message.RbmTextH\x00R\arbmText\x12|\n" +
	"\x18rbm_standalone_rich_card\x18\x13 \x01(\v2A.google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCardH\x00R\x15rbmStandaloneRichCard\x12v\n" +
	"\x16rbm_carousel_rich_card\x18\x14 \x01(\v2?.google.cloud.dialogflow.v2beta1.Intent.Message.RbmCarouselCardH\x00R\x13rbmCarouselRichCard\x12v\n" +
	"\x14browse_carousel_card\x18\x16 \x01(\v2B.google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCardH\x00R\x12browseCarouselCard\x12Z\n" +
	"\n" +
	"table_card\x18\x17 \x01(\v29.google.cloud.dialogflow.v2beta1.Intent.Message.TableCardH\x00R\ttableCard\x12c\n" +
	"\rmedia_content\x18\x18 \x01(\v2<.google.cloud.dialogflow.v2beta1.Intent.Message.MediaContentH\x00R\fmediaContent\x12Y\n" +
	"\bplatform\x18\x06 \x01(\x0e28.google.cloud.dialogflow.v2beta1.Intent.Message.PlatformB\x03\xe0A\x01R\bplatform\x1a\x1a\n" +
	"\x04Text\x12\x12\n" +
	...
	"\rquick_replies\x18\x02 \x03(\tR\fquickReplies\x1a\xe6\x01\n" +
	"\x04Card\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12\x1a\n" +
	"\bsubtitle\x18\x02 \x01(\tR\bsubtitle\x12\x1b\n" +
	"\timage_uri\x18\x03 \x01(\tR\bimageUri\x12U\n" +
	"\abuttons\x18\x04 \x03(\v2;.google.cloud.dialogflow.v2beta1.Intent.Message.Card.ButtonR\abuttons\x1a8\n" +
	"\x06Button\x12\x12\n" +
	...
	"\fdisplay_text\x18\x03 \x01(\tR\vdisplayText\x1a|\n" +
	"\x0fSimpleResponses\x12i\n" +
	"\x10simple_responses\x18\x01 \x03(\v2>.google.cloud.dialogflow.v2beta1.Intent.Message.SimpleResponseR\x0fsimpleResponses\x1a\xc9\x03\n" +
	"\tBasicCard\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12\x1a\n" +
	"\bsubtitle\x18\x02 \x01(\tR\bsubtitle\x12%\n" +
	"\x0eformatted_text\x18\x03 \x01(\tR\rformattedText\x12K\n" +
	"\x05image\x18\x04 \x01(\v25.google.cloud.dialogflow.v2beta1.Intent.Message.ImageR\x05image\x12Z\n" +
	"\abuttons\x18\x05 \x03(\v2@.google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard.ButtonR\abuttons\x1a\xb9\x01\n" +
	"\x06Button\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12v\n" +
	"\x0fopen_uri_action\x18\x02 \x01(\v2N.google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard.Button.OpenUriActionR\ropenUriAction\x1a!\n" +
	...
	"\vSuggestions\x12\\\n" +
	"\vsuggestions\x18\x01 \x03(\v2:.google.cloud.dialogflow.v2beta1.Intent.Message.SuggestionR\vsuggestions\x1aP\n" +
	"\x11LinkOutSuggestion\x12)\n" +
	"\x10destination_name\x18\x01 \x01(\tR\x0fdestinationName\x12\x10\n" +
	"\x03uri\x18\x02 \x01(\tR\x03uri\x1a\xfc\x02\n" +
	"\n" +
	"ListSelect\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12U\n" +
	"\x05items\x18\x02 \x03(\v2?.google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.ItemR\x05items\x12\x1f\n" +
	"\bsubtitle\x18\x03 \x01(\tB\x03\xe0A\x01R\bsubtitle\x1a\xdf\x01\n" +
	"\x04Item\x12R\n" +
	"\x04info\x18\x01 \x01(\v2>.google.cloud.dialogflow.v2beta1.Intent.Message.SelectItemInfoR\x04info\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12K\n" +
	"\x05image\x18\x04 \x01(\v25.google.cloud.dialogflow.v2beta1.Intent.Message.ImageR\x05image\x1a\xcd\x02\n" +
	"\x0eCarouselSelect\x12Y\n" +
	"\x05items\x18\x01 \x03(\v2C.google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect.ItemR\x05items\x1a\xdf\x01\n" +
	"\x04Item\x12R\n" +
	"\x04info\x18\x01 \x01(\v2>.google.cloud.dialogflow.v2beta1.Intent.Message.SelectItemInfoR\x04info\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12K\n" +
	"\x05image\x18\x04 \x01(\v25.google.cloud.dialogflow.v2beta1.Intent.Message.ImageR\x05image\x1a>\n" +
	"\x0eSelectItemInfo\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x1a\n" +
	"\bsynonyms\x18\x02 \x03(\tR\bsynonyms\x1a1\n" +
	"\x12TelephonyPlayAudio\x12\x1b\n" +
	"\taudio_uri\x18\x01 \x01(\tR\baudioUri\x1aQ\n" +
	...
	"\fphone_number\x18\x01 \x01(\tR\vphoneNumber\x1a\x83\x01\n" +
	"\aRbmText\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12d\n" +
	"\x0erbm_suggestion\x18\x02 \x03(\v2=.google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestionR\rrbmSuggestion\x1a\xa0\x02\n" +
	"\x0fRbmCarouselCard\x12h\n" +
	"\n" +
	"card_width\x18\x01 \x01(\x0e2I.google.cloud.dialogflow.v2beta1.Intent.Message.RbmCarouselCard.CardWidthR\tcardWidth\x12c\n" +
	"\rcard_contents\x18\x02 \x03(\v2>.google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContentR\fcardContents\">\n" +
	"\tCardWidth\x12\x1a\n" +
	...
	"\x10card_orientation\x18\x01 \x01(\x0e2Q.google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.CardOrientationR\x0fcardOrientation\x12\x95\x01\n" +
	"\x19thumbnail_image_alignment\x18\x02 \x01(\x0e2Y.google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.ThumbnailImageAlignmentR\x17thumbnailImageAlignment\x12a\n" +
	"\fcard_content\x18\x03 \x01(\v2>.google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContentR\vcardContent\"Q\n" +
	"\x0fCardOrientation\x12 \n" +
	"\x1cCARD_ORIENTATION_UNSPECIFIED\x10\x00\x12\x0e\n" +
	"\n" +
	"HORIZONTAL\x10\x01\x12\f\n" +
	"\bVERTICAL\x10\x02\"Y\n" +
	"\x17ThumbnailImageAlignment\x12)\n" +
	"%THUMBNAIL_IMAGE_ALIGNMENT_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04LEFT\x10\x01\x12\t\n" +
	"\x05RIGHT\x10\x02\x1a\x80\x04\n" +
	"\x0eRbmCardContent\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12]\n" +
	"\x05media\x18\x03 \x01(\v2G.google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContent.RbmMediaR\x05media\x12_\n" +
	"\vsuggestions\x18\x04 \x03(\v2=.google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestionR\vsuggestions\x1a\xf5\x01\n" +
	"\bRbmMedia\x12\x19\n" +
	"\bfile_uri\x18\x01 \x01(\tR\afileUri\x12#\n" +
	"\rthumbnail_uri\x18\x02 \x01(\tR\fthumbnailUri\x12f\n" +
	"\x06height\x18\x03 \x01(\x0e2N.google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContent.RbmMedia.HeightR\x06height\"A\n" +
	"\x06Height\x12\x16\n" +
	...
	"\rRbmSuggestion\x12Y\n" +
	"\x05reply\x18\x01 \x01(\v2A.google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedReplyH\x00R\x05reply\x12\\\n" +
	"\x06action\x18\x02 \x01(\v2B.google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedActionH\x00R\x06actionB\f\n" +
	"\n" +
	"suggestion\x1aL\n" +
	"\x11RbmSuggestedReply\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12#\n" +
	"\rpostback_data\x18\x02 \x01(\tR\fpostbackData\x1a\xe0\x04\n" +
	"\x12RbmSuggestedAction\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12#\n" +
	"\rpostback_data\x18\x02 \x01(\tR\fpostbackData\x12o\n" +
	"\x04dial\x18\x03 \x01(\v2Y.google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedAction.RbmSuggestedActionDialH\x00R\x04dial\x12y\n" +
	"\bopen_url\x18\x04 \x01(\v2\\.google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedAction.RbmSuggestedActionOpenUriH\x00R\aopenUrl\x12\x8b\x01\n" +
	"\x0eshare_location\x18\x05 \x01(\v2b.google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedAction.RbmSuggestedActionShareLocationH\x00R\rshareLocation\x1a;\n" +
	"\x16RbmSuggestedActionDial\x12!\n" +
	"\fphone_number\x18\x01 \x01(\tR\vphoneNumber\x1a-\n" +
	"\x19RbmSuggestedActionOpenUri\x12\x10\n" +
	"\x03uri\x18\x01 \x01(\tR\x03uri\x1a!\n" +
	"\x1fRbmSuggestedActionShareLocationB\b\n" +
	"\x06action\x1a\xd8\x04\n" +
	"\fMediaContent\x12m\n" +
	"\n" +
	"media_type\x18\x01 \x01(\x0e2N.google.cloud.dialogflow.v2beta1.Intent.Message.MediaContent.ResponseMediaTypeR\tmediaType\x12u\n" +
	"\rmedia_objects\x18\x02 \x03(\v2P.google.cloud.dialogflow.v2beta1.Intent.Message.MediaContent.ResponseMediaObjectR\fmediaObjects\x1a\x9c\x02\n" +
	"\x13ResponseMediaObject\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12X\n" +
	"\vlarge_image\x18\x03 \x01(\v25.google.cloud.dialogflow.v2beta1.Intent.Message.ImageH\x00R\n" +
	"largeImage\x12K\n" +
	"\x04icon\x18\x04 \x01(\v25.google.cloud.dialogflow.v2beta1.Intent.Message.ImageH\x00R\x04icon\x12\x1f\n" +
	...
	"\x12BrowseCarouselCard\x12o\n" +
	"\x05items\x18\x01 \x03(\v2Y.google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItemR\x05items\x12\x8a\x01\n" +
	"\x15image_display_options\x18\x02 \x01(\x0e2V.google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.ImageDisplayOptionsR\x13imageDisplayOptions\x1a\xd4\x04\n" +
	"\x16BrowseCarouselCardItem\x12\x8f\x01\n" +
	"\x0fopen_uri_action\x18\x01 \x01(\v2g.google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItem.OpenUrlActionR\ropenUriAction\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12K\n" +
	"\x05image\x18\x04 \x01(\v25.google.cloud.dialogflow.v2beta1.Intent.Message.ImageR\x05image\x12\x16\n" +
	"\x06footer\x18\x05 \x01(\tR\x06footer\x1a\x8a\x02\n" +
	"\rOpenUrlAction\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12\x97\x01\n" +
	"\rurl_type_hint\x18\x03 \x01(\x0e2s.google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItem.OpenUrlAction.UrlTypeHintR\vurlTypeHint\"M\n" +
	...
	"\x12BLURRED_BACKGROUND\x10\x04\x1a\xa7\x03\n" +
	"\tTableCard\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12\x1a\n" +
	"\bsubtitle\x18\x02 \x01(\tR\bsubtitle\x12K\n" +
	"\x05image\x18\x03 \x01(\v25.google.cloud.dialogflow.v2beta1.Intent.Message.ImageR\x05image\x12m\n" +
	"\x11column_properties\x18\x04 \x03(\v2@.google.cloud.dialogflow.v2beta1.Intent.Message.ColumnPropertiesR\x10columnProperties\x12P\n" +
	"\x04rows\x18\x05 \x03(\v2<.google.cloud.dialogflow.v2beta1.Intent.Message.TableCardRowR\x04rows\x12Z\n" +
	"\abuttons\x18\x06 \x03(\v2@.google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard.ButtonR\abuttons\x1a\x98\x02\n" +
	"\x10ColumnProperties\x12\x16\n" +
	"\x06header\x18\x01 \x01(\tR\x06header\x12\x87\x01\n" +
	"\x14horizontal_alignment\x18\x02 \x01(\x0e2T.google.cloud.dialogflow.v2beta1.Intent.Message.ColumnProperties.HorizontalAlignmentR\x13horizontalAlignment\"b\n" +
	"\x13HorizontalAlignment\x12$\n" +
	" HORIZONTAL_ALIGNMENT_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aLEADING\x10\x01\x12\n" +
	"\n" +
	"\x06CENTER\x10\x02\x12\f\n" +
	"\bTRAILING\x10\x03\x1a\x88\x01\n" +
	"\fTableCardRow\x12S\n" +
	"\x05cells\x18\x01 \x03(\v2=.google.cloud.dialogflow.v2beta1.Intent.Message.TableCardCellR\x05cells\x12#\n" +
	"\rdivider_after\x18\x02 \x01(\bR\fdividerAfter\x1a#\n" +
	...
	"\x11ACTIONS_ON_GOOGLE\x10\b\x12\r\n" +
	"\tTELEPHONY\x10\n" +
	"\x12\x13\n" +
	...
	" dialogflow.googleapis.com/Intent\x12)projects/{project}/agent/intents/{intent}\x12>projects/{project}/locations/{location}/agent/intents/{intent}\"\x8a\x02\n" +
	...
	"\vintent_view\x18\x03 \x01(\x0e2+.google.cloud.dialogflow.v2beta1.IntentViewR\n" +
	"intentView\x12\x1b\n" +
	"\tpage_size\x18\x04 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x05 \x01(\tR\tpageToken\"\x80\x01\n" +
	"\x13ListIntentsResponse\x12A\n" +
	"\aintents\x18\x01 \x03(\v2'.google.cloud.dialogflow.v2beta1.IntentR\aintents\x12&\n" +
	...
	"\x06parent\x18\x01 \x01(\tB(\xe0A\x02\xfaA\"\x12 dialogflow.googleapis.com/IntentR\x06parent\x12D\n" +
	"\x06intent\x18\x02 \x01(\v2'.google.cloud.dialogflow.v2beta1.IntentB\x03\xe0A\x02R\x06intent\x12(\n" +
	"\rlanguage_code\x18\x03 \x01(\tB\x03\xe0A\x01R\flanguageCode\x12L\n" +
	"\vintent_view\x18\x04 \x01(\x0e2+.google.cloud.dialogflow.v2beta1.IntentViewR\n" +
	"intentView\"\x90\x02\n" +
	"\x13UpdateIntentRequest\x12D\n" +
	"\x06intent\x18\x01 \x01(\v2'.google.cloud.dialogflow.v2beta1.IntentB\x03\xe0A\x02R\x06intent\x12(\n" +
	...
	"\x13intent_batch_inline\x18\x03 \x01(\v2,.google.cloud.dialogflow.v2beta1.IntentBatchH\x00R\x11intentBatchInline\x12(\n" +
	"\rlanguage_code\x18\x04 \x01(\tB\x03\xe0A\x01R\flanguageCode\x12;\n" +
	"\vupdate_mask\x18\x05 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\x12L\n" +
	"\vintent_view\x18\x06 \x01(\x0e2+.google.cloud.dialogflow.v2beta1.IntentViewR\n" +
	"intentViewB\x0e\n" +
	"\fintent_batch\"_\n" +
	"\x1aBatchUpdateIntentsResponse\x12A\n" +
	"\aintents\x18\x01 \x03(\v2'.google.cloud.dialogflow.v2beta1.IntentR\aintents\"\xa5\x01\n" +
	"\x19BatchDeleteIntentsRequest\x12@\n" +
	"\x06parent\x18\x01 \x01(\tB(\xe0A\x02\xfaA\"\x12 dialogflow.googleapis.com/IntentR\x06parent\x12F\n" +
	"\aintents\x18\x02 \x03(\v2'.google.cloud.dialogflow.v2beta1.IntentB\x03\xe0A\x02R\aintents\"P\n" +
	"\vIntentBatch\x12A\n" +
	"\aintents\x18\x01 \x03(\v2'.google.cloud.dialogflow.v2beta1.IntentR\aintents*?\n" +
	"\n" +
	"IntentView\x12\x1b\n" +
	"\x17INTENT_VIEW_UNSPECIFIED\x10\x00\x12\x14\n" +
	"\x10INTENT_VIEW_FULL\x10\x012\xa1\x12\n" +
	"\aIntents\x12\x8e\x03\n" +
	"\vListIntents\x123.google.cloud.dialogflow.v2beta1.ListIntentsRequest\x1a4.google.cloud.dialogflow.v2beta1.ListIntentsResponse\"\x93\x02\xdaA\x06parent\xdaA\x14parent,language_code\x82\xd3\xe4\x93\x02\xec\x01Z8\x126/v2beta1/{parent=projects/*/locations/*/agent}/intentsZ;\x129/v2beta1/{parent=projects/*/agent/environments/*}/intentsZG\x12E/v2beta1/{parent=projects/*/locations/*/agent/environments/*}/intents\x12*/v2beta1/{parent=projects/*/agent}/intents\x12\xf2\x01\n" +
	"\tGetIntent\x121.google.cloud.dialogflow.v2beta1.GetIntentRequest\x1a'.google.cloud.dialogflow.v2beta1.Intent\"\x88\x01\xdaA\x04name\xdaA\x12name,language_code\x82\xd3\xe4\x93\x02fZ8\x126/v2beta1/{name=projects/*/locations/*/agent/intents/*}\x12*/v2beta1/{name=projects/*/agent/intents/*}\x12\x9a\x02\n" +
	"\fCreateIntent\x124.google.cloud.dialogflow.v2beta1.CreateIntentRequest\x1a'.google.cloud.dialogflow.v2beta1.Intent\"\xaa\x01\xdaA\rparent,intent\xdaA\x1bparent,intent,language_code\x82\xd3\xe4\x93\x02v:\x06intentZ@:\x06intent\"6/v2beta1/{parent=projects/*/locations/*/agent}/intents\"*/v2beta1/{parent=projects/*/agent}/intents\x12\xd3\x02\n" +
	"\fUpdateIntent\x124.google.cloud.dialogflow.v2beta1.UpdateIntentRequest\x1a'.google.cloud.dialogflow.v2beta1.Intent\"\xe3\x01\xdaA\x12intent,update_mask\xdaA\x06intent\xdaA\x14intent,language_code\xdaA intent,language_code,update_mask\x82\xd3\xe4\x93\x02\x84\x01:\x06intentZG:\x06intent2=/v2beta1/{intent.name=projects/*/locations/*/agent/intents/*}21/v2beta1/{intent.name=projects/*/agent/intents/*}\x12\xd1\x01\n" +
	"\fDeleteIntent\x124.google.cloud.dialogflow.v2beta1.DeleteIntentRequest\x1a\x16.google.protobuf.Empty\"s\xdaA\x04name\x82\xd3\xe4\x93\x02fZ8*6/v2beta1/{name=projects/*/locations/*/agent/intents/*}**/v2beta1/{name=projects/*/agent/intents/*}\x12\x8b\x03\n" +
	...
	":google.cloud.dialogflow.v2beta1.BatchUpdateIntentsResponse\x12\x16google.protobuf.Struct\xdaA\x17parent,intent_batch_uri\xdaA\x1aparent,intent_batch_inline\x82\xd3\xe4\x93\x02\x84\x01:\x01*ZG:\x01*\"B/v2beta1/{parent=projects/*/locations/*/agent}/intents:batchUpdate\"6/v2beta1/{parent=projects/*/agent}/intents:batchUpdate\x12\xc0\x02\n" +
	...
	"\x15google.protobuf.Empty\x12\x16google.protobuf.Struct\xdaA\x0eparent,intents\x82\xd3\xe4\x93\x02\x84\x01:\x01*ZG:\x01*\"B/v2beta1/{parent=projects/*/locations/*/agent}/intents:batchDelete\"6/v2beta1/{parent=projects/*/agent}/intents:batchDelete\x1ax\xcaA\x19dialogflow.googleapis.com\xd2AYhttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflowB\xa0\x01\n" +
	"#com.google.cloud.dialogflow.v2beta1B\vIntentProtoP\x01ZCcloud.google.com/go/dialogflow/apiv2beta1/dialogflowpb;dialogflowpb\xa2\x02\x02DF\xaa\x02\x1fGoogle.Cloud.Dialogflow.V2Beta1b\x06proto3"

var (
	file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescOnce sync.Once
	file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2beta1_intent_proto_rawDesc), len(file_google_cloud_dialogflow_v2beta1_intent_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_v2beta1_intent_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2beta1_intent_proto_rawDesc), len(file_google_cloud_dialogflow_v2beta1_intent_proto_rawDesc)),
			NumEnums:      12,
			NumMessages:   57,
			NumExtensions: 0,
			NumServices:   1,
