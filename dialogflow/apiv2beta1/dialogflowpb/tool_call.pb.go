...
const file_google_cloud_dialogflow_v2beta1_tool_call_proto_rawDesc = "" +
	"\n" +
	"/google/cloud/dialogflow/v2beta1/tool_call.proto\x12\x1fgoogle.cloud.dialogflow.v2beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xdf\x05\n" +
	"\bToolCall\x12<\n" +
	...
	"createTime\x12(\n" +
	"\ranswer_record\x18\x06 \x01(\tB\x03\xe0A\x01R\fanswerRecord\x12J\n" +
	"\x05state\x18\a \x01(\x0e2/.google.cloud.dialogflow.v2beta1.ToolCall.StateB\x03\xe0A\x03R\x05state\"E\n" +
	"\x05State\x12\x15\n" +
	...
	"\x06action\x18\x02 \x01(\tB\x03\xe0A\x01R\x06action\x12R\n" +
	"\x05error\x18\x03 \x01(\v25.google.cloud.dialogflow.v2beta1.ToolCallResult.ErrorB\x03\xe0A\x01H\x01R\x05error\x12&\n" +
	"\vraw_content\x18\x05 \x01(\fB\x03\xe0A\x01H\x01R\n" +
	"rawContent\x12\x1f\n" +
...
var (
	...
	file_google_cloud_dialogflow_v2beta1_tool_call_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_v2beta1_tool_call_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_v2beta1_tool_call_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_v2beta1_tool_call_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2beta1_tool_call_proto_rawDesc), len(file_google_cloud_dialogflow_v2beta1_tool_call_proto_rawDesc)))
	})
...
func file_google_cloud_dialogflow_v2beta1_tool_call_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2beta1_tool_call_proto_rawDesc), len(file_google_cloud_dialogflow_v2beta1_tool_call_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
