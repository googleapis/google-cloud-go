...
func (x *AutomatedAgentReply) GetResponse() isAutomatedAgentReply_Response {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *AutomatedAgentReply) GetDetectIntentResponse() *DetectIntentResponse {
	if x != nil {
		if x, ok := x.Response.(*AutomatedAgentReply_DetectIntentResponse); ok {
...
func (x *AutomatedAgentReply) GetMatch() isAutomatedAgentReply_Match {
	if x != nil {
		return x.Match
	}
	return nil
...
func (x *AutomatedAgentReply) GetIntent() string {
	if x != nil {
		if x, ok := x.Match.(*AutomatedAgentReply_Intent); ok {
			return x.Intent
		}
	}
	return ""
...
func (x *AutomatedAgentReply) GetEvent() string {
	if x != nil {
		if x, ok := x.Match.(*AutomatedAgentReply_Event); ok {
			return x.Event
		}
	}
	return ""
...
func (x *AnalyzeContentRequest) GetIntentInput() *IntentInput {
	if x != nil {
		if x, ok := x.Input.(*AnalyzeContentRequest_IntentInput); ok {
			return x.IntentInput
		}
	}
	return nil
...
func (x *StreamingAnalyzeContentRequest) GetInputIntent() string {
	if x != nil {
		if x, ok := x.Input.(*StreamingAnalyzeContentRequest_InputIntent); ok {
...
func (x *StreamingAnalyzeContentRequest) GetInputEvent() string {
	if x != nil {
		if x, ok := x.Input.(*StreamingAnalyzeContentRequest_InputEvent); ok {
			return x.InputEvent
		}
	}
	return ""
...
func (x *SuggestionResult) GetSuggestDialogflowAssistsResponse() *SuggestDialogflowAssistsResponse {
	if x != nil {
		if x, ok := x.SuggestionResponse.(*SuggestionResult_SuggestDialogflowAssistsResponse); ok {
...
func (x *SuggestionResult) GetSuggestEntityExtractionResponse() *SuggestDialogflowAssistsResponse {
	if x != nil {
		if x, ok := x.SuggestionResponse.(*SuggestionResult_SuggestEntityExtractionResponse); ok {
...
func (x *ResponseMessage_TelephonyTransferCall) GetSipUri() string {
	if x != nil {
		if x, ok := x.Endpoint.(*ResponseMessage_TelephonyTransferCall_SipUri); ok {
			return x.SipUri
		}
	}
	return ""
...
const file_google_cloud_dialogflow_v2beta1_participant_proto_rawDesc = "" +
	...
	"\x1bobfuscated_external_user_id\x18\a \x01(\tB\x03\xe0A\x01R\x18obfuscatedExternalUserId\x12\x8d\x01\n" +
	"\x1adocuments_metadata_filters\x18\b \x03(\v2J.google.cloud.dialogflow.v2beta1.Participant.DocumentsMetadataFiltersEntryB\x03\xe0A\x01R\x18documentsMetadataFilters\x12v\n" +
	"\x14agent_desktop_source\x18\n" +
	" \x01(\x0e2?.google.cloud.dialogflow.v2beta1.Participant.AgentDesktopSourceB\x03\xe0A\x01R\x12agentDesktopSource\x1aK\n" +
	...
	"\x10participant_role\x18\x05 \x01(\x0e21.google.cloud.dialogflow.v2beta1.Participant.RoleB\x03\xe0A\x03R\x0fparticipantRole\x12@\n" +
	"\vcreate_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12<\n" +
	"\tsend_time\x18\t \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x01R\bsendTime\x12f\n" +
	"\x12message_annotation\x18\a \x01(\v22.google.cloud.dialogflow.v2beta1.MessageAnnotationB\x03\xe0A\x03R\x11messageAnnotation\x12l\n" +
	"\x12sentiment_analysis\x18\b \x01(\v28.google.cloud.dialogflow.v2beta1.SentimentAnalysisResultB\x03\xe0A\x03R\x11sentimentAnalysis:\xc4\x01\xeaA\xc0\x01\n" +
	"!dialogflow.googleapis.com/Message\x12Bprojects/{project}/conversations/{conversation}/messages/{message}\x12Wprojects/{project}/locations/{location}/conversations/{conversation}/messages/{message}\"\xb6\x01\n" +
	"\x18CreateParticipantRequest\x12E\n" +
	"\x06parent\x18\x01 \x01(\tB-\xe0A\x02\xfaA'\x12%dialogflow.googleapis.com/ParticipantR\x06parent\x12S\n" +
	"\vparticipant\x18\x02 \x01(\v2,.google.cloud.dialogflow.v2beta1.ParticipantB\x03\xe0A\x02R\vparticipant\"Z\n" +
	...
	"\fparticipants\x18\x01 \x03(\v2,.google.cloud.dialogflow.v2beta1.ParticipantR\fparticipants\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xb1\x01\n" +
	"\x18UpdateParticipantRequest\x12S\n" +
	"\vparticipant\x18\x01 \x01(\v2,.google.cloud.dialogflow.v2beta1.ParticipantB\x03\xe0A\x02R\vparticipant\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"m\n" +
	"\n" +
	"AudioInput\x12I\n" +
	"\x06config\x18\x01 \x01(\v21.google.cloud.dialogflow.v2beta1.InputAudioConfigR\x06config\x12\x14\n" +
	"\x05audio\x18\x02 \x01(\fR\x05audio\"o\n" +
	"\vOutputAudio\x12J\n" +
	"\x06config\x18\x01 \x01(\v22.google.cloud.dialogflow.v2beta1.OutputAudioConfigR\x06config\x12\x14\n" +
	"\x05audio\x18\x02 \x01(\fR\x05audio\"\x81\a\n" +
	"\x13AutomatedAgentReply\x12m\n" +
	"\x16detect_intent_response\x18\x01 \x01(\v25.google.cloud.dialogflow.v2beta1.DetectIntentResponseH\x00R\x14detectIntentResponse\x12]\n" +
	"\x11response_messages\x18\x03 \x03(\v20.google.cloud.dialogflow.v2beta1.ResponseMessageR\x10responseMessages\x12?\n" +
	"\x06intent\x18\x04 \x01(\tB%\xfaA\"\n" +
	" dialogflow.googleapis.com/IntentH\x01R\x06intent\x12\x16\n" +
	"\x05event\x18\x05 \x01(\tH\x01R\x05event\x12)\n" +
	"\x10match_confidence\x18\t \x01(\x02R\x0fmatchConfidence\x127\n" +
	"\n" +
	"parameters\x18\n" +
	" \x01(\v2\x17.google.protobuf.StructR\n" +
	"parameters\x12O\n" +
	"\x15cx_session_parameters\x18\x06 \x01(\v2\x17.google.protobuf.StructB\x02\x18\x01R\x13cxSessionParameters\x12\x89\x01\n" +
	"\x1aautomated_agent_reply_type\x18\a \x01(\x0e2L.google.cloud.dialogflow.v2beta1.AutomatedAgentReply.AutomatedAgentReplyTypeR\x17automatedAgentReplyType\x12-\n" +
	"\x12allow_cancellation\x18\b \x01(\bR\x11allowCancellation\x12&\n" +
	"\x0fcx_current_page\x18\v \x01(\tR\rcxCurrentPage\x127\n" +
	"\x18call_companion_auth_code\x18\f \x01(\fR\x15callCompanionAuthCode\"]\n" +
	...
	"\ranswer_record\x18\x01 \x01(\tR\fanswerRecord\x12O\n" +
	"\rtext_override\x18\x02 \x01(\v2*.google.cloud.dialogflow.v2beta1.TextInputR\ftextOverride\x127\n" +
	"\n" +
	"parameters\x18\x04 \x01(\v2\x17.google.protobuf.StructR\n" +
	"parameters\x12T\n" +
	"\x06action\x18\x05 \x01(\x0e27.google.cloud.dialogflow.v2beta1.SuggestionInput.ActionB\x03\xe0A\x01R\x06action\x12O\n" +
	"\fintent_input\x18\x06 \x01(\v2,.google.cloud.dialogflow.v2beta1.IntentInputR\vintentInput\x12<\n" +
	...
	"\aCONFIRM\x10\x03\"T\n" +
	"\vIntentInput\x12\x1b\n" +
	"\x06intent\x18\x01 \x01(\tB\x03\xe0A\x02R\x06intent\x12(\n" +
	"\rlanguage_code\x18\x03 \x01(\tB\x03\xe0A\x02R\flanguageCode\"\x94\x02\n" +
	"\x11SuggestionFeature\x12K\n" +
	"\x04type\x18\x01 \x01(\x0e27.google.cloud.dialogflow.v2beta1.SuggestionFeature.TypeR\x04type\"\xb1\x01\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\x16\n" +
	"\x12ARTICLE_SUGGESTION\x10\x01\x12\a\n" +
	"\x03FAQ\x10\x02\x12\x0f\n" +
	"\vSMART_REPLY\x10\x03\x12\x15\n" +
	"\x11DIALOGFLOW_ASSIST\x10\x04\x12\x1e\n" +
	"\x1aCONVERSATION_SUMMARIZATION\x10\b\x12\x14\n" +
	"\x10KNOWLEDGE_SEARCH\x10\x0e\x12\x14\n" +
	"\x10KNOWLEDGE_ASSIST\x10\x0f\"\xf9\x01\n" +
	"\x15AssistQueryParameters\x12\x92\x01\n" +
	"\x1adocuments_metadata_filters\x18\x01 \x03(\v2T.google.cloud.dialogflow.v2beta1.AssistQueryParameters.DocumentsMetadataFiltersEntryR\x18documentsMetadataFilters\x1aK\n" +
	"\x1dDocumentsMetadataFiltersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x81\b\n" +
	"\x15AnalyzeContentRequest\x12O\n" +
	"\vparticipant\x18\x01 \x01(\tB-\xe0A\x02\xfaA'\n" +
	"%dialogflow.googleapis.com/ParticipantR\vparticipant\x12K\n" +
	"\n" +
	"text_input\x18\x06 \x01(\v2*.google.cloud.dialogflow.v2beta1.TextInputH\x00R\ttextInput\x12N\n" +
	"\vaudio_input\x18\a \x01(\v2+.google.cloud.dialogflow.v2beta1.AudioInputH\x00R\n" +
	"audioInput\x12N\n" +
	"\vevent_input\x18\b \x01(\v2+.google.cloud.dialogflow.v2beta1.EventInputH\x00R\n" +
	"eventInput\x12]\n" +
	"\x10suggestion_input\x18\f \x01(\v20.google.cloud.dialogflow.v2beta1.SuggestionInputH\x00R\x0fsuggestionInput\x12Q\n" +
	"\fintent_input\x18\r \x01(\v2,.google.cloud.dialogflow.v2beta1.IntentInputH\x00R\vintentInput\x12`\n" +
	"\x12reply_audio_config\x18\x05 \x01(\v22.google.cloud.dialogflow.v2beta1.OutputAudioConfigR\x10replyAudioConfig\x12S\n" +
	"\fquery_params\x18\t \x01(\v20.google.cloud.dialogflow.v2beta1.QueryParametersR\vqueryParams\x12f\n" +
	"\x13assist_query_params\x18\x0e \x01(\v26.google.cloud.dialogflow.v2beta1.AssistQueryParametersR\x11assistQueryParams\x12<\n" +
	"\rcx_parameters\x18\x12 \x01(\v2\x17.google.protobuf.StructR\fcxParameters\x12&\n" +
	"\x0fcx_current_page\x18\x14 \x01(\tR\rcxCurrentPage\x12K\n" +
	"\x11message_send_time\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x01R\x0fmessageSendTime\x12\x1d\n" +
	"\n" +
	"request_id\x18\v \x01(\tR\trequestIdB\a\n" +
	"\x05input\">\n" +
	"\x0eDtmfParameters\x12,\n" +
	"\x12accepts_dtmf_input\x18\x01 \x01(\bR\x10acceptsDtmfInput\"\xf8\x04\n" +
	"\x16AnalyzeContentResponse\x12\x1d\n" +
	"\n" +
	"reply_text\x18\x01 \x01(\tR\treplyText\x12M\n" +
	"\vreply_audio\x18\x02 \x01(\v2,.google.cloud.dialogflow.v2beta1.OutputAudioR\n" +
	"replyAudio\x12h\n" +
	"\x15automated_agent_reply\x18\x03 \x01(\v24.google.cloud.dialogflow.v2beta1.AutomatedAgentReplyR\x13automatedAgentReply\x12B\n" +
	"\amessage\x18\x05 \x01(\v2(.google.cloud.dialogflow.v2beta1.MessageR\amessage\x12v\n" +
	"\x1ehuman_agent_suggestion_results\x18\x06 \x03(\v21.google.cloud.dialogflow.v2beta1.SuggestionResultR\x1bhumanAgentSuggestionResults\x12p\n" +
	...
	"\faudio_config\x18\x02 \x01(\v21.google.cloud.dialogflow.v2beta1.InputAudioConfigH\x00R\vaudioConfig\x12S\n" +
	"\vtext_config\x18\x03 \x01(\v20.google.cloud.dialogflow.v2beta1.InputTextConfigH\x00R\n" +
	"textConfig\x12`\n" +
	"\x12reply_audio_config\x18\x04 \x01(\v22.google.cloud.dialogflow.v2beta1.OutputAudioConfigR\x10replyAudioConfig\x12!\n" +
	"\vinput_audio\x18\x05 \x01(\fH\x01R\n" +
	"inputAudio\x12\x1f\n" +
	"\n" +
	"input_text\x18\x06 \x01(\tH\x01R\tinputText\x12U\n" +
	"\n" +
	...
	"\x0fcx_current_page\x18\x0f \x01(\tR\rcxCurrentPage\x12?\n" +
	...
	"\x06configB\a\n" +
	"\x05input\"\xf8\x06\n" +
	"\x1fStreamingAnalyzeContentResponse\x12j\n" +
	"\x12recognition_result\x18\x01 \x01(\v2;.google.cloud.dialogflow.v2beta1.StreamingRecognitionResultR\x11recognitionResult\x12\x1d\n" +
	"\n" +
	"reply_text\x18\x02 \x01(\tR\treplyText\x12M\n" +
	"\vreply_audio\x18\x03 \x01(\v2,.google.cloud.dialogflow.v2beta1.OutputAudioR\n" +
	"replyAudio\x12h\n" +
	"\x15automated_agent_reply\x18\x04 \x01(\v24.google.cloud.dialogflow.v2beta1.AutomatedAgentReplyR\x13automatedAgentReply\x12B\n" +
	"\amessage\x18\x06 \x01(\v2(.google.cloud.dialogflow.v2beta1.MessageR\amessage\x12v\n" +
	"\x1ehuman_agent_suggestion_results\x18\a \x03(\v21.google.cloud.dialogflow.v2beta1.SuggestionResultR\x1bhumanAgentSuggestionResults\x12p\n" +
	"\x1bend_user_suggestion_results\x18\b \x03(\v21.google.cloud.dialogflow.v2beta1.SuggestionResultR\x18endUserSuggestionResults\x12X\n" +
	"\x0fdtmf_parameters\x18\n" +
	" \x01(\v2/.google.cloud.dialogflow.v2beta1.DtmfParametersR\x0edtmfParameters\x12f\n" +
	"\x0edebugging_info\x18\v \x01(\v2?.google.cloud.dialogflow.v2beta1.CloudConversationDebuggingInfoR\rdebuggingInfo\x12!\n" +
	"\fspeech_model\x18\r \x01(\tR\vspeechModel\"\x8c\x01\n" +
	"\x14AnnotatedMessagePart\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12\x1f\n" +
	"\ventity_type\x18\x02 \x01(\tR\n" +
	"entityType\x12?\n" +
	"\x0fformatted_value\x18\x03 \x01(\v2\x16.google.protobuf.ValueR\x0eformattedValue\"\x8b\x01\n" +
	"\x11MessageAnnotation\x12K\n" +
	"\x05parts\x18\x01 \x03(\v25.google.cloud.dialogflow.v2beta1.AnnotatedMessagePartR\x05parts\x12)\n" +
	"\x10contain_entities\x18\x02 \x01(\bR\x0fcontainEntities\"\x8f\x02\n" +
	"\rArticleAnswer\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12\x10\n" +
	"\x03uri\x18\x02 \x01(\tR\x03uri\x12\x1a\n" +
	"\bsnippets\x18\x03 \x03(\tR\bsnippets\x12X\n" +
	"\bmetadata\x18\x05 \x03(\v2<.google.cloud.dialogflow.v2beta1.ArticleAnswer.MetadataEntryR\bmetadata\x12#\n" +
	...
	"\bmetadata\x18\x05 \x03(\v28.google.cloud.dialogflow.v2beta1.FaqAnswer.MetadataEntryR\bmetadata\x12#\n" +
	"\ranswer_record\x18\x06 \x01(\tR\fanswerRecord\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x06intent\"\xfc\x01\n" +
	"\x16DialogflowAssistAnswer\x12Q\n" +
	...
	"!suggest_knowledge_assist_response\x18\b \x01(\v2?.google.cloud.dialogflow.v2beta1.SuggestKnowledgeAssistResponseH\x00R\x1esuggestKnowledgeAssistResponse\x12}\n" +
	"\x1csuggest_faq_answers_response\x18\x03 \x01(\v2:.google.cloud.dialogflow.v2beta1.SuggestFaqAnswersResponseH\x00R\x19suggestFaqAnswersResponse\x12\x83\x01\n" +
	...
	"\fcontext_size\x18\x03 \x01(\x05B\x03\xe0A\x01R\vcontextSize\x12k\n" +
	"\x13assist_query_params\x18\x04 \x01(\v26.google.cloud.dialogflow.v2beta1.AssistQueryParametersB\x03\xe0A\x01R\x11assistQueryParams\"\xbc\x01\n" +
	"\x17SuggestArticlesResponse\x12W\n" +
	"\x0farticle_answers\x18\x01 \x03(\v2..google.cloud.dialogflow.v2beta1.ArticleAnswerR\x0earticleAnswers\x12%\n" +
	"\x0elatest_message\x18\x02 \x01(\tR\rlatestMessage\x12!\n" +
	"\fcontext_size\x18\x03 \x01(\x05R\vcontextSize\"\xc8\x02\n" +
	...
	"!dialogflow.googleapis.com/MessageR\rlatestMessage\x12&\n" +
	"\fcontext_size\x18\x03 \x01(\x05B\x03\xe0A\x01R\vcontextSize\x12k\n" +
	"\x13assist_query_params\x18\x04 \x01(\v26.google.cloud.dialogflow.v2beta1.AssistQueryParametersB\x03\xe0A\x01R\x11assistQueryParams\"\xb2\x01\n" +
	"\x19SuggestFaqAnswersResponse\x12K\n" +
	"\vfaq_answers\x18\x01 \x03(\v2*.google.cloud.dialogflow.v2beta1.FaqAnswerR\n" +
	"faqAnswers\x12%\n" +
	"\x0elatest_message\x18\x02 \x01(\tR\rlatestMessage\x12!\n" +
	"\fcontext_size\x18\x03 \x01(\x05R\vcontextSize\"\xaf\x02\n" +
	"\x1aSuggestSmartRepliesRequest\x12E\n" +
	"\x06parent\x18\x01 \x01(\tB-\xe0A\x02\xfaA'\n" +
	"%dialogflow.googleapis.com/ParticipantR\x06parent\x12X\n" +
	"\x12current_text_input\x18\x04 \x01(\v2*.google.cloud.dialogflow.v2beta1.TextInputR\x10currentTextInput\x12M\n" +
	...
	"\x13smart_reply_answers\x18\x01 \x03(\v21.google.cloud.dialogflow.v2beta1.SmartReplyAnswerR\x11smartReplyAnswers\x12M\n" +
	"\x0elatest_message\x18\x02 \x01(\tB&\xfaA#\n" +
	"!dialogflow.googleapis.com/MessageR\rlatestMessage\x12!\n" +
	"\fcontext_size\x18\x03 \x01(\x05R\vcontextSize\"\x8b\x04\n" +
	"\x1bGenerateSuggestionsResponse\x12\x98\x01\n" +
	"\x1cgenerator_suggestion_answers\x18\x01 \x03(\v2V.google.cloud.dialogflow.v2beta1.GenerateSuggestionsResponse.GeneratorSuggestionAnswerR\x1ageneratorSuggestionAnswers\x12M\n" +
	"\x0elatest_message\x18\x02 \x01(\tB&\xfaA#\n" +
	"!dialogflow.googleapis.com/MessageR\rlatestMessage\x1a\x81\x02\n" +
	"\x19GeneratorSuggestionAnswer\x12g\n" +
	...
	"\x0elatest_message\x18\x02 \x01(\tR\rlatestMessage\x12!\n" +
	"\fcontext_size\x18\x03 \x01(\x05R\vcontextSize\"\xff\x06\n" +
	"\n" +
	"Suggestion\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12O\n" +
	"\barticles\x18\x02 \x03(\v23.google.cloud.dialogflow.v2beta1.Suggestion.ArticleR\barticles\x12V\n" +
	"\vfaq_answers\x18\x04 \x03(\v25.google.cloud.dialogflow.v2beta1.Suggestion.FaqAnswerR\n" +
	"faqAnswers\x12;\n" +
	"\vcreate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x12%\n" +
	"\x0elatest_message\x18\a \x01(\tR\rlatestMessage\x1a\x8e\x02\n" +
	"\aArticle\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12\x10\n" +
	"\x03uri\x18\x02 \x01(\tR\x03uri\x12\x1a\n" +
	"\bsnippets\x18\x03 \x03(\tR\bsnippets\x12]\n" +
	"\bmetadata\x18\x05 \x03(\v2A.google.cloud.dialogflow.v2beta1.Suggestion.Article.MetadataEntryR\bmetadata\x12#\n" +
	"\ranswer_record\x18\x06 \x01(\tR\fanswerRecord\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\bmetadata\x18\x05 \x03(\v2C.google.cloud.dialogflow.v2beta1.Suggestion.FaqAnswer.MetadataEntryR\bmetadata\x12#\n" +
	"\ranswer_record\x18\x06 \x01(\tR\fanswerRecord\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\x02\x18\x01\"\x88\x01\n" +
	"\x16ListSuggestionsRequest\x12\x16\n" +
	"\x06parent\x18\x01 \x01(\tR\x06parent\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken\x12\x16\n" +
	"\x06filter\x18\x04 \x01(\tR\x06filter:\x02\x18\x01\"\x94\x01\n" +
	"\x17ListSuggestionsResponse\x12M\n" +
	"\vsuggestions\x18\x01 \x03(\v2+.google.cloud.dialogflow.v2beta1.SuggestionR\vsuggestions\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken:\x02\x18\x01\"\x80\x01\n" +
	"\x18CompileSuggestionRequest\x12\x16\n" +
	"\x06parent\x18\x01 \x01(\tR\x06parent\x12%\n" +
	"\x0elatest_message\x18\x02 \x01(\tR\rlatestMessage\x12!\n" +
	"\fcontext_size\x18\x03 \x01(\x05R\vcontextSize:\x02\x18\x01\"\xb6\x01\n" +
	"\x19CompileSuggestionResponse\x12K\n" +
	"\n" +
	"suggestion\x18\x01 \x01(\v2+.google.cloud.dialogflow.v2beta1.SuggestionR\n" +
	"suggestion\x12%\n" +
	"\x0elatest_message\x18\x02 \x01(\tR\rlatestMessage\x12!\n" +
	"\fcontext_size\x18\x03 \x01(\x05R\vcontextSize:\x02\x18\x01\"\xaf\b\n" +
	"\x0fResponseMessage\x12K\n" +
	"\x04text\x18\x01 \x01(\v25.google.cloud.dialogflow.v2beta1.ResponseMessage.TextH\x00R\x04text\x123\n" +
	"\apayload\x18\x02 \x01(\v2\x17.google.protobuf.StructH\x00R\apayload\x12q\n" +
	"\x12live_agent_handoff\x18\x03 \x01(\v2A.google.cloud.dialogflow.v2beta1.ResponseMessage.LiveAgentHandoffH\x00R\x10liveAgentHandoff\x12j\n" +
	"\x0fend_interaction\x18\x04 \x01(\v2?.google.cloud.dialogflow.v2beta1.ResponseMessage.EndInteractionH\x00R\x0eendInteraction\x12^\n" +
	"\vmixed_audio\x18\x05 \x01(\v2;.google.cloud.dialogflow.v2beta1.ResponseMessage.MixedAudioH\x00R\n" +
	"mixedAudio\x12\x80\x01\n" +
	"\x17telephony_transfer_call\x18\x06 \x01(\v2F.google.cloud.dialogflow.v2beta1.ResponseMessage.TelephonyTransferCallH\x00R\x15telephonyTransferCall\x1a\x1a\n" +
	"\x04Text\x12\x12\n" +
	"\x04text\x18\x01 \x03(\tR\x04text\x1aG\n" +
	"\x10LiveAgentHandoff\x123\n" +
	"\bmetadata\x18\x01 \x01(\v2\x17.google.protobuf.StructR\bmetadata\x1a\x10\n" +
	"\x0eEndInteraction\x1a\xf0\x01\n" +
	"\n" +
	"MixedAudio\x12_\n" +
	"\bsegments\x18\x01 \x03(\v2C.google.cloud.dialogflow.v2beta1.ResponseMessage.MixedAudio.SegmentR\bsegments\x1a\x80\x01\n" +
	"\aSegment\x12\x16\n" +
	"\x05audio\x18\x01 \x01(\fH\x00R\x05audio\x12\x12\n" +
	"\x03uri\x18\x02 \x01(\tH\x00R\x03uri\x12>\n" +
	"\x1ballow_playback_interruption\x18\x03 \x01(\bR\x19allowPlaybackInterruptionB\t\n" +
	"\acontent\x1ac\n" +
	"\x15TelephonyTransferCall\x12#\n" +
	"\fphone_number\x18\x01 \x01(\tH\x00R\vphoneNumber\x12\x19\n" +
	"\asip_uri\x18\x02 \x01(\tH\x00R\x06sipUriB\n" +
	"\n" +
	"\bendpointB\t\n" +
	"\amessage\"\x9f\x02\n" +
	...
	"\x18previous_suggested_query\x18\x04 \x01(\tB\x03\xe0A\x01R\x16previousSuggestedQuery\"\xdf\x01\n" +
	"\x1eSuggestKnowledgeAssistResponse\x12s\n" +
	"\x17knowledge_assist_answer\x18\x01 \x01(\v26.google.cloud.dialogflow.v2beta1.KnowledgeAssistAnswerB\x03\xe0A\x03R\x15knowledgeAssistAnswer\x12%\n" +
	"\x0elatest_message\x18\x02 \x01(\tR\rlatestMessage\x12!\n" +
	"\fcontext_size\x18\x03 \x01(\x05R\vcontextSize\"\xae\x06\n" +
	"!IngestedContextReferenceDebugInfo\x126\n" +
	"\x17project_not_allowlisted\x18\x01 \x01(\bR\x15projectNotAllowlisted\x12>\n" +
	"\x1bcontext_reference_retrieved\x18\x02 \x01(\bR\x19contextReferenceRetrieved\x12\xa2\x01\n" +
	"\x1eingested_parameters_debug_info\x18\x03 \x03(\v2].google.cloud.dialogflow.v2beta1.IngestedContextReferenceDebugInfo.IngestedParameterDebugInfoR\x1bingestedParametersDebugInfo\x1a\xeb\x03\n" +
	"\x1aIngestedParameterDebugInfo\x12\x1c\n" +
	"\tparameter\x18\x01 \x01(\tR\tparameter\x12\x98\x01\n" +
	"\x10ingestion_status\x18\x02 \x01(\x0e2m.google.cloud.dialogflow.v2beta1.IngestedContextReferenceDebugInfo.IngestedParameterDebugInfo.IngestionStatusR\x0fingestionStatus\"\x93\x02\n" +
	...
	"\"INGESTION_STATUS_LANGUAGE_MISMATCH\x10\x06\"\xe1\x02\n" +
	"\x0eServiceLatency\x12\x84\x01\n" +
	"\x1ainternal_service_latencies\x18\x01 \x03(\v2F.google.cloud.dialogflow.v2beta1.ServiceLatency.InternalServiceLatencyR\x18internalServiceLatencies\x1a\xc7\x01\n" +
	...
	"\rcomplete_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\fcompleteTime\"\x9e\x15\n" +
	...
	"\x19datastore_response_reason\x18\x03 \x01(\x0e28.google.cloud.dialogflow.v2beta1.DatastoreResponseReasonR\x17datastoreResponseReason\x12\x8d\x01\n" +
	"\x19knowledge_assist_behavior\x18\x04 \x01(\v2Q.google.cloud.dialogflow.v2beta1.KnowledgeAssistDebugInfo.KnowledgeAssistBehaviorR\x17knowledgeAssistBehavior\x12\x94\x01\n" +
	"%ingested_context_reference_debug_info\x18\x05 \x01(\v2B.google.cloud.dialogflow.v2beta1.IngestedContextReferenceDebugInfoR!ingestedContextReferenceDebugInfo\x12X\n" +
	"\x0fservice_latency\x18\x06 \x01(\v2/.google.cloud.dialogflow.v2beta1.ServiceLatencyR\x0eserviceLatency\x1a\x9d\t\n" +
	...
	"\x1bQUERY_CATEGORIZATION_FAILED\x10\x03\"\xc7\b\n" +
	"\x15KnowledgeAssistAnswer\x12n\n" +
	"\x0fsuggested_query\x18\x01 \x01(\v2E.google.cloud.dialogflow.v2beta1.KnowledgeAssistAnswer.SuggestedQueryR\x0esuggestedQuery\x12|\n" +
	"\x16suggested_query_answer\x18\x02 \x01(\v2F.google.cloud.dialogflow.v2beta1.KnowledgeAssistAnswer.KnowledgeAnswerR\x14suggestedQueryAnswer\x12#\n" +
	"\ranswer_record\x18\x03 \x01(\tR\fanswerRecord\x12x\n" +
	"\x1bknowledge_assist_debug_info\x18\a \x01(\v29.google.cloud.dialogflow.v2beta1.KnowledgeAssistDebugInfoR\x18knowledgeAssistDebugInfo\x1a/\n" +
	"\x0eSuggestedQuery\x12\x1d\n" +
	"\n" +
	"query_text\x18\x01 \x01(\tR\tqueryText\x1a\xef\x04\n" +
	"\x0fKnowledgeAnswer\x12\x1f\n" +
	"\vanswer_text\x18\x01 \x01(\tR\n" +
	"answerText\x12q\n" +
	"\n" +
	"faq_source\x18\x03 \x01(\v2P.google.cloud.dialogflow.v2beta1.KnowledgeAssistAnswer.KnowledgeAnswer.FaqSourceH\x00R\tfaqSource\x12\x86\x01\n" +
	"\x11generative_source\x18\x04 \x01(\v2W.google.cloud.dialogflow.v2beta1.KnowledgeAssistAnswer.KnowledgeAnswer.GenerativeSourceH\x00R\x10generativeSource\x1a'\n" +
	"\tFaqSource\x12\x1a\n" +
	"\bquestion\x18\x02 \x01(\tR\bquestion\x1a\x8b\x02\n" +
	"\x10GenerativeSource\x12{\n" +
	"\bsnippets\x18\x01 \x03(\v2_.google.cloud.dialogflow.v2beta1.KnowledgeAssistAnswer.KnowledgeAnswer.GenerativeSource.SnippetR\bsnippets\x1az\n" +
	"\aSnippet\x12\x10\n" +
	...
	"\x13SuggestSmartReplies\x12;.google.cloud.dialogflow.v2beta1.SuggestSmartRepliesRequest\x1a<.google.cloud.dialogflow.v2beta1.SuggestSmartRepliesResponse\"\xde\x01\xdaA\x06parent\x82\xd3\xe4\x93\x02\xce\x01:\x01*Zl:\x01*\"g/v2beta1/{parent=projects/*/locations/*/conversations/*/participants/*}/suggestions:suggestSmartReplies\"[/v2beta1/{parent=projects/*/conversations/*/participants/*}/suggestions:suggestSmartReplies\x12\xf7\x02\n" +
	"\x16SuggestKnowledgeAssist\x12>.google.cloud.dialogflow.v2beta1.SuggestKnowledgeAssistRequest\x1a?.google.cloud.dialogflow.v2beta1.SuggestKnowledgeAssistResponse\"\xdb\x01\x82\xd3\xe4\x93\x02\xd4\x01:\x01*Zo:\x01*\"j/v2beta1/{parent=projects/*/locations/*/conversations/*/participants/*}/suggestions:suggestKnowledgeAssist\"^/v2beta1/{parent=projects/*/conversations/*/participants/*}/suggestions:suggestKnowledgeAssist\x12\xd8\x01\n" +
	"\x0fListSuggestions\x127.google.cloud.dialogflow.v2beta1.ListSuggestionsRequest\x1a8.google.cloud.dialogflow.v2beta1.ListSuggestionsResponse\"R\x82\xd3\xe4\x93\x02I\x12G/v2beta1/{parent=projects/*/conversations/*/participants/*}/suggestions\x88\x02\x01\x12\xe9\x01\n" +
	"\x11CompileSuggestion\x129.google.cloud.dialogflow.v2beta1.CompileSuggestionRequest\x1a:.google.cloud.dialogflow.v2beta1.CompileSuggestionResponse\"]\x82\xd3\xe4\x93\x02T:\x01*\"O/v2beta1/{parent=projects/*/conversations/*/participants/*}/suggestions:compile\x88\x02\x01\x1ax\xcaA\x19dialogflow.googleapis.com\xd2AYhttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflowB\xa5\x01\n" +
...
var (
	...
	file_google_cloud_dialogflow_v2beta1_participant_proto_rawDescData []byte
)
...
func file_google_cloud_dialogflow_v2beta1_participant_proto_rawDescGZIP() []byte {
	file_google_cloud_dialogflow_v2beta1_participant_proto_rawDescOnce.Do(func() {
		file_google_cloud_dialogflow_v2beta1_participant_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_dialogflow_v2beta1_participant_proto_rawDesc), len(file_google_cloud_dialogflow_v2beta1_participant_proto_rawDesc)))
	})
