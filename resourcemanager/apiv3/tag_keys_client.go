...
func NewTagKeysClient(ctx context.Context, opts ...option.ClientOption) (*TagKeysClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.ListTagKeys = append(client.CallOptions.ListTagKeys, gax.WithClientMetrics(metrics))
		client.CallOptions.GetTagKey = append(client.CallOptions.GetTagKey, gax.WithClientMetrics(metrics))
		client.CallOptions.GetNamespacedTagKey = append(client.CallOptions.GetNamespacedTagKey, gax.WithClientMetrics(metrics))
		client.CallOptions.CreateTagKey = append(client.CallOptions.CreateTagKey, gax.WithClientMetrics(metrics))
		client.CallOptions.UpdateTagKey = append(client.CallOptions.UpdateTagKey, gax.WithClientMetrics(metrics))
		client.CallOptions.DeleteTagKey = append(client.CallOptions.DeleteTagKey, gax.WithClientMetrics(metrics))
...
// NewTagKeysRESTClient creates a new tag keys rest client.
//
// Allow users to create and manage tag keys.
func NewTagKeysRESTClient(ctx context.Context, opts ...option.ClientOption) (*TagKeysClient, error) {
	clientOpts := append(defaultTagKeysRESTClientOptions(), opts...)
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		clientOpts = append(clientOpts, internaloption.WithTelemetryAttributes(map[string]string{
			"gcp.client.service":  "cloudresourcemanager",
			"gcp.client.version":  getVersionClient(),
	...
	callOpts := defaultTagKeysRESTCallOptions()
	c := &tagKeysRESTClient{
		endpoint:    endpoint,
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.ListTagKeys = append(callOpts.ListTagKeys, gax.WithClientMetrics(metrics))
		callOpts.GetTagKey = append(callOpts.GetTagKey, gax.WithClientMetrics(metrics))
		callOpts.GetNamespacedTagKey = append(callOpts.GetNamespacedTagKey, gax.WithClientMetrics(metrics))
		callOpts.CreateTagKey = append(callOpts.CreateTagKey, gax.WithClientMetrics(metrics))
		callOpts.UpdateTagKey = append(callOpts.UpdateTagKey, gax.WithClientMetrics(metrics))
		callOpts.DeleteTagKey = append(callOpts.DeleteTagKey, gax.WithClientMetrics(metrics))
	...
	return &TagKeysClient{internalClient: c, CallOptions: callOpts}, nil
}
...
func (c *tagKeysRESTClient) Connection() *grpc.ClientConn {
	return nil
}
func (c *tagKeysGRPCClient) ListTagKeys(ctx context.Context, req *resourcemanagerpb.ListTagKeysRequest, opts ...gax.CallOption) *TagKeyIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.resourcemanager.v3.TagKeys/ListTagKeys")
	}
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*resourcemanagerpb.TagKey, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.tagKeysClient.ListTagKeys, req, settings.GRPC, c.logger, "ListTagKeys")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *tagKeysGRPCClient) GetTagKey(ctx context.Context, req *resourcemanagerpb.GetTagKeyRequest, opts ...gax.CallOption) (*resourcemanagerpb.TagKey, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.tagKeysClient.GetTagKey, req, settings.GRPC, c.logger, "GetTagKey")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *tagKeysGRPCClient) GetNamespacedTagKey(ctx context.Context, req *resourcemanagerpb.GetNamespacedTagKeyRequest, opts ...gax.CallOption) (*resourcemanagerpb.TagKey, error) {
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, c.xGoogHeaders...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.resourcemanager.v3.TagKeys/GetNamespacedTagKey")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.tagKeysClient.GetNamespacedTagKey, req, settings.GRPC, c.logger, "GetNamespacedTagKey")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *tagKeysGRPCClient) CreateTagKey(ctx context.Context, req *resourcemanagerpb.CreateTagKeyRequest, opts ...gax.CallOption) (*CreateTagKeyOperation, error) {
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, c.xGoogHeaders...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.resourcemanager.v3.TagKeys/CreateTagKey")
	}
	opts = append((*c.CallOptions).CreateTagKey[0:len((*c.CallOptions).CreateTagKey):len((*c.CallOptions).CreateTagKey)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.tagKeysClient.CreateTagKey, req, settings.GRPC, c.logger, "CreateTagKey")
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	lro := longrunning.InternalNewOperationWithMetadata(*c.LROClient, resp, "*resourcemanager.CreateTagKeyOperation")
...
func (c *tagKeysGRPCClient) UpdateTagKey(ctx context.Context, req *resourcemanagerpb.UpdateTagKeyRequest, opts ...gax.CallOption) (*UpdateTagKeyOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "tag_key.name", url.QueryEscape(req.GetTagKey().GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.resourcemanager.v3.TagKeys/UpdateTagKey")
	}
	opts = append((*c.CallOptions).UpdateTagKey[0:len((*c.CallOptions).UpdateTagKey):len((*c.CallOptions).UpdateTagKey)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.tagKeysClient.UpdateTagKey, req, settings.GRPC, c.logger, "UpdateTagKey")
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	lro := longrunning.InternalNewOperationWithMetadata(*c.LROClient, resp, "*resourcemanager.UpdateTagKeyOperation")
	if gax.IsFeatureEnabled("TRACING") {
		lro.SetParentSpanContext(trace.SpanContextFromContext(ctx))
	}
...
func (c *tagKeysGRPCClient) DeleteTagKey(ctx context.Context, req *resourcemanagerpb.DeleteTagKeyRequest, opts ...gax.CallOption) (*DeleteTagKeyOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.tagKeysClient.DeleteTagKey, req, settings.GRPC, c.logger, "DeleteTagKey")
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	lro := longrunning.InternalNewOperationWithMetadata(*c.LROClient, resp, "*resourcemanager.DeleteTagKeyOperation")
	if gax.IsFeatureEnabled("TRACING") {
		lro.SetParentSpanContext(trace.SpanContextFromContext(ctx))
	}
...
func (c *tagKeysGRPCClient) GetIamPolicy(ctx context.Context, req *iampb.GetIamPolicyRequest, opts ...gax.CallOption) (*iampb.Policy, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.tagKeysClient.GetIamPolicy, req, settings.GRPC, c.logger, "GetIamPolicy")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *tagKeysGRPCClient) SetIamPolicy(ctx context.Context, req *iampb.SetIamPolicyRequest, opts ...gax.CallOption) (*iampb.Policy, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.tagKeysClient.SetIamPolicy, req, settings.GRPC, c.logger, "SetIamPolicy")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *tagKeysGRPCClient) TestIamPermissions(ctx context.Context, req *iampb.TestIamPermissionsRequest, opts ...gax.CallOption) (*iampb.TestIamPermissionsResponse, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.tagKeysClient.TestIamPermissions, req, settings.GRPC, c.logger, "TestIamPermissions")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
// ListTagKeys lists all TagKeys for a parent resource.
func (c *tagKeysRESTClient) ListTagKeys(ctx context.Context, req *resourcemanagerpb.ListTagKeysRequest, opts ...gax.CallOption) *TagKeyIterator {
	it := &TagKeyIterator{}
	req = proto.CloneOf(req)
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*resourcemanagerpb.TagKey, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v3/tagKeys")
		...
		e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			...
			buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "ListTagKeys")
			if err != nil {
				return err
			}
...
// GetTagKey retrieves a TagKey. This method will return PERMISSION_DENIED if the
// key does not exist or the user does not have permission to view it.
func (c *tagKeysRESTClient) GetTagKey(ctx context.Context, req *resourcemanagerpb.GetTagKeyRequest, opts ...gax.CallOption) (*resourcemanagerpb.TagKey, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "GetTagKey")
		if err != nil {
			return err
		}
...
func (c *tagKeysRESTClient) GetNamespacedTagKey(ctx context.Context, req *resourcemanagerpb.GetNamespacedTagKeyRequest, opts ...gax.CallOption) (*resourcemanagerpb.TagKey, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.resourcemanager.v3.TagKeys/GetNamespacedTagKey")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v3/tagKeys/namespaced")
	}
	opts = append((*c.CallOptions).GetNamespacedTagKey[0:len((*c.CallOptions).GetNamespacedTagKey):len((*c.CallOptions).GetNamespacedTagKey)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &resourcemanagerpb.TagKey{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "GetNamespacedTagKey")
		if err != nil {
			return err
		}
...
func (c *tagKeysRESTClient) CreateTagKey(ctx context.Context, req *resourcemanagerpb.CreateTagKeyRequest, opts ...gax.CallOption) (*CreateTagKeyOperation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.resourcemanager.v3.TagKeys/CreateTagKey")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v3/tagKeys")
	}
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "CreateTagKey")
		if err != nil {
			return err
		}
		if err := unm.Unmarshal(buf, resp); err != nil {
...
// UpdateTagKey updates the attributes of the TagKey resource.
func (c *tagKeysRESTClient) UpdateTagKey(ctx context.Context, req *resourcemanagerpb.UpdateTagKeyRequest, opts ...gax.CallOption) (*UpdateTagKeyOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetTagKey()
	jsonReq, err := m.Marshal(body)
	if err != nil {
	...
	baseUrl.Path += fmt.Sprintf("/v3/%v", req.GetTagKey().GetName())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.resourcemanager.v3.TagKeys/UpdateTagKey")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v3/{tag_key.name=tagKeys/*}")
	}
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &longrunningpb.Operation{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "UpdateTagKey")
		if err != nil {
			return err
		}
		if err := unm.Unmarshal(buf, resp); err != nil {
...
// DeleteTagKey deletes a TagKey. The TagKey cannot be deleted if it has any child
// TagValues.
func (c *tagKeysRESTClient) DeleteTagKey(ctx context.Context, req *resourcemanagerpb.DeleteTagKeyRequest, opts ...gax.CallOption) (*DeleteTagKeyOperation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "DeleteTagKey")
		if err != nil {
			return err
		}
		if err := unm.Unmarshal(buf, resp); err != nil {
...
// cloudresourcemanager.googleapis.com/tagKeys.getIamPolicy permission on
// the specified TagKey.
func (c *tagKeysRESTClient) GetIamPolicy(ctx context.Context, req *iampb.GetIamPolicyRequest, opts ...gax.CallOption) (*iampb.Policy, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
...
// The caller must have resourcemanager.tagKeys.setIamPolicy permission
// on the identified tagValue.
func (c *tagKeysRESTClient) SetIamPolicy(ctx context.Context, req *iampb.SetIamPolicyRequest, opts ...gax.CallOption) (*iampb.Policy, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
...
//
// There are no permissions required for making this API call.
func (c *tagKeysRESTClient) TestIamPermissions(ctx context.Context, req *iampb.TestIamPermissionsRequest, opts ...gax.CallOption) (*iampb.TestIamPermissionsResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
...
func (c *tagKeysGRPCClient) CreateTagKeyOperation(name string) *CreateTagKeyOperation {
	return &CreateTagKeyOperation{
		lro: longrunning.InternalNewOperationWithMetadata(*c.LROClient, &longrunningpb.Operation{Name: name}, "*resourcemanager.CreateTagKeyOperation"),
	}
}

// CreateTagKeyOperation returns a new CreateTagKeyOperation from a given name.
// The name must be that of a previously created CreateTagKeyOperation, possibly from a different process.
func (c *tagKeysRESTClient) CreateTagKeyOperation(name string) *CreateTagKeyOperation {
...
func (c *tagKeysGRPCClient) DeleteTagKeyOperation(name string) *DeleteTagKeyOperation {
	return &DeleteTagKeyOperation{
		lro: longrunning.InternalNewOperationWithMetadata(*c.LROClient, &longrunningpb.Operation{Name: name}, "*resourcemanager.DeleteTagKeyOperation"),
	}
}

// DeleteTagKeyOperation returns a new DeleteTagKeyOperation from a given name.
// The name must be that of a previously created DeleteTagKeyOperation, possibly from a different process.
func (c *tagKeysRESTClient) DeleteTagKeyOperation(name string) *DeleteTagKeyOperation {
	override := fmt.Sprintf("/v3/%s", name)
	return &DeleteTagKeyOperation{
		lro:      longrunning.InternalNewOperationWithMetadata(*c.LROClient, &longrunningpb.Operation{Name: name}, "*resourcemanager.DeleteTagKeyOperation"),
		pollPath: override,
...
func (c *tagKeysGRPCClient) UpdateTagKeyOperation(name string) *UpdateTagKeyOperation {
	return &UpdateTagKeyOperation{
		lro: longrunning.InternalNewOperationWithMetadata(*c.LROClient, &longrunningpb.Operation{Name: name}, "*resourcemanager.UpdateTagKeyOperation"),
	}
}

// UpdateTagKeyOperation returns a new UpdateTagKeyOperation from a given name.
// The name must be that of a previously created UpdateTagKeyOperation, possibly from a different process.
func (c *tagKeysRESTClient) UpdateTagKeyOperation(name string) *UpdateTagKeyOperation {
	override := fmt.Sprintf("/v3/%s", name)
	return &UpdateTagKeyOperation{
		lro:      longrunning.InternalNewOperationWithMetadata(*c.LROClient, &longrunningpb.Operation{Name: name}, "*resourcemanager.UpdateTagKeyOperation"),
		pollPath: override,
