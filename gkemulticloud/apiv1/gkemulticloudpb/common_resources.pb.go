...
func file_google_cloud_gkemulticloud_v1_common_resources_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_gkemulticloud_v1_common_resources_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_gkemulticloud_v1_common_resources_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
