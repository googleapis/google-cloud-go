...
// Azure from the Google Cloud Console. When you create a cluster with GKE
// Multi-Cloud, Google creates the resources needed and brings up a cluster
// on your behalf. You can deploy workloads with the GKE Multi-Cloud API or
...
//
//	// go get cloud.google.com/go/gkemulticloud/apiv1@latest
