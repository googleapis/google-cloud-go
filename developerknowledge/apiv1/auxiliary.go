...
type DocumentChunkIterator struct {
	items    []*developerknowledgepb.DocumentChunk
...
func (it *DocumentChunkIterator) Next() (*developerknowledgepb.DocumentChunk, error) {
	var item *developerknowledgepb.DocumentChunk
...
func (it *DocumentChunkIterator) bufLen() int {
	return len(it.items)
}

func (it *DocumentChunkIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
