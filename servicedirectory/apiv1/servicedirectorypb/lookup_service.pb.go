...
const file_google_cloud_servicedirectory_v1_lookup_service_proto_rawDesc = "" +
	"\n" +
	"5google/cloud/servicedirectory/v1/lookup_service.proto\x12 google.cloud.servicedirectory.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a.google/cloud/servicedirectory/v1/service.proto\"\xb4\x01\n" +
	...
	"\x0fendpoint_filter\x18\x03 \x01(\tB\x03\xe0A\x01R\x0eendpointFilter\"]\n" +
	"\x16ResolveServiceResponse\x12C\n" +
	"\aservice\x18\x01 \x01(\v2).google.cloud.servicedirectory.v1.ServiceR\aservice2\xb8\x02\n" +
	"\rLookupService\x12\xd1\x01\n" +
	"\x0eResolveService\x127.google.cloud.servicedirectory.v1.ResolveServiceRequest\x1a8.google.cloud.servicedirectory.v1.ResolveServiceResponse\"L\x82\xd3\xe4\x93\x02F:\x01*\"A/v1/{name=projects/*/locations/*/namespaces/*/services/*}:resolve\x1aS\xcaA\x1fservicedirectory.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xfa\x01\n" +
...
var (
	...
	file_google_cloud_servicedirectory_v1_lookup_service_proto_rawDescData []byte
)
...
func file_google_cloud_servicedirectory_v1_lookup_service_proto_rawDescGZIP() []byte {
	file_google_cloud_servicedirectory_v1_lookup_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_servicedirectory_v1_lookup_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_servicedirectory_v1_lookup_service_proto_rawDesc), len(file_google_cloud_servicedirectory_v1_lookup_service_proto_rawDesc)))
	})
...
func file_google_cloud_servicedirectory_v1_lookup_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_servicedirectory_v1_lookup_service_proto_rawDesc), len(file_google_cloud_servicedirectory_v1_lookup_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
