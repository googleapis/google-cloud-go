...
const file_google_devtools_cloudtrace_v1_trace_proto_rawDesc = "" +
	"\n" +
	")google/devtools/cloudtrace/v1/trace.proto\x12\x1dgoogle.devtools.cloudtrace.v1\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/api/annotations.proto\"\x81\x01\n" +
	"\x05Trace\x12\x1d\n" +
	"\n" +
	"project_id\x18\x01 \x01(\tR\tprojectId\x12\x19\n" +
	"\btrace_id\x18\x02 \x01(\tR\atraceId\x12>\n" +
	"\x05spans\x18\x03 \x03(\v2(.google.devtools.cloudtrace.v1.TraceSpanR\x05spans\"F\n" +
	"\x06Traces\x12<\n" +
	"\x06traces\x18\x01 \x03(\v2$.google.devtools.cloudtrace.v1.TraceR\x06traces\"\xec\x03\n" +
	"\tTraceSpan\x12\x17\n" +
	"\aspan_id\x18\x01 \x01(\x06R\x06spanId\x12E\n" +
	"\x04kind\x18\x02 \x01(\x0e21.google.devtools.cloudtrace.v1.TraceSpan.SpanKindR\x04kind\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x129\n" +
	"\n" +
	"start_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x125\n" +
	"\bend_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\x12)\n" +
	"\x0eparent_span_id\x18\x06 \x01(\x06B\x03\xe0A\x01R\fparentSpanId\x12L\n" +
	"\x06labels\x18\a \x03(\v24.google.devtools.cloudtrace.v1.TraceSpan.LabelsEntryR\x06labels\x1a9\n" +
	...
	"\n" +
	"RPC_CLIENT\x10\x02\"\xcb\x03\n" +
	"\x11ListTracesRequest\x12\"\n" +
	"\n" +
	"project_id\x18\x01 \x01(\tB\x03\xe0A\x02R\tprojectId\x12R\n" +
	"\x04view\x18\x02 \x01(\x0e29.google.devtools.cloudtrace.v1.ListTracesRequest.ViewTypeB\x03\xe0A\x01R\x04view\x12 \n" +
	"\tpage_size\x18\x03 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\x1d\n" +
	"\n" +
	...
	"\border_by\x18\b \x01(\tB\x03\xe0A\x01R\aorderBy\"N\n" +
	"\bViewType\x12\x19\n" +
	"\x15VIEW_TYPE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aMINIMAL\x10\x01\x12\f\n" +
	"\bROOTSPAN\x10\x02\x12\f\n" +
	"\bCOMPLETE\x10\x03\"z\n" +
	"\x12ListTracesResponse\x12<\n" +
	"\x06traces\x18\x01 \x03(\v2$.google.devtools.cloudtrace.v1.TraceR\x06traces\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"U\n" +
	"\x0fGetTraceRequest\x12\"\n" +
	"\n" +
	"project_id\x18\x01 \x01(\tB\x03\xe0A\x02R\tprojectId\x12\x1e\n" +
	"\btrace_id\x18\x02 \x01(\tB\x03\xe0A\x02R\atraceId\"|\n" +
	"\x12PatchTracesRequest\x12\"\n" +
	"\n" +
	"project_id\x18\x01 \x01(\tB\x03\xe0A\x02R\tprojectId\x12B\n" +
	"\x06traces\x18\x02 \x01(\v2%.google.devtools.cloudtrace.v1.TracesB\x03\xe0A\x02R\x06traces2\xb5\x05\n" +
	"\fTraceService\x12\xa8\x01\n" +
	"\n" +
	...
	"\bGetTrace\x12..google.devtools.cloudtrace.v1.GetTraceRequest\x1a$.google.devtools.cloudtrace.v1.Trace\"I\xdaA\x13project_id,trace_id\x82\xd3\xe4\x93\x02-\x12+/v1/projects/{project_id}/traces/{trace_id}\x12\x9e\x01\n" +
	"\vPatchTraces\x121.google.devtools.cloudtrace.v1.PatchTracesRequest\x1a\x16.google.protobuf.Empty\"D\xdaA\x11project_id,traces\x82\xd3\xe4\x93\x02*:\x06traces2 /v1/projects/{project_id}/traces\x1a\xaa\x01\xcaA\x19cloudtrace.googleapis.com\xd2A\x8a\x01https://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/trace.append,https://www.googleapis.com/auth/trace.readonlyB\xad\x01\n" +
...
var (
	...
	file_google_devtools_cloudtrace_v1_trace_proto_rawDescData []byte
)
...
func file_google_devtools_cloudtrace_v1_trace_proto_rawDescGZIP() []byte {
	file_google_devtools_cloudtrace_v1_trace_proto_rawDescOnce.Do(func() {
		file_google_devtools_cloudtrace_v1_trace_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_devtools_cloudtrace_v1_trace_proto_rawDesc), len(file_google_devtools_cloudtrace_v1_trace_proto_rawDesc)))
	})
...
func file_google_devtools_cloudtrace_v1_trace_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_devtools_cloudtrace_v1_trace_proto_rawDesc), len(file_google_devtools_cloudtrace_v1_trace_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
