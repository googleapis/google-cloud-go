...
const file_google_cloud_iot_v1_resources_proto_rawDesc = "" +
	"\n" +
	...
	"\vcredentials\x18\f \x03(\v2%.google.cloud.iot.v1.DeviceCredentialR\vcredentials\x12J\n" +
	...
	"\x11last_error_status\x18\v \x01(\v2\x12.google.rpc.StatusR\x0flastErrorStatus\x129\n" +
	"\x06config\x18\r \x01(\v2!.google.cloud.iot.v1.DeviceConfigR\x06config\x126\n" +
	"\x05state\x18\x10 \x01(\v2 .google.cloud.iot.v1.DeviceStateR\x05state\x12:\n" +
	"\tlog_level\x18\x15 \x01(\x0e2\x1d.google.cloud.iot.v1.LogLevelR\blogLevel\x12E\n" +
	"\bmetadata\x18\x11 \x03(\v2).google.cloud.iot.v1.Device.MetadataEntryR\bmetadata\x12I\n" +
	"\x0egateway_config\x18\x18 \x01(\v2\".google.cloud.iot.v1.GatewayConfigR\rgatewayConfig\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:s\xeaAp\n" +
	"\x1ecloudiot.googleapis.com/Device\x12Nprojects/{project}/locations/{location}/registries/{registry}/devices/{device}\"\xbe\x02\n" +
	"\rGatewayConfig\x12C\n" +
	"\fgateway_type\x18\x01 \x01(\x0e2 .google.cloud.iot.v1.GatewayTypeR\vgatewayType\x12V\n" +
	"\x13gateway_auth_method\x18\x02 \x01(\x0e2&.google.cloud.iot.v1.GatewayAuthMethodR\x11gatewayAuthMethod\x127\n" +
	"\x18last_accessed_gateway_id\x18\x03 \x01(\tR\x15lastAccessedGatewayId\x12W\n" +
	"\x1alast_accessed_gateway_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x17lastAccessedGatewayTime\"\xfb\x04\n" +
	"\x0eDeviceRegistry\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12j\n" +
	"\x1aevent_notification_configs\x18\n" +
	" \x03(\v2,.google.cloud.iot.v1.EventNotificationConfigR\x18eventNotificationConfigs\x12h\n" +
	"\x19state_notification_config\x18\a \x01(\v2,.google.cloud.iot.v1.StateNotificationConfigR\x17stateNotificationConfig\x12@\n" +
	"\vmqtt_config\x18\x04 \x01(\v2\x1f.google.cloud.iot.v1.MqttConfigR\n" +
	"mqttConfig\x12@\n" +
	"\vhttp_config\x18\t \x01(\v2\x1f.google.cloud.iot.v1.HttpConfigR\n" +
	"httpConfig\x12:\n" +
	"\tlog_level\x18\v \x01(\x0e2\x1d.google.cloud.iot.v1.LogLevelR\blogLevel\x12I\n" +
	"\vcredentials\x18\b \x03(\v2'.google.cloud.iot.v1.RegistryCredentialR\vcredentials:d\xeaAa\n" +
	" cloudiot.googleapis.com/Registry\x12=projects/{project}/locations/{location}/registries/{registry}\"Z\n" +
	"\n" +
	"MqttConfig\x12L\n" +
	"\x12mqtt_enabled_state\x18\x01 \x01(\x0e2\x1e.google.cloud.iot.v1.MqttStateR\x10mqttEnabledState\"Z\n" +
	"\n" +
	"HttpConfig\x12L\n" +
	"\x12http_enabled_state\x18\x01 \x01(\x0e2\x1e.google.cloud.iot.v1.HttpStateR\x10httpEnabledState\"r\n" +
	...
	"\x12RegistryCredential\x12a\n" +
	"\x16public_key_certificate\x18\x01 \x01(\v2).google.cloud.iot.v1.PublicKeyCertificateH\x00R\x14publicKeyCertificateB\f\n" +
	"\n" +
	"credential\"\x9b\x02\n" +
	...
	"\x06format\x18\x01 \x01(\x0e2/.google.cloud.iot.v1.PublicKeyCertificateFormatR\x06format\x12 \n" +
	"\vcertificate\x18\x02 \x01(\tR\vcertificate\x12N\n" +
	"\fx509_details\x18\x03 \x01(\v2+.google.cloud.iot.v1.X509CertificateDetailsR\vx509Details\"\xb0\x01\n" +
	"\x10DeviceCredential\x12I\n" +
	"\n" +
	"public_key\x18\x02 \x01(\v2(.google.cloud.iot.v1.PublicKeyCredentialH\x00R\tpublicKey\x12C\n" +
	"\x0fexpiration_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x0eexpirationTimeB\f\n" +
	"\n" +
	"credential\"e\n" +
	"\x13PublicKeyCredential\x12<\n" +
	"\x06format\x18\x01 \x01(\x0e2$.google.cloud.iot.v1.PublicKeyFormatR\x06format\x12\x10\n" +
...
var (
	...
	file_google_cloud_iot_v1_resources_proto_rawDescData []byte
)
...
func file_google_cloud_iot_v1_resources_proto_rawDescGZIP() []byte {
	file_google_cloud_iot_v1_resources_proto_rawDescOnce.Do(func() {
		file_google_cloud_iot_v1_resources_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_iot_v1_resources_proto_rawDesc), len(file_google_cloud_iot_v1_resources_proto_rawDesc)))
	})
...
var file_google_cloud_iot_v1_resources_proto_goTypes = []any{
...
func file_google_cloud_iot_v1_resources_proto_init() {
	...
	file_google_cloud_iot_v1_resources_proto_msgTypes[7].OneofWrappers = []any{
		(*RegistryCredential_PublicKeyCertificate)(nil),
	}
	file_google_cloud_iot_v1_resources_proto_msgTypes[10].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_iot_v1_resources_proto_rawDesc), len(file_google_cloud_iot_v1_resources_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   0,
