...
type internalClient interface {
	...
	ListSecrets(context.Context, *secretspb.ListSecretsRequest, ...gax.CallOption) *SecretIterator
	CreateSecret(context.Context, *secretspb.CreateSecretRequest, ...gax.CallOption) (*secretspb.Secret, error)
	AddSecretVersion(context.Context, *secretspb.AddSecretVersionRequest, ...gax.CallOption) (*secretspb.SecretVersion, error)
	GetSecret(context.Context, *secretspb.GetSecretRequest, ...gax.CallOption) (*secretspb.Secret, error)
	UpdateSecret(context.Context, *secretspb.UpdateSecretRequest, ...gax.CallOption) (*secretspb.Secret, error)
	DeleteSecret(context.Context, *secretspb.DeleteSecretRequest, ...gax.CallOption) error
	ListSecretVersions(context.Context, *secretspb.ListSecretVersionsRequest, ...gax.CallOption) *SecretVersionIterator
	GetSecretVersion(context.Context, *secretspb.GetSecretVersionRequest, ...gax.CallOption) (*secretspb.SecretVersion, error)
	AccessSecretVersion(context.Context, *secretspb.AccessSecretVersionRequest, ...gax.CallOption) (*secretspb.AccessSecretVersionResponse, error)
	DisableSecretVersion(context.Context, *secretspb.DisableSecretVersionRequest, ...gax.CallOption) (*secretspb.SecretVersion, error)
	EnableSecretVersion(context.Context, *secretspb.EnableSecretVersionRequest, ...gax.CallOption) (*secretspb.SecretVersion, error)
	DestroySecretVersion(context.Context, *secretspb.DestroySecretVersionRequest, ...gax.CallOption) (*secretspb.SecretVersion, error)
...
func NewClient(ctx context.Context, opts ...option.ClientOption) (*Client, error) {
	...
	c := &gRPCClient{
		connPool:    connPool,
		client:      secretspb.NewSecretManagerServiceClient(connPool),
...
func (c *gRPCClient) ListSecrets(ctx context.Context, req *secretspb.ListSecretsRequest, opts ...gax.CallOption) *SecretIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*secretspb.Secret, string, error) {
		resp := &secretspb.ListSecretsResponse{}
		if pageToken != "" {
...
func (c *gRPCClient) CreateSecret(ctx context.Context, req *secretspb.CreateSecretRequest, opts ...gax.CallOption) (*secretspb.Secret, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}
...
func (c *gRPCClient) AddSecretVersion(ctx context.Context, req *secretspb.AddSecretVersionRequest, opts ...gax.CallOption) (*secretspb.SecretVersion, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}
...
func (c *gRPCClient) GetSecret(ctx context.Context, req *secretspb.GetSecretRequest, opts ...gax.CallOption) (*secretspb.Secret, error) {
...
func (c *gRPCClient) UpdateSecret(ctx context.Context, req *secretspb.UpdateSecretRequest, opts ...gax.CallOption) (*secretspb.Secret, error) {
...
func (c *gRPCClient) DeleteSecret(ctx context.Context, req *secretspb.DeleteSecretRequest, opts ...gax.CallOption) error {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
...
func (c *gRPCClient) ListSecretVersions(ctx context.Context, req *secretspb.ListSecretVersionsRequest, opts ...gax.CallOption) *SecretVersionIterator {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*secretspb.SecretVersion, string, error) {
		resp := &secretspb.ListSecretVersionsResponse{}
		if pageToken != "" {
			req.PageToken = pageToken
		}
		if pageSize > math.MaxInt32 {
...
func (c *gRPCClient) GetSecretVersion(ctx context.Context, req *secretspb.GetSecretVersionRequest, opts ...gax.CallOption) (*secretspb.SecretVersion, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
...
func (c *gRPCClient) AccessSecretVersion(ctx context.Context, req *secretspb.AccessSecretVersionRequest, opts ...gax.CallOption) (*secretspb.AccessSecretVersionResponse, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
...
func (c *gRPCClient) DisableSecretVersion(ctx context.Context, req *secretspb.DisableSecretVersionRequest, opts ...gax.CallOption) (*secretspb.SecretVersion, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
...
func (c *gRPCClient) EnableSecretVersion(ctx context.Context, req *secretspb.EnableSecretVersionRequest, opts ...gax.CallOption) (*secretspb.SecretVersion, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
...
func (c *gRPCClient) DestroySecretVersion(ctx context.Context, req *secretspb.DestroySecretVersionRequest, opts ...gax.CallOption) (*secretspb.SecretVersion, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
...
// ListSecrets lists Secrets.
func (c *restClient) ListSecrets(ctx context.Context, req *secretspb.ListSecretsRequest, opts ...gax.CallOption) *SecretIterator {
	it := &SecretIterator{}
	req = proto.Clone(req).(*secretspb.ListSecretsRequest)
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*secretspb.Secret, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v1beta1/%v/secrets", req.GetParent())
...
// CreateSecret creates a new Secret containing no SecretVersions.
func (c *restClient) CreateSecret(ctx context.Context, req *secretspb.CreateSecretRequest, opts ...gax.CallOption) (*secretspb.Secret, error) {
...
// AddSecretVersion creates a new SecretVersion containing secret data and attaches
// it to an existing Secret.
func (c *restClient) AddSecretVersion(ctx context.Context, req *secretspb.AddSecretVersionRequest, opts ...gax.CallOption) (*secretspb.SecretVersion, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	...
	baseUrl.Path += fmt.Sprintf("/v1beta1/%v:addVersion", req.GetParent())
...
// GetSecret gets metadata for a given Secret.
func (c *restClient) GetSecret(ctx context.Context, req *secretspb.GetSecretRequest, opts ...gax.CallOption) (*secretspb.Secret, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// UpdateSecret updates metadata of an existing Secret.
func (c *restClient) UpdateSecret(ctx context.Context, req *secretspb.UpdateSecretRequest, opts ...gax.CallOption) (*secretspb.Secret, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetSecret()
	jsonReq, err := m.Marshal(body)
	if err != nil {
	...
	baseUrl.Path += fmt.Sprintf("/v1beta1/%v", req.GetSecret().GetName())
...
// DeleteSecret deletes a Secret.
func (c *restClient) DeleteSecret(ctx context.Context, req *secretspb.DeleteSecretRequest, opts ...gax.CallOption) error {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return err
	}
...
// ListSecretVersions lists SecretVersions. This call does not return secret
// data.
func (c *restClient) ListSecretVersions(ctx context.Context, req *secretspb.ListSecretVersionsRequest, opts ...gax.CallOption) *SecretVersionIterator {
	it := &SecretVersionIterator{}
	req = proto.Clone(req).(*secretspb.ListSecretVersionsRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*secretspb.SecretVersion, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v1beta1/%v/versions", req.GetParent())
...
// projects/*/secrets/*/versions/latest is an alias to the latest
// SecretVersion.
func (c *restClient) GetSecretVersion(ctx context.Context, req *secretspb.GetSecretVersionRequest, opts ...gax.CallOption) (*secretspb.SecretVersion, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// projects/*/secrets/*/versions/latest is an alias to the latest
// SecretVersion.
func (c *restClient) AccessSecretVersion(ctx context.Context, req *secretspb.AccessSecretVersionRequest, opts ...gax.CallOption) (*secretspb.AccessSecretVersionResponse, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	baseUrl.Path += fmt.Sprintf("/v1beta1/%v:access", req.GetName())
...
// Sets the state of the SecretVersion to
// DISABLED.
func (c *restClient) DisableSecretVersion(ctx context.Context, req *secretspb.DisableSecretVersionRequest, opts ...gax.CallOption) (*secretspb.SecretVersion, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
...
// Sets the state of the SecretVersion to
// ENABLED.
func (c *restClient) EnableSecretVersion(ctx context.Context, req *secretspb.EnableSecretVersionRequest, opts ...gax.CallOption) (*secretspb.SecretVersion, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
...
// DESTROYED and irrevocably destroys the
// secret data.
func (c *restClient) DestroySecretVersion(ctx context.Context, req *secretspb.DestroySecretVersionRequest, opts ...gax.CallOption) (*secretspb.SecretVersion, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v1beta1/%v:destroy", req.GetName())
