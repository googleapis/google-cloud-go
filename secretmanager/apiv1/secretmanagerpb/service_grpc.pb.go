...
const (
	...
	SecretManagerService_EnableManagedRotation_FullMethodName = "/google.cloud.secretmanager.v1.SecretManagerService/EnableManagedRotation"
	SecretManagerService_RotateSecret_FullMethodName          = "/google.cloud.secretmanager.v1.SecretManagerService/RotateSecret"
)
...
type SecretManagerServiceClient interface {
	...
	EnableManagedRotation(ctx context.Context, in *EnableManagedRotationRequest, opts ...grpc.CallOption) (*SecretVersion, error)
	...
	RotateSecret(ctx context.Context, in *RotateSecretRequest, opts ...grpc.CallOption) (*SecretVersion, error)
}
...
func (c *secretManagerServiceClient) EnableManagedRotation(ctx context.Context, in *EnableManagedRotationRequest, opts ...grpc.CallOption) (*SecretVersion, error) {
	out := new(SecretVersion)
	err := c.cc.Invoke(ctx, SecretManagerService_EnableManagedRotation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *secretManagerServiceClient) RotateSecret(ctx context.Context, in *RotateSecretRequest, opts ...grpc.CallOption) (*SecretVersion, error) {
	out := new(SecretVersion)
	err := c.cc.Invoke(ctx, SecretManagerService_RotateSecret_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SecretManagerServiceServer interface {
	...
	// should be used. This method will add a secret version and update the
	// password in Cloud SQL.
	EnableManagedRotation(context.Context, *EnableManagedRotationRequest) (*SecretVersion, error)
	// Do a managed rotation for a [Secret][google.cloud.secretmanager.v1.Secret].
	// This can only be triggered after Managed rotation has been enabled.
	// This method will add a secret version and update the password in Cloud SQL.
	RotateSecret(context.Context, *RotateSecretRequest) (*SecretVersion, error)
}
...
func (UnimplementedSecretManagerServiceServer) EnableManagedRotation(context.Context, *EnableManagedRotationRequest) (*SecretVersion, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EnableManagedRotation not implemented")
}
func (UnimplementedSecretManagerServiceServer) RotateSecret(context.Context, *RotateSecretRequest) (*SecretVersion, error) {
...
func _SecretManagerService_EnableManagedRotation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EnableManagedRotationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SecretManagerServiceServer).EnableManagedRotation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SecretManagerService_EnableManagedRotation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SecretManagerServiceServer).EnableManagedRotation(ctx, req.(*EnableManagedRotationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SecretManagerService_RotateSecret_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RotateSecretRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SecretManagerServiceServer).RotateSecret(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SecretManagerService_RotateSecret_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SecretManagerServiceServer).RotateSecret(ctx, req.(*RotateSecretRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SecretManagerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "EnableManagedRotation",
			Handler:    _SecretManagerService_EnableManagedRotation_Handler,
		},
		{
			MethodName: "RotateSecret",
			Handler:    _SecretManagerService_RotateSecret_Handler,
		},
	},
