...
const file_google_cloud_aiplatform_v1_feature_selector_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/aiplatform/v1/feature_selector.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\"\"\n" +
	"\tIdMatcher\x12\x15\n" +
	"\x03ids\x18\x01 \x03(\tB\x03\xe0A\x02R\x03ids\"\\\n" +
	"\x0fFeatureSelector\x12I\n" +
	"\n" +
	"id_matcher\x18\x01 \x01(\v2%.google.cloud.aiplatform.v1.IdMatcherB\x03\xe0A\x02R\tidMatcherB\xd2\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_feature_selector_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_feature_selector_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_feature_selector_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_feature_selector_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_feature_selector_proto_rawDesc), len(file_google_cloud_aiplatform_v1_feature_selector_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_feature_selector_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_feature_selector_proto_rawDesc), len(file_google_cloud_aiplatform_v1_feature_selector_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
