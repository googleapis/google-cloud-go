...
const file_google_cloud_aiplatform_v1_user_action_reference_proto_rawDesc = "" +
	"\n" +
	"6google/cloud/aiplatform/v1/user_action_reference.proto\x12\x1agoogle.cloud.aiplatform.v1\"\x88\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_user_action_reference_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_user_action_reference_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_user_action_reference_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_user_action_reference_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_user_action_reference_proto_rawDesc), len(file_google_cloud_aiplatform_v1_user_action_reference_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1_user_action_reference_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1_user_action_reference_proto_init() {
	...
	file_google_cloud_aiplatform_v1_user_action_reference_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_user_action_reference_proto_rawDesc), len(file_google_cloud_aiplatform_v1_user_action_reference_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
