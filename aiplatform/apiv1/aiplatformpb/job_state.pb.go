...
const file_google_cloud_aiplatform_v1_job_state_proto_rawDesc = "" +
	"\n" +
	...
	"\x12!\n" +
	"\x1dJOB_STATE_PARTIALLY_SUCCEEDED\x10\vB\xcb\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_job_state_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_job_state_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_job_state_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_job_state_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_job_state_proto_rawDesc), len(file_google_cloud_aiplatform_v1_job_state_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_job_state_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_job_state_proto_rawDesc), len(file_google_cloud_aiplatform_v1_job_state_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
