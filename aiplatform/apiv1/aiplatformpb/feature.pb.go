...
const file_google_cloud_aiplatform_v1_feature_proto_rawDesc = "" +
	"\n" +
	"(google/cloud/aiplatform/v1/feature.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a9google/cloud/aiplatform/v1/feature_monitoring_stats.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xcc\v\n" +
	"\aFeature\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x05R\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12Q\n" +
	"\n" +
	"value_type\x18\x03 \x01(\x0e2-.google.cloud.aiplatform.v1.Feature.ValueTypeB\x03\xe0A\x05R\tvalueType\x12@\n" +
	"\vcreate_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12@\n" +
	"\vupdate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12L\n" +
	"\x06labels\x18\x06 \x03(\v2/.google.cloud.aiplatform.v1.Feature.LabelsEntryB\x03\xe0A\x01R\x06labels\x12\x12\n" +
	"\x04etag\x18\a \x01(\tR\x04etag\x122\n" +
	"\x12disable_monitoring\x18\f \x01(\bB\x03\xe0A\x01R\x11disableMonitoring\x12}\n" +
	"\x1amonitoring_stats_anomalies\x18\v \x03(\v2:.google.cloud.aiplatform.v1.Feature.MonitoringStatsAnomalyB\x03\xe0A\x03R\x18monitoringStatsAnomalies\x12.\n" +
	"\x13version_column_name\x18j \x01(\tR\x11versionColumnName\x12(\n" +
	"\x10point_of_contact\x18k \x01(\tR\x0epointOfContact\x1a\xc7\x02\n" +
	"\x16MonitoringStatsAnomaly\x12g\n" +
	"\tobjective\x18\x01 \x01(\x0e2D.google.cloud.aiplatform.v1.Feature.MonitoringStatsAnomaly.ObjectiveB\x03\xe0A\x03R\tobjective\x12h\n" +
	"\x15feature_stats_anomaly\x18\x02 \x01(\v2/.google.cloud.aiplatform.v1.FeatureStatsAnomalyB\x03\xe0A\x03R\x13featureStatsAnomaly\"Z\n" +
	"\tObjective\x12\x19\n" +
	"\x15OBJECTIVE_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17IMPORT_FEATURE_ANALYSIS\x10\x01\x12\x15\n" +
	"\x11SNAPSHOT_ANALYSIS\x10\x02\x1a9\n" +
	...
	"\fDOUBLE_ARRAY\x10\x04\x12\t\n" +
	"\x05INT64\x10\t\x12\x0f\n" +
	"\vINT64_ARRAY\x10\n" +
	"\x12\n" +
	"\n" +
	"\x06STRING\x10\v\x12\x10\n" +
	"\fSTRING_ARRAY\x10\f\x12\t\n" +
	"\x05BYTES\x10\r\x12\n" +
	"\n" +
	"\x06STRUCT\x10\x0e:\x87\x02\xeaA\x83\x02\n" +
	"!aiplatform.googleapis.com/Feature\x12qprojects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entity_type}/features/{feature}\x12Xprojects/{project}/locations/{location}/featureGroups/{feature_group}/features/{feature}*\bfeatures2\afeatureB\xca\x01\n" +
	"\x1ecom.google.cloud.aiplatform.v1B\fFeatureProtoP\x01Z>cloud.google.com/go/aiplatform/apiv1/aiplatformpb;aiplatformpb\xaa\x02\x1aGoogle.Cloud.AIPlatform.V1\xca\x02\x1aGoogle\\Cloud\\AIPlatform\\V1\xea\x02\x1dGoogle::Cloud::AIPlatform::V1b\x06proto3"

var (
	file_google_cloud_aiplatform_v1_feature_proto_rawDescOnce sync.Once
	file_google_cloud_aiplatform_v1_feature_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_feature_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_feature_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_feature_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_feature_proto_rawDesc), len(file_google_cloud_aiplatform_v1_feature_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_feature_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_feature_proto_rawDesc), len(file_google_cloud_aiplatform_v1_feature_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
