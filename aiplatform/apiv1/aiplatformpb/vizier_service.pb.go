...
const file_google_cloud_aiplatform_v1_vizier_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x1faiplatform.googleapis.com/StudyR\x04name\"\x95\x01\n" +
	"\x12CreateStudyRequest\x12A\n" +
	"\x06parent\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!locations.googleapis.com/LocationR\x06parent\x12<\n" +
	"\x05study\x18\x02 \x01(\v2!.google.cloud.aiplatform.v1.StudyB\x03\xe0A\x02R\x05study\"\x9d\x01\n" +
	"\x12ListStudiesRequest\x12A\n" +
	"\x06parent\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!locations.googleapis.com/LocationR\x06parent\x12\"\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tB\x03\xe0A\x01R\tpageToken\x12 \n" +
	"\tpage_size\x18\x03 \x01(\x05B\x03\xe0A\x01R\bpageSize\"z\n" +
	"\x13ListStudiesResponse\x12;\n" +
	"\astudies\x18\x01 \x03(\v2!.google.cloud.aiplatform.v1.StudyR\astudies\x12&\n" +
	...
	"\x06parent\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!locations.googleapis.com/LocationR\x06parent\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x02R\vdisplayName\"\xf4\x01\n" +
	...
	"\tclient_id\x18\x03 \x01(\tB\x03\xe0A\x02R\bclientId\x12I\n" +
	"\bcontexts\x18\x04 \x03(\v2(.google.cloud.aiplatform.v1.TrialContextB\x03\xe0A\x01R\bcontexts\"\x8e\x02\n" +
	"\x15SuggestTrialsResponse\x129\n" +
	"\x06trials\x18\x01 \x03(\v2!.google.cloud.aiplatform.v1.TrialR\x06trials\x12H\n" +
	"\vstudy_state\x18\x02 \x01(\x0e2'.google.cloud.aiplatform.v1.Study.StateR\n" +
	"studyState\x129\n" +
	"\n" +
	"start_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x125\n" +
	"\bend_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\"\x95\x01\n" +
	"\x15SuggestTrialsMetadata\x12_\n" +
	"\x10generic_metadata\x18\x01 \x01(\v24.google.cloud.aiplatform.v1.GenericOperationMetadataR\x0fgenericMetadata\x12\x1b\n" +
	"\tclient_id\x18\x02 \x01(\tR\bclientId\"\x93\x01\n" +
	"\x12CreateTrialRequest\x12?\n" +
	"\x06parent\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\n" +
	"\x1faiplatform.googleapis.com/StudyR\x06parent\x12<\n" +
	"\x05trial\x18\x02 \x01(\v2!.google.cloud.aiplatform.v1.TrialB\x03\xe0A\x02R\x05trial\"N\n" +
	...
	"\n" +
	"page_token\x18\x02 \x01(\tB\x03\xe0A\x01R\tpageToken\x12 \n" +
	"\tpage_size\x18\x03 \x01(\x05B\x03\xe0A\x01R\bpageSize\"w\n" +
	"\x12ListTrialsResponse\x129\n" +
	"\x06trials\x18\x01 \x03(\v2!.google.cloud.aiplatform.v1.TrialR\x06trials\x12&\n" +
	...
	"\x1faiplatform.googleapis.com/TrialR\ttrialName\x12N\n" +
	"\vmeasurement\x18\x03 \x01(\v2'.google.cloud.aiplatform.v1.MeasurementB\x03\xe0A\x02R\vmeasurement\"\x90\x02\n" +
	"\x14CompleteTrialRequest\x12;\n" +
	"\x04name\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\n" +
	"\x1faiplatform.googleapis.com/TrialR\x04name\x12Y\n" +
	"\x11final_measurement\x18\x02 \x01(\v2'.google.cloud.aiplatform.v1.MeasurementB\x03\xe0A\x01R\x10finalMeasurement\x12.\n" +
	...
	"\x10generic_metadata\x18\x01 \x01(\v24.google.cloud.aiplatform.v1.GenericOperationMetadataR\x0fgenericMetadata\x12\x14\n" +
	...
	"\x06parent\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\n" +
	"\x1faiplatform.googleapis.com/StudyR\x06parent\"e\n" +
	"\x19ListOptimalTrialsResponse\x12H\n" +
	"\x0eoptimal_trials\x18\x01 \x03(\v2!.google.cloud.aiplatform.v1.TrialR\roptimalTrials2\xd4\x16\n" +
	"\rVizierService\x12\xab\x01\n" +
	"\vCreateStudy\x12..google.cloud.aiplatform.v1.CreateStudyRequest\x1a!.google.cloud.aiplatform.v1.Study\"I\xdaA\fparent,study\x82\xd3\xe4\x93\x024:\x05study\"+/v1/{parent=projects/*/locations/*}/studies\x12\x96\x01\n" +
	"\bGetStudy\x12+.google.cloud.aiplatform.v1.GetStudyRequest\x1a!.google.cloud.aiplatform.v1.Study\":\xdaA\x04name\x82\xd3\xe4\x93\x02-\x12+/v1/{name=projects/*/locations/*/studies/*}\x12\xac\x01\n" +
	"\vListStudies\x12..google.cloud.aiplatform.v1.ListStudiesRequest\x1a/.google.cloud.aiplatform.v1.ListStudiesResponse\"<\xdaA\x06parent\x82\xd3\xe4\x93\x02-\x12+/v1/{parent=projects/*/locations/*}/studies\x12\x91\x01\n" +
	"\vDeleteStudy\x12..google.cloud.aiplatform.v1.DeleteStudyRequest\x1a\x16.google.protobuf.Empty\":\xdaA\x04name\x82\xd3\xe4\x93\x02-*+/v1/{name=projects/*/locations/*/studies/*}\x12\xa8\x01\n" +
	"\vLookupStudy\x12..google.cloud.aiplatform.v1.LookupStudyRequest\x1a!.google.cloud.aiplatform.v1.Study\"F\xdaA\x06parent\x82\xd3\xe4\x93\x027:\x01*\"2/v1/{parent=projects/*/locations/*}/studies:lookup\x12\xda\x01\n" +
	"\rSuggestTrials\x120.google.cloud.aiplatform.v1.SuggestTrialsRequest\x1a\x1d.google.longrunning.Operation\"x\xcaA.\n" +
	"\x15SuggestTrialsResponse\x12\x15SuggestTrialsMetadata\x82\xd3\xe4\x93\x02A:\x01*\"</v1/{parent=projects/*/locations/*/studies/*}/trials:suggest\x12\xb4\x01\n" +
	"\vCreateTrial\x12..google.cloud.aiplatform.v1.CreateTrialRequest\x1a!.google.cloud.aiplatform.v1.Trial\"R\xdaA\fparent,trial\x82\xd3\xe4\x93\x02=:\x05trial\"4/v1/{parent=projects/*/locations/*/studies/*}/trials\x12\x9f\x01\n" +
	"\bGetTrial\x12+.google.cloud.aiplatform.v1.GetTrialRequest\x1a!.google.cloud.aiplatform.v1.Trial\"C\xdaA\x04name\x82\xd3\xe4\x93\x026\x124/v1/{name=projects/*/locations/*/studies/*/trials/*}\x12\xb2\x01\n" +
	"\n" +
	...
	"\x13AddTrialMeasurement\x126.google.cloud.aiplatform.v1.AddTrialMeasurementRequest\x1a!.google.cloud.aiplatform.v1.Trial\"Y\x82\xd3\xe4\x93\x02S:\x01*\"N/v1/{trial_name=projects/*/locations/*/studies/*/trials/*}:addTrialMeasurement\x12\xae\x01\n" +
	"\rCompleteTrial\x120.google.cloud.aiplatform.v1.CompleteTrialRequest\x1a!.google.cloud.aiplatform.v1.Trial\"H\x82\xd3\xe4\x93\x02B:\x01*\"=/v1/{name=projects/*/locations/*/studies/*/trials/*}:complete\x12\x9a\x01\n" +
	"\vDeleteTrial\x12..google.cloud.aiplatform.v1.DeleteTrialRequest\x1a\x16.google.protobuf.Empty\"C\xdaA\x04name\x82\xd3\xe4\x93\x026*4/v1/{name=projects/*/locations/*/studies/*/trials/*}\x12\xb3\x02\n" +
	...
	"$CheckTrialEarlyStoppingStateResponse\x12%CheckTrialEarlyStoppingStateMetatdata\x82\xd3\xe4\x93\x02\\:\x01*\"W/v1/{trial_name=projects/*/locations/*/studies/*/trials/*}:checkTrialEarlyStoppingState\x12\xa2\x01\n" +
	"\tStopTrial\x12,.google.cloud.aiplatform.v1.StopTrialRequest\x1a!.google.cloud.aiplatform.v1.Trial\"D\x82\xd3\xe4\x93\x02>:\x01*\"9/v1/{name=projects/*/locations/*/studies/*/trials/*}:stop\x12\xdc\x01\n" +
	"\x11ListOptimalTrials\x124.google.cloud.aiplatform.v1.ListOptimalTrialsRequest\x1a5.google.cloud.aiplatform.v1.ListOptimalTrialsResponse\"Z\xdaA\x06parent\x82\xd3\xe4\x93\x02K:\x01*\"F/v1/{parent=projects/*/locations/*/studies/*}/trials:listOptimalTrials\x1aM\xcaA\x19aiplatform.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xd0\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_vizier_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_vizier_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_vizier_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_vizier_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_vizier_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1_vizier_service_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1_vizier_service_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1_vizier_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_vizier_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1_vizier_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   1,
