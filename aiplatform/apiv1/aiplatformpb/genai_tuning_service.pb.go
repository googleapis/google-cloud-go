...
const file_google_cloud_aiplatform_v1_genai_tuning_service_proto_rawDesc = "" +
	"\n" +
	...
	"\n" +
	"tuning_job\x18\x02 \x01(\v2%.google.cloud.aiplatform.v1.TuningJobB\x03\xe0A\x02R\ttuningJob\"V\n" +
	...
	"\x16ListTuningJobsResponse\x12F\n" +
	"\vtuning_jobs\x18\x01 \x03(\v2%.google.cloud.aiplatform.v1.TuningJobR\n" +
	"tuningJobs\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"Y\n" +
	"\x16CancelTuningJobRequest\x12?\n" +
	"\x04name\x18\x01 \x01(\tB+\xe0A\x02\xfaA%\n" +
	"#aiplatform.googleapis.com/TuningJobR\x04name\"\x9f\x03\n" +
	"\x17RebaseTunedModelRequest\x12A\n" +
	"\x06parent\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!locations.googleapis.com/LocationR\x06parent\x12V\n" +
	"\x0ftuned_model_ref\x18\x02 \x01(\v2).google.cloud.aiplatform.v1.TunedModelRefB\x03\xe0A\x02R\rtunedModelRef\x12I\n" +
	"\n" +
	"tuning_job\x18\x03 \x01(\v2%.google.cloud.aiplatform.v1.TuningJobB\x03\xe0A\x01R\ttuningJob\x12b\n" +
	"\x14artifact_destination\x18\x04 \x01(\v2*.google.cloud.aiplatform.v1.GcsDestinationB\x03\xe0A\x01R\x13artifactDestination\x12:\n" +
	"\x17deploy_to_same_endpoint\x18\x05 \x01(\bB\x03\xe0A\x01R\x14deployToSameEndpoint\"\x84\x01\n" +
	"!RebaseTunedModelOperationMetadata\x12_\n" +
	"\x10generic_metadata\x18\x01 \x01(\v24.google.cloud.aiplatform.v1.GenericOperationMetadataR\x0fgenericMetadata2\xb6\b\n" +
	"\x12GenAiTuningService\x12\xc4\x01\n" +
	"\x0fCreateTuningJob\x122.google.cloud.aiplatform.v1.CreateTuningJobRequest\x1a%.google.cloud.aiplatform.v1.TuningJob\"V\xdaA\x11parent,tuning_job\x82\xd3\xe4\x93\x02<:\n" +
	"tuning_job\"./v1/{parent=projects/*/locations/*}/tuningJobs\x12\xa5\x01\n" +
	"\fGetTuningJob\x12/.google.cloud.aiplatform.v1.GetTuningJobRequest\x1a%.google.cloud.aiplatform.v1.TuningJob\"=\xdaA\x04name\x82\xd3\xe4\x93\x020\x12./v1/{name=projects/*/locations/*/tuningJobs/*}\x12\xb8\x01\n" +
	...
	"\x0fCancelTuningJob\x122.google.cloud.aiplatform.v1.CancelTuningJobRequest\x1a\x16.google.protobuf.Empty\"G\xdaA\x04name\x82\xd3\xe4\x93\x02::\x01*\"5/v1/{name=projects/*/locations/*/tuningJobs/*}:cancel\x12\xfd\x01\n" +
	...
	"\tTuningJob\x12!RebaseTunedModelOperationMetadata\xdaA\x16parent,tuned_model_ref\x82\xd3\xe4\x93\x02D:\x01*\"?/v1/{parent=projects/*/locations/*}/tuningJobs:rebaseTunedModel\x1aM\xcaA\x19aiplatform.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xd5\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_genai_tuning_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_genai_tuning_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_genai_tuning_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_genai_tuning_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_genai_tuning_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1_genai_tuning_service_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_genai_tuning_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_genai_tuning_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1_genai_tuning_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
