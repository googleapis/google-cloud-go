...
func file_google_cloud_aiplatform_v1_match_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_aiplatform_v1_match_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_aiplatform_v1_match_service_proto_msgTypes[4].OneofWrappers = []interface{}{
