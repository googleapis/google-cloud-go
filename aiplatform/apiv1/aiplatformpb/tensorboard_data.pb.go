...
const file_google_cloud_aiplatform_v1_tensorboard_data_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/aiplatform/v1/tensorboard_data.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a8google/cloud/aiplatform/v1/tensorboard_time_series.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x84\x02\n" +
	"\x0eTimeSeriesData\x12@\n" +
	"\x1atensorboard_time_series_id\x18\x01 \x01(\tB\x03\xe0A\x02R\x17tensorboardTimeSeriesId\x12b\n" +
	"\n" +
	"value_type\x18\x02 \x01(\x0e2;.google.cloud.aiplatform.v1.TensorboardTimeSeries.ValueTypeB\x06\xe0A\x02\xe0A\x05R\tvalueType\x12L\n" +
	"\x06values\x18\x03 \x03(\v2/.google.cloud.aiplatform.v1.TimeSeriesDataPointB\x03\xe0A\x02R\x06values\"\xbf\x02\n" +
	"\x13TimeSeriesDataPoint\x12<\n" +
	"\x06scalar\x18\x03 \x01(\v2\".google.cloud.aiplatform.v1.ScalarH\x00R\x06scalar\x12G\n" +
	"\x06tensor\x18\x04 \x01(\v2-.google.cloud.aiplatform.v1.TensorboardTensorH\x00R\x06tensor\x12K\n" +
	"\x05blobs\x18\x05 \x01(\v23.google.cloud.aiplatform.v1.TensorboardBlobSequenceH\x00R\x05blobs\x127\n" +
	...
	"\x0eversion_number\x18\x02 \x01(\x05B\x03\xe0A\x01R\rversionNumber\"^\n" +
	"\x17TensorboardBlobSequence\x12C\n" +
	"\x06values\x18\x01 \x03(\v2+.google.cloud.aiplatform.v1.TensorboardBlobR\x06values\"?\n" +
	"\x0fTensorboardBlob\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x03R\x02id\x12\x17\n" +
	"\x04data\x18\x02 \x01(\fB\x03\xe0A\x01R\x04dataB\xd2\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_tensorboard_data_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_tensorboard_data_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_tensorboard_data_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_tensorboard_data_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_tensorboard_data_proto_rawDesc), len(file_google_cloud_aiplatform_v1_tensorboard_data_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1_tensorboard_data_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1_tensorboard_data_proto_init() {
	...
	file_google_cloud_aiplatform_v1_tensorboard_data_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_tensorboard_data_proto_rawDesc), len(file_google_cloud_aiplatform_v1_tensorboard_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
