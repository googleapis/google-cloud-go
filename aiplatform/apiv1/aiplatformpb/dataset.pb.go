...
var file_google_cloud_aiplatform_v1_dataset_proto_rawDesc = []byte{
	...
	0x0d, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0xca,
...
var file_google_cloud_aiplatform_v1_dataset_proto_goTypes = []interface{}{
	...
	(*SavedQuery)(nil),            // 8: google.cloud.aiplatform.v1.SavedQuery
	(*EncryptionSpec)(nil),        // 9: google.cloud.aiplatform.v1.EncryptionSpec
	(*GcsSource)(nil),             // 10: google.cloud.aiplatform.v1.GcsSource
...
var file_google_cloud_aiplatform_v1_dataset_proto_depIdxs = []int32{
	...
	8,  // 4: google.cloud.aiplatform.v1.Dataset.saved_queries:type_name -> google.cloud.aiplatform.v1.SavedQuery
	9,  // 5: google.cloud.aiplatform.v1.Dataset.encryption_spec:type_name -> google.cloud.aiplatform.v1.EncryptionSpec
	10, // 6: google.cloud.aiplatform.v1.ImportDataConfig.gcs_source:type_name -> google.cloud.aiplatform.v1.GcsSource
	4,  // 7: google.cloud.aiplatform.v1.ImportDataConfig.data_item_labels:type_name -> google.cloud.aiplatform.v1.ImportDataConfig.DataItemLabelsEntry
	5,  // 8: google.cloud.aiplatform.v1.ImportDataConfig.annotation_labels:type_name -> google.cloud.aiplatform.v1.ImportDataConfig.AnnotationLabelsEntry
	11, // 9: google.cloud.aiplatform.v1.ExportDataConfig.gcs_destination:type_name -> google.cloud.aiplatform.v1.GcsDestination
