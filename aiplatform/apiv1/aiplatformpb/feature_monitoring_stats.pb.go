...
const file_google_cloud_aiplatform_v1_feature_monitoring_stats_proto_rawDesc = "" +
	"\n" +
	"9google/cloud/aiplatform/v1/feature_monitoring_stats.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd2\x02\n" +
	...
	"\bend_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\aendTimeB\xd9\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_feature_monitoring_stats_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_feature_monitoring_stats_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_feature_monitoring_stats_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_feature_monitoring_stats_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_feature_monitoring_stats_proto_rawDesc), len(file_google_cloud_aiplatform_v1_feature_monitoring_stats_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1_feature_monitoring_stats_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1_feature_monitoring_stats_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_feature_monitoring_stats_proto_rawDesc), len(file_google_cloud_aiplatform_v1_feature_monitoring_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
