...
func file_google_cloud_aiplatform_v1_feature_view_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_aiplatform_v1_feature_view_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_aiplatform_v1_feature_view_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_aiplatform_v1_feature_view_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_aiplatform_v1_feature_view_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_aiplatform_v1_feature_view_proto_msgTypes[4].OneofWrappers = []interface{}{}
	file_google_cloud_aiplatform_v1_feature_view_proto_msgTypes[7].OneofWrappers = []interface{}{}
	type x struct{}
