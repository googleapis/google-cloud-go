...
const file_google_cloud_aiplatform_v1_model_monitoring_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/aiplatform/v1/model_monitoring.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x19google/api/resource.proto\x1a#google/cloud/aiplatform/v1/io.proto\"\x8f\x19\n" +
	"\x1eModelMonitoringObjectiveConfig\x12u\n" +
	"\x10training_dataset\x18\x01 \x01(\v2J.google.cloud.aiplatform.v1.ModelMonitoringObjectiveConfig.TrainingDatasetR\x0ftrainingDataset\x12\xba\x01\n" +
	")training_prediction_skew_detection_config\x18\x02 \x01(\v2`.google.cloud.aiplatform.v1.ModelMonitoringObjectiveConfig.TrainingPredictionSkewDetectionConfigR%trainingPredictionSkewDetectionConfig\x12\xa4\x01\n" +
	"!prediction_drift_detection_config\x18\x03 \x01(\v2Y.google.cloud.aiplatform.v1.ModelMonitoringObjectiveConfig.PredictionDriftDetectionConfigR\x1epredictionDriftDetectionConfig\x12{\n" +
	"\x12explanation_config\x18\x05 \x01(\v2L.google.cloud.aiplatform.v1.ModelMonitoringObjectiveConfig.ExplanationConfigR\x11explanationConfig\x1a\xb1\x03\n" +
	"\x0fTrainingDataset\x12B\n" +
	"\adataset\x18\x03 \x01(\tB&\xfaA#\n" +
	"!aiplatform.googleapis.com/DatasetH\x00R\adataset\x12F\n" +
	"\n" +
	"gcs_source\x18\x04 \x01(\v2%.google.cloud.aiplatform.v1.GcsSourceH\x00R\tgcsSource\x12U\n" +
	"\x0fbigquery_source\x18\x05 \x01(\v2*.google.cloud.aiplatform.v1.BigQuerySourceH\x00R\x0ebigquerySource\x12\x1f\n" +
	"\vdata_format\x18\x02 \x01(\tR\n" +
	"dataFormat\x12!\n" +
	"\ftarget_field\x18\x06 \x01(\tR\vtargetField\x12h\n" +
	"\x19logging_sampling_strategy\x18\a \x01(\v2,.google.cloud.aiplatform.v1.SamplingStrategyR\x17loggingSamplingStrategyB\r\n" +
	"\vdata_source\x1a\xed\x05\n" +
	"%TrainingPredictionSkewDetectionConfig\x12\x9d\x01\n" +
	"\x0fskew_thresholds\x18\x01 \x03(\v2t.google.cloud.aiplatform.v1.ModelMonitoringObjectiveConfig.TrainingPredictionSkewDetectionConfig.SkewThresholdsEntryR\x0eskewThresholds\x12\xd0\x01\n" +
	"!attribution_score_skew_thresholds\x18\x02 \x03(\v2\x84\x01.google.cloud.aiplatform.v1.ModelMonitoringObjectiveConfig.TrainingPredictionSkewDetectionConfig.AttributionScoreSkewThresholdsEntryR\x1eattributionScoreSkewThresholds\x12a\n" +
	"\x16default_skew_threshold\x18\x06 \x01(\v2+.google.cloud.aiplatform.v1.ThresholdConfigR\x14defaultSkewThreshold\x1an\n" +
	"\x13SkewThresholdsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12A\n" +
	"\x05value\x18\x02 \x01(\v2+.google.cloud.aiplatform.v1.ThresholdConfigR\x05value:\x028\x01\x1a~\n" +
	"#AttributionScoreSkewThresholdsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12A\n" +
	"\x05value\x18\x02 \x01(\v2+.google.cloud.aiplatform.v1.ThresholdConfigR\x05value:\x028\x01\x1a\xe1\x05\n" +
	"\x1ePredictionDriftDetectionConfig\x12\x99\x01\n" +
	"\x10drift_thresholds\x18\x01 \x03(\v2n.google.cloud.aiplatform.v1.ModelMonitoringObjectiveConfig.PredictionDriftDetectionConfig.DriftThresholdsEntryR\x0fdriftThresholds\x12\xcb\x01\n" +
	"\"attribution_score_drift_thresholds\x18\x02 \x03(\v2~.google.cloud.aiplatform.v1.ModelMonitoringObjectiveConfig.PredictionDriftDetectionConfig.AttributionScoreDriftThresholdsEntryR\x1fattributionScoreDriftThresholds\x12c\n" +
	"\x17default_drift_threshold\x18\x05 \x01(\v2+.google.cloud.aiplatform.v1.ThresholdConfigR\x15defaultDriftThreshold\x1ao\n" +
	"\x14DriftThresholdsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12A\n" +
	"\x05value\x18\x02 \x01(\v2+.google.cloud.aiplatform.v1.ThresholdConfigR\x05value:\x028\x01\x1a\x7f\n" +
	"$AttributionScoreDriftThresholdsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12A\n" +
	"\x05value\x18\x02 \x01(\v2+.google.cloud.aiplatform.v1.ThresholdConfigR\x05value:\x028\x01\x1a\x8c\x05\n" +
	"\x11ExplanationConfig\x12:\n" +
	"\x19enable_feature_attributes\x18\x01 \x01(\bR\x17enableFeatureAttributes\x12\x93\x01\n" +
	"\x14explanation_baseline\x18\x02 \x01(\v2`.google.cloud.aiplatform.v1.ModelMonitoringObjectiveConfig.ExplanationConfig.ExplanationBaselineR\x13explanationBaseline\x1a\xa4\x03\n" +
	"\x13ExplanationBaseline\x12>\n" +
	"\x03gcs\x18\x02 \x01(\v2*.google.cloud.aiplatform.v1.GcsDestinationH\x00R\x03gcs\x12M\n" +
	"\bbigquery\x18\x03 \x01(\v2/.google.cloud.aiplatform.v1.BigQueryDestinationH\x00R\bbigquery\x12\x9e\x01\n" +
	"\x11prediction_format\x18\x01 \x01(\x0e2q.google.cloud.aiplatform.v1.ModelMonitoringObjectiveConfig.ExplanationConfig.ExplanationBaseline.PredictionFormatR\x10predictionFormat\"N\n" +
	"\x10PredictionFormat\x12!\n" +
	"\x1dPREDICTION_FORMAT_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05JSONL\x10\x02\x12\f\n" +
	"\bBIGQUERY\x10\x03B\r\n" +
	"\vdestination\"\xe3\x02\n" +
	"\x1aModelMonitoringAlertConfig\x12w\n" +
	"\x12email_alert_config\x18\x01 \x01(\v2G.google.cloud.aiplatform.v1.ModelMonitoringAlertConfig.EmailAlertConfigH\x00R\x10emailAlertConfig\x12%\n" +
	...
	"\x14random_sample_config\x18\x01 \x01(\v2?.google.cloud.aiplatform.v1.SamplingStrategy.RandomSampleConfigR\x12randomSampleConfig\x1a5\n" +
	"\x12RandomSampleConfig\x12\x1f\n" +
	"\vsample_rate\x18\x01 \x01(\x01R\n" +
	"sampleRateB\xc4\x02\xeaAo\n" +
	"-monitoring.googleapis.com/NotificationChannel\x12>projects/{project}/notificationChannels/{notification_channel}\n" +
	"\x1ecom.google.cloud.aiplatform.v1B\x14ModelMonitoringProtoP\x01Z>cloud.google.com/go/aiplatform/apiv1/aiplatformpb;aiplatformpb\xaa\x02\x1aGoogle.Cloud.AIPlatform.V1\xca\x02\x1aGoogle\\Cloud\\AIPlatform\\V1\xea\x02\x1dGoogle::Cloud::AIPlatform::V1b\x06proto3"

var (
	file_google_cloud_aiplatform_v1_model_monitoring_proto_rawDescOnce sync.Once
	file_google_cloud_aiplatform_v1_model_monitoring_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_model_monitoring_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_model_monitoring_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_model_monitoring_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_model_monitoring_proto_rawDesc), len(file_google_cloud_aiplatform_v1_model_monitoring_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_model_monitoring_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_model_monitoring_proto_rawDesc), len(file_google_cloud_aiplatform_v1_model_monitoring_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   0,
