...
const file_google_cloud_aiplatform_v1_io_proto_rawDesc = "" +
	"\n" +
	"#google/cloud/aiplatform/v1/io.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a)google/cloud/aiplatform/v1/api_auth.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"W\n" +
	"\n" +
	"AvroSource\x12I\n" +
	"\n" +
	"gcs_source\x18\x01 \x01(\v2%.google.cloud.aiplatform.v1.GcsSourceB\x03\xe0A\x02R\tgcsSource\"V\n" +
	"\tCsvSource\x12I\n" +
	"\n" +
	"gcs_source\x18\x01 \x01(\v2%.google.cloud.aiplatform.v1.GcsSourceB\x03\xe0A\x02R\tgcsSource\"$\n" +
	"\tGcsSource\x12\x17\n" +
	"\x04uris\x18\x01 \x03(\tB\x03\xe0A\x02R\x04uris\"A\n" +
	"\x0eGcsDestination\x12/\n" +
	"\x11output_uri_prefix\x18\x01 \x01(\tB\x03\xe0A\x02R\x0foutputUriPrefix\"2\n" +
	"\x0eBigQuerySource\x12 \n" +
	"\tinput_uri\x18\x01 \x01(\tB\x03\xe0A\x02R\binputUri\"9\n" +
	"\x13BigQueryDestination\x12\"\n" +
	"\n" +
	"output_uri\x18\x01 \x01(\tB\x03\xe0A\x02R\toutputUri\"m\n" +
	"\x1dVertexMultimodalDatasetSource\x12L\n" +
	"\fdataset_name\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!aiplatform.googleapis.com/DatasetR\vdatasetName\"\xb5\x01\n" +
	"\"VertexMultimodalDatasetDestination\x12g\n" +
	"\x14bigquery_destination\x18\x01 \x01(\v2/.google.cloud.aiplatform.v1.BigQueryDestinationB\x03\xe0A\x01R\x13bigqueryDestination\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x01R\vdisplayName\"j\n" +
	"\x0eCsvDestination\x12X\n" +
	"\x0fgcs_destination\x18\x01 \x01(\v2*.google.cloud.aiplatform.v1.GcsDestinationB\x03\xe0A\x02R\x0egcsDestination\"o\n" +
	"\x13TFRecordDestination\x12X\n" +
	"\x0fgcs_destination\x18\x01 \x01(\v2*.google.cloud.aiplatform.v1.GcsDestinationB\x03\xe0A\x02R\x0egcsDestination\"B\n" +
	"\x1cContainerRegistryDestination\x12\"\n" +
	"\n" +
	"output_uri\x18\x01 \x01(\tB\x03\xe0A\x02R\toutputUri\"\xfc\x02\n" +
	"\x11GoogleDriveSource\x12`\n" +
	"\fresource_ids\x18\x01 \x03(\v28.google.cloud.aiplatform.v1.GoogleDriveSource.ResourceIdB\x03\xe0A\x02R\vresourceIds\x1a\x84\x02\n" +
	"\n" +
	"ResourceId\x12o\n" +
	"\rresource_type\x18\x01 \x01(\x0e2E.google.cloud.aiplatform.v1.GoogleDriveSource.ResourceId.ResourceTypeB\x03\xe0A\x02R\fresourceType\x12$\n" +
	"\vresource_id\x18\x02 \x01(\tB\x03\xe0A\x02R\n" +
	"resourceId\"_\n" +
	"\fResourceType\x12\x1d\n" +
	"\x19RESOURCE_TYPE_UNSPECIFIED\x10\x00\x12\x16\n" +
	"\x12RESOURCE_TYPE_FILE\x10\x01\x12\x18\n" +
	"\x14RESOURCE_TYPE_FOLDER\x10\x02\"\x14\n" +
	"\x12DirectUploadSource\"\xea\x03\n" +
	"\vSlackSource\x12V\n" +
	"\bchannels\x18\x01 \x03(\v25.google.cloud.aiplatform.v1.SlackSource.SlackChannelsB\x03\xe0A\x02R\bchannels\x1a\x82\x03\n" +
	"\rSlackChannels\x12c\n" +
	"\bchannels\x18\x01 \x03(\v2B.google.cloud.aiplatform.v1.SlackSource.SlackChannels.SlackChannelB\x03\xe0A\x02R\bchannels\x12[\n" +
	"\x0eapi_key_config\x18\x03 \x01(\v20.google.cloud.aiplatform.v1.ApiAuth.ApiKeyConfigB\x03\xe0A\x02R\fapiKeyConfig\x1a\xae\x01\n" +
	"\fSlackChannel\x12\"\n" +
	"\n" +
	"channel_id\x18\x01 \x01(\tB\x03\xe0A\x02R\tchannelId\x12>\n" +
	"\n" +
	"start_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x01R\tstartTime\x12:\n" +
	"\bend_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x01R\aendTime\"\xd7\x02\n" +
	"\n" +
	"JiraSource\x12Z\n" +
	"\fjira_queries\x18\x01 \x03(\v22.google.cloud.aiplatform.v1.JiraSource.JiraQueriesB\x03\xe0A\x02R\vjiraQueries\x1a\xec\x01\n" +
	"\vJiraQueries\x12\x1a\n" +
	"\bprojects\x18\x03 \x03(\tR\bprojects\x12%\n" +
	"\x0ecustom_queries\x18\x04 \x03(\tR\rcustomQueries\x12\x19\n" +
	"\x05email\x18\x05 \x01(\tB\x03\xe0A\x02R\x05email\x12\"\n" +
	"\n" +
	"server_uri\x18\x06 \x01(\tB\x03\xe0A\x02R\tserverUri\x12[\n" +
	"\x0eapi_key_config\x18\a \x01(\v20.google.cloud.aiplatform.v1.ApiAuth.ApiKeyConfigB\x03\xe0A\x02R\fapiKeyConfig\"\xc4\x04\n" +
	"\x11SharePointSources\x12n\n" +
	"\x13share_point_sources\x18\x01 \x03(\v2>.google.cloud.aiplatform.v1.SharePointSources.SharePointSourceR\x11sharePointSources\x1a\xbe\x03\n" +
	...
	"\tclient_id\x18\x01 \x01(\tR\bclientId\x12U\n" +
	"\rclient_secret\x18\x02 \x01(\v20.google.cloud.aiplatform.v1.ApiAuth.ApiKeyConfigR\fclientSecret\x12\x1b\n" +
	"\ttenant_id\x18\x03 \x01(\tR\btenantId\x120\n" +
	"\x14sharepoint_site_name\x18\x04 \x01(\tR\x12sharepointSiteName\x12\x1c\n" +
	"\afile_id\x18\t \x01(\tB\x03\xe0A\x03R\x06fileIdB\x0f\n" +
	"\rfolder_sourceB\x0e\n" +
	"\fdrive_sourceB\xc5\x01\n" +
	"\x1ecom.google.cloud.aiplatform.v1B\aIoProtoP\x01Z>cloud.google.com/go/aiplatform/apiv1/aiplatformpb;aiplatformpb\xaa\x02\x1aGoogle.Cloud.AIPlatform.V1\xca\x02\x1aGoogle\\Cloud\\AIPlatform\\V1\xea\x02\x1dGoogle::Cloud::AIPlatform::V1b\x06proto3"

var (
	file_google_cloud_aiplatform_v1_io_proto_rawDescOnce sync.Once
	file_google_cloud_aiplatform_v1_io_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_io_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_io_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_io_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_io_proto_rawDesc), len(file_google_cloud_aiplatform_v1_io_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_io_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_io_proto_rawDesc), len(file_google_cloud_aiplatform_v1_io_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   21,
			NumExtensions: 0,
			NumServices:   0,
