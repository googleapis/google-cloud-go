...
const file_google_cloud_aiplatform_v1_study_proto_rawDesc = "" +
	"\n" +
	"&google/cloud/aiplatform/v1/study.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xef\x03\n" +
	"\x05Study\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x02R\vdisplayName\x12I\n" +
	"\n" +
	"study_spec\x18\x03 \x01(\v2%.google.cloud.aiplatform.v1.StudySpecB\x03\xe0A\x02R\tstudySpec\x12B\n" +
	"\x05state\x18\x04 \x01(\x0e2'.google.cloud.aiplatform.v1.Study.StateB\x03\xe0A\x03R\x05state\x12@\n" +
	...
	"\x1faiplatform.googleapis.com/Study\x127projects/{project}/locations/{location}/studies/{study}\"\xf7\b\n" +
	"\x05Trial\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12\x13\n" +
	"\x02id\x18\x02 \x01(\tB\x03\xe0A\x03R\x02id\x12B\n" +
	"\x05state\x18\x03 \x01(\x0e2'.google.cloud.aiplatform.v1.Trial.StateB\x03\xe0A\x03R\x05state\x12P\n" +
	"\n" +
	"parameters\x18\x04 \x03(\v2+.google.cloud.aiplatform.v1.Trial.ParameterB\x03\xe0A\x03R\n" +
	"parameters\x12Y\n" +
	"\x11final_measurement\x18\x05 \x01(\v2'.google.cloud.aiplatform.v1.MeasurementB\x03\xe0A\x03R\x10finalMeasurement\x12P\n" +
	"\fmeasurements\x18\x06 \x03(\v2'.google.cloud.aiplatform.v1.MeasurementB\x03\xe0A\x03R\fmeasurements\x12>\n" +
	"\n" +
	...
	"#aiplatform.googleapis.com/CustomJobR\tcustomJob\x12a\n" +
	"\x0fweb_access_uris\x18\f \x03(\v24.google.cloud.aiplatform.v1.Trial.WebAccessUrisEntryB\x03\xe0A\x03R\rwebAccessUris\x1af\n" +
	"\tParameter\x12&\n" +
	...
	"\n" +
	"parameters\x18\x02 \x03(\v2+.google.cloud.aiplatform.v1.Trial.ParameterR\n" +
	"parameters\"\x9c\x01\n" +
	...
	"\x19decay_curve_stopping_spec\x18\x04 \x01(\v2E.google.cloud.aiplatform.v1.StudySpec.DecayCurveAutomatedStoppingSpecH\x00R\x16decayCurveStoppingSpec\x12\x88\x01\n" +
	"\x1emedian_automated_stopping_spec\x18\x05 \x01(\v2A.google.cloud.aiplatform.v1.StudySpec.MedianAutomatedStoppingSpecH\x00R\x1bmedianAutomatedStoppingSpec\x12\x88\x01\n" +
	"\x1econvex_automated_stopping_spec\x18\t \x01(\v2A.google.cloud.aiplatform.v1.StudySpec.ConvexAutomatedStoppingSpecH\x00R\x1bconvexAutomatedStoppingSpec\x12O\n" +
	"\ametrics\x18\x01 \x03(\v20.google.cloud.aiplatform.v1.StudySpec.MetricSpecB\x03\xe0A\x02R\ametrics\x12X\n" +
	"\n" +
	"parameters\x18\x02 \x03(\v23.google.cloud.aiplatform.v1.StudySpec.ParameterSpecB\x03\xe0A\x02R\n" +
	"parameters\x12M\n" +
	"\talgorithm\x18\x03 \x01(\x0e2/.google.cloud.aiplatform.v1.StudySpec.AlgorithmR\talgorithm\x12c\n" +
	"\x11observation_noise\x18\x06 \x01(\x0e26.google.cloud.aiplatform.v1.StudySpec.ObservationNoiseR\x10observationNoise\x12|\n" +
	"\x1ameasurement_selection_type\x18\a \x01(\x0e2>.google.cloud.aiplatform.v1.StudySpec.MeasurementSelectionTypeR\x18measurementSelectionType\x12r\n" +
	"\x15study_stopping_config\x18\v \x01(\v29.google.cloud.aiplatform.v1.StudySpec.StudyStoppingConfigH\x01R\x13studyStoppingConfig\x88\x01\x01\x1a\xfa\x03\n" +
	"\n" +
	"MetricSpec\x12 \n" +
	"\tmetric_id\x18\x01 \x01(\tB\x03\xe0A\x02R\bmetricId\x12R\n" +
	"\x04goal\x18\x02 \x01(\x0e29.google.cloud.aiplatform.v1.StudySpec.MetricSpec.GoalTypeB\x03\xe0A\x02R\x04goal\x12m\n" +
	"\rsafety_config\x18\x03 \x01(\v2C.google.cloud.aiplatform.v1.StudySpec.MetricSpec.SafetyMetricConfigH\x00R\fsafetyConfig\x88\x01\x01\x1a\xb1\x01\n" +
	...
	"\x0e_safety_config\x1a\xa8\x11\n" +
	"\rParameterSpec\x12q\n" +
	"\x11double_value_spec\x18\x02 \x01(\v2C.google.cloud.aiplatform.v1.StudySpec.ParameterSpec.DoubleValueSpecH\x00R\x0fdoubleValueSpec\x12t\n" +
	"\x12integer_value_spec\x18\x03 \x01(\v2D.google.cloud.aiplatform.v1.StudySpec.ParameterSpec.IntegerValueSpecH\x00R\x10integerValueSpec\x12\x80\x01\n" +
	"\x16categorical_value_spec\x18\x04 \x01(\v2H.google.cloud.aiplatform.v1.StudySpec.ParameterSpec.CategoricalValueSpecH\x00R\x14categoricalValueSpec\x12w\n" +
	"\x13discrete_value_spec\x18\x05 \x01(\v2E.google.cloud.aiplatform.v1.StudySpec.ParameterSpec.DiscreteValueSpecH\x00R\x11discreteValueSpec\x12&\n" +
	"\fparameter_id\x18\x01 \x01(\tB\x03\xe0A\x02R\vparameterId\x12\\\n" +
	"\n" +
	"scale_type\x18\x06 \x01(\x0e2=.google.cloud.aiplatform.v1.StudySpec.ParameterSpec.ScaleTypeR\tscaleType\x12\x8c\x01\n" +
	"\x1bconditional_parameter_specs\x18\n" +
	" \x03(\v2L.google.cloud.aiplatform.v1.StudySpec.ParameterSpec.ConditionalParameterSpecR\x19conditionalParameterSpecs\x1a\x91\x01\n" +
	...
	"\x0e_default_value\x1a\x8c\x06\n" +
	"\x18ConditionalParameterSpec\x12\x9b\x01\n" +
	"\x16parent_discrete_values\x18\x02 \x01(\v2c.google.cloud.aiplatform.v1.StudySpec.ParameterSpec.ConditionalParameterSpec.DiscreteValueConditionH\x00R\x14parentDiscreteValues\x12\x8c\x01\n" +
	"\x11parent_int_values\x18\x03 \x01(\v2^.google.cloud.aiplatform.v1.StudySpec.ParameterSpec.ConditionalParameterSpec.IntValueConditionH\x00R\x0fparentIntValues\x12\xa4\x01\n" +
	"\x19parent_categorical_values\x18\x04 \x01(\v2f.google.cloud.aiplatform.v1.StudySpec.ParameterSpec.ConditionalParameterSpec.CategoricalValueConditionH\x00R\x17parentCategoricalValues\x12_\n" +
	"\x0eparameter_spec\x18\x01 \x01(\v23.google.cloud.aiplatform.v1.StudySpec.ParameterSpecB\x03\xe0A\x02R\rparameterSpec\x1a5\n" +
	...
	"\x1a_update_all_stopped_trials\x1a\xec\x04\n" +
	"\x13StudyStoppingConfig\x12D\n" +
	"\x10should_stop_asap\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x0eshouldStopAsap\x12m\n" +
	"\x1aminimum_runtime_constraint\x18\x02 \x01(\v2/.google.cloud.aiplatform.v1.StudyTimeConstraintR\x18minimumRuntimeConstraint\x12m\n" +
	"\x1amaximum_runtime_constraint\x18\x03 \x01(\v2/.google.cloud.aiplatform.v1.StudyTimeConstraintR\x18maximumRuntimeConstraint\x12A\n" +
	...
	"\x16_study_stopping_config\"\x92\x02\n" +
	"\vMeasurement\x12I\n" +
	"\x10elapsed_duration\x18\x01 \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x03R\x0felapsedDuration\x12\"\n" +
	"\n" +
	"step_count\x18\x02 \x01(\x03B\x03\xe0A\x03R\tstepCount\x12M\n" +
	"\ametrics\x18\x03 \x03(\v2..google.cloud.aiplatform.v1.Measurement.MetricB\x03\xe0A\x03R\ametrics\x1aE\n" +
	"\x06Metric\x12 \n" +
	"\tmetric_id\x18\x01 \x01(\tB\x03\xe0A\x03R\bmetricId\x12\x19\n" +
	"\x05value\x18\x02 \x01(\x01B\x03\xe0A\x03R\x05valueB\xc8\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_study_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_study_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_study_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_study_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_study_proto_rawDesc), len(file_google_cloud_aiplatform_v1_study_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_study_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_study_proto_rawDesc), len(file_google_cloud_aiplatform_v1_study_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   24,
			NumExtensions: 0,
			NumServices:   0,
