...
const file_google_cloud_aiplatform_v1_tensorboard_experiment_proto_rawDesc = "" +
	"\n" +
	"7google/cloud/aiplatform/v1/tensorboard_experiment.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd1\x04\n" +
	...
	"updateTime\x12U\n" +
	"\x06labels\x18\x06 \x03(\v2=.google.cloud.aiplatform.v1.TensorboardExperiment.LabelsEntryR\x06labels\x12\x12\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_tensorboard_experiment_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_tensorboard_experiment_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_tensorboard_experiment_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_tensorboard_experiment_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_tensorboard_experiment_proto_rawDesc), len(file_google_cloud_aiplatform_v1_tensorboard_experiment_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1_tensorboard_experiment_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1_tensorboard_experiment_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_tensorboard_experiment_proto_rawDesc), len(file_google_cloud_aiplatform_v1_tensorboard_experiment_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
