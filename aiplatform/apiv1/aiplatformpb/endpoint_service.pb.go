...
func file_google_cloud_aiplatform_v1_endpoint_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_aiplatform_v1_endpoint_service_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_aiplatform_v1_endpoint_service_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_aiplatform_v1_endpoint_service_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
