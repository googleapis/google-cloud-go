...
const file_google_cloud_aiplatform_v1_model_evaluation_slice_proto_rawDesc = "" +
	...
	"createTime\x12^\n" +
	"\x11model_explanation\x18\x06 \x01(\v2,.google.cloud.aiplatform.v1.ModelExplanationB\x03\xe0A\x03R\x10modelExplanation\x1a\xca\x06\n" +
	"\x05Slice\x12!\n" +
	"\tdimension\x18\x01 \x01(\tB\x03\xe0A\x03R\tdimension\x12\x19\n" +
	"\x05value\x18\x02 \x01(\tB\x03\xe0A\x03R\x05value\x12d\n" +
	"\n" +
	"slice_spec\x18\x03 \x01(\v2@.google.cloud.aiplatform.v1.ModelEvaluationSlice.Slice.SliceSpecB\x03\xe0A\x03R\tsliceSpec\x1a\x9c\x05\n" +
	"\tSliceSpec\x12g\n" +
	"\aconfigs\x18\x01 \x03(\v2M.google.cloud.aiplatform.v1.ModelEvaluationSlice.Slice.SliceSpec.ConfigsEntryR\aconfigs\x1a\x92\x02\n" +
	"\vSliceConfig\x12^\n" +
	"\x05value\x18\x01 \x01(\v2F.google.cloud.aiplatform.v1.ModelEvaluationSlice.Slice.SliceSpec.ValueH\x00R\x05value\x12^\n" +
	"\x05range\x18\x02 \x01(\v2F.google.cloud.aiplatform.v1.ModelEvaluationSlice.Slice.SliceSpec.RangeH\x00R\x05range\x12;\n" +
	"\n" +
	...
	"\x05value\x18\x02 \x01(\v2L.google.cloud.aiplatform.v1.ModelEvaluationSlice.Slice.SliceSpec.SliceConfigR\x05value:\x028\x01:\x94\x01\xeaA\x90\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_model_evaluation_slice_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_model_evaluation_slice_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_model_evaluation_slice_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_model_evaluation_slice_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_model_evaluation_slice_proto_rawDesc), len(file_google_cloud_aiplatform_v1_model_evaluation_slice_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1_model_evaluation_slice_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1_model_evaluation_slice_proto_init() {
	...
	file_google_cloud_aiplatform_v1_model_evaluation_slice_proto_msgTypes[3].OneofWrappers = []any{
	...
	file_google_cloud_aiplatform_v1_model_evaluation_slice_proto_msgTypes[5].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_model_evaluation_slice_proto_rawDesc), len(file_google_cloud_aiplatform_v1_model_evaluation_slice_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
