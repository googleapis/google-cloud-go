...
func file_google_cloud_aiplatform_v1_explanation_metadata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_aiplatform_v1_explanation_metadata_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_explanation_metadata_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_explanation_metadata_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_explanation_metadata_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_explanation_metadata_proto_msgTypes[6].Exporter = func(v any, i int) any {
