...
const file_google_cloud_aiplatform_v1_explanation_metadata_proto_rawDesc = "" +
	"\n" +
	"5google/cloud/aiplatform/v1/explanation_metadata.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xba\x16\n" +
	"\x13ExplanationMetadata\x12X\n" +
	"\x06inputs\x18\x01 \x03(\v2;.google.cloud.aiplatform.v1.ExplanationMetadata.InputsEntryB\x03\xe0A\x02R\x06inputs\x12[\n" +
	"\aoutputs\x18\x02 \x03(\v2<.google.cloud.aiplatform.v1.ExplanationMetadata.OutputsEntryB\x03\xe0A\x02R\aoutputs\x12E\n" +
	"\x1ffeature_attributions_schema_uri\x18\x03 \x01(\tR\x1cfeatureAttributionsSchemaUri\x12.\n" +
	"\x13latent_space_source\x18\x05 \x01(\tR\x11latentSpaceSource\x1a\x93\x10\n" +
	"\rInputMetadata\x12?\n" +
	"\x0finput_baselines\x18\x01 \x03(\v2\x16.google.protobuf.ValueR\x0einputBaselines\x12*\n" +
	"\x11input_tensor_name\x18\x02 \x01(\tR\x0finputTensorName\x12b\n" +
	"\bencoding\x18\x03 \x01(\x0e2F.google.cloud.aiplatform.v1.ExplanationMetadata.InputMetadata.EncodingR\bencoding\x12\x1a\n" +
	"\bmodality\x18\x04 \x01(\tR\bmodality\x12\x82\x01\n" +
	"\x14feature_value_domain\x18\x05 \x01(\v2P.google.cloud.aiplatform.v1.ExplanationMetadata.InputMetadata.FeatureValueDomainR\x12featureValueDomain\x12.\n" +
	...
	" \x03(\v2\x16.google.protobuf.ValueR\x10encodedBaselines\x12q\n" +
	"\rvisualization\x18\v \x01(\v2K.google.cloud.aiplatform.v1.ExplanationMetadata.InputMetadata.VisualizationR\rvisualization\x12\x1d\n" +
	"\n" +
	...
	"\x0foriginal_stddev\x18\x04 \x01(\x02R\x0eoriginalStddev\x1a\xab\a\n" +
	"\rVisualization\x12d\n" +
	"\x04type\x18\x01 \x01(\x0e2P.google.cloud.aiplatform.v1.ExplanationMetadata.InputMetadata.Visualization.TypeR\x04type\x12p\n" +
	"\bpolarity\x18\x02 \x01(\x0e2T.google.cloud.aiplatform.v1.ExplanationMetadata.InputMetadata.Visualization.PolarityR\bpolarity\x12q\n" +
	"\tcolor_map\x18\x03 \x01(\x0e2T.google.cloud.aiplatform.v1.ExplanationMetadata.InputMetadata.Visualization.ColorMapR\bcolorMap\x126\n" +
	"\x17clip_percent_upperbound\x18\x04 \x01(\x02R\x15clipPercentUpperbound\x126\n" +
	"\x17clip_percent_lowerbound\x18\x05 \x01(\x02R\x15clipPercentLowerbound\x12z\n" +
	"\foverlay_type\x18\x06 \x01(\x0e2W.google.cloud.aiplatform.v1.ExplanationMetadata.InputMetadata.Visualization.OverlayTypeR\voverlayType\"6\n" +
	"\x04Type\x12\x14\n" +
	...
	"\x14display_name_mapping\x1ax\n" +
	"\vInputsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12S\n" +
	"\x05value\x18\x02 \x01(\v2=.google.cloud.aiplatform.v1.ExplanationMetadata.InputMetadataR\x05value:\x028\x01\x1az\n" +
	"\fOutputsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12T\n" +
	"\x05value\x18\x02 \x01(\v2>.google.cloud.aiplatform.v1.ExplanationMetadata.OutputMetadataR\x05value:\x028\x01B\xd6\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_explanation_metadata_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_explanation_metadata_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_explanation_metadata_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_explanation_metadata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_explanation_metadata_proto_rawDesc), len(file_google_cloud_aiplatform_v1_explanation_metadata_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_explanation_metadata_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_explanation_metadata_proto_rawDesc), len(file_google_cloud_aiplatform_v1_explanation_metadata_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
