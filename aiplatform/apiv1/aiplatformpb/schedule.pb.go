...
const file_google_cloud_aiplatform_v1_schedule_proto_rawDesc = "" +
	"\n" +
	")google/cloud/aiplatform/v1/schedule.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a1google/cloud/aiplatform/v1/notebook_service.proto\x1a1google/cloud/aiplatform/v1/pipeline_service.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfc\f\n" +
	"\bSchedule\x12\x14\n" +
	"\x04cron\x18\n" +
	" \x01(\tH\x00R\x04cron\x12u\n" +
	"\x1bcreate_pipeline_job_request\x18\x0e \x01(\v24.google.cloud.aiplatform.v1.CreatePipelineJobRequestH\x01R\x18createPipelineJobRequest\x12\x91\x01\n" +
	"%create_notebook_execution_job_request\x18\x14 \x01(\v2=.google.cloud.aiplatform.v1.CreateNotebookExecutionJobRequestH\x01R!createNotebookExecutionJobRequest\x12\x17\n" +
	...
	"\x11started_run_count\x18\x11 \x01(\x03B\x03\xe0A\x03R\x0fstartedRunCount\x12E\n" +
	"\x05state\x18\x05 \x01(\x0e2*.google.cloud.aiplatform.v1.Schedule.StateB\x03\xe0A\x03R\x05state\x12@\n" +
	...
	"\bcatch_up\x18\r \x01(\bB\x03\xe0A\x03R\acatchUp\x12t\n" +
	"\x1blast_scheduled_run_response\x18\x12 \x01(\v20.google.cloud.aiplatform.v1.Schedule.RunResponseB\x03\xe0A\x03R\x18lastScheduledRunResponse\x1az\n" +
	"\vRunResponse\x12H\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_schedule_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_schedule_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_schedule_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_schedule_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_schedule_proto_rawDesc), len(file_google_cloud_aiplatform_v1_schedule_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_schedule_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_schedule_proto_rawDesc), len(file_google_cloud_aiplatform_v1_schedule_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
