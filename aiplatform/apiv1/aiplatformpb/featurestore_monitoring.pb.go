...
func (x *FeaturestoreMonitoringConfig_ThresholdConfig) GetValue() float64 {
	if x != nil {
		if x, ok := x.Threshold.(*FeaturestoreMonitoringConfig_ThresholdConfig_Value); ok {
			return x.Value
		}
	}
	return 0
...
const file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_rawDesc = "" +
	"\n" +
	"8google/cloud/aiplatform/v1/featurestore_monitoring.proto\x12\x1agoogle.cloud.aiplatform.v1\"\xe7\t\n" +
	"\x1cFeaturestoreMonitoringConfig\x12v\n" +
	"\x11snapshot_analysis\x18\x01 \x01(\v2I.google.cloud.aiplatform.v1.FeaturestoreMonitoringConfig.SnapshotAnalysisR\x10snapshotAnalysis\x12\x89\x01\n" +
	"\x18import_features_analysis\x18\x02 \x01(\v2O.google.cloud.aiplatform.v1.FeaturestoreMonitoringConfig.ImportFeaturesAnalysisR\x16importFeaturesAnalysis\x12\x86\x01\n" +
	"\x1anumerical_threshold_config\x18\x03 \x01(\v2H.google.cloud.aiplatform.v1.FeaturestoreMonitoringConfig.ThresholdConfigR\x18numericalThresholdConfig\x12\x8a\x01\n" +
	"\x1ccategorical_threshold_config\x18\x04 \x01(\v2H.google.cloud.aiplatform.v1.FeaturestoreMonitoringConfig.ThresholdConfigR\x1acategoricalThresholdConfig\x1a\x8f\x01\n" +
	"\x10SnapshotAnalysis\x12\x1a\n" +
	"\bdisabled\x18\x01 \x01(\bR\bdisabled\x128\n" +
	"\x18monitoring_interval_days\x18\x03 \x01(\x05R\x16monitoringIntervalDays\x12%\n" +
	"\x0estaleness_days\x18\x04 \x01(\x05R\rstalenessDays\x1a\xe2\x03\n" +
	"\x16ImportFeaturesAnalysis\x12k\n" +
	"\x05state\x18\x01 \x01(\x0e2U.google.cloud.aiplatform.v1.FeaturestoreMonitoringConfig.ImportFeaturesAnalysis.StateR\x05state\x12\x96\x01\n" +
	"\x1aanomaly_detection_baseline\x18\x02 \x01(\x0e2X.google.cloud.aiplatform.v1.FeaturestoreMonitoringConfig.ImportFeaturesAnalysis.BaselineR\x18anomalyDetectionBaseline\"F\n" +
	"\x05State\x12\x15\n" +
	...
	"\fLATEST_STATS\x10\x01\x12\x1e\n" +
	"\x1aMOST_RECENT_SNAPSHOT_STATS\x10\x02\x12\"\n" +
	"\x1ePREVIOUS_IMPORT_FEATURES_STATS\x10\x03\x1a6\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_rawDesc), len(file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_rawDesc), len(file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
