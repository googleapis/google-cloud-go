...
var file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_google_cloud_aiplatform_v1_featurestore_monitoring_proto_msgTypes[3].OneofWrappers = []any{
