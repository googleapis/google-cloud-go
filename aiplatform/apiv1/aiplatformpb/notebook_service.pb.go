...
const file_google_cloud_aiplatform_v1_notebook_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x19notebook_runtime_template\x18\x02 \x01(\v23.google.cloud.aiplatform.v1.NotebookRuntimeTemplateB\x03\xe0A\x02R\x17notebookRuntimeTemplate\x12D\n" +
	"\x1cnotebook_runtime_template_id\x18\x03 \x01(\tB\x03\xe0A\x01R\x19notebookRuntimeTemplateId\"\x91\x01\n" +
	".CreateNotebookRuntimeTemplateOperationMetadata\x12_\n" +
	...
	"\border_by\x18\x06 \x01(\tB\x03\xe0A\x01R\aorderBy\"\xc1\x01\n" +
	"$ListNotebookRuntimeTemplatesResponse\x12q\n" +
	"\x1anotebook_runtime_templates\x18\x01 \x03(\v23.google.cloud.aiplatform.v1.NotebookRuntimeTemplateR\x18notebookRuntimeTemplates\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"u\n" +
	"$DeleteNotebookRuntimeTemplateRequest\x12M\n" +
	"\x04name\x18\x01 \x01(\tB9\xe0A\x02\xfaA3\n" +
	"1aiplatform.googleapis.com/NotebookRuntimeTemplateR\x04name\"\xde\x01\n" +
	"$UpdateNotebookRuntimeTemplateRequest\x12t\n" +
	"\x19notebook_runtime_template\x18\x01 \x01(\v23.google.cloud.aiplatform.v1.NotebookRuntimeTemplateB\x03\xe0A\x02R\x17notebookRuntimeTemplate\x12@\n" +
	...
	"\x10notebook_runtime\x18\x03 \x01(\v2+.google.cloud.aiplatform.v1.NotebookRuntimeB\x03\xe0A\x02R\x0fnotebookRuntime\x123\n" +
	"\x13notebook_runtime_id\x18\x04 \x01(\tB\x03\xe0A\x01R\x11notebookRuntimeId\"\xb4\x01\n" +
	"&AssignNotebookRuntimeOperationMetadata\x12_\n" +
	...
	"page_token\x18\x04 \x01(\tB\x03\xe0A\x01R\tpageToken\x12<\n" +
	"\tread_mask\x18\x05 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x01R\breadMask\x12\x1e\n" +
	"\border_by\x18\x06 \x01(\tB\x03\xe0A\x01R\aorderBy\"\xa0\x01\n" +
	"\x1cListNotebookRuntimesResponse\x12X\n" +
	"\x11notebook_runtimes\x18\x01 \x03(\v2+.google.cloud.aiplatform.v1.NotebookRuntimeR\x10notebookRuntimes\x12&\n" +
	...
	"\x04name\x18\x01 \x01(\tB1\xe0A\x02\xfaA+\n" +
	")aiplatform.googleapis.com/NotebookRuntimeR\x04name\"\xb5\x01\n" +
	"'UpgradeNotebookRuntimeOperationMetadata\x12_\n" +
	"\x10generic_metadata\x18\x01 \x01(\v24.google.cloud.aiplatform.v1.GenericOperationMetadataR\x0fgenericMetadata\x12)\n" +
	...
	"\x04name\x18\x01 \x01(\tB1\xe0A\x02\xfaA+\n" +
	")aiplatform.googleapis.com/NotebookRuntimeR\x04name\"\xb3\x01\n" +
	"%StartNotebookRuntimeOperationMetadata\x12_\n" +
	"\x10generic_metadata\x18\x01 \x01(\v24.google.cloud.aiplatform.v1.GenericOperationMetadataR\x0fgenericMetadata\x12)\n" +
	...
	"\x04name\x18\x01 \x01(\tB1\xe0A\x02\xfaA+\n" +
	")aiplatform.googleapis.com/NotebookRuntimeR\x04name\"\x87\x01\n" +
	"$StopNotebookRuntimeOperationMetadata\x12_\n" +
	"\x10generic_metadata\x18\x01 \x01(\v24.google.cloud.aiplatform.v1.GenericOperationMetadataR\x0fgenericMetadata\"\x1d\n" +
	"\x1bStopNotebookRuntimeResponse\"\x93\x02\n" +
	"!CreateNotebookExecutionJobRequest\x12A\n" +
	"\x06parent\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!locations.googleapis.com/LocationR\x06parent\x12k\n" +
	"\x16notebook_execution_job\x18\x02 \x01(\v20.google.cloud.aiplatform.v1.NotebookExecutionJobB\x03\xe0A\x02R\x14notebookExecutionJob\x12>\n" +
	"\x19notebook_execution_job_id\x18\x03 \x01(\tB\x03\xe0A\x01R\x16notebookExecutionJobId\"\xb9\x01\n" +
	"+CreateNotebookExecutionJobOperationMetadata\x12_\n" +
	"\x10generic_metadata\x18\x01 \x01(\v24.google.cloud.aiplatform.v1.GenericOperationMetadataR\x0fgenericMetadata\x12)\n" +
	"\x10progress_message\x18\x02 \x01(\tR\x0fprogressMessage\"\xbb\x01\n" +
	"\x1eGetNotebookExecutionJobRequest\x12J\n" +
	"\x04name\x18\x01 \x01(\tB6\xe0A\x02\xfaA0\n" +
	".aiplatform.googleapis.com/NotebookExecutionJobR\x04name\x12M\n" +
	"\x04view\x18\x06 \x01(\x0e24.google.cloud.aiplatform.v1.NotebookExecutionJobViewB\x03\xe0A\x01R\x04view\"\xb7\x02\n" +
	...
	"\border_by\x18\x05 \x01(\tB\x03\xe0A\x01R\aorderBy\x12M\n" +
	"\x04view\x18\x06 \x01(\x0e24.google.cloud.aiplatform.v1.NotebookExecutionJobViewB\x03\xe0A\x01R\x04view\"\xb5\x01\n" +
	"!ListNotebookExecutionJobsResponse\x12h\n" +
	"\x17notebook_execution_jobs\x18\x01 \x03(\v20.google.cloud.aiplatform.v1.NotebookExecutionJobR\x15notebookExecutionJobs\x12&\n" +
	...
	"\x17NotebookRuntimeTemplate\x12.CreateNotebookRuntimeTemplateOperationMetadata\xdaA=parent,notebook_runtime_template,notebook_runtime_template_id\x82\xd3\xe4\x93\x02Y:\x19notebook_runtime_template\"</v1/{parent=projects/*/locations/*}/notebookRuntimeTemplates\x12\xdd\x01\n" +
	...
	"\x1dUpdateNotebookRuntimeTemplate\x12@.google.cloud.aiplatform.v1.UpdateNotebookRuntimeTemplateRequest\x1a3.google.cloud.aiplatform.v1.NotebookRuntimeTemplate\"\xa1\x01\xdaA%notebook_runtime_template,update_mask\x82\xd3\xe4\x93\x02s:\x19notebook_runtime_template2V/v1/{notebook_runtime_template.name=projects/*/locations/*/notebookRuntimeTemplates/*}\x12\xbd\x02\n" +
	...
	"\x0fNotebookRuntime\x12&AssignNotebookRuntimeOperationMetadata\xdaAEparent,notebook_runtime_template,notebook_runtime,notebook_runtime_id\x82\xd3\xe4\x93\x02@:\x01*\";/v1/{parent=projects/*/locations/*}/notebookRuntimes:assign\x12\xbd\x01\n" +
	...
	"\x1eUpgradeNotebookRuntimeResponse\x12'UpgradeNotebookRuntimeOperationMetadata\xdaA\x04name\x82\xd3\xe4\x93\x02A:\x01*\"</v1/{name=projects/*/locations/*/notebookRuntimes/*}:upgrade\x12\x85\x02\n" +
	...
	"\x1cStartNotebookRuntimeResponse\x12%StartNotebookRuntimeOperationMetadata\xdaA\x04name\x82\xd3\xe4\x93\x02?:\x01*\":/v1/{name=projects/*/locations/*/notebookRuntimes/*}:start\x12\x80\x02\n" +
	...
	"\x1bStopNotebookRuntimeResponse\x12$StopNotebookRuntimeOperationMetadata\xdaA\x04name\x82\xd3\xe4\x93\x02>:\x01*\"9/v1/{name=projects/*/locations/*/notebookRuntimes/*}:stop\x12\xd6\x02\n" +
	...
	"\x14NotebookExecutionJob\x12+CreateNotebookExecutionJobOperationMetadata\xdaA7parent,notebook_execution_job,notebook_execution_job_id\x82\xd3\xe4\x93\x02S:\x16notebook_execution_job\"9/v1/{parent=projects/*/locations/*}/notebookExecutionJobs\x12\xd1\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_notebook_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_notebook_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_notebook_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_notebook_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_notebook_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1_notebook_service_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_notebook_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_notebook_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1_notebook_service_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   28,
			NumExtensions: 0,
			NumServices:   1,
