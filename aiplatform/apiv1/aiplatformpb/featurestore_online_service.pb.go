...
func file_google_cloud_aiplatform_v1_featurestore_online_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_aiplatform_v1_featurestore_online_service_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_aiplatform_v1_featurestore_online_service_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_aiplatform_v1_featurestore_online_service_proto_msgTypes[14].OneofWrappers = []interface{}{
