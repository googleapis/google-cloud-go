...
func file_google_cloud_aiplatform_v1_publisher_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_aiplatform_v1_publisher_model_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_aiplatform_v1_publisher_model_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_aiplatform_v1_publisher_model_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_aiplatform_v1_publisher_model_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_google_cloud_aiplatform_v1_publisher_model_proto_msgTypes[4].OneofWrappers = []interface{}{}
	file_google_cloud_aiplatform_v1_publisher_model_proto_msgTypes[8].OneofWrappers = []interface{}{
