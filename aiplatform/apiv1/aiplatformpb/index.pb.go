...
func file_google_cloud_aiplatform_v1_index_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_aiplatform_v1_index_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_aiplatform_v1_index_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_aiplatform_v1_index_proto_msgTypes[6].OneofWrappers = []interface{}{
