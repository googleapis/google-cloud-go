...
const file_google_cloud_aiplatform_v1_machine_resources_proto_rawDesc = "" +
	"\n" +
	"2google/cloud/aiplatform/v1/machine_resources.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a1google/cloud/aiplatform/v1/accelerator_type.proto\x1a5google/cloud/aiplatform/v1/reservation_affinity.proto\"\x89\x03\n" +
	"\vMachineSpec\x12&\n" +
	"\fmachine_type\x18\x01 \x01(\tB\x03\xe0A\x05R\vmachineType\x12[\n" +
	"\x10accelerator_type\x18\x02 \x01(\x0e2+.google.cloud.aiplatform.v1.AcceleratorTypeB\x03\xe0A\x05R\x0facceleratorType\x12+\n" +
	...
	"\ftpu_topology\x18\x04 \x01(\tB\x03\xe0A\x05R\vtpuTopology\x12j\n" +
	"\x14reservation_affinity\x18\x05 \x01(\v2/.google.cloud.aiplatform.v1.ReservationAffinityB\x06\xe0A\x05\xe0A\x01R\x13reservationAffinity\"\x93\x03\n" +
	"\x12DedicatedResources\x12R\n" +
	"\fmachine_spec\x18\x01 \x01(\v2'.google.cloud.aiplatform.v1.MachineSpecB\x06\xe0A\x02\xe0A\x05R\vmachineSpec\x122\n" +
	...
	"\x16required_replica_count\x18\t \x01(\x05B\x03\xe0A\x01R\x14requiredReplicaCount\x12p\n" +
	"\x18autoscaling_metric_specs\x18\x04 \x03(\v21.google.cloud.aiplatform.v1.AutoscalingMetricSpecB\x03\xe0A\x05R\x16autoscalingMetricSpecs\x12\x17\n" +
	"\x04spot\x18\x05 \x01(\bB\x03\xe0A\x01R\x04spot\"v\n" +
	"\x12AutomaticResources\x12/\n" +
	"\x11min_replica_count\x18\x01 \x01(\x05B\x03\xe0A\x05R\x0fminReplicaCount\x12/\n" +
	"\x11max_replica_count\x18\x02 \x01(\x05B\x03\xe0A\x05R\x0fmaxReplicaCount\"\xd9\x01\n" +
	"\x17BatchDedicatedResources\x12R\n" +
	"\fmachine_spec\x18\x01 \x01(\v2'.google.cloud.aiplatform.v1.MachineSpecB\x06\xe0A\x02\xe0A\x05R\vmachineSpec\x129\n" +
	"\x16starting_replica_count\x18\x02 \x01(\x05B\x03\xe0A\x05R\x14startingReplicaCount\x12/\n" +
	"\x11max_replica_count\x18\x03 \x01(\x05B\x03\xe0A\x05R\x0fmaxReplicaCount\"=\n" +
	...
	"\x12enable_secure_boot\x18\x01 \x01(\bR\x10enableSecureBootB\xd3\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_machine_resources_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_machine_resources_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_machine_resources_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_machine_resources_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_machine_resources_proto_rawDesc), len(file_google_cloud_aiplatform_v1_machine_resources_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_machine_resources_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_machine_resources_proto_rawDesc), len(file_google_cloud_aiplatform_v1_machine_resources_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
