...
const file_google_cloud_aiplatform_v1_manual_batch_tuning_parameters_proto_rawDesc = "" +
	"\n" +
	"?google/cloud/aiplatform/v1/manual_batch_tuning_parameters.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\"A\n" +
	"\x1bManualBatchTuningParameters\x12\"\n" +
	"\n" +
	"batch_size\x18\x01 \x01(\x05B\x03\xe0A\x05R\tbatchSizeB\xde\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_manual_batch_tuning_parameters_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_manual_batch_tuning_parameters_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_manual_batch_tuning_parameters_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_manual_batch_tuning_parameters_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_manual_batch_tuning_parameters_proto_rawDesc), len(file_google_cloud_aiplatform_v1_manual_batch_tuning_parameters_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1_manual_batch_tuning_parameters_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1_manual_batch_tuning_parameters_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_manual_batch_tuning_parameters_proto_rawDesc), len(file_google_cloud_aiplatform_v1_manual_batch_tuning_parameters_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
