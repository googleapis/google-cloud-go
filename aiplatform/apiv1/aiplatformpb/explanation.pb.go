...
const file_google_cloud_aiplatform_v1_explanation_proto_rawDesc = "" +
	"\n" +
	",google/cloud/aiplatform/v1/explanation.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a5google/cloud/aiplatform/v1/explanation_metadata.proto\x1a#google/cloud/aiplatform/v1/io.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xa8\x01\n" +
	"\vExplanation\x12P\n" +
	"\fattributions\x18\x01 \x03(\v2'.google.cloud.aiplatform.v1.AttributionB\x03\xe0A\x03R\fattributions\x12G\n" +
	"\tneighbors\x18\x02 \x03(\v2$.google.cloud.aiplatform.v1.NeighborB\x03\xe0A\x03R\tneighbors\"m\n" +
	"\x10ModelExplanation\x12Y\n" +
	"\x11mean_attributions\x18\x01 \x03(\v2'.google.cloud.aiplatform.v1.AttributionB\x03\xe0A\x03R\x10meanAttributions\"\x88\x03\n" +
	"\vAttribution\x127\n" +
	...
	"neighborId\x120\n" +
	"\x11neighbor_distance\x18\x02 \x01(\x01B\x03\xe0A\x03R\x10neighborDistance\"\xbb\x01\n" +
	"\x0fExplanationSpec\x12V\n" +
	"\n" +
	"parameters\x18\x01 \x01(\v21.google.cloud.aiplatform.v1.ExplanationParametersB\x03\xe0A\x02R\n" +
	"parameters\x12P\n" +
	"\bmetadata\x18\x02 \x01(\v2/.google.cloud.aiplatform.v1.ExplanationMetadataB\x03\xe0A\x01R\bmetadata\"\x99\x04\n" +
	"\x15ExplanationParameters\x12w\n" +
	"\x1bsampled_shapley_attribution\x18\x01 \x01(\v25.google.cloud.aiplatform.v1.SampledShapleyAttributionH\x00R\x19sampledShapleyAttribution\x12\x86\x01\n" +
	" integrated_gradients_attribution\x18\x02 \x01(\v2:.google.cloud.aiplatform.v1.IntegratedGradientsAttributionH\x00R\x1eintegratedGradientsAttribution\x12X\n" +
	"\x10xrai_attribution\x18\x03 \x01(\v2+.google.cloud.aiplatform.v1.XraiAttributionH\x00R\x0fxraiAttribution\x12B\n" +
	"\bexamples\x18\a \x01(\v2$.google.cloud.aiplatform.v1.ExamplesH\x00R\bexamples\x12\x13\n" +
	...
	"\n" +
	"path_count\x18\x01 \x01(\x05B\x03\xe0A\x02R\tpathCount\"\x82\x02\n" +
	"\x1eIntegratedGradientsAttribution\x12\"\n" +
	"\n" +
	"step_count\x18\x01 \x01(\x05B\x03\xe0A\x02R\tstepCount\x12Z\n" +
	"\x12smooth_grad_config\x18\x02 \x01(\v2,.google.cloud.aiplatform.v1.SmoothGradConfigR\x10smoothGradConfig\x12`\n" +
	"\x14blur_baseline_config\x18\x03 \x01(\v2..google.cloud.aiplatform.v1.BlurBaselineConfigR\x12blurBaselineConfig\"\xf3\x01\n" +
	"\x0fXraiAttribution\x12\"\n" +
	"\n" +
	"step_count\x18\x01 \x01(\x05B\x03\xe0A\x02R\tstepCount\x12Z\n" +
	"\x12smooth_grad_config\x18\x02 \x01(\v2,.google.cloud.aiplatform.v1.SmoothGradConfigR\x10smoothGradConfig\x12`\n" +
	"\x14blur_baseline_config\x18\x03 \x01(\v2..google.cloud.aiplatform.v1.BlurBaselineConfigR\x12blurBaselineConfig\"\xda\x01\n" +
	"\x10SmoothGradConfig\x12!\n" +
	"\vnoise_sigma\x18\x01 \x01(\x02H\x00R\n" +
	"noiseSigma\x12_\n" +
	"\x13feature_noise_sigma\x18\x02 \x01(\v2-.google.cloud.aiplatform.v1.FeatureNoiseSigmaH\x00R\x11featureNoiseSigma\x12,\n" +
	"\x12noisy_sample_count\x18\x03 \x01(\x05R\x10noisySampleCountB\x14\n" +
	"\x12GradientNoiseSigma\"\xba\x01\n" +
	"\x11FeatureNoiseSigma\x12c\n" +
	"\vnoise_sigma\x18\x01 \x03(\v2B.google.cloud.aiplatform.v1.FeatureNoiseSigma.NoiseSigmaForFeatureR\n" +
	"noiseSigma\x1a@\n" +
	"\x14NoiseSigmaForFeature\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05sigma\x18\x02 \x01(\x02R\x05sigma\":\n" +
	"\x12BlurBaselineConfig\x12$\n" +
	"\x0emax_blur_sigma\x18\x01 \x01(\x02R\fmaxBlurSigma\"\xc0\x04\n" +
	"\bExamples\x12e\n" +
	"\x12example_gcs_source\x18\x05 \x01(\v25.google.cloud.aiplatform.v1.Examples.ExampleGcsSourceH\x00R\x10exampleGcsSource\x12]\n" +
	"\x1enearest_neighbor_search_config\x18\x02 \x01(\v2\x16.google.protobuf.ValueH\x01R\x1bnearestNeighborSearchConfig\x12?\n" +
	"\apresets\x18\x04 \x01(\v2#.google.cloud.aiplatform.v1.PresetsH\x01R\apresets\x12%\n" +
	"\x0eneighbor_count\x18\x03 \x01(\x05R\rneighborCount\x1a\xf1\x01\n" +
	"\x10ExampleGcsSource\x12a\n" +
	"\vdata_format\x18\x01 \x01(\x0e2@.google.cloud.aiplatform.v1.Examples.ExampleGcsSource.DataFormatR\n" +
	"dataFormat\x12D\n" +
	"\n" +
	"gcs_source\x18\x02 \x01(\v2%.google.cloud.aiplatform.v1.GcsSourceR\tgcsSource\"4\n" +
	"\n" +
	"DataFormat\x12\x1b\n" +
	...
	"\x06config\"\x8b\x02\n" +
	"\aPresets\x12D\n" +
	"\x05query\x18\x01 \x01(\x0e2).google.cloud.aiplatform.v1.Presets.QueryH\x00R\x05query\x88\x01\x01\x12H\n" +
	"\bmodality\x18\x02 \x01(\x0e2,.google.cloud.aiplatform.v1.Presets.ModalityR\bmodality\"\x1e\n" +
	"\x05Query\x12\v\n" +
	...
	"\aTABULAR\x10\x03B\b\n" +
	"\x06_query\"\x9c\x02\n" +
	"\x17ExplanationSpecOverride\x12Q\n" +
	"\n" +
	"parameters\x18\x01 \x01(\v21.google.cloud.aiplatform.v1.ExplanationParametersR\n" +
	"parameters\x12S\n" +
	"\bmetadata\x18\x02 \x01(\v27.google.cloud.aiplatform.v1.ExplanationMetadataOverrideR\bmetadata\x12Y\n" +
	"\x11examples_override\x18\x03 \x01(\v2,.google.cloud.aiplatform.v1.ExamplesOverrideR\x10examplesOverride\"\xe4\x02\n" +
	"\x1bExplanationMetadataOverride\x12`\n" +
	"\x06inputs\x18\x01 \x03(\v2C.google.cloud.aiplatform.v1.ExplanationMetadataOverride.InputsEntryB\x03\xe0A\x02R\x06inputs\x1aX\n" +
	"\x15InputMetadataOverride\x12?\n" +
	"\x0finput_baselines\x18\x01 \x03(\v2\x16.google.protobuf.ValueR\x0einputBaselines\x1a\x88\x01\n" +
	"\vInputsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12c\n" +
	"\x05value\x18\x02 \x01(\v2M.google.cloud.aiplatform.v1.ExplanationMetadataOverride.InputMetadataOverrideR\x05value:\x028\x01\"\x90\x03\n" +
	...
	"\frestrictions\x18\x03 \x03(\v29.google.cloud.aiplatform.v1.ExamplesRestrictionsNamespaceR\frestrictions\x12+\n" +
	"\x11return_embeddings\x18\x04 \x01(\bR\x10returnEmbeddings\x12X\n" +
	"\vdata_format\x18\x05 \x01(\x0e27.google.cloud.aiplatform.v1.ExamplesOverride.DataFormatR\n" +
	"dataFormat\"H\n" +
	"\n" +
	"DataFormat\x12\x1b\n" +
	"\x17DATA_FORMAT_UNSPECIFIED\x10\x00\x12\r\n" +
	...
	"\x04deny\x18\x03 \x03(\tR\x04denyB\xce\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_explanation_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_explanation_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_explanation_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_explanation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_explanation_proto_rawDesc), len(file_google_cloud_aiplatform_v1_explanation_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_explanation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_explanation_proto_rawDesc), len(file_google_cloud_aiplatform_v1_explanation_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   0,
