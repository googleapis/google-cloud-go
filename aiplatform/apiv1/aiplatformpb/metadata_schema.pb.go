...
const file_google_cloud_aiplatform_v1_metadata_schema_proto_rawDesc = "" +
	"\n" +
	"0google/cloud/aiplatform/v1/metadata_schema.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc2\x04\n" +
	...
	"\x06schema\x18\x03 \x01(\tB\x03\xe0A\x02R\x06schema\x12^\n" +
	"\vschema_type\x18\x04 \x01(\x0e2=.google.cloud.aiplatform.v1.MetadataSchema.MetadataSchemaTypeR\n" +
	"schemaType\x12@\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_metadata_schema_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_metadata_schema_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_metadata_schema_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_metadata_schema_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_metadata_schema_proto_rawDesc), len(file_google_cloud_aiplatform_v1_metadata_schema_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_metadata_schema_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_metadata_schema_proto_rawDesc), len(file_google_cloud_aiplatform_v1_metadata_schema_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
