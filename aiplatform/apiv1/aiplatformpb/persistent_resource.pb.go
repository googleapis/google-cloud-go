...
func file_google_cloud_aiplatform_v1_persistent_resource_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_aiplatform_v1_persistent_resource_proto_msgTypes[8].Exporter = func(v any, i int) any {
	...
	file_google_cloud_aiplatform_v1_persistent_resource_proto_msgTypes[8].OneofWrappers = []any{}
	type x struct{}
