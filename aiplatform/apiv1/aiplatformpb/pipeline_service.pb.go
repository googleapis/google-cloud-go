...
func file_google_cloud_aiplatform_v1_pipeline_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[15].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1_pipeline_service_proto_msgTypes[16].Exporter = func(v any, i int) any {
...
func (c *pipelineServiceClient) BatchDeletePipelineJobs(ctx context.Context, in *BatchDeletePipelineJobsRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/google.cloud.aiplatform.v1.PipelineService/BatchDeletePipelineJobs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pipelineServiceClient) BatchCancelPipelineJobs(ctx context.Context, in *BatchCancelPipelineJobsRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/google.cloud.aiplatform.v1.PipelineService/BatchCancelPipelineJobs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PipelineService_BatchDeletePipelineJobs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.cloud.aiplatform.v1.PipelineService/BatchDeletePipelineJobs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PipelineService_BatchCancelPipelineJobs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.cloud.aiplatform.v1.PipelineService/BatchCancelPipelineJobs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
