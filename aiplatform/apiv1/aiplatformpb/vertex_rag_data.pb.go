...
const file_google_cloud_aiplatform_v1_vertex_rag_data_proto_rawDesc = "" +
	"\n" +
	"0google/cloud/aiplatform/v1/vertex_rag_data.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a)google/cloud/aiplatform/v1/api_auth.proto\x1a0google/cloud/aiplatform/v1/encryption_spec.proto\x1a#google/cloud/aiplatform/v1/io.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8b\x03\n" +
	"\x17RagEmbeddingModelConfig\x12\x8c\x01\n" +
	"\x1avertex_prediction_endpoint\x18\x01 \x01(\v2L.google.cloud.aiplatform.v1.RagEmbeddingModelConfig.VertexPredictionEndpointH\x00R\x18vertexPredictionEndpoint\x1a\xd0\x01\n" +
	...
	"\x10model_version_id\x18\x03 \x01(\tB\x03\xe0A\x03R\x0emodelVersionIdB\x0e\n" +
	"\fmodel_config\"\xa3\a\n" +
	"\x11RagVectorDbConfig\x12b\n" +
	"\x0erag_managed_db\x18\x01 \x01(\v2:.google.cloud.aiplatform.v1.RagVectorDbConfig.RagManagedDbH\x00R\fragManagedDb\x12T\n" +
	"\bpinecone\x18\x03 \x01(\v26.google.cloud.aiplatform.v1.RagVectorDbConfig.PineconeH\x00R\bpinecone\x12t\n" +
	"\x14vertex_vector_search\x18\x06 \x01(\v2@.google.cloud.aiplatform.v1.RagVectorDbConfig.VertexVectorSearchH\x00R\x12vertexVectorSearch\x12>\n" +
	"\bapi_auth\x18\x05 \x01(\v2#.google.cloud.aiplatform.v1.ApiAuthR\aapiAuth\x12x\n" +
	"\x1arag_embedding_model_config\x18\a \x01(\v23.google.cloud.aiplatform.v1.RagEmbeddingModelConfigB\x06\xe0A\x01\xe0A\x05R\x17ragEmbeddingModelConfig\x1a\x98\x02\n" +
	"\fRagManagedDb\x12R\n" +
	"\x03knn\x18\x01 \x01(\v2>.google.cloud.aiplatform.v1.RagVectorDbConfig.RagManagedDb.KNNH\x00R\x03knn\x12R\n" +
	"\x03ann\x18\x02 \x01(\v2>.google.cloud.aiplatform.v1.RagVectorDbConfig.RagManagedDb.ANNH\x00R\x03ann\x1a\x05\n" +
	"\x03KNN\x1aC\n" +
	"\x03ANN\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"FileStatus\x12G\n" +
	"\x05state\x18\x01 \x01(\x0e2,.google.cloud.aiplatform.v1.FileStatus.StateB\x03\xe0A\x03R\x05state\x12&\n" +
	...
	"\x0eserving_config\x18\x01 \x01(\tR\rservingConfig\"\xbf\x01\n" +
	"\fCorpusStatus\x12I\n" +
	"\x05state\x18\x01 \x01(\x0e2..google.cloud.aiplatform.v1.CorpusStatus.StateB\x03\xe0A\x03R\x05state\x12&\n" +
	...
	"\x05ERROR\x10\x03\"\x93\x06\n" +
	"\tRagCorpus\x12a\n" +
	"\x10vector_db_config\x18\t \x01(\v2-.google.cloud.aiplatform.v1.RagVectorDbConfigB\x06\xe0A\x01\xe0A\x05H\x00R\x0evectorDbConfig\x12q\n" +
	"\x17vertex_ai_search_config\x18\n" +
	" \x01(\v20.google.cloud.aiplatform.v1.VertexAiSearchConfigB\x06\xe0A\x01\xe0A\x05H\x00R\x14vertexAiSearchConfig\x12\x17\n" +
	...
	"updateTime\x12R\n" +
	"\rcorpus_status\x18\b \x01(\v2(.google.cloud.aiplatform.v1.CorpusStatusB\x03\xe0A\x03R\fcorpusStatus\x12[\n" +
	"\x0fencryption_spec\x18\f \x01(\v2*.google.cloud.aiplatform.v1.EncryptionSpecB\x06\xe0A\x05\xe0A\x01R\x0eencryptionSpec:\x80\x01\xeaA}\n" +
	...
	"\x0ebackend_config\"\xfe\a\n" +
	"\aRagFile\x12K\n" +
	"\n" +
	"gcs_source\x18\b \x01(\v2%.google.cloud.aiplatform.v1.GcsSourceB\x03\xe0A\x03H\x00R\tgcsSource\x12d\n" +
	"\x13google_drive_source\x18\t \x01(\v2-.google.cloud.aiplatform.v1.GoogleDriveSourceB\x03\xe0A\x03H\x00R\x11googleDriveSource\x12g\n" +
	"\x14direct_upload_source\x18\n" +
	" \x01(\v2..google.cloud.aiplatform.v1.DirectUploadSourceB\x03\xe0A\x03H\x00R\x12directUploadSource\x12L\n" +
	"\fslack_source\x18\v \x01(\v2'.google.cloud.aiplatform.v1.SlackSourceH\x00R\vslackSource\x12I\n" +
	"\vjira_source\x18\f \x01(\v2&.google.cloud.aiplatform.v1.JiraSourceH\x00R\n" +
	"jiraSource\x12_\n" +
	"\x13share_point_sources\x18\x0e \x01(\v2-.google.cloud.aiplatform.v1.SharePointSourcesH\x00R\x11sharePointSources\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x02R\vdisplayName\x12%\n" +
	"\vdescription\x18\x03 \x01(\tB\x03\xe0A\x01R\vdescription\x12@\n" +
	...
	"updateTime\x12L\n" +
	"\vfile_status\x18\r \x01(\v2&.google.cloud.aiplatform.v1.FileStatusB\x03\xe0A\x03R\n" +
	"fileStatus:\x8f\x01\xeaA\x8b\x01\n" +
	...
	"\x0frag_file_source\"\xc5\x01\n" +
	"\bRagChunk\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12O\n" +
	"\tpage_span\x18\x02 \x01(\v2-.google.cloud.aiplatform.v1.RagChunk.PageSpanH\x00R\bpageSpan\x88\x01\x01\x1aF\n" +
	"\bPageSpan\x12\x1d\n" +
	"\n" +
	...
	"\x15fixed_length_chunking\x18\x03 \x01(\v2E.google.cloud.aiplatform.v1.RagFileChunkingConfig.FixedLengthChunkingH\x00R\x13fixedLengthChunking\x1aY\n" +
	...
	"\x0fchunking_config\"\x89\x01\n" +
	"\x1bRagFileTransformationConfig\x12j\n" +
	"\x18rag_file_chunking_config\x18\x01 \x01(\v21.google.cloud.aiplatform.v1.RagFileChunkingConfigR\x15ragFileChunkingConfig\"\xfb\x03\n" +
	"\x14RagFileParsingConfig\x12d\n" +
	"\rlayout_parser\x18\x04 \x01(\v2=.google.cloud.aiplatform.v1.RagFileParsingConfig.LayoutParserH\x00R\flayoutParser\x12[\n" +
	"\n" +
	"llm_parser\x18\x05 \x01(\v2:.google.cloud.aiplatform.v1.RagFileParsingConfig.LlmParserH\x00R\tllmParser\x1au\n" +
	"\fLayoutParser\x12%\n" +
	"\x0eprocessor_name\x18\x01 \x01(\tR\rprocessorName\x12>\n" +
	"\x1cmax_parsing_requests_per_min\x18\x02 \x01(\x05R\x18maxParsingRequestsPerMin\x1a\x9e\x01\n" +
	"\tLlmParser\x12\x1d\n" +
	"\n" +
	"model_name\x18\x01 \x01(\tR\tmodelName\x12>\n" +
	"\x1cmax_parsing_requests_per_min\x18\x02 \x01(\x05R\x18maxParsingRequestsPerMin\x122\n" +
	"\x15custom_parsing_prompt\x18\x03 \x01(\tR\x13customParsingPromptB\b\n" +
	"\x06parser\"\x93\x01\n" +
	"\x13UploadRagFileConfig\x12|\n" +
	"\x1erag_file_transformation_config\x18\x03 \x01(\v27.google.cloud.aiplatform.v1.RagFileTransformationConfigR\x1bragFileTransformationConfig\"\x93\n" +
	"\n" +
	"\x14ImportRagFilesConfig\x12F\n" +
	"\n" +
	"gcs_source\x18\x02 \x01(\v2%.google.cloud.aiplatform.v1.GcsSourceH\x00R\tgcsSource\x12_\n" +
	"\x13google_drive_source\x18\x03 \x01(\v2-.google.cloud.aiplatform.v1.GoogleDriveSourceH\x00R\x11googleDriveSource\x12L\n" +
	"\fslack_source\x18\x06 \x01(\v2'.google.cloud.aiplatform.v1.SlackSourceH\x00R\vslackSource\x12I\n" +
	"\vjira_source\x18\a \x01(\v2&.google.cloud.aiplatform.v1.JiraSourceH\x00R\n" +
	"jiraSource\x12_\n" +
	"\x13share_point_sources\x18\r \x01(\v2-.google.cloud.aiplatform.v1.SharePointSourcesH\x00R\x11sharePointSources\x12i\n" +
	"\x18partial_failure_gcs_sink\x18\v \x01(\v2*.google.cloud.aiplatform.v1.GcsDestinationB\x02\x18\x01H\x01R\x15partialFailureGcsSink\x12x\n" +
	"\x1dpartial_failure_bigquery_sink\x18\f \x01(\v2/.google.cloud.aiplatform.v1.BigQueryDestinationB\x02\x18\x01H\x01R\x1apartialFailureBigquerySink\x12a\n" +
	"\x16import_result_gcs_sink\x18\x0e \x01(\v2*.google.cloud.aiplatform.v1.GcsDestinationH\x02R\x13importResultGcsSink\x12p\n" +
	"\x1bimport_result_bigquery_sink\x18\x0f \x01(\v2/.google.cloud.aiplatform.v1.BigQueryDestinationH\x02R\x18importResultBigquerySink\x12|\n" +
	"\x1erag_file_transformation_config\x18\x10 \x01(\v27.google.cloud.aiplatform.v1.RagFileTransformationConfigR\x1bragFileTransformationConfig\x12l\n" +
	"\x17rag_file_parsing_config\x18\b \x01(\v20.google.cloud.aiplatform.v1.RagFileParsingConfigB\x03\xe0A\x01R\x14ragFileParsingConfig\x12G\n" +
	"\x1emax_embedding_requests_per_min\x18\x05 \x01(\x05B\x03\xe0A\x01R\x1amaxEmbeddingRequestsPerMin\x12*\n" +
	"\x11rebuild_ann_index\x18\x13 \x01(\bR\x0frebuildAnnIndexB\x0f\n" +
	"\rimport_sourceB\x16\n" +
	"\x14partial_failure_sinkB\x14\n" +
	"\x12import_result_sink\"\xc5\x02\n" +
	"\x12RagManagedDbConfig\x12O\n" +
	"\x06scaled\x18\x04 \x01(\v25.google.cloud.aiplatform.v1.RagManagedDbConfig.ScaledH\x00R\x06scaled\x12L\n" +
	"\x05basic\x18\x02 \x01(\v24.google.cloud.aiplatform.v1.RagManagedDbConfig.BasicH\x00R\x05basic\x12d\n" +
	"\runprovisioned\x18\x03 \x01(\v2<.google.cloud.aiplatform.v1.RagManagedDbConfig.UnprovisionedH\x00R\runprovisioned\x1a\b\n" +
	"\x06Scaled\x1a\a\n" +
	"\x05Basic\x1a\x0f\n" +
	"\rUnprovisionedB\x06\n" +
	"\x04tier\"\x9b\x02\n" +
	...
	"\x15rag_managed_db_config\x18\x02 \x01(\v2..google.cloud.aiplatform.v1.RagManagedDbConfigR\x12ragManagedDbConfig:\x8b\x01\xeaA\x87\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_vertex_rag_data_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_vertex_rag_data_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_vertex_rag_data_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_vertex_rag_data_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_vertex_rag_data_proto_rawDesc), len(file_google_cloud_aiplatform_v1_vertex_rag_data_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_vertex_rag_data_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_vertex_rag_data_proto_rawDesc), len(file_google_cloud_aiplatform_v1_vertex_rag_data_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   28,
			NumExtensions: 0,
			NumServices:   0,
