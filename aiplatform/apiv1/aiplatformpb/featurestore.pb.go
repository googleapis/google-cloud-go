...
const file_google_cloud_aiplatform_v1_featurestore_proto_rawDesc = "" +
	"\n" +
	"-google/cloud/aiplatform/v1/featurestore.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a0google/cloud/aiplatform/v1/encryption_spec.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe5\t\n" +
	"\fFeaturestore\x12\x17\n" +
	...
	"updateTime\x12\x17\n" +
	"\x04etag\x18\x05 \x01(\tB\x03\xe0A\x01R\x04etag\x12Q\n" +
	"\x06labels\x18\x06 \x03(\v24.google.cloud.aiplatform.v1.Featurestore.LabelsEntryB\x03\xe0A\x01R\x06labels\x12u\n" +
	"\x15online_serving_config\x18\a \x01(\v2<.google.cloud.aiplatform.v1.Featurestore.OnlineServingConfigB\x03\xe0A\x01R\x13onlineServingConfig\x12I\n" +
	"\x05state\x18\b \x01(\x0e2..google.cloud.aiplatform.v1.Featurestore.StateB\x03\xe0A\x03R\x05state\x12:\n" +
	"\x17online_storage_ttl_days\x18\r \x01(\x05B\x03\xe0A\x01R\x14onlineStorageTtlDays\x12X\n" +
	"\x0fencryption_spec\x18\n" +
	" \x01(\v2*.google.cloud.aiplatform.v1.EncryptionSpecB\x03\xe0A\x01R\x0eencryptionSpec\x12(\n" +
	"\rsatisfies_pzs\x18\x0e \x01(\bB\x03\xe0A\x03R\fsatisfiesPzs\x12(\n" +
	"\rsatisfies_pzi\x18\x0f \x01(\bB\x03\xe0A\x03R\fsatisfiesPzi\x1a\xb7\x02\n" +
	"\x13OnlineServingConfig\x12(\n" +
	"\x10fixed_node_count\x18\x02 \x01(\x05R\x0efixedNodeCount\x12^\n" +
	"\ascaling\x18\x04 \x01(\v2D.google.cloud.aiplatform.v1.Featurestore.OnlineServingConfig.ScalingR\ascaling\x1a\x95\x01\n" +
	"\aScaling\x12)\n" +
	"\x0emin_node_count\x18\x01 \x01(\x05B\x03\xe0A\x02R\fminNodeCount\x12$\n" +
	"\x0emax_node_count\x18\x02 \x01(\x05R\fmaxNodeCount\x129\n" +
	"\x16cpu_utilization_target\x18\x03 \x01(\x05B\x03\xe0A\x01R\x14cpuUtilizationTarget\x1a9\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_featurestore_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_featurestore_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_featurestore_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_featurestore_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_featurestore_proto_rawDesc), len(file_google_cloud_aiplatform_v1_featurestore_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_featurestore_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_featurestore_proto_rawDesc), len(file_google_cloud_aiplatform_v1_featurestore_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
