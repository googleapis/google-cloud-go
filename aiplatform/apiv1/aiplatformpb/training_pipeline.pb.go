...
const file_google_cloud_aiplatform_v1_training_pipeline_proto_rawDesc = "" +
	...
	"\x11input_data_config\x18\x03 \x01(\v2+.google.cloud.aiplatform.v1.InputDataConfigR\x0finputDataConfig\x12=\n" +
	...
	"\x16training_task_metadata\x18\x06 \x01(\v2\x16.google.protobuf.ValueB\x03\xe0A\x03R\x14trainingTaskMetadata\x12I\n" +
	"\x0fmodel_to_upload\x18\a \x01(\v2!.google.cloud.aiplatform.v1.ModelR\rmodelToUpload\x12\x1e\n" +
	"\bmodel_id\x18\x16 \x01(\tB\x03\xe0A\x01R\amodelId\x12&\n" +
	"\fparent_model\x18\x15 \x01(\tB\x03\xe0A\x01R\vparentModel\x12D\n" +
	"\x05state\x18\t \x01(\x0e2).google.cloud.aiplatform.v1.PipelineStateB\x03\xe0A\x03R\x05state\x12-\n" +
	"\x05error\x18\n" +
	...
	"updateTime\x12P\n" +
	"\x06labels\x18\x0f \x03(\v28.google.cloud.aiplatform.v1.TrainingPipeline.LabelsEntryR\x06labels\x12S\n" +
	"\x0fencryption_spec\x18\x12 \x01(\v2*.google.cloud.aiplatform.v1.EncryptionSpecR\x0eencryptionSpec\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:~\xeaA{\n" +
	"*aiplatform.googleapis.com/TrainingPipeline\x12Mprojects/{project}/locations/{location}/trainingPipelines/{training_pipeline}\"\xfb\x06\n" +
	"\x0fInputDataConfig\x12R\n" +
	"\x0efraction_split\x18\x02 \x01(\v2).google.cloud.aiplatform.v1.FractionSplitH\x00R\rfractionSplit\x12L\n" +
	"\ffilter_split\x18\x03 \x01(\v2'.google.cloud.aiplatform.v1.FilterSplitH\x00R\vfilterSplit\x12X\n" +
	"\x10predefined_split\x18\x04 \x01(\v2+.google.cloud.aiplatform.v1.PredefinedSplitH\x00R\x0fpredefinedSplit\x12U\n" +
	"\x0ftimestamp_split\x18\x05 \x01(\v2*.google.cloud.aiplatform.v1.TimestampSplitH\x00R\x0etimestampSplit\x12X\n" +
	"\x10stratified_split\x18\f \x01(\v2+.google.cloud.aiplatform.v1.StratifiedSplitH\x00R\x0fstratifiedSplit\x12U\n" +
	"\x0fgcs_destination\x18\b \x01(\v2*.google.cloud.aiplatform.v1.GcsDestinationH\x01R\x0egcsDestination\x12d\n" +
	"\x14bigquery_destination\x18\n" +
	" \x01(\v2/.google.cloud.aiplatform.v1.BigQueryDestinationH\x01R\x13bigqueryDestination\x12\"\n" +
	"\n" +
	...
	"\x13validation_fraction\x18\x02 \x01(\x01R\x12validationFraction\x12#\n" +
	"\rtest_fraction\x18\x03 \x01(\x01R\ftestFraction\x12\x15\n" +
	"\x03key\x18\x04 \x01(\tB\x03\xe0A\x02R\x03keyB\xd3\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_training_pipeline_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_training_pipeline_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_training_pipeline_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_training_pipeline_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_training_pipeline_proto_rawDesc), len(file_google_cloud_aiplatform_v1_training_pipeline_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1_training_pipeline_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1_training_pipeline_proto_init() {
	...
	file_google_cloud_aiplatform_v1_training_pipeline_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_training_pipeline_proto_rawDesc), len(file_google_cloud_aiplatform_v1_training_pipeline_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
