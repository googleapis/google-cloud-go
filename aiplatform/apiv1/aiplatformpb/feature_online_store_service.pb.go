...
const file_google_cloud_aiplatform_v1_feature_online_store_service_proto_rawDesc = "" +
	"\n" +
	"=google/cloud/aiplatform/v1/feature_online_store_service.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a<google/cloud/aiplatform/v1/featurestore_online_service.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\xbf\x01\n" +
	"\x12FeatureViewDataKey\x12\x12\n" +
	"\x03key\x18\x01 \x01(\tH\x00R\x03key\x12b\n" +
	"\rcomposite_key\x18\x02 \x01(\v2;.google.cloud.aiplatform.v1.FeatureViewDataKey.CompositeKeyH\x00R\fcompositeKey\x1a$\n" +
	"\fCompositeKey\x12\x14\n" +
	"\x05parts\x18\x01 \x03(\tR\x05partsB\v\n" +
	"\tkey_oneof\"\x96\x02\n" +
	"\x19FetchFeatureValuesRequest\x12P\n" +
	"\ffeature_view\x18\x01 \x01(\tB-\xe0A\x02\xfaA'\n" +
	"%aiplatform.googleapis.com/FeatureViewR\vfeatureView\x12N\n" +
	"\bdata_key\x18\x06 \x01(\v2..google.cloud.aiplatform.v1.FeatureViewDataKeyB\x03\xe0A\x01R\adataKey\x12W\n" +
	"\vdata_format\x18\a \x01(\x0e21.google.cloud.aiplatform.v1.FeatureViewDataFormatB\x03\xe0A\x01R\n" +
	"dataFormat\"\xb7\x04\n" +
	"\x1aFetchFeatureValuesResponse\x12p\n" +
	"\n" +
	"key_values\x18\x03 \x01(\v2O.google.cloud.aiplatform.v1.FetchFeatureValuesResponse.FeatureNameValuePairListH\x00R\tkeyValues\x12<\n" +
	"\fproto_struct\x18\x02 \x01(\v2\x17.google.protobuf.StructH\x00R\vprotoStruct\x12I\n" +
	"\bdata_key\x18\x04 \x01(\v2..google.cloud.aiplatform.v1.FeatureViewDataKeyR\adataKey\x1a\x93\x02\n" +
	"\x18FeatureNameValuePairList\x12\x80\x01\n" +
	"\bfeatures\x18\x01 \x03(\v2d.google.cloud.aiplatform.v1.FetchFeatureValuesResponse.FeatureNameValuePairList.FeatureNameValuePairR\bfeatures\x1at\n" +
	"\x14FeatureNameValuePair\x12@\n" +
	"\x05value\x18\x02 \x01(\v2(.google.cloud.aiplatform.v1.FeatureValueH\x00R\x05value\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04nameB\x06\n" +
	"\x04dataB\b\n" +
	"\x06format\"\xa1\n" +
	"\n" +
	"\x14NearestNeighborQuery\x12\"\n" +
	"\tentity_id\x18\x01 \x01(\tB\x03\xe0A\x01H\x00R\bentityId\x12_\n" +
	"\tembedding\x18\x02 \x01(\v2:.google.cloud.aiplatform.v1.NearestNeighborQuery.EmbeddingB\x03\xe0A\x01H\x00R\tembedding\x12*\n" +
	"\x0eneighbor_count\x18\x03 \x01(\x05B\x03\xe0A\x01R\rneighborCount\x12i\n" +
	"\x0estring_filters\x18\x04 \x03(\v2=.google.cloud.aiplatform.v1.NearestNeighborQuery.StringFilterB\x03\xe0A\x01R\rstringFilters\x12l\n" +
	"\x0fnumeric_filters\x18\b \x03(\v2>.google.cloud.aiplatform.v1.NearestNeighborQuery.NumericFilterB\x03\xe0A\x01R\x0enumericFilters\x12U\n" +
	"%per_crowding_attribute_neighbor_count\x18\x05 \x01(\x05B\x03\xe0A\x01R!perCrowdingAttributeNeighborCount\x12`\n" +
	"\n" +
	"parameters\x18\a \x01(\v2;.google.cloud.aiplatform.v1.NearestNeighborQuery.ParametersB\x03\xe0A\x01R\n" +
	"parameters\x1a&\n" +
	"\tEmbedding\x12\x19\n" +
	...
	"\x02op\x18\x05 \x01(\x0e2G.google.cloud.aiplatform.v1.NearestNeighborQuery.NumericFilter.OperatorB\x03\xe0A\x01H\x01R\x02op\x88\x01\x01\"x\n" +
	"\bOperator\x12\x18\n" +
	...
	"\ffeature_view\x18\x01 \x01(\tB-\xe0A\x02\xfaA'\n" +
	"%aiplatform.googleapis.com/FeatureViewR\vfeatureView\x12K\n" +
	"\x05query\x18\x02 \x01(\v20.google.cloud.aiplatform.v1.NearestNeighborQueryB\x03\xe0A\x02R\x05query\x121\n" +
	"\x12return_full_entity\x18\x03 \x01(\bB\x03\xe0A\x01R\x10returnFullEntity\"\x91\x02\n" +
	"\x10NearestNeighbors\x12S\n" +
	"\tneighbors\x18\x01 \x03(\v25.google.cloud.aiplatform.v1.NearestNeighbors.NeighborR\tneighbors\x1a\xa7\x01\n" +
	"\bNeighbor\x12\x1b\n" +
	"\tentity_id\x18\x01 \x01(\tR\bentityId\x12\x1a\n" +
	"\bdistance\x18\x02 \x01(\x01R\bdistance\x12b\n" +
	"\x11entity_key_values\x18\x03 \x01(\v26.google.cloud.aiplatform.v1.FetchFeatureValuesResponseR\x0fentityKeyValues\"z\n" +
	"\x1dSearchNearestEntitiesResponse\x12Y\n" +
	"\x11nearest_neighbors\x18\x01 \x01(\v2,.google.cloud.aiplatform.v1.NearestNeighborsR\x10nearestNeighbors\"\xd2\x04\n" +
	"\x1dFeatureViewDirectWriteRequest\x12M\n" +
	"\ffeature_view\x18\x01 \x01(\tB*\xfaA'\n" +
	"%aiplatform.googleapis.com/FeatureViewR\vfeatureView\x12\x94\x01\n" +
	"\x1bdata_key_and_feature_values\x18\x02 \x03(\v2Q.google.cloud.aiplatform.v1.FeatureViewDirectWriteRequest.DataKeyAndFeatureValuesB\x03\xe0A\x02R\x17dataKeyAndFeatureValues\x1a\xca\x02\n" +
	"\x17DataKeyAndFeatureValues\x12I\n" +
	"\bdata_key\x18\x01 \x01(\v2..google.cloud.aiplatform.v1.FeatureViewDataKeyR\adataKey\x12u\n" +
	"\bfeatures\x18\x02 \x03(\v2Y.google.cloud.aiplatform.v1.FeatureViewDirectWriteRequest.DataKeyAndFeatureValues.FeatureR\bfeatures\x1am\n" +
	"\aFeature\x12@\n" +
	"\x05value\x18\x03 \x01(\v2(.google.cloud.aiplatform.v1.FeatureValueH\x00R\x05value\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04nameB\f\n" +
	"\n" +
	"data_oneof\"\xef\x02\n" +
	"\x1eFeatureViewDirectWriteResponse\x12*\n" +
	"\x06status\x18\x01 \x01(\v2\x12.google.rpc.StatusR\x06status\x12q\n" +
	"\x0fwrite_responses\x18\x02 \x03(\v2H.google.cloud.aiplatform.v1.FeatureViewDirectWriteResponse.WriteResponseR\x0ewriteResponses\x1a\xad\x01\n" +
	"\rWriteResponse\x12I\n" +
	"\bdata_key\x18\x01 \x01(\v2..google.cloud.aiplatform.v1.FeatureViewDataKeyR\adataKey\x12Q\n" +
	...
	"\fPROTO_STRUCT\x10\x022\x81\t\n" +
	"\x19FeatureOnlineStoreService\x12\x8b\x02\n" +
	"\x12FetchFeatureValues\x125.google.cloud.aiplatform.v1.FetchFeatureValuesRequest\x1a6.google.cloud.aiplatform.v1.FetchFeatureValuesResponse\"\x85\x01\xdaA\x16feature_view, data_key\x82\xd3\xe4\x93\x02f:\x01*\"a/v1/{feature_view=projects/*/locations/*/featureOnlineStores/*/featureViews/*}:fetchFeatureValues\x12\xfd\x01\n" +
	"\x15SearchNearestEntities\x128.google.cloud.aiplatform.v1.SearchNearestEntitiesRequest\x1a9.google.cloud.aiplatform.v1.SearchNearestEntitiesResponse\"o\x82\xd3\xe4\x93\x02i:\x01*\"d/v1/{feature_view=projects/*/locations/*/featureOnlineStores/*/featureViews/*}:searchNearestEntities\x12\xfa\x01\n" +
	"\x16FeatureViewDirectWrite\x129.google.cloud.aiplatform.v1.FeatureViewDirectWriteRequest\x1a:.google.cloud.aiplatform.v1.FeatureViewDirectWriteResponse\"e\x82\xd3\xe4\x93\x02_:\x01*\"Z/v1/{feature_view=projects/*/locations/*/featureOnlineStores/*/featureViews/*}:directWrite(\x010\x01\x12\x89\x02\n" +
	"\x18GenerateFetchAccessToken\x12;.google.cloud.aiplatform.v1.GenerateFetchAccessTokenRequest\x1a<.google.cloud.aiplatform.v1.GenerateFetchAccessTokenResponse\"r\x82\xd3\xe4\x93\x02l:\x01*\"g/v1/{feature_view=projects/*/locations/*/featureOnlineStores/*/featureViews/*}:generateFetchAccessToken\x1aM\xcaA\x19aiplatform.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xdc\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_feature_online_store_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_feature_online_store_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_feature_online_store_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_feature_online_store_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_feature_online_store_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1_feature_online_store_service_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_feature_online_store_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_feature_online_store_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1_feature_online_store_service_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   1,
