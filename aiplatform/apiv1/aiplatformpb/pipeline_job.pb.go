...
const file_google_cloud_aiplatform_v1_pipeline_job_proto_rawDesc = "" +
	...
	"updateTime\x12<\n" +
	"\rpipeline_spec\x18\a \x01(\v2\x17.google.protobuf.StructR\fpipelineSpec\x12D\n" +
	"\x05state\x18\b \x01(\x0e2).google.cloud.aiplatform.v1.PipelineStateB\x03\xe0A\x03R\x05state\x12Q\n" +
	"\n" +
	"job_detail\x18\t \x01(\v2-.google.cloud.aiplatform.v1.PipelineJobDetailB\x03\xe0A\x03R\tjobDetail\x12-\n" +
	"\x05error\x18\n" +
	" \x01(\v2\x12.google.rpc.StatusB\x03\xe0A\x03R\x05error\x12K\n" +
	"\x06labels\x18\v \x03(\v23.google.cloud.aiplatform.v1.PipelineJob.LabelsEntryR\x06labels\x12\\\n" +
	"\x0eruntime_config\x18\f \x01(\v25.google.cloud.aiplatform.v1.PipelineJob.RuntimeConfigR\rruntimeConfig\x12S\n" +
	...
	"\x12reserved_ip_ranges\x18\x19 \x03(\tR\x10reservedIpRanges\x12e\n" +
	"\x14psc_interface_config\x18\x1f \x01(\v2..google.cloud.aiplatform.v1.PscInterfaceConfigB\x03\xe0A\x01R\x12pscInterfaceConfig\x12!\n" +
	"\ftemplate_uri\x18\x13 \x01(\tR\vtemplateUri\x12f\n" +
	"\x11template_metadata\x18\x14 \x01(\v24.google.cloud.aiplatform.v1.PipelineTemplateMetadataB\x03\xe0A\x03R\x10templateMetadata\x12(\n" +
	"\rschedule_name\x18\x16 \x01(\tB\x03\xe0A\x03R\fscheduleName\x128\n" +
	"\x15preflight_validations\x18\x1a \x01(\bB\x03\xe0A\x01R\x14preflightValidations\x1a\xf9\x06\n" +
	"\rRuntimeConfig\x12i\n" +
	"\n" +
	"parameters\x18\x01 \x03(\v2E.google.cloud.aiplatform.v1.PipelineJob.RuntimeConfig.ParametersEntryB\x02\x18\x01R\n" +
	"parameters\x125\n" +
	"\x14gcs_output_directory\x18\x02 \x01(\tB\x03\xe0A\x02R\x12gcsOutputDirectory\x12u\n" +
	"\x10parameter_values\x18\x03 \x03(\v2J.google.cloud.aiplatform.v1.PipelineJob.RuntimeConfig.ParameterValuesEntryR\x0fparameterValues\x12X\n" +
	"\x0efailure_policy\x18\x04 \x01(\x0e21.google.cloud.aiplatform.v1.PipelineFailurePolicyR\rfailurePolicy\x12r\n" +
	"\x0finput_artifacts\x18\x05 \x03(\v2I.google.cloud.aiplatform.v1.PipelineJob.RuntimeConfig.InputArtifactsEntryR\x0einputArtifacts\x1a:\n" +
	"\rInputArtifact\x12!\n" +
	...
	"\x05value\x18\x02 \x01(\v2!.google.cloud.aiplatform.v1.ValueR\x05value:\x028\x01\x1aZ\n" +
	"\x14ParameterValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value:\x028\x01\x1a\x86\x01\n" +
	"\x13InputArtifactsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12Y\n" +
	"\x05value\x18\x02 \x01(\v2C.google.cloud.aiplatform.v1.PipelineJob.RuntimeConfig.InputArtifactR\x05value:\x028\x01\x1a9\n" +
	...
	"\x11PipelineJobDetail\x12S\n" +
	"\x10pipeline_context\x18\x01 \x01(\v2#.google.cloud.aiplatform.v1.ContextB\x03\xe0A\x03R\x0fpipelineContext\x12Z\n" +
	"\x14pipeline_run_context\x18\x02 \x01(\v2#.google.cloud.aiplatform.v1.ContextB\x03\xe0A\x03R\x12pipelineRunContext\x12V\n" +
	"\ftask_details\x18\x03 \x03(\v2..google.cloud.aiplatform.v1.PipelineTaskDetailB\x03\xe0A\x03R\vtaskDetails\"\x97\r\n" +
	...
	"\n" +
	"start_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tstartTime\x12:\n" +
	"\bend_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\aendTime\x12d\n" +
	"\x0fexecutor_detail\x18\x06 \x01(\v26.google.cloud.aiplatform.v1.PipelineTaskExecutorDetailB\x03\xe0A\x03R\x0eexecutorDetail\x12O\n" +
	"\x05state\x18\a \x01(\x0e24.google.cloud.aiplatform.v1.PipelineTaskDetail.StateB\x03\xe0A\x03R\x05state\x12H\n" +
	"\texecution\x18\b \x01(\v2%.google.cloud.aiplatform.v1.ExecutionB\x03\xe0A\x03R\texecution\x12-\n" +
	"\x05error\x18\t \x01(\v2\x12.google.rpc.StatusB\x03\xe0A\x03R\x05error\x12x\n" +
	"\x14pipeline_task_status\x18\r \x03(\v2A.google.cloud.aiplatform.v1.PipelineTaskDetail.PipelineTaskStatusB\x03\xe0A\x03R\x12pipelineTaskStatus\x12W\n" +
	"\x06inputs\x18\n" +
	" \x03(\v2:.google.cloud.aiplatform.v1.PipelineTaskDetail.InputsEntryB\x03\xe0A\x03R\x06inputs\x12Z\n" +
	"\aoutputs\x18\v \x03(\v2;.google.cloud.aiplatform.v1.PipelineTaskDetail.OutputsEntryB\x03\xe0A\x03R\aoutputs\x12-\n" +
	"\x10task_unique_name\x18\x0e \x01(\tB\x03\xe0A\x03R\x0etaskUniqueName\x1a\xd6\x01\n" +
	"\x12PipelineTaskStatus\x12@\n" +
	"\vupdate_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12O\n" +
	"\x05state\x18\x02 \x01(\x0e24.google.cloud.aiplatform.v1.PipelineTaskDetail.StateB\x03\xe0A\x03R\x05state\x12-\n" +
	"\x05error\x18\x03 \x01(\v2\x12.google.rpc.StatusB\x03\xe0A\x03R\x05error\x1aW\n" +
	"\fArtifactList\x12G\n" +
	"\tartifacts\x18\x01 \x03(\v2$.google.cloud.aiplatform.v1.ArtifactB\x03\xe0A\x03R\tartifacts\x1av\n" +
	"\vInputsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12Q\n" +
	"\x05value\x18\x02 \x01(\v2;.google.cloud.aiplatform.v1.PipelineTaskDetail.ArtifactListR\x05value:\x028\x01\x1aw\n" +
	"\fOutputsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12Q\n" +
	"\x05value\x18\x02 \x01(\v2;.google.cloud.aiplatform.v1.PipelineTaskDetail.ArtifactListR\x05value:\x028\x01\"\xa6\x01\n" +
	"\x05State\x12\x15\n" +
	...
	"\rNOT_TRIGGERED\x10\t\"\xc6\x05\n" +
	"\x1aPipelineTaskExecutorDetail\x12x\n" +
	"\x10container_detail\x18\x01 \x01(\v2F.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.ContainerDetailB\x03\xe0A\x03H\x00R\x0fcontainerDetail\x12y\n" +
	"\x11custom_job_detail\x18\x02 \x01(\v2F.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.CustomJobDetailB\x03\xe0A\x03H\x00R\x0fcustomJobDetail\x1a\xaf\x02\n" +
	...
	"failedJobsB\t\n" +
	"\adetailsB\x97\x02\xeaAN\n" +
	"\x1ecompute.googleapis.com/Network\x12,projects/{project}/global/networks/{network}\n" +
	"\x1ecom.google.cloud.aiplatform.v1B\bPipelineP\x01Z>cloud.google.com/go/aiplatform/apiv1/aiplatformpb;aiplatformpb\xaa\x02\x1aGoogle.Cloud.AIPlatform.V1\xca\x02\x1aGoogle\\Cloud\\AIPlatform\\V1\xea\x02\x1dGoogle::Cloud::AIPlatform::V1b\x06proto3"

var (
	file_google_cloud_aiplatform_v1_pipeline_job_proto_rawDescOnce sync.Once
	file_google_cloud_aiplatform_v1_pipeline_job_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_pipeline_job_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_pipeline_job_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_pipeline_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_pipeline_job_proto_rawDesc), len(file_google_cloud_aiplatform_v1_pipeline_job_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_pipeline_job_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_pipeline_job_proto_rawDesc), len(file_google_cloud_aiplatform_v1_pipeline_job_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   0,
