...
const file_google_cloud_aiplatform_v1_nas_job_proto_rawDesc = "" +
	"\n" +
	"(google/cloud/aiplatform/v1/nas_job.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a+google/cloud/aiplatform/v1/custom_job.proto\x1a0google/cloud/aiplatform/v1/encryption_spec.proto\x1a*google/cloud/aiplatform/v1/job_state.proto\x1a&google/cloud/aiplatform/v1/study.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\xbb\b\n" +
	"\x06NasJob\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x02R\vdisplayName\x12M\n" +
	"\fnas_job_spec\x18\x04 \x01(\v2&.google.cloud.aiplatform.v1.NasJobSpecB\x03\xe0A\x02R\n" +
	"nasJobSpec\x12S\n" +
	"\x0enas_job_output\x18\x05 \x01(\v2(.google.cloud.aiplatform.v1.NasJobOutputB\x03\xe0A\x03R\fnasJobOutput\x12?\n" +
	...
	"updateTime\x12-\n" +
	"\x05error\x18\v \x01(\v2\x12.google.rpc.StatusB\x03\xe0A\x03R\x05error\x12F\n" +
	"\x06labels\x18\f \x03(\v2..google.cloud.aiplatform.v1.NasJob.LabelsEntryR\x06labels\x12S\n" +
	"\x0fencryption_spec\x18\r \x01(\v2*.google.cloud.aiplatform.v1.EncryptionSpecR\x0eencryptionSpec\x12N\n" +
	...
	" aiplatform.googleapis.com/NasJob\x129projects/{project}/locations/{location}/nasJobs/{nas_job}\"\xe8\x02\n" +
	"\x0eNasTrialDetail\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12\x1e\n" +
	"\n" +
	"parameters\x18\x02 \x01(\tR\n" +
	"parameters\x12G\n" +
	"\fsearch_trial\x18\x03 \x01(\v2$.google.cloud.aiplatform.v1.NasTrialR\vsearchTrial\x12E\n" +
	"\vtrain_trial\x18\x04 \x01(\v2$.google.cloud.aiplatform.v1.NasTrialR\n" +
	"trainTrial:\x8c\x01\xeaA\x88\x01\n" +
	"(aiplatform.googleapis.com/NasTrialDetail\x12\\projects/{project}/locations/{location}/nasJobs/{nas_job}/nasTrialDetails/{nas_trial_detail}\"\xb2\f\n" +
	"\n" +
	"NasJobSpec\x12}\n" +
	"\x1amulti_trial_algorithm_spec\x18\x02 \x01(\v2>.google.cloud.aiplatform.v1.NasJobSpec.MultiTrialAlgorithmSpecH\x00R\x17multiTrialAlgorithmSpec\x12)\n" +
	"\x11resume_nas_job_id\x18\x03 \x01(\tR\x0eresumeNasJobId\x12*\n" +
	"\x11search_space_spec\x18\x01 \x01(\tR\x0fsearchSpaceSpec\x1a\xb7\n" +
	"\n" +
	"\x17MultiTrialAlgorithmSpec\x12\x86\x01\n" +
	"\x15multi_trial_algorithm\x18\x01 \x01(\x0e2R.google.cloud.aiplatform.v1.NasJobSpec.MultiTrialAlgorithmSpec.MultiTrialAlgorithmR\x13multiTrialAlgorithm\x12a\n" +
	"\x06metric\x18\x02 \x01(\v2I.google.cloud.aiplatform.v1.NasJobSpec.MultiTrialAlgorithmSpec.MetricSpecR\x06metric\x12\x7f\n" +
	"\x11search_trial_spec\x18\x03 \x01(\v2N.google.cloud.aiplatform.v1.NasJobSpec.MultiTrialAlgorithmSpec.SearchTrialSpecB\x03\xe0A\x02R\x0fsearchTrialSpec\x12w\n" +
	"\x10train_trial_spec\x18\x04 \x01(\v2M.google.cloud.aiplatform.v1.NasJobSpec.MultiTrialAlgorithmSpec.TrainTrialSpecR\x0etrainTrialSpec\x1a\xde\x01\n" +
	"\n" +
	"MetricSpec\x12 \n" +
	"\tmetric_id\x18\x01 \x01(\tB\x03\xe0A\x02R\bmetricId\x12k\n" +
	"\x04goal\x18\x02 \x01(\x0e2R.google.cloud.aiplatform.v1.NasJobSpec.MultiTrialAlgorithmSpec.MetricSpec.GoalTypeB\x03\xe0A\x02R\x04goal\"A\n" +
	"\bGoalType\x12\x19\n" +
	"\x15GOAL_TYPE_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bMAXIMIZE\x10\x01\x12\f\n" +
	"\bMINIMIZE\x10\x02\x1a\x94\x02\n" +
	"\x0fSearchTrialSpec\x12a\n" +
	"\x15search_trial_job_spec\x18\x01 \x01(\v2).google.cloud.aiplatform.v1.CustomJobSpecB\x03\xe0A\x02R\x12searchTrialJobSpec\x12+\n" +
	...
	"\x16max_failed_trial_count\x18\x04 \x01(\x05R\x13maxFailedTrialCount\x1a\xd2\x01\n" +
	"\x0eTrainTrialSpec\x12_\n" +
	"\x14train_trial_job_spec\x18\x01 \x01(\v2).google.cloud.aiplatform.v1.CustomJobSpecB\x03\xe0A\x02R\x11trainTrialJobSpec\x12<\n" +
	...
	"\x12nas_algorithm_spec\"\xc8\x02\n" +
	"\fNasJobOutput\x12x\n" +
	"\x16multi_trial_job_output\x18\x01 \x01(\v2<.google.cloud.aiplatform.v1.NasJobOutput.MultiTrialJobOutputB\x03\xe0A\x03H\x00R\x13multiTrialJobOutput\x1a\xb3\x01\n" +
	"\x13MultiTrialJobOutput\x12N\n" +
	"\rsearch_trials\x18\x01 \x03(\v2$.google.cloud.aiplatform.v1.NasTrialB\x03\xe0A\x03R\fsearchTrials\x12L\n" +
	"\ftrain_trials\x18\x02 \x03(\v2$.google.cloud.aiplatform.v1.NasTrialB\x03\xe0A\x03R\vtrainTrialsB\b\n" +
	"\x06output\"\xa5\x03\n" +
	"\bNasTrial\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x03R\x02id\x12E\n" +
	"\x05state\x18\x02 \x01(\x0e2*.google.cloud.aiplatform.v1.NasTrial.StateB\x03\xe0A\x03R\x05state\x12Y\n" +
	"\x11final_measurement\x18\x03 \x01(\v2'.google.cloud.aiplatform.v1.MeasurementB\x03\xe0A\x03R\x10finalMeasurement\x12>\n" +
	"\n" +
	...
	"\x1ecom.google.cloud.aiplatform.v1B\vNasJobProtoP\x01Z>cloud.google.com/go/aiplatform/apiv1/aiplatformpb;aiplatformpb\xaa\x02\x1aGoogle.Cloud.AIPlatform.V1\xca\x02\x1aGoogle\\Cloud\\AIPlatform\\V1\xea\x02\x1dGoogle::Cloud::AIPlatform::V1b\x06proto3"

var (
	file_google_cloud_aiplatform_v1_nas_job_proto_rawDescOnce sync.Once
	file_google_cloud_aiplatform_v1_nas_job_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_nas_job_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_nas_job_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_nas_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_nas_job_proto_rawDesc), len(file_google_cloud_aiplatform_v1_nas_job_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_nas_job_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_nas_job_proto_rawDesc), len(file_google_cloud_aiplatform_v1_nas_job_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
