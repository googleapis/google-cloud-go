...
const file_google_cloud_aiplatform_v1_content_proto_rawDesc = "" +
	"\n" +
	...
	"\x05parts\x18\x02 \x03(\v2 .google.cloud.aiplatform.v1.PartB\x03\xe0A\x02R\x05parts\"\xdc\b\n" +
	"\x04Part\x12\x19\n" +
	"\x04text\x18\x01 \x01(\tB\x03\xe0A\x01H\x00R\x04text\x12H\n" +
	"\vinline_data\x18\x02 \x01(\v2 .google.cloud.aiplatform.v1.BlobB\x03\xe0A\x01H\x00R\n" +
	"inlineData\x12H\n" +
	"\tfile_data\x18\x03 \x01(\v2$.google.cloud.aiplatform.v1.FileDataB\x03\xe0A\x01H\x00R\bfileData\x12T\n" +
	"\rfunction_call\x18\x05 \x01(\v2(.google.cloud.aiplatform.v1.FunctionCallB\x03\xe0A\x01H\x00R\ffunctionCall\x12`\n" +
	"\x11function_response\x18\x06 \x01(\v2,.google.cloud.aiplatform.v1.FunctionResponseB\x03\xe0A\x01H\x00R\x10functionResponse\x12Z\n" +
	"\x0fexecutable_code\x18\b \x01(\v2*.google.cloud.aiplatform.v1.ExecutableCodeB\x03\xe0A\x01H\x00R\x0eexecutableCode\x12j\n" +
	"\x15code_execution_result\x18\t \x01(\v2/.google.cloud.aiplatform.v1.CodeExecutionResultB\x03\xe0A\x01H\x00R\x13codeExecutionResult\x12\x1d\n" +
	"\athought\x18\n" +
	" \x01(\bB\x03\xe0A\x01R\athought\x120\n" +
	"\x11thought_signature\x18\v \x01(\fB\x03\xe0A\x01R\x10thoughtSignature\x12W\n" +
	"\x0evideo_metadata\x18\x04 \x01(\v2).google.cloud.aiplatform.v1.VideoMetadataB\x03\xe0A\x01H\x01R\rvideoMetadata\x12[\n" +
	"\x10media_resolution\x18\f \x01(\v20.google.cloud.aiplatform.v1.Part.MediaResolutionR\x0fmediaResolution\x1a\x89\x02\n" +
	"\x0fMediaResolution\x12N\n" +
	"\x05level\x18\x01 \x01(\x0e26.google.cloud.aiplatform.v1.Part.MediaResolution.LevelH\x00R\x05level\"\x9c\x01\n" +
	"\x05Level\x12 \n" +
	...
	"\x03fps\x18\x03 \x01(\x01B\x03\xe0A\x01R\x03fps\"H\n" +
	...
	"\x12voice_sample_audio\x18\x02 \x01(\fB\x03\xe0A\x01R\x10voiceSampleAudio\"\xf6\x01\n" +
	"\vVoiceConfig\x12e\n" +
	"\x15prebuilt_voice_config\x18\x01 \x01(\v2/.google.cloud.aiplatform.v1.PrebuiltVoiceConfigH\x00R\x13prebuiltVoiceConfig\x12p\n" +
	"\x17replicated_voice_config\x18\x03 \x01(\v21.google.cloud.aiplatform.v1.ReplicatedVoiceConfigB\x03\xe0A\x01H\x00R\x15replicatedVoiceConfigB\x0e\n" +
	"\fvoice_config\"\x84\x01\n" +
	"\x12SpeakerVoiceConfig\x12\x1d\n" +
	"\aspeaker\x18\x01 \x01(\tB\x03\xe0A\x02R\aspeaker\x12O\n" +
	"\fvoice_config\x18\x02 \x01(\v2'.google.cloud.aiplatform.v1.VoiceConfigB\x03\xe0A\x02R\vvoiceConfig\"\x82\x01\n" +
	"\x17MultiSpeakerVoiceConfig\x12g\n" +
	"\x15speaker_voice_configs\x18\x02 \x03(\v2..google.cloud.aiplatform.v1.SpeakerVoiceConfigB\x03\xe0A\x02R\x13speakerVoiceConfigs\"\xf6\x01\n" +
	"\fSpeechConfig\x12J\n" +
	"\fvoice_config\x18\x01 \x01(\v2'.google.cloud.aiplatform.v1.VoiceConfigR\vvoiceConfig\x12(\n" +
	"\rlanguage_code\x18\x02 \x01(\tB\x03\xe0A\x01R\flanguageCode\x12p\n" +
	"\x1amulti_speaker_voice_config\x18\x03 \x01(\v23.google.cloud.aiplatform.v1.MultiSpeakerVoiceConfigR\x17multiSpeakerVoiceConfig\"\xa1\x05\n" +
	"\vImageConfig\x12v\n" +
	"\x14image_output_options\x18\x01 \x01(\v2:.google.cloud.aiplatform.v1.ImageConfig.ImageOutputOptionsB\x03\xe0A\x01H\x00R\x12imageOutputOptions\x88\x01\x01\x12+\n" +
	"\faspect_ratio\x18\x02 \x01(\tB\x03\xe0A\x01H\x01R\vaspectRatio\x88\x01\x01\x12o\n" +
	"\x11person_generation\x18\x03 \x01(\x0e28.google.cloud.aiplatform.v1.ImageConfig.PersonGenerationB\x03\xe0A\x01H\x02R\x10personGeneration\x88\x01\x01\x12'\n" +
	"\n" +
	"image_size\x18\x04 \x01(\tB\x03\xe0A\x01H\x03R\timageSize\x88\x01\x01\x1a\x9c\x01\n" +
	"\x12ImageOutputOptions\x12%\n" +
	"\tmime_type\x18\x01 \x01(\tB\x03\xe0A\x01H\x00R\bmimeType\x88\x01\x01\x129\n" +
	"\x13compression_quality\x18\x02 \x01(\x05B\x03\xe0A\x01H\x01R\x12compressionQuality\x88\x01\x01B\f\n" +
	"\n" +
	"_mime_typeB\x16\n" +
	...
	"\x12response_mime_type\x18\r \x01(\tB\x03\xe0A\x01R\x10responseMimeType\x12U\n" +
	"\x0fresponse_schema\x18\x10 \x01(\v2\".google.cloud.aiplatform.v1.SchemaB\x03\xe0A\x01H\n" +
	"R\x0eresponseSchema\x88\x01\x01\x12R\n" +
	"\x14response_json_schema\x18\x1c \x01(\v2\x16.google.protobuf.ValueB\x03\xe0A\x01H\vR\x12responseJsonSchema\x88\x01\x01\x12k\n" +
	"\x0erouting_config\x18\x11 \x01(\v2:.google.cloud.aiplatform.v1.GenerationConfig.RoutingConfigB\x03\xe0A\x01H\fR\rroutingConfig\x88\x01\x01\x121\n" +
	"\x0faudio_timestamp\x18\x14 \x01(\bB\x03\xe0A\x01H\rR\x0eaudioTimestamp\x88\x01\x01\x12k\n" +
	"\x13response_modalities\x18\x15 \x03(\x0e25.google.cloud.aiplatform.v1.GenerationConfig.ModalityB\x03\xe0A\x01R\x12responseModalities\x12q\n" +
	"\x10media_resolution\x18\x16 \x01(\x0e2<.google.cloud.aiplatform.v1.GenerationConfig.MediaResolutionB\x03\xe0A\x01H\x0eR\x0fmediaResolution\x88\x01\x01\x12W\n" +
	"\rspeech_config\x18\x17 \x01(\v2(.google.cloud.aiplatform.v1.SpeechConfigB\x03\xe0A\x01H\x0fR\fspeechConfig\x88\x01\x01\x12i\n" +
	"\x0fthinking_config\x18\x19 \x01(\v2;.google.cloud.aiplatform.v1.GenerationConfig.ThinkingConfigB\x03\xe0A\x01R\x0ethinkingConfig\x12T\n" +
	"\fimage_config\x18\x1e \x01(\v2'.google.cloud.aiplatform.v1.ImageConfigB\x03\xe0A\x01H\x10R\vimageConfig\x88\x01\x01\x1a\xfb\x04\n" +
	"\rRoutingConfig\x12i\n" +
	"\tauto_mode\x18\x01 \x01(\v2J.google.cloud.aiplatform.v1.GenerationConfig.RoutingConfig.AutoRoutingModeH\x00R\bautoMode\x12o\n" +
	"\vmanual_mode\x18\x02 \x01(\v2L.google.cloud.aiplatform.v1.GenerationConfig.RoutingConfig.ManualRoutingModeH\x00R\n" +
	"manualMode\x1a\xb3\x02\n" +
	"\x0fAutoRoutingMode\x12\xa0\x01\n" +
	"\x18model_routing_preference\x18\x01 \x01(\x0e2a.google.cloud.aiplatform.v1.GenerationConfig.RoutingConfig.AutoRoutingMode.ModelRoutingPreferenceH\x00R\x16modelRoutingPreference\x88\x01\x01\"`\n" +
	...
	"\v_model_nameB\x10\n" +
	"\x0erouting_config\x1a\x8d\x03\n" +
	"\x0eThinkingConfig\x123\n" +
	"\x10include_thoughts\x18\x01 \x01(\bB\x03\xe0A\x01H\x00R\x0fincludeThoughts\x88\x01\x01\x121\n" +
	"\x0fthinking_budget\x18\x03 \x01(\x05B\x03\xe0A\x01H\x01R\x0ethinkingBudget\x88\x01\x01\x12z\n" +
	"\x0ethinking_level\x18\x04 \x01(\x0e2I.google.cloud.aiplatform.v1.GenerationConfig.ThinkingConfig.ThinkingLevelB\x03\xe0A\x01H\x02R\rthinkingLevel\x88\x01\x01\"[\n" +
	...
	"\r_image_config\"\x88\x04\n" +
	"\rSafetySetting\x12I\n" +
	"\bcategory\x18\x01 \x01(\x0e2(.google.cloud.aiplatform.v1.HarmCategoryB\x03\xe0A\x02R\bcategory\x12_\n" +
	"\tthreshold\x18\x02 \x01(\x0e2<.google.cloud.aiplatform.v1.SafetySetting.HarmBlockThresholdB\x03\xe0A\x02R\tthreshold\x12V\n" +
	"\x06method\x18\x04 \x01(\x0e29.google.cloud.aiplatform.v1.SafetySetting.HarmBlockMethodB\x03\xe0A\x01R\x06method\"\x9d\x01\n" +
	...
	"\vPROBABILITY\x10\x02\"\x8a\x05\n" +
	"\fSafetyRating\x12I\n" +
	"\bcategory\x18\x01 \x01(\x0e2(.google.cloud.aiplatform.v1.HarmCategoryB\x03\xe0A\x03R\bcategory\x12_\n" +
	"\vprobability\x18\x02 \x01(\x0e28.google.cloud.aiplatform.v1.SafetyRating.HarmProbabilityB\x03\xe0A\x03R\vprobability\x120\n" +
	"\x11probability_score\x18\x05 \x01(\x02B\x03\xe0A\x03R\x10probabilityScore\x12V\n" +
	"\bseverity\x18\x06 \x01(\x0e25.google.cloud.aiplatform.v1.SafetyRating.HarmSeverityB\x03\xe0A\x03R\bseverity\x12*\n" +
	...
	"\x10CitationMetadata\x12G\n" +
	"\tcitations\x18\x01 \x03(\v2$.google.cloud.aiplatform.v1.CitationB\x03\xe0A\x03R\tcitations\"\xe6\x01\n" +
	"\bCitation\x12$\n" +
	...
	"\x10publication_date\x18\x06 \x01(\v2\x11.google.type.DateB\x03\xe0A\x03R\x0fpublicationDate\"\xf9\a\n" +
	"\tCandidate\x12\x19\n" +
	"\x05index\x18\x01 \x01(\x05B\x03\xe0A\x03R\x05index\x12B\n" +
	"\acontent\x18\x02 \x01(\v2#.google.cloud.aiplatform.v1.ContentB\x03\xe0A\x03R\acontent\x12\x19\n" +
	"\x05score\x18\b \x01(\x01B\x03\xe0A\x03R\x05score\x12&\n" +
	"\favg_logprobs\x18\t \x01(\x01B\x03\xe0A\x03R\vavgLogprobs\x12X\n" +
	"\x0flogprobs_result\x18\n" +
	" \x01(\v2*.google.cloud.aiplatform.v1.LogprobsResultB\x03\xe0A\x03R\x0elogprobsResult\x12\\\n" +
	"\rfinish_reason\x18\x03 \x01(\x0e22.google.cloud.aiplatform.v1.Candidate.FinishReasonB\x03\xe0A\x03R\ffinishReason\x12T\n" +
	"\x0esafety_ratings\x18\x04 \x03(\v2(.google.cloud.aiplatform.v1.SafetyRatingB\x03\xe0A\x03R\rsafetyRatings\x12/\n" +
	"\x0efinish_message\x18\x05 \x01(\tB\x03\xe0A\x03H\x00R\rfinishMessage\x88\x01\x01\x12^\n" +
	"\x11citation_metadata\x18\x06 \x01(\v2,.google.cloud.aiplatform.v1.CitationMetadataB\x03\xe0A\x03R\x10citationMetadata\x12a\n" +
	"\x12grounding_metadata\x18\a \x01(\v2-.google.cloud.aiplatform.v1.GroundingMetadataB\x03\xe0A\x03R\x11groundingMetadata\x12e\n" +
	"\x14url_context_metadata\x18\v \x01(\v2..google.cloud.aiplatform.v1.UrlContextMetadataB\x03\xe0A\x03R\x12urlContextMetadata\"\xcd\x01\n" +
	...
	"\furl_metadata\x18\x01 \x03(\v2'.google.cloud.aiplatform.v1.UrlMetadataB\x03\xe0A\x03R\vurlMetadata\"\x9e\x02\n" +
	"\vUrlMetadata\x12#\n" +
	"\rretrieved_url\x18\x01 \x01(\tR\fretrievedUrl\x12l\n" +
	"\x14url_retrieval_status\x18\x02 \x01(\x0e2:.google.cloud.aiplatform.v1.UrlMetadata.UrlRetrievalStatusR\x12urlRetrievalStatus\"|\n" +
	"\x12UrlRetrievalStatus\x12$\n" +
	" URL_RETRIEVAL_STATUS_UNSPECIFIED\x10\x00\x12 \n" +
	"\x1cURL_RETRIEVAL_STATUS_SUCCESS\x10\x01\x12\x1e\n" +
	"\x1aURL_RETRIEVAL_STATUS_ERROR\x10\x02\"\xdd\x03\n" +
	"\x0eLogprobsResult\x12_\n" +
	"\x0etop_candidates\x18\x01 \x03(\v28.google.cloud.aiplatform.v1.LogprobsResult.TopCandidatesR\rtopCandidates\x12a\n" +
	"\x11chosen_candidates\x18\x02 \x03(\v24.google.cloud.aiplatform.v1.LogprobsResult.CandidateR\x10chosenCandidates\x1a\x9f\x01\n" +
	"\tCandidate\x12\x19\n" +
	...
	"\x06_tokenB\v\n" +
	"\t_token_idB\x12\n" +
	"\x10_log_probability\x1ae\n" +
	"\rTopCandidates\x12T\n" +
	"\n" +
	"candidates\x18\x01 \x03(\v24.google.cloud.aiplatform.v1.LogprobsResult.CandidateR\n" +
	"candidates\"\x8e\x01\n" +
	"\aSegment\x12\"\n" +
	"\n" +
	...
	"\x04text\x18\x04 \x01(\tB\x03\xe0A\x03R\x04text\"\x84\t\n" +
	"\x0eGroundingChunk\x12B\n" +
	"\x03web\x18\x01 \x01(\v2..google.cloud.aiplatform.v1.GroundingChunk.WebH\x00R\x03web\x12j\n" +
	"\x11retrieved_context\x18\x02 \x01(\v2;.google.cloud.aiplatform.v1.GroundingChunk.RetrievedContextH\x00R\x10retrievedContext\x12E\n" +
	"\x04maps\x18\x03 \x01(\v2/.google.cloud.aiplatform.v1.GroundingChunk.MapsH\x00R\x04maps\x1aI\n" +
	"\x03Web\x12\x15\n" +
	"\x03uri\x18\x01 \x01(\tH\x00R\x03uri\x88\x01\x01\x12\x19\n" +
	"\x05title\x18\x02 \x01(\tH\x01R\x05title\x88\x01\x01B\x06\n" +
	"\x04_uriB\b\n" +
	"\x06_title\x1a\x91\x02\n" +
	"\x10RetrievedContext\x12C\n" +
	"\trag_chunk\x18\x04 \x01(\v2$.google.cloud.aiplatform.v1.RagChunkH\x00R\bragChunk\x12\x15\n" +
	...
	"\x06_titleB\a\n" +
	"\x05_textB\x10\n" +
	"\x0e_document_name\x1a\x8d\x04\n" +
	"\x04Maps\x12\x15\n" +
	"\x03uri\x18\x01 \x01(\tH\x00R\x03uri\x88\x01\x01\x12\x19\n" +
	"\x05title\x18\x02 \x01(\tH\x01R\x05title\x88\x01\x01\x12\x17\n" +
	"\x04text\x18\x03 \x01(\tH\x02R\x04text\x88\x01\x01\x12\x1e\n" +
	"\bplace_id\x18\x04 \x01(\tH\x03R\aplaceId\x88\x01\x01\x12t\n" +
	"\x14place_answer_sources\x18\x05 \x01(\v2B.google.cloud.aiplatform.v1.GroundingChunk.Maps.PlaceAnswerSourcesR\x12placeAnswerSources\x1a\xfb\x01\n" +
	"\x12PlaceAnswerSources\x12y\n" +
	"\x0freview_snippets\x18\x01 \x03(\v2P.google.cloud.aiplatform.v1.GroundingChunk.Maps.PlaceAnswerSources.ReviewSnippetR\x0ereviewSnippets\x1aj\n" +
	...
	"\asegment\x18\x01 \x01(\v2#.google.cloud.aiplatform.v1.SegmentH\x00R\asegment\x88\x01\x01\x126\n" +
	...
	"\x12web_search_queries\x18\x01 \x03(\tB\x03\xe0A\x01R\x10webSearchQueries\x12d\n" +
	"\x12search_entry_point\x18\x04 \x01(\v2,.google.cloud.aiplatform.v1.SearchEntryPointB\x03\xe0A\x01H\x00R\x10searchEntryPoint\x88\x01\x01\x12U\n" +
	"\x10grounding_chunks\x18\x05 \x03(\v2*.google.cloud.aiplatform.v1.GroundingChunkR\x0fgroundingChunks\x12`\n" +
	"\x12grounding_supports\x18\x06 \x03(\v2,.google.cloud.aiplatform.v1.GroundingSupportB\x03\xe0A\x01R\x11groundingSupports\x12i\n" +
	"\x12retrieval_metadata\x18\a \x01(\v2-.google.cloud.aiplatform.v1.RetrievalMetadataB\x06\xe0A\x01\xe0A\x03H\x01R\x11retrievalMetadata\x88\x01\x01\x12S\n" +
	" google_maps_widget_context_token\x18\b \x01(\tB\x06\xe0A\x01\xe0A\x03H\x02R\x1cgoogleMapsWidgetContextToken\x88\x01\x01\x12q\n" +
	"\x14source_flagging_uris\x18\t \x03(\v2?.google.cloud.aiplatform.v1.GroundingMetadata.SourceFlaggingUriR\x12sourceFlaggingUris\x1aZ\n" +
	...
	"\"modelarmor.googleapis.com/TemplateR\x14responseTemplateName\"w\n" +
	"\x12ModalityTokenCount\x12@\n" +
	"\bmodality\x18\x01 \x01(\x0e2$.google.cloud.aiplatform.v1.ModalityR\bmodality\x12\x1f\n" +
	...
	"\bDOCUMENT\x10\x05B\xaf\x02\xeaAb\n" +
	"\"modelarmor.googleapis.com/Template\x12<projects/{project}/locations/{location}/templates/{template}\n" +
	"\x1ecom.google.cloud.aiplatform.v1B\fContentProtoP\x01Z>cloud.google.com/go/aiplatform/apiv1/aiplatformpb;aiplatformpb\xaa\x02\x1aGoogle.Cloud.AIPlatform.V1\xca\x02\x1aGoogle\\Cloud\\AIPlatform\\V1\xea\x02\x1dGoogle::Cloud::AIPlatform::V1b\x06proto3"

var (
	file_google_cloud_aiplatform_v1_content_proto_rawDescOnce sync.Once
	file_google_cloud_aiplatform_v1_content_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_content_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_content_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_content_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_content_proto_rawDesc), len(file_google_cloud_aiplatform_v1_content_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1_content_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_content_proto_rawDesc), len(file_google_cloud_aiplatform_v1_content_proto_rawDesc)),
			NumEnums:      14,
			NumMessages:   43,
			NumExtensions: 0,
			NumServices:   0,
