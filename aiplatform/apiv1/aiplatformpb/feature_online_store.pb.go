...
func (x *FeatureOnlineStore_Bigtable_BigtableMetadata) Reset() {
	*x = FeatureOnlineStore_Bigtable_BigtableMetadata{}
	mi := &file_google_cloud_aiplatform_v1_feature_online_store_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FeatureOnlineStore_Bigtable_BigtableMetadata) Descriptor() ([]byte, []int) {
	return file_google_cloud_aiplatform_v1_feature_online_store_proto_rawDescGZIP(), []int{0, 0, 1}
}
...
const file_google_cloud_aiplatform_v1_feature_online_store_proto_rawDesc = "" +
	"\n" +
	"5google/cloud/aiplatform/v1/feature_online_store.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a0google/cloud/aiplatform/v1/encryption_spec.proto\x1a3google/cloud/aiplatform/v1/service_networking.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x88\x10\n" +
	"\x12FeatureOnlineStore\x12U\n" +
	"\bbigtable\x18\b \x01(\v27.google.cloud.aiplatform.v1.FeatureOnlineStore.BigtableH\x00R\bbigtable\x12X\n" +
	"\toptimized\x18\f \x01(\v28.google.cloud.aiplatform.v1.FeatureOnlineStore.OptimizedH\x00R\toptimized\x12\x17\n" +
	...
	"updateTime\x12\x17\n" +
	"\x04etag\x18\x05 \x01(\tB\x03\xe0A\x01R\x04etag\x12W\n" +
	"\x06labels\x18\x06 \x03(\v2:.google.cloud.aiplatform.v1.FeatureOnlineStore.LabelsEntryB\x03\xe0A\x01R\x06labels\x12O\n" +
	"\x05state\x18\a \x01(\x0e24.google.cloud.aiplatform.v1.FeatureOnlineStore.StateB\x03\xe0A\x03R\x05state\x12\x8a\x01\n" +
	"\x1adedicated_serving_endpoint\x18\n" +
	" \x01(\v2G.google.cloud.aiplatform.v1.FeatureOnlineStore.DedicatedServingEndpointB\x03\xe0A\x01R\x18dedicatedServingEndpoint\x12X\n" +
	"\x0fencryption_spec\x18\r \x01(\v2*.google.cloud.aiplatform.v1.EncryptionSpecB\x03\xe0A\x01R\x0eencryptionSpec\x12(\n" +
	"\rsatisfies_pzs\x18\x0f \x01(\bB\x03\xe0A\x03R\fsatisfiesPzs\x12(\n" +
	"\rsatisfies_pzi\x18\x10 \x01(\bB\x03\xe0A\x03R\fsatisfiesPzi\x1a\xf1\x04\n" +
	"\bBigtable\x12k\n" +
	"\fauto_scaling\x18\x01 \x01(\v2C.google.cloud.aiplatform.v1.FeatureOnlineStore.Bigtable.AutoScalingB\x03\xe0A\x02R\vautoScaling\x12F\n" +
	"\x1denable_direct_bigtable_access\x18\x03 \x01(\bB\x03\xe0A\x01R\x1aenableDirectBigtableAccess\x12z\n" +
	"\x11bigtable_metadata\x18\x04 \x01(\v2H.google.cloud.aiplatform.v1.FeatureOnlineStore.Bigtable.BigtableMetadataB\x03\xe0A\x03R\x10bigtableMetadata\x12\x17\n" +
	...
	"\tOptimized\x1a\x96\x02\n" +
	"\x18DedicatedServingEndpoint\x12B\n" +
	"\x1bpublic_endpoint_domain_name\x18\x02 \x01(\tB\x03\xe0A\x03R\x18publicEndpointDomainName\x12\x81\x01\n" +
	"\x1eprivate_service_connect_config\x18\x03 \x01(\v27.google.cloud.aiplatform.v1.PrivateServiceConnectConfigB\x03\xe0A\x01R\x1bprivateServiceConnectConfig\x122\n" +
	"\x12service_attachment\x18\x04 \x01(\tB\x03\xe0A\x03R\x11serviceAttachment\x1a9\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_feature_online_store_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_feature_online_store_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_feature_online_store_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_feature_online_store_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_feature_online_store_proto_rawDesc), len(file_google_cloud_aiplatform_v1_feature_online_store_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1_feature_online_store_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_google_cloud_aiplatform_v1_feature_online_store_proto_goTypes = []any{
	...
	(*FeatureOnlineStore_Bigtable_BigtableMetadata)(nil), // 7: google.cloud.aiplatform.v1.FeatureOnlineStore.Bigtable.BigtableMetadata
	(*timestamppb.Timestamp)(nil),                        // 8: google.protobuf.Timestamp
	(*EncryptionSpec)(nil),                               // 9: google.cloud.aiplatform.v1.EncryptionSpec
	(*PrivateServiceConnectConfig)(nil),                  // 10: google.cloud.aiplatform.v1.PrivateServiceConnectConfig
}
var file_google_cloud_aiplatform_v1_feature_online_store_proto_depIdxs = []int32{
	...
	8,  // 2: google.cloud.aiplatform.v1.FeatureOnlineStore.create_time:type_name -> google.protobuf.Timestamp
	8,  // 3: google.cloud.aiplatform.v1.FeatureOnlineStore.update_time:type_name -> google.protobuf.Timestamp
	...
	9,  // 7: google.cloud.aiplatform.v1.FeatureOnlineStore.encryption_spec:type_name -> google.cloud.aiplatform.v1.EncryptionSpec
	...
	7,  // 9: google.cloud.aiplatform.v1.FeatureOnlineStore.Bigtable.bigtable_metadata:type_name -> google.cloud.aiplatform.v1.FeatureOnlineStore.Bigtable.BigtableMetadata
	10, // 10: google.cloud.aiplatform.v1.FeatureOnlineStore.DedicatedServingEndpoint.private_service_connect_config:type_name -> google.cloud.aiplatform.v1.PrivateServiceConnectConfig
...
func file_google_cloud_aiplatform_v1_feature_online_store_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_feature_online_store_proto_rawDesc), len(file_google_cloud_aiplatform_v1_feature_online_store_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
