...
const file_google_cloud_aiplatform_v1_tensorboard_time_series_proto_rawDesc = "" +
	"\n" +
	"8google/cloud/aiplatform/v1/tensorboard_time_series.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd7\a\n" +
	...
	"\n" +
	"value_type\x18\x04 \x01(\x0e2;.google.cloud.aiplatform.v1.TensorboardTimeSeries.ValueTypeB\x06\xe0A\x02\xe0A\x05R\tvalueType\x12@\n" +
	...
	"pluginData\x12[\n" +
	"\bmetadata\x18\n" +
	" \x01(\v2:.google.cloud.aiplatform.v1.TensorboardTimeSeries.MetadataB\x03\xe0A\x03R\bmetadata\x1a\xad\x01\n" +
	"\bMetadata\x12\x1e\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1_tensorboard_time_series_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1_tensorboard_time_series_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1_tensorboard_time_series_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1_tensorboard_time_series_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_tensorboard_time_series_proto_rawDesc), len(file_google_cloud_aiplatform_v1_tensorboard_time_series_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1_tensorboard_time_series_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1_tensorboard_time_series_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1_tensorboard_time_series_proto_rawDesc), len(file_google_cloud_aiplatform_v1_tensorboard_time_series_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
