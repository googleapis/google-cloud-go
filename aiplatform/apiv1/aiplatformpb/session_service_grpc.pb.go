...
const (
	SessionService_CreateSession_FullMethodName = "/google.cloud.aiplatform.v1.SessionService/CreateSession"
	SessionService_GetSession_FullMethodName    = "/google.cloud.aiplatform.v1.SessionService/GetSession"
	SessionService_ListSessions_FullMethodName  = "/google.cloud.aiplatform.v1.SessionService/ListSessions"
	SessionService_UpdateSession_FullMethodName = "/google.cloud.aiplatform.v1.SessionService/UpdateSession"
	SessionService_DeleteSession_FullMethodName = "/google.cloud.aiplatform.v1.SessionService/DeleteSession"
	SessionService_ListEvents_FullMethodName    = "/google.cloud.aiplatform.v1.SessionService/ListEvents"
	SessionService_AppendEvent_FullMethodName   = "/google.cloud.aiplatform.v1.SessionService/AppendEvent"
)
...
func (c *sessionServiceClient) ListEvents(ctx context.Context, in *ListEventsRequest, opts ...grpc.CallOption) (*ListEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, SessionService_ListEvents_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionServiceClient) AppendEvent(ctx context.Context, in *AppendEventRequest, opts ...grpc.CallOption) (*AppendEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, SessionService_AppendEvent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var SessionService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/cloud/aiplatform/v1/session_service.proto",
}
