...
func NewMigrationRESTClient(ctx context.Context, opts ...option.ClientOption) (*MigrationClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.SearchMigratableResources = append(callOpts.SearchMigratableResources, gax.WithClientMetrics(metrics))
		callOpts.BatchMigrateResources = append(callOpts.BatchMigrateResources, gax.WithClientMetrics(metrics))
...
func (c *migrationGRPCClient) SearchMigratableResources(ctx context.Context, req *aiplatformpb.SearchMigratableResourcesRequest, opts ...gax.CallOption) *MigratableResourceIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.aiplatform.v1beta1.MigrationService/SearchMigratableResources")
	}
...
func (c *migrationGRPCClient) BatchMigrateResources(ctx context.Context, req *aiplatformpb.BatchMigrateResourcesRequest, opts ...gax.CallOption) (*BatchMigrateResourcesOperation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.aiplatform.v1beta1.MigrationService/BatchMigrateResources")
	}
...
func (c *migrationRESTClient) BatchMigrateResources(ctx context.Context, req *aiplatformpb.BatchMigrateResourcesRequest, opts ...gax.CallOption) (*BatchMigrateResourcesOperation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.aiplatform.v1beta1.MigrationService/BatchMigrateResources")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1beta1/{parent=projects/*/locations/*}/migratableResources:batchMigrate")
	}
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
