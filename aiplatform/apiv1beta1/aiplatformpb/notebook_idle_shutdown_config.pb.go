...
const file_google_cloud_aiplatform_v1beta1_notebook_idle_shutdown_config_proto_rawDesc = "" +
	"\n" +
	"Cgoogle/cloud/aiplatform/v1beta1/notebook_idle_shutdown_config.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1egoogle/protobuf/duration.proto\"\x95\x01\n" +
	...
	"\x16idle_shutdown_disabled\x18\x02 \x01(\bR\x14idleShutdownDisabledB\xf6\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_notebook_idle_shutdown_config_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_notebook_idle_shutdown_config_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_notebook_idle_shutdown_config_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_notebook_idle_shutdown_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_notebook_idle_shutdown_config_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_notebook_idle_shutdown_config_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_notebook_idle_shutdown_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_notebook_idle_shutdown_config_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_notebook_idle_shutdown_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
