...
var file_google_cloud_aiplatform_v1beta1_notebook_idle_shutdown_config_proto_goTypes = []interface{}{
...
func file_google_cloud_aiplatform_v1beta1_notebook_idle_shutdown_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_aiplatform_v1beta1_notebook_idle_shutdown_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
