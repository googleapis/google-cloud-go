...
type Trial struct {
	...
	WebAccessUris map[string]string `protobuf:"bytes,12,rep,name=web_access_uris,json=webAccessUris,proto3" json:"web_access_uris,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StudyTimeConstraint) GetConstraint() isStudyTimeConstraint_Constraint {
	if x != nil {
		return x.Constraint
	}
	return nil
...
func (x *StudyTimeConstraint) GetMaxDuration() *durationpb.Duration {
	if x != nil {
		if x, ok := x.Constraint.(*StudyTimeConstraint_MaxDuration); ok {
...
func (x *StudyTimeConstraint) GetEndTime() *timestamppb.Timestamp {
	if x != nil {
		if x, ok := x.Constraint.(*StudyTimeConstraint_EndTime); ok {
			return x.EndTime
		}
	}
	return nil
...
type StudySpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to AutomatedStoppingSpec:
	//
...
func (x *StudySpec) GetAutomatedStoppingSpec() isStudySpec_AutomatedStoppingSpec {
	if x != nil {
		return x.AutomatedStoppingSpec
	}
	return nil
}
...
func (x *StudySpec) GetDecayCurveStoppingSpec() *StudySpec_DecayCurveAutomatedStoppingSpec {
	if x != nil {
		if x, ok := x.AutomatedStoppingSpec.(*StudySpec_DecayCurveStoppingSpec); ok {
...
func (x *StudySpec) GetMedianAutomatedStoppingSpec() *StudySpec_MedianAutomatedStoppingSpec {
	if x != nil {
		if x, ok := x.AutomatedStoppingSpec.(*StudySpec_MedianAutomatedStoppingSpec_); ok {
...
func (x *StudySpec) GetConvexStopConfig() *StudySpec_ConvexStopConfig {
	if x != nil {
		if x, ok := x.AutomatedStoppingSpec.(*StudySpec_ConvexStopConfig_); ok {
...
func (x *StudySpec) GetConvexAutomatedStoppingSpec() *StudySpec_ConvexAutomatedStoppingSpec {
	if x != nil {
		if x, ok := x.AutomatedStoppingSpec.(*StudySpec_ConvexAutomatedStoppingSpec_); ok {
...
type StudySpec_ParameterSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to ParameterValueSpec:
	//
...
func (x *StudySpec_ParameterSpec) GetParameterValueSpec() isStudySpec_ParameterSpec_ParameterValueSpec {
	if x != nil {
		return x.ParameterValueSpec
	}
	return nil
}
...
func (x *StudySpec_ParameterSpec) GetDoubleValueSpec() *StudySpec_ParameterSpec_DoubleValueSpec {
	if x != nil {
		if x, ok := x.ParameterValueSpec.(*StudySpec_ParameterSpec_DoubleValueSpec_); ok {
...
func (x *StudySpec_ParameterSpec) GetIntegerValueSpec() *StudySpec_ParameterSpec_IntegerValueSpec {
	if x != nil {
		if x, ok := x.ParameterValueSpec.(*StudySpec_ParameterSpec_IntegerValueSpec_); ok {
...
func (x *StudySpec_ParameterSpec) GetCategoricalValueSpec() *StudySpec_ParameterSpec_CategoricalValueSpec {
	if x != nil {
		if x, ok := x.ParameterValueSpec.(*StudySpec_ParameterSpec_CategoricalValueSpec_); ok {
...
func (x *StudySpec_ParameterSpec) GetDiscreteValueSpec() *StudySpec_ParameterSpec_DiscreteValueSpec {
	if x != nil {
		if x, ok := x.ParameterValueSpec.(*StudySpec_ParameterSpec_DiscreteValueSpec_); ok {
...
type StudySpec_ParameterSpec_ConditionalParameterSpec struct {
	...
	// space.
	//
	// Types that are valid to be assigned to ParentValueCondition:
	//
...
func (x *StudySpec_ParameterSpec_ConditionalParameterSpec) GetParentValueCondition() isStudySpec_ParameterSpec_ConditionalParameterSpec_ParentValueCondition {
	if x != nil {
		return x.ParentValueCondition
	}
	return nil
}
...
func (x *StudySpec_ParameterSpec_ConditionalParameterSpec) GetParentDiscreteValues() *StudySpec_ParameterSpec_ConditionalParameterSpec_DiscreteValueCondition {
	if x != nil {
		if x, ok := x.ParentValueCondition.(*StudySpec_ParameterSpec_ConditionalParameterSpec_ParentDiscreteValues); ok {
...
func (x *StudySpec_ParameterSpec_ConditionalParameterSpec) GetParentIntValues() *StudySpec_ParameterSpec_ConditionalParameterSpec_IntValueCondition {
	if x != nil {
		if x, ok := x.ParentValueCondition.(*StudySpec_ParameterSpec_ConditionalParameterSpec_ParentIntValues); ok {
...
func (x *StudySpec_ParameterSpec_ConditionalParameterSpec) GetParentCategoricalValues() *StudySpec_ParameterSpec_ConditionalParameterSpec_CategoricalValueCondition {
	if x != nil {
		if x, ok := x.ParentValueCondition.(*StudySpec_ParameterSpec_ConditionalParameterSpec_ParentCategoricalValues); ok {
...
const file_google_cloud_aiplatform_v1beta1_study_proto_rawDesc = "" +
	"\n" +
	"+google/cloud/aiplatform/v1beta1/study.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xf9\x03\n" +
	"\x05Study\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x02R\vdisplayName\x12N\n" +
	"\n" +
	"study_spec\x18\x03 \x01(\v2*.google.cloud.aiplatform.v1beta1.StudySpecB\x03\xe0A\x02R\tstudySpec\x12G\n" +
	"\x05state\x18\x04 \x01(\x0e2,.google.cloud.aiplatform.v1beta1.Study.StateB\x03\xe0A\x03R\x05state\x12@\n" +
	"\vcreate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12,\n" +
	"\x0finactive_reason\x18\x06 \x01(\tB\x03\xe0A\x03R\x0einactiveReason\"G\n" +
	"\x05State\x12\x15\n" +
	...
	"\x1faiplatform.googleapis.com/Study\x127projects/{project}/locations/{location}/studies/{study}\"\x90\t\n" +
	"\x05Trial\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12\x13\n" +
	"\x02id\x18\x02 \x01(\tB\x03\xe0A\x03R\x02id\x12G\n" +
	"\x05state\x18\x03 \x01(\x0e2,.google.cloud.aiplatform.v1beta1.Trial.StateB\x03\xe0A\x03R\x05state\x12U\n" +
	"\n" +
	"parameters\x18\x04 \x03(\v20.google.cloud.aiplatform.v1beta1.Trial.ParameterB\x03\xe0A\x03R\n" +
	"parameters\x12^\n" +
	"\x11final_measurement\x18\x05 \x01(\v2,.google.cloud.aiplatform.v1beta1.MeasurementB\x03\xe0A\x03R\x10finalMeasurement\x12U\n" +
	"\fmeasurements\x18\x06 \x03(\v2,.google.cloud.aiplatform.v1beta1.MeasurementB\x03\xe0A\x03R\fmeasurements\x12>\n" +
	"\n" +
	...
	"\tclient_id\x18\t \x01(\tB\x03\xe0A\x03R\bclientId\x120\n" +
	"\x11infeasible_reason\x18\n" +
	" \x01(\tB\x03\xe0A\x03R\x10infeasibleReason\x12J\n" +
	"\n" +
	"custom_job\x18\v \x01(\tB+\xe0A\x03\xfaA%\n" +
	"#aiplatform.googleapis.com/CustomJobR\tcustomJob\x12f\n" +
	"\x0fweb_access_uris\x18\f \x03(\v29.google.cloud.aiplatform.v1beta1.Trial.WebAccessUrisEntryB\x03\xe0A\x03R\rwebAccessUris\x1af\n" +
	"\tParameter\x12&\n" +
	"\fparameter_id\x18\x01 \x01(\tB\x03\xe0A\x03R\vparameterId\x121\n" +
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueB\x03\xe0A\x03R\x05value\x1a@\n" +
	...
	"\x1faiplatform.googleapis.com/Trial\x12Fprojects/{project}/locations/{location}/studies/{study}/trials/{trial}\"\x82\x01\n" +
	"\fTrialContext\x12 \n" +
	"\vdescription\x18\x01 \x01(\tR\vdescription\x12P\n" +
	"\n" +
	"parameters\x18\x02 \x03(\v20.google.cloud.aiplatform.v1beta1.Trial.ParameterR\n" +
	"parameters\"\x9c\x01\n" +
	"\x13StudyTimeConstraint\x12>\n" +
	"\fmax_duration\x18\x01 \x01(\v2\x19.google.protobuf.DurationH\x00R\vmaxDuration\x127\n" +
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampH\x00R\aendTimeB\f\n" +
	"\n" +
	"constraint\"\xc4.\n" +
	"\tStudySpec\x12\x87\x01\n" +
	"\x19decay_curve_stopping_spec\x18\x04 \x01(\v2J.google.cloud.aiplatform.v1beta1.StudySpec.DecayCurveAutomatedStoppingSpecH\x00R\x16decayCurveStoppingSpec\x12\x8d\x01\n" +
	"\x1emedian_automated_stopping_spec\x18\x05 \x01(\v2F.google.cloud.aiplatform.v1beta1.StudySpec.MedianAutomatedStoppingSpecH\x00R\x1bmedianAutomatedStoppingSpec\x12o\n" +
	"\x12convex_stop_config\x18\b \x01(\v2;.google.cloud.aiplatform.v1beta1.StudySpec.ConvexStopConfigB\x02\x18\x01H\x00R\x10convexStopConfig\x12\x8d\x01\n" +
	"\x1econvex_automated_stopping_spec\x18\t \x01(\v2F.google.cloud.aiplatform.v1beta1.StudySpec.ConvexAutomatedStoppingSpecH\x00R\x1bconvexAutomatedStoppingSpec\x12T\n" +
	"\ametrics\x18\x01 \x03(\v25.google.cloud.aiplatform.v1beta1.StudySpec.MetricSpecB\x03\xe0A\x02R\ametrics\x12]\n" +
	"\n" +
	"parameters\x18\x02 \x03(\v28.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpecB\x03\xe0A\x02R\n" +
	"parameters\x12R\n" +
	"\talgorithm\x18\x03 \x01(\x0e24.google.cloud.aiplatform.v1beta1.StudySpec.AlgorithmR\talgorithm\x12h\n" +
	"\x11observation_noise\x18\x06 \x01(\x0e2;.google.cloud.aiplatform.v1beta1.StudySpec.ObservationNoiseR\x10observationNoise\x12\x81\x01\n" +
	"\x1ameasurement_selection_type\x18\a \x01(\x0e2C.google.cloud.aiplatform.v1beta1.StudySpec.MeasurementSelectionTypeR\x18measurementSelectionType\x12{\n" +
	"\x18transfer_learning_config\x18\n" +
	" \x01(\v2A.google.cloud.aiplatform.v1beta1.StudySpec.TransferLearningConfigR\x16transferLearningConfig\x12w\n" +
	"\x15study_stopping_config\x18\v \x01(\v2>.google.cloud.aiplatform.v1beta1.StudySpec.StudyStoppingConfigH\x01R\x13studyStoppingConfig\x88\x01\x01\x1a\x84\x04\n" +
	"\n" +
	"MetricSpec\x12 \n" +
	"\tmetric_id\x18\x01 \x01(\tB\x03\xe0A\x02R\bmetricId\x12W\n" +
	"\x04goal\x18\x02 \x01(\x0e2>.google.cloud.aiplatform.v1beta1.StudySpec.MetricSpec.GoalTypeB\x03\xe0A\x02R\x04goal\x12r\n" +
	"\rsafety_config\x18\x03 \x01(\v2H.google.cloud.aiplatform.v1beta1.StudySpec.MetricSpec.SafetyMetricConfigH\x00R\fsafetyConfig\x88\x01\x01\x1a\xb1\x01\n" +
	"\x12SafetyMetricConfig\x12)\n" +
	"\x10safety_threshold\x18\x01 \x01(\x01R\x0fsafetyThreshold\x12K\n" +
	" desired_min_safe_trials_fraction\x18\x02 \x01(\x01H\x00R\x1cdesiredMinSafeTrialsFraction\x88\x01\x01B#\n" +
	"!_desired_min_safe_trials_fraction\"A\n" +
	"\bGoalType\x12\x19\n" +
	"\x15GOAL_TYPE_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bMAXIMIZE\x10\x01\x12\f\n" +
	"\bMINIMIZE\x10\x02B\x10\n" +
	"\x0e_safety_config\x1a\xda\x11\n" +
	"\rParameterSpec\x12v\n" +
	"\x11double_value_spec\x18\x02 \x01(\v2H.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.DoubleValueSpecH\x00R\x0fdoubleValueSpec\x12y\n" +
	"\x12integer_value_spec\x18\x03 \x01(\v2I.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.IntegerValueSpecH\x00R\x10integerValueSpec\x12\x85\x01\n" +
	"\x16categorical_value_spec\x18\x04 \x01(\v2M.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.CategoricalValueSpecH\x00R\x14categoricalValueSpec\x12|\n" +
	"\x13discrete_value_spec\x18\x05 \x01(\v2J.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.DiscreteValueSpecH\x00R\x11discreteValueSpec\x12&\n" +
	"\fparameter_id\x18\x01 \x01(\tB\x03\xe0A\x02R\vparameterId\x12a\n" +
	"\n" +
	"scale_type\x18\x06 \x01(\x0e2B.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ScaleTypeR\tscaleType\x12\x91\x01\n" +
	"\x1bconditional_parameter_specs\x18\n" +
	" \x03(\v2Q.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpecR\x19conditionalParameterSpecs\x1a\x91\x01\n" +
	"\x0fDoubleValueSpec\x12 \n" +
	"\tmin_value\x18\x01 \x01(\x01B\x03\xe0A\x02R\bminValue\x12 \n" +
	"\tmax_value\x18\x02 \x01(\x01B\x03\xe0A\x02R\bmaxValue\x12(\n" +
	"\rdefault_value\x18\x04 \x01(\x01H\x00R\fdefaultValue\x88\x01\x01B\x10\n" +
	"\x0e_default_value\x1a\x92\x01\n" +
	"\x10IntegerValueSpec\x12 \n" +
	"\tmin_value\x18\x01 \x01(\x03B\x03\xe0A\x02R\bminValue\x12 \n" +
	"\tmax_value\x18\x02 \x01(\x03B\x03\xe0A\x02R\bmaxValue\x12(\n" +
	"\rdefault_value\x18\x04 \x01(\x03H\x00R\fdefaultValue\x88\x01\x01B\x10\n" +
	"\x0e_default_value\x1ao\n" +
	"\x14CategoricalValueSpec\x12\x1b\n" +
	"\x06values\x18\x01 \x03(\tB\x03\xe0A\x02R\x06values\x12(\n" +
	"\rdefault_value\x18\x03 \x01(\tH\x00R\fdefaultValue\x88\x01\x01B\x10\n" +
	"\x0e_default_value\x1al\n" +
	"\x11DiscreteValueSpec\x12\x1b\n" +
	"\x06values\x18\x01 \x03(\x01B\x03\xe0A\x02R\x06values\x12(\n" +
	"\rdefault_value\x18\x03 \x01(\x01H\x00R\fdefaultValue\x88\x01\x01B\x10\n" +
	"\x0e_default_value\x1a\xa0\x06\n" +
	"\x18ConditionalParameterSpec\x12\xa0\x01\n" +
	"\x16parent_discrete_values\x18\x02 \x01(\v2h.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpec.DiscreteValueConditionH\x00R\x14parentDiscreteValues\x12\x91\x01\n" +
	"\x11parent_int_values\x18\x03 \x01(\v2c.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpec.IntValueConditionH\x00R\x0fparentIntValues\x12\xa9\x01\n" +
	"\x19parent_categorical_values\x18\x04 \x01(\v2k.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpec.CategoricalValueConditionH\x00R\x17parentCategoricalValues\x12d\n" +
	"\x0eparameter_spec\x18\x01 \x01(\v28.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpecB\x03\xe0A\x02R\rparameterSpec\x1a5\n" +
	"\x16DiscreteValueCondition\x12\x1b\n" +
	"\x06values\x18\x01 \x03(\x01B\x03\xe0A\x02R\x06values\x1a0\n" +
	"\x11IntValueCondition\x12\x1b\n" +
	"\x06values\x18\x01 \x03(\x03B\x03\xe0A\x02R\x06values\x1a8\n" +
	"\x19CategoricalValueCondition\x12\x1b\n" +
	"\x06values\x18\x01 \x03(\tB\x03\xe0A\x02R\x06valuesB\x18\n" +
	...
	"\x1fDecayCurveAutomatedStoppingSpec\x120\n" +
	"\x14use_elapsed_duration\x18\x01 \x01(\bR\x12useElapsedDuration\x1aO\n" +
	"\x1bMedianAutomatedStoppingSpec\x120\n" +
	"\x14use_elapsed_duration\x18\x01 \x01(\bR\x12useElapsedDuration\x1a\xee\x02\n" +
	"\x1bConvexAutomatedStoppingSpec\x12$\n" +
	"\x0emax_step_count\x18\x01 \x01(\x03R\fmaxStepCount\x12$\n" +
	"\x0emin_step_count\x18\x02 \x01(\x03R\fminStepCount\x122\n" +
	"\x15min_measurement_count\x18\x03 \x01(\x03R\x13minMeasurementCount\x12?\n" +
	"\x1clearning_rate_parameter_name\x18\x04 \x01(\tR\x19learningRateParameterName\x120\n" +
	"\x14use_elapsed_duration\x18\x05 \x01(\bR\x12useElapsedDuration\x12>\n" +
	"\x19update_all_stopped_trials\x18\x06 \x01(\bH\x00R\x16updateAllStoppedTrials\x88\x01\x01B\x1c\n" +
	"\x1a_update_all_stopped_trials\x1a\xf3\x01\n" +
	"\x10ConvexStopConfig\x12\"\n" +
	"\rmax_num_steps\x18\x01 \x01(\x03R\vmaxNumSteps\x12\"\n" +
	"\rmin_num_steps\x18\x02 \x01(\x03R\vminNumSteps\x121\n" +
	"\x14autoregressive_order\x18\x03 \x01(\x03R\x13autoregressiveOrder\x12?\n" +
	"\x1clearning_rate_parameter_name\x18\x04 \x01(\tR\x19learningRateParameterName\x12\x1f\n" +
	"\vuse_seconds\x18\x05 \x01(\bR\n" +
	"useSeconds:\x02\x18\x01\x1a\x85\x01\n" +
	"\x16TransferLearningConfig\x12:\n" +
	"\x19disable_transfer_learning\x18\x01 \x01(\bR\x17disableTransferLearning\x12/\n" +
	"\x11prior_study_names\x18\x02 \x03(\tB\x03\xe0A\x03R\x0fpriorStudyNames\x1a\xf6\x04\n" +
	"\x13StudyStoppingConfig\x12D\n" +
	"\x10should_stop_asap\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x0eshouldStopAsap\x12r\n" +
	"\x1aminimum_runtime_constraint\x18\x02 \x01(\v24.google.cloud.aiplatform.v1beta1.StudyTimeConstraintR\x18minimumRuntimeConstraint\x12r\n" +
	"\x1amaximum_runtime_constraint\x18\x03 \x01(\v24.google.cloud.aiplatform.v1beta1.StudyTimeConstraintR\x18maximumRuntimeConstraint\x12A\n" +
	"\x0emin_num_trials\x18\x04 \x01(\v2\x1b.google.protobuf.Int32ValueR\fminNumTrials\x12A\n" +
	"\x0emax_num_trials\x18\x05 \x01(\v2\x1b.google.protobuf.Int32ValueR\fmaxNumTrials\x12W\n" +
	"\x1amax_num_trials_no_progress\x18\x06 \x01(\v2\x1b.google.protobuf.Int32ValueR\x16maxNumTrialsNoProgress\x12R\n" +
	"\x18max_duration_no_progress\x18\a \x01(\v2\x19.google.protobuf.DurationR\x15maxDurationNoProgress\"J\n" +
	"\tAlgorithm\x12\x19\n" +
	"\x15ALGORITHM_UNSPECIFIED\x10\x00\x12\x0f\n" +
	"\vGRID_SEARCH\x10\x02\x12\x11\n" +
	"\rRANDOM_SEARCH\x10\x03\"H\n" +
	"\x10ObservationNoise\x12!\n" +
	"\x1dOBSERVATION_NOISE_UNSPECIFIED\x10\x00\x12\a\n" +
	...
	"\x16_study_stopping_config\"\x97\x02\n" +
	"\vMeasurement\x12I\n" +
	"\x10elapsed_duration\x18\x01 \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x03R\x0felapsedDuration\x12\"\n" +
	"\n" +
	"step_count\x18\x02 \x01(\x03B\x03\xe0A\x03R\tstepCount\x12R\n" +
	"\ametrics\x18\x03 \x03(\v23.google.cloud.aiplatform.v1beta1.Measurement.MetricB\x03\xe0A\x03R\ametrics\x1aE\n" +
	"\x06Metric\x12 \n" +
	"\tmetric_id\x18\x01 \x01(\tB\x03\xe0A\x03R\bmetricId\x12\x19\n" +
	"\x05value\x18\x02 \x01(\x01B\x03\xe0A\x03R\x05valueB\xe1\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_study_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_study_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_study_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_study_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_study_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_study_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_study_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_study_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_study_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   26,
			NumExtensions: 0,
			NumServices:   0,
