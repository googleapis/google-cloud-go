...
const file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_rawDesc = "" +
	...
	"\n" +
	"page_token\x18\x04 \x01(\tB\x03\xe0A\x01R\tpageToken\"\xb1\x01\n" +
	"\x1fListPersistentResourcesResponse\x12f\n" +
	"\x14persistent_resources\x18\x01 \x03(\v23.google.cloud.aiplatform.v1beta1.PersistentResourceR\x13persistentResources\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"k\n" +
	"\x1fDeletePersistentResourceRequest\x12H\n" +
	"\x04name\x18\x01 \x01(\tB4\xe0A\x02\xfaA.\n" +
	",aiplatform.googleapis.com/PersistentResourceR\x04name\"\xce\x01\n" +
	"\x1fUpdatePersistentResourceRequest\x12i\n" +
	"\x13persistent_resource\x18\x01 \x01(\v23.google.cloud.aiplatform.v1beta1.PersistentResourceB\x03\xe0A\x02R\x12persistentResource\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"k\n" +
	"\x1fRebootPersistentResourceRequest\x12H\n" +
	"\x04name\x18\x01 \x01(\tB4\xe0A\x02\xfaA.\n" +
	",aiplatform.googleapis.com/PersistentResourceR\x04name2\xeb\r\n" +
	...
	"\x12PersistentResource\x12)CreatePersistentResourceOperationMetadata\xdaA1parent,persistent_resource,persistent_resource_id\x82\xd3\xe4\x93\x02S:\x13persistent_resource\"</v1beta1/{parent=projects/*/locations/*}/persistentResources\x12\xd8\x01\n" +
	...
	"\x12PersistentResource\x12)UpdatePersistentResourceOperationMetadata\xdaA\x1fpersistent_resource,update_mask\x82\xd3\xe4\x93\x02g:\x13persistent_resource2P/v1beta1/{persistent_resource.name=projects/*/locations/*/persistentResources/*}\x12\x95\x02\n" +
	...
	"\x12PersistentResource\x12)RebootPersistentResourceOperationMetadata\xdaA\x04name\x82\xd3\xe4\x93\x02H:\x01*\"C/v1beta1/{name=projects/*/locations/*/persistentResources/*}:reboot\x1aM\xcaA\x19aiplatform.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xf5\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
