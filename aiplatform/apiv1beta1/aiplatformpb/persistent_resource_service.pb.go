...
func file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1beta1_persistent_resource_service_proto_msgTypes[9].Exporter = func(v any, i int) any {
...
func (c *persistentResourceServiceClient) RebootPersistentResource(ctx context.Context, in *RebootPersistentResourceRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/google.cloud.aiplatform.v1beta1.PersistentResourceService/RebootPersistentResource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PersistentResourceService_RebootPersistentResource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.cloud.aiplatform.v1beta1.PersistentResourceService/RebootPersistentResource",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
