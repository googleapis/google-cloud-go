...
const file_google_cloud_aiplatform_v1beta1_gen_ai_cache_service_proto_rawDesc = "" +
	"\n" +
	":google/cloud/aiplatform/v1beta1/gen_ai_cache_service.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a4google/cloud/aiplatform/v1beta1/cached_content.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\"\xc1\x01\n" +
	"\x1aCreateCachedContentRequest\x12G\n" +
	"\x06parent\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\x12'aiplatform.googleapis.com/CachedContentR\x06parent\x12Z\n" +
	"\x0ecached_content\x18\x02 \x01(\v2..google.cloud.aiplatform.v1beta1.CachedContentB\x03\xe0A\x02R\rcachedContent\"^\n" +
	"\x17GetCachedContentRequest\x12C\n" +
	"\x04name\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'aiplatform.googleapis.com/CachedContentR\x04name\"\xba\x01\n" +
	"\x1aUpdateCachedContentRequest\x12Z\n" +
	"\x0ecached_content\x18\x01 \x01(\v2..google.cloud.aiplatform.v1beta1.CachedContentB\x03\xe0A\x02R\rcachedContent\x12@\n" +
	...
	"\x1aListCachedContentsResponse\x12W\n" +
	"\x0fcached_contents\x18\x01 \x03(\v2..google.cloud.aiplatform.v1beta1.CachedContentR\x0ecachedContents\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken2\xa8\t\n" +
	"\x11GenAiCacheService\x12\xeb\x01\n" +
	"\x13CreateCachedContent\x12;.google.cloud.aiplatform.v1beta1.CreateCachedContentRequest\x1a..google.cloud.aiplatform.v1beta1.CachedContent\"g\xdaA\x15parent,cached_content\x82\xd3\xe4\x93\x02I:\x0ecached_content\"7/v1beta1/{parent=projects/*/locations/*}/cachedContents\x12\xc4\x01\n" +
	...
	"\x13UpdateCachedContent\x12;.google.cloud.aiplatform.v1beta1.UpdateCachedContentRequest\x1a..google.cloud.aiplatform.v1beta1.CachedContent\"{\xdaA\x1acached_content,update_mask\x82\xd3\xe4\x93\x02X:\x0ecached_content2F/v1beta1/{cached_content.name=projects/*/locations/*/cachedContents/*}\x12\xb2\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_gen_ai_cache_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_gen_ai_cache_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_gen_ai_cache_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_gen_ai_cache_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_gen_ai_cache_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_gen_ai_cache_service_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_gen_ai_cache_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_gen_ai_cache_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_gen_ai_cache_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
