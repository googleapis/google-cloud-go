...
const file_google_cloud_aiplatform_v1beta1_schedule_service_proto_rawDesc = "" +
	"\n" +
	...
	"\bschedule\x18\x02 \x01(\v2).google.cloud.aiplatform.v1beta1.ScheduleB\x03\xe0A\x02R\bschedule\"T\n" +
	...
	"\tschedules\x18\x01 \x03(\v2).google.cloud.aiplatform.v1beta1.ScheduleR\tschedules\x12&\n" +
	...
	"\bcatch_up\x18\x02 \x01(\bB\x03\xe0A\x01R\acatchUp\"\xa5\x01\n" +
	"\x15UpdateScheduleRequest\x12J\n" +
	"\bschedule\x18\x01 \x01(\v2).google.cloud.aiplatform.v1beta1.ScheduleB\x03\xe0A\x02R\bschedule\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask2\xd0\v\n" +
	"\x0fScheduleService\x12\xcb\x01\n" +
	"\x0eCreateSchedule\x126.google.cloud.aiplatform.v1beta1.CreateScheduleRequest\x1a).google.cloud.aiplatform.v1beta1.Schedule\"V\xdaA\x0fparent,schedule\x82\xd3\xe4\x93\x02>:\bschedule\"2/v1beta1/{parent=projects/*/locations/*}/schedules\x12\xdd\x01\n" +
	...
	"\vGetSchedule\x123.google.cloud.aiplatform.v1beta1.GetScheduleRequest\x1a).google.cloud.aiplatform.v1beta1.Schedule\"A\xdaA\x04name\x82\xd3\xe4\x93\x024\x122/v1beta1/{name=projects/*/locations/*/schedules/*}\x12\xc3\x01\n" +
	...
	"\rPauseSchedule\x125.google.cloud.aiplatform.v1beta1.PauseScheduleRequest\x1a\x16.google.protobuf.Empty\"J\xdaA\x04name\x82\xd3\xe4\x93\x02=:\x01*\"8/v1beta1/{name=projects/*/locations/*/schedules/*}:pause\x12\xbd\x01\n" +
	"\x0eResumeSchedule\x126.google.cloud.aiplatform.v1beta1.ResumeScheduleRequest\x1a\x16.google.protobuf.Empty\"[\xdaA\x04name\xdaA\rname,catch_up\x82\xd3\xe4\x93\x02>:\x01*\"9/v1beta1/{name=projects/*/locations/*/schedules/*}:resume\x12\xd9\x01\n" +
	"\x0eUpdateSchedule\x126.google.cloud.aiplatform.v1beta1.UpdateScheduleRequest\x1a).google.cloud.aiplatform.v1beta1.Schedule\"d\xdaA\x14schedule,update_mask\x82\xd3\xe4\x93\x02G:\bschedule2;/v1beta1/{schedule.name=projects/*/locations/*/schedules/*}\x1aM\xcaA\x19aiplatform.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xeb\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_schedule_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_schedule_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_schedule_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_schedule_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_schedule_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_schedule_service_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_schedule_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_schedule_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_schedule_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
