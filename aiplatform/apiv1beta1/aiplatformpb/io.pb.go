...
const file_google_cloud_aiplatform_v1beta1_io_proto_rawDesc = "" +
	"\n" +
	"(google/cloud/aiplatform/v1beta1/io.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a.google/cloud/aiplatform/v1beta1/api_auth.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\\\n" +
	"\n" +
	"AvroSource\x12N\n" +
	"\n" +
	"gcs_source\x18\x01 \x01(\v2*.google.cloud.aiplatform.v1beta1.GcsSourceB\x03\xe0A\x02R\tgcsSource\"[\n" +
	"\tCsvSource\x12N\n" +
	"\n" +
	"gcs_source\x18\x01 \x01(\v2*.google.cloud.aiplatform.v1beta1.GcsSourceB\x03\xe0A\x02R\tgcsSource\"$\n" +
	"\tGcsSource\x12\x17\n" +
	...
	"!aiplatform.googleapis.com/DatasetR\vdatasetName\"\xba\x01\n" +
	"\"VertexMultimodalDatasetDestination\x12l\n" +
	"\x14bigquery_destination\x18\x01 \x01(\v24.google.cloud.aiplatform.v1beta1.BigQueryDestinationB\x03\xe0A\x01R\x13bigqueryDestination\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x01R\vdisplayName\"o\n" +
	"\x0eCsvDestination\x12]\n" +
	"\x0fgcs_destination\x18\x01 \x01(\v2/.google.cloud.aiplatform.v1beta1.GcsDestinationB\x03\xe0A\x02R\x0egcsDestination\"t\n" +
	"\x13TFRecordDestination\x12]\n" +
	"\x0fgcs_destination\x18\x01 \x01(\v2/.google.cloud.aiplatform.v1beta1.GcsDestinationB\x03\xe0A\x02R\x0egcsDestination\"B\n" +
	"\x1cContainerRegistryDestination\x12\"\n" +
	"\n" +
	"output_uri\x18\x01 \x01(\tB\x03\xe0A\x02R\toutputUri\"\x86\x03\n" +
	"\x11GoogleDriveSource\x12e\n" +
	"\fresource_ids\x18\x01 \x03(\v2=.google.cloud.aiplatform.v1beta1.GoogleDriveSource.ResourceIdB\x03\xe0A\x02R\vresourceIds\x1a\x89\x02\n" +
	"\n" +
	"ResourceId\x12t\n" +
	"\rresource_type\x18\x01 \x01(\x0e2J.google.cloud.aiplatform.v1beta1.GoogleDriveSource.ResourceId.ResourceTypeB\x03\xe0A\x02R\fresourceType\x12$\n" +
	...
	"\x12DirectUploadSource\"\xf9\x03\n" +
	"\vSlackSource\x12[\n" +
	"\bchannels\x18\x01 \x03(\v2:.google.cloud.aiplatform.v1beta1.SlackSource.SlackChannelsB\x03\xe0A\x02R\bchannels\x1a\x8c\x03\n" +
	"\rSlackChannels\x12h\n" +
	"\bchannels\x18\x01 \x03(\v2G.google.cloud.aiplatform.v1beta1.SlackSource.SlackChannels.SlackChannelB\x03\xe0A\x02R\bchannels\x12`\n" +
	"\x0eapi_key_config\x18\x03 \x01(\v25.google.cloud.aiplatform.v1beta1.ApiAuth.ApiKeyConfigB\x03\xe0A\x02R\fapiKeyConfig\x1a\xae\x01\n" +
	"\fSlackChannel\x12\"\n" +
	"\n" +
	...
	"\bend_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x01R\aendTime\"\xe1\x02\n" +
	"\n" +
	"JiraSource\x12_\n" +
	"\fjira_queries\x18\x01 \x03(\v27.google.cloud.aiplatform.v1beta1.JiraSource.JiraQueriesB\x03\xe0A\x02R\vjiraQueries\x1a\xf1\x01\n" +
	...
	"\x0eapi_key_config\x18\a \x01(\v25.google.cloud.aiplatform.v1beta1.ApiAuth.ApiKeyConfigB\x03\xe0A\x02R\fapiKeyConfig\"\xce\x04\n" +
	"\x11SharePointSources\x12s\n" +
	"\x13share_point_sources\x18\x01 \x03(\v2C.google.cloud.aiplatform.v1beta1.SharePointSources.SharePointSourceR\x11sharePointSources\x1a\xc3\x03\n" +
	...
	"\tclient_id\x18\x01 \x01(\tR\bclientId\x12Z\n" +
	"\rclient_secret\x18\x02 \x01(\v25.google.cloud.aiplatform.v1beta1.ApiAuth.ApiKeyConfigR\fclientSecret\x12\x1b\n" +
	...
	"\rfolder_sourceB\x0e\n" +
	"\fdrive_sourceB\xde\x01\n" +
	"#com.google.cloud.aiplatform.v1beta1B\aIoProtoP\x01ZCcloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb;aiplatformpb\xaa\x02\x1fGoogle.Cloud.AIPlatform.V1Beta1\xca\x02\x1fGoogle\\Cloud\\AIPlatform\\V1beta1\xea\x02\"Google::Cloud::AIPlatform::V1beta1b\x06proto3"

var (
	file_google_cloud_aiplatform_v1beta1_io_proto_rawDescOnce sync.Once
	file_google_cloud_aiplatform_v1beta1_io_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_io_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_io_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_io_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_io_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_io_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_io_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_io_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_io_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   21,
			NumExtensions: 0,
			NumServices:   0,
