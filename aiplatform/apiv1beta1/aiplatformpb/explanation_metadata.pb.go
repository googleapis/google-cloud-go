...
type ExplanationMetadata struct {
	...
	Inputs map[string]*ExplanationMetadata_InputMetadata `protobuf:"bytes,1,rep,name=inputs,proto3" json:"inputs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	Outputs map[string]*ExplanationMetadata_OutputMetadata `protobuf:"bytes,2,rep,name=outputs,proto3" json:"outputs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_google_cloud_aiplatform_v1beta1_explanation_metadata_proto_rawDesc = "" +
	"\n" +
	":google/cloud/aiplatform/v1beta1/explanation_metadata.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xf1\x16\n" +
	"\x13ExplanationMetadata\x12]\n" +
	"\x06inputs\x18\x01 \x03(\v2@.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputsEntryB\x03\xe0A\x02R\x06inputs\x12`\n" +
	"\aoutputs\x18\x02 \x03(\v2A.google.cloud.aiplatform.v1beta1.ExplanationMetadata.OutputsEntryB\x03\xe0A\x02R\aoutputs\x12E\n" +
	"\x1ffeature_attributions_schema_uri\x18\x03 \x01(\tR\x1cfeatureAttributionsSchemaUri\x12.\n" +
	"\x13latent_space_source\x18\x05 \x01(\tR\x11latentSpaceSource\x1a\xb6\x10\n" +
	"\rInputMetadata\x12?\n" +
	...
	"\bencoding\x18\x03 \x01(\x0e2K.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.EncodingR\bencoding\x12\x1a\n" +
	"\bmodality\x18\x04 \x01(\tR\bmodality\x12\x87\x01\n" +
	"\x14feature_value_domain\x18\x05 \x01(\v2U.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.FeatureValueDomainR\x12featureValueDomain\x12.\n" +
	...
	" \x03(\v2\x16.google.protobuf.ValueR\x10encodedBaselines\x12v\n" +
	"\rvisualization\x18\v \x01(\v2P.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.VisualizationR\rvisualization\x12\x1d\n" +
	"\n" +
	...
	"\x0foriginal_stddev\x18\x04 \x01(\x02R\x0eoriginalStddev\x1a\xbf\a\n" +
	"\rVisualization\x12i\n" +
	"\x04type\x18\x01 \x01(\x0e2U.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.TypeR\x04type\x12u\n" +
	"\bpolarity\x18\x02 \x01(\x0e2Y.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.PolarityR\bpolarity\x12v\n" +
	"\tcolor_map\x18\x03 \x01(\x0e2Y.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.ColorMapR\bcolorMap\x126\n" +
	"\x17clip_percent_upperbound\x18\x04 \x01(\x02R\x15clipPercentUpperbound\x126\n" +
	"\x17clip_percent_lowerbound\x18\x05 \x01(\x02R\x15clipPercentLowerbound\x12\x7f\n" +
	"\foverlay_type\x18\x06 \x01(\x0e2\\.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.OverlayTypeR\voverlayType\"6\n" +
	"\x04Type\x12\x14\n" +
	...
	"\x10CONCAT_EMBEDDING\x10\x06\x1a\xe8\x01\n" +
	...
	"\x18display_name_mapping_key\x18\x02 \x01(\tH\x00R\x15displayNameMappingKey\x12,\n" +
	"\x12output_tensor_name\x18\x03 \x01(\tR\x10outputTensorNameB\x16\n" +
	"\x14display_name_mapping\x1a}\n" +
	"\vInputsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12X\n" +
	"\x05value\x18\x02 \x01(\v2B.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadataR\x05value:\x028\x01\x1a\x7f\n" +
	"\fOutputsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12Y\n" +
	"\x05value\x18\x02 \x01(\v2C.google.cloud.aiplatform.v1beta1.ExplanationMetadata.OutputMetadataR\x05value:\x028\x01B\xef\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_explanation_metadata_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_explanation_metadata_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_explanation_metadata_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_explanation_metadata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_explanation_metadata_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_explanation_metadata_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1beta1_explanation_metadata_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1beta1_explanation_metadata_proto_init() {
	...
	file_google_cloud_aiplatform_v1beta1_explanation_metadata_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_explanation_metadata_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_explanation_metadata_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
