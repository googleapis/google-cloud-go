...
const file_google_cloud_aiplatform_v1beta1_deployment_resource_pool_service_proto_rawDesc = "" +
	...
	"#ListDeploymentResourcePoolsResponse\x12s\n" +
	"\x19deployment_resource_pools\x18\x01 \x03(\v27.google.cloud.aiplatform.v1beta1.DeploymentResourcePoolR\x17deploymentResourcePools\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xdf\x01\n" +
	"#UpdateDeploymentResourcePoolRequest\x12v\n" +
	"\x18deployment_resource_pool\x18\x01 \x01(\v27.google.cloud.aiplatform.v1beta1.DeploymentResourcePoolB\x03\xe0A\x02R\x16deploymentResourcePool\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"\x95\x01\n" +
	"-UpdateDeploymentResourcePoolOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata\"s\n" +
	...
	"\x1bQueryDeployedModelsResponse\x12[\n" +
	"\x0fdeployed_models\x18\x01 \x03(\v2..google.cloud.aiplatform.v1beta1.DeployedModelB\x02\x18\x01R\x0edeployedModels\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12a\n" +
	"\x13deployed_model_refs\x18\x03 \x03(\v21.google.cloud.aiplatform.v1beta1.DeployedModelRefR\x11deployedModelRefs\x12;\n" +
	"\x1atotal_deployed_model_count\x18\x04 \x01(\x05R\x17totalDeployedModelCount\x120\n" +
	"\x14total_endpoint_count\x18\x05 \x01(\x05R\x12totalEndpointCount2\xd4\x0e\n" +
	...
	"\x16DeploymentResourcePool\x12-CreateDeploymentResourcePoolOperationMetadata\xdaA;parent,deployment_resource_pool,deployment_resource_pool_id\x82\xd3\xe4\x93\x02E:\x01*\"@/v1beta1/{parent=projects/*/locations/*}/deploymentResourcePools\x12\xe8\x01\n" +
	...
	"\x16DeploymentResourcePool\x12-UpdateDeploymentResourcePoolOperationMetadata\xdaA$deployment_resource_pool,update_mask\x82\xd3\xe4\x93\x02u:\x18deployment_resource_pool2Y/v1beta1/{deployment_resource_pool.name=projects/*/locations/*/deploymentResourcePools/*}\x12\x88\x02\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_deployment_resource_pool_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_deployment_resource_pool_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_deployment_resource_pool_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_deployment_resource_pool_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_deployment_resource_pool_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_deployment_resource_pool_service_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_deployment_resource_pool_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_deployment_resource_pool_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_deployment_resource_pool_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
