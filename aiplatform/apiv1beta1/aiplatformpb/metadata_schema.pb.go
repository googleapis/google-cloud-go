...
func (x *MetadataSchema) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
var file_google_cloud_aiplatform_v1beta1_metadata_schema_proto_rawDesc = []byte{
	...
	0x61, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x49,
...
func file_google_cloud_aiplatform_v1beta1_metadata_schema_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_aiplatform_v1beta1_metadata_schema_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
