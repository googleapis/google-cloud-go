...
const file_google_cloud_aiplatform_v1beta1_feature_proto_rawDesc = "" +
	"\n" +
	"-google/cloud/aiplatform/v1beta1/feature.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a5google/cloud/aiplatform/v1beta1/feature_monitor.proto\x1a>google/cloud/aiplatform/v1beta1/feature_monitoring_stats.proto\x1a=google/cloud/aiplatform/v1beta1/featurestore_monitoring.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb8\x0e\n" +
	"\aFeature\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x05R\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12V\n" +
	"\n" +
	"value_type\x18\x03 \x01(\x0e22.google.cloud.aiplatform.v1beta1.Feature.ValueTypeB\x03\xe0A\x05R\tvalueType\x12@\n" +
	"\vcreate_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12@\n" +
	"\vupdate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12Q\n" +
	"\x06labels\x18\x06 \x03(\v24.google.cloud.aiplatform.v1beta1.Feature.LabelsEntryB\x03\xe0A\x01R\x06labels\x12\x12\n" +
	"\x04etag\x18\a \x01(\tR\x04etag\x12q\n" +
	"\x11monitoring_config\x18\t \x01(\v2=.google.cloud.aiplatform.v1beta1.FeaturestoreMonitoringConfigB\x05\xe0A\x01\x18\x01R\x10monitoringConfig\x122\n" +
	"\x12disable_monitoring\x18\f \x01(\bB\x03\xe0A\x01R\x11disableMonitoring\x12d\n" +
	"\x10monitoring_stats\x18\n" +
	" \x03(\v24.google.cloud.aiplatform.v1beta1.FeatureStatsAnomalyB\x03\xe0A\x03R\x0fmonitoringStats\x12\x82\x01\n" +
	"\x1amonitoring_stats_anomalies\x18\v \x03(\v2?.google.cloud.aiplatform.v1beta1.Feature.MonitoringStatsAnomalyB\x03\xe0A\x03R\x18monitoringStatsAnomalies\x12w\n" +
	"\x19feature_stats_and_anomaly\x18\r \x03(\v27.google.cloud.aiplatform.v1beta1.FeatureStatsAndAnomalyB\x03\xe0A\x03R\x16featureStatsAndAnomaly\x12.\n" +
	"\x13version_column_name\x18j \x01(\tR\x11versionColumnName\x12(\n" +
	"\x10point_of_contact\x18k \x01(\tR\x0epointOfContact\x1a\xd1\x02\n" +
	"\x16MonitoringStatsAnomaly\x12l\n" +
	"\tobjective\x18\x01 \x01(\x0e2I.google.cloud.aiplatform.v1beta1.Feature.MonitoringStatsAnomaly.ObjectiveB\x03\xe0A\x03R\tobjective\x12m\n" +
	"\x15feature_stats_anomaly\x18\x02 \x01(\v24.google.cloud.aiplatform.v1beta1.FeatureStatsAnomalyB\x03\xe0A\x03R\x13featureStatsAnomaly\"Z\n" +
	"\tObjective\x12\x19\n" +
	...
	"!aiplatform.googleapis.com/Feature\x12qprojects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entity_type}/features/{feature}\x12Xprojects/{project}/locations/{location}/featureGroups/{feature_group}/features/{feature}*\bfeatures2\afeatureB\xe3\x01\n" +
	"#com.google.cloud.aiplatform.v1beta1B\fFeatureProtoP\x01ZCcloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb;aiplatformpb\xaa\x02\x1fGoogle.Cloud.AIPlatform.V1Beta1\xca\x02\x1fGoogle\\Cloud\\AIPlatform\\V1beta1\xea\x02\"Google::Cloud::AIPlatform::V1beta1b\x06proto3"

var (
	file_google_cloud_aiplatform_v1beta1_feature_proto_rawDescOnce sync.Once
	file_google_cloud_aiplatform_v1beta1_feature_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_feature_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_feature_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_feature_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_feature_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_feature_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_feature_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_feature_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_feature_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
