...
const file_google_cloud_aiplatform_v1beta1_publisher_model_proto_rawDesc = "" +
	"\n" +
	"5google/cloud/aiplatform/v1beta1/publisher_model.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a7google/cloud/aiplatform/v1beta1/machine_resources.proto\x1a+google/cloud/aiplatform/v1beta1/model.proto\"\x9d/\n" +
	"\x0ePublisherModel\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12%\n" +
	"\n" +
	"version_id\x18\x02 \x01(\tB\x06\xe0A\x05\xe0A\x03R\tversionId\x12y\n" +
	"\x14open_source_category\x18\a \x01(\x0e2B.google.cloud.aiplatform.v1beta1.PublisherModel.OpenSourceCategoryB\x03\xe0A\x02R\x12openSourceCategory\x12S\n" +
	"\x06parent\x18\x0e \x01(\v26.google.cloud.aiplatform.v1beta1.PublisherModel.ParentB\x03\xe0A\x01R\x06parent\x12n\n" +
	"\x11supported_actions\x18\x13 \x01(\v2<.google.cloud.aiplatform.v1beta1.PublisherModel.CallToActionB\x03\xe0A\x01R\x10supportedActions\x12#\n" +
	"\n" +
	"frameworks\x18\x17 \x03(\tB\x03\xe0A\x01R\n" +
	"frameworks\x12c\n" +
	"\flaunch_stage\x18\x1d \x01(\x0e2;.google.cloud.aiplatform.v1beta1.PublisherModel.LaunchStageB\x03\xe0A\x01R\vlaunchStage\x12f\n" +
	"\rversion_state\x18% \x01(\x0e2<.google.cloud.aiplatform.v1beta1.PublisherModel.VersionStateB\x03\xe0A\x01R\fversionState\x12@\n" +
	"\x18publisher_model_template\x18\x1e \x01(\tB\x06\xe0A\x05\xe0A\x03R\x16publisherModelTemplate\x12`\n" +
	"\x10predict_schemata\x18\x1f \x01(\v20.google.cloud.aiplatform.v1beta1.PredictSchemataB\x03\xe0A\x01R\x0fpredictSchemata\x1a\xa4\x01\n" +
	...
	"\treference\x1a\x96\x01\n" +
	"\x06Parent\x12&\n" +
	"\fdisplay_name\x18\x01 \x01(\tB\x03\xe0A\x02R\vdisplayName\x12d\n" +
	"\treference\x18\x02 \x01(\v2A.google.cloud.aiplatform.v1beta1.PublisherModel.ResourceReferenceB\x03\xe0A\x01R\treference\x1aI\n" +
	"\rDocumentation\x12\x19\n" +
	"\x05title\x18\x01 \x01(\tB\x03\xe0A\x02R\x05title\x12\x1d\n" +
	"\acontent\x18\x02 \x01(\tB\x03\xe0A\x02R\acontent\x1a\xe0!\n" +
	"\fCallToAction\x12q\n" +
	"\rview_rest_api\x18\x01 \x01(\v2H.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.ViewRestApiB\x03\xe0A\x01R\vviewRestApi\x12\x81\x01\n" +
	"\ropen_notebook\x18\x02 \x01(\v2W.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.RegionalResourceReferencesB\x03\xe0A\x01R\fopenNotebook\x12{\n" +
	"\x0eopen_notebooks\x18\f \x01(\v2J.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.OpenNotebooksB\x03\xe0A\x01H\x00R\ropenNotebooks\x88\x01\x01\x12\x8b\x01\n" +
	"\x12create_application\x18\x03 \x01(\v2W.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.RegionalResourceReferencesB\x03\xe0A\x01R\x11createApplication\x12\x97\x01\n" +
	"\x19open_fine_tuning_pipeline\x18\x04 \x01(\v2W.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.RegionalResourceReferencesB\x03\xe0A\x01R\x16openFineTuningPipeline\x12\x9b\x01\n" +
	"\x1aopen_fine_tuning_pipelines\x18\r \x01(\v2T.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.OpenFineTuningPipelinesB\x03\xe0A\x01H\x01R\x17openFineTuningPipelines\x88\x01\x01\x12\x9b\x01\n" +
	"\x1bopen_prompt_tuning_pipeline\x18\x05 \x01(\v2W.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.RegionalResourceReferencesB\x03\xe0A\x01R\x18openPromptTuningPipeline\x12{\n" +
	"\n" +
	"open_genie\x18\x06 \x01(\v2W.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.RegionalResourceReferencesB\x03\xe0A\x01R\topenGenie\x12`\n" +
	"\x06deploy\x18\a \x01(\v2C.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.DeployB\x03\xe0A\x01R\x06deploy\x12~\n" +
	"\x13multi_deploy_vertex\x18\x10 \x01(\v2I.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.DeployVertexB\x03\xe0A\x01R\x11multiDeployVertex\x12j\n" +
	"\n" +
	"deploy_gke\x18\x0e \x01(\v2F.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.DeployGkeB\x03\xe0A\x01R\tdeployGke\x12\x97\x01\n" +
	"\x19open_generation_ai_studio\x18\b \x01(\v2W.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.RegionalResourceReferencesB\x03\xe0A\x01R\x16openGenerationAiStudio\x12\x83\x01\n" +
	"\x0erequest_access\x18\t \x01(\v2W.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.RegionalResourceReferencesB\x03\xe0A\x01R\rrequestAccess\x12\x96\x01\n" +
	"\x18open_evaluation_pipeline\x18\v \x01(\v2W.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.RegionalResourceReferencesB\x03\xe0A\x01R\x16openEvaluationPipeline\x1a\xaf\x04\n" +
	"\x1aRegionalResourceReferences\x12\x8c\x01\n" +
	"\n" +
	"references\x18\x01 \x03(\v2g.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.RegionalResourceReferences.ReferencesEntryB\x03\xe0A\x02R\n" +
	"references\x12\x19\n" +
	...
	"\x14resource_description\x18\x05 \x01(\tB\x03\xe0A\x01H\x02R\x13resourceDescription\x88\x01\x01\x1a\x80\x01\n" +
	"\x0fReferencesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12W\n" +
	"\x05value\x18\x02 \x01(\v2A.google.cloud.aiplatform.v1beta1.PublisherModel.ResourceReferenceR\x05value:\x028\x01B\x11\n" +
	"\x0f_resource_titleB\x14\n" +
	"\x12_resource_use_caseB\x17\n" +
	"\x15_resource_description\x1a\x94\x01\n" +
	"\vViewRestApi\x12j\n" +
	"\x0edocumentations\x18\x01 \x03(\v2=.google.cloud.aiplatform.v1beta1.PublisherModel.DocumentationB\x03\xe0A\x02R\x0edocumentations\x12\x19\n" +
	"\x05title\x18\x02 \x01(\tB\x03\xe0A\x02R\x05title\x1a\x8b\x01\n" +
	"\rOpenNotebooks\x12z\n" +
	"\tnotebooks\x18\x01 \x03(\v2W.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.RegionalResourceReferencesB\x03\xe0A\x02R\tnotebooks\x1a\xac\x01\n" +
	"\x17OpenFineTuningPipelines\x12\x90\x01\n" +
	"\x15fine_tuning_pipelines\x18\x01 \x03(\v2W.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.RegionalResourceReferencesB\x03\xe0A\x02R\x13fineTuningPipelines\x1a\x88\x01\n" +
	"\fDeployVertex\x12x\n" +
	"\x13multi_deploy_vertex\x18\x01 \x03(\v2C.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.DeployB\x03\xe0A\x01R\x11multiDeployVertex\x1a\xf4\b\n" +
	"\x06Deploy\x12f\n" +
	"\x13dedicated_resources\x18\x05 \x01(\v23.google.cloud.aiplatform.v1beta1.DedicatedResourcesH\x00R\x12dedicatedResources\x12f\n" +
	"\x13automatic_resources\x18\x06 \x01(\v23.google.cloud.aiplatform.v1beta1.AutomaticResourcesH\x00R\x12automaticResources\x12+\n" +
	"\x10shared_resources\x18\a \x01(\tH\x00R\x0fsharedResources\x121\n" +
	"\x12model_display_name\x18\x01 \x01(\tB\x03\xe0A\x01R\x10modelDisplayName\x12m\n" +
	"\x15large_model_reference\x18\x02 \x01(\v24.google.cloud.aiplatform.v1beta1.LargeModelReferenceB\x03\xe0A\x01R\x13largeModelReference\x12_\n" +
	"\x0econtainer_spec\x18\x03 \x01(\v23.google.cloud.aiplatform.v1beta1.ModelContainerSpecB\x03\xe0A\x01R\rcontainerSpec\x12&\n" +
	"\fartifact_uri\x18\x04 \x01(\tB\x03\xe0A\x01R\vartifactUri\x122\n" +
	"\x10deploy_task_name\x18\n" +
	" \x01(\tB\x03\xe0A\x01H\x01R\x0edeployTaskName\x88\x01\x01\x12\x85\x01\n" +
	"\x0fdeploy_metadata\x18\v \x01(\v2R.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.Deploy.DeployMetadataB\x03\xe0A\x01H\x02R\x0edeployMetadata\x88\x01\x01\x12\x19\n" +
	"\x05title\x18\b \x01(\tB\x03\xe0A\x02R\x05title\x123\n" +
	"\x13public_artifact_uri\x18\t \x01(\tB\x03\xe0A\x01R\x11publicArtifactUri\x1a\xf4\x01\n" +
	"\x0eDeployMetadata\x12{\n" +
	"\x06labels\x18\x01 \x03(\v2^.google.cloud.aiplatform.v1beta1.PublisherModel.CallToAction.Deploy.DeployMetadata.LabelsEntryB\x03\xe0A\x01R\x06labels\x12*\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_publisher_model_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_publisher_model_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_publisher_model_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_publisher_model_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_publisher_model_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_publisher_model_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_publisher_model_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_publisher_model_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_publisher_model_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   0,
