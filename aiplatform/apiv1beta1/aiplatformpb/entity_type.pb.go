...
const file_google_cloud_aiplatform_v1beta1_entity_type_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/aiplatform/v1beta1/entity_type.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a=google/cloud/aiplatform/v1beta1/featurestore_monitoring.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8a\x06\n" +
	"\n" +
	"EntityType\x12\x17\n" +
	...
	"updateTime\x12T\n" +
	"\x06labels\x18\x06 \x03(\v27.google.cloud.aiplatform.v1beta1.EntityType.LabelsEntryB\x03\xe0A\x01R\x06labels\x12\x17\n" +
	"\x04etag\x18\a \x01(\tB\x03\xe0A\x01R\x04etag\x12o\n" +
	"\x11monitoring_config\x18\b \x01(\v2=.google.cloud.aiplatform.v1beta1.FeaturestoreMonitoringConfigB\x03\xe0A\x01R\x10monitoringConfig\x12<\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_entity_type_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_entity_type_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_entity_type_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_entity_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_entity_type_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_entity_type_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_entity_type_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_entity_type_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_entity_type_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
