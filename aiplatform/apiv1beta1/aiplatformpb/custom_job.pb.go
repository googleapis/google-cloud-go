...
const file_google_cloud_aiplatform_v1beta1_custom_job_proto_rawDesc = "" +
	"\n" +
	"0google/cloud/aiplatform/v1beta1/custom_job.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a5google/cloud/aiplatform/v1beta1/encryption_spec.proto\x1a-google/cloud/aiplatform/v1beta1/env_var.proto\x1a(google/cloud/aiplatform/v1beta1/io.proto\x1a/google/cloud/aiplatform/v1beta1/job_state.proto\x1a7google/cloud/aiplatform/v1beta1/machine_resources.proto\x1a8google/cloud/aiplatform/v1beta1/service_networking.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\xe3\b\n" +
	"\tCustomJob\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x02R\vdisplayName\x12N\n" +
	"\bjob_spec\x18\x04 \x01(\v2..google.cloud.aiplatform.v1beta1.CustomJobSpecB\x03\xe0A\x02R\ajobSpec\x12D\n" +
	"\x05state\x18\x05 \x01(\x0e2).google.cloud.aiplatform.v1beta1.JobStateB\x03\xe0A\x03R\x05state\x12@\n" +
	...
	"updateTime\x12-\n" +
	"\x05error\x18\n" +
	" \x01(\v2\x12.google.rpc.StatusB\x03\xe0A\x03R\x05error\x12N\n" +
	"\x06labels\x18\v \x03(\v26.google.cloud.aiplatform.v1beta1.CustomJob.LabelsEntryR\x06labels\x12X\n" +
	"\x0fencryption_spec\x18\f \x01(\v2/.google.cloud.aiplatform.v1beta1.EncryptionSpecR\x0eencryptionSpec\x12j\n" +
	"\x0fweb_access_uris\x18\x10 \x03(\v2=.google.cloud.aiplatform.v1beta1.CustomJob.WebAccessUrisEntryB\x03\xe0A\x03R\rwebAccessUris\x12(\n" +
	...
	"#aiplatform.googleapis.com/CustomJob\x12?projects/{project}/locations/{location}/customJobs/{custom_job}\"\xfb\b\n" +
	"\rCustomJobSpec\x12j\n" +
	...
	"\x11worker_pool_specs\x18\x01 \x03(\v2/.google.cloud.aiplatform.v1beta1.WorkerPoolSpecB\x03\xe0A\x02R\x0fworkerPoolSpecs\x12K\n" +
	"\n" +
	"scheduling\x18\x03 \x01(\v2+.google.cloud.aiplatform.v1beta1.SchedulingR\n" +
	"scheduling\x12'\n" +
	...
	"\x12reserved_ip_ranges\x18\r \x03(\tB\x03\xe0A\x01R\x10reservedIpRanges\x12j\n" +
	"\x14psc_interface_config\x18\x15 \x01(\v23.google.cloud.aiplatform.v1beta1.PscInterfaceConfigB\x03\xe0A\x01R\x12pscInterfaceConfig\x12c\n" +
	"\x15base_output_directory\x18\x06 \x01(\v2/.google.cloud.aiplatform.v1beta1.GcsDestinationR\x13baseOutputDirectory\x12C\n" +
	...
	"\x1faiplatform.googleapis.com/ModelR\x06models\"\xc9\x04\n" +
	"\x0eWorkerPoolSpec\x12W\n" +
	"\x0econtainer_spec\x18\x06 \x01(\v2..google.cloud.aiplatform.v1beta1.ContainerSpecH\x00R\rcontainerSpec\x12d\n" +
	"\x13python_package_spec\x18\a \x01(\v22.google.cloud.aiplatform.v1beta1.PythonPackageSpecH\x00R\x11pythonPackageSpec\x12W\n" +
	"\fmachine_spec\x18\x01 \x01(\v2,.google.cloud.aiplatform.v1beta1.MachineSpecB\x06\xe0A\x01\xe0A\x05R\vmachineSpec\x12(\n" +
	"\rreplica_count\x18\x02 \x01(\x03B\x03\xe0A\x01R\freplicaCount\x12M\n" +
	"\n" +
	"nfs_mounts\x18\x04 \x03(\v2).google.cloud.aiplatform.v1beta1.NfsMountB\x03\xe0A\x01R\tnfsMounts\x12V\n" +
	"\rlustre_mounts\x18\t \x03(\v2,.google.cloud.aiplatform.v1beta1.LustreMountB\x03\xe0A\x01R\flustreMounts\x12F\n" +
	"\tdisk_spec\x18\x05 \x01(\v2).google.cloud.aiplatform.v1beta1.DiskSpecR\bdiskSpecB\x06\n" +
	"\x04task\"\x9a\x01\n" +
	"\rContainerSpec\x12 \n" +
	...
	"\x03env\x18\x04 \x03(\v2'.google.cloud.aiplatform.v1beta1.EnvVarR\x03env\"\xe7\x01\n" +
	...
	"\x03env\x18\x05 \x03(\v2'.google.cloud.aiplatform.v1beta1.EnvVarR\x03env\"\xc7\x03\n" +
	"\n" +
	"Scheduling\x123\n" +
	"\atimeout\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x12@\n" +
	"\x1drestart_job_on_worker_restart\x18\x03 \x01(\bR\x19restartJobOnWorkerRestart\x12U\n" +
	"\bstrategy\x18\x04 \x01(\x0e24.google.cloud.aiplatform.v1beta1.Scheduling.StrategyB\x03\xe0A\x01R\bstrategy\x12,\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_custom_job_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_custom_job_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_custom_job_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_custom_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_custom_job_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_custom_job_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_custom_job_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_custom_job_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_custom_job_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
