...
func file_google_cloud_aiplatform_v1beta1_model_monitoring_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_aiplatform_v1beta1_model_monitoring_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_aiplatform_v1beta1_model_monitoring_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_aiplatform_v1beta1_model_monitoring_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*ThresholdConfig_Value)(nil),
	}
	file_google_cloud_aiplatform_v1beta1_model_monitoring_proto_msgTypes[5].OneofWrappers = []interface{}{
	...
	file_google_cloud_aiplatform_v1beta1_model_monitoring_proto_msgTypes[13].OneofWrappers = []interface{}{
