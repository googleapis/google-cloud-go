...
func file_google_cloud_aiplatform_v1beta1_tensorboard_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_aiplatform_v1beta1_tensorboard_data_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1beta1_tensorboard_data_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1beta1_tensorboard_data_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Scalar); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_cloud_aiplatform_v1beta1_tensorboard_data_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1beta1_tensorboard_data_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1beta1_tensorboard_data_proto_msgTypes[5].Exporter = func(v any, i int) any {
