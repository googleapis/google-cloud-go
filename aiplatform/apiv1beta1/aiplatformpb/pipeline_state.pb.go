...
const file_google_cloud_aiplatform_v1beta1_pipeline_state_proto_rawDesc = "" +
	"\n" +
	...
	"\x15PIPELINE_STATE_PAUSED\x10\bB\xe9\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_pipeline_state_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_pipeline_state_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_pipeline_state_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_pipeline_state_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_pipeline_state_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_pipeline_state_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1beta1_pipeline_state_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1beta1_pipeline_state_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_pipeline_state_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_pipeline_state_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
