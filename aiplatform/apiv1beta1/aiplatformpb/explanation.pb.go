...
type ExplanationMetadataOverride struct {
	...
	// is not overridden.
	Inputs        map[string]*ExplanationMetadataOverride_InputMetadataOverride `protobuf:"bytes,1,rep,name=inputs,proto3" json:"inputs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_google_cloud_aiplatform_v1beta1_explanation_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/aiplatform/v1beta1/explanation.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a:google/cloud/aiplatform/v1beta1/explanation_metadata.proto\x1a(google/cloud/aiplatform/v1beta1/io.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xb2\x01\n" +
	"\vExplanation\x12U\n" +
	"\fattributions\x18\x01 \x03(\v2,.google.cloud.aiplatform.v1beta1.AttributionB\x03\xe0A\x03R\fattributions\x12L\n" +
	"\tneighbors\x18\x02 \x03(\v2).google.cloud.aiplatform.v1beta1.NeighborB\x03\xe0A\x03R\tneighbors\"r\n" +
	"\x10ModelExplanation\x12^\n" +
	"\x11mean_attributions\x18\x01 \x03(\v2,.google.cloud.aiplatform.v1beta1.AttributionB\x03\xe0A\x03R\x10meanAttributions\"\x88\x03\n" +
	"\vAttribution\x127\n" +
	"\x15baseline_output_value\x18\x01 \x01(\x01B\x03\xe0A\x03R\x13baselineOutputValue\x127\n" +
	"\x15instance_output_value\x18\x02 \x01(\x01B\x03\xe0A\x03R\x13instanceOutputValue\x12N\n" +
	"\x14feature_attributions\x18\x03 \x01(\v2\x16.google.protobuf.ValueB\x03\xe0A\x03R\x13featureAttributions\x12&\n" +
	"\foutput_index\x18\x04 \x03(\x05B\x03\xe0A\x03R\voutputIndex\x123\n" +
	"\x13output_display_name\x18\x05 \x01(\tB\x03\xe0A\x03R\x11outputDisplayName\x124\n" +
	"\x13approximation_error\x18\x06 \x01(\x01B\x03\xe0A\x03R\x12approximationError\x12$\n" +
	"\voutput_name\x18\a \x01(\tB\x03\xe0A\x03R\n" +
	"outputName\"b\n" +
	"\bNeighbor\x12$\n" +
	"\vneighbor_id\x18\x01 \x01(\tB\x03\xe0A\x03R\n" +
	"neighborId\x120\n" +
	"\x11neighbor_distance\x18\x02 \x01(\x01B\x03\xe0A\x03R\x10neighborDistance\"\xc5\x01\n" +
	"\x0fExplanationSpec\x12[\n" +
	"\n" +
	"parameters\x18\x01 \x01(\v26.google.cloud.aiplatform.v1beta1.ExplanationParametersB\x03\xe0A\x02R\n" +
	"parameters\x12U\n" +
	"\bmetadata\x18\x02 \x01(\v24.google.cloud.aiplatform.v1beta1.ExplanationMetadataB\x03\xe0A\x01R\bmetadata\"\xad\x04\n" +
	"\x15ExplanationParameters\x12|\n" +
	"\x1bsampled_shapley_attribution\x18\x01 \x01(\v2:.google.cloud.aiplatform.v1beta1.SampledShapleyAttributionH\x00R\x19sampledShapleyAttribution\x12\x8b\x01\n" +
	" integrated_gradients_attribution\x18\x02 \x01(\v2?.google.cloud.aiplatform.v1beta1.IntegratedGradientsAttributionH\x00R\x1eintegratedGradientsAttribution\x12]\n" +
	"\x10xrai_attribution\x18\x03 \x01(\v20.google.cloud.aiplatform.v1beta1.XraiAttributionH\x00R\x0fxraiAttribution\x12G\n" +
	"\bexamples\x18\a \x01(\v2).google.cloud.aiplatform.v1beta1.ExamplesH\x00R\bexamples\x12\x13\n" +
	"\x05top_k\x18\x04 \x01(\x05R\x04topK\x12A\n" +
	"\x0eoutput_indices\x18\x05 \x01(\v2\x1a.google.protobuf.ListValueR\routputIndicesB\b\n" +
	"\x06method\"?\n" +
	"\x19SampledShapleyAttribution\x12\"\n" +
	"\n" +
	"path_count\x18\x01 \x01(\x05B\x03\xe0A\x02R\tpathCount\"\x8c\x02\n" +
	"\x1eIntegratedGradientsAttribution\x12\"\n" +
	"\n" +
	"step_count\x18\x01 \x01(\x05B\x03\xe0A\x02R\tstepCount\x12_\n" +
	"\x12smooth_grad_config\x18\x02 \x01(\v21.google.cloud.aiplatform.v1beta1.SmoothGradConfigR\x10smoothGradConfig\x12e\n" +
	"\x14blur_baseline_config\x18\x03 \x01(\v23.google.cloud.aiplatform.v1beta1.BlurBaselineConfigR\x12blurBaselineConfig\"\xfd\x01\n" +
	"\x0fXraiAttribution\x12\"\n" +
	"\n" +
	"step_count\x18\x01 \x01(\x05B\x03\xe0A\x02R\tstepCount\x12_\n" +
	"\x12smooth_grad_config\x18\x02 \x01(\v21.google.cloud.aiplatform.v1beta1.SmoothGradConfigR\x10smoothGradConfig\x12e\n" +
	"\x14blur_baseline_config\x18\x03 \x01(\v23.google.cloud.aiplatform.v1beta1.BlurBaselineConfigR\x12blurBaselineConfig\"\xdf\x01\n" +
	"\x10SmoothGradConfig\x12!\n" +
	"\vnoise_sigma\x18\x01 \x01(\x02H\x00R\n" +
	"noiseSigma\x12d\n" +
	"\x13feature_noise_sigma\x18\x02 \x01(\v22.google.cloud.aiplatform.v1beta1.FeatureNoiseSigmaH\x00R\x11featureNoiseSigma\x12,\n" +
	"\x12noisy_sample_count\x18\x03 \x01(\x05R\x10noisySampleCountB\x14\n" +
	"\x12GradientNoiseSigma\"\xbf\x01\n" +
	"\x11FeatureNoiseSigma\x12h\n" +
	"\vnoise_sigma\x18\x01 \x03(\v2G.google.cloud.aiplatform.v1beta1.FeatureNoiseSigma.NoiseSigmaForFeatureR\n" +
	"noiseSigma\x1a@\n" +
	"\x14NoiseSigmaForFeature\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05sigma\x18\x02 \x01(\x02R\x05sigma\":\n" +
	"\x12BlurBaselineConfig\x12$\n" +
	"\x0emax_blur_sigma\x18\x01 \x01(\x02R\fmaxBlurSigma\"\x9f\x05\n" +
	"\bExamples\x12j\n" +
	"\x12example_gcs_source\x18\x05 \x01(\v2:.google.cloud.aiplatform.v1beta1.Examples.ExampleGcsSourceH\x00R\x10exampleGcsSource\x12]\n" +
	"\x1enearest_neighbor_search_config\x18\x02 \x01(\v2\x16.google.protobuf.ValueH\x01R\x1bnearestNeighborSearchConfig\x12D\n" +
	"\apresets\x18\x04 \x01(\v2(.google.cloud.aiplatform.v1beta1.PresetsH\x01R\apresets\x12I\n" +
	"\n" +
	"gcs_source\x18\x01 \x01(\v2*.google.cloud.aiplatform.v1beta1.GcsSourceR\tgcsSource\x12%\n" +
	"\x0eneighbor_count\x18\x03 \x01(\x05R\rneighborCount\x1a\xfb\x01\n" +
	"\x10ExampleGcsSource\x12f\n" +
	"\vdata_format\x18\x01 \x01(\x0e2E.google.cloud.aiplatform.v1beta1.Examples.ExampleGcsSource.DataFormatR\n" +
	"dataFormat\x12I\n" +
	"\n" +
	"gcs_source\x18\x02 \x01(\v2*.google.cloud.aiplatform.v1beta1.GcsSourceR\tgcsSource\"4\n" +
	"\n" +
	"DataFormat\x12\x1b\n" +
	...
	"\x06config\"\x95\x02\n" +
	"\aPresets\x12I\n" +
	"\x05query\x18\x01 \x01(\x0e2..google.cloud.aiplatform.v1beta1.Presets.QueryH\x00R\x05query\x88\x01\x01\x12M\n" +
	"\bmodality\x18\x02 \x01(\x0e21.google.cloud.aiplatform.v1beta1.Presets.ModalityR\bmodality\"\x1e\n" +
	"\x05Query\x12\v\n" +
	...
	"\aTABULAR\x10\x03B\b\n" +
	"\x06_query\"\xab\x02\n" +
	"\x17ExplanationSpecOverride\x12V\n" +
	"\n" +
	"parameters\x18\x01 \x01(\v26.google.cloud.aiplatform.v1beta1.ExplanationParametersR\n" +
	"parameters\x12X\n" +
	"\bmetadata\x18\x02 \x01(\v2<.google.cloud.aiplatform.v1beta1.ExplanationMetadataOverrideR\bmetadata\x12^\n" +
	"\x11examples_override\x18\x03 \x01(\v21.google.cloud.aiplatform.v1beta1.ExamplesOverrideR\x10examplesOverride\"\xee\x02\n" +
	"\x1bExplanationMetadataOverride\x12e\n" +
	"\x06inputs\x18\x01 \x03(\v2H.google.cloud.aiplatform.v1beta1.ExplanationMetadataOverride.InputsEntryB\x03\xe0A\x02R\x06inputs\x1aX\n" +
	"\x15InputMetadataOverride\x12?\n" +
	"\x0finput_baselines\x18\x01 \x03(\v2\x16.google.protobuf.ValueR\x0einputBaselines\x1a\x8d\x01\n" +
	"\vInputsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12h\n" +
	"\x05value\x18\x02 \x01(\v2R.google.cloud.aiplatform.v1beta1.ExplanationMetadataOverride.InputMetadataOverrideR\x05value:\x028\x01\"\x9a\x03\n" +
	"\x10ExamplesOverride\x12%\n" +
	"\x0eneighbor_count\x18\x01 \x01(\x05R\rneighborCount\x12%\n" +
	"\x0ecrowding_count\x18\x02 \x01(\x05R\rcrowdingCount\x12b\n" +
	"\frestrictions\x18\x03 \x03(\v2>.google.cloud.aiplatform.v1beta1.ExamplesRestrictionsNamespaceR\frestrictions\x12+\n" +
	"\x11return_embeddings\x18\x04 \x01(\bR\x10returnEmbeddings\x12]\n" +
	"\vdata_format\x18\x05 \x01(\x0e2<.google.cloud.aiplatform.v1beta1.ExamplesOverride.DataFormatR\n" +
	"dataFormat\"H\n" +
	"\n" +
	"DataFormat\x12\x1b\n" +
	"\x17DATA_FORMAT_UNSPECIFIED\x10\x00\x12\r\n" +
	...
	"\x04deny\x18\x03 \x03(\tR\x04denyB\xe7\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_explanation_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_explanation_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_explanation_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_explanation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_explanation_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_explanation_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1beta1_explanation_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1beta1_explanation_proto_init() {
	...
	file_google_cloud_aiplatform_v1beta1_explanation_proto_msgTypes[5].OneofWrappers = []any{
	...
	file_google_cloud_aiplatform_v1beta1_explanation_proto_msgTypes[9].OneofWrappers = []any{
		(*SmoothGradConfig_NoiseSigma)(nil),
		(*SmoothGradConfig_FeatureNoiseSigma)(nil),
	}
	file_google_cloud_aiplatform_v1beta1_explanation_proto_msgTypes[12].OneofWrappers = []any{
		(*Examples_ExampleGcsSource_)(nil),
		(*Examples_NearestNeighborSearchConfig)(nil),
		(*Examples_Presets)(nil),
	}
	file_google_cloud_aiplatform_v1beta1_explanation_proto_msgTypes[13].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_explanation_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_explanation_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   0,
