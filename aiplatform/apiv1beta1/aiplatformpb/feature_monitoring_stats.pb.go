...
func (x *FeatureStatsAnomaly) GetStartTime() *timestamp.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *FeatureStatsAnomaly) GetEndTime() *timestamp.Timestamp {
	if x != nil {
		return x.EndTime
	}
	return nil
...
var file_google_cloud_aiplatform_v1beta1_feature_monitoring_stats_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x42, 0xf8, 0x01, 0x0a, 0x23, 0x63, 0x6f, 0x6d, 0x2e,
	...
	0x6e, 0x67, 0x53, 0x74, 0x61, 0x74, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x49,
...
var file_google_cloud_aiplatform_v1beta1_feature_monitoring_stats_proto_goTypes = []interface{}{
...
func file_google_cloud_aiplatform_v1beta1_feature_monitoring_stats_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_aiplatform_v1beta1_feature_monitoring_stats_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
