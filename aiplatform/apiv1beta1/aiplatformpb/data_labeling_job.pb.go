...
type DataLabelingJob struct {
	...
	Inputs *_struct.Value `protobuf:"bytes,7,opt,name=inputs,proto3" json:"inputs,omitempty"`
...
func (x *DataLabelingJob) GetInputs() *_struct.Value {
	if x != nil {
		return x.Inputs
	}
	return nil
...
func (x *DataLabelingJob) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *DataLabelingJob) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
var file_google_cloud_aiplatform_v1beta1_data_labeling_job_proto_rawDesc = []byte{
	...
	0x4d, 0x69, 0x6c, 0x6c, 0x69, 0x48, 0x6f, 0x75, 0x72, 0x73, 0x42, 0xf1, 0x01, 0x0a, 0x23, 0x63,
