...
func file_google_cloud_aiplatform_v1beta1_feature_online_store_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_aiplatform_v1beta1_feature_online_store_service_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_aiplatform_v1beta1_feature_online_store_service_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_aiplatform_v1beta1_feature_online_store_service_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*NearestNeighborQuery_EntityId)(nil),
		(*NearestNeighborQuery_Embedding_)(nil),
	}
	file_google_cloud_aiplatform_v1beta1_feature_online_store_service_proto_msgTypes[11].OneofWrappers = []interface{}{
