...
const file_google_cloud_aiplatform_v1beta1_lineage_subgraph_proto_rawDesc = "" +
	"\n" +
	"6google/cloud/aiplatform/v1beta1/lineage_subgraph.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a.google/cloud/aiplatform/v1beta1/artifact.proto\x1a+google/cloud/aiplatform/v1beta1/event.proto\x1a/google/cloud/aiplatform/v1beta1/execution.proto\"\xe6\x01\n" +
	"\x0fLineageSubgraph\x12G\n" +
	"\tartifacts\x18\x01 \x03(\v2).google.cloud.aiplatform.v1beta1.ArtifactR\tartifacts\x12J\n" +
	"\n" +
	"executions\x18\x02 \x03(\v2*.google.cloud.aiplatform.v1beta1.ExecutionR\n" +
	"executions\x12>\n" +
	"\x06events\x18\x03 \x03(\v2&.google.cloud.aiplatform.v1beta1.EventR\x06eventsB\xeb\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_lineage_subgraph_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_lineage_subgraph_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_lineage_subgraph_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_lineage_subgraph_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_lineage_subgraph_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_lineage_subgraph_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1beta1_lineage_subgraph_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1beta1_lineage_subgraph_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_lineage_subgraph_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_lineage_subgraph_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
