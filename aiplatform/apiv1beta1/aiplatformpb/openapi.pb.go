...
const file_google_cloud_aiplatform_v1beta1_openapi_proto_rawDesc = "" +
	"\n" +
	"-google/cloud/aiplatform/v1beta1/openapi.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xc9\n" +
	"\n" +
	"\x06Schema\x12>\n" +
	"\x04type\x18\x01 \x01(\x0e2%.google.cloud.aiplatform.v1beta1.TypeB\x03\xe0A\x01R\x04type\x12\x1b\n" +
	...
	"\adefault\x18\x17 \x01(\v2\x16.google.protobuf.ValueB\x03\xe0A\x01R\adefault\x12B\n" +
	"\x05items\x18\x02 \x01(\v2'.google.cloud.aiplatform.v1beta1.SchemaB\x03\xe0A\x01R\x05items\x12 \n" +
	"\tmin_items\x18\x15 \x01(\x03B\x03\xe0A\x01R\bminItems\x12 \n" +
	"\tmax_items\x18\x16 \x01(\x03B\x03\xe0A\x01R\bmaxItems\x12\x17\n" +
	"\x04enum\x18\t \x03(\tB\x03\xe0A\x01R\x04enum\x12\\\n" +
	"\n" +
	"properties\x18\x03 \x03(\v27.google.cloud.aiplatform.v1beta1.Schema.PropertiesEntryB\x03\xe0A\x01R\n" +
	"properties\x120\n" +
	...
	"\aexample\x18\x04 \x01(\v2\x16.google.protobuf.ValueB\x03\xe0A\x01R\aexample\x12C\n" +
	"\x06any_of\x18\v \x03(\v2'.google.cloud.aiplatform.v1beta1.SchemaB\x03\xe0A\x01R\x05anyOf\x12P\n" +
	"\x15additional_properties\x18\x1a \x01(\v2\x16.google.protobuf.ValueB\x03\xe0A\x01R\x14additionalProperties\x12\x15\n" +
	"\x03ref\x18\x1b \x01(\tB\x03\xe0A\x01R\x03ref\x12J\n" +
	"\x04defs\x18\x1c \x03(\v21.google.cloud.aiplatform.v1beta1.Schema.DefsEntryB\x03\xe0A\x01R\x04defs\x1af\n" +
	"\x0fPropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12=\n" +
	"\x05value\x18\x02 \x01(\v2'.google.cloud.aiplatform.v1beta1.SchemaR\x05value:\x028\x01\x1a`\n" +
	"\tDefsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12=\n" +
	"\x05value\x18\x02 \x01(\v2'.google.cloud.aiplatform.v1beta1.SchemaR\x05value:\x028\x01*e\n" +
	"\x04Type\x12\x14\n" +
	...
	"#com.google.cloud.aiplatform.v1beta1B\fOpenApiProtoP\x01ZCcloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb;aiplatformpb\xaa\x02\x1fGoogle.Cloud.AIPlatform.V1Beta1\xca\x02\x1fGoogle\\Cloud\\AIPlatform\\V1beta1\xea\x02\"Google::Cloud::AIPlatform::V1beta1b\x06proto3"

var (
	file_google_cloud_aiplatform_v1beta1_openapi_proto_rawDescOnce sync.Once
	file_google_cloud_aiplatform_v1beta1_openapi_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_openapi_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_openapi_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_openapi_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_openapi_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_openapi_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_openapi_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_openapi_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_openapi_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
