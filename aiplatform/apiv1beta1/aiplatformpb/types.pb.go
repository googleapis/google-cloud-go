...
const file_google_cloud_aiplatform_v1beta1_types_proto_rawDesc = "" +
	"\n" +
	"+google/cloud/aiplatform/v1beta1/types.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\"#\n" +
	"\tBoolArray\x12\x16\n" +
	...
	"\x06values\x18\x01 \x03(\tR\x06values\"\xb9\x06\n" +
	"\x06Tensor\x12F\n" +
	"\x05dtype\x18\x01 \x01(\x0e20.google.cloud.aiplatform.v1beta1.Tensor.DataTypeR\x05dtype\x12\x14\n" +
	...
	"\n" +
	"uint64_val\x18\n" +
	" \x03(\x04R\tuint64Val\x12B\n" +
	"\blist_val\x18\v \x03(\v2'.google.cloud.aiplatform.v1beta1.TensorR\alistVal\x12U\n" +
	"\n" +
	"struct_val\x18\f \x03(\v26.google.cloud.aiplatform.v1beta1.Tensor.StructValEntryR\tstructVal\x12\x1d\n" +
	"\n" +
	"tensor_val\x18\r \x01(\fR\ttensorVal\x1ae\n" +
	"\x0eStructValEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12=\n" +
	"\x05value\x18\x02 \x01(\v2'.google.cloud.aiplatform.v1beta1.TensorR\x05value:\x028\x01\"\xac\x01\n" +
	"\bDataType\x12\x19\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_types_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_types_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_types_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_types_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_types_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_types_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1beta1_types_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1beta1_types_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_types_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_types_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
