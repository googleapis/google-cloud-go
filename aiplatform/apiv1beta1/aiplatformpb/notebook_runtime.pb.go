...
const file_google_cloud_aiplatform_v1beta1_notebook_runtime_proto_rawDesc = "" +
	"\n" +
	"6google/cloud/aiplatform/v1beta1/notebook_runtime.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a5google/cloud/aiplatform/v1beta1/encryption_spec.proto\x1a7google/cloud/aiplatform/v1beta1/machine_resources.proto\x1a2google/cloud/aiplatform/v1beta1/network_spec.proto\x1a9google/cloud/aiplatform/v1beta1/notebook_euc_config.proto\x1aCgoogle/cloud/aiplatform/v1beta1/notebook_idle_shutdown_config.proto\x1aCgoogle/cloud/aiplatform/v1beta1/notebook_runtime_template_ref.proto\x1a>google/cloud/aiplatform/v1beta1/notebook_software_config.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbd\f\n" +
	"\x17NotebookRuntimeTemplate\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x02R\vdisplayName\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12$\n" +
	"\n" +
	"is_default\x18\x04 \x01(\bB\x05\xe0A\x03\x18\x01R\tisDefault\x12W\n" +
	"\fmachine_spec\x18\x05 \x01(\v2,.google.cloud.aiplatform.v1beta1.MachineSpecB\x06\xe0A\x01\xe0A\x05R\vmachineSpec\x12s\n" +
	"\x19data_persistent_disk_spec\x18\b \x01(\v23.google.cloud.aiplatform.v1beta1.PersistentDiskSpecB\x03\xe0A\x01R\x16dataPersistentDiskSpec\x12T\n" +
	"\fnetwork_spec\x18\f \x01(\v2,.google.cloud.aiplatform.v1beta1.NetworkSpecB\x03\xe0A\x01R\vnetworkSpec\x12+\n" +
	"\x0fservice_account\x18\r \x01(\tB\x02\x18\x01R\x0eserviceAccount\x12\x12\n" +
	"\x04etag\x18\x0e \x01(\tR\x04etag\x12\\\n" +
	"\x06labels\x18\x0f \x03(\v2D.google.cloud.aiplatform.v1beta1.NotebookRuntimeTemplate.LabelsEntryR\x06labels\x12m\n" +
	"\x14idle_shutdown_config\x18\x11 \x01(\v2;.google.cloud.aiplatform.v1beta1.NotebookIdleShutdownConfigR\x12idleShutdownConfig\x12Q\n" +
	"\n" +
	"euc_config\x18\x12 \x01(\v22.google.cloud.aiplatform.v1beta1.NotebookEucConfigR\teucConfig\x12@\n" +
	"\vcreate_time\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12@\n" +
	"\vupdate_time\x18\v \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12p\n" +
	"\x15notebook_runtime_type\x18\x13 \x01(\x0e24.google.cloud.aiplatform.v1beta1.NotebookRuntimeTypeB\x06\xe0A\x01\xe0A\x05R\x13notebookRuntimeType\x12g\n" +
	"\x12shielded_vm_config\x18\x14 \x01(\v21.google.cloud.aiplatform.v1beta1.ShieldedVmConfigB\x06\xe0A\x01\xe0A\x05R\x10shieldedVmConfig\x12&\n" +
	"\fnetwork_tags\x18\x15 \x03(\tB\x03\xe0A\x01R\vnetworkTags\x12X\n" +
	"\x0fencryption_spec\x18\x17 \x01(\v2/.google.cloud.aiplatform.v1beta1.EncryptionSpecR\x0eencryptionSpec\x12e\n" +
	"\x0fsoftware_config\x18\x18 \x01(\v27.google.cloud.aiplatform.v1beta1.NotebookSoftwareConfigB\x03\xe0A\x01R\x0esoftwareConfig\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\x95\x01\xeaA\x91\x01\n" +
	"1aiplatform.googleapis.com/NotebookRuntimeTemplate\x12\\projects/{project}/locations/{location}/notebookRuntimeTemplates/{notebook_runtime_template}\"\xcf\x12\n" +
	"\x0fNotebookRuntime\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12&\n" +
	"\fruntime_user\x18\x02 \x01(\tB\x03\xe0A\x02R\vruntimeUser\x12\x83\x01\n" +
	"\x1dnotebook_runtime_template_ref\x18\x03 \x01(\v2;.google.cloud.aiplatform.v1beta1.NotebookRuntimeTemplateRefB\x03\xe0A\x03R\x1anotebookRuntimeTemplateRef\x12 \n" +
	...
	"updateTime\x12d\n" +
	"\fhealth_state\x18\b \x01(\x0e2<.google.cloud.aiplatform.v1beta1.NotebookRuntime.HealthStateB\x03\xe0A\x03R\vhealthState\x12&\n" +
	"\fdisplay_name\x18\n" +
	" \x01(\tB\x03\xe0A\x02R\vdisplayName\x12 \n" +
	"\vdescription\x18\v \x01(\tR\vdescription\x12,\n" +
	"\x0fservice_account\x18\r \x01(\tB\x03\xe0A\x03R\x0eserviceAccount\x12g\n" +
	"\rruntime_state\x18\x0e \x01(\x0e2=.google.cloud.aiplatform.v1beta1.NotebookRuntime.RuntimeStateB\x03\xe0A\x03R\fruntimeState\x12(\n" +
	"\ris_upgradable\x18\x0f \x01(\bB\x03\xe0A\x03R\fisUpgradable\x12T\n" +
	"\x06labels\x18\x10 \x03(\v2<.google.cloud.aiplatform.v1beta1.NotebookRuntime.LabelsEntryR\x06labels\x12H\n" +
	"\x0fexpiration_time\x18\x11 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\x0eexpirationTime\x12\x1d\n" +
	"\aversion\x18\x12 \x01(\tB\x03\xe0A\x03R\aversion\x12m\n" +
	"\x15notebook_runtime_type\x18\x13 \x01(\x0e24.google.cloud.aiplatform.v1beta1.NotebookRuntimeTypeB\x03\xe0A\x03R\x13notebookRuntimeType\x12T\n" +
	"\fmachine_spec\x18\x14 \x01(\v2,.google.cloud.aiplatform.v1beta1.MachineSpecB\x03\xe0A\x03R\vmachineSpec\x12s\n" +
	"\x19data_persistent_disk_spec\x18\x15 \x01(\v23.google.cloud.aiplatform.v1beta1.PersistentDiskSpecB\x03\xe0A\x03R\x16dataPersistentDiskSpec\x12T\n" +
	"\fnetwork_spec\x18\x16 \x01(\v2,.google.cloud.aiplatform.v1beta1.NetworkSpecB\x03\xe0A\x03R\vnetworkSpec\x12r\n" +
	"\x14idle_shutdown_config\x18\x17 \x01(\v2;.google.cloud.aiplatform.v1beta1.NotebookIdleShutdownConfigB\x03\xe0A\x03R\x12idleShutdownConfig\x12V\n" +
	"\n" +
	"euc_config\x18\x18 \x01(\v22.google.cloud.aiplatform.v1beta1.NotebookEucConfigB\x03\xe0A\x03R\teucConfig\x12d\n" +
	"\x12shielded_vm_config\x18  \x01(\v21.google.cloud.aiplatform.v1beta1.ShieldedVmConfigB\x03\xe0A\x03R\x10shieldedVmConfig\x12&\n" +
	"\fnetwork_tags\x18\x19 \x03(\tB\x03\xe0A\x01R\vnetworkTags\x12e\n" +
	"\x0fsoftware_config\x18\x1f \x01(\v27.google.cloud.aiplatform.v1beta1.NotebookSoftwareConfigB\x03\xe0A\x03R\x0esoftwareConfig\x12]\n" +
	"\x0fencryption_spec\x18\x1c \x01(\v2/.google.cloud.aiplatform.v1beta1.EncryptionSpecB\x03\xe0A\x03R\x0eencryptionSpec\x12(\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_notebook_runtime_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_notebook_runtime_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_notebook_runtime_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_notebook_runtime_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_notebook_runtime_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_notebook_runtime_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_notebook_runtime_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_notebook_runtime_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_notebook_runtime_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
