...
const file_google_cloud_aiplatform_v1beta1_feature_online_store_admin_service_proto_rawDesc = "" +
	...
	"\x1fListFeatureOnlineStoresResponse\x12g\n" +
	"\x15feature_online_stores\x18\x01 \x03(\v23.google.cloud.aiplatform.v1beta1.FeatureOnlineStoreR\x13featureOnlineStores\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xca\x01\n" +
	"\x1fUpdateFeatureOnlineStoreRequest\x12j\n" +
	"\x14feature_online_store\x18\x01 \x01(\v23.google.cloud.aiplatform.v1beta1.FeatureOnlineStoreB\x03\xe0A\x02R\x12featureOnlineStore\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"\x81\x01\n" +
	"\x1fDeleteFeatureOnlineStoreRequest\x12H\n" +
	"\x04name\x18\x01 \x01(\tB4\xe0A\x02\xfaA.\n" +
	",aiplatform.googleapis.com/FeatureOnlineStoreR\x04name\x12\x14\n" +
	"\x05force\x18\x02 \x01(\bR\x05force\"\xa2\x02\n" +
	"\x18CreateFeatureViewRequest\x12L\n" +
	"\x06parent\x18\x01 \x01(\tB4\xe0A\x02\xfaA.\n" +
	",aiplatform.googleapis.com/FeatureOnlineStoreR\x06parent\x12T\n" +
	"\ffeature_view\x18\x02 \x01(\v2,.google.cloud.aiplatform.v1beta1.FeatureViewB\x03\xe0A\x02R\vfeatureView\x12+\n" +
	...
	"\n" +
	"page_token\x18\x04 \x01(\tR\tpageToken\x12\x19\n" +
	"\border_by\x18\x05 \x01(\tR\aorderBy\"\x95\x01\n" +
	"\x18ListFeatureViewsResponse\x12Q\n" +
	"\rfeature_views\x18\x01 \x03(\v2,.google.cloud.aiplatform.v1beta1.FeatureViewR\ffeatureViews\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xad\x01\n" +
	"\x18UpdateFeatureViewRequest\x12T\n" +
	"\ffeature_view\x18\x01 \x01(\v2,.google.cloud.aiplatform.v1beta1.FeatureViewB\x03\xe0A\x02R\vfeatureView\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"]\n" +
	"\x18DeleteFeatureViewRequest\x12A\n" +
	"\x04name\x18\x01 \x01(\tB-\xe0A\x02\xfaA'\n" +
	"%aiplatform.googleapis.com/FeatureViewR\x04name\"\x91\x01\n" +
	")CreateFeatureOnlineStoreOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata\"\x91\x01\n" +
	")UpdateFeatureOnlineStoreOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata\"\x8a\x01\n" +
	"\"CreateFeatureViewOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata\"\x8a\x01\n" +
	"\"UpdateFeatureViewOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata\"j\n" +
	...
	"\x1cListFeatureViewSyncsResponse\x12^\n" +
	"\x12feature_view_syncs\x18\x01 \x03(\v20.google.cloud.aiplatform.v1beta1.FeatureViewSyncR\x10featureViewSyncs\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken2\xf6\x1b\n" +
	...
	"\x12FeatureOnlineStore\x12)CreateFeatureOnlineStoreOperationMetadata\xdaA3parent,feature_online_store,feature_online_store_id\x82\xd3\xe4\x93\x02T:\x14feature_online_store\"</v1beta1/{parent=projects/*/locations/*}/featureOnlineStores\x12\xd8\x01\n" +
	...
	"\x12FeatureOnlineStore\x12)UpdateFeatureOnlineStoreOperationMetadata\xdaA feature_online_store,update_mask\x82\xd3\xe4\x93\x02i:\x14feature_online_store2Q/v1beta1/{feature_online_store.name=projects/*/locations/*/featureOnlineStores/*}\x12\x82\x02\n" +
	...
	"\vFeatureView\x12\"CreateFeatureViewOperationMetadata\xdaA#parent,feature_view,feature_view_id\x82\xd3\xe4\x93\x02[:\ffeature_view\"K/v1beta1/{parent=projects/*/locations/*/featureOnlineStores/*}/featureViews\x12\xd2\x01\n" +
	...
	"\vFeatureView\x12\"UpdateFeatureViewOperationMetadata\xdaA\x18feature_view,update_mask\x82\xd3\xe4\x93\x02h:\ffeature_view2X/v1beta1/{feature_view.name=projects/*/locations/*/featureOnlineStores/*/featureViews/*}\x12\xfd\x01\n" +
	...
	"\x0fSyncFeatureView\x127.google.cloud.aiplatform.v1beta1.SyncFeatureViewRequest\x1a8.google.cloud.aiplatform.v1beta1.SyncFeatureViewResponse\"r\xdaA\ffeature_view\x82\xd3\xe4\x93\x02]:\x01*\"X/v1beta1/{feature_view=projects/*/locations/*/featureOnlineStores/*/featureViews/*}:sync\x12\xf1\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_feature_online_store_admin_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_feature_online_store_admin_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_feature_online_store_admin_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_feature_online_store_admin_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_feature_online_store_admin_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_feature_online_store_admin_service_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_feature_online_store_admin_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_feature_online_store_admin_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_feature_online_store_admin_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   21,
			NumExtensions: 0,
			NumServices:   1,
