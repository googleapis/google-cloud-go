...
const file_google_cloud_aiplatform_v1beta1_index_endpoint_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x0eindex_endpoint\x18\x02 \x01(\v2..google.cloud.aiplatform.v1beta1.IndexEndpointB\x03\xe0A\x02R\rindexEndpoint\"\x8c\x01\n" +
	"$CreateIndexEndpointOperationMetadata\x12d\n" +
	...
	"\tread_mask\x18\x05 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x01R\breadMask\"\x9d\x01\n" +
	"\x1aListIndexEndpointsResponse\x12W\n" +
	"\x0findex_endpoints\x18\x01 \x03(\v2..google.cloud.aiplatform.v1beta1.IndexEndpointR\x0eindexEndpoints\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xba\x01\n" +
	"\x1aUpdateIndexEndpointRequest\x12Z\n" +
	"\x0eindex_endpoint\x18\x01 \x01(\v2..google.cloud.aiplatform.v1beta1.IndexEndpointB\x03\xe0A\x02R\rindexEndpoint\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"a\n" +
	"\x1aDeleteIndexEndpointRequest\x12C\n" +
	"\x04name\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'aiplatform.googleapis.com/IndexEndpointR\x04name\"\xc8\x01\n" +
	"\x12DeployIndexRequest\x12V\n" +
	"\x0eindex_endpoint\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'aiplatform.googleapis.com/IndexEndpointR\rindexEndpoint\x12Z\n" +
	"\x0edeployed_index\x18\x02 \x01(\v2..google.cloud.aiplatform.v1beta1.DeployedIndexB\x03\xe0A\x02R\rdeployedIndex\"l\n" +
	"\x13DeployIndexResponse\x12U\n" +
	"\x0edeployed_index\x18\x01 \x01(\v2..google.cloud.aiplatform.v1beta1.DeployedIndexR\rdeployedIndex\"\xb0\x01\n" +
	"\x1cDeployIndexOperationMetadata\x12d\n" +
	...
	"\x1eUndeployIndexOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata\"\xd0\x01\n" +
	"\x1aMutateDeployedIndexRequest\x12V\n" +
	"\x0eindex_endpoint\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'aiplatform.googleapis.com/IndexEndpointR\rindexEndpoint\x12Z\n" +
	"\x0edeployed_index\x18\x02 \x01(\v2..google.cloud.aiplatform.v1beta1.DeployedIndexB\x03\xe0A\x02R\rdeployedIndex\"t\n" +
	"\x1bMutateDeployedIndexResponse\x12U\n" +
	"\x0edeployed_index\x18\x01 \x01(\v2..google.cloud.aiplatform.v1beta1.DeployedIndexR\rdeployedIndex\"\xb8\x01\n" +
	"$MutateDeployedIndexOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata\x12*\n" +
	"\x11deployed_index_id\x18\x02 \x01(\tR\x0fdeployedIndexId2\x8e\x11\n" +
	...
	"\rIndexEndpoint\x12$CreateIndexEndpointOperationMetadata\xdaA\x15parent,index_endpoint\x82\xd3\xe4\x93\x02I:\x0eindex_endpoint\"7/v1beta1/{parent=projects/*/locations/*}/indexEndpoints\x12\xc4\x01\n" +
	...
	"\x13UpdateIndexEndpoint\x12;.google.cloud.aiplatform.v1beta1.UpdateIndexEndpointRequest\x1a..google.cloud.aiplatform.v1beta1.IndexEndpoint\"{\xdaA\x1aindex_endpoint,update_mask\x82\xd3\xe4\x93\x02X:\x0eindex_endpoint2F/v1beta1/{index_endpoint.name=projects/*/locations/*/indexEndpoints/*}\x12\xec\x01\n" +
	...
	"\vDeployIndex\x123.google.cloud.aiplatform.v1beta1.DeployIndexRequest\x1a\x1d.google.longrunning.Operation\"\xae\x01\xcaA3\n" +
	"\x13DeployIndexResponse\x12\x1cDeployIndexOperationMetadata\xdaA\x1dindex_endpoint,deployed_index\x82\xd3\xe4\x93\x02R:\x01*\"M/v1beta1/{index_endpoint=projects/*/locations/*/indexEndpoints/*}:deployIndex\x12\x9f\x02\n" +
	...
	"\x15UndeployIndexResponse\x12\x1eUndeployIndexOperationMetadata\xdaA index_endpoint,deployed_index_id\x82\xd3\xe4\x93\x02T:\x01*\"O/v1beta1/{index_endpoint=projects/*/locations/*/indexEndpoints/*}:undeployIndex\x12\xc7\x02\n" +
	...
	"\x1bMutateDeployedIndexResponse\x12$MutateDeployedIndexOperationMetadata\xdaA\x1dindex_endpoint,deployed_index\x82\xd3\xe4\x93\x02g:\x0edeployed_index\"U/v1beta1/{index_endpoint=projects/*/locations/*/indexEndpoints/*}:mutateDeployedIndex\x1aM\xcaA\x19aiplatform.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xf0\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_index_endpoint_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_index_endpoint_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_index_endpoint_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_index_endpoint_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_index_endpoint_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_index_endpoint_service_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_index_endpoint_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_index_endpoint_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_index_endpoint_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   1,
