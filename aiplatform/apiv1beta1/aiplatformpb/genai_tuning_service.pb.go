...
func file_google_cloud_aiplatform_v1beta1_genai_tuning_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_aiplatform_v1beta1_genai_tuning_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_google_cloud_aiplatform_v1beta1_genai_tuning_service_proto_msgTypes[6].Exporter = func(v any, i int) any {
...
func (c *genAiTuningServiceClient) RebaseTunedModel(ctx context.Context, in *RebaseTunedModelRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	...
	err := c.cc.Invoke(ctx, "/google.cloud.aiplatform.v1beta1.GenAiTuningService/RebaseTunedModel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GenAiTuningService_RebaseTunedModel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.cloud.aiplatform.v1beta1.GenAiTuningService/RebaseTunedModel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
