...
const file_google_cloud_aiplatform_v1beta1_notebook_execution_job_proto_rawDesc = "" +
	"\n" +
	"<google/cloud/aiplatform/v1beta1/notebook_execution_job.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a5google/cloud/aiplatform/v1beta1/encryption_spec.proto\x1a/google/cloud/aiplatform/v1beta1/job_state.proto\x1a7google/cloud/aiplatform/v1beta1/machine_resources.proto\x1a2google/cloud/aiplatform/v1beta1/network_spec.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\x82\x14\n" +
	"\x14NotebookExecutionJob\x12\x8e\x01\n" +
	"\x1adataform_repository_source\x18\x03 \x01(\v2N.google.cloud.aiplatform.v1beta1.NotebookExecutionJob.DataformRepositorySourceH\x00R\x18dataformRepositorySource\x12y\n" +
	"\x13gcs_notebook_source\x18\x04 \x01(\v2G.google.cloud.aiplatform.v1beta1.NotebookExecutionJob.GcsNotebookSourceH\x00R\x11gcsNotebookSource\x12\x82\x01\n" +
	"\x16direct_notebook_source\x18\x11 \x01(\v2J.google.cloud.aiplatform.v1beta1.NotebookExecutionJob.DirectNotebookSourceH\x00R\x14directNotebookSource\x12\x8e\x01\n" +
	"'notebook_runtime_template_resource_name\x18\x0e \x01(\tB6\xfaA3\n" +
	"1aiplatform.googleapis.com/NotebookRuntimeTemplateH\x01R#notebookRuntimeTemplateResourceName\x12\x85\x01\n" +
	"\x17custom_environment_spec\x18\x10 \x01(\v2K.google.cloud.aiplatform.v1beta1.NotebookExecutionJob.CustomEnvironmentSpecH\x01R\x15customEnvironmentSpec\x12&\n" +
	"\x0egcs_output_uri\x18\b \x01(\tH\x02R\fgcsOutputUri\x12'\n" +
	"\x0eexecution_user\x18\t \x01(\tH\x03R\rexecutionUser\x12)\n" +
	"\x0fservice_account\x18\x12 \x01(\tH\x03R\x0eserviceAccount\x12u\n" +
	"\x11workbench_runtime\x18\x17 \x01(\v2F.google.cloud.aiplatform.v1beta1.NotebookExecutionJob.WorkbenchRuntimeH\x04R\x10workbenchRuntime\x12\x17\n" +
	...
	"\"aiplatform.googleapis.com/ScheduleR\x14scheduleResourceName\x12K\n" +
	"\tjob_state\x18\n" +
	" \x01(\x0e2).google.cloud.aiplatform.v1beta1.JobStateB\x03\xe0A\x03R\bjobState\x12/\n" +
	...
	"updateTime\x12Y\n" +
	"\x06labels\x18\x13 \x03(\v2A.google.cloud.aiplatform.v1beta1.NotebookExecutionJob.LabelsEntryR\x06labels\x12\x1f\n" +
	"\vkernel_name\x18\x14 \x01(\tR\n" +
	"kernelName\x12X\n" +
	"\x0fencryption_spec\x18\x16 \x01(\v2/.google.cloud.aiplatform.v1beta1.EncryptionSpecR\x0eencryptionSpec\x1a\x84\x01\n" +
	...
	"\acontent\x18\x01 \x01(\fR\acontent\x1a\xa0\x02\n" +
	"\x15CustomEnvironmentSpec\x12O\n" +
	"\fmachine_spec\x18\x01 \x01(\v2,.google.cloud.aiplatform.v1beta1.MachineSpecR\vmachineSpec\x12e\n" +
	"\x14persistent_disk_spec\x18\x02 \x01(\v23.google.cloud.aiplatform.v1beta1.PersistentDiskSpecR\x12persistentDiskSpec\x12O\n" +
	"\fnetwork_spec\x18\x03 \x01(\v2,.google.cloud.aiplatform.v1beta1.NetworkSpecR\vnetworkSpec\x1a\x12\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_notebook_execution_job_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_notebook_execution_job_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_notebook_execution_job_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_notebook_execution_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_notebook_execution_job_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_notebook_execution_job_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_notebook_execution_job_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_notebook_execution_job_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_notebook_execution_job_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
