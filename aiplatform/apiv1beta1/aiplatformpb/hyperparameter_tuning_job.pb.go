...
const file_google_cloud_aiplatform_v1beta1_hyperparameter_tuning_job_proto_rawDesc = "" +
	"\n" +
	"?google/cloud/aiplatform/v1beta1/hyperparameter_tuning_job.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a0google/cloud/aiplatform/v1beta1/custom_job.proto\x1a5google/cloud/aiplatform/v1beta1/encryption_spec.proto\x1a/google/cloud/aiplatform/v1beta1/job_state.proto\x1a+google/cloud/aiplatform/v1beta1/study.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\xb7\n" +
	"\n" +
	"\x17HyperparameterTuningJob\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x02R\vdisplayName\x12N\n" +
	"\n" +
	"study_spec\x18\x04 \x01(\v2*.google.cloud.aiplatform.v1beta1.StudySpecB\x03\xe0A\x02R\tstudySpec\x12+\n" +
	...
	"\x16max_failed_trial_count\x18\a \x01(\x05R\x13maxFailedTrialCount\x12Y\n" +
	"\x0etrial_job_spec\x18\b \x01(\v2..google.cloud.aiplatform.v1beta1.CustomJobSpecB\x03\xe0A\x02R\ftrialJobSpec\x12C\n" +
	"\x06trials\x18\t \x03(\v2&.google.cloud.aiplatform.v1beta1.TrialB\x03\xe0A\x03R\x06trials\x12D\n" +
	"\x05state\x18\n" +
	" \x01(\x0e2).google.cloud.aiplatform.v1beta1.JobStateB\x03\xe0A\x03R\x05state\x12@\n" +
	...
	"updateTime\x12-\n" +
	"\x05error\x18\x0f \x01(\v2\x12.google.rpc.StatusB\x03\xe0A\x03R\x05error\x12\\\n" +
	"\x06labels\x18\x10 \x03(\v2D.google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.LabelsEntryR\x06labels\x12X\n" +
	"\x0fencryption_spec\x18\x11 \x01(\v2/.google.cloud.aiplatform.v1beta1.EncryptionSpecR\x0eencryptionSpec\x12(\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_hyperparameter_tuning_job_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_hyperparameter_tuning_job_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_hyperparameter_tuning_job_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_hyperparameter_tuning_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_hyperparameter_tuning_job_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_hyperparameter_tuning_job_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1beta1_hyperparameter_tuning_job_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1beta1_hyperparameter_tuning_job_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_hyperparameter_tuning_job_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_hyperparameter_tuning_job_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
