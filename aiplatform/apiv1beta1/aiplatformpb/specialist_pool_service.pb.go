...
const file_google_cloud_aiplatform_v1beta1_specialist_pool_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x0fspecialist_pool\x18\x02 \x01(\v2/.google.cloud.aiplatform.v1beta1.SpecialistPoolB\x03\xe0A\x02R\x0especialistPool\"\x8d\x01\n" +
	"%CreateSpecialistPoolOperationMetadata\x12d\n" +
	...
	"\tread_mask\x18\x04 \x01(\v2\x1a.google.protobuf.FieldMaskR\breadMask\"\xa1\x01\n" +
	"\x1bListSpecialistPoolsResponse\x12Z\n" +
	"\x10specialist_pools\x18\x01 \x03(\v2/.google.cloud.aiplatform.v1beta1.SpecialistPoolR\x0fspecialistPools\x12&\n" +
	...
	"\x0fspecialist_pool\x18\x01 \x01(\v2/.google.cloud.aiplatform.v1beta1.SpecialistPoolB\x03\xe0A\x02R\x0especialistPool\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"\xe8\x01\n" +
	"%UpdateSpecialistPoolOperationMetadata\x12Y\n" +
	"\x0fspecialist_pool\x18\x01 \x01(\tB0\xe0A\x03\xfaA*\n" +
	"(aiplatform.googleapis.com/SpecialistPoolR\x0especialistPool\x12d\n" +
	"\x10generic_metadata\x18\x02 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata2\xd0\n" +
	"\n" +
	...
	"\x0eSpecialistPool\x12%CreateSpecialistPoolOperationMetadata\xdaA\x16parent,specialist_pool\x82\xd3\xe4\x93\x02K:\x0fspecialist_pool\"8/v1beta1/{parent=projects/*/locations/*}/specialistPools\x12\xc8\x01\n" +
	...
	"\x0eSpecialistPool\x12%UpdateSpecialistPoolOperationMetadata\xdaA\x1bspecialist_pool,update_mask\x82\xd3\xe4\x93\x02[:\x0fspecialist_pool2H/v1beta1/{specialist_pool.name=projects/*/locations/*/specialistPools/*}\x1aM\xcaA\x19aiplatform.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xf1\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_specialist_pool_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_specialist_pool_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_specialist_pool_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_specialist_pool_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_specialist_pool_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_specialist_pool_service_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1beta1_specialist_pool_service_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1beta1_specialist_pool_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_specialist_pool_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_specialist_pool_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
