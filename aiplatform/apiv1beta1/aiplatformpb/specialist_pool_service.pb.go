...
func (x *ListSpecialistPoolsRequest) GetReadMask() *field_mask.FieldMask {
	if x != nil {
		return x.ReadMask
	}
	return nil
...
func (x *UpdateSpecialistPoolRequest) GetUpdateMask() *field_mask.FieldMask {
	if x != nil {
		return x.UpdateMask
	}
	return nil
...
var file_google_cloud_aiplatform_v1beta1_specialist_pool_service_proto_rawDesc = []byte{
	...
	0x75, 0x64, 0x2d, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x42, 0xf7, 0x01, 0x0a, 0x23,
