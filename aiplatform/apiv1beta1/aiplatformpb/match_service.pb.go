...
const file_google_cloud_aiplatform_v1beta1_match_service_proto_rawDesc = "" +
	"\n" +
	"3google/cloud/aiplatform/v1beta1/match_service.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a+google/cloud/aiplatform/v1beta1/index.proto\"\x94\x06\n" +
	...
	"\x11deployed_index_id\x18\x02 \x01(\tR\x0fdeployedIndexId\x12U\n" +
	"\aqueries\x18\x03 \x03(\v2;.google.cloud.aiplatform.v1beta1.FindNeighborsRequest.QueryR\aqueries\x122\n" +
	"\x15return_full_datapoint\x18\x04 \x01(\bR\x13returnFullDatapoint\x1a\xec\x03\n" +
	"\x05Query\x12X\n" +
	"\x03rrf\x18\x06 \x01(\v2?.google.cloud.aiplatform.v1beta1.FindNeighborsRequest.Query.RRFB\x03\xe0A\x01H\x00R\x03rrf\x12R\n" +
	"\tdatapoint\x18\x01 \x01(\v2/.google.cloud.aiplatform.v1beta1.IndexDatapointB\x03\xe0A\x02R\tdatapoint\x12%\n" +
	...
	"\aranking\"\xb2\x03\n" +
	"\x15FindNeighborsResponse\x12t\n" +
	"\x11nearest_neighbors\x18\x01 \x03(\v2G.google.cloud.aiplatform.v1beta1.FindNeighborsResponse.NearestNeighborsR\x10nearestNeighbors\x1a\x9e\x01\n" +
	"\bNeighbor\x12M\n" +
	"\tdatapoint\x18\x01 \x01(\v2/.google.cloud.aiplatform.v1beta1.IndexDatapointR\tdatapoint\x12\x1a\n" +
	"\bdistance\x18\x02 \x01(\x01R\bdistance\x12'\n" +
	"\x0fsparse_distance\x18\x03 \x01(\x01R\x0esparseDistance\x1a\x81\x01\n" +
	"\x10NearestNeighbors\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12]\n" +
	"\tneighbors\x18\x02 \x03(\v2?.google.cloud.aiplatform.v1beta1.FindNeighborsResponse.NeighborR\tneighbors\"\xb2\x01\n" +
	"\x1aReadIndexDatapointsRequest\x12V\n" +
	"\x0eindex_endpoint\x18\x01 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'aiplatform.googleapis.com/IndexEndpointR\rindexEndpoint\x12*\n" +
	"\x11deployed_index_id\x18\x02 \x01(\tR\x0fdeployedIndexId\x12\x10\n" +
	"\x03ids\x18\x03 \x03(\tR\x03ids\"n\n" +
	"\x1bReadIndexDatapointsResponse\x12O\n" +
	"\n" +
	"datapoints\x18\x01 \x03(\v2/.google.cloud.aiplatform.v1beta1.IndexDatapointR\n" +
	"datapoints2\xaf\x04\n" +
	"\fMatchService\x12\xda\x01\n" +
	"\rFindNeighbors\x125.google.cloud.aiplatform.v1beta1.FindNeighborsRequest\x1a6.google.cloud.aiplatform.v1beta1.FindNeighborsResponse\"Z\x82\xd3\xe4\x93\x02T:\x01*\"O/v1beta1/{index_endpoint=projects/*/locations/*/indexEndpoints/*}:findNeighbors\x12\xf2\x01\n" +
	"\x13ReadIndexDatapoints\x12;.google.cloud.aiplatform.v1beta1.ReadIndexDatapointsRequest\x1a<.google.cloud.aiplatform.v1beta1.ReadIndexDatapointsResponse\"`\x82\xd3\xe4\x93\x02Z:\x01*\"U/v1beta1/{index_endpoint=projects/*/locations/*/indexEndpoints/*}:readIndexDatapoints\x1aM\xcaA\x19aiplatform.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xe8\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_match_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_match_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_match_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_match_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_match_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_match_service_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_match_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_match_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_match_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
