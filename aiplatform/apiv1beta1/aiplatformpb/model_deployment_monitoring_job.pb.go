...
const file_google_cloud_aiplatform_v1beta1_model_deployment_monitoring_job_proto_rawDesc = "" +
	...
	"\x05state\x18\x04 \x01(\x0e2).google.cloud.aiplatform.v1beta1.JobStateB\x03\xe0A\x03R\x05state\x12\x81\x01\n" +
	"\x0eschedule_state\x18\x05 \x01(\x0e2U.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob.MonitoringScheduleStateB\x03\xe0A\x03R\rscheduleState\x12\xb2\x01\n" +
	"#latest_monitoring_pipeline_metadata\x18\x19 \x01(\v2^.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob.LatestMonitoringPipelineMetadataB\x03\xe0A\x03R latestMonitoringPipelineMetadata\x12\xb0\x01\n" +
	"-model_deployment_monitoring_objective_configs\x18\x06 \x03(\v2I.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringObjectiveConfigB\x03\xe0A\x02R)modelDeploymentMonitoringObjectiveConfigs\x12\xab\x01\n" +
	"+model_deployment_monitoring_schedule_config\x18\a \x01(\v2H.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringScheduleConfigB\x03\xe0A\x02R'modelDeploymentMonitoringScheduleConfig\x12r\n" +
	"\x19logging_sampling_strategy\x18\b \x01(\v21.google.cloud.aiplatform.v1beta1.SamplingStrategyB\x03\xe0A\x02R\x17loggingSamplingStrategy\x12~\n" +
	"\x1dmodel_monitoring_alert_config\x18\x0f \x01(\v2;.google.cloud.aiplatform.v1beta1.ModelMonitoringAlertConfigR\x1amodelMonitoringAlertConfig\x12=\n" +
	...
	"\x1canalysis_instance_schema_uri\x18\x10 \x01(\tR\x19analysisInstanceSchemaUri\x12u\n" +
	"\x0fbigquery_tables\x18\n" +
	" \x03(\v2G.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringBigQueryTableB\x03\xe0A\x03R\x0ebigqueryTables\x122\n" +
	"\alog_ttl\x18\x11 \x01(\v2\x19.google.protobuf.DurationR\x06logTtl\x12a\n" +
	"\x06labels\x18\v \x03(\v2I.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob.LabelsEntryR\x06labels\x12@\n" +
	...
	"updateTime\x12M\n" +
	"\x12next_schedule_time\x18\x0e \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\x10nextScheduleTime\x12t\n" +
	"\x1estats_anomalies_base_directory\x18\x14 \x01(\v2/.google.cloud.aiplatform.v1beta1.GcsDestinationR\x1bstatsAnomaliesBaseDirectory\x12X\n" +
	"\x0fencryption_spec\x18\x15 \x01(\v2/.google.cloud.aiplatform.v1beta1.EncryptionSpecR\x0eencryptionSpec\x12E\n" +
	...
	"6aiplatform.googleapis.com/ModelDeploymentMonitoringJob\x12gprojects/{project}/locations/{location}/modelDeploymentMonitoringJobs/{model_deployment_monitoring_job}\"\x94\x04\n" +
	"&ModelDeploymentMonitoringBigQueryTable\x12p\n" +
	"\n" +
	"log_source\x18\x01 \x01(\x0e2Q.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringBigQueryTable.LogSourceR\tlogSource\x12j\n" +
	"\blog_type\x18\x02 \x01(\x0e2O.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringBigQueryTable.LogTypeR\alogType\x12.\n" +
	...
	"\aEXPLAIN\x10\x02\"\xc2\x01\n" +
	"(ModelDeploymentMonitoringObjectiveConfig\x12*\n" +
	"\x11deployed_model_id\x18\x01 \x01(\tR\x0fdeployedModelId\x12j\n" +
	"\x10objective_config\x18\x02 \x01(\v2?.google.cloud.aiplatform.v1beta1.ModelMonitoringObjectiveConfigR\x0fobjectiveConfig\"\xb6\x01\n" +
	...
	"\x0emonitor_window\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\rmonitorWindow\"\xbd\x05\n" +
	"\x1dModelMonitoringStatsAnomalies\x12e\n" +
	"\tobjective\x18\x01 \x01(\x0e2G.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringObjectiveTypeR\tobjective\x12*\n" +
	"\x11deployed_model_id\x18\x02 \x01(\tR\x0fdeployedModelId\x12#\n" +
	"\ranomaly_count\x18\x03 \x01(\x05R\fanomalyCount\x12\x81\x01\n" +
	"\rfeature_stats\x18\x04 \x03(\v2\\.google.cloud.aiplatform.v1beta1.ModelMonitoringStatsAnomalies.FeatureHistoricStatsAnomaliesR\ffeatureStats\x1a\xdf\x02\n" +
	"\x1dFeatureHistoricStatsAnomalies\x120\n" +
	"\x14feature_display_name\x18\x01 \x01(\tR\x12featureDisplayName\x12N\n" +
	"\tthreshold\x18\x03 \x01(\v20.google.cloud.aiplatform.v1beta1.ThresholdConfigR\tthreshold\x12[\n" +
	"\x0etraining_stats\x18\x04 \x01(\v24.google.cloud.aiplatform.v1beta1.FeatureStatsAnomalyR\rtrainingStats\x12_\n" +
	"\x10prediction_stats\x18\x05 \x03(\v24.google.cloud.aiplatform.v1beta1.FeatureStatsAnomalyR\x0fpredictionStats*\xce\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_model_deployment_monitoring_job_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_model_deployment_monitoring_job_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_model_deployment_monitoring_job_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_model_deployment_monitoring_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_model_deployment_monitoring_job_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_model_deployment_monitoring_job_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_model_deployment_monitoring_job_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_model_deployment_monitoring_job_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_model_deployment_monitoring_job_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
