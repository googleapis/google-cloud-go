...
const file_google_cloud_aiplatform_v1beta1_evaluated_annotation_proto_rawDesc = "" +
	"\n" +
	":google/cloud/aiplatform/v1beta1/evaluated_annotation.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a1google/cloud/aiplatform/v1beta1/explanation.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xe7\x05\n" +
	"\x13EvaluatedAnnotation\x12e\n" +
	"\x04type\x18\x01 \x01(\x0e2L.google.cloud.aiplatform.v1beta1.EvaluatedAnnotation.EvaluatedAnnotationTypeB\x03\xe0A\x03R\x04type\x12=\n" +
	...
	"\x1bevaluated_data_item_view_id\x18\x06 \x01(\tB\x03\xe0A\x03R\x17evaluatedDataItemViewId\x12c\n" +
	"\fexplanations\x18\b \x03(\v2?.google.cloud.aiplatform.v1beta1.EvaluatedAnnotationExplanationR\fexplanations\x12v\n" +
	"\x1aerror_analysis_annotations\x18\t \x03(\v28.google.cloud.aiplatform.v1beta1.ErrorAnalysisAnnotationR\x18errorAnalysisAnnotations\"\x7f\n" +
	...
	"\x0eFALSE_NEGATIVE\x10\x03\"\x9b\x01\n" +
	"\x1eEvaluatedAnnotationExplanation\x12)\n" +
	"\x10explanation_type\x18\x01 \x01(\tR\x0fexplanationType\x12N\n" +
	"\vexplanation\x18\x02 \x01(\v2,.google.cloud.aiplatform.v1beta1.ExplanationR\vexplanation\"\x97\x04\n" +
	"\x17ErrorAnalysisAnnotation\x12r\n" +
	"\x10attributed_items\x18\x01 \x03(\v2G.google.cloud.aiplatform.v1beta1.ErrorAnalysisAnnotation.AttributedItemR\x0fattributedItems\x12a\n" +
	"\n" +
	"query_type\x18\x02 \x01(\x0e2B.google.cloud.aiplatform.v1beta1.ErrorAnalysisAnnotation.QueryTypeR\tqueryType\x12#\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_evaluated_annotation_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_evaluated_annotation_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_evaluated_annotation_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_evaluated_annotation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_evaluated_annotation_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_evaluated_annotation_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1beta1_evaluated_annotation_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1beta1_evaluated_annotation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_evaluated_annotation_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_evaluated_annotation_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
