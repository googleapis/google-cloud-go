...
const file_google_cloud_aiplatform_v1beta1_accelerator_type_proto_rawDesc = "" +
	"\n" +
	...
	"TPU_V4_POD\x10\n" +
	"\x12\x12\n" +
	"\x0eTPU_V5_LITEPOD\x10\fB\xeb\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_accelerator_type_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_accelerator_type_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_accelerator_type_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_accelerator_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_accelerator_type_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_accelerator_type_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_accelerator_type_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_accelerator_type_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_accelerator_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
