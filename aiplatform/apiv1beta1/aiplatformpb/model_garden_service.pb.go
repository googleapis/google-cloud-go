...
func file_google_cloud_aiplatform_v1beta1_model_garden_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_aiplatform_v1beta1_model_garden_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_aiplatform_v1beta1_model_garden_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
