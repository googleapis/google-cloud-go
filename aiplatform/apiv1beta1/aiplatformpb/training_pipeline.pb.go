...
func (x *InputDataConfig) GetFractionSplit() *FractionSplit {
	if x != nil {
		if x, ok := x.Split.(*InputDataConfig_FractionSplit); ok {
...
func (x *InputDataConfig) GetFilterSplit() *FilterSplit {
	if x != nil {
		if x, ok := x.Split.(*InputDataConfig_FilterSplit); ok {
...
func (x *InputDataConfig) GetPredefinedSplit() *PredefinedSplit {
	if x != nil {
		if x, ok := x.Split.(*InputDataConfig_PredefinedSplit); ok {
...
func (x *InputDataConfig) GetTimestampSplit() *TimestampSplit {
	if x != nil {
		if x, ok := x.Split.(*InputDataConfig_TimestampSplit); ok {
...
func (x *InputDataConfig) GetStratifiedSplit() *StratifiedSplit {
	if x != nil {
		if x, ok := x.Split.(*InputDataConfig_StratifiedSplit); ok {
...
func (x *InputDataConfig) GetGcsDestination() *GcsDestination {
	if x != nil {
		if x, ok := x.Destination.(*InputDataConfig_GcsDestination); ok {
...
func (x *InputDataConfig) GetBigqueryDestination() *BigQueryDestination {
	if x != nil {
		if x, ok := x.Destination.(*InputDataConfig_BigqueryDestination); ok {
...
const file_google_cloud_aiplatform_v1beta1_training_pipeline_proto_rawDesc = "" +
	"\n" +
	"7google/cloud/aiplatform/v1beta1/training_pipeline.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a5google/cloud/aiplatform/v1beta1/encryption_spec.proto\x1a(google/cloud/aiplatform/v1beta1/io.proto\x1a+google/cloud/aiplatform/v1beta1/model.proto\x1a4google/cloud/aiplatform/v1beta1/pipeline_state.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\x90\n" +
	"\n" +
	"\x10TrainingPipeline\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x02R\vdisplayName\x12\\\n" +
	"\x11input_data_config\x18\x03 \x01(\v20.google.cloud.aiplatform.v1beta1.InputDataConfigR\x0finputDataConfig\x12=\n" +
	"\x18training_task_definition\x18\x04 \x01(\tB\x03\xe0A\x02R\x16trainingTaskDefinition\x12M\n" +
	"\x14training_task_inputs\x18\x05 \x01(\v2\x16.google.protobuf.ValueB\x03\xe0A\x02R\x12trainingTaskInputs\x12Q\n" +
	"\x16training_task_metadata\x18\x06 \x01(\v2\x16.google.protobuf.ValueB\x03\xe0A\x03R\x14trainingTaskMetadata\x12N\n" +
	"\x0fmodel_to_upload\x18\a \x01(\v2&.google.cloud.aiplatform.v1beta1.ModelR\rmodelToUpload\x12\x1e\n" +
	"\bmodel_id\x18\x16 \x01(\tB\x03\xe0A\x01R\amodelId\x12&\n" +
	"\fparent_model\x18\x15 \x01(\tB\x03\xe0A\x01R\vparentModel\x12I\n" +
	"\x05state\x18\t \x01(\x0e2..google.cloud.aiplatform.v1beta1.PipelineStateB\x03\xe0A\x03R\x05state\x12-\n" +
	"\x05error\x18\n" +
	" \x01(\v2\x12.google.rpc.StatusB\x03\xe0A\x03R\x05error\x12@\n" +
	...
	"updateTime\x12U\n" +
	"\x06labels\x18\x0f \x03(\v2=.google.cloud.aiplatform.v1beta1.TrainingPipeline.LabelsEntryR\x06labels\x12X\n" +
	"\x0fencryption_spec\x18\x12 \x01(\v2/.google.cloud.aiplatform.v1beta1.EncryptionSpecR\x0eencryptionSpec\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:~\xeaA{\n" +
	"*aiplatform.googleapis.com/TrainingPipeline\x12Mprojects/{project}/locations/{location}/trainingPipelines/{training_pipeline}\"\x9e\a\n" +
	"\x0fInputDataConfig\x12W\n" +
	"\x0efraction_split\x18\x02 \x01(\v2..google.cloud.aiplatform.v1beta1.FractionSplitH\x00R\rfractionSplit\x12Q\n" +
	"\ffilter_split\x18\x03 \x01(\v2,.google.cloud.aiplatform.v1beta1.FilterSplitH\x00R\vfilterSplit\x12]\n" +
	"\x10predefined_split\x18\x04 \x01(\v20.google.cloud.aiplatform.v1beta1.PredefinedSplitH\x00R\x0fpredefinedSplit\x12Z\n" +
	"\x0ftimestamp_split\x18\x05 \x01(\v2/.google.cloud.aiplatform.v1beta1.TimestampSplitH\x00R\x0etimestampSplit\x12]\n" +
	"\x10stratified_split\x18\f \x01(\v20.google.cloud.aiplatform.v1beta1.StratifiedSplitH\x00R\x0fstratifiedSplit\x12Z\n" +
	"\x0fgcs_destination\x18\b \x01(\v2/.google.cloud.aiplatform.v1beta1.GcsDestinationH\x01R\x0egcsDestination\x12i\n" +
	"\x14bigquery_destination\x18\n" +
	" \x01(\v24.google.cloud.aiplatform.v1beta1.BigQueryDestinationH\x01R\x13bigqueryDestination\x12\"\n" +
	"\n" +
	"dataset_id\x18\x01 \x01(\tB\x03\xe0A\x02R\tdatasetId\x12-\n" +
	"\x12annotations_filter\x18\x06 \x01(\tR\x11annotationsFilter\x122\n" +
	"\x15annotation_schema_uri\x18\t \x01(\tR\x13annotationSchemaUri\x12$\n" +
	"\x0esaved_query_id\x18\a \x01(\tR\fsavedQueryId\x129\n" +
	"\x19persist_ml_use_assignment\x18\v \x01(\bR\x16persistMlUseAssignmentB\a\n" +
	"\x05splitB\r\n" +
	...
	"\rtest_fraction\x18\x03 \x01(\x01R\ftestFraction\"\x93\x01\n" +
	"\vFilterSplit\x12,\n" +
	...
	"testFilter\"(\n" +
	"\x0fPredefinedSplit\x12\x15\n" +
	"\x03key\x18\x01 \x01(\tB\x03\xe0A\x02R\x03key\"\xaa\x01\n" +
	"\x0eTimestampSplit\x12+\n" +
	"\x11training_fraction\x18\x01 \x01(\x01R\x10trainingFraction\x12/\n" +
	"\x13validation_fraction\x18\x02 \x01(\x01R\x12validationFraction\x12#\n" +
	"\rtest_fraction\x18\x03 \x01(\x01R\ftestFraction\x12\x15\n" +
	"\x03key\x18\x04 \x01(\tB\x03\xe0A\x02R\x03key\"\xab\x01\n" +
	"\x0fStratifiedSplit\x12+\n" +
	"\x11training_fraction\x18\x01 \x01(\x01R\x10trainingFraction\x12/\n" +
	"\x13validation_fraction\x18\x02 \x01(\x01R\x12validationFraction\x12#\n" +
	"\rtest_fraction\x18\x03 \x01(\x01R\ftestFraction\x12\x15\n" +
	"\x03key\x18\x04 \x01(\tB\x03\xe0A\x02R\x03keyB\xec\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_training_pipeline_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_training_pipeline_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_training_pipeline_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_training_pipeline_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_training_pipeline_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_training_pipeline_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_training_pipeline_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_training_pipeline_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_training_pipeline_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
