...
const file_google_cloud_aiplatform_v1beta1_reasoning_engine_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x10reasoning_engine\x18\x02 \x01(\v20.google.cloud.aiplatform.v1beta1.ReasoningEngineB\x03\xe0A\x02R\x0freasoningEngine\"\x8e\x01\n" +
	"&CreateReasoningEngineOperationMetadata\x12d\n" +
	...
	")aiplatform.googleapis.com/ReasoningEngineR\x04name\"\xc2\x01\n" +
	"\x1cUpdateReasoningEngineRequest\x12`\n" +
	"\x10reasoning_engine\x18\x01 \x01(\v20.google.cloud.aiplatform.v1beta1.ReasoningEngineB\x03\xe0A\x02R\x0freasoningEngine\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x01R\n" +
	"updateMask\"\x8e\x01\n" +
	"&UpdateReasoningEngineOperationMetadata\x12d\n" +
	...
	"\n" +
	"page_token\x18\x04 \x01(\tB\x03\xe0A\x01R\tpageToken\"\xa5\x01\n" +
	"\x1cListReasoningEnginesResponse\x12]\n" +
	"\x11reasoning_engines\x18\x01 \x03(\v20.google.cloud.aiplatform.v1beta1.ReasoningEngineR\x10reasoningEngines\x12&\n" +
	...
	"\x05force\x18\x02 \x01(\bB\x03\xe0A\x01R\x05force2\xce\f\n" +
	...
	"\x0fReasoningEngine\x12&CreateReasoningEngineOperationMetadata\xdaA\x17parent,reasoning_engine\x82\xd3\xe4\x93\x02|:\x10reasoning_engineZ-:\x10reasoning_engine\"\x19/v1beta1/reasoningEngines\"9/v1beta1/{parent=projects/*/locations/*}/reasoningEngines\x12\xf2\x01\n" +
	"\x12GetReasoningEngine\x12:.google.cloud.aiplatform.v1beta1.GetReasoningEngineRequest\x1a0.google.cloud.aiplatform.v1beta1.ReasoningEngine\"n\xdaA\x04name\x82\xd3\xe4\x93\x02aZ$\x12\"/v1beta1/{name=reasoningEngines/*}\x129/v1beta1/{name=projects/*/locations/*/reasoningEngines/*}\x12\xfc\x01\n" +
	"\x14ListReasoningEngines\x12<.google.cloud.aiplatform.v1beta1.ListReasoningEnginesRequest\x1a=.google.cloud.aiplatform.v1beta1.ListReasoningEnginesResponse\"g\xdaA\x06parent\x82\xd3\xe4\x93\x02XZ\x1b\x12\x19/v1beta1/reasoningEngines\x129/v1beta1/{parent=projects/*/locations/*}/reasoningEngines\x12\x81\x03\n" +
	...
	"\x0fReasoningEngine\x12&UpdateReasoningEngineOperationMetadata\xdaA\x1creasoning_engine,update_mask\x82\xd3\xe4\x93\x02\xa7\x01:\x10reasoning_engineZG:\x10reasoning_engine23/v1beta1/{reasoning_engine.name=reasoningEngines/*}2J/v1beta1/{reasoning_engine.name=projects/*/locations/*/reasoningEngines/*}\x12\x99\x02\n" +
	...
	"\x15google.protobuf.Empty\x12\x17DeleteOperationMetadata\xdaA\x04name\x82\xd3\xe4\x93\x02aZ$*\"/v1beta1/{name=reasoningEngines/*}*9/v1beta1/{name=projects/*/locations/*/reasoningEngines/*}\x1aM\xcaA\x19aiplatform.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xf2\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_reasoning_engine_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_reasoning_engine_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_reasoning_engine_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_reasoning_engine_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_reasoning_engine_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_reasoning_engine_service_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_reasoning_engine_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_reasoning_engine_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_reasoning_engine_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
