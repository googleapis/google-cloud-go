...
type AssessDataRequest struct {
	...
	// The assessment type.
	//
	// Types that are valid to be assigned to AssessmentConfig:
	//
...
func (x *AssessDataRequest) GetAssessmentConfig() isAssessDataRequest_AssessmentConfig {
	if x != nil {
		return x.AssessmentConfig
	}
	return nil
}
...
func (x *AssessDataRequest) GetTuningValidationAssessmentConfig() *AssessDataRequest_TuningValidationAssessmentConfig {
	if x != nil {
		if x, ok := x.AssessmentConfig.(*AssessDataRequest_TuningValidationAssessmentConfig_); ok {
...
func (x *AssessDataRequest) GetTuningResourceUsageAssessmentConfig() *AssessDataRequest_TuningResourceUsageAssessmentConfig {
	if x != nil {
		if x, ok := x.AssessmentConfig.(*AssessDataRequest_TuningResourceUsageAssessmentConfig_); ok {
...
func (x *AssessDataRequest) GetBatchPredictionValidationAssessmentConfig() *AssessDataRequest_BatchPredictionValidationAssessmentConfig {
	if x != nil {
		if x, ok := x.AssessmentConfig.(*AssessDataRequest_BatchPredictionValidationAssessmentConfig_); ok {
...
func (x *AssessDataRequest) GetBatchPredictionResourceUsageAssessmentConfig() *AssessDataRequest_BatchPredictionResourceUsageAssessmentConfig {
	if x != nil {
		if x, ok := x.AssessmentConfig.(*AssessDataRequest_BatchPredictionResourceUsageAssessmentConfig_); ok {
...
type AssessDataResponse struct {
	...
	//
	// Types that are valid to be assigned to AssessmentResult:
	//
...
func (x *AssessDataResponse) GetAssessmentResult() isAssessDataResponse_AssessmentResult {
	if x != nil {
...
func (x *AssessDataResponse) GetTuningValidationAssessmentResult() *AssessDataResponse_TuningValidationAssessmentResult {
	if x != nil {
		if x, ok := x.AssessmentResult.(*AssessDataResponse_TuningValidationAssessmentResult_); ok {
...
func (x *AssessDataResponse) GetTuningResourceUsageAssessmentResult() *AssessDataResponse_TuningResourceUsageAssessmentResult {
	if x != nil {
		if x, ok := x.AssessmentResult.(*AssessDataResponse_TuningResourceUsageAssessmentResult_); ok {
...
func (x *AssessDataResponse) GetBatchPredictionValidationAssessmentResult() *AssessDataResponse_BatchPredictionValidationAssessmentResult {
	if x != nil {
		if x, ok := x.AssessmentResult.(*AssessDataResponse_BatchPredictionValidationAssessmentResult_); ok {
...
func (x *AssessDataResponse) GetBatchPredictionResourceUsageAssessmentResult() *AssessDataResponse_BatchPredictionResourceUsageAssessmentResult {
	if x != nil {
		if x, ok := x.AssessmentResult.(*AssessDataResponse_BatchPredictionResourceUsageAssessmentResult_); ok {
...
type GeminiRequestReadConfig struct {
	...
	//
	// Types that are valid to be assigned to ReadConfig:
	//
...
func (x *GeminiRequestReadConfig) GetReadConfig() isGeminiRequestReadConfig_ReadConfig {
	if x != nil {
		return x.ReadConfig
	}
	return nil
...
func (x *GeminiRequestReadConfig) GetTemplateConfig() *GeminiTemplateConfig {
	if x != nil {
		if x, ok := x.ReadConfig.(*GeminiRequestReadConfig_TemplateConfig); ok {
...
func (x *GeminiRequestReadConfig) GetAssembledRequestColumnName() string {
	if x != nil {
		if x, ok := x.ReadConfig.(*GeminiRequestReadConfig_AssembledRequestColumnName); ok {
...
const file_google_cloud_aiplatform_v1beta1_dataset_service_proto_rawDesc = "" +
	"\n" +
	...
	"\adataset\x18\x02 \x01(\v2(.google.cloud.aiplatform.v1beta1.DatasetB\x03\xe0A\x02R\adataset\"\x86\x01\n" +
	"\x1eCreateDatasetOperationMetadata\x12d\n" +
	...
	"\tread_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\breadMask\"\xa1\x01\n" +
	"\x14UpdateDatasetRequest\x12G\n" +
	"\adataset\x18\x01 \x01(\v2(.google.cloud.aiplatform.v1beta1.DatasetB\x03\xe0A\x02R\adataset\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"\xbe\x01\n" +
	"\x1bUpdateDatasetVersionRequest\x12]\n" +
	"\x0fdataset_version\x18\x01 \x01(\v2/.google.cloud.aiplatform.v1beta1.DatasetVersionB\x03\xe0A\x02R\x0edatasetVersion\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"\x80\x02\n" +
	...
	"\bdatasets\x18\x01 \x03(\v2(.google.cloud.aiplatform.v1beta1.DatasetR\bdatasets\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"U\n" +
	"\x14DeleteDatasetRequest\x12=\n" +
	"\x04name\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!aiplatform.googleapis.com/DatasetR\x04name\"\xb1\x01\n" +
	"\x11ImportDataRequest\x12=\n" +
	"\x04name\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!aiplatform.googleapis.com/DatasetR\x04name\x12]\n" +
	"\x0eimport_configs\x18\x02 \x03(\v21.google.cloud.aiplatform.v1beta1.ImportDataConfigB\x03\xe0A\x02R\rimportConfigs\"\x14\n" +
	"\x12ImportDataResponse\"\x83\x01\n" +
	"\x1bImportDataOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata\"\xaf\x01\n" +
	"\x11ExportDataRequest\x12=\n" +
	"\x04name\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!aiplatform.googleapis.com/DatasetR\x04name\x12[\n" +
	"\rexport_config\x18\x02 \x01(\v21.google.cloud.aiplatform.v1beta1.ExportDataConfigB\x03\xe0A\x02R\fexportConfig\";\n" +
	"\x12ExportDataResponse\x12%\n" +
	"\x0eexported_files\x18\x01 \x03(\tR\rexportedFiles\"\xb5\x01\n" +
	"\x1bExportDataOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata\x120\n" +
	"\x14gcs_output_directory\x18\x02 \x01(\tR\x12gcsOutputDirectory\"\xbf\x01\n" +
	"\x1bCreateDatasetVersionRequest\x12A\n" +
	"\x06parent\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!aiplatform.googleapis.com/DatasetR\x06parent\x12]\n" +
	"\x0fdataset_version\x18\x02 \x01(\v2/.google.cloud.aiplatform.v1beta1.DatasetVersionB\x03\xe0A\x02R\x0edatasetVersion\"\x8d\x01\n" +
	"%CreateDatasetVersionOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata\"c\n" +
	...
	"\border_by\x18\x06 \x01(\tB\x03\xe0A\x01R\aorderBy\"\xa1\x01\n" +
	"\x1bListDatasetVersionsResponse\x12Z\n" +
	"\x10dataset_versions\x18\x01 \x03(\v2/.google.cloud.aiplatform.v1beta1.DatasetVersionR\x0fdatasetVersions\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"d\n" +
	"\x1cRestoreDatasetVersionRequest\x12D\n" +
	"\x04name\x18\x01 \x01(\tB0\xe0A\x02\xfaA*\n" +
	"(aiplatform.googleapis.com/DatasetVersionR\x04name\"\x8e\x01\n" +
	"&RestoreDatasetVersionOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata\"\x81\x02\n" +
	...
	"\n" +
	"data_items\x18\x01 \x03(\v2).google.cloud.aiplatform.v1beta1.DataItemR\tdataItems\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xb1\x06\n" +
	"\x16SearchDataItemsRequest\x12-\n" +
	"\x12order_by_data_item\x18\f \x01(\tH\x00R\x0forderByDataItem\x12{\n" +
	"\x13order_by_annotation\x18\r \x01(\v2I.google.cloud.aiplatform.v1beta1.SearchDataItemsRequest.OrderByAnnotationH\x00R\x11orderByAnnotation\x12C\n" +
	...
	"\x05order\"\x98\x01\n" +
	"\x17SearchDataItemsResponse\x12U\n" +
	"\x0fdata_item_views\x18\x01 \x03(\v2-.google.cloud.aiplatform.v1beta1.DataItemViewR\rdataItemViews\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xe1\x01\n" +
	"\fDataItemView\x12F\n" +
	"\tdata_item\x18\x01 \x01(\v2).google.cloud.aiplatform.v1beta1.DataItemR\bdataItem\x12M\n" +
	"\vannotations\x18\x02 \x03(\v2+.google.cloud.aiplatform.v1beta1.AnnotationR\vannotations\x12:\n" +
	...
	"page_token\x18\x04 \x01(\tR\tpageToken\x127\n" +
	"\tread_mask\x18\x05 \x01(\v2\x1a.google.protobuf.FieldMaskR\breadMask\x12\x19\n" +
	"\border_by\x18\x06 \x01(\tR\aorderBy\"\x94\x01\n" +
	"\x18ListSavedQueriesResponse\x12P\n" +
	"\rsaved_queries\x18\x01 \x03(\v2+.google.cloud.aiplatform.v1beta1.SavedQueryR\fsavedQueries\x12&\n" +
	...
	"page_token\x18\x04 \x01(\tR\tpageToken\x127\n" +
	"\tread_mask\x18\x05 \x01(\v2\x1a.google.protobuf.FieldMaskR\breadMask\x12\x19\n" +
	"\border_by\x18\x06 \x01(\tR\aorderBy\"\x90\x01\n" +
	"\x17ListAnnotationsResponse\x12M\n" +
	"\vannotations\x18\x01 \x03(\v2+.google.cloud.aiplatform.v1beta1.AnnotationR\vannotations\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xfa\v\n" +
	"\x11AssessDataRequest\x12\xa9\x01\n" +
	"#tuning_validation_assessment_config\x18\x02 \x01(\v2S.google.cloud.aiplatform.v1beta1.AssessDataRequest.TuningValidationAssessmentConfigB\x03\xe0A\x01H\x00R tuningValidationAssessmentConfig\x12\xb3\x01\n" +
	"'tuning_resource_usage_assessment_config\x18\x03 \x01(\v2V.google.cloud.aiplatform.v1beta1.AssessDataRequest.TuningResourceUsageAssessmentConfigB\x03\xe0A\x01H\x00R#tuningResourceUsageAssessmentConfig\x12\xc5\x01\n" +
	"-batch_prediction_validation_assessment_config\x18\x06 \x01(\v2\\.google.cloud.aiplatform.v1beta1.AssessDataRequest.BatchPredictionValidationAssessmentConfigB\x03\xe0A\x01H\x00R)batchPredictionValidationAssessmentConfig\x12\xcf\x01\n" +
	"1batch_prediction_resource_usage_assessment_config\x18\a \x01(\v2_.google.cloud.aiplatform.v1beta1.AssessDataRequest.BatchPredictionResourceUsageAssessmentConfigB\x03\xe0A\x01H\x00R,batchPredictionResourceUsageAssessmentConfig\x12=\n" +
	"\x04name\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!aiplatform.googleapis.com/DatasetR\x04name\x12z\n" +
	"\x1agemini_request_read_config\x18\b \x01(\v28.google.cloud.aiplatform.v1beta1.GeminiRequestReadConfigB\x03\xe0A\x01R\x17geminiRequestReadConfig\x1a\xa8\x02\n" +
	" TuningValidationAssessmentConfig\x12\"\n" +
	"\n" +
	"model_name\x18\x01 \x01(\tB\x03\xe0A\x02R\tmodelName\x12\x8a\x01\n" +
	"\rdataset_usage\x18\x02 \x01(\x0e2`.google.cloud.aiplatform.v1beta1.AssessDataRequest.TuningValidationAssessmentConfig.DatasetUsageB\x03\xe0A\x02R\fdatasetUsage\"S\n" +
	"\fDatasetUsage\x12\x1d\n" +
	"\x19DATASET_USAGE_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fSFT_TRAINING\x10\x01\x12\x12\n" +
	"\x0eSFT_VALIDATION\x10\x02\x1aI\n" +
	"#TuningResourceUsageAssessmentConfig\x12\"\n" +
	"\n" +
	"model_name\x18\x01 \x01(\tB\x03\xe0A\x02R\tmodelName\x1aO\n" +
	")BatchPredictionValidationAssessmentConfig\x12\"\n" +
	"\n" +
	"model_name\x18\x01 \x01(\tB\x03\xe0A\x02R\tmodelName\x1aR\n" +
	",BatchPredictionResourceUsageAssessmentConfig\x12\"\n" +
	"\n" +
	"model_name\x18\x01 \x01(\tB\x03\xe0A\x02R\tmodelNameB\x13\n" +
	"\x11assessment_config\"\x97\t\n" +
	"\x12AssessDataResponse\x12\xaa\x01\n" +
	"#tuning_validation_assessment_result\x18\x01 \x01(\v2T.google.cloud.aiplatform.v1beta1.AssessDataResponse.TuningValidationAssessmentResultB\x03\xe0A\x01H\x00R tuningValidationAssessmentResult\x12\xb4\x01\n" +
	"'tuning_resource_usage_assessment_result\x18\x02 \x01(\v2W.google.cloud.aiplatform.v1beta1.AssessDataResponse.TuningResourceUsageAssessmentResultB\x03\xe0A\x01H\x00R#tuningResourceUsageAssessmentResult\x12\xc6\x01\n" +
	"-batch_prediction_validation_assessment_result\x18\x03 \x01(\v2].google.cloud.aiplatform.v1beta1.AssessDataResponse.BatchPredictionValidationAssessmentResultB\x03\xe0A\x01H\x00R)batchPredictionValidationAssessmentResult\x12\xd0\x01\n" +
	"1batch_prediction_resource_usage_assessment_result\x18\x04 \x01(\v2`.google.cloud.aiplatform.v1beta1.AssessDataResponse.BatchPredictionResourceUsageAssessmentResultB\x03\xe0A\x01H\x00R,batchPredictionResourceUsageAssessmentResult\x1a?\n" +
	" TuningValidationAssessmentResult\x12\x1b\n" +
	"\x06errors\x18\x01 \x03(\tB\x03\xe0A\x01R\x06errors\x1a\x80\x01\n" +
	"#TuningResourceUsageAssessmentResult\x12\x1f\n" +
	"\vtoken_count\x18\x01 \x01(\x03R\n" +
	"tokenCount\x128\n" +
	"\x18billable_character_count\x18\x02 \x01(\x03R\x16billableCharacterCount\x1a+\n" +
	")BatchPredictionValidationAssessmentResult\x1a{\n" +
	",BatchPredictionResourceUsageAssessmentResult\x12\x1f\n" +
	"\vtoken_count\x18\x01 \x01(\x03R\n" +
	"tokenCount\x12*\n" +
	"\x11audio_token_count\x18\x02 \x01(\x03R\x0faudioTokenCountB\x13\n" +
	"\x11assessment_result\"\x83\x01\n" +
	"\x1bAssessDataOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata\"\xa6\x02\n" +
	"\x14GeminiTemplateConfig\x12Z\n" +
	"\x0egemini_example\x18\x01 \x01(\v2..google.cloud.aiplatform.v1beta1.GeminiExampleB\x03\xe0A\x02R\rgeminiExample\x12q\n" +
	"\rfield_mapping\x18\x02 \x03(\v2G.google.cloud.aiplatform.v1beta1.GeminiTemplateConfig.FieldMappingEntryB\x03\xe0A\x02R\ffieldMapping\x1a?\n" +
	"\x11FieldMappingEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xd4\x01\n" +
	"\x17GeminiRequestReadConfig\x12`\n" +
	"\x0ftemplate_config\x18\x01 \x01(\v25.google.cloud.aiplatform.v1beta1.GeminiTemplateConfigH\x00R\x0etemplateConfig\x12H\n" +
	"\x1dassembled_request_column_name\x18\x04 \x01(\tB\x03\xe0A\x01H\x00R\x1aassembledRequestColumnNameB\r\n" +
	"\vread_config\"\xc0\a\n" +
	"\rGeminiExample\x12@\n" +
	"\x05model\x18\x01 \x01(\tB*\xe0A\x01\xfaA$\n" +
	"\"aiplatform.googleapis.com/EndpointR\x05model\x12I\n" +
	...
	"toolConfig\x12W\n" +
	"\x06labels\x18\n" +
	" \x03(\v2:.google.cloud.aiplatform.v1beta1.GeminiExample.LabelsEntryB\x03\xe0A\x01R\x06labels\x12\\\n" +
	...
	"\x13_system_instruction\"\xd0\x01\n" +
	"\x13AssembleDataRequest\x12=\n" +
	"\x04name\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!aiplatform.googleapis.com/DatasetR\x04name\x12z\n" +
	"\x1agemini_request_read_config\x18\x06 \x01(\v28.google.cloud.aiplatform.v1beta1.GeminiRequestReadConfigB\x03\xe0A\x01R\x17geminiRequestReadConfig\"I\n" +
	"\x14AssembleDataResponse\x121\n" +
	"\x14bigquery_destination\x18\x01 \x01(\tR\x13bigqueryDestination\"\x85\x01\n" +
	"\x1dAssembleDataOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata2\xc9*\n" +
	...
	"\aDataset\x12\x1eCreateDatasetOperationMetadata\xdaA\x0eparent,dataset\x82\xd3\xe4\x93\x02Z:\adatasetZ\x1c:\adataset\"\x11/v1beta1/datasets\"1/v1beta1/{parent=projects/*/locations/*}/datasets\x12\xca\x01\n" +
	"\n" +
	"GetDataset\x122.google.cloud.aiplatform.v1beta1.GetDatasetRequest\x1a(.google.cloud.aiplatform.v1beta1.Dataset\"^\xdaA\x04name\x82\xd3\xe4\x93\x02QZ\x1c\x12\x1a/v1beta1/{name=datasets/*}\x121/v1beta1/{name=projects/*/locations/*/datasets/*}\x12\x82\x02\n" +
	"\rUpdateDataset\x125.google.cloud.aiplatform.v1beta1.UpdateDatasetRequest\x1a(.google.cloud.aiplatform.v1beta1.Dataset\"\x8f\x01\xdaA\x13dataset,update_mask\x82\xd3\xe4\x93\x02s:\adatasetZ-:\adataset2\"/v1beta1/{dataset.name=datasets/*}29/v1beta1/{dataset.name=projects/*/locations/*/datasets/*}\x12\xd4\x01\n" +
	"\fListDatasets\x124.google.cloud.aiplatform.v1beta1.ListDatasetsRequest\x1a5.google.cloud.aiplatform.v1beta1.ListDatasetsResponse\"W\xdaA\x06parent\x82\xd3\xe4\x93\x02HZ\x13\x12\x11/v1beta1/datasets\x121/v1beta1/{parent=projects/*/locations/*}/datasets\x12\xf9\x01\n" +
	...
	"\x15google.protobuf.Empty\x12\x17DeleteOperationMetadata\xdaA\x04name\x82\xd3\xe4\x93\x02QZ\x1c*\x1a/v1beta1/{name=datasets/*}*1/v1beta1/{name=projects/*/locations/*/datasets/*}\x12\xef\x01\n" +
	"\n" +
	"ImportData\x122.google.cloud.aiplatform.v1beta1.ImportDataRequest\x1a\x1d.google.longrunning.Operation\"\x8d\x01\xcaA1\n" +
	"\x12ImportDataResponse\x12\x1bImportDataOperationMetadata\xdaA\x13name,import_configs\x82\xd3\xe4\x93\x02=:\x01*\"8/v1beta1/{name=projects/*/locations/*/datasets/*}:import\x12\xee\x01\n" +
	"\n" +
	"ExportData\x122.google.cloud.aiplatform.v1beta1.ExportDataRequest\x1a\x1d.google.longrunning.Operation\"\x8c\x01\xcaA1\n" +
	"\x12ExportDataResponse\x12\x1bExportDataOperationMetadata\xdaA\x12name,export_config\x82\xd3\xe4\x93\x02=:\x01*\"8/v1beta1/{name=projects/*/locations/*/datasets/*}:export\x12\xe7\x02\n" +
	...
	"\x0eDatasetVersion\x12%CreateDatasetVersionOperationMetadata\xdaA\x16parent,dataset_version\x82\xd3\xe4\x93\x02\x97\x01:\x0fdataset_versionZ?:\x0fdataset_version\",/v1beta1/{parent=datasets/*}/datasetVersions\"C/v1beta1/{parent=projects/*/locations/*/datasets/*}/datasetVersions\x12\xe4\x02\n" +
	"\x14UpdateDatasetVersion\x12<.google.cloud.aiplatform.v1beta1.UpdateDatasetVersionRequest\x1a/.google.cloud.aiplatform.v1beta1.DatasetVersion\"\xdc\x01\xdaA\x1bdataset_version,update_mask\x82\xd3\xe4\x93\x02\xb7\x01:\x0fdataset_versionZO:\x0fdataset_version2</v1beta1/{dataset_version.name=datasets/*/datasetVersions/*}2S/v1beta1/{dataset_version.name=projects/*/locations/*/datasets/*/datasetVersions/*}\x12\xab\x02\n" +
	...
	"\x15google.protobuf.Empty\x12\x17DeleteOperationMetadata\xdaA\x04name\x82\xd3\xe4\x93\x02uZ.*,/v1beta1/{name=datasets/*/datasetVersions/*}*C/v1beta1/{name=projects/*/locations/*/datasets/*/datasetVersions/*}\x12\x84\x02\n" +
	"\x11GetDatasetVersion\x129.google.cloud.aiplatform.v1beta1.GetDatasetVersionRequest\x1a/.google.cloud.aiplatform.v1beta1.DatasetVersion\"\x82\x01\xdaA\x04name\x82\xd3\xe4\x93\x02uZ.\x12,/v1beta1/{name=datasets/*/datasetVersions/*}\x12C/v1beta1/{name=projects/*/locations/*/datasets/*/datasetVersions/*}\x12\x97\x02\n" +
	"\x13ListDatasetVersions\x12;.google.cloud.aiplatform.v1beta1.ListDatasetVersionsRequest\x1a<.google.cloud.aiplatform.v1beta1.ListDatasetVersionsResponse\"\x84\x01\xdaA\x06parent\x82\xd3\xe4\x93\x02uZ.\x12,/v1beta1/{parent=datasets/*}/datasetVersions\x12C/v1beta1/{parent=projects/*/locations/*/datasets/*}/datasetVersions\x12\xc6\x02\n" +
	...
	"\x0eDatasetVersion\x12&RestoreDatasetVersionOperationMetadata\xdaA\x04name\x82\xd3\xe4\x93\x02\x85\x01Z6\x124/v1beta1/{name=datasets/*/datasetVersions/*}:restore\x12K/v1beta1/{name=projects/*/locations/*/datasets/*/datasetVersions/*}:restore\x12\xce\x01\n" +
	...
	"\x12AssessDataResponse\x12\x1bAssessDataOperationMetadata\x82\xd3\xe4\x93\x02=:\x01*\"8/v1beta1/{name=projects/*/locations/*/datasets/*}:assess\x12\xe2\x01\n" +
	"\fAssembleData\x124.google.cloud.aiplatform.v1beta1.AssembleDataRequest\x1a\x1d.google.longrunning.Operation\"}\xcaA5\n" +
	"\x14AssembleDataResponse\x12\x1dAssembleDataOperationMetadata\x82\xd3\xe4\x93\x02?:\x01*\":/v1beta1/{name=projects/*/locations/*/datasets/*}:assemble\x1aM\xcaA\x19aiplatform.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xea\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_dataset_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_dataset_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_dataset_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_dataset_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_dataset_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_dataset_service_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_dataset_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_dataset_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_dataset_service_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   53,
			NumExtensions: 0,
			NumServices:   1,
