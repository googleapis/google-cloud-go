...
func file_google_cloud_aiplatform_v1beta1_dataset_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_aiplatform_v1beta1_dataset_service_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_aiplatform_v1beta1_dataset_service_proto_msgTypes[24].OneofWrappers = []interface{}{
