...
type RaySpec struct {
	...
	//	}
	ResourcePoolImages map[string]string `protobuf:"bytes,6,rep,name=resource_pool_images,json=resourcePoolImages,proto3" json:"resource_pool_images,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type ResourceRuntime struct {
	...
	//	}
	AccessUris map[string]string `protobuf:"bytes,1,rep,name=access_uris,json=accessUris,proto3" json:"access_uris,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_google_cloud_aiplatform_v1beta1_persistent_resource_proto_rawDesc = "" +
	"\n" +
	"9google/cloud/aiplatform/v1beta1/persistent_resource.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a5google/cloud/aiplatform/v1beta1/encryption_spec.proto\x1a7google/cloud/aiplatform/v1beta1/machine_resources.proto\x1a8google/cloud/aiplatform/v1beta1/service_networking.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\xf4\v\n" +
	"\x12PersistentResource\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x05R\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x01R\vdisplayName\x12Y\n" +
	"\x0eresource_pools\x18\x04 \x03(\v2-.google.cloud.aiplatform.v1beta1.ResourcePoolB\x03\xe0A\x02R\rresourcePools\x12T\n" +
	"\x05state\x18\x05 \x01(\x0e29.google.cloud.aiplatform.v1beta1.PersistentResource.StateB\x03\xe0A\x03R\x05state\x12-\n" +
	"\x05error\x18\x06 \x01(\v2\x12.google.rpc.StatusB\x03\xe0A\x03R\x05error\x12@\n" +
	...
	"updateTime\x12\\\n" +
	"\x06labels\x18\n" +
	" \x03(\v2?.google.cloud.aiplatform.v1beta1.PersistentResource.LabelsEntryB\x03\xe0A\x01R\x06labels\x12@\n" +
	"\anetwork\x18\v \x01(\tB&\xe0A\x01\xfaA \n" +
	"\x1ecompute.googleapis.com/NetworkR\anetwork\x12j\n" +
	"\x14psc_interface_config\x18\x11 \x01(\v23.google.cloud.aiplatform.v1beta1.PscInterfaceConfigB\x03\xe0A\x01R\x12pscInterfaceConfig\x12]\n" +
	"\x0fencryption_spec\x18\f \x01(\v2/.google.cloud.aiplatform.v1beta1.EncryptionSpecB\x03\xe0A\x01R\x0eencryptionSpec\x12m\n" +
	"\x15resource_runtime_spec\x18\r \x01(\v24.google.cloud.aiplatform.v1beta1.ResourceRuntimeSpecB\x03\xe0A\x01R\x13resourceRuntimeSpec\x12`\n" +
	"\x10resource_runtime\x18\x0e \x01(\v20.google.cloud.aiplatform.v1beta1.ResourceRuntimeB\x03\xe0A\x03R\x0fresourceRuntime\x121\n" +
	"\x12reserved_ip_ranges\x18\x0f \x03(\tB\x03\xe0A\x01R\x10reservedIpRanges\x12(\n" +
	...
	"\tREBOOTING\x10\x06\x12\f\n" +
	"\bUPDATING\x10\a:\x85\x01\xeaA\x81\x01\n" +
	",aiplatform.googleapis.com/PersistentResource\x12Qprojects/{project}/locations/{location}/persistentResources/{persistent_resource}\"\xd8\x04\n" +
	"\fResourcePool\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x05R\x02id\x12W\n" +
	"\fmachine_spec\x18\x02 \x01(\v2,.google.cloud.aiplatform.v1beta1.MachineSpecB\x06\xe0A\x02\xe0A\x05R\vmachineSpec\x12-\n" +
	"\rreplica_count\x18\x03 \x01(\x03B\x03\xe0A\x01H\x00R\freplicaCount\x88\x01\x01\x12K\n" +
	"\tdisk_spec\x18\x04 \x01(\v2).google.cloud.aiplatform.v1beta1.DiskSpecB\x03\xe0A\x01R\bdiskSpec\x121\n" +
	"\x12used_replica_count\x18\x06 \x01(\x03B\x03\xe0A\x03R\x10usedReplicaCount\x12m\n" +
	"\x10autoscaling_spec\x18\a \x01(\v2=.google.cloud.aiplatform.v1beta1.ResourcePool.AutoscalingSpecB\x03\xe0A\x01R\x0fautoscalingSpec\x1a\xa9\x01\n" +
	"\x0fAutoscalingSpec\x124\n" +
	"\x11min_replica_count\x18\x01 \x01(\x03B\x03\xe0A\x01H\x00R\x0fminReplicaCount\x88\x01\x01\x124\n" +
	"\x11max_replica_count\x18\x02 \x01(\x03B\x03\xe0A\x01H\x01R\x0fmaxReplicaCount\x88\x01\x01B\x14\n" +
	"\x12_min_replica_countB\x14\n" +
	"\x12_max_replica_countB\x10\n" +
	"\x0e_replica_count\"\xcb\x01\n" +
	"\x13ResourceRuntimeSpec\x12j\n" +
	"\x14service_account_spec\x18\x02 \x01(\v23.google.cloud.aiplatform.v1beta1.ServiceAccountSpecB\x03\xe0A\x01R\x12serviceAccountSpec\x12H\n" +
	"\bray_spec\x18\x01 \x01(\v2(.google.cloud.aiplatform.v1beta1.RaySpecB\x03\xe0A\x01R\araySpec\"\xaf\x04\n" +
	"\aRaySpec\x12 \n" +
	"\timage_uri\x18\x01 \x01(\tB\x03\xe0A\x01R\bimageUri\x12M\n" +
	"\n" +
	"nfs_mounts\x18\v \x03(\v2).google.cloud.aiplatform.v1beta1.NfsMountB\x03\xe0A\x01R\tnfsMounts\x12w\n" +
	"\x14resource_pool_images\x18\x06 \x03(\v2@.google.cloud.aiplatform.v1beta1.RaySpec.ResourcePoolImagesEntryB\x03\xe0A\x01R\x12resourcePoolImages\x12?\n" +
	"\x1ahead_node_resource_pool_id\x18\a \x01(\tB\x03\xe0A\x01R\x16headNodeResourcePoolId\x12[\n" +
	"\x0fray_metric_spec\x18\b \x01(\v2..google.cloud.aiplatform.v1beta1.RayMetricSpecB\x03\xe0A\x01R\rrayMetricSpec\x12U\n" +
	"\rray_logs_spec\x18\n" +
	" \x01(\v2,.google.cloud.aiplatform.v1beta1.RayLogsSpecB\x03\xe0A\x01R\vrayLogsSpec\x1aE\n" +
	"\x17ResourcePoolImagesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xb1\x02\n" +
	"\x0fResourceRuntime\x12f\n" +
	"\vaccess_uris\x18\x01 \x03(\v2@.google.cloud.aiplatform.v1beta1.ResourceRuntime.AccessUrisEntryB\x03\xe0A\x03R\n" +
	"accessUris\x12w\n" +
	"\x19notebook_runtime_template\x18\x02 \x01(\tB;\xe0A\x03\xfaA3\n" +
	"1aiplatform.googleapis.com/NotebookRuntimeTemplate\x18\x01R\x17notebookRuntimeTemplate\x1a=\n" +
	"\x0fAccessUrisEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x8a\x01\n" +
	"\x12ServiceAccountSpec\x12F\n" +
	"\x1denable_custom_service_account\x18\x01 \x01(\bB\x03\xe0A\x02R\x1aenableCustomServiceAccount\x12,\n" +
	"\x0fservice_account\x18\x02 \x01(\tB\x03\xe0A\x01R\x0eserviceAccount\"0\n" +
	"\rRayMetricSpec\x12\x1f\n" +
	"\bdisabled\x18\x01 \x01(\bB\x03\xe0A\x01R\bdisabled\".\n" +
	"\vRayLogsSpec\x12\x1f\n" +
	"\bdisabled\x18\x01 \x01(\bB\x03\xe0A\x01R\bdisabledB\xee\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_persistent_resource_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_persistent_resource_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_persistent_resource_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_persistent_resource_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_persistent_resource_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_persistent_resource_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_persistent_resource_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_persistent_resource_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_persistent_resource_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
