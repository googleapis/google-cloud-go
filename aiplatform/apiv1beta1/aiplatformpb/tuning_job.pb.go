...
func (x *TuningJob) GetDistillationSpec() *DistillationSpec {
	if x != nil {
		if x, ok := x.TuningSpec.(*TuningJob_DistillationSpec); ok {
...
func (x *TuningJob) GetPartnerModelTuningSpec() *PartnerModelTuningSpec {
	if x != nil {
		if x, ok := x.TuningSpec.(*TuningJob_PartnerModelTuningSpec); ok {
...
func (x *TuningJob) GetVeoTuningSpec() *VeoTuningSpec {
	if x != nil {
		if x, ok := x.TuningSpec.(*TuningJob_VeoTuningSpec); ok {
...
func (x *TuningDataStats) GetDistillationDataStats() *DistillationDataStats {
	if x != nil {
		if x, ok := x.TuningDataStats.(*TuningDataStats_DistillationDataStats); ok {
...
type DistillationSpec struct {
	...
	// models](https://cloud.google.com/vertex-ai/generative-ai/docs/model-reference/tuning#supported_models).
	//
	// Types that are valid to be assigned to TeacherModel:
	//
...
func (x *DistillationSpec) GetTeacherModel() isDistillationSpec_TeacherModel {
	if x != nil {
		return x.TeacherModel
	}
	return nil
}
...
func (x *DistillationSpec) GetBaseTeacherModel() string {
	if x != nil {
		if x, ok := x.TeacherModel.(*DistillationSpec_BaseTeacherModel); ok {
...
func (x *DistillationSpec) GetTunedTeacherModelSource() string {
	if x != nil {
		if x, ok := x.TeacherModel.(*DistillationSpec_TunedTeacherModelSource); ok {
...
type PartnerModelTuningSpec struct {
	...
	HyperParameters map[string]*structpb.Value `protobuf:"bytes,3,rep,name=hyper_parameters,json=hyperParameters,proto3" json:"hyper_parameters,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_google_cloud_aiplatform_v1beta1_tuning_job_proto_rawDesc = "" +
	...
	"\x0fpre_tuned_model\x18\x1f \x01(\v2..google.cloud.aiplatform.v1beta1.PreTunedModelH\x00R\rpreTunedModel\x12m\n" +
	...
	"\x11custom_base_model\x18\x1a \x01(\tB\x03\xe0A\x01R\x0fcustomBaseModel\x12D\n" +
	...
	"updateTime\x12-\n" +
	"\x05error\x18\v \x01(\v2\x12.google.rpc.StatusB\x03\xe0A\x03R\x05error\x12S\n" +
	"\x06labels\x18\f \x03(\v26.google.cloud.aiplatform.v1beta1.TuningJob.LabelsEntryB\x03\xe0A\x01R\x06labels\x12I\n" +
	"\n" +
	"experiment\x18\r \x01(\tB)\xe0A\x03\xfaA#\n" +
	"!aiplatform.googleapis.com/ContextR\n" +
	"experiment\x12Q\n" +
	"\vtuned_model\x18\x0e \x01(\v2+.google.cloud.aiplatform.v1beta1.TunedModelB\x03\xe0A\x03R\n" +
	"tunedModel\x12a\n" +
	"\x11tuning_data_stats\x18\x0f \x01(\v20.google.cloud.aiplatform.v1beta1.TuningDataStatsB\x03\xe0A\x03R\x0ftuningDataStats\x12P\n" +
	"\fpipeline_job\x18\x12 \x01(\tB-\xe0A\x03\xfaA'\n" +
	"%aiplatform.googleapis.com/PipelineJobR\vpipelineJob\x12X\n" +
	...
	"\n" +
	"output_uri\x18\x19 \x01(\tB\x03\xe0A\x01R\toutputUri\x12l\n" +
	"\x15evaluate_dataset_runs\x18  \x03(\v23.google.cloud.aiplatform.v1beta1.EvaluateDatasetRunB\x03\xe0A\x03R\x13evaluateDatasetRuns\x1a9\n" +
	...
	"\vcheckpoints\x18\x03 \x03(\v25.google.cloud.aiplatform.v1beta1.TunedModelCheckpointB\x03\xe0A\x03R\vcheckpoints\"\xc7\x03\n" +
	...
	"\x03p95\x18\a \x01(\x01B\x03\xe0A\x03R\x03p95\x12q\n" +
	"\abuckets\x18\b \x03(\v2R.google.cloud.aiplatform.v1beta1.SupervisedTuningDatasetDistribution.DatasetBucketB\x03\xe0A\x03R\abuckets\x1a^\n" +
	...
	"\x05right\x18\x03 \x01(\x01B\x03\xe0A\x03R\x05right\"\xcd\b\n" +
	...
	"\x11tuning_step_count\x18\x04 \x01(\x03B\x03\xe0A\x03R\x0ftuningStepCount\x12\x8c\x01\n" +
	"\x1duser_input_token_distribution\x18\x05 \x01(\v2D.google.cloud.aiplatform.v1beta1.SupervisedTuningDatasetDistributionB\x03\xe0A\x03R\x1auserInputTokenDistribution\x12\x8e\x01\n" +
	"\x1euser_output_token_distribution\x18\x06 \x01(\v2D.google.cloud.aiplatform.v1beta1.SupervisedTuningDatasetDistributionB\x03\xe0A\x03R\x1buserOutputTokenDistribution\x12\x9b\x01\n" +
	"%user_message_per_example_distribution\x18\a \x01(\v2D.google.cloud.aiplatform.v1beta1.SupervisedTuningDatasetDistributionB\x03\xe0A\x03R!userMessagePerExampleDistribution\x12a\n" +
	"\x15user_dataset_examples\x18\b \x03(\v2(.google.cloud.aiplatform.v1beta1.ContentB\x03\xe0A\x03R\x13userDatasetExamples\x12F\n" +
	...
	"\x17dropped_example_reasons\x18\f \x03(\tB\x03\xe0A\x03R\x15droppedExampleReasons\"\x89\x03\n" +
	"\x13DatasetDistribution\x12\x15\n" +
	"\x03sum\x18\x01 \x01(\x01B\x03\xe0A\x03R\x03sum\x12\x15\n" +
	"\x03min\x18\x02 \x01(\x01B\x03\xe0A\x03R\x03min\x12\x15\n" +
	"\x03max\x18\x03 \x01(\x01B\x03\xe0A\x03R\x03max\x12\x17\n" +
	"\x04mean\x18\x04 \x01(\x01B\x03\xe0A\x03R\x04mean\x12\x1b\n" +
	"\x06median\x18\x05 \x01(\x01B\x03\xe0A\x03R\x06median\x12\x13\n" +
	"\x02p5\x18\x06 \x01(\x01B\x03\xe0A\x03R\x02p5\x12\x15\n" +
	"\x03p95\x18\a \x01(\x01B\x03\xe0A\x03R\x03p95\x12f\n" +
	"\abuckets\x18\b \x03(\v2G.google.cloud.aiplatform.v1beta1.DatasetDistribution.DistributionBucketB\x03\xe0A\x03R\abuckets\x1ac\n" +
	"\x12DistributionBucket\x12\x19\n" +
	"\x05count\x18\x01 \x01(\x03B\x03\xe0A\x03R\x05count\x12\x17\n" +
	"\x04left\x18\x02 \x01(\x01B\x03\xe0A\x03R\x04left\x12\x19\n" +
	"\x05right\x18\x03 \x01(\x01B\x03\xe0A\x03R\x05right\"\xad\x06\n" +
	"\fDatasetStats\x12D\n" +
	"\x1ctuning_dataset_example_count\x18\x01 \x01(\x03B\x03\xe0A\x03R\x19tuningDatasetExampleCount\x12D\n" +
	"\x1ctotal_tuning_character_count\x18\x02 \x01(\x03B\x03\xe0A\x03R\x19totalTuningCharacterCount\x12H\n" +
	"\x1etotal_billable_character_count\x18\x03 \x01(\x03B\x03\xe0A\x03R\x1btotalBillableCharacterCount\x12/\n" +
	"\x11tuning_step_count\x18\x04 \x01(\x03B\x03\xe0A\x03R\x0ftuningStepCount\x12|\n" +
	"\x1duser_input_token_distribution\x18\x05 \x01(\v24.google.cloud.aiplatform.v1beta1.DatasetDistributionB\x03\xe0A\x03R\x1auserInputTokenDistribution\x12\x83\x01\n" +
	"\x1euser_output_token_distribution\x18\x06 \x01(\v24.google.cloud.aiplatform.v1beta1.DatasetDistributionB\x03\xe0A\x03H\x00R\x1buserOutputTokenDistribution\x88\x01\x01\x12\x8b\x01\n" +
	"%user_message_per_example_distribution\x18\a \x01(\v24.google.cloud.aiplatform.v1beta1.DatasetDistributionB\x03\xe0A\x03R!userMessagePerExampleDistribution\x12a\n" +
	"\x15user_dataset_examples\x18\b \x03(\v2(.google.cloud.aiplatform.v1beta1.ContentB\x03\xe0A\x03R\x13userDatasetExamplesB!\n" +
	"\x1f_user_output_token_distribution\"\x81\x01\n" +
	"\x15DistillationDataStats\x12h\n" +
	"\x16training_dataset_stats\x18\x01 \x01(\v2-.google.cloud.aiplatform.v1beta1.DatasetStatsB\x03\xe0A\x03R\x14trainingDatasetStats\"\x9c\x02\n" +
	"\x0fTuningDataStats\x12}\n" +
	"\x1csupervised_tuning_data_stats\x18\x01 \x01(\v2:.google.cloud.aiplatform.v1beta1.SupervisedTuningDataStatsH\x00R\x19supervisedTuningDataStats\x12u\n" +
	"\x17distillation_data_stats\x18\x03 \x01(\v26.google.cloud.aiplatform.v1beta1.DistillationDataStatsB\x03\xe0A\x03H\x00R\x15distillationDataStatsB\x13\n" +
	"\x11tuning_data_stats\"\xfe\x03\n" +
	"\x19SupervisedHyperParameters\x12$\n" +
	"\vepoch_count\x18\x01 \x01(\x03B\x03\xe0A\x01R\n" +
	"epochCount\x12=\n" +
	"\x18learning_rate_multiplier\x18\x02 \x01(\x01B\x03\xe0A\x01R\x16learningRateMultiplier\x12(\n" +
	"\rlearning_rate\x18\x06 \x01(\x01B\x03\xe0A\x01R\flearningRate\x12n\n" +
	"\fadapter_size\x18\x03 \x01(\x0e2F.google.cloud.aiplatform.v1beta1.SupervisedHyperParameters.AdapterSizeB\x03\xe0A\x01R\vadapterSize\x12\"\n" +
	"\n" +
	"batch_size\x18\x05 \x01(\x03B\x03\xe0A\x01R\tbatchSize\"\xbd\x01\n" +
	...
	"\x17ADAPTER_SIZE_THIRTY_TWO\x10\x05\"\xdf\x04\n" +
	"\x14SupervisedTuningSpec\x125\n" +
	"\x14training_dataset_uri\x18\x01 \x01(\tB\x03\xe0A\x02R\x12trainingDatasetUri\x129\n" +
	"\x16validation_dataset_uri\x18\x02 \x01(\tB\x03\xe0A\x01R\x14validationDatasetUri\x12j\n" +
	"\x10hyper_parameters\x18\x03 \x01(\v2:.google.cloud.aiplatform.v1beta1.SupervisedHyperParametersB\x03\xe0A\x01R\x0fhyperParameters\x12B\n" +
	"\x1bexport_last_checkpoint_only\x18\x06 \x01(\bB\x03\xe0A\x01R\x18exportLastCheckpointOnly\x12c\n" +
	"\x11evaluation_config\x18\x05 \x01(\v21.google.cloud.aiplatform.v1beta1.EvaluationConfigB\x03\xe0A\x01R\x10evaluationConfig\x12a\n" +
	"\vtuning_mode\x18\a \x01(\x0e2@.google.cloud.aiplatform.v1beta1.SupervisedTuningSpec.TuningModeR\n" +
	"tuningMode\"]\n" +
	"\n" +
	"TuningMode\x12\x1b\n" +
	"\x17TUNING_MODE_UNSPECIFIED\x10\x00\x12\x14\n" +
	"\x10TUNING_MODE_FULL\x10\x01\x12\x1c\n" +
	"\x18TUNING_MODE_PEFT_ADAPTER\x10\x02\"\x9a\x04\n" +
	"\x10DistillationSpec\x12.\n" +
	"\x12base_teacher_model\x18\x05 \x01(\tH\x00R\x10baseTeacherModel\x12c\n" +
	"\x1atuned_teacher_model_source\x18\x06 \x01(\tB$\xfaA!\n" +
	"\x1faiplatform.googleapis.com/ModelH\x00R\x17tunedTeacherModelSource\x125\n" +
	"\x14training_dataset_uri\x18\x01 \x01(\tB\x03\xe0A\x02R\x12trainingDatasetUri\x12>\n" +
	"\x16validation_dataset_uri\x18\x02 \x01(\tB\x03\xe0A\x01H\x01R\x14validationDatasetUri\x88\x01\x01\x12l\n" +
	"\x10hyper_parameters\x18\x03 \x01(\v2<.google.cloud.aiplatform.v1beta1.DistillationHyperParametersB\x03\xe0A\x01R\x0fhyperParameters\x12#\n" +
	"\rstudent_model\x18\x04 \x01(\tR\fstudentModel\x12;\n" +
	"\x17pipeline_root_directory\x18\a \x01(\tB\x03\xe0A\x02R\x15pipelineRootDirectoryB\x0f\n" +
	"\rteacher_modelB\x19\n" +
	"\x17_validation_dataset_uri\"\xa9\x02\n" +
	"\x1bDistillationHyperParameters\x12)\n" +
	"\vepoch_count\x18\x01 \x01(\x03B\x03\xe0A\x01H\x00R\n" +
	"epochCount\x88\x01\x01\x12B\n" +
	"\x18learning_rate_multiplier\x18\x02 \x01(\x01B\x03\xe0A\x01H\x01R\x16learningRateMultiplier\x88\x01\x01\x12n\n" +
	"\fadapter_size\x18\x03 \x01(\x0e2F.google.cloud.aiplatform.v1beta1.SupervisedHyperParameters.AdapterSizeB\x03\xe0A\x01R\vadapterSizeB\x0e\n" +
	"\f_epoch_countB\x1b\n" +
	"\x19_learning_rate_multiplier\"\xdf\x02\n" +
	"\x16PartnerModelTuningSpec\x125\n" +
	"\x14training_dataset_uri\x18\x01 \x01(\tB\x03\xe0A\x02R\x12trainingDatasetUri\x129\n" +
	"\x16validation_dataset_uri\x18\x02 \x01(\tB\x03\xe0A\x01R\x14validationDatasetUri\x12w\n" +
	"\x10hyper_parameters\x18\x03 \x03(\v2L.google.cloud.aiplatform.v1beta1.PartnerModelTuningSpec.HyperParametersEntryR\x0fhyperParameters\x1aZ\n" +
	"\x14HyperParametersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value:\x028\x01\"\x87\x02\n" +
	"\rTunedModelRef\x12G\n" +
	...
	"\x10EvaluationConfig\x12F\n" +
	"\ametrics\x18\x01 \x03(\v2'.google.cloud.aiplatform.v1beta1.MetricB\x03\xe0A\x02R\ametrics\x12W\n" +
	"\routput_config\x18\x02 \x01(\v2-.google.cloud.aiplatform.v1beta1.OutputConfigB\x03\xe0A\x02R\foutputConfig\x12`\n" +
	"\x10autorater_config\x18\x03 \x01(\v20.google.cloud.aiplatform.v1beta1.AutoraterConfigB\x03\xe0A\x01R\x0fautoraterConfig\x12v\n" +
	"\x1binference_generation_config\x18\x05 \x01(\v21.google.cloud.aiplatform.v1beta1.GenerationConfigB\x03\xe0A\x01R\x19inferenceGenerationConfig\"\xc0\x02\n" +
	"\x12EvaluateDatasetRun\x12*\n" +
	"\x0eoperation_name\x18\x01 \x01(\tB\x03\xe0A\x03R\roperationName\x12*\n" +
	"\x0eevaluation_run\x18\x05 \x01(\tB\x03\xe0A\x03R\revaluationRun\x12(\n" +
	"\rcheckpoint_id\x18\x02 \x01(\tB\x03\xe0A\x03R\fcheckpointId\x12y\n" +
	"\x19evaluate_dataset_response\x18\x03 \x01(\v28.google.cloud.aiplatform.v1beta1.EvaluateDatasetResponseB\x03\xe0A\x03R\x17evaluateDatasetResponse\x12-\n" +
	...
	"\n" +
	"base_model\x18\x03 \x01(\tB\x03\xe0A\x03R\tbaseModelB\xe5\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_tuning_job_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_tuning_job_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_tuning_job_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_tuning_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_tuning_job_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_tuning_job_proto_rawDesc)))
	})
