...
const file_google_cloud_aiplatform_v1beta1_migration_service_proto_rawDesc = "" +
	"\n" +
	"7google/cloud/aiplatform/v1beta1/migration_service.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a9google/cloud/aiplatform/v1beta1/migratable_resource.proto\x1a/google/cloud/aiplatform/v1beta1/operation.proto\x1a#google/longrunning/operations.proto\x1a\x17google/rpc/status.proto\"\xb9\x01\n" +
	...
	"!SearchMigratableResourcesResponse\x12f\n" +
	"\x14migratable_resources\x18\x01 \x03(\v23.google.cloud.aiplatform.v1beta1.MigratableResourceR\x13migratableResources\x12&\n" +
	...
	"\x19migrate_resource_requests\x18\x02 \x03(\v27.google.cloud.aiplatform.v1beta1.MigrateResourceRequestB\x03\xe0A\x02R\x17migrateResourceRequests\"\xb7\r\n" +
	"\x16MigrateResourceRequest\x12\xae\x01\n" +
	"&migrate_ml_engine_model_version_config\x18\x01 \x01(\v2Y.google.cloud.aiplatform.v1beta1.MigrateResourceRequest.MigrateMlEngineModelVersionConfigH\x00R!migrateMlEngineModelVersionConfig\x12\x91\x01\n" +
	"\x1bmigrate_automl_model_config\x18\x02 \x01(\v2P.google.cloud.aiplatform.v1beta1.MigrateResourceRequest.MigrateAutomlModelConfigH\x00R\x18migrateAutomlModelConfig\x12\x97\x01\n" +
	"\x1dmigrate_automl_dataset_config\x18\x03 \x01(\v2R.google.cloud.aiplatform.v1beta1.MigrateResourceRequest.MigrateAutomlDatasetConfigH\x00R\x1amigrateAutomlDatasetConfig\x12\xaa\x01\n" +
	"$migrate_data_labeling_dataset_config\x18\x04 \x01(\v2X.google.cloud.aiplatform.v1beta1.MigrateResourceRequest.MigrateDataLabelingDatasetConfigH\x00R migrateDataLabelingDatasetConfig\x1a\xbf\x01\n" +
	...
	"\x14dataset_display_name\x18\x02 \x01(\tB\x03\xe0A\x02R\x12datasetDisplayName\x1a\xa1\x04\n" +
	...
	"\x14dataset_display_name\x18\x02 \x01(\tB\x03\xe0A\x01R\x12datasetDisplayName\x12\xed\x01\n" +
	"/migrate_data_labeling_annotated_dataset_configs\x18\x03 \x03(\v2\x82\x01.google.cloud.aiplatform.v1beta1.MigrateResourceRequest.MigrateDataLabelingDatasetConfig.MigrateDataLabelingAnnotatedDatasetConfigB\x03\xe0A\x01R*migrateDataLabelingAnnotatedDatasetConfigs\x1a\x8e\x01\n" +
	...
	"\arequest\"\x97\x01\n" +
	"\x1dBatchMigrateResourcesResponse\x12v\n" +
	"\x1amigrate_resource_responses\x18\x01 \x03(\v28.google.cloud.aiplatform.v1beta1.MigrateResourceResponseR\x18migrateResourceResponses\"\x96\x02\n" +
	...
	"\x1faiplatform.googleapis.com/ModelH\x00R\x05model\x12d\n" +
	"\x13migratable_resource\x18\x03 \x01(\v23.google.cloud.aiplatform.v1beta1.MigratableResourceR\x12migratableResourceB\x13\n" +
	"\x11migrated_resource\"\xab\x04\n" +
	"&BatchMigrateResourcesOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata\x12~\n" +
	"\x0fpartial_results\x18\x02 \x03(\v2U.google.cloud.aiplatform.v1beta1.BatchMigrateResourcesOperationMetadata.PartialResultR\x0epartialResults\x1a\x9a\x02\n" +
	"\rPartialResult\x12*\n" +
	...
	"!aiplatform.googleapis.com/DatasetH\x00R\adataset\x12Q\n" +
	"\arequest\x18\x01 \x01(\v27.google.cloud.aiplatform.v1beta1.MigrateResourceRequestR\arequestB\b\n" +
	"\x06result2\x9b\x05\n" +
	"\x10MigrationService\x12\xfb\x01\n" +
	"\x19SearchMigratableResources\x12A.google.cloud.aiplatform.v1beta1.SearchMigratableResourcesRequest\x1aB.google.cloud.aiplatform.v1beta1.SearchMigratableResourcesResponse\"W\xdaA\x06parent\x82\xd3\xe4\x93\x02H:\x01*\"C/v1beta1/{parent=projects/*/locations/*}/migratableResources:search\x12\xb9\x02\n" +
	...
	"\x1dBatchMigrateResourcesResponse\x12&BatchMigrateResourcesOperationMetadata\xdaA parent,migrate_resource_requests\x82\xd3\xe4\x93\x02N:\x01*\"I/v1beta1/{parent=projects/*/locations/*}/migratableResources:batchMigrate\x1aM\xcaA\x19aiplatform.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xec\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_migration_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_migration_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_migration_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_migration_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_migration_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_migration_service_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1beta1_migration_service_proto_goTypes = []any{
...
func file_google_cloud_aiplatform_v1beta1_migration_service_proto_init() {
	...
	file_google_cloud_aiplatform_v1beta1_migration_service_proto_msgTypes[3].OneofWrappers = []any{
	...
	file_google_cloud_aiplatform_v1beta1_migration_service_proto_msgTypes[5].OneofWrappers = []any{
		(*MigrateResourceResponse_Dataset)(nil),
		(*MigrateResourceResponse_Model)(nil),
	}
	file_google_cloud_aiplatform_v1beta1_migration_service_proto_msgTypes[12].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_migration_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_migration_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   1,
