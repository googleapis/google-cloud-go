...
const file_google_cloud_aiplatform_v1beta1_machine_resources_proto_rawDesc = "" +
	"\n" +
	"7google/cloud/aiplatform/v1beta1/machine_resources.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a6google/cloud/aiplatform/v1beta1/accelerator_type.proto\x1a:google/cloud/aiplatform/v1beta1/reservation_affinity.proto\x1a\x1egoogle/protobuf/duration.proto\"\x91\x04\n" +
	"\vMachineSpec\x12&\n" +
	"\fmachine_type\x18\x01 \x01(\tB\x03\xe0A\x05R\vmachineType\x12`\n" +
	"\x10accelerator_type\x18\x02 \x01(\x0e20.google.cloud.aiplatform.v1beta1.AcceleratorTypeB\x03\xe0A\x05R\x0facceleratorType\x12+\n" +
	"\x11accelerator_count\x18\x03 \x01(\x05R\x10acceleratorCount\x124\n" +
	"\x12gpu_partition_size\x18\a \x01(\tB\x06\xe0A\x05\xe0A\x01R\x10gpuPartitionSize\x12&\n" +
	"\ftpu_topology\x18\x04 \x01(\tB\x03\xe0A\x05R\vtpuTopology\x12?\n" +
	"\x18multihost_gpu_node_count\x18\x06 \x01(\x05B\x06\xe0A\x05\xe0A\x01R\x15multihostGpuNodeCount\x12o\n" +
	"\x14reservation_affinity\x18\x05 \x01(\v24.google.cloud.aiplatform.v1beta1.ReservationAffinityB\x06\xe0A\x05\xe0A\x01R\x13reservationAffinity\x12;\n" +
	"\x16min_gpu_driver_version\x18\t \x01(\tB\x06\xe0A\x01\xe0A\x05R\x13minGpuDriverVersion\"\xd6\x06\n" +
	"\x12DedicatedResources\x12W\n" +
	"\fmachine_spec\x18\x01 \x01(\v2,.google.cloud.aiplatform.v1beta1.MachineSpecB\x06\xe0A\x02\xe0A\x05R\vmachineSpec\x122\n" +
	"\x11min_replica_count\x18\x02 \x01(\x05B\x06\xe0A\x02\xe0A\x05R\x0fminReplicaCount\x12/\n" +
	"\x11max_replica_count\x18\x03 \x01(\x05B\x03\xe0A\x05R\x0fmaxReplicaCount\x129\n" +
	"\x16required_replica_count\x18\t \x01(\x05B\x03\xe0A\x01R\x14requiredReplicaCount\x127\n" +
	"\x15initial_replica_count\x18\x06 \x01(\x05B\x03\xe0A\x05R\x13initialReplicaCount\x12u\n" +
	"\x18autoscaling_metric_specs\x18\x04 \x03(\v26.google.cloud.aiplatform.v1beta1.AutoscalingMetricSpecB\x03\xe0A\x05R\x16autoscalingMetricSpecs\x12\x17\n" +
	"\x04spot\x18\x05 \x01(\bB\x03\xe0A\x01R\x04spot\x12Q\n" +
	"\n" +
	"flex_start\x18\n" +
	" \x01(\v2*.google.cloud.aiplatform.v1beta1.FlexStartB\x06\xe0A\x05\xe0A\x01R\tflexStart\x12u\n" +
	"\x12scale_to_zero_spec\x18\v \x01(\v2C.google.cloud.aiplatform.v1beta1.DedicatedResources.ScaleToZeroSpecB\x03\xe0A\x01R\x0fscaleToZeroSpec\x1a\xb3\x01\n" +
	"\x0fScaleToZeroSpec\x12L\n" +
	"\x12min_scaleup_period\x18\x01 \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x01R\x10minScaleupPeriod\x12R\n" +
	"\x15idle_scaledown_period\x18\x02 \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x01R\x13idleScaledownPeriod\"v\n" +
	"\x12AutomaticResources\x12/\n" +
	"\x11min_replica_count\x18\x01 \x01(\x05B\x03\xe0A\x05R\x0fminReplicaCount\x12/\n" +
	"\x11max_replica_count\x18\x02 \x01(\x05B\x03\xe0A\x05R\x0fmaxReplicaCount\"\xca\x02\n" +
	"\x17BatchDedicatedResources\x12W\n" +
	"\fmachine_spec\x18\x01 \x01(\v2,.google.cloud.aiplatform.v1beta1.MachineSpecB\x06\xe0A\x02\xe0A\x05R\vmachineSpec\x129\n" +
	"\x16starting_replica_count\x18\x02 \x01(\x05B\x03\xe0A\x05R\x14startingReplicaCount\x12/\n" +
	"\x11max_replica_count\x18\x03 \x01(\x05B\x03\xe0A\x05R\x0fmaxReplicaCount\x12Q\n" +
	"\n" +
	"flex_start\x18\x04 \x01(\v2*.google.cloud.aiplatform.v1beta1.FlexStartB\x06\xe0A\x05\xe0A\x01R\tflexStart\x12\x17\n" +
	"\x04spot\x18\x05 \x01(\bB\x03\xe0A\x01R\x04spot\"\xb7\x02\n" +
	"\x16FullFineTunedResources\x12t\n" +
	"\x0fdeployment_type\x18\x01 \x01(\x0e2F.google.cloud.aiplatform.v1beta1.FullFineTunedResources.DeploymentTypeB\x03\xe0A\x02R\x0edeploymentType\x12@\n" +
	"\x1amodel_inference_unit_count\x18\x02 \x01(\x05B\x03\xe0A\x01R\x17modelInferenceUnitCount\"e\n" +
	"\x0eDeploymentType\x12\x1f\n" +
	"\x1bDEPLOYMENT_TYPE_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14DEPLOYMENT_TYPE_EVAL\x10\x01\x12\x18\n" +
	"\x14DEPLOYMENT_TYPE_PROD\x10\x02\"=\n" +
	"\x11ResourcesConsumed\x12(\n" +
	"\rreplica_hours\x18\x01 \x01(\x01B\x03\xe0A\x03R\freplicaHours\"[\n" +
	"\bDiskSpec\x12$\n" +
	"\x0eboot_disk_type\x18\x01 \x01(\tR\fbootDiskType\x12)\n" +
	"\x11boot_disk_size_gb\x18\x02 \x01(\x05R\x0ebootDiskSizeGb\"S\n" +
	"\x12PersistentDiskSpec\x12\x1b\n" +
	"\tdisk_type\x18\x01 \x01(\tR\bdiskType\x12 \n" +
	"\fdisk_size_gb\x18\x02 \x01(\x03R\n" +
	"diskSizeGb\"f\n" +
	"\bNfsMount\x12\x1b\n" +
	"\x06server\x18\x01 \x01(\tB\x03\xe0A\x02R\x06server\x12\x17\n" +
	"\x04path\x18\x02 \x01(\tB\x03\xe0A\x02R\x04path\x12$\n" +
	"\vmount_point\x18\x03 \x01(\tB\x03\xe0A\x02R\n" +
	"mountPoint\"\xa8\x01\n" +
	"\vLustreMount\x12$\n" +
	"\vinstance_ip\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"instanceIp\x12(\n" +
	"\rvolume_handle\x18\x02 \x01(\tB\x03\xe0A\x02R\fvolumeHandle\x12#\n" +
	"\n" +
	"filesystem\x18\x03 \x01(\tB\x03\xe0A\x02R\n" +
	"filesystem\x12$\n" +
	"\vmount_point\x18\x04 \x01(\tB\x03\xe0A\x02R\n" +
	"mountPoint\"\xb8\x02\n" +
	"\x15AutoscalingMetricSpec\x12$\n" +
	"\vmetric_name\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"metricName\x12\x16\n" +
	"\x06target\x18\x02 \x01(\x05R\x06target\x12\x94\x01\n" +
	"\x19monitored_resource_labels\x18\x03 \x03(\v2S.google.cloud.aiplatform.v1beta1.AutoscalingMetricSpec.MonitoredResourceLabelsEntryB\x03\xe0A\x01R\x17monitoredResourceLabels\x1aJ\n" +
	"\x1cMonitoredResourceLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"@\n" +
	"\x10ShieldedVmConfig\x12,\n" +
	"\x12enable_secure_boot\x18\x01 \x01(\bR\x10enableSecureBoot\"X\n" +
	"\tFlexStart\x12K\n" +
	"\x14max_runtime_duration\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\x12maxRuntimeDurationB\xec\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_machine_resources_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_machine_resources_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_machine_resources_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_machine_resources_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_machine_resources_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_machine_resources_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_machine_resources_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_machine_resources_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_machine_resources_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   0,
