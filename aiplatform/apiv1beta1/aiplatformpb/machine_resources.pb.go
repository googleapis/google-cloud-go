...
func file_google_cloud_aiplatform_v1beta1_machine_resources_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_aiplatform_v1beta1_machine_resources_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_aiplatform_v1beta1_machine_resources_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
