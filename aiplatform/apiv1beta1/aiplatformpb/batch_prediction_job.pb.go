...
const file_google_cloud_aiplatform_v1beta1_batch_prediction_job_proto_rawDesc = "" +
	...
	"\x10model_version_id\x18\x1e \x01(\tB\x03\xe0A\x03R\x0emodelVersionId\x12t\n" +
	"\x19unmanaged_container_model\x18\x1c \x01(\v28.google.cloud.aiplatform.v1beta1.UnmanagedContainerModelR\x17unmanagedContainerModel\x12g\n" +
	"\finput_config\x18\x04 \x01(\v2?.google.cloud.aiplatform.v1beta1.BatchPredictionJob.InputConfigB\x03\xe0A\x02R\vinputConfig\x12k\n" +
	"\x0finstance_config\x18\x1b \x01(\v2B.google.cloud.aiplatform.v1beta1.BatchPredictionJob.InstanceConfigR\x0einstanceConfig\x12A\n" +
	"\x10model_parameters\x18\x05 \x01(\v2\x16.google.protobuf.ValueR\x0fmodelParameters\x12j\n" +
	"\routput_config\x18\x06 \x01(\v2@.google.cloud.aiplatform.v1beta1.BatchPredictionJob.OutputConfigB\x03\xe0A\x02R\foutputConfig\x12i\n" +
	"\x13dedicated_resources\x18\a \x01(\v28.google.cloud.aiplatform.v1beta1.BatchDedicatedResourcesR\x12dedicatedResources\x12'\n" +
	"\x0fservice_account\x18\x1d \x01(\tR\x0eserviceAccount\x12\x86\x01\n" +
	"\x1emanual_batch_tuning_parameters\x18\b \x01(\v2<.google.cloud.aiplatform.v1beta1.ManualBatchTuningParametersB\x03\xe0A\x05R\x1bmanualBatchTuningParameters\x121\n" +
	"\x14generate_explanation\x18\x17 \x01(\bR\x13generateExplanation\x12[\n" +
	"\x10explanation_spec\x18\x19 \x01(\v20.google.cloud.aiplatform.v1beta1.ExplanationSpecR\x0fexplanationSpec\x12d\n" +
	"\voutput_info\x18\t \x01(\v2>.google.cloud.aiplatform.v1beta1.BatchPredictionJob.OutputInfoB\x03\xe0A\x03R\n" +
	"outputInfo\x12D\n" +
	"\x05state\x18\n" +
	...
	"\x10partial_failures\x18\f \x03(\v2\x12.google.rpc.StatusB\x03\xe0A\x03R\x0fpartialFailures\x12f\n" +
	"\x12resources_consumed\x18\r \x01(\v22.google.cloud.aiplatform.v1beta1.ResourcesConsumedB\x03\xe0A\x03R\x11resourcesConsumed\x12`\n" +
	"\x10completion_stats\x18\x0e \x01(\v20.google.cloud.aiplatform.v1beta1.CompletionStatsB\x03\xe0A\x03R\x0fcompletionStats\x12@\n" +
	...
	"updateTime\x12W\n" +
	"\x06labels\x18\x13 \x03(\v2?.google.cloud.aiplatform.v1beta1.BatchPredictionJob.LabelsEntryR\x06labels\x12X\n" +
	"\x0fencryption_spec\x18\x18 \x01(\v2/.google.cloud.aiplatform.v1beta1.EncryptionSpecR\x0eencryptionSpec\x12n\n" +
	"\x17model_monitoring_config\x18\x1a \x01(\v26.google.cloud.aiplatform.v1beta1.ModelMonitoringConfigR\x15modelMonitoringConfig\x12\x87\x01\n" +
	" model_monitoring_stats_anomalies\x18\x1f \x03(\v2>.google.cloud.aiplatform.v1beta1.ModelMonitoringStatsAnomaliesR\x1dmodelMonitoringStatsAnomalies\x12O\n" +
	"\x17model_monitoring_status\x18  \x01(\v2\x12.google.rpc.StatusB\x03\xe0A\x03R\x15modelMonitoringStatus\x12:\n" +
	...
	"\rsatisfies_pzi\x18% \x01(\bB\x03\xe0A\x03R\fsatisfiesPzi\x1a\xfc\x02\n" +
	"\vInputConfig\x12K\n" +
	"\n" +
	"gcs_source\x18\x02 \x01(\v2*.google.cloud.aiplatform.v1beta1.GcsSourceH\x00R\tgcsSource\x12Z\n" +
	"\x0fbigquery_source\x18\x03 \x01(\v2/.google.cloud.aiplatform.v1beta1.BigQuerySourceH\x00R\x0ebigquerySource\x12\x89\x01\n" +
	" vertex_multimodal_dataset_source\x18\x04 \x01(\v2>.google.cloud.aiplatform.v1beta1.VertexMultimodalDatasetSourceH\x00R\x1dvertexMultimodalDatasetSource\x12.\n" +
	...
	"\x0fexcluded_fields\x18\x04 \x03(\tR\x0eexcludedFields\x1a\xb3\x03\n" +
	"\fOutputConfig\x12Z\n" +
	"\x0fgcs_destination\x18\x02 \x01(\v2/.google.cloud.aiplatform.v1beta1.GcsDestinationH\x00R\x0egcsDestination\x12i\n" +
	"\x14bigquery_destination\x18\x03 \x01(\v24.google.cloud.aiplatform.v1beta1.BigQueryDestinationH\x00R\x13bigqueryDestination\x12\x98\x01\n" +
	"%vertex_multimodal_dataset_destination\x18\x06 \x01(\v2C.google.cloud.aiplatform.v1beta1.VertexMultimodalDatasetDestinationH\x00R\"vertexMultimodalDatasetDestination\x122\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_batch_prediction_job_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_batch_prediction_job_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_batch_prediction_job_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_batch_prediction_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_batch_prediction_job_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_batch_prediction_job_proto_rawDesc)))
	})
...
var file_google_cloud_aiplatform_v1beta1_batch_prediction_job_proto_goTypes = []any{
	...
	(*VertexMultimodalDatasetSource)(nil),      // 21: google.cloud.aiplatform.v1beta1.VertexMultimodalDatasetSource
	...
	(*VertexMultimodalDatasetDestination)(nil), // 24: google.cloud.aiplatform.v1beta1.VertexMultimodalDatasetDestination
}
var file_google_cloud_aiplatform_v1beta1_batch_prediction_job_proto_depIdxs = []int32{
	...
	21, // 25: google.cloud.aiplatform.v1beta1.BatchPredictionJob.InputConfig.vertex_multimodal_dataset_source:type_name -> google.cloud.aiplatform.v1beta1.VertexMultimodalDatasetSource
	22, // 26: google.cloud.aiplatform.v1beta1.BatchPredictionJob.OutputConfig.gcs_destination:type_name -> google.cloud.aiplatform.v1beta1.GcsDestination
	23, // 27: google.cloud.aiplatform.v1beta1.BatchPredictionJob.OutputConfig.bigquery_destination:type_name -> google.cloud.aiplatform.v1beta1.BigQueryDestination
	24, // 28: google.cloud.aiplatform.v1beta1.BatchPredictionJob.OutputConfig.vertex_multimodal_dataset_destination:type_name -> google.cloud.aiplatform.v1beta1.VertexMultimodalDatasetDestination
...
func file_google_cloud_aiplatform_v1beta1_batch_prediction_job_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_batch_prediction_job_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_batch_prediction_job_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
