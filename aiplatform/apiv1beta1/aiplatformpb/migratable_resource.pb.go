...
const file_google_cloud_aiplatform_v1beta1_migratable_resource_proto_rawDesc = "" +
	"\n" +
	"9google/cloud/aiplatform/v1beta1/migratable_resource.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8a\f\n" +
	"\x12MigratableResource\x12\x86\x01\n" +
	"\x17ml_engine_model_version\x18\x01 \x01(\v2H.google.cloud.aiplatform.v1beta1.MigratableResource.MlEngineModelVersionB\x03\xe0A\x03H\x00R\x14mlEngineModelVersion\x12i\n" +
	"\fautoml_model\x18\x02 \x01(\v2?.google.cloud.aiplatform.v1beta1.MigratableResource.AutomlModelB\x03\xe0A\x03H\x00R\vautomlModel\x12o\n" +
	"\x0eautoml_dataset\x18\x03 \x01(\v2A.google.cloud.aiplatform.v1beta1.MigratableResource.AutomlDatasetB\x03\xe0A\x03H\x00R\rautomlDataset\x12\x82\x01\n" +
	"\x15data_labeling_dataset\x18\x04 \x01(\v2G.google.cloud.aiplatform.v1beta1.MigratableResource.DataLabelingDatasetB\x03\xe0A\x03H\x00R\x13dataLabelingDataset\x12K\n" +
	...
	"\x14dataset_display_name\x18\x04 \x01(\tR\x12datasetDisplayName\x1a\x81\x04\n" +
	"\x13DataLabelingDataset\x12B\n" +
	"\adataset\x18\x01 \x01(\tB(\xfaA%\n" +
	"#datalabeling.googleapis.com/DatasetR\adataset\x120\n" +
	"\x14dataset_display_name\x18\x04 \x01(\tR\x12datasetDisplayName\x12\xad\x01\n" +
	" data_labeling_annotated_datasets\x18\x03 \x03(\v2d.google.cloud.aiplatform.v1beta1.MigratableResource.DataLabelingDataset.DataLabelingAnnotatedDatasetR\x1ddataLabelingAnnotatedDatasets\x1a\xc3\x01\n" +
	...
	"#com.google.cloud.aiplatform.v1beta1B\x17MigratableResourceProtoP\x01ZCcloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb;aiplatformpb\xaa\x02\x1fGoogle.Cloud.AIPlatform.V1Beta1\xca\x02\x1fGoogle\\Cloud\\AIPlatform\\V1beta1\xea\x02\"Google::Cloud::AIPlatform::V1beta1b\x06proto3"

var (
	file_google_cloud_aiplatform_v1beta1_migratable_resource_proto_rawDescOnce sync.Once
	file_google_cloud_aiplatform_v1beta1_migratable_resource_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_migratable_resource_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_migratable_resource_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_migratable_resource_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_migratable_resource_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_migratable_resource_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_migratable_resource_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_migratable_resource_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_migratable_resource_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
