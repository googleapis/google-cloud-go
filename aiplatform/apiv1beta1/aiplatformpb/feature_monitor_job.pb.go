...
func file_google_cloud_aiplatform_v1beta1_feature_monitor_job_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_aiplatform_v1beta1_feature_monitor_job_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*FeatureMonitorJob); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_google_cloud_aiplatform_v1beta1_feature_monitor_job_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*FeatureMonitorJob_JobSummary); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
