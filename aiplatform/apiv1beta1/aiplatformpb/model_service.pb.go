...
const file_google_cloud_aiplatform_v1beta1_model_service_proto_rawDesc = "" +
	...
	"\bmodel_id\x18\x05 \x01(\tB\x03\xe0A\x01R\amodelId\x12A\n" +
	"\x05model\x18\x02 \x01(\v2&.google.cloud.aiplatform.v1beta1.ModelB\x03\xe0A\x02R\x05model\x12,\n" +
	"\x0fservice_account\x18\x06 \x01(\tB\x03\xe0A\x01R\x0eserviceAccount\"\x84\x01\n" +
	"\x1cUploadModelOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata\"\x80\x01\n" +
	...
	"\x1faiplatform.googleapis.com/ModelR\x04name\"\xe3\x01\n" +
	...
	"\x06models\x18\x01 \x03(\v2&.google.cloud.aiplatform.v1beta1.ModelR\x06models\x12&\n" +
	...
	"\x04step\x18\x03 \x01(\x03R\x04step\"\xa8\x01\n" +
	"#ListModelVersionCheckpointsResponse\x12Y\n" +
	"\vcheckpoints\x18\x01 \x03(\v27.google.cloud.aiplatform.v1beta1.ModelVersionCheckpointR\vcheckpoints\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\x99\x01\n" +
	"\x12UpdateModelRequest\x12A\n" +
	"\x05model\x18\x01 \x01(\v2&.google.cloud.aiplatform.v1beta1.ModelB\x03\xe0A\x02R\x05model\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"\xa7\x01\n" +
	"\x1fUpdateExplanationDatasetRequest\x12=\n" +
	"\x05model\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\n" +
	"\x1faiplatform.googleapis.com/ModelR\x05model\x12E\n" +
	"\bexamples\x18\x02 \x01(\v2).google.cloud.aiplatform.v1beta1.ExamplesR\bexamples\"\x91\x01\n" +
	")UpdateExplanationDatasetOperationMetadata\x12d\n" +
	...
	"\x04name\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\n" +
	"\x1faiplatform.googleapis.com/ModelR\x04name\x12,\n" +
	"\x0fversion_aliases\x18\x02 \x03(\tB\x03\xe0A\x02R\x0eversionAliases\"\xc8\x03\n" +
	"\x12ExportModelRequest\x12;\n" +
	"\x04name\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\n" +
	"\x1faiplatform.googleapis.com/ModelR\x04name\x12j\n" +
	"\routput_config\x18\x02 \x01(\v2@.google.cloud.aiplatform.v1beta1.ExportModelRequest.OutputConfigB\x03\xe0A\x02R\foutputConfig\x1a\x88\x02\n" +
	"\fOutputConfig\x12(\n" +
	"\x10export_format_id\x18\x01 \x01(\tR\x0eexportFormatId\x12b\n" +
	"\x14artifact_destination\x18\x03 \x01(\v2/.google.cloud.aiplatform.v1beta1.GcsDestinationR\x13artifactDestination\x12j\n" +
	"\x11image_destination\x18\x04 \x01(\v2=.google.cloud.aiplatform.v1beta1.ContainerRegistryDestinationR\x10imageDestination\"\xe6\x02\n" +
	"\x1cExportModelOperationMetadata\x12d\n" +
	"\x10generic_metadata\x18\x01 \x01(\v29.google.cloud.aiplatform.v1beta1.GenericOperationMetadataR\x0fgenericMetadata\x12n\n" +
	"\voutput_info\x18\x02 \x01(\v2H.google.cloud.aiplatform.v1beta1.ExportModelOperationMetadata.OutputInfoB\x03\xe0A\x03R\n" +
	"outputInfo\x1ap\n" +
	"\n" +
	"OutputInfo\x123\n" +
	...
	"\x13ExportModelResponse\"\xbb\x03\n" +
	...
	"\x1faiplatform.googleapis.com/ModelR\vsourceModel\x12X\n" +
	"\x0fencryption_spec\x18\x03 \x01(\v2/.google.cloud.aiplatform.v1beta1.EncryptionSpecR\x0eencryptionSpec\x129\n" +
	"\x16custom_service_account\x18\a \x01(\tB\x03\xe0A\x01R\x14customServiceAccountB\x13\n" +
	"\x11destination_model\"\x82\x01\n" +
	"\x1aCopyModelOperationMetadata\x12d\n" +
	...
	"\x05model\x18\x01 \x01(\tB$\xfaA!\n" +
	"\x1faiplatform.googleapis.com/ModelR\x05model\x12-\n" +
	"\x10model_version_id\x18\x02 \x01(\tB\x03\xe0A\x03R\x0emodelVersionId\"\xc1\x01\n" +
	"\x1cImportModelEvaluationRequest\x12?\n" +
	"\x06parent\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\n" +
	"\x1faiplatform.googleapis.com/ModelR\x06parent\x12`\n" +
	"\x10model_evaluation\x18\x02 \x01(\v20.google.cloud.aiplatform.v1beta1.ModelEvaluationB\x03\xe0A\x02R\x0fmodelEvaluation\"\xe8\x01\n" +
	"'BatchImportModelEvaluationSlicesRequest\x12I\n" +
	"\x06parent\x18\x01 \x01(\tB1\xe0A\x02\xfaA+\n" +
	")aiplatform.googleapis.com/ModelEvaluationR\x06parent\x12r\n" +
	"\x17model_evaluation_slices\x18\x02 \x03(\v25.google.cloud.aiplatform.v1beta1.ModelEvaluationSliceB\x03\xe0A\x02R\x15modelEvaluationSlices\"x\n" +
	"(BatchImportModelEvaluationSlicesResponse\x12L\n" +
	" imported_model_evaluation_slices\x18\x01 \x03(\tB\x03\xe0A\x03R\x1dimportedModelEvaluationSlices\"\xe8\x01\n" +
	"&BatchImportEvaluatedAnnotationsRequest\x12N\n" +
	"\x06parent\x18\x01 \x01(\tB6\xe0A\x02\xfaA0\n" +
	".aiplatform.googleapis.com/ModelEvaluationSliceR\x06parent\x12n\n" +
	"\x15evaluated_annotations\x18\x02 \x03(\v24.google.cloud.aiplatform.v1beta1.EvaluatedAnnotationB\x03\xe0A\x02R\x14evaluatedAnnotations\"\x7f\n" +
	...
	"\n" +
	"page_token\x18\x04 \x01(\tR\tpageToken\x127\n" +
	"\tread_mask\x18\x05 \x01(\v2\x1a.google.protobuf.FieldMaskR\breadMask\"\xa5\x01\n" +
	"\x1cListModelEvaluationsResponse\x12]\n" +
	"\x11model_evaluations\x18\x01 \x03(\v20.google.cloud.aiplatform.v1beta1.ModelEvaluationR\x10modelEvaluations\x12&\n" +
	...
	"\n" +
	"page_token\x18\x04 \x01(\tR\tpageToken\x127\n" +
	"\tread_mask\x18\x05 \x01(\v2\x1a.google.protobuf.FieldMaskR\breadMask\"\xba\x01\n" +
	"!ListModelEvaluationSlicesResponse\x12m\n" +
	"\x17model_evaluation_slices\x18\x01 \x03(\v25.google.cloud.aiplatform.v1beta1.ModelEvaluationSliceR\x15modelEvaluationSlices\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xe9\x01\n" +
	"\x14RecommendSpecRequest\x12A\n" +
	"\x06parent\x18\x02 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!locations.googleapis.com/LocationR\x06parent\x12\x1c\n" +
	"\agcs_uri\x18\x01 \x01(\tB\x03\xe0A\x02R\x06gcsUri\x12A\n" +
	"\x1acheck_machine_availability\x18\x03 \x01(\bB\x03\xe0A\x01R\x18checkMachineAvailability\x12-\n" +
	"\x10check_user_quota\x18\x04 \x01(\bB\x03\xe0A\x01R\x0echeckUserQuota\"\xfd\x06\n" +
	"\x15RecommendSpecResponse\x12\"\n" +
	"\n" +
	"base_model\x18\x01 \x01(\tB\x03\xe0A\x03R\tbaseModel\x12t\n" +
	"\x0frecommendations\x18\x03 \x03(\v2E.google.cloud.aiplatform.v1beta1.RecommendSpecResponse.RecommendationB\x03\xe0A\x03R\x0frecommendations\x12n\n" +
	"\x05specs\x18\x02 \x03(\v2S.google.cloud.aiplatform.v1beta1.RecommendSpecResponse.MachineAndModelContainerSpecB\x03\xe0A\x03R\x05specs\x1a\xd5\x01\n" +
	"\x1cMachineAndModelContainerSpec\x12T\n" +
	"\fmachine_spec\x18\x01 \x01(\v2,.google.cloud.aiplatform.v1beta1.MachineSpecB\x03\xe0A\x03R\vmachineSpec\x12_\n" +
	"\x0econtainer_spec\x18\x02 \x01(\v23.google.cloud.aiplatform.v1beta1.ModelContainerSpecB\x03\xe0A\x03R\rcontainerSpec\x1a\x81\x03\n" +
	"\x0eRecommendation\x12\x16\n" +
	"\x06region\x18\x01 \x01(\tR\x06region\x12l\n" +
	"\x04spec\x18\x02 \x01(\v2S.google.cloud.aiplatform.v1beta1.RecommendSpecResponse.MachineAndModelContainerSpecB\x03\xe0A\x03R\x04spec\x12\x7f\n" +
	"\x10user_quota_state\x18\x03 \x01(\x0e2P.google.cloud.aiplatform.v1beta1.RecommendSpecResponse.Recommendation.QuotaStateB\x03\xe0A\x03R\x0euserQuotaState\"h\n" +
	"\n" +
	"QuotaState\x12\x1b\n" +
	...
	"\fModelService\x12\xea\x01\n" +
	"\vUploadModel\x123.google.cloud.aiplatform.v1beta1.UploadModelRequest\x1a\x1d.google.longrunning.Operation\"\x86\x01\xcaA3\n" +
	"\x13UploadModelResponse\x12\x1cUploadModelOperationMetadata\xdaA\fparent,model\x82\xd3\xe4\x93\x02;:\x01*\"6/v1beta1/{parent=projects/*/locations/*}/models:upload\x12\xa4\x01\n" +
	"\bGetModel\x120.google.cloud.aiplatform.v1beta1.GetModelRequest\x1a&.google.cloud.aiplatform.v1beta1.Model\">\xdaA\x04name\x82\xd3\xe4\x93\x021\x12//v1beta1/{name=projects/*/locations/*/models/*}\x12\xb7\x01\n" +
	"\n" +
	...
	"\vUpdateModel\x123.google.cloud.aiplatform.v1beta1.UpdateModelRequest\x1a&.google.cloud.aiplatform.v1beta1.Model\"X\xdaA\x11model,update_mask\x82\xd3\xe4\x93\x02>:\x05model25/v1beta1/{model.name=projects/*/locations/*/models/*}\x12\xaa\x02\n" +
	...
	" UpdateExplanationDatasetResponse\x12)UpdateExplanationDatasetOperationMetadata\xdaA\x05model\x82\xd3\xe4\x93\x02N:\x01*\"I/v1beta1/{model=projects/*/locations/*/models/*}:updateExplanationDataset\x12\xd4\x01\n" +
	"\vDeleteModel\x123.google.cloud.aiplatform.v1beta1.DeleteModelRequest\x1a\x1d.google.longrunning.Operation\"q\xcaA0\n" +
	...
	"\x13MergeVersionAliases\x12;.google.cloud.aiplatform.v1beta1.MergeVersionAliasesRequest\x1a&.google.cloud.aiplatform.v1beta1.Model\"e\xdaA\x14name,version_aliases\x82\xd3\xe4\x93\x02H:\x01*\"C/v1beta1/{name=projects/*/locations/*/models/*}:mergeVersionAliases\x12\xf0\x01\n" +
	"\vExportModel\x123.google.cloud.aiplatform.v1beta1.ExportModelRequest\x1a\x1d.google.longrunning.Operation\"\x8c\x01\xcaA3\n" +
	"\x13ExportModelResponse\x12\x1cExportModelOperationMetadata\xdaA\x12name,output_config\x82\xd3\xe4\x93\x02;:\x01*\"6/v1beta1/{name=projects/*/locations/*/models/*}:export\x12\xe7\x01\n" +
	"\tCopyModel\x121.google.cloud.aiplatform.v1beta1.CopyModelRequest\x1a\x1d.google.longrunning.Operation\"\x87\x01\xcaA/\n" +
	"\x11CopyModelResponse\x12\x1aCopyModelOperationMetadata\xdaA\x13parent,source_model\x82\xd3\xe4\x93\x029:\x01*\"4/v1beta1/{parent=projects/*/locations/*}/models:copy\x12\xf3\x01\n" +
	"\x15ImportModelEvaluation\x12=.google.cloud.aiplatform.v1beta1.ImportModelEvaluationRequest\x1a0.google.cloud.aiplatform.v1beta1.ModelEvaluation\"i\xdaA\x17parent,model_evaluation\x82\xd3\xe4\x93\x02I:\x01*\"D/v1beta1/{parent=projects/*/locations/*/models/*}/evaluations:import\x12\xb7\x02\n" +
	" BatchImportModelEvaluationSlices\x12H.google.cloud.aiplatform.v1beta1.BatchImportModelEvaluationSlicesRequest\x1aI.google.cloud.aiplatform.v1beta1.BatchImportModelEvaluationSlicesResponse\"~\xdaA\x1eparent,model_evaluation_slices\x82\xd3\xe4\x93\x02W:\x01*\"R/v1beta1/{parent=projects/*/locations/*/models/*/evaluations/*}/slices:batchImport\x12\xb4\x02\n" +
	"\x1fBatchImportEvaluatedAnnotations\x12G.google.cloud.aiplatform.v1beta1.BatchImportEvaluatedAnnotationsRequest\x1aH.google.cloud.aiplatform.v1beta1.BatchImportEvaluatedAnnotationsResponse\"~\xdaA\x1cparent,evaluated_annotations\x82\xd3\xe4\x93\x02Y:\x01*\"T/v1beta1/{parent=projects/*/locations/*/models/*/evaluations/*/slices/*}:batchImport\x12\xd0\x01\n" +
	...
	"\rRecommendSpec\x125.google.cloud.aiplatform.v1beta1.RecommendSpecRequest\x1a6.google.cloud.aiplatform.v1beta1.RecommendSpecResponse\"A\x82\xd3\xe4\x93\x02;:\x01*\"6/v1beta1/{parent=projects/*/locations/*}:recommendSpec\x1aM\xcaA\x19aiplatform.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xe8\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_model_service_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_model_service_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_model_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_model_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_model_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_model_service_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_model_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_model_service_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_model_service_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   41,
			NumExtensions: 0,
			NumServices:   1,
