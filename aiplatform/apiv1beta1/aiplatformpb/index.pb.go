...
const file_google_cloud_aiplatform_v1beta1_index_proto_rawDesc = "" +
	...
	"\bmetadata\x18\x06 \x01(\v2\x16.google.protobuf.ValueR\bmetadata\x12a\n" +
	"\x10deployed_indexes\x18\a \x03(\v21.google.cloud.aiplatform.v1beta1.DeployedIndexRefB\x03\xe0A\x03R\x0fdeployedIndexes\x12\x12\n" +
	"\x04etag\x18\b \x01(\tR\x04etag\x12J\n" +
	"\x06labels\x18\t \x03(\v22.google.cloud.aiplatform.v1beta1.Index.LabelsEntryR\x06labels\x12@\n" +
	"\vcreate_time\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12@\n" +
	"\vupdate_time\x18\v \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12Q\n" +
	"\vindex_stats\x18\x0e \x01(\v2+.google.cloud.aiplatform.v1beta1.IndexStatsB\x03\xe0A\x03R\n" +
	"indexStats\x12m\n" +
	"\x13index_update_method\x18\x10 \x01(\x0e28.google.cloud.aiplatform.v1beta1.Index.IndexUpdateMethodB\x03\xe0A\x05R\x11indexUpdateMethod\x12]\n" +
	"\x0fencryption_spec\x18\x11 \x01(\v2/.google.cloud.aiplatform.v1beta1.EncryptionSpecB\x03\xe0A\x05R\x0eencryptionSpec\x12(\n" +
	...
	"\x1faiplatform.googleapis.com/Index\x127projects/{project}/locations/{location}/indexes/{index}\"\xd5\t\n" +
	"\x0eIndexDatapoint\x12&\n" +
	"\fdatapoint_id\x18\x01 \x01(\tB\x03\xe0A\x02R\vdatapointId\x12*\n" +
	"\x0efeature_vector\x18\x02 \x03(\x02B\x03\xe0A\x02R\rfeatureVector\x12o\n" +
	"\x10sparse_embedding\x18\a \x01(\v2?.google.cloud.aiplatform.v1beta1.IndexDatapoint.SparseEmbeddingB\x03\xe0A\x01R\x0fsparseEmbedding\x12^\n" +
	"\trestricts\x18\x04 \x03(\v2;.google.cloud.aiplatform.v1beta1.IndexDatapoint.RestrictionB\x03\xe0A\x01R\trestricts\x12t\n" +
	"\x11numeric_restricts\x18\x06 \x03(\v2B.google.cloud.aiplatform.v1beta1.IndexDatapoint.NumericRestrictionB\x03\xe0A\x01R\x10numericRestricts\x12c\n" +
	"\fcrowding_tag\x18\x05 \x01(\v2;.google.cloud.aiplatform.v1beta1.IndexDatapoint.CrowdingTagB\x03\xe0A\x01R\vcrowdingTag\x12K\n" +
	...
	"\tdeny_list\x18\x03 \x03(\tR\bdenyList\x1a\xf9\x02\n" +
	...
	"\x02op\x18\x05 \x01(\x0e2K.google.cloud.aiplatform.v1beta1.IndexDatapoint.NumericRestriction.OperatorR\x02op\"x\n" +
	"\bOperator\x12\x18\n" +
	...
	"\fshards_count\x18\x02 \x01(\x05B\x03\xe0A\x03R\vshardsCountB\xe1\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_index_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_index_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_index_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_index_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_index_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_index_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_index_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_index_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_index_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
