...
const file_google_cloud_aiplatform_v1beta1_cached_content_proto_rawDesc = "" +
	...
	"\x05model\x18\x02 \x01(\tB\x03\xe0A\x05R\x05model\x12b\n" +
	"\x12system_instruction\x18\x03 \x01(\v2(.google.cloud.aiplatform.v1beta1.ContentB\t\xe0A\x01\xe0A\x05\xe0A\x04R\x11systemInstruction\x12O\n" +
	"\bcontents\x18\x04 \x03(\v2(.google.cloud.aiplatform.v1beta1.ContentB\t\xe0A\x01\xe0A\x05\xe0A\x04R\bcontents\x12F\n" +
	"\x05tools\x18\x05 \x03(\v2%.google.cloud.aiplatform.v1beta1.ToolB\t\xe0A\x01\xe0A\x05\xe0A\x04R\x05tools\x12W\n" +
	"\vtool_config\x18\x06 \x01(\v2+.google.cloud.aiplatform.v1beta1.ToolConfigB\t\xe0A\x01\xe0A\x05\xe0A\x04R\n" +
	"toolConfig\x12@\n" +
	...
	"updateTime\x12h\n" +
	"\x0eusage_metadata\x18\f \x01(\v2<.google.cloud.aiplatform.v1beta1.CachedContent.UsageMetadataB\x03\xe0A\x03R\rusageMetadata\x12`\n" +
	"\x0fencryption_spec\x18\r \x01(\v2/.google.cloud.aiplatform.v1beta1.EncryptionSpecB\x06\xe0A\x04\xe0A\x05R\x0eencryptionSpec\x1a\xe7\x01\n" +
	"\rUsageMetadata\x12*\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_cached_content_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_cached_content_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_cached_content_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_cached_content_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_cached_content_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_cached_content_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_cached_content_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_cached_content_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_cached_content_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
