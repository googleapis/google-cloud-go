...
var file_google_cloud_aiplatform_v1beta1_service_networking_proto_rawDesc = []byte{
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0xed, 0x01, 0x0a, 0x23, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f,
...
var file_google_cloud_aiplatform_v1beta1_service_networking_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_cloud_aiplatform_v1beta1_service_networking_proto_goTypes = []interface{}{
...
func file_google_cloud_aiplatform_v1beta1_service_networking_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_aiplatform_v1beta1_service_networking_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_aiplatform_v1beta1_service_networking_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
