...
const file_google_cloud_aiplatform_v1beta1_service_networking_proto_rawDesc = "" +
	"\n" +
	"8google/cloud/aiplatform/v1beta1/service_networking.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\xa4\x02\n" +
	...
	"\x0fforwarding_rule\x18\x04 \x01(\tB\x03\xe0A\x03R\x0eforwardingRule\x12N\n" +
	"\x05state\x18\x05 \x01(\x0e23.google.cloud.aiplatform.v1beta1.PSCAutomationStateB\x03\xe0A\x03R\x05state\x12(\n" +
	"\rerror_message\x18\x06 \x01(\tB\x03\xe0A\x03R\ferrorMessage\"\x90\x03\n" +
	...
	"\x11project_allowlist\x18\x02 \x03(\tR\x10projectAllowlist\x12o\n" +
	"\x16psc_automation_configs\x18\x03 \x03(\v24.google.cloud.aiplatform.v1beta1.PSCAutomationConfigB\x03\xe0A\x01R\x14pscAutomationConfigs\x12U\n" +
	"%enable_secure_private_service_connect\x18\x04 \x01(\bB\x03\xe0A\x01R!enableSecurePrivateServiceConnect\x122\n" +
	...
	"\rmatch_address\x18\x03 \x01(\tR\fmatchAddress\"\xdd\x01\n" +
	"\x12PscInterfaceConfig\x12_\n" +
	"\x12network_attachment\x18\x01 \x01(\tB0\xe0A\x01\xfaA*\n" +
	"(compute.googleapis.com/NetworkAttachmentR\x11networkAttachment\x12f\n" +
	"\x13dns_peering_configs\x18\x02 \x03(\v21.google.cloud.aiplatform.v1beta1.DnsPeeringConfigB\x03\xe0A\x01R\x11dnsPeeringConfigs\"\x87\x01\n" +
	...
	"\x1bPSC_AUTOMATION_STATE_FAILED\x10\x02B\xe6\x02\xeaAv\n" +
	"(compute.googleapis.com/NetworkAttachment\x12Jprojects/{project}/regions/{region}/networkAttachments/{networkattachment}\n" +
	"#com.google.cloud.aiplatform.v1beta1B\x16ServiceNetworkingProtoP\x01ZCcloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb;aiplatformpb\xaa\x02\x1fGoogle.Cloud.AIPlatform.V1Beta1\xca\x02\x1fGoogle\\Cloud\\AIPlatform\\V1beta1\xea\x02\"Google::Cloud::AIPlatform::V1beta1b\x06proto3"

var (
	file_google_cloud_aiplatform_v1beta1_service_networking_proto_rawDescOnce sync.Once
	file_google_cloud_aiplatform_v1beta1_service_networking_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_service_networking_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_service_networking_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_service_networking_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_service_networking_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_service_networking_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_service_networking_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_service_networking_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_service_networking_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
