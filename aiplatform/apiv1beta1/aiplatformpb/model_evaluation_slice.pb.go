...
type ModelEvaluationSlice_Slice_SliceSpec struct {
	...
	Configs       map[string]*ModelEvaluationSlice_Slice_SliceSpec_SliceConfig `protobuf:"bytes,1,rep,name=configs,proto3" json:"configs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ModelEvaluationSlice_Slice_SliceSpec_SliceConfig) GetValue() *ModelEvaluationSlice_Slice_SliceSpec_Value {
	if x != nil {
		if x, ok := x.Kind.(*ModelEvaluationSlice_Slice_SliceSpec_SliceConfig_Value); ok {
			return x.Value
		}
	}
	return nil
...
func (x *ModelEvaluationSlice_Slice_SliceSpec_SliceConfig) GetRange() *ModelEvaluationSlice_Slice_SliceSpec_Range {
	if x != nil {
		if x, ok := x.Kind.(*ModelEvaluationSlice_Slice_SliceSpec_SliceConfig_Range); ok {
			return x.Range
		}
	}
	return nil
...
func (x *ModelEvaluationSlice_Slice_SliceSpec_SliceConfig) GetAllValues() *wrapperspb.BoolValue {
	if x != nil {
		if x, ok := x.Kind.(*ModelEvaluationSlice_Slice_SliceSpec_SliceConfig_AllValues); ok {
			return x.AllValues
		}
	}
	return nil
...
func (x *ModelEvaluationSlice_Slice_SliceSpec_Value) GetStringValue() string {
	if x != nil {
		if x, ok := x.Kind.(*ModelEvaluationSlice_Slice_SliceSpec_Value_StringValue); ok {
...
func (x *ModelEvaluationSlice_Slice_SliceSpec_Value) GetFloatValue() float32 {
	if x != nil {
		if x, ok := x.Kind.(*ModelEvaluationSlice_Slice_SliceSpec_Value_FloatValue); ok {
			return x.FloatValue
		}
	}
	return 0
...
const file_google_cloud_aiplatform_v1beta1_model_evaluation_slice_proto_rawDesc = "" +
	"\n" +
	"<google/cloud/aiplatform/v1beta1/model_evaluation_slice.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a1google/cloud/aiplatform/v1beta1/explanation.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x95\v\n" +
	"\x14ModelEvaluationSlice\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12V\n" +
	"\x05slice\x18\x02 \x01(\v2;.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice.SliceB\x03\xe0A\x03R\x05slice\x121\n" +
	"\x12metrics_schema_uri\x18\x03 \x01(\tB\x03\xe0A\x03R\x10metricsSchemaUri\x125\n" +
	"\ametrics\x18\x04 \x01(\v2\x16.google.protobuf.ValueB\x03\xe0A\x03R\ametrics\x12@\n" +
	"\vcreate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12c\n" +
	"\x11model_explanation\x18\x06 \x01(\v21.google.cloud.aiplatform.v1beta1.ModelExplanationB\x03\xe0A\x03R\x10modelExplanation\x1a\xe3\x06\n" +
	"\x05Slice\x12!\n" +
	"\tdimension\x18\x01 \x01(\tB\x03\xe0A\x03R\tdimension\x12\x19\n" +
	"\x05value\x18\x02 \x01(\tB\x03\xe0A\x03R\x05value\x12i\n" +
	"\n" +
	"slice_spec\x18\x03 \x01(\v2E.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice.Slice.SliceSpecB\x03\xe0A\x03R\tsliceSpec\x1a\xb0\x05\n" +
	"\tSliceSpec\x12l\n" +
	"\aconfigs\x18\x01 \x03(\v2R.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice.Slice.SliceSpec.ConfigsEntryR\aconfigs\x1a\x9c\x02\n" +
	"\vSliceConfig\x12c\n" +
	"\x05value\x18\x01 \x01(\v2K.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice.Slice.SliceSpec.ValueH\x00R\x05value\x12c\n" +
	"\x05range\x18\x02 \x01(\v2K.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice.Slice.SliceSpec.RangeH\x00R\x05range\x12;\n" +
	"\n" +
	"all_values\x18\x03 \x01(\v2\x1a.google.protobuf.BoolValueH\x00R\tallValuesB\x06\n" +
	"\x04kind\x1a-\n" +
	"\x05Range\x12\x10\n" +
	"\x03low\x18\x01 \x01(\x02R\x03low\x12\x12\n" +
	"\x04high\x18\x02 \x01(\x02R\x04high\x1aW\n" +
	"\x05Value\x12#\n" +
	...
	"\x05value\x18\x02 \x01(\v2Q.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice.Slice.SliceSpec.SliceConfigR\x05value:\x028\x01:\x94\x01\xeaA\x90\x01\n" +
...
var (
	...
	file_google_cloud_aiplatform_v1beta1_model_evaluation_slice_proto_rawDescData []byte
)
...
func file_google_cloud_aiplatform_v1beta1_model_evaluation_slice_proto_rawDescGZIP() []byte {
	file_google_cloud_aiplatform_v1beta1_model_evaluation_slice_proto_rawDescOnce.Do(func() {
		file_google_cloud_aiplatform_v1beta1_model_evaluation_slice_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_model_evaluation_slice_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_model_evaluation_slice_proto_rawDesc)))
	})
...
func file_google_cloud_aiplatform_v1beta1_model_evaluation_slice_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_aiplatform_v1beta1_model_evaluation_slice_proto_rawDesc), len(file_google_cloud_aiplatform_v1beta1_model_evaluation_slice_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
