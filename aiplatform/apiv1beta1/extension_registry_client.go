...
func defaultExtensionRegistryRESTCallOptions() *ExtensionRegistryCallOptions {
	return &ExtensionRegistryCallOptions{
		ImportExtension:    []gax.CallOption{},
		GetExtension:       []gax.CallOption{},
		ListExtensions:     []gax.CallOption{},
...
func NewExtensionRegistryClient(ctx context.Context, opts ...option.ClientOption) (*ExtensionRegistryClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.ImportExtension = append(client.CallOptions.ImportExtension, gax.WithClientMetrics(metrics))
		client.CallOptions.GetExtension = append(client.CallOptions.GetExtension, gax.WithClientMetrics(metrics))
		client.CallOptions.ListExtensions = append(client.CallOptions.ListExtensions, gax.WithClientMetrics(metrics))
		client.CallOptions.UpdateExtension = append(client.CallOptions.UpdateExtension, gax.WithClientMetrics(metrics))
		client.CallOptions.DeleteExtension = append(client.CallOptions.DeleteExtension, gax.WithClientMetrics(metrics))
...
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type extensionRegistryRESTClient struct {
...
//
// A service for managing Vertex AI’s Extension registry.
func NewExtensionRegistryRESTClient(ctx context.Context, opts ...option.ClientOption) (*ExtensionRegistryClient, error) {
	clientOpts := append(defaultExtensionRegistryRESTClientOptions(), opts...)
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		clientOpts = append(clientOpts, internaloption.WithTelemetryAttributes(map[string]string{
			"gcp.client.service":  "aiplatform",
			"gcp.client.version":  getVersionClient(),
	...
	callOpts := defaultExtensionRegistryRESTCallOptions()
	c := &extensionRegistryRESTClient{
		endpoint:    endpoint,
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.ImportExtension = append(callOpts.ImportExtension, gax.WithClientMetrics(metrics))
		callOpts.GetExtension = append(callOpts.GetExtension, gax.WithClientMetrics(metrics))
		callOpts.ListExtensions = append(callOpts.ListExtensions, gax.WithClientMetrics(metrics))
		callOpts.UpdateExtension = append(callOpts.UpdateExtension, gax.WithClientMetrics(metrics))
		callOpts.DeleteExtension = append(callOpts.DeleteExtension, gax.WithClientMetrics(metrics))
	...
	return &ExtensionRegistryClient{internalClient: c, CallOptions: callOpts}, nil
}

func defaultExtensionRegistryRESTClientOptions() []option.ClientOption {
	return []option.ClientOption{
...
// Close closes the connection to the API service. The user should invoke this when
// the client is no longer required.
func (c *extensionRegistryRESTClient) Close() error {
...
func (c *extensionRegistryRESTClient) Connection() *grpc.ClientConn {
	return nil
}
func (c *extensionRegistryGRPCClient) ImportExtension(ctx context.Context, req *aiplatformpb.ImportExtensionRequest, opts ...gax.CallOption) (*ImportExtensionOperation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.aiplatform.v1beta1.ExtensionRegistryService/ImportExtension")
	}
...
func (c *extensionRegistryGRPCClient) GetExtension(ctx context.Context, req *aiplatformpb.GetExtensionRequest, opts ...gax.CallOption) (*aiplatformpb.Extension, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.aiplatform.v1beta1.ExtensionRegistryService/GetExtension")
	}
...
func (c *extensionRegistryGRPCClient) ListExtensions(ctx context.Context, req *aiplatformpb.ListExtensionsRequest, opts ...gax.CallOption) *ExtensionIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.aiplatform.v1beta1.ExtensionRegistryService/ListExtensions")
	}
...
func (c *extensionRegistryGRPCClient) UpdateExtension(ctx context.Context, req *aiplatformpb.UpdateExtensionRequest, opts ...gax.CallOption) (*aiplatformpb.Extension, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.aiplatform.v1beta1.ExtensionRegistryService/UpdateExtension")
	}
...
func (c *extensionRegistryGRPCClient) DeleteExtension(ctx context.Context, req *aiplatformpb.DeleteExtensionRequest, opts ...gax.CallOption) (*DeleteExtensionOperation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.aiplatform.v1beta1.ExtensionRegistryService/DeleteExtension")
	}
...
// ImportExtension imports an Extension.
func (c *extensionRegistryRESTClient) ImportExtension(ctx context.Context, req *aiplatformpb.ImportExtensionRequest, opts ...gax.CallOption) (*ImportExtensionOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetExtension()
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.aiplatform.v1beta1.ExtensionRegistryService/ImportExtension")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1beta1/{parent=projects/*/locations/*}/extensions:import")
	}
...
// GetExtension gets an Extension.
func (c *extensionRegistryRESTClient) GetExtension(ctx context.Context, req *aiplatformpb.GetExtensionRequest, opts ...gax.CallOption) (*aiplatformpb.Extension, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.aiplatform.v1beta1.ExtensionRegistryService/GetExtension")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1beta1/{name=projects/*/locations/*/extensions/*}")
	}
	opts = append((*c.CallOptions).GetExtension[0:len((*c.CallOptions).GetExtension):len((*c.CallOptions).GetExtension)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &aiplatformpb.Extension{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
// ListExtensions lists Extensions in a location.
func (c *extensionRegistryRESTClient) ListExtensions(ctx context.Context, req *aiplatformpb.ListExtensionsRequest, opts ...gax.CallOption) *ExtensionIterator {
	it := &ExtensionIterator{}
	req = proto.Clone(req).(*aiplatformpb.ListExtensionsRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*aiplatformpb.Extension, string, error) {
...
// UpdateExtension updates an Extension.
func (c *extensionRegistryRESTClient) UpdateExtension(ctx context.Context, req *aiplatformpb.UpdateExtensionRequest, opts ...gax.CallOption) (*aiplatformpb.Extension, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetExtension()
	jsonReq, err := m.Marshal(body)
	if err != nil {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.aiplatform.v1beta1.ExtensionRegistryService/UpdateExtension")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1beta1/{extension.name=projects/*/locations/*/extensions/*}")
	}
	opts = append((*c.CallOptions).UpdateExtension[0:len((*c.CallOptions).UpdateExtension):len((*c.CallOptions).UpdateExtension)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &aiplatformpb.Extension{}
...
// DeleteExtension deletes an Extension.
func (c *extensionRegistryRESTClient) DeleteExtension(ctx context.Context, req *aiplatformpb.DeleteExtensionRequest, opts ...gax.CallOption) (*DeleteExtensionOperation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// GetLocation gets information about a location.
func (c *extensionRegistryRESTClient) GetLocation(ctx context.Context, req *locationpb.GetLocationRequest, opts ...gax.CallOption) (*locationpb.Location, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// ListLocations lists information about the supported locations for this service.
func (c *extensionRegistryRESTClient) ListLocations(ctx context.Context, req *locationpb.ListLocationsRequest, opts ...gax.CallOption) *LocationIterator {
	it := &LocationIterator{}
	req = proto.Clone(req).(*locationpb.ListLocationsRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*locationpb.Location, string, error) {
...
// GetIamPolicy gets the access control policy for a resource. Returns an empty policy
// if the resource exists and does not have a policy set.
func (c *extensionRegistryRESTClient) GetIamPolicy(ctx context.Context, req *iampb.GetIamPolicyRequest, opts ...gax.CallOption) (*iampb.Policy, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
...
// Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED
// errors.
func (c *extensionRegistryRESTClient) SetIamPolicy(ctx context.Context, req *iampb.SetIamPolicyRequest, opts ...gax.CallOption) (*iampb.Policy, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
...
// permission-aware UIs and command-line tools, not for authorization
// checking. This operation may “fail open” without warning.
func (c *extensionRegistryRESTClient) TestIamPermissions(ctx context.Context, req *iampb.TestIamPermissionsRequest, opts ...gax.CallOption) (*iampb.TestIamPermissionsResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
...
// CancelOperation is a utility method from google.longrunning.Operations.
func (c *extensionRegistryRESTClient) CancelOperation(ctx context.Context, req *longrunningpb.CancelOperationRequest, opts ...gax.CallOption) error {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return err
	}
...
// DeleteOperation is a utility method from google.longrunning.Operations.
func (c *extensionRegistryRESTClient) DeleteOperation(ctx context.Context, req *longrunningpb.DeleteOperationRequest, opts ...gax.CallOption) error {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return err
	}
...
// GetOperation is a utility method from google.longrunning.Operations.
func (c *extensionRegistryRESTClient) GetOperation(ctx context.Context, req *longrunningpb.GetOperationRequest, opts ...gax.CallOption) (*longrunningpb.Operation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// ListOperations is a utility method from google.longrunning.Operations.
func (c *extensionRegistryRESTClient) ListOperations(ctx context.Context, req *longrunningpb.ListOperationsRequest, opts ...gax.CallOption) *OperationIterator {
	it := &OperationIterator{}
	req = proto.Clone(req).(*longrunningpb.ListOperationsRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*longrunningpb.Operation, string, error) {
...
// WaitOperation is a utility method from google.longrunning.Operations.
func (c *extensionRegistryRESTClient) WaitOperation(ctx context.Context, req *longrunningpb.WaitOperationRequest, opts ...gax.CallOption) (*longrunningpb.Operation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// DeleteExtensionOperation returns a new DeleteExtensionOperation from a given name.
// The name must be that of a previously created DeleteExtensionOperation, possibly from a different process.
func (c *extensionRegistryRESTClient) DeleteExtensionOperation(name string) *DeleteExtensionOperation {
...
// ImportExtensionOperation returns a new ImportExtensionOperation from a given name.
// The name must be that of a previously created ImportExtensionOperation, possibly from a different process.
func (c *extensionRegistryRESTClient) ImportExtensionOperation(name string) *ImportExtensionOperation {
	override := fmt.Sprintf("/ui/%s", name)
	return &ImportExtensionOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
