...
func NewMatchClient(ctx context.Context, opts ...option.ClientOption) (*MatchClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.FindNeighbors = append(client.CallOptions.FindNeighbors, gax.WithClientMetrics(metrics))
		client.CallOptions.ReadIndexDatapoints = append(client.CallOptions.ReadIndexDatapoints, gax.WithClientMetrics(metrics))
...
func NewMatchRESTClient(ctx context.Context, opts ...option.ClientOption) (*MatchClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.FindNeighbors = append(callOpts.FindNeighbors, gax.WithClientMetrics(metrics))
		callOpts.ReadIndexDatapoints = append(callOpts.ReadIndexDatapoints, gax.WithClientMetrics(metrics))
...
func (c *matchGRPCClient) FindNeighbors(ctx context.Context, req *aiplatformpb.FindNeighborsRequest, opts ...gax.CallOption) (*aiplatformpb.FindNeighborsResponse, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.aiplatform.v1beta1.MatchService/FindNeighbors")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.matchClient.FindNeighbors, req, settings.GRPC, c.logger, "FindNeighbors")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *matchGRPCClient) ReadIndexDatapoints(ctx context.Context, req *aiplatformpb.ReadIndexDatapointsRequest, opts ...gax.CallOption) (*aiplatformpb.ReadIndexDatapointsResponse, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.aiplatform.v1beta1.MatchService/ReadIndexDatapoints")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.matchClient.ReadIndexDatapoints, req, settings.GRPC, c.logger, "ReadIndexDatapoints")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *matchRESTClient) FindNeighbors(ctx context.Context, req *aiplatformpb.FindNeighborsRequest, opts ...gax.CallOption) (*aiplatformpb.FindNeighborsResponse, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.aiplatform.v1beta1.MatchService/FindNeighbors")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1beta1/{index_endpoint=projects/*/locations/*/indexEndpoints/*}:findNeighbors")
	}
	opts = append((*c.CallOptions).FindNeighbors[0:len((*c.CallOptions).FindNeighbors):len((*c.CallOptions).FindNeighbors)], opts...)
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "FindNeighbors")
		if err != nil {
			return err
		}
...
func (c *matchRESTClient) ReadIndexDatapoints(ctx context.Context, req *aiplatformpb.ReadIndexDatapointsRequest, opts ...gax.CallOption) (*aiplatformpb.ReadIndexDatapointsResponse, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.aiplatform.v1beta1.MatchService/ReadIndexDatapoints")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v1beta1/{index_endpoint=projects/*/locations/*/indexEndpoints/*}:readIndexDatapoints")
	}
	opts = append((*c.CallOptions).ReadIndexDatapoints[0:len((*c.CallOptions).ReadIndexDatapoints):len((*c.CallOptions).ReadIndexDatapoints)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "ReadIndexDatapoints")
		if err != nil {
			return err
		}
