...
// [START configdelivery_v1_generated_ConfigDelivery_CreateResourceBundle_sync]
...
func main() {
	...
	req := &configdeliverypb.CreateResourceBundleRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/configdelivery/apiv1/configdeliverypb#CreateResourceBundleRequest.
	}
