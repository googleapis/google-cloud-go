...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/workloadmanager.svg)](https://pkg.go.dev/cloud.google.com/go/workloadmanager)

Go Client Library for Workload Manager API.

## Install

```bash
go get cloud.google.com/go/workloadmanager
```
