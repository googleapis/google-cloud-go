...
const file_google_cloud_apiregistry_v1beta_resources_proto_rawDesc = "" +
	"\n" +
	"/google/cloud/apiregistry/v1beta/resources.proto\x12\x1fgoogle.cloud.apiregistry.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a,google/cloud/apiregistry/v1beta/common.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xf0\x03\n" +
	"\tMcpServer\x12\x17\n" +
	...
	"\fcapabilities\x18\x06 \x01(\v2\x17.google.protobuf.StructR\fcapabilities\x12A\n" +
	"\x05state\x18\a \x01(\x0e2&.google.cloud.apiregistry.v1beta.StateB\x03\xe0A\x03R\x05state:\xe6\x01\xeaA\xe2\x01\n" +
	...
	"'cloudapiregistry.googleapis.com/McpTool\x12qprojects/{project}/locations/{location}/apiNamespaces/{api_namespace}/mcpServers/{mcp_server}/mcpTools/{mcp_tool}\x12Sprojects/{project}/locations/{location}/mcpServers/{mcp_server}/mcpTools/{mcp_tool}*\bmcpTools2\amcpToolB\xe7\x01\n" +
...
var (
	...
	file_google_cloud_apiregistry_v1beta_resources_proto_rawDescData []byte
)
...
func file_google_cloud_apiregistry_v1beta_resources_proto_rawDescGZIP() []byte {
	file_google_cloud_apiregistry_v1beta_resources_proto_rawDescOnce.Do(func() {
		file_google_cloud_apiregistry_v1beta_resources_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_apiregistry_v1beta_resources_proto_rawDesc), len(file_google_cloud_apiregistry_v1beta_resources_proto_rawDesc)))
	})
...
func file_google_cloud_apiregistry_v1beta_resources_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_apiregistry_v1beta_resources_proto_rawDesc), len(file_google_cloud_apiregistry_v1beta_resources_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
