...
func (ConversionEvent_ConversionCountingMethod) EnumDescriptor() ([]byte, []int) {
	return file_google_analytics_admin_v1alpha_resources_proto_rawDescGZIP(), []int{18, 0}
}
...
type BigQueryLink struct {
	...
	EnterpriseExportEnabled bool `protobuf:"varint,9,opt,name=enterprise_export_enabled,json=enterpriseExportEnabled,proto3" json:"enterprise_export_enabled,omitempty"`
...
func (x *BigQueryLink) GetEnterpriseExportEnabled() bool {
	if x != nil {
		return x.EnterpriseExportEnabled
	}
	return false
}
...
var file_google_analytics_admin_v1alpha_resources_proto_rawDesc = []byte{
	...
	0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x22, 0x9c, 0x04, 0x0a,
	...
	0x6c, 0x65, 0x64, 0x12, 0x3a, 0x0a, 0x19, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73,
	0x65, 0x5f, 0x65, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64,
	0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x17, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69,
	0x73, 0x65, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x12,
...
var file_google_analytics_admin_v1alpha_resources_proto_enumTypes = make([]protoimpl.EnumInfo, 21)
...
var file_google_analytics_admin_v1alpha_resources_proto_goTypes = []interface{}{
	...
	(ConversionEvent_ConversionCountingMethod)(0),                     // 11: google.analytics.admin.v1alpha.ConversionEvent.ConversionCountingMethod
	(CustomDimension_DimensionScope)(0),                               // 12: google.analytics.admin.v1alpha.CustomDimension.DimensionScope
	(CustomMetric_MeasurementUnit)(0),                                 // 13: google.analytics.admin.v1alpha.CustomMetric.MeasurementUnit
	(CustomMetric_MetricScope)(0),                                     // 14: google.analytics.admin.v1alpha.CustomMetric.MetricScope
	(CustomMetric_RestrictedMetricType)(0),                            // 15: google.analytics.admin.v1alpha.CustomMetric.RestrictedMetricType
	(DataRetentionSettings_RetentionDuration)(0),                      // 16: google.analytics.admin.v1alpha.DataRetentionSettings.RetentionDuration
	(AttributionSettings_AcquisitionConversionEventLookbackWindow)(0), // 17: google.analytics.admin.v1alpha.AttributionSettings.AcquisitionConversionEventLookbackWindow
	(AttributionSettings_OtherConversionEventLookbackWindow)(0),       // 18: google.analytics.admin.v1alpha.AttributionSettings.OtherConversionEventLookbackWindow
	(AttributionSettings_ReportingAttributionModel)(0),                // 19: google.analytics.admin.v1alpha.AttributionSettings.ReportingAttributionModel
	(AttributionSettings_AdsWebConversionDataExportScope)(0),          // 20: google.analytics.admin.v1alpha.AttributionSettings.AdsWebConversionDataExportScope
	(*Account)(nil),                                                   // 21: google.analytics.admin.v1alpha.Account
	(*Property)(nil),                                                  // 22: google.analytics.admin.v1alpha.Property
	(*DataStream)(nil),                                                // 23: google.analytics.admin.v1alpha.DataStream
	(*UserLink)(nil),                                                  // 24: google.analytics.admin.v1alpha.UserLink
	(*AuditUserLink)(nil),                                             // 25: google.analytics.admin.v1alpha.AuditUserLink
	(*FirebaseLink)(nil),                                              // 26: google.analytics.admin.v1alpha.FirebaseLink
	(*GlobalSiteTag)(nil),                                             // 27: google.analytics.admin.v1alpha.GlobalSiteTag
	(*GoogleAdsLink)(nil),                                             // 28: google.analytics.admin.v1alpha.GoogleAdsLink
	(*DataSharingSettings)(nil),                                       // 29: google.analytics.admin.v1alpha.DataSharingSettings
	(*AccountSummary)(nil),                                            // 30: google.analytics.admin.v1alpha.AccountSummary
	(*PropertySummary)(nil),                                           // 31: google.analytics.admin.v1alpha.PropertySummary
	(*MeasurementProtocolSecret)(nil),                                 // 32: google.analytics.admin.v1alpha.MeasurementProtocolSecret
	(*ChangeHistoryEvent)(nil),                                        // 33: google.analytics.admin.v1alpha.ChangeHistoryEvent
	(*ChangeHistoryChange)(nil),                                       // 34: google.analytics.admin.v1alpha.ChangeHistoryChange
	(*DisplayVideo360AdvertiserLink)(nil),                             // 35: google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLink
	(*DisplayVideo360AdvertiserLinkProposal)(nil),                     // 36: google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLinkProposal
	(*SearchAds360Link)(nil),                                          // 37: google.analytics.admin.v1alpha.SearchAds360Link
	(*LinkProposalStatusDetails)(nil),                                 // 38: google.analytics.admin.v1alpha.LinkProposalStatusDetails
	(*ConversionEvent)(nil),                                           // 39: google.analytics.admin.v1alpha.ConversionEvent
	(*GoogleSignalsSettings)(nil),                                     // 40: google.analytics.admin.v1alpha.GoogleSignalsSettings
	(*CustomDimension)(nil),                                           // 41: google.analytics.admin.v1alpha.CustomDimension
	(*CustomMetric)(nil),                                              // 42: google.analytics.admin.v1alpha.CustomMetric
	(*DataRetentionSettings)(nil),                                     // 43: google.analytics.admin.v1alpha.DataRetentionSettings
	(*AttributionSettings)(nil),                                       // 44: google.analytics.admin.v1alpha.AttributionSettings
	(*AccessBinding)(nil),                                             // 45: google.analytics.admin.v1alpha.AccessBinding
	(*BigQueryLink)(nil),                                              // 46: google.analytics.admin.v1alpha.BigQueryLink
	(*EnhancedMeasurementSettings)(nil),                               // 47: google.analytics.admin.v1alpha.EnhancedMeasurementSettings
	(*ConnectedSiteTag)(nil),                                          // 48: google.analytics.admin.v1alpha.ConnectedSiteTag
	(*AdSenseLink)(nil),                                               // 49: google.analytics.admin.v1alpha.AdSenseLink
	(*DataStream_WebStreamData)(nil),                                  // 50: google.analytics.admin.v1alpha.DataStream.WebStreamData
	(*DataStream_AndroidAppStreamData)(nil),                           // 51: google.analytics.admin.v1alpha.DataStream.AndroidAppStreamData
	(*DataStream_IosAppStreamData)(nil),                               // 52: google.analytics.admin.v1alpha.DataStream.IosAppStreamData
	(*ChangeHistoryChange_ChangeHistoryResource)(nil),                 // 53: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource
	(*timestamppb.Timestamp)(nil),                                     // 54: google.protobuf.Timestamp
	(*wrapperspb.BoolValue)(nil),                                      // 55: google.protobuf.BoolValue
	(*ExpandedDataSet)(nil),                                           // 56: google.analytics.admin.v1alpha.ExpandedDataSet
	(*ChannelGroup)(nil),                                              // 57: google.analytics.admin.v1alpha.ChannelGroup
	(*Audience)(nil),                                                  // 58: google.analytics.admin.v1alpha.Audience
	(*EventCreateRule)(nil),                                           // 59: google.analytics.admin.v1alpha.EventCreateRule
}
var file_google_analytics_admin_v1alpha_resources_proto_depIdxs = []int32{
	54, // 0: google.analytics.admin.v1alpha.Account.create_time:type_name -> google.protobuf.Timestamp
	54, // 1: google.analytics.admin.v1alpha.Account.update_time:type_name -> google.protobuf.Timestamp
	9,  // 2: google.analytics.admin.v1alpha.Property.property_type:type_name -> google.analytics.admin.v1alpha.PropertyType
	54, // 3: google.analytics.admin.v1alpha.Property.create_time:type_name -> google.protobuf.Timestamp
	54, // 4: google.analytics.admin.v1alpha.Property.update_time:type_name -> google.protobuf.Timestamp
	...
	54, // 7: google.analytics.admin.v1alpha.Property.delete_time:type_name -> google.protobuf.Timestamp
	54, // 8: google.analytics.admin.v1alpha.Property.expire_time:type_name -> google.protobuf.Timestamp
	50, // 9: google.analytics.admin.v1alpha.DataStream.web_stream_data:type_name -> google.analytics.admin.v1alpha.DataStream.WebStreamData
	51, // 10: google.analytics.admin.v1alpha.DataStream.android_app_stream_data:type_name -> google.analytics.admin.v1alpha.DataStream.AndroidAppStreamData
	52, // 11: google.analytics.admin.v1alpha.DataStream.ios_app_stream_data:type_name -> google.analytics.admin.v1alpha.DataStream.IosAppStreamData
	10, // 12: google.analytics.admin.v1alpha.DataStream.type:type_name -> google.analytics.admin.v1alpha.DataStream.DataStreamType
	54, // 13: google.analytics.admin.v1alpha.DataStream.create_time:type_name -> google.protobuf.Timestamp
	54, // 14: google.analytics.admin.v1alpha.DataStream.update_time:type_name -> google.protobuf.Timestamp
	54, // 15: google.analytics.admin.v1alpha.FirebaseLink.create_time:type_name -> google.protobuf.Timestamp
	55, // 16: google.analytics.admin.v1alpha.GoogleAdsLink.ads_personalization_enabled:type_name -> google.protobuf.BoolValue
	54, // 17: google.analytics.admin.v1alpha.GoogleAdsLink.create_time:type_name -> google.protobuf.Timestamp
	54, // 18: google.analytics.admin.v1alpha.GoogleAdsLink.update_time:type_name -> google.protobuf.Timestamp
	31, // 19: google.analytics.admin.v1alpha.AccountSummary.property_summaries:type_name -> google.analytics.admin.v1alpha.PropertySummary
	9,  // 20: google.analytics.admin.v1alpha.PropertySummary.property_type:type_name -> google.analytics.admin.v1alpha.PropertyType
	54, // 21: google.analytics.admin.v1alpha.ChangeHistoryEvent.change_time:type_name -> google.protobuf.Timestamp
	2,  // 22: google.analytics.admin.v1alpha.ChangeHistoryEvent.actor_type:type_name -> google.analytics.admin.v1alpha.ActorType
	34, // 23: google.analytics.admin.v1alpha.ChangeHistoryEvent.changes:type_name -> google.analytics.admin.v1alpha.ChangeHistoryChange
	3,  // 24: google.analytics.admin.v1alpha.ChangeHistoryChange.action:type_name -> google.analytics.admin.v1alpha.ActionType
	53, // 25: google.analytics.admin.v1alpha.ChangeHistoryChange.resource_before_change:type_name -> google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource
	53, // 26: google.analytics.admin.v1alpha.ChangeHistoryChange.resource_after_change:type_name -> google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource
	55, // 27: google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLink.ads_personalization_enabled:type_name -> google.protobuf.BoolValue
	55, // 28: google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLink.campaign_data_sharing_enabled:type_name -> google.protobuf.BoolValue
	55, // 29: google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLink.cost_data_sharing_enabled:type_name -> google.protobuf.BoolValue
	38, // 30: google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLinkProposal.link_proposal_status_details:type_name -> google.analytics.admin.v1alpha.LinkProposalStatusDetails
	55, // 31: google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLinkProposal.ads_personalization_enabled:type_name -> google.protobuf.BoolValue
	55, // 32: google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLinkProposal.campaign_data_sharing_enabled:type_name -> google.protobuf.BoolValue
	55, // 33: google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLinkProposal.cost_data_sharing_enabled:type_name -> google.protobuf.BoolValue
	55, // 34: google.analytics.admin.v1alpha.SearchAds360Link.campaign_data_sharing_enabled:type_name -> google.protobuf.BoolValue
	55, // 35: google.analytics.admin.v1alpha.SearchAds360Link.cost_data_sharing_enabled:type_name -> google.protobuf.BoolValue
	55, // 36: google.analytics.admin.v1alpha.SearchAds360Link.ads_personalization_enabled:type_name -> google.protobuf.BoolValue
	55, // 37: google.analytics.admin.v1alpha.SearchAds360Link.site_stats_sharing_enabled:type_name -> google.protobuf.BoolValue
	...
	54, // 40: google.analytics.admin.v1alpha.ConversionEvent.create_time:type_name -> google.protobuf.Timestamp
	11, // 41: google.analytics.admin.v1alpha.ConversionEvent.counting_method:type_name -> google.analytics.admin.v1alpha.ConversionEvent.ConversionCountingMethod
	5,  // 42: google.analytics.admin.v1alpha.GoogleSignalsSettings.state:type_name -> google.analytics.admin.v1alpha.GoogleSignalsState
	6,  // 43: google.analytics.admin.v1alpha.GoogleSignalsSettings.consent:type_name -> google.analytics.admin.v1alpha.GoogleSignalsConsent
	12, // 44: google.analytics.admin.v1alpha.CustomDimension.scope:type_name -> google.analytics.admin.v1alpha.CustomDimension.DimensionScope
	13, // 45: google.analytics.admin.v1alpha.CustomMetric.measurement_unit:type_name -> google.analytics.admin.v1alpha.CustomMetric.MeasurementUnit
	14, // 46: google.analytics.admin.v1alpha.CustomMetric.scope:type_name -> google.analytics.admin.v1alpha.CustomMetric.MetricScope
	15, // 47: google.analytics.admin.v1alpha.CustomMetric.restricted_metric_type:type_name -> google.analytics.admin.v1alpha.CustomMetric.RestrictedMetricType
	16, // 48: google.analytics.admin.v1alpha.DataRetentionSettings.event_data_retention:type_name -> google.analytics.admin.v1alpha.DataRetentionSettings.RetentionDuration
	17, // 49: google.analytics.admin.v1alpha.AttributionSettings.acquisition_conversion_event_lookback_window:type_name -> google.analytics.admin.v1alpha.AttributionSettings.AcquisitionConversionEventLookbackWindow
	18, // 50: google.analytics.admin.v1alpha.AttributionSettings.other_conversion_event_lookback_window:type_name -> google.analytics.admin.v1alpha.AttributionSettings.OtherConversionEventLookbackWindow
	19, // 51: google.analytics.admin.v1alpha.AttributionSettings.reporting_attribution_model:type_name -> google.analytics.admin.v1alpha.AttributionSettings.ReportingAttributionModel
	20, // 52: google.analytics.admin.v1alpha.AttributionSettings.ads_web_conversion_data_export_scope:type_name -> google.analytics.admin.v1alpha.AttributionSettings.AdsWebConversionDataExportScope
	54, // 53: google.analytics.admin.v1alpha.BigQueryLink.create_time:type_name -> google.protobuf.Timestamp
	21, // 54: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.account:type_name -> google.analytics.admin.v1alpha.Account
	22, // 55: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.property:type_name -> google.analytics.admin.v1alpha.Property
	26, // 56: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.firebase_link:type_name -> google.analytics.admin.v1alpha.FirebaseLink
	28, // 57: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.google_ads_link:type_name -> google.analytics.admin.v1alpha.GoogleAdsLink
	40, // 58: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.google_signals_settings:type_name -> google.analytics.admin.v1alpha.GoogleSignalsSettings
	35, // 59: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.display_video_360_advertiser_link:type_name -> google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLink
	36, // 60: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.display_video_360_advertiser_link_proposal:type_name -> google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLinkProposal
	39, // 61: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.conversion_event:type_name -> google.analytics.admin.v1alpha.ConversionEvent
	32, // 62: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.measurement_protocol_secret:type_name -> google.analytics.admin.v1alpha.MeasurementProtocolSecret
	41, // 63: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.custom_dimension:type_name -> google.analytics.admin.v1alpha.CustomDimension
	42, // 64: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.custom_metric:type_name -> google.analytics.admin.v1alpha.CustomMetric
	43, // 65: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.data_retention_settings:type_name -> google.analytics.admin.v1alpha.DataRetentionSettings
	37, // 66: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.search_ads_360_link:type_name -> google.analytics.admin.v1alpha.SearchAds360Link
	23, // 67: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.data_stream:type_name -> google.analytics.admin.v1alpha.DataStream
	44, // 68: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.attribution_settings:type_name -> google.analytics.admin.v1alpha.AttributionSettings
	56, // 69: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.expanded_data_set:type_name -> google.analytics.admin.v1alpha.ExpandedDataSet
	57, // 70: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.channel_group:type_name -> google.analytics.admin.v1alpha.ChannelGroup
	46, // 71: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.bigquery_link:type_name -> google.analytics.admin.v1alpha.BigQueryLink
	47, // 72: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.enhanced_measurement_settings:type_name -> google.analytics.admin.v1alpha.EnhancedMeasurementSettings
	49, // 73: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.adsense_link:type_name -> google.analytics.admin.v1alpha.AdSenseLink
	58, // 74: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.audience:type_name -> google.analytics.admin.v1alpha.Audience
	59, // 75: google.analytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource.event_create_rule:type_name -> google.analytics.admin.v1alpha.EventCreateRule
