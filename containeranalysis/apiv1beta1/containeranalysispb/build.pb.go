...
func (x *Details) GetProvenance() *BuildProvenance {
	if x != nil {
		return x.Provenance
	}
	return nil
...
var file_google_devtools_containeranalysis_v1beta1_build_build_proto_goTypes = []interface{}{
	...
	(*BuildProvenance)(nil),     // 4: grafeas.v1beta1.provenance.BuildProvenance
}
...
func file_google_devtools_containeranalysis_v1beta1_build_build_proto_init() {
	...
	file_google_devtools_containeranalysis_v1beta1_provenance_provenance_proto_init()
	if !protoimpl.UnsafeEnabled {
