...
type Discovery struct {
	...
	// discovery.
	AnalysisKind NoteKind `protobuf:"varint,1,opt,name=analysis_kind,json=analysisKind,proto3,enum=grafeas.v1beta1.NoteKind" json:"analysis_kind,omitempty"`
}
...
func (x *Discovery) GetAnalysisKind() NoteKind {
	if x != nil {
...
var file_google_devtools_containeranalysis_v1beta1_discovery_discovery_proto_goTypes = []interface{}{
	...
	(NoteKind)(0),                      // 5: grafeas.v1beta1.NoteKind
...
func file_google_devtools_containeranalysis_v1beta1_discovery_discovery_proto_init() {
	...
	file_google_devtools_containeranalysis_v1beta1_common_common_proto_init()
	if !protoimpl.UnsafeEnabled {
