...
const file_google_cloud_deploy_v1_jobrun_notification_payload_proto_rawDesc = "" +
	"\n" +
	"8google/cloud/deploy/v1/jobrun_notification_payload.proto\x12\x16google.cloud.deploy.v1\x1a&google/cloud/deploy/v1/log_enums.proto\"\xb4\x02\n" +
	"\x17JobRunNotificationEvent\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12\x17\n" +
	"\ajob_run\x18\x02 \x01(\tR\x06jobRun\x12!\n" +
	"\fpipeline_uid\x18\x03 \x01(\tR\vpipelineUid\x12\x1f\n" +
	"\vrelease_uid\x18\x04 \x01(\tR\n" +
	"releaseUid\x12\x18\n" +
	"\arelease\x18\b \x01(\tR\arelease\x12\x1f\n" +
	"\vrollout_uid\x18\x05 \x01(\tR\n" +
	"rolloutUid\x12\x18\n" +
	"\arollout\x18\t \x01(\tR\arollout\x12\x1b\n" +
	"\ttarget_id\x18\x06 \x01(\tR\btargetId\x120\n" +
	"\x04type\x18\a \x01(\x0e2\x1c.google.cloud.deploy.v1.TypeR\x04typeBr\n" +
...
var (
	...
	file_google_cloud_deploy_v1_jobrun_notification_payload_proto_rawDescData []byte
)
...
func file_google_cloud_deploy_v1_jobrun_notification_payload_proto_rawDescGZIP() []byte {
	file_google_cloud_deploy_v1_jobrun_notification_payload_proto_rawDescOnce.Do(func() {
		file_google_cloud_deploy_v1_jobrun_notification_payload_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_deploy_v1_jobrun_notification_payload_proto_rawDesc), len(file_google_cloud_deploy_v1_jobrun_notification_payload_proto_rawDesc)))
	})
...
var file_google_cloud_deploy_v1_jobrun_notification_payload_proto_goTypes = []any{
...
func file_google_cloud_deploy_v1_jobrun_notification_payload_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_deploy_v1_jobrun_notification_payload_proto_rawDesc), len(file_google_cloud_deploy_v1_jobrun_notification_payload_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
