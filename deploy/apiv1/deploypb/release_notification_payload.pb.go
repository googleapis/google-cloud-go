...
const file_google_cloud_deploy_v1_release_notification_payload_proto_rawDesc = "" +
	"\n" +
	"9google/cloud/deploy/v1/release_notification_payload.proto\x12\x16google.cloud.deploy.v1\x1a&google/cloud/deploy/v1/log_enums.proto\"\xc4\x01\n" +
	"\x18ReleaseNotificationEvent\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12!\n" +
	"\fpipeline_uid\x18\x04 \x01(\tR\vpipelineUid\x12\x1f\n" +
	"\vrelease_uid\x18\x05 \x01(\tR\n" +
	"releaseUid\x12\x18\n" +
	"\arelease\x18\x02 \x01(\tR\arelease\x120\n" +
	"\x04type\x18\x03 \x01(\x0e2\x1c.google.cloud.deploy.v1.TypeR\x04typeBs\n" +
...
var (
	...
	file_google_cloud_deploy_v1_release_notification_payload_proto_rawDescData []byte
)
...
func file_google_cloud_deploy_v1_release_notification_payload_proto_rawDescGZIP() []byte {
	file_google_cloud_deploy_v1_release_notification_payload_proto_rawDescOnce.Do(func() {
		file_google_cloud_deploy_v1_release_notification_payload_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_deploy_v1_release_notification_payload_proto_rawDesc), len(file_google_cloud_deploy_v1_release_notification_payload_proto_rawDesc)))
	})
...
func file_google_cloud_deploy_v1_release_notification_payload_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_deploy_v1_release_notification_payload_proto_rawDesc), len(file_google_cloud_deploy_v1_release_notification_payload_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
