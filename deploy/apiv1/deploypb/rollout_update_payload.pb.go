...
const file_google_cloud_deploy_v1_rollout_update_payload_proto_rawDesc = "" +
	"\n" +
	"3google/cloud/deploy/v1/rollout_update_payload.proto\x12\x16google.cloud.deploy.v1\x1a&google/cloud/deploy/v1/log_enums.proto\"\xee\x04\n" +
	"\x12RolloutUpdateEvent\x12\x18\n" +
	"\amessage\x18\x06 \x01(\tR\amessage\x12!\n" +
	"\fpipeline_uid\x18\x01 \x01(\tR\vpipelineUid\x12\x1f\n" +
	"\vrelease_uid\x18\x02 \x01(\tR\n" +
	"releaseUid\x12\x18\n" +
	"\arelease\x18\b \x01(\tR\arelease\x12\x18\n" +
	"\arollout\x18\x03 \x01(\tR\arollout\x12\x1b\n" +
	"\ttarget_id\x18\x04 \x01(\tR\btargetId\x120\n" +
	"\x04type\x18\a \x01(\x0e2\x1c.google.cloud.deploy.v1.TypeR\x04type\x12l\n" +
	"\x13rollout_update_type\x18\x05 \x01(\x0e2<.google.cloud.deploy.v1.RolloutUpdateEvent.RolloutUpdateTypeR\x11rolloutUpdateType\"\x88\x02\n" +
	"\x11RolloutUpdateType\x12#\n" +
	"\x1fROLLOUT_UPDATE_TYPE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aPENDING\x10\x01\x12\x13\n" +
	"\x0fPENDING_RELEASE\x10\x02\x12\x0f\n" +
	"\vIN_PROGRESS\x10\x03\x12\x0e\n" +
	"\n" +
	...
	"\tSUCCEEDED\x10\a\x12\n" +
	"\n" +
	"\x06FAILED\x10\b\x12\x15\n" +
	"\x11APPROVAL_REQUIRED\x10\t\x12\f\n" +
	"\bAPPROVED\x10\n" +
	"\x12\f\n" +
	"\bREJECTED\x10\v\x12\x14\n" +
	"\x10ADVANCE_REQUIRED\x10\f\x12\f\n" +
	"\bADVANCED\x10\rBm\n" +
...
var (
	...
	file_google_cloud_deploy_v1_rollout_update_payload_proto_rawDescData []byte
)
...
func file_google_cloud_deploy_v1_rollout_update_payload_proto_rawDescGZIP() []byte {
	file_google_cloud_deploy_v1_rollout_update_payload_proto_rawDescOnce.Do(func() {
		file_google_cloud_deploy_v1_rollout_update_payload_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_deploy_v1_rollout_update_payload_proto_rawDesc), len(file_google_cloud_deploy_v1_rollout_update_payload_proto_rawDesc)))
	})
...
func file_google_cloud_deploy_v1_rollout_update_payload_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_deploy_v1_rollout_update_payload_proto_rawDesc), len(file_google_cloud_deploy_v1_rollout_update_payload_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
