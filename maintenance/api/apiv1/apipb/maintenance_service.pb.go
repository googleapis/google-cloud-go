...
const file_google_cloud_maintenance_api_v1_maintenance_service_proto_rawDesc = "" +
	"\n" +
	...
	"\border_by\x18\x8cR \x01(\tR\aorderBy\"\xca\x01\n" +
	"\x1dSummarizeMaintenancesResponse\x12X\n" +
	"\fmaintenances\x18\x8dR \x03(\v23.google.cloud.maintenance.api.v1.MaintenanceSummaryR\fmaintenances\x12'\n" +
	"\x0fnext_page_token\x18\x8eR \x01(\tR\rnextPageToken\x12&\n" +
	"\vunreachable\x18\x8fR \x03(\tB\x03\xe0A\x06R\vunreachable\"\xf2\a\n" +
	...
	"\vdescription\x18\x03 \x01(\tB\x03\xe0A\x03R\vdescription\x12U\n" +
	"\bcategory\x18\r \x01(\x0e24.google.cloud.maintenance.api.v1.MaintenanceCategoryB\x03\xe0A\x03R\bcategory\x12h\n" +
	...
	" \x01(\bB\x03\xe0A\x03R\x10userControllable\x12T\n" +
	"\bcontrols\x18\x0e \x03(\v23.google.cloud.maintenance.api.v1.MaintenanceControlB\x03\xe0A\x03R\bcontrols\x12T\n" +
	"\x05stats\x18\f \x03(\v29.google.cloud.maintenance.api.v1.MaintenanceSummary.StatsB\x03\xe0A\x03R\x05stats\x1a\x81\x01\n" +
	"\x05Stats\x12\x19\n" +
	"\bgroup_by\x18\x01 \x01(\tR\agroupBy\x12]\n" +
	"\n" +
	"aggregates\x18\x02 \x03(\v2=.google.cloud.maintenance.api.v1.MaintenanceSummary.AggregateR\n" +
	"aggregates\x1a7\n" +
	"\tAggregate\x12\x14\n" +
	"\x05group\x18\x01 \x01(\tR\x05group\x12\x14\n" +
	"\x05count\x18\x02 \x01(\x03R\x05count\"\x86\x10\n" +
	"\x13ResourceMaintenance\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12^\n" +
	"\bresource\x18\x02 \x01(\v2=.google.cloud.maintenance.api.v1.ResourceMaintenance.ResourceB\x03\xe0A\x03R\bresource\x12g\n" +
	"\vmaintenance\x18\x03 \x01(\v2@.google.cloud.maintenance.api.v1.ResourceMaintenance.MaintenanceB\x03\xe0A\x03R\vmaintenance\x12U\n" +
	"\x05state\x18\x04 \x01(\x0e2:.google.cloud.maintenance.api.v1.ResourceMaintenance.StateB\x03\xe0A\x03R\x05state\x12@\n" +
	...
	"\x11user_controllable\x18\f \x01(\bB\x03\xe0A\x03R\x10userControllable\x12T\n" +
	"\bcontrols\x18\r \x03(\v23.google.cloud.maintenance.api.v1.MaintenanceControlB\x03\xe0A\x03R\bcontrols\x12^\n" +
	"\x06labels\x18\xa1Q \x03(\v2@.google.cloud.maintenance.api.v1.ResourceMaintenance.LabelsEntryB\x03\xe0A\x01R\x06labels\x12m\n" +
	"\vannotations\x18\xa2Q \x03(\v2E.google.cloud.maintenance.api.v1.ResourceMaintenance.AnnotationsEntryB\x03\xe0A\x01R\vannotations\x12\x1e\n" +
	...
	"\x04type\x18\x03 \x01(\tB\x03\xe0A\x03R\x04type\x1a\xd1\x01\n" +
	"\vMaintenance\x12)\n" +
	"\x10maintenance_name\x18\x01 \x01(\tR\x0fmaintenanceName\x12\x19\n" +
	"\x05title\x18\x02 \x01(\tB\x03\xe0A\x03R\x05title\x12%\n" +
	"\vdescription\x18\x03 \x01(\tB\x03\xe0A\x03R\vdescription\x12U\n" +
	"\bcategory\x18\x04 \x01(\x0e24.google.cloud.maintenance.api.v1.MaintenanceCategoryB\x03\xe0A\x03R\bcategory\x1a9\n" +
	...
	".maintenance.googleapis.com/ResourceMaintenance\x12Sprojects/{project}/locations/{location}/resourceMaintenances/{resource_maintenance}*\x14resourceMaintenances2\x13resourceMaintenance\"\x80\x02\n" +
	"\x12MaintenanceControl\x12U\n" +
	"\acontrol\x18\x01 \x01(\x0e2;.google.cloud.maintenance.api.v1.MaintenanceControl.ControlR\acontrol\x12\x1b\n" +
	...
	"page_token\x18\x8aR \x01(\tR\tpageToken\x12\x17\n" +
	"\x06filter\x18\x8bR \x01(\tR\x06filter\x12\x1a\n" +
	"\border_by\x18\x8cR \x01(\tR\aorderBy\"\xda\x01\n" +
	" ListResourceMaintenancesResponse\x12j\n" +
	"\x15resource_maintenances\x18\x8dR \x03(\v24.google.cloud.maintenance.api.v1.ResourceMaintenanceR\x14resourceMaintenances\x12'\n" +
	"\x0fnext_page_token\x18\x8eR \x01(\tR\rnextPageToken\x12!\n" +
	...
	"\x0eSERVICE_UPDATE\x10\x032\x92\x06\n" +
	"\vMaintenance\x12\xeb\x01\n" +
	"\x15SummarizeMaintenances\x12=.google.cloud.maintenance.api.v1.SummarizeMaintenancesRequest\x1a>.google.cloud.maintenance.api.v1.SummarizeMaintenancesResponse\"S\xdaA\x06parent\x82\xd3\xe4\x93\x02D\x12B/v1/{parent=projects/*/locations/*}/resourceMaintenances:summarize\x12\xea\x01\n" +
	"\x18ListResourceMaintenances\x12@.google.cloud.maintenance.api.v1.ListResourceMaintenancesRequest\x1aA.google.cloud.maintenance.api.v1.ListResourceMaintenancesResponse\"I\xdaA\x06parent\x82\xd3\xe4\x93\x02:\x128/v1/{parent=projects/*/locations/*}/resourceMaintenances\x12\xd7\x01\n" +
	"\x16GetResourceMaintenance\x12>.google.cloud.maintenance.api.v1.GetResourceMaintenanceRequest\x1a4.google.cloud.maintenance.api.v1.ResourceMaintenance\"G\xdaA\x04name\x82\xd3\xe4\x93\x02:\x128/v1/{name=projects/*/locations/*/resourceMaintenances/*}\x1aN\xcaA\x1amaintenance.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformBo\n" +
...
var (
	...
	file_google_cloud_maintenance_api_v1_maintenance_service_proto_rawDescData []byte
)
...
func file_google_cloud_maintenance_api_v1_maintenance_service_proto_rawDescGZIP() []byte {
	file_google_cloud_maintenance_api_v1_maintenance_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_maintenance_api_v1_maintenance_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_maintenance_api_v1_maintenance_service_proto_rawDesc), len(file_google_cloud_maintenance_api_v1_maintenance_service_proto_rawDesc)))
	})
...
func file_google_cloud_maintenance_api_v1_maintenance_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_maintenance_api_v1_maintenance_service_proto_rawDesc), len(file_google_cloud_maintenance_api_v1_maintenance_service_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   1,
