...
func (it *EventIterator) Next() (*servicehealthpb.Event, error) {
	var item *servicehealthpb.Event
...
// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *OrganizationEventIterator) Next() (*servicehealthpb.OrganizationEvent, error) {
	var item *servicehealthpb.OrganizationEvent
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *OrganizationEventIterator) bufLen() int {
	return len(it.items)
}

func (it *OrganizationEventIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type OrganizationImpactIterator struct {
...
// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *OrganizationImpactIterator) Next() (*servicehealthpb.OrganizationImpact, error) {
	var item *servicehealthpb.OrganizationImpact
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *OrganizationImpactIterator) bufLen() int {
	return len(it.items)
}

func (it *OrganizationImpactIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
