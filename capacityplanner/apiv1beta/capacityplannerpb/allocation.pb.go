...
func (x *Allocation) GetSpecificAllocation() *Allocation_SpecificSKUAllocation {
	if x != nil {
		if x, ok := x.Type.(*Allocation_SpecificAllocation); ok {
...
const file_google_cloud_capacityplanner_v1beta_allocation_proto_rawDesc = "" +
	"\n" +
	"4google/cloud/capacityplanner/v1beta/allocation.proto\x12#google.cloud.capacityplanner.v1beta\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf9\x0f\n" +
	"\n" +
	"Allocation\x12x\n" +
	"\x13specific_allocation\x18\x06 \x01(\v2E.google.cloud.capacityplanner.v1beta.Allocation.SpecificSKUAllocationH\x00R\x12specificAllocation\x12\x0e\n" +
	...
	"\n" +
	"allocation\x18\x05 \x01(\tR\n" +
	"allocation\x12(\n" +
	"\x10owner_project_id\x18\n" +
	" \x01(\tR\x0eownerProjectId\x12N\n" +
	"\x06status\x18\a \x01(\x0e26.google.cloud.capacityplanner.v1beta.Allocation.StatusR\x06status\x12d\n" +
	"\x0eshare_settings\x18\b \x01(\v2=.google.cloud.capacityplanner.v1beta.Allocation.ShareSettingsR\rshareSettings\x12D\n" +
	"\x10auto_delete_time\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\x0eautoDeleteTime\x1a\x9b\b\n" +
	"\x15SpecificSKUAllocation\x12\x92\x01\n" +
	"\x13instance_properties\x18\x01 \x01(\v2a.google.cloud.capacityplanner.v1beta.Allocation.SpecificSKUAllocation.AllocatedInstancePropertiesR\x12instanceProperties\x12\x14\n" +
	"\x05count\x18\x02 \x01(\x03R\x05count\x12\x1d\n" +
	"\n" +
	"used_count\x18\x03 \x01(\x03R\tusedCount\x12#\n" +
	"\rassured_count\x18\x04 \x01(\x03R\fassuredCount\x1a\x92\x06\n" +
	"\x1bAllocatedInstanceProperties\x12!\n" +
	"\fmachine_type\x18\x01 \x01(\tR\vmachineType\x12\xa0\x01\n" +
	"\x11guest_accelerator\x18\x02 \x03(\v2s.google.cloud.capacityplanner.v1beta.Allocation.SpecificSKUAllocation.AllocatedInstanceProperties.AcceleratorConfigR\x10guestAccelerator\x12(\n" +
	"\x10min_cpu_platform\x18\x03 \x01(\tR\x0eminCpuPlatform\x12\x8c\x01\n" +
	"\tlocal_ssd\x18\x04 \x03(\v2o.google.cloud.capacityplanner.v1beta.Allocation.SpecificSKUAllocation.AllocatedInstanceProperties.AllocatedDiskR\blocalSsd\x1a=\n" +
	"\x11AcceleratorConfig\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x14\n" +
	"\x05count\x18\x02 \x01(\x05R\x05count\x1a\xb4\x02\n" +
	"\rAllocatedDisk\x12 \n" +
	"\fdisk_size_gb\x18\x01 \x01(\x03R\n" +
	"diskSizeGb\x12\xa4\x01\n" +
	"\x0edisk_interface\x18\x02 \x01(\x0e2}.google.cloud.capacityplanner.v1beta.Allocation.SpecificSKUAllocation.AllocatedInstanceProperties.AllocatedDisk.DiskInterfaceR\rdiskInterface\"Z\n" +
	...
	"\x05ISCSI\x10\x04\x1a\x9d\x02\n" +
	"\rShareSettings\x12f\n" +
	"\n" +
	"share_type\x18\x01 \x01(\x0e2G.google.cloud.capacityplanner.v1beta.Allocation.ShareSettings.ShareTypeR\tshareType\x12\x1a\n" +
	"\bprojects\x18\x02 \x03(\tR\bprojects\"\x87\x01\n" +
	"\tShareType\x12\x1a\n" +
	"\x16SHARE_TYPE_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fORGANIZATION\x10\x01\x12\x15\n" +
...
var (
	...
	file_google_cloud_capacityplanner_v1beta_allocation_proto_rawDescData []byte
)
...
func file_google_cloud_capacityplanner_v1beta_allocation_proto_rawDescGZIP() []byte {
	file_google_cloud_capacityplanner_v1beta_allocation_proto_rawDescOnce.Do(func() {
		file_google_cloud_capacityplanner_v1beta_allocation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_capacityplanner_v1beta_allocation_proto_rawDesc), len(file_google_cloud_capacityplanner_v1beta_allocation_proto_rawDesc)))
	})
...
func file_google_cloud_capacityplanner_v1beta_allocation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_capacityplanner_v1beta_allocation_proto_rawDesc), len(file_google_cloud_capacityplanner_v1beta_allocation_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
