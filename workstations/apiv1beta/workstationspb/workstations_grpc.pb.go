...
const (
	...
	Workstations_PushCredentials_FullMethodName              = "/google.cloud.workstations.v1beta.Workstations/PushCredentials"
)
...
type WorkstationsClient interface {
	...
	PushCredentials(ctx context.Context, in *PushCredentialsRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error)
}
...
func (c *workstationsClient) PushCredentials(ctx context.Context, in *PushCredentialsRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, Workstations_PushCredentials_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WorkstationsServer interface {
	...
	// complete, supported credential types (application_default_credentials) are
	// made available to processes running in the user container.
	PushCredentials(context.Context, *PushCredentialsRequest) (*longrunningpb.Operation, error)
}
...
func (UnimplementedWorkstationsServer) PushCredentials(context.Context, *PushCredentialsRequest) (*longrunningpb.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PushCredentials not implemented")
}
...
func _Workstations_PushCredentials_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PushCredentialsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkstationsServer).PushCredentials(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Workstations_PushCredentials_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkstationsServer).PushCredentials(ctx, req.(*PushCredentialsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Workstations_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PushCredentials",
			Handler:    _Workstations_PushCredentials_Handler,
		},
	},
