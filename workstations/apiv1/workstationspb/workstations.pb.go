...
const file_google_cloud_workstations_v1_workstations_proto_rawDesc = "" +
	"\n" +
	"/google/cloud/workstations/v1/workstations.proto\x12\x1cgoogle.cloud.workstations.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a#google/longrunning/operations.proto\x1a\x1egoogle/protobuf/duration.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\xa4\v\n" +
	...
	"\x16private_cluster_config\x18\f \x01(\v2E.google.cloud.workstations.v1.WorkstationCluster.PrivateClusterConfigB\x03\xe0A\x01R\x14privateClusterConfig\x12\x1f\n" +
	...
	".workstations.googleapis.com/WorkstationCluster\x12Qprojects/{project}/locations/{location}/workstationClusters/{workstation_cluster}*\x13workstationClusters2\x12workstationClusterR\x01\x01\"\x99\x1f\n" +
	...
	"\x0frunning_timeout\x18\v \x01(\v2\x19.google.protobuf.DurationB\x03\xe0A\x01R\x0erunningTimeout\x12M\n" +
	...
	"conditions\x1a\xa4\t\n" +
	"\x04Host\x12e\n" +
	"\fgce_instance\x18\x01 \x01(\v2@.google.cloud.workstations.v1.WorkstationConfig.Host.GceInstanceH\x00R\vgceInstance\x1a\xaa\b\n" +
	"\vGceInstance\x12&\n" +
	...
	"\x11boot_disk_size_gb\x18\t \x01(\x05B\x03\xe0A\x01R\x0ebootDiskSizeGb\x1a\xb9\x01\n" +
	...
	"\x1benable_confidential_compute\x18\x01 \x01(\bB\x03\xe0A\x01R\x19enableConfidentialComputeB\b\n" +
	"\x06config\x1a\xd0\x04\n" +
	"\x13PersistentDirectory\x12v\n" +
	"\x06gce_pd\x18\x02 \x01(\v2].google.cloud.workstations.v1.WorkstationConfig.PersistentDirectory.GceRegionalPersistentDiskH\x00R\x05gcePd\x12\"\n" +
	"\n" +
	"mount_path\x18\x01 \x01(\tB\x03\xe0A\x01R\tmountPath\x1a\x8a\x03\n" +
	...
	"\x0ereclaim_policy\x18\x04 \x01(\x0e2k.google.cloud.workstations.v1.WorkstationConfig.PersistentDirectory.GceRegionalPersistentDisk.ReclaimPolicyB\x03\xe0A\x01R\rreclaimPolicy\"G\n" +
	...
	"-workstations.googleapis.com/WorkstationConfig\x12yprojects/{project}/locations/{location}/workstationClusters/{workstation_cluster}/workstationConfigs/{workstation_config}*\x12workstationConfigs2\x11workstationConfigR\x01\x01\"\x90\t\n" +
	...
	"\vdelete_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"deleteTime\x12\x17\n" +
	"\x04etag\x18\t \x01(\tB\x03\xe0A\x01R\x04etag\x12J\n" +
	"\x05state\x18\n" +
	" \x01(\x0e2/.google.cloud.workstations.v1.Workstation.StateB\x03\xe0A\x03R\x05state\x12\x17\n" +
	"\x04host\x18\v \x01(\tB\x03\xe0A\x03R\x04host\x1a>\n" +
	"\x10AnnotationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	...
	"\tpage_size\x18\x02 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tB\x03\xe0A\x01R\tpageToken\"\xcc\x01\n" +
