...
func (c *targetInstancesRESTClient) AggregatedList(ctx context.Context, req *computepb.AggregatedListTargetInstancesRequest, opts ...gax.CallOption) *TargetInstancesScopedListPairIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]TargetInstancesScopedListPair, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/aggregated/targetInstances", req.GetProject())
...
func (c *targetInstancesRESTClient) Delete(ctx context.Context, req *computepb.DeleteTargetInstanceRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/zones/%v/targetInstances/%v", req.GetProject(), req.GetZone(), req.GetTargetInstance())
...
func (c *targetInstancesRESTClient) Insert(ctx context.Context, req *computepb.InsertTargetInstanceRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/zones/%v/targetInstances", req.GetProject(), req.GetZone())
...
func (c *targetInstancesRESTClient) SetSecurityPolicy(ctx context.Context, req *computepb.SetSecurityPolicyTargetInstanceRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/zones/%v/targetInstances/%v/setSecurityPolicy", req.GetProject(), req.GetZone(), req.GetTargetInstance())
...
// TestIamPermissions returns permissions that a caller has on the specified resource.
func (c *targetInstancesRESTClient) TestIamPermissions(ctx context.Context, req *computepb.TestIamPermissionsTargetInstanceRequest, opts ...gax.CallOption) (*computepb.TestPermissionsResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true}
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/zones/%v/targetInstances/%v/testIamPermissions", req.GetProject(), req.GetZone(), req.GetResource())
