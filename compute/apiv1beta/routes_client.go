...
func (c *routesRESTClient) Delete(ctx context.Context, req *computepb.DeleteRouteRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/global/routes/%v", req.GetProject(), req.GetRoute())
...
func (c *routesRESTClient) Insert(ctx context.Context, req *computepb.InsertRouteRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/global/routes", req.GetProject())
...
func (c *routesRESTClient) TestIamPermissions(ctx context.Context, req *computepb.TestIamPermissionsRouteRequest, opts ...gax.CallOption) (*computepb.TestPermissionsResponse, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/global/routes/%v/testIamPermissions", req.GetProject(), req.GetResource())
