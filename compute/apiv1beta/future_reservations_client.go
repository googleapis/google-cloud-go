...
var newFutureReservationsClientHook clientHook
...
func defaultFutureReservationsRESTCallOptions() *FutureReservationsCallOptions {
	return &FutureReservationsCallOptions{
		AggregatedList: []gax.CallOption{
...
// internalFutureReservationsClient is an interface that defines the methods available from Google Compute Engine API.
type internalFutureReservationsClient interface {
	Close() error
	setGoogleClientInfo(...string)
	Connection() *grpc.ClientConn
	AggregatedList(context.Context, *computepb.AggregatedListFutureReservationsRequest, ...gax.CallOption) *FutureReservationsScopedListPairIterator
	Cancel(context.Context, *computepb.CancelFutureReservationRequest, ...gax.CallOption) (*Operation, error)
	Delete(context.Context, *computepb.DeleteFutureReservationRequest, ...gax.CallOption) (*Operation, error)
	Get(context.Context, *computepb.GetFutureReservationRequest, ...gax.CallOption) (*computepb.FutureReservation, error)
	Insert(context.Context, *computepb.InsertFutureReservationRequest, ...gax.CallOption) (*Operation, error)
	List(context.Context, *computepb.ListFutureReservationsRequest, ...gax.CallOption) *FutureReservationIterator
	Update(context.Context, *computepb.UpdateFutureReservationRequest, ...gax.CallOption) (*Operation, error)
}

// FutureReservationsClient is a client for interacting with Google Compute Engine API.
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
//
// The FutureReservations API.
type FutureReservationsClient struct {
	// The internal transport-dependent client.
	internalClient internalFutureReservationsClient
...
func (c *FutureReservationsClient) setGoogleClientInfo(keyval ...string) {
...
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type futureReservationsRESTClient struct {
	...
	// Points back to the CallOptions field of the containing FutureReservationsClient
	CallOptions **FutureReservationsCallOptions
...
func NewFutureReservationsRESTClient(ctx context.Context, opts ...option.ClientOption) (*FutureReservationsClient, error) {
	clientOpts := append(defaultFutureReservationsRESTClientOptions(), opts...)
	...
	callOpts := defaultFutureReservationsRESTCallOptions()
	c := &futureReservationsRESTClient{
		endpoint:    endpoint,
	...
	return &FutureReservationsClient{internalClient: c, CallOptions: callOpts}, nil
}

func defaultFutureReservationsRESTClientOptions() []option.ClientOption {
...
// the `x-goog-api-client` header passed on each request. Intended for
// use by Google-written clients.
func (c *futureReservationsRESTClient) setGoogleClientInfo(keyval ...string) {
...
// Close closes the connection to the API service. The user should invoke this when
// the client is no longer required.
func (c *futureReservationsRESTClient) Close() error {
...
func (c *futureReservationsRESTClient) Connection() *grpc.ClientConn {
	return nil
}
...
func (c *futureReservationsRESTClient) AggregatedList(ctx context.Context, req *computepb.AggregatedListFutureReservationsRequest, opts ...gax.CallOption) *FutureReservationsScopedListPairIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]FutureReservationsScopedListPair, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/aggregated/futureReservations", req.GetProject())
		...
		elems := make([]FutureReservationsScopedListPair, 0, len(resp.GetItems()))
		for k, v := range resp.GetItems() {
			elems = append(elems, FutureReservationsScopedListPair{k, v})
		}
...
// Cancel cancel the specified future reservation.
func (c *futureReservationsRESTClient) Cancel(ctx context.Context, req *computepb.CancelFutureReservationRequest, opts ...gax.CallOption) (*Operation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/zones/%v/futureReservations/%v/cancel", req.GetProject(), req.GetZone(), req.GetFutureReservation())
	...
	// Build HTTP headers from client and context metadata.
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v&%s=%v&%s=%v", "project", url.QueryEscape(req.GetProject()), "zone", url.QueryEscape(req.GetZone()), "future_reservation", url.QueryEscape(req.GetFutureReservation()))}

	hds = append(c.xGoogHeaders, hds...)
	hds = append(hds, "Content-Type", "application/json")
	headers := gax.BuildHeaders(ctx, hds...)
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "resource_name", fmt.Sprintf("//compute.googleapis.com//compute/beta/projects/%v/zones/%v/futureReservations/%v", req.GetProject(), req.GetZone(), req.GetFutureReservation()))
	}
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1beta.FutureReservations/Cancel")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/beta/projects/{project}/zones/{zone}/futureReservations/{future_reservation}/cancel")
	}
...
// Delete deletes the specified future reservation.
func (c *futureReservationsRESTClient) Delete(ctx context.Context, req *computepb.DeleteFutureReservationRequest, opts ...gax.CallOption) (*Operation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/zones/%v/futureReservations/%v", req.GetProject(), req.GetZone(), req.GetFutureReservation())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1beta.FutureReservations/Delete")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/beta/projects/{project}/zones/{zone}/futureReservations/{future_reservation}")
	}
...
// Get retrieves information about the specified future reservation.
func (c *futureReservationsRESTClient) Get(ctx context.Context, req *computepb.GetFutureReservationRequest, opts ...gax.CallOption) (*computepb.FutureReservation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1beta.FutureReservations/Get")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/beta/projects/{project}/zones/{zone}/futureReservations/{future_reservation}")
	}
	opts = append((*c.CallOptions).Get[0:len((*c.CallOptions).Get):len((*c.CallOptions).Get)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &computepb.FutureReservation{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
// Insert creates a new Future Reservation.
func (c *futureReservationsRESTClient) Insert(ctx context.Context, req *computepb.InsertFutureReservationRequest, opts ...gax.CallOption) (*Operation, error) {
	m := protojson.MarshalOptions{AllowPartial: true}
	body := req.GetFutureReservationResource()
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/zones/%v/futureReservations", req.GetProject(), req.GetZone())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1beta.FutureReservations/Insert")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/beta/projects/{project}/zones/{zone}/futureReservations")
	}
...
// Update updates the specified future reservation.
func (c *futureReservationsRESTClient) Update(ctx context.Context, req *computepb.UpdateFutureReservationRequest, opts ...gax.CallOption) (*Operation, error) {
	m := protojson.MarshalOptions{AllowPartial: true}
	body := req.GetFutureReservationResource()
	jsonReq, err := m.Marshal(body)
	if err != nil {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1beta.FutureReservations/Update")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/beta/projects/{project}/zones/{zone}/futureReservations/{future_reservation}")
	}
