...
func (c *targetGrpcProxiesRESTClient) Delete(ctx context.Context, req *computepb.DeleteTargetGrpcProxyRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/global/targetGrpcProxies/%v", req.GetProject(), req.GetTargetGrpcProxy())
...
func (c *targetGrpcProxiesRESTClient) Insert(ctx context.Context, req *computepb.InsertTargetGrpcProxyRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/global/targetGrpcProxies", req.GetProject())
...
// TestIamPermissions returns permissions that a caller has on the specified resource.
func (c *targetGrpcProxiesRESTClient) TestIamPermissions(ctx context.Context, req *computepb.TestIamPermissionsTargetGrpcProxyRequest, opts ...gax.CallOption) (*computepb.TestPermissionsResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true}
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/global/targetGrpcProxies/%v/testIamPermissions", req.GetProject(), req.GetResource())
