...
func (it *MultiMigIterator) bufLen() int {
	return len(it.items)
}

func (it *MultiMigIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type NetworkPoliciesScopedListPairIterator struct {
	items    []NetworkPoliciesScopedListPair
	pageInfo *iterator.PageInfo
	nextFunc func() error
...
func (it *NetworkPoliciesScopedListPairIterator) Next() (NetworkPoliciesScopedListPair, error) {
	var item NetworkPoliciesScopedListPair
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *NetworkPoliciesScopedListPairIterator) bufLen() int {
	return len(it.items)
}

func (it *NetworkPoliciesScopedListPairIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
func (it *NetworkPolicyIterator) Next() (*computepb.NetworkPolicy, error) {
	var item *computepb.NetworkPolicy
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
type SnapshotGroupIterator struct {
	...
	// The number of results is no greater than pageSize.
	// If there are no more results, nextPageToken is empty and err is nil.
	InternalFetch func(pageSize int, pageToken string) (results []*computepb.SnapshotGroup, nextPageToken string, err error)
}

// PageInfo supports pagination. See the [google.golang.org/api/iterator] package for details.
func (it *SnapshotGroupIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *SnapshotGroupIterator) Next() (*computepb.SnapshotGroup, error) {
	var item *computepb.SnapshotGroup
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *SnapshotGroupIterator) bufLen() int {
	return len(it.items)
}

func (it *SnapshotGroupIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
func (it *SnapshotsScopedListPairIterator) Next() (SnapshotsScopedListPair, error) {
	var item SnapshotsScopedListPair
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *SnapshotsScopedListPairIterator) bufLen() int {
	return len(it.items)
}

func (it *SnapshotsScopedListPairIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
