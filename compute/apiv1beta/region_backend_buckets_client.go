...
var newRegionBackendBucketsClientHook clientHook
...
func defaultRegionBackendBucketsRESTCallOptions() *RegionBackendBucketsCallOptions {
	return &RegionBackendBucketsCallOptions{
		Delete: []gax.CallOption{
...
type internalRegionBackendBucketsClient interface {
	...
	Delete(context.Context, *computepb.DeleteRegionBackendBucketRequest, ...gax.CallOption) (*Operation, error)
	Get(context.Context, *computepb.GetRegionBackendBucketRequest, ...gax.CallOption) (*computepb.BackendBucket, error)
	GetIamPolicy(context.Context, *computepb.GetIamPolicyRegionBackendBucketRequest, ...gax.CallOption) (*computepb.Policy, error)
	Insert(context.Context, *computepb.InsertRegionBackendBucketRequest, ...gax.CallOption) (*Operation, error)
	List(context.Context, *computepb.ListRegionBackendBucketsRequest, ...gax.CallOption) *BackendBucketIterator
	ListUsable(context.Context, *computepb.ListUsableRegionBackendBucketsRequest, ...gax.CallOption) *BackendBucketIterator
	Patch(context.Context, *computepb.PatchRegionBackendBucketRequest, ...gax.CallOption) (*Operation, error)
	SetIamPolicy(context.Context, *computepb.SetIamPolicyRegionBackendBucketRequest, ...gax.CallOption) (*computepb.Policy, error)
...
func (c *RegionBackendBucketsClient) setGoogleClientInfo(keyval ...string) {
...
// Insert creates a RegionBackendBucket in the specified project in the given scope
...
// ListUsable retrieves a list of all usable backend buckets in the specified project in
// the given region.
...
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type regionBackendBucketsRESTClient struct {
	...
	// Points back to the CallOptions field of the containing RegionBackendBucketsClient
	CallOptions **RegionBackendBucketsCallOptions
...
func NewRegionBackendBucketsRESTClient(ctx context.Context, opts ...option.ClientOption) (*RegionBackendBucketsClient, error) {
	clientOpts := append(defaultRegionBackendBucketsRESTClientOptions(), opts...)
	httpClient, endpoint, err := httptransport.NewClient(ctx, clientOpts...)
	if err != nil {
		return nil, err
	}

	callOpts := defaultRegionBackendBucketsRESTCallOptions()
	c := &regionBackendBucketsRESTClient{
		endpoint:    endpoint,
	...
	return &RegionBackendBucketsClient{internalClient: c, CallOptions: callOpts}, nil
}

func defaultRegionBackendBucketsRESTClientOptions() []option.ClientOption {
...
// the `x-goog-api-client` header passed on each request. Intended for
// use by Google-written clients.
func (c *regionBackendBucketsRESTClient) setGoogleClientInfo(keyval ...string) {
...
func (c *regionBackendBucketsRESTClient) Connection() *grpc.ClientConn {
	return nil
}

// Delete deletes the specified regional BackendBucket resource.
func (c *regionBackendBucketsRESTClient) Delete(ctx context.Context, req *computepb.DeleteRegionBackendBucketRequest, opts ...gax.CallOption) (*Operation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/regions/%v/backendBuckets/%v", req.GetProject(), req.GetRegion(), req.GetBackendBucket())

	params := url.Values{}
	if req != nil && req.ForceDelete != nil {
	...
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v&%s=%v&%s=%v", "project", url.QueryEscape(req.GetProject()), "region", url.QueryEscape(req.GetRegion()), "backend_bucket", url.QueryEscape(req.GetBackendBucket()))}
...
// Get returns the specified regional BackendBucket resource.
func (c *regionBackendBucketsRESTClient) Get(ctx context.Context, req *computepb.GetRegionBackendBucketRequest, opts ...gax.CallOption) (*computepb.BackendBucket, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// GetIamPolicy gets the access control policy for a resource. May be empty if no such
// policy or resource exists.
func (c *regionBackendBucketsRESTClient) GetIamPolicy(ctx context.Context, req *computepb.GetIamPolicyRegionBackendBucketRequest, opts ...gax.CallOption) (*computepb.Policy, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/regions/%v/backendBuckets/%v/getIamPolicy", req.GetProject(), req.GetRegion(), req.GetResource())
...
// Insert creates a RegionBackendBucket in the specified project in the given scope
// using the parameters that are included in the request.
func (c *regionBackendBucketsRESTClient) Insert(ctx context.Context, req *computepb.InsertRegionBackendBucketRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/regions/%v/backendBuckets", req.GetProject(), req.GetRegion())
...
func (c *regionBackendBucketsRESTClient) ListUsable(ctx context.Context, req *computepb.ListUsableRegionBackendBucketsRequest, opts ...gax.CallOption) *BackendBucketIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*computepb.BackendBucket, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/regions/%v/backendBuckets/listUsable", req.GetProject(), req.GetRegion())
...
// semantics and uses theJSON merge
// patch format and processing rules.
func (c *regionBackendBucketsRESTClient) Patch(ctx context.Context, req *computepb.PatchRegionBackendBucketRequest, opts ...gax.CallOption) (*Operation, error) {
	m := protojson.MarshalOptions{AllowPartial: true}
	body := req.GetBackendBucketResource()
	jsonReq, err := m.Marshal(body)
	if err != nil {
...
// SetIamPolicy sets the access control policy on the specified resource.
// Replaces any existing policy.
func (c *regionBackendBucketsRESTClient) SetIamPolicy(ctx context.Context, req *computepb.SetIamPolicyRegionBackendBucketRequest, opts ...gax.CallOption) (*computepb.Policy, error) {
	m := protojson.MarshalOptions{AllowPartial: true}
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/regions/%v/backendBuckets/%v/setIamPolicy", req.GetProject(), req.GetRegion(), req.GetResource())
...
// TestIamPermissions returns permissions that a caller has on the specified resource.
func (c *regionBackendBucketsRESTClient) TestIamPermissions(ctx context.Context, req *computepb.TestIamPermissionsRegionBackendBucketRequest, opts ...gax.CallOption) (*computepb.TestPermissionsResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true}
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/regions/%v/backendBuckets/%v/testIamPermissions", req.GetProject(), req.GetRegion(), req.GetResource())
