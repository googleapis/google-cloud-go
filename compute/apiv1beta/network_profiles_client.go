...
func (c *networkProfilesRESTClient) Get(ctx context.Context, req *computepb.GetNetworkProfileRequest, opts ...gax.CallOption) (*computepb.NetworkProfile, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/global/networkProfiles/%v", req.GetProject(), req.GetNetworkProfile())
	...
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "resource_name", fmt.Sprintf("//compute.googleapis.com//compute/beta/projects/%v/global/networkProfiles/%v", req.GetProject(), req.GetNetworkProfile()))
	}
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1beta.NetworkProfiles/Get")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/beta/projects/{project}/global/networkProfiles/{network_profile}")
	}
...
func (c *networkProfilesRESTClient) List(ctx context.Context, req *computepb.ListNetworkProfilesRequest, opts ...gax.CallOption) *NetworkProfileIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*computepb.NetworkProfile, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/global/networkProfiles", req.GetProject())
