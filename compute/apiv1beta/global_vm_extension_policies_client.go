...
// internalGlobalVmExtensionPoliciesClient is an interface that defines the methods available from Compute Engine API.
...
// GlobalVmExtensionPoliciesClient is a client for interacting with Compute Engine API.
...
func (c *globalVmExtensionPoliciesRESTClient) Delete(ctx context.Context, req *computepb.DeleteGlobalVmExtensionPolicyRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	headers := gax.BuildHeaders(ctx, hds...)
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "resource_name", fmt.Sprintf("//compute.googleapis.com//compute/beta/projects/%v/global/vmExtensionPolicies/%v", req.GetProject(), req.GetGlobalVmExtensionPolicy()))
	}
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1beta.GlobalVmExtensionPolicies/Delete")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/beta/projects/{project}/global/vmExtensionPolicies/{global_vm_extension_policy}/delete")
	}
...
func (c *globalVmExtensionPoliciesRESTClient) Get(ctx context.Context, req *computepb.GetGlobalVmExtensionPolicyRequest, opts ...gax.CallOption) (*computepb.GlobalVmExtensionPolicy, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1beta.GlobalVmExtensionPolicies/Get")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/beta/projects/{project}/global/vmExtensionPolicies/{global_vm_extension_policy}")
	}
...
func (c *globalVmExtensionPoliciesRESTClient) Insert(ctx context.Context, req *computepb.InsertGlobalVmExtensionPolicyRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1beta.GlobalVmExtensionPolicies/Insert")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/beta/projects/{project}/global/vmExtensionPolicies")
	}
...
func (c *globalVmExtensionPoliciesRESTClient) Update(ctx context.Context, req *computepb.UpdateGlobalVmExtensionPolicyRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1beta.GlobalVmExtensionPolicies/Update")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/beta/projects/{project}/global/vmExtensionPolicies/{global_vm_extension_policy}")
	}
