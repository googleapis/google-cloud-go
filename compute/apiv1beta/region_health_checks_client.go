...
// internalRegionHealthChecksClient is an interface that defines the methods available from Compute Engine API.
type internalRegionHealthChecksClient interface {
	...
	TestIamPermissions(context.Context, *computepb.TestIamPermissionsRegionHealthCheckRequest, ...gax.CallOption) (*computepb.TestPermissionsResponse, error)
	Update(context.Context, *computepb.UpdateRegionHealthCheckRequest, ...gax.CallOption) (*Operation, error)
}

// RegionHealthChecksClient is a client for interacting with Compute Engine API.
...
func (c *regionHealthChecksRESTClient) Delete(ctx context.Context, req *computepb.DeleteRegionHealthCheckRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/regions/%v/healthChecks/%v", req.GetProject(), req.GetRegion(), req.GetHealthCheck())
...
func (c *regionHealthChecksRESTClient) Insert(ctx context.Context, req *computepb.InsertRegionHealthCheckRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/regions/%v/healthChecks", req.GetProject(), req.GetRegion())
...
// TestIamPermissions returns permissions that a caller has on the specified resource.
func (c *regionHealthChecksRESTClient) TestIamPermissions(ctx context.Context, req *computepb.TestIamPermissionsRegionHealthCheckRequest, opts ...gax.CallOption) (*computepb.TestPermissionsResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true}
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/regions/%v/healthChecks/%v/testIamPermissions", req.GetProject(), req.GetRegion(), req.GetResource())
