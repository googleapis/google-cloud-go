...
var newNetworkProfilesClientHook clientHook
...
func defaultNetworkProfilesRESTCallOptions() *NetworkProfilesCallOptions {
	return &NetworkProfilesCallOptions{
		Get: []gax.CallOption{
...
type internalNetworkProfilesClient interface {
	...
	Get(context.Context, *computepb.GetNetworkProfileRequest, ...gax.CallOption) (*computepb.NetworkProfile, error)
...
type NetworkProfilesClient struct {
	...
	internalClient internalNetworkProfilesClient
...
func (c *NetworkProfilesClient) setGoogleClientInfo(keyval ...string) {
...
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type networkProfilesRESTClient struct {
	...
	// Points back to the CallOptions field of the containing NetworkProfilesClient
	CallOptions **NetworkProfilesCallOptions
...
func NewNetworkProfilesRESTClient(ctx context.Context, opts ...option.ClientOption) (*NetworkProfilesClient, error) {
	clientOpts := append(defaultNetworkProfilesRESTClientOptions(), opts...)
	httpClient, endpoint, err := httptransport.NewClient(ctx, clientOpts...)
	if err != nil {
		return nil, err
	}

	callOpts := defaultNetworkProfilesRESTCallOptions()
	c := &networkProfilesRESTClient{
		endpoint:    endpoint,
...
func defaultNetworkProfilesRESTClientOptions() []option.ClientOption {
...
func (c *networkProfilesRESTClient) Connection() *grpc.ClientConn {
	return nil
}

// Get returns the specified network profile.
func (c *networkProfilesRESTClient) Get(ctx context.Context, req *computepb.GetNetworkProfileRequest, opts ...gax.CallOption) (*computepb.NetworkProfile, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/global/networkProfiles/%v", req.GetProject(), req.GetNetworkProfile())

	// Build HTTP headers from client and context metadata.
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v&%s=%v", "project", url.QueryEscape(req.GetProject()), "network_profile", url.QueryEscape(req.GetNetworkProfile()))}
...
func (c *networkProfilesRESTClient) List(ctx context.Context, req *computepb.ListNetworkProfilesRequest, opts ...gax.CallOption) *NetworkProfileIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*computepb.NetworkProfile, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/global/networkProfiles", req.GetProject())
