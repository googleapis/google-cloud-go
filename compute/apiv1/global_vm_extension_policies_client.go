...
func (c *globalVmExtensionPoliciesRESTClient) AggregatedList(ctx context.Context, req *computepb.AggregatedListGlobalVmExtensionPoliciesRequest, opts ...gax.CallOption) *VmExtensionPoliciesScopedListPairIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]VmExtensionPoliciesScopedListPair, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/aggregated/vmExtensionPolicies", req.GetProject())
...
func (c *globalVmExtensionPoliciesRESTClient) Delete(ctx context.Context, req *computepb.DeleteGlobalVmExtensionPolicyRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/global/vmExtensionPolicies/%v/delete", req.GetProject(), req.GetGlobalVmExtensionPolicy())
...
func (c *globalVmExtensionPoliciesRESTClient) Get(ctx context.Context, req *computepb.GetGlobalVmExtensionPolicyRequest, opts ...gax.CallOption) (*computepb.GlobalVmExtensionPolicy, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/global/vmExtensionPolicies/%v", req.GetProject(), req.GetGlobalVmExtensionPolicy())
...
func (c *globalVmExtensionPoliciesRESTClient) Insert(ctx context.Context, req *computepb.InsertGlobalVmExtensionPolicyRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/global/vmExtensionPolicies", req.GetProject())
