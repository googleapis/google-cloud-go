...
func (c *reservationSlotsRESTClient) Get(ctx context.Context, req *computepb.GetReservationSlotRequest, opts ...gax.CallOption) (*computepb.ReservationSlotsGetResponse, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/zones/%v/%v/reservationSlots/%v", req.GetProject(), req.GetZone(), req.GetParentName(), req.GetReservationSlot())
...
func (c *reservationSlotsRESTClient) List(ctx context.Context, req *computepb.ListReservationSlotsRequest, opts ...gax.CallOption) *ReservationSlotIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*computepb.ReservationSlot, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/zones/%v/%v/reservationSlots", req.GetProject(), req.GetZone(), req.GetParentName())
