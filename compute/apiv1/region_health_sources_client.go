...
var newRegionHealthSourcesClientHook clientHook
...
func defaultRegionHealthSourcesRESTCallOptions() *RegionHealthSourcesCallOptions {
	return &RegionHealthSourcesCallOptions{
		AggregatedList: []gax.CallOption{
...
// internalRegionHealthSourcesClient is an interface that defines the methods available from Google Compute Engine API.
type internalRegionHealthSourcesClient interface {
	Close() error
	...
	TestIamPermissions(context.Context, *computepb.TestIamPermissionsRegionHealthSourceRequest, ...gax.CallOption) (*computepb.TestPermissionsResponse, error)
}

// RegionHealthSourcesClient is a client for interacting with Google Compute Engine API.
...
func (c *RegionHealthSourcesClient) setGoogleClientInfo(keyval ...string) {
...
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type regionHealthSourcesRESTClient struct {
	...
	// Points back to the CallOptions field of the containing RegionHealthSourcesClient
	CallOptions **RegionHealthSourcesCallOptions
...
func NewRegionHealthSourcesRESTClient(ctx context.Context, opts ...option.ClientOption) (*RegionHealthSourcesClient, error) {
	...
	callOpts := defaultRegionHealthSourcesRESTCallOptions()
	c := &regionHealthSourcesRESTClient{
		endpoint:    endpoint,
	...
	return &RegionHealthSourcesClient{internalClient: c, CallOptions: callOpts}, nil
}

func defaultRegionHealthSourcesRESTClientOptions() []option.ClientOption {
...
// the `x-goog-api-client` header passed on each request. Intended for
// use by Google-written clients.
func (c *regionHealthSourcesRESTClient) setGoogleClientInfo(keyval ...string) {
...
func (c *regionHealthSourcesRESTClient) Connection() *grpc.ClientConn {
	return nil
}
...
func (c *regionHealthSourcesRESTClient) AggregatedList(ctx context.Context, req *computepb.AggregatedListRegionHealthSourcesRequest, opts ...gax.CallOption) *HealthSourcesScopedListPairIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]HealthSourcesScopedListPair, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/aggregated/healthSources", req.GetProject())
		...
		elems := make([]HealthSourcesScopedListPair, 0, len(resp.GetItems()))
		for k, v := range resp.GetItems() {
			elems = append(elems, HealthSourcesScopedListPair{k, v})
		}
...
// Delete deletes the specified HealthSource in the given region
func (c *regionHealthSourcesRESTClient) Delete(ctx context.Context, req *computepb.DeleteRegionHealthSourceRequest, opts ...gax.CallOption) (*Operation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/healthSources/%v", req.GetProject(), req.GetRegion(), req.GetHealthSource())
...
// Get returns the specified HealthSource resource in the given region.
func (c *regionHealthSourcesRESTClient) Get(ctx context.Context, req *computepb.GetRegionHealthSourceRequest, opts ...gax.CallOption) (*computepb.HealthSource, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
func (c *regionHealthSourcesRESTClient) Insert(ctx context.Context, req *computepb.InsertRegionHealthSourceRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/healthSources", req.GetProject(), req.GetRegion())
...
// TestIamPermissions returns permissions that a caller has on the specified resource.
func (c *regionHealthSourcesRESTClient) TestIamPermissions(ctx context.Context, req *computepb.TestIamPermissionsRegionHealthSourceRequest, opts ...gax.CallOption) (*computepb.TestPermissionsResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true}
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/healthSources/%v/testIamPermissions", req.GetProject(), req.GetRegion(), req.GetResource())
