...
func (h *regionOperationsHandle) Poll(ctx context.Context, opts ...gax.CallOption) error {
	resp, err := h.c.Get(ctx, &computepb.GetRegionOperationRequest{Operation: h.proto.GetName()}, opts...)
	if err != nil {
		return err
	}
	h.proto = resp
...
func (h *zoneOperationsHandle) Poll(ctx context.Context, opts ...gax.CallOption) error {
	resp, err := h.c.Get(ctx, &computepb.GetZoneOperationRequest{Operation: h.proto.GetName()}, opts...)
	if err != nil {
		return err
	}
	h.proto = resp
...
func (h *globalOperationsHandle) Poll(ctx context.Context, opts ...gax.CallOption) error {
	resp, err := h.c.Get(ctx, &computepb.GetGlobalOperationRequest{Operation: h.proto.GetName()}, opts...)
	if err != nil {
		return err
	}
	h.proto = resp
...
func (h *globalOrganizationOperationsHandle) Poll(ctx context.Context, opts ...gax.CallOption) error {
	resp, err := h.c.Get(ctx, &computepb.GetGlobalOrganizationOperationRequest{Operation: h.proto.GetName()}, opts...)
	if err != nil {
		return err
	}
	h.proto = resp
