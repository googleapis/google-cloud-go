...
func (c *regionCompositeHealthChecksRESTClient) AggregatedList(ctx context.Context, req *computepb.AggregatedListRegionCompositeHealthChecksRequest, opts ...gax.CallOption) *CompositeHealthChecksScopedListPairIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]CompositeHealthChecksScopedListPair, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/aggregated/compositeHealthChecks", req.GetProject())
...
func (c *regionCompositeHealthChecksRESTClient) Delete(ctx context.Context, req *computepb.DeleteRegionCompositeHealthCheckRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/compositeHealthChecks/%v", req.GetProject(), req.GetRegion(), req.GetCompositeHealthCheck())
...
func (c *regionCompositeHealthChecksRESTClient) GetHealth(ctx context.Context, req *computepb.GetHealthRegionCompositeHealthCheckRequest, opts ...gax.CallOption) (*computepb.CompositeHealthCheckHealth, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/compositeHealthChecks/%v/getHealth", req.GetProject(), req.GetRegion(), req.GetCompositeHealthCheck())
...
func (c *regionCompositeHealthChecksRESTClient) Insert(ctx context.Context, req *computepb.InsertRegionCompositeHealthCheckRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/compositeHealthChecks", req.GetProject(), req.GetRegion())
...
func (c *regionCompositeHealthChecksRESTClient) TestIamPermissions(ctx context.Context, req *computepb.TestIamPermissionsRegionCompositeHealthCheckRequest, opts ...gax.CallOption) (*computepb.TestPermissionsResponse, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/compositeHealthChecks/%v/testIamPermissions", req.GetProject(), req.GetRegion(), req.GetResource())
