...
var newCrossSiteNetworksClientHook clientHook
...
func defaultCrossSiteNetworksRESTCallOptions() *CrossSiteNetworksCallOptions {
	return &CrossSiteNetworksCallOptions{
		Delete: []gax.CallOption{
...
// internalCrossSiteNetworksClient is an interface that defines the methods available from Google Compute Engine API.
type internalCrossSiteNetworksClient interface {
	Close() error
	setGoogleClientInfo(...string)
	Connection() *grpc.ClientConn
	Delete(context.Context, *computepb.DeleteCrossSiteNetworkRequest, ...gax.CallOption) (*Operation, error)
	Get(context.Context, *computepb.GetCrossSiteNetworkRequest, ...gax.CallOption) (*computepb.CrossSiteNetwork, error)
	Insert(context.Context, *computepb.InsertCrossSiteNetworkRequest, ...gax.CallOption) (*Operation, error)
	List(context.Context, *computepb.ListCrossSiteNetworksRequest, ...gax.CallOption) *CrossSiteNetworkIterator
	Patch(context.Context, *computepb.PatchCrossSiteNetworkRequest, ...gax.CallOption) (*Operation, error)
}

// CrossSiteNetworksClient is a client for interacting with Google Compute Engine API.
...
func (c *CrossSiteNetworksClient) setGoogleClientInfo(keyval ...string) {
...
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type crossSiteNetworksRESTClient struct {
	...
	// Points back to the CallOptions field of the containing CrossSiteNetworksClient
	CallOptions **CrossSiteNetworksCallOptions
...
func NewCrossSiteNetworksRESTClient(ctx context.Context, opts ...option.ClientOption) (*CrossSiteNetworksClient, error) {
	clientOpts := append(defaultCrossSiteNetworksRESTClientOptions(), opts...)
	...
	callOpts := defaultCrossSiteNetworksRESTCallOptions()
	c := &crossSiteNetworksRESTClient{
		endpoint:    endpoint,
	...
	return &CrossSiteNetworksClient{internalClient: c, CallOptions: callOpts}, nil
}

func defaultCrossSiteNetworksRESTClientOptions() []option.ClientOption {
...
// the `x-goog-api-client` header passed on each request. Intended for
// use by Google-written clients.
func (c *crossSiteNetworksRESTClient) setGoogleClientInfo(keyval ...string) {
...
// Close closes the connection to the API service. The user should invoke this when
// the client is no longer required.
func (c *crossSiteNetworksRESTClient) Close() error {
...
func (c *crossSiteNetworksRESTClient) Connection() *grpc.ClientConn {
	return nil
}

// Delete deletes the specified cross-site network in the given scope.
func (c *crossSiteNetworksRESTClient) Delete(ctx context.Context, req *computepb.DeleteCrossSiteNetworkRequest, opts ...gax.CallOption) (*Operation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/global/crossSiteNetworks/%v", req.GetProject(), req.GetCrossSiteNetwork())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1.CrossSiteNetworks/Delete")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/v1/projects/{project}/global/crossSiteNetworks/{cross_site_network}")
	}
...
// Get returns the specified cross-site network in the given scope.
func (c *crossSiteNetworksRESTClient) Get(ctx context.Context, req *computepb.GetCrossSiteNetworkRequest, opts ...gax.CallOption) (*computepb.CrossSiteNetwork, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1.CrossSiteNetworks/Get")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/v1/projects/{project}/global/crossSiteNetworks/{cross_site_network}")
	}
	opts = append((*c.CallOptions).Get[0:len((*c.CallOptions).Get):len((*c.CallOptions).Get)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &computepb.CrossSiteNetwork{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
func (c *crossSiteNetworksRESTClient) Insert(ctx context.Context, req *computepb.InsertCrossSiteNetworkRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/global/crossSiteNetworks", req.GetProject())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1.CrossSiteNetworks/Insert")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/v1/projects/{project}/global/crossSiteNetworks")
	}
...
func (c *crossSiteNetworksRESTClient) Patch(ctx context.Context, req *computepb.PatchCrossSiteNetworkRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1.CrossSiteNetworks/Patch")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/v1/projects/{project}/global/crossSiteNetworks/{cross_site_network}")
	}
