...
func (c *projectViewsRESTClient) Get(ctx context.Context, req *computepb.GetProjectViewRequest, opts ...gax.CallOption) (*computepb.ProjectView, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/projectViews", req.GetProject(), req.GetRegion())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1.ProjectViews/Get")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/v1/projects/{project}/regions/{region}/projectViews")
	}
