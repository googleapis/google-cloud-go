...
func file_google_cloud_networkmanagement_v1_connectivity_test_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_networkmanagement_v1_connectivity_test_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_networkmanagement_v1_connectivity_test_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_networkmanagement_v1_connectivity_test_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_networkmanagement_v1_connectivity_test_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_networkmanagement_v1_connectivity_test_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_networkmanagement_v1_connectivity_test_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_networkmanagement_v1_connectivity_test_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_networkmanagement_v1_connectivity_test_proto_msgTypes[1].OneofWrappers = []interface{}{}
	type x struct{}
