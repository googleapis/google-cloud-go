...
func file_google_cloud_memcache_v1beta2_cloud_memcache_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_memcache_v1beta2_cloud_memcache_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_memcache_v1beta2_cloud_memcache_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_memcache_v1beta2_cloud_memcache_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_memcache_v1beta2_cloud_memcache_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
