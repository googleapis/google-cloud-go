...
const file_google_cloud_edgenetwork_v1_resources_proto_rawDesc = "" +
	"\n" +
	"+google/cloud/edgenetwork/v1/resources.proto\x12\x1bgoogle.cloud.edgenetwork.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xaa\x03\n" +
	"\x04Zone\x12\x17\n" +
	...
	"updateTime\x12I\n" +
	"\x06labels\x18\x04 \x03(\v2-.google.cloud.edgenetwork.v1.Zone.LabelsEntryB\x02\x18\x01R\x06labels\x12#\n" +
	"\vlayout_name\x18\x05 \x01(\tB\x02\x18\x01R\n" +
	"layoutName\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:Z\xeaAW\n" +
	"\x1fedgenetwork.googleapis.com/Zone\x124projects/{project}/locations/{location}/zones/{zone}\"\xd6\x03\n" +
	"\aNetwork\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x12@\n" +
	"\vcreate_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12@\n" +
	"\vupdate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12H\n" +
	"\x06labels\x18\x04 \x03(\v20.google.cloud.edgenetwork.v1.Network.LabelsEntryR\x06labels\x12%\n" +
	"\vdescription\x18\x05 \x01(\tB\x03\xe0A\x01R\vdescription\x12\x10\n" +
	"\x03mtu\x18\x06 \x01(\x05R\x03mtu\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:p\xeaAm\n" +
	"\"edgenetwork.googleapis.com/Network\x12Gprojects/{project}/locations/{location}/zones/{zone}/networks/{network}\"\xc6\x06\n" +
	"\x06Subnet\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x12@\n" +
	"\vcreate_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12@\n" +
	"\vupdate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12G\n" +
	"\x06labels\x18\x04 \x03(\v2/.google.cloud.edgenetwork.v1.Subnet.LabelsEntryR\x06labels\x12%\n" +
	"\vdescription\x18\x05 \x01(\tB\x03\xe0A\x01R\vdescription\x12D\n" +
	"\anetwork\x18\x06 \x01(\tB*\xe0A\x02\xfaA$\n" +
	"\"edgenetwork.googleapis.com/NetworkR\anetwork\x12\x1b\n" +
	"\tipv4_cidr\x18\a \x03(\tR\bipv4Cidr\x12\x1b\n" +
	"\tipv6_cidr\x18\b \x03(\tR\bipv6Cidr\x12\x1c\n" +
	"\avlan_id\x18\t \x01(\x05B\x03\xe0A\x01R\x06vlanId\x12W\n" +
	"\fbonding_type\x18\v \x01(\x0e2/.google.cloud.edgenetwork.v1.Subnet.BondingTypeB\x03\xe0A\x01R\vbondingType\x12E\n" +
	"\x05state\x18\n" +
	" \x01(\x0e2*.google.cloud.edgenetwork.v1.ResourceStateB\x03\xe0A\x03R\x05state\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"G\n" +
	"\vBondingType\x12\x1c\n" +
	"\x18BONDING_TYPE_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06BONDED\x10\x01\x12\x0e\n" +
	"\n" +
	"NON_BONDED\x10\x02:m\xeaAj\n" +
	"!edgenetwork.googleapis.com/Subnet\x12Eprojects/{project}/locations/{location}/zones/{zone}/subnets/{subnet}\"\x93\a\n" +
	"\fInterconnect\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x12@\n" +
	"\vcreate_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12@\n" +
	"\vupdate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12M\n" +
	"\x06labels\x18\x04 \x03(\v25.google.cloud.edgenetwork.v1.Interconnect.LabelsEntryR\x06labels\x12%\n" +
	"\vdescription\x18\x05 \x01(\tB\x03\xe0A\x01R\vdescription\x12l\n" +
	"\x11interconnect_type\x18\x06 \x01(\x0e2:.google.cloud.edgenetwork.v1.Interconnect.InterconnectTypeB\x03\xe0A\x01R\x10interconnectType\x12\x17\n" +
	"\x04uuid\x18\a \x01(\tB\x03\xe0A\x03R\x04uuid\x12@\n" +
	"\x1adevice_cloud_resource_name\x18\b \x01(\tB\x03\xe0A\x03R\x17deviceCloudResourceName\x12*\n" +
	"\x0ephysical_ports\x18\t \x03(\tB\x03\xe0A\x03R\rphysicalPorts\x12y\n" +
	"\x1bremote_peering_network_type\x18\n" +
	" \x01(\x0e25.google.cloud.edgenetwork.v1.RemotePeeringNetworkTypeB\x03\xe0A\x01R\x18remotePeeringNetworkType\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"'edgenetwork.googleapis.com/Interconnect\x12Qprojects/{project}/locations/{location}/zones/{zone}/interconnects/{interconnect}\"\x83\a\n" +
	"\x16InterconnectAttachment\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x12@\n" +
	"\vcreate_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12@\n" +
	"\vupdate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12W\n" +
	"\x06labels\x18\x04 \x03(\v2?.google.cloud.edgenetwork.v1.InterconnectAttachment.LabelsEntryR\x06labels\x12%\n" +
	"\vdescription\x18\x05 \x01(\tB\x03\xe0A\x01R\vdescription\x12S\n" +
	"\finterconnect\x18\x06 \x01(\tB/\xe0A\x02\xfaA)\n" +
	"'edgenetwork.googleapis.com/InterconnectR\finterconnect\x12D\n" +
	"\anetwork\x18\v \x01(\tB*\xe0A\x01\xfaA$\n" +
	"\"edgenetwork.googleapis.com/NetworkR\anetwork\x12\x1c\n" +
	"\avlan_id\x18\b \x01(\x05B\x03\xe0A\x02R\x06vlanId\x12\x10\n" +
	"\x03mtu\x18\t \x01(\x05R\x03mtu\x12E\n" +
	"\x05state\x18\n" +
	" \x01(\x0e2*.google.cloud.edgenetwork.v1.ResourceStateB\x03\xe0A\x03R\x05state\x12]\n" +
	"\fpeering_type\x18\f \x01(\x0e25.google.cloud.edgenetwork.v1.RemotePeeringNetworkTypeB\x03\xe0A\x01R\vpeeringType\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\x9f\x01\xeaA\x9b\x01\n" +
	"1edgenetwork.googleapis.com/InterconnectAttachment\x12fprojects/{project}/locations/{location}/zones/{zone}/interconnectAttachments/{interconnect_attachment}\"\xcd\v\n" +
	"\x06Router\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\x12@\n" +
	"\vcreate_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12@\n" +
	"\vupdate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"updateTime\x12G\n" +
	"\x06labels\x18\x04 \x03(\v2/.google.cloud.edgenetwork.v1.Router.LabelsEntryR\x06labels\x12%\n" +
	"\vdescription\x18\x05 \x01(\tB\x03\xe0A\x01R\vdescription\x12D\n" +
	"\anetwork\x18\x06 \x01(\tB*\xe0A\x02\xfaA$\n" +
	"\"edgenetwork.googleapis.com/NetworkR\anetwork\x12K\n" +
	"\tinterface\x18\a \x03(\v2-.google.cloud.edgenetwork.v1.Router.InterfaceR\tinterface\x12F\n" +
	"\bbgp_peer\x18\b \x03(\v2+.google.cloud.edgenetwork.v1.Router.BgpPeerR\abgpPeer\x129\n" +
	"\x03bgp\x18\t \x01(\v2'.google.cloud.edgenetwork.v1.Router.BgpR\x03bgp\x12E\n" +
	"\x05state\x18\n" +
	" \x01(\x0e2*.google.cloud.edgenetwork.v1.ResourceStateB\x03\xe0A\x03R\x05state\x126\n" +
	"\x14route_advertisements\x18\v \x03(\tB\x03\xe0A\x01R\x13routeAdvertisements\x1a\xf3\x01\n" +
	"\tInterface\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1b\n" +
	"\tipv4_cidr\x18\x03 \x01(\tR\bipv4Cidr\x12\x1b\n" +
	"\tipv6_cidr\x18\x06 \x01(\tR\bipv6Cidr\x12D\n" +
	"\x1elinked_interconnect_attachment\x18\x02 \x01(\tR\x1clinkedInterconnectAttachment\x12\x1e\n" +
	"\n" +
	"subnetwork\x18\x04 \x01(\tR\n" +
	"subnetwork\x122\n" +
	"\x15loopback_ip_addresses\x18\x05 \x03(\tR\x13loopbackIpAddresses\x1a\xa4\x02\n" +
	"\aBgpPeer\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1c\n" +
	"\tinterface\x18\x02 \x01(\tR\tinterface\x12.\n" +
	"\x13interface_ipv4_cidr\x18\x03 \x01(\tR\x11interfaceIpv4Cidr\x12.\n" +
	"\x13interface_ipv6_cidr\x18\a \x01(\tR\x11interfaceIpv6Cidr\x12$\n" +
	"\x0epeer_ipv4_cidr\x18\x04 \x01(\tR\fpeerIpv4Cidr\x12$\n" +
	"\x0epeer_ipv6_cidr\x18\x06 \x01(\tR\fpeerIpv6Cidr\x12\x19\n" +
	"\bpeer_asn\x18\x05 \x01(\rR\apeerAsn\x12 \n" +
	"\tlocal_asn\x18\b \x01(\rB\x03\xe0A\x03R\blocalAsn\x1aZ\n" +
	"\x03Bgp\x12\x10\n" +
	"\x03asn\x18\x01 \x01(\rR\x03asn\x12A\n" +
	"\x1dkeepalive_interval_in_seconds\x18\x02 \x01(\rR\x1akeepaliveIntervalInSeconds\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:m\xeaAj\n" +
	"!edgenetwork.googleapis.com/Router\x12Eprojects/{project}/locations/{location}/zones/{zone}/routers/{router}\"R\n" +
	"\x10LinkLayerAddress\x12\x1f\n" +
	"\vmac_address\x18\x01 \x01(\tR\n" +
	"macAddress\x12\x1d\n" +
	"\n" +
	"ip_address\x18\x02 \x01(\tR\tipAddress\"\xa4\x01\n" +
	"\fSubnetStatus\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1f\n" +
	"\vmac_address\x18\x02 \x01(\tR\n" +
	"macAddress\x12_\n" +
	"\x14link_layer_addresses\x18\x03 \x03(\v2-.google.cloud.edgenetwork.v1.LinkLayerAddressR\x12linkLayerAddresses\"\xe4\v\n" +
	"\x17InterconnectDiagnostics\x12\x1f\n" +
	"\vmac_address\x18\x01 \x01(\tR\n" +
	"macAddress\x12_\n" +
	"\x14link_layer_addresses\x18\x02 \x03(\v2-.google.cloud.edgenetwork.v1.LinkLayerAddressR\x12linkLayerAddresses\x12U\n" +
	"\x05links\x18\x03 \x03(\v2?.google.cloud.edgenetwork.v1.InterconnectDiagnostics.LinkStatusR\x05links\x1a\xe3\x02\n" +
	"\n" +
	"LinkStatus\x12\x1d\n" +
	"\n" +
	"circuit_id\x18\x01 \x01(\tR\tcircuitId\x12d\n" +
	"\vlacp_status\x18\x02 \x01(\v2C.google.cloud.edgenetwork.v1.InterconnectDiagnostics.LinkLACPStatusR\n" +
	"lacpStatus\x12h\n" +
	"\rlldp_statuses\x18\x03 \x03(\v2C.google.cloud.edgenetwork.v1.InterconnectDiagnostics.LinkLLDPStatusR\flldpStatuses\x12f\n" +
	"\rpacket_counts\x18\x04 \x01(\v2A.google.cloud.edgenetwork.v1.InterconnectDiagnostics.PacketCountsR\fpacketCounts\x1a\x8a\x02\n" +
	"\fPacketCounts\x12'\n" +
	"\x0finbound_unicast\x18\x01 \x01(\x03R\x0einboundUnicast\x12%\n" +
	"\x0einbound_errors\x18\x02 \x01(\x03R\rinboundErrors\x12)\n" +
	"\x10inbound_discards\x18\x03 \x01(\x03R\x0finboundDiscards\x12)\n" +
	"\x10outbound_unicast\x18\x04 \x01(\x03R\x0foutboundUnicast\x12'\n" +
	"\x0foutbound_errors\x18\x05 \x01(\x03R\x0eoutboundErrors\x12+\n" +
	"\x11outbound_discards\x18\x06 \x01(\x03R\x10outboundDiscards\x1a\xe1\x02\n" +
	"\x0eLinkLACPStatus\x12_\n" +
	"\x05state\x18\x01 \x01(\x0e2I.google.cloud.edgenetwork.v1.InterconnectDiagnostics.LinkLACPStatus.StateR\x05state\x12(\n" +
	"\x10google_system_id\x18\x02 \x01(\tR\x0egoogleSystemId\x12,\n" +
	"\x12neighbor_system_id\x18\x03 \x01(\tR\x10neighborSystemId\x12\"\n" +
	"\faggregatable\x18\x04 \x01(\bR\faggregatable\x12\x1e\n" +
	"\n" +
	"collecting\x18\x05 \x01(\bR\n" +
	"collecting\x12\"\n" +
	"\fdistributing\x18\x06 \x01(\bR\fdistributing\".\n" +
	"\x05State\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\n" +
	"\n" +
	"\x06ACTIVE\x10\x01\x12\f\n" +
	"\bDETACHED\x10\x02\x1a\x98\x02\n" +
	"\x0eLinkLLDPStatus\x12(\n" +
	"\x10peer_system_name\x18\x01 \x01(\tR\x0epeerSystemName\x126\n" +
	"\x17peer_system_description\x18\x02 \x01(\tR\x15peerSystemDescription\x12&\n" +
	"\x0fpeer_chassis_id\x18\x03 \x01(\tR\rpeerChassisId\x12/\n" +
	"\x14peer_chassis_id_type\x18\x04 \x01(\tR\x11peerChassisIdType\x12 \n" +
	"\fpeer_port_id\x18\x05 \x01(\tR\n" +
	"peerPortId\x12)\n" +
	"\x11peer_port_id_type\x18\x06 \x01(\tR\x0epeerPortIdType\"\x93\x06\n" +
	"\fRouterStatus\x12A\n" +
	"\anetwork\x18\x01 \x01(\tB'\xfaA$\n" +
	"\"edgenetwork.googleapis.com/NetworkR\anetwork\x12_\n" +
	"\x0fbgp_peer_status\x18\x02 \x03(\v27.google.cloud.edgenetwork.v1.RouterStatus.BgpPeerStatusR\rbgpPeerStatus\x1a\xa6\x03\n" +
	"\rBgpPeerStatus\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1d\n" +
	"\n" +
	"ip_address\x18\x02 \x01(\tR\tipAddress\x12&\n" +
	"\x0fpeer_ip_address\x18\x03 \x01(\tR\rpeerIpAddress\x12Y\n" +
	"\x06status\x18\x04 \x01(\x0e2A.google.cloud.edgenetwork.v1.RouterStatus.BgpPeerStatus.BgpStatusR\x06status\x12\x14\n" +
	...
	"\x0eprefix_counter\x18\b \x01(\v27.google.cloud.edgenetwork.v1.RouterStatus.PrefixCounterR\rprefixCounter\"*\n" +
	"\tBgpStatus\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\x06\n" +
	"\x02UP\x10\x01\x12\b\n" +
	"\x04DOWN\x10\x02\x1a\xb5\x01\n" +
	"\rPrefixCounter\x12\x1e\n" +
	"\n" +
	"advertised\x18\x01 \x01(\x03R\n" +
	"advertised\x12\x16\n" +
	"\x06denied\x18\x02 \x01(\x03R\x06denied\x12\x1a\n" +
	"\breceived\x18\x03 \x01(\x03R\breceived\x12\x12\n" +
	"\x04sent\x18\x04 \x01(\x03R\x04sent\x12\x1e\n" +
	"\n" +
	"suppressed\x18\x05 \x01(\x03R\n" +
	"suppressed\x12\x1c\n" +
	"\twithdrawn\x18\x06 \x01(\x03R\twithdrawn*\x89\x01\n" +
	...
	"'REMOTE_PEERING_NETWORK_TYPE_UNSPECIFIED\x10\x00\x121\n" +
	"-REMOTE_PEERING_NETWORK_TYPE_CUSTOMER_INTERNAL\x10\x01\x121\n" +
	"-REMOTE_PEERING_NETWORK_TYPE_CUSTOMER_INTERNET\x10\x02B\xd3\x01\n" +
...
var (
	...
	file_google_cloud_edgenetwork_v1_resources_proto_rawDescData []byte
)
...
func file_google_cloud_edgenetwork_v1_resources_proto_rawDescGZIP() []byte {
	file_google_cloud_edgenetwork_v1_resources_proto_rawDescOnce.Do(func() {
		file_google_cloud_edgenetwork_v1_resources_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_edgenetwork_v1_resources_proto_rawDesc), len(file_google_cloud_edgenetwork_v1_resources_proto_rawDesc)))
	})
...
func file_google_cloud_edgenetwork_v1_resources_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_edgenetwork_v1_resources_proto_rawDesc), len(file_google_cloud_edgenetwork_v1_resources_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   25,
			NumExtensions: 0,
			NumServices:   0,
