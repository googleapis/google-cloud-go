...
const file_google_cloud_binaryauthorization_v1_service_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/binaryauthorization/v1/service.proto\x12#google.cloud.binaryauthorization.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a3google/cloud/binaryauthorization/v1/resources.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgrafeas/v1/attestation.proto\"Y\n" +
	"\x10GetPolicyRequest\x12E\n" +
	"\x04name\x18\x01 \x01(\tB1\xe0A\x02\xfaA+\n" +
	")binaryauthorization.googleapis.com/PolicyR\x04name\"_\n" +
	"\x13UpdatePolicyRequest\x12H\n" +
	"\x06policy\x18\x01 \x01(\v2+.google.cloud.binaryauthorization.v1.PolicyB\x03\xe0A\x02R\x06policy\"\xda\x01\n" +
	...
	"attestorId\x12N\n" +
	"\battestor\x18\x03 \x01(\v2-.google.cloud.binaryauthorization.v1.AttestorB\x03\xe0A\x02R\battestor\"]\n" +
	"\x12GetAttestorRequest\x12G\n" +
	"\x04name\x18\x01 \x01(\tB3\xe0A\x02\xfaA-\n" +
	"+binaryauthorization.googleapis.com/AttestorR\x04name\"g\n" +
	"\x15UpdateAttestorRequest\x12N\n" +
	"\battestor\x18\x01 \x01(\v2-.google.cloud.binaryauthorization.v1.AttestorB\x03\xe0A\x02R\battestor\"\x9f\x01\n" +
	...
	"\tattestors\x18\x01 \x03(\v2-.google.cloud.binaryauthorization.v1.AttestorR\tattestors\x12&\n" +
	...
	"\x04name\x18\x01 \x01(\tB1\xe0A\x02\xfaA+\n" +
	")binaryauthorization.googleapis.com/PolicyR\x04name\"\xfc\x01\n" +
	"$ValidateAttestationOccurrenceRequest\x12\x1f\n" +
	"\battestor\x18\x01 \x01(\tB\x03\xe0A\x02R\battestor\x12H\n" +
	"\vattestation\x18\x02 \x01(\v2!.grafeas.v1.AttestationOccurrenceB\x03\xe0A\x02R\vattestation\x12,\n" +
	"\x0foccurrence_note\x18\x03 \x01(\tB\x03\xe0A\x02R\x0eoccurrenceNote\x12;\n" +
	"\x17occurrence_resource_uri\x18\x04 \x01(\tB\x03\xe0A\x02R\x15occurrenceResourceUri\"\x87\x02\n" +
	"%ValidateAttestationOccurrenceResponse\x12i\n" +
	"\x06result\x18\x01 \x01(\x0e2Q.google.cloud.binaryauthorization.v1.ValidateAttestationOccurrenceResponse.ResultR\x06result\x12#\n" +
	"\rdenial_reason\x18\x02 \x01(\tR\fdenialReason\"N\n" +
	"\x06Result\x12\x16\n" +
	"\x12RESULT_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bVERIFIED\x10\x01\x12\x1e\n" +
	"\x1aATTESTATION_NOT_VERIFIABLE\x10\x022\xe2\n" +
	"\n" +
	"\x1bBinauthzManagementServiceV1\x12\x9c\x01\n" +
	"\tGetPolicy\x125.google.cloud.binaryauthorization.v1.GetPolicyRequest\x1a+.google.cloud.binaryauthorization.v1.Policy\"+\xdaA\x04name\x82\xd3\xe4\x93\x02\x1e\x12\x1c/v1/{name=projects/*/policy}\x12\xb3\x01\n" +
	"\fUpdatePolicy\x128.google.cloud.binaryauthorization.v1.UpdatePolicyRequest\x1a+.google.cloud.binaryauthorization.v1.Policy\"<\xdaA\x06policy\x82\xd3\xe4\x93\x02-:\x06policy\x1a#/v1/{policy.name=projects/*/policy}\x12\xce\x01\n" +
	"\x0eCreateAttestor\x12:.google.cloud.binaryauthorization.v1.CreateAttestorRequest\x1a-.google.cloud.binaryauthorization.v1.Attestor\"Q\xdaA\x1bparent,attestor_id,attestor\x82\xd3\xe4\x93\x02-:\battestor\"!/v1/{parent=projects/*}/attestors\x12\xa7\x01\n" +
	"\vGetAttestor\x127.google.cloud.binaryauthorization.v1.GetAttestorRequest\x1a-.google.cloud.binaryauthorization.v1.Attestor\"0\xdaA\x04name\x82\xd3\xe4\x93\x02#\x12!/v1/{name=projects/*/attestors/*}\x12\xc4\x01\n" +
	"\x0eUpdateAttestor\x12:.google.cloud.binaryauthorization.v1.UpdateAttestorRequest\x1a-.google.cloud.binaryauthorization.v1.Attestor\"G\xdaA\battestor\x82\xd3\xe4\x93\x026:\battestor\x1a*/v1/{attestor.name=projects/*/attestors/*}\x12\xba\x01\n" +
	"\rListAttestors\x129.google.cloud.binaryauthorization.v1.ListAttestorsRequest\x1a:.google.cloud.binaryauthorization.v1.ListAttestorsResponse\"2\xdaA\x06parent\x82\xd3\xe4\x93\x02#\x12!/v1/{parent=projects/*}/attestors\x12\x96\x01\n" +
	"\x0eDeleteAttestor\x12:.google.cloud.binaryauthorization.v1.DeleteAttestorRequest\x1a\x16.google.protobuf.Empty\"0\xdaA\x04name\x82\xd3\xe4\x93\x02#*!/v1/{name=projects/*/attestors/*}\x1aV\xcaA\"binaryauthorization.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platform2\x94\x02\n" +
	"\x0eSystemPolicyV1\x12\xa9\x01\n" +
	"\x0fGetSystemPolicy\x12;.google.cloud.binaryauthorization.v1.GetSystemPolicyRequest\x1a+.google.cloud.binaryauthorization.v1.Policy\",\xdaA\x04name\x82\xd3\xe4\x93\x02\x1f\x12\x1d/v1/{name=locations/*/policy}\x1aV\xcaA\"binaryauthorization.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platform2\xf5\x02\n" +
	"\x12ValidationHelperV1\x12\x86\x02\n" +
	"\x1dValidateAttestationOccurrence\x12I.google.cloud.binaryauthorization.v1.ValidateAttestationOccurrenceRequest\x1aJ.google.cloud.binaryauthorization.v1.ValidateAttestationOccurrenceResponse\"N\x82\xd3\xe4\x93\x02H:\x01*\"C/v1/{attestor=projects/*/attestors/*}:validateAttestationOccurrence\x1aV\xcaA\"binaryauthorization.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\x8c\x02\n" +
...
var (
	...
	file_google_cloud_binaryauthorization_v1_service_proto_rawDescData []byte
)
...
func file_google_cloud_binaryauthorization_v1_service_proto_rawDescGZIP() []byte {
	file_google_cloud_binaryauthorization_v1_service_proto_rawDescOnce.Do(func() {
		file_google_cloud_binaryauthorization_v1_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_binaryauthorization_v1_service_proto_rawDesc), len(file_google_cloud_binaryauthorization_v1_service_proto_rawDesc)))
	})
...
func file_google_cloud_binaryauthorization_v1_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_binaryauthorization_v1_service_proto_rawDesc), len(file_google_cloud_binaryauthorization_v1_service_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   3,
