...
const file_google_cloud_binaryauthorization_v1_resources_proto_rawDesc = "" +
	"\n" +
	"3google/cloud/binaryauthorization/v1/resources.proto\x12#google.cloud.binaryauthorization.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa0\x0f\n" +
	"\x06Policy\x12\x17\n" +
	...
	"\x15DRYRUN_AUDIT_LOG_ONLY\x10\x02\"\xec\x02\n" +
	"\bAttestor\x12\x17\n" +
	...
	"publicKeys\x12L\n" +
	" delegation_service_account_email\x18\x03 \x01(\tB\x03\xe0A\x03R\x1ddelegationServiceAccountEmail\"\xe1\x04\n" +
	"\rPkixPublicKey\x12$\n" +
	"\x0epublic_key_pem\x18\x01 \x01(\tR\fpublicKeyPem\x12v\n" +
	"\x13signature_algorithm\x18\x02 \x01(\x0e2E.google.cloud.binaryauthorization.v1.PkixPublicKey.SignatureAlgorithmR\x12signatureAlgorithm\"\xb1\x03\n" +
	...
	"\x13EC_SIGN_P521_SHA512\x10\v\x1a\x02\x10\x01\"\xf0\x01\n" +
