...
type BindingExplanation struct {
	...
	Memberships map[string]*BindingExplanation_AnnotatedMembership `protobuf:"bytes,5,rep,name=memberships,proto3" json:"memberships,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_google_cloud_policytroubleshooter_v1_explanations_proto_rawDesc = "" +
	"\n" +
	"7google/cloud/policytroubleshooter/v1/explanations.proto\x12$google.cloud.policytroubleshooter.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1agoogle/iam/v1/policy.proto\x1a\x16google/type/expr.proto\"\x88\x01\n" +
	"\vAccessTuple\x12!\n" +
	...
	"permission\"\xfe\x02\n" +
	"\x0fExplainedPolicy\x12I\n" +
	"\x06access\x18\x01 \x01(\x0e21.google.cloud.policytroubleshooter.v1.AccessStateR\x06access\x12,\n" +
	"\x12full_resource_name\x18\x02 \x01(\tR\x10fullResourceName\x12-\n" +
	"\x06policy\x18\x03 \x01(\v2\x15.google.iam.v1.PolicyR\x06policy\x12k\n" +
	"\x14binding_explanations\x18\x04 \x03(\v28.google.cloud.policytroubleshooter.v1.BindingExplanationR\x13bindingExplanations\x12V\n" +
	"\trelevance\x18\x05 \x01(\x0e28.google.cloud.policytroubleshooter.v1.HeuristicRelevanceR\trelevance\"\x80\n" +
	"\n" +
	"\x12BindingExplanation\x12N\n" +
	"\x06access\x18\x01 \x01(\x0e21.google.cloud.policytroubleshooter.v1.AccessStateB\x03\xe0A\x02R\x06access\x12\x12\n" +
	"\x04role\x18\x02 \x01(\tR\x04role\x12p\n" +
	"\x0frole_permission\x18\x03 \x01(\x0e2G.google.cloud.policytroubleshooter.v1.BindingExplanation.RolePermissionR\x0erolePermission\x12t\n" +
	"\x19role_permission_relevance\x18\x04 \x01(\x0e28.google.cloud.policytroubleshooter.v1.HeuristicRelevanceR\x17rolePermissionRelevance\x12k\n" +
	"\vmemberships\x18\x05 \x03(\v2I.google.cloud.policytroubleshooter.v1.BindingExplanation.MembershipsEntryR\vmemberships\x12V\n" +
	"\trelevance\x18\x06 \x01(\x0e28.google.cloud.policytroubleshooter.v1.HeuristicRelevanceR\trelevance\x12/\n" +
	"\tcondition\x18\a \x01(\v2\x11.google.type.ExprR\tcondition\x1a\xd2\x01\n" +
	"\x13AnnotatedMembership\x12c\n" +
	"\n" +
	"membership\x18\x01 \x01(\x0e2C.google.cloud.policytroubleshooter.v1.BindingExplanation.MembershipR\n" +
	"membership\x12V\n" +
	"\trelevance\x18\x02 \x01(\x0e28.google.cloud.policytroubleshooter.v1.HeuristicRelevanceR\trelevance\x1a\x8c\x01\n" +
	"\x10MembershipsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12b\n" +
	"\x05value\x18\x02 \x01(\v2L.google.cloud.policytroubleshooter.v1.BindingExplanation.AnnotatedMembershipR\x05value:\x028\x01\"\x9a\x01\n" +
	...
	"\aGRANTED\x10\x01\x12\x0f\n" +
	"\vNOT_GRANTED\x10\x02\x12\x17\n" +
...
var (
	...
	file_google_cloud_policytroubleshooter_v1_explanations_proto_rawDescData []byte
)
...
func file_google_cloud_policytroubleshooter_v1_explanations_proto_rawDescGZIP() []byte {
	file_google_cloud_policytroubleshooter_v1_explanations_proto_rawDescOnce.Do(func() {
		file_google_cloud_policytroubleshooter_v1_explanations_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_policytroubleshooter_v1_explanations_proto_rawDesc), len(file_google_cloud_policytroubleshooter_v1_explanations_proto_rawDesc)))
	})
...
var file_google_cloud_policytroubleshooter_v1_explanations_proto_goTypes = []any{
...
func file_google_cloud_policytroubleshooter_v1_explanations_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_policytroubleshooter_v1_explanations_proto_rawDesc), len(file_google_cloud_policytroubleshooter_v1_explanations_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
