...
func file_google_cloud_policytroubleshooter_v1_checker_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_policytroubleshooter_v1_checker_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_policytroubleshooter_v1_checker_proto_msgTypes[1].Exporter = func(v any, i int) any {
