...
func NewClient(ctx context.Context, opts ...option.ClientOption) (*Client, error) {
	...
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		clientOpts = append(clientOpts, internaloption.WithTelemetryAttributes(map[string]string{
			"gcp.client.service":  "vpcaccess",
			"gcp.client.version":  getVersionClient(),
			"gcp.client.repo":     "googleapis/google-cloud-go",
			"gcp.client.artifact": "cloud.google.com/go/vpcaccess/apiv1",
			"gcp.client.language": "go",
			"url.domain":          "vpcaccess.googleapis.com",
		}))
	}
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.CreateConnector = append(client.CallOptions.CreateConnector, gax.WithClientMetrics(metrics))
		client.CallOptions.GetConnector = append(client.CallOptions.GetConnector, gax.WithClientMetrics(metrics))
		client.CallOptions.ListConnectors = append(client.CallOptions.ListConnectors, gax.WithClientMetrics(metrics))
		client.CallOptions.DeleteConnector = append(client.CallOptions.DeleteConnector, gax.WithClientMetrics(metrics))
...
func NewRESTClient(ctx context.Context, opts ...option.ClientOption) (*Client, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.CreateConnector = append(callOpts.CreateConnector, gax.WithClientMetrics(metrics))
		callOpts.GetConnector = append(callOpts.GetConnector, gax.WithClientMetrics(metrics))
		callOpts.ListConnectors = append(callOpts.ListConnectors, gax.WithClientMetrics(metrics))
		callOpts.DeleteConnector = append(callOpts.DeleteConnector, gax.WithClientMetrics(metrics))
...
func (c *gRPCClient) CreateConnector(ctx context.Context, req *vpcaccesspb.CreateConnectorRequest, opts ...gax.CallOption) (*CreateConnectorOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.CreateConnector, req, settings.GRPC, c.logger, "CreateConnector")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) GetConnector(ctx context.Context, req *vpcaccesspb.GetConnectorRequest, opts ...gax.CallOption) (*vpcaccesspb.Connector, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.GetConnector, req, settings.GRPC, c.logger, "GetConnector")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) ListConnectors(ctx context.Context, req *vpcaccesspb.ListConnectorsRequest, opts ...gax.CallOption) *ConnectorIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*vpcaccesspb.Connector, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.client.ListConnectors, req, settings.GRPC, c.logger, "ListConnectors")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *gRPCClient) DeleteConnector(ctx context.Context, req *vpcaccesspb.DeleteConnectorRequest, opts ...gax.CallOption) (*DeleteConnectorOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.DeleteConnector, req, settings.GRPC, c.logger, "DeleteConnector")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *restClient) DeleteConnector(ctx context.Context, req *vpcaccesspb.DeleteConnectorRequest, opts ...gax.CallOption) (*DeleteConnectorOperation, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "DeleteConnector")
		if err != nil {
			return err
		}
		if err := unm.Unmarshal(buf, resp); err != nil {
