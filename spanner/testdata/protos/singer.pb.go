...
func (x *CustomNullableString) Reset() {
	*x = CustomNullableString{}
	if protoimpl.UnsafeEnabled {
...
func (x *CustomNullableString) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CustomNullableString) ProtoMessage() {}

func (x *CustomNullableString) ProtoReflect() protoreflect.Message {
	mi := &file_singer_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CustomNullableString.ProtoReflect.Descriptor instead.
func (*CustomNullableString) Descriptor() ([]byte, []int) {
	return file_singer_proto_rawDescGZIP(), []int{1}
}

func (x *CustomNullableString) GetValue() string {
...
var file_singer_proto_rawDesc = []byte{
	...
	0x6e, 0x72, 0x65, 0x22, 0x3b, 0x0a, 0x14, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x4e, 0x75, 0x6c,
	0x6c, 0x61, 0x62, 0x6c, 0x65, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x12, 0x19, 0x0a, 0x05, 0x76,
	...
	0x2a, 0x2e, 0x0a, 0x05, 0x47, 0x65, 0x6e, 0x72, 0x65, 0x12, 0x07, 0x0a, 0x03, 0x50, 0x4f, 0x50,
	0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x4a, 0x41, 0x5a, 0x5a, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04,
	0x46, 0x4f, 0x4c, 0x4b, 0x10, 0x02, 0x12, 0x08, 0x0a, 0x04, 0x52, 0x4f, 0x43, 0x4b, 0x10, 0x03,
...
var file_singer_proto_goTypes = []any{
	(Genre)(0),                   // 0: examples.spanner.music.Genre
	(*SingerInfo)(nil),           // 1: examples.spanner.music.SingerInfo
	(*CustomNullableString)(nil), // 2: examples.spanner.music.CustomNullableString
}
...
func file_singer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_singer_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_singer_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*CustomNullableString); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_singer_proto_msgTypes[0].OneofWrappers = []any{}
	file_singer_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
