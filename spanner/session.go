...
func (s *session) ping() error {
	...
	_, err := s.client.ExecuteSql(contextWithOutgoingMetadata(ctx, s.md, false), &sppb.ExecuteSqlRequest{
		Session: s.getID(),
		Sql:     "SELECT 1",
	})
	return err
...
func (s *session) delete(ctx context.Context) {
	...
	err := s.client.DeleteSession(contextWithOutgoingMetadata(ctx, s.md, false), &sppb.DeleteSessionRequest{Name: s.getID()})
