...
func (ChangeStreamRecord_DataChangeRecord_ModType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_spanner_v1_vtinternal_change_stream_proto_enumTypes[0].Descriptor()
}

func (ChangeStreamRecord_DataChangeRecord_ModType) Type() protoreflect.EnumType {
	return &file_google_spanner_v1_vtinternal_change_stream_proto_enumTypes[0]
}
...
func (ChangeStreamRecord_DataChangeRecord_ModType) EnumDescriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_change_stream_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
func (ChangeStreamRecord_DataChangeRecord_ValueCaptureType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_spanner_v1_vtinternal_change_stream_proto_enumTypes[1].Descriptor()
}

func (ChangeStreamRecord_DataChangeRecord_ValueCaptureType) Type() protoreflect.EnumType {
	return &file_google_spanner_v1_vtinternal_change_stream_proto_enumTypes[1]
}
...
func (ChangeStreamRecord_DataChangeRecord_ValueCaptureType) EnumDescriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_change_stream_proto_rawDescGZIP(), []int{0, 0, 1}
}
...
func (x *ChangeStreamRecord) Reset() {
	*x = ChangeStreamRecord{}
	mi := &file_google_spanner_v1_vtinternal_change_stream_proto_msgTypes[0]
...
func (*ChangeStreamRecord) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_change_stream_proto_rawDescGZIP(), []int{0}
}
...
type ChangeStreamRecord_DataChangeRecord struct {
	...
	ModType ChangeStreamRecord_DataChangeRecord_ModType `protobuf:"varint,8,opt,name=mod_type,json=modType,proto3,enum=google.spanner.v1.vtinternal.ChangeStreamRecord_DataChangeRecord_ModType" json:"mod_type,omitempty"`
	// Describes the value capture type that was specified in the change stream
	// configuration when this change was captured.
	ValueCaptureType ChangeStreamRecord_DataChangeRecord_ValueCaptureType `protobuf:"varint,9,opt,name=value_capture_type,json=valueCaptureType,proto3,enum=google.spanner.v1.vtinternal.ChangeStreamRecord_DataChangeRecord_ValueCaptureType" json:"value_capture_type,omitempty"`
...
func (x *ChangeStreamRecord_DataChangeRecord) Reset() {
	*x = ChangeStreamRecord_DataChangeRecord{}
	mi := &file_google_spanner_v1_vtinternal_change_stream_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChangeStreamRecord_DataChangeRecord) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_change_stream_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ChangeStreamRecord_HeartbeatRecord) Reset() {
	*x = ChangeStreamRecord_HeartbeatRecord{}
	mi := &file_google_spanner_v1_vtinternal_change_stream_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChangeStreamRecord_HeartbeatRecord) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_change_stream_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *ChangeStreamRecord_PartitionStartRecord) Reset() {
	*x = ChangeStreamRecord_PartitionStartRecord{}
	mi := &file_google_spanner_v1_vtinternal_change_stream_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChangeStreamRecord_PartitionStartRecord) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_change_stream_proto_rawDescGZIP(), []int{0, 2}
}
...
func (x *ChangeStreamRecord_PartitionEndRecord) Reset() {
	*x = ChangeStreamRecord_PartitionEndRecord{}
	mi := &file_google_spanner_v1_vtinternal_change_stream_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChangeStreamRecord_PartitionEndRecord) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_change_stream_proto_rawDescGZIP(), []int{0, 3}
}
...
func (x *ChangeStreamRecord_PartitionEventRecord) Reset() {
	*x = ChangeStreamRecord_PartitionEventRecord{}
	mi := &file_google_spanner_v1_vtinternal_change_stream_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChangeStreamRecord_PartitionEventRecord) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_change_stream_proto_rawDescGZIP(), []int{0, 4}
}
...
func (x *ChangeStreamRecord_DataChangeRecord_ColumnMetadata) Reset() {
	*x = ChangeStreamRecord_DataChangeRecord_ColumnMetadata{}
	mi := &file_google_spanner_v1_vtinternal_change_stream_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ChangeStreamRecord_DataChangeRecord_ModValue) Reset() {
	*x = ChangeStreamRecord_DataChangeRecord_ModValue{}
	mi := &file_google_spanner_v1_vtinternal_change_stream_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ChangeStreamRecord_DataChangeRecord_Mod) Reset() {
	*x = ChangeStreamRecord_DataChangeRecord_Mod{}
	mi := &file_google_spanner_v1_vtinternal_change_stream_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChangeStreamRecord_DataChangeRecord_Mod) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_change_stream_proto_rawDescGZIP(), []int{0, 0, 2}
}
...
func (x *ChangeStreamRecord_PartitionEventRecord_MoveInEvent) Reset() {
	*x = ChangeStreamRecord_PartitionEventRecord_MoveInEvent{}
	mi := &file_google_spanner_v1_vtinternal_change_stream_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChangeStreamRecord_PartitionEventRecord_MoveInEvent) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_change_stream_proto_rawDescGZIP(), []int{0, 4, 0}
}
...
func (x *ChangeStreamRecord_PartitionEventRecord_MoveOutEvent) Reset() {
	*x = ChangeStreamRecord_PartitionEventRecord_MoveOutEvent{}
	mi := &file_google_spanner_v1_vtinternal_change_stream_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChangeStreamRecord_PartitionEventRecord_MoveOutEvent) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_change_stream_proto_rawDescGZIP(), []int{0, 4, 1}
}
...
var File_google_spanner_v1_vtinternal_change_stream_proto protoreflect.FileDescriptor

const file_google_spanner_v1_vtinternal_change_stream_proto_rawDesc = "" +
	"\n" +
	"0google/spanner/v1/vtinternal/change_stream.proto\x12\x1cgoogle.spanner.v1.vtinternal\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a'google/spanner/v1/vtinternal/type.proto\"\xe6\x1a\n" +
	"\x12ChangeStreamRecord\x12q\n" +
	"\x12data_change_record\x18\x01 \x01(\v2A.google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecordH\x00R\x10dataChangeRecord\x12m\n" +
	"\x10heartbeat_record\x18\x02 \x01(\v2@.google.spanner.v1.vtinternal.ChangeStreamRecord.HeartbeatRecordH\x00R\x0fheartbeatRecord\x12}\n" +
	"\x16partition_start_record\x18\x03 \x01(\v2E.google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionStartRecordH\x00R\x14partitionStartRecord\x12w\n" +
	"\x14partition_end_record\x18\x04 \x01(\v2C.google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEndRecordH\x00R\x12partitionEndRecord\x12}\n" +
	"\x16partition_event_record\x18\x05 \x01(\v2E.google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEventRecordH\x00R\x14partitionEventRecord\x1a\x87\x0e\n" +
	...
	"\x05table\x18\x05 \x01(\tR\x05table\x12y\n" +
	"\x0fcolumn_metadata\x18\x06 \x03(\v2P.google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ColumnMetadataR\x0ecolumnMetadata\x12Y\n" +
	"\x04mods\x18\a \x03(\v2E.google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ModR\x04mods\x12d\n" +
	"\bmod_type\x18\b \x01(\x0e2I.google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ModTypeR\amodType\x12\x80\x01\n" +
	"\x12value_capture_type\x18\t \x01(\x0e2R.google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ValueCaptureTypeR\x10valueCaptureType\x12F\n" +
	...
	"\x15is_system_transaction\x18\r \x01(\bR\x13isSystemTransaction\x1a\xad\x01\n" +
	"\x0eColumnMetadata\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x126\n" +
	"\x04type\x18\x02 \x01(\v2\".google.spanner.v1.vtinternal.TypeR\x04type\x12$\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value\x1a\xbb\x02\n" +
	"\x03Mod\x12^\n" +
	"\x04keys\x18\x01 \x03(\v2J.google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ModValueR\x04keys\x12i\n" +
	"\n" +
	"old_values\x18\x02 \x03(\v2J.google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ModValueR\toldValues\x12i\n" +
	"\n" +
	"new_values\x18\x03 \x03(\v2J.google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ModValueR\tnewValues\"G\n" +
	"\aModType\x12\x18\n" +
	...
	"\x0frecord_sequence\x18\x02 \x01(\tR\x0erecordSequence\x12'\n" +
	"\x0fpartition_token\x18\x03 \x01(\tR\x0epartitionToken\x1a\xb9\x04\n" +
	"\x14PartitionEventRecord\x12E\n" +
	"\x10commit_timestamp\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x0fcommitTimestamp\x12'\n" +
	"\x0frecord_sequence\x18\x02 \x01(\tR\x0erecordSequence\x12'\n" +
	"\x0fpartition_token\x18\x03 \x01(\tR\x0epartitionToken\x12w\n" +
	"\x0emove_in_events\x18\x04 \x03(\v2Q.google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEventRecord.MoveInEventR\fmoveInEvents\x12z\n" +
	"\x0fmove_out_events\x18\x05 \x03(\v2R.google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEventRecord.MoveOutEventR\rmoveOutEvents\x1aC\n" +
	"\vMoveInEvent\x124\n" +
	...
	"\x06recordB\xad\x01\n" +
	"\x15com.google.spanner.v1B\x11ChangeStreamProtoP\x01Z.cloud.google.com/go/spanner/internal/vtpb;vtpb\xaa\x02\x17Google.Cloud.Spanner.V1\xca\x02\x17Google\\Cloud\\Spanner\\V1\xea\x02\x1aGoogle::Cloud::Spanner::V1b\x06proto3"

var (
	file_google_spanner_v1_vtinternal_change_stream_proto_rawDescOnce sync.Once
	file_google_spanner_v1_vtinternal_change_stream_proto_rawDescData []byte
)

func file_google_spanner_v1_vtinternal_change_stream_proto_rawDescGZIP() []byte {
	file_google_spanner_v1_vtinternal_change_stream_proto_rawDescOnce.Do(func() {
		file_google_spanner_v1_vtinternal_change_stream_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_spanner_v1_vtinternal_change_stream_proto_rawDesc), len(file_google_spanner_v1_vtinternal_change_stream_proto_rawDesc)))
	})
	return file_google_spanner_v1_vtinternal_change_stream_proto_rawDescData
}

var file_google_spanner_v1_vtinternal_change_stream_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_google_spanner_v1_vtinternal_change_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_google_spanner_v1_vtinternal_change_stream_proto_goTypes = []any{
	(ChangeStreamRecord_DataChangeRecord_ModType)(0),             // 0: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ModType
	(ChangeStreamRecord_DataChangeRecord_ValueCaptureType)(0),    // 1: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ValueCaptureType
	(*ChangeStreamRecord)(nil),                                   // 2: google.spanner.v1.vtinternal.ChangeStreamRecord
	(*ChangeStreamRecord_DataChangeRecord)(nil),                  // 3: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord
	(*ChangeStreamRecord_HeartbeatRecord)(nil),                   // 4: google.spanner.v1.vtinternal.ChangeStreamRecord.HeartbeatRecord
	(*ChangeStreamRecord_PartitionStartRecord)(nil),              // 5: google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionStartRecord
	(*ChangeStreamRecord_PartitionEndRecord)(nil),                // 6: google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEndRecord
	(*ChangeStreamRecord_PartitionEventRecord)(nil),              // 7: google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEventRecord
	(*ChangeStreamRecord_DataChangeRecord_ColumnMetadata)(nil),   // 8: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ColumnMetadata
	(*ChangeStreamRecord_DataChangeRecord_ModValue)(nil),         // 9: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ModValue
	(*ChangeStreamRecord_DataChangeRecord_Mod)(nil),              // 10: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.Mod
	(*ChangeStreamRecord_PartitionEventRecord_MoveInEvent)(nil),  // 11: google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEventRecord.MoveInEvent
	(*ChangeStreamRecord_PartitionEventRecord_MoveOutEvent)(nil), // 12: google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEventRecord.MoveOutEvent
	(*timestamppb.Timestamp)(nil),                                // 13: google.protobuf.Timestamp
	(*Type)(nil),                                                 // 14: google.spanner.v1.vtinternal.Type
	(*structpb.Value)(nil),                                       // 15: google.protobuf.Value
}
var file_google_spanner_v1_vtinternal_change_stream_proto_depIdxs = []int32{
	3,  // 0: google.spanner.v1.vtinternal.ChangeStreamRecord.data_change_record:type_name -> google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord
	4,  // 1: google.spanner.v1.vtinternal.ChangeStreamRecord.heartbeat_record:type_name -> google.spanner.v1.vtinternal.ChangeStreamRecord.HeartbeatRecord
	5,  // 2: google.spanner.v1.vtinternal.ChangeStreamRecord.partition_start_record:type_name -> google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionStartRecord
	6,  // 3: google.spanner.v1.vtinternal.ChangeStreamRecord.partition_end_record:type_name -> google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEndRecord
	7,  // 4: google.spanner.v1.vtinternal.ChangeStreamRecord.partition_event_record:type_name -> google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEventRecord
	13, // 5: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.commit_timestamp:type_name -> google.protobuf.Timestamp
	8,  // 6: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.column_metadata:type_name -> google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ColumnMetadata
	10, // 7: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.mods:type_name -> google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.Mod
	0,  // 8: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.mod_type:type_name -> google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ModType
	1,  // 9: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.value_capture_type:type_name -> google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ValueCaptureType
	13, // 10: google.spanner.v1.vtinternal.ChangeStreamRecord.HeartbeatRecord.timestamp:type_name -> google.protobuf.Timestamp
	13, // 11: google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionStartRecord.start_timestamp:type_name -> google.protobuf.Timestamp
	13, // 12: google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEndRecord.end_timestamp:type_name -> google.protobuf.Timestamp
	13, // 13: google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEventRecord.commit_timestamp:type_name -> google.protobuf.Timestamp
	11, // 14: google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEventRecord.move_in_events:type_name -> google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEventRecord.MoveInEvent
	12, // 15: google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEventRecord.move_out_events:type_name -> google.spanner.v1.vtinternal.ChangeStreamRecord.PartitionEventRecord.MoveOutEvent
	14, // 16: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ColumnMetadata.type:type_name -> google.spanner.v1.vtinternal.Type
	15, // 17: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ModValue.value:type_name -> google.protobuf.Value
	9,  // 18: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.Mod.keys:type_name -> google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ModValue
	9,  // 19: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.Mod.old_values:type_name -> google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ModValue
	9,  // 20: google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.Mod.new_values:type_name -> google.spanner.v1.vtinternal.ChangeStreamRecord.DataChangeRecord.ModValue
...
func init() { file_google_spanner_v1_vtinternal_change_stream_proto_init() }
func file_google_spanner_v1_vtinternal_change_stream_proto_init() {
	if File_google_spanner_v1_vtinternal_change_stream_proto != nil {
		return
	}
	file_google_spanner_v1_vtinternal_type_proto_init()
	file_google_spanner_v1_vtinternal_change_stream_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_spanner_v1_vtinternal_change_stream_proto_rawDesc), len(file_google_spanner_v1_vtinternal_change_stream_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_spanner_v1_vtinternal_change_stream_proto_goTypes,
		DependencyIndexes: file_google_spanner_v1_vtinternal_change_stream_proto_depIdxs,
		EnumInfos:         file_google_spanner_v1_vtinternal_change_stream_proto_enumTypes,
		MessageInfos:      file_google_spanner_v1_vtinternal_change_stream_proto_msgTypes,
	}.Build()
	File_google_spanner_v1_vtinternal_change_stream_proto = out.File
	file_google_spanner_v1_vtinternal_change_stream_proto_goTypes = nil
	file_google_spanner_v1_vtinternal_change_stream_proto_depIdxs = nil
}
