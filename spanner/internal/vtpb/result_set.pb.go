...
// 	protoc        v6.33.2
// source: google/spanner/v1/vtinternal/result_set.proto
...
func (x *ResultSet) Reset() {
	*x = ResultSet{}
	mi := &file_google_spanner_v1_vtinternal_result_set_proto_msgTypes[0]
...
func (*ResultSet) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_result_set_proto_rawDescGZIP(), []int{0}
}
...
func (x *PartialResultSet) Reset() {
	*x = PartialResultSet{}
	mi := &file_google_spanner_v1_vtinternal_result_set_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PartialResultSet) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_result_set_proto_rawDescGZIP(), []int{1}
}
...
func (x *ResultSetMetadata) Reset() {
	*x = ResultSetMetadata{}
	mi := &file_google_spanner_v1_vtinternal_result_set_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResultSetMetadata) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_result_set_proto_rawDescGZIP(), []int{2}
}
...
func (x *ResultSetStats) Reset() {
	*x = ResultSetStats{}
	mi := &file_google_spanner_v1_vtinternal_result_set_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResultSetStats) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_result_set_proto_rawDescGZIP(), []int{3}
}
...
var File_google_spanner_v1_vtinternal_result_set_proto protoreflect.FileDescriptor

const file_google_spanner_v1_vtinternal_result_set_proto_rawDesc = "" +
	"\n" +
	"-google/spanner/v1/vtinternal/result_set.proto\x12\x1cgoogle.spanner.v1.vtinternal\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a+google/spanner/v1/vtinternal/location.proto\x1a-google/spanner/v1/vtinternal/query_plan.proto\x1a.google/spanner/v1/vtinternal/transaction.proto\x1a'google/spanner/v1/vtinternal/type.proto\"\x8d\x03\n" +
	"\tResultSet\x12K\n" +
	"\bmetadata\x18\x01 \x01(\v2/.google.spanner.v1.vtinternal.ResultSetMetadataR\bmetadata\x12.\n" +
	"\x04rows\x18\x02 \x03(\v2\x1a.google.protobuf.ListValueR\x04rows\x12B\n" +
	"\x05stats\x18\x03 \x01(\v2,.google.spanner.v1.vtinternal.ResultSetStatsR\x05stats\x12l\n" +
	"\x0fprecommit_token\x18\x05 \x01(\v2>.google.spanner.v1.vtinternal.MultiplexedSessionPrecommitTokenB\x03\xe0A\x01R\x0eprecommitToken\x12Q\n" +
	"\fcache_update\x18\x06 \x01(\v2).google.spanner.v1.vtinternal.CacheUpdateB\x03\xe0A\x01R\vcacheUpdate\"\xf5\x03\n" +
	"\x10PartialResultSet\x12K\n" +
	"\bmetadata\x18\x01 \x01(\v2/.google.spanner.v1.vtinternal.ResultSetMetadataR\bmetadata\x12.\n" +
	"\x06values\x18\x02 \x03(\v2\x16.google.protobuf.ValueR\x06values\x12#\n" +
	"\rchunked_value\x18\x03 \x01(\bR\fchunkedValue\x12!\n" +
	"\fresume_token\x18\x04 \x01(\fR\vresumeToken\x12B\n" +
	"\x05stats\x18\x05 \x01(\v2,.google.spanner.v1.vtinternal.ResultSetStatsR\x05stats\x12l\n" +
	"\x0fprecommit_token\x18\b \x01(\v2>.google.spanner.v1.vtinternal.MultiplexedSessionPrecommitTokenB\x03\xe0A\x01R\x0eprecommitToken\x12\x17\n" +
	"\x04last\x18\t \x01(\bB\x03\xe0A\x01R\x04last\x12Q\n" +
	"\fcache_update\x18\n" +
	" \x01(\v2).google.spanner.v1.vtinternal.CacheUpdateB\x03\xe0A\x01R\vcacheUpdate\"\x84\x02\n" +
	"\x11ResultSetMetadata\x12C\n" +
	"\brow_type\x18\x01 \x01(\v2(.google.spanner.v1.vtinternal.StructTypeR\arowType\x12K\n" +
	"\vtransaction\x18\x02 \x01(\v2).google.spanner.v1.vtinternal.TransactionR\vtransaction\x12]\n" +
	"\x15undeclared_parameters\x18\x03 \x01(\v2(.google.spanner.v1.vtinternal.StructTypeR\x14undeclaredParameters\"\xfe\x01\n" +
	"\x0eResultSetStats\x12F\n" +
	"\n" +
	"query_plan\x18\x01 \x01(\v2'.google.spanner.v1.vtinternal.QueryPlanR\tqueryPlan\x128\n" +
	...
	"\trow_countB\xaa\x01\n" +
	"\x15com.google.spanner.v1B\x0eResultSetProtoP\x01Z.cloud.google.com/go/spanner/internal/vtpb;vtpb\xaa\x02\x17Google.Cloud.Spanner.V1\xca\x02\x17Google\\Cloud\\Spanner\\V1\xea\x02\x1aGoogle::Cloud::Spanner::V1b\x06proto3"

var (
	file_google_spanner_v1_vtinternal_result_set_proto_rawDescOnce sync.Once
	file_google_spanner_v1_vtinternal_result_set_proto_rawDescData []byte
)

func file_google_spanner_v1_vtinternal_result_set_proto_rawDescGZIP() []byte {
	file_google_spanner_v1_vtinternal_result_set_proto_rawDescOnce.Do(func() {
		file_google_spanner_v1_vtinternal_result_set_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_spanner_v1_vtinternal_result_set_proto_rawDesc), len(file_google_spanner_v1_vtinternal_result_set_proto_rawDesc)))
	})
	return file_google_spanner_v1_vtinternal_result_set_proto_rawDescData
}

var file_google_spanner_v1_vtinternal_result_set_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_spanner_v1_vtinternal_result_set_proto_goTypes = []any{
	(*ResultSet)(nil),                        // 0: google.spanner.v1.vtinternal.ResultSet
	(*PartialResultSet)(nil),                 // 1: google.spanner.v1.vtinternal.PartialResultSet
	(*ResultSetMetadata)(nil),                // 2: google.spanner.v1.vtinternal.ResultSetMetadata
	(*ResultSetStats)(nil),                   // 3: google.spanner.v1.vtinternal.ResultSetStats
	...
	(*CacheUpdate)(nil),                      // 6: google.spanner.v1.vtinternal.CacheUpdate
	(*structpb.Value)(nil),                   // 7: google.protobuf.Value
	(*StructType)(nil),                       // 8: google.spanner.v1.vtinternal.StructType
	(*Transaction)(nil),                      // 9: google.spanner.v1.vtinternal.Transaction
	(*QueryPlan)(nil),                        // 10: google.spanner.v1.vtinternal.QueryPlan
	(*structpb.Struct)(nil),                  // 11: google.protobuf.Struct
}
var file_google_spanner_v1_vtinternal_result_set_proto_depIdxs = []int32{
	2,  // 0: google.spanner.v1.vtinternal.ResultSet.metadata:type_name -> google.spanner.v1.vtinternal.ResultSetMetadata
	4,  // 1: google.spanner.v1.vtinternal.ResultSet.rows:type_name -> google.protobuf.ListValue
	3,  // 2: google.spanner.v1.vtinternal.ResultSet.stats:type_name -> google.spanner.v1.vtinternal.ResultSetStats
	5,  // 3: google.spanner.v1.vtinternal.ResultSet.precommit_token:type_name -> google.spanner.v1.vtinternal.MultiplexedSessionPrecommitToken
	6,  // 4: google.spanner.v1.vtinternal.ResultSet.cache_update:type_name -> google.spanner.v1.vtinternal.CacheUpdate
	2,  // 5: google.spanner.v1.vtinternal.PartialResultSet.metadata:type_name -> google.spanner.v1.vtinternal.ResultSetMetadata
	7,  // 6: google.spanner.v1.vtinternal.PartialResultSet.values:type_name -> google.protobuf.Value
	3,  // 7: google.spanner.v1.vtinternal.PartialResultSet.stats:type_name -> google.spanner.v1.vtinternal.ResultSetStats
	5,  // 8: google.spanner.v1.vtinternal.PartialResultSet.precommit_token:type_name -> google.spanner.v1.vtinternal.MultiplexedSessionPrecommitToken
	6,  // 9: google.spanner.v1.vtinternal.PartialResultSet.cache_update:type_name -> google.spanner.v1.vtinternal.CacheUpdate
	8,  // 10: google.spanner.v1.vtinternal.ResultSetMetadata.row_type:type_name -> google.spanner.v1.vtinternal.StructType
	9,  // 11: google.spanner.v1.vtinternal.ResultSetMetadata.transaction:type_name -> google.spanner.v1.vtinternal.Transaction
	8,  // 12: google.spanner.v1.vtinternal.ResultSetMetadata.undeclared_parameters:type_name -> google.spanner.v1.vtinternal.StructType
	10, // 13: google.spanner.v1.vtinternal.ResultSetStats.query_plan:type_name -> google.spanner.v1.vtinternal.QueryPlan
	11, // 14: google.spanner.v1.vtinternal.ResultSetStats.query_stats:type_name -> google.protobuf.Struct
...
func init() { file_google_spanner_v1_vtinternal_result_set_proto_init() }
func file_google_spanner_v1_vtinternal_result_set_proto_init() {
	if File_google_spanner_v1_vtinternal_result_set_proto != nil {
		return
	}
	file_google_spanner_v1_vtinternal_location_proto_init()
	file_google_spanner_v1_vtinternal_query_plan_proto_init()
	file_google_spanner_v1_vtinternal_transaction_proto_init()
	file_google_spanner_v1_vtinternal_type_proto_init()
	file_google_spanner_v1_vtinternal_result_set_proto_msgTypes[3].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_spanner_v1_vtinternal_result_set_proto_rawDesc), len(file_google_spanner_v1_vtinternal_result_set_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_spanner_v1_vtinternal_result_set_proto_goTypes,
		DependencyIndexes: file_google_spanner_v1_vtinternal_result_set_proto_depIdxs,
		MessageInfos:      file_google_spanner_v1_vtinternal_result_set_proto_msgTypes,
	}.Build()
	File_google_spanner_v1_vtinternal_result_set_proto = out.File
	file_google_spanner_v1_vtinternal_result_set_proto_goTypes = nil
	file_google_spanner_v1_vtinternal_result_set_proto_depIdxs = nil
}
