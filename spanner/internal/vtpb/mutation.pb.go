...
// 	protoc        v6.33.2
// source: google/spanner/v1/vtinternal/mutation.proto
...
func (x *Mutation) Reset() {
	*x = Mutation{}
	mi := &file_google_spanner_v1_vtinternal_mutation_proto_msgTypes[0]
...
func (*Mutation) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_mutation_proto_rawDescGZIP(), []int{0}
}
...
func (x *Mutation_Write) Reset() {
	*x = Mutation_Write{}
	mi := &file_google_spanner_v1_vtinternal_mutation_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Mutation_Write) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_mutation_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *Mutation_Delete) Reset() {
	*x = Mutation_Delete{}
	mi := &file_google_spanner_v1_vtinternal_mutation_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Mutation_Delete) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_mutation_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *Mutation_Send) Reset() {
	*x = Mutation_Send{}
	mi := &file_google_spanner_v1_vtinternal_mutation_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Mutation_Send) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_mutation_proto_rawDescGZIP(), []int{0, 2}
}
...
func (x *Mutation_Ack) Reset() {
	*x = Mutation_Ack{}
	mi := &file_google_spanner_v1_vtinternal_mutation_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Mutation_Ack) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_mutation_proto_rawDescGZIP(), []int{0, 3}
}
...
var File_google_spanner_v1_vtinternal_mutation_proto protoreflect.FileDescriptor

const file_google_spanner_v1_vtinternal_mutation_proto_rawDesc = "" +
	"\n" +
	"+google/spanner/v1/vtinternal/mutation.proto\x12\x1cgoogle.spanner.v1.vtinternal\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a'google/spanner/v1/vtinternal/keys.proto\"\xb9\b\n" +
	"\bMutation\x12F\n" +
	"\x06insert\x18\x01 \x01(\v2,.google.spanner.v1.vtinternal.Mutation.WriteH\x00R\x06insert\x12F\n" +
	"\x06update\x18\x02 \x01(\v2,.google.spanner.v1.vtinternal.Mutation.WriteH\x00R\x06update\x12X\n" +
	"\x10insert_or_update\x18\x03 \x01(\v2,.google.spanner.v1.vtinternal.Mutation.WriteH\x00R\x0einsertOrUpdate\x12H\n" +
	"\areplace\x18\x04 \x01(\v2,.google.spanner.v1.vtinternal.Mutation.WriteH\x00R\areplace\x12G\n" +
	"\x06delete\x18\x05 \x01(\v2-.google.spanner.v1.vtinternal.Mutation.DeleteH\x00R\x06delete\x12A\n" +
	"\x04send\x18\x06 \x01(\v2+.google.spanner.v1.vtinternal.Mutation.SendH\x00R\x04send\x12>\n" +
	"\x03ack\x18\a \x01(\v2*.google.spanner.v1.vtinternal.Mutation.AckH\x00R\x03ack\x1ap\n" +
	"\x05Write\x12\x19\n" +
	"\x05table\x18\x01 \x01(\tB\x03\xe0A\x02R\x05table\x12\x18\n" +
	"\acolumns\x18\x02 \x03(\tR\acolumns\x122\n" +
	"\x06values\x18\x03 \x03(\v2\x1a.google.protobuf.ListValueR\x06values\x1ag\n" +
	"\x06Delete\x12\x19\n" +
	"\x05table\x18\x01 \x01(\tB\x03\xe0A\x02R\x05table\x12B\n" +
	"\akey_set\x18\x02 \x01(\v2$.google.spanner.v1.vtinternal.KeySetB\x03\xe0A\x02R\x06keySet\x1a\xc5\x01\n" +
	"\x04Send\x12\x19\n" +
	...
	"\toperationB\xa9\x01\n" +
	"\x15com.google.spanner.v1B\rMutationProtoP\x01Z.cloud.google.com/go/spanner/internal/vtpb;vtpb\xaa\x02\x17Google.Cloud.Spanner.V1\xca\x02\x17Google\\Cloud\\Spanner\\V1\xea\x02\x1aGoogle::Cloud::Spanner::V1b\x06proto3"

var (
	file_google_spanner_v1_vtinternal_mutation_proto_rawDescOnce sync.Once
	file_google_spanner_v1_vtinternal_mutation_proto_rawDescData []byte
)

func file_google_spanner_v1_vtinternal_mutation_proto_rawDescGZIP() []byte {
	file_google_spanner_v1_vtinternal_mutation_proto_rawDescOnce.Do(func() {
		file_google_spanner_v1_vtinternal_mutation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_spanner_v1_vtinternal_mutation_proto_rawDesc), len(file_google_spanner_v1_vtinternal_mutation_proto_rawDesc)))
	})
	return file_google_spanner_v1_vtinternal_mutation_proto_rawDescData
}

var file_google_spanner_v1_vtinternal_mutation_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_spanner_v1_vtinternal_mutation_proto_goTypes = []any{
	(*Mutation)(nil),              // 0: google.spanner.v1.vtinternal.Mutation
	(*Mutation_Write)(nil),        // 1: google.spanner.v1.vtinternal.Mutation.Write
	(*Mutation_Delete)(nil),       // 2: google.spanner.v1.vtinternal.Mutation.Delete
	(*Mutation_Send)(nil),         // 3: google.spanner.v1.vtinternal.Mutation.Send
	(*Mutation_Ack)(nil),          // 4: google.spanner.v1.vtinternal.Mutation.Ack
	(*structpb.ListValue)(nil),    // 5: google.protobuf.ListValue
	(*KeySet)(nil),                // 6: google.spanner.v1.vtinternal.KeySet
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
	(*structpb.Value)(nil),        // 8: google.protobuf.Value
}
var file_google_spanner_v1_vtinternal_mutation_proto_depIdxs = []int32{
	1,  // 0: google.spanner.v1.vtinternal.Mutation.insert:type_name -> google.spanner.v1.vtinternal.Mutation.Write
	1,  // 1: google.spanner.v1.vtinternal.Mutation.update:type_name -> google.spanner.v1.vtinternal.Mutation.Write
	1,  // 2: google.spanner.v1.vtinternal.Mutation.insert_or_update:type_name -> google.spanner.v1.vtinternal.Mutation.Write
	1,  // 3: google.spanner.v1.vtinternal.Mutation.replace:type_name -> google.spanner.v1.vtinternal.Mutation.Write
	2,  // 4: google.spanner.v1.vtinternal.Mutation.delete:type_name -> google.spanner.v1.vtinternal.Mutation.Delete
	3,  // 5: google.spanner.v1.vtinternal.Mutation.send:type_name -> google.spanner.v1.vtinternal.Mutation.Send
	4,  // 6: google.spanner.v1.vtinternal.Mutation.ack:type_name -> google.spanner.v1.vtinternal.Mutation.Ack
	5,  // 7: google.spanner.v1.vtinternal.Mutation.Write.values:type_name -> google.protobuf.ListValue
	6,  // 8: google.spanner.v1.vtinternal.Mutation.Delete.key_set:type_name -> google.spanner.v1.vtinternal.KeySet
	5,  // 9: google.spanner.v1.vtinternal.Mutation.Send.key:type_name -> google.protobuf.ListValue
	7,  // 10: google.spanner.v1.vtinternal.Mutation.Send.deliver_time:type_name -> google.protobuf.Timestamp
	8,  // 11: google.spanner.v1.vtinternal.Mutation.Send.payload:type_name -> google.protobuf.Value
	5,  // 12: google.spanner.v1.vtinternal.Mutation.Ack.key:type_name -> google.protobuf.ListValue
...
func init() { file_google_spanner_v1_vtinternal_mutation_proto_init() }
func file_google_spanner_v1_vtinternal_mutation_proto_init() {
	if File_google_spanner_v1_vtinternal_mutation_proto != nil {
		return
	}
	file_google_spanner_v1_vtinternal_keys_proto_init()
	file_google_spanner_v1_vtinternal_mutation_proto_msgTypes[0].OneofWrappers = []any{
		(*Mutation_Insert)(nil),
		(*Mutation_Update)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_spanner_v1_vtinternal_mutation_proto_rawDesc), len(file_google_spanner_v1_vtinternal_mutation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_spanner_v1_vtinternal_mutation_proto_goTypes,
		DependencyIndexes: file_google_spanner_v1_vtinternal_mutation_proto_depIdxs,
		MessageInfos:      file_google_spanner_v1_vtinternal_mutation_proto_msgTypes,
	}.Build()
	File_google_spanner_v1_vtinternal_mutation_proto = out.File
	file_google_spanner_v1_vtinternal_mutation_proto_goTypes = nil
	file_google_spanner_v1_vtinternal_mutation_proto_depIdxs = nil
}
