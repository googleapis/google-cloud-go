...
// 	protoc        v6.33.2
// source: google/spanner/v1/vtinternal/transaction.proto
...
func (TransactionOptions_IsolationLevel) Descriptor() protoreflect.EnumDescriptor {
	return file_google_spanner_v1_vtinternal_transaction_proto_enumTypes[0].Descriptor()
}

func (TransactionOptions_IsolationLevel) Type() protoreflect.EnumType {
	return &file_google_spanner_v1_vtinternal_transaction_proto_enumTypes[0]
}
...
func (TransactionOptions_IsolationLevel) EnumDescriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_transaction_proto_rawDescGZIP(), []int{0, 0}
}
...
func (TransactionOptions_ReadWrite_ReadLockMode) Descriptor() protoreflect.EnumDescriptor {
	return file_google_spanner_v1_vtinternal_transaction_proto_enumTypes[1].Descriptor()
}

func (TransactionOptions_ReadWrite_ReadLockMode) Type() protoreflect.EnumType {
	return &file_google_spanner_v1_vtinternal_transaction_proto_enumTypes[1]
}
...
func (TransactionOptions_ReadWrite_ReadLockMode) EnumDescriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_transaction_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
type TransactionOptions struct {
	...
	IsolationLevel TransactionOptions_IsolationLevel `protobuf:"varint,6,opt,name=isolation_level,json=isolationLevel,proto3,enum=google.spanner.v1.vtinternal.TransactionOptions_IsolationLevel" json:"isolation_level,omitempty"`
...
func (x *TransactionOptions) Reset() {
	*x = TransactionOptions{}
	mi := &file_google_spanner_v1_vtinternal_transaction_proto_msgTypes[0]
...
func (*TransactionOptions) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_transaction_proto_rawDescGZIP(), []int{0}
}
...
func (x *Transaction) Reset() {
	*x = Transaction{}
	mi := &file_google_spanner_v1_vtinternal_transaction_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_transaction_proto_rawDescGZIP(), []int{1}
}
...
func (x *TransactionSelector) Reset() {
	*x = TransactionSelector{}
	mi := &file_google_spanner_v1_vtinternal_transaction_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TransactionSelector) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_transaction_proto_rawDescGZIP(), []int{2}
}
...
func (x *MultiplexedSessionPrecommitToken) Reset() {
	*x = MultiplexedSessionPrecommitToken{}
	mi := &file_google_spanner_v1_vtinternal_transaction_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MultiplexedSessionPrecommitToken) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_transaction_proto_rawDescGZIP(), []int{3}
}
...
type TransactionOptions_ReadWrite struct {
	...
	ReadLockMode TransactionOptions_ReadWrite_ReadLockMode `protobuf:"varint,1,opt,name=read_lock_mode,json=readLockMode,proto3,enum=google.spanner.v1.vtinternal.TransactionOptions_ReadWrite_ReadLockMode" json:"read_lock_mode,omitempty"`
...
func (x *TransactionOptions_ReadWrite) Reset() {
	*x = TransactionOptions_ReadWrite{}
	mi := &file_google_spanner_v1_vtinternal_transaction_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *TransactionOptions_PartitionedDml) Reset() {
	*x = TransactionOptions_PartitionedDml{}
	mi := &file_google_spanner_v1_vtinternal_transaction_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TransactionOptions_PartitionedDml) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_transaction_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *TransactionOptions_ReadOnly) Reset() {
	*x = TransactionOptions_ReadOnly{}
	mi := &file_google_spanner_v1_vtinternal_transaction_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TransactionOptions_ReadOnly) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_transaction_proto_rawDescGZIP(), []int{0, 2}
}
...
var File_google_spanner_v1_vtinternal_transaction_proto protoreflect.FileDescriptor

const file_google_spanner_v1_vtinternal_transaction_proto_rawDesc = "" +
	"\n" +
	".google/spanner/v1/vtinternal/transaction.proto\x12\x1cgoogle.spanner.v1.vtinternal\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a+google/spanner/v1/vtinternal/location.proto\"\x93\n" +
	"\n" +
	"\x12TransactionOptions\x12[\n" +
	"\n" +
	"read_write\x18\x01 \x01(\v2:.google.spanner.v1.vtinternal.TransactionOptions.ReadWriteH\x00R\treadWrite\x12j\n" +
	"\x0fpartitioned_dml\x18\x03 \x01(\v2?.google.spanner.v1.vtinternal.TransactionOptions.PartitionedDmlH\x00R\x0epartitionedDml\x12X\n" +
	"\tread_only\x18\x02 \x01(\v29.google.spanner.v1.vtinternal.TransactionOptions.ReadOnlyH\x00R\breadOnly\x12D\n" +
	"\x1fexclude_txn_from_change_streams\x18\x05 \x01(\bR\x1bexcludeTxnFromChangeStreams\x12h\n" +
	"\x0fisolation_level\x18\x06 \x01(\x0e2?.google.spanner.v1.vtinternal.TransactionOptions.IsolationLevelR\x0eisolationLevel\x1a\xae\x02\n" +
	"\tReadWrite\x12m\n" +
	"\x0eread_lock_mode\x18\x01 \x01(\x0e2G.google.spanner.v1.vtinternal.TransactionOptions.ReadWrite.ReadLockModeR\freadLockMode\x12a\n" +
	...
	"\x0eread_timestamp\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\rreadTimestamp\x12g\n" +
	"\x0fprecommit_token\x18\x03 \x01(\v2>.google.spanner.v1.vtinternal.MultiplexedSessionPrecommitTokenR\x0eprecommitToken\x12Q\n" +
	"\fcache_update\x18\x05 \x01(\v2).google.spanner.v1.vtinternal.CacheUpdateB\x03\xe0A\x01R\vcacheUpdate\"\xd0\x01\n" +
	"\x13TransactionSelector\x12Q\n" +
	"\n" +
	"single_use\x18\x01 \x01(\v20.google.spanner.v1.vtinternal.TransactionOptionsH\x00R\tsingleUse\x12\x10\n" +
	"\x02id\x18\x02 \x01(\fH\x00R\x02id\x12H\n" +
	"\x05begin\x18\x03 \x01(\v20.google.spanner.v1.vtinternal.TransactionOptionsH\x00R\x05beginB\n" +
	"\n" +
	"\bselector\"d\n" +
	" MultiplexedSessionPrecommitToken\x12'\n" +
	"\x0fprecommit_token\x18\x01 \x01(\fR\x0eprecommitToken\x12\x17\n" +
	"\aseq_num\x18\x02 \x01(\x05R\x06seqNumB\xac\x01\n" +
	"\x15com.google.spanner.v1B\x10TransactionProtoP\x01Z.cloud.google.com/go/spanner/internal/vtpb;vtpb\xaa\x02\x17Google.Cloud.Spanner.V1\xca\x02\x17Google\\Cloud\\Spanner\\V1\xea\x02\x1aGoogle::Cloud::Spanner::V1b\x06proto3"

var (
	file_google_spanner_v1_vtinternal_transaction_proto_rawDescOnce sync.Once
	file_google_spanner_v1_vtinternal_transaction_proto_rawDescData []byte
)

func file_google_spanner_v1_vtinternal_transaction_proto_rawDescGZIP() []byte {
	file_google_spanner_v1_vtinternal_transaction_proto_rawDescOnce.Do(func() {
		file_google_spanner_v1_vtinternal_transaction_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_spanner_v1_vtinternal_transaction_proto_rawDesc), len(file_google_spanner_v1_vtinternal_transaction_proto_rawDesc)))
	})
	return file_google_spanner_v1_vtinternal_transaction_proto_rawDescData
}

var file_google_spanner_v1_vtinternal_transaction_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_google_spanner_v1_vtinternal_transaction_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_google_spanner_v1_vtinternal_transaction_proto_goTypes = []any{
	(TransactionOptions_IsolationLevel)(0),         // 0: google.spanner.v1.vtinternal.TransactionOptions.IsolationLevel
	(TransactionOptions_ReadWrite_ReadLockMode)(0), // 1: google.spanner.v1.vtinternal.TransactionOptions.ReadWrite.ReadLockMode
	(*TransactionOptions)(nil),                     // 2: google.spanner.v1.vtinternal.TransactionOptions
	(*Transaction)(nil),                            // 3: google.spanner.v1.vtinternal.Transaction
	(*TransactionSelector)(nil),                    // 4: google.spanner.v1.vtinternal.TransactionSelector
	(*MultiplexedSessionPrecommitToken)(nil),       // 5: google.spanner.v1.vtinternal.MultiplexedSessionPrecommitToken
	(*TransactionOptions_ReadWrite)(nil),           // 6: google.spanner.v1.vtinternal.TransactionOptions.ReadWrite
	(*TransactionOptions_PartitionedDml)(nil),      // 7: google.spanner.v1.vtinternal.TransactionOptions.PartitionedDml
	(*TransactionOptions_ReadOnly)(nil),            // 8: google.spanner.v1.vtinternal.TransactionOptions.ReadOnly
	(*timestamppb.Timestamp)(nil),                  // 9: google.protobuf.Timestamp
	(*CacheUpdate)(nil),                            // 10: google.spanner.v1.vtinternal.CacheUpdate
	(*durationpb.Duration)(nil),                    // 11: google.protobuf.Duration
}
var file_google_spanner_v1_vtinternal_transaction_proto_depIdxs = []int32{
	6,  // 0: google.spanner.v1.vtinternal.TransactionOptions.read_write:type_name -> google.spanner.v1.vtinternal.TransactionOptions.ReadWrite
	7,  // 1: google.spanner.v1.vtinternal.TransactionOptions.partitioned_dml:type_name -> google.spanner.v1.vtinternal.TransactionOptions.PartitionedDml
	8,  // 2: google.spanner.v1.vtinternal.TransactionOptions.read_only:type_name -> google.spanner.v1.vtinternal.TransactionOptions.ReadOnly
	0,  // 3: google.spanner.v1.vtinternal.TransactionOptions.isolation_level:type_name -> google.spanner.v1.vtinternal.TransactionOptions.IsolationLevel
	9,  // 4: google.spanner.v1.vtinternal.Transaction.read_timestamp:type_name -> google.protobuf.Timestamp
	5,  // 5: google.spanner.v1.vtinternal.Transaction.precommit_token:type_name -> google.spanner.v1.vtinternal.MultiplexedSessionPrecommitToken
	10, // 6: google.spanner.v1.vtinternal.Transaction.cache_update:type_name -> google.spanner.v1.vtinternal.CacheUpdate
	2,  // 7: google.spanner.v1.vtinternal.TransactionSelector.single_use:type_name -> google.spanner.v1.vtinternal.TransactionOptions
	2,  // 8: google.spanner.v1.vtinternal.TransactionSelector.begin:type_name -> google.spanner.v1.vtinternal.TransactionOptions
	1,  // 9: google.spanner.v1.vtinternal.TransactionOptions.ReadWrite.read_lock_mode:type_name -> google.spanner.v1.vtinternal.TransactionOptions.ReadWrite.ReadLockMode
	9,  // 10: google.spanner.v1.vtinternal.TransactionOptions.ReadOnly.min_read_timestamp:type_name -> google.protobuf.Timestamp
	11, // 11: google.spanner.v1.vtinternal.TransactionOptions.ReadOnly.max_staleness:type_name -> google.protobuf.Duration
	9,  // 12: google.spanner.v1.vtinternal.TransactionOptions.ReadOnly.read_timestamp:type_name -> google.protobuf.Timestamp
	11, // 13: google.spanner.v1.vtinternal.TransactionOptions.ReadOnly.exact_staleness:type_name -> google.protobuf.Duration
...
func init() { file_google_spanner_v1_vtinternal_transaction_proto_init() }
func file_google_spanner_v1_vtinternal_transaction_proto_init() {
	if File_google_spanner_v1_vtinternal_transaction_proto != nil {
		return
	}
	file_google_spanner_v1_vtinternal_location_proto_init()
	file_google_spanner_v1_vtinternal_transaction_proto_msgTypes[0].OneofWrappers = []any{
		(*TransactionOptions_ReadWrite_)(nil),
		(*TransactionOptions_PartitionedDml_)(nil),
		(*TransactionOptions_ReadOnly_)(nil),
	}
	file_google_spanner_v1_vtinternal_transaction_proto_msgTypes[2].OneofWrappers = []any{
		(*TransactionSelector_SingleUse)(nil),
		(*TransactionSelector_Id)(nil),
		(*TransactionSelector_Begin)(nil),
	}
	file_google_spanner_v1_vtinternal_transaction_proto_msgTypes[6].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_spanner_v1_vtinternal_transaction_proto_rawDesc), len(file_google_spanner_v1_vtinternal_transaction_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_spanner_v1_vtinternal_transaction_proto_goTypes,
		DependencyIndexes: file_google_spanner_v1_vtinternal_transaction_proto_depIdxs,
		EnumInfos:         file_google_spanner_v1_vtinternal_transaction_proto_enumTypes,
		MessageInfos:      file_google_spanner_v1_vtinternal_transaction_proto_msgTypes,
	}.Build()
	File_google_spanner_v1_vtinternal_transaction_proto = out.File
	file_google_spanner_v1_vtinternal_transaction_proto_goTypes = nil
	file_google_spanner_v1_vtinternal_transaction_proto_depIdxs = nil
}
