...
// 	protoc        v6.33.2
// source: google/spanner/v1/vtinternal/location.proto
...
func (Tablet_Role) Descriptor() protoreflect.EnumDescriptor {
	return file_google_spanner_v1_vtinternal_location_proto_enumTypes[0].Descriptor()
}

func (Tablet_Role) Type() protoreflect.EnumType {
	return &file_google_spanner_v1_vtinternal_location_proto_enumTypes[0]
}
...
func (Tablet_Role) EnumDescriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_location_proto_rawDescGZIP(), []int{1, 0}
}
...
func (KeyRecipe_Part_Order) Descriptor() protoreflect.EnumDescriptor {
	return file_google_spanner_v1_vtinternal_location_proto_enumTypes[1].Descriptor()
}

func (KeyRecipe_Part_Order) Type() protoreflect.EnumType {
	return &file_google_spanner_v1_vtinternal_location_proto_enumTypes[1]
}
...
func (KeyRecipe_Part_Order) EnumDescriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_location_proto_rawDescGZIP(), []int{3, 0, 0}
}
...
func (KeyRecipe_Part_NullOrder) Descriptor() protoreflect.EnumDescriptor {
	return file_google_spanner_v1_vtinternal_location_proto_enumTypes[2].Descriptor()
}

func (KeyRecipe_Part_NullOrder) Type() protoreflect.EnumType {
	return &file_google_spanner_v1_vtinternal_location_proto_enumTypes[2]
}
...
func (KeyRecipe_Part_NullOrder) EnumDescriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_location_proto_rawDescGZIP(), []int{3, 0, 1}
}
...
func (x *Range) Reset() {
	*x = Range{}
	mi := &file_google_spanner_v1_vtinternal_location_proto_msgTypes[0]
...
func (*Range) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_location_proto_rawDescGZIP(), []int{0}
}
...
type Tablet struct {
	...
	Role Tablet_Role `protobuf:"varint,4,opt,name=role,proto3,enum=google.spanner.v1.vtinternal.Tablet_Role" json:"role,omitempty"`
...
func (x *Tablet) Reset() {
	*x = Tablet{}
	mi := &file_google_spanner_v1_vtinternal_location_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Tablet) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_location_proto_rawDescGZIP(), []int{1}
}
...
func (x *Group) Reset() {
	*x = Group{}
	mi := &file_google_spanner_v1_vtinternal_location_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Group) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_location_proto_rawDescGZIP(), []int{2}
}
...
func (x *KeyRecipe) Reset() {
	*x = KeyRecipe{}
	mi := &file_google_spanner_v1_vtinternal_location_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeyRecipe) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_location_proto_rawDescGZIP(), []int{3}
}
...
func (x *RecipeList) Reset() {
	*x = RecipeList{}
	mi := &file_google_spanner_v1_vtinternal_location_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RecipeList) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_location_proto_rawDescGZIP(), []int{4}
}
...
func (x *CacheUpdate) Reset() {
	*x = CacheUpdate{}
	mi := &file_google_spanner_v1_vtinternal_location_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CacheUpdate) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_location_proto_rawDescGZIP(), []int{5}
}
...
func (x *RoutingHint) Reset() {
	*x = RoutingHint{}
	mi := &file_google_spanner_v1_vtinternal_location_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RoutingHint) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_location_proto_rawDescGZIP(), []int{6}
}
...
type KeyRecipe_Part struct {
	...
	// if `tag` is zero.
	Order KeyRecipe_Part_Order `protobuf:"varint,2,opt,name=order,proto3,enum=google.spanner.v1.vtinternal.KeyRecipe_Part_Order" json:"order,omitempty"`
	// How NULLs are represented in the encoded key part. Only present if `tag`
	// is zero.
	NullOrder KeyRecipe_Part_NullOrder `protobuf:"varint,3,opt,name=null_order,json=nullOrder,proto3,enum=google.spanner.v1.vtinternal.KeyRecipe_Part_NullOrder" json:"null_order,omitempty"`
...
func (x *KeyRecipe_Part) Reset() {
	*x = KeyRecipe_Part{}
	mi := &file_google_spanner_v1_vtinternal_location_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeyRecipe_Part) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_location_proto_rawDescGZIP(), []int{3, 0}
}
...
func (x *RoutingHint_SkippedTablet) Reset() {
	*x = RoutingHint_SkippedTablet{}
	mi := &file_google_spanner_v1_vtinternal_location_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RoutingHint_SkippedTablet) Descriptor() ([]byte, []int) {
	return file_google_spanner_v1_vtinternal_location_proto_rawDescGZIP(), []int{6, 0}
}
...
var File_google_spanner_v1_vtinternal_location_proto protoreflect.FileDescriptor

const file_google_spanner_v1_vtinternal_location_proto_rawDesc = "" +
	"\n" +
	"+google/spanner/v1/vtinternal/location.proto\x12\x1cgoogle.spanner.v1.vtinternal\x1a\x1cgoogle/protobuf/struct.proto\x1a'google/spanner/v1/vtinternal/type.proto\"\x99\x01\n" +
	"\x05Range\x12\x1b\n" +
	...
	"\x04role\x18\x04 \x01(\x0e2).google.spanner.v1.vtinternal.Tablet.RoleR\x04role\x12 \n" +
	...
	"\tREAD_ONLY\x10\x02\"\xa7\x01\n" +
	"\x05Group\x12\x1b\n" +
	"\tgroup_uid\x18\x01 \x01(\x04R\bgroupUid\x12>\n" +
	"\atablets\x18\x02 \x03(\v2$.google.spanner.v1.vtinternal.TabletR\atablets\x12!\n" +
	...
	"\roperation_uid\x18\x03 \x01(\x04H\x00R\foperationUid\x12@\n" +
	"\x04part\x18\x04 \x03(\v2,.google.spanner.v1.vtinternal.KeyRecipe.PartR\x04part\x1a\xb1\x04\n" +
	"\x04Part\x12\x10\n" +
	"\x03tag\x18\x01 \x01(\rR\x03tag\x12H\n" +
	"\x05order\x18\x02 \x01(\x0e22.google.spanner.v1.vtinternal.KeyRecipe.Part.OrderR\x05order\x12U\n" +
	"\n" +
	"null_order\x18\x03 \x01(\x0e26.google.spanner.v1.vtinternal.KeyRecipe.Part.NullOrderR\tnullOrder\x126\n" +
	"\x04type\x18\x04 \x01(\v2\".google.spanner.v1.vtinternal.TypeR\x04type\x12 \n" +
	"\n" +
	...
	"\n" +
	"RecipeList\x12+\n" +
	"\x11schema_generation\x18\x01 \x01(\fR\x10schemaGeneration\x12?\n" +
	"\x06recipe\x18\x03 \x03(\v2'.google.spanner.v1.vtinternal.KeyRecipeR\x06recipe\"\xef\x01\n" +
	"\vCacheUpdate\x12\x1f\n" +
	"\vdatabase_id\x18\x01 \x01(\x04R\n" +
	"databaseId\x129\n" +
	"\x05range\x18\x02 \x03(\v2#.google.spanner.v1.vtinternal.RangeR\x05range\x129\n" +
	"\x05group\x18\x03 \x03(\v2#.google.spanner.v1.vtinternal.GroupR\x05group\x12I\n" +
	"\vkey_recipes\x18\x05 \x01(\v2(.google.spanner.v1.vtinternal.RecipeListR\n" +
	"keyRecipes\"\xe8\x03\n" +
	"\vRoutingHint\x12#\n" +
	...
	"\n" +
	"tablet_uid\x18\b \x01(\x04R\ttabletUid\x12e\n" +
	"\x12skipped_tablet_uid\x18\t \x03(\v27.google.spanner.v1.vtinternal.RoutingHint.SkippedTabletR\x10skippedTabletUid\x12'\n" +
	"\x0fclient_location\x18\n" +
	" \x01(\tR\x0eclientLocation\x1aP\n" +
	"\rSkippedTablet\x12\x1d\n" +
	"\n" +
	"tablet_uid\x18\x01 \x01(\x04R\ttabletUid\x12 \n" +
	"\vincarnation\x18\x02 \x01(\fR\vincarnationB\xa9\x01\n" +
	"\x15com.google.spanner.v1B\rLocationProtoP\x01Z.cloud.google.com/go/spanner/internal/vtpb;vtpb\xaa\x02\x17Google.Cloud.Spanner.V1\xca\x02\x17Google\\Cloud\\Spanner\\V1\xea\x02\x1aGoogle::Cloud::Spanner::V1b\x06proto3"

var (
	file_google_spanner_v1_vtinternal_location_proto_rawDescOnce sync.Once
	file_google_spanner_v1_vtinternal_location_proto_rawDescData []byte
)

func file_google_spanner_v1_vtinternal_location_proto_rawDescGZIP() []byte {
	file_google_spanner_v1_vtinternal_location_proto_rawDescOnce.Do(func() {
		file_google_spanner_v1_vtinternal_location_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_spanner_v1_vtinternal_location_proto_rawDesc), len(file_google_spanner_v1_vtinternal_location_proto_rawDesc)))
	})
	return file_google_spanner_v1_vtinternal_location_proto_rawDescData
}

var file_google_spanner_v1_vtinternal_location_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_google_spanner_v1_vtinternal_location_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_google_spanner_v1_vtinternal_location_proto_goTypes = []any{
	(Tablet_Role)(0),                  // 0: google.spanner.v1.vtinternal.Tablet.Role
	(KeyRecipe_Part_Order)(0),         // 1: google.spanner.v1.vtinternal.KeyRecipe.Part.Order
	(KeyRecipe_Part_NullOrder)(0),     // 2: google.spanner.v1.vtinternal.KeyRecipe.Part.NullOrder
	(*Range)(nil),                     // 3: google.spanner.v1.vtinternal.Range
	(*Tablet)(nil),                    // 4: google.spanner.v1.vtinternal.Tablet
	(*Group)(nil),                     // 5: google.spanner.v1.vtinternal.Group
	(*KeyRecipe)(nil),                 // 6: google.spanner.v1.vtinternal.KeyRecipe
	(*RecipeList)(nil),                // 7: google.spanner.v1.vtinternal.RecipeList
	(*CacheUpdate)(nil),               // 8: google.spanner.v1.vtinternal.CacheUpdate
	(*RoutingHint)(nil),               // 9: google.spanner.v1.vtinternal.RoutingHint
	(*KeyRecipe_Part)(nil),            // 10: google.spanner.v1.vtinternal.KeyRecipe.Part
	(*RoutingHint_SkippedTablet)(nil), // 11: google.spanner.v1.vtinternal.RoutingHint.SkippedTablet
	(*Type)(nil),                      // 12: google.spanner.v1.vtinternal.Type
	(*structpb.Value)(nil),            // 13: google.protobuf.Value
}
var file_google_spanner_v1_vtinternal_location_proto_depIdxs = []int32{
	0,  // 0: google.spanner.v1.vtinternal.Tablet.role:type_name -> google.spanner.v1.vtinternal.Tablet.Role
	4,  // 1: google.spanner.v1.vtinternal.Group.tablets:type_name -> google.spanner.v1.vtinternal.Tablet
	10, // 2: google.spanner.v1.vtinternal.KeyRecipe.part:type_name -> google.spanner.v1.vtinternal.KeyRecipe.Part
	6,  // 3: google.spanner.v1.vtinternal.RecipeList.recipe:type_name -> google.spanner.v1.vtinternal.KeyRecipe
	3,  // 4: google.spanner.v1.vtinternal.CacheUpdate.range:type_name -> google.spanner.v1.vtinternal.Range
	5,  // 5: google.spanner.v1.vtinternal.CacheUpdate.group:type_name -> google.spanner.v1.vtinternal.Group
	7,  // 6: google.spanner.v1.vtinternal.CacheUpdate.key_recipes:type_name -> google.spanner.v1.vtinternal.RecipeList
	11, // 7: google.spanner.v1.vtinternal.RoutingHint.skipped_tablet_uid:type_name -> google.spanner.v1.vtinternal.RoutingHint.SkippedTablet
	1,  // 8: google.spanner.v1.vtinternal.KeyRecipe.Part.order:type_name -> google.spanner.v1.vtinternal.KeyRecipe.Part.Order
	2,  // 9: google.spanner.v1.vtinternal.KeyRecipe.Part.null_order:type_name -> google.spanner.v1.vtinternal.KeyRecipe.Part.NullOrder
	12, // 10: google.spanner.v1.vtinternal.KeyRecipe.Part.type:type_name -> google.spanner.v1.vtinternal.Type
	13, // 11: google.spanner.v1.vtinternal.KeyRecipe.Part.value:type_name -> google.protobuf.Value
...
func init() { file_google_spanner_v1_vtinternal_location_proto_init() }
func file_google_spanner_v1_vtinternal_location_proto_init() {
	if File_google_spanner_v1_vtinternal_location_proto != nil {
		return
	}
	file_google_spanner_v1_vtinternal_type_proto_init()
	file_google_spanner_v1_vtinternal_location_proto_msgTypes[3].OneofWrappers = []any{
		(*KeyRecipe_TableName)(nil),
		(*KeyRecipe_IndexName)(nil),
		(*KeyRecipe_OperationUid)(nil),
	}
	file_google_spanner_v1_vtinternal_location_proto_msgTypes[7].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_spanner_v1_vtinternal_location_proto_rawDesc), len(file_google_spanner_v1_vtinternal_location_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_spanner_v1_vtinternal_location_proto_goTypes,
		DependencyIndexes: file_google_spanner_v1_vtinternal_location_proto_depIdxs,
		EnumInfos:         file_google_spanner_v1_vtinternal_location_proto_enumTypes,
		MessageInfos:      file_google_spanner_v1_vtinternal_location_proto_msgTypes,
	}.Build()
	File_google_spanner_v1_vtinternal_location_proto = out.File
	file_google_spanner_v1_vtinternal_location_proto_goTypes = nil
	file_google_spanner_v1_vtinternal_location_proto_depIdxs = nil
}
