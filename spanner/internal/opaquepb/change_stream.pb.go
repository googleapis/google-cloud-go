...
// 	protoc        v6.33.2
// source: librarian_opaque/google/spanner/v1/change_stream.proto
...
func (ChangeStreamRecord_DataChangeRecord_ModType) Descriptor() protoreflect.EnumDescriptor {
	return file_librarian_opaque_google_spanner_v1_change_stream_proto_enumTypes[0].Descriptor()
}

func (ChangeStreamRecord_DataChangeRecord_ModType) Type() protoreflect.EnumType {
	return &file_librarian_opaque_google_spanner_v1_change_stream_proto_enumTypes[0]
}
...
func (ChangeStreamRecord_DataChangeRecord_ValueCaptureType) Descriptor() protoreflect.EnumDescriptor {
	return file_librarian_opaque_google_spanner_v1_change_stream_proto_enumTypes[1].Descriptor()
}

func (ChangeStreamRecord_DataChangeRecord_ValueCaptureType) Type() protoreflect.EnumType {
	return &file_librarian_opaque_google_spanner_v1_change_stream_proto_enumTypes[1]
}
...
func (x *ChangeStreamRecord) Reset() {
	*x = ChangeStreamRecord{}
	mi := &file_librarian_opaque_google_spanner_v1_change_stream_proto_msgTypes[0]
...
func (x case_ChangeStreamRecord_Record) String() string {
	md := file_librarian_opaque_google_spanner_v1_change_stream_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
type ChangeStreamRecord_DataChangeRecord struct {
	...
	xxx_hidden_ModType                              ChangeStreamRecord_DataChangeRecord_ModType            `protobuf:"varint,8,opt,name=mod_type,json=modType,proto3,enum=google.spanner.v1.internalopaque.ChangeStreamRecord_DataChangeRecord_ModType"`
	xxx_hidden_ValueCaptureType                     ChangeStreamRecord_DataChangeRecord_ValueCaptureType   `protobuf:"varint,9,opt,name=value_capture_type,json=valueCaptureType,proto3,enum=google.spanner.v1.internalopaque.ChangeStreamRecord_DataChangeRecord_ValueCaptureType"`
...
func (x *ChangeStreamRecord_DataChangeRecord) Reset() {
	*x = ChangeStreamRecord_DataChangeRecord{}
	mi := &file_librarian_opaque_google_spanner_v1_change_stream_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ChangeStreamRecord_DataChangeRecord_builder struct {
	...
	// [server_transaction_id][google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.server_transaction_id]
	// by
	// [record_sequence][google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.record_sequence]
	...
	// [mods][google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.mods] listed
	// below.
...
func (x *ChangeStreamRecord_HeartbeatRecord) Reset() {
	*x = ChangeStreamRecord_HeartbeatRecord{}
	mi := &file_librarian_opaque_google_spanner_v1_change_stream_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ChangeStreamRecord_PartitionStartRecord) Reset() {
	*x = ChangeStreamRecord_PartitionStartRecord{}
	mi := &file_librarian_opaque_google_spanner_v1_change_stream_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ChangeStreamRecord_PartitionEndRecord) Reset() {
	*x = ChangeStreamRecord_PartitionEndRecord{}
	mi := &file_librarian_opaque_google_spanner_v1_change_stream_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ChangeStreamRecord_PartitionEndRecord_builder struct {
	...
	// partition.
	// [partition_token][google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionEndRecord.partition_token]
...
func (x *ChangeStreamRecord_PartitionEventRecord) Reset() {
	*x = ChangeStreamRecord_PartitionEventRecord{}
	mi := &file_librarian_opaque_google_spanner_v1_change_stream_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ChangeStreamRecord_PartitionEventRecord_builder struct {
	...
	// occurred on.
	// [partition_token][google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionEventRecord.partition_token]
	// is equal to the partition token of the change stream partition currently
...
func (x *ChangeStreamRecord_DataChangeRecord_ColumnMetadata) Reset() {
	*x = ChangeStreamRecord_DataChangeRecord_ColumnMetadata{}
	mi := &file_librarian_opaque_google_spanner_v1_change_stream_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
// [Mod][google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.Mod].
...
func (x *ChangeStreamRecord_DataChangeRecord_ModValue) Reset() {
	*x = ChangeStreamRecord_DataChangeRecord_ModValue{}
	mi := &file_librarian_opaque_google_spanner_v1_change_stream_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ChangeStreamRecord_DataChangeRecord_ModValue_builder struct {
	...
	// [column_metadata][google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.column_metadata]
...
func (x *ChangeStreamRecord_DataChangeRecord_Mod) Reset() {
	*x = ChangeStreamRecord_DataChangeRecord_Mod{}
	mi := &file_librarian_opaque_google_spanner_v1_change_stream_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ChangeStreamRecord_DataChangeRecord_Mod_builder struct {
	...
	// Always empty for
	// [INSERT][google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ModType.INSERT],
	// or if old values are not being captured specified by
	// [value_capture_type][google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ValueCaptureType].
	OldValues []*ChangeStreamRecord_DataChangeRecord_ModValue
	// Returns the new values after the change for the modified columns.
	// Always empty for
	// [DELETE][google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ModType.DELETE].
...
func (x *ChangeStreamRecord_PartitionEventRecord_MoveInEvent) Reset() {
	*x = ChangeStreamRecord_PartitionEventRecord_MoveInEvent{}
	mi := &file_librarian_opaque_google_spanner_v1_change_stream_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
// [MoveOutEvent][google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionEventRecord.MoveOutEvent]
...
// [commit_timestamp][google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionEventRecord.commit_timestamp].
...
func (x *ChangeStreamRecord_PartitionEventRecord_MoveOutEvent) Reset() {
	*x = ChangeStreamRecord_PartitionEventRecord_MoveOutEvent{}
	mi := &file_librarian_opaque_google_spanner_v1_change_stream_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_librarian_opaque_google_spanner_v1_change_stream_proto protoreflect.FileDescriptor
...
const file_librarian_opaque_google_spanner_v1_change_stream_proto_rawDesc = "" +
	...
	"\x0fcolumn_metadata\x18\x06 \x03(\v2T.google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ColumnMetadataR\x0ecolumnMetadata\x12]\n" +
	"\x04mods\x18\a \x03(\v2I.google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ModR\x04mods\x12h\n" +
	"\bmod_type\x18\b \x01(\x0e2M.google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ModTypeR\amodType\x12\x84\x01\n" +
	"\x12value_capture_type\x18\t \x01(\x0e2V.google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ValueCaptureTypeR\x10valueCaptureType\x12F\n" +
	...
	"\x15is_system_transaction\x18\r \x01(\bR\x13isSystemTransaction\x1a\xb1\x01\n" +
	...
	"\n" +
	"old_values\x18\x02 \x03(\v2N.google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ModValueR\toldValues\x12m\n" +
	"\n" +
	"new_values\x18\x03 \x03(\v2N.google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ModValueR\tnewValues\"G\n" +
	"\aModType\x12\x18\n" +
	...
	"\x0frecord_sequence\x18\x02 \x01(\tR\x0erecordSequence\x12'\n" +
	"\x0fpartition_token\x18\x03 \x01(\tR\x0epartitionToken\x1a\xc1\x04\n" +
	"\x14PartitionEventRecord\x12E\n" +
	"\x10commit_timestamp\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x0fcommitTimestamp\x12'\n" +
	"\x0frecord_sequence\x18\x02 \x01(\tR\x0erecordSequence\x12'\n" +
	"\x0fpartition_token\x18\x03 \x01(\tR\x0epartitionToken\x12{\n" +
	"\x0emove_in_events\x18\x04 \x03(\v2U.google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionEventRecord.MoveInEventR\fmoveInEvents\x12~\n" +
	"\x0fmove_out_events\x18\x05 \x03(\v2V.google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionEventRecord.MoveOutEventR\rmoveOutEvents\x1aC\n" +
	"\vMoveInEvent\x124\n" +
	...
	"\x06recordB\xb5\x01\n" +
	"\x15com.google.spanner.v1B\x11ChangeStreamProtoP\x01Z6cloud.google.com/go/spanner/internal/opaquepb;opaquepb\xaa\x02\x17Google.Cloud.Spanner.V1\xca\x02\x17Google\\Cloud\\Spanner\\V1\xea\x02\x1aGoogle::Cloud::Spanner::V1b\x06proto3"

var file_librarian_opaque_google_spanner_v1_change_stream_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_librarian_opaque_google_spanner_v1_change_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_librarian_opaque_google_spanner_v1_change_stream_proto_goTypes = []any{
	(ChangeStreamRecord_DataChangeRecord_ModType)(0),             // 0: google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ModType
	(ChangeStreamRecord_DataChangeRecord_ValueCaptureType)(0),    // 1: google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ValueCaptureType
	(*ChangeStreamRecord)(nil),                                   // 2: google.spanner.v1.internalopaque.ChangeStreamRecord
	(*ChangeStreamRecord_DataChangeRecord)(nil),                  // 3: google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord
	(*ChangeStreamRecord_HeartbeatRecord)(nil),                   // 4: google.spanner.v1.internalopaque.ChangeStreamRecord.HeartbeatRecord
	(*ChangeStreamRecord_PartitionStartRecord)(nil),              // 5: google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionStartRecord
	(*ChangeStreamRecord_PartitionEndRecord)(nil),                // 6: google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionEndRecord
	(*ChangeStreamRecord_PartitionEventRecord)(nil),              // 7: google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionEventRecord
	(*ChangeStreamRecord_DataChangeRecord_ColumnMetadata)(nil),   // 8: google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ColumnMetadata
	(*ChangeStreamRecord_DataChangeRecord_ModValue)(nil),         // 9: google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ModValue
	(*ChangeStreamRecord_DataChangeRecord_Mod)(nil),              // 10: google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.Mod
	(*ChangeStreamRecord_PartitionEventRecord_MoveInEvent)(nil),  // 11: google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionEventRecord.MoveInEvent
...
var file_librarian_opaque_google_spanner_v1_change_stream_proto_depIdxs = []int32{
	...
	4,  // 1: google.spanner.v1.internalopaque.ChangeStreamRecord.heartbeat_record:type_name -> google.spanner.v1.internalopaque.ChangeStreamRecord.HeartbeatRecord
	5,  // 2: google.spanner.v1.internalopaque.ChangeStreamRecord.partition_start_record:type_name -> google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionStartRecord
	6,  // 3: google.spanner.v1.internalopaque.ChangeStreamRecord.partition_end_record:type_name -> google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionEndRecord
	7,  // 4: google.spanner.v1.internalopaque.ChangeStreamRecord.partition_event_record:type_name -> google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionEventRecord
	13, // 5: google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.commit_timestamp:type_name -> google.protobuf.Timestamp
	8,  // 6: google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.column_metadata:type_name -> google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ColumnMetadata
	10, // 7: google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.mods:type_name -> google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.Mod
	0,  // 8: google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.mod_type:type_name -> google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ModType
	1,  // 9: google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.value_capture_type:type_name -> google.spanner.v1.internalopaque.ChangeStreamRecord.DataChangeRecord.ValueCaptureType
	13, // 10: google.spanner.v1.internalopaque.ChangeStreamRecord.HeartbeatRecord.timestamp:type_name -> google.protobuf.Timestamp
	13, // 11: google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionStartRecord.start_timestamp:type_name -> google.protobuf.Timestamp
	13, // 12: google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionEndRecord.end_timestamp:type_name -> google.protobuf.Timestamp
	13, // 13: google.spanner.v1.internalopaque.ChangeStreamRecord.PartitionEventRecord.commit_timestamp:type_name -> google.protobuf.Timestamp
...
func init() { file_librarian_opaque_google_spanner_v1_change_stream_proto_init() }
func file_librarian_opaque_google_spanner_v1_change_stream_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_librarian_opaque_google_spanner_v1_change_stream_proto_rawDesc), len(file_librarian_opaque_google_spanner_v1_change_stream_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_librarian_opaque_google_spanner_v1_change_stream_proto_goTypes,
		DependencyIndexes: file_librarian_opaque_google_spanner_v1_change_stream_proto_depIdxs,
		EnumInfos:         file_librarian_opaque_google_spanner_v1_change_stream_proto_enumTypes,
		MessageInfos:      file_librarian_opaque_google_spanner_v1_change_stream_proto_msgTypes,
	}.Build()
	File_librarian_opaque_google_spanner_v1_change_stream_proto = out.File
	file_librarian_opaque_google_spanner_v1_change_stream_proto_goTypes = nil
	file_librarian_opaque_google_spanner_v1_change_stream_proto_depIdxs = nil
}
