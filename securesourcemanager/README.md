...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/securesourcemanager.svg)](https://pkg.go.dev/cloud.google.com/go/securesourcemanager)

Go Client Library for Secure Source Manager API.
