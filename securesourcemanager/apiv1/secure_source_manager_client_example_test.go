...
func ExampleClient_FetchRefs() {
	...
	req := &securesourcemanagerpb.FetchRefsRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/securesourcemanager/apiv1/securesourcemanagerpb#FetchRefsRequest.
	}
	it := c.FetchRefs(ctx, req)
	for {
		resp, err := it.Next()
		...
		_ = it.Response.(*securesourcemanagerpb.FetchRefsResponse)
	}
}
