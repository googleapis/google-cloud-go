...
type Repository struct {
	...
	ScanConfig    *Repository_ScanConfig `protobuf:"bytes,13,opt,name=scan_config,json=scanConfig,proto3" json:"scan_config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Repository) GetScanConfig() *Repository_ScanConfig {
	if x != nil {
		return x.ScanConfig
	}
	return nil
...
type Repository_ScanConfig struct {
	...
	SecretScanConfig *Repository_ScanConfig_SecretScanConfig `protobuf:"bytes,1,opt,name=secret_scan_config,json=secretScanConfig,proto3" json:"secret_scan_config,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *Repository_ScanConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use Repository_ScanConfig.ProtoReflect.Descriptor instead.
func (*Repository_ScanConfig) Descriptor() ([]byte, []int) {
	return file_google_cloud_securesourcemanager_v1_secure_source_manager_proto_rawDescGZIP(), []int{1, 2}
}

func (x *Repository_ScanConfig) GetSecretScanConfig() *Repository_ScanConfig_SecretScanConfig {
	if x != nil {
		return x.SecretScanConfig
	}
	return nil
}
...
func (x *Repository_ScanConfig_SecretScanConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use Repository_ScanConfig_SecretScanConfig.ProtoReflect.Descriptor instead.
func (*Repository_ScanConfig_SecretScanConfig) Descriptor() ([]byte, []int) {
	return file_google_cloud_securesourcemanager_v1_secure_source_manager_proto_rawDescGZIP(), []int{1, 2, 0}
}

func (x *Repository_ScanConfig_SecretScanConfig) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *Repository_ScanConfig_SecretScanConfig) GetInspectTemplate() string {
	if x != nil {
...
const file_google_cloud_securesourcemanager_v1_secure_source_manager_proto_rawDesc = "" +
	...
	"+securesourcemanager.googleapis.com/Instance\x12<projects/{project}/locations/{location}/instances/{instance}R\x01\x01\"\xbf\n" +
	"\n" +
	"\n" +
	"Repository\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12%\n" +
	...
	" \x01(\v2=.google.cloud.securesourcemanager.v1.Repository.InitialConfigB\x03\xe0A\x04R\rinitialConfig\x12R\n" +
	"\x0fservice_account\x18\v \x01(\tB)\xe0A\x01\xfaA#\n" +
	"!iam.googleapis.com/ServiceAccountR\x0eserviceAccount\x12`\n" +
	"\vscan_config\x18\r \x01(\v2:.google.cloud.securesourcemanager.v1.Repository.ScanConfigB\x03\xe0A\x01R\n" +
	"scanConfig\x1aX\n" +
	"\x04URIs\x12\x17\n" +
	...
	"\x06readme\x18\x04 \x01(\tR\x06readme\x1a\x97\x02\n" +
	"\n" +
	"ScanConfig\x12~\n" +
	"\x12secret_scan_config\x18\x01 \x01(\v2K.google.cloud.securesourcemanager.v1.Repository.ScanConfig.SecretScanConfigB\x03\xe0A\x01R\x10secretScanConfig\x1a\x88\x01\n" +
	"\x10SecretScanConfig\x12\x1d\n" +
	...
	"(compute.googleapis.com/ServiceAttachment\x12Kprojects/{project}/regions/{region}/serviceAttachments/{service_attachment}\xeaAq\n" +
	"\"dlp.googleapis.com/InspectTemplate\x12Kprojects/{project}/locations/{location}/inspectTemplates/{inspect_template}\n" +
