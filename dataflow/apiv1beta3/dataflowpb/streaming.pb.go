...
type TopologyConfig struct {
	...
	UserStageToComputationNameMap map[string]string `protobuf:"bytes,3,rep,name=user_stage_to_computation_name_map,json=userStageToComputationNameMap,proto3" json:"user_stage_to_computation_name_map,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *StreamLocation) GetLocation() isStreamLocation_Location {
	if x != nil {
		return x.Location
	}
	return nil
...
func (x *StreamLocation) GetStreamingStageLocation() *StreamingStageLocation {
	if x != nil {
		if x, ok := x.Location.(*StreamLocation_StreamingStageLocation); ok {
...
func (x *StreamLocation) GetPubsubLocation() *PubsubLocation {
	if x != nil {
		if x, ok := x.Location.(*StreamLocation_PubsubLocation); ok {
...
func (x *StreamLocation) GetSideInputLocation() *StreamingSideInputLocation {
	if x != nil {
		if x, ok := x.Location.(*StreamLocation_SideInputLocation); ok {
...
func (x *StreamLocation) GetCustomSourceLocation() *CustomSourceLocation {
	if x != nil {
		if x, ok := x.Location.(*StreamLocation_CustomSourceLocation); ok {
...
const file_google_dataflow_v1beta3_streaming_proto_rawDesc = "" +
	"\n" +
	"'google/dataflow/v1beta3/streaming.proto\x12\x17google.dataflow.v1beta3\"\x97\x04\n" +
	"\x0eTopologyConfig\x12P\n" +
	"\fcomputations\x18\x01 \x03(\v2,.google.dataflow.v1beta3.ComputationTopologyR\fcomputations\x12_\n" +
	"\x15data_disk_assignments\x18\x02 \x03(\v2+.google.dataflow.v1beta3.DataDiskAssignmentR\x13dataDiskAssignments\x12\x95\x01\n" +
	"\"user_stage_to_computation_name_map\x18\x03 \x03(\v2J.google.dataflow.v1beta3.TopologyConfig.UserStageToComputationNameMapEntryR\x1duserStageToComputationNameMap\x12.\n" +
	"\x13forwarding_key_bits\x18\x04 \x01(\x05R\x11forwardingKeyBits\x128\n" +
	...
	"\bid_label\x18\x04 \x01(\tR\aidLabel\x12$\n" +
	"\x0edrop_late_data\x18\x05 \x01(\bR\fdropLateData\x123\n" +
	"\x15tracking_subscription\x18\x06 \x01(\tR\x14trackingSubscription\x12'\n" +
	"\x0fwith_attributes\x18\a \x01(\bR\x0ewithAttributes\x121\n" +
	"\x14dynamic_destinations\x18\b \x01(\bR\x13dynamicDestinations\"5\n" +
	"\x16StreamingStageLocation\x12\x1b\n" +
	"\tstream_id\x18\x01 \x01(\tR\bstreamId\"Q\n" +
	"\x1aStreamingSideInputLocation\x12\x10\n" +
	"\x03tag\x18\x01 \x01(\tR\x03tag\x12!\n" +
	"\fstate_family\x18\x02 \x01(\tR\vstateFamily\"2\n" +
	"\x14CustomSourceLocation\x12\x1a\n" +
	"\bstateful\x18\x01 \x01(\bR\bstateful\"\xab\x03\n" +
	"\x0eStreamLocation\x12k\n" +
	"\x18streaming_stage_location\x18\x01 \x01(\v2/.google.dataflow.v1beta3.StreamingStageLocationH\x00R\x16streamingStageLocation\x12R\n" +
	"\x0fpubsub_location\x18\x02 \x01(\v2'.google.dataflow.v1beta3.PubsubLocationH\x00R\x0epubsubLocation\x12e\n" +
	"\x13side_input_location\x18\x03 \x01(\v23.google.dataflow.v1beta3.StreamingSideInputLocationH\x00R\x11sideInputLocation\x12e\n" +
	"\x16custom_source_location\x18\x04 \x01(\v2-.google.dataflow.v1beta3.CustomSourceLocationH\x00R\x14customSourceLocationB\n" +
	"\n" +
	"\blocation\"O\n" +
	"\x11StateFamilyConfig\x12!\n" +
	"\fstate_family\x18\x01 \x01(\tR\vstateFamily\x12\x17\n" +
	"\ais_read\x18\x02 \x01(\bR\x06isRead\"\x89\x03\n" +
	"\x13ComputationTopology\x12*\n" +
	"\x11system_stage_name\x18\x01 \x01(\tR\x0fsystemStageName\x12%\n" +
	"\x0ecomputation_id\x18\x05 \x01(\tR\rcomputationId\x12H\n" +
	"\n" +
	"key_ranges\x18\x02 \x03(\v2).google.dataflow.v1beta3.KeyRangeLocationR\tkeyRanges\x12?\n" +
	"\x06inputs\x18\x03 \x03(\v2'.google.dataflow.v1beta3.StreamLocationR\x06inputs\x12A\n" +
	"\aoutputs\x18\x04 \x03(\v2'.google.dataflow.v1beta3.StreamLocationR\aoutputs\x12Q\n" +
	"\x0estate_families\x18\a \x03(\v2*.google.dataflow.v1beta3.StateFamilyConfigR\rstateFamilies\"\xd0\x01\n" +
	"\x10KeyRangeLocation\x12\x14\n" +
	"\x05start\x18\x01 \x01(\tR\x05start\x12\x10\n" +
	"\x03end\x18\x02 \x01(\tR\x03end\x12+\n" +
	"\x11delivery_endpoint\x18\x03 \x01(\tR\x10deliveryEndpoint\x12\x1b\n" +
	"\tdata_disk\x18\x05 \x01(\tR\bdataDisk\x12J\n" +
	"\x1fdeprecated_persistent_directory\x18\x04 \x01(\tB\x02\x18\x01R\x1ddeprecatedPersistentDirectory\".\n" +
	"\x0fMountedDataDisk\x12\x1b\n" +
	"\tdata_disk\x18\x01 \x01(\tR\bdataDisk\"T\n" +
	"\x12DataDiskAssignment\x12\x1f\n" +
	"\vvm_instance\x18\x01 \x01(\tR\n" +
	"vmInstance\x12\x1d\n" +
	"\n" +
	...
	"\tdata_disk\x18\x03 \x01(\tR\bdataDisk\"\xa5\x01\n" +
	"\x1aStreamingComputationRanges\x12%\n" +
	"\x0ecomputation_id\x18\x01 \x01(\tR\rcomputationId\x12`\n" +
	"\x11range_assignments\x18\x02 \x03(\v23.google.dataflow.v1beta3.KeyRangeDataDiskAssignmentR\x10rangeAssignments\"w\n" +
	" StreamingApplianceSnapshotConfig\x12\x1f\n" +
	"\vsnapshot_id\x18\x01 \x01(\tR\n" +
	"snapshotId\x122\n" +
	"\x15import_state_endpoint\x18\x02 \x01(\tR\x13importStateEndpointB\xd1\x01\n" +
...
var (
	...
	file_google_dataflow_v1beta3_streaming_proto_rawDescData []byte
)
...
func file_google_dataflow_v1beta3_streaming_proto_rawDescGZIP() []byte {
	file_google_dataflow_v1beta3_streaming_proto_rawDescOnce.Do(func() {
		file_google_dataflow_v1beta3_streaming_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_dataflow_v1beta3_streaming_proto_rawDesc), len(file_google_dataflow_v1beta3_streaming_proto_rawDesc)))
	})
...
func file_google_dataflow_v1beta3_streaming_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_dataflow_v1beta3_streaming_proto_rawDesc), len(file_google_dataflow_v1beta3_streaming_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   0,
