...
// CommitResponse is a wrapper over pb.CommitResponse to avoid exposing proto directly.
...
// commitResponse is the Transaction option to record the commit response.
type commitResponse struct {
...
// on a failed commit. Example:
//
// var cr firestore.CommitResponse
// err := client.RunTransaction(...., firestore.WithCommitResponseTo(&cr))
// if err != nil {...}
// // CommitReponse can be accessed here.
