...
// Maximum creates an aggregation that calculates the sum of values from an expression or a field's values
// across multiple stage inputs.
//
// Example:
//
//		// Calculate the total revenue from a set of orders
//		Maximum(FieldOf("orderAmount")).As("totalRevenue") // FieldOf returns Expr
//	 	Maximum("orderAmount").As("totalRevenue")          // String implicitly becomes FieldOf(...).As(...)
func Maximum(fieldOrExpr any) AggregateFunction {
	return newBaseAggregateFunction("maximum", fieldOrExpr)
}

// Minimum creates an aggregation that calculates the sum of values from an expression or a field's values
// across multiple stage inputs.
//
// Example:
//
//		// Calculate the total revenue from a set of orders
//		Minimum(FieldOf("orderAmount")).As("totalRevenue") // FieldOf returns Expr
//	 	Minimum("orderAmount").As("totalRevenue")          // String implicitly becomes FieldOf(...).As(...)
