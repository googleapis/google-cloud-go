...
func file_google_firestore_v1_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_firestore_v1_query_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_firestore_v1_query_proto_msgTypes[12].OneofWrappers = []interface{}{
