...
// internalLocationsClient is an interface that defines the methods available from Cloud Firestore API.
...
// LocationsClient is a client for interacting with Cloud Firestore API.
...
// locationsGRPCClient is a client for interacting with Cloud Firestore API over gRPC transport.
//
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
