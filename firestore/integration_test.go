...
func TestIntegration_BSONQueries(t *testing.T) {
	skipIfEdition(t, "BSON types", editionStandard)
	t.Skip("Temporarily skipping BSON integration test. Not yet released to prod.")
	ctx := context.Background()
	client := integrationClient(t)
...
func TestIntegration_BSONCrossTypeOrder(t *testing.T) {
	skipIfEdition(t, "BSON types", editionStandard)
	t.Skip("Temporarily skipping BSON integration test. Not yet released to prod.")
	ctx := context.Background()
	client := integrationClient(t)
...
func TestIntegration_BSONValidationRejection(t *testing.T) {
	skipIfEdition(t, "BSON types", editionStandard)
	t.Skip("Temporarily skipping BSON integration test. Not yet released to prod.")
	ctx := context.Background()
	client := integrationClient(t)
