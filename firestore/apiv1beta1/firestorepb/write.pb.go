...
var file_google_firestore_v1beta1_write_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x05, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0xdb, 0x01, 0x0a, 0x1c, 0x63,
	...
	0x74, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x40, 0x63, 0x6c, 0x6f, 0x75, 0x64,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x67, 0x6f, 0x2f, 0x66,
	0x69, 0x72, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x76, 0x31, 0x62, 0x65,
	0x74, 0x61, 0x31, 0x2f, 0x66, 0x69, 0x72, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x70, 0x62, 0x3b,
...
var file_google_firestore_v1beta1_write_proto_goTypes = []any{
...
func file_google_firestore_v1beta1_write_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_firestore_v1beta1_write_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Write); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_firestore_v1beta1_write_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_firestore_v1beta1_write_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_firestore_v1beta1_write_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_firestore_v1beta1_write_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_google_firestore_v1beta1_write_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_google_firestore_v1beta1_write_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_google_firestore_v1beta1_write_proto_msgTypes[7].Exporter = func(v any, i int) any {
	...
	file_google_firestore_v1beta1_write_proto_msgTypes[0].OneofWrappers = []any{
		(*Write_Update)(nil),
		(*Write_Delete)(nil),
		(*Write_Transform)(nil),
	}
	file_google_firestore_v1beta1_write_proto_msgTypes[7].OneofWrappers = []any{
