...
import (
	...
	firestorepb "cloud.google.com/go/firestore/apiv1beta1/firestorepb"
...
func ExampleClient_BatchWrite() {
	...
	req := &firestorepb.BatchWriteRequest{
		...
		// See https://pkg.go.dev/cloud.google.com/go/firestore/apiv1beta1/firestorepb#BatchWriteRequest.
	}
...
func ExampleClient_BeginTransaction() {
	...
	req := &firestorepb.BeginTransactionRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/firestore/apiv1beta1/firestorepb#BeginTransactionRequest.
	}
...
func ExampleClient_Commit() {
	...
	req := &firestorepb.CommitRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/firestore/apiv1beta1/firestorepb#CommitRequest.
	}
...
func ExampleClient_CreateDocument() {
	...
	req := &firestorepb.CreateDocumentRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/firestore/apiv1beta1/firestorepb#CreateDocumentRequest.
	}
...
func ExampleClient_DeleteDocument() {
	...
	req := &firestorepb.DeleteDocumentRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/firestore/apiv1beta1/firestorepb#DeleteDocumentRequest.
	}
...
func ExampleClient_GetDocument() {
	...
	req := &firestorepb.GetDocumentRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/firestore/apiv1beta1/firestorepb#GetDocumentRequest.
	}
...
func ExampleClient_ListCollectionIds() {
	...
	req := &firestorepb.ListCollectionIdsRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/firestore/apiv1beta1/firestorepb#ListCollectionIdsRequest.
	}
	...
	for {
		...
		_ = it.Response.(*firestorepb.ListCollectionIdsResponse)
	}
}
...
func ExampleClient_ListDocuments() {
	...
	req := &firestorepb.ListDocumentsRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/firestore/apiv1beta1/firestorepb#ListDocumentsRequest.
	}
...
func ExampleClient_PartitionQuery() {
	...
	req := &firestorepb.PartitionQueryRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/firestore/apiv1beta1/firestorepb#PartitionQueryRequest.
	}
	...
	for {
		...
		// Otherwise, remove this line. Only populated after
		// first call to Next(). Not safe for concurrent access.
		_ = it.Response.(*firestorepb.PartitionQueryResponse)
	}
}
...
func ExampleClient_Rollback() {
	...
	req := &firestorepb.RollbackRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/firestore/apiv1beta1/firestorepb#RollbackRequest.
	}
...
func ExampleClient_UpdateDocument() {
	...
	req := &firestorepb.UpdateDocumentRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/firestore/apiv1beta1/firestorepb#UpdateDocumentRequest.
	}
