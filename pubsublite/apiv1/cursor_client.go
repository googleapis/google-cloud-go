...
func NewCursorClient(ctx context.Context, opts ...option.ClientOption) (*CursorClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.StreamingCommitCursor = append(client.CallOptions.StreamingCommitCursor, gax.WithClientMetrics(metrics))
		client.CallOptions.CommitCursor = append(client.CallOptions.CommitCursor, gax.WithClientMetrics(metrics))
		client.CallOptions.ListPartitionCursors = append(client.CallOptions.ListPartitionCursors, gax.WithClientMetrics(metrics))
...
func (c *cursorGRPCClient) StreamingCommitCursor(ctx context.Context, opts ...gax.CallOption) (pubsublitepb.CursorService_StreamingCommitCursorClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.pubsublite.v1.CursorService/StreamingCommitCursor")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		c.logger.DebugContext(ctx, "api streaming client request", "serviceName", serviceName, "rpcName", "StreamingCommitCursor")
		resp, err = c.cursorClient.StreamingCommitCursor(ctx, settings.GRPC...)
		c.logger.DebugContext(ctx, "api streaming client response", "serviceName", serviceName, "rpcName", "StreamingCommitCursor")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *cursorGRPCClient) CommitCursor(ctx context.Context, req *pubsublitepb.CommitCursorRequest, opts ...gax.CallOption) (*pubsublitepb.CommitCursorResponse, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.pubsublite.v1.CursorService/CommitCursor")
	}
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.cursorClient.CommitCursor, req, settings.GRPC, c.logger, "CommitCursor")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *cursorGRPCClient) ListPartitionCursors(ctx context.Context, req *pubsublitepb.ListPartitionCursorsRequest, opts ...gax.CallOption) *PartitionCursorIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*pubsublitepb.PartitionCursor, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.cursorClient.ListPartitionCursors, req, settings.GRPC, c.logger, "ListPartitionCursors")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
