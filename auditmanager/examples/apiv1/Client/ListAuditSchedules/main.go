...
// [START auditmanager_v1_generated_AuditManager_ListAuditSchedules_sync]
...
func main() {
	...
	it := c.ListAuditSchedules(ctx, req)
	for {
		resp, err := it.Next()
		...
		_ = it.Response.(*auditmanagerpb.ListAuditSchedulesResponse)
	}
}

// [END auditmanager_v1_generated_AuditManager_ListAuditSchedules_sync]
