...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/storagebatchoperations.svg)](https://pkg.go.dev/cloud.google.com/go/storagebatchoperations)

Go Client Library for Storage Batch Operations API.

## Install

```bash
go get cloud.google.com/go/storagebatchoperations
```
