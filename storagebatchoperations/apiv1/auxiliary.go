...
func (op *CreateJobOperation) Metadata() (*storagebatchoperationspb.OperationMetadata, error) {
	var meta storagebatchoperationspb.OperationMetadata
...
func (it *BucketOperationIterator) Next() (*storagebatchoperationspb.BucketOperation, error) {
	var item *storagebatchoperationspb.BucketOperation
...
func (it *BucketOperationIterator) bufLen() int {
	return len(it.items)
}

func (it *BucketOperationIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
func (it *JobIterator) Next() (*storagebatchoperationspb.Job, error) {
	var item *storagebatchoperationspb.Job
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
