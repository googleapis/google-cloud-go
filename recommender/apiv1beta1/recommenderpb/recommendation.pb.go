...
func file_google_cloud_recommender_v1beta1_recommendation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_recommender_v1beta1_recommendation_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_recommender_v1beta1_recommendation_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_recommender_v1beta1_recommendation_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_recommender_v1beta1_recommendation_proto_msgTypes[8].OneofWrappers = []interface{}{
