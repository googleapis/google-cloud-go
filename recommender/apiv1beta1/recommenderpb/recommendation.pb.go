...
const file_google_cloud_recommender_v1beta1_recommendation_proto_rawDesc = "" +
	"\n" +
	...
	"\x11last_refresh_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x0flastRefreshTime\x12O\n" +
	"\x0eprimary_impact\x18\x05 \x01(\v2(.google.cloud.recommender.v1beta1.ImpactR\rprimaryImpact\x12U\n" +
	"\x11additional_impact\x18\x06 \x03(\v2(.google.cloud.recommender.v1beta1.ImpactR\x10additionalImpact\x12U\n" +
	"\bpriority\x18\x11 \x01(\x0e29.google.cloud.recommender.v1beta1.Recommendation.PriorityR\bpriority\x12Q\n" +
	"\acontent\x18\a \x01(\v27.google.cloud.recommender.v1beta1.RecommendationContentR\acontent\x12X\n" +
	"\n" +
	"state_info\x18\n" +
	" \x01(\v29.google.cloud.recommender.v1beta1.RecommendationStateInfoR\tstateInfo\x12\x12\n" +
	"\x04etag\x18\v \x01(\tR\x04etag\x12r\n" +
	"\x13associated_insights\x18\x0e \x03(\v2A.google.cloud.recommender.v1beta1.Recommendation.InsightReferenceR\x12associatedInsights\x12 \n" +
	...
	"\x10operation_groups\x18\x02 \x03(\v20.google.cloud.recommender.v1beta1.OperationGroupR\x0foperationGroups\x123\n" +
	"\boverview\x18\x03 \x01(\v2\x17.google.protobuf.StructR\boverview\"]\n" +
	"\x0eOperationGroup\x12K\n" +
	"\n" +
	"operations\x18\x01 \x03(\v2+.google.cloud.recommender.v1beta1.OperationR\n" +
	"operations\"\xfa\x05\n" +
	"\tOperation\x12\x16\n" +
	...
	"sourcePath\x12.\n" +
	"\x05value\x18\a \x01(\v2\x16.google.protobuf.ValueH\x00R\x05value\x12U\n" +
	"\rvalue_matcher\x18\n" +
	" \x01(\v2..google.cloud.recommender.v1beta1.ValueMatcherH\x00R\fvalueMatcher\x12_\n" +
	"\fpath_filters\x18\b \x03(\v2<.google.cloud.recommender.v1beta1.Operation.PathFiltersEntryR\vpathFilters\x12r\n" +
	"\x13path_value_matchers\x18\v \x03(\v2B.google.cloud.recommender.v1beta1.Operation.PathValueMatchersEntryR\x11pathValueMatchers\x1aV\n" +
	...
	"\x05value\x18\x02 \x01(\v2..google.cloud.recommender.v1beta1.ValueMatcherR\x05value:\x028\x01B\f\n" +
	"\n" +
	"path_value\"J\n" +
	"\fValueMatcher\x12)\n" +
	...
	"\bduration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\bduration\"\x9c\x04\n" +
	"\x06Impact\x12M\n" +
	"\bcategory\x18\x01 \x01(\x0e21.google.cloud.recommender.v1beta1.Impact.CategoryR\bcategory\x12[\n" +
	"\x0fcost_projection\x18d \x01(\v20.google.cloud.recommender.v1beta1.CostProjectionH\x00R\x0ecostProjection\x12g\n" +
	"\x13security_projection\x18e \x01(\v24.google.cloud.recommender.v1beta1.SecurityProjectionH\x00R\x12securityProjection\x12y\n" +
	"\x19sustainability_projection\x18f \x01(\v2:.google.cloud.recommender.v1beta1.SustainabilityProjectionH\x00R\x18sustainabilityProjection\"t\n" +
	"\bCategory\x12\x18\n" +
	...
	"\x0eSUSTAINABILITY\x10\x05B\f\n" +
	"\n" +
	"projection\"\x8a\x03\n" +
	"\x17RecommendationStateInfo\x12U\n" +
	"\x05state\x18\x01 \x01(\x0e2?.google.cloud.recommender.v1beta1.RecommendationStateInfo.StateR\x05state\x12s\n" +
	"\x0estate_metadata\x18\x02 \x03(\v2L.google.cloud.recommender.v1beta1.RecommendationStateInfo.StateMetadataEntryR\rstateMetadata\x1a@\n" +
	...
	"\tDISMISSED\x10\x05\"\x97\x03\n" +
	"\x0fRecommenderType\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name:\xef\x02\xeaA\xeb\x02\n" +
...
var (
	...
	file_google_cloud_recommender_v1beta1_recommendation_proto_rawDescData []byte
)
...
func file_google_cloud_recommender_v1beta1_recommendation_proto_rawDescGZIP() []byte {
	file_google_cloud_recommender_v1beta1_recommendation_proto_rawDescOnce.Do(func() {
		file_google_cloud_recommender_v1beta1_recommendation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_recommender_v1beta1_recommendation_proto_rawDesc), len(file_google_cloud_recommender_v1beta1_recommendation_proto_rawDesc)))
	})
...
func file_google_cloud_recommender_v1beta1_recommendation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_recommender_v1beta1_recommendation_proto_rawDesc), len(file_google_cloud_recommender_v1beta1_recommendation_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   0,
