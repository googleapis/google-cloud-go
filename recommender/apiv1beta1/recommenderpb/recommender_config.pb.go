...
const file_google_cloud_recommender_v1beta1_recommender_config_proto_rawDesc = "" +
	"\n" +
	"9google/cloud/recommender/v1beta1/recommender_config.proto\x12 google.cloud.recommender.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc5\x05\n" +
	"\x11RecommenderConfig\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x81\x01\n" +
	"\x1drecommender_generation_config\x18\x02 \x01(\v2=.google.cloud.recommender.v1beta1.RecommenderGenerationConfigR\x1brecommenderGenerationConfig\x12\x12\n" +
	...
	"revisionId\x12f\n" +
	"\vannotations\x18\x06 \x03(\v2D.google.cloud.recommender.v1beta1.RecommenderConfig.AnnotationsEntryR\vannotations\x12!\n" +
	"\fdisplay_name\x18\a \x01(\tR\vdisplayName\x1a>\n" +
	"\x10AnnotationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\xd2\x01\xeaA\xce\x01\n" +
...
var (
	...
	file_google_cloud_recommender_v1beta1_recommender_config_proto_rawDescData []byte
)
...
func file_google_cloud_recommender_v1beta1_recommender_config_proto_rawDescGZIP() []byte {
	file_google_cloud_recommender_v1beta1_recommender_config_proto_rawDescOnce.Do(func() {
		file_google_cloud_recommender_v1beta1_recommender_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_recommender_v1beta1_recommender_config_proto_rawDesc), len(file_google_cloud_recommender_v1beta1_recommender_config_proto_rawDesc)))
	})
...
func file_google_cloud_recommender_v1beta1_recommender_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_recommender_v1beta1_recommender_config_proto_rawDesc), len(file_google_cloud_recommender_v1beta1_recommender_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
