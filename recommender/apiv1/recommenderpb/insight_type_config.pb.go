...
const file_google_cloud_recommender_v1_insight_type_config_proto_rawDesc = "" +
	...
	"revisionId\x12a\n" +
	"\vannotations\x18\x06 \x03(\v2?.google.cloud.recommender.v1.InsightTypeConfig.AnnotationsEntryR\vannotations\x12!\n" +
	"\fdisplay_name\x18\a \x01(\tR\vdisplayName\x1a>\n" +
	"\x10AnnotationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\xaf\x02\xeaA\xab\x02\n" +
	",recommender.googleapis.com/InsightTypeConfig\x12Jprojects/{project}/locations/{location}/insightTypes/{insight_type}/config\x12Torganizations/{organization}/locations/{location}/insightTypes/{insight_type}/config\x12YbillingAccounts/{billing_account}/locations/{location}/insightTypes/{insight_type}/config\"N\n" +
...
var (
	...
	file_google_cloud_recommender_v1_insight_type_config_proto_rawDescData []byte
)
...
func file_google_cloud_recommender_v1_insight_type_config_proto_rawDescGZIP() []byte {
	file_google_cloud_recommender_v1_insight_type_config_proto_rawDescOnce.Do(func() {
		file_google_cloud_recommender_v1_insight_type_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_recommender_v1_insight_type_config_proto_rawDesc), len(file_google_cloud_recommender_v1_insight_type_config_proto_rawDesc)))
	})
...
func file_google_cloud_recommender_v1_insight_type_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_recommender_v1_insight_type_config_proto_rawDesc), len(file_google_cloud_recommender_v1_insight_type_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
