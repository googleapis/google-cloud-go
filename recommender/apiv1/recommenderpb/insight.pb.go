...
const file_google_cloud_recommender_v1_insight_proto_rawDesc = "" +
	"\n" +
	")google/cloud/recommender/v1/insight.proto\x12\x1bgoogle.cloud.recommender.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x92\v\n" +
	"\aInsight\x12\x17\n" +
	...
	"\x12observation_period\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\x11observationPeriod\x12L\n" +
	"\n" +
	"state_info\x18\x06 \x01(\v2-.google.cloud.recommender.v1.InsightStateInfoR\tstateInfo\x12I\n" +
	"\bcategory\x18\a \x01(\x0e2-.google.cloud.recommender.v1.Insight.CategoryR\bcategory\x12I\n" +
	"\bseverity\x18\x0f \x01(\x0e2-.google.cloud.recommender.v1.Insight.SeverityR\bseverity\x12\x12\n" +
	"\x04etag\x18\v \x01(\tR\x04etag\x12{\n" +
	"\x1aassociated_recommendations\x18\b \x03(\v2<.google.cloud.recommender.v1.Insight.RecommendationReferenceR\x19associatedRecommendations\x1aA\n" +
	"\x17RecommendationReference\x12&\n" +
	"\x0erecommendation\x18\x01 \x01(\tR\x0erecommendation\"\x85\x01\n" +
	"\bCategory\x12\x18\n" +
	...
	"\x05state\x18\x01 \x01(\x0e23.google.cloud.recommender.v1.InsightStateInfo.StateR\x05state\x12g\n" +
	"\x0estate_metadata\x18\x02 \x03(\v2@.google.cloud.recommender.v1.InsightStateInfo.StateMetadataEntryR\rstateMetadata\x1a@\n" +
	...
	"\tDISMISSED\x10\x03B\xf0\x03\xeaA\xd3\x02\n" +
	...
	"\x1fcom.google.cloud.recommender.v1B\fInsightProtoP\x01ZAcloud.google.com/go/recommender/apiv1/recommenderpb;recommenderpb\xa2\x02\x04CREC\xaa\x02\x1bGoogle.Cloud.Recommender.V1b\x06proto3"

var (
	file_google_cloud_recommender_v1_insight_proto_rawDescOnce sync.Once
	file_google_cloud_recommender_v1_insight_proto_rawDescData []byte
)
...
func file_google_cloud_recommender_v1_insight_proto_rawDescGZIP() []byte {
	file_google_cloud_recommender_v1_insight_proto_rawDescOnce.Do(func() {
		file_google_cloud_recommender_v1_insight_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_recommender_v1_insight_proto_rawDesc), len(file_google_cloud_recommender_v1_insight_proto_rawDesc)))
	})
...
var file_google_cloud_recommender_v1_insight_proto_goTypes = []any{
...
func file_google_cloud_recommender_v1_insight_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_recommender_v1_insight_proto_rawDesc), len(file_google_cloud_recommender_v1_insight_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
