...
[![Go Reference](https://pkg.go.dev/badge/cloud.google.com/go/backstory.svg)](https://pkg.go.dev/cloud.google.com/go/backstory)

Go Client Library for Malachite Common Protos.

## Install

```bash
go get cloud.google.com/go/backstory
```
