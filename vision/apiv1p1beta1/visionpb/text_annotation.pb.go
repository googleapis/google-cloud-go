...
const file_google_cloud_vision_v1p1beta1_text_annotation_proto_rawDesc = "" +
	"\n" +
	"3google/cloud/vision/v1p1beta1/text_annotation.proto\x12\x1dgoogle.cloud.vision.v1p1beta1\x1a,google/cloud/vision/v1p1beta1/geometry.proto\"\x8b\x05\n" +
	"\x0eTextAnnotation\x129\n" +
	"\x05pages\x18\x01 \x03(\v2#.google.cloud.vision.v1p1beta1.PageR\x05pages\x12\x12\n" +
	...
	"\rDetectedBreak\x12Y\n" +
	"\x04type\x18\x01 \x01(\x0e2E.google.cloud.vision.v1p1beta1.TextAnnotation.DetectedBreak.BreakTypeR\x04type\x12\x1b\n" +
	...
	"\fTextProperty\x12m\n" +
	"\x12detected_languages\x18\x01 \x03(\v2>.google.cloud.vision.v1p1beta1.TextAnnotation.DetectedLanguageR\x11detectedLanguages\x12b\n" +
	"\x0edetected_break\x18\x02 \x01(\v2;.google.cloud.vision.v1p1beta1.TextAnnotation.DetectedBreakR\rdetectedBreak\"\xea\x01\n" +
	"\x04Page\x12V\n" +
	"\bproperty\x18\x01 \x01(\v2:.google.cloud.vision.v1p1beta1.TextAnnotation.TextPropertyR\bproperty\x12\x14\n" +
	"\x05width\x18\x02 \x01(\x05R\x05width\x12\x16\n" +
	"\x06height\x18\x03 \x01(\x05R\x06height\x12<\n" +
	"\x06blocks\x18\x04 \x03(\v2$.google.cloud.vision.v1p1beta1.BlockR\x06blocks\x12\x1e\n" +
	"\n" +
	"confidence\x18\x05 \x01(\x02R\n" +
	"confidence\"\xbc\x03\n" +
	"\x05Block\x12V\n" +
	"\bproperty\x18\x01 \x01(\v2:.google.cloud.vision.v1p1beta1.TextAnnotation.TextPropertyR\bproperty\x12N\n" +
	"\fbounding_box\x18\x02 \x01(\v2+.google.cloud.vision.v1p1beta1.BoundingPolyR\vboundingBox\x12H\n" +
	"\n" +
	"paragraphs\x18\x03 \x03(\v2(.google.cloud.vision.v1p1beta1.ParagraphR\n" +
	"paragraphs\x12M\n" +
	"\n" +
	"block_type\x18\x04 \x01(\x0e2..google.cloud.vision.v1p1beta1.Block.BlockTypeR\tblockType\x12\x1e\n" +
	"\n" +
	"confidence\x18\x05 \x01(\x02R\n" +
	"confidence\"R\n" +
	"\tBlockType\x12\v\n" +
	...
	"\aBARCODE\x10\x05\"\x8e\x02\n" +
	"\tParagraph\x12V\n" +
	"\bproperty\x18\x01 \x01(\v2:.google.cloud.vision.v1p1beta1.TextAnnotation.TextPropertyR\bproperty\x12N\n" +
	"\fbounding_box\x18\x02 \x01(\v2+.google.cloud.vision.v1p1beta1.BoundingPolyR\vboundingBox\x129\n" +
	"\x05words\x18\x03 \x03(\v2#.google.cloud.vision.v1p1beta1.WordR\x05words\x12\x1e\n" +
	"\n" +
	"confidence\x18\x04 \x01(\x02R\n" +
	"confidence\"\x8f\x02\n" +
	"\x04Word\x12V\n" +
	"\bproperty\x18\x01 \x01(\v2:.google.cloud.vision.v1p1beta1.TextAnnotation.TextPropertyR\bproperty\x12N\n" +
	"\fbounding_box\x18\x02 \x01(\v2+.google.cloud.vision.v1p1beta1.BoundingPolyR\vboundingBox\x12?\n" +
	"\asymbols\x18\x03 \x03(\v2%.google.cloud.vision.v1p1beta1.SymbolR\asymbols\x12\x1e\n" +
	"\n" +
	"confidence\x18\x04 \x01(\x02R\n" +
	"confidence\"\xe4\x01\n" +
	"\x06Symbol\x12V\n" +
	"\bproperty\x18\x01 \x01(\v2:.google.cloud.vision.v1p1beta1.TextAnnotation.TextPropertyR\bproperty\x12N\n" +
	"\fbounding_box\x18\x02 \x01(\v2+.google.cloud.vision.v1p1beta1.BoundingPolyR\vboundingBox\x12\x12\n" +
...
var (
	...
	file_google_cloud_vision_v1p1beta1_text_annotation_proto_rawDescData []byte
)
...
func file_google_cloud_vision_v1p1beta1_text_annotation_proto_rawDescGZIP() []byte {
	file_google_cloud_vision_v1p1beta1_text_annotation_proto_rawDescOnce.Do(func() {
		file_google_cloud_vision_v1p1beta1_text_annotation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_vision_v1p1beta1_text_annotation_proto_rawDesc), len(file_google_cloud_vision_v1p1beta1_text_annotation_proto_rawDesc)))
	})
...
var file_google_cloud_vision_v1p1beta1_text_annotation_proto_goTypes = []any{
...
func file_google_cloud_vision_v1p1beta1_text_annotation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_vision_v1p1beta1_text_annotation_proto_rawDesc), len(file_google_cloud_vision_v1p1beta1_text_annotation_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
