...
const file_google_cloud_vision_v1p1beta1_web_detection_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/vision/v1p1beta1/web_detection.proto\x12\x1dgoogle.cloud.vision.v1p1beta1\"\x86\t\n" +
	"\fWebDetection\x12X\n" +
	"\fweb_entities\x18\x01 \x03(\v25.google.cloud.vision.v1p1beta1.WebDetection.WebEntityR\vwebEntities\x12f\n" +
	"\x14full_matching_images\x18\x02 \x03(\v24.google.cloud.vision.v1p1beta1.WebDetection.WebImageR\x12fullMatchingImages\x12l\n" +
	"\x17partial_matching_images\x18\x03 \x03(\v24.google.cloud.vision.v1p1beta1.WebDetection.WebImageR\x15partialMatchingImages\x12p\n" +
	"\x1apages_with_matching_images\x18\x04 \x03(\v23.google.cloud.vision.v1p1beta1.WebDetection.WebPageR\x17pagesWithMatchingImages\x12l\n" +
	"\x17visually_similar_images\x18\x06 \x03(\v24.google.cloud.vision.v1p1beta1.WebDetection.WebImageR\x15visuallySimilarImages\x12`\n" +
	"\x11best_guess_labels\x18\b \x03(\v24.google.cloud.vision.v1p1beta1.WebDetection.WebLabelR\x0fbestGuessLabels\x1a`\n" +
	"\tWebEntity\x12\x1b\n" +
	...
	"\n" +
	"page_title\x18\x03 \x01(\tR\tpageTitle\x12f\n" +
	"\x14full_matching_images\x18\x04 \x03(\v24.google.cloud.vision.v1p1beta1.WebDetection.WebImageR\x12fullMatchingImages\x12l\n" +
	"\x17partial_matching_images\x18\x05 \x03(\v24.google.cloud.vision.v1p1beta1.WebDetection.WebImageR\x15partialMatchingImages\x1aE\n" +
	"\bWebLabel\x12\x14\n" +
	"\x05label\x18\x01 \x01(\tR\x05label\x12#\n" +
	"\rlanguage_code\x18\x02 \x01(\tR\flanguageCodeBy\n" +
...
var (
	...
	file_google_cloud_vision_v1p1beta1_web_detection_proto_rawDescData []byte
)
...
func file_google_cloud_vision_v1p1beta1_web_detection_proto_rawDescGZIP() []byte {
	file_google_cloud_vision_v1p1beta1_web_detection_proto_rawDescOnce.Do(func() {
		file_google_cloud_vision_v1p1beta1_web_detection_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_vision_v1p1beta1_web_detection_proto_rawDesc), len(file_google_cloud_vision_v1p1beta1_web_detection_proto_rawDesc)))
	})
...
var file_google_cloud_vision_v1p1beta1_web_detection_proto_goTypes = []any{
...
func file_google_cloud_vision_v1p1beta1_web_detection_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_vision_v1p1beta1_web_detection_proto_rawDesc), len(file_google_cloud_vision_v1p1beta1_web_detection_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
