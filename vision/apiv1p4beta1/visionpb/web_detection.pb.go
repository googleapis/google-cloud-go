...
var file_google_cloud_vision_v1p4beta1_web_detection_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x42, 0x7d, 0x0a, 0x21, 0x63,
...
var file_google_cloud_vision_v1p4beta1_web_detection_proto_goTypes = []any{
...
func file_google_cloud_vision_v1p4beta1_web_detection_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_vision_v1p4beta1_web_detection_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_vision_v1p4beta1_web_detection_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_vision_v1p4beta1_web_detection_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_vision_v1p4beta1_web_detection_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_cloud_vision_v1p4beta1_web_detection_proto_msgTypes[4].Exporter = func(v any, i int) any {
