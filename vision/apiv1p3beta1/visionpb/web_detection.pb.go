...
var file_google_cloud_vision_v1p3beta1_web_detection_proto_goTypes = []any{
...
func file_google_cloud_vision_v1p3beta1_web_detection_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes[4].Exporter = func(v any, i int) any {
