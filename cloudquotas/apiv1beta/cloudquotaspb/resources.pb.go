...
const file_google_api_cloudquotas_v1beta_resources_proto_rawDesc = "" +
	"\n" +
	"-google/api/cloudquotas/v1beta/resources.proto\x12\x1dgoogle.api.cloudquotas.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x8d\t\n" +
	"\tQuotaInfo\x12\x12\n" +
	...
	"\x10refresh_interval\x18\x06 \x01(\tR\x0frefreshInterval\x12]\n" +
	"\x0econtainer_type\x18\a \x01(\x0e26.google.api.cloudquotas.v1beta.QuotaInfo.ContainerTypeR\rcontainerType\x12\x1e\n" +
	"\n" +
	...
	"metricUnit\x12u\n" +
	"\x1aquota_increase_eligibility\x18\f \x01(\v27.google.api.cloudquotas.v1beta.QuotaIncreaseEligibilityR\x18quotaIncreaseEligibility\x12\x19\n" +
	"\bis_fixed\x18\r \x01(\bR\aisFixed\x12X\n" +
	"\x10dimensions_infos\x18\x0e \x03(\v2-.google.api.cloudquotas.v1beta.DimensionsInfoR\x0fdimensionsInfos\x12#\n" +
	...
	"$cloudquotas.googleapis.com/QuotaInfo\x12Rprojects/{project}/locations/{location}/services/{service}/quotaInfos/{quota_info}\x12Pfolders/{folder}/locations/{location}/services/{service}/quotaInfos/{quota_info}\x12\\organizations/{organization}/locations/{location}/services/{service}/quotaInfos/{quota_info}\"\xd3\x02\n" +
	"\x18QuotaIncreaseEligibility\x12\x1f\n" +
	"\vis_eligible\x18\x01 \x01(\bR\n" +
	"isEligible\x12~\n" +
	"\x14ineligibility_reason\x18\x02 \x01(\x0e2K.google.api.cloudquotas.v1beta.QuotaIncreaseEligibility.IneligibilityReasonR\x13ineligibilityReason\"\x95\x01\n" +
	...
	"\x05OTHER\x10\x02\"\x92\a\n" +
	"\x0fQuotaPreference\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12c\n" +
	"\n" +
	"dimensions\x18\x02 \x03(\v2>.google.api.cloudquotas.v1beta.QuotaPreference.DimensionsEntryB\x03\xe0A\x05R\n" +
	"dimensions\x12R\n" +
	"\fquota_config\x18\x03 \x01(\v2*.google.api.cloudquotas.v1beta.QuotaConfigB\x03\xe0A\x02R\vquotaConfig\x12\x17\n" +
	...
	"*cloudquotas.googleapis.com/QuotaPreference\x12Kprojects/{project}/locations/{location}/quotaPreferences/{quota_preference}\x12Ifolders/{folder}/locations/{location}/quotaPreferences/{quota_preference}\x12Uorganizations/{organization}/locations/{location}/quotaPreferences/{quota_preference}\"\x95\x04\n" +
	"\vQuotaConfig\x12,\n" +
	...
	"\btrace_id\x18\x04 \x01(\tB\x03\xe0A\x03R\atraceId\x12b\n" +
	"\vannotations\x18\x05 \x03(\v2;.google.api.cloudquotas.v1beta.QuotaConfig.AnnotationsEntryB\x03\xe0A\x01R\vannotations\x12]\n" +
	"\x0erequest_origin\x18\x06 \x01(\x0e21.google.api.cloudquotas.v1beta.QuotaConfig.OriginB\x03\xe0A\x03R\rrequestOrigin\x1a>\n" +
	...
	"\rAUTO_ADJUSTER\x10\x02\"\xa8\x02\n" +
	"\x0eDimensionsInfo\x12]\n" +
	"\n" +
	"dimensions\x18\x01 \x03(\v2=.google.api.cloudquotas.v1beta.DimensionsInfo.DimensionsEntryR\n" +
	"dimensions\x12E\n" +
	"\adetails\x18\x02 \x01(\v2+.google.api.cloudquotas.v1beta.QuotaDetailsR\adetails\x121\n" +
	"\x14applicable_locations\x18\x03 \x03(\tR\x13applicableLocations\x1a=\n" +
	"\x0fDimensionsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"s\n" +
	"\fQuotaDetails\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x03R\x05value\x12M\n" +
	"\frollout_info\x18\x03 \x01(\v2*.google.api.cloudquotas.v1beta.RolloutInfoR\vrolloutInfo\"6\n" +
	"\vRolloutInfo\x12'\n" +
...
var (
	...
	file_google_api_cloudquotas_v1beta_resources_proto_rawDescData []byte
)
...
func file_google_api_cloudquotas_v1beta_resources_proto_rawDescGZIP() []byte {
	file_google_api_cloudquotas_v1beta_resources_proto_rawDescOnce.Do(func() {
		file_google_api_cloudquotas_v1beta_resources_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_api_cloudquotas_v1beta_resources_proto_rawDesc), len(file_google_api_cloudquotas_v1beta_resources_proto_rawDesc)))
	})
...
func file_google_api_cloudquotas_v1beta_resources_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_api_cloudquotas_v1beta_resources_proto_rawDesc), len(file_google_api_cloudquotas_v1beta_resources_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
