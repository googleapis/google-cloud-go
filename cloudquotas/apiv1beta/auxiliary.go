...
func (it *QuotaInfoIterator) Next() (*cloudquotaspb.QuotaInfo, error) {
	var item *cloudquotaspb.QuotaInfo
...
func (it *QuotaInfoIterator) bufLen() int {
	return len(it.items)
}

func (it *QuotaInfoIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
type QuotaPreferenceIterator struct {
...
func (it *QuotaPreferenceIterator) Next() (*cloudquotaspb.QuotaPreference, error) {
	var item *cloudquotaspb.QuotaPreference
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
...
func (it *QuotaPreferenceIterator) bufLen() int {
	return len(it.items)
}

func (it *QuotaPreferenceIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
