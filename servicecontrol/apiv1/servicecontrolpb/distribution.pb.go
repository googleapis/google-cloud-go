...
func file_google_api_servicecontrol_v1_distribution_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_api_servicecontrol_v1_distribution_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_api_servicecontrol_v1_distribution_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_api_servicecontrol_v1_distribution_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_api_servicecontrol_v1_distribution_proto_msgTypes[3].Exporter = func(v any, i int) any {
