...
var file_google_cloud_automl_v1_model_proto_rawDesc = []byte{
	...
	0x6c, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x42, 0xa0, 0x01, 0x0a, 0x1a, 0x63,
...
func file_google_cloud_automl_v1_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_automl_v1_model_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Model); i {
			case 0:
				return &v.state
			case 1:
