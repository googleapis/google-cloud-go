...
const file_google_cloud_automl_v1_text_segment_proto_rawDesc = "" +
	"\n" +
	")google/cloud/automl/v1/text_segment.proto\x12\x16google.cloud.automl.v1\"i\n" +
	"\vTextSegment\x12\x18\n" +
	"\acontent\x18\x03 \x01(\tR\acontent\x12!\n" +
	"\fstart_offset\x18\x01 \x01(\x03R\vstartOffset\x12\x1d\n" +
	"\n" +
	"end_offset\x18\x02 \x01(\x03R\tendOffsetB\xb2\x01\n" +
	"\x1acom.google.cloud.automl.v1B\x10TextSegmentProtoP\x01Z2cloud.google.com/go/automl/apiv1/automlpb;automlpb\xaa\x02\x16Google.Cloud.AutoML.V1\xca\x02\x16Google\\Cloud\\AutoMl\\V1\xea\x02\x19Google::Cloud::AutoML::V1b\x06proto3"

var (
	file_google_cloud_automl_v1_text_segment_proto_rawDescOnce sync.Once
	file_google_cloud_automl_v1_text_segment_proto_rawDescData []byte
)
...
func file_google_cloud_automl_v1_text_segment_proto_rawDescGZIP() []byte {
	file_google_cloud_automl_v1_text_segment_proto_rawDescOnce.Do(func() {
		file_google_cloud_automl_v1_text_segment_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1_text_segment_proto_rawDesc), len(file_google_cloud_automl_v1_text_segment_proto_rawDesc)))
	})
...
var file_google_cloud_automl_v1_text_segment_proto_goTypes = []any{
...
func file_google_cloud_automl_v1_text_segment_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1_text_segment_proto_rawDesc), len(file_google_cloud_automl_v1_text_segment_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
