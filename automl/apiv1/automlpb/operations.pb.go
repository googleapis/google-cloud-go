...
func (x *OperationMetadata) GetCreateDatasetDetails() *CreateDatasetOperationMetadata {
	if x != nil {
		if x, ok := x.Details.(*OperationMetadata_CreateDatasetDetails); ok {
...
const file_google_cloud_automl_v1_operations_proto_rawDesc = "" +
	"\n" +
	"'google/cloud/automl/v1/operations.proto\x12\x16google.cloud.automl.v1\x1a\x1fgoogle/cloud/automl/v1/io.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\xb5\t\n" +
	"\x11OperationMetadata\x12X\n" +
	"\x0edelete_details\x18\b \x01(\v2/.google.cloud.automl.v1.DeleteOperationMetadataH\x00R\rdeleteDetails\x12h\n" +
	"\x14deploy_model_details\x18\x18 \x01(\v24.google.cloud.automl.v1.DeployModelOperationMetadataH\x00R\x12deployModelDetails\x12n\n" +
	"\x16undeploy_model_details\x18\x19 \x01(\v26.google.cloud.automl.v1.UndeployModelOperationMetadataH\x00R\x14undeployModelDetails\x12h\n" +
	"\x14create_model_details\x18\n" +
	" \x01(\v24.google.cloud.automl.v1.CreateModelOperationMetadataH\x00R\x12createModelDetails\x12n\n" +
	"\x16create_dataset_details\x18\x1e \x01(\v26.google.cloud.automl.v1.CreateDatasetOperationMetadataH\x00R\x14createDatasetDetails\x12e\n" +
	"\x13import_data_details\x18\x0f \x01(\v23.google.cloud.automl.v1.ImportDataOperationMetadataH\x00R\x11importDataDetails\x12k\n" +
	"\x15batch_predict_details\x18\x10 \x01(\v25.google.cloud.automl.v1.BatchPredictOperationMetadataH\x00R\x13batchPredictDetails\x12e\n" +
	"\x13export_data_details\x18\x15 \x01(\v23.google.cloud.automl.v1.ExportDataOperationMetadataH\x00R\x11exportDataDetails\x12h\n" +
	"\x14export_model_details\x18\x16 \x01(\v24.google.cloud.automl.v1.ExportModelOperationMetadataH\x00R\x12exportModelDetails\x12)\n" +
	...
	"\x1bExportDataOperationMetadata\x12i\n" +
	"\voutput_info\x18\x01 \x01(\v2H.google.cloud.automl.v1.ExportDataOperationMetadata.ExportDataOutputInfoR\n" +
	"outputInfo\x1a]\n" +
	...
	"\x1dBatchPredictOperationMetadata\x12R\n" +
	"\finput_config\x18\x01 \x01(\v2/.google.cloud.automl.v1.BatchPredictInputConfigR\vinputConfig\x12m\n" +
	"\voutput_info\x18\x02 \x01(\v2L.google.cloud.automl.v1.BatchPredictOperationMetadata.BatchPredictOutputInfoR\n" +
	"outputInfo\x1a_\n" +
	"\x16BatchPredictOutputInfo\x122\n" +
	"\x14gcs_output_directory\x18\x01 \x01(\tH\x00R\x12gcsOutputDirectoryB\x11\n" +
	"\x0foutput_location\"\xd6\x01\n" +
	"\x1cExportModelOperationMetadata\x12k\n" +
	"\voutput_info\x18\x02 \x01(\v2J.google.cloud.automl.v1.ExportModelOperationMetadata.ExportModelOutputInfoR\n" +
	"outputInfo\x1aI\n" +
	"\x15ExportModelOutputInfo\x120\n" +
	"\x14gcs_output_directory\x18\x01 \x01(\tR\x12gcsOutputDirectoryB\xa0\x01\n" +
...
var (
	...
	file_google_cloud_automl_v1_operations_proto_rawDescData []byte
)
...
func file_google_cloud_automl_v1_operations_proto_rawDescGZIP() []byte {
	file_google_cloud_automl_v1_operations_proto_rawDescOnce.Do(func() {
		file_google_cloud_automl_v1_operations_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1_operations_proto_rawDesc), len(file_google_cloud_automl_v1_operations_proto_rawDesc)))
	})
...
var file_google_cloud_automl_v1_operations_proto_goTypes = []any{
...
func file_google_cloud_automl_v1_operations_proto_init() {
	...
	file_google_cloud_automl_v1_operations_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_google_cloud_automl_v1_operations_proto_msgTypes[10].OneofWrappers = []any{
		(*ExportDataOperationMetadata_ExportDataOutputInfo_GcsOutputDirectory)(nil),
	}
	file_google_cloud_automl_v1_operations_proto_msgTypes[11].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1_operations_proto_rawDesc), len(file_google_cloud_automl_v1_operations_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   0,
