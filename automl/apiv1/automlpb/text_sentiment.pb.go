...
const file_google_cloud_automl_v1_text_sentiment_proto_rawDesc = "" +
	"\n" +
	"+google/cloud/automl/v1/text_sentiment.proto\x12\x16google.cloud.automl.v1\x1a+google/cloud/automl/v1/classification.proto\"7\n" +
	...
	"\x0fquadratic_kappa\x18\a \x01(\x02R\x0equadraticKappa\x12r\n" +
	"\x10confusion_matrix\x18\b \x01(\v2G.google.cloud.automl.v1.ClassificationEvaluationMetrics.ConfusionMatrixR\x0fconfusionMatrixB\xb4\x01\n" +
...
var (
	...
	file_google_cloud_automl_v1_text_sentiment_proto_rawDescData []byte
)
...
func file_google_cloud_automl_v1_text_sentiment_proto_rawDescGZIP() []byte {
	file_google_cloud_automl_v1_text_sentiment_proto_rawDescOnce.Do(func() {
		file_google_cloud_automl_v1_text_sentiment_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1_text_sentiment_proto_rawDesc), len(file_google_cloud_automl_v1_text_sentiment_proto_rawDesc)))
	})
...
var file_google_cloud_automl_v1_text_sentiment_proto_goTypes = []any{
...
func file_google_cloud_automl_v1_text_sentiment_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1_text_sentiment_proto_rawDesc), len(file_google_cloud_automl_v1_text_sentiment_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
