...
const file_google_cloud_automl_v1_io_proto_rawDesc = "" +
	"\n" +
	"\x1fgoogle/cloud/automl/v1/io.proto\x12\x16google.cloud.automl.v1\x1a\x1fgoogle/api/field_behavior.proto\"\xdf\x01\n" +
	"\vInputConfig\x12B\n" +
	"\n" +
	"gcs_source\x18\x01 \x01(\v2!.google.cloud.automl.v1.GcsSourceH\x00R\tgcsSource\x12G\n" +
	"\x06params\x18\x02 \x03(\v2/.google.cloud.automl.v1.InputConfig.ParamsEntryR\x06params\x1a9\n" +
	...
	"\n" +
	"gcs_source\x18\x01 \x01(\v2!.google.cloud.automl.v1.GcsSourceB\x03\xe0A\x02H\x00R\tgcsSourceB\b\n" +
	"\x06source\"W\n" +
	"\x13DocumentInputConfig\x12@\n" +
	"\n" +
	"gcs_source\x18\x01 \x01(\v2!.google.cloud.automl.v1.GcsSourceR\tgcsSource\"u\n" +
	"\fOutputConfig\x12V\n" +
	"\x0fgcs_destination\x18\x01 \x01(\v2&.google.cloud.automl.v1.GcsDestinationB\x03\xe0A\x02H\x00R\x0egcsDestinationB\r\n" +
	"\vdestination\"\x81\x01\n" +
	"\x18BatchPredictOutputConfig\x12V\n" +
	"\x0fgcs_destination\x18\x01 \x01(\v2&.google.cloud.automl.v1.GcsDestinationB\x03\xe0A\x02H\x00R\x0egcsDestinationB\r\n" +
	"\vdestination\"\xb3\x02\n" +
	"\x17ModelExportOutputConfig\x12V\n" +
	"\x0fgcs_destination\x18\x01 \x01(\v2&.google.cloud.automl.v1.GcsDestinationB\x03\xe0A\x02H\x00R\x0egcsDestination\x12!\n" +
	"\fmodel_format\x18\x04 \x01(\tR\vmodelFormat\x12S\n" +
	"\x06params\x18\x02 \x03(\v2;.google.cloud.automl.v1.ModelExportOutputConfig.ParamsEntryR\x06params\x1a9\n" +
	"\vParamsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\tGcsSource\x12\"\n" +
	"\n" +
	"input_uris\x18\x01 \x03(\tB\x03\xe0A\x02R\tinputUris\"A\n" +
	"\x0eGcsDestination\x12/\n" +
	"\x11output_uri_prefix\x18\x01 \x01(\tB\x03\xe0A\x02R\x0foutputUriPrefixB\xa0\x01\n" +
...
var (
	...
	file_google_cloud_automl_v1_io_proto_rawDescData []byte
)

func file_google_cloud_automl_v1_io_proto_rawDescGZIP() []byte {
	file_google_cloud_automl_v1_io_proto_rawDescOnce.Do(func() {
		file_google_cloud_automl_v1_io_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1_io_proto_rawDesc), len(file_google_cloud_automl_v1_io_proto_rawDesc)))
	})
...
var file_google_cloud_automl_v1_io_proto_goTypes = []any{
...
func file_google_cloud_automl_v1_io_proto_init() {
	...
	file_google_cloud_automl_v1_io_proto_msgTypes[0].OneofWrappers = []any{
		(*InputConfig_GcsSource)(nil),
	}
	file_google_cloud_automl_v1_io_proto_msgTypes[1].OneofWrappers = []any{
		(*BatchPredictInputConfig_GcsSource)(nil),
	}
	file_google_cloud_automl_v1_io_proto_msgTypes[3].OneofWrappers = []any{
		(*OutputConfig_GcsDestination)(nil),
	}
	file_google_cloud_automl_v1_io_proto_msgTypes[4].OneofWrappers = []any{
		(*BatchPredictOutputConfig_GcsDestination)(nil),
	}
	file_google_cloud_automl_v1_io_proto_msgTypes[5].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1_io_proto_rawDesc), len(file_google_cloud_automl_v1_io_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
