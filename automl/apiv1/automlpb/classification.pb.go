...
const file_google_cloud_automl_v1_classification_proto_rawDesc = "" +
	"\n" +
	"+google/cloud/automl/v1/classification.proto\x12\x16google.cloud.automl.v1\"0\n" +
	"\x18ClassificationAnnotation\x12\x14\n" +
	"\x05score\x18\x01 \x01(\x02R\x05score\"\xe6\t\n" +
	"\x1fClassificationEvaluationMetrics\x12\x15\n" +
	"\x06au_prc\x18\x01 \x01(\x02R\x05auPrc\x12\x15\n" +
	"\x06au_roc\x18\x06 \x01(\x02R\x05auRoc\x12\x19\n" +
	"\blog_loss\x18\a \x01(\x02R\alogLoss\x12\x88\x01\n" +
	"\x18confidence_metrics_entry\x18\x03 \x03(\v2N.google.cloud.automl.v1.ClassificationEvaluationMetrics.ConfidenceMetricsEntryR\x16confidenceMetricsEntry\x12r\n" +
	"\x10confusion_matrix\x18\x04 \x01(\v2G.google.cloud.automl.v1.ClassificationEvaluationMetrics.ConfusionMatrixR\x0fconfusionMatrix\x12,\n" +
	...
	"\fdisplay_name\x18\x03 \x03(\tR\vdisplayName\x12]\n" +
	"\x03row\x18\x02 \x03(\v2K.google.cloud.automl.v1.ClassificationEvaluationMetrics.ConfusionMatrix.RowR\x03row\x1a*\n" +
	"\x03Row\x12#\n" +
...
var (
	...
	file_google_cloud_automl_v1_classification_proto_rawDescData []byte
)
...
func file_google_cloud_automl_v1_classification_proto_rawDescGZIP() []byte {
	file_google_cloud_automl_v1_classification_proto_rawDescOnce.Do(func() {
		file_google_cloud_automl_v1_classification_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1_classification_proto_rawDesc), len(file_google_cloud_automl_v1_classification_proto_rawDesc)))
	})
...
var file_google_cloud_automl_v1_classification_proto_goTypes = []any{
...
func file_google_cloud_automl_v1_classification_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1_classification_proto_rawDesc), len(file_google_cloud_automl_v1_classification_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
