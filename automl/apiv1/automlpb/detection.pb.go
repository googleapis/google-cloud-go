...
const file_google_cloud_automl_v1_detection_proto_rawDesc = "" +
	"\n" +
	"&google/cloud/automl/v1/detection.proto\x12\x16google.cloud.automl.v1\x1a%google/cloud/automl/v1/geometry.proto\"\x7f\n" +
	"\x1eImageObjectDetectionAnnotation\x12G\n" +
	"\fbounding_box\x18\x01 \x01(\v2$.google.cloud.automl.v1.BoundingPolyR\vboundingBox\x12\x14\n" +
	...
	"\x1aconfidence_metrics_entries\x18\x03 \x03(\v2F.google.cloud.automl.v1.BoundingBoxMetricsEntry.ConfidenceMetricsEntryR\x18confidenceMetricsEntries\x1a\x9c\x01\n" +
	...
	"\bf1_score\x18\x04 \x01(\x02R\af1Score\"\xa8\x02\n" +
	"%ImageObjectDetectionEvaluationMetrics\x12?\n" +
	"\x1cevaluated_bounding_box_count\x18\x01 \x01(\x05R\x19evaluatedBoundingBoxCount\x12p\n" +
	"\x1cbounding_box_metrics_entries\x18\x02 \x03(\v2/.google.cloud.automl.v1.BoundingBoxMetricsEntryR\x19boundingBoxMetricsEntries\x12L\n" +
	"#bounding_box_mean_average_precision\x18\x03 \x01(\x02R\x1fboundingBoxMeanAveragePrecisionB\xa0\x01\n" +
...
var (
	...
	file_google_cloud_automl_v1_detection_proto_rawDescData []byte
)
...
func file_google_cloud_automl_v1_detection_proto_rawDescGZIP() []byte {
	file_google_cloud_automl_v1_detection_proto_rawDescOnce.Do(func() {
		file_google_cloud_automl_v1_detection_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1_detection_proto_rawDesc), len(file_google_cloud_automl_v1_detection_proto_rawDesc)))
	})
...
var file_google_cloud_automl_v1_detection_proto_goTypes = []any{
...
func file_google_cloud_automl_v1_detection_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1_detection_proto_rawDesc), len(file_google_cloud_automl_v1_detection_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
