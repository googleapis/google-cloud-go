...
const file_google_cloud_automl_v1beta1_image_proto_rawDesc = "" +
	"\n" +
	"'google/cloud/automl/v1beta1/image.proto\x12\x1bgoogle.cloud.automl.v1beta1\x1a1google/cloud/automl/v1beta1/annotation_spec.proto\x1a0google/cloud/automl/v1beta1/classification.proto\"\x86\x01\n" +
	"\"ImageClassificationDatasetMetadata\x12`\n" +
	"\x13classification_type\x18\x01 \x01(\x0e2/.google.cloud.automl.v1beta1.ClassificationTypeR\x12classificationType\"%\n" +
	"#ImageObjectDetectionDatasetMetadata\"\x82\x02\n" +
	" ImageClassificationModelMetadata\x12\"\n" +
	"\rbase_model_id\x18\x01 \x01(\tR\vbaseModelId\x12!\n" +
	"\ftrain_budget\x18\x02 \x01(\x03R\vtrainBudget\x12\x1d\n" +
	"\n" +
	"train_cost\x18\x03 \x01(\x03R\ttrainCost\x12\x1f\n" +
	"\vstop_reason\x18\x05 \x01(\tR\n" +
	"stopReason\x12\x1d\n" +
	"\n" +
	"model_type\x18\a \x01(\tR\tmodelType\x12\x19\n" +
	"\bnode_qps\x18\r \x01(\x01R\anodeQps\x12\x1d\n" +
	"\n" +
	...
	"\bnode_qps\x18\x04 \x01(\x01R\anodeQps\x12\x1f\n" +
	"\vstop_reason\x18\x05 \x01(\tR\n" +
	"stopReason\x12@\n" +
	"\x1dtrain_budget_milli_node_hours\x18\x06 \x01(\x03R\x19trainBudgetMilliNodeHours\x12<\n" +
	"\x1btrain_cost_milli_node_hours\x18\a \x01(\x03R\x17trainCostMilliNodeHours\"K\n" +
	...
	"\n" +
	"node_count\x18\x01 \x01(\x03R\tnodeCountB\xa7\x01\n" +
...
var (
	...
	file_google_cloud_automl_v1beta1_image_proto_rawDescData []byte
)
...
func file_google_cloud_automl_v1beta1_image_proto_rawDescGZIP() []byte {
	file_google_cloud_automl_v1beta1_image_proto_rawDescOnce.Do(func() {
		file_google_cloud_automl_v1beta1_image_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1beta1_image_proto_rawDesc), len(file_google_cloud_automl_v1beta1_image_proto_rawDesc)))
	})
...
var file_google_cloud_automl_v1beta1_image_proto_goTypes = []any{
...
func file_google_cloud_automl_v1beta1_image_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1beta1_image_proto_rawDesc), len(file_google_cloud_automl_v1beta1_image_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
