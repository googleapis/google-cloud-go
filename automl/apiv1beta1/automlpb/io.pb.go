...
var file_google_cloud_automl_v1beta1_io_proto_rawDesc = []byte{
	...
	0x74, 0x70, 0x75, 0x74, 0x55, 0x72, 0x69, 0x42, 0x9b, 0x01, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e,
...
func file_google_cloud_automl_v1beta1_io_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_automl_v1beta1_io_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_io_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_io_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_io_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_io_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_io_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_io_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_io_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_io_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_io_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_io_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_io_proto_msgTypes[11].Exporter = func(v any, i int) any {
