...
func (x *BatchPredictInputConfig) GetSource() isBatchPredictInputConfig_Source {
	if x != nil {
		return x.Source
	}
	return nil
...
func (x *BatchPredictInputConfig) GetGcsSource() *GcsSource {
	if x != nil {
		if x, ok := x.Source.(*BatchPredictInputConfig_GcsSource); ok {
			return x.GcsSource
		}
	}
	return nil
...
func (x *BatchPredictInputConfig) GetBigquerySource() *BigQuerySource {
	if x != nil {
		if x, ok := x.Source.(*BatchPredictInputConfig_BigquerySource); ok {
			return x.BigquerySource
		}
	}
	return nil
...
func (x *BatchPredictOutputConfig) GetDestination() isBatchPredictOutputConfig_Destination {
	if x != nil {
		return x.Destination
	}
	return nil
...
func (x *BatchPredictOutputConfig) GetGcsDestination() *GcsDestination {
	if x != nil {
		if x, ok := x.Destination.(*BatchPredictOutputConfig_GcsDestination); ok {
			return x.GcsDestination
		}
	}
	return nil
...
func (x *BatchPredictOutputConfig) GetBigqueryDestination() *BigQueryDestination {
	if x != nil {
		if x, ok := x.Destination.(*BatchPredictOutputConfig_BigqueryDestination); ok {
			return x.BigqueryDestination
		}
	}
	return nil
...
func (x *ModelExportOutputConfig) GetDestination() isModelExportOutputConfig_Destination {
	if x != nil {
		return x.Destination
	}
	return nil
...
func (x *ModelExportOutputConfig) GetGcsDestination() *GcsDestination {
	if x != nil {
		if x, ok := x.Destination.(*ModelExportOutputConfig_GcsDestination); ok {
			return x.GcsDestination
		}
	}
	return nil
...
func (x *ModelExportOutputConfig) GetGcrDestination() *GcrDestination {
	if x != nil {
		if x, ok := x.Destination.(*ModelExportOutputConfig_GcrDestination); ok {
...
func (x *ExportEvaluatedExamplesOutputConfig) GetDestination() isExportEvaluatedExamplesOutputConfig_Destination {
	if x != nil {
		return x.Destination
	}
	return nil
...
func (x *ExportEvaluatedExamplesOutputConfig) GetBigqueryDestination() *BigQueryDestination {
	if x != nil {
		if x, ok := x.Destination.(*ExportEvaluatedExamplesOutputConfig_BigqueryDestination); ok {
			return x.BigqueryDestination
		}
	}
	return nil
...
const file_google_cloud_automl_v1beta1_io_proto_rawDesc = "" +
	"\n" +
	"$google/cloud/automl/v1beta1/io.proto\x12\x1bgoogle.cloud.automl.v1beta1\"\xc1\x02\n" +
	"\vInputConfig\x12G\n" +
	"\n" +
	"gcs_source\x18\x01 \x01(\v2&.google.cloud.automl.v1beta1.GcsSourceH\x00R\tgcsSource\x12V\n" +
	"\x0fbigquery_source\x18\x03 \x01(\v2+.google.cloud.automl.v1beta1.BigQuerySourceH\x00R\x0ebigquerySource\x12L\n" +
	"\x06params\x18\x02 \x03(\v24.google.cloud.automl.v1beta1.InputConfig.ParamsEntryR\x06params\x1a9\n" +
	"\vParamsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\b\n" +
	"\x06source\"\xc4\x01\n" +
	"\x17BatchPredictInputConfig\x12G\n" +
	"\n" +
	"gcs_source\x18\x01 \x01(\v2&.google.cloud.automl.v1beta1.GcsSourceH\x00R\tgcsSource\x12V\n" +
	"\x0fbigquery_source\x18\x02 \x01(\v2+.google.cloud.automl.v1beta1.BigQuerySourceH\x00R\x0ebigquerySourceB\b\n" +
	"\x06source\"\\\n" +
	"\x13DocumentInputConfig\x12E\n" +
	"\n" +
	"gcs_source\x18\x01 \x01(\v2&.google.cloud.automl.v1beta1.GcsSourceR\tgcsSource\"\xdc\x01\n" +
	"\fOutputConfig\x12V\n" +
	"\x0fgcs_destination\x18\x01 \x01(\v2+.google.cloud.automl.v1beta1.GcsDestinationH\x00R\x0egcsDestination\x12e\n" +
	"\x14bigquery_destination\x18\x02 \x01(\v20.google.cloud.automl.v1beta1.BigQueryDestinationH\x00R\x13bigqueryDestinationB\r\n" +
	"\vdestination\"\xe8\x01\n" +
	"\x18BatchPredictOutputConfig\x12V\n" +
	"\x0fgcs_destination\x18\x01 \x01(\v2+.google.cloud.automl.v1beta1.GcsDestinationH\x00R\x0egcsDestination\x12e\n" +
	"\x14bigquery_destination\x18\x02 \x01(\v20.google.cloud.automl.v1beta1.BigQueryDestinationH\x00R\x13bigqueryDestinationB\r\n" +
	"\vdestination\"\x90\x03\n" +
	"\x17ModelExportOutputConfig\x12V\n" +
	"\x0fgcs_destination\x18\x01 \x01(\v2+.google.cloud.automl.v1beta1.GcsDestinationH\x00R\x0egcsDestination\x12V\n" +
	"\x0fgcr_destination\x18\x03 \x01(\v2+.google.cloud.automl.v1beta1.GcrDestinationH\x00R\x0egcrDestination\x12!\n" +
	"\fmodel_format\x18\x04 \x01(\tR\vmodelFormat\x12X\n" +
	"\x06params\x18\x02 \x03(\v2@.google.cloud.automl.v1beta1.ModelExportOutputConfig.ParamsEntryR\x06params\x1a9\n" +
	"\vParamsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\r\n" +
	"\vdestination\"\x9b\x01\n" +
	"#ExportEvaluatedExamplesOutputConfig\x12e\n" +
	"\x14bigquery_destination\x18\x02 \x01(\v20.google.cloud.automl.v1beta1.BigQueryDestinationH\x00R\x13bigqueryDestinationB\r\n" +
	"\vdestination\"*\n" +
	"\tGcsSource\x12\x1d\n" +
	"\n" +
	...
	"\tinput_uri\x18\x01 \x01(\tR\binputUri\"<\n" +
	...
	"\n" +
	"output_uri\x18\x01 \x01(\tR\toutputUriB\x9b\x01\n" +
...
var (
	...
	file_google_cloud_automl_v1beta1_io_proto_rawDescData []byte
)
...
func file_google_cloud_automl_v1beta1_io_proto_rawDescGZIP() []byte {
	file_google_cloud_automl_v1beta1_io_proto_rawDescOnce.Do(func() {
		file_google_cloud_automl_v1beta1_io_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1beta1_io_proto_rawDesc), len(file_google_cloud_automl_v1beta1_io_proto_rawDesc)))
	})
...
var file_google_cloud_automl_v1beta1_io_proto_goTypes = []any{
...
func file_google_cloud_automl_v1beta1_io_proto_init() {
	...
	file_google_cloud_automl_v1beta1_io_proto_msgTypes[0].OneofWrappers = []any{
		(*InputConfig_GcsSource)(nil),
		(*InputConfig_BigquerySource)(nil),
	}
	file_google_cloud_automl_v1beta1_io_proto_msgTypes[1].OneofWrappers = []any{
		(*BatchPredictInputConfig_GcsSource)(nil),
		(*BatchPredictInputConfig_BigquerySource)(nil),
	}
	file_google_cloud_automl_v1beta1_io_proto_msgTypes[3].OneofWrappers = []any{
		(*OutputConfig_GcsDestination)(nil),
		(*OutputConfig_BigqueryDestination)(nil),
	}
	file_google_cloud_automl_v1beta1_io_proto_msgTypes[4].OneofWrappers = []any{
		(*BatchPredictOutputConfig_GcsDestination)(nil),
		(*BatchPredictOutputConfig_BigqueryDestination)(nil),
	}
	file_google_cloud_automl_v1beta1_io_proto_msgTypes[5].OneofWrappers = []any{
		(*ModelExportOutputConfig_GcsDestination)(nil),
		(*ModelExportOutputConfig_GcrDestination)(nil),
	}
	file_google_cloud_automl_v1beta1_io_proto_msgTypes[6].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1beta1_io_proto_rawDesc), len(file_google_cloud_automl_v1beta1_io_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
