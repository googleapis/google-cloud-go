...
type TablesDatasetMetadata struct {
	...
	TargetColumnCorrelations map[string]*CorrelationStats `protobuf:"bytes,6,rep,name=target_column_correlations,json=targetColumnCorrelations,proto3" json:"target_column_correlations,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *TablesModelMetadata) GetAdditionalOptimizationObjectiveConfig() isTablesModelMetadata_AdditionalOptimizationObjectiveConfig {
	if x != nil {
		return x.AdditionalOptimizationObjectiveConfig
	}
	return nil
}
...
func (x *TablesModelMetadata) GetOptimizationObjectiveRecallValue() float32 {
	if x != nil {
		if x, ok := x.AdditionalOptimizationObjectiveConfig.(*TablesModelMetadata_OptimizationObjectiveRecallValue); ok {
...
func (x *TablesModelMetadata) GetOptimizationObjectivePrecisionValue() float32 {
	if x != nil {
		if x, ok := x.AdditionalOptimizationObjectiveConfig.(*TablesModelMetadata_OptimizationObjectivePrecisionValue); ok {
...
const file_google_cloud_automl_v1beta1_tables_proto_rawDesc = "" +
	"\n" +
	"(google/cloud/automl/v1beta1/tables.proto\x12\x1bgoogle.cloud.automl.v1beta1\x1a0google/cloud/automl/v1beta1/classification.proto\x1a-google/cloud/automl/v1beta1/column_spec.proto\x1a,google/cloud/automl/v1beta1/data_items.proto\x1a,google/cloud/automl/v1beta1/data_stats.proto\x1a(google/cloud/automl/v1beta1/ranges.proto\x1a,google/cloud/automl/v1beta1/regression.proto\x1a*google/cloud/automl/v1beta1/temporal.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb7\x04\n" +
	"\x15TablesDatasetMetadata\x121\n" +
	"\x15primary_table_spec_id\x18\x01 \x01(\tR\x12primaryTableSpecId\x121\n" +
	"\x15target_column_spec_id\x18\x02 \x01(\tR\x12targetColumnSpecId\x121\n" +
	"\x15weight_column_spec_id\x18\x03 \x01(\tR\x12weightColumnSpecId\x120\n" +
	"\x15ml_use_column_spec_id\x18\x04 \x01(\tR\x11mlUseColumnSpecId\x12\x8e\x01\n" +
	"\x1atarget_column_correlations\x18\x06 \x03(\v2P.google.cloud.automl.v1beta1.TablesDatasetMetadata.TargetColumnCorrelationsEntryR\x18targetColumnCorrelations\x12F\n" +
	"\x11stats_update_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x0fstatsUpdateTime\x1az\n" +
	"\x1dTargetColumnCorrelationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12C\n" +
	"\x05value\x18\x02 \x01(\v2-.google.cloud.automl.v1beta1.CorrelationStatsR\x05value:\x028\x01\"\x80\x06\n" +
	...
	"\x12target_column_spec\x18\x02 \x01(\v2'.google.cloud.automl.v1beta1.ColumnSpecR\x10targetColumnSpec\x12d\n" +
	"\x1ainput_feature_column_specs\x18\x03 \x03(\v2'.google.cloud.automl.v1beta1.ColumnSpecR\x17inputFeatureColumnSpecs\x125\n" +
	"\x16optimization_objective\x18\x04 \x01(\tR\x15optimizationObjective\x12k\n" +
	"\x18tables_model_column_info\x18\x05 \x03(\v22.google.cloud.automl.v1beta1.TablesModelColumnInfoR\x15tablesModelColumnInfo\x12@\n" +
	"\x1dtrain_budget_milli_node_hours\x18\x06 \x01(\x03R\x19trainBudgetMilliNodeHours\x12<\n" +
	"\x1btrain_cost_milli_node_hours\x18\a \x01(\x03R\x17trainCostMilliNodeHours\x124\n" +
	"\x16disable_early_stopping\x18\f \x01(\bR\x14disableEarlyStoppingB*\n" +
	"(additional_optimization_objective_config\"\xc5\x02\n" +
	"\x10TablesAnnotation\x12\x14\n" +
	"\x05score\x18\x01 \x01(\x02R\x05score\x12Y\n" +
	"\x13prediction_interval\x18\x04 \x01(\v2(.google.cloud.automl.v1beta1.DoubleRangeR\x12predictionInterval\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value\x12k\n" +
	"\x18tables_model_column_info\x18\x03 \x03(\v22.google.cloud.automl.v1beta1.TablesModelColumnInfoR\x15tablesModelColumnInfo\x12%\n" +
	"\x0ebaseline_score\x18\x05 \x01(\x02R\rbaselineScore\"\xa0\x01\n" +
	"\x15TablesModelColumnInfo\x12(\n" +
	"\x10column_spec_name\x18\x01 \x01(\tR\x0ecolumnSpecName\x12.\n" +
	"\x13column_display_name\x18\x02 \x01(\tR\x11columnDisplayName\x12-\n" +
	"\x12feature_importance\x18\x03 \x01(\x02R\x11featureImportanceB\x9b\x01\n" +
...
var (
	...
	file_google_cloud_automl_v1beta1_tables_proto_rawDescData []byte
)
...
func file_google_cloud_automl_v1beta1_tables_proto_rawDescGZIP() []byte {
	file_google_cloud_automl_v1beta1_tables_proto_rawDescOnce.Do(func() {
		file_google_cloud_automl_v1beta1_tables_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1beta1_tables_proto_rawDesc), len(file_google_cloud_automl_v1beta1_tables_proto_rawDesc)))
	})
...
var file_google_cloud_automl_v1beta1_tables_proto_goTypes = []any{
...
func file_google_cloud_automl_v1beta1_tables_proto_init() {
	...
	file_google_cloud_automl_v1beta1_tables_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1beta1_tables_proto_rawDesc), len(file_google_cloud_automl_v1beta1_tables_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
