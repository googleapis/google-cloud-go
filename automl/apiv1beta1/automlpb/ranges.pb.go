...
const file_google_cloud_automl_v1beta1_ranges_proto_rawDesc = "" +
	"\n" +
	"(google/cloud/automl/v1beta1/ranges.proto\x12\x1bgoogle.cloud.automl.v1beta1\"5\n" +
	"\vDoubleRange\x12\x14\n" +
	"\x05start\x18\x01 \x01(\x01R\x05start\x12\x10\n" +
	"\x03end\x18\x02 \x01(\x01R\x03endB\xa8\x01\n" +
	"\x1fcom.google.cloud.automl.v1beta1B\vRangesProtoP\x01Z7cloud.google.com/go/automl/apiv1beta1/automlpb;automlpb\xca\x02\x1bGoogle\\Cloud\\AutoMl\\V1beta1\xea\x02\x1eGoogle::Cloud::AutoML::V1beta1b\x06proto3"

var (
	file_google_cloud_automl_v1beta1_ranges_proto_rawDescOnce sync.Once
	file_google_cloud_automl_v1beta1_ranges_proto_rawDescData []byte
)
...
func file_google_cloud_automl_v1beta1_ranges_proto_rawDescGZIP() []byte {
	file_google_cloud_automl_v1beta1_ranges_proto_rawDescOnce.Do(func() {
		file_google_cloud_automl_v1beta1_ranges_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1beta1_ranges_proto_rawDesc), len(file_google_cloud_automl_v1beta1_ranges_proto_rawDesc)))
	})
...
func file_google_cloud_automl_v1beta1_ranges_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1beta1_ranges_proto_rawDesc), len(file_google_cloud_automl_v1beta1_ranges_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
