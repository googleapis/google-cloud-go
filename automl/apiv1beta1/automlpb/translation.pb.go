...
var file_google_cloud_automl_v1beta1_translation_proto_rawDesc = []byte{
	...
	0x74, 0x42, 0xad, 0x01, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
...
func file_google_cloud_automl_v1beta1_translation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_automl_v1beta1_translation_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_translation_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_translation_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_translation_proto_msgTypes[3].Exporter = func(v any, i int) any {
