...
const file_google_cloud_automl_v1beta1_detection_proto_rawDesc = "" +
	"\n" +
	"+google/cloud/automl/v1beta1/detection.proto\x12\x1bgoogle.cloud.automl.v1beta1\x1a*google/cloud/automl/v1beta1/geometry.proto\x1a\x1egoogle/protobuf/duration.proto\"\x84\x01\n" +
	"\x1eImageObjectDetectionAnnotation\x12L\n" +
	"\fbounding_box\x18\x01 \x01(\v2).google.cloud.automl.v1beta1.BoundingPolyR\vboundingBox\x12\x14\n" +
	...
	"timeOffset\x12L\n" +
	"\fbounding_box\x18\x03 \x01(\v2).google.cloud.automl.v1beta1.BoundingPolyR\vboundingBox\x12\x14\n" +
	"\x05score\x18\x04 \x01(\x02R\x05score\"\x9f\x03\n" +
	"\x17BoundingBoxMetricsEntry\x12#\n" +
	"\riou_threshold\x18\x01 \x01(\x02R\fiouThreshold\x124\n" +
	"\x16mean_average_precision\x18\x02 \x01(\x02R\x14meanAveragePrecision\x12\x89\x01\n" +
	"\x1aconfidence_metrics_entries\x18\x03 \x03(\v2K.google.cloud.automl.v1beta1.BoundingBoxMetricsEntry.ConfidenceMetricsEntryR\x18confidenceMetricsEntries\x1a\x9c\x01\n" +
	...
	"\bf1_score\x18\x04 \x01(\x02R\af1Score\"\xad\x02\n" +
	"%ImageObjectDetectionEvaluationMetrics\x12?\n" +
	"\x1cevaluated_bounding_box_count\x18\x01 \x01(\x05R\x19evaluatedBoundingBoxCount\x12u\n" +
	"\x1cbounding_box_metrics_entries\x18\x02 \x03(\v24.google.cloud.automl.v1beta1.BoundingBoxMetricsEntryR\x19boundingBoxMetricsEntries\x12L\n" +
	"#bounding_box_mean_average_precision\x18\x03 \x01(\x02R\x1fboundingBoxMeanAveragePrecision\"\xe0\x02\n" +
	"$VideoObjectTrackingEvaluationMetrics\x122\n" +
	"\x15evaluated_frame_count\x18\x01 \x01(\x05R\x13evaluatedFrameCount\x12?\n" +
	"\x1cevaluated_bounding_box_count\x18\x02 \x01(\x05R\x19evaluatedBoundingBoxCount\x12u\n" +
	"\x1cbounding_box_metrics_entries\x18\x04 \x03(\v24.google.cloud.automl.v1beta1.BoundingBoxMetricsEntryR\x19boundingBoxMetricsEntries\x12L\n" +
	"#bounding_box_mean_average_precision\x18\x06 \x01(\x02R\x1fboundingBoxMeanAveragePrecisionB\x9b\x01\n" +
...
var (
	...
	file_google_cloud_automl_v1beta1_detection_proto_rawDescData []byte
)
...
func file_google_cloud_automl_v1beta1_detection_proto_rawDescGZIP() []byte {
	file_google_cloud_automl_v1beta1_detection_proto_rawDescOnce.Do(func() {
		file_google_cloud_automl_v1beta1_detection_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1beta1_detection_proto_rawDesc), len(file_google_cloud_automl_v1beta1_detection_proto_rawDesc)))
	})
...
var file_google_cloud_automl_v1beta1_detection_proto_goTypes = []any{
...
func file_google_cloud_automl_v1beta1_detection_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1beta1_detection_proto_rawDesc), len(file_google_cloud_automl_v1beta1_detection_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
