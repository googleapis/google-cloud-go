...
var file_google_cloud_automl_v1beta1_text_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x42, 0xa6, 0x01, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e,
...
func file_google_cloud_automl_v1beta1_text_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_automl_v1beta1_text_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_text_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_text_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_text_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_text_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_google_cloud_automl_v1beta1_text_proto_msgTypes[5].Exporter = func(v any, i int) any {
