...
const file_google_cloud_automl_v1beta1_text_proto_rawDesc = "" +
	"\n" +
	"&google/cloud/automl/v1beta1/text.proto\x12\x1bgoogle.cloud.automl.v1beta1\x1a0google/cloud/automl/v1beta1/classification.proto\"\x85\x01\n" +
	"!TextClassificationDatasetMetadata\x12`\n" +
	"\x13classification_type\x18\x01 \x01(\x0e2/.google.cloud.automl.v1beta1.ClassificationTypeR\x12classificationType\"\x83\x01\n" +
	"\x1fTextClassificationModelMetadata\x12`\n" +
	"\x13classification_type\x18\x03 \x01(\x0e2/.google.cloud.automl.v1beta1.ClassificationTypeR\x12classificationType\"\x1f\n" +
...
var (
	...
	file_google_cloud_automl_v1beta1_text_proto_rawDescData []byte
)
...
func file_google_cloud_automl_v1beta1_text_proto_rawDescGZIP() []byte {
	file_google_cloud_automl_v1beta1_text_proto_rawDescOnce.Do(func() {
		file_google_cloud_automl_v1beta1_text_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1beta1_text_proto_rawDesc), len(file_google_cloud_automl_v1beta1_text_proto_rawDesc)))
	})
...
var file_google_cloud_automl_v1beta1_text_proto_goTypes = []any{
...
func file_google_cloud_automl_v1beta1_text_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1beta1_text_proto_rawDesc), len(file_google_cloud_automl_v1beta1_text_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
