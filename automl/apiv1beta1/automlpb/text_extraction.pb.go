...
const file_google_cloud_automl_v1beta1_text_extraction_proto_rawDesc = "" +
	"\n" +
	"1google/cloud/automl/v1beta1/text_extraction.proto\x12\x1bgoogle.cloud.automl.v1beta1\x1a.google/cloud/automl/v1beta1/text_segment.proto\"\x8d\x01\n" +
	"\x18TextExtractionAnnotation\x12M\n" +
	"\ftext_segment\x18\x03 \x01(\v2(.google.cloud.automl.v1beta1.TextSegmentH\x00R\vtextSegment\x12\x14\n" +
	"\x05score\x18\x01 \x01(\x02R\x05scoreB\f\n" +
	"\n" +
	"annotation\"\xeb\x02\n" +
	"\x1fTextExtractionEvaluationMetrics\x12\x15\n" +
	"\x06au_prc\x18\x01 \x01(\x02R\x05auPrc\x12\x91\x01\n" +
	"\x1aconfidence_metrics_entries\x18\x02 \x03(\v2S.google.cloud.automl.v1beta1.TextExtractionEvaluationMetrics.ConfidenceMetricsEntryR\x18confidenceMetricsEntries\x1a\x9c\x01\n" +
	...
	"\bf1_score\x18\x05 \x01(\x02R\af1ScoreB\x9b\x01\n" +
...
var (
	...
	file_google_cloud_automl_v1beta1_text_extraction_proto_rawDescData []byte
)
...
func file_google_cloud_automl_v1beta1_text_extraction_proto_rawDescGZIP() []byte {
	file_google_cloud_automl_v1beta1_text_extraction_proto_rawDescOnce.Do(func() {
		file_google_cloud_automl_v1beta1_text_extraction_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1beta1_text_extraction_proto_rawDesc), len(file_google_cloud_automl_v1beta1_text_extraction_proto_rawDesc)))
	})
...
var file_google_cloud_automl_v1beta1_text_extraction_proto_goTypes = []any{
...
func file_google_cloud_automl_v1beta1_text_extraction_proto_init() {
	...
	file_google_cloud_automl_v1beta1_text_extraction_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_automl_v1beta1_text_extraction_proto_rawDesc), len(file_google_cloud_automl_v1beta1_text_extraction_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
