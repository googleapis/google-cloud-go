...
type ModelMetadata struct {
	...
	ModelFeatures map[string]*ModelFeatures `protobuf:"bytes,1,rep,name=model_features,json=modelFeatures,proto3" json:"model_features,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type LanguageMetadata struct {
	...
	Models        map[string]*ModelMetadata `protobuf:"bytes,1,rep,name=models,proto3" json:"models,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_google_cloud_speech_v2_locations_metadata_proto_rawDesc = "" +
	"\n" +
	"/google/cloud/speech/v2/locations_metadata.proto\x12\x16google.cloud.speech.v2\"M\n" +
	"\fModelFeature\x12\x18\n" +
	"\afeature\x18\x01 \x01(\tR\afeature\x12#\n" +
	"\rrelease_state\x18\x02 \x01(\tR\freleaseState\"Z\n" +
	"\rModelFeatures\x12I\n" +
	"\rmodel_feature\x18\x01 \x03(\v2$.google.cloud.speech.v2.ModelFeatureR\fmodelFeature\"\xd9\x01\n" +
	"\rModelMetadata\x12_\n" +
	"\x0emodel_features\x18\x01 \x03(\v28.google.cloud.speech.v2.ModelMetadata.ModelFeaturesEntryR\rmodelFeatures\x1ag\n" +
	"\x12ModelFeaturesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12;\n" +
	"\x05value\x18\x02 \x01(\v2%.google.cloud.speech.v2.ModelFeaturesR\x05value:\x028\x01\"\xc2\x01\n" +
	"\x10LanguageMetadata\x12L\n" +
	"\x06models\x18\x01 \x03(\v24.google.cloud.speech.v2.LanguageMetadata.ModelsEntryR\x06models\x1a`\n" +
	"\vModelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12;\n" +
	"\x05value\x18\x02 \x01(\v2%.google.cloud.speech.v2.ModelMetadataR\x05value:\x028\x01\"\xd8\x01\n" +
	"\x0eAccessMetadata\x12^\n" +
	"\x0fconstraint_type\x18\x01 \x01(\x0e25.google.cloud.speech.v2.AccessMetadata.ConstraintTypeR\x0econstraintType\"f\n" +
	"\x0eConstraintType\x12\x1f\n" +
	"\x1bCONSTRAINT_TYPE_UNSPECIFIED\x10\x00\x123\n" +
	"/RESOURCE_LOCATIONS_ORG_POLICY_CREATE_CONSTRAINT\x10\x01\"\xac\x01\n" +
	"\x11LocationsMetadata\x12F\n" +
	"\tlanguages\x18\x01 \x01(\v2(.google.cloud.speech.v2.LanguageMetadataR\tlanguages\x12O\n" +
	"\x0faccess_metadata\x18\x02 \x01(\v2&.google.cloud.speech.v2.AccessMetadataR\x0eaccessMetadataBj\n" +
...
var (
	...
	file_google_cloud_speech_v2_locations_metadata_proto_rawDescData []byte
)
...
func file_google_cloud_speech_v2_locations_metadata_proto_rawDescGZIP() []byte {
	file_google_cloud_speech_v2_locations_metadata_proto_rawDescOnce.Do(func() {
		file_google_cloud_speech_v2_locations_metadata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_speech_v2_locations_metadata_proto_rawDesc), len(file_google_cloud_speech_v2_locations_metadata_proto_rawDesc)))
	})
...
func file_google_cloud_speech_v2_locations_metadata_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_speech_v2_locations_metadata_proto_rawDesc), len(file_google_cloud_speech_v2_locations_metadata_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
