...
const file_google_cloud_speech_v1_cloud_speech_adaptation_proto_rawDesc = "" +
	"\n" +
	...
	"\rphrase_set_id\x18\x02 \x01(\tB\x03\xe0A\x02R\vphraseSetId\x12E\n" +
	"\n" +
	"phrase_set\x18\x03 \x01(\v2!.google.cloud.speech.v1.PhraseSetB\x03\xe0A\x02R\tphraseSet\"\x9c\x01\n" +
	"\x16UpdatePhraseSetRequest\x12E\n" +
	"\n" +
	"phrase_set\x18\x01 \x01(\v2!.google.cloud.speech.v1.PhraseSetB\x03\xe0A\x02R\tphraseSet\x12;\n" +
	...
	"\x04name\x18\x01 \x01(\tB'\xe0A\x02\xfaA!\n" +
	"\x1fspeech.googleapis.com/PhraseSetR\x04name\"\xd7\x01\n" +
	...
	"\x0fcustom_class_id\x18\x02 \x01(\tB\x03\xe0A\x02R\rcustomClassId\x12K\n" +
	"\fcustom_class\x18\x03 \x01(\v2#.google.cloud.speech.v1.CustomClassB\x03\xe0A\x02R\vcustomClass\"\xa4\x01\n" +
	"\x18UpdateCustomClassRequest\x12K\n" +
	"\fcustom_class\x18\x01 \x01(\v2#.google.cloud.speech.v1.CustomClassB\x03\xe0A\x02R\vcustomClass\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"V\n" +
	...
	"\x0ecustom_classes\x18\x01 \x03(\v2#.google.cloud.speech.v1.CustomClassR\rcustomClasses\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"Y\n" +
	"\x18DeleteCustomClassRequest\x12=\n" +
	"\x04name\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!speech.googleapis.com/CustomClassR\x04name2\x8e\x0f\n" +
	"\n" +
	"Adaptation\x12\xc1\x01\n" +
	"\x0fCreatePhraseSet\x12..google.cloud.speech.v1.CreatePhraseSetRequest\x1a!.google.cloud.speech.v1.PhraseSet\"[\xdaA\x1fparent,phrase_set,phrase_set_id\x82\xd3\xe4\x93\x023:\x01*\"./v1/{parent=projects/*/locations/*}/phraseSets\x12\x9d\x01\n" +
	"\fGetPhraseSet\x12+.google.cloud.speech.v1.GetPhraseSetRequest\x1a!.google.cloud.speech.v1.PhraseSet\"=\xdaA\x04name\x82\xd3\xe4\x93\x020\x12./v1/{name=projects/*/locations/*/phraseSets/*}\x12\xad\x01\n" +
	...
	"\x0fUpdatePhraseSet\x12..google.cloud.speech.v1.UpdatePhraseSetRequest\x1a!.google.cloud.speech.v1.PhraseSet\"f\xdaA\x16phrase_set,update_mask\x82\xd3\xe4\x93\x02G:\n" +
	"phrase_set29/v1/{phrase_set.name=projects/*/locations/*/phraseSets/*}\x12\x98\x01\n" +
	...
	"\x11CreateCustomClass\x120.google.cloud.speech.v1.CreateCustomClassRequest\x1a#.google.cloud.speech.v1.CustomClass\"b\xdaA#parent,custom_class,custom_class_id\x82\xd3\xe4\x93\x026:\x01*\"1/v1/{parent=projects/*/locations/*}/customClasses\x12\xa6\x01\n" +
	...
	"\x11UpdateCustomClass\x120.google.cloud.speech.v1.UpdateCustomClassRequest\x1a#.google.cloud.speech.v1.CustomClass\"o\xdaA\x18custom_class,update_mask\x82\xd3\xe4\x93\x02N:\fcustom_class2>/v1/{custom_class.name=projects/*/locations/*/customClasses/*}\x12\x9f\x01\n" +
...
var (
	...
	file_google_cloud_speech_v1_cloud_speech_adaptation_proto_rawDescData []byte
)
...
func file_google_cloud_speech_v1_cloud_speech_adaptation_proto_rawDescGZIP() []byte {
	file_google_cloud_speech_v1_cloud_speech_adaptation_proto_rawDescOnce.Do(func() {
		file_google_cloud_speech_v1_cloud_speech_adaptation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_speech_v1_cloud_speech_adaptation_proto_rawDesc), len(file_google_cloud_speech_v1_cloud_speech_adaptation_proto_rawDesc)))
	})
...
func file_google_cloud_speech_v1_cloud_speech_adaptation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_speech_v1_cloud_speech_adaptation_proto_rawDesc), len(file_google_cloud_speech_v1_cloud_speech_adaptation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   1,
