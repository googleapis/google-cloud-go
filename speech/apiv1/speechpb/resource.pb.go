...
func (*TranscriptNormalization) Descriptor() ([]byte, []int) {
	return file_google_cloud_speech_v1_resource_proto_rawDescGZIP(), []int{3}
}
...
func (x *SpeechAdaptation_ABNFGrammar) Reset() {
	*x = SpeechAdaptation_ABNFGrammar{}
	mi := &file_google_cloud_speech_v1_resource_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *TranscriptNormalization_Entry) Reset() {
	*x = TranscriptNormalization_Entry{}
	mi := &file_google_cloud_speech_v1_resource_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TranscriptNormalization_Entry) Descriptor() ([]byte, []int) {
	return file_google_cloud_speech_v1_resource_proto_rawDescGZIP(), []int{3, 0}
}
...
const file_google_cloud_speech_v1_resource_proto_rawDesc = "" +
	"\n" +
	"%google/cloud/speech/v1/resource.proto\x12\x16google.cloud.speech.v1\x1a\x19google/api/resource.proto\"\x9f\x02\n" +
	"\vCustomClass\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12&\n" +
	"\x0fcustom_class_id\x18\x02 \x01(\tR\rcustomClassId\x12C\n" +
	"\x05items\x18\x03 \x03(\v2-.google.cloud.speech.v1.CustomClass.ClassItemR\x05items\x1a!\n" +
	"\tClassItem\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05value:l\xeaAi\n" +
	"!speech.googleapis.com/CustomClass\x12Dprojects/{project}/locations/{location}/customClasses/{custom_class}\"\x96\x02\n" +
	"\tPhraseSet\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12B\n" +
	"\aphrases\x18\x02 \x03(\v2(.google.cloud.speech.v1.PhraseSet.PhraseR\aphrases\x12\x14\n" +
	"\x05boost\x18\x04 \x01(\x02R\x05boost\x1a4\n" +
	"\x06Phrase\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05value\x12\x14\n" +
	"\x05boost\x18\x02 \x01(\x02R\x05boost:e\xeaAb\n" +
	"\x1fspeech.googleapis.com/PhraseSet\x12?projects/{project}/locations/{location}/phraseSets/{phrase_set}\"\x87\x03\n" +
	"\x10SpeechAdaptation\x12B\n" +
	"\vphrase_sets\x18\x01 \x03(\v2!.google.cloud.speech.v1.PhraseSetR\n" +
	"phraseSets\x12X\n" +
	"\x15phrase_set_references\x18\x02 \x03(\tB$\xfaA!\n" +
	"\x1fspeech.googleapis.com/PhraseSetR\x13phraseSetReferences\x12J\n" +
	"\x0ecustom_classes\x18\x03 \x03(\v2#.google.cloud.speech.v1.CustomClassR\rcustomClasses\x12W\n" +
	"\fabnf_grammar\x18\x04 \x01(\v24.google.cloud.speech.v1.SpeechAdaptation.ABNFGrammarR\vabnfGrammar\x1a0\n" +
	"\vABNFGrammar\x12!\n" +
	"\fabnf_strings\x18\x01 \x03(\tR\vabnfStrings\"\xcc\x01\n" +
	"\x17TranscriptNormalization\x12O\n" +
	"\aentries\x18\x01 \x03(\v25.google.cloud.speech.v1.TranscriptNormalization.EntryR\aentries\x1a`\n" +
	"\x05Entry\x12\x16\n" +
	"\x06search\x18\x01 \x01(\tR\x06search\x12\x18\n" +
	"\areplace\x18\x02 \x01(\tR\areplace\x12%\n" +
	"\x0ecase_sensitive\x18\x03 \x01(\bR\rcaseSensitiveBp\n" +
...
var (
	...
	file_google_cloud_speech_v1_resource_proto_rawDescData []byte
)
...
func file_google_cloud_speech_v1_resource_proto_rawDescGZIP() []byte {
	file_google_cloud_speech_v1_resource_proto_rawDescOnce.Do(func() {
		file_google_cloud_speech_v1_resource_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_speech_v1_resource_proto_rawDesc), len(file_google_cloud_speech_v1_resource_proto_rawDesc)))
	})
	return file_google_cloud_speech_v1_resource_proto_rawDescData
}

var file_google_cloud_speech_v1_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_google_cloud_speech_v1_resource_proto_goTypes = []any{
	...
	(*TranscriptNormalization)(nil),       // 3: google.cloud.speech.v1.TranscriptNormalization
	(*CustomClass_ClassItem)(nil),         // 4: google.cloud.speech.v1.CustomClass.ClassItem
	(*PhraseSet_Phrase)(nil),              // 5: google.cloud.speech.v1.PhraseSet.Phrase
	(*SpeechAdaptation_ABNFGrammar)(nil),  // 6: google.cloud.speech.v1.SpeechAdaptation.ABNFGrammar
	(*TranscriptNormalization_Entry)(nil), // 7: google.cloud.speech.v1.TranscriptNormalization.Entry
}
var file_google_cloud_speech_v1_resource_proto_depIdxs = []int32{
	4, // 0: google.cloud.speech.v1.CustomClass.items:type_name -> google.cloud.speech.v1.CustomClass.ClassItem
	5, // 1: google.cloud.speech.v1.PhraseSet.phrases:type_name -> google.cloud.speech.v1.PhraseSet.Phrase
	...
	6, // 4: google.cloud.speech.v1.SpeechAdaptation.abnf_grammar:type_name -> google.cloud.speech.v1.SpeechAdaptation.ABNFGrammar
	7, // 5: google.cloud.speech.v1.TranscriptNormalization.entries:type_name -> google.cloud.speech.v1.TranscriptNormalization.Entry
...
func file_google_cloud_speech_v1_resource_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_speech_v1_resource_proto_rawDesc), len(file_google_cloud_speech_v1_resource_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
