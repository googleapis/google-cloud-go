...
type DeviceSessionIterator struct {
	items    []*devicestreamingpb.DeviceSession
...
func (it *DeviceSessionIterator) Next() (*devicestreamingpb.DeviceSession, error) {
	var item *devicestreamingpb.DeviceSession
...
func (it *DeviceSessionIterator) bufLen() int {
	return len(it.items)
}

func (it *DeviceSessionIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
